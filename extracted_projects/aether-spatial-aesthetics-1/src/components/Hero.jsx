...
export default function Hero() {
  ...
  return (
    <div className="relative w-full max-w-[1400px] aspect-[4/3] max-h-[90vh] bg-[#0a0a0a] rounded-[2rem] border border-white/5 shadow-2xl overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col h-full w-full p-6 md:p-10 pointer-events-none">
        ...
        {/* Top Navigation specific to Aether container */}
        <header className="flex pointer-events-auto w-full items-center justify-between">
          ...
          <nav className="flex items-center gap-3">
            <div className="hidden md:flex items-center bg-white/5 hover:bg-white/10 backdrop-blur-md rounded-full px-5 py-2.5 gap-6 text-sm text-zinc-300 border border-white/5 transition-all duration-300">
              <Link to="/ecosystem" className="hover:text-white transition-colors font-geist">Ecosystem</Link>
              <Link to="/nodes" className="hover:text-white transition-colors font-geist">Nodes</Link>
              <Link to="/network" className="hover:text-white transition-colors font-geist">Network</Link>
            </div>
        ...
        {/* Main Content Area */}
        <main className="flex-1 flex flex-col items-center justify-end pb-4 md:pb-12 pointer-events-auto">
          <div className="flex items-end mb-4 animate-fade-up opacity-0">
            <h1 className="text-[15vw] md:text-[11rem] leading-none text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-indigo-200/50 font-geist font-light tracking-tighter">
              Summits
            </h1>
          ...
          <p className="text-zinc-400 text-center max-w-lg text-sm md:text-lg leading-relaxed animate-fade-up opacity-0 delay-100 font-geist">
            Aether equips pioneers to scale digital ecosystems from local nodes to global networks.
          </p>

    ...
    return (
      <div className="min-h-[calc(100vh-80px)] pt-32 px-6 pb-24 max-w-[800px] mx-auto flex flex-col items-center justify-center text-center w-full">
        ...
        <p className="text-zinc-400 text-lg mb-8 max-w-md">
          Your quantum instance is spinning up. Check your email to access the Aether control plane.
        </p>
    ...
    >
      ...
      <div className="flex-1 flex flex-col pt-8">
        ...
        <p className={clsx(
          ...
          Provision your environment and connect to the global edge network. Aether simplifies distributed infrastructure so you can focus on spatial aesthetics.
        </p>
        ...
        <form onSubmit={handleSubmit} className="relative z-10 p-8 md:p-10 flex flex-col gap-6 h-full">
          ...
          <div className="flex flex-col gap-3 mt-2">
            ...
            <label className={clsx(
              ...
              <div className="flex flex-col gap-1 w-full">
                <div className="flex justify-between items-center w-full">
                  <span className="text-white font-medium">Aether Enterprise</span>
          ...
          <div className="mt-4">
            ...
            <p className="text-center text-xs text-zinc-600 mt-4 font-light">
              By deploying, you agree to the Aether Network Terms of Service.
            </p>
          </div>
        </form>
      </div>

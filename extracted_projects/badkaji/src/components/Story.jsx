...
export function Story() {
  return (
    <section className="min-h-screen flex overflow-hidden bg-zinc-950 border-white/5 border-t pt-24 pb-24 relative items-center justify-center scanlines" id="story">
      {/* Background Ambient */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 gap-x-16 gap-y-16 items-center">
          ...
          <Reveal className="flex flex-col gap-6">
            ...
            <h2 className="sm:text-5xl leading-tight text-4xl font-medium text-white tracking-tight font-playfair mb-2">
              THE<br /><span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-700 glitch-text" data-text="BADKA JI">BADKA JI</span>
            </h2>

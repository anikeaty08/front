...
export function Contact() {
  ...
  return (
    <section className="min-h-screen flex overflow-hidden bg-zinc-950 border-white/5 border-t pt-24 pb-24 relative items-center justify-center" id="contact">
      ...
      {/* Floating Realistic 3D Icons Backdrop */}
      <div 
        className="absolute top-1/4 left-10 text-white/5 pointer-events-none z-0 perspective-[1000px]"
        style={{ transform: `translate(${mousePos.x * 0.8}px, ${mousePos.y * 0.8}px)` }}
      >
        <div className="animate-float-3d-realistic" style={{ animationDuration: '12s' }}>
          <MessageSquare className="w-32 h-32" />
        </div>
      </div>
      <div 
        className="absolute bottom-1/4 right-10 text-red-500/10 pointer-events-none z-0 perspective-[1000px]" 
        style={{ transform: `translate(${mousePos.x * 1.6}px, ${mousePos.y * 1.6}px)` }}
      >
        <div className="animate-float-3d-realistic" style={{ animationDelay: '-4s', animationDuration: '14s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10 w-full">
            ...
            <div className="flex items-center gap-5 bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-2xl p-5 transition-all duration-300 hover:-translate-y-1 hover:bg-zinc-900/60 hover:border-red-500/50 hover:shadow-[0_0_25px_rgba(239,68,68,0.15)] group/card cursor-none">
              ...
              <div className="overflow-hidden">
                ...
                <p className="truncate text-lg text-white font-playfair">@badkaji_001</p>
              </div>
            </div>
          </div>

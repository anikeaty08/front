...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex overflow-hidden pt-20 relative perspective-[2000px] items-center justify-center" id="hero">
      ...
      <div id="env-objects" className="absolute inset-0 pointer-events-none z-0">
        ...
        <div 
          className="absolute top-[15%] left-[10%] perspective-[1000px]"
          style={{ transform: `translate(${mousePos.x * 1.2}px, ${mousePos.y * 1.2}px)` }}
        >
          <div className="w-40 h-32 animate-float-3d-realistic">
        ...
        {/* Floating Film Strip */}
        <div 
          className="absolute bottom-[20%] right-[10%] perspective-[1000px]"
          style={{ transform: `translate(${mousePos.x * 2}px, ${mousePos.y * 2}px)` }}
        >
          <div className="w-24 h-48 animate-float-3d-realistic" style={{ animationDelay: '-2s' }}>
        ...
        <div 
          className="absolute top-[30%] right-[20%] perspective-[1000px]"
          style={{ transform: `translate(${mousePos.x * 1.5}px, ${mousePos.y * 1.5}px)` }}
        >
          <div className="w-32 h-32 animate-float-3d-realistic" style={{ animationDelay: '-4s' }}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mx-auto px-8 gap-16">
        ...
        <div className="flex-1 text-center md:text-left z-20">
          ...
          <h1 className="text-4xl tracking-tight mb-6 leading-tight drop-shadow-2xl sm:text-6xl lg:text-7xl font-playfair font-medium">
            <span className="cinematic-text block text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.15)]">WELCOME TO MY</span>
            <span className="bg-gradient-to-t from-red-400 to-red-600 lg:bg-clip-text lg:text-transparent block cinematic-text" style={{ animationDelay: '0.2s' }}>PORTFOLIO</span>
          </h1>

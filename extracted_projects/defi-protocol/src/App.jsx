...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative selection:bg-emerald-900 selection:text-emerald-50">
      ...
      >
        <div className="aura-background-component top-0 w-full -z-10 absolute h-full">
          <div className="absolute w-full h-full left-0 top-0 -z-10">
            <UnicornScene projectId="EET25BiXxR2StNXZvAzF" sdkUrl="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.29/dist/unicornStudio.umd.js" />
          </div>
        </div>
      </div>
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <div className="bg-gray-950/80 backdrop-blur-md border border-white/10 rounded-full pl-2 pr-2 py-1.5 flex items-center gap-6 shadow-2xl shadow-black/50">
          ...
          <a href="#" className="bg-white text-black px-4 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1 hover:bg-gray-200 transition-colors shadow-lg shadow-emerald-500/10">
            Start Engine
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 ml-0.5"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
          </a>
        </div>
      </nav>
        ...
        <div className="container md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 h-full mr-auto ml-auto pr-6 pl-6 gap-x-12 gap-y-12 items-center">
          ...
          <div className="flex flex-col order-2 lg:col-span-7 lg:order-1 my-24 relative gap-x-8 gap-y-8">
            ...
            <div className="flex flex-col sm:flex-row pt-4 gap-x-6 gap-y-6 items-center sm:items-stretch">
              {/* Primary Button: Animated Generate */}
              ...
              {/* Secondary Button: Spinning Border Glow CTA */}
          ...
          {/* Right Column: Abstract Visualization & Noodles */}
      ...
      <section className="relative z-20 w-full overflow-hidden border-y border-white/5 bg-black/50 py-10 animate-enter delay-200 border-emerald-500/50">
        ...
        <div className="marquee-container flex overflow-hidden">
          ...
          <div className="animate-marquee flex gap-16 md:gap-24 items-center whitespace-nowrap px-12">
            ...
            <div className="flex items-center gap-16 md:gap-24 text-zinc-600">
              <iconify-icon icon="logos:vercel" width="96" height="36" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="logos:stripe" width="80" height="36" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="simple-icons:openai" width="96" height="30" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="logos:microsoft" width="96" height="36" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="logos:google" width="90" height="30" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="simple-icons:github" width="80" height="36" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="logos:airbnb" width="96" height="30" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
              <iconify-icon icon="logos:linear" width="96" height="30" class="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300"></iconify-icon>
            </div>
      ...
      <section className="z-10 bg-black/20 pt-24 pb-24 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-fr">
            {/* Card 1: Scenarios (Wide) */}
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 animate-enter delay-300">
              <div className="p-8 h-full flex flex-col justify-between relative z-10">
                ...
                <div className="relative h-48 w-full mt-auto border border-white/5 rounded-xl bg-black/40 p-4 overflow-hidden">
                  ...
                  <div className="absolute top-[40px] left-[170px] bg-zinc-800 border border-zinc-700 rounded px-3 py-1.5 flex items-center gap-2 shadow-lg">
                    <iconify-icon icon="solar:layers-minimalistic-linear" class="text-xs text-emerald-400"></iconify-icon>
                  ...
                  <div className="absolute top-[100px] left-[20px] bg-zinc-800 border border-zinc-700 rounded px-3 py-1.5 flex items-center gap-2 shadow-lg">
                    <iconify-icon icon="solar:chip-linear" class="text-blue-400 text-xs"></iconify-icon>
            ...
            {/* Card 2: Tasks Scheduler */}
            <div className="relative group overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 animate-enter delay-400">
                  ...
                  <div className="relative w-32 h-32 flex items-center justify-center">
                    ...
                    <div className="absolute inset-4 rounded-full bg-zinc-900 flex flex-col items-center justify-center shadow-inner border border-white/5">
                      ...
                      <div className="flex items-center gap-1 mt-1 text-zinc-500">
                        <iconify-icon icon="solar:bell-linear" class="text-[10px]"></iconify-icon>
            ...
            {/* Card 3: Customize Styles */}
            <div className="relative group overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 animate-enter delay-500">
              <div className="p-6 h-full flex flex-col relative z-10">
                <h3 className="text-lg font-semibold text-zinc-100 tracking-tight mb-2">
            ...
            {/* Card 4: Multi-users */}
            <div className="relative group overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 animate-enter delay-600">
              <div className="p-6 h-full flex flex-col relative z-10">
                <h3 className="text-lg font-semibold text-zinc-100 tracking-tight mb-2">
                  Global Settlement.
                </h3>
            ...
            {/* Card 6: TalkToTaipy (Wide) */}
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 animate-enter delay-500">
                  ...
                  <div className="relative bg-zinc-900 border border-white/10 rounded-xl p-4 flex flex-col shadow-2xl">
                    ...
                    <div className="flex-1 bg-black/20 rounded border border-white/5 p-2 relative min-h-[100px]">
                      ...
                      <svg viewBox="0 0 100 50" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                        ...
                        {/* Line 1 (Red -> Emerald in CSS/Fill) */}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      ...
                      <div className="relative z-10 transform transition-transform duration-700 group-hover:scale-110">
                        <iconify-icon icon="solar:shield-check-linear" class="text-emerald-400 drop-shadow-[0_0_25px_rgba(16,185,129,0.4)]" width="160"></iconify-icon>
                      </div>
                      ...
                      <div className="absolute -top-16 -right-16 bg-zinc-900 border border-emerald-500/30 px-3 py-1.5 rounded-lg flex items-center gap-2 shadow-2xl animate-bounce delay-700 z-20">
                        <iconify-icon icon="solar:lock-password-broken" class="text-emerald-400 text-sm"></iconify-icon>
                      ...
                      <div className="absolute -bottom-10 -left-12 bg-zinc-900 border border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2 shadow-2xl animate-bounce delay-100 z-20">
                        <iconify-icon icon="solar:code-scan-linear" class="text-blue-400 text-sm"></iconify-icon>
                        <span className="text-[10px] text-zinc-300 font-mono uppercase">
                          On-Chain Verified
                        </span>
                      </div>
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="px-8 py-4 text-white hover:text-emerald-400 font-medium transition-colors flex items-center gap-2">
              Read Documentation
              <iconify-icon icon="solar:book-linear" class="text-lg"></iconify-icon>
            </button>
          </div>
        </div>
      </section>

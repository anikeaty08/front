    ...
    <main className="flex-1 w-full flex flex-col justify-center items-center py-32 px-6 relative z-10 min-h-[70vh]">
      <div className="max-w-2xl text-center flex flex-col items-center">
        ...
        <p className="text-gray-500 mb-12 leading-relaxed max-w-md">
          This structural component is currently under development. The architectural layout for this route will be deployed shortly.
        </p>
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-sm font-semibold tracking-widest uppercase text-gray-900 border-b border-gray-900 pb-1 hover:text-gray-400 hover:border-gray-400 transition-colors"
        >

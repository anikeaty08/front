  ...
  const features = [
    {
      ...
      title: 'Agenda Online',
      description: 'Calendario estilo Google integrado para todos tus profesionales y sucursales.',
      isActive: false
    },
    {
      id: 'ai-recovery',
      badge: 'Add-on Exclusivo',
      badgeColor: 'text-white',
      badgeBorder: 'border-rose-500/30',
      icon: 'solar:magic-stick-3-linear',
      iconColor: 'text-rose-500 drop-shadow-[0_0_15px_rgba(244,63,94,0.5)]',
      title: 'Recuperación IA',
      description: 'Módulo de campañas automáticas que detecta pacientes dormidos y les envía promociones personalizadas por WhatsApp para que vuelvan.',
      isActive: true,
    ...
    },
    {
      ...
      title: 'Fichas y Retención',
      description: 'Historial clínico, notas rápidas y etiquetas automáticas ("frecuente", "dormido").',
      isActive: false
    }
  ];
    ...
    <section className="w-full max-w-7xl py-32 px-6 relative border-b border-white/[0.05]">
      ...
      <div ref={headerRef} className="text-center mb-24">
        ...
        <h2 className="text-4xl md:text-5xl text-white font-medium tracking-tight">
          <MaskedText text="La plataforma que tu\nnegocio necesita" delayStart={200} stagger={100} />
        </h2>
      </div>
            ...
            <div key={feature.id} className={`${getHolodexClass(index)} clip-slide delay-${(index + 3) * 100} h-full`}>
              ...
              >
                ...
                {feature.isActive && feature.bgImage && (
                  <div 
                    className="absolute inset-0 opacity-10 mix-blend-screen bg-cover bg-center rounded-sm pointer-events-none grayscale group-hover:grayscale-0 transition-all duration-700"

    ...
    <section className="w-full max-w-7xl py-32 px-6 relative">
      <div ref={headerRef} className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 reveal-up gap-6">
        <div>
          <div className="flex items-center space-x-4 mb-4 text-[0.65rem] tracking-widest uppercase text-rose-500 font-medium">
            ...
            <span>Novedades y Recursos</span>
          </div>
          <h2 className="text-4xl md:text-5xl text-white font-medium tracking-tight">
            Mejora el flujo de<br/>tu <span className="text-rose-500">Consulta</span>
          </h2>
        </div>
      ...
      <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-12 gap-8 reveal-up">
        ...
        <article className="md:col-span-8 group cursor-pointer flex flex-col h-full">
          ...
          <h3 className="text-2xl text-white font-medium tracking-tight mb-3 group-hover:text-rose-500 transition-colors">Webinar » Cómo reducir inasistencias en un 80%</h3>
          <p className="text-sm text-white/50 font-light leading-relaxed max-w-2xl mb-6 flex-grow">
            Únete a nuestro equipo de éxito al cliente en esta charla exclusiva. Mostraremos cómo la configuración correcta de los mensajes por WhatsApp y las políticas de confirmación pueden cambiar los ingresos de tu clínica.
          </p>
          <div>
            <button className="px-6 py-2 border border-white/20 rounded-sm text-white text-[0.65rem] tracking-widest uppercase hover:bg-white hover:text-black transition-all">Leer Más</button>
          </div>
        </article>
          ...
          <article className="group cursor-pointer">
            <div className="w-full aspect-video overflow-hidden rounded-sm border border-white/10 mb-4">
              <img 
                ...
                alt="Logo de WhatsApp en la pantalla de un celular" 
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 grayscale group-hover:grayscale-0"
              />
            </div>
            <div className="text-[0.65rem] text-white/40 tracking-widest uppercase mb-2">Dic 10, 2024</div>
            <h4 className="text-lg text-white font-medium tracking-tight mb-3 group-hover:text-pink-500 transition-colors">Integración Oficial con WhatsApp Business API</h4>
            <span className="text-[0.65rem] text-pink-500 tracking-widest uppercase font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
              Leer Nota <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
            </span>
          </article>
          ...
          <article className="group cursor-pointer">
            <div className="w-full aspect-video overflow-hidden rounded-sm border border-white/10 mb-4 relative flex items-center justify-center">
              <img 
                ...
                alt="Gráficos y reportes médicos" 
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-60 grayscale group-hover:grayscale-0"
              />
              <div className="relative z-10 w-12 h-12 bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center rounded-sm group-hover:bg-rose-500/20 group-hover:border-rose-500/50 transition-colors">
                <span className="text-xl font-bold group-hover:text-rose-500 transition-colors">AI</span>
              </div>
            </div>
            <div className="text-[0.65rem] text-white/40 tracking-widest uppercase mb-2">Ene 15, 2025</div>
            <h4 className="text-lg text-white font-medium tracking-tight mb-3 group-hover:text-pink-500 transition-colors">Lanzamiento: Módulo de IA para Retención</h4>
            <span className="text-[0.65rem] text-pink-500 tracking-widest uppercase font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
              Leer Nota <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
            </span>
          </article>

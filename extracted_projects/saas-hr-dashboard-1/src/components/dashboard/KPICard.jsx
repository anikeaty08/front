...
export default function KPICard({ title, value, trend, trendUp, subtitle, icon, highlight = false }) {
  return (
    <div className="bg-white rounded-[1.5rem] p-5 shadow-sm border border-gray-100 flex flex-col relative overflow-hidden group hover:shadow-md transition-shadow">
      {/* Optional Highlight Decoration */}
      {highlight && (

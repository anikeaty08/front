    ...
    <header className="h-20 px-8 flex items-center justify-between shrink-0">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative group">
          ...
          <input
            type="text"
            className="block w-full pl-11 pr-4 py-2.5 bg-white border border-gray-100 rounded-full text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#c5f82a]/50 focus:border-[#c5f82a] transition-all shadow-sm"

  ...
  return (
    <section className="relative w-full min-h-[700px] flex items-center justify-center py-32 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
        ...
        <BlurText 
          text="Tú nos cuentas. Nosotros la lanzamos." 
          className="section-heading text-5xl md:text-6xl lg:text-7xl font-heading italic tracking-tight leading-[0.9] justify-center text-white mb-6"
        />
        ...
        >
          Una llamada para entender tu negocio, un prototipo en 48h y la web online en menos de una semana. Sin reuniones interminables ni presupuestos eternos.
        </motion.p>

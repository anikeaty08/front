      ...
      <div className="relative z-10 lg:px-[6%] max-w-[1600px] mr-auto ml-auto pr-6 pl-6">
        ...
        <div className="mb-20 lg:mb-24 max-w-4xl">
          <h2 className="lg:text-8xl text-4xl font-normal text-white tracking-tight mb-8 animate-reveal">
            Five AI <span className="text-white/30">service lines.</span>
          </h2>
          <div className="animate-reveal delay-100 grid grid-cols-1 lg:grid-cols-2 gap-12">
            <p className="text-lg text-white/60 font-light leading-relaxed">
              What we actually build, deploy, and maintain. Every engagement ships in your infrastructure,
              with documentation and a handoff training session for your team.
            </p>
            <div className="flex gap-4 items-center lg:justify-end">
              <div className="h-[1px] w-12 bg-white/20"></div>
              <span className="text-xs font-mono text-white/40 uppercase">Built on NIST AI RMF + OWASP LLM Top 10</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 gap-x-6 gap-y-6">
          ...
          <FlashlightCard className="animate-reveal delay-200 col-span-1 lg:col-span-2 hover:bg-white/[0.04] transition-all duration-500 flex flex-col hover:border-white/10 h-full border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/50 font-light leading-relaxed">
                Background workflows that run quietly and produce structured output. Lead-gen pipelines, document generation, intent classification, content drafting, meeting-to-action wiring. Ships with a usable dashboard — never a CLI.
              </p>
            </div>
          </FlashlightCard>
          ...
          <FlashlightCard className="animate-reveal delay-300 col-span-1 lg:col-span-2 hover:bg-white/[0.04] transition-all duration-500 flex flex-col hover:border-white/10 h-full border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/50 font-light leading-relaxed">
                Custom GPTs, Claude Projects, voice agents, prompt libraries, and team training. For clients who already have AI tools but aren't getting full value out of them.
              </p>
            </div>
          </FlashlightCard>
          ...
          <FlashlightCard className="animate-reveal delay-500 col-span-1 lg:col-span-2 hover:bg-white/[0.04] transition-all duration-500 flex flex-col hover:border-white/10 h-full border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-lg font-medium text-white mb-3 tracking-tight">AI Search Visibility</h3>
              <p className="text-sm text-white/50 font-light leading-relaxed">
                Measure your brand across ChatGPT, Claude, Perplexity, Gemini, and Google AI Overviews. Then ship the fixes — schema, Wikipedia/Wikidata, canonical content, listings — and re-measure at T+30.
              </p>
            </div>
          </FlashlightCard>
          ...
          <FlashlightCard className="animate-reveal delay-200 col-span-1 lg:col-span-3 hover:bg-white/[0.04] transition-all duration-500 flex flex-col min-h-[320px] hover:border-white/10 border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden">
            ...
            <div className="mt-auto relative z-10">
              <h3 className="text-xl font-medium text-white mb-3 tracking-tight">Intelligence Systems &amp; Custom Agents</h3>
              <p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
                Multi-source monitoring with full dashboards. Governance trackers, competitive intelligence, compliance monitoring across regulatory feeds, and custom agentic systems with backend integration, escalation logic, and domain-specific RAG.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <div className="text-xs font-mono text-purple-400 bg-purple-400/10 px-2 py-1 rounded">Multi-source ingest</div>
                <div className="text-xs font-mono text-white/60 bg-white/5 px-2 py-1 rounded">Web dashboard</div>
                <div className="text-xs font-mono text-white/60 bg-white/5 px-2 py-1 rounded">Alerting layer</div>
              </div>
            </div>
          </FlashlightCard>
          ...
          <FlashlightCard className="animate-reveal delay-300 col-span-1 lg:col-span-3 hover:bg-white/[0.04] transition-all duration-500 flex flex-col min-h-[320px] hover:border-white/10 border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden">
            ...
            <div className="mt-auto relative z-10">
              ...
              <p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
                Comprehensive security assessments of existing AI deployments mapped to OWASP LLM Top 10. Vendor and contract audits. Internal AI usage policies. Compliance mapping for HIPAA, ABA Rule 1.6, AICPA SSTS 1.4, EU AI Act, Colorado SB 24-205.
              </p>
              <div className="mt-8 flex -space-x-2 overflow-hidden items-center">
                ...
                <div className="inline-block h-6 px-2 rounded-full ring-2 ring-[#0a051e] bg-white/10 flex items-center justify-center text-[9px] font-mono text-white whitespace-nowrap">OWASP LLM Top 10</div>
              </div>
            </div>
          </FlashlightCard>

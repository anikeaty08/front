...
<a className="text-2xl font-serif text-white border-b border-white/10 pb-4" href="#" onClick={(e) => { toggleMobileMenu() }}>Home</a>
<a className="text-xl text-slate-300 font-light" href="#services" onClick={(e) => { toggleMobileMenu() }}>Services</a>
<a className="text-xl text-slate-300 font-light" href="#doctors" onClick={(e) => { toggleMobileMenu() }}>Our Doctors</a>
<a className="text-xl text-slate-300 font-light" href="#new-patients" onClick={(e) => { toggleMobileMenu() }}>New Patients</a>
<a className="text-xl text-slate-300 font-light" href="#location" onClick={(e) => { toggleMobileMenu() }}>Location</a>
...
<a className="mt-4 w-full py-4 bg-white text-slate-950 rounded-full text-center text-sm font-semibold" href="#booking" onClick={(e) => { toggleMobileMenu() }}>Request Appointment</a>
</div>
</div>
<button className="absolute top-6 right-6 text-white p-2" onClick={(e) => { toggleMobileMenu() }}>
...
<form className="space-y-4" onSubmit={(e) => { event.preventDefault(); alert('Thank you! Your request has been sent. Our team will contact you shortly.'); }}>

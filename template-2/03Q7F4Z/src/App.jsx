...
<div className="sm:rounded-2xl sm:p-6 flex flex-col gap-3 sm:gap-4 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 glass-darker hover:border-gray-500/60 bg-[url(/assets/6776fba5-2ede-4e94-b98f-8d32fde75a36_800w.jpg)] bg-cover border-gray-600/40 rounded-xl pt-4 pr-4 pb-4 pl-4 shadow-xl" style={{}}>
...
<div className="sm:rounded-2xl sm:p-6 flex flex-col gap-3 sm:gap-4 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 glass-darker text-gray-200 bg-[url(/assets/ec79d014-d7ca-4526-b496-b6bb9ba0a50c_800w.jpg)] bg-cover border-gray-500/50 rounded-xl pt-4 pr-4 pb-4 pl-4 shadow-xl" style={{}}>
...
<div className="sm:rounded-2xl sm:p-6 flex flex-col gap-3 sm:gap-4 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:col-span-2 lg:col-span-1 glass-darker hover:border-gray-500/60 bg-[url(/assets/381bd046-b81e-4b30-87a3-412386e6824f_800w.jpg)] bg-cover border-gray-600/40 rounded-xl pt-4 pr-4 pb-4 pl-4 shadow-xl" style={{}}>

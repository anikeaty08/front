...
...transformStyleUtilities,
    ...
    function handleHover3D(e, el) {
      const rect = el.getBoundingClientRect();
      const x = ((e.clientX - rect.left) / rect.width - 0.5) * 30;
      const y = ((e.clientY - rect.top) / rect.height - 0.5) * 30;
      el.style.transform = `scale(1.1) rotateY(${x * 0.3}deg) rotateX(${-y * 0.3}deg) translateZ(10px)`;
...
<div className="pointer-events-none absolute inset-0 transform-gpu perspective-[800px]" data-parallax="0.12" style={{transform: `translate3d(0px, -0.0500046px, 0px) rotateX(-0.000500046deg)`, willChange: `transform`}}>

<div className="absolute top-[10%] left-[5%] w-2 h-2 bg-cyan-400/90 rounded-full blur-[0.5px] animate-ping shadow-[0_0_25px_rgba(34,211,238,0.8)]" data-3d-depth="0.8" style={{transform: `translate3d(0.326531px, -7.96768px, 0px) rotateX(2.3903deg) rotateY(0.0979592deg)`}}></div>
<div className="absolute top-[18%] left-[25%] w-1.5 h-1.5 bg-cyan-300/80 rounded-full shadow-[0_0_20px_rgba(34,211,238,0.6)]" data-3d-depth="0.6" style={{transform: `translate3d(0.244898px, -5.97576px, 0px) rotateX(1.79273deg) rotateY(0.0734694deg)`}}></div>
<div className="absolute top-[22%] right-[18%] w-2 h-2 bg-cyan-300/90 rounded-full blur-[0.5px] animate-pulse shadow-[0_0_30px_rgba(34,211,238,0.7)]" data-3d-depth="0.9" style={{transform: `translate3d(0.367347px, -8.96364px, 0px) rotateX(2.68909deg) rotateY(0.110204deg)`}}></div>

<div className="absolute top-[48%] left-[12%] w-1 h-1 bg-cyan-200/70 rounded-full animate-pulse shadow-[0_0_15px_rgba(34,211,238,0.5)]" data-3d-depth="0.4" style={{transform: `translate3d(0.163265px, -3.98384px, 0px) rotateX(1.19515deg) rotateY(0.0489796deg)`}}></div>
<div className="absolute top-[58%] left-[45%] w-1.5 h-1.5 bg-cyan-400/80 rounded-full animate-bounce shadow-[0_0_22px_rgba(34,211,238,0.6)]" data-3d-depth="0.7" style={{transform: `translate3d(0.285714px, -6.97172px, 0px) rotateX(2.09152deg) rotateY(0.0857143deg)`}}></div>

<div className="absolute bottom-[12%] left-[20%] w-1 h-1 bg-cyan-300/60 rounded-full blur-[0.5px] shadow-[0_0_12px_rgba(34,211,238,0.4)]" data-3d-depth="0.3" style={{transform: `translate3d(0.122449px, -2.98788px, 0px) rotateX(0.896364deg) rotateY(0.0367347deg)`}}></div>
<div className="absolute bottom-[18%] right-[25%] w-1 h-1 bg-cyan-200/50 rounded-full animate-ping shadow-[0_0_10px_rgba(34,211,238,0.3)]" data-3d-depth="0.2" style={{transform: `translate3d(0.0816327px, -1.99192px, 0px) rotateX(0.597576deg) rotateY(0.0244898deg)`}}></div>
</div>

<div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(34,211,238,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(34,211,238,0.03)_1px,transparent_1px)] bg-[size:60px_60px] opacity-30 transform-gpu" data-parallax="0.05" style={{transform: `translate3d(0px, -0.0222252px, 0px) rotateX(-0.000222252deg)`, transformOrigin: `center bottom`, willChange: `transform`}}></div>
...
<div className="absolute inset-0 rounded-3xl bg-gradient-to-b from-cyan-500/15 to-indigo-600/10 blur-3xl animate-pulse"></div>

<div className="absolute inset-0 grid place-items-center transform-gpu" data-scroll-rotate="">
...
<circle cx="100" cy="100" opacity="0.3" r="92" stroke="#22d3ee" strokeDasharray="5,10" strokeWidth="0.3"></circle>
<circle cx="100" cy="100" opacity="0.25" r="65" stroke="#0891b2" strokeDasharray="8,15" strokeWidth="0.3"></circle>
</svg>

<div className="absolute inset-0 animate-spin" data-hover-3d="true" id="aura-emek8imdu" onMouseEnter={(e) => { e.currentTarget.style.transform = 'scale(1.1) rotateY(5deg) rotateX(-2deg)' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1) rotateY(0deg) rotateX(0deg)' }} onMouseMove={(e) => { handleHover3D(event, e.currentTarget) }} style={{animationDuration: `25s`, transform: `scale(1) rotateY(0deg) rotateX(0deg)`, transition: `transform 0.1s ease-out`}}>
...
<div className="absolute -bottom-4 right-2 flex flex-col gap-3" id="aura-emek8m0wx">
<div className="backdrop-saturate-150 ring-1 ring-white/[0.15] hover:ring-cyan-400/40 hover:bg-white/[0.12] transition-all duration-300 shadow-[0_8px_32px_rgba(0,0,0,0.2)] hover:shadow-[0_12px_40px_rgba(34,211,238,0.15)] hover:scale-105 cursor-pointer border-white/10 border rounded-2xl pt-3 pr-4 pb-3 pl-4 backdrop-blur-2xl" id="aura-emek8jz41">
<div className="flex gap-2 text-xs text-slate-200/95 items-center">
<svg className="h-4 w-4 stroke-cyan-300" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 8V4m-7 8h14M5 8h14v8a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3V8Z"></path>
<path d="M8 13h.01M16 13h.01"></path>
</svg>
      Live AI co-pilot active
    </div>
<div className="mt-2 h-1 w-full bg-white/10 rounded-full overflow-hidden">
<div className="h-full w-3/4 bg-gradient-to-r from-cyan-400 to-cyan-300 rounded-full"></div>
</div>
</div>
<div className="ring-1 ring-white/10 hover:ring-cyan-400/30 transition-all duration-300 hover:scale-105 cursor-pointer rounded-2xl pt-2 pr-3 pb-2 pl-3 backdrop-blur-xl" id="aura-emek8lxvl">
...
<div className="">
<h2 className="text-2xl sm:text-3xl tracking-tight text-white transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{fontFamily: `Space Grotesk, Inter, ui-sans-serif`, fontWeight: `600`, transitionDelay: `0ms`, textShadow: `0 0 30px rgba(34,211,238,0.1)`}}>
              Core Systems
            </h2>
<p className="mt-2 text-slate-400 max-w-2xl text-sm sm:text-base transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>
...
<div className="group relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-white/[0.08] hover:bg-white/[0.08] hover:ring-cyan-400/40 hover:border-white/25 transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgba(34,211,238,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`, transformStyle: `preserve-3d`}}>
...
<div className="group relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-white/[0.08] hover:bg-white/[0.08] hover:ring-cyan-400/40 hover:border-white/25 transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgba(79,70,229,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`, transformStyle: `preserve-3d`}}>
...
<div className="group relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-white/[0.08] hover:bg-white/[0.08] hover:ring-cyan-400/40 hover:border-white/25 transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgba(34,211,238,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `160ms`, transformStyle: `preserve-3d`}}>
...
<div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.02] backdrop-blur-3xl backdrop-saturate-200 ring-1 ring-white/[0.08] transition-all duration-1000 ease-out transform-gpu shadow-[0_20px_80px_rgba(0,0,0,0.2)] hover:shadow-[0_30px_100px_rgba(34,211,238,0.1)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>

<div className="absolute left-4 top-4 z-10">
<div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-cyan-400/10 backdrop-blur-xl px-4 py-2 text-xs text-cyan-200 ring-1 ring-cyan-400/30 border border-white/10 transition-all duration-1000 ease-out transform-gpu shadow-[0_0_30px_rgba(34,211,238,0.2)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `140ms`}}>
...
<aside className="col-span-1 border-r border-white/15 bg-white/[0.02] backdrop-blur-xl p-4 lg:p-6 transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `120ms`}}>
...
<div className="col-span-3 p-4 lg:p-8 transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `160ms`}}>

<div className="grid grid-cols-2 md:grid-cols-3 gap-3 lg:gap-4 mb-8">
<div className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl p-4 transition-all duration-1000 ease-out transform-gpu hover:scale-105 hover:from-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.1)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`}}>
...
<div className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl p-4 transition-all duration-1000 ease-out transform-gpu hover:scale-105 hover:from-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.1)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>
...
<div className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl p-4 transition-all duration-1000 ease-out transform-gpu hover:scale-105 hover:from-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.1)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `160ms`}}>
...
<div className="col-span-2 rounded-3xl border border-white/15 bg-gradient-to-br from-white/[0.08] to-white/[0.01] backdrop-blur-2xl p-6 transition-all duration-1000 ease-out transform-gpu shadow-[0_20px_60px_rgba(0,0,0,0.15)] hover:shadow-[0_30px_80px_rgba(34,211,238,0.1)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`}}>
...
<div className="rounded-3xl border border-white/15 bg-gradient-to-br from-white/[0.08] to-white/[0.01] backdrop-blur-2xl p-6 transition-all duration-1000 ease-out transform-gpu shadow-[0_20px_60px_rgba(0,0,0,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>
<div className="flex items-center justify-between mb-6">
...
<div className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
<div className="mb-10">
<h2 className="text-2xl sm:text-3xl tracking-tight text-white transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{fontFamily: `Space Grotesk`, fontWeight: `600`, transitionDelay: `0ms`, textShadow: `0 0 30px rgba(34,211,238,0.1)`}}>Trusted by pioneers</h2>
<p className="mt-2 text-slate-400 text-sm sm:text-base transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>From research labs to global networks, teams elevate output with NeuroLink.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">

<div className="group relative overflow-hidden rounded-3xl ring-1 ring-cyan-400/20 border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 hover:ring-cyan-400/40 hover:bg-white/[0.06] transition-all duration-500 transform-gpu hover:scale-105 shadow-[0_20px_60px_rgba(0,0,0,0.15)] hover:shadow-[0_30px_80px_rgba(34,211,238,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`}}>
...
<div className="group relative overflow-hidden rounded-3xl ring-1 ring-cyan-400/20 border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 hover:ring-cyan-400/40 hover:bg-white/[0.06] transition-all duration-500 transform-gpu hover:scale-105 shadow-[0_20px_60px_rgba(0,0,0,0.15)] hover:shadow-[0_30px_80px_rgba(79,70,229,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>
...
<div className="group relative overflow-hidden rounded-3xl ring-1 ring-cyan-400/20 border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 hover:ring-cyan-400/40 hover:bg-white/[0.06] transition-all duration-500 transform-gpu hover:scale-105 shadow-[0_20px_60px_rgba(0,0,0,0.15)] hover:shadow-[0_30px_80px_rgba(34,211,238,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `160ms`}}>
...
<h2 className="text-2xl sm:text-3xl tracking-tight text-white transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{fontFamily: `Space Grotesk`, fontWeight: `600`, transitionDelay: `0ms`, textShadow: `0 0 30px rgba(34,211,238,0.1)`}}>Choose your trajectory</h2>
<p className="mt-2 text-slate-400 text-sm sm:text-base transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`}}>Simple, scalable tiers with enterprise foundations.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 perspective-[1000px]">

<div className="relative rounded-3xl border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-white/[0.08] hover:ring-cyan-400/40 hover:bg-white/[0.06] transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 shadow-[0_20px_60px_rgba(0,0,0,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`, transformStyle: `preserve-3d`}}>
...
<div className="relative rounded-3xl border border-cyan-400/40 bg-gradient-to-br from-cyan-500/15 to-cyan-400/5 backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-cyan-400/30 shadow-[0_0_60px_rgba(34,211,238,0.2)] transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 hover:shadow-[0_0_80px_rgba(34,211,238,0.25)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `80ms`, transformStyle: `preserve-3d`}}>
...
<div className="relative rounded-3xl border border-white/15 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 p-6 ring-1 ring-white/[0.08] hover:ring-cyan-400/40 hover:bg-white/[0.06] transition-all duration-500 transform-gpu hover:scale-105 hover:rotateY-2 shadow-[0_20px_60px_rgba(0,0,0,0.15)] opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `160ms`, transformStyle: `preserve-3d`}}>
<div className="relative">
...
<div className="relative mx-auto max-w-7xl px-6 py-20 lg:py-28 overflow-hidden rounded-3xl border border-white/15 bg-gradient-to-br from-white/[0.04] to-white/[0.01] backdrop-blur-3xl backdrop-saturate-200 shadow-[0_40px_120px_rgba(0,0,0,0.25)]" data-cta-3d="" style={{transform: `perspective(1000px) rotateY(0deg) rotateX(0deg)`}}>

<div className="pointer-events-none absolute -inset-4 bg-[radial-gradient(40%_50%_at_30%_30%,rgba(34,211,238,0.15),transparent),radial-gradient(30%_40%_at_80%_60%,rgba(99,102,241,0.15),transparent),radial-gradient(20%_30%_at_50%_80%,rgba(34,211,238,0.12),transparent)] blur-3xl transform-gpu" data-parallax="0.08" style={{transform: `translate3d(0px, -231.969px, 0px) rotateX(-2deg)`, willChange: `transform`}}></div>
<div className="absolute inset-0 opacity-50 bg-fixed transform-gpu" data-parallax="0.04" style={{transform: `translate3d(0px, -120.446px, 0px) rotateX(-1.20446deg)`, willChange: `transform`}}></div>
...
<div className="relative text-center transition-all duration-1000 ease-out transform-gpu opacity-100 translate-y-0 blur-0" data-reveal="" style={{transitionDelay: `0ms`}}>
...
<span className="">Get Early Access Now</span>

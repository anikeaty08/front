...
<article className="relative overflow-hidden h-[200px] bg-zinc-800 border border-zinc-800 rounded-2xl">
<div className="absolute inset-0 bg-cover hover:scale-105 transition-transform duration-500 bg-[url(/assets/6653564f-d2bb-4c35-8fef-be58ac89ffe0_800w.jpg)] bg-center"></div>

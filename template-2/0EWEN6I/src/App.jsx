...
<div className="absolute inset-0 opacity-[.07]" style={{backgroundImage: `linear-gradient(var(--grid-major) 1px, transparent 1px),
           linear-gradient(90deg, var(--grid-major) 1px, transparent 1px)`, backgroundSize: `80px 80px, 80px 80px`}}></div>
<div className="absolute inset-0 opacity-[.04]" style={{backgroundImage: `linear-gradient(var(--grid-minor) 1px, transparent 1px),
           linear-gradient(90deg, var(--grid-minor) 1px, transparent 1px)`, backgroundSize: `16px 16px, 16px 16px`}}></div>

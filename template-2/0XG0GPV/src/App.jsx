...

{
    ...
    createIcons({
      icons: { Battery, Wifi, Signal, ChevronLeft, MoreHorizontal, MapPin, Briefcase, Link2, ShieldCheck, Banknote, Camera, UserCheck, BadgeCheck, GraduationCap, Handshake, Heart, Lock, Compass, Stars, Sparkle, MessageSquare, User, X, ChevronRight },
...
<div className="min-h-screen flex items-center justify-center pt-6 px-6 pb-6">

<div className="relative bg-slate-900/30 rounded-[38px] p-3 ring-1 ring-white/10 shadow-[0_40px_120px_-30px_rgba(0,0,0,0.75)] backdrop-blur">
...
<svg className="lucide lucide-signal h-4 w-4" data-lucide="signal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
...
<header className="mt-3 px-5 flex items-center justify-between opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" style={{willChange: `transform, opacity, filter`}}>
...
<h1 className="text-[28px] leading-tight tracking-tight font-semibold text-white">Профиль</h1>
<div className="flex items-center gap-2">
<button aria-pressed="true" className="px-3 py-1.5 rounded-full text-[12px] ring-1 ring-white/10 bg-white/5 hover:bg-white/10 active:scale-95 transition duration-200 ease-out" id="view-full">Полный</button>
<button aria-pressed="false" className="px-3 py-1.5 rounded-full text-[12px] ring-1 ring-white/10 bg-transparent hover:bg-white/10 active:scale-95 transition duration-200 ease-out" id="view-minimal">Минимальный</button>
...
<section className="mt-5 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" style={{willChange: `transform, opacity, filter`}}>
<div className="relative overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/[0.02]">
<div className="p-4 flex items-center gap-4">
<div className="relative shrink-0">
<img alt="Фото профиля" className="h-16 w-16 rounded-2xl object-cover ring-1 ring-white/10" id="avatar" src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=640&auto=format&fit=crop" />
<span className="absolute -bottom-1 -right-1 inline-flex items-center gap-1 rounded-full bg-[#CBA35A]/20 px-2 py-0.5 text-[10px] text-[#E3CDA0] ring-1 ring-[#CBA35A]/30">
<svg className="lucide lucide-shield-check h-3.5 w-3.5 text-[#E3CDA0]" data-lucide="shield-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> VIP
                  </span>
</div>
<div className="min-w-0">
<div className="flex items-center gap-2">
<h2 className="text-[22px] tracking-tight font-semibold text-white">Александра, 32</h2>
...
<svg className="lucide lucide-map-pin h-3.5 w-3.5" data-lucide="map-pin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="10"></circle></svg> Москва
                    </span>
</div>
<div className="mt-1 text-[13px] text-slate-300 flex flex-wrap items-center gap-2">
<span className="inline-flex items-center gap-1">
<svg className="lucide lucide-briefcase h-3.5 w-3.5 text-slate-400" data-lucide="briefcase" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="14" rx="2" width="20"></rect></svg>
                      Инвестиционный директор
                    </span>
<span className="inline-flex items-center gap-1.5 text-[#E3CDA0] ring-1 ring-[#CBA35A]/30 bg-[#CBA35A]/10 rounded-full px-2 py-0.5">
<svg className="lucide lucide-link-2 h-3.5 w-3.5" data-lucide="link-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><line></line></svg>
...
<div className="border-white/10 border-t pt-3 pr-4 pb-3 pl-4">
<div className="flex items-center gap-3 overflow-x-auto no-scrollbar">
<button className="group inline-flex items-center gap-2 rounded-full bg-white/[0.03] px-3 py-1.5 ring-1 ring-[#CBA35A]/30 hover:bg-[#CBA35A]/10 transition" data-tooltip="Подтвержденный доход">
<svg className="lucide lucide-banknote h-4.5 w-4.5 text-[#E3CDA0]" data-lucide="banknote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="12" rx="2" width="20"></rect><circle cx="12" cy="12"></circle><path></path></svg>
<span className="text-[12px] text-[#E3CDA0]">Доход</span>
</button>
<button className="group inline-flex items-center gap-2 rounded-full bg-white/[0.03] px-3 py-1.5 ring-1 ring-[#CBA35A]/30 hover:bg-[#CBA35A]/10 transition" data-tooltip="Верифицированные фото">
<svg className="lucide lucide-camera h-4.5 w-4.5 text-[#E3CDA0]" data-lucide="camera" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="13"></circle></svg>
<span className="text-[12px] text-[#E3CDA0]">Фото</span>
</button>
<button className="group inline-flex items-center gap-2 rounded-full bg-white/[0.03] px-3 py-1.5 ring-1 ring-[#CBA35A]/30 hover:bg-[#CBA35A]/10 transition" data-tooltip="ID подтвержден">
<svg className="lucide lucide-user-check h-4.5 w-4.5 text-[#E3CDA0]" data-lucide="user-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="9" cy="7"></circle></svg>
<span className="text-[12px] text-[#E3CDA0]">ID</span>
</button>
<button className="group inline-flex items-center gap-2 rounded-full bg-white/[0.03] px-3 py-1.5 ring-1 ring-[#CBA35A]/30 hover:bg-[#CBA35A]/10 transition" data-tooltip="Проверка службой безопасности">
<svg className="lucide lucide-shield-check h-4.5 w-4.5 text-[#E3CDA0]" data-lucide="shield-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
<span className="text-[12px] text-[#E3CDA0]">Bg</span>
</button>
<button className="group inline-flex items-center gap-2 rounded-full bg-white/[0.03] px-3 py-1.5 ring-1 ring-[#CBA35A]/30 hover:bg-[#CBA35A]/10 transition" data-tooltip="Социальные сети верифицированы">
<svg className="lucide lucide-badge-check h-4.5 w-4.5 text-[#E3CDA0]" data-lucide="badge-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
<span className="text-[12px] text-[#E3CDA0]">Social</span>
</button>
</div>
</div>
</div>
...
<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" style={{willChange: `transform, opacity, filter`}}>
<div className="flex items-center justify-between mb-2">
<h3 className="text-[18px] tracking-tight font-semibold text-white">Фотографии</h3>
<button className="text-sm text-slate-300 hover:text-slate-200 active:scale-95 transition" id="btn-view-all">Открыть все</button>
</div>
<div className="space-y-3">

<div className="relative group overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/5">
<img alt="Фото 1" className="h-56 w-full object-cover" src="https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?q=80&w=1200&auto=format&fit=crop" />
...
<button aria-label="Открыть фото" className="absolute inset-0" data-photo-index="0" data-photo-src="https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?q=80&w=1600&auto=format&fit=crop"></button>
</div>

<div className="flex gap-3 overflow-x-auto no-scrollbar">
<button className="relative shrink-0 overflow-hidden rounded-2xl ring-1 ring-white/10">
<img alt="Фото 2" className="h-24 w-36 object-cover" src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?q=80&w=800&auto=format&fit=crop" />
<span className="absolute inset-0 ring-1 ring-inset ring-white/10"></span>
<span className="sr-only">Фото 2</span>
<span className="absolute inset-0" data-photo-index="1" data-photo-src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?q=80&w=1600&auto=format&fit=crop"></span>
</button>
<button className="relative shrink-0 overflow-hidden rounded-2xl ring-1 ring-white/10">
<img alt="Фото 3" className="h-24 w-36 object-cover" src="https://images.unsplash.com/photo-1544006659-f0b21884ce1d?q=80&w=800&auto=format&fit=crop" />
<span className="absolute inset-0" data-photo-index="2" data-photo-src="https://images.unsplash.com/photo-1544006659-f0b21884ce1d?q=80&w=1600&auto=format&fit=crop"></span>
</button>
<button className="relative shrink-0 overflow-hidden rounded-2xl ring-1 ring-white/10">
<img alt="Фото 4" className="h-24 w-36 object-cover" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=800&auto=format&fit=crop" />
<span className="absolute inset-0" data-photo-index="3" data-photo-src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=1600&auto=format&fit=crop"></span>
</button>
<button className="relative shrink-0 overflow-hidden rounded-2xl ring-1 ring-white/10">
<img alt="Фото 5" className="h-24 w-36 object-cover" src="https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=800&auto=format&fit=crop" />
<span className="absolute inset-0" data-photo-index="4" data-photo-src="https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?q=80&w=1600&auto=format&fit=crop"></span>
</button>
<button className="relative shrink-0 overflow-hidden rounded-2xl ring-1 ring-white/10">
<img alt="Фото 6" className="h-24 w-36 object-cover" src="https://images.unsplash.com/photo-1511497584788-876760111969?q=80&w=800&auto=format&fit=crop" />
<span className="absolute inset-0" data-photo-index="5" data-photo-src="https://images.unsplash.com/photo-1511497584788-876760111969?q=80&w=1600&auto=format&fit=crop"></span>
</button>
</div>
</div>
</section>

<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" data-module="interests" style={{willChange: `transform, opacity, filter`}}>
...
<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" data-module="education" style={{willChange: `transform, opacity, filter`}}>
<div className="rounded-3xl ring-1 ring-white/10 bg-white/[0.02]">
<div className="p-4">
...
<svg className="lucide lucide-graduation-cap h-5 w-5 text-slate-300" data-lucide="graduation-cap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</div>
<div className="min-w-0">
...
<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" data-module="about" style={{willChange: `transform, opacity, filter`}}>
<div className="rounded-3xl ring-1 ring-white/10 bg-white/[0.02]">
<div className="p-4">
<div className="flex items-center justify-between">
...
<svg className="lucide lucide-handshake h-5 w-5" data-lucide="handshake" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
<span className="text-[14px] font-medium tracking-tight">Запросить интро</span>
</button>
<button aria-pressed="false" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white/5 px-4 py-3 ring-1 ring-white/10 hover:bg-white/10 active:scale-95 transition" id="btn-like">
<svg className="lucide lucide-heart h-5 w-5 text-slate-200" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" hidden="" id="minimal-note" style={{willChange: `transform, opacity, filter`}}>
<div className="rounded-2xl ring-1 ring-white/10 bg-white/[0.02] p-4">
<div className="flex items-start gap-3">
<svg className="lucide lucide-lock h-5 w-5 text-slate-300 mt-0.5" data-lucide="lock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="11" rx="2" ry="2" width="18"></rect><path></path></svg>
...
<section className="mt-6 px-5 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" data-module="future" hidden="" style={{willChange: `transform, opacity, filter`}}>
<div className="rounded-3xl ring-1 ring-white/10 bg-white/[0.02] p-4">
<div className="flex items-center justify-between">
...
<nav className="absolute inset-x-0 bottom-0 z-50 opacity-0 translate-y-3 blur-sm transition duration-500 ease-out" style={{willChange: `transform, opacity, filter`}}>
...
<svg className="lucide lucide-sparkle h-6 w-6" data-lucide="sparkle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<svg className="lucide lucide-x h-6 w-6 text-white" data-lucide="x" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
...
<div className="absolute left-1/2 bottom-24 -translate-x-1/2 rounded-full bg-white/10 text-slate-100 text-[12px] px-3 py-1.5 ring-1 ring-white/15 backdrop-blur pointer-events-none transition opacity-0 translate-y-2" id="toast">Полный профиль</div></div>
</div>
</div>

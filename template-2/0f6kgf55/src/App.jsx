...
<div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-darkSecondary opacity-70 hover:opacity-100 transition-all duration-300 cursor-pointer hover:scale-110 wow animate__animated animate__fadeIn" data-wow-delay="1.5s" data-wow-duration="1s" onClick={(e) => { scrollToNextSection() }}>

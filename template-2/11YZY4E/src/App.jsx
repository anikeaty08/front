...
<template id="video-card-template"><div className="absolute inset-0 w-full h-full flex flex-col justify-end items-stretch pointer-events-auto transition-all duration-500"><div className="relative w-full h-full rounded-3xl overflow-hidden video-shadow border border-neutral-800 video-gradient"><video className="object-cover w-full h-full absolute top-0 left-0" loop muted playsInline preload="auto"></video><div className="absolute bottom-0 left-0 right-0 p-5 pb-6 z-10 flex flex-row justify-between items-end gap-5 pointer-events-none"><div><div className="flex flex-row gap-3 items-center mb-1"><img className="w-9 h-9 rounded-full avatar-outline pointer-events-auto" /><span className="font-semibold text-lg tracking-tight"></span><button className="ml-2 px-3 py-1 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 text-xs font-medium text-white shadow-md hover:scale-105 transition pointer-events-auto"></button></div><p className="text-md md:text-lg font-normal text-neutral-100 mb-1 max-w-[70vw] md:max-w-[300px] pointer-events-auto"></p><div className="flex gap-2 text-sm text-neutral-400 pointer-events-auto"><span className="hashtag"></span><span className="hashtag"></span><span className="hashtag"></span></div></div><div className="flex flex-col gap-4 items-center pointer-events-auto"><button className="video-action flex flex-col items-center group" title="Like"><svg className="mb-1 group-hover:stroke-blue-400" fill="none" height="32" stroke="currentColor" width="32"><use href="#lucide-heart"></use></svg><span className="text-xs"></span></button><button className="video-action flex flex-col items-center group" title="Comment"><svg className="mb-1 group-hover:stroke-blue-400" fill="none" height="32" stroke="currentColor" width="32"><use href="#lucide-message-circle"></use></svg><span className="text-xs"></span></button><button className="video-action flex flex-col items-center group" title="Share"><svg className="mb-1 group-hover:stroke-blue-400" fill="none" height="32" stroke="currentColor" width="32"><use href="#lucide-share-2"></use></svg><span className="text-xs"></span></button></div></div></div></div></template>

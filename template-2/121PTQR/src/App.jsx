...
<svg className="lucide lucide-info w-[16px] h-[16px] cursor-pointer text-slate-500" data-icon-replaced="true" data-lucide="info" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" style={{width: `16px`, height: `16px`, color: `rgb(100, 116, 139)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path><path></path></svg>
...
<svg className="lucide lucide-info w-[16px] h-[16px] cursor-pointer text-slate-500" data-lucide="" fill="none" height="16" stroke="currentColor" stroke-line="round" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12"></circle><path></path><path></path></svg>
...
<svg className="lucide lucide-building-2 h-4 w-4 text-slate-600" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</span>
<div className="">
...
<a className="sm:inline-flex items-center gap-2 text-[12px] hover:bg-[#095EC4] font-medium text-white bg-[#0A6EE7] rounded-lg pt-1 pr-1.5 pb-1 pl-1.5" href="https://aura.build/share/URKMA1N" role="button">ดูข้อมูล</a>
</div>
...
</div><div className="h-px w-full bg-black/10 hidden sm:block"></div>
...
<svg className="lucide lucide-badge-check h-4 w-4 text-slate-600" data-lucide="badge-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
<div className="">
<div className="text-xs text-slate-600">ตราสารหนี้เอกชน</div>
...
<svg className="lucide lucide-user-plus h-4 w-4" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="9" cy="7"></circle><line></line><line></line></svg>
              เปิดบัญชี
            </a>
...
<svg className="lucide lucide-message-circle h-4 w-4" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
              คุยกับทีมงาน
            </a>
</div>
</div>

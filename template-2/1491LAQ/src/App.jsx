...
<button className="inline-flex items-center gap-1.5 px-2.5 h-8 rounded-md bg-neutral-900 text-[12px] text-neutral-200 hover:bg-neutral-800 shadow-sm ring-1 ring-neutral-800" onClick={(e) => { document.querySelector('#search-input').focus() }}>

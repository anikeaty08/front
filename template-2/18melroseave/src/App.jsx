...
<button className="bg-white text-black px-6 py-3 rounded-lg font-medium hover:bg-neutral-200 transition-all flex items-center gap-2 text-sm" onClick={(e) => { document.getElementById('inquire').scrollIntoView({behavior: 'smooth'}) }}>
                        Schedule Tour
                        <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
</button>
<button className="px-6 py-3 rounded-lg font-medium border border-white/10 hover:bg-white/5 transition-all text-white text-sm" onClick={(e) => { document.getElementById('gallery').scrollIntoView({behavior: 'smooth'}) }}>
                        View Photos
                    </button>
</div>
</div>

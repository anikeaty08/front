...
<template id="kpiTemplate"><div className="group rounded-xl bg-white/70 backdrop-blur ring-1 ring-gray-200 p-6 shadow-sm transition hover:-translate-y-1 hover:ring-gray-300"><p className="text-[11px] uppercase text-gray-500 mb-1 kpi-title"></p><h2 className="text-2xl font-semibold kpi-value"></h2><p className="text-xs text-gray-500 mt-1 kpi-sub"></p></div></template>

...
<div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=60 height=60 viewBox=0 0 60 xmlns=http://www.w3.org/2000/svg%3E%3Cg fill=none fill-rule=evenodd fill-opacity=0.03%3E%3Ccircle cx=30 cy=30 r=1/%3E%3C/g%3E%3C/svg%3E')] opacity-50 bg-[url(https://images.unsplash.com/photo-1678581231067-644dddeca6dc?w=2160&q=80)] bg-cover"></div>

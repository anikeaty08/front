...
<img alt="Architecture" className="w-full h-full object-cover smooth-transition duration-700" src="/assets/70426dad-3f33-4dea-a151-4dda47043b18_1600w.png" />
</div>
...
<article className="group cursor-pointer flex flex-col image-zoom">
<div className="relative w-full aspect-[4/3] overflow-hidden rounded-xl bg-gray-100 mb-5">
<img alt="Investing" className="smooth-transition duration-700 w-full h-full object-cover" src="/assets/800w.jpg" />
<div className="text-[10px] sm:text-xs uppercase font-medium text-[#171717] tracking-[0.1em] bg-white/95 border-gray-200/50 border rounded-lg pt-1.5 pr-3 pb-1.5 pl-3 absolute top-4 left-4 shadow-sm backdrop-blur-md">
                Investing
            </div>
</div>
...
<article className="group cursor-pointer flex flex-col image-zoom">
<div className="relative w-full aspect-[4/3] overflow-hidden rounded-xl bg-gray-100 mb-5">
<img alt="Diversification" className="smooth-transition duration-700 w-full h-full object-cover" src="/assets/f8f2e308-3a78-44ba-ad9b-3f23f5863b94_800w.webp" />
<div className="text-[10px] sm:text-xs uppercase font-medium text-[#171717] tracking-[0.1em] bg-white/95 border-gray-200/50 border rounded-lg pt-1.5 pr-3 pb-1.5 pl-3 absolute top-4 left-4 shadow-sm backdrop-blur-md">
                Diversification
            </div>
</div>
...
<button aria-expanded="false" className="faq-button w-full py-6 flex justify-between items-center focus:outline-none text-left group" onClick={(e) => { toggleFAQ(e.currentTarget) }}>
...
<div className="border-b border-gray-100">
<button aria-expanded="false" className="faq-button flex focus:outline-none group text-left w-full pt-6 pb-6 items-center justify-between" onClick={(e) => { toggleFAQ(e.currentTarget) }}>
...
<iconify-icon className="faq-icon text-gray-400 group-hover:text-gray-900" icon="solar:alt-arrow-down-linear" strokeWidth="1.5" width="20"></iconify-icon>
</button><button aria-expanded="false" className="faq-button flex focus:outline-none group text-left w-full pt-6 pb-6 items-center justify-between" onClick={(e) => { toggleFAQ(e.currentTarget) }}>

...
<path clip-rule="evenodd" d="M12 24C12 18.4772 16.4772 14 22 14H24C29.5228 14 34 18.4772 34 24V30C34 32.2091 32.2091 34 30 34H26C24.8954 34 24 34.8954 24 36V38C24 40.2091 22.2091 42 20 42H16C13.7909 42 12 40.2091 12 38V24ZM16 26C15.4477 26 15 26.4477 15 27V38C15 38.5523 15.4477 39 16 39H20C20.5523 39 21 38.5523 21 38V36C21 33.2386 23.2386 31 26 31H30C30.5523 31 31 30.5523 31 30V24C31 20.134 27.866 17 24 17H22C18.134 17 15 20.134 15 24H16V26Z" fill="currentColor" fillRule="evenodd"></path>

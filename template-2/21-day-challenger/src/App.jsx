...
<a className="text-xs font-medium text-neutral-400 hover:text-white transition-colors" href="#join">
                ACCESS PORTAL
            </a>
</div>
</nav>
...
<h3 className="text-2xl text-white font-medium tracking-tight">Who needs a reset?</h3>
</div>
...
<p>
                        Most "advanced" programs add volume. They tell you to do more work. But if your systemic recovery is tapped out, more work just digs a deeper hole.
                    </p>
<p>
...
<section className="py-24 bg-neutral-900/30 border-b border-white/5">
...
<h2 className="text-3xl text-white font-medium tracking-tight mt-4">The Challenger Architecture</h2>
</div>
...
<h3 className="text-white font-medium text-lg mb-2">Reset</h3>
...
<h3 className="text-white font-medium text-lg mb-2">Contrast</h3>
<p className="text-xs font-mono text-neutral-500 mb-4 uppercase">Days 8-14</p>
<p className="text-sm text-neutral-400">
                        Introduction of isometric constraints. Tempo manipulation. High neural drive, low mechanical damage. Waking up the motor units without frying the system.
                    </p>
</div>
...
<p className="text-sm text-neutral-400">
                        Reintegration of compound lifts with new rules. The "Game Layer" is applied. You aren't just lifting; you are executing specific missions.
                    </p>
</div>
</div>
</div>
...
<span className="text-sm text-neutral-500" style={{}}>/ (for 1st time users)</span>
</div>
...
<button className="hover:bg-neutral-200 transition-all flex gap-2 group cursor-pointer font-medium text-neutral-950 bg-white w-full h-11 rounded gap-x-2 gap-y-2 items-center justify-center" onClick={(e) => { window.location.href='https://challengers-by-badoni.kit.com/6ca9f5daf4';window.location.href='https://challengers-by-badoni.kit.com/6ca9f5daf4' }} role="button">Gain Access</button>

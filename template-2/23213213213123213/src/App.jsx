...
<img alt="Wine Bottle" className="h-full object-contain grayscale-[30%] group-hover:grayscale-0 group-hover:-translate-y-2 transition-all duration-500 drop-shadow-2xl" src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" />
</div>
...
<div className="h-64 w-full flex items-center justify-center mb-8 relative">
<div className="absolute inset-0 bg-gradient-to-t from-neutral-900/40 to-transparent rounded-full blur-xl transform translate-y-8 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<img alt="Wine Bottle" className="h-full object-contain grayscale-[30%] group-hover:grayscale-0 group-hover:-translate-y-2 transition-all duration-500 drop-shadow-2xl" src="/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg" />
</div>
<div className="mt-auto">
<div className="flex items-baseline justify-between mb-1">
...
<div className="h-64 w-full flex items-center justify-center mb-8 relative">
<div className="absolute inset-0 bg-gradient-to-t from-neutral-900/40 to-transparent rounded-full blur-xl transform translate-y-8 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<img alt="Wine Bottle" className="h-full object-contain grayscale-[30%] group-hover:grayscale-0 group-hover:-translate-y-2 transition-all duration-500 drop-shadow-2xl" src="/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg" />
</div>
<div className="mt-auto">
<div className="flex items-baseline justify-between mb-1">
...
<div className="h-64 w-full flex items-center justify-center mb-8 relative">
<div className="absolute inset-0 bg-gradient-to-t from-neutral-900/40 to-transparent rounded-full blur-xl transform translate-y-8 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<img alt="Wine Bottle" className="h-full object-contain grayscale-[30%] group-hover:grayscale-0 group-hover:-translate-y-2 transition-all duration-500 drop-shadow-2xl" src="/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp" />
</div>
<div className="mt-auto">
<div className="flex items-baseline justify-between mb-1">
...
<img className="h-full object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform duration-700" src="/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp" />
</div>
...
<img className="h-full object-contain grayscale contrast-125" src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" />
</div>
<div className="text-center">

...
<div className="flex items-center gap-2">
<i className="h-4 w-4 text-emerald-600" data-lucide="shield-check" data-stroke-width="1.5"></i>
<span>Dados criptografados</span>
</div>
<div className="flex items-center gap-2">
<i className="h-4 w-4 text-blue-600" data-lucide="pie-chart" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4" data-lucide="log-in" data-stroke-width="1.5"></i>
                      Entrar
                    </button>
</div>
<div className="flex items-center gap-3">
...
<i className="h-4 w-4" data-lucide="sparkles" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4" data-lucide="panel-left-close" data-stroke-width="1.5"></i>
</button>
</div>
...
<i className="h-4 w-4 text-neutral-500 group-hover:text-neutral-900" data-lucide="layout-dashboard" data-stroke-width="1.5"></i>
<span>Dashboard</span>
</button>
...
<i className="h-4 w-4 text-neutral-500 group-hover:text-neutral-900" data-lucide="building-2" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4 text-neutral-500 group-hover:text-neutral-900" data-lucide="bar-chart-3" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4 text-neutral-500 group-hover:text-neutral-900" data-lucide="settings" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4 text-neutral-500 group-hover:text-neutral-900" data-lucide="log-out" data-stroke-width="1.5"></i>
<span>Sair</span>
</button>
</nav>
...
<i className="h-5 w-5" data-lucide="panel-left-open" data-stroke-width="1.5"></i>
</button>
...
<div className="relative">
<i className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-400" data-lucide="search" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4 text-neutral-500" data-lucide="calendar" data-stroke-width="1.5"></i>
...
<i className="h-5 w-5" data-lucide="bell" data-stroke-width="1.5"></i>
</button>
...
<i className="h-4 w-4 text-neutral-500" data-lucide="wallet" data-stroke-width="1.5"></i>
</div>
...
<i className="h-4 w-4 text-neutral-500" data-lucide="percent" data-stroke-width="1.5"></i>
</div>
<div className="mt-2 flex items-baseline gap-2">
...
<i className="h-4 w-4 text-neutral-500" data-lucide="trending-up" data-stroke-width="1.5"></i>
</div>
<div className="mt-2 flex items-baseline gap-2">
...
<i className="h-4 w-4 text-neutral-500" data-lucide="buildings" data-stroke-width="1.5"></i>
</div>
<div className="mt-2 flex items-baseline gap-2">
...
<i className="h-3.5 w-3.5" data-lucide="waves" data-stroke-width="1.5"></i>
                          Área
                        </button>
...
<i className="h-3.5 w-3.5" data-lucide="line-chart" data-stroke-width="1.5"></i>
                          Linhas
                        </button>
</div>
</div>
...
<i className="h-4 w-4 text-neutral-500" data-lucide="circle-equal" data-stroke-width="1.5"></i>
</div>
...
<i className="h-4 w-4 text-neutral-500" data-lucide="building" data-stroke-width="1.5"></i>
</div>
<div className="mt-2 flex items-end gap-2">
...
<i className="h-4 w-4 text-neutral-500" data-lucide="banknote" data-stroke-width="1.5"></i>
</div>
<div className="mt-2 flex items-end gap-2">
...
<div className="flex items-center gap-2">
<div className="hidden sm:flex items-center gap-2">
<i className="h-4 w-4 text-neutral-500" data-lucide="filter" data-stroke-width="1.5"></i>
...
<i className="h-4 w-4" data-lucide="plus" data-stroke-width="1.5"></i>
                      Nova propriedade
                    </button>
</div>
</div>
...
<i className="h-4 w-4" data-lucide="download" data-stroke-width="1.5"></i>
                      Exportar CSV
                    </button>
...
<i className="h-4 w-4" data-lucide="file-text" data-stroke-width="1.5"></i>
                      Gerar PDF
                    </button>
</div>
</div>
...
<i className="h-5 w-5 text-neutral-600" data-lucide="x" data-stroke-width="1.5"></i>
</button>
</div>

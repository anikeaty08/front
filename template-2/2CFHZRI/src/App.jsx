...
<div className="fixed inset-0 bg-center bg-cover -z-10" style={{backgroundImage: `url('https://images.unsplash.com/photo-1660513924321-d9142645a41d?w=3840&q=80')`}}></div>

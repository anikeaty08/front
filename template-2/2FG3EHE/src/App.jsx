...
<div className="absolute inset-0" style={{backgroundImage: `radial-gradient(80rem 40rem at 20% 10%, rgba(99,102,241,0.08), transparent 60%),
...
<div className="absolute inset-0 opacity-[0.08] mix-blend-screen" style={{backgroundImage: `linear-gradient(transparent 0, rgba(255,255,255,0.06) 1px, transparent 1px),
          linear-gradient(90deg, transparent 0, rgba(255,255,255,0.06) 1px, transparent 1px)`, backgroundSize: `24px 24px, 24px 24px`}}>
</div>

<div className="absolute inset-0 opacity-[0.07]" style={{backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='.9' numOctaves='2' stitchTiles='stitch'/></filter><rect width='100%' height='100%' filter='url(%23n)' opacity='.35'/></svg>')`, backgroundSize: `cover`}}></div>
</div>
...
<div className="pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity group-hover:opacity-100" style={{background: `radial-gradient(60rem 30rem at 20% -10%, rgba(99,102,241,0.08), transparent 50%),
                          radial-gradient(40rem 20rem at 90% 0%, rgba(34,197,94,0.06), transparent 50%)`}}></div>

...
<button className="flex items-center gap-2 group" id="nav-logo" onClick={(e) => { navigate('page-landing') }}>
...
<button className="w-full text-left text-sm px-3 py-2 rounded-md hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3AB795]" onClick={(e) => { navigate('page-settings') }}>Settings</button>
...
<div className="mt-4 flex flex-wrap items-center gap-3">
<button className="copy-btn h-10 px-3 rounded-lg bg-white/70 border border-slate-300/90 text-slate-700 text-sm hover:bg-white inline-flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3AB795]" data-code="<label for=&quot;email&quot;>Email</label>
...
/* Labels */
label[for=&quot;email&quot;],label[for=&quot;name&quot;]{display:inline-block;margin-bottom:.25rem}

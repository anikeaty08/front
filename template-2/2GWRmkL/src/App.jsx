...
<h1 className="text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 text-white">
          Transform Ideas with Cognitive Intelligence
        </h1>
...
<i className="fas fa-play text-xs mr-2"></i> Watch Demo
          </a>
</div>
...
<span className="ml-3 text-white text-lg">Neural Model</span>
</div>
...
<i className="fas fa-network-wired text-4xl text-white/50"></i>
</div>
</div>
<div className="mt-4 h-2 bg-white/10 rounded-full overflow-hidden">
<div className="h-full w-3/4 bg-white rounded-full"></div>
</div>
<div className="mt-2 text-xs text-white/70 text-right">Processing: 75%</div>
</div>
</div>
...
<span className="text-white text-sm">Model Performance</span>
...
<div className="text-white text-sm mb-2">Accuracy</div>

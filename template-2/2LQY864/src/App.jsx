...
<button aria-label="Toggle dark mode" className="ml-2 p-2 rounded-full hover:bg-[--muted]" onClick={(e) => { toggleDark() }}>
...
<button aria-label="Toggle dark mode" className="py-2" onClick={(e) => { toggleDark() }}>🌗 Toggle Dark</button>
</div>
</div>
...
<button aria-label="Prev" className="w-10 h-10 rounded-full bg-[--muted] hover:bg-[--primary]/20 flex items-center justify-center" onClick={(e) => { testimonialNav(-1) }}><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7"></path></svg></button>
<button aria-label="Next" className="w-10 h-10 rounded-full bg-[--muted] hover:bg-[--primary]/20 flex items-center justify-center" onClick={(e) => { testimonialNav(1) }}><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"></path></svg></button>
</div>
...
<button aria-label="Live Chat" className="fixed bottom-6 right-6 z-50 bg-[--primary] text-[--primary-foreground] rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:bg-[--accent] transition" onClick={(e) => { showChat() }}>
...
<button aria-label="Close" className="text-2xl leading-none" onClick={(e) => { showChat() }}>×</button>
</div>
<div className="flex-1 px-4 py-3 overflow-y-auto h-40 text-sm" id="chatArea"></div>
<form className="flex border-t border-[--muted]" onSubmit={(e) => { sendChat(event) }}>

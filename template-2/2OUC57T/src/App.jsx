...
<a className="inline-flex items-center space-x-2 text-yellow-400 hover:text-yellow-300 transition-colors" href="#" onClick={(e) => { downloadSponsorshipPacket() }}>
...
<li><a className="hover:text-yellow-400 transition-colors" href="#tickets">Buy Tickets</a></li>
<li><a className="hover:text-yellow-400 transition-colors" href="#raffle">Car Raffle</a></li>

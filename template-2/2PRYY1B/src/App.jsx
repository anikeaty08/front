...
<div className="absolute inset-0 -z-20" data-parallax="" style={{backgroundImage: `url('https://images.unsplash.com/photo-1514190051471-5fcec2bf3433?auto=format&fit=crop&w=1400&q=80')`}}>
</div>
...
<footer className="py-10 px-6 md:px-12 text-center text-sm textlate-500 fade-up">
    ...
     · 
    {"<"} href="#" class="hover:text-orange-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"{">"}Terms

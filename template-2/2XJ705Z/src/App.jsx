...
<button className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg w-full" onClick={(e) => { toggleSubmenu('picks') }}>
...
<div className="space-y-1">
<button className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg w-full" onClick={(e) => { toggleSubmenu('directory') }}>

...
<button className="w-full inline-flex justify-center items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg px-4 py-3 transition" onClick={(e) => { next() }} type="button">
...
<div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-6 cursor-pointer hover:border-indigo-400 transition" onClick={(e) => { document.getElementById('file').click() }}>
...
<input accept="image/*,application/pdf" className="hidden" id="file" onChange={(e) => { markUploaded() }} type="file" />
<span className="mt-2 text-sm text-indigo-600 font-medium hidden" id="fileName"></span>
</div>
</div>
<div className="flex justify-between">
<button className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 transition" onClick={(e) => { prev() }} type="button">
<i className="w-4 h-4" data-lucide="arrow-left"></i>Kembali
        </button>
<button className="inline-flex justify-center items-center gap-2 bg-indigo-600 text-white font-medium rounded-lg px-5 py-3 opacity-40 cursor-not-allowed transition" disabled id="submitBtn" onClick={(e) => { next() }} type="button">

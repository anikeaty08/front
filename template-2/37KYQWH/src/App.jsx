...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group" onClick={(e) => { showModal('outline') }}>
...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group" onClick={(e) => { showModal('draft') }}>
...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group" onClick={(e) => { showModal('cover') }}>
...
<button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 rounded-xl font-medium transition-colors" onClick={(e) => { showModal('pricing') }}>Start Free</button>
</div>
...
<button className="w-full bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white py-3 rounded-xl font-medium transition-all" onClick={(e) => { showModal('pricing') }}>Start Free Trial</button>
</div>
...
<button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 rounded-xl font-medium transition-colors" onClick={(e) => { showModal('pricing') }}>Upgrade Now</button>
</div>
</div>
</div>
</section>
...
<button className="text-gray-400 hover:text-gray-600" onClick={(e) => { hideModal('outline') }}>
...
<button className="text-gray-400 hover:text-gray-600" onClick={(e) => { hideModal('draft') }}>
<i className="w-6 h-6" data-lucide="x" strokeWidth="1.5"></i>
</button>
</div>
<form className="space-y-6">
...
<button className="text-gray-400 hover:text-gray-600" onClick={(e) => { hideModal('cover') }}>
<i className="w-6 h-6" data-lucide="x" strokeWidth="1.5"></i>
</button>
</div>
<form className="space-y-6">
...
<button className="text-gray-400 hover:text-gray-600" onClick={(e) => { hideModal('pricing') }}>
<i className="w-6 h-6" data-lucide="x" strokeWidth="1.5"></i>
</button>
</div>
<form className="space-y-6">
...
<button className="bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105" onClick={(e) => { showModal('pricing') }}>

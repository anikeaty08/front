...
<div className="fixed inset-0 pointer-events-none" style={{backgroundImage: `radial-gradient(1200px 600px at -10% -20%, rgba(16,185,129,0.08), transparent 60%),
...
<div className="w-full max-w-7xl ring-1 ring-white/10 shadow-black/40 bg-white/5 bg-[url(/assets/7aa2a7af-86ba-4dbe-8883-bb3e87b1612a_1600w.jpg)] bg-cover rounded-3xl pt-10 pr-10 pb-10 pl-10 shadow-2xl backdrop-blur-sm" style={{animation: `fadeUp .7s ease forwards`, animationDelay: `.12s`}}>
...
<div className="h-8 w-8 ring-1 ring-emerald-400/20 flex bg-emerald-400/10 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7de1229a-6a54-423d-a41c-2377d871bf2c_320w.jpg)] bg-cover rounded-lg items-center justify-center">
</div>
...
<img alt="Abstract portrait with motion blur" className="absolute inset-0 h-full w-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/72135b5e-1c8d-4f99-847a-22565c937cae_1600w.jpg" />
...
<img alt="Member avatar" className="h-8 w-8 rounded-full ring-2 ring-white/30 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5197b21a-36b8-435c-84f0-e109840e65ca_800w.jpg" />
...
<div className="mt-4 flex items-center gap-3">
<img alt="Member avatar" className="h-8 w-8 rounded-full ring-2 ring-white/30 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a37efc45-155a-4527-9242-07aecb87e958_320w.jpg" />
<div className="text-sm">
...
<div className="mt-4 flex items-center gap-3">
<img alt="Member avatar" className="h-8 w-8 rounded-full ring-2 ring-white/30 object-cover" src="/assets/05e3e53f-e4cc-4941-8fa1-f22b5b9379f1_800w.jpg" />
<div className="text-sm">

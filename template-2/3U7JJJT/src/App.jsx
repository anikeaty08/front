...
<template id="productCardTpl"><article className="bg-white border border-slate-100 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow"><div className="flex items-start justify-between"><div><div className="text-xs text-slate-500 product-category"></div><h3 className="mt-1 text-lg font-semibold text-slate-900 product-title"></h3></div><div className="text-right"><div className="text-sm font-medium text-slate-800 product-price"></div><div className="text-xs text-slate-500 product-tag"></div></div></div><p className="mt-3 text-sm text-slate-600 product-desc"></p><div className="mt-4 flex items-center justify-between"><div className="flex items-center gap-3"><button className="px-3 py-1 text-sm rounded border border-slate-200 hover:bg-slate-50"></button><button className="px-3 py-1 text-sm rounded bg-amber-50 text-amber-700 border border-amber-100"></button></div><button className="px-3 py-1 rounded bg-sky-600 text-white text-sm hover:bg-sky-700 buyBtn"></button></div></article></template>

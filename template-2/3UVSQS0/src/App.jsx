...
<div className="relative w-full max-w-6xl md:p-16 ring-1 ring-white/10 bg-[url(/assets/30eeab2d-e97c-4b45-b740-6695c7862813_1600w.jpg)] bg-cover rounded-3xl mr-4 ml-4 pt-8 pr-8 pb-8 pl-8 shadow-2xl backdrop-blur-xl">
...
</section><meta charset="utf-8" /><meta content="width=device-width, initial-scale=1.0" name="viewport" /><title>Pricing, Testimonials & FAQ</title><section className="py-20 border-t border-white/10">
<div className="mx-auto max-w-7xl px-4 md:px-8">
<div className="text-center mb-16">
...
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(1) }}>
...
<div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(2) }}>
...
<div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(3) }}>
...
<div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(4) }}>
...
<div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(5) }}>
...
<div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
<button className="w-full text-left p-6 hover:bg-white/5 transition-colors flex items-center justify-between" onClick={(e) => { toggleFAQ(6) }}>

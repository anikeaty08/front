...
<img alt="CleanGod spray" className="w-20 h-28 object-cover rounded-lg shadow-lg ring-1 ring-slate-100 bg-white" src="https://images.unsplash.com/photo-1585386959984-a4155229e1f9?q=80&w=400&auto=format&fit=crop&ixlib=rb-4.0.3&s=8b6e7f1b04d4b9b9f2b6bdf0a6b6a06a" /></div>
</div>

...
<span className="text-xs sm:text-sm tracking-tight text-neutral-300">LOCAL/ <span className="tabular-nums" id="localTime">22:44:26</span></span>
</div>
<div className="hidden sm:flex items-center gap-2 text-neutral-400">
<svg aria-hidden="true" className="lucide lucide-grip-horizontal w-4 h-4" data-lucide="grip-horizontal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="9" r="1"></circle><circle cx="19" cy="9" r="1"></circle><circle cx="5" cy="9" r="1"></circle><circle cx="12" cy="15" r="1"></circle><circle cx="19" cy="15" r="1"></circle><circle cx="5" cy="15" r="1"></circle></svg>
</div>
<a className="group inline-flex items-center gap-2 hover:bg-white/10 text-sm font-medium text-white tracking-tight bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-4 pb-2 pl-4" href="#contact">
...
<section className="sm:px-6 max-w-7xl mr-auto ml-auto pr-4 pl-4">
<div className="relative mt-10 sm:mt-16">
<h1 className="leading-none select-none text-white tracking-tight">
<span className="block text-[22vw] md:text-[16vw] xl:text-[12vw] 2xl:text-[10vw] -translate-x-1 font-normal font-instrument-serif scale-75" style={{overflow: `hidden`, maskImage: `linear-gradient(70deg, transparent, black 0%, black 100%, transparent)`, webkitMaskImage: `linear-gradient(70deg, transparent, black 0%, black 100%, transparent)`}}>Comera Latitude Travel and Tourism LLC</span>
</h1>
...
<div className="border-t border-white/10 pt-5">
<div className="flex items-start gap-3">
<svg aria-hidden="true" className="lucide lucide-cpu w-5 h-5 text-indigo-400 mt-0.5" data-lucide="cpu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 20v2"></path><path d="M12 2v2"></path><path d="M17 20v2"></path><path d="M17 2v2"></path><path d="M2 12h2"></path><path d="M2 17h2"></path><path d="M2 7h2"></path><path d="M20 12h2"></path><path d="M20 17h2"></path><path d="M20 7h2"></path><path d="M7 20v2"></path><path d="M7 2v2"></path><rect height="16" rx="2" width="16" x="4" y="4"></rect><rect height="8" rx="1" width="8" x="8" y="8"></rect></svg>
<div className="">
...
<img alt="Portrait with bold red lighting" className="w-full h-[52vh] sm:h-[60vh] object-cover" loading="eager" src="/assets/c00ff13b-bcc2-4ddd-a8bc-13bd3da53a81_1600w.jpg" />
</div>
</div>
</div>
</section>
...
<img alt="Comera Latitude Travel and Tourism LLC Logo" className="transition-transform duration-500 group-hover:scale-[1.03] cursor-pointer w-full h-full object-contain pt-6 pr-6 pb-6 pl-6 absolute top-0 right-0 bottom-0 left-0" onClick={(e) => { window.location.href='https://photos.google.com/photo/AF1QipPcXkkbB8UdF2vet7GuvP5Ww6yOJ9opBmzJkXui' }} role="button" src="https://www.aura.build/editor/LOGOWE.png" />
</div>
<div className="p-4">
<div className="flex items-center gap-2 text-xs text-neutral-400">
<svg aria-hidden="true" className="lucide lucide-box w-4 h-4" data-lucide="box" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"></path><path d="m3.3 7 8.7 5 8.7-5"></path><path d="M12 22V12"></path></svg>
<span>3D System</span>
</div>
...
<article className="group rounded-xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<div className="relative aspect-[16/10]">
<img alt="Man in black leather coat walking in city with luxury cars" className="transition-transform duration-500 group-hover:scale-[1.03] w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://www.aura.build/editor/Change_the_clothes_of_this_person_and_make_him_loo_delpmaspu%20(3).png" />
</div>
<div className="p-4">
<div className="flex items-center gap-2 text-xs text-neutral-400">
<svg aria-hidden="true" className="lucide lucide-mountain w-4 h-4" data-lucide="mountain" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m8 3 4 8 5-5 5 15H2L8 3z"></path></svg>
...
<article className="group rounded-xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<div className="relative aspect-[16/10]">
<img alt="Minimal ocean scene" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="/assets/166b473a-a637-42d7-92a0-a1c7325e07cc_800w.jpg" />
</div>
<div className="p-4">
<div className="flex items-center gap-2 text-xs text-neutral-400">
...
<img alt="Portrait side profile with dramatic lighting" className="absolute inset-0 w-full h-full object-cover" src="/assets/102e9e77-7a32-4330-92f4-d2149285c86b_1600w.jpg" />
...
<svg aria-hidden="true" className="lucide lucide-check w-3.5 h-3.5 mt-0.5 text-emerald-400" data-lucide="check" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<img alt="Brand stationery set with bold colors" className="w-full h-full object-cover" src="/assets/b870108f-3551-40b3-bb97-ae4fc783d1df_320w.jpg" />
</div>
<div className="aspect-[4/3] w-24 sm:w-28 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Business cards and patterns" className="w-full h-full object-cover" src="/assets/4d5175fe-2aa3-4ef3-8a6f-44a752f57930_320w.jpg" />
</div>
<div className="aspect-[4/3] w-24 sm:w-28 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Stationery mockups on yellow background" className="w-full h-full object-cover" src="/assets/2d210766-5c9f-4df0-873c-edb4557202b7_320w.jpg" />
</div>
<div className="aspect-[4/3] w-24 sm:w-28 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Colorful brand collateral" className="w-full h-full object-cover" src="/assets/781b233e-9c54-40fc-8c11-186d4ce76914_320w.jpg" />
</div>
</div>
</div>
...
<img alt="Workshop desk" className="w-full h-full object-cover grayscale" src="/assets/7c7c0abe-b3bf-4f26-92a0-126405775d17_320w.jpg" />
</div>
<div className="aspect-[16/10] w-28 sm:w-32 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Strategy notes and artifacts" className="w-full h-full object-cover grayscale" src="/assets/1c79362c-952e-4a16-b043-e48fb1f55728_320w.jpg" />
</div>
</div>
</div>
<div className="md:col-span-3 md:text-right">
...
<img alt="Designing interface on laptop" className="w-full h-full object-cover" src="/assets/237ae1f5-edc0-48a4-bb60-1eb41e314e05_320w.jpg" />
</div>
<div className="aspect-[16/10] w-32 sm:w-40 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Team collaborating over wireframes" className="w-full h-full object-cover" src="/assets/79fd2860-1afb-406f-b9d8-56f13319c7c7_320w.jpg" />
</div>
</div>
</div>
<div className="md:col-span-3 md:text-right">
...
<svg aria-hidden="true" className="lucide lucide-file-text w-4 h-4" data-lucide="file-text" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"></path><path d="M14 2v5a1 1 0 0 0 1 1h5"></path><path d="M10 9H8"></path><path d="M16 13H8"></path><path d="M16 17H8"></path></svg>
...
<svg aria-hidden="true" className="lucide lucide-message-square w-4 h-4" data-lucide="message-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z"></path></svg>
<span>Message</span>
</a>
</div>
</div>
</div>
<p className="mt-6 text-xs text-neutral-500">© <span id="year">2026</span> Kyro Studio</p>
</footer>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="spline-container fixed top-0 w-full h-screen -z-10" data-alpha-mask="80" style={{maskImage: `linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)`, webkitMaskImage: `linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)`}}><iframe frameborder="0" height="100%" src="https://my.spline.design/3dgradient-AcpgG6LxFkpnJSoowRHPfcbO" width="100%"></iframe></div>
...
<span className="text-xs sm:text-sm tracking-tight text-neutral-300">LOCAL/ <span className="tabular-nums" id="localTime">16:20:17</span></span>
</div>
...
<span className="" style={{display: `inline-block`, animation: `letterSlideIn 0.8s ease-out forwards`, animationDelay: `0s`, transform: `translateY(-100%)`, opacity: `0`, clipPath: `inset(0 0 100% 0)`}}>75</span>
...
<img alt="Portrait with bold red lighting" className="w-full h-[52vh] sm:h-[60vh] object-cover" loading="eager" src="/assets/25b2762f-2abb-4175-aec9-fc9ef6db44f3_1600w.png" />
</div>
</div>
</div>
</section>
...
<img alt="3D abstract render" className="transition-transform duration-500 group-hover:scale-[1.03] w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="/assets/c4e25fdd-1ad7-4b5d-8138-c0b5dbe0c9e2_800w.jpg" />
</div>
<div className="p-4">
...
<article className="group rounded-xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<div className="relative aspect-[16/10]">
<img alt="Mountain landscape" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="/assets/e0a39d5f-b50a-4023-af86-d6cd0cd2c5c6_800w.jpg" />
</div>
<div className="p-4">
<div className="flex items-center gap-2 text-xs text-neutral-400">
...
<img alt="Portrait side profile with dramatic lighting" className="absolute inset-0 w-full h-full object-cover" src="/assets/c58ec9db-9b8f-4305-8008-7df305ccd944_3840w.png" />

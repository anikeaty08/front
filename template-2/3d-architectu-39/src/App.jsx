...
<div className="select-none text-4xl md:text-6xl font-bold text-white tracking-widest uppercase flex items-center gap-1 cursor-pointer" onClick={(e) => { window.location.reload() }}>

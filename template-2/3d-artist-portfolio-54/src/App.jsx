...
<img alt="Alex Rivera" className="w-[10vw] h-[10vw] sm:w-[70px] sm:h-[70px] lg:w-[90px] lg:h-[90px] rounded-full object-cover border-2 border-white/20 shadow-2xl" src="/assets/986db8ed-1c5d-42fb-8c1d-4b3716d2e317_3840w.jpg" style={{animation: `portraitFall 1.2s cubic-bezier(0.34, 1.56, 0.64, 1) 0.8s both`}} />
            Crafting
          </span>

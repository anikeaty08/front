...
<img alt="3D Figurine Preview" className="relative z-10 w-[300px] md:w-[400px] h-[500px] object-cover mix-blend-lighten grayscale contrast-125 brightness-75 drop-shadow-2xl mask-image-gradient" src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" />
...
<img alt="Figurine" className="w-full h-full object-cover transition duration-500 group-hover:scale-105 filter grayscale group-hover:grayscale-0" src="/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg" />
...
<div className="relative group aspect-[3/4] rounded-xl overflow-hidden cursor-pointer">
<img alt="Figurine" className="w-full h-full object-cover transition duration-500 group-hover:scale-105 filter grayscale group-hover:grayscale-0" src="/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg" />
<div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80"></div>
<div className="absolute bottom-4 left-4">
...
<div className="relative group aspect-[3/4] rounded-xl overflow-hidden cursor-pointer">
<img alt="Figurine" className="w-full h-full object-cover transition duration-500 group-hover:scale-105 filter grayscale group-hover:grayscale-0" src="/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp" />
<div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80"></div>
<div className="absolute bottom-4 left-4">

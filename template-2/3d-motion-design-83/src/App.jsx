                ...
                const newData = [
                    {
                        ...
                        img: "/assets/e135f35b-eaeb-4b52-b2df-a9690249ff63_1600w.jpg"
                    },
                    {
                        id: "02",
                        sub: "Module 02",
                        ...
                        img: "/assets/16d38370-5873-45cf-bab1-60a7b923dc6e_1600w.jpg"
                    },
                    {
                        id: "03",
                        sub: "Module 03",
                        ...
                        img: "/assets/4f30f4f2-b81c-4bf1-88c7-86b1dc41acd1_1600w.jpg"
                    },
                    {
                        id: "04",
                        sub: "Deep Dive",
                        ...
                        img: "/assets/81a14d03-8b28-415a-b8d8-bf76b3206731_1600w.webp"
                    }
                ];
        ...
        (function() {
            const data = [
                ...
                },
                {
                    ...
                    title: "Cinematic Lighting<br>Essentials",
                    desc: "Understand the physical properties of light. Learn to construct studio setups, volumetric environments, and dramatic moods that elevate your renders from flat to photorealistic.",
                    img: "/assets/d3d4d588-f8cc-4129-8a9b-d0f004d15ab4_1600w.webp"
                }
            ];
...
<nav className="z-50 sticky bg-black/60 w-full border-white/5 border-b top-0 backdrop-blur-lg">
<div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
<div className="flex items-center gap-12">
<a className="inline-flex items-center justify-center bg-center w-[140px] h-[36px] bg-[url(/assets/3b763a66-5dbf-4079-af7e-a616cc333698_320w.png)] bg-cover rounded-full" href="#"></a>
<div className="hidden md:flex items-center gap-8 text-xs font-medium tracking-widest text-slate-400 uppercase">
<a className="flex items-center gap-2 text-white border-b pb-0.5 border-orange-400" href="#" style={{}}>
<iconify-icon className="text-orange-400" icon="solar:layers-minimalistic-bold-duotone"></iconify-icon>
          Curriculum
        </a>
...
<img alt="Sphere" className="opacity-90 w-full h-full object-contain rounded-full drop-shadow-2xl" src="/assets/a6add742-6a55-445d-b07d-92ef48d3c652_1600w.jpg" />
</div>
</div>
</header>

<section className="border-b border-white/5 relative z-20 bg-black/50 backdrop-blur-md">
...
<img alt="Futuristic red-lit VR headset portrait" className="transition-all duration-500 ease-out transform mix-blend-lighten w-full h-full object-cover" id="crs-img-v2" src="/assets/e135f35b-eaeb-4b52-b2df-a9690249ff63_1600w.jpg" />
...
<span className="text-xs font-medium uppercase tracking-widest mb-6 text-orange-400 block transition-all duration-300 ease-out transform" id="crs-sub">Module 01</span>
...
</section><section className="overflow-hidden bg-black border-white/5 border-b pt-24 pb-24 relative">
...
<div className="md:col-span-2 group overflow-hidden min-h-[320px] bg-black z-20 relative">
<div className="overflow-hidden z-20 w-2/3 h-full absolute top-0 right-0">
<div className="z-10 bg-gradient-to-r from-black via-black/50 to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
<img alt="Assets" className="group-hover:opacity-60 group-hover:grayscale-0 transition-all duration-700 ease-out transform group-hover:scale-105 opacity-40 w-full h-full object-cover z-20 grayscale" src="/assets/e2a6572b-2fda-41e6-833d-041a0b24681f_1600w.webp" />
</div>
...
<div className="bg-black group relative overflow-hidden min-h-[320px]">
...
<div className="md:col-span-2 bg-black group relative overflow-hidden min-h-[320px]">
...
<img alt="Abstract" className="mask-image-radial group-hover:opacity-60 group-hover:grayscale-0 transition-all duration-700 ease-out transform group-hover:scale-105 opacity-40 mix-blend-screen w-full h-full object-cover z-20 rounded-full grayscale" src="/assets/ea262fd9-14f0-4917-be69-86fd3b302ccd_800w.webp" />
</div>
...
<img alt="Mentor" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500 opacity-60 group-hover:opacity-100" src="/assets/15caab24-bf25-496e-99c0-b00f6f4de74f_1600w.webp" />
...
<div className="bg-panel p-0 group relative overflow-hidden">
<div className="aspect-[4/3] bg-slate-800 relative overflow-hidden">
<img alt="Mentor" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500 opacity-60 group-hover:opacity-100" src="/assets/4f4590c0-f760-4c47-8347-9ed5701903e6_1600w.webp" />
<div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-panel via-transparent to-transparent"></div>
</div>
...
<div className="absolute left-0 top-0 bottom-0 w-24 z-10 pointer-events-none" style={{background: `linear-gradient(to right, #000000 0%, transparent 100%)`}}></div>

<div className="absolute right-0 top-0 bottom-0 w-24 z-10 pointer-events-none" style={{background: `linear-gradient(to left, #000000 0%, transparent 100%)`}}></div>
...
<img alt="Art" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover" src="/assets/96e3ccfa-3799-4c9c-9f2a-263c0ff6a449_800w.webp" />
...
<img alt="Art" className="transition-transform duration-700 group-hover:scale-105 mix-blend-lighten w-full h-full object-cover" src="/assets/a032328b-a082-425f-8870-b5222565e31f_800w.webp" style={{}} />
...
<div className="group relative flex-shrink-0 w-full md:w-[calc(33.333%-1.33rem)]">
<div className="aspect-[4/5] bg-slate-800 overflow-hidden relative">
<img alt="Art" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" style={{}} />
...
<div className="group relative flex-shrink-0 w-full md:w-[calc(33.333%-1.33rem)]">
<div className="aspect-[4/5] bg-slate-800 overflow-hidden relative">
<img alt="Art" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover" src="/assets/448cc80c-2ef0-44f1-aa35-fb915bd39852_800w.webp" />
<div className="bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60 absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-6 left-6 right-6">
...
<div className="group relative flex-shrink-0 w-full md:w-[calc(33.333%-1.33rem)]">
<div className="aspect-[4/5] bg-slate-800 overflow-hidden relative">
<img alt="Art" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover" src="/assets/dee707e7-67d1-4c28-9ed8-e0f71b46347b_800w.webp" />
<div className="bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60 absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-6 left-6 right-6">
...
<div className="group relative flex-shrink-0 w-full md:w-[calc(33.333%-1.33rem)]">
<div className="aspect-[4/5] bg-slate-800 overflow-hidden relative">
<img alt="Art" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover" src="/assets/4d3f4658-ecfd-47b7-8318-ab5e0f7dba77_800w.webp" />
<div className="bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60 absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-6 left-6 right-6">
...
<div className="absolute top-1 bottom-1 left-1 w-32 bg-[#ffffff]/10 rounded-full shadow-lg shadow-white/5 transition-transform duration-300 ease-out z-0" id="active-pill" style={{transform: `translateX(0%)`, '--border-gradient': `linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))`, '--border-radius-before': `9999px`}}></div>
<button className="relative z-10 w-32 py-2.5 text-xs font-semibold tracking-widest uppercase text-white transition-colors duration-300" id="btn-monthly" onClick={(e) => { switchPlan('monthly') }}>
          Monthly
        </button>
<button className="relative z-10 w-32 py-2.5 text-xs font-medium tracking-widest uppercase text-slate-400 hover:text-white transition-colors duration-300" id="btn-yearly" onClick={(e) => { switchPlan('yearly') }}>
          Yearly
        </button>
</div>
</div>
...
<a className="flex items-center justify-center hover:text-white hover:border-white transition-all bg-center text-slate-400 w-10 h-10 bg-[url(/assets/e66c0296-2c66-4807-ab74-9626c9bf90ca_320w.webp)] bg-cover border-white/10 border rounded-full" href="#">
<iconify-icon icon="solar:facebook-bold" width="16"></iconify-icon>
</a>
<a className="flex items-center justify-center hover:text-white hover:border-white transition-all bg-center text-slate-400 w-10 h-10 bg-[url(/assets/c3f33b24-5083-4ed7-890e-acca5261bec4_320w.webp)] bg-cover border-white/10 border rounded-full" href="#">
<iconify-icon icon="solar:twitter-bold" width="16"></iconify-icon>
</a>
<a className="flex items-center justify-center hover:text-white hover:border-white transition-all bg-center text-slate-400 w-10 h-10 bg-[url(/assets/45346b2f-1ebf-4fd1-ad60-5f4c935b534f_320w.webp)] bg-cover border-white/10 border rounded-full" href="#">

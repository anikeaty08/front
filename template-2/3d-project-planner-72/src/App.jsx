                        ...
                        <div class="mt-auto flex items-center justify-between">
                            <div class="flex -space-x-1.5">
                                ${task.members.map(mId => {
                                    ...
                                    return `<img src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" class="w-4 h-4 rounded-full border border-surface" title="${u.name}">`;
                                }).join('')}
                            </div>
                            ...
                            ${task.members.map(mId => {
                                ...
                                return `
                                    <div class="flex items-center gap-2 bg-white/5 pl-1 pr-3 py-1 rounded-full border border-white/5">
                                        <img src="/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" class="w-5 h-5 rounded-full">
...
<div className="flex items-center gap-2" onClick={(e) => { toggle3DMode() }}>

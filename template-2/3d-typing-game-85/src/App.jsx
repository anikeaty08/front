...
<div className="flex items-center gap-4 group cursor-pointer pl-0 lg:pl-2" onClick={(e) => { location.reload() }}>
...
<button className="flex items-center gap-4 px-0 lg:px-4 py-3 rounded-xl bg-white/5 text-white border border-white/5 w-full justify-center lg:justify-start group hover:bg-brand-cyan/10 hover:border-brand-cyan/30 transition-all" onClick={(e) => { startGame() }}>
...
<button className="flex items-center gap-4 px-0 lg:px-4 py-3 rounded-xl hover:bg-white/5 text-slate-400 hover:text-white transition-all w-full justify-center lg:justify-start group" onClick={(e) => { toggleSettings() }}>
...
<path d="M32 50V20" stroke="#00F0FF" strokeOpacity="0.5" strokeWidth="1"></path>
...
<button className="group relative px-10 py-5 bg-white text-space-950 font-bold rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)]" onClick={(e) => { startGame() }}>
...
<button className="mt-4 px-8 py-3 rounded-lg border border-white/20 text-white hover:bg-white hover:text-space-950 transition-all font-medium tracking-wide w-full flex items-center justify-center gap-2 group" onClick={(e) => { startGame() }}>
...
<button className="text-slate-400 hover:text-white transition-colors" onClick={(e) => { toggleSettings() }}><iconify-icon icon="solar:close-circle-linear" width="28"></iconify-icon></button>
</div>

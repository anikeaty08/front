...
<button className="text-white/70 hover:text-white transition-colors" onClick={(e) => { toggleChat() }}>
...
<button className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-[#003865] hover:bg-slate-50 hover:border-[#F47B20]/30 transition-colors" onClick={(e) => { sendSuggestion('What services do you offer?') }}>Services</button>
<button className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-[#003865] hover:bg-slate-50 hover:border-[#F47B20]/30 transition-colors" onClick={(e) => { sendSuggestion('Do you do schools?') }}>Education Projects</button>
<button className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-[#003865] hover:bg-slate-50 hover:border-[#F47B20]/30 transition-colors" onClick={(e) => { sendSuggestion('What is Quick Ship?') }}>Quick Ship</button>
<button className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-[#003865] hover:bg-slate-50 hover:border-[#F47B20]/30 transition-colors" onClick={(e) => { sendSuggestion('Contact sales') }}>Contact</button>
</div>
</div>
...
<button className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#003865] text-white shadow-xl shadow-[#003865]/30 hover:bg-[#00284d] hover:scale-105 transition-all duration-300" id="chat-toggle-btn" onClick={(e) => { toggleChat() }}>

...
<button className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-2xl hover:from-pink-600 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center gap-2 whitespace-nowrap font-sans" onClick={(e) => { openModal() }}>
...
<button className="category-btn hover:bg-purple-600 transition-all duration-200 transform hover:scale-105 active font-medium text-white bg-purple-500 rounded-full pt-3 pr-6 pb-3 pl-6" onClick={(e) => { filterWords('all') }}>All Words</button>
<button className="category-btn hover:bg-purple-50 hover:border-purple-200 transition-all duration-200 transform hover:scale-105 font-medium rounded-full pt-3 pr-6 pb-3 pl-6 bg-white text-gray-700 border border-gray-200" onClick={(e) => { filterWords('sounds') }}>Funny Sounds</button>
<button className="category-btn px-6 py-3 rounded-full bg-white text-gray-700 border border-gray-200 font-medium hover:bg-purple-50 hover:border-purple-200 transition-all duration-200 transform hover:scale-105 font-sans" onClick={(e) => { filterWords('animals') }}>Silly Animals</button>
<button className="category-btn px-6 py-3 rounded-full bg-white text-gray-700 border border-gray-200 font-medium hover:bg-purple-50 hover:border-purple-200 transition-all duration-200 transform hover:scale-105 font-sans" onClick={(e) => { filterWords('actions') }}>Weird Actions</button>
<button className="category-btn px-6 py-3 rounded-full bg-white text-gray-700 border border-gray-200 font-medium hover:bg-purple-50 hover:border-purple-200 transition-all duration-200 transform hover:scale-105 font-sans" onClick={(e) => { filterWords('things') }}>Strange Things</button>
<button className="category-btn px-6 py-3 rounded-full bg-white text-gray-700 border border-gray-200 font-medium hover:bg-yellow-50 hover:border-yellow-200 transition-all duration-200 transform hover:scale-105 font-sans flex items-center gap-2" onClick={(e) => { filterWords('favorites') }}>
...
<button className="p-2 hover:bg-gray-100 rounded-full transition-colors" onClick={(e) => { closeModal() }}>
...
<button className="emoji-btn p-2 text-2xl hover:bg-purple-100 rounded-lg transition-colors" onClick={(e) => { selectEmoji('🤪') }} type="button">🤪</button>
<button className="emoji-btn p-2 text-2xl hover:bg-purple-100 rounded-lg transition-colors" onClick={(e) => { selectEmoji('😵‍💫') }} type="button">😵‍💫</button>
<button className="emoji-btn p-2 text-2xl hover:bg-purple-100 rounded-lg transition-colors" onClick={(e) => { selectEmoji('🎭') }} type="button">🎭</button>
<button className="emoji-btn p-2 text-2xl hover:bg-purple-100 rounded-lg transition-colors" onClick={(e) => { selectEmoji('🌀') }} type="button">🌀</button>
<button className="emoji-btn p-2 text-2xl hover:bg-purple-100 rounded-lg transition-colors" onClick={(e) => { selectEmoji('✨') }} type="button">✨</button>
...
<button className="flex-1 px-6 py-3 border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors font-medium font-sans" onClick={(e) => { closeModal() }} type="button">Cancel</button>

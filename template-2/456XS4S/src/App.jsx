...
<a className="hover:text-[#00D3E0]" href="#about" onClick={(e) => { toggleMenu() }}>About</a>
<a className="hover:text-[#00D3E0]" href="#whitepaper" onClick={(e) => { toggleMenu() }}>White Paper</a>
<a className="hover:text-[#00D3E0]" href="#join" onClick={(e) => { toggleMenu() }}>Join</a>
...
<section className="py-20 md:py-28 text-white text-center" style={{background: `#2B2B2B url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAB') repeat`}}>

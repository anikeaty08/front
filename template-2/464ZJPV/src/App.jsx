...
<a className="hidden sm:inline-flex items-center gap-2 hover:bg-white/90 transition-colors ring-1 ring-black/5 text-sm font-medium text-black bg-white rounded-full pt-2 pr-4 pb-2 pl-4" href="#">Solicitar
            Orçamento<svg className="lucide lucide-handshake lucide-fast-forward lucide-sparkles w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="handshake" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(0, 0, 0)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg></a>
...
<svg className="lucide lucide-menu w-5 h-5 text-white" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</button>
</div>
</div>
...
<a className="inline-flex items-center justify-center gap-2 hover:bg-white/90 transition-colors text-sm font-medium text-black bg-white ring-black/5 ring-1 rounded-xl pt-3 pr-5 pb-3 pl-5" href="#">Conheça
          nossas soluções<svg className="lucide lucide-image-play lucide-rocket w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="image-play" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(0, 0, 0)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="9"></circle></svg></a>
<a className="inline-flex items-center justify-center gap-2 hover:bg-white/10 transition-colors text-sm font-medium text-white bg-white/5 border-white/10 border rounded-xl pt-3 pr-5 pb-3 pl-5" href="#">Ver
          portfólio<svg className="lucide lucide-play w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg></a>
</div>
...
<svg className="lucide lucide-step-back h-5 w-5" data-icon-replaced="true" data-lucide="step-back" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<div className="mt-4">
<div className="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center text-white">
<svg className="lucide lucide-timer-reset w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="timer-reset" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</div>
...
<div className="mt-4">
<div className="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center text-white">
<svg className="lucide lucide-chevrons-left-right-ellipsis w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="chevrons-left-right-ellipsis" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
</div>
...
<div className="mt-4">
<div className="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center text-white">
<svg className="lucide lucide-camera w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="camera" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="13"></circle></svg>
</div>
...
<div className="mt-4">
<div className="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center text-white">
<svg className="lucide lucide-user-round-x w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="user-round-x" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="10" cy="8"></circle><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-arrow-right h-4 w-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
</div>
</div>
</a>
...
<div className="mb-4 flex items-center justify-between">
<div className="grid h-12 w-12 place-items-center rounded-xl bg-white/5 ring-1 ring-white/10 group-hover:ring-slate-400/30 group-hover:bg-slate-400/10 transition-all duration-300">
<svg className="lucide lucide-video group-hover:text-slate-400 group-hover:scale-110 transition-all duration-300 w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="video" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(100, 116, 139)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" rx="2" width="14"></rect></svg>
</div>
...
<div className="mb-4 flex items-center justify-between">
<div className="grid h-12 w-12 place-items-center rounded-xl bg-white/5 ring-1 ring-white/10 group-hover:ring-slate-400/30 group-hover:bg-slate-400/10 transition-all duration-300">
<svg className="lucide lucide-monitor group-hover:text-slate-400 group-hover:scale-110 transition-all duration-300 w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="monitor" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(100, 116, 139)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><line></line><line></line></svg>
</div>
...
<div className="mb-4 flex items-center justify-between">
<div className="grid h-12 w-12 place-items-center rounded-xl bg-white/5 ring-1 ring-white/10 group-hover:ring-slate-400/30 group-hover:bg-slate-400/10 transition-all duration-300">
<svg className="lucide lucide-rocket group-hover:text-slate-400 group-hover:scale-110 transition-all duration-300 w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="rocket" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(100, 116, 139)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-clock w-[12px] h-[12px]" data-lucide="clock" fill="none stroke=" height="12" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `12px`, height: `12px`, color: `#fff`}} viewBox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
<path></path>
...
<path></path><circle cx="8" cy="9"></circle><path></path><path></path>
</svg>
</div>
</div>
...
<rect height="16" rx="2" width="16"></rect><rect height="6" rx="1" width="6"></rect><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path>
</svg>
</div>
</div>
...
<svg className="lucide w-3.5 h-3.5" data-lucide="clock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg>
                    Duração: 30 segundos
                  </span>
<span className="inline-flex items-center gap-2 text-xs text-white/85 bg-white/10 ring-1 ring-white/15 rounded-full px-3 py-1">
<svg className="lucide w-3.5 h-3.5" data-lucide="monitor" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><path></path><path></path></svg>
...
<div className="flex items-center gap-2 text-sm text-slate-500">
<svg className="" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><polyline className="" points="12,6 12,12 16,14"></polyline></svg>
...
<svg className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path></path></svg>
<svg className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path></path></svg>
<svg className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path></path></svg>
<svg className="w-3 h-3 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path></path></svg>
<svg className="w-3 h-3 text-yellow-300 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path></path></svg>
</span>
</span>
</div>
...
<svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"></path></svg>
</button>
...
<svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className="" strokeLinecap="round" strokeLinejoin="round"></path></svg>
</button>
</div>
</div>
</div>
...
<img alt="Abstract minimal background" className="h-full w-full object-cover opacity-40" src="/assets/60668e31-2150-424e-b292-05bfdda254e0_1600w.jpg" />
...
<svg className="lucide mt-0.5 w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="locate" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><line></line><line></line><line></line><line className=""></line><circle className="" cx="12" cy="12"></circle></svg>
</div>
</div></div>
...
<svg className="lucide w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="mail" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20"></rect><path></path></svg>
...
<svg className="lucide w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="phone" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
          +55 41 9142-5126
        </a>
</li>
</ul>
...
<svg className="lucide w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="instagram" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="5" ry="5" width="20"></rect><path></path><line></line></svg>
          Instagram
        </a>
</li>
<li className="">
...
<title>Tiktok</title>
<g className="" fill="none" fillRule="evenodd" id="Icon/Social/tiktok-black" stroke="currentColor" strokeWidth="1">
<path className="" fill="#000000" id="Fill-1"></path>
</g>
</svg>
          TikTok
...
<svg className="lucide w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="facebook" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
          Facebook
        </a>
</li>
<li className="">
...
<svg className="lucide w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="linkedin" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" width="4"></rect><circle cx="4" cy="4"></circle></svg>
          LinkedIn
        </a>
</li>
</ul>

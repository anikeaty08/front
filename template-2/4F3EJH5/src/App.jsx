...
<button className="bg-purple-600 text-white px-4 py-2 rounded-full shadow hover:bg-purple-800 transition" onClick={(e) => { filterImages('all') }}>All</button>
<button className="bg-green-600 text-white px-4 py-2 rounded-full shadow hover:bg-green-800 transition" onClick={(e) => { filterImages('nature') }}>Nature</button>
<button className="bg-blue-600 text-white px-4 py-2 rounded-full shadow hover:bg-blue-800 transition" onClick={(e) => { filterImages('city') }}>City</button>
<button className="bg-pink-600 text-white px-4 py-2 rounded-full shadow hover:bg-pink-800 transition" onClick={(e) => { filterImages('people') }}>People</button>
<button className="bg-yellow-500 text-white px-4 py-2 rounded-full shadow hover:bg-yellow-700 transition" onClick={(e) => { filterImages('abstract') }}>Abstract</button>
</div>

...
<div className="space-y-3">
<template id="freqTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="activityFrequency" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
</div>
</section>
...
<div className="space-y-3">
<template id="functionTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="physicalFunction" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
</div>
</section>
...
<div className="space-y-3">
<template id="intentTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="intentToChange" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
</div>
</section>
...
<div className="space-y-3">
<template id="sleepTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="sleep" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
</div>
</section>
...
<div className="space-y-3">
<template id="tobaccoTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="tobaccoUse" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
</div>
</section>
...
<div className="space-y-3">
<template id="goalTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="primaryGoal" required type="radio" /><span className="w-5 h-5 rounded-full border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"></span><span className="text-sm font-medium"></span></label></template>
...
<div className="space-y-3">
<template id="prefTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="activityPreferences" type="checkbox" /><span className="w-5 h-5 rounded-lg border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"><i className="w-3.5 h-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity" data-lucide="check"></i></span><span className="text-sm font-medium"></span></label></template>
...
<div className="space-y-3">
<template id="equipTemplate"><label className="flex items-center gap-3 p-4 rounded-xl border border-neutral-200 hover:border-[#ae9ab0] hover:bg-[#f5f3f7] cursor-pointer transition-colors group"><input className="peer sr-only" name="equipmentAccess" type="checkbox" /><span className="w-5 h-5 rounded-lg border border-neutral-300 transition-all flex items-center justify-center peer-checked:border-[#ae9ab0] peer-checked:bg-[#ae9ab0] group-hover:border-[#ae9ab0]"><i className="w-3.5 h-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity" data-lucide="check"></i></span><span className="text-sm font-medium"></span></label></template>

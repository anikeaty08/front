...
document.getElementById('downloadBtn').addEventListener('click', () => {
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/f83949d8-67f4-44e7-bd91-b1f427402651_3840w.jpg")`}}></div>
...
<img alt="User" className="w-10 h-10 rounded-full object-cover" src="/assets/9306e964-743f-4746-b85b-870737f72f8f_320w.jpg" style={{}} />
<div className="">
...
<img alt="Hotel" className="w-32 h-28 rounded-xl object-cover" src="/assets/9eb96530-cbdf-4573-b08f-ee7240680cc8_320w.jpg" style={{}} />
...
<div className="relative flex-none">
<img alt="Hotel" className="w-32 h-28 rounded-xl object-cover" src="/assets/5c10e182-ac88-49f7-b57d-6a268b5fa81e_320w.jpg" style={{}} />
<button className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white flex items-center justify-center hover:bg-neutral-100 transition-colors">
...
<div className="relative flex-none">
<img alt="Hotel" className="w-32 h-28 rounded-xl object-cover" src="/assets/4785a61d-64cb-483a-abf4-af980ea112a5_320w.jpg" style={{}} />
<button className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white flex items-center justify-center hover:bg-neutral-100 transition-colors">
<svg className="lucide lucide-heart w-4 h-4 text-neutral-500" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path></svg>
</button>
</div>

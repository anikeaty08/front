...
<div className="absolute inset-0" style={{background: `linear-gradient(90deg, 
...
<div className="md:hidden absolute inset-0" style={{background: `linear-gradient(180deg, 
               rgba(253,245,216,0.93) 0%,
...
<input className="w-full bg-[#FAF6EA] border border-[#EDE6D0] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 text-[#0D2B20]" id="nome" placeholder="Ex.: Maria Silva" type="text" />
</div>
<div className="">

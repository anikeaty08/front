...
<div className="bg-white rounded-lg border border-slate-100 shadow-sm transition">
...
<h3 className="text-xl font-semibold text-blue-600">Family Law</h3>
</div>
<i className="w-5 h-5 text-slate-400 transition-transform group-open:rotate-180" data-lucide="chevron-down"></i>
</summary>
<p className="mt-6 text-sm text-slate-700">Compassionate guidance for divorce, dissolution, custody, and support—including collaborative and mediated solutions.</p>
</details>
</div>
...
<i className="w-8 h-8-blue-600" data-lucide="gavel"></i>
<h3 className="text-xl font-semibold text-blue-600">Litigation</h3>
</div>
<i className="w-5 h-5 text-slate-400 transition-transform group-open:rotate-180" data-lucide="chevron-down"></i>
</summary>
<p className="mt-6 text-sm text-slate-700">Strategic representation in civil disputes—from pre-suit strategy to trial and appeal—in state and federal courts.</p>
</details>
</div>
...
<summary className="flex items-center justify-between cursor-pointer list-none">
<div className="flex items-center space-x-3">
<i className="w-8 h-8 text-blue-600" data-lucide="credit-card"></i>
<h3 className="text-xl font-semibold text-blue-600">Debtor-Creditor / Bankruptcy</h3>
</div>
<i className="w-5 h-5 text-slate-400 transition-transform group-open:rotate-180" data-lucide="chevron-down"></i>
</summary>
<p className="mt-6 text-sm text-slate-700">Bankruptcy filings, creditor defense, and negotiation of practical debt-relief solutions for businesses and individuals.</p>
</details>
</div>
</div>
</div>

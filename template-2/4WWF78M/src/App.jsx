  ...
  useEffect(() => {
    ...
    cards.forEach((card, idx) => {
      card.addEventListener('click', () => {
        ...
        setTimeout(() => {
          card.style.outline = "";
          card.style.transform = card.style.transform.replace(" scale(1.018)", "");
        }, 340);
      });
    });
...
<div className="relative w-full max-w-5xl mx-auto h-[670px] flex items-end justify-end fade-in" style={{animationDelay: `0.09s`}}>
...
<div className="absolute top-1/2 left-1/2 glass card-outline rounded-2xl cursor-pointer [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden] shadow-xl flex flex-col transition-all duration-200" style={{width: `500px`, height: `470px`, zIndex: `1`, transformOrigin: `50% 50%`, transform: `translate(-50%, -50%) translate3d(120px, -140px, -180px) rotate(5.99976deg) skew(5.99976deg, 6deg) scale(1.00551, 0.99452)`}}>
<div className="browser-bar">
<span aria-label="Close" className="traffic-light traffic-red" tabindex="0"></span>
<span aria-label="Minimize" className="traffic-light traffic-yellow" tabindex="0"></span>
<span aria-label="Expand" className="traffic-light traffic-green" tabindex="0"></span>
...
<div className="absolute top-1/2 left-1/2 glass card-outline rounded-2xl cursor-pointer [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden] shadow-xl flex flex-col transition-all duration-200" style={{width: `500px`, height: `470px`, zIndex: `3`, transformOrigin: `50% 50%`, transform: `translate(-50%, -50%) translate3d(0px, 0px, 0px) rotate(5.99976deg) skew(5.99976deg, 6deg) scale(1.00551, 0.99452)`}}>
<div className="browser-bar">
<span aria-label="Close" className="traffic-light traffic-red" tabindex="0"></span>
<span aria-label="Minimize" className="traffic-light traffic-yellow" tabindex="0"></span>
<span aria-label="Expand" className="traffic-light traffic-green" tabindex="0"></span>
...
<div className="absolute top-1/2 left-1/2 glass card-outline rounded-2xl cursor-pointer [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden] shadow-xl flex flex-col transition-all duration-200" style={{width: `500px`, height: `470px`, zIndex: `2`, transformOrigin: `50% 50%`, transform: `translate(-50%, -50%) translate3d(60px, -70px, -90px) rotate(5.99976deg) skew(5.99976deg, 6deg) scale(1.00551, 0.99452)`, fontFamily: `'Roboto', 'Inter', ui-sans-serif, sans-serif`}}>
...
<div className="flex flex-col h-full w-full bg-white rounded-b-2xl" style={{overflow: `hidden`}}>

<div className="flex items-center px-5 py-2 border-b border-gray-200 rounded-t-2xl" style={{minHeight: `60px`}}>

...
<button className="md:hidden p-2 rounded hover:bg-gray-100" onClick={(e) => { toggleSidebar() }}>
...
<button className="absolute top-3 right-3 p-2 rounded hover:bg-gray-100" onClick={(e) => { toggleSidebar() }}>
<i data-feather="x"></i>
</button>

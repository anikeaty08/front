  ...
  useEffect(() => {
    ...
    try {
        ...
        function resetWidget() {
            document.getElementById('score').textContent = '700/1000';
            document.getElementById('performance').textContent = 'Performance: Fair';
            document.getElementById('progress-bar').style.width = '70%';
            document.getElementById('progress-bar').className = 'bg-yellow-500 h-2 rounded-full transition-all duration-1000';
            document.getElementById('summary').textContent = '$250 of your commission is at risk. Get unpaid clients to pay ASAP. Enable autopay and encourage account creation to improve retention and protect future income.';
            
            const container = document.getElementById('bullet-container');
            container.innerHTML = `
                <div id="bullet-1" class="flex items-start gap-2 text-sm">
                    <span class="text-gray-400 mt-1">•</span>
                    <div>
                        <span class="text-gray-500 italic">Emily Jones (OSCPRIM004)</span> has not paid. Loss of $75 commission if not received. 
                        <a href="#" class="text-blue-600 hover:underline">Make a payment</a>
                    </div>
                </div>
                <div id="bullet-2" class="flex items-start gap-2 text-sm">
                    <span class="text-gray-400 mt-1">•</span>
                    <div>
                        <span class="text-gray-500 italic">Members (Linda & Daniel)</span> have not enabled autopay. 
                        <a href="#" class="text-blue-600 hover:underline">Enable autopay</a>
                    </div>
                </div>
            `;
        }
        ...
        function animateUpdate() {
            ...
            setTimeout(() => {
                ...
                skeletonBullet.className = 'flex items-start gap-2 text-sm opacity-0 fade-in';
                skeletonBullet.innerHTML = `
                    <div class="skeleton h-4 w-1 rounded mt-1"></div>
                    <div class="flex-1">
        ...
        function startAnimation() {
            ...
            animationInterval = setInterval(animateUpdate, 8000);
        }
...
<button className="fixed top-4 right-4 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg shadow-lg transition-colors text-xs" id="restart-btn">
        Restart Animation
    </button>
<div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
<div className="flex items-center justify-between mb-1">
<div className="flex items-center gap-2">
<h2 className="text-2xl font-bold text-gray-900">Book Score</h2>
...
<div className="flex items-start gap-2 text-sm" id="bullet-1">
...
<div className="flex items-start gap-2 text-sm" id="bullet-2">
<span className="text-gray-400 mt-1">•</span>
<div>
...
<path clip-rule="evenodd" d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z" fillRule="evenodd"></path>
</svg>
</div>

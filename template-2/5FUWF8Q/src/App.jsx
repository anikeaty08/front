...
<input checked className="mt-1 mr-3 accent-blue-600" name="mode" onChange={(e) => { showConfig('no_join') }} type="radio" value="no_join" />
<div>
...
<label className="flex items-start p-3 rounded border border-gray-200 cursor-pointer bg-gray-50">
<input className="mt-1 mr-3 accent-blue-600" name="mode" onChange={(e) => { showConfig('date') }} type="radio" value="date" />
<div>
...
<label className="flex items-start p-3 rounded border border-gray-200 cursor-pointer bg-gray-50">
<input className="mt-1 mr-3 accent-blue-600" name="mode" onChange={(e) => { showConfig('regex') }} type="radio" value="regex" />
<div>
...
<label className="flex items-start p-3 rounded border border-gray-200 cursor-pointer bg-gray-50">
<input className="mt-1 mr-3 accent-blue-600" name="mode" onChange={(e) => { showConfig('user_def_field') }} type="radio" value="user_def_field" />
<div>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image" style={{backgroundImage: `url("https://i.postimg.cc/zBX3f0XR/lmarena-image-80.png?w=800&q=80")`}}></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10"></div>
...
<div className="space-y-1 flex-grow overflow-y-auto hide-scrollbar" id="conversations-list"><div className="relative group flex items-center justify-between p-3 rounded-lg hover:bg-white/10 cursor-pointer transition-colors"><div><h4 className="text-white font-medium text-sm">Ideias para Reels</h4><span className="text-white/60 text-xs">Ontem</span></div><div className="relative"><button className="options-btn opacity-0 group-hover:opacity-100 transition-opacity text-white/60 hover:text-white p-1 rounded-full"><svg className="lucide lucide-more-horizontal w-4 h-4" data-lucide="more-horizontal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></button><div className="conversation-options-menu liquid-glass p-2"><a className="notification-item flex items-center gap-2 px-3 py-2 text-white text-xs" href="#"><svg className="lucide lucide-pencil w-3 h-3" data-lucide="pencil" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"></path><path d="m15 5 4 4"></path></svg> Renomear</a><a className="notification-item flex items-center gap-2 px-3 py-2 text-red-400 text-xs" href="#"><svg className="lucide lucide-trash-2 w-3 h-3" data-lucide="trash-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path><path d="M3 6h18"></path><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir</a></div></div></div><div className="relative group flex items-center justify-between p-3 rounded-lg hover:bg-white/10 cursor-pointer transition-colors"><div><h4 className="text-white font-medium text-sm">Roteiro para TikTok</h4><span className="text-white/60 text-xs">Há 3 dias</span></div><div className="relative"><button className="options-btn opacity-0 group-hover:opacity-100 transition-opacity text-white/60 hover:text-white p-1 rounded-full"><svg className="lucide lucide-more-horizontal w-4 h-4" data-lucide="more-horizontal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></button><div className="conversation-options-menu liquid-glass p-2"><a className="notification-item flex items-center gap-2 px-3 py-2 text-white text-xs" href="#"><svg className="lucide lucide-pencil w-3 h-3" data-lucide="pencil" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"></path><path d="m15 5 4 4"></path></svg> Renomear</a><a className="notification-item flex items-center gap-2 px-3 py-2 text-red-400 text-xs" href="#"><svg className="lucide lucide-trash-2 w-3 h-3" data-lucide="trash-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path><path d="M3 6h18"></path><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir</a></div></div></div><div className="relative group flex items-center justify-between p-3 rounded-lg hover:bg-white/10 cursor-pointer transition-colors"><div><h4 className="text-white font-medium text-sm">Estratégia de Marketing</h4><span className="text-white/60 text-xs">Semana passada</span></div><div className="relative"><button className="options-btn opacity-0 group-hover:opacity-100 transition-opacity text-white/60 hover:text-white p-1 rounded-full"><svg className="lucide lucide-more-horizontal w-4 h-4" data-lucide="more-horizontal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></button><div className="conversation-options-menu liquid-glass p-2"><a className="notification-item flex items-center gap-2 px-3 py-2 text-white text-xs" href="#"><svg className="lucide lucide-pencil w-3 h-3" data-lucide="pencil" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"></path><path d="m15 5 4 4"></path></svg> Renomear</a><a className="notification-item flex items-center gap-2 px-3 py-2 text-red-400 text-xs" href="#"><svg className="lucide lucide-trash-2 w-3 h-3" data-lucide="trash-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path><path d="M3 6h18"></path><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir</a></div></div></div></div>
</div>
</div>
...
<div className="relative">
<button className="text-white/60 hover:text-white transition-colors" id="credits-info-btn"><svg className="lucide lucide-info w-3.5 h-3.5" data-lucide="info" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg></button>
...
<a className="menu-item flex items-center gap-3 p-2.5 text-white text-sm" href="#"><svg className="lucide lucide-gem w-4 h-4 text-white/70" data-lucide="gem" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10.5 3 8 9l4 13 4-13-2.5-6"></path><path d="M17 3a2 2 0 0 1 1.6.8l3 4a2 2 0 0 1 .013 2.382l-7.99 10.986a2 2 0 0 1-3.247 0l-7.99-10.986A2 2 0 0 1 2.4 7.8l2.998-3.997A2 2 0 0 1 7 3z"></path><path d="M2 9h20"></path></svg><span>Gerenciar Assinatura</span></a>
<a className="menu-item flex items-center gap-3 p-2.5 text-white text-sm" href="#"><svg className="lucide lucide-settings w-4 h-4 text-white/70" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"></path><circle cx="12" cy="12" r="3"></circle></svg><span>Configurações da Conta</span></a>
<a className="menu-item flex items-center gap-3 p-2.5 text-white text-sm" href="#"><svg className="lucide lucide-help-circle w-4 h-4 text-white/70" data-lucide="help-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg><span>Central de Ajuda</span></a>
<div className="border-t border-white/10 my-2"></div>
<a className="menu-item flex items-center gap-3 p-2.5 text-red-400 hover:text-red-300 text-sm" href="#"><svg className="lucide lucide-log-out w-4 h-4" data-lucide="log-out" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 17 5-5-5-5"></path><path d="M21 12H9"></path><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path></svg><span>Sair da Conta</span></a>
</div>
</div>
</div>
</div>
...
<div className="min-h-[40vh] flex flex-col mt-12 mb-6 items-center justify-center">
<div className="mb-6 text-center animate-entry">
<h2 aria-label="Boa tarde, Sofia" className="text-3xl font-semibold text-white tracking-tight" id="dynamic-greeting" style={{fontFamily: `'Geist',sans-serif`}}><span className="greeting-char" style={{animationDelay: `0ms`}}>B</span><span className="greeting-char" style={{animationDelay: `50ms`}}>o</span><span className="greeting-char" style={{animationDelay: `100ms`}}>a</span><span className="greeting-char" style={{animationDelay: `150ms`}}> </span><span className="greeting-char" style={{animationDelay: `200ms`}}>n</span><span className="greeting-char" style={{animationDelay: `250ms`}}>o</span><span className="greeting-char" style={{animationDelay: `300ms`}}>i</span><span className="greeting-char" style={{animationDelay: `350ms`}}>t</span><span className="greeting-char" style={{animationDelay: `400ms`}}>e</span><span className="greeting-char" style={{animationDelay: `450ms`}}>,</span><span className="greeting-char" style={{animationDelay: `500ms`}}> </span><span className="greeting-char" style={{animationDelay: `550ms`}}>S</span><span className="greeting-char" style={{animationDelay: `600ms`}}>o</span><span className="greeting-char" style={{animationDelay: `650ms`}}>f</span><span className="greeting-char" style={{animationDelay: `700ms`}}>i</span><span className="greeting-char" style={{animationDelay: `750ms`}}>a</span></h2>
</div>
...
<div className="text-sm font-medium text-white/60 hidden sm:block" id="popular-indicators">1 / 4</div>
<a className="text-sm font-medium text-white/80 hover:text-white transition-colors" href="#">Ver todos</a>
</div>
</div>
<div className="relative">
<button className="carousel-nav-btn absolute top-1/2 -left-6 transform -translate-y-1/2 w-12 h-12 rounded-full liquid-glass-pill hidden lg:flex items-center justify-center" disabled id="popular-prev-btn">
...
<div className="flex items-center gap-1"><svg className="lucide lucide-arrow-right w-3 h-3" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></div>
</div>
</div>
</div>
</li>
...
<div className="ml-4 flex-shrink-0">
<div className="w-10 h-10 rounded-full bg-gradient-to-br from-[var(--brand-pink)] to-[var(--brand-mint)] flex items-center justify-center"><svg className="lucide lucide-search w-5 h-5 text-white" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m21 21-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></svg></div>
</div>
</div>

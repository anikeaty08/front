...
<input checked className="appearance-none w-10 h-6 rounded-full bg-zinc-300 dark:bg-zinc-700 checked:bg-indigo-500 relative outline-none transition-colors cursor-pointer" id="dark-toggle" onClick={(e) => { toggleDarkMode(e.currentTarget) }} type="checkbox" />
<svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">

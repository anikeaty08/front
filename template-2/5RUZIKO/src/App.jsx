...
<svg className="lucide lucide-building-2 w-3.5 h-3.5" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path className=""></path><path></path><path></path><path></path><path></path><path></path></svg> Ticker: AAPL
      </span>
...
<h4 className="text-[18px] sm:text-[20px] text-xs font-normal text-gray-900 tracking-tight">Apple Overseas Bonds ที่สนใจ</h4>

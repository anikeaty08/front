...
<div className="relative max-w-6xl mx-auto min-h-[760px] flex flex-col bg-neutral-950 bg-cover rounded-3xl px-20 py-10" style={{backgroundImage: `linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.5)), url('data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 1000 1000%22><rect fill=%22%23059669%22 width=%221000%22 height=%221000%22/><g fill=%22%2300d9ff%22 opacity=%220.1%22><circle cx=%22200%22 cy=%22200%22 r=%2280%22/><circle cx=%22800%22 cy=%22300%22 r=%2260%22/><circle cx=%22300%22 cy=%22700%22 r=%2290%22/><rect x=%22600%22 y=%22600%22 width=%22100%22 height=%22100%22 rx=%2220%22/></g></svg>')`}}>

...
lucide.createIcons({ attrs: { 'stroke-width': 1.5 } });
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/c592e5b5-3682-4c4f-85ce-669f4c0f9625_3840w.jpg")`}}></div>
...
<img alt="" className="absolute inset-0 w-full h-full object-cover" src="/assets/6e29bd08-f172-468a-9f34-baf96386658d_800w.jpg" style={{}} />
...
<img alt="" className="w-full h-full object-cover" src="/assets/693a62b0-4d0b-42c8-9af1-ed66d6c4180b_320w.jpg" style={{}} />
</div>
</div>
</div>
...
<img alt="" className="w-full h-48 object-cover group-hover:scale-105 transition duration-500" src="/assets/b5cf09cd-cb67-413d-aa02-1b08cd4cf7fb_800w.jpg" style={{}} />
...
<div className="relative rounded-3xl overflow-hidden bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 shadow-xl hover:shadow-2xl hover:bg-gray-800/80 transition group">
<img alt="" className="w-full h-48 object-cover group-hover:scale-105 transition duration-500" src="/assets/24c7c604-ba48-4e9c-b415-dbbe91d1337d_800w.jpg" style={{}} />
<div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-transparent to-transparent"></div>
<div className="absolute top-4 left-4 flex items-center gap-1 bg-black/70 backdrop-blur-sm px-3 py-1.5 rounded-full text-sm font-medium text-white border border-white/10 font-sans">
...
<div className="relative rounded-3xl overflow-hidden bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 shadow-xl hover:shadow-2xl hover:bg-gray-800/80 transition group">
<img alt="" className="w-full h-48 object-cover group-hover:scale-105 transition duration-500" src="/assets/3fd5ecc0-70c1-481e-bcca-44739e6af626_800w.jpg" style={{}} />
...
<div className="relative rounded-3xl overflow-hidden bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 shadow-xl hover:shadow-2xl hover:bg-gray-800/80 transition group">
<img alt="" className="w-full h-48 object-cover group-hover:scale-105 transition duration-500" src="/assets/acc53465-8174-4822-b041-b15c04dd35bc_800w.jpg" style={{}} />
<div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-transparent to-transparent"></div>
<div className="absolute top-4 left-4 flex items-center gap-1 bg-black/70 backdrop-blur-sm px-3 py-1.5 rounded-full text-sm font-medium text-white border border-white/10 font-sans">
<svg className="lucide lucide-star w-4 h-4 text-yellow-400 fill-current" data-lucide="star" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg> 4.9
            </div>
...
<img alt="" className="w-full h-64 object-cover" src="/assets/4c4a5b30-8f7a-42dd-9bd3-b841442b3830_800w.jpg" />
...
<img alt="" className="w-full h-full object-cover" src="/assets/10b82f02-0664-4276-be7d-8b63b0623907_320w.jpg" />
</div>
<div className="flex-1">

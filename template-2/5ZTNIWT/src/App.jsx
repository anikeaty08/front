...
<header className="relative overflow-hidden opacity-0 bg-teal-800 bg-[url(/assets/b0d25cfe-74e2-44ec-be70-9f0c7dfd9acf_1600w.jpg)] bg-cover rounded-3xl mb-8 shadow-2xl translate-y-4" style={{animation: `fadeInUp 0.8s ease-out 0.1s forwards`}}>
...
<img alt="Hydroponic System" className="w-full h-full object-cover" src="/assets/438c9971-2d90-4f83-8ae5-a4c720a1234a_800w.jpg" />
...
<div className="opacity-0 text-white bg-slate-900 bg-[url(/assets/1748efa3-57d9-4fbc-bc85-6c64763cd0d6_800w.jpg)] bg-cover rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-xl translate-y-4" style={{animation: `fadeInUp 0.8s ease-out 0.2s forwards`}}>
...
<div className="opacity-0 bg-[url(/assets/0f723c55-d136-402b-895a-a5d075e17651_800w.jpg)] bg-cover rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-xl translate-y-4" style={{animation: `fadeInUp 0.8s ease-out 0.3s forwards`}}>
<div className="flex items-center justify-between mb-6">
<div className="flex items-center space-x-3">

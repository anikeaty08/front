...
<button className="thumb-btn border-[#1879C3] ring-1 ring-[#1879C3]/20 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-2 flex items-center justify-center hover:border-zinc-300 transition-all relative" onClick={(e) => { window.syncGallery(0) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-2 flex items-center justify-center hover:border-zinc-300 transition-all relative" onClick={(e) => { window.syncGallery(1) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(2) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(3) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(4) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(5) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(6) }}>
...
<button className="thumb-btn border-zinc-200 w-20 h-20 sm:w-24 sm:h-24 shrink-0 snap-start border rounded-sm bg-white p-1 flex items-center justify-center hover:border-zinc-300 transition-all relative overflow-hidden" onClick={(e) => { window.syncGallery(7) }}>
...
<div className="flex gap-0.5 text-amber-400 gap-x-0.5 gap-y-0.5 items-center cursor-pointer group" onClick={(e) => { event.preventDefault(); const section = Array.from(document.querySelectorAll('h2')).find(el => el.textContent.includes('Reviews')); if(section) section.parentElement.scrollIntoView({behavior: 'smooth', block: 'start'}); }}>
...
<div className="w-full sm:w-px h-px sm:h-4 bg-zinc-300 shrink-0"></div>
<button className="hover:underline flex gap-1 text-base text-[#1879C3] items-center" onClick={(e) => { document.getElementById('shipping-modal-emmzd').classList.remove('hidden'); if(window.lucide) { window.lucide.createIcons(); } }}>
                Shipping Information
                <div className="hidden fixed inset-0 z-[100] flex items-center justify-center bg-black/50 cursor-default no-underline hover:no-underline text-left" id="shipping-modal-emmzd" onClick={(e) => { event.stopPropagation(); e.currentTarget.classList.add('hidden') }}>
<div className="bg-white w-full max-w-4xl shadow-xl flex flex-col max-h-[90vh] mx-4 rounded-sm" onClick={(e) => { event.stopPropagation() }}>
...
<div className="cursor-pointer hover:text-zinc-300 transition-colors p-1" onClick={(e) => { document.getElementById('shipping-modal-emmzd').classList.add('hidden') }}>
...
<p className="leading-relaxed m-0">
                          ...
                          <a className="text-[#1879C3] hover:underline" href="tel:800-507-9651" onClick={(e) => { event.stopPropagation() }}>
                            800-507-9651
                          </a>
                          or email us at
                          <a className="text-[#1879C3] hover:underline" href="mailto:sales@hydraulic-supply.com" onClick={(e) => { event.stopPropagation() }}>
...
<button className="mt-0.5 flex-shrink-0 w-6 h-6 border border-zinc-300 rounded-sm flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:border-zinc-400 hover:bg-zinc-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#1879C3] focus:ring-offset-1" onClick={(e) => { e.currentTarget.parentElement.parentElement.querySelector('.answer-block').classList.toggle('hidden'); const icon = e.currentTarget.querySelector('i'); if(icon.getAttribute('data-lucide') === 'chevron-down') { icon.setAttribute('data-lucide', 'chevron-right'); } else { icon.setAttribute('data-lucide', 'chevron-down'); } lucide.createIcons(); }}>
...
<button className="flex hover:text-zinc-900 hover:border-zinc-300 transition-colors focus:outline-none text-zinc-500 bg-white w-10 h-10 border-zinc-200 border rounded-sm items-center justify-center" onClick={(e) => { const p = e.currentTarget.closest('.border-t'); const c = p ? p.querySelector('.overflow-x-auto') : null; if(c) c.scrollBy({left: -304, behavior: 'smooth'}); }}>
<iconify-icon className="text-xl" icon="lucide:chevron-left" style={{strokeWidth: `1.5`}}></iconify-icon>
</button>
<button className="w-10 h-10 border border-zinc-200 rounded-sm flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:border-zinc-300 bg-white transition-colors focus:outline-none" onClick={(e) => { const p = e.currentTarget.closest('.border-t'); const c = p ? p.querySelector('.overflow-x-auto') : null; if(c) c.scrollBy({left: 304, behavior: 'smooth'}); }}>

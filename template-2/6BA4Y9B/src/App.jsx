...
<img alt="Abstract design" className="w-full h-64 sm:h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500" src="/assets/a764bb3b-5586-46e0-9d7d-eee3d6cb2211_800w.jpg" style={{}} />
...
<img alt="Modern interface" className="w-full h-32 object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500" src="/assets/c160e528-a195-4720-8c90-671df696522d_800w.jpg" style={{}} />
<div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent group-hover:from-black/30 transition-all duration-300"></div>
...
<img alt="Design system" className="w-full h-32 object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500" src="/assets/eb724d1c-3844-4a38-b93d-5dc2355546bc_800w.jpg" style={{}} />
<div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent group-hover:from-black/30 transition-all duration-300"></div>
<div className="absolute bottom-2 left-2 right-2">

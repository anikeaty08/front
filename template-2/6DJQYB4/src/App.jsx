...
<div className="relative bg-white/5 bg-[url(/assets/8d0f3c19-2547-4b20-8911-9713329c4ca6_800w.jpg)] bg-cover rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-lg">
...
<div className="relative bg-white/5 bg-[url(/assets/9dead2ce-9640-41bd-8153-af6e7acc42cf_800w.jpg)] bg-cover rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-lg">
...
<div className="relative md:col-span-2 xl:col-span-1 bg-white/5 bg-[url(/assets/86c20217-e734-45e2-a50b-0e5602db415c_800w.jpg)] bg-cover rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-lg">
<div className="flex items-center justify-between mb-4">
<p className="text-xs text-white/60 flex items-center gap-1 font-geist">

...
<div className="aurora-layer absolute top-1/2 left-0 w-full h-32 opacity-60" style={{background: `linear-gradient(90deg, #3A29FF 0%, #FF94B4 50%, #FF3232 100%)`, filter: `blur(20px)`, transform: `translateY(-50%) rotate(-2deg)`}}>
</div>
</div>

<div className="aurora-wave absolute inset-0">
<div className="aurora-layer absolute top-1/2 left-0 w-full h-24 opacity-50" style={{background: `linear-gradient(90deg, #FF3232 0%, #3A29FF 50%, #FF94B4 100%)`, filter: `blur(25px)`, transform: `translateY(-30px) rotate(1deg)`}}>
</div>
</div>

<div className="aurora-wave absolute inset-0">
<div className="aurora-layer absolute top-1/2 left-0 w-full h-40 opacity-40" style={{background: `linear-gradient(90deg, #FF94B4 0%, #FF3232 50%, #3A29FF 100%)`, filter: `blur(30px)`, transform: `translateY(20px) rotate(-1deg)`}}>
</div>
</div>

<div className="absolute top-1/3 left-0 w-full h-20 opacity-30 aurora-layer" style={{background: `radial-gradient(ellipse, #3A29FF 0%, transparent 70%)`, filter: `blur(40px)`, animationDuration: `10s, 8s`}}>
</div>
<div className="absolute bottom-1/3 left-0 w-full h-16 opacity-25 aurora-layer" style={{background: `radial-gradient(ellipse, #FF94B4 0%, transparent 60%)`, filter: `blur(35px)`, animationDuration: `14s, 9s`, animationDelay: `-3s, -2s`}}>
</div>
</div>

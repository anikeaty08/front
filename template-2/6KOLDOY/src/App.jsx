...
<button className="backBtn hidden focus:outline-none flex items-center gap-2 text-sm text-neutral-400 hover:text-white" onClick={(e) => { goback() }}><i className="w-4 h-4" data-lucide="arrow-left"></i><span className="sr-only">Regresar</span></button>
...
<button className="w-full py-3 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:to-indigo-700 transition-colors" onClick={(e) => { goto(2) }}>Comenzar</button>
</section>

<section className="hidden space-y-6 animate-entry" id="screen2">
<button className="backBtn flex items-center gap-2 text-sm text-neutral-400 hover:text-white focus:outline-none" onClick={(e) => { goback() }}><i className="w-4 h-4" data-lucide="arrow-left"></i><span className="sr-only">Regresar</span></button>
...
<button className="w-full py-3 rounded-md bg-indigo-600 opacity-50" disabled id="continueSim" onClick={(e) => { goto(3) }}>Continuar</button>
</section>
...
<button className="w-full py-3 rounded-md bg-indigo-600 opacity-50" disabled id="confirmBtn" onClick={(e) => { crearInv() }}>Confirmar Inversión</button>
</section>
...
<button className="backBtn flex mx-auto items-center gap-2 text-sm text-neutral-400 hover:text-white focus:outline-none" onClick={(e) => { goback() }}><i className="w-4 h-4" data-lucide="arrow-left"></i><span className="sr-only">Regresar</span></button>
...
<button className="w-full py-3 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:to-indigo-700" onClick={(e) => { goto(6) }}>Continuar</button>
</section>
...
<button className="w-full py-3 rounded-md bg-neutral-800 hover:bg-neutral-700" onClick={(e) => { goto(7) }}>Mover todo a Cuenta+</button>
</div>
</section>

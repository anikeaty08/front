...
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onClick={(e) => { nextScreen() }}>Comenzar</button>
</div>
</section>
...
<input className="w-full h-14 border border-[#A8A8A8] rounded-[12px] px-4 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="amountInput" min="100" onInput={(e) => { updateSimulation() }} step="100" type="number" value="1000" />
</label>

<label className="flex flex-col gap-2">
<span className="text-[14px]">Plazo (días)</span>
<select className="w-full h-14 border border-[#A8A8A8] rounded-[12px] px-4 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="termSelect" onChange={(e) => { updateSimulation() }}>
...
<div className="mt-auto">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onClick={(e) => { goToConfirm() }}>Continuar</button>
</div>
</section>
...
<div className="mt-auto">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold opacity-50" disabled id="confirmBtn" onClick={(e) => { createInvestment() }}>Confirmar inversión</button>
</div>
</section>
...
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onClick={(e) => { nextScreen() }}>Continuar</button>
</div>
</section>
...
<div className="mt-auto">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold opacity-50" disabled id="postContinue" onClick={(e) => { nextScreen() }}>Guardar Preferencia</button>
</div>
</section>
...
<div>
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onClick={(e) => { resetToSim() }}>Crear nueva inversión</button>
</div>
</section>
...
<div className="mt-auto">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onClick={(e) => { backToList() }}>Volver</button>
</div>
</section>
</main>
</div>

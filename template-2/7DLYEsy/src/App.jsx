...
<div>
<button className="bg-teal-500 hover:bg-teal-600 text-white px-5 py-2 rounded-lg transition">Get Started</button>
</div>
</div>
</nav>

<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 flex flex-col items-center text-center">
<span className="px-3 py-1 bg-teal-500/20 text-teal-300 rounded-full text-sm mb-6 inline-block">CREATIVE SOLUTIONS</span>
...
<button className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-3 rounded-lg text-lg font-medium transition">
          See Our Work
        </button>
...
<p className="max-w-2xl mx-auto text-gray-600">We offer a comprehensive range of digital services to help your business grow and succeed in the digital landscape.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">

<div className="feature-card bg-gray-50 p-6 rounded-xl border border-gray-200">
<div className="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center mb-4">
<svg className="h-6 w-6 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-gray-600 mb-4">Custom websites that are responsive, fast, and designed to convert visitors into customers.</p>
<a className="text-teal-600 font-medium hover:text-teal-800" href="#">Learn more →</a>
</div>
...
<h3 className="text-xl font-semibold text-gray-900 mb-2">Branding</h3>
<p className="text-gray-600 mb-4">Strategic brand development that helps you stand out and connect with your target audience.</p>
<a className="text-purple-600 font-medium hover:text-purple-800" href="#">Learn more →</a>
</div>
...
<p className="text-gray-600 mb-4">Data-driven strategies to increase your online visibility and drive meaningful traffic.</p>

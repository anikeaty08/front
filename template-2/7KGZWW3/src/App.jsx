...
<template id="agentTemplate"><div className="flex items-center gap-1 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 shadow-inner"><i className="w-4 h-4 text-[#ffd700] animate-pulse" data-lucide="bot"></i><span className="text-sm"></span></div></template>

...
<template id="artCard"><div className="space-y-1 hover-lift"><p className="caption text-xs font-medium text-slate-300 hover:text-indigo-400 cursor-text outline-none focus:ring-2 focus:ring-indigo-500/50 rounded text-center" contenteditable="true"></p><div className="relative w-full aspect-square"><img alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg border border-slate-700 hover:border-indigo-500 transition" src="" /></div></div></template>
<template id="photoCard"><img alt="" className="w-full h-64 object-cover rounded-lg border border-slate-700 hover:border-indigo-500 transition hover-lift" src="" /></template>
<template id="videoCard"><video className="w-full rounded-lg border border-slate-700 hover:border-indigo-500 transition" controls preload="none"><source src="" type="video/mp4" /></video></template>

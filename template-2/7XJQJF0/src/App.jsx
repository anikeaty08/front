...
<a className="inline-flex items-center gap-2 ring-1 ring-white/10 shadow-[0_10px_40px_-10px_rgba(139,92,246,0.6)] hover:shadow-[0_15px_50px_-10px_rgba(139,92,246,0.8)] transition-all duration-300 relative overflow-hidden text-sm font-medium text-white tracking-tight bg-gradient-to-tr from-violet-600 to-fuchsia-600 border-2 rounded-full pt-3 pr-6 pb-3 pl-6" href="#" onMouseEnter={(e) => { e.currentTarget.querySelector('.shine-effect').style.animation='shine 1.5s ease-out infinite' }} onMouseLeave={(e) => { e.currentTarget.querySelector('.shine-effect').style.animation='none' }} onMouseOut={(e) => { e.currentTarget.style.transform='scale(1)'; e.currentTarget.style.borderColor='rgba(255, 255, 255, 0.3)'; e.currentTarget.querySelector('.lucide-rocket').style.transform='translateX(0px)' }} onMouseOver={(e) => { e.currentTarget.style.transform='scale(1.05)'; e.currentTarget.style.borderColor='rgba(255, 255, 255, 0.6)'; e.currentTarget.querySelector('.lucide-rocket').style.transform='translateX(4px)' }} style={{borderColor: `rgba(255, 255, 255, 0.3)`, cursor: `pointer`, transform: `scale(1)`}}>

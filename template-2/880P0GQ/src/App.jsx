...
<svg className="lucide lucide-circle w-4 h-4" data-lucide="circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle></svg>
</span>
</span>
...
<svg className="lucide lucide-quote w-4.5 h-4.5" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-chevron-down w-5 h-5 text-gray-500 transition-transform duration-200" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<div className="group">
<button aria-controls="b3-c          <button type=" aria-expanded="false" className="acc-btn w-full flex items-center justify-between gap-6 px-5 sm:px-6 py-4 text-left" id="b3-h" type="button">

...
<button className="inline-flex items-center px-4 py-2.5 text-sm rounded-lg border border-[color:var(--brand-line)] bg-[color:var(--brand-elev)] hover:bg-white hover:text-black transition focus-ring">
...
<section className="mt-12" id="benefits">
<div className="flex items-end justify-between">
<div>
<h2 className="text-2xl font-semibold tracking-tight">Membership Benefits</h2>
<p className="text-[15px] text-[color:var(--brand-muted)] mt-1">Everything you need to sharpen your brand strategy and connect with ambitious professionals.</p>
</div>
</div>
<div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

<article className="rounded-2xl border border-[color:var(--brand-line)] bg-[color:var(--brand-elev)]/40 p-6">
<div className="flex items-center gap-3">
...
<h3 className="text-base font-semibold tracking-tight">Access to full branding strategy videos</h3>
</div>
<p className="mt-3 text-[15px] text-[color:var(--brand-muted)]">Deep dives, frameworks, and practical walkthroughs to apply on real projects.</p>
<ul className="mt-3 space-y-2">
<li className="flex items-start gap-2 text-[15px] text-[color:var(--brand-muted)]">
<i className="w-4 h-4 text-white/70 mt-0.5" data-lucide="check-circle"></i>
...
<h3 className="text-base font-semibold tracking-tight">Exclusive brand strategy articles & case studies</h3>
</div>
<p className="mt-3 text-[15px] text-[color:var(--brand-muted)]">Learn how top brands grow through positioning, messaging, and design systems.</p>
<ul className="mt-3 space-y-2">
<li className="flex items-start gap-2 text-[15px] text-[color:var(--brand-muted)]">
<i className="w-4 h-4 text-white/70 mt-0.5" data-lucide="check-circle"></i>
...
<h3 className="text-base font-semibold tracking-tight">Networking with branding professionals</h3>
</div>
<p className="mt-3 text-[15px] text-[color:var(--brand-muted)]">Collaborate, get feedback, and find opportunities with a curated peer group.</p>
<ul className="mt-3 space-y-2">
<li className="flex items-start gap-2 text-[15px] text-[color:var(--brand-muted)]">
<i className="w-4 h-4 text-white/70 mt-0.5" data-lucide="check-circle"></i>
                    Expert AMAs and town halls
                  </li>
<li className="flex items-start gap-2 text-[15px] text-[color:var(--brand-muted)]">
<i className="w-4 h-4 text-white/70 mt-0.5" data-lucide="check-circle"></i>
                    Curated channels by topic
                  </li>
</ul>
</article>
...
<h3 className="text-base font-semibold tracking-tight">Special contests & rewards for members</h3>
</div>
<p className="mt-3 text-[15px] text-[color:var(--brand-muted)]">Earn perks for sharing work, helping others, and contributing to the community.</p>
<ul className="mt-3 space-y-2">
<li className="flex items-start gap-2 text-[15px] text-[color:var(--brand-muted)]">
<i className="w-4 h-4 text-white/70 mt-0.5" data-lucide="check-circle"></i>
                    Monthly showcases
...
<p className="mt-2 text-[13px] text-white/80 inline-flex items-center gap-2">
<i className="w-4 h-4" data-lucide="lock"></i>
                  Full access available for members only.
                </p>
</div>
...
<i className="w-4 h-4" data-lucide="play"></i> Preview
                  </button>
<button className="absolute bottom-3 right-3 inline-flex items-center gap-1.5 px-3 py-1.5 text-[13px] rounded-lg border border-white/20 bg-white/10 text-white shadow focus-ring">
<i className="w-4 h-4" data-lucide="lock"></i> Locked
                  </button>
...
<span className="absolute top-3 right-3 text-[12px] px-2 py- rounded-md bg-white/10 border border-white/20 text-white/90">25:03</span>
</div>
<div className="p-4">

...
<button className="w-full py-3 bg-indigo-600 rounded-lg font-medium transition hover:bg-indigo-500" onClick={(e) => { go(2) }}>Comenzar</button>
</section>
...
<input className="w-full accent-indigo-600" id="amountRange" max="50000" min="500" onInput={(e) => { updateSim() }} step="500" type="range" value="5000" />
</div>
<div>
<label className="text-sm text-neutral-400">Plazo (días)</label>
<select className="w-full mt-1 bg-neutral-800 border border-neutral-700 rounded-lg py-2 px-3 focus:outline-none" id="plazoSelect" onChange={(e) => { updateSim() }}>
...
<button className="w-full py-3 bg-indigo-600 rounded-lg font-medium transition hover:bg-indigo-500" onClick={(e) => { nextFromSim() }}>Continuar</button>
</section>
...
<input className="accent-indigo-600 mt-1" id="termsChk" onChange={(e) => { toggleConfirmBtn() }} type="checkbox" />
<span className="text-xs text-neutral-300">Acepto los términos y condiciones</span>
</label>
</div>
<button className="w-full py-3 bg-indigo-600/50 rounded-lg font-medium transition disabled:cursor-not-allowed" disabled id="confirmBtn" onClick={(e) => { createInvestment() }}>Invertir ahora</button>
</section>
...
<button className="w-full py-3 bg-indigo-600 rounded-lg font-medium transition hover:bg-indigo-500" onClick={(e) => { go(6) }}>Continuar</button>
</section>
...
<button className="mt-auto w-full py-3 bg-indigo-600 rounded-lg font-medium transition hover:bg-indigo-500" onClick={(e) => { go(7) }}>Guardar</button>
</section>
...
<button className="w-full py-3 bg-indigo-600 rounded-lg font-medium transition hover:bg-indigo-500" onClick={(e) => { resetToIntro() }}>Nueva Inversión</button>
</div>
</section>

<section className="hidden w-full h-full flex flex-col p-6 space-y-4" data-screen="8">
<button className="flex items-center space-x-1 text-sm text-neutral-400 hover:text-white transition" onClick={(e) => { go(7) }}>

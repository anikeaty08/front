...
<path d="M 4 0 L 0 0 0 4" fill="none" stroke="#2a2a32" strokeOpacity="0.15" strokeWidth="0.5"></path>
</pattern>
<pattern height="32" id="mainGrid" patternunits="userSpaceOnUse" width="32">
<rect fill="url(#tinyGrid)" height="32" width="32"></rect>
<path d="M 32 0 L 0 0 0 32" fill="none" stroke="#3a3a42" strokeOpacity="0.17" strokeWidth="1"></path>
</pattern>
</defs>

...
<div className="max-w-5xl mx-auto flex items-center justify-between py-6 px-4 md:px-8">
...
<span className="text-xs text-gray-600 bg-gray-100 rounded px-3 py-1">Private Local Storage</span>
<button className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition shadow" type="button">
          Get Started
        </button>
</div>
</div>
...
<li><b>Quick Add:</b> Add new items with description, location, and image.</li>
<li><b>Versatile Image Upload:</b> Upload, drag & drop, or paste images; mobile camera supported.</li>
<li><b>Smart Image Handling:</b> Images are resized and compressed automatically before saving.</li>
</ul>
</div>
...
<ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
<li><b>Automatic Description Suggestion:</b> AI generates concise item descriptions from images.</li>
<li><b>Intelligent Tag & Category Suggestions:</b> AI proposes useful tags; re-trigger any time.</li>
<li><b>Duplicate Prevention:</b> Detects similar items before adding to avoid clutter.</li>
</ul>
</div>
...
<ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
<li><b>Clear Overview:</b> View all items in a beautiful card layout.</li>
<li><b>Easy Editing:</b> Modify details and trigger new AI suggestions anytime.</li>
<li><b>Safe Deletion:</b> Remove items with confirmation.</li>
</ul>
</div>
...
<ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
<li><b>Quick Access:</b> Floating Action Button for instant search.</li>
<li><b>Text & Visual Search:</b> Find by keywords or upload an image for AI-powered matching.</li>
</ul>
</div>
...
<ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
<li><b>Private Local Storage:</b> All data is stored securely in your browser, offline and private.</li>
<li><b>Storage Insights:</b> Know your available space at a glance.</li>
<li><b>Backup & Restore:</b> Export/import your catalog with replace or merge options.</li>
<li><b>Fresh Start:</b> Reset your database anytime with confirmation.</li>
</ul>
</div>
</div>
</div>
...
<div className="max-w-5xl mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 gap-2">

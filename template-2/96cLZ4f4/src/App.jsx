...
<a className="flex items-center px-3 py-2 text-sm rounded-md hover:bg-slate-800/30 text-slate-400" href="#">
<svg className="h-4 w-4 mr-3 text-slate-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
<path clip-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" fillRule="evenodd"></path>
</svg>
<span>Support</span>
</a>
</div>
...
<h2 className="text-sm font-medium text-slate-300">Recent Chat</h2>
...
<div className="flex items-start max-w-3xl mx-auto px-4 py-3">
<div className="flex-1 relative">
<textarea className="w-full py-2 px-4 rounded-lg bg-slate-800/70 border border-slate-700/50 focus:outline-none focus:border-slate-600 text-sm text-slate-200 placeholder-slate-500 resize-none h-10" id="messageInput" placeholder="Type a message..." rows="1"></textarea>
<div className="absolute right-2 top-2 flex space-x-1 text-slate-400">
<button className="p-1 hover:text-slate-300">
<svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
<path clip-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4a.5.5 0 01-.5-.5v-6.5a.5.5 0 01.5-.5h12a.5.5 0 01.5.5V15a.5.5 0 01-.5.5zM4 4.5a.5.5 0 01.5-.5h11a.5.5 0 010 1h-11a.5.5 0 01-.5-.5z" fillRule="evenodd"></path>
</svg>
</button>
<button className="p-1 hover:text-slate-300">
...
<button className="ml-3 p-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition-colors duration-200 flex-shrink-0 h-10 w-10 flex items-center justify-center" id="sendButton">
<svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">

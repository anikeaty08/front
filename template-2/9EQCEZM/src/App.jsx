    ...
    try {
        ...
        function switchLogoSets() {
            ...
            if (currentSet === 1) {
                ...
                set1.classList.add('fade-out');
                set2.classList.add('fade-in');
                set2.style.opacity = '1';
                
                setTimeout(() => {
                    set1.style.opacity = '0';
                    set1.classList.remove('fade-out');
                }, 400);
                
                setTimeout(() => {
                    set2.classList.remove('fade-in');
                }, 400);
                
                currentSet = 2;
            } else {
                // Fade out set 2, fade in set 1
                set2.classList.add('fade-out');
                set1.classList.add('fade-in');
                set1.style.opacity = '1';
                
                setTimeout(() => {
                    set2.style.opacity = '0';
                    set2.classList.remove('fade-out');
                }, 400);
                
                setTimeout(() => {
                    set1.classList.remove('fade-in');
                }, 400);
        ...
        setTimeout(() => {
            setInterval(switchLogoSets, 3000);
        }, 2000);
...
<h1 className="md:text-6xl bg-clip-text text-2xl font-light text-neutral-200 tracking-tight bg-gradient-to-r from-white via-gray-200 to-gray-400 mb-6">
...
<div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto logo-set fade-out" id="logoSet1" style={{opacity: `1`}}>

<div className="logo-container group cursor-pointer">
<div className="flex items-center justify-center h-16 md:h-20 p-4 transition-all duration-300 hover:scale-110">
<svg className="w-6 h-6 md:w-8 md:h-8 fill-white/70 transition-all duration-300 group-hover:fill-white group-hover:scale-110" viewBox="0 0 24 24">

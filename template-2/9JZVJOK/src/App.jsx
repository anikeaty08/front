...
<button className="w-full h-14 rounded-2xl font-sans" onMouseOut={(e) => { e.currentTarget.style.background='linear-gradient(to right, rgba(0, 180, 255, 0.1) 1%, transparent 40%,transparent 60% , rgba(0, 180, 255, 0.1) 100%)'; e.currentTarget.style.boxShadow='inset 0 0 10px rgba(0, 180, 255, 0.4), 0 0 9px 3px rgba(0, 180, 255, 0.1)'; e.currentTarget.style.transform='scale(1)' }} onMouseOver={(e) => { e.currentTarget.style.background='linear-gradient(to right, rgba(0, 180, 255, 0.2) 1%, rgba(0, 180, 255, 0.1) 40%, rgba(0, 180, 255, 0.1) 60%, rgba(0, 180, 255, 0.2) 100%)'; e.currentTarget.style.boxShadow='inset 0 0 15px rgba(0, 180, 255, 0.6), 0 0 15px 5px rgba(0, 180, 255, 0.2)'; e.currentTarget.style.transform='scale(1.02)' }} style={{'--blue': `#00B4FF`, fontSize: `15px`, padding: `0.7em 2.7em`, letterSpacing: `0.06em`, position: `relative`, fontFamily: `inherit`, borderRadius: `0.6em`, overflow: `hidden`, lineHeight: `1.4em`, border: `2px solid var(--blue)`, background: `linear-gradient(to right, rgba(0, 180, 255, 0.1) 1%, transparent 40%, transparent 60%, rgba(0, 180, 255, 0.1) 100%)`, color: `var(--blue)`, boxShadow: `rgba(0, 180, 255, 0.4) 0px 0px 10px inset, rgba(0, 180, 255, 0.1) 0px 0px 9px 3px`, cursor: `pointer`}}>
Sign in
</button>
</div>

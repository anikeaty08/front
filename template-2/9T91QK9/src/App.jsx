...
<button className="glow-button w-full py-3 text-white font-medium" onClick={(e) => { selectPlan('starter') }}>
                    Get Started
                </button>
</div>
...
<button className="glow-button w-full py-3 text-white font-medium" onClick={(e) => { selectPlan('pro') }}>
                    Start Pro Trial
                </button>
</div>
...
<button className="glow-button w-full py-3 text-white font-medium" onClick={(e) => { selectPlan('enterprise') }}>
                    Contact Sales
                </button>
</div>
</div>

...
<svg className="lucide lucide-bell h-5 w-5 text-slate-200" data-lucide="bell" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
...
<svg className="lucide lucide-plus h-5 w-5 text-slate-200" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
</div>
</header>
...
<svg className="lucide lucide-chevron-down inline w-[16px] h-[16px]" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(226, 232, 240)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<svg className="lucide lucide-chevron-down inline h-4 w-4" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
...
<svg className="lucide lucide-chevron-down inline h-4 w-4" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button></div>
</div>
...
<div className="relative aspect-[4/3] group" onMouseEnter={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.play().catch(()=>{});} }} onMouseLeave={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.pause(); v.currentTime=0;} }}>
...
<svg className="lucide lucide-heart h-4 w-4" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<article className="group relative overflow-hidden ring-1 ring-white/10 shadow-[0_10px_40px_-10px_rgba(120,80,255,0.35)] transition duration-500 ease-out motion-reduce:transition-none opacity-100 bg-gradient-to-b from-[#7E6ECA]/20 to-[#4F4FB8]/10 rounded-3xl blur-none translate-y-0" onMouseEnter={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.play().catch(()=>{});} }} onMouseLeave={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.pause(); v.currentTime=0;} }} style={{}}>
<div className="relative aspect-[4/3] group" onMouseEnter={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.play().catch(()=>{});} }} onMouseLeave={(e) => { const v=e.currentTarget.querySelector('video'); if(v){v.pause(); v.currentTime=0;} }}>
...
<svg className="lucide lucide-line-chart h-6 w-6" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
...
<svg className="lucide lucide-dollar-sign h-5 w-5" data-lucide="dollar-sign" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><line></line><path></path></svg>
<span>Revenue</span>
</button>

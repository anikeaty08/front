...
<input className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200 placeholder-gray-500" id="callDate" min="2025-09-06" name="date" required type="date" />
</div>
<div>

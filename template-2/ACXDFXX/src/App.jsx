...

{
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/b5cf09cd-cb67-413d-aa02-1b08cd4cf7fb_3840w.jpg")`}}></div>
...
<button className="lg:hidden p-2 rounded-lg hover:bg-slate-800/60 focus-visible:ring-2 focus-visible:ring-blue-400=" height="26" id="mobileMenuBtn" strokeWidth="1.5">
</button>
...
<svg className="lucide lucide-calendar w-4 h-4" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path></svg>
          Book Now
        </a>
</div>
</nav>
...
<img alt="Camping in the Laurentians" className="absolute inset-0 h-full w-full object-cover scale-100 group-hover:scale-105 transition duration-700 z-0" src="/assets/c956db0f-553e-416a-999b-48f537a5aff1_800w.jpg" style={{}} />
...
<div className="glass border-white/20 border rounded-2xl mb-0 pt-2 pr-2 pb-2 pl-2 shadow-2xl" style={{background: `rgba(255, 255, 255, 0.08)`, backdropFilter: `blur(20px) saturate(180%)`, border: `1px solid rgba(255, 255, 255, 0.25)`, boxShadow: `0 25px 50px rgba(0, 0, 0, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.15), inset 0 -1px 0 rgba(0, 0, 0, 0.05)`}}>
...
<img alt="Mont-Tremblant" className="absolute inset-0 h-full w-full object-cover scale-100 group-hover:scale-105 transition duration-500 z-0" src="/assets/5fedd99a-caed-4493-8783-009c7bef7da5_800w.jpg" style={{}} />
...
<svg className="lucide lucide-tent w-[14px] h-[14px] drop-shadow-sm" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `14px`, height: `14px`, color: `rgb(147, 197, 253)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<svg className="lucide lucide-arrow-up-right w-[16px] h-[16px]" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(15, 23, 42)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
</div>
</div>
</div>
...
<img alt="Jacques-Cartier Park" className="absolute inset-0 h-full w-full object-cover group-hover:scale-105 scale-100 transition duration-500 z-0" src="/assets/6e29bd08-f172-468a-9f34-baf96386658d_800w.jpg" />
<div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-900/60 to-transparent"></div>
<div className="glass relative z-10 border-white/15 border rounded-2xl pt-5 pr-5 pb-5 pl-5 shadow-lg" style={{background: `rgba(255, 255, 255, 0.02)`, backdropFilter: `blur(8px) saturate(120%)`, border: `1px solid rgba(255, 255, 255, 0.12)`, boxShadow: `0 25px 50px rgba(0, 0, 0, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -1px 0 rgba(0, 0, 0, 0.1)`}}>
<div className="flex gap-2 mb-3 items-center">
<svg className="lucide lucide-trees w-[18px] h-[18px] text-blue-400 drop-shadow" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-1.5 text-xs text-blue-300/95">
<svg className="lucide lucide-waves w-[14px] h-[14px] drop-shadow-sm" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
<span className="font-sans drop-shadow-sm">River access</span>
</div>
<span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-200/90 group-hover:bg-blue-400 transition text-slate-900 border border-white/70 shadow-lg backdrop-blur-sm">
<svg className="lucide lucide-arrow-up-right w-[16px] h-[16px]" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
</div>
</div>
</div>
...
<div className="glass border-white/15 border rounded-2xl pt-5 pr-5 pb-5 pl-5 shadow-lg" style={{background: `rgba(255, 255, 255, 0.04)`, backdropFilter: `blur(8px) saturate(160%)`, border: `1px solid rgba(255, 255, 255, 0.2)`, boxShadow: `0 8px 32px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)`}}>
<div className="flex gap-2 mb-3 items-center">
<svg className="lucide lucide-waves w-[18px] h-[18px] text-blue-400" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<svg className="lucide lucide-binoculars w-[14px] h-[14px]" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-900/60 to-transparent"></div>
<div className="absolute inset-0 flex flex-col md:p-7 z-10 pt-6 pr-6 pb-6 pl-6 justify-end">
<div className="glass border-white/15 border rounded-2xl pt-5 pr-5 pb-5 pl-5 shadow-lg" style={{background: `rgba(255, 255, 255, 0.01)`, backdropFilter: `blur(8px) saturate(140%)`, border: `1px solid rgba(255, 255, 255, 0.08)`, boxShadow: `0 12px 40px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.05), inset 0 -1px 0 rgba(0, 0, 0, 0.1)`}}>
<div className="flex items-center gap-2 mb-3">
<svg className="lucide lucide-leaf w-[18px] h-[18px] text-green-400" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-1.5 text-xs text-blue-300/90">
<svg className="lucide lucide-camera w-[14px] h-[14px]" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="13"></circle></svg>

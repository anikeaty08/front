...
<button aria-selected="true" className="tab-btn relative h-[42px] flex gap-2 whitespace-nowrap transition-colors aria-selected:text-blue-600 text-sm text-slate-500 pr-3 pl-3 items-center" data-tab-target="assets" role="tab" tabindex="0">
...
<button aria-selected="false" className="tab-btn relative h-[42px] flex gap-2 whitespace-nowrap transition-colors aria-selected:text-blue-600 text-sm text-slate-500 pr-3 pl-3 items-center" data-tab-target="plan" role="tab" tabindex="-1">
...
<button aria-label="View Cash Account summary and holdings, total $120,000" className="inline-flex items-center gap-1 rounded-[6px] border px-2 py-[2px] text-[11px] text-slate-600 border-slate-200 bg-white group-hover:bg-slate-50" onClick={(e) => { window.location.href='/assets/thai-stocks/cash-account' }} type="button">
<span>Cash Account · $120,000</span>
<svg className="lucide lucide-chevron-right w-3 h-3 text-slate-400" data-lucide="chevron-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg>
</button>
<button aria-label="View Credit Balance account summary and holdings, total $16,000" className="inline-flex items-center gap-1 rounded-[6px] border px-2 py-[2px] text-[11px] text-slate-600 border-slate-200 bg-white group-hover:bg-slate-50" onClick={(e) => { window.location.href='/assets/thai-stocks/credit-balance' }} type="button">
...
<section className="space-y-6 hidden" data-tab-panel="plan" role="tabpanel">
...
<svg className="lucide lucide-shield-check w-4.5 h-4.5 text-emerald-500" data-lucide="shield-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg>
                      Drawdown Guard
                    </div>

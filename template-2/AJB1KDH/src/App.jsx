...
<div className="absolute inset-0 pointer-events-none -z-10" style={{background: `radial-gradient(180px 140px at 4% 0%, rgba(59,130,246,0.45), transparent 60%),
...
<div className="group relative overflow-hidden rounded-[28px] border border-white/10 p-8 text-center bg-black/40 hover:border-white/15 transition-all">
<div className="absolute inset-0 pointer-events-none -z-10" style={{background: `radial-gradient(220px 160px at 100% 0%, rgba(251,146,60,0.45), transparent 60%),
...
<div className="group relative overflow-hidden rounded-[28px] border border-white/10 p-8 text-center bg-black/40 hover:border-white/15 transition-all">
<div className="absolute inset-0 pointer-events-none -z-10" style={{background: `radial-gradient(200px 160px at 0% 100%, rgba(139,92,246,0.40), transparent 60%),
...
<div className="group relative overflow-hidden rounded-[28px] border border-white/10 p-8 text-center bg-black/40 hover:border-white/15 transition-all">
<div className="absolute inset-0 pointer-events-none -z-10" style={{background: `radial-gradient(200px 160px at 100% 100%, rgba(45,212,191,0.40), transparent 60%),
...
<div className="absolute inset-0 pointer-events-none" style={{background: `radial-gradient(220px 160px at 10% 0%, rgba(59,130,246,0.25), transparent 60%),
...
<div className="absolute inset-0 pointer-events-none" style={{background: `radial-gradient(220px 160px at 100% 0%, rgba(251,146,60,0.25), transparent 60%),
...
<div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 p-6">
<div className="absolute inset-0 pointer-events-none" style={{background: `radial-gradient(220px 160px at 8% 100%, rgba(139,92,246,0.25), transparent 60%),
...
<div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 p-6">
<div className="absolute inset-0 pointer-events-none" style={{background: `radial-gradient(220px 160px at 100% 100%, rgba(45,212,191,0.25), transparent 60%),

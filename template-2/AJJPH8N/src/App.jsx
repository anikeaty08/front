...
<section className="max-w-7xl bg-pink-100 bg-[url(/assets/4060a9d9-c421-49eb-a925-93468b68c5a6_1600w.jpg)] bg-cover mr-auto ml-auto pt-16 pr-6 pb-16 pl-6" style={{}}>
...
<img alt="Customer enjoying macarons" className="h-full w-full object-cover" data-video-src="https://cdn.midjourney.com/video/13709696-6e08-46d8-812e-33919c76bc32/0.mp4" onLoad={(e) => { (function(img){try{var container=img.parentElement;if(!container)return;var btn=container.querySelector('button');if(!btn)return;if(btn.__auraBound)return;btn.__auraBound=true;btn.addEventListener('click',function(ev){ev.preventDefault();var sel='video[data-aura-video="'+img.id+'"]';var existing=container.querySelector(sel);if(existing){existing.play();btn.style.display='none';return;}var v=document.createElement('video');v.setAttribute('data-aura-video',img.id);v.src=img.getAttribute('data-video-src')||'https://cdn.midjourney.com/video/13709696-6e08-46d8-812e-33919c76bc32/0.mp4';v.autoplay=true;v.controls=true;v.playsInline=true;v.poster=img.currentSrc||img.src;v.className='absolute inset-0 h-full w-full object-cover';container.appendChild(v);btn.style.display='none';});}catch(e){}})(e.currentTarget) }} src="https://cdn.midjourney.com/edcdfcf5-f0e6-43da-83e4-c044a8575e20/0_0.png?w=800&q=80" style={{}} />
...
<article className="min-w-[260px] max-w-[260px] snap-start rounded-2xl overflow-hidden bg-white border border-neutral-200">
<div className="aspect-[9/16] relative">
<img alt="Creator tasting desserts" className="h-full w-full object-cover" data-video-src="https://cdn.midjourney.com/video/71496ca0-1fe7-41ba-be85-5e787966122d/0.mp4" onLoad={(e) => { (function(img){try{var container=img.parentElement;if(!container)return;var btn=container.querySelector('button');if(!btn)return;if(btn.__auraBound)return;btn.__auraBound=true;btn.addEventListener('click',function(ev){ev.preventDefault();var sel='video[data-aura-video="'+img.id+'"]';var existing=container.querySelector(sel);if(existing){existing.play();btn.style.display='none';return;}var v=document.createElement('video');v.setAttribute('data-aura-video',img.id);v.src=img.getAttribute('data-video-src')||'https://cdn.midjourney.com/video/71496ca0-1fe7-41ba-be85-5e787966122d/0.mp4';v.autoplay=true;v.controls=true;v.playsInline=true;v.poster=img.currentSrc||img.src;v.className='absolute inset-0 h-full w-full object-cover';container.appendChild(v);btn.style.display='none';});}catch(e){}})(e.currentTarget) }} src="https://cdn.midjourney.com/79602e58-a1a6-4c2d-9649-560412480b13/0_0.png?w=800&q=80" style={{}} />
<button className="absolute bottom-3 left-3 inline-flex items-center gap-2 rounded-full bg-white/90 backdrop-blur px-3 py-1.5 text-xs font-geist">
...
<article className="min-w-[260px] max-w-[260px] snap-start rounded-2xl overflow-hidden bg-white border border-neutral-200">
<div className="aspect-[9/16] relative">
<img alt="Happy customer with treats" className="h-full w-full object-cover" data-video-src="https://cdn.midjourney.com/video/0b1d0804-f00a-4fdb-b4b5-1b4697238f2f/3.mp4" id="aura-emefey9o8" onLoad={(e) => { (function(img){try{var container=img.parentElement;if(!container)return;var btn=container.querySelector('button');if(!btn)return;if(btn.__auraBound)return;btn.__auraBound=true;btn.addEventListener('click',function(ev){ev.preventDefault();var sel='video[data-aura-video="'+img.id+'"]';var existing=container.querySelector(sel);if(existing){existing.play();btn.style.display='none';return;}var v=document.createElement('video');v.setAttribute('data-aura-video',img.id);v.src=img.getAttribute('data-video-src')||'https://cdn.midjourney.com/video/0b1d0804-f00a-4fdb-b4b5-1b4697238f2f/3.mp4';v.autoplay=true;v.controls=true;v.playsInline=true;v.poster=img.currentSrc||img.src;v.className='absolute inset-0 h-full w-full object-cover';container.appendChild(v);btn.style.display='none';});}catch(e){}})(e.currentTarget) }} src="https://cdn.midjourney.com/3f4c1177-1dbf-4c79-88a4-2bb73b620df3/0_0.png?w=800&q=80" style={{}} />
<button className="absolute bottom-3 left-3 inline-flex items-center gap-2 rounded-full bg-white/90 backdrop-blur px-3 py-1.5 text-xs font-geist">

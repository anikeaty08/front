...
<div className="group relative cursor-pointer focus:outline-none transition-transform hover:scale-110 active:scale-95" draggable="true" onMouseEnter={(e) => { e.currentTarget.classList.add('animate-bounce') }} onMouseLeave={(e) => { e.currentTarget.classList.remove('animate-bounce') }}>
...
<button className="px-8 py-3 bg-gradient-to-tr from-fuchsia-400 via-indigo-400 to-purple-500 text-white font-fun text-lg rounded-full shadow-xl hover:scale-[1.07] transition-all duration-150 blur-[1.5px] hover:blur-0 hover:wiggle focus:outline-none" onClick={(e) => { e.currentTarget.blur(); }}>
          Start Game
        </button>
</div>
</div>

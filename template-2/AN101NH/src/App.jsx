...
<p className="text-3xl font-semibold mb-6">$12<span className="text-base font-normal">/user/mo</span></p>
<ul className="text-sm text-gray-600 space-y-3 flex-1">
<li>Unlimited projects</li>
<li>Moodboards & audio huddles</li>
<li>Version history</li>
<li>Priority support</li>
</ul>
<button className="mt-8 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg transition">Start free trial</button>
</div>

<div className="border border-gray-200 bg-white rounded-2xl shadow-lg p-10 flex flex-col">
<h3 className="text-lg font-medium mb-2">Enterprise</h3>
<p className="text-3xl font-semibold mb-6">Custom</p>
<ul className="text-sm text-gray-600 space-y-3 flex-1">
...
<button className="mt-8 px-6 py-3 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg transition">Contact sales</button>
</div>
</div>
</div>
</section>
...
<a className="text-lg font-semibold tracking-tight flex items-center gap-1" href="#">
<span className="text-indigo-600">L</span><span>oop</span><span className="text-pink-500">w</span><span>ork</span>
</a>
<p className="text-sm text-gray-500">© 2024 Loopwork. All rights reserved.</p>
<div className="flex gap-5">
<a className="hover:text-indigo-600 transition text-sm" href="#">Privacy</a>
<a className="hover:text-indigo-600 transition text-sm" href="#">Terms</a>
<a className="hover:text-indigo-600 transition text-sm" href="#">Security</a>
</div>
</div>
</footer>

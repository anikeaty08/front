...
<a className="inline-flex items-center hover:bg-zinc-800 transition-colors text-sm font-medium text-white bg-zinc-900 rounded-lg pt-1.5 pr-3 pb-1.5 pl-3" data-h="0" href="#" onMouseEnter={(e) => { e.currentTarget.dataset.h='1'; const g=e.currentTarget.querySelector('.cp-border'); if(!g) return; g.style.transition='transform .75s linear'; let dir=0; (function loop(){ if (e.currentTarget.dataset.h!=='1') return; dir = dir===0 ? -25 : 0; g.style.transform='translateX('+dir+'%)'; setTimeout(loop.bind(e.currentTarget),750); }).call(e.currentTarget); }} onMouseLeave={(e) => { e.currentTarget.dataset.h='0'; const g=e.currentTarget.querySelector('.cp-border'); if(!g) return; g.style.transition='transform .25s ease-out'; g.style.transform='translateX(-5%)'; }} style={{position: `relative`, isolation: `isolate`, padding: `3px`, borderRadius: `10px`, overflow: `hidden`, backgroundColor: `transparent`}}>
...
<main className="w-full sm:px-6 bg-[url(/assets/c01b7a18-4c69-46a5-b568-703ee1c983e8_3840w.jpg)] bg-cover pt-8 pr-4 pb-12 pl-4" style={{}}>
...
<div className="card-animate flex flex-col w-full aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-xl group animate-in rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-lg justify-between text-white" style={{backgroundImage: `url('/assets/5f7e5239-1f0b-4f78-b88f-bf3590bb95b7_1600w.jpg')`, backgroundSize: `cover`, backgroundPosition: `center`, backgroundRepeat: `no-repeat`}}>
<div className="space-y-6">
<div className="flex items-center justify-between">
<svg className="lucide lucide-sparkles w-8 h-8 group-hover:scale-110 transition-transform text-rose-100" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
...
<svg className="lucide lucide-check-circle w-4 h-4 text-rose-100" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<div className="flex flex-1 bg-[url(/assets/ddbc2405-ff2e-450d-873a-1fb853ef1299_800w.jpg)] bg-cover border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center border-amber-100" style={{}}>
</div>
...
<div className="flex items-center gap-2">
<span className="font-medium text-xs tracking-wider font-sans">GLOW</span>
<svg className="lucide lucide-check-circle w-4 h-4 text-emerald-100" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<div className="card-animate flex flex-col w-full aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-xl group animate-in border rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-sm backdrop-blur-md justify-between text-zinc-800 bg-white/40 border-zinc-100">
<div className="flex flex-1 bg-[url(/assets/cc8e09b4-f7e4-4778-bb01-2600e5f66527_800w.jpg)] bg-cover border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center border-purple-100" style={{}}>
</div>
<div className="space-y-6 mt-8">
<div className="flex items-center justify-between">
...
<div className="flex items-center gap-2">
<span className="font-medium text-xs tracking-wider font-sans">GLOW</span>
<svg className="lucide lucide-check-circle w-4 h-4 text-violet-100" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<div className="card-animate flex flex-col w-full aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-xl group animate-in border rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-sm backdrop-blur-md justify-between text-zinc-800 bg-white/40 border-zinc-100">
<div className="flex flex-1 bg-[url(/assets/77445677-6c36-4871-8033-3455fbe878f2_800w.jpg)] bg-cover border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center border-rose-100" style={{}}>
</div>
<div className="space-y-6 mt-8">
<div className="flex items-center justify-between">

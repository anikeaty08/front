...
<div className="md:w-2/5 min-h-[200px] md:min-h-[300px] bg-blue-500 bg-cover bg-center relative transition-transform duration-500 ease-out group-hover:scale-103" style={{backgroundImage: `url('https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}>
</div>

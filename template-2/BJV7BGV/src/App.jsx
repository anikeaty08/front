...
<div className="rounded-xl p-4 bg-gray-50 hover:bg-gray-100 cursor-pointer transition-colors" onClick={(e) => { openScoringModal(4,4) }}>
...
<div className="rounded-xl p-4 bg-gray-50 hover:bg-gray-100 cursor-pointer transition-colors" onClick={(e) => { openScoringModal(5,5) }}>
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
<div className="text-center">
...
<div className="rounded-xl p-4 bg-emerald-50 hover:bg-emerald-100 border-2 border-emerald-200 cursor-pointer transition-colors" onClick={(e) => { openScoringModal(6,3) }}>
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
<div className="text-center">
...
<div className="px-6 pb-6">
<button className="w-full rounded-xl py-4 font-semibold flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white" onClick={(e) => { openScoringModal(7,4) }}>
...
<button className="p-2 rounded-full hover:bg-white hover:bg-opacity-20 transition-colors" onClick={(e) => { closeScoringModal() }}>
...
<button className="w-12 h-12 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold text-xl toggle-button" onClick={(e) => { adjustScore(-1) }}>−</button>
<div className="text-center">
...
<button className="mx-auto w-16 h-16 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-2xl text-black toggle-button" id="firButton" onClick={(e) => { toggleFIR() }}>\</button>
</div>
<div className="flex-1 text-center">
<h4 className="text-sm font-semibold mb-3 uppercase text-gray-700 tracking-wide">GIR</h4>
<button className="mx-auto w-16 h-16 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-2xl text-black toggle-button" id="girButton" onClick={(e) => { toggleGIR() }}>\</button>
</div>
</div>
...
<div className="flex items-center justify-center gap-4">
<button className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold" onClick={(e) => { adjustBunkerShots(-1) }}>−</button>
...
<div className="flex items-center justify-center gap-4">
<button className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold" onClick={(e) => { adjustPenaltyShots(-1) }}>−</button>
...
<button className="flex-1 rounded-xl py-3 font-medium bg-gray-100 hover:bg-gray-200 text-gray-700" onClick={(e) => { closeScoringModal() }}>Cancel</button>
<button className="flex-1 rounded-xl py-3 font-medium bg-emerald-600 hover:bg-emerald-700 text-white" onClick={(e) => { saveScore() }}>Save Score</button>
</div>
</div>
</div>
</div>

...
<section className="relative h-[45vh] bg-center bg-cover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1522204507435-9c4a9c4533c6?auto=format&fit=crop&w=1600&q=80')`}}>

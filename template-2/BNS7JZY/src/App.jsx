...
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-for="c1-personne-physique">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-for="c1-auteur-projet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 hover:bg-amber-100 transition" data-menu-for="c2-description">
<i className="w-3.5 h-3.5" data-lucide="alert-triangle"></i> À vérifier
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-for="c2-phasage">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-for="c5-codt">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-red-200 bg-red-50 px-2.5 py-1 text-xs font-medium text-red-700 hover:bg-red-100 transition" data-menu-for="c6-derogation">
<i className="w-3.5 h-3.5" data-lucide="octagon-x"></i> Bloquant
                        </button>

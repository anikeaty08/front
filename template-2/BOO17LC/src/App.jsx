...
<img alt="" className="h-full w-full md:rounded-r-none md:rounded-t-none object-cover rounded-t-3xl" src="/assets/ed1ea47d-a79b-439d-843e-a77b07aface7_1600w.jpg" style={{}} />
</div>

<div className="flex flex-col sm:p-12 lg:p-16 gap-10 bg-[url(/assets/ae1952a3-7b58-4714-9f71-0a11ced366f9_1600w.jpg)] bg-cover pt-8 pr-8 pb-8 pl-8 justify-between animate-slide-right delay-400">
...
<img alt="" className="w-7 h-7 rounded-full ring-2 ring-slate-900 object-cover" src="/assets/5daf7d77-38db-43d6-99ef-765fb11058b4_800w.jpg" style={{}} />
...
<div className="flex flex-col min-h-[420px] lg:col-span-1 text-white bg-slate-900 bg-[url(/assets/6edaf09b-bdf5-452f-a440-01295e678315_800w.jpg)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-xl justify-between animate-scale-fade delay-900">
...
<div className="lg:col-span-1 flex flex-col min-h-[420px] relative overflow-hidden text-white bg-indigo-600 bg-[url(/assets/b8ba6eb9-a1b0-449f-95b8-463faad7dc74_800w.jpg)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-xl justify-between animate-scale-fade delay-1000">
...
<div className="flex flex-col min-h-[420px] lg:col-span-1 bg-white bg-[url(/assets/c8a33d0d-45b6-4e8f-9b55-3d0c0217f032_800w.jpg)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-xl justify-between animate-scale-fade delay-1100">
<div className="space-y-6">

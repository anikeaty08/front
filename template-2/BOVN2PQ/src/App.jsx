...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/f247d190-6625-4a16-a6dc-a811b2c7fb67_3840w.jpg")`}}></div>
...
<img alt="Player" className="w-8 h-8 rounded-full border-2 border-stone-600 object-cover" src="/assets/10b82f02-0664-4276-be7d-8b63b0623907_320w.jpg" style={{}} />
<img alt="Player" className="w-8 h-8 rounded-full border-2 border-stone-600 object-cover" src="/assets/050d676e-cf6b-47b7-8566-cbd7d8333a47_320w.jpg" />
<img alt="Player" className="w-8 h-8 rounded-full border-2 border-stone-600 object-cover" src="/assets/518239d8-7bdd-4f54-964a-b0b7bca838f1_320w.jpg" style={{}} />
<img alt="Player" className="w-8 h-8 rounded-full border-2 border-stone-600 object-cover" src="/assets/eb205ad5-97fe-4855-b28b-05c6a796f20f_320w.jpg" style={{}} />
<img alt="Player" className="w-8 h-8 rounded-full border-2 border-stone-600 object-cover" src="/assets/537f7b5c-c41b-4c0f-8157-3c0dbfce8813_320w.jpg" style={{}} />
</div>
...
<img alt="Soccer training" className="absolute inset-0 w-full h-full object-cover" src="/assets/b2ca5b54-d478-40c0-9c54-a2735e395b78_1600w.jpg" style={{}} />
...
<div className="relative z-10 lg:p-8 flex flex-col h-full bg-[url(/assets/82a21b5e-43c7-450c-853a-3c4966a5e63a_800w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6 justify-between" style={{}}>
...
<div className="relative z-10 lg:p-8 flex flex-col h-full bg-[url(/assets/ee5b36ac-7a97-495e-a6a4-5f9b5b0adcea_800w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6 justify-between" style={{}}>
...
<div className="lg:p-8 grow bg-[url(/assets/10b82f02-0664-4276-be7d-8b63b0623907_800w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6" style={{}}>

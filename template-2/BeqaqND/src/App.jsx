...
<input className="w-10 h-10 -ml-1 -mt-1 cursor-pointer" id="startColor" onInput={(e) => { generateGradient() }} type="color" value="#F5E6AD" />
</div>
<input className="w-24 px-2 py-1 border border-gray-300 rounded" id="startColorText" onInput={(e) => { document.getElementById('startColor').value = e.currentTarget.value; generateGradient() }} type="text" value="#F5E6AD" />
</div>
<div className="flex items-center">
<div className="w-8 h-8 rounded border border-gray-300 mr-2 overflow-hidden">
<input className="w-10 h-10 -ml-1 -mt-1 cursor-pointer" id="endColor" onInput={(e) => { generateGradient() }} type="color" value="#F13C77" />
</div>
<input className="w-24 px-2 py-1 border border-gray-300 rounded" id="endColorText" onInput={(e) => { document.getElementById('endColor').value = e.currentTarget.value; generateGradient() }} type="text" value="#F13C77" />
</div>
<div className="flex items-center">
<label className="mr-2 text-sm" htmlFor="numColors">Number of colors:</label>
<input className="w-16 px-2 py-1 border border-gray-300 rounded" id="numColors" max="20" min="2" onInput={(e) => { generateGradient() }} type="number" value="7" />
</div>
<button className="px-4 py-1 border border-gray-300 rounded hover:bg-gray-100" onClick={(e) => { randomizeColors() }}>
                Random
            </button>
<button className="ml-auto px-4 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 flex items-center" onClick={(e) => { exportPalette() }}>
                Export

...
<button className="mr-3 bg-[#1c1c1c] p-2 rounded-full">
...
<h1 className="text-white text-xl font-medium">Booking Details</h1>
</div>
...
<div className="flex items-center">
<div className="w-12 h-12 bg-[#252525] rounded-full overflow-hidden mr-3">
...
<p className="text-white text-sm">Toyota Camry Hybrid • White</p>
</div>
<div className="text-right">
<p className="text-gray-400 text-xs mb-1">License Plate</p>
<p className="text-white text-sm">SBA 4729G</p>
</div>
</div>
</div>
...
<div>
<p className="text-white text-sm">RideNow Comfort</p>
<p className="text-gray-500 text-xs">Extra legroom, top-rated driver</p>
</div>
</div>
...
<div className="absolute inset-0 opacity-80" style={{backgroundImage: `url('https://api.mapbox.com/styles/v1/mapbox/dark-v10/static/103.8198,1.3521,13,0/600x300?access_token=pk.dummy')`, backgroundSize: `cover`}}></div>

<div className="absolute inset-0 flex items-center justify-center">
<div className="w-[80%] h-1 bg-green-500 rounded-full relative">
...
<div className="w-6 h-6 bg-[#1a1a1a] rounded-full border-2 border-green-500 flex items-center justify-center">
<svg className="w-3 h-3 text-green-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="absolute bottom-3 right-3 bg-[#1a1a1a] bg-opacity-90 rounded-lg px-3 py-2 border border-[#252525]">
<p className="text-white text-xs font-medium">Arriving in 2 mins</p>
<p className="text-gray-400 text-xs">12:45 PM</p>
</div>
</div>
<div className="p-4">
...
<div className="w-0.5 h-10 bg-gray-700 mx-auto my-1"></div>
<div className="w-3 h-3 rounded-full bg-red-500"></div>
</div>
<div className="flex-1">
<div className="mb-3">
<p className="text-gray-400 text-xs">Pickup location</p>
<p className="text-white text-sm">123 Main Street, Downtown</p>
</div>
<div>
<p className="text-gray-400 text-xs">Destination</p>
<p className="text-white text-sm">Central Business District, Tower 3</p>
</div>
</div>
</div>
...
<div>
<p className="text-white text-sm">Estimated Trip Time</p>
<p className="text-gray-400 text-xs">12 minutes • 5.8 km</p>
</div>
</div>
<span className="text-white text-sm font-medium">12:57 PM</span>
</div>
</div>
</div>
</div>
...
<p className="text-white text-sm">$12.50</p>
</div>
<div className="flex justify-between items-center">
<p className="text-gray-400 text-sm">Comfort service</p>
<p className="text-white text-sm">$2.00</p>
</div>
<div className="flex justify-between items-center">
<p className="text-gray-400 text-sm">Peak hour surcharge</p>
<p className="text-white text-sm">$1.30</p>
</div>
<div className="flex justify-between items-center">
<p className="text-gray-400 text-sm">Booking fee</p>
<p className="text-white text-sm">$0.00</p>
</div>
<div className="border-t border-[#252525] pt-2 mt-2">
<div className="flex justify-between items-center">
...
<button className="bg-[#252525] hover:bg-[#303030] text-white font-medium py-4 rounded-xl transition duration-200 flex items-center justify-center">
...
<button className="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-4 rounded-xl transition duration-200 mb-6">
        Cancel Ride
      </button>
</div>

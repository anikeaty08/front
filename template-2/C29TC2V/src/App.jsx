...
<img alt="" className="col-span-2 row-span-2 w-full h-full object-cover" src="/assets/abb07eeb-b372-46b7-8e0b-15e0522a465f_800w.jpg" style={{}} />
<img alt="" className="w-full h-full object-cover" src="/assets/5a8b15b5-e61b-4c25-bdb7-fe972df7fe45_320w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/ef020f3d-5097-4840-a617-2997e6cdad6e_320w.jpg" />
</div>
...
<img alt="" className="col-span-2 row-span-2 w-full h-full object-cover" src="/assets/df7165d2-bcb9-4827-b502-3489c3ae16a2_800w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/489e6f55-4412-442e-bdaf-7f484900e708_320w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/00c49c51-b2f7-421e-bba1-ff3df1af734f_320w.jpg" style={{}} />
</div>
...
<article className="w-80 shrink-0">
<div className="grid grid-cols-3 grid-rows-2 h-48 gap-0.5 rounded-xl overflow-hidden">
<img alt="" className="col-span-2 row-span-2 w-full h-full object-cover" src="/assets/26832f9e-37e2-475e-ad52-1cbaedf724ea_800w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/448aceb8-23eb-4731-b45a-2ef0d01382ff_320w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/2cd768e7-ecfe-40cd-ab23-1e0a62b36ed9_320w.jpg" />
</div>
...
<article className="w-80 shrink-0">
<div className="grid grid-cols-3 grid-rows-2 h-48 gap-0.5 rounded-xl overflow-hidden">
<img alt="" className="col-span-2 row-span-2 w-full h-full object-cover" src="/assets/16e0bbc9-74d7-4a0a-b5a5-8c32f537825c_800w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/e86c3104-8199-47cc-b038-e03c9379dc06_320w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/a8e9bf8b-f280-490f-8aad-54be215b6433_320w.jpg" />
</div>
...
<article className="w-80 shrink-0">
<div className="grid grid-cols-3 grid-rows-2 h-48 gap-0.5 rounded-xl overflow-hidden">
<img alt="" className="col-span-2 row-span-2 w-full h-full object-cover" src="/assets/71da56cd-3bf3-436f-a7c3-3a6f9672ca78_800w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/f09193c9-6355-4bd1-b913-9c5728e4dd03_320w.jpg" />
<img alt="" className="w-full h-full object-cover" src="/assets/eb724d1c-3844-4a38-b93d-5dc2355546bc_320w.jpg" />
</div>
...
<div className="relative">
<img alt="Modern interior" className="w-full h-auto object-cover" src="/assets/c8f607a9-ba3f-4a7c-badb-cf0ecbf0c2ef_800w.jpg" style={{}} />
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Mountain View" className="w-full h-auto object-cover" src="/assets/1a40bff5-bbf9-4bda-b05d-e479626177de_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Modern interior" className="w-full h-auto object-cover" src="/assets/48933b0d-af9c-47d1-bdc1-e0133dfc4f97_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Interior Design" className="w-full h-auto object-cover" src="/assets/1c7bb6b6-6dc6-4648-bf8d-2108fd09ab1c_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Nature" className="w-full h-auto object-cover" src="/assets/defe56a1-14e2-45ae-937e-80a44411e48a_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Fashion" className="w-full h-auto object-cover" src="/assets/1ba266bd-81e8-4c6b-b290-bdcb56dc9f72_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Technology" className="w-full h-auto object-cover" src="/assets/65e5d0f0-a5eb-4753-82ae-6c1026ca3333_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>
...
<div className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-[#393D5E] rounded-2xl shadow-sm">
<div className="relative">
<img alt="Travel" className="w-full h-auto object-cover" src="/assets/72c0a942-8db1-4109-b875-9ccb3cee3299_800w.jpg" style={{}} />
<div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="hover:bg-purple-300 text-sm font-medium text-black font-geist bg-purple-50 rounded-full pt-2 pr-4 pb-2 pl-4">Collect</button>
</div>
</div>

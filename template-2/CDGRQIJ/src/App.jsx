...
<input className="otp h-12 w-10 sm:w-12 text-center text-lg rounded-md border border-neutral-200 focus:ring-2 focus:ring-amber-300 outline-none" maxlength="1" /></div>
<div className="flex items-center justify-between">

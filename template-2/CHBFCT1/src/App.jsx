...
<button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 rounded-xl font-medium transition-colors" onClick={(e) => { showModal('pricing') }}>Get Started</button>
</div>
...
<button className="mt-4 text-gray-500 hover:text-gray-700 text-sm" onClick={(e) => { hideModal() }}>Maybe later</button>
</div>
</div>
</div>

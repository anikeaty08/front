...
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">Websites</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">Digital Marketing</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">About</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">Our Work</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">Learn</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/90 tracking-tight" href="#">Contact</a>
</div>

...
<svg className="mr-2 w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="circle-arrow-left" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path><path></path></svg>
              Get Started
            </a>
</nav>
...
<img alt="Small business team collaborating in an office" className="w-full h-full object-cover" src="/assets/2834e6e0-db44-4c9f-b6b1-0413fe287ad7_800w.jpg" />
...
<svg className="w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="cog" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `20px`, height: `20px`, color: `rgb(211, 146, 54)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</div>
...
<svg className="w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="badge-alert" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `20px`, height: `20px`, color: `rgb(211, 146, 54)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path className=""></path><line></line><line></line></svg>
</div>
...
<svg className="w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="eclipse" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `20px`, height: `20px`, color: `rgb(211, 146, 54)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12"></circle><path className=""></path></svg>
</div>
...
<form className="space-y-4" onSubmit={(e) => { event.preventDefault(); fakeSubmit(); }}>
...
<a href="#">Status</a>
<a className="inline-flex items-center hover:text-slate-300" href="#" style={{}}><i className="w-4 h-4 mr-1.5" strokeWidth="1.5"></i>Twitter</a><i className="w-4 h-4 mr-1.5" data-lucide="linkedin"></i>LinkedIn
            </div>
</div>
</div>
</footer>

...
window.addEventListener('load', disableHashLinks);
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/88d0cc0d-1d53-470c-81f5-3eb5328e26e6_3840w.jpg")`}}></div>
...
<img alt="Store locations map" className="w-full h-full object-cover rounded-xl pt-30 pb-30" src="/assets/84cd85d8-c9c1-4c8d-b0af-92e54afbcccf_1600w.jpg" />

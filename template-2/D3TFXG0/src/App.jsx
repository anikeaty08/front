...
<path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#10b981" strokeDasharray="75, 100" strokeWidth="2"></path>
</svg>
...
<button className="py-4 border-b-2 border-blue-600 text-blue-600 font-medium" onClick={(e) => { showTab('seo') }}>SEO Analysis</button>
<button className="py-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700" onClick={(e) => { showTab('performance') }}>Performance</button>
<button className="py-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700" onClick={(e) => { showTab('accessibility') }}>Accessibility</button>
</nav>
</div>

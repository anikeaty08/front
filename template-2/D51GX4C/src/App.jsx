...
<button className="flex-1 px-3 py-2 text-sm bg-primary-50 text-primary-300 rounded-lg hover:bg-primary-100 transition-colors" onClick={(e) => { openReportModal('performance') }}>
                                    View Report
                                </button>
...
<div className="flex gap-2 pt-4 border-t border-gray-100">
<button className="flex-1 px-3 py-2 text-sm bg-success-50 text-success-500 rounded-lg hover:bg-success-100 transition-colors" onClick={(e) => { openReportModal('seo') }}>
                                    View Report
                                </button>
<button className="p-2 text-gray-500 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">
<i className="w-4 h-4" data-lucide="download" style={{strokeWidth: `1.5`}}></i>
...
<div className="flex gap-2 pt-4 border-t border-gray-100">
<button className="flex-1 px-3 py-2 text-sm bg-warning-50 text-warning-500 rounded-lg hover:bg-warning-100 transition-colors" onClick={(e) => { openReportModal('accessibility') }}>
                                    View Report
                                </button>
<button className="p-2 text-gray-500 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">
<i className="w-4 h-4" data-lucide="download" style={{strokeWidth: `1.5`}}></i>
...
<button className="p-2 text-gray-500 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors" onClick={(e) => { closeReportModal() }}>
...
<circle className="transition-all duration-1000" cx="48" cy="48" fill="none" r="40" stroke="#10B981" strokeDasharray="251.2" strokeDashoffset="15.072" strokeWidth="8"></circle>
</svg>

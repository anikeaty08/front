...
<div className="relative flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.06] px-3 py-2.5 shadow-[0_6px_24px_-10px_rgba(0,0,0,0.6)] hover:bg-white/[0.08] transition cursor-pointer" onClick={(e) => { editInvestment(1) }}>
...
<div className="relative flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.06] px-3 py-2.5 shadow-[0_6px_24px_-10px_rgba(0,0,0,0.6)] hover:bg-white/[0.08] transition cursor-pointer" onClick={(e) => { editInvestment(2) }}>

...
<button aria-pressed="true" className="relative px-6 py-2 rounded-full text-sm font-semibold transition-all duration-200 focus:outline-none bg-gradient-to-t from-[#a78bfa] to-[#6d28d9] text-white shadow hover:scale-[1.05] z-10" id="monthlyBtn" onClick={(e) => { setPricing('monthly') }}>
        Monthly
      </button>
<button aria-pressed="false" className="relative px-6 py-2 rounded-full text-sm font-semibold transition-all duration-200 focus:outline-none text-gray-300 hover:text-white hover:bg-[#23242b]" id="annualBtn" onClick={(e) => { setPricing('annual') }}>
        Annual
      </button>
</div>
</div>
...
<svg className="w-3 h-3 text-[#181925] fill-current" viewBox="0 0 16 16"><path clip-rule="evenodd" d="M12.416 3.376a.75.75 0 0 1 .208 1.04l-5 7.5a.75.75 0 0 1-1.154.114l-3-3a.75.75 0 0 1 1.06-1.06l2.353 2.353 4.493-6.74a.75.75 0 0 1 1.04-.207Z" fillRule="evenodd"></path></svg>
</span>

...
<section className="overflow-hidden bg-[url(/assets/77bd7788-e487-4f4b-85a6-ea90f9910cba_3840w.jpg)] bg-cover">
...
<img alt="lunia Premium Bottle" className="w-64 sm:w-72 lg:w-80 rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-500 object-cover" src="/assets/2784faff-d788-4235-bebb-56ba24f098e5_800w.jpg" />
<img alt="Premium Packaging" className="absolute -right-8 sm:-right-16 top-8 sm:top-10 w-48 sm:w-56 lg:w-60 rounded-2xl shadow-xl hidden sm:block hover:scale-105 transition-transform duration-500 object-cover" src="/assets/f46bf9c9-3ce5-43c1-a422-b4c4c739a6c2_800w.jpg" />
<div className="absolute -left-8 bottom-12 bg-white rounded-xl p-4 shadow-lg hidden lg:block">
<div className="flex items-center space-x-3">
<div className="flex -space-x-2">
<img alt="" className="h-8 w-8 rounded-full border-2 border-white object-cover" src="/assets/c82d6765-7e5d-4e81-855c-94793e2d63d2_320w.jpg" />
<img alt="" className="h-8 w-8 rounded-full border-2 border-white object-cover" src="/assets/81508906-af60-495c-ac86-8039b3832a33_320w.jpg" />
<img alt="" className="h-8 w-8 rounded-full border-2 border-white object-cover" src="/assets/f052416b-2c41-4a53-9029-20675c1cdfde_320w.jpg" />
</div>
<div>
...
<section className="bg-gray-50 bg-[url(/assets/75bdb8aa-4ca3-4822-b868-8421e8198cf3_3840w.jpg)] bg-cover">
...
<div className="slide-up">
<img alt="Laboratory Research" className="rounded-2xl shadow-lg w-full object-cover" src="/assets/9afffd05-f2bb-4dcc-9335-d6e64dce4dcc_800w.jpg" />
</div>
<div className="slide-up stagger-1">
...
<img alt="" className="h-12 w-12 rounded-full object-cover" src="/assets/234b921f-c187-4467-9f59-7a0f8b5377fd_320w.jpg" />
<div>
...
<div className="flex items-center space-x-4">
<img alt="" className="h-12 w-12 rounded-full object-cover" src="/assets/fdc7194d-1cb7-4c85-a5d0-657d7429fa51_320w.jpg" />
<div>
...
<div className="flex items-center space-x-4">
<img alt="" className="h-12 w-12 rounded-full object-cover" src="/assets/db93d327-6f7a-44ef-afb5-149848109b3c_320w.jpg" />
<div>
...
<section className="bg-[url(/assets/a25f66d8-000a-4af7-a213-b609071d4281_3840w.jpg)] bg-cover">

...
<main className="container max-w-5xl flex flex-col md:flex-row gap-8">

<section className="bg-blue-200 rounded-3xl p-8 flex flex-col justify-center md:w-1/2">
...
<h1 className="text-3xl md:text-4xl font-bold text-center mb-4">This is Your New Classroom</h1>
<p className="text-center text-lg mb-6">Intuitive drag and drop block-based builder. Choose between hundreds of templates.</p>
</section>

<section className="md:w-1/2 flex flex-col gap-6">

<div className="bg-white rounded-3xl p-6 shadow-md flex items-center">
...
<div>
<h2 className="text-xl font-bold text-blue-900 mb-1">Create an account</h2>
<p className="text-gray-600">Simply sign up and your online training platform is up and running.</p>
</div>
</div>
...
<div>
<h2 className="text-xl font-bold text-blue-900 mb-1">Upload content</h2>
<p className="text-gray-600">Start by adding your existing learning materials: presentations, PDFs, Word docs, guidelines, videos.</p>
</div>
</div>
<button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-lg w-full transition duration-300 uppercase">Upload Now</button>
</div>
</section>
</main>

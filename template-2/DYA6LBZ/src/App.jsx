...
<div style={{width: `100%`, maxWidth: `48rem`, background: `linear-gradient(to bottom, #f7f1ee, #f7f7ee)`, borderRadius: `1rem`, boxShadow: `0 10px 15px -3px rgba(0, 0, 0, 0.1),
        0 4px 6px -4px rgba(0, 0, 0, 0.1)`, display: `flex`, flexDirection: `column`, position: `relative`}}>
...
<footer className="fade-after-logo" style={{padding: `1.25rem`, textAlign: `center`, fontSize: `0.875rem`, color: `#6b7280`, opacity: `0`, transition: `opacity 1.2s ease`}}>

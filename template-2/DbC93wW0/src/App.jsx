...
<div className="shooting-star" style={{top: `30%`, left: `20%`, animationDelay: `0s`}}>
<div className="star-tail"></div>
</div>

<div className="shooting-star" style={{top: `60%`, left: `40%`, animationDelay: `2s`}}>
<div className="star-tail"></div>
</div>

<div className="relative z-10 h-full flex flex-col justify-between p-6">
<div>
<h3 className="text-white text-xl font-semibold tracking-wider">COSMIC JOURNEY</h3>
<p className="text-gray-400 mt-2 text-sm">Explore the night sky</p>
</div>
<div className="border-t border-gray-700 pt-4">
<p className="text-gray-300 text-sm">The universe is full of magical things patiently waiting for our wits to grow sharper.</p>

...
<p className="text-indigo-600 italic text-lg mb-1">Alex,</p>
<p className="text-indigo-900 font-bold text-xl mb-3">YOUR FLIGHT IS IN 3 DAYS</p>
...
<path clip-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" fillRule="evenodd"></path>
</svg>
</button>
</div>
...
<p className="text-indigo-900 font-bold text-2xl">DFW</p>
<p className="text-gray-500 text-sm">06:30</p>
</div>
<div className="flex flex-col items-center">
<svg className="h-5 w-5 text-gray-400 mb-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M21.5,16.5H18.75a1,1,0,0,1-.66-.25l-1.59-1.4V16.5h-7.5V14.86L7.41,16.25a1,1,0,0,1-.66.25H3.5a1,1,0,0,1-1-1v-4a1,1,0,0,1,1-1H6.75a1,1,0,0,1,.66.25L9,12.14V10.5h7.5v1.64l1.59-1.39a1,1,0,0,1,.66-.25H21.5a1,1,0,0,1,1,1v4A1,1,0,0,1,21.5,16.5Z"></path>
</svg>
<p className="text-gray-600 font-bold text-xs">3 h 45 min</p>
</div>
<div className="text-center">
<p className="text-indigo-900 font-bold text-2xl">MIA</p>
<p className="text-gray-500 text-sm">10:15</p>
</div>
</div>
<div className="flex justify-between items-center mt-6">
<div>
<p className="text-gray-500 text-xs mb-1">Flight number</p>
<p className="text-gray-700 font-medium">AA 2198</p>
</div>
<div>
<p className="text-gray-500 text-xs mb-1">Class</p>
<p className="text-gray-700 font-medium">Premium</p>
</div>
<div>
<p className="text-gray-500 text-xs mb-1">Date</p>
<p className="text-gray-700 font-medium">Jun 15</p>
</div>
</div>
</div>
...
<p className="text-gray-600 font-bold text-xs">7 h 20 min</p>
</div>
<div className="text-center">
<p className="text-indigo-900 font-bold text-2xl">DXB</p>
<p className="text-gray-500 text-sm">22:05</p>
</div>
</div>
<div className="flex justify-between items-center mt-6">
<div>
<p className="text-gray-500 text-xs mb-1">Flight number</p>
<p className="text-gray-700 font-medium">AF 456</p>
</div>
<div>
<p className="text-gray-500 text-xs mb-1">Class</p>
<p className="text-gray-700 font-medium">Business</p>
</div>
<div>
<p className="text-gray-500 text-xs mb-1">Date</p>
<p className="text-gray-700 font-medium">Jul 3</p>
</div>
</div>
</div>
...
<div className="flex justify-between items-center mb-2">
<div className="text-center">
<p className="text-indigo-900 font-bold text-2xl">HND</p>
<p className="text-gray-500 text-sm">09:20</p>
</div>
<div className="flex flex-col items-center">
<svg className="h-5 w-5 text-gray-400 mb-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M21.5,16.5H18.75a1,1,0,0,1-.66-.25l-1.59-1.4V16.5h-7.5V14.86L7.41,16.25a1,1,0,0,1-.66.25H3.5a1,1,0,0,1-1-1v-4a1,1,0,0,1,1-1H6.75a1,1,0,0,1,.66.25L9,12.14V10.5h7.5v1.64l1.59-1.39a1,1,0,0,1,.66-.25H21.5a1,1,0,0,1,1,1v4A1,1,0,0,1,21.5,16.5Z"></path>
</svg>
<p className="text-gray-600 font-bold text-xs">5 h 40 min</p>
</div>
<div className="text-center">
<p className="text-indigo-900 font-bold text-2xl">ICN</p>
...
<div>
<p className="text-gray-500 text-xs mb-1">Flight number</p>
<p className="text-gray-700 font-medium">NH 864</p>
</div>
<div>
<p className="text-gray-500 text-xs mb-1">Class</p>
...
<div>
<p className="text-gray-500 text-xs mb-1">Date</p>
<p className="text-gray-700 font-medium">Aug 21</p>
</div>
</div>
</div>
</div>
...
<span className="text-xs text-gray-500 mt-1">Flights</span>
</div>
<div className="flex flex-col items-center">
<svg className="h-6 w-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

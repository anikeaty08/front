...
<div className="mt-4 rounded-xl border border-white/10 bg-gradient-to-b from-white/0 to-white/[0.03] p-2">
<div absolute="" className="relative h-20 <div class=">
<div className="h-full w-full">
...
<div className="mt-4 h-24 overflow-hidden rounded-xl border border-white/10 bg-white/5" style={{backgroundImage: `url('https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=1200&auto=format&fit=crop')`, backgroundSize: `cover`, backgroundPosition: `center`}}></div>
</div>
</section></main></div>

...
<header className="h-screen bg-fixed bg-center bg-cover flex items-center justify-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1519682337058-a94d519337bc?auto=format&fit=crop&w=1400&q=80')`}}>
...
<section className="h-screen bg-fixed bg-center bg-cover flex items-end" style={{backgroundImage: `url('https://images.unsplash.com/photo-1533055640609-bc8e33e033d4?auto=format&fit=crop&w=1400&q=80')`}}>
...
<section className="h-screen bg-fixed bg-center bg-cover flex items-end" style={{backgroundImage: `url('https://images.unsplash.com/photo-1515023115689-589c94056163?auto=format&fit=crop&w=1400&q=80')`}}>
<div className="w-full bg-gradient-to-t from-neutral-900/80 to-transparent py-12 px-6">
<h3 className="text-2xl md:text-3xl font-semibold" data-aos="fade-up">Paris | Rain-soaked Alleyways</h3>
</div>
</section>

<section className="h-screen bg-fixed bg-center bg-cover flex items-end" style={{backgroundImage: `url('https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1400&q=80')`}}>
<div className="w-full bg-gradient-to-t from-neutral-900/80 to-transparent py-12 px-6">

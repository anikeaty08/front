...
<div className="md:p-8 ring-white/10 text-white bg-black bg-[url(/assets/f6fde9e4-e981-4763-98e7-63ee9ff8d84f_1600w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6" style={{backgroundColor: `rgb(0, 0, 0)`, color: `rgb(230, 238, 248)`, backdropFilter: `blur(8px)`}}>
...
<div className="relative">
<img alt="Modern workspace" className="w-full h-36 object-cover rounded-xl ring-1 ring-black/5" src="/assets/0a0b9575-3354-4375-82b0-d9c58b57c504_800w.jpg" />
<div className="absolute inset-0 bg-black/40 rounded-xl flex items-center justify-center">
<div className="text-white text-center">
...
<article className="relative overflow-hidden ring-1 ring-black/5 text-white bg-gray-900 bg-[url(/assets/046f0e74-64ae-4e71-ae2d-67940e33e9bc_1600w.jpg)] bg-cover rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-sm" style={{}}>
<div className="flex items-center justify-between">
...
<div className="flex items-start gap-3">
<img alt="Marcus Rodriguez" className="w-10 h-10 object-cover rounded-full" src="/assets/b1c1e147-5d35-4171-9f02-24e269c2c8b3_320w.jpg" style={{}} />
<div className="flex-1">
<div className="flex items-center gap-1 mb-2">
<svg className="w-4 h-4 text-amber-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
<svg className="w-4 h-4 text-amber-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 17.27 18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
...
<form className="mt-4 flex items-center gap-2" onSubmit={(e) => { event.preventDefault(); }}>

...
<button className="btn-scale-hover transition-all duration-150 shadow w-full h-12 rounded-lg bg-[#4F46E5] text-white text-[15px] font-semibold mt-1" onClick={(e) => { window.location.href='#' }}>
        Begin Your Journey
      </button>
</div>
</div>

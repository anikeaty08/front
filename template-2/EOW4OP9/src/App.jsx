...
<button className="text-xs bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded text-white" onClick={(e) => { randomizeEffect() }}>Randomize</button>
</div>
</div>
...
<div className="absolute inset-0 opacity-30 mix-blend-overlay" style={{backgroundImage: `radial-gradient(circle at 20% 30%, rgba(255,0,255,0.3) 0%, transparent 50%),
                ...
                radial-gradient(circle at 90% 20%, rgba(255,100,0,0.3) 0%, transparent 50%)`, animation: `plasma2 30s ease-in-out infinite`}}>
</div>

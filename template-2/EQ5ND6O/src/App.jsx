...
<div className="flex items-center gap-3">
<button className="h-11 flex-1 rounded-lg border border-white/10 bg-neutral-800/70 hover:bg-neutral-800 active:bg-neutral-800/80 transition text-sm text-neutral-300" type="button">
                Preview
              </button>

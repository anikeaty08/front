...
<div className="group rounded-lg border border-slate-200 hover:border-slate-300 bg-white p-3 transition-colors">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
...
<button className="text-xs text-slate-700 hover:text-slate-900 underline">Voir les sources</button>
</div>
</div>
...
<span className="claim inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-800" data-claim-id="c1" data-confidence="0.78" data-type="fait">
<i className="w-3.5 h-3.5 text-emerald-600" data-lucide="check-circle-2"></i> ITE 12 cm en façade rue
                      <span className="ml-1 rounded bg-emerald-50 text-emerald-700 border border-emerald-200 px-1.5 py-0.5 text-[10px]">fait</span>
</span>
<span className="claim inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-800" data-claim-id="c2" data-confidence="0.66" data-type="fait">
<i className="w-3.5 h-3.5 text-emerald-600" data-lucide="check-circle-2"></i> Peinture châssis gris quartz
                      <span className="ml-1 rounded bg-emerald-50 text-emerald-700 border border-emerald-200 px-1.5 py-0.5 text-[10px]">fait</span>
</span>
<span className="claim inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-800" data-claim-id="c3" data-confidence="0.85" data-type="fait">
<i className="w-3.5 h-3.5 text-emerald-600" data-lucide="check-circle-2"></i> Véranda non chauffée
                      <span className="ml-1 rounded bg-emerald-50 text-emerald-700 border border-emerald-200 px-1.5 py-0.5 text-[10px]">fait</span>
</span>
<span className="claim inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-800" data-claim-id="c4" data-confidence="0.52" data-type="opinion">
<i className="w-3.5 h-3.5 text-amber-600" data-lucide="help-circle"></i> Pas de modification de l’enveloppe
                      <span className="ml-1 rounded bg-amber-50 text-amber-700 border border-amber-200 px-1.5 py-0.5 text-[10px]">opinion</span>
</span>
</div>
...
<button className="text-xs text-slate-700 hover:text-slate-900 underline">Voir les extraits</button>
</div>
</div>
...
<li>Pas de modification de l’enveloppe: BASTIN, DEVOS</li>
<li>Véranda non chauffée + châssis existants maintenus: VOSS</li>
</ul>
...
<span className="text-xs text-slate-500">ROUSSEAU p.5–7</span>
</div>
<ul className="mt-2 space-y-2 text-sm">
<li className="annex-item flex items-center justify-between gap-2" data-group="rousseau">
<button aria-label="Cocher" className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50">
<i className="w-3 h-3 text-transparent" data-lucide="check"></i>
</button>
<div className="flex-1">Vues en plan</div>
...
<li className="annex-item flex items-center justify-between gap-2" data-group="rousseau">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
<div className="flex-1">Coupes</div>
<button className="inline-flex items-center gap-1 text-xs text-slate-700 hover:text-slate-900"><i className="w-3.5 h-3.5" data-lucide="paperclip"></i> Joindre</button>
</li>
<li className="annex-item flex items-center justify-between gap-2" data-group="rousseau">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
...
<span className="text-xs text-slate-500">DEVOS</span>
</div>
<ul className="mt-2 space-y-2 text-sm">
<li className="annex-item flex items-center justify-between gap-2" data-group="devos">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
...
<li className="annex-item flex items-center justify-between gap-2" data-group="devos">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
<div className="flex-1">Reportage photo</div>
<button className="inline-flex items-center gap-1 text-xs text-slate-700 hover:text-slate-900"><i className="w-3.5 h-3.5" data-lucide="paperclip"></i> Joindre</button>
</li>
<li className="annex-item flex items-center justify-between gap-2" data-group="devos">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
...
<span className="text-xs text-slate-500">VOSS</span>
</div>
<ul className="mt-2 space-y-2 text-sm">
<li className="annex-item flex items-center justify-between gap-2" data-group="voss">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
...
<span className="text-xs text-slate-500">DONDZA</span>
</div>
<ul className="mt-2 space-y-2 text-sm">
<li className="annex-item flex items-center justify-between gap-2" data-group="dondza">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
<div className="flex-1">Occupation de la parcelle</div>
<button className="inline-flex items-center gap-1 text-xs text-slate-700 hover:text-slate-900"><i className="w-3.5 h-3.5" data-lucide="paperclip"></i> Joindre</button>
</li>
<li className="annex-item flex items-center justify-between gap-2" data-group="dondza">
<button className="annex-check w-5 h-5 rounded-md border border-slate-300 grid place-items-center hover:bg-slate-50"><i className="w-3 h-3 text-transparent" data-lucide="check"></i></button>
...
<div>
                      Contradiction détectée: “pas de modif enveloppe” mais “coupes cotées” cochées. Vérifier la cohérence (pattern ROUSSEAU vs DEVOS).
                    </div>
</div>
</div>
</div>
...
<div className="space-y-3" id="verify-list">

<div className="verify-card rounded-lg border border-slate-200 bg-white p-3" data-point-id="p1" data-severity="bloquant">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
...
<div className="verify-card rounded-lg border border-slate-200 bg-white p-3" data-point-id="p2" data-severity="arevoir">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
...
<div className="verify-card rounded-lg border border-slate-200 bg-white p-3" data-point-id="p3" data-severity="fyi">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
...
<div className="verify-card rounded-lg border border-slate-200 bg-white p-3" data-point-id="p4" data-severity="arevoir">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<i className="w-4 h-4 text-amber-600" data-lucide="alert-triangle"></i>
...
<button className="w-full mt-4 inline-flex items-center justify-center gap-2 rounded-lg bg-slate-900 text-white px-4 py-3 text-sm hover:bg-slate-800" id="validate-all">

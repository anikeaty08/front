...
blurIn: { '0%': { opacity: '0', filter: 'blur(10px)' }, '100%': { opacity: '1', filter: 'blur(0)' } }
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center z-[-1]" id="aura-image" style={{backgroundImage: `url("https://images.unsplash.com/photo-1508615070457-7baeba4003ab?w=3840&q=80")`}}></div>

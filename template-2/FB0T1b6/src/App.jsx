...
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#635BFF" r="20"></circle>
...
<div className="feature-card">
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#0A2540" r="20"></circle>
...
<div className="feature-card">
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1559526324-4b87b5e36e44?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#00D4FF" r="20"></circle>
...
<div className="feature-card">
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1544197150-b99a580bb7a8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#ED5F74" r="20"></circle>
...
<div className="feature-card">
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1576224731050-fbde3f3d69d7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#74E4A2" r="20"></circle>
...
<div className="feature-card">
<div className="feature-graphic p-8 flex items-center justify-center bg-[#f6f9fc]">
<div className="feature-graphic-bg" style={{backgroundImage: `url('https://images.unsplash.com/photo-1507608869274-d3177c8bb4c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="icon-wrapper">
<div className="icon icon-solid"></div>
<div className="icon">
<div className="icon-logo">
<svg fill="none" height="40" viewBox="0 0 40 40" width="40" xmlns="http://www.w3.org/2000/svg">
<circle cx="20" cy="20" fill="#9A66FF" r="20"></circle>
<rect height="16" rx="2" stroke="white" strokeWidth="2" width="16" x="12" y="12"></rect>
<path d="M16 20H24" stroke="white" strokeLinecap="round" strokeWidth="2"></path>
<path d="M20 16V24" stroke="white" strokeLinecap="round" strokeWidth="2"></path>
</svg>
</div>
</div>
<div className="icon-label">Atlas</div>
</div>
</div>
<div className="p-8">
...
<a className="inline-block px-8 py-4 bg-[var(--linkColor)] hover:bg-[#4b44c2] text-white font-medium rounded-lg transition-colors" href="#">
        View all features
      </a>
</div>
</div>

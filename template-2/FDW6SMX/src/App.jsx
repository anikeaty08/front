...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      function updateDots() {
        ...
        for (let i = 0; i < total; i++) {
          ...
          b.className = 'h-2.5 w-2.5 rounded-full border ' + (i === index ? 'bg-neutral-100 border-neutral-100' : 'bg-neutral-800 border-neutral-700');
      ...
      window.addEventListener('resize', () => {
        ...
        slideWidth = computeSlideWidth();
        if (Math.abs(slideWidth - old) > 1) {
          moveToIndex();
        }
      });

      [prevBtn, prevBtnM].forEach(btn => btn && btn.addEventListener('click', () => { prev(); startAutoplay(); }));
      [nextBtn, nextBtnM].forEach(btn => btn && btn.addEventListener('click', () => { next(); startAutoplay(); }));
...
<a className="text-[14px] font-medium text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#">Home</a>
<a className="text-[14px] font-medium text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#gallery">Gallery</a>
<a className="text-[14px] font-medium text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#about">About</a>
<a className="text-[14px] font-medium text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#commissions">Commissions</a>
<a className="text-[14px] font-medium text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#contact">Contact</a>
</nav>

<div className="hidden md:flex items-center gap-3">
<a className="inline-flex items-center gap-2 rounded-md border border-neutral-800 bg-neutral-900 px-3.5 py-2 text-[14px] font-medium text-neutral-100 hover:border-neutral-700 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#gallery">
...
<a className="inline-flex items-center gap-2 rounded-md bg-neutral-100 text-neutral-900 px-3.5 py-2 text-[14px] font-medium hover:bg-neutral-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#commissions">
...
<a className="flex items-center justify-between px-2 py-2 rounded-md hover:bg-neutral-800 text-[15px] font-medium text-neutral-200" href="#">
...
<a className="flex items-center justify-between px-2 py-2 rounded-md hover:bg-neutral-800 text-[15px] font-medium text-neutral-200" href="#gallery">
...
<a className="flex items-center justify-between px-2 py-2 rounded-md hover:bg-neutral-800 text-[15px] font-medium text-neutral-200" href="#about">
...
<a className="flex items-center justify-between px-2 py-2 rounded-md hover:bg-neutral-800 text-[15px] font-medium text-neutral-200" href="#commissions">
...
<a className="flex items-center justify-between px-2 py-2 rounded-md hover:bg-neutral-800 text-[15px] font-medium text-neutral-200" href="#contact">
...
<a className="inline-flex items-center gap-2 rounded-md bg-neutral-100 text-neutral-900 px-4 py-2.5 text-[14px] font-medium hover:bg-neutral-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#gallery">
...
<a className="inline-flex items-center gap-2 rounded-md border border-neutral-800 bg-neutral-900 px-4 py-2.5 text-[14px] font-medium text-neutral-100 hover:border-neutral-700 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#about">
...
<div className="mt-5 flex items-center justify-center gap-2" id="dots"><button aria-label="Go to slide 1" className="h-2.5 w-2.5 rounded-full border bg-neutral-100 border-neutral-100"></button><button aria-label="Go to slide 2" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 3" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 4" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 5" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 6" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 7" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button><button aria-label="Go to slide 8" className="h-2.5 w-2.5 rounded-full border bg-neutral-800 border-neutral-700"></button></div>
</div>
</div>
</section>
...
<a className="inline-flex items-center gap-2 rounded-md bg-neutral-100 text-neutral-900 px-4 py-2.5 text-[14px] font-medium hover:bg-neutral-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#commissions">
...
<a className="inline-flex items-center gap-2 rounded-md border border-neutral-800 bg-neutral-900 px-4 py-2.5 text-[14px] font-medium text-neutral-100 hover:border-neutral-700 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#contact">
...
<div className="mt-6">
<a className="inline-flex items-center gap-2 rounded-md bg-neutral-100 text-neutral-900 px-4 py-2.5 text-[14px] font-medium hover:bg-neutral-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700" href="#contact">
...
<div className="flex flex-col leading-none">
<span className="text-[18px] tracking-tight font-semibold text-neutral-100">Magda Meijer</span>
<span className="text-[12px] text-neutral-400 font-medium">Ceramic Art</span>
</div>
</a>
<nav className="flex flex-wrap items-center gap-x-6 gap-y-2">
<a className="text-[14px] text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#">Home</a>
<a className="text-[14px] text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#gallery">Gallery</a>
<a className="text-[14px] text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#about">About</a>
<a className="text-[14px] text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#commissions">Commissions</a>
<a className="text-[14px] text-neutral-300 hover:text-neutral-100 hover:underline underline-offset-4" href="#contact">Contact</a>
</nav>
</div>
<div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-t border-neutral-800 pt-6">
<p className="text-[13px] text-neutral-400">© <span id="year">2025</span> Magda Meijer. All rights reserved.</p>
<div className="flex items-center gap-3">
<a className="inline-flex items-center justify-center h-9 w-9 rounded-md border border-neutral-800 bg-neutral-900 text-neutral-300 hover:text-neutral-100 hover:border-neutral-700" href="#">
<svg className="lucide lucide-instagram h-4.5 w-4.5" data-lucide="instagram" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="5" ry="5" width="20" x="2" y="2"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
</a>
<a className="inline-flex items-center justify-center h-9 w-9 rounded-md border border-neutral-800 bg-neutral-900 text-neutral-300 hover:text-neutral-100 hover:border-neutral-700" href="mailto:studio@magdameijer.com">
<svg className="lucide lucide-mail h-4.5 w-4.5" data-lucide="mail" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path><rect height="16" rx="2" width="20" x="2" y="4"></rect></svg>
</a>
</div>
</div>

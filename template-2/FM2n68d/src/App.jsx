...
<div className="pie-segment text-[#0070f3]" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('production') }} style={{'--percentage': `45%`, '--rotation': `0`}}></div>
<div className="pie-segment text-[#7928ca]" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('preview') }} style={{'--percentage': `25%`, '--rotation': `162`}}></div>
<div className="pie-segment text-[#50e3c2]" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('development') }} style={{'--percentage': `20%`, '--rotation': `252`}}></div>
<div className="pie-segment text-[#f5a623]" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('testing') }} style={{'--percentage': `10%`, '--rotation': `324`}}></div>
...
<div className="flex items-center p-2 rounded-lg legend-item" id="production" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('production') }}>
...
<div className="flex items-center p-2 rounded-lg legend-item" id="preview" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('preview') }}>
...
<div className="flex items-center p-2 rounded-lg legend-item" id="development" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('development') }}>
...
<div className="flex items-center p-2 rounded-lg legend-item" id="testing" onMouseOut={(e) => { resetHighlight() }} onMouseOver={(e) => { highlightSegment('testing') }}>

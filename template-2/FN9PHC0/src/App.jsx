...
<div className="flex items-center gap-4 bg-zinc-900/60 glass-effect border border-zinc-800/60 rounded-xl p-4">
<img alt="Noise-canceling Headphones" className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" />
<div className="flex-1">
<h4 className="font-semibold text-sm">Noise-canceling Headphones</h4>
<p className="text-zinc-400 text-xs">$199 each</p>
</div>
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('headphones', -1) }}>-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('headphones', 1) }}>+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onClick={(e) => { removeFromCart('headphones') }}>
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
<div className="flex items-center gap-4 bg-zinc-900/60 glass-effect border border-zinc-800/60 rounded-xl p-4">
<img alt="Ergonomic Chair" className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" />
<div className="flex-1">
<h4 className="font-semibold text-sm">Ergonomic Chair</h4>
<p className="text-zinc-400 text-xs">$349 each</p>
</div>
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('chair', -1) }}>-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('chair', 1) }}>+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onClick={(e) => { removeFromCart('chair') }}>
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
<div className="flex items-center gap-4 bg-zinc-900/60 glass-effect border border-zinc-800/60 rounded-xl p-4">
<img alt="Smart Speaker" className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" />
<div className="flex-1">
<h4 className="font-semibold text-sm">Smart Speaker</h4>
<p className="text-zinc-400 text-xs">$129 each</p>
</div>
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('speaker', -1) }}>-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('speaker', 1) }}>+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onClick={(e) => { removeFromCart('speaker') }}>
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
<div className="flex items-center gap-4 bg-zinc-900/60 glass-effect border border-zinc-800/60 rounded-xl p-4">
<img alt="Mechanical Keyboard" className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" />
<div className="flex-1">
<h4 className="font-semibold text-sm">Mechanical Keyboard</h4>
<p className="text-zinc-400 text-xs">$169 each</p>
</div>
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('keyboard', -1) }}>-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onClick={(e) => { updateQuantity('keyboard', 1) }}>+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onClick={(e) => { removeFromCart('keyboard') }}>
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
</div>
<div className="text-center py-12" id="empty-cart" style={{display: `none`}}>
...
<div className="border-t border-zinc-800/60 px-6 py-4 space-y-4" id="cart-footer" style={{display: `block`}}>
<div className="flex items-center justify-between text-lg font-semibold">
<span>Total</span>
<span id="cart-total">$846</span>
</div>
...
<span className="text-lg font-medium text-zinc-200 group-hover:text-zinc-100 transition-colors tracking-tight">NXT</span>
</a>
...
<span className="absolute -top-1 -right-1 text-[10px] leading-none bg-emerald-400 text-zinc-900 rounded-full px-1.5 py-1 font-semibold shadow-lg" id="cart-count">4</span>
</button>
...
<img alt="Customer" className="h-12 w-12 rounded-full ring-3 ring-zinc-950 object-cover hover:scale-110 transition-transform cursor-pointer" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0b561a0b-b1a0-43a5-ac03-852308f05daa_320w.jpg" />
<img alt="Customer" className="h-12 w-12 rounded-full ring-3 ring-zinc-950 object-cover hover:scale-110 transition-transform cursor-pointer" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/46ced6a9-43d9-4cb3-9d41-e60c4df9040e_320w.jpg" />
<img alt="Customer" className="h-12 w-12 rounded-full ring-3 ring-zinc-950 object-cover hover:scale-110 transition-transform cursor-pointer" src="/assets/44a363ff-a90a-4404-9439-cd5fb9f91c5d_320w.jpg" />
...
<div className="relative">
<img alt="Wearables" className="h-64 w-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/efa4c7a4-8174-4f7d-a86e-fb32a8e19bcd_800w.jpg" />
...
<div className="relative">
<img alt="Home" className="h-64 w-full object-cover group-hover:scale-105 transition-transform duration-700" src="/assets/bc64ea1e-0deb-42bd-90e4-d27f24d644c9_800w.jpg" />
<div className="absolute inset-0 bg-gradient-to-t from-zinc-950/80 via-zinc-950/20 to-transparent"></div>
</div>
<div className="absolute bottom-0 p-6 flex items-end justify-between w-full">
<div className="">
...
<div className="relative">
<img alt="Desk" className="h-64 w-full object-cover group-hover:scale-105 transition-transform duration-700" src="/assets/28ab409c-b2de-419d-8737-4c3b451bd28b_800w.jpg" />
<div className="absolute inset-0 bg-gradient-to-t from-zinc-950/80 via-zinc-950/20 to-transparent"></div>
</div>
<div className="absolute bottom-0 p-6 flex items-end justify-between w-full">
<div>
...
<video autoPlay className="h-full w-full lg:absolute" id="aura-eme9fzrko" loop muted playsInline src="https://cdn.midjourney.com/video/c55d12e8-25f2-4268-a4d8-f2bfceeae73c/0.mp4" title="Summer sale products"></video>
</div>
</div>
</div>
</section>

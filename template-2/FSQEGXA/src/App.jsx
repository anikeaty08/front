...
<path d="M30 0H0v30" stroke="#e5e7eb" strokeOpacity=".6" strokeWidth="0.5"></path>
</pattern>
</defs>
...
<path d="M140 230 C 220 210, 280 240, 336 310
                                        S 560 160, 614 210
                                        S 730 420, 760 420" fill="none" id="routePath" opacity=".7" stroke="#fb923c" strokeDasharray="6 8" strokeLinecap="round" strokeWidth="4"></path>
...
<path d="M110 140 C210 120 260 140 300 180 S 480 120 520 180" fill="none" stroke="#fb923c" strokeDasharray="6 8" strokeLinecap="round" strokeWidth="4"></path>
...
<form className="mt-6 flex flex-col sm:flex-row gap-3" onSubmit={(e) => { return false; }}>

...
<svg className="icon w-[16px] h-[16px]" data-lucide="grid-3x3" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="12" rx="2" width="18"></rect></svg>
        All Artworks
      </button>
...
<svg className="icon w-[16px] h-[16px]" data-lucide="user" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(168, 162, 158)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="7"></circle></svg>
        Portraits
      </button>
...
<svg className="icon w-[16px] h-[16px]" data-lucide="mountain" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(168, 162, 158)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18"></rect><circle cx="9" cy="9"></circle><path></path></svg>
        Landscapes
      </button>
...
<svg className="icon w-[16px] h-[16px]" data-lucide="palette" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(168, 162, 158)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="6" rx="2" width="16"></rect><path></path><rect height="6" rx="1" width="4"></rect></svg>
        Abstract
      </button>
...
<svg className="icon w-[16px] h-[16px]" data-lucide="cpu" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(168, 162, 158)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
        Digital Art
      </button>
...
<svg className="icon w-[16px] h-[16px]" data-lucide="sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(168, 162, 158)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
        Fantasy
      </button>
</div>
...
<svg className="w-[16px] h-[16px]" data-lucide="sliders-horizontal" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="17" cy="17"></circle><circle cx="7" cy="7"></circle></svg>
    Filters
  </button>
...
<svg className="w-[12px] h-[12px]" data-lucide="heart" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `12px`, height: `12px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<svg className="w-[12px] h-[12px]" data-lucide="share" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `12px`, height: `12px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="5"></circle><circle cx="6" cy="12"></circle><circle cx="18" cy="19"></circle><line></line><line></line></svg>
</button>
</div>
</div>
</div>

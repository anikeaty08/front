...
<img alt="Dashboard Analytics screenshot" className="w-full h-52 object-cover transition-transform group-hover:scale-105 duration-500" loading="lazy" onError={(e) => { e.currentTarget.src='https://via.placeholder.com/800x400/1e1e1e/ffffff?text=Image+Unavailable' }} src="https://images.unsplash.com/photo-1535223289827-42f1e9919769?auto=format&fit=crop&w=800&q=80" />
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-white/10 bg-zinc-900">
<img alt="eCommerce Storefront screenshot" className="w-full h-52 object-cover transition-transform group-hover:scale-105 duration-500" loading="lazy" onError={(e) => { e.currentTarget.src='https://via.placeholder.com/800x400/1e1e1e/ffffff?text=Image+Unavailable' }} src="https://images.unsplash.com/photo-1555529771-35a29d3a4b46?auto=format&fit=crop&w=800&q=80" />
<div className="p-6 space-y-2">
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-white/10 bg-zinc-900">
<img alt="Mobile Wallet screenshot" className="w-full h-52 object-cover transition-transform group-hover:scale-105 duration-500" loading="lazy" onError={(e) => { e.currentTarget.src='https://via.placeholder.com/800x400/1e1e1e/ffffff?text=Image+Unavailable' }} src="https://images.unsplash.com/photo-1601597111158-1b32b16ab66a?auto=format&fit=crop&w=800&q=80" />
<div className="p-6 space-y-2">

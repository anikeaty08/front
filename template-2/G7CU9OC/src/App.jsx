...
<span bg-neutral-800="" border="" border-neutral-700="" className="text-[11px] rounded bg-amber-500/10 border-amber-500/30 text-amber-300 px-2 py-1门铃批量唤醒减少中断</span> <span class=" px-2="" rounded="" text-neutral-300="">与 MRRS/MPS 对齐</span>
</div>
</div>
</div>
...
<ul border-l="" border-neutral-800="" ml-4="" pl-4="" space-y-2="" text-sm="">
<li className="relative">
<div className="absolute -left-4 top-3 w-4 h-px bg-neutral-800"></div>
...
<div className="flex items-center gap-3">
<div className="h-6 w-6 rounded bg-neutral-900 border border-neutral-800 flex items-center justify-center">
<svg data-lucide="check-square" height="16 stroke-width=" width="16"></svg>
</div>
...
<span className="text-[15px] font-semibold tracking-tight text-neutral-100">第四部分：调试与观测</span>
                  ...
                  {"<"} data-lucide="chevron-down" width="18" height="18" stroke-width="1.5" class="transition-transform group-open:rotate-180 text-neutral-400"{">"}
</summary>
<div className="px-4 pb-4 space-y-3">
<div className="rounded-md border border-neutral-800 bg-neutral-900/40 p-3">
<div className="flex items-center gap-2">
...
<svg className="mt-0.5 shrink-0 text-neutral-400" data-lucide="chevrons-right" strokeWidth="1.5" width="16 height="></svg>

...
<button className="hidden md:inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition ring-1 ring-gray-200" onClick={(e) => { openTemplates() }}>
<i className="w-4 h-4" data-lucide="sparkles"></i>
                Templates
              </button>
<button className="hidden md:inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition ring-1 ring-gray-200" onClick={(e) => { openCommunity() }}>
<i className="w-4 h-4" data-lucide="globe"></i>
                Community
              </button>
<button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] active:bg-[#5c27af] transition ring-1 ring-[#8338EC]/30 shadow-sm" onClick={(e) => { openWizard() }}>
...
<button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={(e) => { openAdmin() }}>
<i className="w-4 h-4" data-lucide="settings"></i>
                    Organization Admin
                  </button>
<button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={(e) => { showView('login') }}>
...
<button className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] active:bg-[#5c27af] transition ring-1 ring-[#8338EC]/30 shadow-sm" onClick={(e) => { handleMagicLink() }}>
...
<button className="inline-flex gap-2 hover:bg-gray-50 transition text-sm text-gray-900 bg-white w-full ring-gray-200 ring-1 rounded-lg pt-2.5 pr-4 pb-2.5 pl-4 items-center justify-center" id="aura-emffa7xf4" onClick={(e) => { completeLogin() }}>Deep Funding Account</button>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] transition ring-1 ring-[#8338EC]/30" onClick={(e) => { openWizard() }}>
<i className="w-4 h-4" data-lucide="plus"></i>
                  New Project
                </button>
</div>
...
<button className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900" onClick={(e) => { openTemplates() }}>Templates</button>
<button className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900" onClick={(e) => { openCommunity() }}>Community Gallery</button>
</div>
...
<button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] transition ring-1 ring-[#8338EC]/30" onClick={(e) => { openWizard() }}>
<i className="w-4 h-4" data-lucide="plus"></i>
                    New Project
                  </button>
<button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200 transition" onClick={(e) => { openTemplates() }}>
<i className="w-4 h-4" data-lucide="sparkles"></i>
                    Browse Templates
                  </button>
</div>
...
<button className="group text-left rounded-xl border border-gray-200 hover:border-[#8338EC] hover:shadow-sm transition p-4" onClick={(e) => { selectBase('scratch') }}>
...
<button className="group text-left rounded-xl border border-gray-200 hover:border-[#8338EC] hover:shadow-sm transition p-4" onClick={(e) => { selectBase('template','RFP 12 steps') }}>
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
...
<button className="group text-left rounded-xl border border-gray-200 hover:border-[#8338EC] hover:shadow-sm transition p-4" onClick={(e) => { selectBase('template','Hackathon 8') }}>
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
...
<button className="group text-left rounded-xl border border-gray-200 hover:border-[#8338EC] hover:shadow-sm transition p-4 md:col-span-1" onClick={(e) => { selectBase('template','Budget 10') }}>
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
...
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { cancelWizard() }}>Cancel</button>
...
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { prevStep(1) }}>Back</button>
<div className="flex gap-2">
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { cancelWizard() }}>Cancel</button>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { addTaskRow() }}>
<i className="w-4 h-4" data-lucide="plus"></i>
                    Add task
                  </button>
<div className="flex items-center gap-2">
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { prevStep(2) }}>Back</button>
...
<div className="mt-5 flex items-center justify-between">
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { prevStep(3) }}>Back</button>
...
<div className="flex items-center gap-2">
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { openShare() }}>
<i className="w-4 h-4" data-lucide="share-2"></i>
                  Share
                </button>
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { duplicatePlaybook() }}>
<i className="w-4 h-4" data-lucide="copy"></i>
                  Duplicate
                </button>
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { exportCSV() }}>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { addPBTask() }}>
<i className="w-4 h-4" data-lucide="plus"></i>
                  Add task
                </button>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] transition ring-1 ring-[#8338EC]/30" onClick={(e) => { saveSnapshot() }}>
...
<button className="p-2 rounded-lg hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { closeShare() }}>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] transition ring-1 ring-[#8338EC]/30" onClick={(e) => { inviteUser() }}>
                    Invite
                  </button>
</div>
...
<button className="px-4 py-2 rounded-lg text-sm text-gray-900 bg-white hover:bg-gray-50 ring-1 ring-gray-200" onClick={(e) => { closeShare() }}>Close</button>
</div>
</div>
</div>
</div>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm bg-white ring-1 ring-gray-200 hover:bg-gray-50" onClick={(e) => { showView('dashboard') }}>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm bg-white ring-1 ring-gray-200 hover:bg-gray-50" onClick={(e) => { openCommunity() }}>
...
<div className="flex items-center gap-2">
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] ring-1 ring-[#8338EC]/30" onClick={(e) => { duplicateFromPublic() }}>
<i className="w-4 h-4" data-lucide="copy"></i>Duplicate to My Workspace
              </button>
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm bg-white ring-1 ring-gray-200 hover:bg-gray-50" onClick={(e) => { exportPublicCSV() }}>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white bg-[#8338EC] hover:bg-[#6f2fd2] ring-1 ring-[#8338EC]/30" onClick={(e) => { inviteOrgUser() }}>
                      Invite user
                    </button>
</div>
</div>
...
<button className="mt-3 inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm bg-white ring-1 ring-gray-200 hover:bg-gray-50" onClick={(e) => { openTemplates() }}>

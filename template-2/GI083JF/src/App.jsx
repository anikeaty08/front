...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('pizza') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
<img alt="Pizza" className="w-full h-40 object-cover" src="https://images.unsplash.com/photo-1617470702355-94a48c0b9729?w=1080&q=80" />
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('burger') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('taco') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('ramen') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('sushi') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('ice-cream') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
<img alt="Ice Cream" className="w-full h-40 object-cover" src="https://images.unsplash.com/photo-1629385742818-32909d7b45a2?w=1080&q=80" />
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('pasta') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
<img alt="Pasta" className="w-full h-40 object-cover" src="https://images.unsplash.com/photo-1598720290281-9f26ae6d6f81?w=1080&q=80" />
...
<p className="text-sm text-gray-600 mb-3">Twirl your way to flavor town!</p>
<div className="flex items-center justify-between">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('salad') }} style={{transform: `rotate(0deg) scale(1)`}}>
<div className="relative">
...
<div className="relative">
<button className="absolute top-4 right-4 z-10 bg-black/50 hover:bg-black/70 text-white p-2 rounded-full transition-all duration-300" onClick={(e) => { closeFoodPreview() }}>

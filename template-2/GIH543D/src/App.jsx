...
<img alt="Cyclistes à Lyon sur une piste cyclable" className="col-span-3 row-span-4 h-64 w-full object-cover border-blue-200 border rounded-xl shadow-sm" src="https://images.unsplash.com/photo-1673889655788-09df7d0f286b?w=800&q=80" />
<img alt="Arbres et rues apaisées à Lyon" className="col-span-3 row-span-3 h-48 w-full object-cover border-blue-200 border rounded-xl shadow-sm" src="https://images.unsplash.com/photo-1683293254738-b94068c90eb8?w=800&q=80" />
<img alt="Bâtiments modernes et mobilité douce" className="col-span-3 row-span-3 h-48 w-full object-cover border-blue-200 border rounded-xl shadow-sm" src="https://images.unsplash.com/photo-1607444433383-c9938621ea2e?w=800&q=80" />
<img alt="Communauté diverse à vélo" className="col-span-3 row-span-3 h-48 w-full object-cover border-blue-200 border rounded-xl shadow-sm" src="https://images.unsplash.com/photo-1459184113209-08daa5161363?w=800&q=80" />
</div>
</div>
</div>
</div>

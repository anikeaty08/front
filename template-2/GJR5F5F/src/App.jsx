...
<button className="country-btn bg-orange-100 border border-orange-200 text-orange-600 hover:bg-orange-200 px-5 py-2 rounded-md text-sm font-medium transition" onClick={(e) => { selectCountry('germany') }}>Germany</button>
</div>

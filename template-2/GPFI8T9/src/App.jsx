...
<button className="relative inline-flex items-center gap-3 font-medium border-none rounded-full cursor-pointer transition-all duration-200 uppercase text-black bg-white px-10 py-4 text-lg hover:-translate-y-1 hover:shadow-lg active:-translate-y-0.5 active:shadow-md" onMouseDown={(e) => { e.currentTarget.style.transform='translateY(-1px)'; e.currentTarget.style.boxShadow='0 5px 10px rgba(0, 0, 0, 0.2)' }} onMouseOut={(e) => { e.currentTarget.style.transform='translateY(0px)'; e.currentTarget.style.boxShadow='0 0 0 0 rgba(0, 0, 0, 0)' }} onMouseOver={(e) => { e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow='0 10px 20px rgba(0, 0, 0, 0.2)' }} onMouseUp={(e) => { e.currentTarget.style.transform='translateY(-3px)'; e.currentTarget.style.boxShadow='0 10px 20px rgba(0, 0, 0, 0.2)' }} style={{boxShadow: `rgba(0, 0, 0, 0) 0px 0px 0px 0px`, transition: `0.2s`, fontFamily: `inherit`, fontWeight: `500`, transform: `translateY(0px)`}}>

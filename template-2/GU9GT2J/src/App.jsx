...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        // Simple pill toggle behavior
        const pills = document.querySelectorAll('.pill');
        pills.forEach(p => {
          p.addEventListener('click', () => {
            const group = p.parentElement.querySelectorAll('.pill');
            group.forEach(btn => {
              btn.classList.remove('bg-white', 'text-zinc-900');
              btn.classList.add('text-white/90');
            });
            p.classList.add('bg-white', 'text-zinc-900');
...
<div className="h-screen bg-zinc-100 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8e249747-11d9-4c29-9017-590f07779c2e_3840w.jpg)] bg-cover pt-5 pr-5 pb-5 pl-5">
...
<button className="p-2 rounded-xl bg-zinc-900/60 hover:bg-zinc-800 transition">
...
<div className="mt-2 text-3xl tracking-tight font-jakarta font-light" style={{}}>6</div>
</div>
<div className="rounded-2xl bg-zinc-900 p-4">
<div className="flex items-center justify-between">
...
<div className="mt-2 text-3xl tracking-tight font-jakarta font-light" style={{}}>27</div>
</div>
<div className="rounded-2xl bg-zinc-900 p-4">
<div className="flex items-center justify-between">
...
<div className="mt-2 text-3xl tracking-tight font-jakarta font-light" style={{}}>22</div>
</div>
<div className="rounded-2xl bg-zinc-900 p-4">
<div className="flex items-center justify-between">
...
<div className="mt-2 text-3xl tracking-tight font-jakarta font-light" style={{}}>3</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<img alt="avatar" className="h-9 w-9 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/94f325d2-00ce-48ec-9c3d-a87ff77bb836_320w.jpg" />
...
<div className="flex items-center gap-3">
<img alt="avatar" className="h-9 w-9 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/4d72eb51-d86e-431b-ad62-97cdf574a592_320w.jpg" />
<div className="flex-1">
...
<div className="rounded-2xl p-3 bg-zinc-900/70">
<div className="flex items-center gap-3">
<img alt="avatar" className="h-9 w-9 rounded-full object-cover" src="/assets/d72202a6-6f82-40bf-84db-846e9adc396a_320w.jpg" />
<div className="flex-1">
...
<img alt="me" className="h-9 w-9 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b42a4dfd-8458-407e-a755-f3d75cdd369b_320w.jpg" />
<div className="flex-1">
<div className="text-sm font-medium tracking-tight font-geist">Jordan Lake</div>
...
<img alt="lead" className="h-16 w-16 md:h-20 md:w-20 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2d84440c-f8f5-4db9-aa0b-0b4e3512a162_320w.jpg" />
<div className="flex-1">
<div className="flex flex-wrap items-center gap-3">
<h1 className="text-2xl md:text-3xl tracking-tight font-jakarta font-light" style={{}}>Avery Nolan</h1>
...
<div className="font-geist">Product Manager • Nordbyte (2,100 employees)</div>
<div className="font-geist">(402) 555‑0146</div>
<div className="font-geist">3538 Copper Ridge Dr, Boise, ID</div>
</div>
</div>
<div className="flex flex-col items-end gap-2">
<div className="flex items-center gap-2 rounded-full bg-zinc-100 px-3 py-1">
<img alt="mgr" className="h-6 w-6 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6e7842fa-2930-4398-a1b1-829010b57b42_320w.jpg" />
...
<button className="self-start p-2 rounded-xl bg-zinc-100 hover:bg-zinc-200">
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="lead" className="h-8 w-8 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2d84440c-f8f5-4db9-aa0b-0b4e3512a162_320w.jpg" />
<div className="text-sm">
<span className="font-medium font-geist">Avery Nolan</span>
...
<div className="mt-1 text-3xl tracking-tight font-jakarta font-light" style={{}}>$ 23,500</div>
</div>
...
<li className="flex items-center gap-2">
<span className="h-5 w-5 rounded-full bg-white/20 flex items-center justify-center">
<svg className="lucide lucide-minus h-3.5 w-3.5" data-lucide="minus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path></svg>
</span>
...
<li className="flex items-center gap-1.5 font-geist"><svg className="lucide lucide-zap h-3.5 w-3.5" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg> Fast onboarding</li>
</ul>
</div>
<div className="rounded-2xl bg-white/80 p-3">
<div className="text-sm font-medium font-geist">AltBrew</div>
<ul className="mt-1 text-xs text-zinc-700 space-y-1">
<li className="flex items-center gap-1.5 font-geist"><svg className="lucide lucide-info h-3.5 w-3.5" data-lucide="info" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg> Lower price, longer delivery</li>
</ul>
</div>
</div>
</div>
...
<img alt="mountains" className="w-full h-40 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/256139c9-e118-4ca1-b76d-9cb35137e5c0_800w.jpg" />
</div>
</aside>
</div>
</div>

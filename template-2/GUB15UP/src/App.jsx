...
<div className="flex flex-col w-full aspect-[3/5] hover:scale-[1.03] transition-all duration-300 hover:shadow-3xl group sm:p-10 ring-1 ring-emerald-500/10 bg-center relative overflow-hidden text-white bg-[url(https://cdn.midjourney.com/ab015e70-3530-4b30-957c-7e88ecccfe00/0_1.png?w=800&q=80)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 justify-between" onMouseEnter={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.currentTime=0; v.play().catch(()=>{});}})(e.currentTarget) }} onMouseLeave={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.pause(); v.currentTime=0;}})(e.currentTarget) }} style={{boxShadow: `rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(16, 185, 129, 0.12) 0px 0px 0px 1px`}}><div aria-hidden="true" className="absolute inset-0 pointer-events-none">
...
<div className="flex flex-col w-full aspect-[3/5] hover:scale-[1.03] transition-all duration-300 hover:shadow-3xl group sm:p-10 ring-1 ring-cyan-400/10 bg-center text-white bg-[url(https://cdn.midjourney.com/1d4fd59c-9023-4628-8ea1-4256408af86b/0_1.png?w=800&q=80)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 justify-between relative overflow-hidden" onMouseEnter={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.currentTime=0; v.play().catch(()=>{});}})(e.currentTarget) }} onMouseLeave={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.pause(); v.currentTime=0;}})(e.currentTarget) }} style={{boxShadow: `rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(34, 211, 238, 0.12) 0px 0px 0px 1px`}}>
...
<div className="flex flex-col w-full aspect-[3/5] hover:scale-[1.03] transition-all duration-300 hover:shadow-3xl group sm:p-10 ring-1 ring-violet-400/10 bg-center text-white bg-[url(https://cdn.midjourney.com/a2ccbf1b-ad14-4f40-9667-0ac8bfdb7d70/0_2.png?w=800&q=80)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 justify-between relative overflow-hidden" onMouseEnter={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.currentTime=0; v.play().catch(()=>{});}})(e.currentTarget) }} onMouseLeave={(e) => { (function(el){const v=el.querySelector('video'); if(v){v.pause(); v.currentTime=0;}})(e.currentTarget) }} style={{boxShadow: `rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(139, 92, 246, 0.12) 0px 0px 0px 1px`}}>
<div aria-hidden="true" className="absolute inset-0 pointer-events-none">

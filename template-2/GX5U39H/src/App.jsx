...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group shadow-lg" onClick={(e) => { showModal('outline') }}>
...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group shadow-lg" onClick={(e) => { showModal('draft') }}>
...
<button className="glass hover:scale-105 transition-all duration-200 p-6 rounded-xl group shadow-lg" onClick={(e) => { showModal('cover') }}>
...
<button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 rounded-xl font-medium transition-colors shadow-lg" onClick={(e) => { showModal('pricing') }}>Start Free</button>
</div>
...
<button className="w-full bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white py-3 rounded-xl font-medium transition-all shadow-lg" onClick={(e) => { showModal('pricing') }}>Start Free Trial</button>
</div>

...
<div className="mt-4 rounded-lg overflow-hidden border border-white/10 transition-all duration-300 group-hover:border-white/20">
<img alt="Дизайн‑системы — превью" className="aspect-video w-full transition-transform duration-500 group-hover:scale-110 object-cover" src="/assets/9d25c2d1-8a41-471b-bac8-c69712d13bb1_800w.jpg" />
</div>
</div>
<div className="flex text-sm text-[#ffffff] mt-6 items-center">
<span>Learn more</span>

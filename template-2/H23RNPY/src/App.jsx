...
<input className="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" id="amount" min="100" onInput={(e) => { simulate() }} placeholder="0" step="100" type="number" />
</label>
<div>
<span className="text-sm font-medium">Plazo</span>
<div className="grid grid-cols-2 gap-3 mt-2">
<button className="term-btn py-2 rounded-lg border border-gray-300 font-medium" data-days="30" onClick={(e) => { selectTerm(e.currentTarget) }}>30 días</button>
<button className="term-btn py-2 rounded-lg border border-gray-300 font-medium" data-days="90" onClick={(e) => { selectTerm(e.currentTarget) }}>90 días</button>
<button className="term-btn py-2 rounded-lg border border-gray-300 font-medium" data-days="180" onClick={(e) => { selectTerm(e.currentTarget) }}>180 días</button>
<button className="term-btn py-2 rounded-lg border border-gray-300 font-medium" data-days="360" onClick={(e) => { selectTerm(e.currentTarget) }}>360 días</button>
</div>
</div>
...
<input className="w-5 h-5 accent-indigo-600" id="terms" onChange={(e) => { toggleConfirm() }} type="checkbox" />

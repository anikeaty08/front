...
<button className="w-full py-2 bg-[#23262E] hover:bg-[#2d313b] text-gray-200 font-medium rounded-md transition-colors" onClick={(e) => { closeCard() }}>Dismiss</button>
</div>
<button aria-label="Close" className="absolute top-3 right-3 text-gray-400 hover:text-gray-200 p-1 rounded transition-colors" onClick={(e) => { closeCard() }}>

...
<button className="mr-4 p-2 text-gray-500 hover:text-gray-700 rounded-md" onClick={(e) => { history.back() }}>
...
<button className="p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { toggleSection('hero-content') }}>
...
<button className="ml-4 p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { copyToClipboard('Welcome to Our Platform - Your Complete Digital Solution for Modern Businesses') }}>
...
<button className="p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { copyToClipboard('Turn 23% More Website Visitors Into Paying Customers (In 30 Days)') }}>
<i className="fa-solid fa-copy"></i>
</button>
<button className="p-2 text-green-600 hover:text-green-800" onClick={(e) => { acceptSuggestion('hero-section') }}>
...
<div className="flex space-x-2 ml-4">
<button className="p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { copyToClipboard('Stop Losing 67% of Your Website Traffic to Competitors') }}>
<i className="fa-solid fa-copy"></i>
</button>
<button className="p-2 text-green-600 hover:text-green-800" onClick={(e) => { acceptSuggestion('hero-section') }}>
<i className="fa-solid fa-check"></i>
...
<div className="flex space-x-2 ml-4">
<button className="p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { copyToClipboard('Join 2,847 Businesses Already Boosting Revenue with Our Platform') }}>
<i className="fa-solid fa-copy"></i>
</button>
<button className="p-2 text-green-600 hover:text-green-800" onClick={(e) => { acceptSuggestion('hero-section') }}>
<i className="fa-solid fa-check"></i>
...
<button className="p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { copyToClipboard('Our AI-powered optimization platform has helped businesses like yours increase conversions by an average of 34% in just 30 days. No technical skills required.') }}>
<i className="fa-solid fa-copy"></i>
</button>
</div>
</div>
...
<div className="flex items-center space-x-3">
<button className="px-4 py-2 text-sm font-medium text-brand-primary border border-brand-primary rounded-md hover:bg-brand-light" onClick={(e) => { showModal('create-task-modal') }}>

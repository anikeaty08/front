...
<svg className="lucide lucide-search w-5 h-5" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
</button>
<button className="hover:text-gray-600 transition-colors relative">
<svg className="lucide lucide-heart w-5 h-5" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<button className="hover:text-gray-600 transition-colors relative">
<svg className="lucide lucide-shopping-bag w-5 h-5" data-lucide="shopping-bag" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<button className="hover:text-gray-600 transition-colors">
<svg className="lucide lucide-user w-5 h-5" data-lucide="user" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="7"></circle></svg>
</button>
...
<div className="relative w-full max-w-3xl px-6<!-- Slider Container --> <div class=" slider-container="">
...
<button className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 border border-white/30 bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-white/20 transition-all z-10" onClick={(e) => { previousSlide() }}>
<svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path></path>
</svg>
</button>
<button className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 border border-white/30 bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-white/20 transition-all z-10" onClick={(e) => { nextSlide() }}>
<svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path></path>
</svg>
</button>
...
<button className="h-2 bg-white/30 transition-all dot progress-rect active" onClick={(e) => { goToSlide(0) }} style={{width: `48px`, backgroundColor: `rgba(255, 255, 255, 0.5)`}}>
<div className="progress-fill h-full bg-white transition-all duration-100 ease-linear" style={{width: `0%`}}></div>
</button>
<button className="h-2 w-3 transition-all dot progress-rect bg-white/30" onClick={(e) => { goToSlide(1) }} style={{width: `12px`, backgroundColor: `rgba(255, 255, 255, 0.3)`}}>
<div className="progress-fill h-full bg-white transition-all duration-100 ease-linear" style={{width: `0%`}}></div>
</button>
<button className="h-2 w-3 bg-white/30 transition-all dot progress-rect" onClick={(e) => { goToSlide(2) }} style={{width: `12px`, backgroundColor: `rgba(255, 255, 255, 0.3)`}}>
<div className="progress-fill h-full bg-white transition-all duration-100 ease-linear" style={{width: `0%`}}></div>
</button>
</div>
...
<svg className="lucide lucide-chevron-left w-5 h-5" data-lucide="chevron-left" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<svg className="lucide lucide-chevron-right w-5 h-5" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
</div>
</div>
...
<button className="hover:text-black transition-colors">
<svg className="lucide lucide-facebook w-5 h-5" data-lucide="facebook" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
</div>
</div>
</div>

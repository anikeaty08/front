...
<button className="bg-white/30 hover:bg-white/40 px-4 py-1.5 text-xs text-white rounded-full transition" onClick={(e) => { alert('Balance Details') }}>Details</button>
</div>
...
<button className="text-xs text-purple-600 font-medium" onClick={(e) => { alert('Show all cards') }}>See All</button>
</div>
<div className="space-y-4">
<div className="bg-gradient-to-r from-blue-500 to-blue-700 rounded-xl p-5 flex items-center text-white shadow cursor-pointer" onClick={(e) => { alert('Card details') }}>
...
<div className="bg-white rounded-xl p-5 flex items-center shadow border border-gray-100 cursor-pointer" onClick={(e) => { alert('Card details') }}>
<div className="flex-1">
...
<button className="text-xs text-purple-600 font-medium" onClick={(e) => { alert('Show all transactions') }}>See All</button>
</div>
<div className="space-y-3">
<div className="flex items-center bg-white rounded-xl shadow px-4 py-3 cursor-pointer transition hover:bg-purple-50" onClick={(e) => { alert('Groceries') }}>
...
<div className="flex items-center bg-white rounded-xl shadow px-4 py-3 cursor-pointer transition hover:bg-purple-50" onClick={(e) => { alert('Netflix') }}>
...
<div className="flex items-center bg-white rounded-xl shadow px-4 py-3 cursor-pointer transition hover:bg-purple-50" onClick={(e) => { alert('Salary') }}>
...
<div className="flex flex-col items-center cursor-pointer" onClick={(e) => { alert('Go to Wallet') }}>
...
<div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center -mt-8 shadow cursor-pointer" onClick={(e) => { alert('Add new entry'); }}>
...
<div className="flex flex-col items-center cursor-pointer" onClick={(e) => { alert('Go to Stats') }}>
...
<div className="flex flex-col items-center cursor-pointer" onClick={(e) => { alert('Go to More') }}>

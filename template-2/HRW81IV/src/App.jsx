...
<p className="mt-1 text-neutral-500 text-center text-base font-normal">
          Build and preview a glowing flower with real-time controls.
        </p>
</header>
<main className="flex flex-col md:flex-row gap-10">

<section className="w-full max-w-md mx-auto md:mx-0 md:w-[320px] bg-white border border-neutral-200 rounded-xl shadow-md shadow-black/[0.03] px-7 py-8 flex flex-col gap-6">
<div>
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="petals">Petals</label>
<input className="w-full accent-indigo-500 slider-thumb" id="petals" max="20" min="4" type="range" value="10" />
<div className="flex justify-between text-xs mt-1 text-neutral-400">
<span>4</span>
<span className="text-neutral-700 font-semibold" id="petalsVal">10</span>
<span>20</span>
</div>
</div>
<div>
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="speed">Glow Speed</label>
<input className="w-full accent-indigo-500 slider-thumb" id="speed" max="12" min="2" step="0.1" type="range" value="6" />
<div className="flex justify-between text-xs mt-1 text-neutral-400">
<span>2</span>
<span className="text-neutral-700 font-semibold" id="speedVal">6.0</span>
<span>12</span>
</div>
</div>
<div>
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="frequency">Wave Frequency</label>
<input className="w-full accent-indigo-500 slider-thumb" id="frequency" max="100" min="20" type="range" value="60" />
<div className="flex justify-between text-xs mt-1 text-neutral-400">
<span>20</span>
<span className="text-neutral-700 font-semibold" id="frequencyVal">60</span>
<span>100</span>
</div>
</div>
<div className="flex gap-3">
<div className="flex-1">
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="base1">Gradient A</label>
<input className="w-8 h-8 rounded-md border border-neutral-200 focus:ring-2 focus:ring-indigo-200 bg-white cursor-pointer" id="base1" type="color" value="#cc33ff" />
</div>
<div className="flex-1">
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="base2">Gradient B</label>
<input className="w-8 h-8 rounded-md border border-neutral-200 focus:ring-2 focus:ring-indigo-200 bg-white cursor-pointer" id="base2" type="color" value="#ff8833" />
</div>
</div>
<div>
<label className="block text-sm font-medium text-neutral-800 mb-1" htmlFor="flowers">Number of Flowers</label>
<input className="w-full accent-indigo-500 slider-thumb" id="flowers" max="10" min="1" type="range" value="7" />
<div className="flex justify-between text-xs mt-1 text-neutral-400">
<span>1</span>
<span className="text-neutral-700 font-semibold" id="flowersVal">7</span>
<span>10</span>
</div>
</div>
</section>
...
<div className="bg-white border border-neutral-200 rounded-xl shadow-md shadow-black/[0.03] p-4 flex items-center justify-center">
<canvas className="rounded-lg border border-neutral-200 shadow-sm" height="420" id="shader" width="420"></canvas>
</div>
</div>
<div className="w-full">
<div className="flex items-center mb-2">
<span className="text-base font-semibold text-neutral-800 flex-1">Code</span>
<button className="px-3 py-1.5 bg-neutral-100 hover:bg-neutral-200 text-neutral-700 border border-neutral-200 rounded-lg text-xs font-medium shadow transition" id="copyBtn">
                Copy
              </button>
</div>
<pre className="bg-[#f8f9fb] border border-neutral-200 rounded-lg px-4 py-4 text-xs font-mono text-neutral-800 shadow-inner shadow-black/[0.02] overflow-x-auto max-h-80 leading-relaxed" id="shaderCode">precision highp float;

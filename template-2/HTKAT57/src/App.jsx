...
<div className="relative w-64 h-64 rounded-full" id="dial" style={{background: `conic-gradient(from 135deg, #06b6d4 0deg, #0891b2 calc(var(--temp-angle, 180deg)), rgba(255,255,255,0.05) calc(var(--temp-angle, 180deg)), rgba(255,255,255,0.05) 360deg)`, '--temp-angle': `337.5deg`, filter: `drop-shadow(rgba(6, 182, 212, 0.3) 0px 0px 20px)`}}>

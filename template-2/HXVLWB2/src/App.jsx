...
<img alt="Cozy modern home interior" className="w-full h-full object-cover" src="/assets/cc673ecb-d2ff-41e7-b415-17f32b9884bf_3840w.jpg" />
...
<div className="toggle-switch w-12 h-6 relative cursor-pointer bg-gray-600 rounded-full" onClick={(e) => { toggleSwitch(e.currentTarget) }}>
...
<div className="toggle-switch w-12 h-6 relative cursor-pointer active bg-gradient-to-r from-green-500 to-emerald-500 rounded-full" onClick={(e) => { toggleSwitch(e.currentTarget) }}>
...
<div className="toggle-switch w-12 h-6 bg-gray-600 rounded-full relative cursor-pointer" onClick={(e) => { toggleSwitch(e.currentTarget) }}>

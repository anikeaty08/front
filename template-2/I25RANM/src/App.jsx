...

{
          ...
          (function () {
            var root = document.getElementById('aura-emfagjjn6');
            if (!root) return;
            var els = root.querySelectorAll('[data-slide]');
  ...
  return (
    <>
      <div className="aura-background-component fixed top-0 w-full h-screen -z-10"><div className="spline-container absolute top-0 left-0 w-full h-full -z-10"><iframe frameborder="0" height="100%" src="https://my.spline.design/herolightcopy-HWuYMA6IdNGk0VGuyvrItNGB" width="100%"></iframe></div></div>
...
<h1 className="max-w-3xl sm:text-5xl md:text-6xl lg:text-8xl leading-[1.05] text-4xl font-semibold text-neutral-900 tracking-tighter font-space-grotesk" style={{}}>Dive into your best form at 
          
          Tropix Swim Club</h1>

<p className="sm:text-lg max-w-[85ch] text-base text-neutral-800 font-geist mt-4">
...
<svg className="lucide lucide-thermometer-sun w-[14px] h-[14px]" data-lucide="thermometer-sun" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path></svg>
            Heated 8-lane pool
          </span>
<span className="inline-flex items-center gap-2 ring-1 ring-neutral-200 text-xs text-slate-950 bg-neutral-200 rounded-full pt-1.5 pr-3 pb-1.5 font-geist">
<svg className="lucide lucide-badge-check w-[14px] h-[14px]" data-lucide="badge-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
            Certified coaches
          </span>
<span className="inline-flex items-center gap-2 ring-1 ring-neutral-200 text-xs text-slate-950 bg-neutral-200 rounded-full pt-1.5 pr-3 pb-1.5 font-geist">
<svg className="lucide lucide-users w-[14px] h-[14px]" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
            All ages & levels
          </span>
<span className="inline-flex items-center gap-2 ring-1 ring-neutral-200 text-xs text-slate-950 bg-neutral-200 rounded-full pt-1.5 pr-3 pb-1.5 font-geist">
<svg className="lucide lucide-heart w-[14px] h-[14px]" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
            Family-friendly
          </span>
</div>

<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8">
<a className="group inline-flex items-center justify-center gap-3 shadow-stone-800/20 ring-1 ring-neutral-200 transition duration-150 ease-out hover:-translate-y-0.5 text-base font-medium text-white bg-zinc-800 rounded-full pt-3 pr-6 pb-3 pl-6 shadow-lg font-geist" href="#booking">Book Your First Splash<span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/25">
<svg className="lucide lucide-arrow-big-right w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="arrow-big-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span></a>
...
<h2 className="text-[44px] sm:text-6xl lg:text-7xl leading-[0.9] font-medium text-zinc-100 tracking-tighter font-geist mt-2" style={{}}>Swim better, together.</h2>
...
<svg className="lucide lucide-plus h-4 w-4" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
</svg>
<span className="text-sm font-normal font-geist" style={{}}>Technique-first coaching</span>
</div>
<div className="flex items-center gap-2">
<svg className="lucide lucide-plus h-4 w-4" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
...
<span className="text-sm font-normal font-geist" style={{}}>Structured programs</span>
</div>
<div className="flex items-center gap-2">
<svg className="lucide lucide-plus h-4 w-4" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
...
<span className="text-sm font-normal font-geist" style={{}}>Interactive community</span>
</div>
</div>
</div>
</div>
...
<div className="">
<p className="text-sm font-medium text-zinc-400 tracking-tight font-geist" style={{}}>Progress with purpose</p>
<p className="text-sm text-zinc-400 font-geist mt-1" style={{}}>From fundamentals to elite racing, our pathways and session plans help swimmers build confidence, efficiency and endurance.</p>
...
<p className="leading-relaxed sm:text-right sm:pl-8 text-base text-zinc-300 font-geist" style={{}}>Our coaching team blends years of competitive experience with a supportive approach that brings out your best</p>
</div>
</div>
</div>
...
<svg className="lucide lucide-brain w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="star" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `14px`, height: `14px`, color: `rgb(24, 24, 27)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
</div>
<div className="absolute top-3 right-3">
</div>
<div className="absolute bottom-3 left-3 right-3">
<p className="leading-tight text-lg font-medium text-white tracking-tight font-geist" style={{}}>Taylor Cooke</p>
</div>
</article>

<article className="relative overflow-hidden h-[200px] bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-800 rounded-2xl">
<div className="absolute inset-0 hover:scale-105 transition-transform duration-500 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0e60f1bd-bde0-4ec4-8c23-24383a8b650a_800w.jpg)] bg-cover" style={{}}>
</div>
<div className="absolute top-3 left-3">
<span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-zinc-100/90 text-zinc-900 border border-zinc-700">
<svg className="lucide lucide-zap w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="star" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `14px`, height: `14px`, color: `rgb(24, 24, 27)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
</div>
<div className="absolute top-3 right-3">
</div>
<div className="absolute bottom-3 left-3 right-3">
<p className="leading-tight text-lg font-medium text-white tracking-tight font-geist" style={{}}>Jordan Lee</p>
</div>
</article>
...
<div className="absolute top-3 left-3">
<span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-zinc-100/90 text-zinc-900 border border-zinc-700">
<svg className="lucide lucide-trending-up w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="star" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `14px`, height: `14px`, color: `rgb(24, 24, 27)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
</div>
<div className="absolute top-3 right-3">
</div>
<div className="absolute bottom-3 left-3 right-3">
<p className="leading-tight text-lg font-medium text-white tracking-tight font-geist" style={{}}>Alicia Blacke</p>
</div>
</article>
...
<div className="absolute top-3 left-3">
<span className="inline-flex h-7 w-7 items-center justify-center text-zinc-900 bg-zinc-100/90 border-zinc-700 border rounded-full">
<svg className="lucide lucide-shield-check w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="star" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: `14px`, height: `14px`, color: `rgb(24, 24, 27)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
</div>
<div className="absolute top-3 right-3">
</div>
<div className="absolute bottom-3 left-3 right-3">
<p className="leading-tight text-lg font-medium text-white tracking-tight font-geist" style={{}}>Dane Small</p>
</div>
</article>
</div>
</div>
...
<div className="flex sm:mb-8 mb-6 items-end justify-between transition-all duration-700 ease-out will-change-transform opacity-100 translate-y-0" data-slide="" style={{}}>
<div className="">
<p className="text-[11px] sm:text-xs uppercase text-neutral-500 tracking-[0.2em] font-geist">(01) Programs</p>
<h2 className="sm:text-3xl text-2xl tracking-tight mt-2 font-space-grotesk font-semibold" style={{}}>Signature programs that build confident swimmers.</h2>
</div>
<a className="hidden sm:inline-flex-center gap-2 ring-1 ring-neutral-200 hover:shadow text-sm text-neutral-700 bg-white rounded-full px-4 py-2 font-geist" href="#programs">
                All programs
                <svg className="lucide lucide-arrow-up-right w-4 h-4" data-lucide="arrow-up-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
</a>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">

<div className="group relative overflow-hidden ring-1 ring-neutral-200 cursor-pointer bg-white rounded-3xl shadow-sm h-80 transition-all duration-700 ease-out will-change-transform opacity-100 translate-y-0" data-slide="" style={{}}>
<img alt="Learn to Swim program for ages 5–12" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1629946832022-c327f74956e0?w=800&q=80" style={{}} />
<div className="absolute inset-0 opacity-100 group-hover:opacity-0 transition-opacity duration-300 bg-gradient-to-t from-black/50 to-transparent bg-[url(https://images.unsplash.com/photo-1629946832022-c327f74956e0?w=800&q=80)] bg-cover" style={{}}></div>
<div className="absolute bottom-0 left-0 right-0 pt-5 pr-5 pb-5 pl-5">
<p className="text-xs text-white/70 font-geist">Learn to Swim • Ages 5–12 • 8‑week course</p>
<div className="mt-1 flex items-center justify-between">
<h3 className="sm:text-lg text-base font-semibold text-white tracking-tight fontist">Learn to Swim</h3>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
</span>
</div>
</div>
</div>
...
<div className="group relative overflow-hidden ring-1 ring-neutral-200 cursor-pointer bg-white rounded-3xl shadow-sm h-80 transition-all duration-700 ease-out will-change-transform opacity-100 translate-y-0" data-slide="" style={{}}>
<img alt="Masters & Tri swim training for adults" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1640906152676-dace6710d24b?w=800&q=80" style={{}} />
<div className="absolute inset-0 opacity-100 group-hover:opacity-0 transition-opacity duration-300 bg-gradient-to-t from-black/50 to-transparent bg-[url(https://images.unsplash.com/photo-1640906152676-dace6710d24b?w=800&q=80)] bg-cover"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Masters & Tri • Adults • Structured sets</p>
<div className="mt-1 flex items-center justify-between">
<h3 className="text-base sm:text-lg font-semibold tracking-tight text-white font-geist">Masters & Tri Training</h3>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
</span>
</div>
...
<div className="group relative overflow-hidden ring-1 ring-neutral-200 cursor-pointer bg-white rounded-3xl shadow-sm h-80 transition-all duration-700 ease-out will-change-transform opacity-100 translate-y-0" data-slide="" style={{}}>
<img alt="Open fitness lanes for independent swimming" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1724525647065-f948fc102e68?w=800&q=80" style={{}} />
<div className="absolute inset-0 opacity-100 group-hover:opacity-0 transition-opacity duration-300 bg-gradient-to-t from-black/50 to-transparent bg-[url(https://images.unsplash.com/photo-1724525647065-f948fc102e68?w=800&q=80)] bg-cover"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Lane Swim • All levels • Book by hour</p>
<div className="mt-1 flex items-center justify-between">
<h3 className="sm:text-lg text-base font-semibold text-white tracking-tight font-geist">Open Fitness Lanes</h3>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
</span>
</div>
...
<a className="inline-flex items-center gap-2 rounded-full bg-white ring-1 ring-neutral-200 px-5 py-3 text-sm text-neutral-700 hover:shadow font-geist transition-all duration-700 ease-out will-change-transform opacity-100 translate-y-0" data-slide="" href="#programs" style={{}}>
...
<svg className="lucide lucide-calendar-check h-4 w-4" data-lucide="calendar-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path><path></path></svg>
              Book a lane
            </a>
...
<svg className="lucide lucide-list-checks h-4 w-4" data-lucide="list-checks" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
              View schedule
            </a>
</div>
</div>
...
<div className="group sm:p-8 cursor-pointer transition-all duration-500 hover:scale-105 hover:bg-zinc-800/80 hover:shadow-xl text-slate-50 bg-zinc-900 border-zinc-800 border rounded-3xl mt-0 pt-6 pr-6 pb-6 pl-6">
<div className="sm:p-6 md:p-8 transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20 text-slate-50 bg-stone-900/5 border-white/10 border rounded-2xl pt-5 pr-5 pb-5 pl-5">
<div className="flex items-center justify-between">
<h3 className="flex items-center gap-2 text-xl font-medium text-slate-50 tracking-tight font-geist">
...
<p className="text-sm text-slate-50/70 font-geist mt-2">Video analysis, drills, and progressive sets that reinforce efficient technique for faster, safer swimming.</p>
...
<div className="group sm:p-8 cursor-pointer transition-all duration-500 hover:scale-105 hover:bg-zinc-800/80 hover:shadow-xl bg-zinc-900 border-zinc-800 border rounded-3xl mt-8 pt-6 pr-6 pb-6 pl-6">
<div className="sm:p-6 md:p-8 transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20 bg-stone-900/5 border-white/10 border rounded-2xl pt-5 pr-5 pb-5 pl-5">
<div className="flex items-center justify-between">
<h3 className="flex items-center gap-2 text-xl font-medium text-white tracking-tight font-geist">
...
<div className="relative z-10 sm:p-12 md:p-16 bg-neutral-900 pt-12 pr-8 pb-8 pl-8">
<div className="grid grid-cols-1 lg:grid-cols-4 gap-8 border-white/10 border-b pb-12">
<div className="lg:col-span-4">
<div className="flex items-center gap-2 mb-4">
<svg className="lucide lucide-swiss-franc" data-lucide="swiss-franc" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{display: `none`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
<svg className="lucide lucide-waves w-5 h-5 text-white/80" data-lucide="waves" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<svg className="lucide lucide-check w-4 h-4 text-green-400 mt-0.5" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<svg className="lucide lucide-phone w-4 h-4" data-lucide="phone" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                      +1 (234) 567‑8900
                    </a>
</div>
...
<div className="">
<div className="">
<canvas className="" height="120" id="occupancyChart"></canvas>
</div>
</div>
</div>
</div>
...
<svg className="lucide lucide-mail w-4 h-4" data-lucide="mail" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="16" rx="2" width="20"></rect></svg>
                      Email us
                    </a>
...
<svg className="lucide lucide-calendar w-4 h-4" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path></svg>
                      Confirm booking
                    </button>
</div>
</form>
...
<svg className="lucide lucide-sticky-note w-[20px] h-[20px]" data-icon-replaced="true" data-lucide="sticky-note" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(23, 23, 23)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
<div className="">
...
<svg className="lucide lucide-download w-4 h-4 text-neutral-400 group-hover:text-neutral-700" data-lucide="download" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</a>
<a className="group flex items-center justify-between rounded-2xl border border-neutral-200 bg-white p-4 hover:shadow-sm" href="#">
<div className="flex items-center gap-3">
<span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-neutral-100 ring-1 ring-neutral-200">
...
<svg className="lucide lucide-quote w-4 h-4" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/"><path></path><path></path></svg>
...
<svg className="lucide lucide-check-circle-2 w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `14px`, height: `14px`, color: `rgb(37, 99, 235)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12"></circle><path></path></svg>
</div>
...
<svg className="lucide lucide-circle-check lucide-check-circle-2 font-geist w-[14px] h-[14px]" data-icon-replaced="true" data-lucide="circle-check" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `14px`, height: `14px`, color: `rgb(37, 99, 235)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12"></circle><path></path></svg>
</div><p></p></div>
</div><p className="text-xs text-zinc-600 translate-x-12 -translate-y-2 font-geist">Adult Beginner Program</p>
<p className="sm:text-base text-sm text-zinc-700 mt-4 -translate-y-2 font-geist">
...
<svg className="lucide lucide-check-circle-2 w-3.5 h-3.5 text-blue-600" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg>
</div>
<p className="text-xs text-zinc-600 font-geist">Parent of Junior Swimmer</p>
</div>
</div>
<p className="sm:text-base text-sm text-zinc-700 mt-4 font-geist">My 8-year-old daughter loves coming here. 
...
<p border-t="" border-zinc-100="" className="mt-4 text-sm sm:text-baseTraining for my first triathlon here was perfect. The structured sessions and coaching helped me go from struggling to confident in open water. </p> </article> </div> <div class=" left="" right="" to="">
...
<article className="shrink-0 w-[280px] sm:w-[360px] md:w-[420px] border rounded-2xl pt-5 pr-5 pb-5 pl-5 bg-zinc-100/40 border-zinc-100">
<div className="flex items-center gap-3">
<img alt="Avatar" className="size-9 object-cover rounded-full" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&q=80" />
<div>
<div className="flex items-center gap-1">

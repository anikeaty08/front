...
<aside className="relative sm:p-10 flex flex-col md:min-h-[420px] lg:min-h-[480px] group hover:border-neutral-600/60 transition-all duration-500 opacity-0 animate-scale-in animate-delay-800 text-neutral-200 bg-[url(/assets/4cbc60a4-4fe9-4076-aa9f-780d9db024b5_800w.jpg)] bg-cover border-neutral-700/50 rounded-xl pt-8 pr-8 pb-8 pl-8 shadow-2xl backdrop-blur-xl">
...
</aside><aside className="relative sm:p-10 flex flex-col md:min-h-[420px] lg:min-h-[480px] group hover:border-neutral-600/60 transition-all duration-500 opacity-0 animate-scale-in animate-delay-800 text-neutral-200 bg-[url(/assets/587704f8-5e00-4904-b740-9c240e358d12_800w.jpg)] bg-cover border-neutral-700/50 rounded-xl pt-8 pr-8 pb-8 pl-8 shadow-2xl backdrop-blur-xl">
<div className="relative z-10">
<div className="flex items-start justify-between">

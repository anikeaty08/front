...
<button className="text-gray-300 hover:text-white transition-colors text-sm" onClick={(e) => { goToSection(0) }}>Home</button>
<button className="text-gray-300 hover:text-white transition-colors text-sm" onClick={(e) => { goToSection(1) }}>About</button>
<button className="text-gray-300 hover:text-white transition-colors text-sm" onClick={(e) => { goToSection(2) }}>Services</button>
<button className="text-gray-300 hover:text-white transition-colors text-sm" onClick={(e) => { goToSection(3) }}>Testimonials</button>
<button className="text-gray-300 hover:text-white transition-colors text-sm" onClick={(e) => { goToSection(4) }}>Contact</button>
</div>
</div>
</nav>

<div className="fixed right-8 top-1/2 transform -translate-y-1/2 z-50 flex flex-col space-y-4">
<div className="dot active" data-section="0" onClick={(e) => { goToSection(0) }}></div>
<div className="dot" data-section="1" onClick={(e) => { goToSection(1) }}></div>
<div className="dot" data-section="2" onClick={(e) => { goToSection(2) }}></div>
<div className="dot" data-section="3" onClick={(e) => { goToSection(3) }}></div>
<div className="dot" data-section="4" onClick={(e) => { goToSection(4) }}></div>
</div>

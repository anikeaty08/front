...
<a className="nav-link" href="#hero" onClick={(e) => { closeMobileMenu() }}>Home</a>
<a className="nav-link" href="#servizi" onClick={(e) => { closeMobileMenu() }}>Servizi</a>
<a className="nav-link" href="#casi" onClick={(e) => { closeMobileMenu() }}>Casi Studio</a>
<a className="nav-link" href="#contatti" onClick={(e) => { closeMobileMenu() }}>Contatti</a>
<a className="cta-btn shadow-md" href="#contatti" onClick={(e) => { closeMobileMenu() }}>Richiedi Preventivo</a>
</div>
</header>

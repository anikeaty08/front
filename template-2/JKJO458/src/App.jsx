...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
    ...
    // No instruction bar, but keep the 3D effect
...
<div className="w-full max-w-5xl mx-auto shadow-xl rounded-2xl bg-neutral-900 flex overflow-hidden">

<div className="w-1/2 flex flex-col justify-center px-10 py-16">
<h1 className="jakarta tight-tracking text-white text-[64px] leading-tight mb-6 font-light">
        Welcome<br />Back
      </h1>
<p className="text-neutral-400 text-[18px] mb-10 font-normal" style={{fontFamily: `'Inter',sans-serif`}}>
        Login to your account to continue
      </p>
<form className="flex flex-col gap-6">
<div>
<label className="block text-neutral-300 text-[15px] mb-2 font-medium" htmlFor="email">Email</label>
<input autocomplete="username" className="w-full px-4 py-3 rounded-lg bg-neutral-800 border border-neutral-700 text-neutral-100 placeholder-neutral-500 text-[16px] focus:outline-none focus:ring-2 focus:ring-blue-500 transition" id="email" placeholder="you@email.com" type="email" />
</div>
<div>
<label className="block text-neutral-300 text-[15px] mb-2 font-medium" htmlFor="password">Password</label>
<input autocomplete="current-password" className="w-full px-4 py-3 rounded-lg bg-neutral-800 border border-neutral-700 text-neutral-100 placeholder-neutral-500 text-[16px] focus:outline-none focus:ring-2 focus:ring-blue-500 transition" id="password" placeholder="••••••••" type="password" />
</div>
<div className="flex items-center justify-between">
<label className="flex items-center text-neutral-400 text-[14px] font-normal">
<input className="accent-blue-600 mr-2" type="checkbox" />
            Remember me
          </label>
<a className="text-blue-500 text-[14px] hover:underline" href="#">Forgot password?</a>
</div>
<button className="mt-4 w-full py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-[16px] font-semibold transition" type="submit">
          Sign In
        </button>
</form>
<div className="mt-8 text-neutral-400 text-[15px]" style={{fontFamily: `'Inter',sans-serif`}}>
        Don't have an account?
        <a className="text-blue-500 hover:underline" href="#">Sign up</a>
</div>
</div>

<div className="w-1/2 bg-neutral-800 relative flex items-center justify-center">
<canvas className="w-full h-[540px] md:h-[640px] rounded-xl" id="cubes-canvas"></canvas>
</div>
</div>

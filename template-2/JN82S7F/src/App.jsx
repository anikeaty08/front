...
<button className="p-2 text-muted hover:text-primary transition-colors" id="theme-toggle" onClick={(e) => { toggleTheme() }}>
...
<div className="property-card animate-slide-up delay-200" onClick={(e) => { openDealModal('deal-1') }}>
<div className="relative">
...
<div className="property-card animate-slide-up delay-300" onClick={(e) => { openDealModal('deal-2') }}>
<div className="relative">
...
<div className="property-card animate-slide-up delay-400" onClick={(e) => { openDealModal('deal-3') }}>
<div className="relative">
...
<button className="p-2 text-muted hover:text-danger" onClick={(e) => { closeDealModal() }}>

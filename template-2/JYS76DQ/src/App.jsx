...
<circle className="" cx="90" cy="90" stroke="url(#grad)" strokeWidth="8"></circle>
<circle className="" cx="90" cy="90" opacity="0.6" stroke="url(#grad2)" strokeWidth="4"></circle>
<circle cx="90" cy="90" opacity="0.4" stroke="url(#grad3)" strokeWidth="2"></circle>
<defs>
</defs>
</svg>
</div>
...
<rect className="" fill="#8b5cf6" height="60" rx="4" width="30"></rect>
<rect className="" fill="#3b82f6" height="40" rx="4" width="30"></rect>
<rect className="" fill="#06b6d4" height="50" rx="4" width="30"></rect>
<rect className="" fill="#8b5cf6" height="70" rx="4" width="30"></rect>
<circle cx="35" cy="35" fill="#06b6d4" opacity="0.6"></circle>
<circle cx="85" cy="55" fill="#8b5cf6" opacity="0.6"></circle>
<circle cx="135" cy="45" fill="#3b82f6" opacity="0.6"></circle>
<circle cx="185" cy="25" fill="#06b6d4" opacity="0.6"></circle>
</svg>
</div>
...
<rect className="" height="80" rx="14" stroke="#8b5cf6" strokeOpacity=".8" strokeWidth="2" width="220"></rect>
<rect className="" height="80" rx="14" stroke="#3b82f6" strokeOpacity=".5" strokeWidth="2" width="220"></rect>
<rect className="" height="80" rx="14" stroke="#06b6d4" strokeOpacity=".3" strokeWidth="2" width="220"></rect>
<rect className="" fill="#8b5cf6" fillOpacity="0.1" height="40" rx="8" width="160"></rect>
<circle cx="50" cy="60" fill="#8b5cf6" opacity="0.6"></circle>
<circle className="" cx="70" cy="60" fill="#3b82f6" opacity="0.6"></circle>
<circle cx="90" cy="60" fill="#06b6d4" opacity="0.6"></circle>
</svg>
</div>

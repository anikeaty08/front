...
<path clip-rule="evenodd" d="M8 3a1 1 0 011 1v2h2a1 1 0 110 2H9v2a1 1 0 11-2 0V8H5a1 1 0 110-2h2V4a1 1 0 011-1z" fillRule="evenodd"></path>
</svg>
</button>
<button className="p-1 text-gray-500 hover:text-gray-900 rounded hover:bg-gray-200">
<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
...
<button className="p-1 text-gray-500 hover:text-gray-900 rounded hover:bg-gray-200">
<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
<path clip-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a3 3 0 00-3-3 3 3 0 00-3 3v4a5 5 0 0010 0V7a3 3 0 00-3-3h-4z" fillRule="evenodd"></path>
</svg>
</button>

...
<button className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50" onClick={(e) => { showModal('share-modal') }}>
<i className="fa-solid fa-share mr-2"></i>
                            Share Report
                        </button>
<button className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50" onClick={(e) => { showModal('export-modal') }}>
...
<button className="expand-btn p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { expandCard('issue-1') }}>
...
<button className="text-sm text-brand-primary hover:text-brand-dark" onClick={(e) => { copyToClipboard('Professional website audit tool that analyzes SEO, performance, and user experience. Get actionable insights to improve your online presence.') }}>
...
<div className="flex items-center space-x-2">
<button className="expand-btn p-2 text-gray-400 hover:text-gray-600" onClick={(e) => { expandCard('issue-2') }}>
<i className="fa-solid fa-chevron-down"></i>
</button>
</div>
</div>

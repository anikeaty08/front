...
<a className="px-3.5 py-2.5 rounded-lg border border-neutral-800/70 bg-neutral-900/40 text-neutral-200 text-sm hover:border-neutral-700 hover:bg-neutral-900/70 transition" download="HypurrLink-wordmark-dualtone.svg" href="data:image/svg+xml;utf8,<?xml version='1.0' encoding='UTF-8'?><svg xmlns='http://www.w3.org/2000/svg' width='1600' height='400' viewBox='0 0 1600 400'><rect width='100%' height='100%' fill='transparent'/><g><text x='50' y='270' font-family='Space Grotesk, Inter, system-ui, -apple-system, Segoe UI, Roboto' font-weight='600' font-size='220' letter-spacing='-0.02em' fill='%23e5e7eb'>Hypurr</text><text x='860' y='270' font-family='Space Grotesk, Inter, system-ui, -apple-system, Segoe UI, Roboto' font-weight='600' font-size='220' letter-spacing='-0.02em' fill='%2367e8f9'>Link</text></g></svg>" style={{fontFamily: `Inter, ui-sans-serif, system-ui`}}>
                Download SVG
              </a>

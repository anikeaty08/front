...
<svg className="w-6 h-6 text-indigo-400" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect><rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect>
</svg>
</div>
...
<div className="w-12 h-12 flex items-center justify-center bg-indigo-500/20 border border-indigo-400/30 rounded-xl">
<svg className="w-6 h-6 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<rect height="18" rx="1" width="7"></rect><rect height="18" rx="1" width="7"></rect>
</svg>
</div>
...
<div className="w-12 h-12 flex items-center justify-center bg-indigo-500/20 border border-indigo-400/30 rounded-xl">
<svg className="w-6 h-6 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12"></circle><path className=""></path>
</svg>
</div>
...
<span className="scroll-phrase animate-in phrase-gradient-3" id="phrase-current" style={{}}>Power of Imagination</span>
<span className="scroll-phrase next" id="phrase-next" style={{}}></span>
</span>
</h1>

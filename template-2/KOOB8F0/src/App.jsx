...
<div className="absolute inset-0" style={{backgroundImage: `radial-gradient(1px 1px at 10% 20%, rgba(255,255,255,0.14) 0, rgba(255,255,255,0.14) 1px, transparent 1px),
...
<div className="absolute inset-0 opacity-70" style={{background: `radial-gradient(600px 400px at 50% 0%, rgba(124,58,237,0.12), transparent 55%),
...
<div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition" style={{background: `radial-gradient(320px 220px at 50% 0%, rgba(168,85,247,0.10), transparent 60%)`}}></div>
...
<div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition" style={{background: `radial-gradient(320px 220px at 50% 0%, rgba(34,197,94,0.10), transparent 60%)`}}></div>
<div className="flex flex-col items-center text-center">
...
<div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition" style={{background: `radial-gradient(320px 220px at 50% 0%, rgba(59,130,246,0.10), transparent 60%)`}}></div>
<div className="flex flex-col items-center text-center">
...
<div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition" style={{background: `radial-gradient(320px 220px at 50% 0%, rgba(239,68,68,0.10), transparent 60%)`}}></div>
<div className="flex flex-col items-center text-center">

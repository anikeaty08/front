...
<a className="flex items-center gap-3 rounded-xl border border-neutral-200 bg-white px-3 py-2.5 hover:bg-neutral-100 hover:border-neutral-300 transition-colors" href="#" onClick={(e) => { showDiv('pagina-resumo') }}>
...
<li className="px-2">
<a aria-current="page" className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-900 bg-neutral-100 border border-neutral-200 hover:border-neutral-300 hover:bg-neutral-100 transition-colors" href="#" onClick={(e) => { showDiv('pagina-resumo') }}>
...
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-analise-funil') }}>
...
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-ticket-geral') }}>
...
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-metricas-principais') }}>
...
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-analise-grafica') }}>
...
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-resumo-original') }}>
<svg className="lucide lucide-area-chart w-4.5 h-4.5 text-neutral-600 group-hover:text-neutral-700" data-lucide="area-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M7 11.207a.5.5 0 0 1 .146-.353l2-2a.5.5 0 0 1 .708 0l3.292 3.292a.5.5 0 0 0 .708 0l4.292-4.292a.5.5 0 0 1 .854.353V16a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1z"></path></svg>
<span className="nav-label truncate">Resumo Original</span>
</a>
</li>
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-projecao-resultados') }}>
<svg className="lucide lucide-bar-chart-3 w-4.5 h-4.5 text-neutral-600 group-hover:text-neutral-700" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>
<span className="nav-label truncate">Projeção de Resultados</span>
</a>
</li>
<li className="px-2 mt-1.5">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-controle-estatistico') }}>
<svg className="lucide lucide-pie-chart w-4.5 h-4.5 text-neutral-600 group-hover:text-neutral-700" data-lucide="pie-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 12c.552 0 1.005-.449.95-.998a10 10 0 0 0-8.953-8.951c-.55-.055-.998.398-.998.95v8a1 1 0 0 0 1 1z"></path><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path></svg>
<span className="nav-label truncate">Controle Estatístico</span>
</a>
</li>
<li className="px-2 mt-1.5 mb-2">
<a className="group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 border border-transparent hover:border-neutral-200 transition-colors" href="#" onClick={(e) => { showDiv('pagina-meta-ads') }}>
<svg className="lucide lucide-line-chart w-4.5 h-4.5 text-neutral-600 group-hover:text-neutral-700" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg>

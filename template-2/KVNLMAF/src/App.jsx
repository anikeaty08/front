...
<svg className="" data-lucide="sparkles class=" fill="none" height="24" lucide="" lucide-sparkles="" stroke="currentColor" strokeLinejoin="round" strokeWidth="2 stroke-linecap=" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path className=""></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-home size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="home" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
      Home
    </a>
...
<svg className="lucide lucide-layout-dashboard size-4" data-lucide="layout-dashboard" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect><rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect></svg>
      Dashboard
 </a>
<a className="group flex items-center gap-3 rounded-md px-3 py-2 text-[13px] font-medium text-neutral-700 hover:bg-neutral-100 font-geist" href="#" style={{}}>
<svg className="lucide lucide-folder size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="folder" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
      Projects
    </a>
<a className="group flex items-center gap-3 rounded-md px-3 py-2 text-[13px] font-medium text-neutral-700 hover:bg-neutral-100 font-geist" href="#" style={{}}>
<svg className="lucide lucide-check-square size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="check-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
      Tasks
      <span className="ml-auto rounded-full bg-neutral-900/5 px-2 py-0.5 text-[11px] text-neutral-700 font-geist" style={{}}>10</span>
</a>
<a className="group flex items-center gap-3 rounded-md px-3 py-2 text-[13px] font-medium text-neutral-700 hover:bg-neutral-100 font-geist" href="#" style={{}}>
<svg className="lucide lucide-bar-chart-3 size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
      Reporting
    </a>
<a className="group flex items-center gap-3 rounded-md px-3 py-2 text-[13px] font-medium text-neutral-700 hover:bg-neutral-100 font-geist" href="#" style={{}}>
<svg className="lucide lucide-users size-4 text-neutral-500 group-hover:text-neutral-700" data-lide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
      Users
    </a>
</nav>
...
<svg className="lucide lucide-bell size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="bell" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
      Notifications
...
<a className="group flex items-center gap-3 rounded-md px-3 py-2 text-[13px] text-neutral-700 hover:bg-neutral-100 font-geist" href="#" style={{}}>
<svg className="lucide lucide-settings size-4 text-neutral-500 group-hover:text-neutral-700" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="12"></circle></svg>
      Settings
    </a>
</div>
...
<svg className="lucide lucide-upload size-4 text-neutral-600" data-lucide="upload" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                Import
              </button>
...
<svg className="lucide lucide-plus size-4" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                Add customer
              </button>
</div>
</div>
...
<svg className="lucide lucide-trending-up size-3.5" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> 20%
                </span>
</div>
</div>
<div className="rounded-xl border border-neutral-200 p-4">
...
<span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 text-[12px] text-emerald-700 font-geist" style={{}}>
<svg className="lucide lucide-trending-up size-3.5" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> 15%
                </span>
</div>
</div>
<div className="rounded-xl border border-neutral-200 p-4">
...
<button className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3.5 py-1.5 text-[12px] text-neutral-800 hover:bg-neutral-50 font-geist" style={{}}>
                All time
                <svg className="lucide lucide-x size-3.5 text-neutral-500" data-lucide="x" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
<button className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3.5 py-1.5 text-[12px] text-neutral-800 hover:bg-neutral-50 font-geist" style={{}}>
                US, AU, +4
                <svg className="lucide lucide-x size-3.5 text-neutral-500" data-lucide="x" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<button className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3.5 py-1.5 text-[12px] text-neutral-800 hover:bg-neutral-50 font-geist" style={{}}>
<svg className="lucide lucide-filter size-3.5 text-neutral-600" data-lucide="filter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                More filters
              </button>
</div>
...
<svg className="lucide lucide-trash-2 size-4 text-neutral-500" data-lucide="trash-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
</button>
<button className="rounded-md p-1.5 hover:bg-neutral-50">
<svg className="lucide lucide-pencil size-4 text-neutral-500" data-lucide="pencil" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
</div>
</div>
...
<svg className="lucide lucide-chevron-left size-4 text-neutral-500" data-lucide="chevron-left" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                Previous
              </button>
<p className="text-[12px] text-neutral-600 font-geist" style={{}}>Page 1 of 10</p>
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-1.5 text-[12px] text-neutral-800 hover:bg-neutral-50 font-geist" style={{}}>
                Next
                <svg className="lucide lucide-chevron-right size-4 text-neutral-500" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
</div>
</section>
</main>
...
<svg className="lucide lucide-figma size-4 text-neutral-600" data-lucide="figma" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
          Export
        </button>

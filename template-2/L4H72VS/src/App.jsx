...
<button className="nav-link text-blue-400 font-medium" onClick={(e) => { showDashboard() }}>Dashboard</button>
<button className="nav-link text-gray-300 font-medium" onClick={(e) => { showCalendar() }}>Calendar</button>
<button className="nav-link text-gray-300 font-medium" onClick={(e) => { showReports() }}>Reports</button>
<button className="nav-link text-gray-300 font-medium" onClick={(e) => { showSettings() }}>Settings</button>
</div>
...
<button className="flex-1 bg-gradient-to-r from-emerald-500 to-blue-500 text-white py-3 px-6 rounded-xl font-medium hover:from-emerald-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl" onClick={(e) => { saveEntry() }}>
                        Save Entry
                    </button>
<button className="px-6 py-3 bg-red-500/20 text-red-400 rounded-xl font-medium hover:bg-red-500/30 transition-all duration-300 border border-red-500/30 hidden" id="deleteButton" onClick={(e) => { deleteCurrentEntry() }}>
                        Delete
                    </button>
</div>
</div>

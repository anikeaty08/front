...
<div className="flex flex-1 bg-[url(/assets/c348a351-d823-4782-aca8-fba2670caab9_800w.jpg)] bg-cover border-zinc-800/50 border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center" style={{}}>
<div className="relative">
</div>
</div>
...
<div className="card-animate flex flex-col sm:p-10 w-full aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-3xl group animate-in text-white bg-[url(/assets/a3f1cd61-1f82-44be-b97d-dc1fa1132370_1600w.jpg)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-2xl justify-between" style={{boxShadow: `rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(34, 211, 238, 0.1) 0px 0px 0px 1px`}}>
<div className="space-y-6">
<div className="flex items-center justify-between">
...
<div className="flex flex-1 bg-[url(/assets/3d96dfc9-1c52-4ce1-a1ec-90b64d26cde8_800w.jpg)] bg-cover border-zinc-800/50 border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center" style={{}}>
<div className="relative">
</div>
</div>
<div className="space-y-6 mt-8">
...
<div className="card-animate flex flex-col sm:p-10 w-full aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-3xl group animate-in text-white bg-[url(/assets/088b775e-f259-464f-8b1e-c4a769c3f7ca_1600w.jpg)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-2xl justify-between" style={{boxShadow: `rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(139, 92, 246, 0.1) 0px 0px 0px 1px`}}>
<div className="space-y-6">
<div className="flex items-center justify-between">
...
<div className="flex flex-1 bg-[url(/assets/233c2f7e-1bb9-4ce6-82bc-c3d8e0b8af36_800w.jpg)] bg-cover border-zinc-800/50 border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center" style={{}}>
<div className="relative">
</div>
</div>
<div className="space-y-6 mt-8">

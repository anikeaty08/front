...
<img alt="YouTube video thumbnail" aria-label="Open YouTube video player" className="ring-1 ring-gray-800/50 rounded-lg shadow-2xl" onClick={(e) => { window.open('https://www.youtube.com/watch?v=dQw4w9WgXcQ','_blank') }} src="https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg" style={{cursor: `pointer`}} />

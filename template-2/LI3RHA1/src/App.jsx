...
<div aria-hidden="true" className="absolute inset-0" style={{backgroundImage: `url('https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?q=80&w=1974&auto=format&fit=crop')`, backgroundSize: `cover`, backgroundPosition: `center`, filter: `brightness(0.65) saturate(1.1)`}}></div>
...
<div aria-hidden="true" className="absolute inset-0 opacity-30" style={{background: `radial-gradient(40% 50% at 20% 20%, #0074E4 0%, transparent 70%),

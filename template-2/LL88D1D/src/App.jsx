          ...
          new Chart(ctx, {
            ...
            options: {
              ...
              scales: {
                ...
                y: { grid: { color: 'rgba(255,255,255,0.06)' }, ticks: { color: '#a3a3a3', font: { size: 11 }, stepSize: 200 } }
              }
            }
          });
        }
...
<circle className="" cx="24" cy="24" fill="none" r="12" stroke="currentColor" strokeWidth="2"></circle>
<circle cx="32" cy="18" fill="currentColor" r="3"></circle>
</svg>
<span className="text-lg font-semibold tracking-tight">NOVA</span>
</a>
<nav className="hidden md:flex items-center gap-8 text-sm">
<a className="text-gray-400 hover:text-gray-200 font-sans" href="#features">Features</a>
<a className="text-gray-400 hover:text-gray-200 font-sans" href="#security">Security</a>
<a className="text-gray-400 hover:text-gray-200 font-sans" href="#pricing">Pricing</a>
<a className="text-gray-400 hover:text-gray-200 font-sans" href="#docs">Docs</a>
</nav>
<div className="flex items-center gap-3">
<a className="hidden sm:inline-flex items-center gap-2 rounded-full border border-gray-800 bg-gray-900/50 px-4 py-2.5 text-sm font-medium hover:bg-gray-800 transition font-sans" href="#">
...
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-4 py-2.5 text-sm font-medium hover:bg-gray-100 transition font-sans" href="#">
...
<section className="relative overflow-hidden max-w-7xl bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0fb4aa0f-5e53-4030-88ae-8f570ef7170c_3840w.jpg)] bg-cover border-white/10 rounded-3xl mt-8 mr-auto ml-auto" style={{}}>
...
<div className="">
<h1 className="text-4xl sm:text-5xl md:text-6xl text-white font-manrope tracking-tighter" style={{}}>
              Ship chat your users love — <span className="italic tracking-tight font-instrument-serif" style={{}}>realtime, secure, fast</span>
</h1>
<p className="mt-5 text-gray-300/90 leading-relaxed font-sans">
              NOVA Chat is a developer-first messaging platform for modern apps. Realtime sync, AI assist, end-to-end encryption, and SDKs for Web, iOS, and Android.
            </p>
<div className="mt-8 flex items-center gap-3">
<a className="inline-flex items-center gap-2 text-sm font-medium text-white border border-white/15 bg-white/10 rounded-full px-6 py-3 hover:bg-white/15 hover:shadow-lg transition backdrop-blur font-sans" href="#">
...
<a className="inline-flex items-center gap-2 text-sm font-medium border border-white/15 text-white rounded-full px-6 py-3 hover:bg-white/10 transition backdrop-blur font-sans" href="#docs">
...
<div className="">
<h4 className="text-base font-semibold text-white mb-1 font-sans">End‑to‑end encryption</h4>
<p className="text-sm text-gray-300/90 leading-relaxed font-sans">Zero‑knowledge architecture with rotating keys and secure device handshakes.</p>
</div>
</div>
<div className="flex items-start gap-4">
...
<svg className="lucide lucide-radio w-4 h-4 text-blue-400" data-lucide="radio" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16.247 7.761a6 6 0 0 1 0 8.478"></path><path d="M19.075 4.933a10 10 0 0 1 0 14.134"></path><path d="M4.925 19.067a10 10 0 0 1 0-14.134"></path><path d="M7.753 16.239a6 6 0 0 1 0-8.478"></path><circle cx="12" cy="12" r="2"></circle></svg>
</div>
<div className="">
<h4 className="text-base font-semibold text-white mb-1 font-sans">Realtime at scale</h4>
<p className="text-sm text-gray-300/90 leading-relaxed font-sans">Sub‑100ms fanout, presence, typing indicators, and optimistic updates built‑in.</p>
</div>
</div>
<div className="flex items-start gap-4">
...
<defs>
<pattern height="24" id="grid-dark" patternunits="userSpaceOnUse" width="24">
<path d="M24 0H0V24" fill="none" stroke="currentColor" strokeWidth="1"></path>
</pattern>
</defs>
<rect className="" fill="url(#grid-dark)" height="100%" width="100%"></rect>
</svg>
...
<span className="h-2.5 w-2.5 rounded-full bg-white/20"></span>
<span className="h-2.5 w-2.5 rounded-full bg-white/20"></span>
<div className="ml-3 h-2 w-24 rounded bg-white/20"></div>
...
<img alt="Ava" className="h-7 w-7 rounded-full ring-1 ring-white/10 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/91b9f74f-bc94-458c-82e2-8033d1113ade_320w.jpg" />
<div className="">
...
<img alt="You" className="h-7 w-7 rounded-full ring-1 ring-white/10 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8971b844-3f76-4d34-963f-0426b84c3985_320w.jpg" style={{}} />
</div>

<div className="flex items-start gap-3">
<img alt="Kai" className="h-7 w-7 rounded-full ring-1 ring-white/10 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/13a5581f-35ac-4b9e-ae7c-47573e09ab8e_320w.jpg" style={{}} />
<div className="">
<div className="flex items-center gap-2">
...
<svg className="lucide lucide-shield-check w-3.5 h-3.5" data-lucide="shield-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg> E2EE
                            </span>
</div>
<div className="mt-1 rounded-2xl bg-white/10 text-gray-100 text-sm px-3 py-2 ring-1 ring-white/10 backdrop-blur font-sans">
...
<div className="flex items-center gap-3">
<svg className="lucide lucide-message-square w-5 h-5 text-neutral-300" data-lucide="message-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z"></path></svg>
<h3 className="text-xl sm:text-2xl text-gray-100 font-manrope tracking-tighter" style={{}}>Conversation Infrastructure</h3>
</div>
...
<div className="mt-4">
<a className="inline-flex items-center gap-2 text-xs font-medium text-gray-100 hover:text-gray-300 font-sans" href="#features">
                      Explore features
...
<div className="absolute -top-5 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] h-9 shadow-[0_6px_20px_rgba(16,185,129,0.25)] bg-blue-900/20 rounded-2xl backdrop-blur"></div>
...
<div className="pointer-events-none absolute inset-x-0 -top-10 h-24 bg-gradient-to-b from-white/20 to-transparent"></div>
...
<h3 className="text-[15px] sm:text-base font-semibold tracking-tight truncate font-sans">AI Summary posted to #release</h3>
...
<section className="pt-16 pb-16 md:py-20" id="features">
<div className="max-w-7xl mx-auto px-6">
<div className="flex items-end justify-between gap-6">
<div className="">
<h2 className="text-3xl sm:text-4xl text-white font-manrope tracking-tighter" style={{}}>Built for scale — <span className="italic tracking-tight font-instrument-serif" style={{}}>designed for people</span></h2>
...
<a className="hidden sm:inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-5 py-3 text-sm font-medium hover:bg-gray-100 font-sans" href="#docs">
            Read the docs <svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
...
<div className="h-10 w-10 rounded-full bg-purple-500/10 flex items-center justify-center ring-1 ring-purple-400/20">
<i className="w-5 h-5 text-purple-300" data-lucide="broadcast"></i>
</div>
<button className="text-gray-500 hover:text-gray-300 transition-colors">
<svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
<h3 className="text-lg font-semibold text-white mb-2 tracking-tight font-sans">Realtime Engine</h3>
<p className="text-sm text-gray-400 mb-6 font-sans">Presence, typing, reactions, threads, and read receipts with global fanout.</p>
<div className="space-y-3 text-sm">
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Latency p95</span>
<span className="text-purple-300 font-medium font-sans">84ms</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Regions</span>
<span className="text-purple-300 font-medium font-sans">16</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Messages/min</span>
<span className="text-purple-300 font-medium font-sans">2.1M</span>
</div>
</div>
</div>

<div className="hover:shadow-xl transition-shadow duration-300 bg-gradient-to-br from-gray-900 to-gray-900/60 border border-gray-800 rounded-2xl p-6 shadow-lg" id="security">
<div className="flex items-start justify-between mb-4">
<div className="h-10 w-10 rounded-full bg-blue-500/10 flex items-center justify-center ring-1 ring-blue-400/20">
...
<h3 className="text-lg font-semibold text-white mb-2 tracking-tight font-sans">End‑to‑End Security</h3>
<p className="text-sm text-gray-400 mb-6 font-sans">E2EE, SSO/SAML, audit logs, DLP, BYOK/HYOK, and compliance exports.</p>
<div className="space-y-3 text-sm">
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Encryption</span>
<span className="text-blue-300 font-medium font-sans">AES‑256 / XChaCha20</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Certs</span>
<span className="text-blue-300 font-medium font-sans">SOC2 • ISO27001</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Uptime</span>
<span className="text-blue-300 font-medium font-sans">99.99%</span>
</div>
</div>
</div>
...
<div className="hover:shadow-xl transition-shadow duration-300 bg-gradient-to-br from-gray-900 to-gray-900/60 border border-gray-800 rounded-2xl p-6 shadow-lg">
<div className="flex items-start justify-between mb-4">
<div className="h-10 w-10 rounded-full bg-pink-500/10 flex items-center justify-center ring-1 ring-pink-400/20">
<svg className="lucide lucide-wand-sparkles w-5 h-5 text-purple-300" data-lucide="wand-sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72"></path><path d="m14 7 3 3"></path><path d="M5 6v4"></path><path d="M19 14v4"></path><path d="M10 2v2"></path><path d="M7 8H3"></path><path d="M21 16h-4"></path><path d="M11 3H9"></path></svg>
</div>
<button className="text-gray-500 hover:text-gray-300 transition-colors">
<svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
<h3 className="text-lg font-semibold text-white mb-2 tracking-tight font-sans">AI Assist</h3>
<p className="text-sm text-gray-400 mb-6 font-sans">Context‑aware replies, triage, routing, and conversation summaries with your data.</p>
<div className="space-y-3 text-sm">
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Time to reply</span>
<span className="text-pink-300 font-medium font-sans">‑42%</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">Resolution rate</span>
<span className="text-pink-300 font-medium font-sans">+28%</span>
</div>
<div className="flex items-center justify-between">
<span className="text-gray-300 font-sans">CSAT</span>
<span className="text-pink-300 font-medium font-sans">4.7/5</span>
</div>
</div>
</div>
</div>
...
<div>
<p className="text-3xl text-white font-manrope tracking-tighter" style={{}}>2.4M+</p>
<p className="text-sm text-gray-400 mt-1 font-sans">Messages per minute</p>
</div>
<div>
<p className="text-3xl text-white font-manrope tracking-tighter" style={{}}>99.99%</p>
<p className="text-sm text-gray-400 mt-1 font-sans">Uptime last 90 days</p>
</div>
<div>
<p className="text-3xl text-white font-manrope tracking-tighter" style={{}}>120ms</p>
<p className="text-sm text-gray-400 mt-1 font-sans">Global p95 latency</p>
</div>
<div className="flex items-start gap-3">
<svg className="lucide lucide-map-pin w-5 h-5 mt-1 text-neutral-400" data-lucide="map-pin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
...
<h3 className="text-base font-semibold tracking-tight text-white font-sans">Weekly messages</h3>
<p className="text-sm text-gray-400 mt-1 font-sans">Peak traffic handled with zero degradation.</p>
</div>

<div className="mt-4">
<div className="relative h-40">
<canvas className="" height="320" id="messagesChart" style={{display: `block`, boxSizing: `border-box`, height: `160px`, width: `1166px`}} width="2332"></canvas>
</div>
</div>
</div>
</div>
...
<section className="pt-16 pb-16 md:py-20" id="pricing">
<div className="max-w-7xl mx-auto px-6">
<div className="text-center max-w-3xl mx-auto mb-12">
<h2 className="text-3xl sm:text-4xl text-white font-manrope tracking-tighter" style={{}}>Pricing — <span className="italic tracking-tight font-instrument-serif" style={{}}>simple and scalable</span></h2>
<p className="mt-3 text-gray-400 font-sans">Start for free. Upgrade when you need more throughput, features, or controls.</p>
</div>
...
<span className="inline-flex items-center rounded-full bg-white/5 px-3 py-1 text-xs font-medium text-gray-200 ring-1 ring-white/10 font-sans">Free</span>
<div className="mt-6">
<div className="">
<div className="text-4xl text-white font-manrope tracking-tighter" style={{}}>$0<span className="ml-1 text-gray-400 text-base italic font-normal font-sans">/month</span></div>
<p className="mt-2 text-sm text-gray-400 font-sans">Best for prototypes and small apps.</p>
</div>
...
<span className="text-gray-300 font-sans">10k monthly active users</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">Core chat SDKs</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">Shared region</span>
</li>
</ul>
<a className="mt-8 w-full inline-flex items-center justify-center rounded-full border border-white/10 px-6 py-3 text-sm font-medium text-white hover:bg-white/5 transition font-sans" href="#">
                Choose Free
              </a>
</div>
</div>
...
<span className="inline-flex items-center rounded-full bg-blue-500/15 px-3 py-1 text-xs font-medium text-blue-200 ring-1 ring-blue-400/30 font-sans">Pro</span>
<div className="mt-6 text-white">
<div>
<div className="text-4xl font-manrope tracking-tighter" style={{}}>$249<span className="ml-1 text-gray-300 text-base italic font-normal font-sans">/month</span></div>
<p className="mt-2 text-sm text-gray-300 font-sans">Growing apps that need scale and controls.</p>
</div>
<ul className="mt-6 space-y-3 text-sm">
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-300" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-100 font-sans">100k MAU + burst scaling</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-300" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-100 font-sans">Threads, search, file uploads</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-300" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-100 font-sans">Custom retention + GDPR tools</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-300" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-100 font-sans">Email support</span>
</li>
</ul>
<a className="mt-8 w-full inline-flex items-center justify-center rounded-full bg-white text-gray-900 px-6 py-3 text-sm font-medium hover:bg-gray-100 transition font-sans" href="#">
                Choose Pro
              </a>
</div>
</div>
...
<div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-gray-900 to-gray-900/60 p-8 shadow-sm hover:shadow-lg transition-shadow">
<span className="inline-flex items-center rounded-full bg-white/5 px-3 py-1 text-xs font-medium text-gray-200 ring-1 ring-white/10 font-sans">Enterprise</span>
<div className="mt-6">
<div className="">
<div className="text-4xl text-white font-manrope tracking-tighter" style={{}}>Custom<span className="ml-1 text-gray-400 text-base italic font-normal font-sans">/annual</span></div>
<p className="mt-2 text-sm text-gray-400 font-sans">Dedicated regions, SSO/SAML, BYOK/HYOK, and support SLAs.</p>
</div>
<ul className="mt-6 space-y-3 text-sm">
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">Unlimited MAU</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">Private cloud & on‑prem</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">24/7 enterprise support</span>
</li>
<li className="flex items-center gap-3">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-gray-300 font-sans">Compliance: SOC2, ISO27001</span>
</li>
</ul>
<a className="mt-8 w-full inline-flex items-center justify-center rounded-full border border-white/10 px-6 py-3 text-sm font-medium text-white hover:bg-white/5 transition font-sans" href="#">
                Contact sales
...
<p className="text-sm text-gray-400 font-sans">Transparent pricing. Cancel anytime.</p>
</div>
</div>
</section>
...
<h2 className="text-3xl sm:text-4xl text-white font-manrope tracking-tighter" style={{}}>Frequently asked — <span className="italic tracking-tight font-instrument-serif" style={{}}>questions</span></h2>
<p className="mt-3 text-gray-400 font-sans">Everything you need to know about integrating NOVA Chat.</p>
</div>
<div className="space-y-6">
<div className="border border-white/10 rounded-2xl p-6 hover:bg-white/[0.02] transition">
<h3 className="text-lg font-semibold text-white mb-3 font-sans">How long does integration take?</h3>
<p className="text-gray-400 text-sm leading-relaxed font-sans">Most teams ship a production chat in under a week using our SDKs and templates. Web, iOS, and Android are covered, plus REST and WebSocket APIs.</p>
</div>
<div className="border border-white/10 rounded-2xl p-6 hover:bg-white/[0.02] transition">
<h3 className="text-lg font-semibold text-white mb-3 font-sans">Is end‑to‑end encryption enabled by default?</h3>
<p className="text-gray-400 text-sm leading-relaxed font-sans">Yes for direct messages and optional per‑channel for group chats. Key rotation and device verification are provided out of the box.</p>
</div>
<div className="border border-white/10 rounded-2xl p-6 hover:bg-white/[0.02] transition">
<h3 className="text-lg font-semibold text-white mb-3 font-sans">Can we migrate from an existing provider?</h3>
<p className="text-gray-400 text-sm leading-relaxed font-sans">We offer assisted migrations with message import, user mapping, and zero‑downtime cutovers for Pro and Enterprise plans.</p>
</div>
<div className="border border-white/10 rounded-2xl p-6 hover:bg-white/[0.02] transition">
<h3 className="text-lg font-semibold text-white mb-3 font-sans">What about rate limits and scale?</h3>
<p className="text-gray-400 text-sm leading-relaxed font-sans">Generous defaults with burst capacity. Enterprise plans include dedicated regions, custom limits, and performance SLAs.</p>
</div>
<div className="border border-white/10 rounded-2xl p-6 hover:bg-white/[0.02] transition">
<h3 className="text-lg font-semibold text-white mb-3 font-sans">Where can I find examples?</h3>
<p className="text-gray-400 text-sm leading-relaxed font-sans">See our starter kits and sample apps in the docs. We also provide prebuilt chat UIs you can theme in minutes.</p>
</div>
</div>
<div className="mt-12 text-center">
<p className="text-gray-400 mb-4 font-sans">Still have questions?</p>
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-5 py-3 text-sm font-medium hover:bg-gray-100 transition font-sans" href="#">
            Get in touch
            <svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
...
<section className="py-14" id="docs">
<div className="max-w-7xl mx-auto px-6">
<div className="relative overflow-hidden border-white/10 rounded-3xl">
<img alt="abstract grid" className="absolute inset-0 h-full w-full object-cover opacity-40" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/79c03f5d-fd87-4312-bdb4-3032e5aac6f6_1600w.jpg" />
<div className="relative bg-gray-950/40">
<div className="sm:px-12 sm:py-20 pt-16 pr-8 pb-16 pl-8">
<div className="max-w-2xl text-white">
<h3 className="text-3xl sm:text-4xl font-manrope tracking-tighter" style={{}}>Ready to build conversations that delight?</h3>
<p className="mt-3 text-white/80 font-sans">Drop‑in components, powerful APIs, and production‑ready templates.</p>
<div className="mt-6 flex flex-wrap items-center gap-3">
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-5 py-3 text-sm font-medium hover:bg-gray-100 font-sans" href="#">
                    Quickstart guide
                    <svg className="lucide lucide-file-code-2 w-4 h-4" data-lucide="file-code-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="m5 12-3 3 3 3"></path><path d="m9 18 3-3-3-3"></path></svg>
</a>
<a className="inline-flex items-center gap-2 rounded-full border border-white/40 text-white px-5 py-3 text-sm font-medium hover:bg-white/10 font-sans" href="#">
                    API reference
...
<span className="text-lg font-semibold tracking-tight text-white font-sans">NOVA Chat</span>
</div>
<p className="mt-3 text-sm text-gray-400 font-sans">
                Conversation infrastructure for modern apps. Realtime, secure, and delightful by default.
              </p>
<ul className="mt-6 space-y-2">
<li>
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm" href="#">
<span className="flex items-center gap-3 text-gray-200 font-sans">
<svg className="lucide lucide-github w-4 h-4 text-neutral-400" data-lucide="github" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
                      GitHub
                    </span>
<svg className="lucide lucide-arrow-right w-4 h-4 text-neutral-500" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</li>
<li>
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm" href="#">
...
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm" href="#">
<span className="flex items-center gap-3 text-gray-200 font-sans">
<svg className="lucide lucide-linkedin w-4 h-4 text-neutral-400" data-lucide="linkedin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect height="12" width="4" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                      LinkedIn
                    </span>
<svg className="lucide lucide-arrow-right w-4 h-4 text-neutral-500" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
...
<form className="mt-3">
<label className="sr-only font-sans" htmlFor="footer-email">Email address</label>
<div className="flex items-center gap-3 sm:max-w-sm">
<input className="flex-1 rounded-full border border-white/10 bg-gray-950 px-5 py-2.5 text-sm placeholder-gray-600 focus:outline-none text-gray-200" id="footer-email" placeholder="Your email address" type="email" />
<button className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-5 py-2.5 text-sm font-medium hover:bg-gray-100 font-sans" type="button">
                    Subscribe
...
<ul className="mt-6 space-y-2">
<li>
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm text-gray-200 font-sans" href="#features">
                    Features
                    <svg className="lucide lucide-arrow-right w-4 h-4 text-neutral-500" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</li>
<li>
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm text-gray-200 font-sans" href="#pricing">
                    Pricing
                    <svg className="lucide lucide-arrow-right w-4 h-4 text-neutral-500" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</li>
<li>
<a className="flex items-center justify-between border-b border-white/10 py-3 text-sm text-gray-200 font-sans" href="#docs">
                    Docs
                    <svg className="lucide lucide-arrow-right w-4 h-4 text-neutral-500" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</li>
<li className="flex items-center justify-between py-3 text-sm text-gray-400">
<span className="font-sans">© <span className="font-sans" id="year">2025</span> NOVA. All rights reserved.</span>
</li>
</ul>
</div>
</div>

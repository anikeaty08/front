...
<div>
<h2 className="text-lg font-bold">Good afternoon, Alex</h2>
<p className="text-textsecondary text-sm">Your home is secure and efficient</p>
</div>
...
<p className="text-xs text-textsecondary">2 devices</p>
</div>
<div className="w-8 h-8 rounded-full bg-neugray shadow-clay flex items-center justify-center">
<svg className="h-4 w-4 text-textsecondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
...
<div className="flex items-center justify-between">
<span className="text-sm text-textsecondary">19°</span>
<div className="flex items-center gap-1">
<span className="w-2 h-2 rounded-full bg-danger"></span>
<span className="text-xs text-textsecondary">Lights off</span>
</div>
...
<p className="text-xs text-textsecondary">1 device</p>
</div>
<div className="w-8 h-8 rounded-full bg-neugray shadow-clay flex items-center justify-center">
<svg className="h-4 w-4 text-textsecondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
...
<div className="flex items-center justify-between">
<span className="text-sm text-textsecondary">22°</span>
<div className="flex items-center gap-1">
<span className="w-2 h-2 rounded-full bg-danger"></span>
<span className="text-xs text-textsecondary">Lights off</span>
</div>
...
<div className="flex justify-between items-center mb-4">
<h3 className="font-bold">Energy Consumption</h3>
...
<p className="text-xs text-textsecondary">70% completed</p>
</div>
<div className="text-primary font-bold">16.4 kWh</div>
</div>

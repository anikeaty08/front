...
<h1>SubTrack</h1>
<div className="header-icon" onClick={(e) => { showSettings() }}>⚙️</div>
</div>
...
<div className="arrow" onClick={(e) => { showScreen('subscriptions-screen') }}>{">"}</div>
</div>
<div className="card">
...
<div className="add-button" onClick={(e) => { showAddSubscription() }}>
            + ADD SUBSCRIPTION
        </div>
</div>
...
<div className="close-button" onClick={(e) => { hideAddSubscription() }}>✕</div>
<h2>New Subscription</h2>
<div className="save-button" onClick={(e) => { saveSubscription() }}>Save</div>
</div>
...
<div className="toggle-option active" onClick={(e) => { toggleBilling(e.currentTarget) }}>Monthly</div>
<div className="toggle-option" onClick={(e) => { toggleBilling(e.currentTarget) }}>Annual</div>
</div>
</div>
<div className="form-group">
...
<div className="tab active" onClick={(e) => { showScreen('dashboard-screen') }}>
<div className="tab-icon">📊</div>
<div className="tab-label">Dashboard</div>
</div>
<div className="tab" onClick={(e) => { showScreen('subscriptions-screen') }}>
<div className="tab-icon">📋</div>
<div className="tab-label">Subscriptions</div>
</div>
<div className="tab" onClick={(e) => { showScreen('insights-screen') }}>
<div className="tab-icon">📈</div>

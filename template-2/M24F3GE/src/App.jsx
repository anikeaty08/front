...
<svg className="lucide lucide-filter w-4 h-4 text-neutral-700 group-hover:text-neutral-900" data-lucide="filter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
          Mode Validation
        </button>
<button className="group inline-flex items-center gap-2 rounded-md border px-3 py-2 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-900 transition border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300" id="btnExport" title="Exporter le document">
<svg className="lucide lucide-download w-4 h-4 text-neutral-700 group-hover:text-neutral-900" data-lucide="download" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
          Exporter
        </button>
</div>
</div>
...
<div className="text-sm font-semibold tracking-tight style=" segoe="">Cadre 1 — Demandeur</div>
<span className="inline-flex items-center gap-1.5 field-status-badge text-xs font-medium text-[#649DAD] bg-[#649DAD]/10 border-[#649DAD]/30 border rounded-full pt-1 pr-2.5 pb-1 pl-2.5" data-status-badge="warning">À compléter<svg className="lucide lucide-alert-triangle w-3.5 h-3.5" data-lucide="alert-triangle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg></span>
</div>
<svg className="lucide lucide-chevron-down w-4 h-4 text-neutral-500 transition-transform group-open:rotate-180" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
...
<select className="rounded-md border border-neutral-200 bg-white px-3 py-1.5 text-sm" onChange={(e) => { fillArchitectData(e.currentTarget.value) }}>
<option value="0">Marie Dupont</option>
<option value="1">Paul Martin</option>
<option value="2">Sophie Bernard</option>
</select>
<button className="inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-sm border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50" onClick={(e) => { alert('Fonctionnalité d\'édition des coordonnées - Interface à développer') }} type="button">
<svg className="" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
      Éditer
    </button>
</div>
...
<svg className="lucide lucide-check-circle-2 w-4 h-4" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg> Valider le cadre
    </button>
</div>
...
<span className="inline-flex items-center gap-1.5 field-status-badge text-xs font-medium text-[#649DAD] bg-[#649DAD]/10 border-[#649DAD]/30 border rounded-full pt-1 pr-2.5 pb-1 pl-2.5">À compléter<svg className="lucide lucide-alert-triangle w-3.5 h-3.5" data-lucide="alert-triangle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg></span><span className="inline-flex items-center gap-1.5 field-status-badge text-xs font-medium text-[#649DAD] bg-[#649DAD]/10 border-[#649DAD]/30 border rounded-full pt-1 pr-2.5 pb-1 pl-2.5">À vérifier<svg className="lucide lucide-alert-triangle w-3.5 h-3.5" data-lucide="alert-triangle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg></span>
</div>
<svg className="lucide lucide-chevron-down w-4 h-4 text-neutral-500 transition-transform group-open:rotate-180" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
</summary>
...
<svg className="transition-transform group-open:rotate-180 w-[16px] h-[16px]" data-icon-replaced="true" fill="none" stroke="currentColor" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(115, 115, 115)`}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
</div>
</summary>
<div className="border-t border-neutral-200">
<div className="sm:p-6 pt-4 pr-4 pb-4 pl-4 space-y-6">
...
<button className="inline-flex gap-1.5 hover:bg-neutral-100 transition-colors text-sm text-neutral-600 rounded-md pt-2 pr-3 pb-2 pl-3 items-center" onClick={(e) => { toggleAiHelper('description') }} title="Ouvrir les suggestions IA">
...
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-description" onChange={(e) => { applyAiPrompt('description') }}>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-description" onClick={(e) => { generateAiContent('description') }}>
...
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('description') }}>
...
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('description') }}>
              Générer
            </button>
</div>
</div>
...
<svg className="lucide lucide-chevrons-up-down group-hover:text-neutral-900-[14px] h-[14px]" data-icon-replaced="true" data-lucide="chevrons-up-down" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `14px`, height: `14px`, color: `rgb(23, 23, 23)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<input className="sr-only peer" id="particularite-relief" onChange={(e) => { toggleSection('relief') }} type="checkbox" />
...
<button aria-label="Déplier" className="hover:bg-neutral-100 transition-colors rounded-full pt-1 pr-1 pb-1 pl-1" onClick={(e) => { toggleExpand('relief', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('relief') }} title="Ouvrir les suggestions IA">
...
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-relief" onChange={(e) => { applyAiPrompt('relief') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-relief" onClick={(e) => { generateAiContent('relief') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('relief') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('relief') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-enseignes" onChange={(e) => { toggleSection('enseignes') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('enseignes', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('enseignes') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-enseignes" onChange={(e) => { applyAiPrompt('enseignes') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-enseignes" onClick={(e) => { generateAiContent('enseignes') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('enseignes') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('enseignes') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-boisement" onChange={(e) => { toggleSection('boisement') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('boisement', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('boisement') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-boisement" onChange={(e) => { applyAiPrompt('boisement') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-boisement" onClick={(e) => { generateAiContent('boisement') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<path className=""></path>
                    ...
                    <button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('boisement') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-energie" onChange={(e) => { toggleSection('energie') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('energie', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('energie') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
                </button>
</div>
<div className="hidden space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-energie">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-energie" onChange={(e) => { applyAiPrompt('energie') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-energie" onClick={(e) => { generateAiContent('energie') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
                  </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('energie') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Enregistrer
                    </button>
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('energie') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-phases" onChange={(e) => { toggleSection('phases') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('phases', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('phases') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
                </button>
</div>
<div className="hidden space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-phases">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-phases" onChange={(e) => { applyAiPrompt('phases') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-phases" onClick={(e) => { generateAiContent('phases') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
                  </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('phases') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className="">Générer</path></svg></button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-regularisation" onChange={(e) => { toggleSection('regularisation') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('regularisation', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('regularisation') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
                </button>
</div>
<div className="hidden space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-regularisation">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-regularisation" onChange={(e) => { applyAiPrompt('regularisation') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-regularisation" onClick={(e) => { generateAiContent('regularisation') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
                  </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('regularisation') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Enregistrer
                    </button>
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('regularisation') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-limitee" onChange={(e) => { toggleSection('limitee') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('limitee', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('limitee') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
                </button>
</div>
<div className="hidden space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-limitee">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-limitee" onChange={(e) => { applyAiPrompt('limitee') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-limitee" onClick={(e) => { generateAiContent('limitee') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
                  </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('limitee') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Enregistrer
                    </button>
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('limitee') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-modification" onChange={(e) => { toggleSection('modification') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('modification', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('modification') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
      </button>
</div>
<div className="space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-modification">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-modification" onChange={(e) => { applyAiPrompt('modification') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-modification" onClick={(e) => { generateAiContent('modification') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
        </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('modification') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Enregistrer
          </button>
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('modification') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="relative flex-shrink-0">
<input className="sr-only peer" id="particularite-servitudes" onChange={(e) => { toggleSection('servitudes') }} type="checkbox" />
<div className="w-5 h-5 peer-checked:bg-[#649DAD] peer-checked:border-[#649DAD] peer-focus:ring-2 peer-focus:ring-[#649DAD]/20 transition-all duration-200 flex bg-white border-neutral-300 border-2 rounded items-center justify-center">
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
<path className="" clip-rule="evenodd" fillRule="evenodd"></path>
</svg>
...
<button aria-label="Déplier" className="p-1 hover:bg-neutral-100 rounded-full transition-colors" onClick={(e) => { toggleExpand('servitudes', event) }} type="button">
...
<div className="flex items-center justify-end">
<button className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { toggleAiHelper('servitudes') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Aide IA
                </button>
</div>
<div className="hidden space-y-3 rounded-md border border-neutral-200 bg-neutral-50/60 p-3" id="ai-helper-servitudes">
<select className="w-full rounded-md border border-neutral-200 bg-white p-2 text-sm text-neutral-600 focus:border-[#649DAD] focus:ring-1 focus:ring-[#649DAD]/50 transition-colors" id="ai-prompt-select-servitudes" onChange={(e) => { applyAiPrompt('servitudes') }}>
<option disabled selected value="">Suggestions de prompts...</option>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-servitudes" onClick={(e) => { generateAiContent('servitudes') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Régénérer
                  </button>
<div className="flex items-center gap-2 ml-auto">
<button className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" onClick={(e) => { saveToLibrary('servitudes') }}>
<svg className="lucide lucide-library" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg> Enregistrer
                    </button>
<button className="inline-flex items-center gap-1.5 rounded-md border border-transparent bg-[#649DAD] px-3 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" onClick={(e) => { generateAiContent('servitudes') }}>Générer</button>
</div>
</div>
</div>
</div>
...
<svg className="w-4 h-4 text-neutral-500 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
</div>
...
<div className="flex items-center justify-between">
<button className="hidden inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-600 hover:bg-neutral-100 transition-colors" id="ai-regenerate-btn-description" onClick={(e) => { generateAiContent('description') }}>
<svg className="lucide lucide-refresh-cw" fill="none" height="16" stroke="currentColor" strokeLinecap="round stroke-linejoin=" strokeWidth="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path></path>
<path></path>
<path></path>
<path></path>
...
<svg className="w-3 h-3 text-neutral-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="7" width="7"></rect><rect height="7" width="7"></rect><rect height="7" width="7"></rect><rect height="7" width="7"></rect></svg>
...
<svg className="w-3.5 h-3.5 text-neutral-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20"></rect><path></path><path></path><path></path><path></path></svg>
        ← → pour naviguer
      </span>
...
<svg className="w-3.5 h-3.5 transition-opacity" data-icon="" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="4" rx="1" width="8"></rect><path></path><rect height="12" rx="2" width="8"></rect></svg>
<svg className="w-3.5 h-3.5 text-[#10B981] hidden" data-check="" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg>
</button>
...
<svg className="w-4 h-4 text-neutral-500 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
</div>
...
<svg className="w-4 h-4 mt-0.5 text-neutral-600" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12"></circle><path className=""></path><path className=""></path></svg>
...
<svg className="w-4 h-4 text-neutral-500 transition-transform duration-200" fill="none" id="chev-derog" stroke="currentColor" strokeWidth="2" style={{transform: `rotate(180deg)`}} viewBox="0 0 24 24"><path className=""></path></svg>
</button>
</label>
...
<button className="flex ml-auto gap-1.5 hover:bg-neutral-100 transition-colors text-sm text-neutral-600 rounded-md pt-2 pr-3 pb-2 pl-3 items-center" onClick={(e) => { toggleAiHelper('description') }} title="Ouvrir les suggestions IA">
<svg className="lucide lucide-sparkles w-[16px] h-[16px]" data-icon-replaced="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(82, 82, 82)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className=""></path>
<path className=""></path>
<path className=""></path>
...
<svg className="w-4 h-4 text-neutral-500 transition-transform duration-200" fill="none" id="chev-ecart" stroke="currentColor" strokeWidth="2" style={{transform: `rotate(180deg)`}} viewBox="0 0 24 24"><path className=""></path></svg>
</button>
</label>
...
<svg className="w-3.5 h-3.5 text-neutral-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path></svg>
...
<svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20"><path className="" clip-rule="evenodd" fillRule="evenodd"></path></svg>
</div>
</div>
<div className="flex flex-col">
...
<svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path></svg>
            Inclus
          </div>
</div>
</div>
...
<svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20"><path className="" clip-rule="evenodd" fillRule="evenodd"></path></svg>
</div>
</div>
...
<svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path></svg>
              Uploader
            </button>
<button className="hidden inline-flex items-center gap-1.5 rounded-md border px-2 py-1 text-[11px] border-neutral-200 bg-white text-neutral-600 hover:bg-neutral-50" data-action="clear" type="button">Supprimer</button>
</div>
...
<input className="hidden" type="file" />
<button className="inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-xs border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50" data-action="upload" type="button">
<svg box="0 0 24 24" className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path></svg>
                  Uploader
                </button>
...
<svg className="w-4 h-4 text-neutral-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path className=""></path><path className=""></path><path className=""></path></svg>
...
<svg className="w-4 h-4 text-neutral-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect className="" height="5" rx="1" width="20"></rect><path className=""></path><path className=""></path></svg>
...
<svg className="lucide lucide-file-text w-4 h-4" data-lucide="file-text" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
      Ouvrir l’Étude de faisabilité
      <svg className="lucide lucide-arrow-up-right w-4 h-4" data-lucide="arrow-up-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
</div>

<div className="rounded-md border border-neutral-200 bg-neutral-50/60 p-3">
<div className="flex items-start gap-2 text-[13px]">
<svg className="lucide lucide-alert-triangle w-4 h-4 mt-0.5 text-[#B45309]" data-lucide="alert-triangle" fill="none" height="24" stroke="#B45309" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<svg className="lucide lucide-link-2 w-4 h-4" data-lucide="link-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><line></line></svg>
<span>#</span>
</button>
</div>
...
<svg className="lucide lucide-chevron-up w-4 h-4" data-lucide="chevron-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
    Haut du cadre
  </button>

...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/60 hover:bg-white/80 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400" onClick={(e) => { alert('Luna selected!') }}>
...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/60 hover:bg-white/80 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400" onClick={(e) => { alert('Max selected!') }}>
...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/60 hover:bg-white/80 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400" onClick={(e) => { alert('Bella selected!') }}>
...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/60 hover:bg-white/80 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400" onClick={(e) => { alert('Charlie selected!') }}>
...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/60 hover:bg-white/80 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400" onClick={(e) => { alert('Milo selected!') }}>
...
<button className="group flex flex-col items-center p-4 rounded-2xl bg-white/40 hover:bg-white/60 transition-all hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400 border-2 border-dashed border-gray-300" onClick={(e) => { alert('Add new pet!') }}>

...
<circle className="text-indigo-500 progress-ring__circle" cx="50" cy="50" fill="transparent" id="progress-ring" r="42" stroke="currentColor" strokeDasharray="264" strokeDashoffset="0" strokeWidth="4"></circle>
</svg>

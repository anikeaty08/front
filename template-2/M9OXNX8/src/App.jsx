...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&auto=format&fit=crop')`}}></div>
</div>
</div>

<div className="grid gap-4 grid-cols-6 row-2">
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1513326738677-b964603b136d?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1506929562872-bb421503ef21?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1493246507139-91e8fad9978e?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=400&auto=format&fit=crop')`}}></div>
</div>
</div>

<div className="grid gap-4 grid-cols-6 row-3">
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1528543606781-2f6e6857f318?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1551632811-561732d1e306?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400&auto=format&fit=crop')`}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-xl">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=400&auto=format&fit=crop')`}}></div>
</div>
...
<div className="absolute inset-0 w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80')`}}></div>
...
<div className="relative rounded-3xl overflow-hidden shadow-xl w-full h-[400px]">
<div className="absolute inset-0 w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1505761671935-60b3a7427bad?auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
<div className="absolute inset-0 flex flex-col justify-end pt-6 pr-6 pb-6 pl-6">
<div className="glass-overlay rounded-2xl p-5 mb-4">
<div className="flex items-center gap-3 mb-4">
...
<div className="relative rounded-3xl overflow-hidden shadow-xl w-full h-[400px]">
<div className="absolute inset-0 w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1467269204594-9661b134dd2b?auto=format&fit=crop&w=800&q=80')`}}></div>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
<div className="absolute inset-0 flex flex-col justify-end pt-6 pr-6 pb-6 pl-6">
<div className="glass-overlay rounded-2xl p-5 mb-4">
<div className="flex items-center gap-3 mb-4">

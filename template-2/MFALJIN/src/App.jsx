...
<p className="text-sm font-medium" style={{fontWeight: `600`, color: `#0E8D99`}}>Our Fleet</p>
<h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl tracking-tight font-medium" style={{fontFamily: `'Gotham', 'Source Sans Pro', system-ui`, fontWeight: `600`}}>Modern coaches, mini-buses, and accessible vehicles</h2>
<p className="mt-4 text-slate-600" style={{fontFamily: `'Source Sans Pro', system-ui`}}>From long-distance coaches to smaller shuttle buses — maintained, insured, and inspected regularly.</p>
</div>
<div className="grid md:grid-cols-3 gap-6">
<article className="rounded-xl border border-slate-100 overflow-hidden shadow-sm">
<img alt="Coach" className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1542362567-b07e54358753?q=80&w=1200&auto=format&fit=crop" />
<div className="p-5">
<h3 className="text-lg font-medium text-slate-900" style={{fontFamily: `'Gotham', 'Source Sans Pro', system-ui`, fontWeight: `600`}}>Executive Coach</h3>
<p className="mt-2 text-sm text-slate-600" style={{fontFamily: `'Source Sans Pro', system-ui`}}>48 passengers, luggage bays, onboard restroom, reclining seats.</p>
<div className="mt-4 flex items-center justify-between">
<div className="text-sm text-slate-700 font-medium">From $/mile</div>
<a className="text-sm text-[#0F2F55] hover:underline" href="#contact">Get a Quote</a>
</div>
</div>
</article>
<article className="rounded-xl border border-slate-100 overflow-hidden shadow-sm">
<img alt="Minibus" className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=1200&auto=format&fit=crop" />
<div className="p-5">
<h3 className="text-lg font-medium text-slate-900" style={{fontFamily: `'Gotham', 'Source Sans Pro', system-ui`, fontWeight: `600`}}>Mini Coach</h3>
<p className="mt-2 text-sm text-slate-600" style={{fontFamily: `'Source Sans Pro', system-ui`}}>20–30 passengers, ideal for shorter routes and shuttle service.</p>
<div className="mt-4 flex items-center justify-between">
<div className="text-sm text-slate-700 font-medium">Flexible hourly rates</div>
<a className="text-sm text-[#0F2F55] hover:underline" href="#contact">Request Rates</a>
</div>
</div>
</article>
<article className="rounded-xl border border-slate-100 overflow-hidden shadow-sm">
<img alt="Accessible bus" className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=1200&auto=format&fit=crop" />
<div className="p-5">
<h3 className="text-lg font-medium text-slate-900" style={{fontFamily: `'Gotham', 'Source Sans Pro', system-ui`, fontWeight: `600`}}>Accessible Vehicles</h3>
<p className="mt-2 text-sm text-slate-600" style={{fontFamily: `'Source Sans Pro', system-ui`}}>Wheelchair lifts, securement systems, trained drivers for special access needs.</p>
<div className="mt-4 flex items-center justify-between">
<div className="text-sm text-slate-700 font-medium">ADA compliant</div>
<a className="text-sm text-[#0F2F55] hover:underline" href="#contact">Book Accessible</a>
</div>
</div>
</article>
</div>

...
<circle cx="24" cy="24" data-darkreader-inline-fill="" data-darkreader-inline-stroke="" fill="#101216" r="23" stroke="#34BBFF" strokeWidth="2" style={{'--darkreader-inline-stroke': `var(--darkreader-text-34bbff, #3ebeff)`, '--darkreader-inline-fill': `var(--darkreader-text-101216, #dcd9d4)`}}></circle>
<circle cx="24" cy="24" data-darkreader-inline-fill="" data-darkreader-inline-stroke="" fill="#101216" r="13" stroke="#4EFB7F" strokeWidth="2" style={{'--darkreader-inline-stroke': `var(--darkreader-text-4efb7f, #51fb81)`, '--darkreader-inline-fill': `var(--darkreader-text-101216, #dcd9d4)`}}></circle>
<path d="M24 11v13l11 8" data-darkreader-inline-stroke="" stroke="#4EFB7F" strokeLinecap="round" strokeWidth="2.2" style={{'--darkreader-inline-stroke': `var(--darkreader-text-4efb7f, #51fb81)`}}></path>
</svg>
<h1 className="tracking-tight" data-darkreader-inline-color="" id="aura-emc2fps7v" style={{fontFamily: `"IBM Plex Sans", sans-serif`, fontSize: `2.15rem`, fontWeight: `600`, letterSpacing: `-0.025em`, color: `rgb(184, 249, 255)`, marginRight: `1.5rem`, marginLeft: `0.5rem`, textShadow: `rgba(52, 187, 255, 0.125) 0px 2px 7px`, '--darkreader-inline-color': `var(--darkreader-text-b8f9ff, #9af6ff)`}}>CASO Studio: Data Refinery Panel</h1>
</div>
...
<svg className="lucide lucide-database" data-darkreader-inline-stroke="" data-lucide="database" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `19px`, height: `19px`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 21 12"></path></svg> Load New Dataset
      </button>
<button className="icon-btn hover-outline" data-darkreader-inline-bgcolor="" data-darkreader-inline-bgimage="" style={{background: `linear-gradient(90deg, rgba(52, 187, 255, 0.2) 0%, rgba(78, 251, 127, 0.2) 100%)`, '--darkreader-inline-bgimage': `linear-gradient(90deg, var(--darkreader-background-34bbff33, rgba(0, 115, 173, 0.2)) 0%, var(--darkreader-background-4efb7f33, rgba(4, 156, 74, 0.2)) 100%)`, '--darkreader-inline-bgcolor': `initial`}} title="Run Quick Audit">
<svg className="lucide lucide-activity" data-darkreader-inline-stroke="" data-lucide="activity" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `19px`, height: `19px`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg> Quick Audit
      </button>
</div>
</header>
...
<svg className="lucide lucide-microscope" data-darkreader-inline-color="" data-darkreader-inline-stroke="" data-lucide="microscope" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: `rgb(78, 251, 127)`, width: `26px`, height: `26px`, marginBottom: `7px`, '--darkreader-inline-color': `var(--darkreader-text-4efb7f, #51fb81)`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 18h8"></path><path d="M3 22h18"></path><path d="M14 22a7 7 0 1 0 0-14h-1"></path><path d="M9 14h2"></path><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"></path><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"></path></svg>
...
<svg className="lucide lucide-settings" data-darkreader-inline-color="" data-darkreader-inline-stroke="" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: `rgb(52, 187, 255)`, width: `26px`, height: `26px`, marginBottom: `7px`, '--darkreader-inline-color': `var(--darkreader-text-34bbff, #3ebeff)`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg>
...
<svg className="lucide lucide-share" data-darkreader-inline-color="" data-darkreader-inline-stroke="" data-lucide="share" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: `rgb(78, 251, 127)`, width: `26px`, height: `26px`, marginBottom: `7px`, '--darkreader-inline-color': `var(--darkreader-text-4efb7f, #51fb81)`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2v13"></path><path d="m16 6-4-4-4 4"></path><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path></svg>
...
<svg className="lucide lucide-microscope" data-darkreader-inline-color="" data-darkreader-inline-stroke="" data-lucide="microscope" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: `rgb(78, 251, 127)`, width: `32px`, height: `32px`, '--darkreader-inline-color': `var(--darkreader-text-4efb7f, #51fb81)`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 18h8"></path><path d="M3 22h18"></path><path d="M14 22a7 7 0 1 0 0-14h-1"></path><path d="M9 14h2"></path><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"></path><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"></path></svg>
<div>
<div data-darkreader-inline-color="" style={{fontSize: `1.3rem`, fontWeight: `600`, color: `rgb(184, 249, 255)`, '--darkreader-inline-color': `var(--darkreader-text-b8f9ff, #9af6ff)`}}>
                Data Source Health Overview
              </div>
<div data-darkreader-inline-color="" style={{color: `rgb(164, 247, 228)`, fontSize: `1.03rem`, '--darkreader-inline-color': `var(--darkreader-text-a4f7e4, #90f5de)`}}>
<span data-darkreader-inline-color="" style={{color: `rgb(78, 251, 127)`, '--darkreader-inline-color': `var(--darkreader-text-4efb7f, #51fb81)`}}>76%</span> valid, <span data-darkreader-inline-color="" style={{color: `rgb(52, 187, 255)`, '--darkreader-inline-color': `var(--darkreader-text-34bbff, #3ebeff)`}}>12%</span> missing, <span data-darkreader-inline-color="" style={{color: `rgb(244, 193, 92)`, '--darkreader-inline-color': `var(--darkreader-text-f4c15c, #f4c15d)`}}>8%</span> anomalous, <span data-darkreader-inline-color="" style={{color: `rgb(255, 92, 148)`, '--darkreader-inline-color': `var(--darkreader-text-ff5c94, #ff5a93)`}}>4%</span> rejected
              </div>
</div>
</div>
...
<svg className="lucide lucide-download-cloud" data-darkreader-inline-stroke="" data-lucide="download-cloud" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `18px`, height: `18px`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 13v8l-4-4"></path><path d="m12 21 4-4"></path><path d="M4.393 15.269A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.436 8.284"></path></svg> Export Report
            </button>
</div>
</div>
...
<svg className="lucide lucide-bar-chart-3" data-darkreader-inline-color="" data-darkreader-inline-stroke="" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: `rgb(52, 187, 255)`, width: `28px`, height: `28px`, '--darkreader-inline-color': `var(--darkreader-text-34bbff, #3ebeff)`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>
<div>
...
<button className="icon-btn hover-outline text-xs py-1 px-2" style={{fontSize: `0.99rem`}}><svg className="lucide lucide-download-cloud" data-darkreader-inline-stroke="" data-lucide="download-cloud" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, '--darkreader-inline-stroke': `currentColor`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 13v8l-4-4"></path><path d="m12 21 4-4"></path><path d="M4.393 15.269A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.436 8.284"></path></svg> Export</button>
</div>
</div>
</div>

...
export default function App() {
  useEffect(() => {
    ...
    try {
        ...
        function switchLogoSet() {
            if (currentSet === 1) {
                logoSet1.classList.add('fade-out');
                logoSet1.classList.remove('active');
                
                setTimeout(() => {
                    logoSet2.classList.add('fade-in', 'active');
                    logoSet2.classList.remove('fade-out');
                    currentSet = 2;
                }, 500);
            } else {
                logoSet2.classList.add('fade-out');
                logoSet2.classList.remove('active');
                
                setTimeout(() => {
                    logoSet1.classList.add('fade-in', 'active');
        ...
        setInterval(switchLogoSet, 4000);

        // Initialize first set
        logoSet1.classList.add('active');
...
<div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto logo-set active" id="logoSet1">
...
<div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto logo-set absolute inset-0" id="logoSet2">

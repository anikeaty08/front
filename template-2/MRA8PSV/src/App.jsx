...
<button className="px-4 py-2 text-sm rounded-xl bg-primary-50 text-primary-600 hover:bg-primary-100 dark:bg-primary-900 dark:text-primary-300" onClick={(e) => { document.getElementById('fileUpload').click() }} type="button">
                        Browse Files
                      </button>

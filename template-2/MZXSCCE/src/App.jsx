...

{
  ...
  // Скрываем модалку успеха при загрузке
  hideSuccessMessage();
...
<div className="fixed left-6 top-1/2 -translate-y-1/2 z-40 hidden xl:block" id="statusIndicator" style={{transform: `translateY(calc(-50% - 343.7px)) scale(0.92)`, filter: `drop-shadow(rgba(34, 197, 94, 0.55) 0px 0px 20px)`}}>
...
<div className="fixed z-[60] pointer-events-none rounded-full" id="spotlight" style={{width: `220px`, height: `220px`, borderRadius: `9999px`, background: `white`, mixBlendMode: `difference`, opacity: `0`, transform: `translate(-50%, -50%)`, left: `174px`, top: `315px`}}></div>
...
<h1 className="md:text-3xl lg:text-6xl text-4xl font-semibold tracking-tight font-nunito mt-2 mb-2" id="heroHeadline"><span style={{display: `inline-block`}}>П</span><span style={{display: `inline-block`}}>р</span><span style={{display: `inline-block`}}>о</span><span className="" style={{display: `inline-block`}}>д</span><span className="" style={{display: `inline-block`}}>у</span><span className="" style={{display: `inline-block`}}>к</span><span style={{display: `inline-block`}}>т</span><span className="" style={{display: `inline-block`}}>о</span><span style={{display: `inline-block`}}>в</span><span style={{display: `inline-block`}}>ы</span><span style={{display: `inline-block`}}>й</span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`}}>д</span><span style={{display: `inline-block`}}>и</span><span style={{display: `inline-block`}}>з</span><span style={{display: `inline-block`}}>а</span><span style={{display: `inline-block`}}>й</span><span style={{display: `inline-block`}}>н</span><span style={{display: `inline-block`}}>е</span><span style={{display: `inline-block`}}>р</span></h1>
...
<h2 className="md:text-5xl text-4xl font-light tracking-tight">Чем я занимаюсь</h2>
...
<footer className="relative border-white/10 border-t pt-20 pb-24" id="contact">
<div className="mx-auto max-w-7xl px-6 lg:px-8">
...
<a className="inline-flex items-center gap-3 md:text-base hover:bg-white/15 transition-all hover:scale-[1.02] text-sm font-medium text-white bg-white/10 border-white/20 border rounded-full pt-3.5 pr-7 pb-3.5 pl-7 backdrop-blur" href="#" id="scheduleCallBtn">
...
<path></path>
<path></path>
<rect className="" height="18" rx="2" width="18"></rect>
<path></path>
</svg></a>
</div>
...
<div className="bg-gradient-to-b from-white/10 to-white/5 border-white/10 border rounded-3xl pt-8 pr-8 pb-8 pl-8" data-anim="fade-in" data-delay="200">
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 opacity-0 pointer-events-none transition-all duration-300 backdrop-blur-lg" id="scheduleModal" style={{display: `none`}}>
<div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-white/15 rounded-2xl max-w-md w-full p-6 backdrop-blur-xl shadow-2xl" onClick={(e) => { event.stopPropagation() }}>
...
<svg className="lucide lucide-x w-5 h-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</button>
...
<path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path>
</svg>
          Дата *
        </label>
<input className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200 placeholder-gray-500" id="callDate" min="2025-09-07" name="date" required type="date" />
</div>
<div>
...
<circle cx="12" cy="12"></circle><polyline points="12 6 12 12 16 14"></polyline>
</svg>
          Время *
        </label>
...
<path></path><rect height="18" rx="2" width="18"></rect><circle cx="12" cy="10"></circle><path></path><path></path>
</svg>
          Email или телефон *
        </label>
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 opacity-0 pointer-events-none transition-all duration-300 backdrop-blur-lg" id="successMessage" style={{display: `none`}}>
<div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-white/15 rounded-2xl max-w-md w-full p-8 backdrop-blur-xl text-center shadow-2xl" onClick={(e) => { event.stopPropagation() }}>
<div className="mb-5">

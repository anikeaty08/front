...
<section className="relative overflow-hidden bg-[url(/assets/3d6636b4-b2ea-42f4-a4b1-f31ec35af96b_3840w.jpg)] bg-cover" id="platform" style={{}}>
...
<section className="bg-[url(/assets/a0c744d5-9d12-42c9-a431-77b086938f4b_3840w.jpg)] bg-cover pt-24 pr-6 pb-24 pl-6" id="solutions">
<div className="container mx-auto">
...
<img alt="Marcus Thompson" className="w-16 h-16 rounded-full object-cover" src="/assets/b62eea8b-831c-41a3-b9b1-21f4c25de5e5_800w.jpg" style={{}} />
<div>
...
<div className="opacity-0 animate-fade-in-right animate-delay-200" style={{opacity: `1`, transform: `translateY(0px)`}}>
<img alt="Modern office environment" className="w-full h-96 object-cover rounded-2xl shadow-xl" src="/assets/fa727995-a530-4803-be97-b588c2a202ad_1600w.jpg" style={{}} />
</div>
</div>
</div>
</section>

<section className="text-neutral-200 bg-neutral-900 bg-[url(/assets/ad24d59f-0f44-4c69-9ffb-626ad87a3d65_3840w.jpg)] bg-cover pt-24 pr-6 pb-24 pl-6" id="resources">
<div className="container mx-auto">
<div className="text-center mb-16 opacity-0 animate-fade-in-up" style={{opacity: `1`, transform: `translateY(0px)`}}>

...
export default function App() {
  ...
  return (
    <>
      <div className="spline-container fixed top-0 w-full h-screen -z-10"><iframe frameborder="0" height="100%" id="aura-spline" src="https://my.spline.design/unchained-d3hHCgdWho7a8ATGzKtB11TU" width="100%"></iframe></div>

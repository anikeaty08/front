...
<button className="w-full px-4 py-2 rounded-md font-medium text-sm transition-all bg-gray-800/80 text-gray-300 hover:bg-gray-700/80 hover:shadow-sm ring-1 ring-gray-700/60" id="t9TeamsButton" onClick={(e) => { toggleT9Teams()
                     }}>

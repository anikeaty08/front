...
<img alt="" className="h-full w-full object-cover" src="/assets/8e20c91b-860e-4c2f-9c61-acca8fa7428f_3840w.jpg" />
...
<img alt="Misty forest path" className="w-full h-80 object-cover" src="/assets/945ae6b8-3f41-4f19-b61e-fc8d622ec7c0_1600w.jpg" />
<div className="p-8">
...
<div className="rounded-3xl overflow-hidden bg-zinc-800/30 border border-zinc-700/30 backdrop-blur">
<img alt="Serene lake at sunset" className="w-full h-80 object-cover" src="/assets/ea8340c6-2f32-4780-8a61-0075ee995c03_1600w.jpg" />
<div className="p-8">
...
<img alt="Traveler" className="size-10 object-cover rounded-2xl" src="/assets/eb205ad5-97fe-4855-b28b-05c6a796f20f_320w.jpg" />
<div className="">
...
<div className="flex items-center gap-3">
<img alt="Traveler" className="size-10 object-cover rounded-2xl" src="/assets/bb990be3-dd53-4b38-aca4-7b6423eb2baa_320w.jpg" />
<div className="">
...
<div className="flex items-center gap-3">
<img alt="Traveler" className="size-10 object-cover rounded-2xl" src="/assets/bd1eb571-6afa-4553-9637-e3d69570481a_320w.jpg" />
<div>
...
<img alt="Community gathering" className="w-full h-full object-cover opacity-20" src="/assets/0db47eea-1632-45dc-911f-2c9f72fafb6a_3840w.jpg" />
</div>
<div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
<div className="mx-auto max-w-2xl text-center mb-16 fade-in">

...
<button className="flex items-center space-x-2 p-1 rounded-full hover:bg-gray-800 transition" onClick={(e) => { toggleUserMenu() }}>
<img alt="" className="w-8 h-8 rounded-full object-cover ring-2 ring-gray-700" src="/assets/5113900d-1c55-4c45-a282-e60d9aea22d6_320w.jpg" />
</button>
...
<button aria-label="Menu" className="md:hidden transition text-gray-400 hover:text-gray-100" onClick={(e) => { toggleMobileMenu() }}>
...
<button className="md:hidden flex items-center space-x-2 px-4 py-2 bg-gray-800 rounded-lg text-sm" onClick={(e) => { toggleFilters() }}>
...
<input className="flex-1 bg-transparent border-0 p-0 focus:ring-0 text-sm placeholder-gray-500" onKeyUp={(e) => { handleSearchInput(e.currentTarget) }} placeholder="San Francisco, CA" type="text" value="San Francisco, CA" />
<button className="ml-2 text-gray-400 hover:text-gray-200" onClick={(e) => { clearInput(e.currentTarget) }}>
...
<input className="flex-1 bg-transparent border-0 p-0 focus:ring-0 text-sm placeholder-gray-500" onChange={(e) => { handleDateChange() }} type="date" value="2024-01-15" />
</div>
<div className="bg-black border border-gray-800 rounded-lg flex items-center px-4 py-3 focus-within:border-blue-500 transition">
...
<select className="flex-1 bg-transparent border-0 p-0 focus:ring-0 text-sm" onChange={(e) => { handleTypeFilter() }}>
...
<button className="flex items-center space-x-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm transition" onClick={(e) => { togglePriceFilter() }}>
...
<button className="flex items-center space-x-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm transition" onClick={(e) => { toggleFeatureFilter() }}>
<span>Features</span>
<svg className="lucide lucide-chevron-down w-4 h-4" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</button>
...
<button className="ml-1" onClick={(e) => { removeFilter(e.currentTarget) }}>
...
<button className="flex items-center space-x-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm transition" onClick={(e) => { toggleMapView() }}>
...
<select className="bg-black border border-gray-800 rounded-lg text-sm px-3 py-2 focus:ring-0 focus:border-blue-500 transition" onChange={(e) => { handleSort() }}>
...
<article className="relative bg-black border border-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden card-hover cursor-pointer" onClick={(e) => { viewCarDetails('bmw-x5') }}>
<div className="relative">
...
<button aria-label="Save" className="absolute top-3 right-3 p-2 bg-black/50 backdrop-blur-sm rounded-full transition hover:bg-black/70" onClick={(e) => { event.stopPropagation(); toggleFavorite(e.currentTarget) }}>
...
<button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg text-sm font-medium transition" onClick={(e) => { event.stopPropagation(); quickBook('bmw-x5') }}>
            Quick Book
          </button>
</div>
</div>
...
<article className="relative bg-black border border-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden card-hover cursor-pointer" onClick={(e) => { viewCarDetails('porsche-911') }}>
<div className="relative">
...
<button aria-label="Save" className="absolute top-3 right-3 p-2 bg-black/50 backdrop-blur-sm rounded-full transition hover:bg-black/70 heart-liked" onClick={(e) => { event.stopPropagation(); toggleFavorite(e.currentTarget) }}>
...
<button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg text-sm font-medium transition" onClick={(e) => { event.stopPropagation(); quickBook('porsche-911') }}>
            Quick Book
          </button>
</div>
</div>
...
<article className="relative bg-black border border-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden card-hover cursor-pointer" onClick={(e) => { viewCarDetails('tesla-s') }}>
<div className="relative">
...
<button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg text-sm font-medium transition" onClick={(e) => { event.stopPropagation(); quickBook('tesla-s') }}>
            Quick Book
          </button>
</div>
</div>
...
<article className="relative bg-black border border-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden card-hover cursor-pointer" onClick={(e) => { viewCarDetails('mercedes-g') }}>
<div className="relative">
...
<button className="flex items-center space-x-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm font-medium transition" onClick={(e) => { loadMoreCars() }}>

...
<div className="group">
<button className="flex w-full items-center justify-between px-6 py-5 focus:outline-none focus:bg-white/10 transition" onClick={(e) => { toggleFaq(0) }} type="button">
...
<div className="group">
<button className="flex w-full items-center justify-between px-6 py-5 focus:outline-none focus:bg-white/10 transition" onClick={(e) => { toggleFaq(1) }} type="button">
...
<div className="group">
<button className="flex w-full items-center justify-between px-6 py-5 focus:outline-none focus:bg-white/10 transition" onClick={(e) => { toggleFaq(2) }} type="button">
...
<div className="group">
<button className="flex w-full items-center justify-between px-6 py-5 focus:outline-none focus:bg-white/10 transition" onClick={(e) => { toggleFaq(3) }} type="button">
...
<div className="group">
<button className="flex w-full items-center justify-between px-6 py-5 focus:outline-none focus:bg-white/10 transition" onClick={(e) => { toggleFaq(4) }} type="button">

...
<template id="nodeToolbarTpl"><div className="absolute -top-3 right-3 z-20 inline-flex items-center gap-1 bg-white border border-slate-200 rounded-md shadow-sm px-1.5 py-1"><button className="p-1 rounded hover:bg-neutral-100 text-slate-700 cursor-move" data-action="move" title="Drag to move"><i className="w-4 h-4" data-lucide="move"></i></button><button className="p-1 rounded hover:bg-neutral-100 text-slate-700" data-action="up" title="Move up"><i className="w-4 h-4" data-lucide="arrow-up"></i></button><button className="p-1 rounded hover:bg-neutral-100 text-slate-700" data-action="down" title="Move down"><i className="w-4 h-4" data-lucide="arrow-down"></i></button><button className="p-1 rounded hover:bg-neutral-100 text-slate-700" data-action="duplicate" title="Duplicate"><i className="w-4 h-4" data-lucide="copy"></i></button><button className="p-1 rounded hover:bg-neutral-100 text-rose-600" data-action="delete" title="Delete"><i className="w-4 h-4" data-lucide="trash-2"></i></button></div></template>

...
<circle className="segment-hover" cx="50" cy="50" fill="none" id="youtube-segment" r="40" stroke="#F87171" strokeDasharray="0 251.2" strokeDashoffset="0" strokeWidth="20">
</circle>
</svg>

<svg className="absolute inset-0 transform -rotate-90" viewBox="0 0 100 100">
<circle className="segment-hover" cx="50" cy="50" fill="none" id="design-segment" r="40" stroke="#3B82F6" strokeDasharray="0 251.2" strokeDashoffset="0" strokeWidth="20">
</circle>
</svg>

<svg className="absolute inset-0 transform -rotate-90" viewBox="0 0 100 100">
<circle className="segment-hover" cx="50" cy="50" fill="none" id="angle-segment" r="40" stroke="#A855F7" strokeDasharray="0 251.2" strokeDashoffset="0" strokeWidth="20">
</circle>
</svg>

...
<div className="orbital-item avatar" style={{backgroundImage: `url('https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80')`}}></div>
</div>
<div className="orbital-element" id="orbital-6">
<div className="orbital-item avatar" style={{backgroundImage: `url('https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80')`}}></div>
</div>
<div className="orbital-element" id="orbital-7">
<div className="orbital-item avatar" style={{backgroundImage: `url('https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80')`}}></div>
</div>
</div>

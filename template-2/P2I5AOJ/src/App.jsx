...
<div className="absolute top-0 w-full -z-10 h-[900px] blur-3xl bg-cover bg-center opacity-80" style={{backgroundImage: `url('https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=2400&auto=format&fit=crop')`}}></div>
...
<article className="relative overflow-hidden aspect-[4/3] bg-cover bg-center border border-neutral-200 rounded-2xl" style={{backgroundImage: `url('https://images.unsplash.com/photo-1519315901367-f34ff9154487?q=80&w=1200&auto=format&fit=crop')`}}>

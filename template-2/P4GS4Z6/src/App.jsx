...
<div className="flex-1">
<form action="mailto:snapfind.help@gmail.com" className="bg-white/80 backdrop-blur-lg border rounded-xl shadow-sm p-5 flex flex-col gap-3" enctype="text/plain" method="POST" onSubmit={(e) => { alert('이메일 클라이언트가 열립니다.\n작동하지 않을 경우 위 이메일로 직접 보내주세요!'); }}>

...
slideRight: { '0%': { opacity: '0', transform: 'translateX(-30px)' }, '100%': { opacity: '1', transform: 'translateX(0)' } }
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image" style={{backgroundImage: `url("/assets/21f5cac3-90a8-4ccb-bd07-9bbecae12dd5_3840w.jpg")`}}></div>
...
<img alt="avatar" className="w-9 h-9 rounded-full object-cover ring-2 ring-orange-500/80" src="/assets/10b82f02-0664-4276-be7d-8b63b0623907_320w.jpg" style={{}} />
...
<img alt="TechHub Central" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" src="/assets/2d7b9294-2ae6-4b09-865d-c46481dfaccc_800w.jpg" style={{}} />
</div>
...
<div className="rounded-lg overflow-hidden aspect-[4/3] mb-4">
<img alt="Creative District" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" src="/assets/3b175135-a5f6-4b15-bd83-d88886f4f40e_800w.jpg" style={{}} />
</div>
<div className="flex items-center justify-between text-sm mb-4">
<div className="flex items-center gap-4 text-white/70">
<span className="flex items-center gap-1 font-geist">
...
<div className="rounded-lg overflow-hidden aspect-[4/3] mb-4">
<img alt="Business Plaza" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" src="/assets/e746e827-f5eb-429e-a946-e41035adc171_800w.jpg" style={{}} />
</div>
<div className="flex items-center justify-between text-sm mb-4">
<div className="flex items-center gap-4 text-white/70">
<span className="flex items-center gap-1 font-geist">

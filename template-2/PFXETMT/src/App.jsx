...
<button className="bg-accent text-primary font-semibold rounded-xl px-4 py-2 shadow-soft hover:scale-105 transition" onClick={(e) => { document.getElementById('loginModal').classList.remove('hidden') }}>Login / Signup</button>
...
<button className="bg-accent text-primary px-8 py-3 rounded-2xl font-semibold shadow-soft text-lg hover:scale-105 transition" onClick={(e) => { document.getElementById('loginModal').classList.remove('hidden') }}>Get Started</button>
</div>
</section>
...
<button className="absolute top-4 right-4 text-muted hover:text-accent transition text-2xl" onClick={(e) => { document.getElementById('loginModal').classList.add('hidden') }}>×</button>

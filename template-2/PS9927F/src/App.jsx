...
<path fill="none" stroke="#e5e7eb" strokeDasharray="100, 100" strokeWidth="3"></path>
<path fill="none" stroke="#eab308" strokeDasharray="71, 100" strokeWidth="3"></path>
<text fill="#374151" fontSize="8" font-weight="bold" text-anchor="middle">71%</text>
</svg>
</div>
...
<div className="absolute inset-y-0 left-10%" style={{width: `8%`}}></div>

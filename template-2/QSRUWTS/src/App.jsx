...
<div className="tracking-tight" style={{fontWeight: `600`, letterSpacing: `-0.06em`, fontSize: `20px`, background: `linear-gradient(92.52deg, var(--main-red) 29.95%, var(--main-yellow) 48.66%, var(--roxo-vibrante) 86.58%)`, backgroundSize: `200% 200%`, animation: `moveGradient 4s infinite linear`}}>aisa</div>
...
<svg className="text-slate-200" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewBox="0 0 18 12" width="18"><path></path></svg>
</button>
</div>
</div>
</div>
...
<svg className="w-4 h-4 text-slate-200" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
</div>
</div>
</div>
...
<div className="min-w-[260px] w-[260px] rounded-2xl overflow-hidden shadow-xl border border-slate-700/40 bg-gradient-to-tr from-white/5 to-white/3 backdrop-blur-md" style={{}}>
<div className="h-[140px] bg-center bg-cover" id="aura-eme3dt4g7" style={{backgroundImage: `url(https://cdn.prod.website-files.com/679d467e1ba7f0477be7d60e/67aa9187e1961d612243b85a_claro.svg)`}}></div><div className="p-4 bg-white/6 backdrop-blur-sm">
<div className="flex items-start justify-between">
<div className="">
...
<div className="ml-3 self-end">
<span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-white/10">
<svg className="w-4 h-4 text-slate-200" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path></path><path className=""></path></svg>
</span>
</div>
</div>
</div>
...
<svg className="w-5 h-5 text-slate-200" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
</button>
...
<svg className="text-white" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="28"><circle cx="12" cy="12"></circle><circle cx="12" cy="12"></circle><circle cx="12" cy="12"></circle></svg>
</div>
...
<svg className="text-white" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="28"><path></path></svg>
</div>
...
<svg className="text-white" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="28"><path></path><circle cx="9" cy="7"></circle><path></path></svg>
</div>
...
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16"><circle cx="12" cy="12"></circle><path></path></svg>
</div>
...
<div className="w-8 h-8 mx-auto rounded-md bg-slate-700 flex items-center justify-center mb-2" style={{}}>
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16"><circle cx="12" cy="12"></circle></svg>
</div>
...
<div className="w-8 h-8 mx-auto rounded-md bg-slate-700 flex items-center justify-center mb-2" style={{}}>
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16"><path></path></svg>
</div>
...
<a className="text-slate-400 hover:text-white" href="#" style={{}}><svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16"><rect height="20" rx="5" width="20"></rect><circle cx="12" cy="12"></circle></svg></a>

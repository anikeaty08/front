...
<path d="M 613.328125,861.9296875 C 613.328125,961.9296875 773.32890625,961.9296875 879.99609375,962.49609375
                   S 1146.6640625,963.0625 1146.6640625,1063.0625" fill="none" filter="url(#soft-glow)" id="connection-path" stroke="rgba(16,185,129,0.28)" strokeDasharray="4 8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
...
<line stroke="rgba(110,231,183,0.15)" strokeDasharray="6 12" strokeWidth="2" x1="600" x2="600" y1="70" y2="630"></line>
...
<a className="inline-flex items-center gap-2 hover:bg-emerald-400 transition-colors text-sm font-medium rounded-full pt-3 pr-6 pb-3 pl-6 relative overflow-hidden" href="#" onMouseOut={(e) => { e.currentTarget.style.color='var(--green)'; e.currentTarget.style.boxShadow='inset 0 0 10px rgba(27, 253, 156, 0.4), 0 0 9px 3px rgba(27, 253, 156, 0.1)'; e.currentTarget.querySelector('.sweep-effect').style.transform='translateX(-4em)'; }} onMouseOver={(e) => { e.currentTarget.style.color='#82ffc9'; e.currentTarget.style.boxShadow='inset 0 0 10px rgba(27, 253, 156, 0.6), 0 0 9px 3px rgba(27, 253, 156, 0.2)'; e.currentTarget.querySelector('.sweep-effect').style.transform='translateX(15em)'; }} style={{'--green': `#1BFD9C`, fontSize: `15px`, padding: `0.7em 2.7em`, letterSpacing: `0.06em`, position: `relative`, fontFamily: `inherit`, borderRadius: `2.6em`, overflow: `hidden`, lineHeight: `1.4em`, border: `2px solid var(--green)`, background: `linear-gradient(to right, rgba(27, 253, 156, 0.1) 1%, transparent 40%, transparent 60%, rgba(27, 253, 156, 0.1) 100%)`, color: `var(--green)`, boxShadow: `rgba(27, 253, 156, 0.4) 0px 0px 10px inset, rgba(27, 253, 156, 0.1) 0px 0px 9px 3px`}}>

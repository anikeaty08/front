...
<button className="mt-4 md:mt-0 ml-0 md:ml-8 bg-blue-600 text-white px-5 py-2 rounded font-semibold hover:bg-blue-700 transition" onClick={(e) => { document.getElementById('cv-modal').classList.remove('hidden') }}>Apply / Submit CV</button>
</div>
...
<button className="text-gray-500 hover:text-gray-900" onClick={(e) => { document.getElementById('cv-modal').classList.add('hidden') }}>×</button>
</div>
<form className="space-y-4">
<div>

...
<div className="p-2">
<img alt="Exploradora en terrazas de arroz al atardecer" className="w-full h-[420px] sm:h-[520px] lg:h-[560px] object-cover rounded-[20px]" onError={(e) => { e.currentTarget.onerror=null;e.currentTarget.src='https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=1600&auto=format&fit=crop'; }} src="hero.jpg" />
</div>

...
<svg className="lucide lucide-compass h-3.5 w-3.5" data-lucide="compass" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="12"></circle></svg>
...
<div className="flex items-center gap-2">
<svg className="lucide lucide-percent h-5 w-5 text-slate-900" data-lucide="percent" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><line></line><circle cx="6.5" cy="6.5"></circle><circle cx="17.5" cy="17.5"></circle></svg>
<h3 className="text-base font-semibold tracking-tight">10% CAGR (luxury new‑builds)</h3>
</div>
</div>
<div className="rounded-3xl bg-white ring-1 ring-slate-200 p-6">
<div className="flex items-center gap-2">
<svg className="lucide lucide-land-plot h-5 w-5 text-slate-900" data-lucide="land-plot" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
<h3 className="text-base font-semibold tracking-tight">EU‑aligned infra & visa policy</h3>
</div>
</div>
<div className="rounded-3xl bg-white ring-1 ring-slate-200 p-6">
<div className="flex items-center gap-2">
<svg className="lucide lucide-sparkles h-5 w-5 text-slate-900" data-lucide="sparkles" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
<h3 className="text-base font-semibold tracking-tight">Cultural pull for UK/EU/Gulf</h3>
</div>
</div>
<div className="rounded-3xl bg-white ring-1 ring-slate-200 p-6">
<div className="flex items-center gap-2">
<svg className="lucide lucide-train-front h-5 w-5 text-slate-900" data-lucide="train-front" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path></svg>
...
<svg className="lucide lucide-target h-5 w-5 text-slate-900" data-lucide="target" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><circle cx="12" cy="12"></circle><circle cx="12" cy="12"></circle></svg>
<div className="">
...
<div className="flex items-start gap-3 rounded-2xl ring-1 ring-slate-200 p-4">
<svg className="lucide lucide-stamp h-5 w-5 text-slate-900" data-lucide="stamp" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
<div className="">
...
<div className="flex items-start gap-3 rounded-2xl ring-1 ring-slate-200 p-4">
<svg className="lucide lucide-building h-5 w-5 text-slate-900" data-lucide="building" fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path><rect height="20" rx="2" width="16"></rect></svg>
<div className="">
...
<svg className="lucide lucide-arrow-right h-4 w-4" data-lucide="arrow-right" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
<a className="inline-flex items-center gap-2 rounded-xl bg-white text-slate-900 ring-1 ring-slate-200 text-sm font-semibold px-4 py-2.5 shadow-sm hover:bg-slate-50 transition" href="#teaser">
<span className="">Get Teaser Pack</span>
<svg className="lucide lucide-file-down h-4 w-4" data-lucide="file-down" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</a>
</div>
</div>
</div>

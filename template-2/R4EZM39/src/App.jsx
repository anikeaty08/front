...
<button className="bg-pink-600 text-white px-6 py-2 rounded-full font-bold hover:bg-pink-800 transition" onClick={(e) => { showPrompt() }}>Next</button>
</div>
...
<button className="bg-purple-600 text-white px-6 py-2 rounded-full font-bold hover:bg-purple-800 transition" onClick={(e) => { showAlbum() }}>Snap Album Cover!</button>
<button className="bg-gray-200 border border-purple-300 text-purple-700 px-4 py-2 rounded-full font-semibold hover:bg-purple-100" onClick={(e) => { restartWebcam() }}>Retake Photo</button>
</div>
</div>
...
<button className="mt-4 bg-blue-600 text-white px-6 py-2 rounded-full font-bold hover:bg-blue-800 transition" onClick={(e) => { restart() }}>Make Another!</button>
</div>

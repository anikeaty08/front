...
<div className="relative w-full max-w-xl rounded-3xl border border-neutral-200 bg-white p-2 ring-1 ring-black/5" style={{boxShadow: `0 1px 2px rgba(0,0,0,0.05),

...
<template id="indicatorTemplate"><div className="relative rounded-lg border border-gray-800 bg-gray-800/60 p-4 overflow-hidden backdrop-blur-md group"><h3 className="text-base font-medium text-gray-200 mb-1 flex items-center gap-2"><span className="indicator-icon text-xl"></span><span className="indicator-title flex-1"></span></h3><div className="flex items-end space-x-2 mb-1"><span className="text-2xl font-semibold indicator-value"></span></div><p className="text-xs text-gray-400 indicator-trend mb-2"></p><p className="text-xs text-gray-500 indicator-desc leading-snug"></p><div className="absolute inset-0 pointer-events-none rounded-lg ring-0 ring-yellow-500 transition group-hover:ring-2"></div></div></template>
</div>

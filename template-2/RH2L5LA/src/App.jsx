...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('pizza') }}>
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('burger') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('taco') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('ramen') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('ice-cream') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('pasta') }}>
<div className="relative">
...
<div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden border border-orange-200/50 food-card transition-all duration-300 goofy-shadow cursor-pointer" onClick={(e) => { openFoodPreview('salad') }}>
<div className="relative">

...
<path className="fade-in anim-delay-0" stroke="#6366f1" strokeLinecap="round"></path>

<path className="fade-in anim-delay-1" stroke="#7c3aed" strokeLinecap="round"></path>

<path className="fade-in anim-delay-2" stroke="#6366f1" strokeLinecap="round"></path>
</svg>

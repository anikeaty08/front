...
<div className="aspect-[16/9] bg-center bg-cover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1541271696563-3be2f555fc4e?q=80&w=1400&auto=format&fit=crop')`}}></div>
<div className="p-6">
...
<div className="rounded-2xl border border-white/10 bg-white/[0.04] overflow-hidden">
<div className="aspect-[16/9] bg-center bg-cover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?q=80&w=1400&auto=format&fit=crop')`}}></div>
<div className="p-6">
<div className="flex items-center gap-3">
...
<form className="mt-4 flex flex-col sm:flex-row gap-3" onSubmit={(e) => { event.preventDefault(); window.open(lumaUrl,'_blank','noopener'); }}>

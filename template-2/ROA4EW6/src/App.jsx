...
<div className="bg-white rounded-xl shadow-sm p-5 flex flex-col gap-4" x-data="{show:true}" x-show="show">
<div className="flex items-center gap-4">
...
<div className="bg-white rounded-xl shadow-sm p-5 space-y-4" x-data="{running:true,seconds:0}" x-init="setInterval(()=>running?seconds++:null,1000)">
...
<button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-red-600 text-white hover:bg-red-500 transition">
<lucide-phone-off className="w-4 h-4 stroke-1.5"></lucide-phone-off>
              Завершить
            </button>
<button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-700 transition">
...
<button className="py-2 font-medium transition">Скрипт</button>
<button className="py-2 font-medium transition">Заметки</button>
</div>
...
<div className="h-full" x-show="tab==='notes'">
...
<div className="bg-white rounded-xl shadow-sm p-5" x-show="true">

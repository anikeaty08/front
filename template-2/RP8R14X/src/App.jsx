...
export default function App() {
  useEffect(() => {
    ...
    particlesJS('particles-js',{
      ...
      shape:{type:'circle'},opacity:{value:.25,random:true},
      size:{value:3,random:true},move:{enable:true,speed:1,out_mode:'out'}},
    ...
    new Chart(document.getElementById('cashFlowChart'),{
      type:'line',
      data:{labels:['Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'],
        datasets:[
    ...
    new Chart(document.getElementById('expensesChart'),{
      type:'bar',
      data:{labels:['HR','Hosting','Sales','R&D','Operations','Other'],
    ...
    function openSidebar(){
      ...
      sidebarClose.classList.remove('opacity-0','pointer-events-none');
    ...
    function closeSidebar(){
      ...
      sidebarClose.classList.add('opacity-0','pointer-events-none');
...
<aside className="fixed inset-y-0 left-0 z-50 w-64 glass border-r border-white/10 flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out" id="sidebar">

<div className="relative h-16 flex items-center gap-2 px-6 border-b border-white/10">
...
<button aria-label="Close menu" className="lg:hidden absolute right-4 top-1/2 -translate-y-1/2 hover:text-indigo-400 transition opacity-0 pointer-events-none" id="sidebarClose">
<svg className="w-5 h-5" data-lucide="x"></svg>
</button>
</div>
...
<div aria-hidden="true" className="fixed inset-0 bg-black/40 backdrop-blur-sm z-40 opacity-0 pointer-events-none transition-opacity lg:hidden" id="overlay"></div>

<header className="sticky top-0 z-40 glass border-b border-white/10 lg:left-64 lg:w-[calc(100%-16rem)]">
<div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between lg:justify-end">

<button aria-expanded="false" aria-label="Open menu" className="relative lg:hidden hover:text-indigo-400 transition" id="burger">
<svg className="icon-menu w-6 h-6" data-lucide="menu"></svg>
<svg className="icon-close w-6 h-6 hidden" data-lucide="x"></svg>
</button>
<div className="flex items-center gap-5">
<button aria-label="Notifications" className="relative hover:text-indigo-400 transition">
...
<section className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 grid gap-14 items-center fade-up" style={{animationDelay: `.1s`}}>
<div>
<h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight bg-gradient-to-br from-indigo-300 via-purple-400 to-fuchsia-500 bg-clip-text text-transparent">
...
<div className="relative h-64 sm:h-80 lg:h-96 rounded-3xl overflow-hidden hover-scale">
...
<section className="max-w-7xl mx-auto px-6 lg:px-8 mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
...
<section className="max-w-7xl mx-auto px-6 lg:px-8 mt-24 grid grid-cols-1 lg:grid-cols-3 gap-10">
...
<div className="mt-6"><div><canvas height="140" id="cashFlowChart"></canvas></div></div>
</div>
...
<section className="max-w-7xl mx-auto px-6 lg:px-8 mt-24 glass rounded-3xl p-8 border border-white/10 hover-scale fade-up" style={{animationDelay: `.45s`}}>
<h2 className="text-lg font-semibold tracking-tight flex items-center gap-2">
...
<div className="mt-6"><div><canvas height="140" id="expensesChart"></canvas></div></div>
</section>

<section className="max-w-7xl mx-auto px-6 lg:px-8 mt-24 mb-32 glass rounded-3xl p-8 border border-white/10 overflow-x-auto hover-scale fade-up" style={{animationDelay: `.5s`}}>
<h2 className="text-lg font-semibold tracking-tight flex items-center gap-2">
...
<thead className="sr-only"><tr><th>Date</th><th>Description</th><th>Category</th><th>Amount</th><th>Status</th></tr></thead>
<tbody>
<tr className="hover:bg-white/5 rounded-lg">
<td className="py-3 pr-4">05 Oct 23</td><td className="py-3 pr-4">Stripe Payment</td><td className="py-3 pr-4">Revenue</td>
...
<tr className="hover:bg-white/5 rounded-lg">
<td className="py-3 pr-4">03 Oct 23</td><td className="py-3 pr-4">AWS Cloud</td><td className="py-3 pr-4">Hosting</td>
...
<tr className="hover:bg-white/5 rounded-lg">
<td className="py-3 pr-4">30 Sep 23</td><td className="py-3 pr-4">Google Ads</td><td className="py-3 pr-4">Marketing</td>
...
<tr className="hover:bg-white/5 rounded-lg">
<td className="py-3 pr-4">28 Sep 23</td><td className="py-3 pr-4">Consulting Fee</td><td className="py-3 pr-4">Revenue</td>

...
<button className="px-3 py-1 text-xs font-medium rounded-md transition-all" onMouseOut={(e) => { e.currentTarget.style.backgroundColor='var(--color-main-primary)' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor='var(--color-main-secondary)' }} style={{backgroundColor: `var(--color-main-primary)`, color: `var(--color-global-white)`}}>
                            レポート出力
                        </button>
</div>
</div>

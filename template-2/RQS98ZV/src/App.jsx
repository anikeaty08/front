...
<a className="inline-flex items-center gap-1 underline decoration-dotted underline-offset-4 hover:text-violet-500 transition" href="https://www.google.com/search?q=Cabinet+de+conseil" target="_blank">si vous préférez un POC hors-de-prix{"<"} i data-lucide="external-link" class="w-4 h-4"{">"}</a>
</p>
</div>
</footer>

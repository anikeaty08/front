...
<input className="w-full pl-10 pr-4 py-3 border border-neutral-200 rounded-lg text-sm" id="searchInput" placeholder="Search creators..." style={{focus: `border-color: #0d6b59`}} type="text" />
...
<div className="toggle-switch" onClick={(e) => { toggleSavedCreators() }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('tier') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('age') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('gender') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('location') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('distinctives') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('canshow') }}>
...
<div>
<button className="flex items-center justify-between w-full py-2 text-left" onClick={(e) => { toggleDropdown('availability') }}>
...
<button className="p-2 text-gray-400 hover:text-red-500 transition-colors" onClick={(e) => { toggleSave(1) }}>
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(1) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
...
<button className="p-2 text-gray-400 hover:text-red-500 transition-colors" onClick={(e) => { toggleSave(2) }}>
<svg className="lucide lucide-heart w-5 h-5" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
</button>
</div>
<div className="flex-1 mb-4">
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(2) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
</div>
...
<button className="p-2 text-gray-400 hover:text-red-500 transition-colors" onClick={(e) => { toggleSave(3) }}>
<svg className="lucide lucide-heart w-5 h-5" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
</button>
</div>
<div className="flex-1 mb-4">
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(3) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
</div>
...
<button className="p-2 text-gray-400 hover:text-red-500 transition-colors" onClick={(e) => { toggleSave(4) }}>
<svg className="lucide lucide-heart w-5 h-5" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
</button>
</div>
<div className="flex-1 mb-4">
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(4) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
</div>
...
<button className="p-2 text-gray-400 hover:text-red-500 transition-colors" onClick={(e) => { toggleSave(5) }}>
<svg className="lucide lucide-heart w-5 h-5" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
</button>
</div>
<div className="flex-1 mb-4">
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(5) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
</div>
...
<button className="p-2 text-red-500 hover:text-red-600 transition-colors" onClick={(e) => { toggleSave(6) }}>
...
<button className="w-full text-white py-2 px-4 rounded-lg font-medium transition-colors group-hover:opacity-90 mt-auto" onClick={(e) => { openCreatorModal(6) }} style={{backgroundColor: `#0d6b59`}}>
                    View Profile
                </button>
</div>
</div>
...
<button className="p-2 text-gray-400 hover:text-gray-600 transition-colors" onClick={(e) => { closeCreatorModal() }}>

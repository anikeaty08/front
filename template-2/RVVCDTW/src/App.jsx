...
<div className="fixed left-6 top-1/2 -translate-y-1/2 z-40 hidden xl:block" id="statusIndicator" style={{transform: `translateY(calc(-50% - 89.2px)) scale(0.979092)`, filter: `drop-shadow(rgba(34, 197, 94, 0.55) 0px 0px 33.1737px)`}}>
...
<div className="fixed z-[60] pointer-events-none rounded-full" id="spotlight" style={{width: `220px`, height: `220px`, borderRadius: `9999px`, background: `white`, mixBlendMode: `difference`, opacity: `0`, transform: `translate(-50%, -50%)`, left: `685px`, top: `98px`}}></div>
...
<a className="inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/10 backdrop-blur text-white px-7 py-3.5 text-sm md:text-base font-medium hover:bg-white/15 transition-all hover:scale-[1.02]" href="#" id="scheduleCallBtn">
...
<path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path>
        ...
        {"<"}<input className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200" id="callDate" min="2025-09-06" name="date" required type="date" />
</div>
<div>
...
<select className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200" id="callTime" name="time" required>
...
<input className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200" id="contactInfo" name="contact" placeholder="Ваш email или номер телефона" required type="text" />
</div>
<div>
...
<textarea className="w-full bg-gray-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/30 transition-all duration-200 resize-none" id="message" name="message" placeholder="Кратко опишите тему разговора" rows="3"></textarea>
</div>

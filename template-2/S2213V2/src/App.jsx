...
<div className="fixed top-0 left-0 h-[2px] bg-gradient-to-r from-blue-400 to-purple-400 w-0 z-[60]" id="scroll-progress" style={{width: `36.7859%`}}></div>

<header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md border-b bg-black/70 border-gray-900 transition-transform duration-300 will-change-transform -translate-y-full" id="site-header">
...
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90 font-geist" data-animate="up" data-delay="0" style={{opacity: `0`, transform: `translateY(12px)`}}>Master React, the right way</p>
<h1 className="sm:text-5xl lg:text-6xl leading-tight text-4xl tracking-tight font-geist mt-4" data-animate="left" data-delay="100" style={{fontFamily: `"Plus Jakarta Sans", Inter, sans-serif`, opacity: `1`, transform: `none`}}>
            Build production‑grade React apps with confidence
          </h1>
<p className="mt-6 text-lg text-gray-300 max-w-xl font-geist" data-animate="up" data-delay="200" style={{opacity: `1`, transform: `none`}}>
...
<div className="flex flex-col sm:flex-row gap-3 mt-8" data-animate="up" data-delay="300" style={{opacity: `1`, transform: `none`}}>
...
<div className="mt-8 flex items-center gap-6" data-animate="up" data-delay="400" style={{opacity: `1`, transform: `none`}}>
...
<img alt="Student avatar" className="w-9 h-9 rounded-full border-2 border-black object-cover" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=320&q=80" style={{transition: `outline 0.1s ease-in-out`}} />
...
<div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-gray-900/40" data-animate="right" data-delay="150" style={{opacity: `1`, transform: `none`}}>
<img alt="Coding preview" className="w-full h-[460px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d50f4a31-1a94-4495-b28b-7fb99a6f6730_1600w.jpg" style={{transition: `outline 0.1s ease-in-out`}} />
...
<canvas aria-label="Study streak chart" className="" height="128" id="miniChart" style={{display: `block`, boxSizing: `border-box`, height: `64px`, width: `176px`}} width="352"></canvas>
</div>
</div>
</div>
</div>
...
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90 font-geist" data-animate="up" data-delay="0" style={{opacity: `0`, transform: `translateY(12px)`}}>Curriculum</p>
<h2 className="mt-3 text-3xl lg:text-4xl tracking-tight text-white font-geist" data-animate="left" data-delay="100" style={{fontFamily: `"Plus Jakarta Sans", Inter, sans-serif`, opacity: `1`, transform: `none`}}>
...
<div className="group relative hover:bg-black/50 transition-colors overflow-hidden bg-black/40 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur" data-animate="up" data-delay="80" style={{opacity: `0`, transform: `translateY(12px)`}}>
...
<div className="group relative hover:bg-black/50 transition-colors overflow-hidden bg-black/40 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur" data-animate="up" data-delay="120" style={{opacity: `1`, transform: `none`}}>
...
<div className="group relative hover:bg-black/50 transition-colors overflow-hidden bg-black/40 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur" data-animate="up" data-delay="160" style={{opacity: `1`, transform: `none`}}>
...
<div className="group relative hover:bg-black/50 transition-colors overflow-hidden bg-black/40 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur" data-animate="up" data-delay="200" style={{opacity: `1`, transform: `none`}}>
...
<article className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-gray-900/60 to-black" data-animate="up" data-delay="240" style={{opacity: `1`, transform: `none`}}>
<div className="relative h-56">
<img alt="Dashboard project" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e3c3930d-dcc0-4fe0-bd69-7b5b1bbae625_800w.jpg" style={{transition: `outline 0.1s ease-in-out`}} />
...
<article className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-gray-900/60 to-black" data-animate="up" data-delay="260" style={{opacity: `1`, transform: `none`}}>
<div className="relative h-56">
...
<article className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-gray-900/60 to-black" data-animate="up" data-delay="280" style={{opacity: `1`, transform: `none`}}>
<div className="relative h-56">
<img alt="Mobile friendly app" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f41cd27f-b37b-47b1-9488-5df62ac4c335_800w.jpg" style={{transition: `outline 0.1s ease-in-out`}} />
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
<div className="absolute bottom-4 left-4 flex items-center gap-2">
<span className="px-2.5 py-1 rounded-full text-xs bg-white/10 border border-white/10 font-geist" style={{}}>Project</span>
...
<div className="flex items-end justify-between gap-6">
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90 font-geist" data-animate="up" data-delay="0" style={{opacity: `0`, transform: `translateY(12px)`}}>Meet your instructors</p>
<h2 className="mt-3 text-3xl lg:text-4xl tracking-tight text-white font-geist" data-animate="left" data-delay="100" style={{fontFamily: `"Plus Jakarta Sans", Inter, sans-serif`, opacity: `1`, transform: `none`}}>
...
<div className="rounded-2xl border border-white/10 bg-black/40 overflow-hidden" data-animate="up" data-delay="80" style={{opacity: `0`, transform: `translateY(12px)`}}>
<img alt="Instructor" className="w-full h-48 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/321cc5b6-c611-4dd6-82df-a7ea47211580_800w.jpg" style={{transition: `outline 0.1s ease-in-out`}} />
<div className="p-5">
...
<p className="mt-3 text-sm text-gray-400 font-geist" style={{}}>Previously at large-scale SaaS, focuses on performance and DX.</p>
</div>
</div>
<div className="rounded-2xl border border-white/10 bg-black/40 overflow-hidden" data-animate="up" data-delay="120" style={{opacity: `1`, transform: `none`}}>
...
<div className="rounded-2xl border border-white/10 bg-black/40 overflow-hidden" data-animate="up" data-delay="160" style={{opacity: `1`, transform: `none`}}>
<img alt="Instructor" className="w-full h-48 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/566d4b5d-ce71-4ae8-9976-c268fe32108a_800w.jpg" style={{transition: `outline 0.1s ease-in-out`}} />
<div className="p-5">
<div className="flex items-center justify-between">
<div className="">
...
<div className="flex items-end justify-between gap-6">
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90 font-geist" data-animate="up" data-delay="0" style={{opacity: `0`, transform: `translateY(12px)`}}>Pricing</p>
<h2 className="mt-3 text-3xl lg:text-4xl tracking-tight text-white font-geist" data-animate="left" data-delay="100" style={{fontFamily: `"Plus Jakarta Sans", Inter, sans-serif`, opacity: `1`, transform: `none`}}>
            Simple, transparent plans
          </h2>
<p className="mt-3 text-gray-400 font-geist" data-animate="up" data-delay="200" style={{opacity: `0`, transform: `translateY(12px)`}}>Lifetime access, updates included. 14‑day refund guarantee.</p>
</div>
...
<div className="rounded-2xl border border-white/10 bg-gradient-to-b from-gray-950 to-black p-6" data-animate="up" data-delay="80" style={{opacity: `0`, transform: `translateY(12px)`}}>
<div className="flex items-center justify-between">
...
<div className="rounded-2xl border border-blue-400/30 bg-gradient-to-b from-gray-900/80 to-black p-6 relative" data-animate="up" data-delay="120" style={{opacity: `0`, transform: `translateY(12px)`}}>
...
<div className="rounded-2xl border border-white/10 bg-gradient-to-b from-gray-950 to-black p-6" data-animate="up" data-delay="160" style={{opacity: `0`, transform: `translateY(12px)`}}>
<div className="flex items-center justify-between">
...
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90 font-geist" data-animate="up" data-delay="0" style={{opacity: `0`, transform: `translateY(12px)`}}>FAQ</p>
<h2 className="mt-3 text-3xl lg:text-4xl tracking-tight text-white font-geist" data-animate="left" data-delay="100" style={{fontFamily: `"Plus Jakarta Sans", Inter, sans-serif`, opacity: `0`, transform: `translateX(-16px)`}}>
            Answers to common questions
          </h2>
<p className="mt-4 text-gray-400 font-geist" data-animate="up" data-delay="200" style={{opacity: `0`, transform: `translateY(12px)`}}>Can’t find what you’re looking for? Email us: team@reactpro.dev</p>

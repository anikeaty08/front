...
<button className="nav-btn active" data-section="hero" onClick={(e) => { showSection('hero') }}>Home</button>
<button className="nav-btn" data-section="about" onClick={(e) => { showSection('about') }}>About Us</button>
<button className="nav-btn" data-section="agents" onClick={(e) => { showSection('agents') }}>Agents</button>
<button className="nav-btn" data-section="live" onClick={(e) => { showSection('live') }}>Intelligence Hub</button>
<button className="nav-btn" data-section="contact" onClick={(e) => { showSection('contact') }}>Contact</button>
</div>
<button className="hidden md:block px-4 py-2 text-sm border border-gray-700 rounded-md hover:bg-white/5" onClick={(e) => { showSection('contact') }}>Request access</button>
</nav>
...
<button className="bg-blue-500 hover:bg-blue-400 px-6 py-3 rounded-md" onClick={(e) => { showSection('contact') }}>Get early access</button>
<button className="border border-gray-700 hover:bg-white/5 px-6 py-3 rounded-md flex items-center gap-2" onClick={(e) => { showSection('live') }}>
...
<button className="demo-nav-button active" data-demo="metrics" onClick={(e) => { showDemo('metrics') }}>
<svg className="lucide lucide-bar-chart w-4 h-4"></svg>
          Live Metrics
        </button>
<button className="demo-nav-button" data-demo="architecture" onClick={(e) => { showDemo('architecture') }}>
<svg className="lucide lucide-network w-4 h-4"></svg>
          System Architecture
        </button>
<button className="demo-nav-button" data-demo="slack" onClick={(e) => { showDemo('slack') }}>
<svg className="lucide lucide-message-circle w-4 h-4"></svg>
          Agent Communications
        </button>
<button className="demo-nav-button" data-demo="insights" onClick={(e) => { showDemo('insights') }}>

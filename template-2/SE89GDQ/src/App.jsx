...
<button aria-label="Menu" className="flex items-center focus:outline-none focus:ring-2 focus:ring-accent">
<svg fill="none" height="28" stroke="currentColor" strokeWidth="2" width="28"><path></path></svg>
</button>
<div className="absolute right-0 top-14 bg-white border border-gray-100 rounded-lg shadow-lg py-4 px-6 flex flex-col gap-4 z-40" style={{display: `none`}} x-show="open">
<a className="hover:text-accent transition" href="#about">About</a>
<a className="hover:text-accent transition" href="#services">Services</a>
<a className="hover:text-accent transition" href="#trusted">Trusted By</a>
<a className="hover:text-accent transition" href="#team">Team</a>
...
<svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12"></circle><path></path></svg>
<span className="font-medium text-brand">Science-based recovery & training</span>
</li>
<li className="flex gap-3 items-center">
<svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path></path></svg>
<span className="font-medium text-brand">Proven results for all levels</span>
</li>
<li className="flex gap-3 items-center">
<svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect height="12" rx="2" width="20"></rect><path></path></svg>
...
<span className="relative inline-block mb-2">
<svg className="w-10 h-10 text-brand" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
<rect height="12" rx="2" width="20"></rect>
<path></path>
</svg>
</span>

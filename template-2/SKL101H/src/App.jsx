...
<button className="px-3 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" onClick={(e) => { randomize() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="shuffle"></i>
                            Random
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-medium rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="playBtn" onClick={(e) => { togglePlay() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="play"></i>
                            Party
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white font-medium rounded-xl hover:from-red-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="megaBtn" onClick={(e) => { megaMode() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="zap"></i>
                            MEGA
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium rounded-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="laserBtn" onClick={(e) => { laserMode() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="target"></i>
                            Laser
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-green-600 to-green-800 text-white font-medium rounded-xl hover:from-green-700 hover:to-green-900 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="matrixBtn" onClick={(e) => { matrixMode() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="binary"></i>
                            Matrix
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="hologramBtn" onClick={(e) => { hologramMode() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="diamond"></i>
                            Holo
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" id="multiBtn" onClick={(e) => { multiStickMode() }}>
<i className="w-4 h-4 inline mr-1" data-lucide="copy"></i>
                            Multi
                        </button>
<button className="px-3 py-2 bg-gradient-to-r from-gray-500 to-gray-600 text-white font-medium rounded-xl hover:from-gray-600 hover:to-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" onClick={(e) => { resetAll() }}>
...
<button className="w-8 h-8 rounded-lg bg-red-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ff0000', 'rgba(255, 0, 0, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-orange-600 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ff4500', 'rgba(255, 69, 0, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-orange-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ffa500', 'rgba(255, 165, 0, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-yellow-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ffff00', 'rgba(255, 255, 0, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-green-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#00ff00', 'rgba(0, 255, 0, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-cyan-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#00ffff', 'rgba(0, 255, 255, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-blue-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#0000ff', 'rgba(0, 0, 255, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-purple-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#8000ff', 'rgba(128, 0, 255, 0.8)') }}></button>
</div>

<div className="grid grid-cols-8 gap-2 mb-4">
<button className="w-8 h-8 rounded-lg bg-pink-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ff1493', 'rgba(255, 20, 147, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-pink-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ff69b4', 'rgba(255, 105, 180, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-fuchsia-500 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#ff00ff', 'rgba(255, 0, 255, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-lime-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#adff2f', 'rgba(173, 255, 47, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-emerald-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#00ff7f', 'rgba(0, 255, 127, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-turquoise hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#40e0d0', 'rgba(64, 224, 208, 0.8)') }} style={{backgroundColor: `#40e0d0`}}></button>
<button className="w-8 h-8 rounded-lg bg-blue-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#1e90ff', 'rgba(30, 144, 255, 0.8)') }}></button>
<button className="w-8 h-8 rounded-lg bg-purple-400 hover:scale-110 transition-transform duration-200 shadow-lg" onClick={(e) => { setColor('#9370db', 'rgba(147, 112, 219, 0.8)') }}></button>
</div>

<div className="grid grid-cols-4 gap-3 mb-4">
<button className="px-3 py-2 bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500 text-white font-medium rounded-lg hover:scale-105 transition-transform duration-200 shadow-lg" onClick={(e) => { setGradientColor('rainbow') }}>
                                Rainbow
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-white font-medium rounded-lg hover:scale-105 transition-transform duration-200 shadow-lg" onClick={(e) => { setGradientColor('sunset') }}>
                                Sunset
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 text-white font-medium rounded-lg hover:scale-105 transition-transform duration-200 shadow-lg" onClick={(e) => { setGradientColor('ocean') }}>
                                Ocean
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white font-medium rounded-lg hover:scale-105 transition-transform duration-200 shadow-lg" onClick={(e) => { setGradientColor('galaxy') }}>
                                Galaxy
                            </button>
</div>

<div className="flex gap-3 mb-4">
<input className="w-12 h-10 rounded-lg border-2 border-gray-300 cursor-pointer" id="customColor" onChange={(e) => { setCustomColor() }} type="color" value="#3b82f6" />
<button className="flex-1 px-4 py-2 bg-gray-700 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors duration-200" onClick={(e) => { setCustomColor() }}>
                                Use Custom Color
                            </button>
</div>
</div>
...
<button className="px-3 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition-colors duration-200" onClick={(e) => { setAnimation('pulse') }}>
                                Pulse
                            </button>
<button className="px-3 py-2 bg-yellow-500 text-white font-medium rounded-lg hover:bg-yellow-600 transition-colors duration-200" onClick={(e) => { setAnimation('strobe') }}>
                                Strobe
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-red-500 to-purple-500 text-white font-medium rounded-lg hover:from-red-600 hover:to-purple-600 transition-colors duration-200" onClick={(e) => { setAnimation('rainbow') }}>
                                Rainbow
                            </button>
<button className="px-3 py-2 bg-cyan-500 text-white font-medium rounded-lg hover:bg-cyan-600 transition-colors duration-200" onClick={(e) => { setAnimation('wave') }}>
                                Wave
                            </button>
<button className="px-3 py-2 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600 transition-colors duration-200" onClick={(e) => { setAnimation('spin') }}>
                                Spin
                            </button>
<button className="px-3 py-2 bg-orange-500 text-white font-medium rounded-lg hover:bg-orange-600 transition-colors duration-200" onClick={(e) => { setAnimation('bounce') }}>
                                Bounce
                            </button>
<button className="px-3 py-2 bg-pink-500 text-white font-medium rounded-lg hover:bg-pink-600 transition-colors duration-200" onClick={(e) => { setAnimation('glow-intense') }}>
                                Intense Glow
                            </button>
<button className="px-3 py-2 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-colors duration-200" onClick={(e) => { setAnimation('shake') }}>
                                Shake
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-lg hover:from-purple-600 hover:to-pink-600 transition-colors duration-200" onClick={(e) => { setAnimation('disco') }}>
                                Disco
                            </button>
<button className="px-3 py-2 bg-indigo-500 text-white font-medium rounded-lg hover:bg-indigo-600 transition-colors duration-200" onClick={(e) => { setAnimation('lightning') }}>
                                Lightning
                            </button>
<button className="px-3 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors duration-200" onClick={(e) => { setAnimation('heartbeat') }}>
                                Heartbeat
                            </button>
<button className="px-3 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-colors duration-200" onClick={(e) => { setAnimation('hypnotic') }}>
                                Hypnotic
                            </button>
</div>
</div>
...
<input className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer mb-4" id="intensitySlider" max="100" min="10" onChange={(e) => { updateIntensity(e.currentTarget.value) }} type="range" value="80" />
...
<input className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer mb-4" id="speedSlider" max="5" min="0.5" onChange={(e) => { updateSpeed(e.currentTarget.value) }} step="0.1" type="range" value="1" />
<div className="flex justify-between text-sm text-gray-500">
<span>Slow</span>
...
<button className="px-4 py-2 bg-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-400 transition-colors duration-200" id="soundBtn" onClick={(e) => { toggleSound() }}>
...
<button className="px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('concert') }}>
                                🎵 Concert Mode
                            </button>
<button className="px-4 py-3 bg-gradient-to-r from-pink-500 to-red-500 text-white font-medium rounded-lg hover:from-pink-600 hover:to-red-600 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('rave') }}>
                                🎉 Rave Mode
                            </button>
<button className="px-4 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-medium rounded-lg hover:from-teal-600 hover:to-cyan-600 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('chill') }}>
                                😌 Chill Mode
                            </button>
<button className="px-4 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('party') }}>
                                🎊 Party Mode
                            </button>
<button className="px-4 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white font-medium rounded-lg hover:from-red-700 hover:to-orange-700 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('fire') }}>
                                🔥 Fire Mode
                            </button>
<button className="px-4 py-3 bg-gradient-to-r from-blue-400 to-cyan-400 text-white font-medium rounded-lg hover:from-blue-500 hover:to-cyan-500 transition-all duration-200 shadow-lg" onClick={(e) => { setPreset('ice') }}>
                                ❄️ Ice Mode
                            </button>
</div>
</div>
...
<button className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium rounded-xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105" onClick={(e) => { shareConfig() }}>

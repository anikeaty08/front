...
<li className="group relative flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 transition-all hover:-translate-y-0.5 hover:shadow-md hover:border-emerald-400/40">
<span className="absolute inset-0 pointer-events-none rounded-lg shadow-[inset_0_0_0_1px_rgba(16,185,129,0.12)]"></span>
<i className="w-4 h-4 text-emerald-300" data-lucide="percent"></i>
                Fixed APR
              </li>
</ul>
...
<h3 className="text-lg tracking-tight font-semibold text-white">Get started in minutes</h3>
<span className="inline-flex items-center text-xs font-medium text-violet-300 bg-violet-400/10 border border-violet-400/30 rounded-md px-2 py-1">
<i className="w-3.5 h-3.5 mr-1" data-lucide="sparkles"></i>
                    New
                  </span>
</div>
<p className="text-sm text-slate-400 mt-1.5">A guided flow to check your offer with no impact to your score.</p>
</div>
<div className="p-5 sm:p-6 space-y-5">
<ol className="space-y-3">
<li className="group flex items-start gap-3 rounded-lg border border-white/10 bg-white/[0.03] p-3">
<div className="h-8 w-8 rounded-md bg-violet-500/15 text-violet-300 grid place-items-center ring-1 ring-violet-400/30">
<i className="w-4 h-4" data-lucide="edit-3"></i>
</div>
<div>
<div className="text-sm font-medium text-white">Tell us about yourself</div>
<p className="text-xs text-slate-400 mt-0.5">Basic info only — no hard pull.</p>
</div>
</li>
<li className="group flex items-start gap-3 rounded-lg border border-white/10 bg-white/[0.03] p-3">
<div className="h-8 w-8 rounded-md bg-emerald-500/15 text-emerald-300 grid place-items-center ring-1 ring-emerald-400/30">
<i className="w-4 h-4" data-lucide="sliders"></i>
</div>
<div>
<div className="text-sm font-medium text-white">Choose your terms</div>
<p className="text-xs text-slate-400 mt-0.5">Compare monthly payments vs. total cost.</p>
</div>
</li>
<li className="group flex items-start gap-3 rounded-lg border border-white/10 bg-white/[0.03] p-3">
<div className="h-8 w-8 rounded-md bg-emerald-500/15 text-emerald-300 grid place-items-center ring-1 ring-emerald-400/30">
...
<div>
<div className="text-sm font-medium text-white">Review and accept</div>
<p className="text-xs text-slate-400 mt-0.5">Lock your rate and get funded fast.</p>
</div>
</li>
</ol>
...
<div className="rounded-lg border border-white/10 bg-white/[0.03] p-3 text-sm">
<div className="flex items-center gap-2 text-slate-300">
<i className="w-4 h-4 text-emerald-300" data-lucide="zap"></i>
                      Fast decisions
                    </div>
</div>
</div>
...
<i className="w-3.5 h-3.5 text-slate-300" data-lucide="lock"></i>
                    Bank‑level security
                  </div>
<div className="inline-flex items-center gap-1.5">
<i className="w-3.5 h-3.5 text-slate-300" data-lucide="file-text"></i>
                    Soft credit check
                  </div>
</div>
</div>
...
<div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
<div className="text-sm text-slate-300Max APR</div> <div class=" font-semibold="" mt-1="" text-2xl="" tracking-tight="">22.99%</div>
</div>
</div>
<div className="mt-6">
<div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
...
<div className="h-full rounded-lg bg-white/[0.02]-2">
...
<span className="pointer-events-none absolute inset-y-0 -left-1/3 w-1/3 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-[-15deg] translate-x-[-30%] group-hover:translate-x-[220%] transition-transform duration-700"></span>
<div className="flex items-center gap-3">
<img alt="Customer" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10 shadow" src="https://images.unsplash.com/photo-1635151227785-429f420c6b9d?w=1080&q=80" />
<div>
...
<span className="pointer-events-none absolute inset-y-0 -left-1/3 w-1/3 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-[-15deg] translate-x-[-30%] group-hover:translate-x-[220%] transition-transform duration-700"></span>
<div className="flex items-center gap-3">
<img alt="Customer" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10 shadow" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&q=80" />
<div>

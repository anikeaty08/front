...
<div className="absolute inset-0 opacity-10 mix-blend-overlay" style={{backgroundImage: `url('https://images.unsplash.com/photo-1544213456-b2dcf59bdd98?q=80&w=1200&auto=format&fit=crop')`, backgroundSize: `cover`, backgroundPosition: `center`}}></div>
<div className="flex items-center gap-4">

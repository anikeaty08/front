...
<button className="bg-gradient-to-r from-blue-600 to-purple-700 hover:from-blue-700 hover:to-purple-800 transition-all duration-300 px-8 py-3 rounded-xl font-semibold transform hover:scale-105" onClick={(e) => { resetGame() }}>
<div className="flex items-center space-x-2">

...
<button className="mobile-menu-toggle fixed top-4 left-4 z-50 bg-neutral-800 border border-neutral-600 p-3 lg:hidden" onClick={(e) => { toggleMenu() }}>
<div className="w-5 h-0.5 bg-neutral-300 mb-1"></div>
<div className="w-5 h-0.5 bg-neutral-300 mb-1"></div>
<div className="w-5 h-0.5 bg-neutral-300"></div>
</button>

<div className="fixed inset-0 bg-black bg-opacity-50 z-30 lg:hidden hidden" id="mobile-overlay" onClick={(e) => { toggleMenu() }}></div>
...
<button className="lg:hidden absolute top-4 right-4 text-neutral-400 hover:text-neutral-200" onClick={(e) => { toggleMenu() }}>
...
<li><a className="block py-2 lg:py-3 px-3 lg:px-4 text-neutral-100 bg-neutral-700 border border-neutral-500 text-xs lg:text-sm uppercase tracking-wide hover:bg-neutral-600 transition-all" href="#projects" onClick={(e) => { closeMobileMenu() }}>PROJECTS</a></li>
<li><a className="block py-2 lg:py-3 px-3 lg:px-4 text-neutral-400 border border-neutral-700 hover:bg-neutral-700 hover:text-neutral-100 transition-all text-xs lg:text-sm uppercase tracking-wide" href="#skills" onClick={(e) => { closeMobileMenu() }}>SKILLS</a></li>
<li><a className="block py-2 lg:py-3 px-3 lg:px-4 text-neutral-400 border border-neutral-700 hover:bg-neutral-700 hover:text-neutral-100 transition-all text-xs lg:text-sm uppercase tracking-wide" href="#experience" onClick={(e) => { closeMobileMenu() }}>EXPERIENCE</a></li>
<li><a className="block py-2 lg:py-3 px-3 lg:px-4 text-neutral-400 border border-neutral-700 hover:bg-neutral-700 hover:text-neutral-100 transition-all text-xs lg:text-sm uppercase tracking-wide" href="#contact" onClick={(e) => { closeMobileMenu() }}>CONTACT</a></li>
</ul>
</nav>

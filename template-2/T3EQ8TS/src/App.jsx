...
<circle className="transition-all duration-2000 drop-shadow-lg" cx="18" cy="18" data-circle-progress="70" fill="none" r="16" stroke="url(#gradient1)" strokeDasharray="70.37167544041137,100.53096491487338" strokeLinecap="round" strokeWidth="3"></circle>
<defs>
...
<img alt="User 1" className="h-12 w-12 rounded-full ring-3 ring-slate-700 transition-all duration-300 hover:scale-110 hover:ring-indigo-400 object-cover" src="/assets/8326850b-c44f-444f-8cc7-cd798d6894a0_320w.jpg" />
<img alt="User 2" className="h-12 w-12 rounded-full ring-3 ring-slate-700 transition-all duration-300 hover:scale-110 hover:ring-indigo-400 object-cover" src="/assets/a070cb3f-5d6a-4dbb-a944-affdf6f83b49_320w.jpg" />
<img alt="User 3" className="h-12 w-12 rounded-full ring-3 ring-slate-700 transition-all duration-300 hover:scale-110 hover:ring-indigo-400 object-cover" src="/assets/2de2a5b1-5048-4f3e-9c13-f8152f7e5834_320w.jpg" />

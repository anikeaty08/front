...
<a className="text-sm text-slate-600 hover:text-slate-900 transition" href="#catalog">Catalog</a>
<a className="text-sm text-slate-600 hover:text-slate-900 transition" href="#about">About</a>
...
<img alt="Brake assembly" className="w-full h-[320px] md:h-[420px] object-cover" src="https://images.unsplash.com/photo-1606229365485-c7ef5fecd5e3?q=80&w=1600&auto=format&fit=crop" />
...
<section className="border-t border-slate-200 bg-slate-50/50" id="catalog">
...
<img alt="Manufacturing facility" className="w-full h-[320px] md:h-[420px] object-cover" src="https://images.unsplash.com/photo-1586521995568-39b5b93edfd2?q=80&w=1600&auto=format&fit=crop" />
</div>
<div>
...
<section className="border-t border-slate-200 bg-slate-50/60" id="contact">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
...
<a className="text-slate-600 hover:text-slate-900 transition" href="#catalog">Catalog</a>
<a className="text-slate-600 hover:text-slate-900 transition" href="#about">About</a>

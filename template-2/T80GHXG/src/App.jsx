...
new Chart(ctx,{type:'line',
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/9dead2ce-9640-41bd-8153-af6e7acc42cf_3840w.jpg")`}}></div>
...
<img alt="avatar" className="w-10 h-10 rounded-full object-cover ring-1 ring-slate-700" src="/assets/2de2a5b1-5048-4f3e-9c13-f8152f7e5834_320w.jpg" />
...
<img alt="delivery truck" className="w-28 h-14 rounded-lg object-cover" src="/assets/1e9172c7-5d67-4da7-8de0-05525c420fec_320w.jpg" />
</div>
...
<img alt="delivery van" className="w-28 h-14 rounded-lg object-cover" src="/assets/ae731e89-9af1-4914-82cc-9039bb5c090d_320w.jpg" />
</div>
...
<img alt="cargo truck" className="w-28 h-14 rounded-lg object-cover" src="/assets/22df5474-7a3a-4fea-b5c6-e2980964892d_320w.jpg" style={{}} />
</div>
</div>

...
<input className="mt-3 mb-2" id="bpm" max="120" min="40" name="bpm" onInput={(e) => { document.getElementById('bpm-value').textContent=e.currentTarget.value }} type="range" value="65" />

...
<svg className="lucide lucide-user h-4 w-4 text-slate-300" data-lucide="user" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="7"></circle></svg>
              Войти
            </button>
...
<svg className="lucide lucide-menu h-5 w-5" data-lucide="menu" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</button>
</div>
</div>
...
<svg className="lucide lucide-grid-3x3 h-4 w-4 text-cyan-100/90" data-lucide="grid-3x3" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" width="18"></rect><path></path><path></path><path></path><path></path></svg>
                Смотреть модули
              </span>
</a>
...
<svg className="lucide lucide-video h-4 w-4 text-slate-200" data-lucide="video" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" rx="2" width="14"></rect></svg>
              Запросить демо
            </a>
</div>
</div>
...
<svg className="lucide lucide-ticket text-slate-50" data-lucide="ticket" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</div>
<div className="">
...
<div className="flex gap-3 border rounded-2xl p-4 backdrop-blur hover:shadow-lg transition bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 hover:shadow-indigo-400/10">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-[conic-gradient(from_180deg,var(--tw-gradient-stops))] from-neutral-400/40 via-cyan-800/50 to-neutral-400/50">
<svg className="lucide lucide-search text-slate-50" data-lucide="search" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
</div>
<div className="">
...
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-[conic-gradient(from_180deg,var(--tw-gradient-stops))] from-neutral-400/40 via-cyan-800/50 to-neutral-400/50">
<svg className="lucide lucide-megaphone text-slate-50" data-lucide="megaphone" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</div>
<div className="">
...
<li className="flex gap-2"><svg className="lucide lucide-sparkles mt-0.5 text-cyan-400" data-lucide="sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg> Эксклюзивная дистрибуция туров и динамическое ценообразование для партнёров.</li>
<li className="flex gap-2"><svg className="lucide lucide-wand-sparkles mt-0.5 text-cyan-400" data-lucide="wand-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg> Умный поиск (NLP) и рекомендации повышают конверсию и средний чек.</li>
<li className="flex gap-2"><svg className="lucide lucide-layout-template mt-0.5 text-cyan-400" data-lucide="layout-template" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="7" rx="1" width="18"></rect><rect height="7" rx="1" width="9"></rect><rect height="7" rx="1" width="5"></rect></svg> White‑label витрины и контент‑студия: продающие лендинги за минуты.</li>
<li className="flex gap-2"><svg className="lucide lucide-wallet mt-0.5 text-cyan-400" data-lucide="wallet" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> Прозрачные финансы: комиссии, счета, выплаты, сверки — без Excel.</li>
<li className="flex gap-2"><svg className="lucide lucide-headphones mt-0.5 text-cyan-400" data-lucide="headphones" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg> Поддержка 24/7 и API‑интеграции с экосистемой агентства.</li>
</ul>
</div>
<div className="rounded-2xl bg-white/[0.04] border p-5 border-white/10">
<div className="flex items-center gap-2">
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-user-check mt-0.5 text-cyan-400" data-lucide="user-check" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="9" cy="7"></circle></svg> Владельцы/менеджеры турагентств‑ритейлеров — рост продаж и маржинальности.</li>
<li className="flex gap-2"><svg className="lucide lucide-gauge mt-0.5 text-cyan-400" data-lucide="gauge" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> Снижение времени брони, меньше ручной рутины, выше NPS клиентов.</li>
<li className="flex gap-2"><svg className="lucide lucide-link mt-0.5 text-cyan-400" data-lucide="link" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> Технологическое преимущество: API, SSO, CRM‑коннекторы, вебхуки.</li>
</ul>
</div>
</div>
</div>
...
<svg className="lucide lucide-search text-slate-200" data-lucide="search" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-sliders-horizontal mt-0.5 text-cyan-400" data-lucide="sliders-horizontal" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><line></line><line></line><line></line><line></line><line></line><line></line><line></line><line></line><line></line></svg> Фильтры: даты, бюджет, направления, тип тура, провайдер.</li>
<li className="flex gap-2"><svg className="lucide lucide-languages mt-0.5 text-cyan-400" data-lucide="languages" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path></svg> Умный поиск (NLP), синонимы и промо‑запросы.</li>
<li className="flex gap-2"><svg className="lucide lucide-calendar-check-2 mt-0.5 text-cyan-400" data-lucide="calendar-check-2" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg> Доступность/цена в реальном времени, блокировка мест.</li>
<li className="flex gap-2"><svg className="lucide lucide-file-input mt-0.5 text-cyan-400" data-lucide="file-input" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg> Оформление брони, ваучеры, документы, доп.услуги.</li>
<li className="flex gap-2"><svg className="lucide lucide-history mt-0.5 text-cyan-400" data-lucide="history" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> История заказов, правки, отмены, обмены.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-wallet text-slate-200" data-lucide="wallet" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-receipt mt-0.5 text-cyan-400" data-lucide="receipt" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> Инвойсы, акты, фискальные чеки, автосверки.</li>
<li className="flex gap-2"><svg className="lucide lucide-percent mt-0.5 text-cyan-400" data-lucide="percent" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><line></line><circle cx="6.5" cy="6.5"></circle><circle cx="17.5" cy="17.5"></circle></svg> Комиссии и маркап, правила скидок, промокоды.</li>
<li className="flex gap-2"><svg className="lucide lucide-credit-card mt-0.5 text-cyan-400" data-lucide="credit-card" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><line></line></svg> Платежи: карты, BNPL, банковские переводы, гарантии.</li>
<li className="flex gap-2"><svg className="lucide lucide-send-to-back mt-0.5 text-cyan-400" data-lucide="send-to-back" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8"></rect><rect height="8" rx="2" width="8"></rect><path></path><path></path></svg> Выплаты агентам, реконсиляция, мультивалютность.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-megaphone text-slate-200" data-lucide="megaphone" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-layout-template mt-0.5 text-cyan-400" data-lucide="layout-template" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="7" rx="1" width="18"></rect><rect height="7" rx="1" width="9"></rect><rect height="7" rx="1" width="5"></rect></svg> White‑label витрины и виджеты для сайта агентства.</li>
<li className="flex gap-2"><svg className="lucide lucide-images mt-0.5 text-cyan-400" data-lucide="images" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="13" cy="7" fill="currentColor"></circle><rect height="14" rx="2" width="14"></rect></svg> Контент‑студия: баннеры, лендинги, PDF‑презентации.</li>
<li className="flex gap-2"><svg className="lucide lucide-mail mt-0.5 text-cyan-400" data-lucide="mail" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="16" rx="2" width="20"></rect></svg> Email/SMS кампании, сегментация, UTM‑метки.</li>
<li className="flex gap-2"><svg className="lucide lucide-badge-percent mt-0.5 text-cyan-400" data-lucide="badge-percent" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg> Акции и лояльность: промо‑кампании, бандлы, реферальные программы.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-users text-slate-200" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="9" cy="7"></circle><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-id-card mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg> Профили клиентов, предпочтения, документы и визы.</li>
<li className="flex gap-2"><svg className="lucide lucide-messages-square mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="7" rx="1" width="7"></rect><rect height="7" rx="1" width="7"></rect><rect rx="1" width="7"></rect></svg> История коммуникаций: звонки, email, мессенджеры.</li>
<li className="flex gap-2"><svg className="lucide lucide-filter mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> Сегменты и списки: VIP, частые, корпоративные.</li>
<li className="flex gap-2"><svg className="lucide lucide-shield-check mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> GDPR/152‑ФЗ режимы приватности и согласия.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-life-buoy text-slate-200" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><circle cx="12" cy="12"></circle><path></path><path></path><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-headset mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> Тикеты и чат 24/7, SLA‑метрики.</li>
<li className="flex gap-2"><svg className="lucide lucide-book-open mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> База знаний, макеты писем, шаблоны скриптов.</li>
<li className="flex gap-2"><svg className="lucide lucide-bell-ring mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> Оповещения по критическим броням и платежам.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-plug text-slate-200" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-braces mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> REST/GraphQL API, SDK для JS и Python.</li>
<li className="flex gap-2"><svg className="lucide lucide-radio-tower mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> Вебхуки, события брони/платежей, ретраи.</li>
<li className="flex gap-2"><svg className="lucide lucide-shield mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg> SSO (SAML/OAuth), RBAC, аудиты и логирование.</li>
</ul>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 flex rounded-xl items-center justify-center bg-white/10">
<svg className="lucide lucide-chart-line text-slate-200" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</div>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2"><svg className="lucide lucide-presentation mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><rect height="12" rx="2" width="20"></rect><path></path><path></path></svg> Дашборды по GMV, конверсиям и марже.</li>
<li className="flex gap-2"><svg className="lucide lucide-candlestick-chart mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="8" rx="1" width="3"></rect><rect height="8" rx="1" width="3"></rect></svg> Cohort‑анализ, ABC/XYZ, LTV/Retention.</li>
<li className="flex gap-2"><svg className="lucide lucide-file-down mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg> Экспорт: CSV, XLSX, Google Sheets, API.</li>
</ul>
</div>
</div>
</div>
...
<svg className="lucide lucide-server text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="20"></rect><rect height="8" rx="2" width="20"></rect><path></path><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-lock text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="11" rx="2" width="18"></rect><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-cable text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-code-2 text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-git-merge text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><circle cx="6" cy="18"></circle><circle cx="6" cy="6"></circle><circle cx="18" cy="12"></circle><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-sparkle text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-bot text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8"></rect><path></path><path></path><path></path><path></path></svg>
</span>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-notebook-pen text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path className=""></path><path></path><path></path></svg>
</span>
...
<form aria-label="AI демо формы" className="mt-3 space-y-3" id="aiForm" onSubmit={(e) => { return false }}>
<div className="">
...
<svg className="lucide lucide-wand-sparkles" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
                  Подобрать
                </button>
...
<svg className="lucide lucide-eraser" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                  Очистить
                </button>
</div>
...
<svg className="lucide lucide-send h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                  Отправить
                </button>
</div>
</div>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-phone text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
...
<svg className="lucide lucide-compass text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="12"></circle></svg>
</span>

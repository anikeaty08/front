...
<button className="px-2.5 py-1.5 rounded-md border border-slate-200 text-xs hover:bg-slate-50" onClick={(e) => { window.open('https://wa.me/?text=' + encodeURIComponent('Pay here: https://sm.link/pl/8X29KM')) }}>
<i className="h-3.5 w-3.5 inline-block mr-1" data-lucide="send"></i> WhatsApp
                              </button>
<button className="px-2.5 py-1.5 rounded-md border border-slate-200 text-xs hover:bg-slate-50" onClick={(e) => { window.location.href='mailto:?subject=Payment Link&body=Pay here: https://sm.link/pl/8X29KM' }}>
...
<button className="px-2.5 py-1.5 rounded-md border border-slate-200 text-xs hover:bg-slate-50" onClick={(e) => { window.open('https://wa.me/?text=' + encodeURIComponent('Pay here: https://sm.link/pl/2H17AA')) }}>
<i className="h-3.5 w-3.5 inline-block mr-1" data-lucide="send"></i> WhatsApp
                              </button>
<button className="px-2.5 py-1.5 rounded-md border border-slate-200 text-xs hover:bg-slate-50" onClick={(e) => { window.location.href='mailto:?subject=Payment Link&body=Pay here: https://sm.link/pl/2H17AA' }}>
<i className="h-3.5 w-3.5 inline-block mr-1" data-lucide="mail"></i> Email
                              </button>
</div>
</td>

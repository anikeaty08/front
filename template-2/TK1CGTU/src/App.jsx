...
<svg className="w-[16px] h-[16px]" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path className=""></path><path></path></svg>
</div>
...
<svg className="w-[14px] h-[14px]" data-lucide="sparkles" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `14px`, height: `14px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><line></line><line></line><circle className="" cx="12" cy="14"></circle></svg>
                Realtime
              </span>
</div>
...
<svg className="w-[16px] h-[16px]" data-lucide="calendar" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path></svg>
              Last 6 months
            </button>
...
<svg className="w-[16px] h-[16px]" data-lucide="download" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><polyline points="7 10 12 15 17 10"></polyline><line></line></svg>
              Export
            </button>
</div>
</div>
...
<circle cx="150" cy="150" fill="none" opacity="0.3" stroke="url(#glow)" strokeWidth="1"></circle>
<circle cx="150" cy="150" fill="none" opacity="0.2" stroke="url(#glow)" strokeWidth="1"></circle>
<circle cx="150" cy="150" fill="none" opacity="0.15" stroke="url(#glow)" strokeWidth="1"></circle>

<g className="" fill="none" strokeLinecap="round">
<circle cx="150" cy="150" opacity="0.9" stroke="#8b5cf6" strokeDasharray="1 11" strokeWidth="3"></circle>
<circle cx="150" cy="150" opacity="0.9" stroke="#22d3ee" strokeDasharray="1 10" strokeWidth="3"></circle>
<circle className="" cx="150" cy="150" opacity="0.9" stroke="#e879f9" strokeDasharray="1 9" strokeWidth="3"></circle>
<circle cx="150" cy="150" opacity="0.9" stroke="#a78bfa" strokeDasharray="1 8" strokeWidth="3"></circle>
<circle cx="150" cy="150" opacity="0.9" stroke="#22d3ee" strokeDasharray="1 7" strokeWidth="3"></circle>
<circle cx="150" cy="150" opacity="0.9" stroke="#e879f9" strokeDasharray="1 6" strokeWidth="3"></circle>
</g>

<circle className="" cx="150" cy="150" fill="#0f1224" opacity="0.8" stroke="#a78bfa" strokeWidth="2"></circle>
</svg>

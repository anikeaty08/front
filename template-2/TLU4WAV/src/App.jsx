...
<canvas className="fixed inset-0 w-full h-full pointer-events-none" height="913" id="particle-bg" style={{zIndex: `-1`}} width="1440"></canvas>

<header className="sticky top-0 z-30 backdrop-blur border-b border-white/10 bg-sky-950/80">
<nav className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between animate-seq">
...
<span className="text-lg text-sky-50">ZION-CITY</span>
</div>
<ul className="hidden md:flex gap-5 text-sm">
<li className=""><a className="text-sky-50 hover:text-white" href="#">Dashboard</a></li>
<li><a className="text-sky-50 hover:text-white" href="#">Gear</a></li>
<li><a className="text-sky-50 hover:text-white" href="#">Matches</a></li>
<li><a className="text-sky-50 hover:text-white" href="#">Profile</a></li>
</ul>
<button className="ml-3 flex items-center gap-2 rounded-full bg-sky-900/60 hover:bg-sky-800/80 px-2 py-1 ring-1 ring-white/10">
<img alt="avatar" className="w-7 h-7 rounded-full ring-2 ring-sky-400 object-cover" src="https://randomuser.me/api/portraits/men/22.jpg" />
<span className="hidden sm:inline text-sm text-white">Личный кабинет</span>
</button>
...
<section className="max-w-xl lg:text-left flex flex-col lg:items-start animate-seq visible text-center items-center" id="aura-emdit9zxa">
<h1 className="sm:text-5xl md:text-6xl text-4xl font-medium text-white tracking-tight mb-5">ZION-CITY Decentralized Internet Operating System</h1>
<p className="text-lg sm:text-xl text-gray-300 mb-6">ЕДИНАЯ ВАЛЮТА ЕAЭС АЛТЫН, СУВЕРЕННЫЙ ИНТЕРНЕТ, ЦИФРОВАЯ ЭКОНОМИКА 2022</p>
<div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
<button className="btn-primary flex items-center gap-6">
            Регистрация
...
<button className="btn-secondary pb-123 space-y-0 flex items-center gap-6">
            О ZION CITY
            <svg className="lucide lucide-info w-[18px] h-[18px]" data-lucide="info" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
</button>
</div>
</section>
...
<span className="w-9 h-9 rounded-full bg-gradient-to-tr from-cyan-400 to-sky-400 flex items-center justify-center ring-2 ring-white/10">
...
<span className="text-2xl text-slate-50">ALTYN</span>
</div>
<span className="inline-flex items-center gap-1 uppercase text-xs text-sky-200 bg-sky-400/30 border-sky-400/50 border rounded-full pt-1 pr-3 pb-1 pl-3">Меню<svg className="lucide lucide-menu w-[14px] h-[14px]" data-lucide="menu" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.25" style={{width: `14px`, height: `14px`, color: `rgb(186, 230, 253)`}} viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M4 12h16"></path><path d="M4 18h16"></path><path d="M4 6h16"></path></svg></span>
</div>

<div className="relative flex controller-animate-group -translate-x-8 -translate-y-3 mx-10 px-23 py-10 space-x-20 space-y-0 items-center justify-start"><div className="absolute -inset-4 pointer-events-none blur-[40px]" style={{background: `radial-gradient(circle at 70% 60%,rgba(34,211,238,.12) 0%,rgba(59,130,246,.14) 60%,transparent 100%)`}}></div><img alt="Zion card art" className="controller-img w-[260px] md:w-[340px] lg:w-[390px] drop-shadow-[0_8px_24px_rgba(34,211,238,.2)] select-none pointer-events-none" draggable="false" loading="lazy" src="https://i.postimg.cc/yDjVDHzJ/your-image.jpg" /></div>

<div className="grid grid-cols-3 text-center gap-2">
<div className=""><div className="text-2xl text-sky-400">82%</div><div className="text-xs uppercase">Win Rate</div></div>
<div className=""><div className="text-2xl text-sky-400">1.6ms</div><div className="text-xs uppercase">Input Lag</div></div>
<div className=""><div className="text-2xl text-sky-400">4.5h</div><div className="text-xs uppercase">Session</div></div>
</div>
<div className="h-px bg-gradient-to-r from-sky-400/10 via-sky-300/20 to-white/10"></div>

<div className="grid grid-cols-2 gap-4 text-white/90 text-sm">
<div className="flex items-center gap-3">
<span className="w-9 h-9 rounded-lg bg-sky-700/30 border border-sky-400/30 flex items-center justify-center">
...
<div className="flex items-center gap-3">
<span className="w-9 h-9 rounded-lg bg-sky-800/30 border border-sky-400/30 flex items-center justify-center">
...
<button className="flex gap-2 hover:scale-105 active:scale-95 transition text-white bg-gradient-to-r from-sky-400/90 to-sky-400/80 border-sky-400/40 border rounded-lg pt-2 pr-4 pb-2 pl-4 items-center">Купить «Алтын»<svg className="lucide lucide-wallet w-[24px] h-[24px]" data-lucide="wallet" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" style={{width: `24px`, height: `24px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"></path><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"></path></svg></button><button className="flex gap-2 hover:bg-sky-900/15 active:scale-95 transition text-sky-200 bg-white/5 border-sky-400/30 border rounded-lg pt-2 pr-4 pb-2 pl-4 items-center">Курс валюты<svg className="lucide lucide-bar-chart-3 w-5 h-5" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg></button>
</div>

...
<button className="py-3 px-1 border-b-2 font-medium text-blue-600 border-blue-600 focus:outline-none" id="tab-branding" onClick={(e) => { showTab('branding') }}>
          Brand Identity
        </button>
<button className="py-3 px-1 border-b-2 font-medium text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 focus:outline-none" id="tab-domain" onClick={(e) => { showTab('domain') }}>
          Custom Domain
        </button>
<button className="py-3 px-1 border-b-2 font-medium text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300 focus:outline-none" id="tab-communications" onClick={(e) => { showTab('communications') }}>
          Communications
        </button>
</nav>
</div>

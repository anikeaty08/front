...
<template id="prescriptionCardTemplate"><article className="bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-4"><div className="flex items-start justify-between"><div><h4 className="text-[16px] tracking-tight font-semibold text-slate-900"><span data-field="doctorName"></span></h4><p className="text-xs text-slate-500 mt-0.5"><i className="inline-block h-3.5 w-3.5 mr-1 -mt-0.5" data-lucide="calendar"></i><span data-field="date"></span></p></div><div className="ml-3 shrink-0 hidden" data-field="thumbWrap"><img alt="Prescription" className="h-12 w-12 rounded-lg object-cover ring-1 ring-slate-200" data-field="thumb" src="" /></div></div><div className="mt-3"><p className="text-sm text-slate-700" data-field="desc" style={{display: `-webkit-box`, webkitLineClamp: `3`, webkitBoxOrient: `vertical`, overflow: `hidden`}}></p><button className="mt-1 text-xs text-slate-600 hover:text-slate-900 underline underline-offset-2" data-action="toggleDesc"></button></div><div className="mt-3 pt-3 border-t border-slate-200 flex items-center gap-2"><button className="h-9 px-3 rounded-xl ring-1 ring-slate-200 hover:bg-slate-50 text-slate-700 text-sm flex items-center gap-2" data-action="update"><i className="h-4 w-4" data-lucide="pencil"></i></button><button className="h-9 px-3 rounded-xl ring-1 ring-slate-200 hover:bg-slate-50 text-slate-700 text-sm flex items-center gap-2" data-action="share"><i className="h-4 w-4" data-lucide="share-2"></i></button><button className="ml-auto h-9 px-3 rounded-xl ring-1 ring-red-200 text-red-600 hover:bg-red-50 text-sm flex items-center gap-2" data-action="delete"><i className="h-4 w-4" data-lucide="trash-2"></i></button></div></article></template>
<template id="labCardTemplate"><article className="bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-4"><div className="flex items-start justify-between"><div><h4 className="text-[16px] tracking-tight font-semibold text-slate-900"><span data-field="reportName"></span></h4><p className="text-xs text-slate-500 mt-0.5"><i className="inline-block h-3.5 w-3.5 mr-1 -mt-0.5" data-lucide="calendar"></i><span data-field="date"></span></p></div><div className="ml-3 shrink-0"><div className="h-12 w-12 rounded-lg ring-1 ring-slate-200 overflow-hidden bg-slate-100 flex items-center justify-center" data-field="thumbWrap"><img alt="Report" className="h-full w-full object-cover hidden" data-field="thumb" /><i className="h-5 w-5 text-slate-500" data-lucide="file-text"></i></div></div></div><div className="mt-3"><p className="text-sm text-slate-700" data-field="desc" style={{display: `-webkit-box`, webkitLineClamp: `3`, webkitBoxOrient: `vertical`, overflow: `hidden`}}></p><button className="mt-1 text-xs text-slate-600 hover:text-slate-900 underline underline-offset-2" data-action="toggleDesc"></button></div><div className="mt-3 pt-3 border-t border-slate-200 flex items-center gap-2"><button className="h-9 px-3 rounded-xl ring-1 ring-slate-200 hover:bg-slate-50 text-slate-700 text-sm flex items-center gap-2" data-action="update"><i className="h-4 w-4" data-lucide="pencil"></i></button><button className="h-9 px-3 rounded-xl ring-1 ring-slate-200 hover:bg-slate-50 text-slate-700 text-sm flex items-center gap-2" data-action="share"><i className="h-4 w-4" data-lucide="share-2"></i></button><button className="ml-auto h-9 px-3 rounded-xl ring-1 ring-red-200 text-red-600 hover:bg-red-50 text-sm flex items-center gap-2" data-action="delete"><i className="h-4 w-4" data-lucide="trash-2"></i></button></div></article></template>

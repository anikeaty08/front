...
<button className="inline-flex items-center px-2 py-1 text-xs rounded hover:outline hover:outline-indigo-400 hover:bg-indigo-50 transition" onClick={(e) => { updateStatus(0) }}>
...
<td className="px-6 py-4 text-right">
<button className="inline-flex items-center px-2 py-1 text-xs rounded hover:outline hover:outline-indigo-400 hover:bg-indigo-50 transition" onClick={(e) => { updateStatus(1) }}>
<svg className="lucide lucide-check h-4 w-4 mr-1" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Completa
            </button>
</td>
</tr>
...
<td className="px-6 py-4 text-right">
<button className="inline-flex items-center px-2 py-1 text-xs rounded hover:outline hover:outline-indigo-400 hover:bg-indigo-50 transition" onClick={(e) => { updateStatus(3) }}>
<svg className="lucide lucide-check h-4 w-4 mr-1" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Completa
            </button>
</td>
</tr>
...
<td className="px-6 py-4 text-right">
<button className="inline-flex items-center px-2 py-1 text-xs rounded hover:outline hover:outline-indigo-400 hover:bg-indigo-50 transition" onClick={(e) => { updateStatus(4) }}>
<svg className="lucide lucide-check h-4 w-4 mr-1" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Completa
            </button>
</td>
</tr>

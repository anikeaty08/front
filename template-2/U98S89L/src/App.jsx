...
<template id="hour-card"><div className="shrink-0 w-16 h-28 flex flex-col justify-around items-center bg-white/5 rounded-lg ring-1 ring-white/10"><span className="text-xs font-medium"></span><i className="w-5 h-5 text-blue-200" data-lucide="cloud-sun"></i><span className="text-sm font-semibold"></span></div></template>
</div>
</section>
<div className="border-t border-white/10"></div>
...
<template id="day-row"><div className="flex items-center justify-between px-3 py-2 bg-white/5 rounded-lg ring-1 ring-white/10"><span className="w-16 text-sm font-medium"></span><i className="w-5 h-5 text-blue-200" data-lucide="cloud-rain"></i><div className="flex gap-2 font-semibold"><span className="text-sm text-gray-200"></span><span className="text-sm text-gray-400"></span></div></div></template>
</div>
</section>
<div className="border-t border-white/10"></div>

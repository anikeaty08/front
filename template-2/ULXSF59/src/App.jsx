...
<button className="mt-6 w-full py-3 bg-electric text-white rounded-lg font-bold text-lg shadow hover:bg-violet transition" onClick={(e) => { document.getElementById('onboarding').classList.add('hidden') }}>Let’s Go!</button>
</div>
</div>
...
<button className="flex-1 py-2 font-bold rounded-l-xl bg-electric text-white shadow" onClick={(e) => { showTab('login') }}>Login</button>
<button className="flex-1 py-2 font-bold rounded-r-xl bg-white dark:bg-sidebar text-electric border border-electric dark:border-violet" onClick={(e) => { showTab('register') }}>Register</button>
</div>
...
<a className="text-electric hover:underline" href="#" onClick={(e) => { showReset() }}>Forgot password?</a>
</div>
<button className="w-full py-3 rounded-lg bg-electric text-white font-bold shadow hover:bg-violet transition" onClick={(e) => { goDashboard() }} type="button">Sign In</button>
...
<button className="w-full py-3 rounded-lg bg-electric text-white font-bold shadow hover:bg-coral transition" onClick={(e) => { goDashboard() }} type="button">Register</button>
</form>
<p className="text-xs text-center mt-6 text-gray-500">
<span id="registerPrompt">Don't have an account? <a className="text-electric font-semibold hover:underline" href="#" onClick={(e) => { showTab('register') }}>Register</a></span>
<span className="hidden" id="loginPrompt">Already have an account? <a className="text-electric font-semibold hover:underline" href="#" onClick={(e) => { showTab('login') }}>Login</a></span>
</p>
</div>
</div>
...
<button className="w-full py-2 rounded bg-electric text-white font-bold hover:bg-violet transition" onClick={(e) => { resetOK() }}>Send Reset Link</button>
</div>
</div>
...
<button className="w-full py-2 rounded bg-electric text-white font-bold hover:bg-violet transition" onClick={(e) => { closeReset() }}>Back to login</button>
</div>
</div>
...
<button className="ml-2 px-3 py-2 bg-violet text-white rounded-lg font-semibold shadow hover:bg-coral transition" id="profileBtn" onClick={(e) => { toggleProfileMenu() }}><i className="ti ti-menu-2"></i></button>
<div className="absolute right-0 mt-2 bg-white dark:bg-sidebar shadow rounded-lg py-2 w-48 hidden z-50" id="profileMenu">
<a className="block px-4 py-2 hover:bg-electric/10" href="#" onClick={(e) => { showScreen('settings') }}><i className="ti ti-user-circle mr-2"></i>Account Settings</a>
<a className="block px-4 py-2 hover:bg-electric/10" href="#" onClick={(e) => { showScreen('subscription') }}><i className="ti ti-credit-card mr-2"></i>Subscription</a>
<div className="px-4 py-2 text-xs text-gray-400">Pro Plan</div>
<button className="block w-full text-left px-4 py-2 hover:bg-coral/10 text-coral" onClick={(e) => { logout() }}><i className="ti ti-logout mr-2"></i>Logout</button>
</div>
</div>
</div>
</header>

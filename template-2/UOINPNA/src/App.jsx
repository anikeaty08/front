...
<button className="w-full py-3 rounded-lg bg-[#fc4b08] hover:bg-[#fc4b08]/80 transition-colors font-medium" onClick={(e) => { showScreen('loginScreen') }}>
          Iniciar sesión
        </button>
<button className="w-full py-3 rounded-lg border border-[#fc4b08] hover:bg-[#fc4b08]/10 transition-colors font-medium" onClick={(e) => { alert('Flow de registro pendiente') }}>
          Registrarse
        </button>
</div>
</section>
...
<form className="space-y-6" onSubmit={(e) => { event.preventDefault();showScreen('dashboardScreen') }}>
...
<button className="block text-center w-full text-xs mt-2 hover:text-[#fc4b08] transition-colors" onClick={(e) => { alert('Recuperación de contraseña...') }} type="button">
...
<button className="p-2 rounded-full hover:bg-white/10" onClick={(e) => { showScreen('profileScreen') }}>
...
<button className="p-2 rounded-full hover:bg-white/10" onClick={(e) => { showScreen('dashboardScreen') }}>
...
<div className="cursor-pointer rounded-xl border border-white/10 p-4 bg-[#0b1130] hover:border-[#fc4b08]/50 transition flex flex-col space-y-2" onClick={(e) => { showScreen('campaignDetailScreen') }}>
...
<header className="px-6 pt-6 pb-4 flex items-center space-x-2">
<button className="p-2 rounded-full hover:bg-white/10" onClick={(e) => { showScreen('campaignsScreen') }}>
<i className="w-5 h-5" data-lucide="chevron-left"></i>
</button>
...
<button className="w-full py-3 rounded-lg bg-[#fc4b08] hover:bg-[#fc4b08]/80 transition-colors font-medium" onClick={(e) => { showScreen('suggestionsScreen') }}>
...
<header className="px-6 pt-6 pb-4 flex items-center space-x-2">
<button className="p-2 rounded-full hover:bg-white/10" onClick={(e) => { showScreen('campaignDetailScreen') }}>
<i className="w-5 h-5" data-lucide="chevron-left"></i>
</button>
...
<button className="py-3 rounded-lg bg-red-600/80 hover:bg-red-600 transition-colors text-sm font-medium" onClick={(e) => { alert('Campaña pausada') }}>
            Pausar campaña
          </button>
<button className="py-3 rounded-lg bg-[#fc4b08] hover:bg-[#fc4b08]/80 transition-colors text-sm font-medium" onClick={(e) => { alert('Abriendo editor de presupuesto') }}>
            Modificar presupuesto
          </button>
<button className="col-span-2 py-3 rounded-lg border border-white/20 hover:bg-white/10 transition-colors text-sm font-medium" onClick={(e) => { showScreen('campaignDetailScreen') }}>
            Ignorar
          </button>
</div>
</div>
...
<button className="w-full flex items-center justify-between px-4 py-4 hover:bg-white/5 text-sm text-red-400" onClick={(e) => { showScreen('welcomeScreen') }}>
...
<button className="flex flex-col items-center gap-1 text-xs" onClick={(e) => { showScreen('dashboardScreen') }}>
<i className="w-5 h-5" data-lucide="home"></i>
      Inicio
    </button>
<button className="flex flex-col items-center gap-1 text-xs" onClick={(e) => { showScreen('campaignsScreen') }}>
<i className="w-5 h-5" data-lucide="bar-chart-2"></i>
      Reportes
    </button>
<button className="flex flex-col items-center gap-1 text-xs" onClick={(e) => { alert('Alertas...') }}>
<i className="w-5 h-5" data-lucide="bell"></i>
      Alertas
    </button>
<button className="flex flex-col items-center gap-1 text-xs" onClick={(e) => { showScreen('profileScreen') }}>
<i className="w-5 h-5" data-lucide="user"></i>
      Perfil
    </button>
</nav>

...
<svg className="lucide lucide-sparkle text-slate-50" data-lucide="sparkle" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
<div>
...
<svg className="lucide lucide-sparkles mt-0.5 text-cyan-400" data-lucide="sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
              Эксклюзивная дистрибуция туров и динамическое ценообразование для партнёров.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-wand-sparkles mt-0.5 text-cyan-400" data-lucide="wand-sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
...
<li className="flex gap-2">
<svg className="lucide lucide-wallet mt-0.5 text-cyan-400" data-lucide="wallet" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
              Прозрачные финансы: комиссии, счета, выплаты, сверки — без Excel.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-headphones mt-0.5 text-cyan-400" data-lucide="headphones" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-user-check mt-0.5 text-cyan-400" data-lucide="user-check" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="9" cy="7"></circle></svg>
              Владельцы/менеджеры турагентств‑ритейлеров — рост продаж и маржинальности.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-gauge mt-0.5 text-cyan-400" data-lucide="gauge" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
              Снижение времени брони, меньше ручной рутины, выше NPS клиентов.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-link mt-0.5 text-cyan-400" data-lucide="link" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-sliders-horizontal mt-0.5 text-cyan-400" data-lucide="sliders-horizontal" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><line></line><line></line><line></line><line></line><line></line><line></line><line></line><line></line><line></line></svg>
              Фильтры: даты, бюджет, направления, тип тура, провайдер.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-languages mt-0.5 text-cyan-400" data-lucide="languages" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path></svg>
              Умный поиск (NLP), синонимы и промо‑запросы.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-calendar-check-2 mt-0.5 text-cyan-400" data-lucide="calendar-check-2" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
              Доступность/цена в реальном времени, блокировка мест.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-file-input mt-0.5 text-cyan-400" data-lucide="file-input" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
              Оформление брони, ваучеры, документы, доп. услуги.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-history mt-0.5 text-cyan-400" data-lucide="history" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-receipt mt-0.5 text-cyan-400" data-lucide="receipt" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
              Инвойсы, акты, фискальные чеки, автосверки.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-percent mt-0.5 text-cyan-400" data-lucide="percent" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><line></line><circle cx="6.5" cy="6.5"></circle><circle cx="17.5" cy="17.5"></circle></svg>
              Комиссии и маркап, правила скидок, промокоды.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-credit-card mt-0.5 text-cyan-400" data-lucide="credit-card" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><line></line></svg>
              Платежи: карты, BNPL, банковские переводы, гарантии.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-send-to-back mt-0.5 text-cyan-400" data-lucide="send-to-back" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8"></rect><rect height="8" rx="2" width="8"></rect><path></path><path></path></svg>
...
<li className="flex gap-2">
<svg className="lucide lucide-images mt-0.5 text-cyan-400" data-lucide="images" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><circle cx="13" cy="7" fill="currentColor"></circle><rect height="14" rx="2" width="14"></rect></svg>
              Контент‑студия: баннеры, лендинги, PDF‑презентации.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-mail mt-0.5 text-cyan-400" data-lucide="mail" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="16" rx="2" width="20"></rect></svg>
              Email/SMS кампании, сегментация, UTM‑метки.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-badge-percent mt-0.5 text-cyan-400" data-lucide="badge-percent" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-id-card mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
              Профили клиентов, предпочтения, документы и визы.
            </li>
<li className="flex gap-2">

<svg className="lucide lucide-messages-square mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="7" rx="1" width="7"></rect><rect height="7" rx="1" width="7"></rect><rect height="7" rx="1" width="7"></rect></svg>
              История коммуникаций: звонки, email, мессенджеры.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-filter mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
              Сегменты и списки: VIP, частые, корпоративные.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-shield-check mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-headset mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
              Тикеты и чат 24/7, SLA‑метрики.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-book-open mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
              База знаний, макеты писем, шаблоны скриптов.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-bell-ring mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-braces mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
              REST/GraphQL API, SDK для JS и Python.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-radio-tower mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
              Вебхуки, события брони/платежей, ретраи.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-shield mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
...
<ul className="mt-3 space-y-2 text-sm text-white/80">
<li className="flex gap-2">
<svg className="lucide lucide-presentation mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><rect height="12" rx="2" width="20"></rect><path></path><path></path></svg>
              Дашборды по GMV, конверсиям и марже.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-candlestick-chart mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="8" rx="1" width="3"></rect><rect height="8" rx="1" width="3"></rect></svg>
              Cohort‑анализ, ABC/XYZ, LTV/Retention.
            </li>
<li className="flex gap-2">
<svg className="lucide lucide-file-down mt-0.5 text-cyan-400" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
...
<div className="flex items-center gap-2">
<span className="h-8 w-8 rounded-lg inline-flex items-center justify-center bg-white/10">
<svg className="lucide lucide-notebook-pen text-cyan-300" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-eraser" fill="none" height="16" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                Очистить
              </button>
</div>
...
<svg className="lucide lucide-video text-indigo-200" fill="none" height="18" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="12" rx="2" width="14"></rect><path></path></svg>
</div>
<div>
...
<form aria-label="Форма запроса демо" className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3" id="demoForm" onSubmit={(e) => { return false }}>
<div className="">

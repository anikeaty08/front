...
<button className="md:hidden flex items-center justify-center w-9 h-9 rounded-md border border-black/10 hover:border-[#ff8da1] transition-colors" onClick={(e) => { document.querySelector('#booking').scrollIntoView({behavior:'smooth'}) }}>
...
<button className="mt-10 px-8 py-3 rounded-lg bg-[#ff8da1] text-white font-semibold shadow-md hover:shadow-lg hover:bg-[#ffa9b8] transition-all opacity-0 translate-y-6" data-delay="200" onClick={(e) => { document.querySelector('#booking').scrollIntoView({behavior:'smooth'}) }} style={{transitionDuration: `700ms`}}>Book Now</button>
</div>
</div>
</section>

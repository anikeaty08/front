...
<div className="relative w-full max-w-[320px] xl:mx-0 h-[640px] flex flex-col overflow-hidden hover:scale-105 transition-transform duration-300 bg-indigo-800 bg-[url(/assets/3d88d288-2c8c-4130-b2d9-20c5a68b3998_1600w.jpg)] bg-cover rounded-[2.5rem] mr-auto ml-auto shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]">
...
<img alt="Learning illustration" className="w-32 h-32 object-cover rounded-full" src="/assets/fa51a15b-4dd1-4b40-b2b9-2e943bd5e564_320w.jpg" style={{}} />
</div>
</div>
...
<img alt="Profile" className="w-10 h-10 object-cover rounded-full" src="/assets/226384e4-8238-463a-baaa-645484f90b86_320w.jpg" />
<div className="">
...
<div className="px-6 mt-6">
<div className="w-full flex flex-col gap-4 bg-indigo-800 bg-[url(/assets/2082cb53-c0f0-46e5-a4e5-8de1d2247343_800w.jpg)] bg-cover rounded-3xl pt-6 pr-6 pb-6 pl-6">
...
<div className="w-full flex flex-col gap-6 bg-indigo-800 bg-[url(/assets/322719de-f763-429e-9cc6-d2f032a9f8ec_800w.jpg)] bg-cover rounded-3xl pt-6 pr-6 pb-6 pl-6 items-center">
<div className="w-32 h-32 rounded-full flex items-center justify-center bg-black/50">
<img alt="AI Assistant" className="w-24 h-24 object-cover rounded-full" src="/assets/21b7ee4f-dfd0-45f5-a64c-b8a7761bc2b9_320w.jpg" />
</div>

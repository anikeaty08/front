...
<button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium" onClick={(e) => { showPage('new-audit') }}>New Audit</button>
...
<button className="text-blue-600 hover:text-blue-900 mr-4" onClick={(e) => { showPage('audit-results') }}>View</button>
...
<button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-medium hover:shadow-lg transition" onClick={(e) => { startAudit() }} type="button">
              Start Audit
            </button>
</form>
</div>
...
<div className="flex gap-3">
<button className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700" onClick={(e) => { showPage('report-generator') }}>Generate Report</button>
...
<path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#10b981" strokeDasharray="82, 100" strokeWidth="2"></path>
</svg>

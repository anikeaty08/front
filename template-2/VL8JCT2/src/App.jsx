...
<button className="area-card group rounded-lg border-2 border-transparent bg-white shadow hover:shadow-lg transition p-4 flex flex-col items-center gap-2 cursor-pointer" id="area-matematicas" onClick={(e) => { selectArea('matematicas') }}>
...
<button className="area-card group rounded-lg border-2 border-transparent bg-white shadow hover:shadow-lg transition p-4 flex flex-col items-center gap-2 cursor-pointer" id="area-lectura" onClick={(e) => { selectArea('lectura') }}>
...
<button className="area-card group rounded-lg border-2 border-transparent bg-white shadow hover:shadow-lg transition p-4 flex flex-col items-center gap-2 cursor-pointer" id="area-ciencias" onClick={(e) => { selectArea('ciencias') }}>
...
<button className="area-card group rounded-lg border-2 border-transparent bg-white shadow hover:shadow-lg transition p-4 flex flex-col items-center gap-2 cursor-pointer" id="area-sociales" onClick={(e) => { selectArea('sociales') }}>
...
<button className="area-card group rounded-lg border-2 border-transparent bg-white shadow hover:shadow-lg transition p-4 flex flex-col items-center gap-2 cursor-pointer" id="area-ingles" onClick={(e) => { selectArea('ingles') }}>

...
<path stroke="currentColor" strokeWidth="2"></path>
<circle cx="52" cy="24" fill="currentColor"></circle>
</svg>
</div>
...
<defs>
<filter color-interpolation-filters="sRGB" filterunits="userSpaceOnUse" height="800" id="f" width="1400">
...
{"<"}svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 48" role="img" aria-label="Linea"{">"}
  ...
  {"<"}/g{">"}
  {"<"}text x="60" y="32" font-family="Inter, system-ui, -apple-system" font-size="20" font-weight="600" letter-spacing="-0.02em" fill="currentColor"{">"}Linea{"<"}/text{">"}
{"<"}/svg{">"}
            </textarea>
</div>
</div>

...
<div className="flex items-center h-16 px-6 gap-3 border-b border-white/10">
...
<svg className="lucide lucide-x h-4 w-4 text-white/60" data-lucide="x" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: `1.5`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
</div>
...
<p className="text-gray-500 text-sm">Manage your content library and rights</p>
</header>
...
<button className="flex gap-2 h-10 hover:bg-red-700 text-sm text-white bg-red-600 rounded-lg pr-4 pl-4 items-center" onClick={(e) => { 
  ...
  newRow.innerHTML = `
    <td class='px-6 py-4 flex items-center gap-3'>
      <span class='w-6 h-6 flex items-center justify-center rounded bg-gray-200 text-gray-600'>
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' data-lucide='file-text' class='lucide lucide-file-text w-4 h-4' style='stroke-width: 1.5;'><path d='M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z'></path><path d='M14 2v6h6'></path><path d='M16 13H8'></path><path d='M16 17H8'></path><path d='M10 9H8'></path></svg>
      </span>
      <div>
        <p class='font-medium'>New Content</p>
        <p class='text-xs text-gray-500'>ID: NEW-000</p>
      </div>
    </td>
    <td class='px-6 py-4'>
      <span class='px-2 py-0.5 rounded-full bg-gray-100 text-gray-600 text-xs'>Uncategorized</span>
    </td>
    <td class='px-6 py-4'>
      <span class='px-2 py-0.5 rounded-full bg-gray-100 text-gray-600 text-xs'>Status</span>
    </td>
    <td class='px-6 py-4'>Region</td>
    <td class='px-6 py-4'>YYYY-MM-DD</td>
...
<button className="hover:underline text-red-600" onClick={(e) => { if(confirm('Are you sure you want to delete e.currentTarget row?')) { const row = e.currentTarget.closest('tr'); if(row) row.remove(); } }} type="button">Delete</button>
</td>
</tr>

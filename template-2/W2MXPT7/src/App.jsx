...
<div className="absolute inset-0 bg-[url(/assets/f09193c9-6355-4bd1-b913-9c5728e4dd03_800w.jpg)] bg-cover transition-transform duration-500 group-hover:scale-110"></div>
...
<div className="absolute inset-0 bg-[url(/assets/96eb5636-6a37-4a34-a637-59576912351f_800w.jpg)] bg-cover transition-transform duration-500 group-hover:scale-110"></div>
<div className="absolute bottom-3 left-4">
<div className="h-10 w-10 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">

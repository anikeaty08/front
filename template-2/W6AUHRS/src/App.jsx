...
<svg className="lucide lucide-feather h-5 w-5 text-black" data-lucide="feather" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-user-plus w-4 h-4" data-lucide="user-plus" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="9" cy="7"></circle><line></line><line></line></svg>
...
<svg className="lucide lucide-trending-up h-3.5 w-3.5" data-lucide="trending-up" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-pen-line w-4 h-4" data-lucide="pen-line" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
...
<svg className="lucide lucide-play-circle h-4.5 w-4.5" data-lucide="play-circle" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="12"></circle></svg>
...
<svg className="lucide lucide-plus" data-lucide="plus" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                          新建
                        </button>
</div>
...
<svg className="lucide lucide-book" data-lucide="book" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</span>
...
<svg className="lucide lucide-files" data-lucide="files" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-code-2" data-lucide="code-2" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-clipboard-list" data-lucide="clipboard-list" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><rect height="4" rx="1" ry="1" width="8"></rect><path></path><path></path><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-search text-zinc-400" data-lucide="search" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
...
<svg className="lucide lucide-bold" data-lucide="bold" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                          B
                        </button>
<button className="h-7 px-2 rounded-md text-xs ring-1 inline-flex items-center gap-1.5 bg-zinc-900 ring-zinc-800 hover:bg-zinc-800" style={{}}>
<svg className="lucide lucide-italic" data-lucide="italic" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><line></line><line></line><line></line></svg>
                          I
                        </button>
<button className="h-7 px-2 rounded-md text-xs ring-1 inline-flex items-center gap-1.5 bg-zinc-900 ring-zinc-800 hover:bg-zinc-800" style={{}}>
<svg className="lucide lucide-list" data-lucide="list" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path></svg>
                          列表
                        </button>
<button className="h-7 px-2 rounded-md text-xs ring-1 inline-flex items-center gap-1.5 bg-zinc-900 ring-zinc-800 hover:bg-zinc-800" style={{}}>
<svg className="lucide lucide-link-2" data-lucide="link-2" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><line></line></svg>
                          链接
                        </button>
</div>
<div className="flex items-center gap-2">
...
<svg className="lucide lucide-share-2" data-lucide="share-2" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="5"></circle><circle cx="6" cy="12"></circle><circle cx="18" cy="19"></circle><line></line><line></line></svg>
                          分享
                        </button>
<button className="h-7 px-2 rounded-md text-xs ring-1 inline-flex items-center gap-1.5 bg-zinc-900 ring-zinc-800 hover:bg-zinc-800" style={{}}>
<svg className="lucide lucide-messages-square" data-lucide="messages-square" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                          评论
                        </button>
</div>
</div>
...
<svg className="lucide lucide-check-circle-2 mt-0.5 text-emerald-400" data-lucide="check-circle-2" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg>
                              规划空间与目录结构
                            </li>
<li className="flex items-start gap-2" style={{}}>
<svg className="lucide lucide-users mt-0.5 text-emerald-400" data-lucide="users" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
                              设置成员与权限
                            </li>
<li className="flex items-start gap-2" style={{}}>
<svg className="lucide lucide-sparkles mt-0.5 text-emerald-400" data-lucide="sparkles" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
                              使用模板与格式规范
                            </li>
<li className="flex items-start gap-2" style={{}}>
<svg className="lucide lucide-search mt-0.5 text-emerald-400" data-lucide="search" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
                              打造可检索的知识索引
                            </li>
</ul>
</div>
...
<svg className="lucide lucide-history" data-lucide="history" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                        历史版本
                      </button>
<button className="inline-flex gap-1.5 text-xs font-medium rounded-lg pt-1.5 pr-3 pb-1.5 pl-3 items-center hover:bg-zinc-800 text-zinc-200 bg-zinc-950" style={{}}>
<svg className="lucide lucide-lock" data-lucide="lock" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><rect height="11" rx="2" ry="2" width="18"></rect><path></path></svg>
                        权限
                      </button>
</div>
</div>
...
<svg className="lucide lucide-user-round" data-lucide="user-round" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="8"></circle><path></path></svg>
</span>
...
<svg className="lucide lucide-type" data-lucide="type" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-folders" data-lucide="folders" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
...
<svg className="lucide lucide-search" data-lucide="search" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
</span>
...
<svg className="lucide lucide-shield-check" data-lucide="shield-check" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</span>
...
<a className="inline-flex items-center gap-1 text-sm font-medium mt-3 mb-8 hover:text-emerald-300 text-emerald-400" href="#" style={{}}>
                查看模板
                <svg className="lucide lucide-arrow-right h-4 w-4" data-lucide="arrow-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
...
<svg className="lucide lucide-zap" data-lucide="zap" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                10 分钟搭建你的第一座知识库
              </span>
...
<svg className="lucide lucide-play h-6 w-6 text-zinc-100" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
</div>
</div>
</div>
...
<svg className="lucide lucide-rocket" data-lucide="rocket" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
                免费注册
              </a>
...
<svg className="lucide lucide-credit-card" data-lucide="credit-card" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><line></line></svg>
                查看定价
              </a>
</div>
</div>
...
<svg className="lucide lucide-chevron-down h-5 w-5 text-zinc-400" data-lucide="chevron-down" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<svg className="lucide lucide-feather h-5 w-5 text-black" data-lucide="feather" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-twitter h-4.5 w-4.5" data-lucide="twitter" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</a>
<a className="h-9 w-9 rounded-full ring-1 flex items-center justify-center ring-zinc-800 hover:bg-zinc-950" href="#">
<svg className="lucide lucide-youtube h-4.5 w-4.5" data-lucide="youtube" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
<a className="h-9 w-9 rounded-full ring-1 flex items-center justify-center ring-zinc-800 hover:bg-zinc-950" href="#">
<svg className="lucide lucide-github h-4.5 w-4.5" data-lucide="github" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
</div>
</div>
<div>
...
<svg className="lucide lucide-log-in" data-lucide="log-in" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                    登录
                  </a>
...
<svg className="lucide lucide-user-plus" data-lucide="user-plus" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="9" cy="7"></circle><line></line><line></line></svg>
<span style={{}}>注册</span>
</span>
</button>
</div>

...
<button className="hover:bg-neutral-100 transition-colors duration-150 bg-neutral-700 rounded-full pt-2 pr-2 pb-2 pl-2" onClick={(e) => { toggleFilter() }}>
...
<input className="w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm border-neutral-200 border rounded-lg pt-2 pr-2 pb-2 pl-2" onKeyUp={(e) => { filterTopics(e.currentTarget.value) }} placeholder="Filter topics..." type="text" />
</div>

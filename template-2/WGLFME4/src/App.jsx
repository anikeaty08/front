...
<div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-600 to-purple-700 p-0.5 shadow-xl cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-105" onClick={(e) => { toggleChat() }}>
...
<button className="p-1 hover:bg-gray-100 rounded-lg transition-colors" onClick={(e) => { toggleChat() }}>

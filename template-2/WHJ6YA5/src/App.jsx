...
<span className="inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-xs ring-1 bg-black/5 ring-black/10 text-slate-700">
<svg className="lucide lucide-shield-check h-4 w-4 text-slate-600" data-lucide="shield-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path><path></path></svg>
...
<a className="sm:inline-flex items-center gap-2 text-[12px] hover:bg-[#095EC4] font-medium text-white bg-[#0A6EE7] rounded-lg pt-1 pr-1.5 pb-1 pl-1.5" href="https://aura.build/share/9GG5KDA" role="button">ดูข้อมูล</a>
</div>
...
<svg className="lucide lucide-calendar h-4 w-4 text-slate-600" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect className="" height="18" rx="2" width="18"></rect><path></path></svg>
          2027–2034
        </div>

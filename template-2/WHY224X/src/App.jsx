...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm text-emerald-300 hover:text-white hover:bg-white/5 transition font-geist" id="servicesButton">
                Services
                <svg className="lucide lucide-chevron-down h-4 w-4" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<svg className="lucide lucide-megaphone h-4 w-4" data-lucide="megaphone" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
<div>
...
<svg className="lucide lucide-workflow h-4 w-4" data-lucide="workflow" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8"></rect><path></path><rect height="8" rx="2" width="8"></rect></svg>
<div>
...
<svg className="lucide lucide-layout-dashboard h-4 w-4" data-lucide="layout-dashboard" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect><rect height="9" rx="1" width="7"></rect><rect height="5" rx="1" width="7"></rect></svg>
<div>
...
<svg className="lucide lucide-users h-4 w-4" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
<div>
...
<svg className="lucide lucide-sparkles h-4 w-4" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
              Free Systems Audit
            </a>
...
<svg className="lucide lucide-scan-line h-4 w-4" data-lucide="scan-line" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
...
<div className="h-px w-8 bg-white/10"></div>
              ...
              <svg className="lucide lucide-chevrons-down h-3.5 w-3.5" data-lucide="chevrons-down" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
<div className="h-px w-8 bg-white/10"></div>
</div>
...
<svg className="lucide lucide-message-square h-4 w-4" data-lucide="message-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                        Intake
                      </div>
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-2 text-xs text-emerald-300 font-geist">
<svg className="lucide lucide-mail-check h-4 w-4" data-lucide="mail-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                        Nurture
                      </div>
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-2 text-xs text-emerald-300 font-geist">
<svg className="lucide lucide-line-chart h-4 w-4" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                        Weekly KPI
                      </div>
...
<svg className="lucide lucide-file-text h-5 w-5" data-lucide="file-text" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
</div>
...
<div className="rounded-3xl border border-white/10 bg-emerald-900/60 p-6 hover:translate-y-[-2px] transition will-change-transform">
<div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center">
<svg className="lucide lucide-bot h-5 w-5" data-lucide="bot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" rx="2" width="16"></rect><path></path><path></path><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-megaphone h-5 w-5 text-emerald-300 group-hover:text-white" data-lucide="megaphone" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</div>
...
<svg className="lucide lucide-workflow h-5 w-5 text-emerald-200" data-lucide="workflow" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8"></rect><path></path><rect height="8" rx="2" width="8"></rect></svg>
</div>
...
<div className="mt-5 inline-flex items-center gap-2 text-sm text-emerald-900 bg-white rounded-full px-3 py-1.5 self-start font-geist">
              Build my engine
              <svg className="lucide lucide-rocket h-4 w-4" data-lucide="rocket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
</div>
</a>
...
<a className="inline-flex items-center gap-2 rounded-full bg-white/10 text-white px-4 py-2 text-sm font-medium hover:bg-white/15 transition font-geist" href="#services">
            Explore Services
            <svg className="lucide lucide-chevrons-right h-4 w-4" data-lucide="chevrons-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
</div>
...
<svg className="lucide lucide-users h-5 w-5" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
</div>
<div>
<div className="text-sm font-medium font-geist">Clario for Teams</div>
...
<a className="inline-flex items-center gap-2 rounded-full bg-white text-emerald-900 px-3 py-1.5 text-xs font-medium font-geist" href="#contact">
              Request access
              <svg className="lucide lucide-arrow-right h-3.5 w-3.5" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
</div>
</div>
</div>
...
<svg className="lucide lucide-search h-4 w-4" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg> Discover
            </div>
<p className="mt-2 text-sm text-emerald-300 font-geist">Audit the value chain. Shortlist the 3–5 automations that matter.</p>
</div>
<div className="rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:translate-y-[-2px] transition will-change-transform">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-map h-4 w-4" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg> Design
            </div>
<p className="mt-2 text-sm text-emerald-300 font-geist">Map flows, prompts, data models, and UI.</p>
</div>
<div className="rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:translate-y-[-2px] transition will-change-transform">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-bot h-4 w-4" data-lucide="bot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24              viewBox=" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" rx="2" width="16"></rect><path></path><path></path><path></path><path></path></svg> Build
            </div>
<p className="mt-2 text-sm text-emerald-300 font-geist">Ship the MVP workflow. Integrate CRM, automations, and dashboards.</p>
</div>
<div className="rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:translate-y-[-2px] transition will-change-transform">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-line-chart h-4 w-4" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg> Prove
            </div>
...
<div className="rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:translate-y-[-2px] transition will-change-transform">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-rocket h-4 w-4" data-lucide="rocket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg> Scale
            </div>
...
<a className="hidden sm:inline-flex items-center gap-2 rounded-full bg-white/10 text-white px-4 py-2 text-sm font-medium hover:bg-white/15 transition font-geist" href="#contact">
            Start a project
            <svg className="lucide lucide-arrow-right h-4 w-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
</a>
</div>
...
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-zap h-4 w-4" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
              Quickstart
            </div>
...
<a className="group rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:border-white/20 hover:translate-y-[-2px] transition will-change-transform" href="#contact">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-send h-4 w-4" data-lucide="send" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
              Outreach
            </div>
...
<a className="group rounded-3xl border border-white/10 bg-emerald-900/60 p-5 hover:border-white/20 hover:translate-y-[-2px] transition will-change-transform" href="#contact">
<div className="flex items-center gap-2 text-xs text-emerald-400 font-geist">
<svg className="lucide lucide-bar-chart-3 h-4 w-4" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg>
              Analytics
            </div>
...
<div className="">
<div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-[11px] text-emerald-100 font-geist">
<svg className="lucide lucide-sparkles h-3.5 w-3.5" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="4" cy="20"></circle></svg>
              Free Systems Audit
            </div>
...
<button className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-white text-emerald-900 px-4 py-2 text-sm font-medium hover:opacity-90 transition font-geist" type="submit">
              Book my audit
              <svg className="lucide lucide-calendar-check-2 h-4 w-4" data-lucide="calendar-check-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="18" rx="2" width="18"></rect><path></path><path></path></svg>
</button>

...
<template id="testimonialTemplate"><div className="w-full md:w-1/2 lg:w-1/3 shrink-0"><div className="h-full flex flex-col p-8 border border-[#E7E7EA] rounded-3xl bg-white shadow-sm"><svg aria-hidden="true" className="w-6 h-6 text-[#E2E2E5]" viewBox="0 0 24 24"><path d="M7.17 6.17a4 4 0 1 1 5.66 5.66L8 16H4v-4l3.17-5.83ZM19.17 6.17a4 4 0 1 1 5.66 5.66L20 16h-4v-4l3.17-5.83Z" fill="currentColor"></path></svg><p className="mt-4 mb-6 text-sm leading-relaxed grow"></p><div className="text-sm font-medium" style={{fontFamily: `'Lora',serif`}}></div></div></div></template>

...
<svg className="lucide lucide-mail w-5 h-5 text-purple-400" data-lucide="mail" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="16" rx="2" width="20"></rect></svg>
</div>
<div>
...
<div className="flex items-center gap-4">
<div className="glass-effect rounded-xl p-3 border border-white/10">
<svg className="lucide lucide-phone w-5 h-5 text-purple-400" data-lucide="phone" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
<div>
...
<svg className="lucide lucide-twitter w-5 h-5 text-white/70 hover:text-purple-400 transition-colors" data-lucide="twitter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</a>
<a className="glass-effect rounded-xl p-3 border border-white/10 hover:border-purple-400/30 hover:scale-105 transition-all" href="#">
<svg className="lucide lucide-linkedin w-5 h-5 text-white/70 hover:text-purple-400 transition-colors" data-lucide="linkedin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" width="4"></rect><circle cx="4" cy="4"></circle></svg>
</a>
<a className="glass-effect rounded-xl p-3 border border-white/10 hover:border-purple-400/30 hover:scale-105 transition-all" href="#">
<svg className="lucide lucide-instagram w-5 h-5 text-white/70 hover:text-purple-400 transition-colors" data-lucide="instagram" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="5" ry="5" width="20"></rect><path></path><line></line></svg>
</a>
<a className="glass-effect rounded-xl p-3 border border-white/10 hover:border-purple-400/30 hover:scale-105 transition-all" href="#">
<svg className="lucide lucide-facebook w-5 h-5 text-white/70 hover:text-purple-400 transition-colors" data-lucide="facebook" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</a>
</div>
</div>
</div>
...
<svg className="lucide lucide-map-pin w-5 h-5 text-purple-400" data-lucide="map-pin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="10"></circle></svg>
</div>
<div>
...
<span>Made with</span>
<svg className="lucide lucide-heart w-3 h-3 text-red-400" data-lucide="heart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>

...
<div className="icon-circle active" data-tooltip="Propulsion System" onClick={(e) => { toggleSystem('propulsion') }}>
<i className="w-4 h-4 text-green-400" data-lucide="rocket"></i>
</div>
<div className="card-vertical-divider h-5"></div>
<div className="icon-circle warning" data-tooltip="Communications" onClick={(e) => { toggleSystem('communication') }}>
<i className="w-4 h-4 text-amber-400" data-lucide="satellite"></i>
</div>
<div className="card-vertical-divider h-5"></div>
<div className="icon-circle" data-tooltip="Navigation" onClick={(e) => { toggleSystem('navigation') }}>
<i className="w-4 h-4 text-neutral-400" data-lucide="radio"></i>
</div>
<div className="card-vertical-divider h-5"></div>
<div className="icon-circle" data-tooltip="Security Systems" onClick={(e) => { toggleSystem('security') }}>
...
<div className="stat-container text-center px-2" onClick={(e) => { showStatDetails('distance') }}>
...
<div className="stat-container text-center px-2" onClick={(e) => { showStatDetails('systems') }}>
...
<div className="card-vertical-divider h-12 my-auto"></div>
<div className="stat-container text-center px-2" onClick={(e) => { showStatDetails('uptime') }}>
...
<span className="tag-item text-[10px] px-2 py-1 rounded-full bg-green-500/10 border border-green-500/30 text-green-300" onClick={(e) => { highlightTag(e.currentTarget) }}>LIFE SUPPORT</span>
<span className="tag-item text-[10px] px-2 py-1 rounded-full bg-neutral-500/10 border border-neutral-500/30 text-neutral-300" onClick={(e) => { highlightTag(e.currentTarget) }}>NAVIGATION</span>
<span className="tag-item text-[10px] px-2 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-300" onClick={(e) => { highlightTag(e.currentTarget) }}>DEEP SPACE</span>
<span className="tag-item text-[10px] px-2 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300" onClick={(e) => { highlightTag(e.currentTarget) }}>RESEARCH</span>
</div>

...
<button className="inline-flex items-center gap-1 rounded-md px-3 py-1.5 text-xs font-medium text-slate-200/90 hover:text-white hover:bg-white/5 ring-1 ring-white/10 hover:ring-white/20 transition" onClick={(e) => { goTo('map') }}>
              Skip
...
<button className="inline-flex w-full gap-2 ring-1 ring-sky-400/30 hover:bg-sky-500/20 hover:ring-sky-300/50 transition text-sm font-medium text-sky-300 bg-sky-500/15 rounded-xl pt-3 pr-4 pb-3 pl-4 items-center justify-center" onClick={(e) => { goTo('map') }}>
<svg className="lucide lucide-map-pin w-4 h-4" data-lucide="map-pin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
                Find Clubs
              </button>
<button className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white/5 px-4 py-3 text-sm font-medium text-slate-200 ring-1 ring-white/10 hover:bg-white/10 hover:ring-white/20 transition" onClick={(e) => { comingSoon() }}>
...
<button className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] font-medium text-fuchsia-300/90 ring-1 ring-fuchsia-400/30 hover:bg-fuchsia-500/10 hover:ring-fuchsia-300/50 transition" onClick={(e) => { vipTease() }}>
              Try VIP
            </button>
</div>
</div>
...
<button className="inline-flex items-center gap-2 rounded-xl bg-slate-900/60 px-3 py-2 text-sm text-slate-200 ring-1 ring-white/10 hover:ring-white/20 hover:bg-white/10 transition" onClick={(e) => { goTo('chat') }}>
...
<button className="inline-flex items-center gap-1 rounded-lg bg-emerald-500/15 px-2.5 py-1.5 text-xs font-medium text-emerald-300 ring-1 ring-emerald-400/30 hover:bg-emerald-500/20 hover:ring-emerald-300/50 transition" onClick={(e) => { directions('Wild%20Thyme') }}>
...
<button className="inline-flex items-center gap-1 rounded-lg bg-white/5 px-2.5 py-1.5 text-xs font-medium text-slate-200 ring-1 ring-white/10 hover:bg-white/10 hover:ring-white/20 transition" onClick={(e) => { dismissPrompt(e.currentTarget) }}>
                    Not now
                  </button>
</div>
</div>
...
<div className="ml-3">
<button className="inline-flex items-center gap-1.5 rounded-xl bg-sky-500/15 px-3 py-2 text-xs font-medium text-sky-300 ring-1 ring-sky-400/30 group-hover:bg-sky-500/20 group-hover:ring-sky-300/50 transition" onClick={(e) => { directions('Wild%20Thyme') }}>
...
<div className="ml-3">
<button className="inline-flex items-center gap-1.5 rounded-xl bg-sky-500/15 px-3 py-2 text-xs font-medium text-sky-300 ring-1 ring-sky-400/30 group-hover:bg-sky-500/20 group-hover:ring-sky-300/50 transition" onClick={(e) => { directions('Fire%20Sign') }}>
<svg className="lucide lucide-navigation w-4 h-4" data-lucide="navigation" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polygon points="3 11 22 2 13 21 11 13 3 11"></polygon></svg>
                          Get Directions
                        </button>
</div>
...
<button className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-[11px] text-fuchsia-300 ring-1 ring-fuchsia-400/30 hover:bg-fuchsia-500/10 hover:ring-fuchsia-300/50 transition" onClick={(e) => { comingSoon('Matching at these spots is coming soon.') }}>
                    Match there
                  </button>
</div>
</div>

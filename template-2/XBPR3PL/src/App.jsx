...
<h1 className="md:text-3xl bg-clip-text text-xl font-semibold text-transparent tracking-tight font-inter bg-gradient-to-r from-white via-gray-200 to-gray-400 mb-1">Turbocharged by industry leaders.</h1>

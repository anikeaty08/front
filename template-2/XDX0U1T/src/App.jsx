...
<button className="px-4 py-2 rounded-full bg-teal-600 hover:bg-teal-500 text-white text-sm shadow-lg hover:shadow-xl glow-teal-intense button-hover cursor-pointer" onClick={(e) => { downloadPage() }}>
        Download HTML
      </button>
</div>
</header>
...
<div className="card-content">
<div className="relative h-72 bg-center bg-cover card-image-hover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1564866657314-0aabc2f9a5a0?auto=format&fit=crop&w=1200&q=80')`}}>
...
<div className="card-content">
<div className="relative h-72 bg-center bg-cover card-image-hover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1518779578993-56dfd8f0b3fb?auto=format&fit=crop&w=1200&q=80')`}}>
...
<div className="card-content">
<div className="relative h-72 bg-center bg-cover card-image-hover" style={{backgroundImage: `url('https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?auto=format&fit=crop&w=1200&q=80')`}}>

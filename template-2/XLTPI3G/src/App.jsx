...
<div className="fixed z-[60] pointer-events-none rounded-full" id="spotlight" style={{width: `220px`, height: `220px`, borderRadius: `9999px`, background: `white`, mixBlendMode: `difference`, opacity: `0`, transform: `translate(-50%, -50%)`, left: `157px`, top: `640px`}}></div>

<section className="relative pt-36 pb-20" id="hero">
<div className="mx-auto max-w-7xl px-6 lg:px-8">
<div className="text-center">
<div className="mb-8 flex justify-center">
<img alt="Jordan Chen" className="h-28 w-28 md:h-32 md:w-32 ring-4 ring-white/15 opacity-0 object-cover rounded-full shadow-2xl" data-anim="scale-in" data-delay="200" src="attachment://790407499.png" />
</div>
...
</span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`}}>П</span><span style={{display: `inline-block`}}>р</span><span style={{display: `inline-block`}}>о</span><span style={{display: `inline-block`}}>д</span><span style={{display: `inline-block`}}>у</span><span style={{display: `inline-block`}}>к</span><span style={{display: `inline-block`}}>т</span><span style={{display: `inline-block`}}>о</span><span style={{display: `inline-block`}}>в</span><span style={{display: `inline-block`}}>ы</span><span style={{display: `inline-block`}}>й</span><span style={{display: `inline-block`, marginRight: `0.5rem`}}> </span><span style={{display: `inline-block`}}>д</span><span style={{display: `inline-block`}}>и</span><span style={{display: `inline-block`}}>з</span><span style={{display: `inline-block`}}>а</span><span style={{display: `inline-block`}}>й</span><span style={{display: `inline-block`}}>н</span><span style={{display: `inline-block`}}>е</span><span style={{display: `inline-block`}}>р</span><span style={{display: `inline-block`}}>
...
<div className="scroll-reveal stagger-1 group sm:p-8 cursor-pointer transition-all duration-500 hover:scale-105 hover:bg-zinc-800/80 hover:shadow-xl revealed bg-zinc-900 border-zinc-800/70 border rounded-3xl mt-8 pt-6 pr-6 pb-6 pl-6 backdrop-blur">
...
<div className="scroll-reveal stagger-2 group sm:p-8 cursor-pointer transition-all duration-500 hover:scale-105 hover:bg-zinc-800/80 hover:shadow-xl revealed bg-zinc-900/80 border-zinc-800 border rounded-3xl mt-8 pt-6 pr-6 pb-6 pl-6 backdrop-blur">
<div className="sm:p-6 md:p-8 bg-white/5 border-white/10 border rounded-2xl pt-5 pr-5 pb-5 pl-5 transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20">
...
<div className="scroll-reveal stagger-3 group sm:p-8 cursor-pointer transition-all duration-500 hover:scale-105 hover:bg-zinc-800/80 hover:shadow-xl revealed bg-zinc-900/90 border-zinc-800 border rounded-3xl mt-8 pt-6 pr-6 pb-6 pl-6 backdrop-blur-md">
<div className="sm:p-6 md:p-8 bg-white/5 border-white/10 border rounded-2xl pt-5 pr-5 pb-5 pl-5 transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20">
...
<div className="mt-4 min-h-[160px] font-mono text-sm leading-relaxed text-gray-300" id="codeContainer"><div className="" style={{whiteSpace: `pre`, fontFamily: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace`, lineHeight: `1.6`, fontSize: `0.9rem`, borderRight: `none`, opacity: `1`}}><span style={{color: `#60A5FA`}}>// Дизайн‑система</span></div><div className="" style={{whiteSpace: `pre`, fontFamily: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace`, lineHeight: `1.6`, fontSize: `0.9rem`, borderRight: `none`, opacity: `1`}}><span style={{color: `#60A5FA`}}>const</span> <span style={{color: `#FBBF24`}}>components</span> = <span style={{color: `#E5E7EB`}}>{"{"}</span></div><div style={{whiteSpace: `pre`, fontFamily: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace`, lineHeight: `1.6`, fontSize: `0.9rem`, borderRight: `2px solid rgb(16, 185, 129)`, opacity: `1`}}></div></div>
</div>
<div className="border-white/10 border rounded-2xl pt-6 pr-6 pb-6 pl-6 backdrop-blur-lg">
...
<img alt="Интерактивный прототип amoCRM" className="w-full h-[360px] md:h-[420px] opacity-0 object-cover" data-anim="blur-in" data-delay="150" src="attachment://image.png" />
</div>
</div>

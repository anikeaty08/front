...
<svg className="sparkle" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<span className="text">Generate Design</span>
</button>
<div className="bodydrop"></div>
<span aria-hidden="true" className="particle-pen">
<svg className="particle" fill="none" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">

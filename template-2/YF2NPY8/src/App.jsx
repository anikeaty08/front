...
<button className="inline-block px-6 py-3 rounded-full bg-accent-500 text-surface-900 font-semibold text-base hover:bg-accent-600 transition" onClick={(e) => { alert('Getting Started...') }}>
              Get Started
            </button>
<button className="inline-block px-6 py-3 rounded-full border border-gray-700 text-gray-200 font-semibold text-base hover:bg-surface-800 transition" onClick={(e) => { alert('Demo Coming Soon!') }}>
              View Demo
            </button>
</div>

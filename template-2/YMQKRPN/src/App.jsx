...
<div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-40 opacity-0 pointer-events-none transition-opacity lg:hidden" id="overlay"></div>
...
<button aria-label="Menu" className="lg:hidden hover:text-indigo-400 transition" id="burger">

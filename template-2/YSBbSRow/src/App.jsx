...
<div className="feature-card bg-gray-50 p-6 rounded-xl border border-gray-200">
<div className="w-12 h-12 bg-gradient-to-br from-indigo-100 to-purple-200 rounded-lg flex items-center justify-center mb-4">
...
<a className="text-indigo-600 font-medium hover:text-indigo-800" href="#">Learn more →</a>
</div>

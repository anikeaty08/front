...
document.addEventListener('DOMContentLoaded', function() {
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: `url("/assets/c956db0f-553e-416a-999b-48f537a5aff1_3840w.jpg")`}}></div>
...
<img alt="Yoga practice" className="w-full h-full object-cover rounded-xl border border-slate-700/50" src="/assets/0f32d1c8-d81d-460c-ab87-59281e62b82a_1600w.jpg" />
...
</section><meta charset="utf-8" /><meta content="width=device-width, initial-scale=1.0" name="viewport" /><title>FAQ Section</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet" /><section className="mt-20 border-t border-slate-700/50 pt-16">
...
<section className="bg-[url(/assets/f34fe4a1-55ad-41cc-b1ca-566cffdbf729_1600w.jpg)] bg-cover border-cyan-500/20 rounded-2xl mt-20 shadow-lg backdrop-blur-sm" style={{}}>

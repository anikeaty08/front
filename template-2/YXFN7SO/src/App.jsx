...
<button className="text-xs px-2 py-1 rounded-md border border-orange-500/30 bg-orange-500/10 text-orange-400 hover:bg-orange-500/15 hover:border-orange-500/40 transition inline-flex items-center gap-1">
<i data-lucide="check-in"></i>Check
                </button>
</div>
</div>
...
<div className="-r border-white/[0.04]"></div><div className="border-r border-white/[0.04]"></div><div border-white=""></div></div>
<div border-white=""></div></div><div className="border-r border-white/[0.04]"></div><div className="border-r border-white/[0.04]"></div>
...
<path fill="none" stroke="white" strokeOpacity="0.15" strokeWidth="2" svg="">
</path></svg></div>

<div className="absolute left-[20%]-[40%]">
<span bg-orange-500="" border="" border-orange-300="" className="absolute -inset-2 rounded-full bg-orange-500/20 animate-pingspan> <span class=" relative="" rounded-full=""></span>
</div>
<div className="absolute left-[62%] top-[55%]">
<span bg-emerald-400="" border="" border-emerald-300="" className="absolute -inset-2 rounded-full bg-emerald-400/20 animate-pingspan> <span class=" relative="" rounded-full=""></span>
</div>
...
<input bg-white="" border="" border-white="" focus:border-orange-="" focus:ring-1="" focus:ring-orange-500="" outline-none="" px-3="" py-2="" rounded-md="" text-sm="" />
<div bg-white="" border="" border-white="" className="space-y-1 max-h-[420px] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 <button class=" flex="" hover:bg-white="" items-center="" rounded-md="" text-left="" text-sm="" transition="">
...
<img ring="" ring-1="" rounded-full="" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=64&h=64&fit=crop" />
<span>M</span>
</button>
</div>
...
<form className="flex-1 bg-white/[003] border border-white/10 rounded-md px-3 py-2 text-sm-none focus:border-orange-500/40 focus:ring-1 focus:ring-orange-500/30" id="chatForm" placeholder="Type a message..."></form>
...
<img className="h-7 w-7 rounded-full ring-1 ring-white/10" src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?q=80&w=64&h=64&fit=crop" />
<img className="h-7 w-7 rounded-full ring-1 ring-white/10" />
...
<img className="h-7 w7 rounded-full ring-1 ring-white/10" />
...
<button className="text-xs px-2-1 rounded-md border border-white/10 hover:border-white/20 bg-white/[0.03] hover:bg-white/[0.06]">View</button>
 {"<"} class="text-xs px-2 py-1 rounded-md border border-white/10 hover:border-white/20 bg/[0.03] hover:bg-white/[0.06] transition"{">"}Invite
</div></div>
</div>
</div>
</div>
...
<thead tracking-wider="" uppercase="">

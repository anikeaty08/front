...
<template id="bloodCell"><div className="flex flex-col items-center justify-center bg-white/80 rounded-full shadow-md px-8 py-7 mb-3 w-[126px] h-[126px]"><div className="mb-1 text-[20px] font-medium"></div><div className="text-[13px]"></div></div></template>

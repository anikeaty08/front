...
<path clip-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" fillRule="evenodd"></path>
</svg>
                            +12.8%
                        </span>
</div>
...
<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
<path clip-rule="evenodd" d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z" fillRule="evenodd"></path>
</svg>
</div>
...
<button className="text-gray-500 text-sm font-normal py-2 px-5 rounded-full hover:bg-white transition" onClick={(e) => { switchTab('performance') }}>Performance</button>
<button className="bg-white text-gray-900 font-semibold text-sm py-2 px-5 rounded-full shadow transition" id="assetTab" onClick={(e) => { switchTab('allocation') }}>Asset Allocation</button>
</nav>

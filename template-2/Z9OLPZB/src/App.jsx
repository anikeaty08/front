...
<svg className="lucide lucide-grip w-5 h-5" data-lucide="grip" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="5"></circle><circle cx="19" cy="5"></circle><circle cx="5" cy="5"></circle><circle cx="12" cy="12"></circle><circle cx="19" cy="12"></circle><circle cx="5" cy="12"></circle><circle cx="12" cy="19"></circle><circle cx="19" cy="19"></circle><circle cx="5" cy="19"></circle></svg>
</button>
...
<svg className="lucide lucide-moon w-5 h-5" data-lucide="moon" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
...
<svg className="lucide lucide-chevron-down w-4 h-4" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</button>
</div>
</div>
</div>
...
<svg className="lucide lucide-settings w-4 h-4 mr-1.5 inline" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="12" cy="12"></circle></svg>
                  Preferences
                </button>
...
<svg className="lucide lucide-play w-4 h-4 mr-2 inline" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                  Start Session
                </button>
</div>
</div>
...
<div className="hidden md:flex items-center gap-2">
<button className="px-3 py-2 rounded-lg text-sm font-medium border border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/20">
<svg className="lucide lucide-filter w-4 h-4 mr-1.5 inline" data-lucide="filter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
                      Filter
                    </button>
<button className="px-3 py-2 rounded-lg text-sm font-medium border border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/20">
<svg className="lucide lucide-sort-desc w-4 h-4 mr-1.5 inline" data-lucide="sort-desc" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
                      Sort
                    </button>
</div>
</div>
...
<svg className="lucide lucide-cloud w-4 h-4" data-lucide="cloud" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
<span>Cloud</span>
</div>
...
<div className="text-right">
<div className="flex items-center justify-end gap-1 text-xs text-[#5F6368] dark:text-[#AEB3B9]">
<svg className="lucide lucide-hard-drive w-4 h-4" data-lucide="hard-drive" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><line></line><path></path><line></line><line></line></svg>
<span>Local</span>
</div>
...
<svg className="lucide lucide-user-plus w-5 h-5" data-lucide="user-plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="9" cy="7"></circle><line></line><line></line></svg>
</div>
<div>
...
<div className="hidden md:flex items-center gap-2">
<button className="px-3 py-2 rounded-lg text-sm font-medium border border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/20">
<svg className="lucide lucide-file-text w-4 h-4 mr-1.5 inline" data-lucide="file-text" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path></svg>
                  Import
                </button>
</div>
</div>
...
<svg className="lucide lucide-upload w-4 h-4 mr-1.5 inline" data-lucide="upload" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                        Choose File
                      </button>
</div>
...
<svg className="lucide lucide-search w-4 h-4 mr-2 inline" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="11" cy="11"></circle></svg>
                      Research Expert
                    </button>
...
<svg className="lucide lucide-check w-3.5 h-3.5 text-white" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
...
<svg className="lucide lucide-external-link w-4 h-4 text-[#5F6368] dark:text-[#AEB3B9]" data-lucide="external-link" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
</label>
<label className="flex items-start gap-3 p-3 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer">
<input aria-label="Select source" className="peer sr-only" type="checkbox" />
<div className="h-5 w-5 rounded-md border border-black/20 dark:border-white/30 flex items-center justify-center peer-checked:bg-[#3A7DFF] peer-checked:border-[#3A7DFF]">
...
<svg className="lucide lucide-headphones w-4 h-4 text-[#5F6368] dark:text-[#AEB3B9]" data-lucide="headphones" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</label>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="h-10 w-10 rounded-lg bg-[#3A7DFF]/10 text-[#3A7DFF] flex items-center justify-center">
<svg className="lucide lucide-bot w-5 h-5" data-lucide="bot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><rect height="12" rx="2" width="16"></rect><path></path><path></path><path></path><path></path></svg>
</div>
<div>
...
<div className="flex items-center gap-2 text-sm"><svg className="lucide lucide-cloud w-4 h-4" data-lucide="cloud" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg> Cloud</div>
</div>
<div className="rounded-lg border border-black/5 dark:border-white/10 p-3">
...
<div className="flex items-center gap-2 text-sm"><svg className="lucide lucide-mic w-4 h-4" data-lucide="mic" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="13" rx="3" width="6"></rect></svg> Voice</div>
</div>
...
<svg className="lucide lucide-dot w-5 h-5 text-[#4CAF50]" data-lucide="dot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12.1" cy="12.1"></circle></svg> Connected
                </span>
</div>
...
<svg className="lucide lucide-columns-2 w-4 h-4 mr-1.5 inline" data-lucide="columns-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" width="18"></rect><path></path></svg>
                  Split-View
                </button>
...
<svg className="lucide lucide-square w-4 h-4 mr-1.5 inline" data-lucide="square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" width="18"></rect></svg>
                  End Session
                </button>
</div>
</div>
...
<svg className="lucide lucide-repeat-2 w-4 h-4 mr-1 inline" data-lucide="repeat-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path></svg> Swap
              </button>
</div>
...
<svg className="lucide lucide-mic w-5 h-5" data-lucide="mic" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><rect height="13" rx="3" width="6"></rect></svg>
...
<svg className="lucide lucide-users w-4 h-4 mr-1.5 inline" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><circle cx="9" cy="7"></circle></svg>
                  Swap Persona
                </button>
</div>
<div className="flex items-center gap-2">
...
<svg className="lucide lucide-check w-5 h-5" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg>
</div>
<div>
...
<svg className="lucide lucide-file w-4 h-4 mr-1.5 inline" data-lucide="file" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path></svg>
                      Export TXT
                    </button>
</div>
</div>
...
<svg className="lucide lucide-circle-check w-4 h-4 text-[#4CAF50] mt-0.5" data-lucide="circle-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12"></circle><path></path></svg>
<div className="text-sm">
...
<svg className="lucide lucide-download w-4 h-4 mr-1.5 inline" data-lucide="download" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path></svg>
                        Export Snippets
                      </button>
</div>
</div>
...
<div className="hidden md:flex items-center gap-2">
<div className="relative">
<input bg-white="" border="" border-black="" dark:border-white="" focus:outline-none="" focus:ring-2="" placeholder="Search sessions..." pr-3="" py-2="" rounded-lg="" text-sm="" type="text" />
...
<svg className="lucide lucide-play w-4 h-4 mr-1 inline" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path></path></svg> Resume
                  </button>
</div>
</article>
<article className="rounded-xl bg-white dark:bg-[#2A2E35] border border-black/5 dark:border-white/10 p-4 hover:shadow-sm transition">

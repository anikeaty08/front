...
<ul>
<li>
<button className="w-full text-left flex items-center px-6 py-3 rounded-r-full font-medium">
...
<li>
<button className="w-full text-left flex items-center px-6 py-3 rounded-r-full font-medium mt-2">
<svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
<rect height="13" rx="2" width="18"></rect>
<path></path>
</svg>
                Templates
              </button>
...
<button className="bg-white border border-blue-600 text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 flex items-center">
<svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
<path></path>
</svg>
              New Template
...
<button className="flex flex-col items-center justify-center p-5 bg-green-50 hover:bg-green-100 rounded-lg shadow">
...
<button className="flex flex-col items-center justify-center p-5 bg-yellow-50 hover:bg-yellow-100 rounded-lg shadow">
...
<template x-for="(field, idx) in templateForm.fields"><div className="flex flex-col md:flex-row md:items-center md:space-x-2 space-y-2 md:space-y-0 bg-gray-50 rounded-lg p-3"><div className="flex-1 flex items-center space-x-2"><input className="w-32 border rounded-lg px-2 py-1" placeholder="Field Name" type="text" x-model="field.name" /><select className="w-28 border rounded-lg px-2 py-1" x-model="field.type"><option value="text"></option><option value="date"></option><option value="number"></option></select><input className="w-32 border rounded-lg px-2 py-1" placeholder="Regex/Pattern (optional)" type="text" x-model="field.regex" /></div><div className="flex items-center space-x-1 mt-2 md:mt-0"><button className="text-gray-400 hover:text-blue-500 disabled:opacity-40" type="button"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path></path></svg></button><button className="text-gray-400 hover:text-blue-500 disabled:opacity-40" type="button"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path></path></svg></button><button className="text-red-400 hover:text-red-600 ml-2" type="button"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path></path></svg></button></div></div></template>
</div>
<button className="mt-3 text-blue-600 hover:underline text-sm font-medium flex items-center" type="button">
<svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
<path></path>
</svg>
                Add Field
...
<button className="px-5 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300 font-semibold" type="button">Cancel</button>
<button className="mt-3 md:mt-0 px-5 py-2 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700" type="button">Save Template</button>
</div>
</form>
</div>
...
<template x-for="field in templateForm.fields"><li className="pl-2 text-sm text-gray-700"><span className="font-medium" x-text="field.name || 'Field'"></span><span className="text-gray-400"></span><span className="italic text-gray-500" x-text="field.type"></span><template x-if="field.regex"><span className="text-xs text-blue-600 ml-1"><span x-text="field.regex"></span></span></template><span className="text-gray-400"></span></li></template>
<template x-if="!templateForm.fields.length"><li className="text-gray-400 italic"></li></template>
</ul>
</div>
</div>
</div>

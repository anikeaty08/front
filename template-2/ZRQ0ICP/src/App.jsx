...
<svg className="w-[16px] h-[16px]" data-lucide="plus" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `16px`, height: `16px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path></path><circle cx="14" cy="15"></circle></svg>
        New Project
      </button>
</div>
</div>
...
<svg className="w-[24px] h-[24px]" data-lucide="folder" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `24px`, height: `24px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className=""></path></svg>
</div>
</div>
...
<div className="flex h-12 w-12 bg-gray-50/10 rounded-full items-center justify-center">
<svg className="w-[24px] h-[24px]" data-lucide="image" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `24px`, height: `24px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect className="" height="18" rx="2" ry="2" width="18"></rect><circle cx="9" cy="9"></circle><path></path></svg>
</div>
</div>
...
<div className="flex h-12 w-12 bg-gray-50/10 rounded-full items-center justify-center">
<svg className="w-[24px] h-[24px]" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `24px`, height: `24px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20"></rect><line></line></svg>
</div>
</div>
<div className="mt-4 flex items-center gap-2">
...
<div className="flex h-12 w-12 bg-gray-50/10 rounded-full items-center justify-center">
<svg className="w-[24px] h-[24px]" data-lucide="hard-drive" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `24px`, height: `24px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect className="" height="5" rx="1" width="20"></rect><path className=""></path><path></path><path className=""></path><path className=""></path></svg>
</div>
</div>
<div className="mt-4 flex items-center gap-2">
...
<svg className="w-[20px] h-[20px]" data-lucide="wand-2" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><path></path><path></path><path></path><path></path><path></path><path></path><path></path></svg>
</div>
<div className="">
...
<svg className="w-[20px] h-[20px]" data-lucide="upload" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: `20px`, height: `20px`, color: `rgb(255, 255, 255)`}} viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path></path><polyline points="17 8 12 3 7 8"></polyline><line></line></svg>
</div>
<div className="">

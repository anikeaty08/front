...
<button className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg btn-primary transition-colors duration-200" onClick={(e) => { deleteSelected() }}>
<i className="w-4 h-4 mr-2" data-lucide="trash-2"></i>
                            削除
                        </button>
<button className="inline-flex items-center px-3 py-2 rounded-lg btn-secondary transition-colors duration-200" onClick={(e) => { clearSelection() }}>
...
<input className="checkbox-custom" id="selectAll" onChange={(e) => { toggleSelectAll() }} type="checkbox" />
<h3 className="text-lg font-medium" style={{color: `#212121`}}>プロジェクト一覧</h3>
</div>
<div className="flex items-center space-x-2">
<button className="p-2 rounded-lg transition-colors duration-200" onMouseOut={(e) => { e.currentTarget.style.color='#81819E'; e.currentTarget.style.backgroundColor='transparent' }} onMouseOver={(e) => { e.currentTarget.style.color='#4862a6'; e.currentTarget.style.backgroundColor='#f8fbfe' }} style={{color: `#81819E`}}>

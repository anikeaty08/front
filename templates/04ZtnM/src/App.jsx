...
<div className="w-20 h-6 bg-[#6E56CF]/30 rounded-md"></div>
</div>
<div className="mt-3 flex space-x-1">
<div className="w-8 h-8 rounded border border-[#333] flex items-center justify-center">
<div className="w-4 h-4 bg-[#6E56CF]/70 rounded-sm"></div>
</div>
<div className="w-8 h-8 rounded border border-[#333] flex items-center justify-center">
<div className="w-4 h-1 bg-[#6E56CF]/70 rounded-sm"></div>
</div>
<div className="w-8 h-8 rounded border border-[#333] flex items-center justify-center">
<div className="w-3 h-3 bg-transparent border border-[#6E56CF]/70 rounded-full"></div>
</div>
</div>
</div>
</div>
...
<p className="text-gray-400 mb-3 text-xs leading-relaxed">
            Create and maintain consistent designs with a comprehensive design system. Manage colors, typography, components, and styles across your entire team's workflow.
          </p>
...
<p className="text-gray-400 mb-3 text-xs leading-relaxed">
            Transform static designs into interactive prototypes. Test user flows and animations before development begins.
          </p>
<div className="flex text-[10px] gap-1 mt-auto">
...
<p className="text-gray-400 mb-3 text-xs leading-relaxed">
            Track design changes with full version history. Compare versions and restore previous iterations when needed.
          </p>
<div className="flex text-[10px] gap-1 mt-auto">

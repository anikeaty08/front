...
<div className="absolute inset-0 animate-spin" data-hover-3d="true" id="aura-emek8imdu" onmouseenter="this.style.transform = 'scale(1.1) rotateY(5deg) rotateX(-2deg)'" onmouseleave="this.style.transform = 'scale(1) rotateY(0deg) rotateX(0deg)'" onmousemove="handleHover3D(event, this)" style={{animationDuration: '25s', transform: 'scale(1) rotateY(0deg) rotateX(0deg)', transition: 'transform 0.1s ease-out'}}>

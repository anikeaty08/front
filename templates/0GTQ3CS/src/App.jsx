...
<img alt="Team collaboration" className="w-full h-full object-cover rounded-xl" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dbbf1869-f6fb-45ad-af6f-bde5244ee6df_1600w.jpg"/>
</div>
</div>
...
</section><section className="max-w-7xl lg:px-8 bg-teal-900 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e8c8bc93-9fa2-4ae8-9066-52376ec84807_1600w.jpg)] bg-cover rounded-2xl mt-20 mr-auto ml-auto pr-6 pl-6 shadow-lg">

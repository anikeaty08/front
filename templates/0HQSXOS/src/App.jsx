...
document.addEventListener('DOMContentLoaded', function() {
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d08ced8-659d-4f74-bc99-21ceb0980b53_3840w.jpg")'}}></div>
...
<style>
      /* Enhanced slider styling for better base appearance and thumb centering */
      input[type="range"] {

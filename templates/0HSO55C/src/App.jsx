...
<i className="absolute top-2 right-2 h-5 w-5 text-emerald-600 opacity-0 group-[.active]:opacity-100 transition" data-lucide="check-circle-2"></i>
</button>
...
<span className="underline decoration-dotted cursor-pointer" id="checkoutLink">Checkout link pending…</span>
</div>
</div>
...
<div className="hidden space-y-3" id="thankyouPreview"></div></div></div></div></div></div></div></section></div></main></div>
    </>
  );
}

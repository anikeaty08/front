...
<line opacity="0.5" stroke="#2563eb" stroke-dasharray="7 3" strokeWidth="1" x1="100" x2="100" y1="6" y2="194"></line>
<line opacity="0.5" stroke="#2563eb" stroke-dasharray="7 3" strokeWidth="1" x1="6" x2="194" y1="100" y2="100"></line>
</svg>
...
<line opacity="0.5" stroke="#34d399" stroke-dasharray="7 3" strokeWidth="1" x1="100" x2="100" y1="6" y2="194"></line>
<line opacity="0.5" stroke="#34d399" stroke-dasharray="7 3" strokeWidth="1" x1="6" x2="194" y1="100" y2="100"></line>
</svg>
<div className="absolute inset-0 flex flex-col justify-between pointer-events-none select-none">
<div className="flex justify-between items-start px-5 pt-4 text-[1.05rem] text-neutral-800">
<div>
...
<line opacity="0.5" stroke="#d946ef" stroke-dasharray="7 3" strokeWidth="1" x1="100" x2="100" y1="6" y2="194"></line>
<line opacity="0.5" stroke="#d946ef" stroke-dasharray="7 3" strokeWidth="1" x1="6" x2="194" y1="100" y2="100"></line>
</svg>
<div className="absolute inset-0 flex flex-col justify-between pointer-events-none select-none">
<div className="flex justify-between items-start px-5 pt-4 text-[1.05rem] text-neutral-800">
<div>

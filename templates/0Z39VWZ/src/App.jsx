...
<img alt="Nike Air Max 270" className="w-full h-full object-cover product-zoom" id="mainProductImage" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a0334f32-8e67-444f-bb8c-ef1ebc4a3a8f_1600w.jpg"/>
</div>
...
<button className="inline-flex items-center gap-2 text-sm font-medium hover:text-white/90 transition-all duration-300 hover:scale-105 font-sans" onclick="window.scrollTo({ top: 0, behavior: 'smooth' })">

...
<svg className="lucide lucide-info w-[16px] h-[16px] cursor-pointer text-slate-500" data-icon-replaced="true" data-lucide="info" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" style={{width: '16px', height: '16px', color: 'rgb(100, 116, 139)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
...
<svg className="lucide lucide-info w-[16px] h-[16px] cursor-pointer text-slate-500" data-lucide="" fill="none" height="16" stroke="currentColor" stroke-line="round" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>

...
<button className="flex items-center justify-center gap-2 bg-slate-700 text-white text-sm font-semibold py-3 rounded-xl shadow-lg hover:bg-slate-800 transition-all duration-200 transform hover:scale-105" onclick="sharePass()">
<i className="w-4 h-4" data-lucide="share-2"></i>
          Share
        </button>
<button className="flex items-center justify-center gap-2 bg-primary text-white text-sm font-semibold py-3 rounded-xl shadow-lg hover:bg-blue-700 transition-all duration-200 transform hover:scale-105" onclick="downloadPass()">

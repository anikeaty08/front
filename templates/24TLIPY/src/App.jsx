...
<button className="inline-flex items-center gap-2 rounded-full border border-slate-300/70 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-white/60 backdrop-blur-sm">
<i className="h-4 w-4" data-lucide="phone"></i>
              Contact
            </button>
<button className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">
<i className="h-4 w-4" data-lucide="sparkles"></i>
              Get a Quote
            </button>
<button className="md:hidden inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-300/70" id="menuBtn">
...
<a className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:from-cyan-600 hover:to-indigo-700" href="#">
<i className="h-4 w-4" data-lucide="solar-panel"></i>
                  Explore Solutions
                </a>
<a className="inline-flex items-center gap-2 rounded-full border border-slate-300/80 bg-white px-5 py-2.5 text-sm font-medium text-slate-800 hover:bg-slate-50" href="#">
...
<button className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800" type="submit">
...
<img alt="Solar on modern home" className="h-44 w-full rounded-xl object-cover" src="https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<div className="mt-3">
<p className="text-sm font-medium text-slate-900">Empowering Homes</p>
<p className="mt-1 text-xs text-slate-600">High-efficiency rooftop systems</p>
</div>
</div>
<div className="rounded-2xl border border-slate-200 bg-white/80 p-3 backdrop-blur">
<img alt="Commercial solar array" className="h-44 w-full rounded-xl object-cover" src="https://images.unsplash.com/photo-1509395062183-67c5ad6faff9?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<div className="mt-3">
<p className="text-sm font-medium text-slate-900">Business at Scale</p>
<p className="mt-1 text-xs text-slate-600">Smart monitoring &amp; storage</p>
</div>
</div>
<div className="col-span-2 rounded-2xl border border-slate-200 bg-gradient-to-r from-cyan-50 to-indigo-50 p-4">
<div className="flex items-center gap-3">
<span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white shadow-sm ring-1 ring-slate-200">
<i className="h-5 w-5 text-cyan-600" data-lucide="line-chart"></i>
</span>
<div>
<p className="text-sm font-medium text-slate-900">Save up to 30% on bills</p>
<p className="text-xs text-slate-600">With optimized production curves</p>
</div>
</div>
</div>
</div>
...
<div className="mt-3 flex items-center justify-between text-xs-slate-600">
<span className="inline-flex items-center gap-1">
<i ="h-4="" data-lucide="sun" text-cyan-600"="" w-4=""></i>
                    Tier-1 panels
                  </span>
<span className="inline-flex items-center gap-1">
...
<section className="mt-16 overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-r from-indigo-600 to-cyan-500 p-6 sm:p-8">
...
<div className="lg:col-span-2 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
...
<button className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-800">
<i className="h-4 w-4" data-lucide="send"></i>
                  Send message
                </button>
</div>
...
<a className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50" href="#">

...
<svg className="w-4 h-4 mr-1" fill="currentColor" viewbox="0 0 20 20"><path clip-rule="evenodd" d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z" fill-rule="evenodd"></path></svg>
              12% from last month
            </span>
</div>
</div>
...
<button className="text-blue-600 hover:text-blue-700 font-medium" onclick="showPage('tasks')">View All</button>
</div>
</div>
<div className="p-6">
...
<button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition" onclick="showPage('new-audit')">New Audit</button>

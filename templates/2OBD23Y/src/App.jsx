...
<label className="group relative overflow-hidden rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-xl p-6 md:p-8 cursor-pointer transition hover:bg-emerald-50/10" id="drop-ref" ondragleave="handleDragLeave(event)" ondragover="handleDrag(event)" ondrop="handleDrop(event,'reference')" onmouseleave="resetTilt(event)" onmousemove="tilt3D(event)" style={{transformStyle: 'preserve-3d', perspective: '1000px'}}>
<input accept="audio/*" className="hidden" id="file-ref" onchange="handleFile(this.files[0],'reference')" type="file"/>
...
<circle cx="36" cy="36" fill="none" id="arc-ref" r="30" stroke="#14F2C7" stroke-dasharray="188.5" stroke-dashoffset="188.5" strokeLinecap="round" strokeWidth="6" style={{filter: 'drop-shadow(0 0 6px rgba(20,242,199,0.6))', transition: 'stroke-dashoffset .35s ease'}}></circle>
</svg>
...
<label className="group relative overflow-hidden rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-xl p-6 md:p-8 cursor-pointer transition hover:bg-emerald-50/10" id="drop-vocal" ondragleave="handleDragLeave(event)" ondragover="handleDrag(event)" ondrop="handleDrop(event,'vocal')" onmouseleave="resetTilt(event)" onmousemove="tilt3D(event)" style={{transformStyle: 'preserve-3d', perspective: '1000px'}}>
<input accept="audio/*" className="hidden" id="file-vocal" onchange="handleFile(this.files[0],'vocal')" type="file"/>
...
<svg className="block" height="72" viewbox="0 0 72 72" width="72">
<circle cx="36" cy="36" fill="none" r="30" stroke="rgb(30,41,59)" strokeWidth="6"></circle>
<circle cx="36" cy="36" fill="none" id="arc-vocal" r="30" stroke="#14F2C7" stroke-dasharray="188.5" stroke-dashoffset="188.5" strokeLinecap="round" strokeWidth="6" style={{filter: 'drop-shadow(0 0 6px rgba(20,242,199,0.6))', transition: 'stroke-dashoffset .35s ease'}}></circle>
</svg>
<div className="absolute inset-0 flex items-center justify-center">
<div className="h-10 w-10 rounded-xl bg-white/5 ring-1 ring-white/10 flex items-center justify-center">

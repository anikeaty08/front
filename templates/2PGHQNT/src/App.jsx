...
<button className="px-4 py-2 rounded-lg bg-gray-100 text-gray-700 font-semibold" onclick="document.getElementById('promoModal').classList.add('hidden')">Cancel</button>

...
<a className="inline-flex items-center gap-1 hover:text-[#0A6EE7] transition" href="https://aura.build/share/8U0E828" id="aura-emf56a1jr">
...
<span className="inline-flex items-center gap-1 ring-1 ring-gray-200 bg-gray-100 rounded-lg pt-1 pr-2 pb-1 pl-2">
<svg className="lucide lucide-line-chart w-3.5 h-3.5" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg> Y ~ 3.20%
                  </span>
...
<div className="mt-3 flex-center gap-2 text-xs text-gray-600">
<span className="inline-flex items-center gap-1 ring-1 ring-gray-200 bg-gray-100 rounded-lg pt-1 pr-2 pb-1 pl-2">
<svg className="lucide lucide-badge-dollar-sign w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"></path><path d="M12 18V6"></path></svg> USD
                  </span>
<span className="inline-flex items-center gap-1 ring-1 ring-gray-200 bg-gray-100 rounded-lg pt-1 pr-2 pb-1 pl-2">
<svg className="lucide lucide-line-chart w-3.5 h3.5" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg> Y ~ 3.00%
                  </span>
<span className="inline-flex items-center gap-1 rounded-lg bg-gray-100 px-2 py-1 ring-1 ring-gray-200">
<svg className="lucide lucide-calendar w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg> 2028–2034
                  </span>
</div>
<div className="flex mt-3 items-center justify-center">
<button className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium text-gray-700 hover:text-[#0A6EE7] hover:bg-gray-100 ring-1 ring-gray-200 transition">

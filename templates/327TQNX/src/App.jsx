...
<section className="relative overflow-hidden bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/45c97fa5-e6c3-4724-9f9d-f101b6292bc0_3840w.jpg)] bg-cover">
...
<img alt="Pilot wearing FPV goggles" className="rounded-xl shadow-2xl ring-1 ring-neutral-800 object-cover w-full h-auto" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/92a6b77d-f9a6-4e04-9d1f-9e2f3929a5ee_1600w.jpg"/>
</div>
</div>
</section>

<section className="bg-neutral-900 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9dead2ce-9640-41bd-8153-af6e7acc42cf_3840w.jpg)] bg-cover pt-24 pb-24" id="why">
...
<img alt="Close-up of drone build" className="relative rounded-xl shadow-2xl ring-1 ring-neutral-800 object-cover w-full h-auto" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f28788b9-ed9e-41a8-a3f6-32cd68f7be06_1600w.jpg" style={{}}/>
</div>
</div>
</section>
...
<img alt="Drone build components" className="w-full h-40 object-cover rounded-lg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/737adeef-7802-4581-a30c-fe2a0ab34814_800w.jpg" style={{}}/>
</div>
...
<div className="bg-neutral-900 rounded-xl p-8 flex flex-col">
<div className="flex-shrink-0 mb-6">
<img alt="Aerial filming" className="w-full h-40 object-cover rounded-lg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/63f0a8e4-2348-4a21-ae0c-0dd3f83dafac_800w.jpg" style={{}}/>
</div>
...
<div className="bg-neutral-900 rounded-xl p-8 flex flex-col">
<div className="flex-shrink-0 mb-6">
<img alt="Freestyle tricks" className="w-full h-40 object-cover rounded-lg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b1c63d47-0d9d-4b44-9e0c-263cef27b106_800w.jpg"/>
</div>
...
<section className="bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/20f222af-e037-4dea-a697-2b93dc33d3f3_3840w.jpg)] bg-cover pt-20 pb-20">

...
new Chart(ctx,{type:'radar',
  ...
  options:{scales:{r:{angleLines:{color:'#e5e7eb'},
    grid:{color:'#e5e7eb'},ticks:{display:false},
    suggestedMin:0,suggestedMax:100}},plugins:{legend:{display:false}},responsive:true,maintainAspectRatio:false}
});
...
// Entrance animation
const observer=new IntersectionObserver(entries=>{entries.forEach(e=>{if(e.isIntersecting){e.target.classList.add('animate');observer.unobserve(e.target)}})},{threshold:.2});
...
<p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
        Data professional crafting machine-learning solutions and data pipelines for finance, fraud, and time-series challenges. Passionate about turning raw data into insights that drive decisions.
      </p>
...
<li><a className="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 rounded" href="https://linkedin.com/in/segevohana" rel="noopener noreferrer" target="_blank"><i className="h-4 w-4" data-lucide="linkedin"></i> LinkedIn</a></li>
<li><a className="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 rounded" href="https://github.com/segevstat/portfolio" rel="noopener noreferrer" target="_blank"><i className="h-4 w-4" data-lucide="github"></i> GitHub</a></li>
<li><a className="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 rounded" href="https://rpubs.com/Segev_ohana" rel="noopener noreferrer" target="_blank"><i className="h-4 w-4" data-lucide="folder-open"></i> Portfolio</a></li>
</ul>
</div>
...
<div className="w-full h-64 sm:h-56 relative">
<canvas aria-label="Radar chart of competencies" height="100" id="skillChart" role="img"></canvas>
</div>
</div>
</div>
</section>
...
<p className="text-sm text-gray-600 dark:text-gray-300 flex-1">
          Deep-learning linear regression model evaluating housing prices. Explores normalization pipelines, regularisation, and performance diagnostics.
        </p>
<a className="mt-4 inline-flex items-center gap-1 text-rose-600 dark:text-rose-400 text-sm font-medium hover:underline focus-visible:ring-2 focus-visible:ring-rose-500 rounded" href="https://github.com/segevstat/portfolio/blob/main/Models---ML-DL/DL_Linear_Regression_Model_Housing_portfolio.ipynb" rel="noopener noreferrer" target="_blank">
<i className="h-4 w-4" data-lucide="external-link"></i> Repository
        </a>
</div>
</article>
...
<div>
<div className="flex items-start justify-between flex-wrap gap-y-1"><h3 className="font-medium">Application Coordinator Analyst — TCS</h3><time className="text-sm text-gray-500 dark:text-gray-400">2018 – 2019</time></div>
<ul className="list-disc list-inside mt-2 space-y-1">

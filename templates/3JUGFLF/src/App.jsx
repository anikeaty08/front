...
<button className="p-2 rounded-full hover:bg-white/10 transition-colors duration-300" onclick="closeCart()">
...
<button className="px-6 py-3 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="closeCart()" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
            Continue Shopping
          </button>
</div>
...
<button className="w-full py-3 px-6 rounded-xl text-sm font-medium text-white/80 border border-white/20 hover:border-white/30 transition-all duration-300" onclick="closeCart()" style={{background: 'rgba(255, 255, 255, 0.05)'}}>
              Continue Shopping
            </button>
</div>
</div>
...
<button className="p-2 rounded-full hover:bg-white/10 transition-colors duration-300" onclick="closeCustomize()">
<i className="w-5 h-5 text-white/60" data-lucide="x"></i>
</button>
</div>
...
<input className="sr-only peer" name="size" onchange="updatePreview()" type="radio" value="small"/>
...
<label className="relative">
<input checked="" className="sr-only peer" name="size" onchange="updatePreview()" type="radio" value="medium"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative">
<input className="sr-only peer" name="size" onchange="updatePreview()" type="radio" value="large"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<input checked="" className="sr-only peer" name="base" onchange="updatePreview()" type="radio" value="dark"/>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="base" onchange="updatePreview()" type="radio" value="milk"/>
<div className="flex items-center w-full p-4 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="base" onchange="updatePreview()" type="radio" value="white"/>
<div className="flex items-center w-full p-4 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="base" onchange="updatePreview()" type="radio" value="ruby"/>
<div className="flex items-center w-full p-4 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="stardust"/>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="meteors"/>
<div className="flex items-center w-full p-3 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="nebula"/>
<div className="flex items-center w-full p-3 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="moondust"/>
<div className="flex items-center w-full p-3 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="plasma"/>
<div className="flex items-center w-full p-3 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative flex items-center">
<input className="sr-only peer" name="toppings" onchange="updatePreview()" type="checkbox" value="comet"/>
<div className="flex items-center w-full p-3 rounded-xl border border-amber-500/20 cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative">
<input checked="" className="sr-only peer" name="shape" onchange="updatePreview()" type="radio" value="sphere"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative">
<input className="sr-only peer" name="shape" onchange="updatePreview()" type="radio" value="star"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative">
<input className="sr-only peer" name="shape" onchange="updatePreview()" type="radio" value="galaxy"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<label className="relative">
<input className="sr-only peer" name="shape" onchange="updatePreview()" type="radio" value="rocket"/>
<div className="p-4 rounded-xl border border-amber-500/20 text-center cursor-pointer transition-all duration-300 peer-checked:border-amber-500/50 peer-checked:bg-amber-500/10 hover:border-amber-500/30" style={{background: 'rgba(245, 158, 11, 0.03)'}}>
...
<button className="w-10 h-10 rounded-xl border border-amber-500/20 flex items-center justify-center hover:border-amber-500/40 transition-colors duration-300" onclick="updateQuantity(-1)" style={{background: 'rgba(245, 158, 11, 0.05)'}}>
...
<button className="flex-1 py-4 px-6 rounded-xl text-sm font-medium text-white border border-amber-500/40 hover:border-amber-500/60 transition-all duration-300" onclick="addToCart()" style={{background: 'rgba(245, 158, 11, 0.2)'}}>
            Add to Cart
          </button>
<button className="flex-1 py-4 px-6 rounded-xl text-sm font-medium text-white/80 border border-white/20 hover:border-white/30 transition-all duration-300" onclick="closeCustomize()" style={{background: 'rgba(255, 255, 255, 0.05)'}}>
            Cancel
          </button>
</div>
</div>
...
<button aria-label="Cart" className="relative hover:bg-white/5 p-2 rounded-full transition-all duration-300 border border-white/5" onclick="openCart()" style={{background: 'rgba(255, 255, 255, 0.02)'}}>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Nebula Truffle')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Galaxy Sphere')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Comet Tail')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Meteor Crunch')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Plasma Crystal')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="px-4 py-2 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="openCustomize('Rocket Ship')" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
                  Customize
                </button>
</div>
</div>
...
<button className="inline-flex items-center justify-center px-8 py-4 rounded-xl text-sm font-medium text-white border border-amber-500/40 hover:border-amber-500/60 transition-all duration-300" onclick="openCustomize('Custom Space Chocolate')" style={{background: 'rgba(245, 158, 11, 0.2)'}}>
<i className="w-4 h-4 mr-2" data-lucide="settings"></i>
              Create Custom Space Chocolate
            </button>
<button className="inline-flex items-center justify-center px-6 py-4 rounded-xl text-sm font-medium text-white/80 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/5" onclick="addPresetToCart('Space Collection Gift Set', 89)" style={{background: 'rgba(255, 255, 255, 0.02)'}}>
...
<button className="w-full py-4 px-6 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="addPresetToCart('Stellar Selection', 89)" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
              Add to Cart
            </button>
</div>
...
<button className="w-full py-4 px-6 rounded-xl text-sm font-medium text-white border border-amber-500/40 hover:border-amber-500/60 transition-all duration-300" onclick="addPresetToCart('Galaxy Explorer', 179)" style={{background: 'rgba(245, 158, 11, 0.2)'}}>
              Add to Cart
            </button>
</div>
...
<button className="w-full py-4 px-6 rounded-xl text-sm font-medium text-white border border-amber-500/30 hover:border-amber-500/50 transition-all duration-300 hover:bg-amber-500/10" onclick="addPresetToCart('Universe Masterpiece', 399)" style={{background: 'rgba(245, 158, 11, 0.08)'}}>
              Reserve Now
            </button>
</div>
</div>
...
<div className="rounded-2xl border border-amber-500/20 overflow-hidden" style={{background: 'rgba(245, 158, 11, 0.05)'}}>
<button className="w-full px-8 py-6 text-left flex items-center justify-between hover:bg-amber-500/10 transition-all duration-300" onclick="toggleFaq(this)">

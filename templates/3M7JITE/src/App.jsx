...
<input className="w-full rounded-xl bg:white/90 bg-white/90 px-4 py-3 text-sm ring-1 ring-[#cfc3c3]/70 focus:outline-none focus:ring-2" placeholder="Your email" required="" style={{-TwRingColor: '#9ebac8'}} type="email"/>

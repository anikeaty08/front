...
<button className="ml-4 px-3 py-2 rounded-l-lg text-sm bg-blue-600 text-white font-semibold border border-blue-600 focus:outline-none" id="btn-card">Card</button>
<button className="px-3 py-2 rounded-r-lg text-sm bg-white text-gray-700 font-semibold border border-blue-600 focus:outline-none" id="btn-table">Table</button>
</div>
</div>

<div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-8" id="card-view">

<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">example.com</span>
...
<img alt="Auditor" className="w-6 h-6 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/32.jpg"/>
<span className="text-sm text-gray-700">Prince Reuben</span>
</div>
...
<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">mysite.org</span>
<span className="inline-block px-2 py-1 rounded text-xs bg-yellow-100 text-yellow-700 font-medium">Needs Improvement</span>
</div>
<div className="flex items-center justify-between mb-4">
<span className="text-3xl font-bold text-yellow-700">73</span>
<span className="text-xs text-gray-400">2024-06-12</span>
</div>
<div className="flex items-center mb-4">
<img alt="Auditor" className="w-6 h-6 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/32.jpg"/>
<span className="text-sm text-gray-700">Prince Reuben</span>
...
<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">demo.site</span>
<span className="inline-block px-2 py-1 rounded text-xs bg-red-100 text-red-700 font-medium">Failed</span>
</div>
<div className="flex items-center justify-between mb-4">
<span className="text-3xl font-bold text-red-700">58</span>
<span className="text-xs text-gray-400">2024-06-10</span>
</div>
<div className="flex items-center mb-4">
<img alt="Auditor" className="w-6 h-6 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/32.jpg"/>
<span className="text-sm text-gray-700">Prince Reuben</span>
...
<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">coolnew.com</span>
<span className="inline-block px-2 py-1 rounded text-xs bg-green-100 text-green-700 font-medium">Passed</span>
</div>
<div className="flex items-center justify-between mb-4">
<span className="text-3xl font-bold text-green-700">90</span>
<span className="text-xs text-gray-400">2024-06-08</span>
</div>
<div className="flex items-center mb-4">
<img alt="Auditor" className="w-6 h-6 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/32.jpg"/>
<span className="text-sm text-gray-700">Prince Reuben</span>
...
<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">webplus.io</span>
<span className="inline-block px-2 py-1 rounded text-xs bg-yellow-100 text-yellow-700 font-medium">Needs Improvement</span>
</div>
<div className="flex items-center justify-between mb-4">
<span className="text-3xl font-bold text-yellow-700">69</span>
<span className="text-xs text-gray-400">2024-06-05</span>
</div>
<div className="flex items-center mb-4">
<img alt="Auditor" className="w-6 h-6 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/32.jpg"/>
<span className="text-sm text-gray-700">Prince Reuben</span>
...
<div className="bg-white rounded-xl shadow p-6 flex flex-col">
<div className="flex items-center justify-between mb-3">
<span className="text-sm font-semibold text-gray-700">landingz.com</span>
<span className="inline-block px-2 py-1 rounded text-xs bg-green-100 text-green-700 font-medium">Passed</span>
</div>
<div className="flex items-center justify-between mb-4">
...
<div className="hidden bg-white rounded-lg shadow overflow-x-auto mb-8" id="table-view">
...
<img alt="Auditor" className="w-5 h-5 rounded-full" src="https://randomuser.me/api/portraits/men/32.jpg"/>
              Prince Reuben
            </td>

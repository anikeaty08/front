...
<button className="gradient-bg text-white px-5 py-2 rounded-full font-medium btn-hover hover:shadow-lg">Sign Up</button>
</div>
</header>
...
<h2 className="text-5xl font-bold leading-tight mb-6 heading animate-fade-in-up">
...
<button className="gradient-bg text-white px-6 py-3 rounded-full font-medium flex items-center btn-hover hover:shadow-lg">
                    Shop Now
...
<button className="bg-black text-white px-6 py-3 rounded-full font-medium flex items-center btn-hover hover:shadow-lg">
                    Sell Now
                    <svg className="h-5 w-5 ml-2" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
<path clip-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" fill-rule="evenodd"></path>
</svg>
...
<div className="bg-white rounded-xl shadow-lg p-8 relative overflow-hidden animate-fade-in-right delay-400 card-hover">
...
<button className="flex items-center text-black font-medium group btn-hover">
                        Accept
...
<div className="md:col-span-2 animate-fade-in-right delay-550">
<div className="bg-white rounded-xl shadow-lg p-8 h-full relative overflow-hidden card-hover">
...
<div className="gradient-bg w-72 h-44 rounded-xl p-6 text-white flex flex-col justify-between shadow-lg card-rotate">
...
<div className="bg-white rounded-xl shadow-lg p-8 relative overflow-hidden animate-fade-in-right delay-700 card-hover">
...
<div className="gradient-bg w-36 h-36 rounded-full flex items-center justify-center text-white shadow-lg card-rotate">
...
<div className="bg-white rounded-xl shadow-lg p-8 relative overflow-hidden animate-fade-in-right delay-850 card-hover">
...
<div className="w-48 h-48 relative card-rotate">
...
<div className="bg-white rounded-xl shadow-lg p-8 relative overflow-hidden animate-fade-in-right delay-900 card-hover">
<div className="absolute -bottom-10 -right-10 w-32 h-32 rounded-full gradient-bg opacity-10"></div>
<h3 className="text-xl font-bold mb-6 heading">Quick Stats</h3>
<div className="space-y-6">
<div className="flex items-center">
<div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mr-4 card-rotate">
...
<div className="flex items-center">
<div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center mr-4 card-rotate">
...
<div className="flex items-center">
<div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mr-4 card-rotate">

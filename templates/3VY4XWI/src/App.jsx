...
<button aria-pressed="false" className="group relative flex flex-col items-center justify-center rounded-xl bg-[#fff2e8] aspect-square gap-2 focus:outline-none focus:ring-2 focus:ring-orange-400" onclick="toggleTile(this)">
...
<button aria-label="Add new pet" className="flex flex-col items-center justify-center rounded-xl bg-[#fff2e8] aspect-square gap-2 hover:bg-[#ffe7d5] transition-colors" onclick="alert('Coming soon!')">
...
<button aria-expanded="false" aria-haspopup="listbox" className="w-full h-14 bg-[#fff2e8] rounded-xl px-4 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-orange-400" id="taskSelectBtn" onclick="toggleTaskDropdown()">
...
<li>
<button className="w-full px-4 py-3 flex items-center gap-3 focus:bg-orange-100 hover:bg-orange-50" data-value="Walk" onclick="selectTask(this)" role="option">
<svg className="lucide lucide-paw-print w-5 h-5 text-orange-500" data-lucide="paw-print" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="4" r="2"></circle><circle cx="18" cy="8" r="2"></circle><circle cx="20" cy="16" r="2"></circle><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.045Q6.52 17.48 4.46 16.84A3.5 3.5 0 0 1 5.5 10Z"></path></svg>
                Walk
              </button>
</li>
<li>
<button className="w-full px-4 py-3 flex items-center gap-3 focus:bg-orange-100 hover:bg-orange-50" data-value="Feed" onclick="selectTask(this)" role="option">
...
<li>
<button className="w-full px-4 py-3 flex items-center gap-3 focus:bg-orange-100 hover:bg-orange-50" data-value="Groom" onclick="selectTask(this)" role="option">
...
<li>
<button className="w-full px-4 py-3 flex items-center gap-3 focus:bg-orange-100 hover:bg-orange-50" data-value="Vet" onclick="selectTask(this)" role="option">
...
<button aria-pressed="false" className="relative w-12 h-6 rounded-full transition-colors bg-gray-300" id="remToggle" onclick="toggleReminder()">

...
<img alt="Portrait with bold red lighting" className="w-full h-[52vh] sm:h-[60vh] object-cover" loading="eager" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c00ff13b-bcc2-4ddd-a8bc-13bd3da53a81_1600w.jpg"/>
</div>
</div>
</div>
</section>
...
<img alt="Comera Latitude Travel and Tourism LLC Logo" className="transition-transform duration-500 group-hover:scale-[1.03] cursor-pointer w-full h-full object-contain pt-6 pr-6 pb-6 pl-6 absolute top-0 right-0 bottom-0 left-0" onclick="window.location.href='https://photos.google.com/photo/AF1QipPcXkkbB8UdF2vet7GuvP5Ww6yOJ9opBmzJkXui'" role="button" src="https://www.aura.build/editor/LOGOWE.png"/>
</div>
<div className="p-4">

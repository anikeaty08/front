...
<img alt="Portrait with bold red lighting" className="w-full h-[52vh] sm:h-[60vh] object-cover" loading="eager" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/25b2762f-2abb-4175-aec9-fc9ef6db44f3_1600w.png"/>
</div>
</div>
</div>
</section>
...
<img alt="3D abstract render" className="transition-transform duration-500 group-hover:scale-[1.03] w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c4e25fdd-1ad7-4b5d-8138-c0b5dbe0c9e2_800w.jpg"/>
</div>
<div className="p-4">
...
<article className="group rounded-xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<div className="relative aspect-[16/10]">
<img alt="Mountain landscape" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e0a39d5f-b50a-4023-af86-d6cd0cd2c5c6_800w.jpg"/>
</div>
<div className="p-4">
<div className="flex items-center gap-2 text-xs text-neutral-400">
...
<img alt="Portrait side profile with dramatic lighting" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c58ec9db-9b8f-4305-8008-7df305ccd944_3840w.png"/>
...
<img alt="Brand stationery set with bold colors" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b870108f-3551-40b3-bb97-ae4fc783d1df_320w.jpg"/>
</div>
<div className="aspect-[4/3] w-24 sm:w-28 rounded-md overflow-hidden ring-1 ring-white/10">
<img alt="Business cards and patterns" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d5175fe-2aa3-4ef3-8a6f-44a752f57930_320w.jpg"/>
</div>
<div className="aspect-[4/3] w-24 sm:w-28 rounded-md overflow-hidden ring-1 ring-white/10">

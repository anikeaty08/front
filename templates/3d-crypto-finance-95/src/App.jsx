...
<span className="font-mono text-xs font-medium tracking-tight text-indigo-300">
            DEPLOY_ENGINE_V2.9
          </span>
</div>
</header>
<div className="absolute -translate-y-1/2 left-6 md:left-10 max-w-lg animate-fade-in opacity-0 top-[40%] z-30" style={{animationDelay: '0.2s'}}>
<h1 className="font-display text-6xl md:text-8xl font-bold tracking-tight text-white leading-[0.9] drop-shadow-xl">
          Set Trillions
          <br/>
          to Work
        </h1>
</div>
<div className="absolute bottom-6 right-6 w-[240px] pointer-events-auto rounded-lg animate-fade-in opacity-0 flex flex-col shadow-xl shadow-neutral-200/50 font-mono bg-white border border-neutral-200 shadow-lg" style={{animationDelay: '0.4s'}}>
...
<input id="input-color" type="color" value="#818cf8"/>
</div>

...
<button className="group relative px-10 py-4 bg-white text-black rounded-full font-medium text-base overflow-hidden transition-all hover:scale-105 duration-300 ease-expo-out" onclick="document.getElementById('visualizer').scrollIntoView({behavior: 'smooth'})">
...
<button className="p-3 rounded-xl bg-white/10 border border-white/20 text-white text-xs font-medium hover:bg-white/20 transition-all text-center shadow-[0_0_15px_rgba(255,255,255,0.05)]" id="btn-cube" onclick="selectShape('cube')">
                  Cube
                </button>
<button className="p-3 rounded-xl bg-transparent border border-white/10 text-zinc-500 text-xs font-medium hover:bg-white/5 transition-all text-center" id="btn-cylinder" onclick="selectShape('cylinder')">
                  Cylinder
                </button>
<button className="p-3 rounded-xl bg-transparent border border-white/10 text-zinc-500 text-xs font-medium hover:bg-white/5 transition-all text-center" id="btn-sphere" onclick="selectShape('sphere')">
                  Sphere
                </button>
<button className="p-3 rounded-xl bg-transparent border border-white/10 text-zinc-500 text-xs font-medium hover:bg-white/5 transition-all text-center" id="btn-cone" onclick="selectShape('cone')">
                  Cone
                </button>
<button className="p-3 rounded-xl bg-transparent border border-white/10 text-zinc-500 text-xs font-medium hover:bg-white/5 transition-all text-center" id="btn-cuboid" onclick="selectShape('cuboid')">
                  Cuboid
                </button>
</div>

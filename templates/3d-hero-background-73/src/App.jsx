...
<button className="ui-panel flex items-center gap-2 px-3 py-2 rounded-full bg-white/10 text-white hover:bg-white/20 transition-all group" id="btn-portrait" onclick="setMode('portrait')">
...
<button className="ui-panel flex items-center gap-2 px-3 py-2 rounded-full text-white/40 hover:text-white hover:bg-white/5 transition-all group" id="btn-wide" onclick="setMode('wide')">
...
<button className="bg-[#0f0f10] border border-white/10 rounded-full w-10 h-10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all backdrop-blur-md" id="btn-pause" onclick="togglePause()">

...
<div className="text-[10px] text-zinc-500 tracking-wide font-mono" id="coords">POS: 0, 0</div>
</div>
...
<span className="iconify animate-bounce" data-icon="lucide:arrow-down" data-width="14"></span>
                Press ENTER to Open
            </div>
</div>
...
<span className="iconify text-white" data-icon="lucide:arrow-left" data-width="24"></span>
</button>
...
<span className="iconify text-white" data-icon="lucide:arrow-right" data-width="24"></span>
</button>
</div>
...
<span className="iconify text-white" data-icon="lucide:arrow-up" data-width="24"></span>
</button>
...
<span className="iconify text-purple-400" data-icon="lucide:user" data-width="20"></span>
</div>
</div>
...
<span className="iconify text-blue-400" data-icon="lucide:briefcase" data-width="20"></span>
</div>
</div>
<div className="text-center">
<div className="bg-zinc-900/80 backdrop-blur px-2 py-1 rounded border border-white/10">
...
<div className="world-label flex flex-col items-center gap-3 opacity-0" id="label-portfolio">
<div className="relative group">
...
<span className="iconify text-emerald-400" data-icon="lucide:layers" data-width="20"></span>
</div>
</div>
<div className="text-center">
<div className="bg-zinc-900/80 backdrop-blur px-2 py-1 rounded border border-white/10">
...
<span className="iconify text-purple-400" data-icon="lucide:map-pin" data-width="16"></span>
<span className="text-xs text-zinc-300">San Francisco, CA</span>
</div>
<div className="bg-zinc-900 p-3 rounded border border-white/5 flex items-center gap-3">
<span className="iconify text-purple-400" data-icon="lucide:mail" data-width="16"></span>
...
<div className="modal-panel w-full max-w-3xl bg-zinc-950 border border-white/10 rounded-xl shadow-2xl overflow-hidden hidden transform scale-95 opacity-0" id="modal-portfolio">

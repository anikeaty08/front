...
<img alt="Logo" className="h-10 w-auto object-contain origin-left" src="https://digitaldynamics.uk/wp-content/uploads/2023/05/web-logo.png"/>
<span className="text-xs text-slate-400 font-medium tracking-wide ml-1">SOLAR SYSTEM V.1.0</span>
</div>

...
<button className="btn-action group relative flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-zinc-400 hover:text-white" id="btn-scramble" onclick="scrambleCube()">
...
<button className="btn-action group relative flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-indigo-400 hover:text-indigo-300 disabled:opacity-50 disabled:cursor-not-allowed" id="btn-solve" onclick="solveCube()">
...
<div className="w-px h-8 bg-white/10 mx-1"></div>
<button className="btn-action group relative flex flex-col items-center gap-1 px-4 py-2 rounded-xl text-zinc-400 hover:text-white" onclick="resetCamera()">

...
<path className="group-hover:stroke-[3px] transition-all duration-700 opacity-80" d="M 150 140 C 220 140, 200 240, 280 240" fill="none" stroke="url(#lineGrad)" stroke-dasharray="8 4" strokeWidth="2"></path>
<path d="M 150 280 C 220 280, 200 240, 280 240" fill="none" stroke="rgba(255,255,255,0.1)" strokeWidth="2"></path>
</svg>

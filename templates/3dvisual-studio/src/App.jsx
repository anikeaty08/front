...
<svg aria-hidden="true" data-icon="lucide:x" data-strokeWidth="1.5" data-width="32" height="32" role="img" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg"><path d="M18 6L6 18M6 6l12 12" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</button>
...
<img alt="Abstract 3D Design" className="hero-slide absolute inset-0 w-full h-full object-cover opacity-80" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/68c70ed3-3617-478c-b904-4a86ef50ff12_3840w.webp" style={{transition: 'outline 0.1s ease-in-out'}}/>
...
<img alt="Dark Architecture" className="hero-slide opacity-80 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0a460363-bc5b-4b38-8915-07bc183dc66b_3840w.png"/>
</div>
...
<div className="bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f8b428da-9ed3-47c6-9392-c6b7f5e466dc_800w.png)] bg-cover absolute top-0 right-0 bottom-0 left-0"></div>
...
<div className="bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/49c51142-771e-4d9e-87c8-58472375cdc6_800w.png)] bg-cover bg-center absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-0 left-0 p-6 w-full">
<span className="text-[10px] font-sans uppercase tracking-widest text-[#D6FF4F] mb-1 block">
                Category
              </span>
...
<div className="bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6a0da6d9-39eb-45e0-8f25-70e05f4ce244_800w.png)] bg-cover absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-0 left-0 p-6 w-full">
<span className="text-[10px] font-sans uppercase tracking-widest text-[#D6FF4F] mb-1 block">
                Category
              </span>
...
<div className="bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6796dd95-e78d-4408-a398-e3926294042f_800w.png)] bg-cover absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-0 left-0 p-6 w-full">
<span className="text-[10px] font-sans uppercase tracking-widest text-[#D6FF4F] mb-1 block">
                Category
              </span>

...
<button aria-label="Volver" className="p-2 -ml-2 hidden" id="backBtn" onclick="prevScreen()">
...
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold transition hover:brightness-90 active:scale-[.98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00D180]" onclick="nextScreen()">Comenzar</button>
</div>
</section>
...
<input className="w-full h-14 border border-[#A8A8A8] rounded-[12px] py-2 px-3 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="amountInput" min="100" oninput="updateSimulation()" step="100" type="number" value="1000"/>
</label>
<label className="flex flex-col gap-2">
<span className="text-[14px]">Plazo (días)</span>
<select className="w-full h-14 border border-[#A8A8A8] rounded-[12px] py-2 px-3 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="termSelect" onchange="updateSimulation()">
...
<div className="mt-auto mb-4">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold transition hover:brightness-90 active:scale-[.98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00D180]" onclick="goToConfirm()">Continuar</button>
</div>
</section>
...
<div className="mt-auto mb-4">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold opacity-50 cursor-not-allowed transition active:scale-[.98]" disabled="" id="confirmBtn" onclick="createInvestment()">Confirmar inversión</button>
</div>
</section>
...
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold transition hover:brightness-90 active:scale-[.98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00D180]" onclick="nextScreen()">Continuar</button>
</div>
</section>
...
<div className="mt-auto mb-4">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold opacity-50 cursor-not-allowed transition active:scale-[.98]" disabled="" id="postContinue" onclick="nextScreen()">Guardar Preferencia</button>
</div>
</section>
...
<div className="mt-auto mb-4">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold transition hover:brightness-90 active:scale-[.98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00D180]" onclick="resetToSim()">Crear nueva inversión</button>
</div>
</section>
...
<div className="mt-auto mb-4">
<button className="bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-bold transition hover:brightness-90 active:scale-[.98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00D180]" onclick="backToList()">Volver</button>
</div>
</section>
</main>
</div>

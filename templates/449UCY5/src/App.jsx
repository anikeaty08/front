...
<div className="flex items-center justify-between px-3 py-2 bg-gray-50 hover:bg-gray-100 cursor-pointer state-header">
<div className="flex items-center space-x-2">
<input className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600 state-checkbox" type="checkbox"/>
<i className="w-4 h-4 stroke-1.5 transition-transform" data-lucide="chevron-right"></i>
<span className="text-sm font-medium state-name"></span>
</div>
<span className="text-xs text-gray-500 state-count"></span>
</div>

<div className="state-products pl-7 hidden"></div>
</div>
</template>
<template id="productTemplate">
<div className="border-t border-gray-200 product-node">
<div className="flex items-center justify-between px-3 py-2 hover:bg-gray-50 cursor-pointer product-header">
<div className="flex items-center space-x-2">
<input className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600 product-checkbox" type="checkbox"/>
<i className="w-3.5 h-3.5 stroke-1.5 transition-transform" data-lucide="chevron-right"></i>
<span className="text-sm product-name"></span>
</div>
<span className="text-xs text-gray-500 product-count"></span>
</div>
<div className="product-versions pl-7 hidden"></div>
</div>
</template>
<template id="versionTemplate">
<label className="flex items-center justify-between px-3 py-1.5 hover:bg-blue-50 rounded-md version-line">
<div className="flex items-center space-x-2">
<input className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600 version-checkbox-single" type="checkbox"/>
<span className="text-sm version-label"></span>
</div>
<span className="text-xs badge px-2 py-0.5 rounded"></span>
</label>
</template>

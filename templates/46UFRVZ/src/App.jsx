...
<button className="text-gray-500 hover:text-blue-600 font-semibold" onclick="prevStep()" type="button">Back</button>
<button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow" onclick="saveBusinessStage()" type="button">Next</button>
</div>
</form>
</div>
...
<button className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg" onclick="closeNicheModal()" type="button">Close</button>
</div>
</div>

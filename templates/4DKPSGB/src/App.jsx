...
<a className="nav-link hover:text-white transition-colors text-base font-normal text-white/70 tracking-tight" href="#">Home</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">Websites</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">Digital Marketing</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">About</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">Our Work</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">Learn</a>
<a className="nav-link hover:text-white transition-colors text-base font-medium text-white/70 tracking-tight" href="#">Contact</a>
</div>
...
<span className="gradient-text">Your partners </span><span className="text-slate-50">in</span>
</h1>

...
<text fill="#FFFFFF" fontFamily="Inter, ui-sans-serif, system-ui" fontSize="20" font-weight="600" letter-spacing="-0.01em" style={{paintOrder: 'stroke fill'}} x="0" y="25">
              CONGDON
            </text>

<circle cx="126" cy="18" fill="#8BABB6" r="2.6"></circle>
<text fill="#FFFFFF" fontFamily="Inter, ui-sans-serif, system-ui" fontSize="20" font-weight="600" letter-spacing="-0.01em" style={{paintOrder: 'stroke fill'}} x="136" y="25">
              COLEMAN
            </text>
</svg>
</div>

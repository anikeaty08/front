...
<button className="rounded-xl border p-4 hover:border-amber-500/30 transition-colors group text-left border-zinc-800 bg-zinc-950 hover:bg-zinc-900/50" onclick="showSection('billing')">
...
<button className="rounded-xl border p-4 hover:border-amber-500/30 transition-colors group text-left border-zinc-800 bg-zinc-950 hover:bg-zinc-900/50" onclick="showSection('payables')">
<div className="h-10 w-10 rounded-md bg-amber-500/15 border border-amber-500/30 flex items-center justify-center mb-3">
...
<button className="rounded-xl border p-4 hover:border-amber-500/30 transition-colors group text-left border-zinc-800 bg-zinc-950 hover:bg-zinc-900/50" onclick="showSection('reports')">
<div className="h-10 w-10 rounded-md bg-amber-500/15 border border-amber-500/30 flex items-center justify-center mb-3">
...
<button className="rounded-xl border p-4 hover:border-amber-500/30 transition-colors group text-left border-zinc-800 bg-zinc-950 hover:bg-zinc-900/50" onclick="showSection('reconciliation')">
<div className="h-10 w-10 rounded-md bg-amber-500/15 border border-amber-500/30 flex items-center justify-center mb-3">

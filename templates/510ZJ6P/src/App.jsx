...
<section className="w-full flex flex-row cardswap-section items-center justify-center px-12 py-16 gap-12 max-w-7xl mx-auto" style={{minHeight: '100vh'}}>

<div className="flex-1 max-w-lg cardswap-text fade-in" style={{animationDelay: '0.06s'}}>
<h1 className="text-[2.6rem] md:text-[2.9rem] lg:text-[3.2rem] leading-[1.08] font-light text-white tracking-tight mb-4" style={{fontFamily: 'Inter, sans-serif'}}><span className="font-light text-[#a78bfa]">Dominate Your Market </span>Stand Out in Search.</h1>
<h2 className="text-[#d7cafb] text-[1.25rem] md:text-[1.35rem] font-medium tracking-tight mb-3" style={{fontFamily: 'Inter, sans-serif'}}>
        See exactly how your business appears against competitors on Google, in real time.
      </h2>
<p className="text-[#c6b6f1] text-base md:text-lg font-normal mb-7 leading-relaxed" style={{fontFamily: 'Inter, sans-serif'}}>
        Our live card interface shows your organic search position, visibility, and how your listing compares to the rest. Get instant clarity, spot opportunities, and take action with confidence—all in one powerful visual snapshot.
      </p>
<ul className="space-y-2 text-[#b29ee7] text-base font-medium pl-1">
</ul>
</div>

<div className="relative flex-1 flex items-end justify-end fade-in" style={{minWidth: '520px', animationDelay: '0.12s'}}>
<div className="absolute bottom-0 right-0 cardswap-container perspective-900 overflow-visible" id="cardswap" style={{width: '500px', height: '470px', transform: 'translate(5%, 55%) scale(1)', marginLeft: '30px'}}>

<div aria-hidden="false" className="absolute top-1/2 left-1/2 border-gradient glass card-outline rounded-xl cursor-pointer shadow-lg flex flex-col transition-all duration-200" style={{width: '500px', height: '470px', translate: 'none', rotate: 'none', scale: 'none', zIndex: '3', transformOrigin: '50% 50%', transform: 'translate(-50%, -50%) translate3d(0px, 0px, 0px) rotate(12.0013deg) skew(12.0013deg, 1deg)', pointerEvents: 'auto'}} tabindex="0">
...
<div aria-hidden="true" className="absolute top-1/2 left-1/2 border-gradient glass card-outline rounded-xl cursor-pointer shadow-lg flex flex-col transition-all duration-200" style={{width: '500px', height: '470px', translate: 'none', rotate: 'none', scale: 'none', zIndex: '2', transformOrigin: '50% 50%', transform: 'translate(-50%, -50%) translate3d(60px, -70px, -90px) rotate(12deg) skew(12deg, 1deg) scale(1.00182, 0.97815)', pointerEvents: 'none'}} tabindex="-1">
<div className="browser-bar">
<span className="traffic-light traffic-red"></span>
<span className="traffic-light traffic-yellow"></span>
<span className="traffic-light traffic-green"></span>
...
<div aria-hidden="true" className="absolute top-1/2 left-1/2 border-gradient glass card-outline rounded-xl cursor-pointer shadow-lg flex flex-col transition-all duration-200" style={{width: '500px', height: '470px', fontFamily: 'Roboto, Inter, ui-sans-serif, sans-serif', translate: 'none', rotate: 'none', scale: 'none', zIndex: '1', transformOrigin: '50% 50%', transform: 'translate(-50%, -50%) translate3d(120px, -140px, -180px) rotate(12deg) skew(12deg, 1deg) scale(1.00062, 0.98776)', pointerEvents: 'none'}} tabindex="-1">
<div className="browser-bar">
<span className="traffic-light traffic-red"></span>
<span className="traffic-light traffic-yellow"></span>
<span className="traffic-light traffic-green"></span>

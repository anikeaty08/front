...
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="home"></i>
...
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="users"></i>
<span className="font-medium">Clientes</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="receipt"></i>
<span className="font-medium">Cobranças</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="wallet"></i>
<span className="font-medium">Pagar</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="send"></i>
<span className="font-medium">Transferir</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="qr-code"></i>
<span className="font-medium">Pix</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="credit-card"></i>
<span className="font-medium">Carteira</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="contactless-payment"></i>
<span className="font-medium">Máquina de cartão</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="building"></i>
<span className="font-medium">Cartões Empresa</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="file-text"></i>
<span className="font-medium">Nota fiscal</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="hand-coins"></i>
<span className="font-medium">Arrecadação</span>
</a>
</li>
<li>
<a className="flex items-center gap-3 rounded-lg px-3 py-2.5 hover:bg-white hover:border hover:border-neutral-200 transition">
<i className="h-4.5 w-4.5 text-neutral-600" data-lucide="trending-up"></i>
...
<div className="relative mx-auto rounded-[2.2rem] bg-black p-2 shadow-2xl">

<div className="absolute left-1/2 -translate-x-1/2 top-2 h-6 w-36 rounded-b-3xl bg-black z-10"></div>
<div className="rounded-[1.8rem] overflow-hidden bg-neutral-50">
<div className="px-4 pt-6 pb-3 flex items-center justify-between">
<span className="text-xs text-neutral-500">9:41</span>
...
<div className="flex items-center justify-between">
<div>
<h4 className="text-lg tracking-tight font-semibold">Bem vindo</h4>
<p className="text-xs text-neutral-500">Zeca, peça o seu cartão</p>
</div>
<div className="h-8 w-8 rounded-full overflow-hidden ring-1 ring-neutral-200">
<img alt="avatar" className="h-full w-full object-cover" src="https://images.unsplash.com/photo-1544723795-3fb6469f5b39?q=80&amp;w=240&amp;auto=format&amp;fit=crop"/>
</div>
</div>
<div className="mt-4 grid grid-cols-2 gap-3">
<div className="rounded-xl p-4 text-white" style={{background: 'linear-gradient(135deg,#1e293b, #0ea5e9)'}}>
<p className="text-xs/4 opacity-90">sua marca</p>
<p className="mt-2 text-xl tracking-tight font-semibold">R$ 1.000,00</p>
</div>
<div className="rounded-xl p-4 text-white" style={{background: 'linear-gradient(135deg,#0ea5e9, #22c55e)'}}>
<p className="text-xs/4 opacity-90">Cashback</p>
<p className="mt-2 text-xl tracking-tight font-semibold">R$ 40,00</p>
</div>
</div>
<div className="mt-4 rounded-xl border border-neutral-200 bg-white p-3">
<div className="flex items-center justify-between">
<span className="text-sm font-medium">Atalhos</span>
<button className="text-xs text-neutral-600 inline-flex items-center gap-1">
                        Ver mais
                        <i className="h-3.5 w-3.5" data-lucide="chevron-right"></i>
</button>
</div>
<div className="mt-3 grid grid-cols-3 gap-2">
<button className="flex flex-col items-center gap-2 rounded-lg border border-neutral-200 bg-white py-3 hover:bg-neutral-50">
<i className="h-5 w-5" data-lucide="qr-code"></i>
...
<div className="mt-4">
<h5 className="text-sm font-medium">Gift cards</h5>
<div className="mt-2 grid grid-cols-4 gap-2">
<div className="rounded-lg overflow-hidden ring-1 ring-neutral-200">
<img alt="gift" className="h-14 w-full object-cover" src="https://images.unsplash.com/photo-1512295767273-ac109ac3acfa?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
</div>
<div className="rounded-lg overflow-hidden ring-1 ring-neutral-200">
<img alt="gift" className="h-14 w-full object-cover" src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
</div>
<div className="rounded-lg overflow-hidden ring-1 ring-neutral-200">
<img alt="gift" className="h-14 w-full object-cover" src="https://images.unsplash.com/photo-1471341971476-ae15ff5dd4ea?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
</div>
<div className="rounded-lg overflow-hidden ring-1 ring-neutral-200">
<img alt="gift" className="h-14 w-full object-cover" src="https://images.unsplash.com/photo-1541873676-a18131494184?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
</div>
</div>
</div>
</div>
<div className="px-6 pb-6">
<div className="h-9 rounded-xl bg-white/70 border border-neutral-200 grid grid-cols-4 overflow-hidden text-neutral-600 text-xs">
<button className="flex items-center justify-center gap-1 bg-neutral-900 text-white font-medium">
<i className="h-4 w-4" data-lucide="home"></i> Início
                    </button>
<button className="flex items-center justify-center gap-1">
<i className="h-4 w-4" data-lucide="receipt"></i> Pagar
                    </button>
<button className="flex items-center justify-center gap-1">
<i className="h-4 w-4" data-lucide="wallet"></i> Saldo
                    </button>
<button className="flex items-center justify-center gap-1">
<i className="h-4 w-4" data-lucide="user"></i> Perfil
                    </button>
</div>
</div>
</div>
</div>
<p className="text-center text-xs text-neutral-500 mt-3">Preview mobile</p>
</div>
</div>
</div>
</div>

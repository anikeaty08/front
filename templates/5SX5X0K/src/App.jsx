...
<img alt="Abstract 3D render" className="absolute inset-0 h-full w-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/587704f8-5e00-4904-b740-9c240e358d12_3840w.jpg" style={{}}/>
...
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover -ml-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8b9d7665-a3f8-48a3-8deb-4423535e171b_320w.jpg"/>
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover -ml-2" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d25806e7-e515-4a9a-9bca-93661e9d7d47_320w.jpg"/>
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover -ml-2" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ef094a8a-d614-4d62-a462-2ce2617e5b34_320w.jpg" style={{}}/>
...
<a className="group relative overflow-hidden rounded-3xl ring-1 ring-zinc-200 bg-white shadow-sm" href="#">
<img alt="Dev tools" className="h-56 sm:h-64 w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d50bfcc-af2b-4668-b115-0a03f8ff1b7b_800w.jpg" style={{}}/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">

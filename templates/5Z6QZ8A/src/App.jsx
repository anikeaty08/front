...
<p className="text-slate-300 text-base xs:text-lg sm:text-xl md:text-2xl mb-7 sm:mb-8 max-w-lg font-extralight tracking-wide">
            Download your free guide to disciplined, data-driven football investing.<br/>
            Discover how Simplifi is transforming football analytics by focusing on market movements, risk management, and responsible strategies.
          </p>
...
<div className="relative w-60 xs:w-72 sm:w-80 md:w-[350px] lg:w-[450px] aspect-[1/1.1] flex justify-center items-center mx-auto">
<div className="absolute inset-0 bg-gradient-to-r from-[#1f5410]/20 to-[#004e2b]/20 rounded-full blur-3xl z-0"></div>
<img alt="Simplifi Football Guide Cover" className="relative z-10 w-full h-full object-contain rounded-xl shadow-lg border border-zinc-800" src="https://i.postimg.cc/4306sy0J/SIMPLIFI-AD-POSTS.jpg"/>
</div>
</div>
</div>

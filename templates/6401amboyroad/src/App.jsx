...
<button className="bg-white text-black px-6 py-3 rounded-lg font-medium hover:bg-neutral-200 transition-all flex items-center justify-center gap-2 text-sm md:text-base" onclick="document.getElementById('inquire').scrollIntoView({behavior: 'smooth'})">
                        Contact Agent
                        <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
</button>
<button className="px-6 py-3 rounded-lg font-medium border border-white/10 hover:bg-white/5 transition-all text-white text-sm md:text-base" onclick="document.getElementById('gallery').scrollIntoView({behavior: 'smooth'})">
                        View Surveys
                    </button>
</div>
</div>

...
<button className="flex items-center gap-2 rounded-md bg-white/10 px-6 py-3 text-sm font-medium text-gray-200 backdrop-blur hover:bg-white/20" onclick="toggleVideo()">

...
<button className="flex-1 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors" onclick="closeContactModal()" type="button">
                        Annulla
                    </button>
...
<button className="px-6 py-2 bg-black text-white rounded-full text-sm font-medium hover:bg-gray-800 transition-all duration-300" onclick="openContactModal()">
                        Contattaci
                    </button>
</div>
...
<button className="px-8 py-4 bg-black text-white rounded-full text-lg font-medium hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105" onclick="openContactModal()">
                    Inizia il Progetto →
                </button>
<button className="px-8 py-4 border border-gray-300 text-black rounded-full text-lg font-medium hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md" onclick="document.getElementById('work').scrollIntoView({behavior: 'smooth'})">
                    Scopri i Lavori
                </button>
</div>
...
<button className="w-full py-3 border border-gray-300 rounded-xl hover:bg-black hover:text-white transition-all duration-300" onclick="openContactModal()">
                        Richiedi Preventivo
                    </button>
</div>

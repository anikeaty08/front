...
<div className="fixed inset-0 bg-cover bg-center -z-30 opacity-20 dark:opacity-10" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1624359136353-f60129a367b9?w=3840&amp'}}></div>

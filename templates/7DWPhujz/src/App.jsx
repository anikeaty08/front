...
<div className="dropdown-item px-4 py-1 border-b border-gray-200 text-black" onclick="openWindow('about')">About This Macintosh</div>
...
<div className="absolute top-4 right-4 flex flex-col items-center w-24 cursor-pointer" onclick="openWindow('finder')">
...
<div className="absolute top-28 right-4 flex flex-col items-center w-24 cursor-pointer" onclick="alert('The trash is empty')">
<div className="w-12 h-12 bg-gray-200 border border-gray-400 rounded">
<svg className="w-full h-full p-1" viewbox="0 0 24 24">
...
<div className="w-3 h-3 cursor-pointer" onclick="closeWindow('finder')">
<svg className="w-full h-full" viewbox="0 0 16 16">
...
<div className="w-3 h-3 cursor-pointer" onclick="closeWindow('about')">
<svg className="w-full h-full" viewbox="0 0 16 16">
<rect fill="white" height="12" stroke="black" width="12" x="2" y="2"></rect>
<line stroke="black" strokeWidth="1" x1="4" x2="12" y1="4" y2="12"></line>
<line stroke="black" strokeWidth="1" x1="12" x2="4" y1="4" y2="12"></line>
...
<div className="dock-icon w-8 h-8 bg-gray-300 rounded-lg flex items-center justify-center cursor-pointer" onclick="openWindow('finder')">
...
<div className="dock-icon w-8 h-8 bg-gray-300 rounded-lg flex items-center justify-center cursor-pointer" onclick="openWindow('about')">
<svg className="w-6 h-6 text-gray-700" viewbox="0 0 24 24">

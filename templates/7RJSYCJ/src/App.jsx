...
<button className="inline-flex gap-2 text-[15px] transition-colors bg-amber-500 rounded-md pt-3 pr-6 pb-3 pl-6 shadow-sm items-center justify-center hover:bg-amber-400 text-black" style={{fontFamily: 'Inter, system-ui', fontWeight: '500'}}>
            Explore Universe
            <svg className="lucide lucide-arrow-right h-[18px] w-[18px]" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
<button className="inline-flex items-center justify-center gap-2 rounded-md border px-6 py-3 text-[15px] transition-colors shadow-sm default border-neutral-800/80 text-white hover:bg-white/10 hover:border-neutral-700" style={{fontFamily: 'Inter, system-ui', fontWeight: '500'}}>
            Quantum Process
            <svg className="lucide lucide-workflow h-[18px] w-[18px] text-amber-500" data-lucide="workflow" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8" x="3" y="3"></rect><path d="M7 11v4a2 2 0 0 0 2 2h4"></path><rect height="8" rx="2" width="8" x="13" y="13"></rect></svg>
</button>
</div>
</div>
...
<a className="inline-flex items-center gap-2 rounded-md border px-4 py-2 text-[14px] transition-colors shadow-sm default border-neutral-800/80 text-white hover:bg-white/10 hover:border-neutral-700" href="#" style={{fontFamily: 'Inter, system-ui', fontWeight: '500'}}>
        View all work
        <svg className="lucide lucide-arrow-right h-[16px] w-[16px]" data-lucide="arrow-right" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
...
<button className="inline-flex items-center gap-2 rounded-md border px-4 py-2 text-[14px] transition-colors shadow-sm default border-neutral-800/80 text-white hover:bg-white/10 hover:border-neutral-700" style={{fontFamily: 'Inter, system-ui', fontWeight: '500'}}>
          Our Services
          <svg className="lucide lucide-layers h-[16px] w-[16px] text-amber-500" data-lucide="layers" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path></svg>
</button>
...
<div className="fade-in-up bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30eeab2d-e97c-4b45-b740-6695c7862813_1600w.jpg)] bg-cover border rounded-2xl pt-6 pr-6 pb-6 pl-6 space-y-6 border-zinc-800" style={{}}>
...
<div className="fade-in-up stagger-delay-3 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d332ff93-b258-4594-bf65-7ccd8793ff59_1600w.jpg)] bg-cover border rounded-2xl pt-6 pr-6 pb-6 pl-6 space-y-6 visible border-zinc-800" style={{}}>
<div className="flex items-center gap-4">
<div className="w-12 h-12 rounded-full border flex items-center justify-center text-sm font-medium font-geist border-neutral-700" style={{}}>
            04</div>

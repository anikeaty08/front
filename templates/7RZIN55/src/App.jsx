...
<h1 className="md:text-6xl bg-clip-text text-xs font-light text-transparent tracking-tighter font-inter bg-gradient-to-r from-white via-gray-200 to-gray-400 mb-6 pt-2 pb-2">Turbocharged by industry leaders.</h1>
...
<div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto logo-set fade-in" id="logoSet1">
...
<div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto logo-set absolute inset-0 fade-out" id="logoSet2" style={{opacity: '0'}}>

...
<div>
<label className="block font-inter text-sm font-medium text-zinc-700 mb-2">Indirizzo completo</label>
<textarea className="w-full px-4 py-3 border border-zinc-200 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent font-inter text-sm" placeholder="Via, Città, CAP" rows="3"></textarea>
</div>
<div>
<label className="block font-inter text-sm font-medium text-zinc-700 mb-2">Numero camere</label>
...
<button className="px-4 py-2 bg-zinc-800 text-white rounded-md font-inter text-sm hover:bg-zinc-900 transition-colors" onclick="aggiungiRegola()" type="button">+ Aggiungi Regola</button>
</div>
...
<button className="px-4 py-2 bg-black text-white rounded-md font-inter text-sm hover:bg-zinc-800 transition-colors" onclick="aggiungiCamera()" type="button">+ Aggiungi Camera</button>
</div>

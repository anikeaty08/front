...
<img alt="7K Mobile" className="w-auto h-8 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0b2e12d6-456f-4c10-9db1-e243c0d82ac6_320w.png"/>
</a>

<button className="transition-all duration-300 active:scale-95 hover:bg-black hover:text-white hover:shadow-[0_0_20px_rgba(0,0,0,0.15)] text-sm font-semibold text-black bg-transparent border-black border-2 rounded-full pt-2 pr-5 pb-2 pl-5 shadow-none" onclick="toggleModal(true)">
            Join Waitlist
        </button>
</nav>
...
<img alt="7K Mobile App Interface" className="md:max-w-[500px] lg:max-w-[540px] transform hover:scale-[1.01] transition-transform duration-500 w-full max-w-[340px] object-contain z-10 relative shadow scale-95" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/555a77f3-f086-4f6b-9bee-5b5e25d582af_800w.png" style={{maskImage: 'linear-gradient(transparent, black 5%, black 75%, transparent)'}}/>
...
<button className="bg-[#111] text-white px-8 py-3 rounded-full text-base font-medium hover:bg-gray-800 transition-all shadow-lg hover:-translate-y-0.5 active:scale-95" onclick="toggleModal(true)">
                Join Waitlist
            </button>
</section>
</main>
...
<div className="mb-6">
<img alt="7K" className="h-10 w-auto object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0b2e12d6-456f-4c10-9db1-e243c0d82ac6_320w.png"/>
</div>
...
<button className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#111] text-white p-2 rounded-lg hover:bg-gray-800 transition-colors" onclick="submitForm()">
...
<button className="transition-all duration-300 active:scale-95 hover:bg-black hover:text-white hover:shadow-[0_0_20px_rgba(0,0,0,0.15)] text-sm font-semibold text-black bg-white border-black border-2 rounded-full px-10 py-2.5 shadow-none" onclick="toggleModal(false)">
                    Close
                </button>
</div>
</div>

...
<button @click="sidebarOpen = !sidebarOpen" className="text-gray-400 hover:text-white focus:outline-none">
...
<div :className="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" className="transform md:translate-x-0 transition-transform duration-300 ease-in-out absolute md:relative z-10 md:z-0 w-64 bg-gray-900 md:bg-gray-800 h-[calc(100vh-4rem)] md:h-auto overflow-y-auto border-r border-gray-700">
<nav className="p-4">

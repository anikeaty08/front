...
<h1 className="headline mb-4 text-gray-900 font-normal">
        ...
        with the <span className="bg-gradient-to-r from-purple-500 via-indigo-400 to-orange-400 bg-clip-text text-transparent font-normal">power of AI</span>
</h1>
...
<img alt="App Preview" className="mx-auto max-w-full w-[500px] md:w-[650px] rounded-xl shadow-2xl border border-gray-300 transition" loading="lazy" src="https://www.launchuicomponents.com/app-dark.png"/>
</div>
</main>

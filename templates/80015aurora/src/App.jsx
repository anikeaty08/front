...
<div className="flex glass-panel transition-all duration-300 cursor-pointer max-w-7xl rounded-full mr-auto ml-auto pt-3 pr-6 pb-3 pl-6 shadow-sm items-center justify-between" onclick="window.location.href='https://drive.google.com/file/d/1bkEw4Sk6Vp1ZssY1rVUPIrp8tKPVHq1n/view?usp=drive_link'" role="button">
...
<img alt="17335 E Rice Cir Unit C" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 filter brightness-[0.98]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>

<div className="cursor-pointer bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d4dcbb2-f485-499d-989c-591267293dc0_1600w.png)] bg-cover absolute top-0 right-0 bottom-0 left-0" onclick="window.location.href='https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d4dcbb2-f485-499d-989c-591267293dc0_1600w.png'" role="button"></div>

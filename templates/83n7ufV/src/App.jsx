...
<h2 className="text-2xl font-light tracking-tight text-center mb-10">Design Tools</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">


<div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg overflow-hidden transition-all hover:border-[#6E56CF]/50 shadow-[0_2px_10px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
...
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Animations</span>
</div>
</div>
</div>
...
<div className="flex space-x-1">
<div className="w-3 h-3 rounded-full bg-[#6E56CF]/60"></div>
<div className="w-24 h-3 bg-[#6E56CF]/20 rounded"></div>
</div>
<div className="flex space-x-1">
<div className="w-3 h-3 rounded-full bg-[#6E56CF]/40"></div>
<div className="w-20 h-3 bg-[#6E56CF]/20 rounded"></div>
</div>
</div>
</div>
</div>
...
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Branching</span>
</div>
</div>
</div>
...
<div className="bg-[#6E56CF]/20 rounded-lg p-1 flex items-center justify-center">
<div className="w-8 h-8 rounded-md bg-[#6E56CF]/40"></div>
</div>
<div className="bg-[#6E56CF]/10 rounded-lg p-1 flex items-center justify-center">
<div className="w-12 h-3 rounded-md bg-[#6E56CF]/40"></div>
</div>
<div className="bg-[#6E56CF]/10 rounded-lg p-1 flex items-center justify-center">
<div className="w-6 h-6 rounded-full bg-[#6E56CF]/40"></div>
</div>
<div className="bg-[#6E56CF]/20 rounded-lg p-1 flex items-center justify-center">
<div className="w-10 h-4 rounded-md bg-[#6E56CF]/40"></div>
</div>
</div>
</div>
</div>
...
<h3 className="text-base font-medium tracking-tight">UI Components</h3>
</div>
<p className="text-gray-400 mb-3 text-xs leading-relaxed">
            Build and manage reusable components for consistent interfaces across projects.
          </p>
<div className="flex text-[10px] gap-1 mt-auto">
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Library</span>
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Variants</span>
</div>
</div>
</div>


<div className="md:col-span-2 bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg overflow-hidden transition-all hover:border-[#6E56CF]/50 shadow-[0_2px_10px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
<div className="aspect-w-16 aspect-h-9 bg-[#212121] p-4">
<div className="w-full h-full">
...
<div className="w-full h-1 bg-[#6E56CF]/20 rounded mb-1"></div>
<div className="w-3/4 h-1 bg-[#6E56CF]/20 rounded"></div>
...
<div className="w-5 h-5 rounded-full bg-[#C4B5FD] border border-[#212121]"></div>
</div>
</div>
<div className="flex flex-col space-y-2">
...
<div className="flex-1 bg-[#6E56CF]/10 rounded p-1">
<div className="w-full h-1 bg-[#6E56CF]/30 rounded mb-1"></div>
<div className="w-1/2 h-1 bg-[#6E56CF]/30 rounded"></div>
</div>
</div>
</div>
</div>
...
<h3 className="text-base font-medium tracking-tight">Real-time Collaboration</h3>
</div>
<p className="text-gray-400 mb-3 text-xs leading-relaxed">
...
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Comments</span>
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Presence</span>
</div>
</div>
</div>
...
<div className="w-6 h-6 bg-[#6E56CF] rounded"></div>
<div className="w-6 h-6 bg-[#9E8CFC] rounded"></div>
<div className="w-6 h-6 bg-[#C4B5FD] rounded"></div>
</div>
<div className="flex space-x-1 mb-2">
<div className="w-16 h-4 bg-[#6E56CF] rounded-md"></div>
<div className="w-10 h-4 bg-[#6E56CF]/60 rounded-md"></div>
</div>
<div className="flex space-x-1">
<div className="w-6 h-6 rounded border border-[#333] flex items-center justify-center">
<div className="w-3 h-3 bg-[#6E56CF]/70 rounded-sm"></div>
</div>
<div className="w-6 h-6 rounded border border-[#333] flex items-center justify-center">
<div className="w-3 h-1 bg-[#6E56CF]/70 rounded-sm"></div>
</div>
</div>
</div>
</div>
...
<span className="px-1.5 py-0.5 rounded-full border border-[#6E56CF]/30 text-[#9E8CFC]">Styles</span>
</div>
</div>
</div>
</div>

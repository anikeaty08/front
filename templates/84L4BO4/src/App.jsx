...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7aa3f483-3978-4416-8322-fa9964864dcb_3840w.jpg")'}}></div>
...
<div className="flex w-12 h-12 bg-white bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/686aa8d3-7d4f-455f-afba-ed9399e3708b_320w.jpg)] bg-cover border-zinc-800/30 border rounded-2xl items-center justify-center">
</div>
<div className="">
...
<div className="hover:border-zinc-700/50 transition-all duration-300 bg-black/20 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d1c5ab29-19c6-425d-b896-a48cbe5a00ff_800w.jpg)] bg-cover border-zinc-800/30 border rounded-3xl pt-8 pr-8 pb-8 pl-8">
...
<div className="bg-black/20 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2fdcc9de-94c9-4f1c-80d4-900440428d32_800w.jpg)] bg-cover border-zinc-800/30 border rounded-3xl pt-6 pr-6 pb-6 pl-6">

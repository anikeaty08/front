...
<div className="bg-white rounded-2xl shadow-lg ring-1 ring-black/5 p-8 mb-6 opacity-0 animate-fade-in" style={{animationDelay: '0.2s'}}>
...
<p className="text-gray-600 mb-8">You have the overview masterclass. Now get the <strong>complete system</strong> — detailed masterclasses, workbooks, eBooks, and AI assistance for each step of your artist transformation.</p>
...
<span className="text-xs font-semibold text-orange-600 bg-orange-200 rounded-full px-2 py-1">75% OFF</span>
</div>
<div className="flex items-center justify-center gap-2 mb-3">
<span className="text-lg text-gray-500 line-through">$2,397</span>
<span className="text-3xl font-bold text-orange-600">$597</span>
</div>

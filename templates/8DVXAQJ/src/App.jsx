...
<aside className="group w-16 hover:w-64 transition-all duration-200 shrink-0 border-r border-neutral-200 bg-white/60 backdrop-blur-md shadow-sm flex flex-col overflow-y-auto">
...
<aside className="w-80 shrink-0 border-l border-neutral-200 bg-white/50 flex flex-col overflow-y-auto">

...
<span className="ml-3 text-xl tracking-tight">Nexus</span>
</div>
...
<button className="bg-white text-black font-medium rounded-md px-8 py-3 hover:bg-opacity-90 transition-all">
            Get started
          </button>
...
<div>
<p className="text-4xl font-semibold mb-1 tracking-tight">95%</p>
<p className="text-gray-400 text-base">User satisfaction</p>
</div>
<div>
<p className="text-4xl font-semibold mb-1 tracking-tight">15k+</p>
...
<div>
<p className="text-4xl font-semibold mb-1 tracking-tight">100%</p>
<p className="text-gray-400 text-base">Cloud-based</p>
</div>
</div>

<div className="mt-32 max-w-6xl mx-auto">
<h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-center mb-16">Key features that set us apart</h2>
...
<p className="text-gray-400">Experience unmatched speed with our optimized platform designed for performance.</p>
</div>
<div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl">
...
<span className="material-symbols-outlined text-teal-400">insights</span>
</div>
<h3 className="text-xl font-semibold mb-2">Smart Analytics</h3>
<p className="text-gray-400">Gain valuable insights with our advanced analytics and reporting tools.</p>
</div>
</div>
</div>
</div>

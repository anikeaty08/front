...
<div %3e%3c="" %3e%3ccircle="" %3e%3cg="" 40"="" className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=" cx="20" cy="20" fill="none" fillOpacity="0.03" fill-rule="evenodd" g%3e%3c="" height="40" opacity-20"="" r="1" svg%3e')]="" viewbox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"></div>
<div className="relative overflow-hidden h-[48vh] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8e1d1c1a-a3b6-46bd-bbab-454e16ca12eb_1600w.jpg)] bg-cover items-center justify-center">
...
<path d="M21 15v4a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
...
<path d="M7.5 4.27c.71 2.4.5 4.84-.36 6.83a8 8 0 1 0 11.5-6.16c-1.78.37-3.47 1.4-4.64 2.93"></path>

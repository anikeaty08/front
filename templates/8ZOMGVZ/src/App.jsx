...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/91b76de7-6349-4826-be85-69a179ee18b6_3840w.jpg")'}}></div>

<div className="max-w-7xl sm:px-6 lg:px-8 lg:py-10 mr-auto ml-auto pt-6 pr-4 pb-6 pl-4">
<div className="sm:p-6 lg:p-8 shadow-[0_10px_60px_-15px_rgba(0,0,0,0.6)] bg-white/5 border-white/15 border rounded-3xl pt-4 pr-4 pb-4 pl-4 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] backdrop-blur-xl">
...
<svg className="lucide lucide-trees h-5 w-5 text-emerald-300" data-lucide="trees" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10 10v.2A3 3 0 0 1 8.9 16H5a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0Z"></path><path d="M7 16v6"></path><path d="M13 19v3"></path><path d="M12 19h8.3a1 1 0 0 0 .7-1.7L18 14h.3a1 1 0 0 0 .7-1.7L16 9h.2a1 1 0 0 0 .8-1.7L13 3l-1.4 1.5"></path></svg>
</span>
<span className="text-xl md:text-2xl text-white font-geist font-medium tracking-tighter" style={{}}>MistHaven</span>
</div>
<nav className="hidden md:flex items-center gap-8 text-sm text-slate-200/90">
<a className="hover:text-white transition font-geist" href="#">Stays</a>
<a className="hover:text-white transition font-geist" href="#">Cabins</a>
<a className="hover:text-white transition font-geist" href="#">Experiences</a>
<a className="hover:text-white transition font-geist" href="#">Contact</a>
</nav>
...
<span className="block text-white font-geist font-medium tracking-tighter" style={{}}>Where Silence</span>
<span className="block text-white/70 font-geist font-medium tracking-tighter" style={{}}>Meets</span>
<span className="block bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 font-geist font-medium tracking-tighter" style={{}}>The Pines</span>
</h1>
...
<svg className="lucide lucide-chevron-down h-4 w-4 text-slate-300/80" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
...
<div className="">
<div className="text-2xl text-white font-geist font-medium tracking-tighter" style={{}}>$329<span className="text-base font-medium text-slate-300 font-geist"> / night</span></div>
...
</div><section className="mt-16 lg:mt-20">

<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16">

<div className="relative group rounded-3xl bg-white/5 p-7 lg:p-8 ring-1 ring-white/15 backdrop-blur-sm overflow-hidden" style={{boxShadow: '0 0 0 1px rgba(255, 255, 255, 0.1), 0 6px 22px rgba(0,0,0,0.14)', minHeight: '360px'}}>

<div className="absolute inset-0 opacity-10" style={{background: 'linear-gradient(90deg, transparent 0%, rgba(110, 231, 183, 0.3) 50%, transparent 100%)', animation: 'shimmer 3s ease-in-out infinite', transform: 'translateX(-100%)'}}></div>
...
<img alt="Wood-fired stove" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a66a6053-081d-461e-b7bf-f325b92ef575_800w.jpg" style={{}}/>
...
<svg className="lucide lucide-flame h-3.5 w-3.5" data-lucide="flame" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"></path></svg>
          Wood • Warmth
        </div>
</div>
...
<div className="relative group lg:p-8 ring-1 ring-white/15 overflow-hidden bg-white/5 rounded-3xl pt-7 pr-7 pb-7 pl-7 backdrop-blur-sm" style={{boxShadow: '0 0 0 1px rgba(255, 255, 255, 0.1), 0 6px 22px rgba(0,0,0,0.14)', minHeight: '360px'}}>

<div className="absolute inset-0 opacity-10" style={{background: 'linear-gradient(90deg, transparent 0%, rgba(147, 197, 253, 0.3) 50%, transparent 100%)', animation: 'shimmer 3s ease-in-out infinite 1s', transform: 'translateX(-100%)'}}></div>
...
<img alt="Stargazing deck" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/81f80b03-8c4a-4b12-80cc-ef4dfb260072_800w.jpg" style={{}}/>
<div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent"></div>
<div className="absolute left-3 bottom-3 inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2.5 py-1 text-xs text-white ring-1 ring-white/20 backdrop-blur-sm font-geist">
<svg className="lucide lucide-moon h-3. w-3.5" data-lucide="moon" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"></path></svg>
          Night sky
        </div>
</div>
...
<div className="mt-4 flex flex-wrap items-center gap-2">
<span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 px-2.5 py-1 text-xs text-slate-200 ring-1 ring-white/15 font-geist">
<svg className="lucide lucide-star h-3.5 w-3.5 text-blue-300" data-lucide="star" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg>
          Zero light pollution
        </span>
<span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 px-2.5 py-1 text-xs text-slate-200 ring-1 ring-white/15 font-geist">
<svg className="lucide lucide-map-pin h-3.5 w-3.5 text-blue-300" data-lucide="map-pin" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
          Riverside deck
        </span>
</div>
</div>
...
<div className="absolute inset-0 opacity-10" style={{background: 'linear-gradient(90deg, transparent 0%, rgba(252, 211, 77, 0.3) 50%, transparent 100%)', animation: 'shimmer 3s ease-in-out infinite 2s', transform: 'translateX(-100%)'}}></div>
...
<img alt="Digital detox cabin interior" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a7eacbd6-2566-476b-9e41-eebb713e56c1_800w.jpg" style={{}}/>
<div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent"></div>
<div className="absolute left-3 bottom-3 inline-flex items-center gap-1.5 rounded-full bg-black/40 px-2.5 py-1 text-xs text-white ring-1 ring-white/20 backdrop-blur-sm font-geist">
<svg className="lucide lucide-wifi-off h-3.5 w-3.5" data-lucide="wifi-off" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M12 20h.01"></path><path d="M8.5 16.429a5 5 0 0 1 7 0"></path><path d="M5 12.859a10 10 0 0 1 5.17-2.69"></path><path d="M19 12.859a10 10 0 0 0-2.007-1.523"></path><path d="M2 8.82a15 15 0 0 1 4.177-2.643"></path><path d="M22 8.82a15 15 0 0 0-11.288-3.764"></path><path d="m2 2 20 20"></path></svg>
          Offline
        </div>
</div>
...
<div className="mt-4 flex flex-wrap items-center gap-2">
<span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 px-2.5 py-1 text-xs text-slate-200 ring-1 ring-white/15 font-geist">
<svg className="lucide lucide-book h-3.5 w-3.5 text-amber-300" data-lucide="book" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"></path></svg>
          Library corner
        </span>
<span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 px-2.5 py-1 text-xs text-slate-200 ring-1 ring-white/15 font-geist">
<svg className="lucide lucide-coffee h-3.5 w-3.5 text-amber-300" data-lucide="coffee" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M10 2v2"></path><path d="M14 2v2"></path><path d="M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1"></path><path d="M6 2v2"></path></svg>
          Slow mornings
        </span>
</div>
</div>

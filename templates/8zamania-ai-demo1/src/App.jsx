...
<button className="hidden md:block hover:bg-white/5 hover:border-white/20 transition-all duration-300 cursor-pointer text-xs font-medium text-white border-white/10 border rounded-md pt-1.5 pr-3 pb-1.5 pl-3" onclick="document.getElementById('domainInput').focus();window.location.href='https://8zamania.com'" role="button">8Zamania</button>
</div>
</div>
</nav>
...
<p className="-bottom-6 text-[10px] transition-opacity text-violet-500 text-center opacity-0 w-full absolute left-0 cursor-pointer" id="errorMsg" onclick="window.location.href='https://8zamania.com'" role="button">Visita 8Zamania, La Ciudad de los Robots AI</p>
</div>
</div>
</header>

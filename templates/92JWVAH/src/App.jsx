...
export default function App() {
  useEffect(() => {
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      // Dropdown team switcher logic unchanged...
      (function() {

...
<div className="pointer-events-none absolute inset-x-0 top-0 h-40 -z-10" style={{background: 'url(\'data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 1440 320%27%3E%3Cpath fill=%27%2337B5A9%27 fillOpacity=%270.10%27 d=%27M0,128L40,138.7C80,149,160,171,240,192C320,213,400,235,480,224C560,213,640,171,720,160C800,149,880,171,960,186.7C1040,203,1120,213,1200,213.3C1280,213,1360,203,1400,197.3L1440,192V0H0Z%27/%3E%3C/svg%3E\') center/cover'}}></div>
<header className="relative z-10">
<nav className="max-w-7xl flex md:px-10 fade fade-1 mr-auto ml-auto pt-6 pr-6 pb-6 pl-6 items-center justify-between">

<a className="flex items-center space-x-2 font-semibold tracking-tight text-lg" href="#">
<svg className="w-6 h-6 text-[#37B5A9]" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8 6a4 4 0 1 1 8 0v5m0 0a4 4 0 0 1-8 0V6m8 5v7a4 4 0 1 1-8 0v-7"></path></svg>
<span className="sr-only">EverAfter home</span>
</a>

<ul className="hidden md:flex flex-1 gap-8 text-sm font-medium ml-40 justify-center">
<li className=""><a className="hover:text-[#37B5A9]" href="#">Why Us</a></li>
<li className=""><a className="hover:text-[#37B5A9]" href="#">Security</a></li>
<li className=""><a className="hover:text-[#37B5A9]" href="#">Pricing</a></li>
</ul>
...
<svg className="lucide lucide-menu w-6 h-6" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 12h16"></path><path className="" d="M4 18h16"></path><path d="M4 6h16"></path></svg>
</button>
</nav>
...
<p className="md:text-xl text-base text-[#9CA3AF] mb-10 fade fade-2">
      In just 10 minutes, Leave It Clear helps you organise and share essential personal, financial, and digital information—so nothing important is lost and no one is left guessing.
    </p>
...
<p className="text-sm text-[#9CA3AF]">Trusted by <span className="font-medium text-[#37B5A9]">35,000+</span> families worldwide</p>
</div>
</div>
</section>

<div className="max-w-3xl border-white/10 border-t mt-24 mr-auto mb-24 ml-auto"></div>

<section className="relative z-10 max-w-7xl md:px-10 mx-auto pt-24 pb-24 px-6" id="how-it-works">
...
<p className="max-w-2xl mx-auto text-center mt-4 text-[#9CA3AF] fade fade-2">
    Three simple steps to make sure everything important is documented, secure, and ready when it’s needed most.
  </p>

...
<nav className="w-full bg-[#0F172A] fixed top-0 z-40 border-[#1E293B] border-b">
...
<button aria-label="Toggle Theme" className="p-2 rounded hover:bg-[#1E293B] text-[#FACC15] focus:outline-none" onclick="toggleTheme()">
...
<button aria-label="Toggle Menu" className="md:hidden p-2" onclick="toggleMenu()">
...
<span className="">BTC/USD <span className="text-[#22C55E]">+1.2%</span> 43,150</span>
<span className="">EUR/USD <span className="text-[#22C55E]">1.0850</span></span>
<span className="">GBP/USD <span className="text-[#EF4444]">-0.15%</span> 1.2450</span>
<span>USD/JPY <span className="text-[#22C55E]">+0.07%</span> 143.20</span>
<span className="">XAU/USD <span className="text-[#EF4444]">-0.8%</span> 1915.00</span>
</div>
</div>
</nav>
...
<div className="bg-[#1E293B] flex flex-col items-center rounded-xl pt-6 pr-6 pb-6 pl-6 shadow">
<svg className="h-9 w-9 text-[#FACC15] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
...
<div className="bg-[#334155] rounded p-3 hover:bg-[#475569] transition cursor-pointer" onclick="alert('News expands to full story with related pairs highlighted.')">
...
<td>
<button className="text-[#FACC15] hover:underline" onclick="alert('Choose alert method: Telegram, Discord, Email')">Notify Me</button>
</td>
</tr>
<tr className="border-t border-[#334155] hover:bg-[#334155] transition">

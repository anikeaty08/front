...
<svg className="lucide lucide-menu h-4 w-4" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 12h16"></path><path d="M4 18h16"></path><path d="M4 6h16"></path></svg>
</button>
</div>
</nav>
</header>
...
<svg className="lucide lucide-eye" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    Explore Collections
                    <svg className="lucide lucide-arrow-right h-5 w-5 group-hover:translate-x-1 transition-transform" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
...
<svg className="lucide lucide-calendar" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg>
                    Book Consultation
                </button>
</div>
...
<div className="flex flex-col gap-2 text-slate-400 items-center cursor-pointer transition-all duration-300 hover:text-slate-600" onclick="document.getElementById('collections').scrollIntoView({behavior: 'smooth', block: 'start'})">
<span className="text-sm font-medium text-slate-600 tracking-wider">SCROLL</span>
<div className="w-px h-8 bg-slate-600"></div>
<svg className="lucide lucide-chevron-down animate-bounce w-[16px] h-[16px] text-slate-600 transition-colors duration-300" data-icon-replaced="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className="" d="m6 9 6 6 6-6"></path></svg>
</div>
</div>
</section>
...
<img alt="Spring Collection Hero" className="w-full h-full object-cover image-parallax group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0acba87b-568b-4948-8d56-d3e725650040_800w.jpg" style={{}}/>
...
<img alt="Formal Collection" className="w-full h-full object-cover image-parallax group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9473f3af-3f99-40ef-a58f-01b003f9d8b1_800w.jpg" style={{}}/>
<div className="absolute inset-0 bg-gradient-to-t to-transparent from-slate-900/40"></div>
<div className="absolute bottom-4 left-4 right-4 text-white">
...
<div className="mb-6 space-y-3">
<div className="flex items-center gap-3">
<svg duration-500"="" fill="none" height="16" stroke="currentColor" strokeLinecap="round" stroke-linejoin-slate-500="" strokeWidth="2" transition-colors="" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg>
...
<svg className="text-slate-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>
<span className="text-slate-600">Madison Avenue, NYC</span>
</li>
<li className="flex items-center gap-3">
<svg className="text-slate-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
<span className="text-slate-600">(555) 123-4567</span>
</li>
<li className="flex items-center gap-3">
<svg className="text-slate-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20" x="2" y="4"></rect><path d="m2 7 8.91 5.91a2 2 0 0 0 2.18 0L22 7"></path></svg>

...
<button className="px-6 py-3 bg-pink-500 text-white font-bold rounded-full shadow-lg transform hover:scale-110 transition-all duration-300 focus:outline-none ring-4 ring-pink-300" onclick="alert('🎉 Überraschung! Du bist jetzt Quatsch-Meister! 🦄')">
...
<button className="px-4 py-2 bg-blue-400 text-white rounded-lg font-bold shadow-lg hover:bg-blue-300 transition-all duration-300" onclick="confetti()">
        Konfetti! 🎉
      </button>
</div>
</div>

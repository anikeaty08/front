...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cce953ba-bb14-489b-b395-4f22267673e1_3840w.jpg")'}}></div>
...
<img alt="Profile" className="w-10 h-10 rounded-xl object-cover border border-white/30 group-hover:rotate-6 transition-transform duration-300" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8c334c60-c1c2-4306-8861-5b115655eb00_320w.jpg"/>
</button>
</div>
</div>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Ahri" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/585253c8-a642-4441-8b48-a7129af38e4a_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 pt-4 pr-4 pb-4 pl-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-blue-200 transition-colors duration-300">Ahri</h3>
<p className="text-xs text-white/70 mb-3 group-hover:text-white/90 transition-colors duration-300">The Nine-Tailed Fox</p>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Yasuo" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d58d888-b70d-4447-bffb-e8a323df8d16_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute top-3 left-3 px-3 py-1 bg-green-500/80 backdrop-blur-xl rounded-full text-xs text-white font-medium border border-green-400/30 animate-bounce-soft">FREE</div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-green-200 transition-colors duration-300">Yasuo</h3>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Jinx" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8aa4c77b-ff68-4e40-a3e1-517139da29de_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-pink-200 transition-colors duration-300">Jinx</h3>
<p className="text-xs text-white/70 mb-3 group-hover:text-white/90 transition-colors duration-300">The Loose Cannon</p>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Thresh" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cd6496a9-fd9e-428e-b2b3-1b35908d9d25_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute top-3 left-3 px-3 py-1 bg-green-500/80 backdrop-blur-xl rounded-full text-xs text-white font-medium border border-green-400/30 animate-bounce-soft">FREE</div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-cyan-200 transition-colors duration-300">Thresh</h3>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Lee Sin" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/85cb6a1c-4a80-40ce-93f6-2973adb241d4_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-orange-200 transition-colors duration-300">Lee Sin</h3>
<p className="text-xs text-white/70 mb-3 group-hover:text-white/90 transition-colors duration-300">The Blind Monk</p>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Lux" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/071f0f74-e190-4f94-93fb-223ca6938511_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute top-3 left-3 px-3 py-1 bg-green-500/80 backdrop-blur-xl rounded-full text-xs text-white font-medium border border-green-400/30 animate-bounce-soft">FREE</div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-yellow-200 transition-colors duration-300">Lux</h3>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Darius" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/05e3e53f-e4cc-4941-8fa1-f22b5b9379f1_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-red-200 transition-colors duration-300">Darius</h3>
<p className="text-xs text-white/70 mb-3 group-hover:text-white/90 transition-colors duration-300">The Hand of Noxus</p>
...
<div className="bg-white/10 backdrop-blur-3xl rounded-3xl border border-white/20 overflow-hidden shadow-xl hover:shadow-2xl hover:border-white/40 transition-all duration-500 hover:bg-white/15">
<div className="aspect-square relative overflow-hidden">
<img alt="Ezreal" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/256db67a-9160-4421-b6ad-10cd2d386754_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
<div className="absolute top-3 left-3 px-3 py-1 bg-green-500/80 backdrop-blur-xl rounded-full text-xs text-white font-medium border border-green-400/30 animate-bounce-soft">FREE</div>
<div className="absolute bottom-0 left-0 right-0 p-4">
<h3 className="font-semibold text-white mb-1 group-hover:text-blue-200 transition-colors duration-300">Ezreal</h3>

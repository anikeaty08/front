...
!function(){if(!window.UnicornStudio){window.UnicornStudio={isInitialized:!1};var i=document.createElement("script");i.src="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.29/dist/unicornStudio.umd.js",i.onload=function(){window.UnicornStudio.isInitialized||(UnicornStudio.init(),window.UnicornStudio.isInitialized=!0)},(document.head || document.body).appendChild(i)}}();
  ...
  return (
    <>
      <div className="absolute w-full h-[816px] left-0 top-0 -z-10" data-us-project="Vpa6JQ9WnxiC9cgDUWnu"></div>
...
<span className="text-sm sm:text-base font-medium tracking-tight">Jordan Lee</span>
</a>

<div className="hidden md:flex items-center gap-6">
<a className="text-sm text-gray-700 hover:text-gray-900 tracking-tight" href="#work">Work</a>
<a className="text-sm text-gray-700 hover:text-gray-900 tracking-tight" href="#about">About</a>
<a className="text-sm text-gray-700 hover:text-gray-900 tracking-tight" href="#skills">Skills</a>
<a className="text-sm text-gray-700 hover:text-gray-900 tracking-tight" href="#contact">Contact</a>
</div>

<div className="flex items-center gap-2">
<a className="hidden sm:inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-sm font-medium tracking-tight text-gray-900 bg-white hover:bg-gray-50 border border-gray-200 shadow-sm" href="#">
...
<span className="tracking-tighter" data-letter="" style={{display: 'inline-block', transform: 'translateY(0px)', opacity: '1'}}>Jordan</span>
<span className="block"></span>
<span className="tracking-tighter" data-letter="" style={{display: 'inline-block', transform: 'translateY(0px)', opacity: '1'}}>Lee</span>
</span>
</h1>
<p className="sm:mt-5 sm:text-3xl leading-relaxed max-w-2xl mix-blend-luminosity brightness-200 text-base text-gray-700 tracking-tight mt-4">
...
<div className="flex items-start gap-3 border-t border-black/5 pt-4">
<svg className="lucide lucide-monitor w-[18px] h-[18px] text-gray-400 mt-0.5" data-lucide="monitor" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20" x="2" y="3"></rect><line x1="8" x2="16" y1="21" y2="21"></line><line x1="12" x2="12" y1="17" y2="21"></line></svg>
<div className="">
<p className="text-sm font-medium tracking-tight">Product Design + Frontend</p>
...
<svg className="lucide lucide-check w-[18px] h-[18px] text-gray-400 mt-0.5" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<div className="">
<p className="text-sm font-medium tracking-tight">Currently available</p>
<p className="text-xs text-gray-500 mt-0.5">Starting mid‑September</p>
</div>
</div>
</div>
</div>
<div className="lg:col-span-5">
<div className="relative aspect-[4/5] sm:aspect-[5/6] overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.08)] bg-white rounded-3xl">
<img alt="Portrait of Jordan Lee" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5180d964-2425-4134-8220-c1528af09124_800w.jpg" style={{filter: 'grayscale(100%) saturate(0) contrast(1.05)'}}/>
...
<div className="text-lg font-semibold tracking-tight text-white">120+</div>
</div>
...
<div className="flex items-center gap-2 mb-1">
<div className="w-2 h-2 rounded-full bg-white/50"></div>
<div className="text-lg font-semibold tracking-tight text-white">8 yrs</div>
</div>
...
<p className="text-[11px] text-white/70">Startups</p>
</div>
</div>
</div>
</div>
...
<section className="max-w-7xl sm:px-6 sm:mt-20 border-black/5 border-t mt-16 mr-auto ml-auto pt-10 pr-4 pl-4" id="work">
<div className="flex items-center justify-between">
<h2 className="text-xl sm:text-2xl tracking-tight">Recent Work</h2>
<a className="inline-flex items-center gap-2 text-sm tracking-tight text-gray-700 hover:text-gray-900" href="#">
...
<article className="group overflow-hidden rounded-2xl border border-black/5 bg-white">
<div className="relative aspect-[16/10]">
<img alt="Fintech dashboard design" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6595dc59-1c6b-45fa-b6fa-596b47a99f7c_800w.jpg"/>
...
<h3 className="mt-2 text-base font-semibold tracking-tight">Atlas Analytics</h3>
<p className="text-sm text-gray-600 mt-1">Realtime dashboard for a fintech platform.</p>
</div>
</article>

<article className="group overflow-hidden rounded-2xl border border-black/5 bg-white">
<div className="relative aspect-[16/10]">
<img alt="Mobile app design" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b2935f88-b46a-4628-bd14-9d912c5060ee_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent"></div>
</div>
<div className="p-4 border-t border-black/5">
<div className="flex items-center gap-2 text-xs text-gray-500">
...
<h3 className="mt-2 text-base font-semibold tracking-tight">Tempo Health</h3>
<p className="text-sm text-gray-600 mt-1">Companion app for remote care.</p>
</div>
</article>

<article className="group overflow-hidden rounded-2xl border border-black/5 bg-white">
<div className="relative aspect-[16/10]">
<img alt="Marketing website design" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/109e8c99-f7f6-4bd2-8398-d4646bff4b4f_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent"></div>
</div>
<div className="p-4 border-t border-black/5">
<div className="flex items-center gap-2 text-xs text-gray-500">
...
<h3 className="mt-2 text-base font-semibold tracking-tight">Nexus Commerce</h3>
<p className="text-sm text-gray-600 mt-1">High‑converting storefront experience.</p>
</div>
</article>
</div>
</section><section className="max-w-7xl sm:px-6 sm:mt-24 mt-16 mr-auto mb-16 ml-auto pt-10 pr-4 pl-4" id="contact">
...
<p className="text-lg text-white/70 max-w-2xl mx-auto">I've partnered with startups and Fortune 500s to design and build digital products that scale</p>
<div className="mt-8 pt-8 pr-6 pb-6 pl-6">
<div className="text-center">
<p className="uppercase text-sm font-medium text-zinc-400 tracking-wide">Companies I've worked with</p>
</div>
...
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Design Systems</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Product Strategy</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Prototyping</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Accessibility</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">React</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">TypeScript</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Next.js</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Framer Motion</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Data Visualization</span>
<span className="px-2.5 py-1 text-xs rounded-md bg-white/10 border border-white/10">Performance</span>
</div>
</div>
<div className="rounded-2xl border border-white/10 bg-white/5 p-4">
<div className="flex items-center gap-2">
...
<svg className="lucide lucide-building-2 w-4 h-4 text-white/70 mt-0.5" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path><path d="M10 6h4"></path><path d="M10 10h4"></path><path d="M10 14h4"></path><path d="M10 18h4"></path></svg>
<div className="">
<p className="text-sm font-medium tracking-tight">Senior Product Designer • Atlas Analytics</p>
<p className="text-xs text-white/60">2022 — 2024 · Led design system and multi-tenant analytics</p>
</div>
</li>
<li className="flex items-start gap-3">
<svg className="lucide lucide-building-2 w-4 h-4 text-white/70 mt-0.5" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path><path d="M10 6h4"></path><path d="M10 10h4"></path><path d="M10 14h4"></path><path d="M10 18h4"></path></svg>
<div className="">
<p className="text-sm font-medium tracking-tight">Product Designer • Tempo Health</p>
<p className="text-xs text-white/60">2019 — 2022 · Care workflows, mobile companion app</p>
</div>
</li>
<li className="flex items-start gap-3">
<svg className="lucide lucide-building-2 w-4 h-4 text-white/70 mt-0.5" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path><path d="M10 6h4"></path><path d="M10 10h4"></path><path d="M10 14h4"></path><path d="M10 18h4"></path></svg>
<div>
<p className="text-sm font-medium tracking-tight">Frontend Engineer • Nexus Commerce</p>
<p className="text-xs text-white/60">2017 — 2019 · Storefront UI, performance, A/B testing</p>
</div>
</li>
</ul>
</div>
...
<p className="text-sm font-medium tracking-tight">Independent — Designer &amp; Engineer</p>
</li>
<li className="relative pl-6 pb-4 border-l border-white/10">
...
<p className="text-xs text-white/60">2019 — 2022</p>
<p className="text-sm font-medium tracking-tight">Product Designer — Tempo Health</p>
</li>
...
<p className="text-xs text-white/60">2017 — 2019</p>
<p className="text-sm font-medium tracking-tight">Frontend Engineer — Nexus Commerce</p>
</li>
</ol>
</div>
</div>
<p className="mt-6 text-center text-[11px] text-white/60">© <span id="year">2025</span> Jordan Lee — Available for freelance &amp; contracts</p>
</div>
</div>
</section>

<section className="max-w-7xl mx-auto px-4 sm:px-6 mt-16 sm:mt-20 pt-10 border-t border-black/5" id="about">
...
<img alt="Workspace" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f0f33052-7e87-44a7-9c52-a02692aceec9_800w.jpg"/>
...
<div className="">
<h3 className="text-sm font-medium tracking-tight text-gray-900">Recent Focus Areas</h3>
...
<div className="">
<h3 className="text-sm font-medium tracking-tight text-gray-900">Notable Clients</h3>
<p className="mt-1 text-sm text-gray-600">Stripe, Linear, Notion, early-stage YC companies, and Fortune 500 enterprises</p>
</div>
</div>
...
<p className="text-[11px] text-gray-500 mt-0.5">Clients</p>
</div>
</div>
<div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
<h3 className="text-sm font-medium tracking-tight text-gray-900 mb-2">Currently Learning</h3>
<p className="text-sm text-gray-600">Exploring AI-powered design tools, advanced animation techniques with Framer Motion, and WebGL for interactive experiences.</p>
</div>
<div className="mt-6 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight text-white bg-gray-900 hover:bg-gray-800 border border-gray-900">
...
<section className="max-w-7xl sm:px-6 sm:mt-20 border-black/5 border-t mt-16 mr-auto ml-auto pt-10 pr-4 pl-4" id="skills">
<div className="flex items-end justify-between">
<h2 className="text-2xl sm:text-3xl tracking-tight">Skills &amp; Expertise</h2>
<p className="hidden sm:block text-xs text-gray-500">Tools, technologies &amp; focus areas</p>
</div>
<div className="mt-6 space-y-8">

<div>
<h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
<svg className="text-gray-600" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
        Design &amp; Strategy
      </h3>
<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
<div className="font-medium">Design Systems</div>
<div className="text-xs text-gray-500 mt-0.5">Advanced</div>
</div>
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
<div className="font-medium">Figma</div>
<div className="text-xs text-gray-500 mt-0.5">Expert</div>
</div>
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
...
<div className="text-xs text-gray-500 mt-0.5">Intermediate</div>
</div>
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
...
<div>
<h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
<svg className="text-gray-600" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
...
<div>
<h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
<svg className="text-gray-600" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z"></path><path d="M13 13l6 6"></path></svg>
        Specializations
      </h3>
<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
...
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
<div className="font-medium">System Thinking</div>
<div className="text-xs text-gray-500 mt-0.5">Advanced</div>
</div>
<div className="rounded-xl border border-black/5 bg-white px-3 py-2.5 text-sm">
...
<h3 className="text-sm font-semibold text-gray-900 mb-4">Recent Learning &amp; Certifications</h3>
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
<div className="flex items-start gap-3">
<div className="w-2 h-2 rounded-full bg-green-500 mt-2"></div>
<div>
<div className="text-sm font-medium">WCAG 2.1 AA Certification</div>
<div className="text-xs text-gray-500">Web Accessibility Guidelines • 2024</div>
</div>
</div>
<div className="flex items-start gap-3">
...
<div className="text-xs text-gray-500">Epic React by Kent C. Dodds • 2024</div>
</div>
</div>
<div className="flex items-start gap-3">
<div className="w-2 h-2 rounded-full bg-purple-500 mt-2"></div>
<div>
<div className="text-sm font-medium">Design System Architecture</div>
<div className="text-xs text-gray-500">Independent study • 2023</div>
</div>
</div>
<div className="flex items-start gap-3">
<div className="w-2 h-2 rounded-full bg-orange-500 mt-2"></div>
<div>
<div className="text-sm font-medium">WebGL Fundamentals</div>
<div className="text-xs text-gray-500">Three.js &amp; Interactive Graphics • 2024</div>
</div>
</div>
</div>
</div>
...
<section className="max-w-7xl sm:px-6 sm:mt-24 border-black/5 border-t mt-16 mr-auto mb-16 ml-auto pt-10 pr-4 pl-4" id="contact">
...
<span className="break-all">hello@jordan.design</span>
</a>
</div>
<div className="md:pl-8">
<p className="text-sm text-white/70">Schedule</p>
<a className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium tracking-tight text-gray-900 bg-white hover:bg-white/90 border border-white/10 mt-2" href="#">

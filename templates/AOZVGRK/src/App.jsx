...
<button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-neutral-400 hover:text-white transition-colors" onclick="togglePassword()" type="button">
...
<div className="biometric-scanner" onclick="startBiometricScan()">
...
<button className="login-button w-full text-white font-medium relative overflow-hidden" onclick="handleLogin(event)" type="submit">

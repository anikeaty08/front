...
<![CDATA[
            ...
            const N = 200, WIDTH = 380, HEIGHT = 240, DOT_R = 1, MARGIN = 20;
            const CX = WIDTH/2, CY = HEIGHT/2, MAX_R = Math.min(CX, CY) - MARGIN - DOT_R;
            ...
            for(let i=0; i<N; i++) {
              ...
              animO.setAttribute("values","0.33;0.8;0.33");
...
<div className="relative w-[380px] h-[240px] rounded-2xl shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden border border-zinc-200 bg-white">

<div className="absolute inset-0 z-0">
<svg className="block" height="240" viewbox="0 0 380 240" width="380">
<rect fill="white" height="240" rx="16" ry="16" width="380"></rect>
<g>
...
<div className="absolute inset-0 p-6 text-gray-800 flex flex-col justify-between z-10">
...
<span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">SPIRAL</span>
</div>
</div>

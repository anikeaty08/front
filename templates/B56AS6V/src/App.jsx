...
<span className="w-5 h-5 rounded-lg border border-neutral-300 peer-checked:border-indigo-500 peer-checked:bg-indigo-500 transition-all flex items-center justify-center">

...
<span className="text-base font-bold tracking-tight">MATES</span>
</a>
...
<button className="inline-flex items-center gap-2 rounded-md px-3.5 py-2 text-sm font-medium transition hover:opacity-90" style={{backgroundColor: '#f1cb59', color: '#000000'}}>
...
<div className="max-w-7xl sm:px-6 lg:px-8 bg-white border border-white mr-auto ml-auto pt-8 pr-4 pb-20 pl-4">
...
<p className="text-sm font-medium mb-2" style={{color: '#ec7997'}}>Featured</p>
<h1 className="sm:text-5xl text-4xl font-semibold tracking-tight">MATES COMMUNITY MX
¡TU COMMUNIDAD EN CDMX!</h1>
<p className="mt-4 text-base text-neutral-200/90 max-w-xl">
                A celebration of sound and culture bringing together musicians and enthusiasts from across the region. Explore live shows, art, food, and immersive installations.
              </p>
</div>

<div className="mt-12">
<div className="mx-auto max-w-4xl">
<div className="bg-white/10 border-white/15 border rounded-2xl pt-2 pr-2 pb-2 pl-2 backdrop-blur">
...
<div className="p-6">
<h2 className="text-2xl font-semibold tracking-tight text-black">The Citywide Art Festival</h2>
<p className="mt-3 text-sm text-black/50">
                Three days of exhibitions, music, and interactive installations with artists from around the world.
              </p>
<ul className="mt-5 space-y-2 text-sm text-black">
<li className="flex items-start gap-2">
<svg className="lucide lucide-palette mt-0.5 h-4 w-4" data-lucide="palette" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: '#ec7997'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 22a1 1 0 0 1 0-20 10 9 0 0 1 10 9 5 5 0 0 1-5 5h-2.25a1.75 1.75 0 0 0-1.4 2.8l.3.4a1.75 1.75 0 0 1-1.4 2.8z"></path><circle cx="13.5" cy="6.5" fill="currentColor" r=".5"></circle><circle cx="17.5" cy="10.5" fill="currentColor" r=".5"></circle><circle cx="6.5" cy="12.5" fill="currentColor" r=".5"></circle><circle cx="8.5" cy="7.5" fill="currentColor" r=".5"></circle></svg>
                  A diverse array of contemporary and classic works.
                </li>
<li className="flex items-start gap-2">
<svg className="lucide lucide-music-4 mt-0.5 h-4 w-4" data-lucide="music-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: '#ec7997'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M9 18V5l12-2v13"></path><path d="m9 9 12-2"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
                  Live performances across multiple stages.
                </li>
<li className="flex items-start gap-2">
<svg className="lucide lucide-cup-soda mt-0.5 h-4 w-4" data-lucide="cup-soda" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: '#ec7997'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 8 1.75 12.28a2 2 0 0 0 2 1.72h4.54a2 2 0 0 0 2-1.72L18 8"></path><path d="M5 8h14"></path><path d="M7 15a6.47 6.47 0 0 1 5 0 6.47 6.47 0 0 0 5 0"></path><path d="m12 8 1-6h2"></path></svg>
                  Food market with local favorites and pop-ups.
                </li>
</ul>
...
<svg className="lucide lucide-map h-4 w-4" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z"></path><path d="M15 5.764v15"></path><path d="M9 3.236v15"></path></svg>
                  City Park &amp; Downtown Civic Center
                </div>
<div className="flex items-center gap-2 text-black/50">
...
<button className="inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition hover:opacity-90" style={{backgroundColor: '#f1cb59', color: '#000000'}}>
<svg className="lucide lucide-ticket h-4 w-4" data-lucide="ticket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"></path><path d="M13 5v2"></path><path d="M13 17v2"></path><path d="M13 11v2"></path></svg> Get tickets
                </button>
<button className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-black/5 px-4 py-2 text-sm text-black hover:bg-white/10 transition">
<svg className="lucide lucide-bookmark-plus h-4 w-4" data-lucide="bookmark-plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path><line x1="12" x2="12" y1="7" y2="13"></line><line x1="15" x2="9" y1="10" y2="10"></line></svg> Save
                </button>
</div>
<div className="mt-8">
<h3 className="text-sm font-medium text-black mb-3">Tags</h3>
<div className="flex flex-wrap gap-2">
<span className="px-3 py-1.5 text-xs rounded-full bg-black/5 border border-white/10 text-black/60">art</span>
<span className="px-3 py-1.5 text-xs rounded-full bg-black/5 border border-white/10 text-black/60">citywide</span>
<span className="px-3 py-1.5 text-xs rounded-full bg-black/5 border border-white/10 text-black/60">music</span>
<span className="px-3 py-1.5 text-xs rounded-full bg-black/5 border border-white/10 text-black/60">outdoor</span>
</div>
</div>
</div>
</div>
...
<div className="relative">
<img alt="Art festival lights" className="h-40 w-full object-cover" src="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<span className="absolute left-3 top-3 text-[11px] font-medium px-2.5 py-1 rounded-full" style={{backgroundColor: '#f1cb59', color: '#000000'}}>12 May</span>
</div>
...
<span className="text-sm text-bold text-[#ec7997]">$25</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
...
<span className="absolute left-3 top-3 text-[11px] font-medium px-2.5 py-1 rounded-full" style={{backgroundColor: '#f1cb59', color: '#000000'}}>12 May</span>
<span className="absolute right-3 top-3 text-[11px] font-medium text-white px-2.5 py-1 rounded-full" style={{backgroundColor: '#ec7997'}}>Coming soon</span>
</div>
<div className="pt-4 pr-4 pb-4 pl-4">
...
<div className="mt-3 flex items-center justify-between">
<span className="text-sm text-bold text-[#ec7997]">Free</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
...
<div className="mt-3 flex items-center justify-between">
<span className="text-sm text-bold text-[#ec7997]">$39</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
<svg className="lucide lucide-plus h-3.5 w-3.5" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg> Add
                              </button>
</div>
...
<span className="absolute left-3 top-3 text-[11px] font-medium px-2.5 py-1 rounded-full" style={{backgroundColor: '#f1cb59', color: '#000000'}}>12 May</span>
<span className="absolute right-3 top-3 text-[11px] font-medium text-white px-2.5 py-1 rounded-full" style={{backgroundColor: '#ec7997'}}>Save 30%</span>
</div>
<div className="pt-4 pr-4 pb-4 pl-4">
...
<div className="mt-3 flex items-center justify-between">
<span className="text-sm text-bold text-[#ec7997]">$49</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
<svg className="lucide lucide-eye h-3.5 w-3.5" data-lucide="eye" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></svg> Details
                              </button>
</div>
...
<article className="rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 shadow-xl">
<div className="relative">
<img alt="City street food market" className="h-40 w-full object-cover" src="https://images.unsplash.com/photo-1461782296612-699cc4f252a7?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<span className="absolute left-3 top-3 text-[11px] font-medium px-2.5 py-1 rounded-full" style={{backgroundColor: '#f1cb59', color: '#000000'}}>18 May</span>
</div>
<div className="pt-4 pr-4 pb-4 pl-4">
...
<div className="mt-3 flex items-center justify-between">
<span className="text-sm text-bold text-[#ec7997]">$5</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
<svg className="lucide lucide-plus h-3.5 w-3.5" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg> Add
                              </button>
</div>
...
<span className="absolute left-3 top-3 text-[11px] font-medium px-2.5 py-1 rounded-full" style={{backgroundColor: '#f1cb59', color: '#000000'}}>21 May</span>
</div>
<div className="pt-4 pr-4 pb-4 pl-4">
...
<div className="mt-3 flex items-center justify-between">
<span className="text-sm text-bold text-[#ec7997]">$29</span>
<button className="inline-flex items-center gap-1.5 text-sm text-black gap-2 rounded-lg border border-white/10 bg-black/5 px-3 py-2 hover:bg-white/10">
<svg className="lucide lucide-plus h-3.5 w-3.5" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg> Add
                              </button>
</div>

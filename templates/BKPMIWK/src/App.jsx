...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('sarah')">Read full</button>
</div>
...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('aom')">Read full</button>
</div>
...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('daniel')">Read full</button>
</div>
...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('nok')">Read full</button>
</div>
...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('marcus')">Read full</button>
</div>
...
<button className="text-xs text-violet-400 hover:text-violet-300 transition-colors" onclick="openModal('lisa')">Read full</button>
</div>
</div>
</div>
...
<button className="text-white/60 hover:text-white transition-colors" onclick="closeModal()">

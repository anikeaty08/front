...
<li className="">
<button className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 transition-colors" onclick="toggleSub('categories')">
...
<div className="mt-6">
<button className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 transition-colors" onclick="toggleSub('following')">
<div className="flex items-center space-x-3">

...
<svg className="lucide lucide-search text-gray-500 hover:text-gray-700" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m21 21-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></svg>
<svg className="lucide lucide-bell text-gray-500 hover:text-gray-700" data-lucide="bell" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10.268 21a2 2 0 0 0 3.464 0"></path><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"></path></svg>
</div>
</div>
<div className="mx-6 mt-5 p-6 rounded-2xl bg-gradient-to-br from-violet-200 to-violet-400/80 relative overflow-hidden">
<div %3e%3c="" %3e%3ccircle="" %3e%3cg="" 60"="" className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width= bg-[url(https://images.unsplash.com/photo-1676022763096-a1ad12b2e370?w=1080&amp;q=80)] bg-cover" cx="30" cy="30" fill="none" fillOpacity="0.1" fill-rule="evenodd" g%3e%3c="" height="60" opacity-30"="" r="2" svg%3e')]="" viewbox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"></div>
...
<svg className="lucide lucide-trending-up text-violet-900 w-5 h-5" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 7h6v6"></path><path d="m22 7-8.5 8.5-5-5L2 17"></path></svg>
</div>
</div>
</div>
...
<div className="flex items-center gap-4">
<svg className="lucide lucide-plus text-gray-500 hover:text-gray-700" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
...
<svg className="lucide lucide-code w-4 h-4 text-violet-600 mt-0.5" data-lucide="code" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 18 6-6-6-6"></path><path d="m8 6-6 6 6 6"></path></svg>
<div className="">
...
<svg className="lucide lucide-arrow-left text-gray-700 hover:text-gray-900" data-lucide="arrow-left" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m12 19-7-7 7-7"></path><path d="M19 12H5"></path></svg>
...
<div %3e%3c="" %3e%3cg="" %3e%3cpath="" 40"="" className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width= bg-[url(https://images.unsplash.com/photo-1661092133357-e50572adedc1?w=1080&amp;q=80)] bg-cover" d="M20 20c0-5.5-4.5-10-10-10s-10 4.5-10 10 4.5 10 10 10 10-4.5 10-10z" fill="none" fillOpacity="0.15" fill-rule="evenodd" g%3e%3c="" height="40" opacity-40"="" svg%3e')]="" viewbox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"></div>
<div className="relative z-10 flex items-center gap-3">
<svg className="lucide lucide-code w-5 h-5 text-emerald-900" data-lucide="code" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 18 6-6-6-6"></path><path d="m8 6-6 6 6 6"></path></svg>
...
<div className="flex-shrink-0 w-32 bg-white rounded-2xl p-4 text-center border border-gray-100">
<svg className="lucide lucide-users mx-auto w-5 h-5 text-gray-600" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>
...
<div className="flex-shrink-0 w-32 bg-white rounded-2xl p-4 text-center border border-gray-100">
<svg className="lucide lucide-bar-chart-3 mx-auto w-5 h-5 text-gray-600" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>
...
<div className="flex items-center justify-between bg-white p-4 rounded-xl border border-gray-100">
<div className="flex items-center gap-3">
<svg className="lucide lucide-circle w-5 h-5 text-gray-300" data-lucide="circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle></svg>
<div className="">
...
<g className="">
<rect className="" fill="#8b5cf6" height="8%" rx="4" width="45%" x="15%" y="15%"></rect>
<rect className="" fill="#06d6a0" height="8%" rx="4" width="35%" x="25%" y="35%"></rect>
<rect className="" fill="#f72585" height="8%" rx="4" width="40%" x="45%" y="55%"></rect>
<rect className="" fill="#ffd166" height="8%" rx="4" width="30%" x="35%" y="75%"></rect>
</g>
</svg>

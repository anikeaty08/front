...
<div className="absolute inset-0 bg-gray-400" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&amp', backgroundSize: 'cover', backgroundPosition: 'center'}}></div>
...
<div className="w-12 h-12 bg-gray-400 rounded-full border-2 border-green-800" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&amp', backgroundSize: 'cover'}}></div>
<div className="w-12 h-12 bg-gray-400 rounded-full border-2 border-green-800" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&amp', backgroundSize: 'cover'}}></div>
<div className="w-12 h-12 bg-gray-400 rounded-full border-2 border-green-800" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&amp', backgroundSize: 'cover'}}></div>
<div className="w-12 h-12 bg-gray-400 rounded-full border-2 border-green-800" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&amp', backgroundSize: 'cover'}}></div>
</div>
<div>

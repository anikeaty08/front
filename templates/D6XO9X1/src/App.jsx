...
export default function App() {
  ...
  return (
    <>
      <div className="spline-container fixed top-0 w-full h-screen -z-10" data-parallax="0.2" style={{transform: 'translate3d(0px, 0px, 0px)'}}><iframe frameborder="0" height="100%" src="https://my.spline.design/flowingribbon-TlkEaNrvCCNZuJBNJN3LXpRF" width="100%"></iframe></div>

<div className="fixed inset-0 pointer-events-none z-50" id="cursor-trail"><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1473px', top: '497px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1473px', top: '498px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1473px', top: '501px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(192, 132, 252)', left: '1473px', top: '514px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(124, 58, 237)', left: '1473px', top: '520px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(124, 58, 237)', left: '1471px', top: '525px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1470px', top: '530px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(251, 191, 36)', left: '1466px', top: '535px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(251, 191, 36)', left: '1270px', top: '250px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(217, 119, 6)', left: '1281px', top: '264px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(252, 211, 77)', left: '1282px', top: '269px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1281px', top: '274px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(192, 132, 252)', left: '1280px', top: '279px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(245, 158, 11)', left: '1279px', top: '280px', opacity: '0.8', transform: 'scale(1)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(139, 92, 246)', left: '1064px', top: '147px', opacity: '0', transform: 'scale(0.2) translate(14.4782px, -3.14887px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(251, 191, 36)', left: '996px', top: '138px', opacity: '0', transform: 'scale(0.2) translate(14.6817px, 13.4204px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(168, 85, 247)', left: '738px', top: '98px', opacity: '0', transform: 'scale(0.2) translate(2.41603px, 0.826074px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(217, 119, 6)', left: '715px', top: '92px', opacity: '0', transform: 'scale(0.2) translate(14.1508px, 2.36184px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(124, 58, 237)', left: '629px', top: '66px', opacity: '0', transform: 'scale(0.2) translate(0.659973px, 4.30275px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(217, 119, 6)', left: '565px', top: '47px', opacity: '0', transform: 'scale(0.2) translate(-6.51904px, 0.613066px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(251, 191, 36)', left: '522px', top: '27px', opacity: '0', transform: 'scale(0.2) translate(2.98238px, 17.2219px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(139, 92, 246)', left: '520px', top: '25px', opacity: '0', transform: 'scale(0.2) translate(-3.1274px, 15.778px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div><div style={{position: 'absolute', pointerEvents: 'none', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: 'rgb(217, 119, 6)', left: '528px', top: '11px', opacity: '0', transform: 'scale(0.2) translate(17.3714px, 3.78693px)', transition: '0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67)', zIndex: '60'}}></div></div>
...
<div className="absolute inset-0 opacity-[0.03]" data-parallax="0.3" style={{backgroundImage: 'linear-gradient(to right, rgb(139, 69, 19) 1px, transparent 1px), linear-gradient(rgb(79, 70, 229) 1px, transparent 1px)', backgroundSize: '60px 60px', transform: 'translate3d(0px, 0px, 0px)'}}></div>

<div className="absolute left-[10%] top-[30%] size-2 rounded-full blur-[2px] animate-bounce bg-violet-400" data-parallax="0.4" style={{transform: 'translate3d(0px, 0px, 0px)'}}></div>
<div className="absolute right-[18%] top-[22%] size-2 rounded-full blur-[2px] animate-bounce bg-amber-400" data-parallax="0.5" style={{animationDelay: '0.6s', transform: 'translate3d(0px, 0px, 0px)'}}></div>
<div className="absolute right-[30%] bottom-[18%] size-2 rounded-full blur-[2px] animate-bounce bg-violet-500" data-parallax="0.3" style={{animationDelay: '1.2s', transform: 'translate3d(0px, 0px, 0px)'}}></div>
<div className="absolute left-[22%] bottom-[12%] size-2 rounded-full blur-[2px] animate-bounce bg-amber-500" data-parallax="0.4" style={{animationDelay: '0.3s', transform: 'translate3d(0px, 0px, 0px)'}}></div>
</div>

<header className="sticky top-0 z-30 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80 border-b border-gray-200/80 animate-fade-in-down" style={{animationPlayState: 'running'}}>
...
<div className="space-y-7 animate-fade-in-left" style={{animationPlayState: 'running'}}>
<div className="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-[11px] uppercase tracking-[0.12em] border-violet-200 bg-violet-50 text-violet-800 animate-fade-in-up" style={{animationDelay: '0.1s', animationPlayState: 'running'}}>
<span className="h-1 w-1 rounded-full bg-gradient-to-r to-amber-700 from-violet-700"></span>
            Next-Gen Coaching
          </div>
<h1 className="text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl text-gray-900 animate-fade-in-up" style={{animationDelay: '0.2s', animationPlayState: 'running'}}>
...
<p className="max-w-xl text-gray-600 animate-fade-in-up" style={{animationDelay: '0.3s', animationPlayState: 'running'}}>
...
<div className="flex flex-wrap items-center gap-3 pt-2 animate-fade-in-up" style={{animationDelay: '0.4s', animationPlayState: 'running'}}>
...
<div className="mt-8 flex flex-wrap items-center gap-8 text-xs text-gray-600 animate-fade-in-up" style={{animationDelay: '0.5s', animationPlayState: 'running'}}>
...
<div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border ring-1 shadow-xl border-gray-200 bg-white ring-gray-100 animate-fade-in-right" data-parallax="0.1" style={{animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="group relative animate-fade-in-left" data-parallax="0.1" style={{animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="relative animate-fade-in-right" style={{animationPlayState: 'running'}}>
<div className="pointer-events-none absolute -inset-10 -z-10 bg-[radial-gradient(400px_200px_at_20%_30%,rgba(79,70,229,0.08),transparent_60%)]" data-parallax="0.2" style={{transform: 'translate3d(0px, 0px, 0px)'}}></div>
<h2 className="text-3xl font-semibold tracking-tight sm:text-4xl text-gray-900">Your Coach, Your Edge.</h2>
<p className="max-w-xl text-gray-600 mt-4">I blend performance coaching, habit design, and nutritional science to engineer breakthroughs. Expect structured phases, progressive overload, mobility foundations, and precise macro frameworks delivered with accountability and clarity.</p>
<div className="mt-8 grid gap-6 sm:grid-cols-2">
<div className="group relative rounded-xl border p-5 ring-1 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg border-gray-200 bg-white ring-gray-100 hover:border-violet-300 before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-up" style={{animationDelay: '0.3s', animationPlayState: 'running'}}>
...
<div className="group relative rounded-xl border p-5 ring-1 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg border-gray-200 bg-white ring-gray-100 hover:border-amber-300 before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-up" style={{animationDelay: '0.4s', animationPlayState: 'running'}}>
<div className="flex items-center gap-3 relative z-10">
...
<div className="mt-10 flex flex-wrap gap-4 text-sm text-gray-700 animate-fade-in-up" style={{animationDelay: '0.5s', animationPlayState: 'running'}}>
...
<div className="animate-fade-in-up" style={{animationPlayState: 'running'}}>
...
<a className="group relative hidden items-center gap-2 rounded-lg border px-4 py-2 text-sm transition-colors md:inline-flex border-gray-200 bg-white hover:text-gray-900 hover:border-violet-300 text-gray-700 shadow-sm before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-lg animate-fade-in-up" href="#cta" style={{animationDelay: '0.1s', animationPlayState: 'running'}}>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.1s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.2s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
<div className="pointer-events-none absolute -inset-[1px] rounded-2xl bg-gradient-to-r to-amber-700 from-violet-700 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
<div className="absolute -inset-6 rounded-2xl bg-gradient-to-r to-amber-600/20 from-violet-600/20 opacity-0 blur-2xl transition-all duration-500 group-hover:opacity-100"></div>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
<div className="pointer-events-none absolute -inset-[1px] rounded-2xl bg-gradient-to-r to-amber-700 from-violet-700 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
<div className="absolute -inset-6 rounded-2xl bg-gradient-to-r to-amber-600/20 from-violet-600/20 opacity-0 blur-2xl transition-all duration-500 group-hover:opacity-100"></div>
<div className="relative h-full rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 hover:shadow-violet-500/10">
<div className="mb-5 flex items-center justify-between">
...
<p className="text-sm text-gray-600 mt-2">High-energy sessions, community push, and coaching at scale where progress becomes contagious.</p>
<div className="mt-6 flex items-center gap-2 text-sm text-gray-700">
...
<div className="hidden items-center gap-2 md:flex animate-fade-in-up" style={{animationDelay: '0.1s', animationPlayState: 'running'}}>
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.1s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.2s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
<div className="flex items-center gap-4 relative z-10">
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
<div className="flex items-center gap-4 relative z-10">
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.4s', animationPlayState: 'running', transform: 'translate3d(0px, 0px, 0px)'}}>
<div className="flex items-center gap-4 relative z-10">
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.1s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.2s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.3s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.4s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="absolute inset-0 bg-[radial-gradient(ellipse_1000px_400px_at_50%_200px,rgba(139,69,19,0.15),transparent_70%),radial-gradient(ellipse_800px_300px_at_80%_-100px,rgba(79,70,229,0.1),transparent_70%)]" data-parallax="0.1" style={{transform: 'translate3d(0px, 0px, 0px)'}}></div>
<div className="relative max-w-5xl text-center mr-auto ml-auto pt-24 pr-6 pb-24 pl-6">
<h2 className="mx-auto max-w-3xl text-4xl font-semibold tracking-tight sm:text-5xl text-gray-900 animate-fade-in-up" style={{animationPlayState: 'paused'}}>
...
<p className="max-w-2xl animate-fade-in-up text-gray-600 mt-4 mr-auto ml-auto" style={{animationDelay: '0.1s', animationPlayState: 'paused'}}>Step into a system designed for momentum. Start with a free session, no pressure, just precision.</p>
<div className="mt-8 flex flex-wrap items-center justify-center gap-4 animate-fade-in-up" style={{animationDelay: '0.2s', animationPlayState: 'paused'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.4s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.5s', animationPlayState: 'paused', transform: 'translate3d(0px, 0px, 0px)'}}>
...
<div className="animate-fade-in-left" style={{animationPlayState: 'paused'}}>
...
<form className="rounded-2xl border p-6 ring-1 border-gray-200 bg-white ring-gray-100 shadow-sm animate-fade-in-right" style={{animationPlayState: 'paused'}}>
...
<div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 py-10 md:flex-row animate-fade-in-up" style={{animationPlayState: 'paused'}}>
<div className="flex items-center gap-3">

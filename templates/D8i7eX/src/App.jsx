...
<div>
<h1 className="text-2xl font-bold">Hey, Chef!</h1>
...
<span className="text-xs">Burgers</span>
</div>
<div className="flex flex-col items-center">
...
<h3 className="font-bold">Featured Recipes</h3>
<button className="text-xs text-orange-600">View All</button>
</div>
<div className="relative rounded-2xl overflow-hidden h-48 mb-4">
<img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4">
<div className="bg-orange-500 text-white text-xs px-2 py-1 rounded-full w-fit mb-2">Trending</div>
<h4 className="text-white font-bold">Mediterranean Salad Bowl</h4>
<div className="flex items-center text-white/80 text-xs mt-1">
<i className="fas fa-clock mr-1"></i> 25 mins
                <i className="fas fa-fire ml-3 mr-1"></i> 320 cal
                <div className="flex items-center ml-3">
<i className="fas fa-star mr-1 text-yellow-400"></i> 4.8
                </div>
</div>
</div>
</div>

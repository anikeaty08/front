...
<button className="bg-white/10 hover:bg-white/20 text-white py-2 px-4 rounded-full text-sm font-medium transition-all duration-200 border border-white/20" onclick="setCashAmount(15000)">
                                15.000 €
                            </button>
<button className="bg-[#9ACB5D] hover:bg-[#7A9E4B] text-white py-2 px-4 rounded-full text-sm font-medium transition-all duration-200" onclick="setCashAmount(25000)">
                                25.000 €
                            </button>
<button className="bg-white/10 hover:bg-white/20 text-white py-2 px-4 rounded-full text-sm font-medium transition-all duration-200 border border-white/20" onclick="setCashAmount(50000)">
                                50.000 €
                            </button>
<button className="bg-white/10 hover:bg-white/20 text-white py-2 px-4 rounded-full text-sm font-medium transition-all duration-200 border border-white/20" onclick="setCashAmount(75000)">
                                75.000 €
                            </button>
</div>
...
<button className="option-tab flex-1 bg-white border-2 border-gray-200 rounded-2xl p-6 text-left hover:border-[#9ACB5D] hover:shadow-lg transition-all duration-300 cursor-pointer" id="tab-direktverkauf" onclick="selectOption('direktverkauf')">
...
<button className="option-tab flex-1 bg-white border-2 border-[#9ACB5D] rounded-2xl p-6 text-left hover:shadow-lg transition-all duration-300 cursor-pointer active-tab" id="tab-beleihung" onclick="selectOption('beleihung')">
...
<button className="option-tab flex-1 bg-white border-2 border-gray-200 rounded-2xl p-6 text-left hover:border-blue-500 hover:shadow-lg transition-all duration-300 cursor-pointer" id="tab-salerent" onclick="selectOption('salerent')">
<div className="flex items-start space-x-4">
...
<style>
        .slider::-webkit-slider-thumb {
            ...
            box-shadow: 0 4px 12px rgba(154, 203, 93, 0.3);
        }

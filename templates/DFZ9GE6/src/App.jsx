...
<svg className="lucide lucide-play w-[16px] h-[16px] text-orange-300" data-icon-replaced="true" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '16px', height: '16px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
                  Watch Demo
                </button>
</div>
...
<path className="" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
        ORCHESTRATOR
      </span>
...
<svg className="w-3 h-3" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path className="" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
        ANALYTICS
      </span>
...
<svg className="w-3 h-3" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path className="" d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
        COORDINATION
      </span>
</div>
...
<path className="" d="M14.3766 22.1001H17.0433" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" d="M28.3766 23.3333H24.8983L20.0288 27.3333H11.7099" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" d="M21.0432 10H22.3766" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" d="M26.3766 10H27.0433" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" d="M15.7099 31.3333H17.0433" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" d="M10.3766 22H11.0433" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" clip-rule="evenodd" d="M9.04326 12.6667C9.77964 12.6667 10.3766 12.0697 10.3766 11.3333C10.3766 10.597 9.77964 10 9.04326 10C8.30688 10 7.70993 10.597 7.70993 11.3333C7.70993 12.0697 8.30688 12.6667 9.04326 12.6667Z" fill-rule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
<path className="" clip-rule="evenodd" d="M25.0433 18C25.7796 18 26.3766 17.4031 26.3766 16.6667C26.3766 15.9303 25.7796 15.3333 25.0433 15.3333C24.3069 15.3333 23.7099 15.9303 23.7099 16.6667C23.7099 17.4031 24.3069 18 25.0433 18Z" fill-rule="evenodd" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
...
<path className="" d="M60.7518 26.7609C60.5287 26.7609 60.4411 26.6574 60.4889 26.4502L62.7598 16.9124C62.8395 16.5618 62.8475 16.2908 62.7837 16.0996C62.7359 15.8924 62.5925 15.7888 62.3534 15.7888C62.0666 15.7888 61.7479 16.004 61.3973 16.4343C61.0626 16.8486 60.6801 17.6454 60.2499 18.8247C60.1861 19.0319 60.0746 19.1355 59.9152 19.1355C59.6761 19.1355 59.6124 18.992 59.724 18.7052C60.0746 17.6056 60.4411 16.745 60.8236 16.1235C61.222 15.502 61.6204 15.0637 62.0188 14.8088C62.4172 14.5538 62.7837 14.4263 63.1184 14.4263C63.6443 14.4263 64.0188 14.6255 64.2419 15.0239C64.465 15.4064 64.473 16.0438 64.2658 16.9363L64.0028 18.0598C63.9869 18.1713 64.0108 18.2351 64.0746 18.251C64.1383 18.2669 64.1941 18.2271 64.2419 18.1315C64.8475 16.745 65.3973 15.7809 65.8913 15.239C66.3853 14.6972 66.9511 14.4263 67.5885 14.4263C68.0188 14.4263 68.3375 14.5458 68.5447 14.7849C68.7678 15.008 68.8794 15.3187 68.8794 15.7171C68.8794 16.1155 68.7837 16.4343 68.5925 16.6733C68.4013 16.9124 68.1543 17.0319 67.8515 17.0319C67.5965 17.0319 67.4132 16.9681 67.3017 16.8406C67.1901 16.7131 67.1025 16.5697 67.0387 16.4104C66.9909 16.2351 66.9351 16.0837 66.8714 15.9562C66.8076 15.8287 66.704 15.7649 66.5606 15.7649C66.3216 15.7649 66.0108 16.0677 65.6284 16.6733C65.2459 17.2789 64.8315 18.0996 64.3853 19.1355C63.955 20.1554 63.5327 21.3028 63.1184 22.5777C62.72 23.8526 62.3694 25.1594 62.0666 26.498C62.0188 26.6733 61.9072 26.7609 61.7319 26.7609H60.7518Z" fill="currentColor"></path>
<path className="" d="M55.1903 26.9761C54.3457 26.9761 53.6684 26.6494 53.1584 25.996C52.6485 25.3267 52.3935 24.3864 52.3935 23.1753C52.3935 22.1235 52.5768 21.0797 52.9433 20.0438C53.3258 19.008 53.8198 18.0677 54.4254 17.2231C55.0309 16.3785 55.6923 15.7012 56.4094 15.1912C57.1425 14.6813 57.8517 14.4263 58.5369 14.4263C59.2859 14.4263 59.8198 14.6096 60.1385 14.9761C60.4732 15.3267 60.6405 15.8048 60.6405 16.4104C60.6405 17.1275 60.3855 17.8446 59.8756 18.5618C59.3816 19.2629 58.6804 19.8924 57.772 20.4502C56.8796 21.008 55.8278 21.4223 54.6166 21.6932C54.266 21.7729 54.0827 21.9721 54.0668 22.2908C54.0509 22.4024 54.0429 22.5219 54.0429 22.6494C54.0429 22.7609 54.0429 22.8725 54.0429 22.9841C54.0429 23.8924 54.1943 24.5777 54.4971 25.0398C54.8158 25.502 55.2461 25.7331 55.7879 25.7331C56.3935 25.7331 56.9752 25.4542 57.5329 24.8964C58.1067 24.3386 58.5847 23.5498 58.9672 22.5299C59.015 22.3864 59.1106 22.3147 59.2541 22.3147C59.3497 22.3147 59.4055 22.3546 59.4214 22.4343C59.4533 22.5139 59.4533 22.6096 59.4214 22.7211C58.9114 24.1235 58.2899 25.1833 57.5568 25.9004C56.8397 26.6175 56.0509 26.9761 55.1903 26.9761ZM54.3058 20.7849C54.274 20.8964 54.2899 20.992 54.3537 21.0717C54.4333 21.1355 54.529 21.1514 54.6405 21.1195C55.6286 20.8486 56.4572 20.4422 57.1266 19.9004C57.7959 19.3426 58.2979 18.7211 58.6325 18.0359C58.9831 17.3506 59.1584 16.6813 59.1584 16.0279C59.1584 15.3586 58.8955 15.0239 58.3696 15.0239C57.9074 15.0239 57.4055 15.2948 56.8636 15.8367C56.3218 16.3785 55.8198 17.0877 55.3576 17.9641C54.8955 18.8406 54.5449 19.7809 54.3058 20.7849Z" fill="currentColor"></path>
<path className="" d="M43.5957 26.5219C43.516 26.5219 43.4443 26.498 43.3806 26.4502C43.3168 26.4024 43.285 26.2988 43.285 26.1394L43.0459 11.5578C43.0459 11.4462 43.0061 11.3905 42.9264 11.3905C42.8627 11.3905 42.8148 11.4383 42.783 11.5339L39.269 24.7052C39.1575 25.1514 39.1495 25.494 39.2451 25.7331C39.3567 25.9562 39.6037 26.0996 39.9862 26.1634L40.273 26.2112C40.4642 26.2271 40.5599 26.3147 40.5599 26.4741C40.5599 26.6653 40.4085 26.761 40.1057 26.761H36.7352C36.4961 26.761 36.3766 26.6813 36.3766 26.5219C36.3766 26.3466 36.5041 26.243 36.7591 26.2112L37.0937 26.1634C37.524 26.0996 37.8427 25.9562 38.0499 25.7331C38.2571 25.494 38.4164 25.1514 38.528 24.7052L42.1376 11.1275C42.2172 10.7929 42.2172 10.5698 42.1376 10.4582C42.0579 10.3466 41.8427 10.259 41.4921 10.1953L41.0858 10.1235C40.8308 10.0757 40.7033 9.97214 40.7033 9.81278C40.7033 9.63748 40.8467 9.54984 41.1336 9.54984H44.0021C44.4642 9.54984 44.6953 9.78888 44.6953 10.267L44.8388 22.1474C44.8388 22.259 44.8706 22.3227 44.9344 22.3387C45.0141 22.3387 45.0778 22.2908 45.1256 22.1952L50.9105 10.1474C51.1017 9.74904 51.4045 9.54984 51.8188 9.54984H54.7113C54.9025 9.54984 54.9981 9.62952 54.9981 9.78888C54.9981 9.94824 54.8627 10.0518 54.5918 10.0996L54.0181 10.1953C53.6675 10.259 53.4284 10.3466 53.3009 10.4582C53.1734 10.5698 53.0698 10.7929 52.9902 11.1275L50.2172 25.1833C50.1535 25.5179 50.1535 25.741 50.2172 25.8526C50.2969 25.9641 50.4961 26.0518 50.8149 26.1155L51.2212 26.1873C51.3806 26.2032 51.4842 26.243 51.532 26.3068C51.5798 26.3546 51.6037 26.4104 51.6037 26.4741C51.6037 26.6653 51.4603 26.761 51.1734 26.761H46.9184C46.6953 26.761 46.5838 26.6813 46.5838 26.5219C46.5838 26.3626 46.7113 26.259 46.9662 26.2112L47.54 26.1155C47.8905 26.0518 48.1296 25.9641 48.2571 25.8526C48.4005 25.741 48.5041 25.5179 48.5678 25.1833L51.269 11.6295C51.3009 11.518 51.277 11.4542 51.1973 11.4383C51.1176 11.4064 51.0539 11.4383 51.0061 11.5339L44.026 26.1394C43.9623 26.2988 43.8905 26.4024 43.8109 26.4502C43.7471 26.498 43.6754 26.5219 43.5957 26.5219Z" fill="currentColor"></path>
</svg>
</div>
</div>
<style>
...
<div className="card-top glass-effect w-full h-fit overflow-hidden relative transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] bg-gradient-to-r from-white/15 to-white/5 rounded-[1.2em]" style={{backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)'}}>
<div className="absolute inset-0 border-white/20 border rounded-[1.2em]" style={{maskImage: 'linear-gradient(135deg, white, transparent 60%)'}}></div>
<div className="absolute inset-0 border-white/10 border rounded-[1.2em]" style={{maskImage: 'linear-gradient(135deg, transparent 60%, white)'}}></div>
<div className="flex flex-col h-full pt-6 pr-6 pb-7 pl-6">
<div className="flex mb-2 items-start justify-between">
...
<svg className="h-4 w-4 text-white" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 5v11"></path><path d="M12 5v6"></path><path d="M18 5v14"></path></svg>
</span>
...
<div className="flex items-center gap-3 mb-3">
<span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-neutral-400 to-neutral-500">
<svg className="h-4 w-4 text-white" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="11" rx="2" ry="2" width="18" x="3" y="11"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
</span>
...
<svg className="lucide lucide-check-circle-2 mt-0.5 w-[20px] h-[20px] text-orange-300" data-icon-replaced="true" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '20px', height: '20px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
...
<svg className="lucide lucide-terminal mr-2 w-[16px] h-[16px] text-orange-300" data-icon-replaced="true" data-lucide="terminal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '16px', height: '16px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 19h8"></path><path d="m4 17 6-6-6-6"></path></svg>
              npm i ai-factory
            </div>
</div>
...
<path className="rounded-xl" d="M5 12h14"></path>
<path className="rounded-xl" d="m12 5 7 7-7 7"></path>
</svg>
</span>
</button>
</form>
...
<svg className="lucide lucide-shield mr-2 w-[16px] h-[16px] text-neutral-400" data-icon-replaced="true" data-lucide="shield" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '16px', height: '16px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path></svg>
...
<svg className="mt-0.5 h-4 w-4 text-orange-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
...
<div className="card-top w-full h-fit overflow-hidden relative transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ring-1 ring-neutral-300/20 bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 rounded-[1.2em]" style={{backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)'}}>
<div className="relative pt-8 pr-8 pb-8 pl-8">
<div className="relative">
...
<ul className="mt-8 space-y-3 text-sm">
<li className="flex items-start gap-3">
<svg className="mt-0.5 h-4 w-4 text-orange-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
...
<div className="card-top glass-effect w-full h-fit overflow-hidden relative transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] bg-gradient-to-r from-white/15 to-white/5 rounded-[1.2em] mt-12 mr-auto ml-auto max-w-7xl" style={{backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)'}}>
<div className="absolute inset-0 border-white/20 border rounded-[1.2em]" style={{maskImage: 'linear-gradient(135deg, white, transparent 60%)'}}></div>
<div className="absolute inset-0 border-white/10 border rounded-[1.2em]" style={{maskImage: 'linear-gradient(135deg, transparent 60%, white)'}}></div>
...
<svg className="h-3 w-3 text-orange-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
          No setup fees

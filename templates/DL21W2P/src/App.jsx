  ...
  useEffect(() => {
    try {
      ...
      window.addEventListener('DOMContentLoaded', () => {
        ...
        // Disable sticky behavior of first column (해지)
        disableStickyFirstColumn();
      });
      ...
      // Disable sticky first column by overriding style
      function disableStickyFirstColumn() {
        const selectors = ['#compareGrid > .sticky.left-0', '#landscapeOverlay .grid > .sticky.left-0'];
...
<div className="min-w-[836px] sm:min-w-[980px] grid [grid-template-columns:128px_repeat(3,240px)] sm:[grid-template-columns:160px_repeat(3,280px)]" id="compareGrid">

<div className="border-b border-neutral-200"></div>

<div className="p-4 border-b border-neutral-200">
<div className="aspect-square rounded-xl overflow-hidden relative" data-gallery="" role="thumb">
...
<img alt="소파 A 3" className="w-full h-full object-cover flex-none snap-center" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&amp;q=80"/>
</div>
...
<img alt="소파 B 3" className="w-full h-full object-cover flex-none snap-center" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&amp;q=80"/>
</div>
<button className="absolute top-2 right-2 w-8 h-8 rounded-full bg-black/70 text-white grid place-items-center">
<i className="w-4 h-4" data-lucide="x"></i>
</button>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">브랜드</div>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">상품명</div>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">옵션</div>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">가격</div>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">크기</div>
...
<div className="bg-white border-b border-neutral-100 px-4 py-3 text-sm text-neutral-500">소재</div>
...
<div className="overflow-auto touch-pan-x touch-pan-y">
<div className="min-w-[900px] sm:min-w-[1100px] grid [grid-template-columns:140px_repeat(3,260px)] sm:[grid-template-columns:180px_repeat(3,320px)]">
<div className="border-b border-neutral-200"></div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">브랜드</div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">상품명</div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">옵션</div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">가격</div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">크기</div>
...
<div className="bg-white border-b border-neutral-100 px-5 py-4 text-sm text-neutral-500">소재</div>

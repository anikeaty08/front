...
<p>David Blocker is a seasoned litigation and family law attorney and founder of Blocker Law LLC, offering decades of experience guiding clients through complex financial and personal legal matters. Known for his practical, empathetic counsel, David helps individuals, families, and businesses navigate bankruptcy, debt, divorce, custody, estate planning, and commercial disputes.</p>
</div>

<div className="space-y-6">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Core Expertise</h4>
<ul className="grid sm:grid-cols-2 gap-4 list-disc list-inside text-slate-700 text-sm">
<li>Litigation — bench &amp; jury trials, depositions, written discovery, settlement conferences</li>
...
<li>Avvo Rating: 8.7 (“Excellent”)</li>
</ul>
</div>
...
<h4 className="text-2xl font-semibold tracking-tight text-blue-900">Contact David</h4>
<p className="text-sm text-slate-700">📞 Phone: <a className="text-blue-600 hover:underline" href="tel:12163609961">(216) 360-9961</a></p>
<p className="text-sm text-slate-700">📧 Email/Inquiries: Use the <button className="underline text-blue-600 hover:text-blue-800" data-section="contact">Contact Us</button> page</p>
<p className="text-sm text-slate-700">📍 Office: 30195 Chagrin Blvd., Suite 300, Pepper Pike, OH 44124</p>
</div>
</div>
</section>

<section className="section hidden py-24" id="practice"> …… </section>

<section className="section hidden py-24 bg-slate-50" id="contact"> …… </section>

<section className="section hidden py-24" id="map"> …… </section>
</main>

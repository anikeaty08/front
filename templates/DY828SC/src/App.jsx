...
<div className="w-1/2 pr-2 sm:pr-8 min-w-0">
...
<span className="font-semibold text-white">Are you in it to lose money or retain your capital?</span><br/>
            Discover how Simplifi is transforming football analytics by focusing on market movements, risk management, and responsible inestment behavior. Download your step by step guide to disciplined, data-driven football investing.
          </p>
...
<div className="relative w-full max-w-xs sm:max-w-md lg:max-w-lg flex justify-center items-center mx-auto">
<div className="absolute inset-0 bg-gradient-to-r from-[#1f5410]/20 to-[#004e2b]/20 rounded-full blur-3xl z-0"></div>
<img alt="Simplifi Football Guide Cover" className="relative z-10 w-full h-auto rounded-xl shadow-lg border border-zinc-800" src="https://i.postimg.cc/sx40QWYb/Dark-Blue-and-Purple-Modern-Market-Research-Report.jpg" style={{display: 'block'}}/>
</div>
</div>
</div>

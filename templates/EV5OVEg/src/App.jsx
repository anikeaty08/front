...
<div>
<h1 className="text-white text-2xl font-medium">Canvas</h1>
...
<div className="w-full bg-white rounded-2xl overflow-hidden shadow-lg mb-4 relative">
...
<button className="bg-[#1a1a1a] p-3 rounded-xl border border-indigo-500">
...
<button className="bg-[#1a1a1a] p-3 rounded-xl">
...
<div className="w-full bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg border border-[#252525] mb-4">
...
<div className="w-full bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg border border-[#252525] mb-4">
<div className="px-4 pt-3 pb-2 border-b border-[#252525] flex justify-between items-center">
<h3 className="text-gray-200 font-medium text-sm">Layers</h3>
<button className="text-indigo-400 text-xs">Add New</button>
</div>

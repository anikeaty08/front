...
<circle className="progress-ring-circle text-green-500" cx="60" cy="60" fill="transparent" id="progressRing" r="50" stroke="currentColor" stroke-dasharray="314.16" stroke-dashoffset="314.16" strokeLinecap="round" strokeWidth="10"></circle>
</svg>

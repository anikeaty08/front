...
<svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewbox="0 0 24 24"><circle cx="12" cy="12" r="10" strokeWidth="2"></circle><path d="M8 12h8M12 8v8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>

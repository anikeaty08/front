...
<div className="w-[390px] h-[844px] bg-black rounded-[60px] p-3 shadow-2xl relative overflow-hidden">

<div className="w-full h-full bg-black rounded-[50px] overflow-hidden relative">

<div className="absolute top-0 w-full px-8 pt-3 pb-1 flex justify-between items-center z-30">
<div className="text-white text-sm font-medium">9:41</div>
<div className="absolute top-1 left-1/2 transform -translate-x-1/2 w-[150px] h-[30px] bg-black rounded-b-[20px] z-40"></div>
...
<path d="M9 10a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
<svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="w-full h-full bg-gradient-to-b from-indigo-900 to-purple-900 pt-12">
...
<div className="ml-3">
<h1 className="text-white text-xl font-semibold">Nova AI</h1>
...
<div className="bg-white rounded-t-3xl h-[680px] overflow-hidden flex flex-col">

<div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
<h2 className="text-gray-800 font-semibold">New Chat</h2>
...
<span className="text-xs text-gray-400">Today, 9:41 AM</span>
</div>
...
<div className="ml-3 bg-gray-100 rounded-xl rounded-tl-none p-4 max-w-[260px]">
<p className="text-gray-800 text-sm">Hello! I'm Nova, your AI assistant. How can I help you today?</p>
</div>
</div>

<div className="flex items-start justify-end">
<div className="mr-3 bg-indigo-600 rounded-xl rounded-tr-none p-4 max-w-[260px]">
<p className="text-white text-sm">Can you help me plan a trip to Japan next month?</p>
</div>
...
<div className="ml-3 bg-gray-100 rounded-xl rounded-tl-none p-4 max-w-[260px]">
<p className="text-gray-800 text-sm">I'd be happy to help plan your trip to Japan! Here are some initial questions:</p>
<ul className="text-gray-800 text-sm mt-2 list-disc list-inside">
<li>How long will you be staying?</li>
<li>Which cities do you want to visit?</li>
<li>What's your budget range?</li>
<li>Are you interested in culture, food, nature, or urban experiences?</li>
</ul>
</div>
</div>
</div>
...
<input className="bg-transparent flex-1 outline-none text-gray-600 text-sm" placeholder="Message Nova..." type="text"/>
<button className="ml-2 w-8 h-8 bg-indigo-600 rounded-full flex items-center justify-center">
<svg className="h-5 w-5 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

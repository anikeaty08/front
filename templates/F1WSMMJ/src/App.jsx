...
<img alt="Digital Interface" className="w-full max-w-md rounded-3xl shadow-2xl object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1ba266bd-81e8-4c6b-b290-bdcb56dc9f72_800w.jpg"/>
...
<canvas className="w-full h-64 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9895d626-b35e-41b6-92f7-f1842072b761_1600w.jpg)] bg-cover rounded-lg" height="520" id="insightsChart" style={{display: 'block', boxSizing: 'border-box', height: '260px', width: '520px'}} width="1040"></canvas>

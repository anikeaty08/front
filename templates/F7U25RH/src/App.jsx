...
<div className="relative col-span-12 lg:col-span-8 bg-center overflow-hidden h-[520px] bg-cover rounded-2xl" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1523419409548-8a8c9d8c86a2?q=80&amp'}}>
...
<div className="w-full h-48 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d7597939-dea3-474c-af26-1f32a3e90d39_1600w.jpg)] bg-cover border rounded-md border-black/10" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1562967912-339e7c6a12b3?q=80&amp'}}></div>
</div>
</div>
</div>
</section>

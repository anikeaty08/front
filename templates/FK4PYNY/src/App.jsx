...
<img alt="Sneaker hero" className="w-full h-[420px] sm:h-[520px] object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6fdbbeb3-36ec-475f-8227-1bc9b7fa96a2_1600w.jpg"/>
...
<div className="group break-inside-avoid block rounded-3xl overflow-hidden bg-white/40 backdrop-blur border border-black/5 hover:bg-white hover:shadow-2xl hover:shadow-black/5 transition-all duration-300">
<div className="relative">
<img alt="Street Classic" className="w-full h-64 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/00189d5a-7f25-4559-935e-bbe4ea895a1a_800w.jpg" style={{transition: 'outline 0.1s ease-in-out'}}/>
...
<div className="group break-inside-avoid block rounded-3xl overflow-hidden bg-white/40 backdrop-blur border border-black/5 hover:bg-white hover:shadow-2xl hover:shadow-black/5 transition-all duration-300">
<div className="relative">
<img alt="Terra Trek" className="w-full h-96 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a0334f32-8e67-444f-bb8c-ef1ebc4a3a8f_800w.jpg"/>
</div>
<div className="p-5">
<div className="flex items-start justify-between">
<div>
...
<div className="group break-inside-avoid block rounded-3xl overflow-hidden bg-white/40 backdrop-blur border border-black/5 hover:bg-white hover:shadow-2xl hover:shadow-black/5 transition-all duration-300">
<div className="relative">
<img alt="Court Pro" className="w-full h-80 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/250cac47-d1b1-42fe-8c29-60c9a4c55da3_800w.jpg"/>
</div>
<div className="p-5">
<div className="flex items-start justify-between">
<div>

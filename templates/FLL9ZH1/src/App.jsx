...
<td>
<button className="rounded p-1 outline-none focus:ring-2 focus:ring-indigo-400 hover:bg-neutral-800" onclick="openSocioModal('Sofia D\'Amico')" title="Dettagli">
...
<td>
<button className="rounded p-1 outline-none focus:ring-2 focus:ring-indigo-400 hover:bg-neutral-800" onclick="openSocioModal('Marco Neri')" title="Dettagli">
<svg className="lucide lucide-eye w-4 h-4 stroke-[1.5]" data-lucide="eye" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></svg>
</button>
</td>
</tr>
...
<td>
<button className="rounded p-1 outline-none focus:ring-2 focus:ring-indigo-400 hover:bg-neutral-800" onclick="openSocioModal('Chiara Blu')" title="Dettagli">
<svg className="lucide lucide-eye w-4 h-4 stroke-[1.5]" data-lucide="eye" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></svg>
</button>
</td>
</tr>
...
<button className="transition-colors text-neutral-400 hover:text-indigo-400" onclick="closeSocioModal()">
...
<style>
    @keyframes fade-in-up { 0% { opacity:0; transform:translateY(24px) scale(0.98); } 100% { opacity:1; transform:translateY(0) scale(1);} }
    .animate-fade-in-up { animation: fade-in-up 0.5s cubic-bezier(.4,0,.2,1) both; }
    @keyframes fade-in-left { 0% { opacity:0; transform:translateX(-24px) scale(0.98); } 100% { opacity:1; transform:translateX(0) scale(1);} }
    .animate-fade-in-left { animation: fade-in-left 0.5s cubic-bezier(.4,0,.2,1) both; }
    @keyframes blur-in { 0% { filter: blur(8px); opacity:0; } 100% { filter: blur(0); opacity:1; } }
    .animate-blur-in { animation: blur-in 0.7s cubic-bezier(.4,0,.2,1) both; }
  </style>

...
<a className="inline-flex items-center gap-2 ring-1 ring-inset transition-colors hover:bg-[#1d4ed8] text-sm text-white tracking-tight rounded-full pt-2.5 pr-5 pb-2.5 pl-5" href="#plan" onclick="event.preventDefault();var t=document.querySelector('#plan');if(t){t.scrollIntoView({behavior:'smooth',block:'start'});}else{location.hash='#plan';}}" style={{backgroundColor: '#2563eb', ringColor: 'rgba(37,99,235,0.35)'}}>
...
<li className="flex gap-2 items-center"><svg className="lucide lucide-settings h-4 w-4" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: '#2563eb'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"></path><circle cx="12" cy="12" r="3"></circle></svg> CRM Setup</li>
<li className="flex items-center gap-2"><svg className="lucide lucide-funnel h-4 w-4" data-lucide="funnel" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: '#2563eb'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z"></path></svg> “Get a Quote” Funnel</li>

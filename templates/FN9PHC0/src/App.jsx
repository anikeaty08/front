...
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('headphones', -1)">-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('headphones', 1)">+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onclick="removeFromCart('headphones')">
...
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('chair', -1)">-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('chair', 1)">+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onclick="removeFromCart('chair')">
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('speaker', -1)">-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('speaker', 1)">+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onclick="removeFromCart('speaker')">
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="flex items-center gap-2">
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('keyboard', -1)">-</button>
<span className="text-sm w-6 text-center">1</span>
<button className="quantity-btn w-6 h-6 rounded bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center transition-colors" onclick="updateQuantity('keyboard', 1)">+</button>
</div>
<button className="text-zinc-400 hover:text-red-400 transition-colors" onclick="removeFromCart('keyboard')">
<svg className="w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"></path></svg>
</button>
</div>
</div>

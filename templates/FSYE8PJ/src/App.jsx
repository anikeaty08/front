...
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Home</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Websites</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Digital Marketing</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">About</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Our Work</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Learn</a>
<a className="nav-link hover:text-white transition-colors text-sm font-medium text-white/70 tracking-tight" href="#">Contact</a>
</div>

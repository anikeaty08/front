...
<section className="relative h-screen bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1920&amp'}}>
...
<div className="aspect-video bg-cover bg-center rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1511578314322-379afb476865?w=600&amp'}}></div>
...
<div className="aspect-video bg-cover bg-center rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=600&amp'}}></div>
...
<div className="aspect-video bg-cover bg-center rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=600&amp'}}></div>

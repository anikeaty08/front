...
<div className="relative z-10 w-full min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-400 to-cyan-400 px-8 py-8 perspective-distant">

<div className="shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8),0_30px_60px_-30px_rgba(0,0,0,0.6)] bg-[#1a1a1a] w-[375px] h-[812px] relative border-[#333] border rounded-[54px] px-2 py-2 scale-75 rotate-x-15 -rotate-y-15 rotate-z-15">

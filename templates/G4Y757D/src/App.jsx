...
<a className="sm:inline-flex items-center gap-2 text-[12px] hover:bg-[#095EC4] font-medium text-white bg-[#0A6EE7] rounded-lg pt-1 pr-1.5 pb-1 pl-1.5" href="https://aura.build/share/S8O9S2N" id="aura-emf568493" role="button">ดูข้อมูล</a>
</div>
...
<div className="max-w-7xl sm:px-6 lg:px-8 mr-auto ml-auto pt-8 pr-5 pb-8 pl-5" id="aura-emf55zj3s">

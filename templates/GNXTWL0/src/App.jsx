...
<a className="flex items-center px-4 py-3 text-neutral-300 hover:text-white hover:bg-neutral-700/30 rounded-lg transition" href="#">
<svg className="w-5 h-5 mr-3" fill="currentColor" viewbox="0 0 20 20">
<path d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2z" fill-rule="evenodd"></path>
</svg>
            Security
          </a>
<a className="flex items-center px-4 py-3 text-neutral-300 hover:text-white hover:bg-neutral-700/30 rounded-lg transition" href="#">
<svg className="w-5 h-5 mr-3" fill="currentColor" viewbox="0 0 20 20">
<path d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" fill-rule="evenodd"></path>
</svg>
            Preferences
          </a>
</div>
...
<button className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-800 focus:outline-none focus:border-neutral-400 transition text-sm flex items-center justify-between" onclick="toggleDropdown('language')" type="button">
...
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('language', 'English (US)')">English (US)</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('language', 'English (UK)')">English (UK)</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('language', 'Spanish')">Spanish</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('language', 'French')">French</div>
</div>
</div>

<div className="dropdown">
<label className="block text-xs font-medium text-neutral-600 mb-2 tracking-wide">TIMEZONE</label>
<button className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-800 focus:outline-none focus:border-neutral-400 transition text-sm flex items-center justify-between" onclick="toggleDropdown('timezone')" type="button">
...
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('timezone', 'UTC-8 (Pacific Time)')">UTC-8 (Pacific Time)</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('timezone', 'UTC-5 (Eastern Time)')">UTC-5 (Eastern Time)</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('timezone', 'UTC+0 (GMT)')">UTC+0 (GMT)</div>
<div className="px-4 py-3 hover:bg-neutral-50 cursor-pointer text-sm" onclick="selectOption('timezone', 'UTC+1 (Central European Time)')">UTC+1 (Central European Time)</div>
</div>
</div>

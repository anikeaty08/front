...
<button className="w-full flex justify-center items-center mt-3 text-linear-text hover:text-linear-title transition-colors duration-200 text-xs" onclick="toggleDetails()">

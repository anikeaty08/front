...
<div aria-hidden="true" className="absolute inset-x-0 top-[-10%] h-[600px] opacity-50 transition duration-700 opacity-100 translate-y-0" style="background:
            radial-gradient(600px 200px at 20% 20%, rgba(34,197,94,0.18), transparent 60%),

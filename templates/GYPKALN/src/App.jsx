...
<div className="pointer-events-none absolute left-1/2 top-[-180px] h-[520px] w-[760px] -translate-x-1/2 rounded-full blur-3xl" style="background:
              radial-gradient(60% 60% at 50% 50%, rgba(126,185,240,0.10), transparent 65%),
              ...
              radial-gradient(55% 55% at 40% 20%, rgba(251,224,138,0.18), transparent 75%)
            ;"></div>

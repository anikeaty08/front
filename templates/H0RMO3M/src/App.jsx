      ...
      function startCodeTyping() {
        ...
        if (prefersReduced) {
          lines.forEach(l => {
            ...
            if (l.html) row.innerHTML = l.html; else row.textContent = l.text || '';
        ...
        function typeLine() {
          ...
          const row = document.createElement('div');
          row.setAttribute('style', sharedRowStyle + ' border-right: 2px solid #10B981; opacity: 1;');
...
<iframe frameborder="0" height="100%" src="https://my.spline.design/retrofuturismbganimation-Lb3VtL1bNaYUnirKNzn0FvaW" title="Retro Futurism Background" width="100%"></iframe>
</div>
</div>
...
<div className="fixed left-6 top-1/2 -translate-y-1/2 z-40 hidden xl:block" id="statusIndicator" style={{transform: 'translateY(calc(-50% - 91.25px)) scale(0.969263)', filter: 'drop-shadow(rgba(34, 197, 94, 0.55) 0px 0px 36.8222px)'}}>
...
<h1 className="md:text-7xl lg:text-8xl text-5xl font-semibold tracking-tight" id="heroHeadline"><span style={{display: 'inline-block'}}>П</span><span style={{display: 'inline-block'}}>р</span><span style={{display: 'inline-block'}}>о</span><span style={{display: 'inline-block'}}>д</span><span style={{display: 'inline-block'}}>у</span><span style={{display: 'inline-block'}}>к</span><span style={{display: 'inline-block'}}>т</span><span className="" style={{display: 'inline-block'}}>о</span><span className="" style={{display: 'inline-block'}}>в</span><span className="" style={{display: 'inline-block'}}>ы</span><span className="" style={{display: 'inline-block'}}>й</span><span style={{display: 'inline-block', marginRight: '0.5rem'}}> </span><span style={{display: 'inline-block'}}>д</span><span style={{display: 'inline-block'}}>и</span><span style={{display: 'inline-block'}}>з</span><span style={{display: 'inline-block'}}>а</span><span style={{display: 'inline-block'}}>й</span><span style={{display: 'inline-block'}}>н</span><span style={{display: 'inline-block'}}>е</span><span style={{display: 'inline-block'}}>р</span></h1>
...
<img alt="UX/UI дизайн — превью" className="aspect-video w-full transition-transform duration-500 group-hover:scale-110 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b2935f88-b46a-4628-bd14-9d912c5060ee_800w.jpg"/>
</div>
</div>
...
<div className="mt-4 rounded-lg overflow-hidden border border-white/10 transition-all duration-300 group-hover:border-white/20">
<img alt="Product Design — превью" className="aspect-video w-full transition-transform duration-500 group-hover:scale-110 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/40da0c82-6e2f-4b70-a7b5-0498f0e7f525_800w.jpg"/>
</div>
</div>
<div className="flex text-sm text-[#ffffff] mt-6 items-center">
<span>Learn more</span>
...
<div className="mt-4 rounded-lg overflow-hidden border border-white/10 transition-all duration-300 group-hover:border-white/20">
<img alt="Дизайн‑системы — превью" className="aspect-video w-full transition-transform duration-500 group-hover:scale-110 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d25c2d1-8a41-471b-bac8-c69712d13bb1_800w.jpg"/>
</div>
</div>
<div className="flex text-sm text-[#ffffff] mt-6 items-center">
<span>Learn more</span>
...
<div className="mt-4 min-h-[160px] font-mono text-sm leading-relaxed text-gray-300" id="codeContainer"><div style={{whiteSpace: 'pre', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', lineHeight: '1.6', fontSize: '0.9rem', borderRight: 'none', opacity: '1'}}><span style={{color: '#60A5FA'}}>// Дизайн‑система</span></div><div style={{whiteSpace: 'pre', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', lineHeight: '1.6', fontSize: '0.9rem', borderRight: 'none', opacity: '1'}}><span style={{color: '#60A5FA'}}>const</span> <span style={{color: '#FBBF24'}}>components</span> = <span style={{color: '#E5E7EB'}}>{</span></div><div style={{whiteSpace: 'pre', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', lineHeight: '1.6', fontSize: '0.9rem', borderRight: '2px solid #10B981', opacity: '1'}}></div></div>
</div>

...
femaleBtn.addEventListener('click', () => selectGender(femaleBtn, 'female'))
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1612543827278-d19245d6a00d?w=3840&amp'}}></div>

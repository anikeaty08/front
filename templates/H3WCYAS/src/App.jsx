...
<svg className="w-5 h-5" fill="currentColor" viewbox="0 0 20 20">
<path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z"></path><path clip-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" fill-rule="evenodd"></path>
</svg>
<span>Schemas</span>
</a>
<a className="flex items-center space-x-3 p-3 rounded-lg sidebar-item text-white/70 hover:text-white transition-all font-sf-text" href="#">
...
<path d="M120,100 L200,100 L280,100" fill="none" stroke="url(#lineGradient)" stroke-dasharray="5,5" strokeWidth="2">

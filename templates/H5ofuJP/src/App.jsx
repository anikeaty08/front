...
<p className="text-gray-400 max-w-2xl mx-auto text-lg">Choose the plan that works best for you and your team.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">

<div className="bg-gray-800 rounded-xl overflow-hidden">
<div className="p-8">
<h3 className="text-xl font-bold mb-2 text-blue-400">Basic</h3>
...
<button className="w-full py-3 px-4 bg-blue-500 hover:bg-blue-600 rounded-lg font-medium transition-colors">Get Started</button>
</div>
</div>
...
<p className="text-gray-400 mb-6">For professionals and growing teams</p>
<ul className="space-y-3 mb-8">
<li className="flex items-center">
...
<button className="w-full py-3 px-4 bg-purple-500 hover:bg-purple-600 rounded-lg font-medium transition-colors">Get Started</button>
</div>
</div>
...
<p className="text-gray-400 mb-6">For businesses and organizations</p>
<ul className="space-y-3 mb-8">
<li className="flex items-center">
...
<button className="w-full py-3 px-4 bg-indigo-500 hover:bg-indigo-600 rounded-lg font-medium transition-colors">Contact Sales</button>
</div>
</div>
</div>

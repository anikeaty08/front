...
<button className="text-gray-700 hover:text-indigo-700 font-medium" onclick="showSection('landing')">Home</button>
<button className="text-gray-700 hover:text-indigo-700 font-medium" onclick="showSection('dashboard')">Dashboard</button>
<button className="text-gray-700 hover:text-indigo-700 font-medium" onclick="showSection('onboarding')">Onboard</button>
...
<button className="bg-yellow-300 text-indigo-900 font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-yellow-400 transition" onclick="showSection('onboarding')">Get Started</button>
<button className="bg-white text-indigo-700 px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-gray-100 transition" onclick="showSection('dashboard')">View Dashboard</button>
</div>
</div>
...
<button className="bg-indigo-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg hover:bg-indigo-800 transition" onclick="showSection('onboarding')">Get Started Now</button>
</div>
</section>
...
<button className="bg-yellow-300 text-indigo-900 px-8 py-3 rounded-lg font-semibold shadow-lg hover:bg-yellow-400 transition mt-4 md:mt-0" onclick="showSection('onboarding')">Onboard Now</button>
</div>
</div>
</section>

...
<a className="block py-2 hover:text-cyan-400" href="#blog" onclick="closeMenu()">Blog</a>
<a className="block py-2 hover:text-cyan-400" href="#podcast" onclick="closeMenu()">Podcast</a>
<a className="block py-2 hover:text-cyan-400" href="#whitepaper" onclick="closeMenu()">White Paper</a>
<a className="block py-2 hover:text-cyan-400" href="#research" onclick="closeMenu()">Research</a>
<a className="block py-2 hover:text-cyan-400" href="#software" onclick="closeMenu()">Software</a>
<a className="block py-2 hover:text-cyan-400" href="#donate" onclick="closeMenu()">Donate</a>
<a className="block py-2 hover:text-cyan-400" href="#join" onclick="closeMenu()">Join</a>
</div>

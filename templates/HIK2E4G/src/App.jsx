...
<div className="relative bg-gray-900 border border-white/20 rounded-2xl max-w-md w-full p-6 backdrop-blur-xl" onclick="event.stopPropagation()">
...
<div className="relative bg-gray-900 border border-white/20 rounded-2xl max-w-md w-full p-6 backdrop-blur-xl text-center" onclick="event.stopPropagation()">

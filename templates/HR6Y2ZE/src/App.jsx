...
<path d="M2 16a16 16 0 0 1 27 0" fill="none" stroke="#fde68a" stroke-dasharray="100" stroke-dashoffset="25" strokeLinecap="round" strokeWidth="4"></path>
</svg>
...
<style>
.shadow-innerBorder {
  box-shadow: inset 0 1.5px 8px 0 rgba(0,0,0,0.55), 0 1.5px 24px 0 rgba(0,0,0,0.18);
}
</style>

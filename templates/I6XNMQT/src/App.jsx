  ...
  useEffect(() => {
    ...
    try {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let spotlightColor = 'rgba(145, 64, 115, 0.25)';
...
<div className="relative z-10 w-full max-w-7xl mx-auto px-8" style={{zIndex: '3'}}>
...
<div aria-label="Websites Solution Card" className="rounded-2xl p-0 border border-gray-800/50 bg-gradient-to-br from-gray-900/20 to-gray-800/10 backdrop-blur-sm hover:border-gray-700/80 hover:bg-gray-800/20 transition-all duration-500 h-full flex flex-col relative overflow-hidden solution-card-spotlight" data-card="websites" style={{'--spotlight-color': 'rgba(145, 64, 115, 0.25)'}} tabindex="0">
...
<ul className="flex flex-col gap-3 mt-4 mb-0 pl-0">
...
<div aria-label="SEO Solution Card" className="rounded-2xl p-0 border border-gray-800/50 bg-gradient-to-br from-gray-900/20 to-gray-800/10 backdrop-blur-sm hover:border-gray-700/80 hover:bg-gray-800/20 transition-all duration-500 h-full flex flex-col relative overflow-hidden solution-card-spotlight" data-card="seo" style={{'--spotlight-color': 'rgba(145, 64, 115, 0.25)'}} tabindex="0">
<div className="flex items-center gap-3 px-8 pt-8 pb-4">
<div className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/5">
<i className="w-6 h-6 text-purple-400" data-lucide="search"></i>
</div>
<div>
<h3 className="text-xl font-medium text-white tracking-tight font-geist">
                                    SEO
...
<div aria-label="Google Ads Solution Card" className="rounded-2xl p-0 border border-gray-800/50 bg-gradient-to-br from-gray-900/20 to-gray-800/10 backdrop-blur-sm hover:border-gray-700/80 hover:bg-gray-800/20 transition-all duration-500 h-full flex flex-col relative overflow-hidden solution-card-spotlight" data-card="ads" style={{'--spotlight-color': 'rgba(145, 64, 115, 0.25)'}} tabindex="0">
<div className="flex items-center gap-3 px-8 pt-8 pb-4">
<div className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/5">
...
<div aria-label="Social Media Solution Card" className="rounded-2xl p-0 border border-gray-800/50 bg-gradient-to-br from-gray-900/20 to-gray-800/10 backdrop-blur-sm hover:border-gray-700/80 hover:bg-gray-800/20 transition-all duration-500 h-full flex flex-col relative overflow-hidden solution-card-spotlight" data-card="social" style={{'--spotlight-color': 'rgba(145, 64, 115, 0.25)'}} tabindex="0">
<div className="flex items-center gap-3 px-8 pt-8 pb-4">
<div className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/5">

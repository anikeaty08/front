...
<path d="M56 32a24 24 0 1 1-6.7-16.9" stroke="currentColor" strokeLinecap="round" strokeWidth="4"></path>
<circle cx="10" cy="42" fill="currentColor" r="2.5"></circle>
<text fill="currentColor" fontFamily="Inter, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" fontSize="22" font-weight="600" x="22" y="44">cv</text>
</svg>
</span>

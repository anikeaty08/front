...
<button className="nav-link text-blue-400 font-medium active" onclick="showView('dashboard')">Dashboard</button>
<button className="nav-link text-gray-300 font-medium" onclick="showView('calendar')">Calendar</button>
<button className="nav-link text-gray-300 font-medium" onclick="showView('reports')">Reports</button>
<button className="nav-link text-gray-300 font-medium" onclick="showView('settings')">Settings</button>
</div>
...
<div className="flex items-center space-x-4">
<button className="glass-inner p-3 rounded-xl hover:bg-white/10 transition-all" onclick="previousMonth()">
<svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M15 19l-7-7 7-7" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</button>
<span className="text-white font-medium text-xl px-6" id="currentMonthFull"></span>
<button className="glass-inner p-3 rounded-xl hover:bg-white/10 transition-all" onclick="nextMonth()">
<svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M9 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</button>
...
<button className="flex-1 bg-gradient-to-r from-emerald-500 to-blue-500 text-white font-medium py-3 px-6 rounded-xl hover:from-emerald-600 hover:to-blue-600 transition-all duration-300 shadow-lg" onclick="saveEntry()">
                        Save Entry
                    </button>
<button className="bg-gradient-to-r from-red-500 to-pink-500 text-white font-medium py-3 px-6 rounded-xl hover:from-red-600 hover:to-pink-600 transition-all duration-300 shadow-lg" onclick="deleteEntry()">
                        Delete
                    </button>
</div>
</div>

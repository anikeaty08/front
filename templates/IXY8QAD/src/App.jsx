...
<button className="w-full px-6 py-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg transition heading-font text-sm flex items-center justify-center" onclick="nextStep()">
                    Get Started
...
<button className="px-6 py-3 bg-neutral-100 hover:bg-neutral-200 text-neutral-700 rounded-lg transition heading-font text-sm" onclick="prevStep()">Back</button>
<button className="flex-1 px-6 py-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg transition heading-font text-sm" onclick="nextStep()">Continue</button>
</div>
</div>

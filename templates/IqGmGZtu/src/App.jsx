...
<div className="flex justify-between items-center">
<div className="flex items-center">
<div bg-blue-100="" className="w-10 h- &lt;div class=" flex="" h-10="" items-center="" justify-center="" mr-3"="" rounded-full="" w-10="">
<svg className="text-blue-600" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<path d="M21 14h-8v-2h8v2zm-8-4V8h8v2h-8zm8 8h-8v-2h8v2zm-9-8a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"></path>
<path d="M4 8a4 4 0 0 1 4-4 4 4 0 0 1 4 4 4 4 0 0 1-4 4 4 4 0 0 1-4-4z"></path>
<path d="M9 16.3c-.2-.2-1.1-.8-2.1-1.1-.6-.2-1.3-.2-1.9-.2-.8 0-1.4.1-1.9.2-1 .3-1.9.9-2.1 1.1-.2.2-.2.4-.2.7h8.4c0-.3 0-.5-.2-.7z"></path>
</svg>
</div>
<div>

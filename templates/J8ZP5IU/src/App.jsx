...
<a className="group relative overflow-hidden transition hover:bg-white/10 bg-center bg-white/5 bg-cover rounded-2xl backdrop-blur-xl bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c160e528-a195-4720-8c90-671df696522d_800w.jpg)]" href="#" style={{}}>
...
<a className="group relative overflow-hidden transition hover:bg-white/10 bg-center bg-white/5 bg-cover rounded-2xl backdrop-blur-xl bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/737e9198-413d-453a-bd26-a7891df32780_800w.jpg)]" href="#">
<div className="absolute inset-0 flex">
<div className="w-2/6"></div>
<div className="w-4/6 flex pt-0 pr-0 pb-0 pl-0 items-center justify-center">

...
<header className="sticky top-0 z-30 bg-sky-950/80 border-white/10 border-b backdrop-blur">
...
<span className="text-lg font-nunito text-sky-50" style={{}}>ZION-CITY</span>
</div>
<ul className="hidden md:flex gap-5 text-sm">
<li className=""><a className="font-nunito text-sky-50 hover:text-white" href="#" style={{}}>Dashboard</a></li>
<li><a className="font-nunito text-sky-50 hover:text-white" href="#" style={{}}>Gear</a></li>
<li><a className="font-nunito text-sky-50 hover:text-white" href="#" style={{}}>Matches</a></li>
<li><a className="font-nunito text-sky-50 hover:text-white" href="#" style={{}}>Profile</a></li>
</ul>
<button className="ml-3 flex items-center gap-2 rounded-full px-2 py-1 ring-1 bg-sky-900/60 hover:bg-sky-800/80 ring-white/10">
<img alt="avatar" className="w-7 h-7 rounded-full ring-2 object-cover ring-sky-400" src="https://randomuser.me/api/portraits/men/22.jpg?w=800&amp;q=80"/>
...
<p className="sm:text-xl mb-6 font-nunito text-xl text-gray-300" style={{}}>ЕДИНАЯ ВАЛЮТА ЕAЭС АЛТЫН, СУВЕРЕННЫЙ ИНТЕРНЕТ, ЦИФРОВАЯ ЭКОНОМИКА 2022</p>
...
<button className="btn-secondary pb-123 space-y-0 flex items-center gap-6 font-nunito" style={{}}>
            О ZION CITY
            <svg className="lucide lucide-info w-[18px] h-[18px]" data-lucide="info" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
</button>
</div>
</section>
...
<span className="w-9 h-9 rounded-full bg-gradient-to-tr flex items-center justify-center ring-2 from-cyan-400 to-sky-400 ring-white/10">
...
<span className="font-nunito font-bold text-xl text-slate-50" style={{}}>ALTYN</span>
</div>
<span className="inline-flex items-center gap-1 uppercase text-xs border rounded-full pt-1 pr-3 pb-1 pl-3 font-nunito text-sky-200 bg-sky-400/30 border-sky-400/50" style={{}}>Меню<svg className="lucide lucide-menu w-[14px] h-[14px]" data-lucide="menu" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.25" style={{width: '14px', height: '14px', color: 'rgb(186, 230, 253)'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M4 12h16"></path><path d="M4 18h16"></path><path d="M4 6h16"></path></svg></span>
</div>
...
<div className=""><div className="font-nunito font-bold text-xl text-sky-400" style={{}}>82%</div><div className="text-xs uppercase font-nunito" style={{}}>Win Rate</div></div>
<div className=""><div className="font-nunito font-bold text-xl text-sky-400" style={{}}>1.6ms</div><div className="text-xs uppercase font-nunito" style={{}}>Input Lag</div></div>
<div className=""><div className="font-nunito font-bold text-xl text-sky-400" style={{}}>4.5h</div><div className="text-xs uppercase font-nunito" style={{}}>Session</div></div>
</div>
...
<span className="w-9 h-9 rounded-lg border flex items-center justify-center bg-sky-700/30 border-sky-400/30">
...
<div className="flex items-center gap-3 font-nunito" style={{}}>
<span className="w-9 h-9 rounded-lg border flex items-center justify-center bg-sky-800/30 border-sky-400/30">
...
<button className="flex gap-2 hover:scale-105 active:scale-95 transition bg-gradient-to-r border rounded-lg pt-2 pr-4 pb-2 pl-4 items-center font-nunito text-white from-sky-400/90 to-sky-400/80 border-sky-400/40" style={{}}>Купить «Алтын»<svg className="lucide lucide-wallet w-[24px] h-[24px]" data-lucide="wallet" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" style={{width: '24px', height: '24px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"></path><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"></path></svg></button><button className="flex gap-2 active:scale-95 transition border rounded-lg pt-2 pr-4 pb-2 pl-4 items-center font-nunito hover:bg-sky-900/15 text-sky-200 bg-white/5 border-sky-400/30" style={{}}>Курс валюты<svg className="lucide lucide-bar-chart-3 w-5 h-5" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg></button>
</div>

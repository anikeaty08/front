...
<button className="p-2 hover:bg-slate-700/50 rounded-full transition" onclick="closeSearch()">
...
<div className="flex items-center space-x-3">
<button className="p-2 hover:bg-slate-700/60 transition rounded-full outline-none focus:ring-2 focus:ring-red-500 tooltip" data-tooltip="Search" onclick="openSearch()">
...
<img alt="Midnight Chronicles" className="w-full h-72 md:h-96 object-cover scale-105 transition-all duration-500 group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/131bb8ac-5b7c-4df7-9a6c-a9b982eb18a0_1600w.jpg"/>
...
<div className="flex items-center space-x-3">
<button className="inline-flex items-center space-x-2 bg-gradient-to-r from-red-600 via-red-500 to-red-400 text-white text-sm font-semibold px-6 py-3 rounded-xl shadow-md hover:scale-105 transition-all focus:outline-none focus:ring-2 focus:ring-red-500 animate-fade-in-up" onclick="playVideo()" style={{animationDelay: '0.4s'}}>
...
<button className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur text-white text-sm font-semibold px-6 py-3 rounded-xl border border-white/20 hover:bg-white/20 transition-all focus:outline-none focus:ring-2 focus:ring-white/50" onclick="addToWatchlist()">
...
<img alt="Digital Divide" className="w-full h-40 object-cover group-hover:brightness-105 transition" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/00c49c51-b2f7-421e-bba1-ff3df1af734f_1600w.jpg"/>
...
<div className="card flex-shrink-0 w-44 bg-gradient-to-br from-slate-800/90 via-slate-800/90 to-slate-800/95 border border-white/10 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group outline-none focus:ring-2 focus:ring-red-500 animate-fade-in-up flex flex-col" onclick="showDetails('Ocean Deep')" style={{animationDelay: '0.5s'}}>
<div className="relative overflow-hidden rounded-t-2xl">
<img alt="Ocean Deep" className="w-full h-40 object-cover group-hover:brightness-105 transition" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/48933b0d-af9c-47d1-bdc1-e0133dfc4f97_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<button className="absolute top-2 right-2 p-1.5 bg-black/50 backdrop-blur rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-black/70">
<svg className="lucide lucide-play w-4 h-4 text-white" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</button>
...
<div className="card flex-shrink-0 w-44 bg-gradient-to-br from-slate-800/90 via-slate-800/90 to-slate-800/95 border border-white/10 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group outline-none focus:ring-2 focus:ring-red-500 animate-fade-in-up flex flex-col" onclick="showDetails('City Lights')" style={{animationDelay: '0.55s'}}>
<div className="relative overflow-hidden rounded-t-2xl">
<img alt="City Lights" className="w-full h-40 object-cover group-hover:brightness-105 transition" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b364d321-6ae7-4010-8a05-37d12694108e_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<button className="absolute top-2 right-2 p-1.5 bg-black/50 backdrop-blur rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-black/70">
<svg className="lucide lucide-play w-4 h-4 text-white" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</button>
...
<div className="card flex-shrink-0 w-44 bg-gradient-to-br from-slate-800/90 via-slate-800/90 to-slate-800/95 border border-white/10 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group outline-none focus:ring-2 focus:ring-red-500 animate-fade-in-up flex flex-col" onclick="showDetails('Echoes')" style={{animationDelay: '0.6s'}}>
<div className="relative overflow-hidden rounded-t-2xl">
<img alt="Echoes" className="w-full h-40 object-cover group-hover:brightness-105 transition" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/24ec0171-4413-4899-8c3e-a7e758f3cbfd_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<button className="absolute top-2 right-2 p-1.5 bg-black/50 backdrop-blur rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-black/70">
<svg className="lucide lucide-play w-4 h-4 text-white" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</button>
...
<img alt="Profile" className="w-11 h-11 rounded-full object-cover border-2 border-red-600/30 shadow" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/477765ae-46ca-4701-afb5-5686f2f20c7a_320w.jpg"/>
...
<div className="relative">
<button className="p-2 hover:bg-slate-700/50 rounded-full transition focus:outline-none focus:ring-2 focus:ring-red-500" onclick="toggleProfileMenu()">
...
<div className="relative">
<img alt="Shadow Valley" className="w-20 h-12 rounded object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/21b7ee4f-dfd0-45f5-a64c-b8a7761bc2b9_320w.jpg"/>
...
<div className="relative">
<img alt="Shadow Valley" className="w-20 h-12 rounded object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5d062fec-0a26-47e3-857c-f69554167460_320w.jpg"/>
<div className="absolute inset-0 bg-black/20 rounded opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
<svg className="lucide lucide-play w-5 h-5 text-white" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</div>
</div>
...
<div className="relative">
<img alt="Midnight Chronicles" className="w-20 h-12 rounded object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/72c0a942-8db1-4109-b875-9ccb3cee3299_320w.jpg"/>
<div className="absolute inset-0 bg-black/20 rounded opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
<svg className="lucide lucide-play w-5 h-5 text-white" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</div>
</div>
...
<div className="flex items-center space-x-3 bg-gradient-to-r from-slate-800/80 via-slate-900/80 to-slate-800/90 rounded-2xl p-3 shadow border border-white/10 hover:border-white/20 transition-all cursor-pointer group">
<div className="relative">
<img alt="Digital Divide" className="w-20 h-12 rounded object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f83949d8-67f4-44e7-bd91-b1f427402651_320w.jpg"/>
<div className="absolute -top-1 -right-1 flex -space-x-1">
<img alt="Friend" className="w-4 h-4 rounded-full border border-slate-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/477765ae-46ca-4701-afb5-5686f2f20c7a_320w.jpg"/>

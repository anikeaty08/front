...
<button className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-white ring-1 ring-neutral-200 text-sm hover:bg-neutral-50" onclick="enterWizardFromDashboard()">Open</button>
...
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('dashboard')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back to Dashboard
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('checkout')">
                      Next — Checkout Page
...
<div className="mt-4 flex items-center justify-between">
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('product')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back — Product
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('bump')">
                      Next — Order Bump
                      <i className="size-[18px]" data-lucide="chevron-right"></i>
</button>
</div>
...
<button className="inline-flex items-center gap-2 px-2.5 py-1.5 rounded-md text-xs ring-1 ring-neutral-200 hover:bg-neutral-50 transition" onclick="simulateCheckout()">
...
<div className="mt-4 flex items-center justify-between">
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('checkout')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back — Checkout
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('upsells')">
                      Next — Upsells
                      <i className="size-[18px]" data-lucide="chevron-right"></i>
</button>
</div>
...
<div className="mt-4 flex items-center justify-between">
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('bump')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back — Order Bump
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('downsells')">
                      Next — Downsells
                      <i className="size-[18px]" data-lucide="chevron-right"></i>
</button>
</div>
...
<div className="mt-4 flex items-center justify-between">
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('upsells')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back — Upsells
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('thankyou')">
                      Next — Thank You
                      <i className="size-[18px]" data-lucide="chevron-right"></i>
</button>
</div>
...
<div className="mt-4 flex items-center justify-between">
<button className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('downsells')">
<i className="size-[18px]" data-lucide="chevron-left"></i>
                      Back — Downsells
                    </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('map')">
                      Next — Funnel Map
                      <i className="size-[18px]" data-lucide="chevron-right"></i>
</button>
</div>
...
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('thankyou')">
<i className="size-4" data-lucide="chevron-left"></i>
                    Back
                  </button>
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('analytics')">
                    Continue — Analytics
...
<div className="flex items-center gap-2">
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-white ring-1 ring-neutral-200 hover:bg-neutral-50 text-sm transition" onclick="goToStep('map')">
<i className="size-4" data-lucide="chevron-left"></i>
                        Back — Map
                      </button>
<button className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-emerald-600 text-white ring-1 ring-black/5 hover:bg-emerald-700 text-sm transition" onclick="goToStep('dashboard')">
                        Finish

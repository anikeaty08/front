...
<img alt="Financial Dashboard" className="w-full rounded-2xl shadow-2xl object-cover h-96 lg:h-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8eac089d-6f9c-4f95-99ec-0218c0c6ec17_1600w.jpg"/>
</div>
</div>
</div>
</section>
...
<img alt="Portfolio Analytics" className="rounded-xl w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5c17ca71-0e51-4ac2-a6b0-02dbf73b8fdd_800w.jpg"/>
...
<img alt="Security Infrastructure" className="rounded-xl w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/956ef7f0-86a7-4d5a-ae7b-43d0ca339aba_800w.jpg"/>
<div className="mt-6 flex items-center gap-4 text-sm text-slate-400">
<div className="flex items-center gap-1">
...
<img alt="Market Intelligence" className="rounded-xl w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/551013be-61e3-49e3-9001-73a3a9fea0c0_800w.jpg"/>
<div className="mt-6 flex items-center gap-4 text-sm text-slate-400">
<div className="flex items-center gap-1">
...
<img alt="Sarah Chen, CTO" className="rounded-2xl shadow-lg object-cover w-full h-96 lg:h-[500px]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/336569e1-5ebd-455c-8b6f-f159ef2b28ed_1600w.jpg"/>
</div>

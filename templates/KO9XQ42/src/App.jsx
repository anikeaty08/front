...
<img alt="Luxury Villa" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cca81beb-4f3e-4874-a88a-6608b8a91637_1600w.jpg" style={{}}/>
...
<img alt="Manhattan Penthouse" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6f9ebb4a-77d8-4b87-9ae2-a392fe9626d8_800w.jpg" style={{}}/>
...
<div className="group cursor-pointer">
<div className="relative h-32 lg:h-40 overflow-hidden bg-gray-900">
<img alt="Modern Villa" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e74be831-5deb-4313-853a-8949b05f2171_800w.jpg" style={{}}/>
<div className="absolute inset-0 group-hover:bg-black/20 transition-colors duration-300 bg-black/30"></div>
<div className="absolute bottom-3 left-3 text-white">
...
<div className="group cursor-pointer">
<div className="relative h-32 lg:h-40 overflow-hidden bg-gray-900">
<img alt="Urban Penthouse" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d6a247fd-9763-4426-8296-4c6414122bfc_800w.jpg" style={{}}/>
<div className="absolute inset-0 group-hover:bg-black/20 transition-colors duration-300 bg-black/30"></div>
<div className="absolute bottom-3 left-3 text-white">
...
<div className="group cursor-pointer">
<div className="relative h-32 lg:h-40 overflow-hidden bg-gray-900">
<img alt="Waterfront Estate" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/21c2faef-8c83-49a8-b921-a4c6fd4effc6_800w.jpg" style={{}}/>
<div className="absolute inset-0 group-hover:bg-black/20 transition-colors duration-300 bg-black/30"></div>
<div className="absolute bottom-3 left-3 text-white">

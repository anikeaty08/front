...
<div className="absolute -top-24 -left-24 h-80 w-80 rounded-full blur-3xl opacity-20 bg-[#25eb2a]"></div>
<div className="absolute -bottom-20 -right-20 h-96 w-96 rounded-full blur-3xl opacity-20 bg-[#25eb2a]"></div>
<div className="absolute top-1/3 left-1/2 -translate-x-1/2 h-[28rem] w-[28rem] rounded-full blur-3xl opacity-10 bg-[#25eb2a]"></div>
</div>
...
<a className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#25eb2a] to-[#25eb2a] px-3.5 py-2.5 text-sm font-semibold tracking-tight text-neutral-950 shadow-sm hover:from-[#25eb2a] hover:to-[#25eb2a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25eb2a]" href="#buy">
              Play now
...
<h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight">
              Win <span className="bg-gradient-to-r from-[#25eb2a] via-[#25eb2a] to-[#25eb2a] bg-clip-text text-transparent">$3,000,000</span> this week
            </h1>
...
<i className="w-5 h-5 text-[#25eb2a]" data-lucide="trophy"></i>
</div>
<div>
...
<div className="flex items-center gap-2">
<button aria-label="Decrease" className="inline-flex h-11 w-11 items-center justify-center rounded-md bg-neutral-900 hover:bg-neutral-800 ring-1 ring-white/10 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25eb2a]" id="minusBtn">
<i className="w-5 h-5" data-lucide="minus"></i>
</button>
<input className="w-full h-11 rounded-md bg-neutral-950 ring-1 ring-white/10 px-4 text-center text-lg font-semibold tracking-tight focus:ring-2 focus:ring-[#25eb2a]/50 outline-none" id="ticketQty" inputmode="numeric" min="1" type="number" value="5"/>
<button aria-label="Increase" className="inline-flex h-11 w-11 items-center justify-center rounded-md bg-neutral-900 hover:bg-neutral-800 ring-1 ring-white/10 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25eb2a]" id="plusBtn">
...
<div className="h-full rounded-full bg-gradient-to-r from-[#25eb2a] to-[#25eb2a]" id="progressBar" style={{width: '0%'}}></div>
</div>
</div>
<button className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#25eb2a] to-[#25eb2a] px-5 py-3.5 text-sm font-semibold tracking-tight text-neutral-950 shadow-sm hover:from-[#25eb2a] hover:to-[#25eb2a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25eb2a]" id="purchaseBtn">
                  Purchase tickets
...
<div className="flex items-center gap-2">
<i className="w-4 h-4 text-[#25eb2a]" data-lucide="check-circle"></i>
...
<a className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-[#25eb2a] to-[#25eb2a] px-4 py-2 text-sm font-semibold tracking-tight text-neutral-950 shadow-sm hover:from-[#25eb2a] hover:to-[#25eb2a]" href="#buy" id="mobileBuy">
          Buy now
          <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>

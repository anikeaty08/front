...
<div className="mt-4">
<div className="h-72">
<canvas className="w-full h-full" height="288" id="allocationChart" style={{display: 'block', boxSizing: 'border-box', height: '288px', width: '347px'}} width="347"></canvas>
</div>

<div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-2 text-m">

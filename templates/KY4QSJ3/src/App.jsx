...
<marquee behavior="scroll" className="py-2 text-sm text-white/80" direction="left" id="tonightTicker" onmouseout="this.start();" onmouseover="this.stop();" scrollamount="4"></marquee>
</div>
</div>
...
<form className="flex gap-2 items-center" id="newsletterForm" onsubmit="return false">
...
<form className="mt-6 grid md:grid-cols-2 gap-4" id="caterForm" onsubmit="return false;">
<div className="md:col-span-2">
...
<form className="mt-6 grid md:grid-cols-2 gap-4" id="contactForm" onsubmit="return false;">
<div>
...
<form className="flex gap-2" id="footerNewsletter" onsubmit="return false;">

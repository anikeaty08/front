...
<button className="px-8 py-4 bg-black text-white rounded-full text-lg font-medium hover:bg-gray-800 transition-all duration-300 shadow-sm hover:shadow-md" onclick="openContactModal()">
                    Start Project
                </button>
<button className="px-8 py-4 border border-gray-300 text-black rounded-full text-lg font-medium hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md" onclick="document.getElementById('casi-studio').scrollIntoView({behavior: 'smooth'})">
                    View Portfolio
                </button>
</div>

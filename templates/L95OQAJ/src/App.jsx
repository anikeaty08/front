...
<div className="flex items-center space-x-3">
<img alt="Profile" className="w-8 h-8 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a4239f65-c647-458d-b02f-57640ce3f623_320w.jpg" style={{}}/>
...
<div className="relative h-32 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f198d06f-9683-4085-b9be-e6dccc631f60_800w.jpg)] bg-cover">
<img alt="Sarah" className="absolute bottom-4 left-4 w-16 h-16 rounded-full border-4 border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8034cded-525d-4ab5-8d29-c44e6b8d2881_800w.jpg" style={{}}/>
...
<circle cx="50" cy="50" fill="none" r="40" stroke="#3b82f6" stroke-dasharray="251" stroke-dashoffset="75" strokeLinecap="round" strokeWidth="8"></circle>
</svg>
...
<div className="hover:shadow-sm transition-shadow fade-in fade-in-delay-4 bg-neutral-900 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b88e97f2-2dd8-442b-a9bb-3e4f80d7fb9f_800w.jpg)] bg-cover border-neutral-800 border rounded-xl pt-6 pr-6 pb-6 pl-6">

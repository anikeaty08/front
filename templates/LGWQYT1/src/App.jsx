...
<div className="rounded-xl p-6 ring-1 ring-white/10 transition transform-gpu perspective-500 hover:shadow-cyan-400/80 hover:shadow-lg hover:ring-2 hover:ring-cyan-400 hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]" onmouseleave="this.style.transform='perspective(500px) rotateX(0) rotateY(0)'" onmousemove="const el=this;const rect=el.getBoundingClientRect();const x=event.clientX-rect.left;const y=event.clientY-rect.top;const cx=rect.width/2;const cy=rect.height/2;const dx=(x-cx)/cx;const dy=(y-cy)/cy;const tiltX=dy*12;const tiltY=dx*12;el.style.transform=`perspective(500px) rotateX(${-tiltX}deg) rotateY(${tiltY}deg)`;" style={{transformStyle: 'preserve-3d', transform: 'perspective(500px) rotateX(0deg) rotateY(0deg)'}}>
...
<div className="ring-1 ring-white/10 transition rounded-xl pt-6 pr-6 pb-6 pl-6 perspective-500 transform-gpu hover:shadow-cyan-400/80 hover:shadow-lg hover:ring-2 hover:ring-cyan-400 hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]" onmouseleave="this.style.transform='perspective(500px) rotateX(0) rotateY(0)'" onmousemove="const el=this;const rect=el.getBoundingClientRect();const x=event.clientX-rect.left;const y=event.clientY-rect.top;const cx=rect.width/2;const cy=rect.height/2;const dx=(x-cx)/cx;const dy=(y-cy)/cy;const tiltX=dy*12;const tiltY=dx*12;el.style.transform=`perspective(500px) rotateX(${-tiltX}deg) rotateY(${tiltY}deg)`;" style={{transformStyle: 'preserve-3d', transform: 'perspective(500px) rotateX(0deg) rotateY(0deg)'}}>
...
<div className="rounded-xl p-6 ring-1 ring-white/10 transition perspective-500 transform-gpu hover:shadow-cyan-400/80 hover:shadow-lg hover:ring-2 hover:ring-cyan-400 hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]" onmouseleave="this.style.transform='perspective(500px) rotateX(0) rotateY(0)'" onmousemove="const el=this;const rect=el.getBoundingClientRect();const x=event.clientX-rect.left;const y=event.clientY-rect.top;const cx=rect.width/2;const cy=rect.height/2;const dx=(x-cx)/cx;const dy=(y-cy)/cy;const tiltX=dy*12;const tiltY=dx*12;el.style.transform=`perspective(500px) rotateX(${-tiltX}deg) rotateY(${tiltY}deg)`;" style={{transformStyle: 'preserve-3d', transform: 'perspective(500px) rotateX(0deg) rotateY(0deg)'}}>

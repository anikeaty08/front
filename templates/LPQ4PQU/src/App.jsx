...
<div %3e%3c="" %3e%3ccircle="" %3e%3cg="" 60"="" className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg width=" cx="30" cy="30" fill="none" fillOpacity="0.03" fill-rule="evenodd" g%3e%3c="" height="60" opacity-40"="" r="1" svg%3e')]="" viewbox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"></div>
</div>
...
<svg className="lucide lucide-calendar-check sm:w-10 sm:h-10 w-[32px] h-[32px]" data-lucide="calendar-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" style={{width: '32px', height: '32px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path><path d="m9 16 2 2 4-4"></path></svg>
</div>
...
<svg className="lucide lucide-trending-up sm:w-10 sm:h-10 w-[32px] h-[32px]" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" style={{width: '32px', height: '32px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 7h6v6"></path><path d="m22 7-8.5 8.5-5-5L2 17"></path></svg>
</div>
</div>

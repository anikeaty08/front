...
<div className="fixed z-[90] pointer-events-none mix-blend-screen" id="cursorHighlight" style="inset:auto auto 0 0; width:160px; height:160px; transform: translate(-9999px, -9999px);
      background: radial-gradient(100px 100px at center, rgba(138,255,117,0.18), rgba(222,255,81,0.06) 35%, rgba(138,255,117,0.02) 60%, transparent 70%);
      filter: blur(8px);"></div>

<div aria-hidden="true" className="fixed inset-0 -z-10">
<div className="absolute inset-0 opacity-80" id="globalGrid" style="
          background-image:

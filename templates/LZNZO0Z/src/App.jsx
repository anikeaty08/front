...
<section className="relative flex min-h-screen flex-col overflow-hidden bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/43b1f862-83f5-42c1-8168-d841ad05dd9c_3840w.jpg)] bg-cover pt-28 items-center justify-center">
...
<section className="sm:py-32 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/61613b76-62cc-4a73-95a6-2e470a47b858_3840w.jpg)] bg-cover pt-24 pb-24">

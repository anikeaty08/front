...
<button className="icon-btn hover-outline" data-darkreader-inline-bgcolor="" data-darkreader-inline-bgimage="" style={{background: 'linear-gradient(90deg, rgba(52, 187, 255, 0.2) 0%, rgba(78, 251, 127, 0.2) 100%)', -DarkreaderInlineBgimage: 'linear-gradient(90deg, var(--darkreader-background-34bbff33, rgba(0, 115, 173, 0.2)) 0%, var(--darkreader-background-4efb7f33, rgba(4, 156, 74, 0.2)) 100%)', '--darkreader-inline-bgcolor': 'initial'}} title="Run Quick Audit">

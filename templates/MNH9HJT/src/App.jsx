...
<p>Oi, aqui é o Pai Marcel. Eu sei como é sentir que alguém especial está se afastando ou que ainda nem conseguimos criar uma conexão. Eu já ajudei muitas pessoas que passaram exatamente por isso, e quero te mostrar que há um caminho para mudar essa situação.</p>
<p>Com essa análise, eu vou olhar para o seu caso de forma individual e cuidadosa. Vou te mostrar:</p>
<ul className="list-disc pl-5 space-y-2 text-white/85">
<li>O que está bloqueando a conexão entre vocês;</li>
<li>Como reverter o afastamento antes que ele se torne definitivo;</li>
<li>Como criar ou reacender um vínculo verdadeiro e duradouro.</li>
</ul>
<p>Não é uma fórmula pronta — cada orientação é feita pensando em você, na sua história e nas suas emoções. Meu objetivo é que você consiga despertar interesse, fortalecer vínculos e abrir portas para algo real e positivo.</p>
...
<div className="p-5">
<div className="flex items-center gap-3">
<img alt="Amanda S." className="h-12 w-12 rounded-full object-cover ring-2 ring-white" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&amp;q=80" style={{borderRadius: '50%'}}/>
<div>
...
<div className="p-5">
<div className="flex items-center gap-3">
<img alt="Carlos M." className="h-12 w-12 rounded-full object-cover ring-2 ring-white" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=1080&amp;q=80" style={{borderRadius: '50%'}}/>
<div>
...
<div className="p-5">
<div className="flex items-center gap-3">
<img alt="Juliana P." className="h-12 w-12 rounded-full object-cover ring-2 ring-white" src="https://images.unsplash.com/photo-1635151227785-429f420c6b9d?w=1080&amp;q=80" style={{borderRadius: '50%'}}/>
<div>
...
<div className="p-5">
<div className="flex items-center gap-3">
<img alt="Renato L." className="h-12 w-12 rounded-full object-cover ring-2 ring-white" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=1080&amp;q=80" style={{borderRadius: '50%'}}/>
<div>

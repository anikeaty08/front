...
<img alt="2025 Summer Camps" className="rounded-2xl shadow-lg w-full h-64 object-cover img-hover" src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?auto=format&amp;fit=crop&amp;w=600&amp;q=80"/>

<div className="absolute inset-0 flex items-center justify-center">
<div className="text-white font-extrabold text-4xl sm:text-5xl md:text-6xl drop-shadow-lg text-center select-none pointer-events-none">
              2025 Summer Camps
            </div>
</div>
<div className="absolute bottom-6 left-1/2 -translate-x-1/2">
<a aria-label="Enroll in 2025 Summer Camps" className="bg-blue-700 hover:bg-blue-800 px-6 py-3 rounded-full text-white font-semibold shadow transition-all duration-150 ease-in-out focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" href="https://forms.gle/your-google-form-link-here" rel="noopener noreferrer" target="_blank">Enroll Now</a>
</div>
</div>
<p className="text-gray-700 mt-4 text-center px-2 text-base md:text-sm fade-in">
          Hands-on, fun academic and enrichment camps for K-8. Explore, learn, and make friends this summer!
        </p>
</div>

<div className="flex-1 flex flex-col items-center justify-center">
<div className="relative w-full group">
<img alt="2025 Fall Programs" className="rounded-2xl shadow-lg w-full h-64 object-cover img-hover" src="https://images.unsplash.com/photo-1503676382389-4809596d5290?auto=format&amp;fit=crop&amp;w=600&amp;q=80"/>

<div className="absolute inset-0 flex flex-col items-center justify-center">
<div className="text-white font-extrabold text-4xl sm:text-5xl md:text-6xl drop-shadow-lg text-center select-none pointer-events-none mb-6">
              2025 Fall Programs
            </div>
<a aria-label="Enroll in 2025 Fall Programs" className="bg-blue-700 hover:bg-blue-800 px-6 py-3 rounded-full text-white font-semibold shadow transition-all duration-150 ease-in-out focus:ring-2 focus:ring-blue-300 focus:outline-none text-base" href="https://forms.gle/your-google-form-link-here" rel="noopener noreferrer" target="_blank">Enroll Now</a>
</div>
</div>
<p className="text-gray-700 mt-4 text-center px-2 text-base md:text-sm fade-in">
          After-school programs, academic enrichment, and skill-building for a successful school year. Small group and 1:1 options available.
        </p>
</div>
</div>
</section>

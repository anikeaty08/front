...
<img alt="Santorini" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ebb77f71-46e3-4f1e-b8b5-d1bbe5a39202_800w.jpg" style={{}}/>
...
<div className="relative min-w-[280px] h-72 rounded-2xl overflow-hidden shadow-sm border border-stone-200/60 hover:shadow-lg transition-shadow">
<img alt="Reykjavik" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e83b9dc6-2653-4648-bf4b-f9d30f115d8d_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
<div className="absolute inset-0 p-5 flex flex-col justify-end text-white">
<div className="flex items-center space-x-2 mb-2">
<span className="h-4 w-4 rounded-full overflow-hidden">
...
<div className="relative min-w-[280px] h-72 rounded-2xl overflow-hidden shadow-sm border border-stone-200/60 hover:shadow-lg transition-shadow">
<img alt="Barcelona" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e86c3104-8199-47cc-b038-e03c9379dc06_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
<div className="absolute inset-0 p-5 flex flex-col justify-end text-white">
<div className="flex items-center space-x-2 mb-2">
<span className="h-4 w-4 rounded-full overflow-hidden">
...
<div className="relative min-w-[280px] h-72 rounded-2xl overflow-hidden shadow-sm border border-stone-200/60 hover:shadow-lg transition-shadow">
<img alt="Oslo" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a8e9bf8b-f280-490f-8aad-54be215b6433_800w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
<div className="absolute inset-0 p-5 flex flex-col justify-end text-white">
<div className="flex items-center space-x-2 mb-2">
<span className="h-4 w-4 rounded-full overflow-hidden">

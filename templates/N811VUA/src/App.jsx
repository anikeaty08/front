...
<h1 className="md:text-6xl lg:text-7xl bg-clip-text fade text-4xl font-semibold text-transparent tracking-tight bg-gradient-to-tl from-blue-700 via-blue-800 to-gray-900" style={{animationDelay: '0.1s'}}>Navigate the Future of Finance with Cryptex</h1>

...
window.addEventListener('DOMContentLoaded', () => {
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/caafb46f-4cfe-4d82-8dfd-72321d98ac70_3840w.jpg")'}}></div>
...
<img alt="" className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/71fe71cd-cd57-472e-82c9-53d663c51c9b_320w.jpg"/>
<img alt="" className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1b33be0b-d1be-4f7e-99f3-df83494621cb_320w.jpg" style={{}}/>
<img alt="" className="w-8 h-8 rounded-full border-2 border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/17ae146c-1c35-492c-8da7-7936a3732309_320w.jpg" style={{}}/>
</div>
...
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4f2e4c2d-f99f-4851-a994-84f0eda2453b_320w.jpg" style={{}}/>
...
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/97a78864-b1aa-40f8-8970-19afe1729b3e_320w.jpg" style={{}}/>
<div className="flex-1">
...
<div className="flex items-center gap-3 hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-colors duration-200">
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/63734b64-3888-4b82-9dae-181a2f5b4fcd_320w.jpg" style={{}}/>
<div className="flex-1">
...
<div className="flex items-center gap-3 hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-colors duration-200">
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3834ac14-b247-4d1c-b43a-28feb7f8002e_320w.jpg" style={{}}/>
<div className="flex-1">
...
<div className="flex items-center gap-3 hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-colors duration-200">
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3757c353-e74a-45f8-9e1e-5794c6b10185_800w.jpg" style={{}}/>
<div className="flex-1">
...
<div className="flex items-center gap-3 hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-colors duration-200">
<img alt="" className="w-24 h-14 rounded-lg object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2ca62f36-96a5-4f49-9bfe-1c4f0021de9e_320w.jpg" style={{}}/>
<div className="flex-1">
...
<img alt="" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c4a261f6-cf8f-4ed8-8fa8-00fe2d3b1d61_800w.jpg" style={{}}/>
...
<div className="w-full h-24 relative overflow-hidden bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ebb77f71-46e3-4f1e-b8b5-d1bbe5a39202_800w.jpg)] bg-cover border-white/10 border rounded-lg">
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-3">
<img alt="" className="w-10 h-10 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/81508906-af60-495c-ac86-8039b3832a33_320w.jpg" style={{}}/>
<div className="">
...
<img alt="Video Frame 1" className="w-1/5 h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/63fe2476-0344-437c-8a76-061567c16d68_800w.jpg" style={{}}/>
<img alt="Video Frame 2" className="w-1/5 h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/16e0f42e-fb68-4e17-9309-3280af01fb86_800w.jpg" style={{}}/>
<img alt="Video Frame 3" className="w-1/5 h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b1c63d47-0d9d-4b44-9e0c-263cef27b106_800w.jpg" style={{}}/>
<img alt="Video Frame 4" className="w-1/5 h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/59b843dc-0c59-43a4-a938-a6002d6623cf_800w.jpg" style={{}}/>
<img alt="Video Frame 5" className="w-1/5 h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f83949d8-67f4-44e7-bd91-b1f427402651_800w.jpg"/>
</div>

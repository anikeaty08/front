...
<a className="hover:text-white transition-colors font-normal text-white/80 tracking-tighter" href="#">Home</a>
<a className="hover:text-white transition-colors text-white/80" href="#">Websites</a>
<a className="hover:text-white transition-colors text-white/80" href="#">Digital Marketing</a>
<a className="hover:text-white transition-colors text-white/80" href="#">About</a>
</div>
<div className="flex items-center space-x-4">
<a className="hover:bg-white/15 transition-colors text-white bg-white/10 border-white/10 border rounded-lg pt-2 pr-4 pb-2 pl-4" href="#">Contact Us</a>
...
<section className="relative z-10 min-h-[90vh] flex md:px-8 pt-10 pr-4 pb-20 pl-4 items-center">
...
<p className="md:text-xl max-w-xl fade-in fade-in-delay-2 text-lg text-white/80 font-geist text-left mb-8">
...
<a className="hover:bg-white/15 transition-all font-medium text-white text-center bg-white/10 border-white/10 border rounded-xl pt-4 pr-8 pb-4 pl-8" href="#">Case Studies</a>
</div>

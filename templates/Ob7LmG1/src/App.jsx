...
<div className="w-1/2 rounded-lg overflow-hidden shadow-xl border border-gray-700">
...
<span className="text-blue-400">&lt;head&gt;</span>
  ...
  <span className="text-blue-400">&lt;title&gt;</span><span className="text-gray-300">My Portfolio</span><span className="text-blue-400">&lt;/title&gt;</span>
<span className="text-blue-400">&lt;/head&gt;</span>
<span className="text-blue-400">&lt;body&gt;</span>
  <span className="text-blue-400">&lt;h1</span> <span className="text-green-400">class=</span><span className="text-amber-400">"title"</span><span className="text-blue-400">&gt;</span><span className="text-gray-300">Hello World</span><span className="text-blue-400">&lt;/h1&gt;</span>
  <span className="text-blue-400">&lt;p&gt;</span><span className="text-gray-300">Welcome to my website!</span><span className="text-blue-400">&lt;/p&gt;</span>
  <span className="text-blue-400">&lt;button&gt;</span><span className="text-gray-300">Click me</span><span className="text-blue-400">&lt;/button&gt;</span>
<span className="text-blue-400">&lt;/body&gt;</span>
...
<div className="w-1/2 rounded-lg overflow-hidden shadow-xl border border-gray-700 flex flex-col">
...
<div className="flex-1 bg-gray-700 rounded px-3 py-1 flex items-center">
<svg className="w-3 h-3 text-gray-400 mr-2" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
<span className="text-gray-300 text-xs">http://localhost:3000</span>
</div>
</div>

<div className="flex-1 bg-white p-6">
<h1 className="text-3xl font-bold mb-4 text-gray-900">Hello World</h1>
<p className="text-gray-700 mb-6">Welcome to my website!</p>

...
<button className="ml-2 bg-green-400 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-full transition shadow text-md" onclick="restart()">Restart</button>
</div>
...
<button aria-label="Previous card" className="bg-cyan-100 text-cyan-600 hover:bg-cyan-200 rounded-full p-2 disabled:opacity-40" id="prevBtn" onclick="prevCard()" title="Previous">
<svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M15 19l-7-7 7-7" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</button>
<div className="flex-grow"></div>
<button aria-label="Next card" className="bg-cyan-100 text-cyan-600 hover:bg-cyan-200 rounded-full p-2 disabled:opacity-40" id="nextBtn" onclick="nextCard(true)" title="Next">
<svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
...
<button className="bg-sky-400 hover:bg-sky-500 text-white font-bold py-2 px-6 rounded-full transition shadow text-lg" id="showAnswerBtn" onclick="flipCard()">
      Show Answer
    </button>
<div className="flex flex-col sm:flex-row gap-5">
<button className="flex items-center gap-2 bg-green-400 hover:bg-green-500 text-white text-lg font-bold py-2 px-6 rounded-full shadow transition" onclick="answerCard(true)">
<span>✔️</span> I got it!
      </button>
<button className="flex items-center gap-2 bg-rose-300 hover:bg-rose-400 text-white text-lg font-bold py-2 px-6 rounded-full shadow transition" onclick="answerCard(false)">
<span>❌</span> Not yet
      </button>
</div>
...
<button className="bg-green-400 hover:bg-green-500 text-white font-bold py-2 px-6 rounded-full shadow transition" onclick="restart()">
      Restart
    </button>
</div>
...
<button className="absolute right-4 top-2 text-gray-400 hover:text-rose-400 text-2xl font-bold rounded-full" onclick="closeModal()">×</button>
...
<button className="mt-2 bg-sky-400 hover:bg-sky-500 text-white font-bold py-1 px-4 rounded-full transition" onclick="importSheet()">Import from Google Sheet</button>
...
..." rows="5"></textarea>
<button className="mt-2 bg-green-400 hover:bg-green-500 text-white font-bold py-1 px-4 rounded-full transition" onclick="importText()">Import Pasted Cards</button>
<div className="text-xs text-gray-600 mt-1">
...
<button className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-1 px-3 rounded-full transition" onclick="closeModal()">Cancel</button>
</div>
</div>
</div>

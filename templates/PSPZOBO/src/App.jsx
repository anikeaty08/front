...
<input className="h-7 w-7 cursor-pointer border-0 p-0 bg-transparent" id="colorPrimary" oninput="this.parentNode.style.backgroundColor=this.value" style={{WebkitAppearance: 'none', appearance: 'none', border: 'none', padding: '0', margin: '0', width: '100%', height: '100%', borderRadius: '9999px', backgroundColor: 'transparent', opacity: '0', display: 'block'}} title="Primary color" type="color" value="#6366f1"/>
</div>
...
<select className="w-full focus:outline-none focus:ring-2 focus:ring-neutral-600/50 text-xs text-neutral-200 bg-neutral-900/0 border-neutral-800 border rounded-md pt-1.5 pb-1.5 pl-2 pr-8 cursor-pointer hover:border-neutral-700 transition" data-token="typography.family" style={{WebkitAppearance: 'none', MozAppearance: 'none', appearance: 'none', backgroundImage: 'url(\'data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23A3A3A3%27 strokeWidth=%271.5%27 strokeLinecap=%27round%27 strokeLinejoin=%27round%27%3E%3Cpath d=%27m6 9 6 6 6-6%27/%3E%3C/svg%3E\')', backgroundRepeat: 'no-repeat', backgroundPosition: 'right 8px center', backgroundSize: '14px 14px'}}>
...
<input className="w-full focus:outline-none focus:ring-2 focus:ring-neutral-600/50 text-xs text-neutral-200 bg-neutral-900/0 border-neutral-800 border rounded-md pt-1.5 pr-2 pb-1.5 pl-2" data-token="sizing.container" max="1920" min="640" oninput="(function(el){el.setAttribute('value', el.value);var p=el.parentNode;if(!p)return;var lbl=p.querySelector('#aura-emed4uhj2-readout');if(!lbl){lbl=document.createElement('div');lbl.id='aura-emed4uhj2-readout';lbl.className='mt-1 text-[11px] text-neutral-400';p.appendChild(lbl);}lbl.textContent=el.value+'px';})(this)" step="10" style={{padding: '0', borderWidth: '0', backgroundColor: 'transparent'}} type="range" value="1920"/>
<div className="mt-1 text-[11px] text-neutral-400">1920px</div>
</label>
<label className="block">
<span className="mb-1 block text-xs text-neutral-400">Gutter</span>
<input className="w-full focus:outline-none focus:ring-2 focus:ring-neutral-600/50 accent-neutral-200 text-xs text-neutral-200 bg-neutral-900/0 border-neutral-800 border rounded-md pt-1.5 pr-2 pb-1.5 pl-2" data-token="sizing.gutter" max="48" min="0" oninput="(function(el){el.setAttribute('value', el.value);var p=el.parentNode;if(!p)return;var lbl=p.querySelector('#aura-emed4slap-readout');if(!lbl){lbl=document.createElement('div');lbl.id='aura-emed4slap-readout';lbl.className='mt-1 text-[11px] text-neutral-400';p.appendChild(lbl);}lbl.textContent=el.value+'px';})(this)" step="1" style={{padding: '0', borderWidth: '0', backgroundColor: 'transparent'}} type="range" value="0"/>

...
<div className="bg-zinc-800/70 backdrop-blur-lg border border-zinc-700/50 rounded-xl p-4 subscription-card" onclick="window.location.href='#'">
<div className="flex items-center">
...
<div className="bg-zinc-800/70 backdrop-blur-lg border border-zinc-700/50 rounded-xl p-4 mb-3 subscription-card" onclick="window.location.href='#'">
<div className="flex items-center">

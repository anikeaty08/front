...
<button className="w-full glassmorphic rounded-xl p-4 text-left btn-hover glow-pulse" data-sound="quest-complete" onclick="triggerCelebration('task-clear')">
...
<button className="w-full glassmorphic rounded-xl p-4 text-left btn-hover glow-pulse" data-sound="mind-clear" onclick="triggerCelebration('inbox-zero')">
<div className="flex items-center space-x-3">
...
<div className="space-y-4">
<button className="w-full glassmorphic rounded-xl p-4 text-left btn-hover glow-pulse" data-sound="level-up" onclick="triggerCelebration('level-up')">
<div className="flex items-center space-x-3">
<div className="w-10 h-10 rounded-xl purple-pink-gradient flex items-center justify-center">
<svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24">
...
<button className="w-full glassmorphic rounded-xl p-4 text-left btn-hover glow-pulse" data-sound="fire-streak" onclick="triggerCelebration('streak-milestone')">
<div className="flex items-center space-x-3">
...
<div className="celebration-overlay aurora-bg" id="task-clear-overlay" onclick="hideCelebration(this)">
...
<div className="celebration-overlay aurora-bg" id="inbox-zero-overlay" onclick="hideCelebration(this)">
...
<div className="celebration-overlay aurora-bg" id="level-up-overlay" onclick="hideCelebration(this)">
...
<div className="celebration-overlay aurora-bg" id="streak-milestone-overlay" onclick="hideCelebration(this)">
<div className="text-center scale-bounce" style={{animationDelay: '0.3s'}}>
<div className="glassmorphic rounded-3xl p-12 max-w-md mx-auto relative overflow-hidden">

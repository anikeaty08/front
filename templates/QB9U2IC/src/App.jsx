...
<div className="max-w-7xl mx-auto w-full grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">

<div className="text-left max-w-2xl">
<h1 className="text-4xl md:text-5xl xl:text-6xl leading-tight fade-in fade-in-delay-1 text-slate-50 tracking-tight text-left mb-6">
                    Command Attention<br/>
                    Attract Dream Customers
                </h1>
<p className="text-lg md:text-xl text-white/80 mb-8 max-w-lg text-left fade-in fade-in-delay-2">
...
<div className="relative h-[600px] xl:h-[700px] flex items-center justify-center">

<div className="glass-effect bg-white/5 border border-white/10 rounded-2xl w-72 h-72 md:w-80 md:h-80 absolute transform rotate-6 floating-delay fade-in fade-in-delay-2">
<div className="absolute top-6 left-6 right-6 bottom-6 flex flex-col">
<div className="flex items-center mb-4">
<div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
<i className="fas fa-chart-line text-white text-sm"></i>
</div>
<span className="ml-3 text-white text-lg">AI Platform</span>
</div>
...
<i className="fas fa-brain text-white/60 text-4xl"></i>
</div>
</div>
...
<div className="glass-effect bg-white/5 border border-white/10 rounded-2xl w-56 h-40 md:w-64 md:h-44 absolute -bottom-8 -left-8 transform -rotate-12 floating fade-in fade-in-delay-3">
<div className="p-4">
<div className="flex justify-between items-center mb-3">
<span className="text-white text-sm">Customer Growth</span>
<i className="fas fa-arrow-up text-green-400 text-xs"></i>
</div>
<div className="h-16 md:h-20 flex items-end justify-between gap-1 mb-2">
...
<div className="glass-effect bg-white/5 border border-white/10 rounded-2xl w-40 h-40 md:w-48 md:h-48 absolute -top-4 -right-4 transform rotate-12 floating fade-in fade-in-delay-1">
<div className="p-4 h-full flex flex-col">
<div className="text-white text-sm mb-2">Engagement</div>
<div className="flex-1 flex items-center justify-center">
<div className="relative w-20 h-20 md:w-28 md:h-28 rounded-full bg-white/10 flex items-center justify-center">
<div className="absolute inset-0 rounded-full border-4 border-white/80 border-t-transparent transform rotate-45"></div>
<span className="text-xl md:text-2xl text-white font-medium">97%</span>
</div>
</div>
</div>
</div>

      ...
      function showSection(id) {
        sections.forEach(sec => {
          if (sec.id === id) {
            ...
            requestAnimationFrame(() => sec.classList.add('fade-enter-active'));
            setTimeout(() => sec.classList.remove('fade-enter', 'fade-enter-active'), 500);
          } else {
...
<a className="flex items-center space-x-2 font-semibold tracking-tight" href="#">
<span className="text-white">BL</span>
<span className="hidden sm:inline text-white">Blocker Law</span>
</a>
<div className="hidden md:flex items-center space-x-8 text-sm font-medium">
<button className="nav-link text-white hover:text-blue-200 transition" data-section="home">Home</button>
<button className="nav-link text-white hover:text-blue-200 transition" data-section="attorney">Attorney Profile</button>
<button className="nav-link text-white hover:text-blue-200 transition" data-section="practice">Practice Areas</button>
<button className="nav-link text-white hover:text-blue-200 transition" data-section="contact">Contact Us</button>
<button className="nav-link text-white hover:text-blue-200 transition" data-section="map">Map &amp; Directions</button>
</div>
<button className="md:hidden inline-flex items-center px-3 py-1.5 rounded-md bg-blue-900 hover:bg-blue-800 text-white text-sm font-medium transition" data-section="contact">
...
<h2 className="text-2xl sm:text-3xl font-medium tracking-tight text-blue-900">Blocker Law Works Tirelessly for Your Success</h2>
...
<a className="inline-flex items-center px-6 py-3 rounded-md bg-blue-900 text-white font-medium hover:bg-blue-800 transition" href="tel:12163609961">
<i className="w-4 h-4 mr-2" data-lucide="phone"></i> 216-360-9961
            </a>
<a className="inline-flex items-center px-6 py-3 rounded-md border border-slate-300 text-slate-800 font-medium hover:border-blue-900 hover:text-blue-900 transition" data-section="contact" href="#">
              Contact us online
...
<h3 className="text-2xl font-medium tracking-tight text-blue-900 text-center">David S. Blocker</h3>
...
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Core Expertise</h4>
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Representative Engagements</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Honors &amp; Recognition</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Bar Admissions</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
<li>Ohio, 2002</li>
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Education</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Professional Experience</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Associations</h4>
<ul className="list-disc list-inside space-y-1 text-slate-700">
...
<div className="space-y-4">
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Community &amp; Approach</h4>
...
<h4 className="text-xl font-semibold tracking-tight text-blue-900">Contact David</h4>
<p className="text-slate-700"><span className="font-medium">📞 Phone:</span> (216) 360-9961</p>
<p className="text-slate-700"><span className="font-medium">📧 Email/Inquiries:</span> Via the <button className="underline text-blue-900 hover:text-blue-800" data-section="contact">Contact Us</button> page</p>
...
<h3 className="text-2xl font-semibold tracking-tight text-blue-900 mb-3">Family Law</h3>
...
<a className="inline-flex items-center text-blue-900 text-sm font-medium hover:underline" href="#">
              View full Family Law services
              <i className="w-4 h-4 ml-1" data-lucide="arrow-right"></i>
</a>
</div>
<div className="border border-slate-100 rounded-lg p-6 shadow-sm hover:shadow-md transition">
<h3 className="text-2xl font-semibold tracking-tight text-blue-900 mb-3">Litigation</h3>
...
<div className="border border-slate-100 rounded-lg p-6 shadow-sm hover:shadow-md transition">
<h3 className="text-2xl font-semibold tracking-tight text-blue-900 mb-3">Debtor-Creditor &amp; Bankruptcy</h3>
...
<h4 className="text-lg font-semibold tracking-tight text-blue-900">Depth of Experience</h4>
...
<div className="space-y-2">
<h4 className="text-lg font-semibold tracking-tight text-blue-900">Tailored Representation</h4>
...
<div className="space-y-2">
<h4 className="text-lg font-semibold tracking-tight text-blue-900">Unwavering Commitment</h4>
...
<h3 className="text-2xl font-semibold tracking-tight text-blue-900">Ready to Get Started?</h3>
...
<div>
<h4 className="font-semibold text-blue-900">Why Contact Us?</h4>
...
<div>
<h4 className="font-semibold text-blue-900">Prefer a Conversation?</h4>
<p>Call us at (216) 360-9961, email <a className="text-blue-900 hover:underline" href="mailto:info@blockerlawfirm.com">info@blockerlawfirm.com</a>, or drop in during business hours.</p>
</div>
</div>
</div>
<form className="space-y-6" id="contactForm">
<h3 className="text-2xl font-semibold tracking-tight text-blue-900">Contact Form</h3>
<div className="grid sm:grid-cols-2 gap-6">
<div className="space-y-2 sm:col-span-2">
<label className="text-sm font-medium" htmlFor="name">Name *</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="name" required="" type="text"/>
</div>
<div className="space-y-2">
<label className="text-sm font-medium" htmlFor="company">Company (if applicable)</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="company" type="text"/>
</div>
<div className="space-y-2">
<label className="text-sm font-medium" htmlFor="email">Email *</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="email" required="" type="email"/>
</div>
<div className="space-y-2">
<label className="text-sm font-medium" htmlFor="phone">Phone *</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="phone" required="" type="tel"/>
</div>
<div className="space-y-2">
<label className="text-sm font-medium" htmlFor="city">City / State</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="city" type="text"/>
</div>
<div className="space-y-2">
<label className="text-sm font-medium" htmlFor="ref">How did you find us?</label>
<input className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="ref" placeholder="Google, referral, etc." type="text"/>
</div>
<div className="space-y-2 sm:col-span-2">
<label className="text-sm font-medium block">Preferred method of contact</label>
<div className="flex items-center gap-6">
<label className="flex items-center gap-2 text-sm">
<input checked="" className="h-4 w-4 text-blue-900 border-slate-300 focus:ring-blue-300" name="contactMethod" type="radio"/>
                  Phone
                </label>
<label className="flex items-center gap-2 text-sm">
<input className="h-4 w-4 text-blue-900 border-slate-300 focus:ring-blue-300" name="contactMethod" type="radio"/>
                  Email
                </label>
<label className="flex items-center gap-2 text-sm">
<input className="h-4 w-4 text-blue-900 border-slate-300 focus:ring-blue-300" name="contactMethod" type="radio"/>
...
<textarea className="w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300" id="message" required="" rows="4"></textarea>
</div>
</div>
<div className="space-y-4">
<button className="inline-flex items-center px-6 py-3 rounded-md bg-blue-900 text-white font-medium hover:bg-blue-800 transition" type="submit">
              Submit
              <i className="w-4 h-4 ml-2" data-lucide="arrow-right"></i>
</button>
...
<div className="space-y-4">
<h3 className="text-xl font-semibold tracking-tight text-blue-900 text-center">Serving Northeast Ohio</h3>
...
<p className="text-sm">✉️ Planning a visit or have questions? Call us at <a className="text-blue-900 hover:underline" href="tel:12163609961">216-360-9961</a>.</p>
</div>
</div>
</section>
</main>
...
<p>© <span id="year"></span> Blocker Law LLC • All rights reserved.</p>
<div className="flex items-center gap-4">
<a className="hover:underline" data-section="home" href="#">Home</a>
<a className="hover:underline" data-section="attorney" href="#">Attorney</a>
<a className="hover:underline" data-section="practice" href="#">Practice Areas</a>
<a className="hover:underline" data-section="contact" href="#">Contact</a>
</div>
</div>
</footer>

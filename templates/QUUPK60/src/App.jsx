...
<div className="py-2">
<button aria-label="Add pet photo" className="w-full h-32 rounded-2xl bg-[#fff2e8] border-2 border-dashed border-orange-300 flex items-center justify-center hover:bg-[#ffedd9] hover:border-orange-400 transition-all" onclick="selectPhoto()">
...
<button aria-haspopup="listbox" className="w-full h-12 bg-[#fff2e8] rounded-xl px-4 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="sexBtn" onclick="toggleDropdown('sex')">
...
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('sex', 'Male')">Male</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('sex', 'Female')">Female</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('sex', 'Unknown')">Unknown</button></li>
</ul>
</div>

<div className="relative">
<label className="text-sm font-medium text-gray-600 mb-2 block">Species *</label>
<button aria-haspopup="listbox" className="w-full h-12 bg-[#fff2e8] rounded-xl px-4 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="speciesBtn" onclick="toggleDropdown('species')">
...
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Dog')">Dog</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Cat')">Cat</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Fish')">Fish</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Small Mammal')">Small Mammal</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Bird')">Bird</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Reptile')">Reptile</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Horse')">Horse</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('species', 'Other')">Other</button></li>
</ul>
</div>

<div className="relative">
<label className="text-sm font-medium text-gray-600 mb-2 block">Breed</label>
<button aria-haspopup="listbox" className="w-full h-12 bg-[#fff2e8] rounded-xl px-4 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="breedBtn" onclick="toggleDropdown('breed')">
...
<div className="relative">
<input className="w-full h-12 bg-[#fff2e8] rounded-xl px-4 pr-12 focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="birthDateText" onchange="calculateAge()" oninput="calculateAge()" placeholder="MM/DD/YYYY" type="text"/>
<button aria-label="Open date picker" className="absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:bg-orange-200 rounded transition-colors" onclick="openDatePicker()" type="button">
...
<input className="absolute opacity-0 pointer-events-none" id="hiddenDatePicker" onchange="updateTextFromPicker()" type="date"/>
</div>
...
<input className="flex-1 h-12 bg-[#fff2e8] rounded-xl px-4 focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="weightInput" min="0" oninput="updateWeightDisplay()" step="0.1" type="number"/>
<div className="flex bg-gray-100 rounded-xl p-1 h-12">
<button className="px-3 py-2 rounded-lg text-sm font-medium transition-all bg-orange-400 text-white" id="kgBtn" onclick="toggleWeightUnit('kg')">kg</button>
<button className="px-3 py-2 rounded-lg text-sm font-medium transition-all text-gray-600 hover:text-gray-800" id="lbBtn" onclick="toggleWeightUnit('lb')" style={{}}>lb</button>
</div>
</div>
...
<button aria-haspopup="listbox" className="w-full h-12 bg-[#fff2e8] rounded-xl px-4 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-orange-400 border border-orange-200" id="spayedBtn" onclick="toggleDropdown('spayed')">
...
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('spayed', 'Yes')">Yes</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('spayed', 'No')">No</button></li>
<li><button className="w-full px-4 py-3 text-left hover:bg-orange-50" onclick="selectOption('spayed', 'Unknown')">Unknown</button></li>
</ul>
</div>
...
<button className="flex items-center gap-1 px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-sm hover:bg-orange-200 transition-colors" onclick="showAllergyInput()" style={{}}>
...
<input className="w-full bg-transparent focus:outline-none text-sm hidden" id="allergyInput" onblur="hideAllergyInput()" onkeypress="handleAllergyInput(event)" placeholder="Type allergy and press Enter" style={{}} type="text"/>
</div>
</div>

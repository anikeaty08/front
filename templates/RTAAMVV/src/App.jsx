...
<section className="lg:py-24 text-white bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d6683c27-db00-4574-a03f-40b1577013ad_3840w.jpg)] bg-cover pt-16 pb-16 blur-none">
<div className="max-w-7xl sm:px-6 lg:px-8 mr-auto ml-auto pr-4 pl-4">
...
<span className="" style={{display: 'block', padding: '12px 24px', borderRadius: '25px', overflow: 'hidden', position: 'relative', backgroundImage: 'linear-gradient(to bottom, #e9d1ff, transparent 8px)', backgroundPosition: '0 -6px', backgroundRepeat: 'no-repeat', zIndex: '1'}}>
    ...
    <style>
      ...
      #aura-emdxjiri6 span::before,
      #aura-emdxjiri6 span::after {
        content: "";
        position: absolute;
        left: 50%;
        transform: translateX(-50%);
      ...
      #aura-emdxjiri6:hover span::before {
        opacity: 0.8;
        transform: translateX(-50%) scale(1.25);
      }
      #aura-emdxjiri6:hover span::after {
        opacity: 1;
      }
    </style>
</span>

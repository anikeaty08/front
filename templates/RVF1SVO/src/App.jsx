...
<div className="absolute inset-0 bg-gradient-to-b via-transparent from-black/60 to-black/60"></div>
</div>
...
<span className="text-xs sm:text-sm tracking-tight text-gray-400">VIP/ <span className="tabular-nums" id="localTime">13:13:27</span></span>
</div>

<nav aria-label="Primary" className="hidden md:flex items-center gap-6">
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#impact">Impact</a>
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#services">Services</a>
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#work">Work</a>
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#pricing">Pricing</a>
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#faq">FAQ</a>
<a className="text-sm font-medium tracking-tight transition-colors text-gray-300 hover:text-gray-100" href="#contact">Contact</a>
</nav>
<a className="group inline-flex items-center gap-2 text-sm font-medium tracking-tight border rounded-full px-4 py-2 text-black bg-gray-100 hover:bg-gray-200 border-gray-800/10" href="#contact">
...
<div className="relative overflow-hidden rounded-[32px] border shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_8px_30px_rgba(0,0,0,0.08)] bg-black border-black/20">
...
<h1 className="text-[36px] sm:text-[52px] lg:text-[64px] leading-[1.05] font-semibold text-gray-100 tracking-tight">Marketing that Builds Financial Brands.</h1>
...
<a className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border shadow-sm text-black bg-emerald-400 hover:bg-emerald-300 border-emerald-300/20" href="#impact">
...
<div className="relative overflow-hidden rounded-2xl h-[260px] sm:h-[320px] bg-neutral-100">
...
<div className="absolute inset-0 bg-gradient-to-t to-transparent from-white/60 via-white/10"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-sm text-black/90">Acquisition Engine</p>
<h3 className="text-2xl font-semibold tracking-tight text-black">AI-First Growth Stack</h3>
<div className="mt-3 grid grid-cols-3 gap-2">
<div className="rounded-lg border p-3 backdrop-blur-sm bg-black/10 border-black/10">
<p className="text-lg font-semibold tracking-tight text-black">+42%</p>
<p className="text-[11px] text-black/70">MQLs</p>
</div>
<div className="rounded-lg border p-3 backdrop-blur-sm bg-black/10 border-black/10">
<p className="text-lg font-semibold tracking-tight text-black">-31%</p>
<p className="text-[11px] text-black/70">CPA</p>
</div>
<div className="rounded-lg border p-3 backdrop-blur-sm bg-black/10 border-black/10">
<p className="text-lg font-semibold tracking-tight text-black">3.1x</p>
<p className="text-[11px] text-black/70">ROI</p>
</div>
</div>
</div>
</div>
...
<div className="rounded-2xl border p-4 bg-black border-gray-800/60">
<div className="text-2xl font-semibold tracking-tight">120+</div>
<p className="text-[12px] mt-0.5 text-gray-400">Financial Sector Projects</p>
</div>
<div className="rounded-2xl border p-4 bg-black border-gray-800/60">
<div className="text-2xl font-semibold tracking-tight">60+</div>
<p className="text-[12px] mt-0.5 text-gray-400">High-Value Clients</p>
</div>
<div className="rounded-2xl border p-4 bg-black border-gray-800/60">
<div className="text-2xl font-semibold tracking-tight">5+</div>
<p className="text-[12px] mt-0.5 text-gray-400">Years of Technical Expertise</p>
</div>
<div className="rounded-2xl border p-4 bg-black border-gray-800/60">
<div className="text-2xl font-semibold tracking-tight">98%</div>
<p className="text-[12px] mt-0.5 text-gray-400">Client Retention Rate</p>
</div>
</div>
</section>
...
<a className="inline-flex items-center gap-2 text-sm font-medium tracking-tight rounded-full px-3 py-1.5 border text-gray-200 bg-gray-900 hover:bg-gray-800 border-gray-800/60" href="#work">
...
<article className="group overflow-hidden rounded-2xl border bg-black border-gray-800/60">
...
<div className="absolute inset-0 bg-gradient-to-t via-transparent to-transparent from-white/20"></div>
</div>
<div className="p-4">
...
<p className="text-sm mt-1 text-gray-400">Multi-channel campaign driving a record number of new member sign-ups in Q3.</p>
</div>
</article>
...
<p className="text-sm mt-1 text-gray-400">A complete UI/UX and website overhaul focused on user experience and loan application conversion.</p>
</div>
</article>
...
<p className="text-sm mt-1 text-gray-400">AI-First SEO strategy that established topical authority and captured top search rankings.</p>
</div>
</article>
</div>
</div>
...
<a className="mt-5 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border text-black bg-gray-100 hover:bg-gray-200 border-gray-800/10" href="#team">
...
<div className="lg:col-span-7">
<div className="relative overflow-hidden rounded-2xl border border-gray-800/60">
...
<div className="rounded-xl backdrop-blur-sm border p-3 bg-black/80 border-gray-800/80">
...
<p className="text-[11px] text-gray-400">Retention</p>
</div>
</div>
</div>
...
<div className="mt-6 grid grid-cols-1 md:grid-cols-12 gap-6 border-t pt-6 border-gray-800/70">
...
<svg className="w-4 h-4 stroke-1.5 mt-0.5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<p className="mt-3 text-sm sm:text-base text-gray-300">Transparent answers about process, compliance, and integration.</p>
<a className="mt-5 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border text-gray-100 bg-gray-900 hover:bg-gray-800 border-gray-800/70" href="#contact">
...
<div className="rounded-2xl border bg-black border-gray-800/70" data-accordion-item="" data-open="true">
...
<div className="px-5 pb-5 text-sm text-gray-300" data-qa="a">
...
<div className="rounded-2xl border bg-black border-gray-800/70" data-accordion-item="">
...
<div className="px-5 pb-5 text-sm hidden text-gray-300" data-qa="a">
...
<div className="relative overflow-hidden rounded-[32px] border shadow-[0_8px_30px_rgba(0,0,0,0.18)] bg-neutral-50 text-black border-black/10">
<div className="absolute inset-0 pointer-events-none">
...
<div className="md:col-span-5">
<div className="h-full rounded-2xl ring-1 p-5 flex flex-col bg-black/5 ring-black/10">
<p className="text-sm text-black/80">Foundational Acquisition Website</p>
<div className="mt-3 flex items-end gap-2">
<div className="text-5xl sm:text-6xl font-semibold tracking-tight tabular-nums" data-amount="">$3,000</div>
<div className="pb-2 text-base text-black/70" data-period="">/project</div>
</div>
<div className="mt-6 text-xs flex items-center justify-between text-black/70">
<span>Timeline</span>
<span>4–6 weeks</span>
</div>
</div>
...
<div className="h-full rounded-2xl ring-1 p-5 bg-black/5 ring-black/10">
<ul className="space-y-3">
<li className="flex items-start gap-2">
<svg className="w-5 h-5 stroke-1.5 text-black/80" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
<span className="text-sm">Complete UI/UX &amp; Strategic Design</span>
</li>
<li className="flex items-start gap-2">
<svg className="w-5 h-5 stroke-1.5 text-black/80" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20" x="2" y="3"></rect><path d="M8 21h8"></path><path d="M12 17v4"></path></svg>
<span className="text-sm">AI-Ready Website Built on Next.js</span>
</li>
<li className="flex items-start gap-2">
<svg className="w-5 h-5 stroke-1.5 text-black/80" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="18" x="3" y="4"></rect><path d="M7 8h10"></path><path d="M7 12h6"></path></svg>
<span className="text-sm">Full CMS for Team Management</span>
</li>
</ul>
<a className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-medium tracking-tight transition-colors border text-gray-100 bg-black hover:bg-black/90 border-black/10" href="#contact">
...
<div className="md:col-span-3">
<div className="h-full rounded-2xl ring-1 p-5 flex flex-col justify-between bg-black/5 ring-black/10">
<div>
<p className="text-sm font-medium tracking-tight">Need ongoing growth?</p>
<p className="mt-1 text-sm text-black/70">Add our monthly Growth Retainer for ongoing SEO, content marketing, and performance analytics.</p>
</div>
<div className="mt-6 flex items-center justify-between">
<div className="text-sm">
<span className="text-black/90">+ $2,500</span>
<span className="text-black/60">/month</span>
</div>
<button aria-checked="false" className="inline-flex h-6 w-11 ring-1 transition-colors duration-200 rounded-full items-center ring-black/10 bg-black/10 bg-white/10" data-upsell-switch="" role="switch" type="button">
<span className="h-4 w-4 rounded-full transition-transform duration-200 translate-x-0 bg-black" data-upsell-knob=""></span>
...
<p className="mt-4 text-[11px] text-center text-black/60">Every engagement is scoped to your goals. No long-term lock-in unless specified.</p>
</div>
</div>
</section>

<section className="max-w-7xl mx-auto mt-12 mb-16 px-4 sm:px-6" id="contact">
<div className="relative overflow-hidden rounded-[32px] border p-6 sm:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.18)] border-black/10 bg-neutral-50 text-black">
<div className="absolute inset-0 pointer-events-none">
...
<p className="mt-2 text-black/80">Let's build something unforgettable—together.</p>
<div className="mt-6 flex flex-wrap items-center gap-3">
<a className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border text-gray-100 bg-black hover:bg-black/90 border-black/10" href="mailto:hello@vipcreative.studio">
...
<a className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border text-black bg-emerald-400 hover:bg-emerald-300 border-emerald-300/20" href="#book">
...
<a className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium tracking-tight border text-black bg-gray-100 hover:bg-gray-200 border-black/10" href="#contact">
...
<div className="mt-8 border-t pt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 border-black/10">
<div>
<p className="text-sm text-black/70">Explore</p>
...
<div>
<p className="text-sm text-black/70">Details</p>
...
<p className="mt-6 text-xs text-black/70">© <span id="year">2025</span> VIP Creative — Finance Growth Studio</p>
</div>
</div>
</section>

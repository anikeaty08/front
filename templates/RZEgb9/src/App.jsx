...
<input className="w-full bg-[#1E1E26] border border-subtle rounded-xl py-3 pl-10 pr-4 text-white placeholder-gray-500 outline-none" placeholder="Search your library" type="text"/>
</div>
</div>
...
<span className="text-sm text-white">All Items</span>
</div>
</div>
<div className="px-1">
...
<div className="relative z-10 mt-6 px-6 pb-24 h-[calc(100%-180px)] overflow-y-auto">

<div className="mb-8">
<div className="flex justify-between items-center mb-4">
<h2 className="text-sm font-medium text-gray-400 uppercase">Recent</h2>
...
<div>
<h3 className="text-sm font-medium text-white">Product Roadmap Discussion</h3>
<p className="text-xs text-gray-400 mt-1">Yesterday at 2:30 PM • Chat</p>
</div>
</div>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<div>
<h3 className="text-sm font-medium text-white">Logo Design Concept</h3>
<p className="text-xs text-gray-400 mt-1">Yesterday at 11:15 AM • Image</p>
</div>
</div>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<div className="mb-8">
<h2 className="text-sm font-medium text-gray-400 uppercase mb-4">Folders</h2>
...
<h3 className="text-sm font-medium text-white">Work Projects</h3>
</div>
...
<h3 className="text-sm font-medium text-white">Personal</h3>
</div>
...
<h3 className="text-sm font-medium text-white">Creative</h3>
</div>
<p className="text-xs text-gray-400">5 items</p>
</div>
<div className="bg-[#1E1E26] border border-subtle rounded-xl p-4 border-dashed flex items-center justify-center">
<svg className="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path d="M12 6v6m0 0v6m0-6h6m-6 0H6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
<span className="text-sm text-gray-400">New Folder</span>
</div>
</div>
</div>
...
<div>
<div className="flex justify-between items-center mb-4">
<h2 className="text-sm font-medium text-gray-400 uppercase">All Files</h2>
<div className="flex items-center">
<button className="text-xs font-medium text-gray-400 mr-4">Sort: Recent</button>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<div>
<h3 className="text-sm font-medium text-white">Marketing Strategy.pdf</h3>
<p className="text-xs text-gray-400 mt-1">3 days ago • 2.4 MB</p>
</div>
</div>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<div>
<h3 className="text-sm font-medium text-white">Customer Feedback Analysis</h3>
<p className="text-xs text-gray-400 mt-1">5 days ago • Chat</p>
</div>
</div>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<div>
<h3 className="text-sm font-medium text-white">Website Mockup</h3>
<p className="text-xs text-gray-400 mt-1">1 week ago • Image</p>
</div>
</div>
<button>
<svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<span className="text-xs font-medium text-accent mt-1">Library</span>
</button>
<button className="p-3 flex flex-col items-center">
<svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewbox="0 0 24 24">

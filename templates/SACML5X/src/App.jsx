      ...
      document.querySelectorAll('.source-chip').forEach(chip => {
        chip.addEventListener('click', () => {
          ...
          if (preview === 'photo' || preview === 'plan') {
            box.innerHTML = `<img src="${img || 'https://images.unsplash.com/photo-1523419409543-a7cf68f1b2ed?q=80&w=1740&auto=format&fit=crop'}" class="w-full h-full object-cover rounded-lg">`;
          } else if (preview === 'geo') {
            box.innerHTML = `

...
export default function App() {
  useEffect(() => {
    ...
    createGlobe(canvas, {
      ...
      baseColor: [0.8,0.7,0.9], markerColor: [0.7,0.3,0.9], glowColor: [0.8,0.6,0.9],
      markers: [
...
<a className="hover:text-purple-600 transition-colors" href="#">Early Access</a>
<a className="hover:text-purple-600 transition-colors" href="#">Pricing</a>
<a className="hover:text-purple-600 transition-colors" href="#">Support &amp; Implementation</a>
...
<a className="hover:text-purple-600 transition-colors" href="#">Blog</a>
</div>

<div className="flex items-center gap-3">
<button className="hidden md:block bg-purple-600 text-white rounded-md px-4 py-2 hover:bg-purple-700 transition-all text-sm">
          Schedule a Demo
        </button>
...
<div className="absolute inset-0 bg-gradient-to-br from-purple-100/50 via-white to-white"></div>
...
<button className="bg-purple-600 text-white rounded-md px-6 py-3 hover:bg-purple-700 transition-all">
              Schedule a Demo
            </button>
...
<svg className="h-6 w-6 text-purple-600" data-lucide="alert-circle"></svg>
<span className="text-gray-700">Too many systems that don’t talk to each other</span>
</li>
<li className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="credit-card"></svg>
<span className="text-gray-700">Paying for tools you don’t understand</span>
</li>
<li className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="shield-off"></svg>
<span className="text-gray-700">Worried about losing control or overspending</span>
</li>
<li className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="slash"></svg>
...
<div className="mx-auto mb-4 h-12 w-12 flex items-center justify-center rounded-full bg-purple-50">
<svg className="h-6 w-6 text-purple-600" data-lucide="phone"></svg>
</div>
...
<div className="text-center">
<div className="mx-auto mb-4 h-12 w-12 flex items-center justify-center rounded-full bg-purple-50">
<svg className="h-6 w-6 text-purple-600" data-lucide="target"></svg>
</div>
...
<div className="text-center">
<div className="mx-auto mb-4 h-12 w-12 flex items-center justify-center rounded-full bg-purple-50">
<svg className="h-6 w-6 text-purple-600" data-lucide="rocket"></svg>
</div>
...
<svg className="h-6 w-6 text-purple-600" data-lucide="link-2"></svg>
<span className="text-gray-700">Finances, sales, inventory all connected</span>
</div>
<div className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="zap"></svg>
<span className="text-gray-700">Fast implementation</span>
</div>
<div className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="badge-dollar-sign"></svg>
<span className="text-gray-700">Transparent pricing</span>
</div>
<div className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="users"></svg>
<span className="text-gray-700">Real support from real people</span>
</div>
<div className="flex items-start gap-4">
<svg className="h-6 w-6 text-purple-600" data-lucide="smile"></svg>
<span className="text-gray-700">Easy to understand</span>
</div>
</div>
<div className="text-center mt-16">
<button className="bg-purple-600 text-white rounded-md px-8 py-3 hover:bg-purple-700 transition-all">
...
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Core modules</li>
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Email support</li>
</ul>
<button className="mt-auto bg-purple-600 text-white rounded-md px-5 py-3 hover:bg-purple-700 transition-all">
          Choose Starter
        </button>
</div>

<div className="border-2 border-purple-600 rounded-lg p-8 flex flex-col transform transition-all duration-200 hover:shadow-xl hover:-translate-y-1 hover:scale-105">
...
<ul className="space-y-3 text-gray-700 mb-8">
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Everything in Starter</li>
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Advanced reporting</li>
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Priority support</li>
</ul>
<button className="mt-auto bg-purple-600 text-white rounded-md px-5 py-3 hover:bg-purple-700 transition-all">
          Choose Growth
        </button>
...
<ul className="space-y-3 text-gray-700 mb-8">
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Dedicated manager</li>
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> 24/7 premium support</li>
<li className="flex items-center gap-2"><svg className="h-5 w-5 text-purple-600" data-lucide="check"></svg> Custom integrations</li>
</ul>
<button className="mt-auto bg-purple-600 text-white rounded-md px-5 py-3 hover:bg-purple-700 transition-all">
          Talk to Sales
        </button>
...
<input className="flex-1 border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Full name" required="" type="text"/>
<input className="flex-1 border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Email address" required="" type="email"/>
</div>
<input className="w-full border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Company" type="text"/>
<textarea className="w-full border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="How can we help?" rows="5"></textarea>
<button className="bg-purple-600 text-white rounded-md px-8 py-3 hover:bg-purple-700 transition-all" type="submit">
        Submit
      </button>
</form>
</section>
...
<li><a className="hover:text-purple-600" href="#">Solutions</a></li>
<li><a className="hover:text-purple-600" href="#">Pricing</a></li>
<li><a className="hover:text-purple-600" href="#">Blog</a></li>
<li><a className="hover:text-purple-600" href="#">Support</a></li>
...
<li><a className="hover:text-purple-600" href="#">Terms of Use</a></li>
</ul>
</div>
<div>
...
<a aria-label="Twitter" href="#"><svg className="h-5 w-5 text-gray-500 hover:text-purple-600" data-lucide="twitter"></svg></a>
<a aria-label="LinkedIn" href="#"><svg className="h-5 w-5 text-gray-500 hover:text-purple-600" data-lucide="linkedin"></svg></a>
<a aria-label="GitHub" href="#"><svg className="h-5 w-5 text-gray-500 hover:text-purple-600" data-lucide="github"></svg></a>
</div>
</div>
</div>

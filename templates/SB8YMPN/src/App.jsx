...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/26ab393e-b31b-4b0c-b898-a9f433e30e2a_3840w.jpg")'}}></div>
...
<img alt="Mountain landscape" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a0c744d5-9d12-42c9-a431-77b086938f4b_1600w.jpg" style={{}}/>
...
<img alt="" className="w-6 h-6 rounded-full border-2 border-white/20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1ddf69f0-d3d2-4775-bbe6-cfea18262abb_320w.jpg" style={{}}/>
<img alt="" className="w-6 h-6 rounded-full border-2 border-white/20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/36e9fafd-c1ed-46b5-a6e7-b976cfd26e1c_320w.jpg"/>
</div>
...
<div className="relative z-10 flex flex-col h-full min-h-[400px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4c9721c5-7db7-4e0b-8736-965c721a2e6a_1600w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6">
...
<img alt="Urban landscape" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8669d7ab-d501-42b5-81b1-7e30d202e9d6_1600w.jpg"/>

...
<h1 className="md:text-6xl text-4xl font-semibold text-white tracking-tight font-space-grotesk" style={{}}>
...
<canvas className="" height="188" id="tpsChart" style={{display: 'block', boxSizing: 'border-box', height: '140px', width: '664px'}} width="896"></canvas>
</div>
</div>
</div>
...
<div className="mt-2">
<div className="relative">
<canvas className="" height="366" id="allocChart" style={{display: 'block', boxSizing: 'border-box', height: '305px', width: '305px'}} width="366"></canvas>
</div>
</div>
</div>
</div>
...
<div className="relative">
<canvas className="" height="121" id="miniChart" style={{display: 'block', boxSizing: 'border-box', height: '90px', width: '460px'}} width="620"></canvas>
</div>
</div>
</div>
</div>
...
<div className="max-w-6xl grid lg:grid-cols-2 gap-10 mr-auto ml-auto pr-6 pl-6 items-center">
<div className="relative">

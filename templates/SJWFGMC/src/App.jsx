...
<input autocomplete="email" className="w-full py-3 pl-12 pr-4 rounded-xl text-sm text-white bg-gray-800/60 border border-gray-700/60 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none placeholder-gray-500 transition-all duration-300" placeholder="you@company.com" required="" type="email"/>
</div>
<button className="flex gap-2 hover:from-indigo-600 hover:to-purple-700 transition hover:scale-105 hover:-translate-y-1 hover:shadow-indigo-700/20 font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl pt-3 pr-6 pb-3 pl-6 shadow items-center justify-center bubble mt-0 sm:mt-0" type="submit">
...
<li className="flex gap-2 items-start">
<span className="mt-1"><svg className="lucide lucide-check-circle w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11 3 3L22 4"></path></svg></span>
<span className=""><span className="font-medium text-white">Qualify Leads Early</span> Use proven frameworks.</span>
</li>
<li className="flex gap-2 items-start">
<span className="mt-1"><svg className="lucide lucide-check-circle w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11 3 3L22 4"></path></svg></span>
<span className=""><span className="font-medium text-white">Nurture with Value</span> Deliver targeted content.</span>
</li>
<li className="flex gap-2 items-start">
<span className="mt-1"><svg className="lucide lucide-check-circle w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11 3 3L22 4"></path></svg></span>
</li>
...
<div className="px-3 sm:px-5 py-2 bg-gray-900/70 border-t border-gray-800/60 flex items-center text-xs text-gray-400 font-mono">
<svg className="lucide lucide-align-left w-4 h-4 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15 12H3"></path><path d="M17 18H3"></path><path d="M21 6H3"></path></svg>
                12-point actionable checklist
              </div>
</div>
</div>
</div>
...
<svg className="lucide lucide-building w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24"><rect height="14" rx="2" width="18" x="3" y="7"></rect><path d="M17 21V13M7 21V13M3 10h18"></path></svg>
              GrowthPilot
            </span>
</div>
</div>
...
<p className="text-base sm:text-lg text-gray-100 leading-snug font-normal mb-2 sm:mb-4"><svg className="lucide lucide-quote w-6 h-6 text-indigo-400 inline mr-2 -mt-2" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24"><path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path></svg>
              The guide is clear, actionable, and immediately improved our lead quality. Can’t recommend enough.
            </p>
<span className="inline-flex items-center gap-2 text-xs text-gray-500 justify-center sm:justify-start">
<svg className="lucide lucide-building w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24"><rect height="14" rx="2" width="18" x="3" y="7"></rect><path d="M17 21V13M7 21V13M3 10h18"></path></svg>
              Finlytics
...
<div className="flex flex-col sm:flex-row gap-4 sm:gap-6 bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 rounded-2xl shadow-lg border border-gray-800/60 px-4 sm:px-6 py-6 sm:py-8 items-center">
<img alt="Tina Rowe" className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover shadow-lg border-2 border-indigo-500/40 mb-4 sm:mb-0" src="https://images.unsplash.com/photo-1724525647065-f948fc102e68?w=2160&amp;q=80"/>
<div className="flex-1 flex flex-col justify-center text-center sm:text-left">
<div className="flex flex-col sm:flex-row items-center sm:gap-2 mb-2">
<span className="text-indigo-400 font-semibold text-base">Tina Rowe</span>
<span className="text-gray-400 text-sm">Founder, SaaSly</span>
</div>
<p className="text-base sm:text-lg text-gray-100 leading-snug font-normal mb-2 sm:mb-4"><svg className="lucide lucide-quote w-6 h-6 text-indigo-400 inline mr-2 -mt-2" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24"><path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path></svg>
              It’s the only checklist you’ll ever need for B2B lead gen. The results speak for themselves.
            </p>
<span className="inline-flex items-center gap-2 text-xs text-gray-500 justify-center sm:justify-start">
<svg className="lucide lucide-building w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24"><rect height="14" rx="2" width="18" x="3" y="7"></rect><path d="M17 21V13M7 21V13M3 10h18"></path></svg>
              SaaSly
...
<div className="flex flex-col sm:flex-row gap-4 sm:gap-6 bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 rounded-2xl shadow-lg border border-gray-800/60 px-4 sm:px-6 py-6 sm:py-8 items-center">
<img alt="David Chen" className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover shadow-lg border-2 border-indigo-500/40 mb-4 sm:mb-0" src="https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=2160&amp;q=80"/>
<div className="flex-1 flex flex-col justify-center text-center sm:text-left">
<div className="flex flex-col sm:flex-row items-center sm:gap-2 mb-2">
<span className="text-indigo-400 font-semibold text-base">David Chen</span>
<span className="text-gray-400 text-sm">VP Sales, TechNest</span>
</div>

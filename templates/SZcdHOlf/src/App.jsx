...
<div @click="sidebarOpen = false" className="fixed inset-0 bg-black/50" x-show="sidebarOpen" x-transition:enter="transition-opacity ease-linear duration-300" x-transition:enter-end="opacity-100" x-transition:enter-start="opacity-0" x-transition:leave="transition-opacity ease-linear duration-300" x-transition:leave-end="opacity-0" x-transition:leave-start="opacity-100"></div>
...
<button @click="sidebarOpen = false" className="text-dark-subdued">
...
<h2 className="font-barlow text-xl font-semibold tracking-tight">Documentation</h2>
<button @click="sidebarOpen = true" className="text-dark-subdued">
<svg className="h-6 w-6" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

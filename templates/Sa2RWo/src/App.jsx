    ...
    function home() {
      return `
        <section class="flex-1 flex flex-col items-center justify-center px-4 py-20">
          <div class="bg-white/80 rounded-2xl shadow-lg p-12 max-w-xl w-full border border-indigo-100">
            <h2 class="text-3xl font-bold mb-5 text-green-700 flex items-center gap-3">
              <svg class="w-9 h-9 inline text-green-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg>
              Authenticated
            </h2>
            <p class="text-lg mb-8 text-gray-800">You’re logged in with secure multi-question verification.</p>

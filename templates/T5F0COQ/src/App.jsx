...
<h1 className="headline mb-4 text-white font-normal">
        ...
        <span className="bg-gradient-to-r from-purple-400 via-pink-300 to-orange-300 bg-clip-text text-transparent font-normal">Days</span>,<br className="hidden sm:inline"/>

...
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c1-personne-physique" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c1-auteur-projet" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 hover:bg-amber-100 transition" data-menu-htmlFor="c2-description" title="Statut: À vérifier — nécessite une attention">
<i className="w-3.5 h-3.5" data-lucide="alert-triangle"></i> À vérifier
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c2-phasage" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c5-codt" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-red-200 bg-red-50 px-2.5 py-1 text-xs font-medium text-700 hover:bg-red-100 transition" data-menu-htmlFor="c6-derogation" title="Statut: Bloquant — à compléter avant envoi">
<i className="w-3.5 h-3.5" data-lucide="octagon-x"></i> Bloquant
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 hover:bg-amber-100 transition" data-menu-htmlFor="c6-ecarts" title="Statut: À vérifier — nécessite une attention">
<i className="w-3.5 h-3.5" data-lucide="alert-triangle"></i> À vérifier
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c7-eaux" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c7-paysage" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 hover:bg-amber-100 transition" data-menu-htmlFor="c8-radon" title="Statut: À vérifier — nécessite une attention">
<i className="w-3.5 h-3.5" data-lucide="alert-triangle"></i> À vérifier
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c8-pollution" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c8b-patrimoine" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c9-acces" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c9-reseau" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c10-peb" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c11-surfaces" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>
...
<div className="relative">
<button className="field-status-trigger inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition" data-menu-htmlFor="c12-reunion" title="Statut: Validé — champ complet">
<i className="w-3.5 h-3.5" data-lucide="check-circle"></i> Validé
                        </button>

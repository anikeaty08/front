...
<div className="pointer-events-none absolute inset-0 -z-10 bg-black/90 bg-fixed" style="background-image:
        radial-gradient(600px 600px at 80% 20%, rgba(255,211,51,0.06), transparent 60%),

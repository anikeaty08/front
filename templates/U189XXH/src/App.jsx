...
!function(){if(!window.UnicornStudio){window.UnicornStudio={isInitialized:!1};var i=document.createElement("script");i.src="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.29/dist/unicornStudio.umd.js",i.onload=function(){window.UnicornStudio.isInitialized||(UnicornStudio.init(),window.UnicornStudio.isInitialized=!0)},(document.head || document.body).appendChild(i)}}();
      ...
      function smoothScrollTo(targetId) {
        ...
        const top =
          el.getBoundingClientRect().top + window.pageYOffset - headerH + 6;
        window.scrollTo({ top, behavior: 'smooth' });
      }
      document
        .querySelectorAll('a[href^="#"]:not([data-mobile-link])')
        .forEach((a) => {
      ...
      document
        ...
        ?.addEventListener('click', () => {
          tasksRoot
            ?.querySelectorAll('[data-checkbox][aria-checked="true"]')
            .forEach((btn) => {
              const row = btn.closest('[data-task]');
      ...
      document.getElementById('add-quick')?.addEventListener('click', () => {
        ...
        node.innerHTML = `
          <button type="button"
            class="relative mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-md bg-black/40 border border-white/15 hover:border-white/25 transition"
            data-checkbox aria-checked="false" aria-label="Toggle task">
            <svg data-lucide="check" width="16" height="16" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
              class="w-3.5 h-3.5 opacity-0 transition"><path d="M20 6 9 17l-5-5"></path></svg>
          </button>
          <div class="min-w-0">
...
<svg className="lucide lucide-check-circle2 w-3.5 h-3.5" data-lucide="check-circle2" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    On‑track
                  </span>
</div>
</div>
...
<div className="">
<p className="text-sm uppercase tracking-wider text-blue-300/90">
              Features
            </p>
...
<div className="mt-2 h-16 w-full">
<div className="w-full h-full">
<canvas height="128" id="spark" style={{display: 'block', boxSizing: 'border-box', height: '64px', width: '208px'}} width="416"></canvas>
</div>
</div>
</div>
</div>
...
<p className="mt-3 text-gray-300">
              Real‑time insight into throughput, cycle time, and forecast—no
...
<div className="w-full h-full">
<canvas height="512" id="mainChart" style={{display: 'block', boxSizing: 'border-box', height: '256px', width: '631px'}} width="1262"></canvas>
</div>
</div>
</div>
</div>
...
<li>
<a className="hover:text-gray-200" href="#overview">Status</a>
</li>
</ul>
</div>
</div>

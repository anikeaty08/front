...
<div>
<p className="text-xs text-pink-500 font-medium">Lesson</p>
<h2 className="font-bold text-xl text-indigo-900">Color Theory Basics</h2>
</div>
</div>

<div className="relative mb-8">
<div className="h-36 w-full rounded-2xl bg-gradient-to-br from-pink-400 via-yellow-200 to-yellow-300 shadow-lg flex items-end overflow-hidden relative">
<svg className="absolute right-0 bottom-0 w-32 h-32 opacity-50" fill="none" viewbox="0 0 120 120">
<circle cx="60" cy="60" fill="#fff" fillOpacity="0.13" r="48"></circle>
<circle cx="60" cy="60" fill="#fff" fillOpacity="0.09" r="27"></circle>
</svg>
...
<circle cx="12" cy="12" fill="#FDE68A" r="10" stroke="#F87171" strokeWidth="2"></circle>
<circle cx="12" cy="12" fill="#F472B6" r="4"></circle>
</svg>
</div>
<div>
<h3 className="text-white text-lg font-bold">Color Theory Basics</h3>
<p className="text-white/80 text-xs">Lesson 2</p>
</div>
</div>
</div>
...
<span className="text-sm text-indigo-700 font-semibold">4.9</span>
</div>
...
<div className="flex items-center gap-1 text-xs text-indigo-500">
<svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 8h2v-2H7v2zm0-4h2v-2H7v2zm0-4h2V7H7v2zm4 8h2v-2h-2v2zm0-4h2v-2h-2v2zm0-4h2V7h-2v2zm4 8h2v-2h-2v2zm0-4h2v-2h-2v2zm0-4h2V7h-2v2z"></path>
</svg>
              Resources
            </div>
</div>
...
<span className="text-sm text-indigo-900 font-semibold">Lesson Progress</span>
<span className="text-xs text-indigo-500 font-medium">80%</span>
</div>
<div className="w-full h-3 bg-pink-100 rounded-full relative overflow-hidden">
<div className="h-full bg-gradient-to-r from-pink-400 via-yellow-200 to-yellow-300 rounded-full" style={{width: '80%'}}></div>
</div>
</div>

<div className="mb-7">
<h4 className="font-bold text-indigo-900 text-base mb-2">What you'll learn</h4>
<ul className="list-disc ml-5 text-pink-500 text-sm mb-4 space-y-1">
<li>The fundamentals of color theory and the color wheel</li>
<li>How to create harmonious color palettes</li>
<li>The psychological impact of color choices</li>
<li>Practical techniques for using color in UI design</li>
</ul>
<h4 className="font-bold text-indigo-900 text-base mb-2">Lesson Content</h4>
<p className="text-indigo-500 text-sm leading-relaxed mb-2">
            Understanding color theory is essential for crafting engaging and accessible interfaces. This lesson covers primary, secondary, and tertiary colors, color harmony, contrast, and accessibility tips. You’ll see real-world UI examples and learn how to choose palettes that enhance usability and brand identity.
          </p>
<div className="flex gap-3 mt-5">
<a className="flex-1 flex flex-col items-center justify-center bg-white/70 border border-white/40 rounded-lg p-3 shadow hover:bg-white/90 transition" href="#">
<svg className="w-6 h-6 text-pink-400 mb-1" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<polygon points="5 3 19 12 5 21 5 3"></polygon>
</svg>
<span className="text-xs text-indigo-500">Watch Video</span>
</a>
<a className="flex-1 flex flex-col items-center justify-center bg-white/70 border border-white/40 rounded-lg p-3 shadow hover:bg-white/90 transition" href="#">
<svg className="w-6 h-6 text-yellow-400 mb-1" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M4 19h16M4 15h16M7 11l5-5 5 5"></path>
</svg>
<span className="text-xs text-indigo-500">Download PDF</span>
</a>
<a className="flex-1 flex flex-col items-center justify-center bg-white/70 border border-white/40 rounded-lg p-3 shadow hover:bg-white/90 transition" href="#">
<svg className="w-6 h-6 text-indigo-400 mb-1" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="M19 21H5a2 2 0 01-2-2V7a2 2 0 012-2h4l2-2 2 2h4a2 2 0 012 2v12a2 2 0 01-2 2z"></path>
</svg>
<span className="text-xs text-indigo-500">Take Notes</span>
</a>
</div>
</div>

...
<p className="text-white/90 font-medium text-sm">Tuesday, April 1</p>
</div>

<div className="absolute top-[95px] w-full flex justify-center z-30">
<div className="relative">
<span className="font-thin text-[112px] leading-none text-white/95 tracking-tight">9:41</span>
</div>
</div>

<div className="absolute inset-x-3 bottom-[165px] z-30">
...
<div>
<p className="text-white/70 text-sm font-medium">San Francisco</p>
<div className="flex items-center gap-2">
<span className="text-white text-4xl font-light">72°</span>
...
<p className="text-white/80 text-sm">Mostly Sunny</p>
</div>
<div className="text-right">
<p className="text-white/70 text-xs">H:75° L:62°</p>
</div>
</div>

<div className="flex justify-between items-center space-x-4">
<div className="text-center flex-1">
<p className="text-white/60 text-xs mb-1">Now</p>
<svg className="h-5 w-5 text-yellow-400 mx-auto mb-1" fill="currentColor" viewbox="0 0 20 20">
<path clip-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd"></path>
</svg>
<p className="text-white text-sm font-medium">72°</p>
</div>
<div className="text-center flex-1">
<p className="text-white/60 text-xs mb-1">11AM</p>
<svg className="h-5 w-5 text-yellow-400 mx-auto mb-1" fill="currentColor" viewbox="0 0 20 20">
<path clip-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd"></path>
</svg>
...
<div className="text-center flex-1">
<p className="text-white/60 text-xs mb-1">12PM</p>
<svg className="h-5 w-5 text-gray-400 mx-auto mb-1" fill="currentColor" viewbox="0 0 20 20">
<path d="M5.5 16a3.5 3.5 0 01-.369-6.98 4 4 0 117.753-1.977A4.5 4.5 0 1113.5 16h-8z"></path>
</svg>
<p className="text-white text-sm font-medium">75°</p>
</div>
<div className="text-center flex-1">
<p className="text-white/60 text-xs mb-1">1PM</p>
<svg className="h-5 w-5 text-gray-400 mx-auto mb-1" fill="currentColor" viewbox="0 0 20 20">
<path d="M5.5 16a3.5 3.5 0 01-.369-6.98 4 4 0 117.753-1.977A4.5 4.5 0 1113.5 16h-8z"></path>
</svg>
<p className="text-white text-sm font-medium">73°</p>
</div>
<div className="text-center flex-1">
<p className="text-white/60 text-xs mb-1">2PM</p>
<svg className="h-5 w-5 text-blue-400 mx-auto mb-1" fill="currentColor" viewbox="0 0 20 20">
<path clip-rule="evenodd" d="M5.5 17a4.5 4.5 0 01-1.44-8.765 4.5 4.5 0 018.302-3.046 3.5 3.5 0 014.504 4.272A4 4 0 0115 17H5.5zm3.75-2a.75.75 0 001.5 0v-1a.75.75 0 00-1.5 0v1zm-1.5-1.5a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5z" fill-rule="evenodd"></path>
</svg>
<p className="text-white text-sm font-medium">70°</p>
</div>
</div>
</div>
</div>

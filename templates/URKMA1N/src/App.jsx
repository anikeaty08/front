...
<button className="inline-flex gap-2 hover:text-[#0A6EE7] hover:-translate-x-0.5 transition-all text-sm text-gray-600 items-center" id="backBtn">
...
<span className="mx-2 h-4 w-px bg-gray-200"></span>
<div className="inline-flex items-center gap-2">
<div className="">
<div className="text-[13px] text-gray-500">Issuer</div>
<div className="text-sm font-medium tracking-tight">Apple Inc.</div>
</div>
</div>
</div>
...
<svg className="lucide lucide-rotate-ccw w-3.5 h-3.5" data-lucide="rotate-ccw" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> รีเซ็ต
                </button>
</div>
</div>
</div>
...
<svg className="lucide lucide-badge-dollar-sign w-3.5 h-3.5" data-lucide="badge-dollar-sign" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"></path><path d="M12 18V6"></path></svg> USD
                  </span>
<span className="inline-flex items-center gap-1 ring-1 ring-gray-200 bg-gray-100 rounded-lg pt-1 pr-2 pb-1 pl-2">
<svg className="lucide lucide-line-chart w-3.5 h-3.5" data-lucide="line-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg> YTM ~ 3.20%
                  </span>
<span className="inline-flex items-center gap-1 rounded-lg bg-gray-100 px-2 py-1 ring-1 ring-gray-200">
<svg className="lucide lucide-calendar w-3.5 h-3.5" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg> 2029–2032
                  </span>
</div>
...
<span className="inline-flex items-center gap-1 rounded-lg bg-gray-100 px-2 py-1 ring-1 ring-gray-200">
<svg className="lucide lucide-calendar w-3.5 h-3.5" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg> 2028–2031
                  </span>
</div>
<div className="flex mt-3 items-center justify-center">
...
<span className="inline-flex items-center gap-1 rounded-lg bg-gray-100 px-2 py-1 ring-1 ring-gray-200">
<svg className="lucide lucide-calendar w-3.5 h-3.5" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg> 2029–2034
                  </span>
</div>
<div className="flex mt-3 items-center justify-center">
<button className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium text-gray-700 hover:text-[#0A6EE7] hover:bg-gray-100 ring-1 ring-gray-200 transition">

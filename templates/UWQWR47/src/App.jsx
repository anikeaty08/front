...
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onclick="nextScreen()">Comenzar</button>
</section>
...
<input className="w-full h-12 border rounded-lg px-4 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="amountInput" min="100" oninput="updateSimulation()" step="100" type="number" value="1000"/>
</label>

<label className="flex flex-col gap-2">
<span className="text-[14px]">Plazo (días)</span>
<select className="w-full h-12 border rounded-lg px-4 text-[15px] focus:outline-none focus:ring-2 focus:ring-[#00D180]" id="termSelect" onchange="updateSimulation()">
...
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onclick="goToConfirm()">Continuar</button>
</section>
...
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold opacity-50" disabled="" id="confirmBtn" onclick="createInvestment()">Confirmar inversión</button>
</section>
...
<button className="w-full bg-[#00D180] text-[#161616] h-14 rounded-[12px] font-semibold" onclick="nextScreen()">Continuar</button>
</section>
...
<div className="flex flex-col gap-4">
<button className="post-option w-full border rounded-lg h-14 flex items-center justify-between px-4 text-[14px] transition hover:border-[#00D180]/60" onclick="selectPostAction(0)">Reinvertir monto + ganancias</button>
<button className="post-option w-full border rounded-lg h-14 flex items-center justify-between px-4 text-[14px] transition hover:border-[#00D180]/60" onclick="selectPostAction(1)">Reinvertir solo el monto</button>
<button className="post-option w-full border rounded-lg h-14 flex items-center justify-between px-4 text-[14px] transition hover:border-[#00D180]/60" onclick="selectPostAction(2)">Mover todo a Stori Cuenta+</button>
</div>
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold opacity-50" disabled="" id="postContinue" onclick="nextScreen()">Guardar Preferencia</button>
</section>
...
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onclick="resetToSim()">Crear nueva inversión</button>
</section>
...
<button className="mt-auto mb-4 bg-[#00D180] text-[#161616] h-14 w-full rounded-[12px] font-semibold" onclick="backToList()">Volver</button>
</section>
</main>
</div>

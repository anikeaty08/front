...
<circle cx="140" cy="140" fill="none" id="progressCircle" r="110" stroke="url(#progressGrad)" stroke-dasharray="691" stroke-dashoffset="345" strokeLinecap="round" strokeWidth="8" style={{filter: 'drop-shadow(rgba(59, 130, 246, 0.5) 0px 0px 10px)', strokeDasharray: '691.150384', strokeDashoffset: '468.994903'}}></circle>
</svg>

...
<button className="fixed top-6 right-6 bg-white hover:bg-gray-50 text-gray-800 rounded-full p-2.5 shadow-lg z-50 transition-all duration-200" onclick="toggleNotifications()">
...
<button className="text-gray-400 hover:text-gray-600" onclick="toggleNotifications()">
<svg className="h-5 w-5" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">

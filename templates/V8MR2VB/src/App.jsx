...
export default function App() {
  ...
  return (
    <>
      <div className="spline-container fixed top-0 w-full h-screen -z-10 blur-sm"><iframe frameborder="0" height="100%" src="https://my.spline.design/worldplanet-inmHh7fVCul1jUFrNRYlotVU" width="100%"></iframe></div>

<header className="sticky top-0 z-50 backdrop-blur bg-[#0f1117]/80 border-b border-white/10">
<div className="mx-auto max-w-7xl px-6 flex items-center justify-between h-16">
<a className="text-lg font-semibold tracking-tight font-geist" href="#" style={{}}>BizalmiKör</a>
...
<button className="px-4 py-2 rounded-md transition text-sm font-medium hover:bg-blue-500 bg-blue-600 font-geist" style={{}}>Regisztráció</button>
...
<h1 className="md:text-6xl text-4xl font-semibold tracking-tight font-geist" style={{}}>A leggyorsabb út<br className="hidden md:block"/> <span className="text-blue-500 font-geist font-semibold" style={{}}>vállalkozásod következő szintjére</span></h1>
...
<button className="px-6 py-3 rounded-md font-medium transition hover:bg-blue-500 bg-blue-600 font-geist" style={{}}>Csatlakozz most</button>
...
<p className="leading-7 text-white/70 mt-6 font-geist" style={{}}>Egy olyan közösséget építünk, ahol a tudásmegosztás, a hálózatépítés és az inspiráció találkozik, hogy tagjaink akár 10× gyorsabban érjék el üzleti céljaikat.</p>
<ul className="mt-8 space-y-4">
<li className="flex items-start space-x-3">
<svg className="lucide lucide-users w-6 h-6 stroke-[1.5] text-green-400" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>
<span className="font-geist" style={{}}>Bővülő, több mint <strong className="font-medium font-geist" style={{}}>800</strong> fős tagság.</span>
</li>
<li className="flex items-start space-x-3">
<svg className="lucide lucide-rocket w-6 h-6 stroke-[1.5] text-green-400" data-lucide="rocket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"></path><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"></path><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path></svg>
<span className="font-geist" style={{}}>Havi <strong className="font-medium font-geist" style={{}}>5+</strong> élő esemény és workshop.</span>
</li>
<li className="flex items-start space-x-3">
<svg className="lucide lucide-library w-6 h-6 stroke-[1.5] text-green-400" data-lucide="library" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 6 4 14"></path><path d="M12 6v14"></path><path d="M8 8v12"></path><path d="M4 4v16"></path></svg>
<span className="font-geist" style={{}}>Folyamatosan bővülő tudásbázis.</span>
</li>
</ul>
</div>
<div className="relative">
<img alt="team" className="w-full h-80 lg:h-96 object-cover rounded-xl shadow-lg" src="https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?auto=format&amp;fit=crop&amp;w=800&amp;q=80"/>
</div>
</div>
</section>
...
<p className="mt-4 max-w-2xl mx-auto text-center text-white/70 font-geist" style={{}}>Átlátható, rugalmas csomagok különböző vállalati méretre szabva.</p>
<div className="mt-16 grid gap-10 md:grid-cols-2">

<div className="border rounded-2xl p-8 transition border-white/10 bg-white/5 hover:bg-white/10">
<h3 className="text-xl font-semibold tracking-tight flex items-center font-geist" style={{}}><svg className="lucide lucide-briefcase w-6 h-6 mr-2 stroke-[1.5] text-green-400" data-lucide="briefcase" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path><rect height="14" rx="2" width="20" x="2" y="6"></rect></svg> Kisvállalati csomag</h3>
<p className="mt-4 text-sm text-white/70 font-geist" style={{}}>Azonnal bevethető eszközök és közösségi támogatás havi áron.</p>
<ul className="mt-6 space-y-3 text-sm">
<li className="flex items-start font-geist" style={{}}><svg className="lucide lucide-check w-4 h-4 mr-2 stroke-[1.5] text-green-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Heti online mastermind</li>
...
<span className="ml-2 text-white/70 font-geist" style={{}}>Ft / hó</span>
</div>
<button className="mt-8 w-full py-3 rounded-md transition font-medium hover:bg-blue-500 bg-blue-600 font-geist" style={{}}>Előfizetek</button>
</div>

<div className="border rounded-2xl p-8 ring-1 ring-inset relative border-blue-500/60 ring-blue-500/20 bg-blue-600/10" style={{}}>
<span className="absolute -top-4 right-4 px-3 py-1 rounded-full text-xs font-medium bg-blue-500 font-geist" style={{}}>Legnépszerűbb</span>
<h3 className="text-xl font-semibold tracking-tight flex items-center font-geist" style={{}}><svg className="lucide lucide-building-2 w-6 h-6 mr-2 stroke-[1.5] text-green-400" data-lucide="building-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path><path d="M10 6h4"></path><path d="M10 10h4"></path><path d="M10 14h4"></path><path d="M10 18h4"></path></svg>Nagyvállalati VIP</h3>
<p className="mt-4 text-sm text-white/70 font-geist" style={{}}>Premier hozzáférés eseményekhez, dedikált tanácsadó, exkluzív tartalmak.</p>
<ul className="mt-6 space-y-3 text-sm">
<li className="flex items-start font-geist" style={{}}><svg className="lucide lucide-check w-4 h-4 mr-2 stroke-[1.5] text-green-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Dedikált account manager</li>
...
<li className="flex items-start font-geist" style={{}}><svg className="lucide lucide-check w-4 h-4 mr-2 stroke-[1.5] text-green-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>Priorizált esemény-belépő</li>
</ul>
<div className="mt-8 flex items-baseline">
<span className="text-3xl tracking-tight font-geist font-semibold" style={{}}>Kérj ajánlatot</span>
</div>
<button className="mt-8 w-full py-3 rounded-md transition font-medium hover:bg-blue-500 bg-blue-600 font-geist" style={{}}>Kapcsolatfelvétel</button>
</div>
</div>
</section>
...
<h2 className="text-2xl tracking-tight flex items-center font-geist font-semibold" style={{}}><svg className="lucide lucide-bar-chart-3 w-6 h-6 mr-2 stroke-[1.5] text-green-400" data-lucide="bar-chart-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg> Tagság növekedése</h2>
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Hogyan bővült közösségünk az elmúlt 6 hónapban.</p>
<div className="mt-6">
<div className="">
<canvas className="" height="364" id="memberChart" style={{display: 'block', boxSizing: 'border-box', height: '364px', width: '910px'}} width="910"></canvas>
</div>
</div>
</div>
</section>
...
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Tanuld meg, hogyan tudod az automatizációt beépíteni a mindennapi marketingbe.</p>
...
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Gyakorlati tapasztalatok 0-ról 10k-ig.</p>
<button className="mt-4 inline-flex items-center text-sm hover:underline text-blue-400 font-geist" style={{}}>Regisztrálok</button>
</div>
</article>
...
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Új toborzási stratégiák és employer branding.</p>
<button className="mt-4 inline-flex items-center text-sm hover:underline text-blue-400 font-geist" style={{}}>Regisztrálok</button>
</div>
</article>
</div>
...
<p className="mt-4 max-w-2xl mx-auto text-center text-white/70 font-geist" style={{}}>Ingyenes tudásanyagok, esettanulmányok.</p>
...
<h3 className="mt-2 text-lg font-semibold tracking-tight transition group-hover:text-blue-400 font-geist" style={{}}>Hogyan növelte meg a BrightTech 300-al a leadjeit?</h3>
<p className="mt-2 text-sm line-clamp-3 text-white/70 font-geist" style={{}}>Naprakész tartalommarketing-stratégia és automatizált funnel…</p>
</div>
</a>
</article>
...
<h3 className="mt-2 text-lg font-semibold tracking-tight transition group-hover:text-blue-400 font-geist" style={{}}>A Z-generációs vezető, aki megreformálta a logisztikát</h3>
<p className="mt-2 text-sm line-clamp-3 text-white/70 font-geist" style={{}}>Megkérdeztük Gábort, hogyan építette fel…</p>
</div>
</a>
</article>
...
<h3 className="mt-2 text-lg font-semibold tracking-tight transition group-hover:text-blue-400 font-geist" style={{}}>5 perc alatt AI-alapú forecast</h3>
<p className="mt-2 text-sm line-clamp-3 text-white/70 font-geist" style={{}}>Bemutatjuk a legújabb no-code eszközt…</p>
</div>
</a>
</article>
</div>
...
<p className="mt-4 max-w-2xl mx-auto text-center text-white/70 font-geist" style={{}}>Tagjaink mondták</p>
<div className="mt-16 grid gap-10 md:grid-cols-2">

<blockquote className="border-l-4 pl-6 border-blue-500" style={{}}>
...
<span className="block text-xs text-white/60 font-geist" style={{}}>CEO, GreenLab</span>
</div>
</footer>
</blockquote>
...
<span className="block text-xs text-white/60 font-geist" style={{}}>CTO, BigData Co.</span>
</div>
</footer>
</blockquote>
</div>
...
<p className="mt-4 text-white/70 font-geist" style={{}}>Töltsd ki az alábbi űrlapot, és 24 órán belül visszajelzünk.</p>
<form className="mt-8 space-y-6">
<div>
<label className="block text-sm font-medium mb-1 font-geist" style={{}}>Név</label>
...
<div>
<label className="block text-sm font-medium mb-1 font-geist" style={{}}>Email</label>
...
<div>
<label className="block text-sm font-medium mb-1 font-geist" style={{}}>Üzenet</label>
...
<button className="w-full py-3 rounded-md transition font-medium hover:bg-blue-500 bg-blue-600 font-geist" style={{}} type="submit">Elküldöm</button>
</form>
</div>
...
<summary className="cursor-pointer font-medium text-sm font-geist" style={{}}>Milyen hosszú a tagsági időszak?</summary>
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Havi előfizetésről van szó, bármikor lemondható.</p>
</details>
<details className="border rounded-md p-4 bg-white/5 border-white/10">
<summary className="cursor-pointer font-medium text-sm font-geist" style={{}}>Hogyan érhetem el az exkluzív tartalmakat?</summary>
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>Belépés után a profilodban automatikusan megjelenik a Tudásbázis menüpont.</p>
</details>
<details className="border rounded-md p-4 bg-white/5 border-white/10">
<summary className="cursor-pointer font-medium text-sm font-geist" style={{}}>Cégenként vagy személyenként kell fizetni?</summary>
<p className="mt-2 text-sm text-white/70 font-geist" style={{}}>A tagság cégenként értendő, egy előfizetéssel több munkatárs is csatlakozhat.</p>
</details>
</div>
</div>
</div>
...
<span className="text-sm text-white/60 font-geist" style={{}}>© 2024 Vállalkozói Klub. Minden jog fenntartva.</span>

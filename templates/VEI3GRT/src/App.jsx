...
<button className="text-left bg-gray-900 rounded-2xl shadow border border-gray-800 px-4 py-3 transition hover:ring-2 hover:ring-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 w-full relative group" onclick="openModal(0)">
...
<button className="text-left bg-gray-900 rounded-2xl shadow border border-gray-800 px-4 py-3 transition hover:ring-2 hover:ring-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 w-full relative group" onclick="openModal(1)">
<span className="absolute inset-0"></span>
<div className="flex items-center gap-3">
...
<button className="absolute top-3 right-3 text-gray-400 hover:text-gray-200 rounded-full p-1" onclick="closeModal()">

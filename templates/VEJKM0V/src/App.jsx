...
<h1 className="text-2xl font-bold mb-8 text-gray-900">Weekly Course Calendar</h1>
...
<span className="w-28 text-gray-500 text-sm">9:00 - 10:30 am</span>
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">10:00 - 11:30 am</span>
...
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">3:00 - 4:00 pm</span>
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">2:00 - 3:30 pm</span>
...
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">5:00 - 6:00 pm</span>
<div className="ml-4 flex-1 bg-pink-100 border-l-4 border-pink-500 rounded px-4 py-2">
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">9:30 - 11:00 am</span>
<div className="ml-4 flex-1 bg-blue-100 border-l-4 border-blue-500 rounded px-4 py-2">
<span className="font-semibold text-blue-800">Creative Writing</span>
</div>
</div>
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">1:00 - 2:00 pm</span>
<div className="ml-4 flex-1 bg-green-100 border-l-4 border-green-500 rounded px-4 py-2">
<span className="font-semibold text-green-800">Public Speaking</span>
</div>
</div>
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">3:00 - 4:30 pm</span>
<div className="ml-4 flex-1 bg-yellow-100 border-l-4 border-yellow-500 rounded px-4 py-2">
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">11:00 am - 12:30 pm</span>
<div className="ml-4 flex-1 bg-purple-100 border-l-4 border-purple-500 rounded px-4 py-2">
...
<div className="flex flex-col gap-4 ml-8">
<div className="flex items-center">
<span className="w-28 text-gray-500 text-sm">10:00 - 11:00 am</span>
<div className="ml-4 flex-1 bg-yellow-100 border-l-4 border-yellow-500 rounded px-4 py-2">

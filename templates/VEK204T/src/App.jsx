...
<div className="absolute inset-0 bg-gradient-to-br from-purple-900/10 via-transparent to-blue-900/10" style={{zIndex: '2'}}></div>
...
<div className="card-divider mx-8 relative z-10"></div>

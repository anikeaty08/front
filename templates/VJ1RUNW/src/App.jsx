...
<button aria-label="Copy code" className="absolute top-4 right-4 text-slate-400 hover:text-white transition-colors" onclick="copyCode()">
...
<div className="w-56 shrink-0 bg-[#151a24] border border-white/10 rounded-lg p-4 relative">
<button aria-label="Remove variant" className="absolute top-3 right-3 text-slate-500 hover:text-slate-300">
<i className="w-4 h-4" data-lucide="x"></i>
</button>
<div className="text-center mb-4">
<span className="text-emerald-400 font-bold text-sm">25% of users</span>
<i className="inline w-3 h-3 text-slate-400 ml-1" data-lucide="pen"></i>
<h3 className="text-xs text-slate-300 mt-1">Test 1 | E1</h3>
<p className="text-[10px] text-slate-500">2,123 Assigned</p>
</div>
<div className="w-full h-72 bg-slate-800 rounded-md"></div>
</div>
</template>

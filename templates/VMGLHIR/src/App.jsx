...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      function renderBlockPreview(block) {
        ...
        switch (block.type) {
          case "hero": {
            ...
            t.className = `mt-4 text-[${block.titleSize}px] tracking-tight font-medium`;
            ...
            s.className = "mt-2 text-[15px] text-neutral-600";
            ...
            btn.style.textAlign = block.align;
      ...
      function countCharacters() {
        const text = state.blocks.map(b => {
          ...
          if (b.type === "hero") return [b.title, b.subtitle].filter(Boolean).
    } catch (error) {

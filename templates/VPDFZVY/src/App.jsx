...
<div className="grid-item relative w-full h-full overflow-hidden rounded-lg" onclick="openModal('https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1600&amp;auto=format&amp;fit=crop')">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800&amp'}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-lg" onclick="openModal('https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=1600&amp;auto=format&amp;fit=crop')">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&amp'}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-lg" onclick="openModal('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600&amp;auto=format&amp;fit=crop')">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=800&amp'}}></div>
</div>
<div className="grid-item relative w-full h-full overflow-hidden rounded-lg" onclick="openModal('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600&amp;auto=format&amp;fit=crop')">
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1506929562872-bb421503ef21?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1465188162913-8fb5709d6d57?w=800&amp'}}></div>
</div>
...
<div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?w=800&amp'}}></div>
</div>

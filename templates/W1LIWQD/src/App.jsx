...
<div className="frame-texture" id="frameTexture" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1553267751-1c148a7280a1?q=80&amp'}}></div>
</div>
...
<div className="mount-option bg-white p-2 rounded-md active-mat" data-mount-style={{}}>
...
<div className="absolute inset-0 bg-black bg-opacity-20 rounded-lg flex items-center justify-center">
<div className="mount-option bg-white p-2 rounded-md" data-mount-style={{}}>

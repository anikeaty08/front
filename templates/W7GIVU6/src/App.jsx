...
<section className="relative h-screen bg-cover bg-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1511578314322-379afb476865?w=1920&amp'}}>
...
<div className="w-full h-full bg-cover bg-center flex items-center justify-center" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&amp'}}>
...
<div className="bg-cover bg-center aspect-video rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=600&amp'}}></div>
...
<div className="bg-cover bg-center aspect-video rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&amp'}}></div>
...
<div className="bg-cover bg-center aspect-video rounded-2xl mb-4 group-hover:scale-105 transition-transform duration-300" style={{backgroundImage: 'url(\'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&amp'}}></div>

...
<button className="hover:bg-black/40 transition bg-black/30 rounded-full px-2 py-2">
<svg className="" fill="none" height="24" stroke="white" viewbox="0 0 24 24" width="24">
...
<button className="flex flex-row items-center gap-2 text-base font-medium text-white bg-[#4E18BB] rounded-full px-6 py-3 shadow-lg">

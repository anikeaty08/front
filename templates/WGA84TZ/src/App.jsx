...
<button className="rounded-xl border-2 border-primary bg-accent p-4 flex flex-col items-center hover:scale-105 transition focus-ring" onclick="setTheme('blue')">
<span className="block w-6 h-6 rounded-full bg-blue-400 mb-1"></span>
<span className="text-xs font-medium">Calm Blue</span>
</button>
<button className="rounded-xl border-2 border-primary bg-accent p-4 flex flex-col items-center hover:scale-105 transition focus-ring" onclick="setTheme('green')">
<span className="block w-6 h-6 rounded-full bg-green-400 mb-1"></span>
<span className="text-xs font-medium">Fresh Green</span>
</button>
<button className="rounded-xl border-2 border-primary bg-accent p-4 flex flex-col items-center hover:scale-105 transition focus-ring" onclick="setTheme('purple')">
<span className="block w-6 h-6 rounded-full bg-purple-400 mb-1"></span>
<span className="text-xs font-medium">Chill Purple</span>
</button>
<button className="rounded-xl border-2 border-primary bg-accent p-4 flex flex-col items-center hover:scale-105 transition focus-ring" onclick="setTheme('gray')">
...
<button className="w-full flex items-center gap-3 p-3 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="selectChatbot('Serious &amp; Supportive')">
...
<button className="w-full flex items-center gap-3 p-3 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="selectChatbot('Mature Peer')">
...
<button className="w-full flex items-center gap-3 p-3 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="selectChatbot('Slightly Sarcastic')">
...
<button className="rounded-full bg-accent p-2 focus-ring" onclick="showScreen('settings')" title="Settings">
...
<button className="mt-2 px-4 py-2 bg-primary text-white rounded-md font-medium focus-ring" onclick="showScreen('chat')">Chat Now</button>
</div>
<nav className="grid grid-cols-2 gap-4 mb-8">
<button className="bg-accent rounded-xl p-5 flex flex-col items-center shadow hover:scale-105 transition focus-ring" onclick="showScreen('outreach')">
...
<button className="bg-accent rounded-xl p-5 flex flex-col items-center shadow hover:scale-105 transition focus-ring" onclick="showScreen('resources')">
...
<button className="mb-4 text-primary text-sm font-medium flex items-center gap-1 focus-ring" onclick="showScreen('dashboard')">
...
<button className="w-full flex items-center gap-3 p-4 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="showOutreachForm('Check-in with Counselor')">
...
<button className="w-full flex items-center gap-3 p-4 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="showOutreachForm('Share Anonymously')">
...
<button className="w-full flex items-center gap-3 p-4 border-2 border-primary rounded-lg bg-accent hover:scale-105 transition focus-ring" onclick="showOutreachForm('File Official Report')">
...
<div className="flex gap-2">
<button className="w-7 h-7 rounded-full bg-blue-400 border-2 border-primary focus-ring" onclick="setTheme('blue')"></button>
<button className="w-7 h-7 rounded-full bg-green-400 border-2 border-primary focus-ring" onclick="setTheme('green')"></button>
<button className="w-7 h-7 rounded-full bg-purple-400 border-2 border-primary focus-ring" onclick="setTheme('purple')"></button>
<button className="w-7 h-7 rounded-full bg-gray-400 border-2 border-primary focus-ring" onclick="setTheme('gray')"></button>
</div>
</div>
<div className="mb-4">
<label className="block font-medium mb-1">AI chatbot personality</label>
<select className="w-full border border-primary rounded p-2 focus-ring" onchange="selectChatbot(this.value)">

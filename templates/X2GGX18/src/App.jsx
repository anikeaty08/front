...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
    ...
    (function () {
      var root = document.getElementById('aura-emfalm9dj');
      if (!root) return;

      var text = root.getAttribute('data-tooltip') || '';
      var tip = root.querySelector('[data-tooltip-bubble]');
      var textEl = tip ?.querySelector('[data-tooltip-text]') : null;
      ...
      root.setAttribute('aria-describedby', 'tooltip-' + root.id);
      tip.setAttribute('id', 'tooltip-' + root.id);
...
<div className="max-w-7xl flex relative mr-auto ml-auto pt-6 pr-6 pb-6 pl-6 items-center justify-between">
...
<p className="max-w-none w-full text-slate-600 mt-3" style={{animation: 'fadeUp .7s ease-out .1s both'}}>Yuanta ให้บริการแนะนำการลงทุนจากทีมงานมืออาชีพ ที่มากด้วยประสบการณ์และผู้เชี่ยวชาญเฉพาะสินทรัพย์ ที่พร้อมดูแลสินทรัพย์การลงทุนที่หลากหลาย เพื่อตอบโจทย์ในทุก ๆ วัตถุประสงค์การลงทุนใน ตราสารหนี้ หุ้นต่างประเทศและ ETF</p>
</div>
...
<div className="rounded-lg ring-1 p-4 bg-white/60 ring-black/10">
<div className="text-[11px] uppercase text-slate-600 tracking-wide">Duration</div>
...
<div className="flex text-sm text-slate-600 mt-2 items-center justify-between"><span className="">ตราสารหนี้แนะนำ</span><span className="text-xs text-slate-500">ข้อมูลอัปเดต 25 สิงหาคม 2568 9.00 น.</span></div>
...
<div className="col-span-2 relative group inline-flex gap-1 items-center" data-tooltip="อาดอกเบี้ยคงที่ที่ผู้ออกพันธบัตรสัญญาว่าจะจ่ายให้กับผู้ถือพันธบัตรเป็นรายปี">
<span className="tracking-tight">Coupon</span>
<div aria-hidden="true" className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 transform w-[280px] pointer-events-none z-50 hidden" data-tooltip-bubble="">
<div className="relative">
<div className="absolute -bottom-1 left-1/2 -translate-x-1/2 h-2 w-2 rotate-45 bg-slate-900 ring-1 ring-black/10"></div>
<div className="rounded-lg bg-slate-900 text-white text-xs leading-relaxed px-3 py-2 ring-1 ring-black/10 shadow" data-tooltip-text="">
...
<div className="col-span-2">Credit Rating</div>
...
<div className="sm:col-span-2 w-full flex gap-1 text-sm text-slate-800 items-center">3.0–4.3%</div>
...
<a className="sm:inline-flex items-center gap-2 text-[12px] hover:bg-[#095EC4] font-medium text-white bg-[#0A6EE7] rounded-lg pt-1 pr-1.5 pb-1 pl-1.5" href="https://aura.build/share/5GJ8Y0P" role="button">ดูข้อมูล</a>
</div>
...
<div className="sm:col-span-2 w-full flex gap-1 text-sm text-slate-800 items-center">2.1–5.4%</div>
<div className="sm:col-span-2 text-sm text-slate-800 w-full flex items-center gap-1">
...
<div className="sm:col-span-2 w-full flex gap-1 text-sm text-slate-800 items-center">3.0–5.8%</div>
...
<div className="sm:col-span-2 w-full flex gap-1 text-sm text-slate-800 items-center">2.4–5.2%</div>
<div className="sm:col-span-2 text-sm text-slate-800 w-full flex items-center gap-1">
<svg className="lucide lucide-calendar h-4 w-4 text-slate-600" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path></svg>
          2026–2033
        </div>
...
<div className="max-w-7xl md:pb-24 mr-auto ml-auto pr-6 pb-16 pl-6">
<div className="relative overflow-hidden rounded-lg bg-gradient-to-b ring-1 from-slate-100/60 to-slate-100/20 ring-black/10">
<div className="absolute inset-0 pointer-events-none">
...
<h3 className="text-2xl font-semibold text-gray-900 tracking-tight mt-1">สนใจติดต่อลงทุนสินทรัพย์ต่างประเทศ</h3>
...
<input className="w-full ring-1 ring-gray-200 placeholder:text-gray-400 focus:outline-none focus:ring-gray-300 text-sm text-gray-900 rounded-lg pt-2.5 pr-3.5 pb-2.5 pl-3.5" inputmode="tel" placeholder="08x-xxx-xxxx" required="" type="tel"/>
</div>
<div className="sm:col-span-1">
<label className="block text-[12px] text-gray-600 pb-1.5">อีเมล*</label>
<input className="w-full ring-1 ring-gray-200 placeholder:text-gray-400 focus:outline-none focus:ring-gray-300 text-sm text-gray-900 rounded-lg pt-2.5 pr-3.5 pb-2.5 pl-3.5" placeholder="you@example.com" required="" type="email"/>
</div>
<div className="sm:col-span-2">
</div>
<div className="sm:col-span-2 mt-1 items-center justify-center">
<div className="ring-1 ring-gray-200 sm:p-6 bg-white rounded-2xl pt-4 pr-4 pb-4 pl-4">
<h4 className="text-base font-semibold text-slate-900 tracking-tight">สินทรัพย์ต่างประเทศที่สนใจ</h4>
<div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
<label className="flex items-start gap-3 cursor-pointer select-none">
<input className="peer sr-only" name="apple_bonds[]" type="checkbox" value="Apple Inc 1.37 2026"/>
<span className="h-6 w-6 ring-1 ring-gray-300 flex items-center justify-center peer-checked:bg-[#0A6EE7] peer-checked:ring-[#0A6EE7] bg-white rounded-md">
<svg className="hidden peer-checked:block h-3.5 w-3.5 text-white" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
</span>
<span className="leading-relaxed">
<span className="text-sm font-medium text-slate-900 tracking-tight">Overseas Bonds</span>
</span>
</label>
<label className="flex items-start gap-3 cursor-pointer select-none">
<input className="peer sr-only" name="apple_bonds[]" type="checkbox" value="Apple Inc 1.65% 2027"/>
<span className="h-6 w-6 rounded-md ring-1 ring-gray-300 bg-white flex items-center justify-center peer-checked:bg-[#0A6EE7] peer-checked:ring-[#0A6EE7]">
<svg className="hidden peer-checked:block h-3.5 w-3.5 text-white" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
</span>
<span className="leading-relaxed">
<span className="text-sm font-medium text-slate-900 tracking-tight">Apple Inc 1.65%</span>
</span>
</label>
<label className="flex items-start gap-3 cursor-pointer select-none">
<input className="peer sr-only" name="apple_bonds[]" type="checkbox" value="Apple Inc 3.05% 2032"/>
<span className="h-6 w-6 rounded-md ring-1 ring-gray-300 bg-white flex items-center justify-center peer-checked:bg-[#0A6EE7] peer-checked:ring-[#0A6EE7]">
<svg className="hidden peer-checked:block h-3.5 w-3.5 text-white" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
</span>
<span className="leading-relaxed">
<span className="text-slate900 text-sm font-medium tracking-tight">Apple Inc 3.05%</span>
</span>
</label>
</div>
</div>
<button className="inline-flex hover:bg-gray-800 transition w-full sm:w-auto text-sm font-medium text-white bg-[#0A6EE7] rounded-lg pt-2.5 pr-4 pb-2.5 pl-4 items-center justify-center mt-3" type="submit">ส่งข้อมูล</button>
</div>
</form>
</div>
</div>

...
<div="rounded-lg border="" border-slate-200="" dark:border-slate-800="" p-4"="">
...
<button className="inline-flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-md border-slate-200 dark:border-slate-800 hover:bg-slate50 dark:hover:bg-slate-800/60" onclick="window.print()">
...
<div>
          &lt;4 className="font-medium tracking-tight"&gt;Legal
<ul className="mt-2 grid gap-1.5">

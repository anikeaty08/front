...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10 blur-sm" id="aura-image" style={{backgroundImage: 'url("https://i.postimg.cc/Rh7z50WJ/lmarena-image-96.png?w=800&amp'}}></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div><div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image"></div>

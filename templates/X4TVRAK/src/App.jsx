...
<button className="styleBtn rounded-md border border-neutral-300 px-3 py-1 text-sm transition hover:border-amber-500 border-amber-500 bg-amber-50" data-style={{}}>Luxury</button>
<button className="styleBtn rounded-md border border-neutral-300 px-3 py-1 text-sm transition hover:border-amber-500" data-style={{}}>Balanced</button>
<button className="styleBtn rounded-md border border-neutral-300 px-3 py-1 text-sm transition hover:border-amber-500" data-style={{}}>Budget</button>
</div>
</div>
</div>

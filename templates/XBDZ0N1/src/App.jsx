...
<p className="max-w-2xl text-slate-600 mt-3" style={{animation: 'fadeUp .7s ease-out .1s both'}}>Yuanta ให้บริการแนะนำการลงทุนจากทีมงานมืออาชีพ ที่มากด้วยประสบการณ์และผู้เชี่ยวชาญเฉพาะสินทรัพย์ ที่พร้อมดูแลสินทรัพย์การลงทุนของคุณ </p>
</div>
...
<p className="text-slate-600 mt-3">ลงทุนในพันธบัตรรัฐบาลและเอกชนต่างประเทศ รับกระแสเงินสดจากคูปอง เสริมเสถียรภาพพอร์ต พร้อมกระจายความเสี่ยงด้านสกุลเงินและอันดับเครดิต</p>
...
<span className="inline-flex items-center gap-1 relative group tracking-tight">Coupon
  <svg className="lucide lucide-info ml-1 w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="info" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" style={{width: '16px', height: '16px', color: 'rgb(71, 85, 105)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle className="" cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
</span>

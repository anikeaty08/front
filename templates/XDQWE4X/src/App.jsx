...
<template id="cardTpl">
<div className="relative group bg-white p-4 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
<img alt="" className="w-full h-64 object-cover rounded-xl" src=""/>
<div className="absolute inset-0 rounded-2xl ring-1 ring-black/5 group-hover:ring-indigo-500/40 transition pointer-events-none"></div>
<div className="pt-5 flex items-start justify-between gap-4">
<div>
<h3 className="font-medium text-lg leading-snug name"></h3>
<p className="text-gray-500 text-sm mt-1 category"></p>
</div>
<span className="text-indigo-600 font-semibold price"></span>
</div>

<button aria-label="Add to cart" className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-black text-white text-sm font-medium hover:bg-neutral-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-black">

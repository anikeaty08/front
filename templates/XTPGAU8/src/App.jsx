...
<img alt="Family Law" className="rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1589927986089-35812388d1d4?w=1080&amp;q=80"/>
<div className="space-y-6">
...
<div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
<img alt="Litigation" className="rounded-lg shadow-lg md:order-2" src="https://images.unsplash.com/photo-1603791452906-bb8a80f0d1c1?w=1080&amp;q=80"/>
...
<div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
<img alt="Bankruptcy" className="rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1610484826987-7680c31b5990?w=1080&amp;q=80"/>
<div className="space-y-6">

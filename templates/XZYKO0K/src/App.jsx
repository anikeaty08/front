...
<button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition">New Audit</button>
...
<th className="px-6 py-4 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" scope="col">
                  Actions
                </th>
</tr>
</thead>
...
<div>
<div className="text-sm font-medium text-gray-900">mysite.org</div>
...
<td className="px-6 py-4 whitespace-nowrap">
<div className="flex items-center">
<div className="text-sm font-medium text-gray-900">74</div>
<div className="ml-2 w-16 bg-gray-200 rounded-full h-2">
...
<div>
<div className="text-sm font-medium text-gray-900">storefront.net</div>
<div className="text-xs text-gray-500">Online Store</div>
</div>
</div>
</td>
<td className="px-6 py-4 whitespace-nowrap">
<div className="text-sm text-gray-900">May 20, 2023</div>
...
<button className="text-gray-400 hover:text-gray-600">
<svg className="w-5 h-5" fill="currentColor" viewbox="0 0 20 20">
</svg></button></div></td></tr></tbody></table></div></div></div></main>
    </>
  );
}

...
<circle cx="20" cy="20" fill="transparent" r="16" stroke="#FF3B30" stroke-dasharray="40 60" stroke-dashoffset="0" strokeWidth="8"></circle>

<circle cx="20" cy="20" fill="transparent" r="16" stroke="#34C759" stroke-dasharray="28 72" stroke-dashoffset="-40" strokeWidth="8"></circle>

<circle cx="20" cy="20" fill="transparent" r="16" stroke="#00C7BE" stroke-dasharray="22 78" stroke-dashoffset="-68" strokeWidth="8"></circle>

<circle cx="20" cy="20" fill="transparent" r="16" stroke="#FFC800" stroke-dasharray="10 90" stroke-dashoffset="-90" strokeWidth="8"></circle>
</svg>
</div>

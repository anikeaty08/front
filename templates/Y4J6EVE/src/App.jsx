...
<tr className="hover:bg-neutral-900 transition-colors cursor-pointer border-b border-zinc-900 last:border-b-0" onclick="window.location.href='#';">
...
<tr className="hover:bg-neutral-900 transition-colors cursor-pointer" onclick="window.location.href='#';">
<td className="py-4 pr-4 sm:py-5 sm:pr-8">
<div className="flex flex-col gap-1">
<span className="flex items-center gap-2 font-medium">

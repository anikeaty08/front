...
<h1 className="w-3/4 text-[24px] font-light leading-tight tracking-tight font-jakarta" style={{color: '#007899'}}>Advancing Digital Innovation for Tomorrow</h1>
<div className="w-1/4 text-[24px] font-semibold text-right font-jakarta" style={{color: '#007899'}}>NOVA</div>
</div>

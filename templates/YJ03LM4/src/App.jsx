...
<button className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors" onclick="openModal('contactModal')" type="button">Contact</button>
</nav>

<div className="hidden md:flex items-center gap-3">
<button className="inline-flex items-center gap-2 px-3.5 py-2 rounded-md bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors shadow-sm ring-1 ring-neutral-900/10" onclick="openModal('prospectusModal')" type="button">
<i className="w-4 h-4" data-lucide="file-text"></i>
              Request Prospectus
            </button>
<button className="inline-flex items-center gap-2 px-3.5 py-2 rounded-md bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-50 transition-colors ring-1 ring-neutral-200" onclick="openModal('callModal')" type="button">
<i className="w-4 h-4" data-lucide="calendar"></i>
              Schedule Call
            </button>
</div>

<button className="md:hidden inline-flex items-center justify-center h-9 w-9 rounded-md ring-1 ring-neutral-200 hover:bg-neutral-50" onclick="toggleMobile()">
...
<a className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors" href="#performance">Performance</a>
<a className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors" href="#about">About</a>
<button className="text-left text-sm text-neutral-700 hover:text-neutral-900 transition-colors" onclick="openModal('contactModal')" type="button">Contact</button>
<div className="flex gap-2 pt-2">
<button className="flex-1 inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded-md bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors shadow-sm ring-1 ring-neutral-900/10" onclick="openModal('prospectusModal')" type="button">
<i className="w-4 h-4" data-lucide="file-text"></i>
              Prospectus
            </button>
<button className="flex-1 inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded-md bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-50 transition-colors ring-1 ring-neutral-200" onclick="openModal('callModal')" type="button">
<i className="w-4 h-4" data-lucide="calendar"></i>
              Call
            </button>
</div>
...
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors shadow-sm ring-1 ring-neutral-900/10" onclick="openModal('prospectusModal')" type="button">
<i className="w-4 h-4" data-lucide="file-text"></i>
                Request Prospectus
              </button>
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-50 transition-colors ring-1 ring-neutral-200" onclick="openModal('callModal')" type="button">
...
<div className="mt-8">
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-50 transition-colors ring-1 ring-neutral-200" onclick="openModal('prospectusModal')" type="button">
...
<button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors shadow-sm ring-1 ring-neutral-900/10" onclick="openModal('callModal')" type="button">
...
<div className="absolute inset-0 bg-black/30" onclick="closeModal('prospectusModal')"></div>
...
<button className="h-8 w-8 rounded-md hover:bg-neutral-50 inline-flex items-center justify-center ring-1 ring-neutral-200" onclick="closeModal('prospectusModal')">
<i className="w-4 h-4" data-lucide="x"></i>
</button>
</div>
<form className="p-5 space-y-4" onsubmit="event.preventDefault(); if(validateAccredited('prospectus')) { alert('Access granted. A secure link will be emailed after verification.'); closeModal('prospectusModal'); }">
...
<button className="h-5 w-5 rounded border border-neutral-300 bg-white ring-1 ring-inset ring-transparent hover:ring-neutral-300 flex items-center justify-center" id="prospectusCheck" onclick="toggleCheck(this)" type="button">
...
<div className="absolute inset-0 bg-black/30" onclick="closeModal('callModal')"></div>
<div className="relative max-w-lg mx-auto mt-24 bg-white rounded-lg border border-neutral-200 shadow-xl">
<div className="flex items-center justify-between px-5 py-4 border-b border-neutral-200">
<div className="flex items-center gap-2 text-sm font-medium text-neutral-900">
...
<button className="h-8 w-8 rounded-md hover:bg-neutral-50 inline-flex items-center justify-center ring-1 ring-neutral-200" onclick="closeModal('callModal')">
<i className="w-4 h-4" data-lucide="x"></i>
</button>
</div>
<form className="p-5 space-y-4" onsubmit="event.preventDefault(); if(validateAccredited('call')) { alert('Thanks—our team will confirm a time shortly.'); closeModal('callModal'); }">
<div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
<div>
...
<div className="flex items-start gap-3">
<button className="h-5 w-5 rounded border border-neutral-300 bg-white ring-1 ring-inset ring-transparent hover:ring-neutral-300 flex items-center justify-center" id="callCheck" onclick="toggleCheck(this)" type="button">
</button>
...
<div className="absolute inset-0 bg-black/30" onclick="closeModal('contactModal')"></div>
<div className="relative max-w-lg mx-auto mt-24 bg-white rounded-lg border border-neutral-200 shadow-xl">
<div className="flex items-center justify-between px-5 py-4 border-b border-neutral-200">
<div className="flex items-center gap-2 text-sm font-medium text-neutral-900">
...
<button className="h-8 w-8 rounded-md hover:bg-neutral-50 inline-flex items-center justify-center ring-1 ring-neutral-200" onclick="closeModal('contactModal')">
<i className="w-4 h-4" data-lucide="x"></i>
</button>
</div>
<form className="p-5 space-y-4" onsubmit="event.preventDefault(); if(validateAccredited('contact')) { alert('Thank you—our team will respond within one business day.'); closeModal('contactModal'); }">
<div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
<div>
<label className="block text-xs text-neutral-700 mb-1">Name</label>
<input className="w-full px-3 py-2 text-sm rounded-md border border-neutral-300 focus:outline-none focus:ring-4 focus:ring-neutral-200 focus:border-neutral-400" placeholder="Full name" required="" type="text"/>
...
<div className="flex items-start gap-3">
<button className="h-5 w-5 rounded border border-neutral-300 bg-white ring-1 ring-inset ring-transparent hover:ring-neutral-300 flex items-center justify-center" id="contactCheck" onclick="toggleCheck(this)" type="button">
</button>
<label className="text-sm text-neutral-700">I confirm I am an accredited/qualified investor.</label>
</div>
<div className="flex items-center justify-between">

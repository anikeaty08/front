...
<button className="w-full bg-blue-600 text-white rounded-xl py-2 font-semibold mt-2 shadow active:scale-95 transition" onclick="sendOTP()">Send OTP</button>
</div>
</div>
...
<button className="w-full bg-blue-600 text-white rounded-xl py-2 font-semibold shadow active:scale-95 transition" onclick="validateOTP()">Verify &amp; Continue</button>
<button className="mt-2 text-xs text-blue-500 underline" onclick="showScreen('loginScreen')">Edit Mobile Number</button>
</div>
</div>
...
<input className="w-full border rounded-xl px-3 py-2 bg-blue-50" id="dob" onchange="calcAge()" type="date"/>
</div>
<div className="w-1/2">
...
<button className="w-full bg-blue-600 text-white rounded-xl py-2 mt-2 font-semibold shadow active:scale-95 transition" onclick="completeOnboarding()">Continue</button>
</div>
</div>
...
<input className="w-full border rounded-xl px-3 py-2 mb-2 focus:ring focus:ring-blue-100 bg-blue-50" id="symptomSearch" oninput="searchSymptoms()" placeholder="Search symptoms..." type="text"/>
<div className="flex flex-wrap gap-2 mb-2">
<button className="symptom-btn bg-blue-500 text-white px-3 py-1 rounded-full text-xs active:scale-95 transition" onclick="selectSymptom('Fever')">Fever</button>
<button className="symptom-btn bg-blue-500 text-white px-3 py-1 rounded-full text-xs active:scale-95 transition" onclick="selectSymptom('Headache')">Headache</button>
<button className="symptom-btn bg-blue-500 text-white px-3 py-1 rounded-full text-xs active:scale-95 transition" onclick="selectSymptom('Cough')">Cough</button>
<button className="symptom-btn bg-blue-500 text-white px-3 py-1 rounded-full text-xs active:scale-95 transition" onclick="selectSymptom('Sore throat')">Sore throat</button>
<button className="symptom-btn bg-blue-500 text-white px-3 py-1 rounded-full text-xs active:scale-95 transition" onclick="selectSymptom('Nausea')">Nausea</button>
</div>
<small className="text-gray-500">Tap a symptom or search and select.</small>
</div>

<button className="fixed bottom-32 right-6 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg shadow-green-200 transition active:scale-90 z-40" onclick="exportWhatsapp()" title="Export to WhatsApp">
...
<button className="flex items-center gap-3 border rounded-xl p-3 shadow active:scale-95 transition bg-blue-50 hover:bg-blue-100" onclick="connectAppleHealth()">
...
<button className="flex items-center gap-3 border rounded-xl p-3 shadow active:scale-95 transition bg-blue-50 hover:bg-blue-100" onclick="connectGoogleFit()">
...
<button className="flex items-center gap-3 border rounded-xl p-3 shadow active:scale-95 transition bg-green-50 hover:bg-green-100" onclick="exportWhatsapp()">
...
<button className="nav-btn flex flex-col items-center text-blue-600 font-bold" id="nav-home" onclick="navTo('home')">
...
<button className="nav-btn flex flex-col items-center text-gray-400" id="nav-profile" onclick="navTo('profile')">
...
<button className="nav-btn flex flex-col items-center text-gray-400" id="nav-integrations" onclick="navTo('integrations')">

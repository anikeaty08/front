...
<span className="ml-3 text-lg font-medium text-white">Quantum</span>
</div>
...
<input className="w-full bg-[#1E1E26] border border-subtle rounded-xl py-3 pl-10 pr-4 text-white placeholder-gray-500 outline-none" placeholder="Search or type a command" type="text"/>
</div>
</div>

<div className="relative z-10 mt-8 px-6">
<h2 className="text-sm font-medium text-gray-400 uppercase">Quick Actions</h2>
<div className="grid grid-cols-2 gap-3 mt-3">
<div className="bg-[#1E1E26] border border-subtle rounded-xl p-4 flex flex-col">
...
<span className="text-xs text-gray-400 mt-1">Start conversation</span>
</div>
<div className="bg-[#1E1E26] border border-subtle rounded-xl p-4 flex flex-col">
<div className="w-10 h-10 rounded-lg bg-accent bg-opacity-20 flex items-center justify-center mb-3">
<svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewbox="0 0 24 24">
...
<span className="text-xs text-gray-400 mt-1">Create images</span>
</div>
</div>
</div>
...
<div className="relative z-10 mt-8 px-6">
<div className="flex justify-between items-center">
<h2 className="text-sm font-medium text-gray-400 uppercase">Recent Chats</h2>
<a className="text-xs font-medium text-accent" href="#">View all</a>
</div>
...
<span className="ml-2 text-sm font-medium text-white">Marketing strategy</span>
</div>
<span className="text-xs text-gray-400">2h ago</span>
</div>
<p className="mt-2 text-xs text-gray-400 line-clamp-2">We discussed content marketing strategies for the new product launch...</p>
</div>
<div className="bg-[#1E1E26] border border-subtle rounded-xl p-4">
<div className="flex justify-between items-start">
<div className="flex items-center">
...
<span className="ml-2 text-sm font-medium text-white">Code review</span>
</div>
<span className="text-xs text-gray-400">Yesterday</span>
</div>
<p className="mt-2 text-xs text-gray-400 line-clamp-2">I helped you debug the authentication service and optimize database queries...</p>
</div>
</div>
</div>
...
<span className="text-xs font-medium text-accent mt-1">Home</span>
</button>
<button className="p-3 flex flex-col items-center">

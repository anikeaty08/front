...
<img alt="Jennifer Lim portrait" className="absolute inset-0 w-full h-full object-cover object-center z-0 opacity-0 scale-125 blur-md transition-all duration-2000 ease-out" id="heroImage" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d0b0002-7af7-41bd-b98a-34421a404140_1600w.jpg" style={{filter: 'brightness(0.56)'}}/>
...
<img alt="Jennifer Lim working" className="absolute inset-0 w-full h-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d0b0002-7af7-41bd-b98a-34421a404140_1600w.jpg"/>
...
<img alt="E-Commerce Platform Redesign" className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/77827dc5-39e4-4855-bf02-5d844f2cc636_800w.jpg"/>
</div>
</div>
</div>
</div>
...
<img alt="MobileBanking App" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/73268d9b-80d3-458d-acd9-47c696ab9d24_1600w.jpg"/>
...
<div className="group">
<div className="relative mb-6 overflow-hidden rounded-xl ring-1 ring-zinc-700/50">
<img alt="Healthcare Dashboard" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d0b0002-7af7-41bd-b98a-34421a404140_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-zinc-900/60 to-transparent"></div>
</div>
<div className="mb-4">

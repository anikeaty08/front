...
<h2 className="text-2xl font-semibold text-slate-600 text-center max-w-3xl animate-in" style={{'--delay': '1200ms'}}>Koordynacja kampanii reklamowych na czołowych serwisach Real Estate</h2>
<div className="w-full logo-carousel overflow-hidden">
<div className="flex scrolling-logos">

<div className="flex-shrink-0 flex items-center justify-center space-x-12 px-6 animate-in" style={{'--delay': '1300ms'}}>
...
<div className="inline-flex items-center gap-x-2.5 rounded-full bg-green-100 px-4 py-2 animate-in" style={{'--delay': '1400ms'}}>

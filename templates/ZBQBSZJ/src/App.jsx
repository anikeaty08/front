...
<nav className="bg-neutral-900/70 backdrop-blur-xl shadow-[0_1px_0_0_rgba(255,255,255,0.06)_inset,0_8px_30px_rgba(0,0,0,0.35)]">
...
<a className="px-3 py-2 text-sm font-medium text-neutral-200/90 hover:text-white hover:bg-white/5 rounded-md transition-colors" href="/products/api">API Directory</a>
<a className="px-3 py-2 text-sm font-medium text-neutral-200/90 hover:text-white hover:bg-white/5 rounded-md transition-colors" href="/data-coverage">Data Coverage</a>

<div className="relative group">
<button className="inline-flex items-center px-3 py-2 text-sm font-medium text-neutral-200/90 hover:text-white hover:bg-white/5 rounded-md transition-colors">
                Billing
                <i className="ml-1 h-4 w-4 text-neutral-300" data-lucide="chevron-down"></i>
</button>
<div className="invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-150 ease-out absolute right-0 mt-2 w-48 rounded-lg bg-neutral-900/80 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-1">
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/invoice">Invoices</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/correspondence">Correspondence</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/ledger">Ledger</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/newsrpm">NewsRPM</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/usage">API Usage</a>
</div>
</div>
...
<div className="invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-150 ease-out absolute right-0 mt-2 w-48 rounded-lg bg-neutral-900/80 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-1">
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/account">Accounts</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/article">Articles</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/platform">Platform</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/product">Products</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/user">Users</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/vendor">Vendor</a>
</div>
</div>
...
<div className="invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-150 ease-out absolute right-0 mt-2 w-56 rounded-lg bg-neutral-900/80 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-1">
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/password">Change Password</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/deployment">Deployments</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/invoice">Invoices</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/profile">My Profile</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/syndicatedContent">Syndicated Content</a>
</div>
</div>
<a className="px-3 py-2 text-sm font-medium text-neutral-200/90 hover:text-white hover:bg-white/5 rounded-md transition-colors" href="/logout">Logout</a>
<a className="px-3 py-2 text-sm font-medium text-neutral-200/90 hover:text-white hover:bg-white/5 rounded-md transition-colors" href="/contact">Contact Us</a>
</div>

<button aria-label="Open Menu" className="lg:hidden inline-flex items-center justify-center p-2 rounded-md text-neutral-200 hover:text-white hover:bg-white/5 transition-colors" id="mobileMenuBtn">
...
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/products/api">API Directory</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/data-coverage">Data Coverage</a>
<details className="px-1">
<summary className="px-2 py-2 text-sm text-neutral-200 cursor-pointer rounded-md hover:bg-white/5">Billing</summary>
<div className="pl-4 py-1 space-y-1">
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/invoice">Invoices</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/correspondence">Correspondence</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/ledger">Ledger</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/newsrpm">NewsRPM</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/billing/usage">API Usage</a>
</div>
</details>
<details className="px-1">
<summary className="px-2 py-2 text-sm text-neutral-200 cursor-pointer rounded-md hover:bg-white/5">Admin</summary>
<div className="pl-4 py-1 space-y-1">
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/account">Accounts</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/article">Articles</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/platform">Platform</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/product">Products</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/user">Users</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/admin/vendor">Vendor</a>
</div>
</details>
<details className="px-1">
<summary className="px-2 py-2 text-sm text-neutral-200 cursor-pointer rounded-md hover:bg-white/5">My Account</summary>
<div className="pl-4 py-1 space-y-1">
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/password">Change Password</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/deployment">Deployments</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/invoice">Invoices</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/profile">My Profile</a>
<a className="block px-2 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/account/syndicatedContent">Syndicated Content</a>
</div>
</details>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/logout">Logout</a>
<a className="block px-3 py-2 text-sm rounded-md hover:bg-white/5 text-neutral-200" href="/contact">Contact Us</a>
</div>
</div>
</nav>
</header>
...
<div className="absolute inset-0 opacity-80" style={{background: 'radial-gradient(1200px 600px at 10% 10%, rgba(59,130,246,0.25), transparent 60%), radial-gradient(1000px 500px at 90% 20%, rgba(56,189,248,0.18), transparent 60%), radial-gradient(900px 500px at 50% 90%, rgba(168,85,247,0.18), transparent 60%)', filter: 'blur(20px)', animation: 'fadeInBlur 1.2s ease-out both'}}></div>
<div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[1200px] h-[1200px] rounded-full opacity-40" style={{background: 'conic-gradient(from 180deg at 50% 50%, rgba(59,130,246,0.20), rgba(168,85,247,0.10), rgba(56,189,248,0.20), rgba(59,130,246,0.20))', filter: 'blur(32px)', animation: 'gradientShift 20s ease-in-out infinite'}}></div>
...
<a className="inline-flex items-center justify-center rounded-md bg-blue-500 text-white px-5 py-2.5 text-sm font-medium hover:bg-blue-400/90 transition-colors shadow-[0_8px_30px_rgba(59,130,246,0.35)] focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:ring-offset-0" href="/products/api">
              Explore API Directory
              <i className="ml-2 h-4 w-4 text-white" data-lucide="arrow-right"></i>
</a>
<a className="inline-flex items-center justify-center rounded-md bg-white/5 backdrop-blur-xl ring-1 ring-white/10 px-5 py-2.5 text-sm text-neutral-200 hover:bg-white/10 transition-colors shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]" href="/data-coverage">
              View Data Coverage
            </a>
</div>
...
<div className="px-3 py-1.5 rounded-md bg-white/5 ring-1 ring-white/10 shadow-sm text-xs font-medium tracking-tight text-neutral-200">SDS</div>
<div className="px-3 py-1.5 rounded-md bg-white/5 ring-1 ring-white/10 shadow-sm text-xs font-medium tracking-tight text-neutral-200">BATS</div>
<div className="px-3 py-1.5 rounded-md bg-white/5 ring-1 ring-white/10 shadow-sm text-xs font-medium tracking-tight text-neutral-200">NASDAQ</div>
<div className="px-3 py-1.5 rounded-md bg-white/5 ring-1 ring-white/10 shadow-sm text-xs font-medium tracking-tight text-neutral-200">NYSE</div>
<div className="px-3 py-1.5 rounded-md bg-white/5 ring-1 ring-white/10 shadow-sm text-xs font-medium tracking-tight text-neutral-200">TMX</div>
</div>
</div>
</div>

<div className="relative" style={{animation: 'fadeUp .8s ease-out both', animationDelay: '.15s'}}>
<div className="rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-5">
...
<div className="rounded-lg bg-white/5 backdrop-blur-xl p-3 ring-1 ring-white/10 shadow-sm">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
...
<div className="pointer-events-none absolute -right-6 -top-6 h-28 w-28 rounded-full bg-blue-500/20 blur-2xl" style={{animation: 'float 6s ease-in-out infinite'}}></div>
</div>
</div>
</div>
</section>
...
<div className="rounded-xl bg-white/5 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-5">
...
<div className="rounded-xl bg-white/5 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-4">
...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="rounded-2xl bg-white/5 backdrop-blur-xl shadow-2xl ring-1 ring-white/10 px-6 py-6 sm:px-8 sm:py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4" style={{animation: 'fadeUp .8s ease-out both', animationDelay: '.05s'}}>
<div>
...
<a className="inline-flex items-center justify-center rounded-md bg-blue-500 text-white px-4 py-2.5 text-sm font-medium hover:bg-blue-400/90 transition-colors shadow-[0_8px_30px_rgba(59,130,246,0.35)] focus:outline-none focus:ring-2 focus:ring-blue-400/50" href="/products/api">
            Browse APIs
            <i className="ml-2 h-4 w-4 text-white" data-lucide="arrow-right"></i>
</a>
<a className="inline-flex items-center justify-center rounded-md bg-white/5 backdrop-blur-xl ring-1 ring-white/10 px-4 py-2.5 text-sm text-neutral-200 hover:bg-white/10 transition-colors" href="/contact">
            Contact Sales
          </a>
</div>
</div>

...
<div className="video-background-container fixed top-0 w-full h-screen -z-10 opacity-30 blur-lg">
<video autoplay="" className="w-full h-full object-cover" loop="" muted="" playsinline="" src="https://cdn.midjourney.com/video/a468c79f-c301-48f0-9af3-37cd4e29622e/2.mp4"></video>
</div>
...
<p className="text-center text-sm mt-4 font-geist text-glass-muted" style={{}}>Tire Monitor</p>
</div>
...
<div className="origin-bottom w-1.5 absolute bottom-1/2 rounded bg-white/90" id="hour" style={{height: '28%', transform: 'rotate(400.1deg)'}}></div>
<div className="origin-bottom w-1 absolute bottom-1/2 rounded bg-white/90" id="minute" style={{height: '38%', transform: 'rotate(121.2deg)'}}></div>
<div className="origin-bottom w-0.5 bg-orange-400 absolute bottom-1/2 rounded" id="second" style={{height: '44%', transform: 'rotate(72deg)'}}></div>
</div>

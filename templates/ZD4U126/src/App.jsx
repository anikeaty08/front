...
new Chart(ctx,{
  type:'radar',
  data:{labels:['Python','SQL','R','ML','ETL','Viz'],
    datasets:[{data:[92,88,80,90,85,87],
      backgroundColor:'rgba(99,102,241,.1)',
      borderColor:'rgb(99,102,241)',borderWidth:2,
      pointBackgroundColor:'rgb(99,102,241)'}]},
  options:{scales:{r:{angleLines:{color:'#e5e7eb'},grid:{color:'#e5e7eb'},ticks:{display:false},
    suggestedMin:0,suggestedMax:100}},plugins:{legend:{display:false}},
...
<header className="w-full backdrop-blur supports-backdrop-blur:bg-white/60 bg-white/90 dark:bg-gray-900/90 fixed top-0 z-50 border-b border-gray-200 dark:border-gray-800">
<div className="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
<span className="text-lg font-semibold tracking-tight gradient-text">Segev Ohana</span>
...
<button className="p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500" id="themeToggle">
...
<h1 className="text-4xl sm:text-5xl font-semibold tracking-tight mb-4 gradient-text">
        Turning Data Into <span className="inline-block animate-pulse">Impact</span>
</h1>
<p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
        I’m a data scientist specializing in predictive analytics, time-series forecasting, and fraud detection. My mission is to translate complex data into
        business value through elegant code, robust infrastructure, and compelling storytelling.
      </p>
...
<li>
<a className="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 rounded" href="mailto:segev054@gmail.com">
...
<img alt="Segev smiling" className="h-48 w-48 rounded-full object-cover shadow-md ring-4 ring-indigo-200 dark:ring-indigo-400" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?auto=format&amp;w=320&amp;q=80"/>
...
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="terminal"></i> Languages</h3>
<p>Python, R, SQL, Bash</p>
</div>
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="library"></i> ML Frameworks</h3>
<p>Scikit-learn, PyTorch, TensorFlow, XGBoost</p>
</div>
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="layers"></i> Data Stack</h3>
<p>Pandas, Spark, Airflow, dbt</p>
</div>
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="cloud"></i> Cloud</h3>
<p>AWS (S3, Redshift, Lambda), GCP BigQuery</p>
</div>
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="bar-chart-3"></i> BI &amp; Viz</h3>
<p>Tableau, Power BI, Looker, D3.js</p>
</div>
<div>
<h3 className="font-medium flex items-center gap-1 mb-2"><i className="h-4 w-4" data-lucide="shield-alert"></i> Specialities</h3>
<p>Time-Series, Anomaly Detection, MLOps</p>
</div>
</div>
<div className="mt-12">
...
<div><div><canvas aria-label="Radar chart of competencies" height="160" id="skillChart" role="img"></canvas></div></div>
</div>
</div>
</section>
<div className="border-t border-gray-200 dark:border-gray-800 my-16 mx-6"></div>
...
<p className="text-sm text-gray-600 dark:text-gray-300 flex-1">
          End-to-end streaming pipeline predicting sales every 15 min using
          Kafka, Spark Structured Streaming, and a PyTorch LSTM served via
          FastAPI.
        </p>
...
<p className="text-sm text-gray-600 dark:text-gray-300 flex-1">
          Self-learning autoencoder that re-trains on daily transaction
          distributions, achieving 30 % precision lift compared with static
          thresholds.
        </p>
...
<li>Served as the data liaison between dev teams and stakeholders.</li>
</ul>
</div>
</section>
<div className="border-t border-gray-200 dark:border-gray-800 my-16 mx-6"></div>

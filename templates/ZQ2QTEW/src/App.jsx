...
<circle cx="32" cy="32" fill="none" id="ring1" r="28" stroke="var(--blue)" stroke-dasharray="175" stroke-dashoffset="175" strokeLinecap="round" strokeWidth="4"></circle>
</svg>
...
<svg height="64" width="64">
<circle cx="32" cy="32" fill="none" id="ring2" r="28" stroke="var(--blue)" stroke-dasharray="175" stroke-dashoffset="175" strokeLinecap="round" strokeWidth="4"></circle>
</svg>
...
<svg height="64" width="64">
<circle cx="32" cy="32" fill="none" id="ring3" r="28" stroke="var(--blue)" stroke-dasharray="175" stroke-dashoffset="175" strokeLinecap="round" strokeWidth="4"></circle>
</svg>
...
<svg height="64" width="64">
<circle cx="32" cy="32" fill="none" id="ring4" r="28" stroke="var(--blue)" stroke-dasharray="175" stroke-dashoffset="175" strokeLinecap="round" strokeWidth="4"></circle>
</svg>
...
<path d="M20,60 C100,10 300,10 380,60 S300,110 200,160 100,210 20,260" fill="none" stroke="url(#pathgrad)" stroke-dasharray="10 14" stroke-dashoffset="10" strokeLinecap="round" strokeWidth="4">

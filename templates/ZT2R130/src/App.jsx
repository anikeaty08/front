...
<section className="mx-auto max-w-7xl px-6 pt-10 pb-16" id="overview">
...
<i className="h-3.5 w-3.5" data-lucide="equal"></i> 3
                </span>
</div>

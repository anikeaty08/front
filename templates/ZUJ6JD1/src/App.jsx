...
export default function App() {
  ...
  return (
    <>
      <div className="spline-container fixed top-0 w-full h-screen -z-10" data-parallax="0.2"><iframe frameborder="0" height="100%" src="https://my.spline.design/flowingribbon-TlkEaNrvCCNZuJBNJN3LXpRF" width="100%"></iframe></div>
...
<div className="absolute inset-0 opacity-[0.03]" data-parallax="0.3" style={{backgroundImage: 'linear-gradient(to right, rgb(139,69,19) 1px, transparent 1px), linear-gradient(to bottom, rgb(79,70,229) 1px, transparent 1px)', backgroundSize: '60px 60px'}}></div>

<div className="absolute left-[10%] top-[30%] size-2 rounded-full blur-[2px] animate-bounce bg-violet-400" data-parallax="0.4"></div>
<div className="absolute right-[18%] top-[22%] size-2 rounded-full blur-[2px] animate-bounce bg-amber-400" data-parallax="0.5" style={{animationDelay: '0.6s'}}></div>
<div className="absolute right-[30%] bottom-[18%] size-2 rounded-full blur-[2px] animate-bounce bg-violet-500" data-parallax="0.3" style={{animationDelay: '1.2s'}}></div>
<div className="absolute left-[22%] bottom-[12%] size-2 rounded-full blur-[2px] animate-bounce bg-amber-500" data-parallax="0.4" style={{animationDelay: '0.3s'}}></div>
</div>
...
<div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border ring-1 shadow-xl border-gray-200 bg-white ring-gray-100 animate-fade-in-right" data-parallax="0.1" style={{animationPlayState: 'running'}}>
...
<div className="group relative animate-fade-in-left" data-parallax="0.1" style={{animationPlayState: 'running'}}>
...
<div className="pointer-events-none absolute -inset-10 -z-10 bg-[radial-gradient(400px_200px_at_20%_30%,rgba(79,70,229,0.08),transparent_60%)]" data-parallax="0.2"></div>
...
<div className="group relative rounded-xl border p-5 ring-1 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg border-gray-200 bg-white ring-gray-100 hover:border-violet-300 before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-up" style={{animationDelay: '0.3s', animationPlayState: 'paused'}}>
...
<div className="mt-10 flex flex-wrap gap-4 text-sm text-gray-700 animate-fade-in-up" style={{animationDelay: '0.5s', animationPlayState: 'paused'}}>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.1s', animationPlayState: 'running'}}>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.2s', animationPlayState: 'running'}}>
<div className="pointer-events-none absolute -inset-[1px] rounded-2xl bg-gradient-to-r to-amber-700 from-violet-700 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
<div className="absolute -inset-6 rounded-2xl bg-gradient-to-r to-amber-600/20 from-violet-600/20 opacity-0 blur-2xl transition-all duration-500 group-hover:opacity-100"></div>
...
<div className="group relative rounded-2xl p-[1px] animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'running'}}>
<div className="pointer-events-none absolute -inset-[1px] rounded-2xl bg-gradient-to-r to-amber-700 from-violet-700 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
<div className="absolute -inset-6 rounded-2xl bg-gradient-to-r to-amber-600/20 from-violet-600/20 opacity-0 blur-2xl transition-all duration-500 group-hover:opacity-100"></div>
<div className="relative h-full rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 hover:shadow-violet-500/10">
<div className="mb-5 flex items-center justify-between">
...
<div className="mt-6 flex items-center gap-2 text-sm text-gray-700">
<svg className="lucide lucide-video size-4 text-violet-700" data-lucide="video" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"></path><rect className="" height="12" rx="2" width="14" x="2" y="6"></rect></svg>
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.1s', animationPlayState: 'running'}}>
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.2s', animationPlayState: 'running'}}>
<div className="flex items-center gap-4 relative z-10">
...
<article className="group relative min-w-[320px] snap-start overflow-hidden rounded-2xl border p-6 ring-1 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-gray-200 bg-white ring-gray-100 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-r before:to-amber-700 before:from-violet-700 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10 before:blur-xl animate-fade-in-left" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'running'}}>
<div className="flex items-center gap-4 relative z-10">
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.1s', animationPlayState: 'paused'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.2s', animationPlayState: 'paused'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.3s', animationPlayState: 'paused'}}>
...
<div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-white ring-1 ring-gray-100 animate-fade-in-up" data-parallax="0.03" style={{animationDelay: '0.4s', animationPlayState: 'paused'}}>
...
<div className="absolute inset-0 bg-[radial-gradient(ellipse_1000px_400px_at_50%_200px,rgba(139,69,19,0.15),transparent_70%),radial-gradient(ellipse_800px_300px_at_80%_-100px,rgba(79,70,229,0.1),transparent_70%)]" data-parallax="0.1"></div>
...
<p className="mx-auto mt-4 max-w-2xl text-gray-600 animate-fade-in-up" style={{animationDelay: '0.1s', animationPlayState: 'paused'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.3s', animationPlayState: 'paused'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.4s', animationPlayState: 'paused'}}>
...
<div className="aspect-video overflow-hidden rounded-lg border border-gray-200 animate-fade-in-up" data-parallax="0.05" style={{animationDelay: '0.5s', animationPlayState: 'paused'}}>

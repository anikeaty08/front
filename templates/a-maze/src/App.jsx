...
<img alt="A-MAZE Logo" className="w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bb4f2592-d1c7-4007-8941-5dfc41a72282_320w.png?w=800&amp;q=80"/>
</div>
...
<img alt="Slide 1" className="w-full h-full object-cover opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a76eb22a-d0ec-4dc5-be1c-cfa36d30c6e9_3840w.jpg"/>
</div>
...
<img alt="Slide 2" className="w-full h-full object-cover opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ad9c6f4f-8653-4984-aa0d-1ba10d74cb26_800w.jpg"/>
</div>
...
<img alt="Slide 3" className="w-full h-full object-cover opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b85f88f4-6bf5-4716-b20f-8c30c09f32aa_800w.jpg"/>
</div>
...
<img alt="Slide 4" className="transition ease-in-out opacity-90 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0e608d91-80b8-4208-bcb6-0a833e85a3c1_3840w.jpg"/>
</div>
...
<button className="absolute left-6 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white/20 hover:scale-105 z-30" onclick="prevSlide()">
<iconify-icon className="" icon="solar:alt-arrow-left-linear" width="24"></iconify-icon>
</button>
<button className="-translate-y-1/2 flex group-hover:opacity-100 transition-opacity hover:bg-white/20 hover:scale-105 z-30 text-white bg-white/10 opacity-0 w-12 h-12 border-white/20 border rounded-full absolute top-1/2 right-6 backdrop-blur-md items-center justify-center" onclick="nextSlide()">
...
<button className="hero-dot w-2 h-2 rounded-full transition-all shadow-sm" onclick="goToSlide(0)"></button>
<button className="hero-dot w-2 h-2 rounded-full hover:bg-white/80 transition-all shadow-sm" onclick="goToSlide(1)"></button>
<button className="hero-dot w-2 h-2 rounded-full hover:bg-white/80 transition-all shadow-sm" onclick="goToSlide(2)"></button>
<button className="hero-dot w-2 h-2 rounded-full hover:bg-white/80 transition-all shadow-sm" onclick="goToSlide(3)"></button>
</div>
</div>
</section>
...
<img alt="FII 8th Edition" className="transition-transform duration-700 group-hover:scale-105 opacity-90 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a76eb22a-d0ec-4dc5-be1c-cfa36d30c6e9_1600w.jpg"/>
...
<img alt="Red Sea Global Launch" className="transition-transform duration-700 group-hover:scale-105 opacity-90 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ad9c6f4f-8653-4984-aa0d-1ba10d74cb26_800w.jpg"/>
<div className="bg-gradient-to-t from-black/80 via-black/20 to-transparent absolute top-0 right-0 bottom-0 left-0">
</div>
...
<a className="group block relative rounded-2xl overflow-hidden bg-zinc-900 flex-1 min-h-[250px] lg:h-[288px] shadow-sm border border-black/5" href="#">
<img alt="Doha Tech Summit" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b85f88f4-6bf5-4716-b20f-8c30c09f32aa_800w.jpg"/>
...
<span className="text-zinc-900 font-medium group-hover:text-indigo-600 transition-colors text Murabba&lt;/span&gt; &lt;span class=" font-light="" text-xs="" text-zinc-400"="">Riyadh · Immersive Live Experience</span>
</div>
...
<iframe allow="autoplay; fullscreen; picture-in-picture;
        referrerpolicy=" className="" data-ready="true" frameborder="0" src="https://player.vimeo.com/video/1146567370?h=4856f182bb&amp;autopause=0&amp;player_id=0&amp;app_id=58479;title=0&amp;byline=0&amp;portrait=0" strict-origin-when-cross-origin"="" style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%'}}></iframe>
</div>
...
<div className="">
<span className="text-xs text-zinc-500 uppercase tracking-widest font Volume&lt;/span&gt; &lt;h3 class=" font-medium="" mt-1"="" text-xl="" text-zinc-900="" tracking-tight="">Completed vs Signed
        </span>
</div>
...
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="100" y1="100" y2="20"></line>
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="169.3" y1="100" y2="60"></line>
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="169.3" y1="100" y2="140"></line>
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="100" y1="100" y2="180"></line>
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="30.7" y1="100" y2="140"></line>
<line className="stroke-zinc-200" strokeWidth="1" x1="100" x2="30.7" y1="100" y2="60"></line>
...
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="middle" x="100" y="8">Creativity</text>
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="start" x="175" y="55">Skills</text>
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="start" x="175" y="145">Performance</text>
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="middle" x="100" y="195">Effectiveness</text>
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="end" x="25" y="145">Contribution</text>
<text className="text-[10px] fill-zinc-600 font-medium" text-anchor="end" x="25" y="55">Sales</text>
</svg>
</div>
</div>
</div>
...
<img alt="Executive Director" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f8ed1436-2945-43b6-ad61-6db6451870d9_800w.jpg?w=800&amp;q=80"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Lead Scenographer" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/17fe7386-8c1d-416d-9998-48202c6ad714_800w.jpg?w=800&amp;q=80"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Head of Strategy" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/41524233-fab6-482f-b80f-06690aabfd2f_800w.png?w=800&amp;q=80"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Technical Director" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de90f17a-7e49-44d9-9c7a-9bbb36b5872e_800w.jpg"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Art Director" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6ef5a611-be9b-43db-b854-87e86cd837aa_800w.jpg?w=800&amp;q=80"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Production Lead" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5a78fd5e-f225-4b49-8759-4bdd0e99db6a_800w.jpg"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Experience Designer" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8450ef0c-32f3-4fda-aee8-a18c27fcaa52_800w.png"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-xl overflow-hidden bg-zinc-100 mb-4 shadow-sm border border-black/5 relative">
<img alt="Head of Architecture" className="group-hover:grayscale-0 transition-all duration-500 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e9032ca2-f409-4d73-a3c5-b8eac12a6e4b_800w.jpg"/>
</div>
...
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ed9db8f1-6111-41c8-85a2-e981b7b1a7c3_320w.jpg"/>
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8e73a3ab-2eff-4d27-bee8-65f8dea70c24_320w.jpg?w=800&amp;q=80"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b9186a42-bafb-4981-b6e8-208312a3f98f_320w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/90580801-b9eb-4acd-b6c5-00c9b190fede_320w.jpg?w=800&amp;q=80"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/419ecd99-2e8b-4fae-ba1e-6b8a5ac99112_320w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 group-hover:opacity-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/486df25d-882d-4d1f-95a9-5b8528511cd6_320w.jpg"/>
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b2a1aa51-3069-4686-ac56-207179c18d11_320w.jpg"/>
<div className="bg-gradient-to-t from-black/60 to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<div className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer shadow-sm border border-black/5">
<div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-purple-800"></div>
<img alt="Collaborator" className="transition-opacity duration-300 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6c1acc9f-a5c7-4b2e-b0da-0ae2f549a75b_320w.jpg"/>
<div className="bg-gradient-to-t from-black/60 to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute bottom-0 left-0 right-0 p-2">
...
<img alt="A-MAZE Logo" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bb4f2592-d1c7-4007-8941-5dfc41a72282_800w.png"/>
</div>

...
<svg className="lucide lucide-phone w-5 h-5" data-lucide="phone" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path></svg>
...
<div className="flex items-center gap-3">
<svg className="lucide lucide-shield w-6 h-6 flex-shrink-0" data-lucide="shield" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path></svg>
...
<div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-md" style={{}}>
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-clock w-8 h-8 text-blue-800 flex-shrink-0" data-lucide="clock" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6v6l4 2"></path><circle cx="12" cy="12" r="10"></circle></svg>
</div>
...
<div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-md" style={{}}>
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-wrench w-8 h-8 text-blue-800 flex-shrink-0" data-lucide="wrench" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z"></path></svg>
</div>
...
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-droplet w-8 h-8 text-blue-800" data-lucide="droplet" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z"></path></svg>
</div>
...
<a className="inline-flex items-center gap-2 mt-4 text-blue-700 font-medium hover:text-blue-900" href="#contact">Book now
        <svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>

<div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-md">
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-flame w-8 h-8 text-blue-800" data-lucide="flame" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4"></path></svg>
</div>
...
<div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-md">
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-search w-8 h-8 text-blue-800" data-lucide="search" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m21 21-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></svg>
</div>
...
<div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-md">
<div className="flex items-center gap-3 mb-4">
<svg className="lucide lucide-phone w-8 h-8 text-blue-800" data-lucide="phone" data-lucide-strokeWidth="1.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path></svg>
</div>

...
<div className="w-8 h-8 bg-[#FFD026] rounded-lg flex items-center justify-center text-black">
<iconify-icon icon="solar:documents-minimalistic-linear" width="18"></iconify-icon>
</div>
<span className="text-lg font-bold tracking-tight group-hover:opacity-80 transition-opacity">MUTA 02</span>
</a>
...
<span className="">LINE ID SANTA2554</span>
...
<h1 className="md:text-7xl leading-[1.05] text-5xl font-semibold text-black tracking-tight mb-8">
                    Accounting, Tax &amp; more
                </h1>
...
<img alt="User" className="w-full h-full object-cover" src="default"/>
</div>
<div>
...
<section className="max-w-7xl mr-auto mb-24 ml-auto pr-6 pl-6" id="leadership">
...
<img alt="Wassana (Wasa)" className="object-[50%_35%] z-10 w-32 h-32 object-cover border-white border-4 rounded-full relative shadow-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f59d515e-6ebe-4f82-9d8a-31d37e60f030_800w.jpg"/>
</div>
<h3 className="text-xl font-bold mb-1 tracking-tight">Wassana (Wasa)</h3>
<p className="uppercase text-xs font-bold text-[#dcb00a] tracking-widest mb-6">Founder &amp; ceo</p>
<p className="leading-relaxed flex-grow text-sm text-neutral-500">Wassana (Wasa) has two decades of Accounting experience in leading companies in Thailand and started Muta 02 in 2020, the company is now the Top 3 Agencies in Pattaya and growing. She is a big Muay Thai fan.</p>
...
<div className="relative mb-6">
<div className="absolute inset-0 bg-[#FFD026] rounded-full blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500"></div>
<img alt="Rohan (Ronnie)" className="z-10 w-32 h-32 object-cover object-[50%_30%] border-white border-4 rounded-full relative shadow-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/fb8f02aa-a43f-478c-8767-017b653328b6_3840w.jpg"/>
</div>
<h3 className="text-xl font-bold mb-1 tracking-tight">Rohan (Ronnie)</h3>
<p className="uppercase text-xs font-bold text-[#dcb00a] tracking-widest mb-6">Partner &amp; cmo</p>
<p className="leading-relaxed flex-grow text-sm text-neutral-500">Rohan(Ronnie) heads the Marketing side of the business Virtually and spearheads Muta Designs, a new venture under Muta 02 focus specifically on Website Design &amp; Marketing. He has lived and worked in Dubai, Montreal, Bahrain and many other markets and worked for organizations like Burger King and Applebee's.</p>
<div className="mt-8 flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0">
<a className="text-neutral-400 hover:text-[#FFD026] transition-colors" href="#"><iconify-icon icon="solar:letter-linear" width="20"></iconify-icon></a>
<a className="text-neutral-400 hover:text-[#0077b5] transition-colors" href="#"><iconify-icon className="" icon="brandico:linkedin-rect" width="20"></iconify-icon></a>
</div>
</div>
</div>
</section>

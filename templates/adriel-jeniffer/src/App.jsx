...
<p className="reveal-up font-body text-xs uppercase tracking-[0.4em] text-stone-500 mb-6">Vamos nos Casar</p>
<div className="reveal-up" style={{transitionDelay: '100ms'}}>
<h1 className="md:text-8xl lg:text-9xl leading-[0.9] text-6xl text-stone-800 tracking-tight font-heading" style={{}}>Adriel <span className="font-thin text-stone-300 block md:inline md:text-7xl align-middle italic transform -translate-y-2">&amp;</span> Jeniffer</h1>
</div>
...
<span className="font-heading text-4xl md:text-5xl text-stone-800 block mb-2 transition-transform duration-500 group-hover:-translate-y-1" id="days">79</span>
<span className="text-[9px] uppercase tracking-[0.2em] text-stone-400 border-t border-stone-200 pt-2 block w-full">Dias</span>
</div>
<div className="text-center group cursor-default">
<span className="font-heading text-4xl md:text-5xl text-stone-800 block mb-2 transition-transform duration-500 group-hover:-translate-y-1" id="hours">05</span>
<span className="text-[9px] uppercase tracking-[0.2em] text-stone-400 border-t border-stone-200 pt-2 block w-full">Hrs</span>
</div>
<div className="text-center group cursor-default">
<span className="font-heading text-4xl md:text-5xl text-stone-800 block mb-2 transition-transform duration-500 group-hover:-translate-y-1" id="minutes">53</span>
<span className="text-[9px] uppercase tracking-[0.2em] text-stone-400 border-t border-stone-200 pt-2 block w-full">Min</span>
</div>
<div className="text-center group cursor-default">
<span className="font-heading text-4xl md:text-5xl text-stone-800 block mb-2 transition-transform duration-500 group-hover:-translate-y-1" id="seconds">49</span>
...
<iconify-icon icon="lucide:heart-handshake" width="14"></iconify-icon> Nossa História
                </div>
<h3 className="stagger-child font-heading text-4xl md:text-5xl text-stone-800 mb-8 leading-tight">
                    Um amor escrito <br/><span className="italic text-stone-400">no destino</span>
</h3>
<p className="stagger-child font-body text-stone-600 leading-8 font-light text-base mb-6 text-justify">
                    O que começou como uma coincidência se transformou na certeza mais bonita de nossas vidas. Cada dia juntos tem sido uma nova página cheia de risos, aprendizado e amor incondicional.
                </p>
<p className="stagger-child font-body text-stone-600 leading-8 font-light text-sm text-justify">
                    Hoje, com o coração cheio de gratidão, queremos dar o próximo passo cercados pelas pessoas que mais amamos. Sua presença é o fio que termina de tecer este momento perfeito.
                </p>
...
<section className="bg-stone-100/50 pt-32 pr-4 pb-32 pl-4 relative" id="evento">
...
<span className="text-[10px] uppercase tracking-[0.4em] text-stone-400 font-bold block mb-3">Celebração</span>
<h3 className="font-heading text-4xl text-stone-800">Detalhes do Dia</h3>
</div>
...
<span className="text-[10px] uppercase font-medium text-stone-600 tracking-wider bg-stone-200/50 rounded-full pt-1.5 pr-4 pb-1.5 pl-4" style={{}}>16:30 Hrs</span>
</div>
<h4 className="text-2xl text-stone-800 font-heading mb-2" style={{}}>Recepção</h4>
<p className="uppercase text-xs font-medium text-stone-400 tracking-widest font-body mb-8">Moinho do Vale - Blumenau SC</p>
<p className="font-body text-stone-600 text-sm leading-7 mb-10 font-light border-l-2 border-stone-200 pl-4">
                        Começaremos nossa união com uma cerimônia solene. Agradecemos a pontualidade para este momento sagrado.
                    </p>
<a className="inline-flex items-center gap-3 text-xs uppercase tracking-widest text-stone-800 hover:text-stone-500 transition-colors group-hover:pl-2 duration-300" href="#">
                        Ver Localização <iconify-icon icon="lucide:arrow-right" width="12"></iconify-icon>
</a>
</div>

<div className="glass-panel group hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-700 reveal-up pt-12 pr-12 pb-12 pl-12 relative" style={{transitionDelay: '150ms'}}>
<div className="absolute top-0 left-0 w-full h-1 bg-stone-200 origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700"></div>
<div className="flex justify-between items-start mb-10">
<div className="bg-white p-4 rounded-full text-stone-800 shadow-sm border border-stone-100">
...
<h4 className="text-2xl text-stone-800 font-heading mb-2">Recepção &amp; Festa</h4>
<p className="font-body text-xs text-stone-400 mb-8 uppercase tracking-widest font-medium">Hacienda Santa Cruz</p>
<p className="font-body text-stone-600 text-sm leading-7 mb-10 font-light border-l-2 border-stone-200 pl-4">
                        Continuaremos com um coquetel de boas-vindas nos jardins, seguido de jantar formal e dança sob as estrelas.
                    </p>
<a className="inline-flex items-center gap-3 text-xs uppercase tracking-widest text-stone-800 hover:text-stone-500 transition-colors group-hover:pl-2 duration-300" href="#">
                        Ver Localização <iconify-icon icon="lucide:arrow-right" width="12"></iconify-icon>
</a>
</div><div className="glass-panel group hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-700 reveal-up pt-12 pr-12 pb-12 pl-12 relative" style={{transitionDelay: '150ms'}}>
<div className="absolute top-0 left-0 w-full h-1 bg-stone-200 origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700"></div>
<div className="flex justify-between items-start mb-10">
<div className="bg-white p-4 rounded-full text-stone-800 shadow-sm border border-stone-100">
<iconify-icon icon="lucide:wine" width="24"></iconify-icon>
...
<h3 className="font-heading text-4xl text-stone-800 mb-3">Itinerário</h3>
...
<h4 className="font-heading text-xl text-stone-800">Cerimônia Religiosa</h4>
<p className="text-sm font-body text-stone-500 font-light mt-2">O momento do "Sim, aceito".</p>
</div>
</div>
...
<h4 className="font-heading text-xl text-stone-800">Coquetel de Boas-vindas</h4>
<p className="text-sm font-body text-stone-500 font-light mt-2">Música acústica e mixologia autoral.</p>
</div>
</div>
...
<h4 className="font-heading text-xl text-stone-800">Jantar Formal</h4>
<p className="text-sm font-body text-stone-500 font-light mt-2">Menu de 4 pratos.</p>
</div>
</div>
...
<h4 className="font-heading text-xl text-stone-800">Festa</h4>
<p className="text-sm font-body text-stone-500 font-light mt-2">Para celebrar a noite toda!</p>
</div>
</div>
</div>
</div>
...
<p className="font-heading text-lg font-light text-stone-500 mb-12 tracking-wide">Traje Social Completo • Formal</p>
...
<span className="text-[10px] uppercase tracking-wider text-stone-500 font-medium">Preto</span>
</div>
<div className="text-center w-24 stagger-child hover:-translate-y-2 transition-transform duration-300">
<div className="w-12 h-12 mx-auto rounded-full bg-[#1e293b] shadow-lg mb-4"></div>
<span className="text-[10px] uppercase tracking-wider text-stone-500 font-medium">Azul Noite</span>
</div>
<div className="text-center w-24 stagger-child hover:-translate-y-2 transition-transform duration-300">
...
<span className="text-[10px] uppercase tracking-wider text-stone-500 font-medium">Prata</span>
</div>
</div>
<p className="text-xs text-stone-400 uppercase tracking-widest max-w-lg mx-auto leading-6 italic">
                Reservamos a cor branca exclusivamente para a noiva.
            </p>
</div>
</section>
...
<div>
<span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 font-bold block mb-2">Estadia</span>
<h3 className="font-heading text-3xl text-stone-800">Sugestão de Hotel</h3>
</div>
...
<p className="text-sm text-stone-500 mb-8 font-light leading-7">
                        Desfrute de uma estadia inesquecível. Localizado a apenas 10 minutos do local da recepção. Inclui café da manhã buffet e transporte para o evento.
                    </p>
...
<div>
<span className="block text-[10px] uppercase text-stone-400 tracking-wider mb-1 font-bold">Reservas</span>
...
<h3 className="font-heading text-3xl uppercase tracking-widest text-stone-800 mb-10">Lista de Presentes</h3>
...
<p className="font-body text-stone-600 font-light text-sm leading-7">
                    O mais importante para nós é a sua presença. No entanto, se desejarem nos presentear, preparamos algumas opções:
                </p>
...
<span className="z-10 relative font-medium">Transferência</span>
<span className="text-[9px] text-stone-400 z-10">Ver Dados</span>
</a>
</div>
</div>
</div>
...
<p className="font-body text-xs uppercase tracking-widest text-stone-400 mt-4 font-medium">Favor confirmar antes de 1º de Março</p>
</div>
<form className="space-y-8">
<div className="space-y-3 group">
<label className="text-[10px] uppercase tracking-widest text-stone-500 font-bold group-focus-within:text-stone-800 transition-colors">Nome Completo</label>
<input className="w-full bg-stone-50 border-b border-stone-200 p-3 text-stone-800 focus:outline-none focus:border-stone-800 focus:bg-transparent transition-all font-body text-sm placeholder-stone-400/50" placeholder="Ex. João Silva" type="text"/>
</div>
<div className="space-y-3">
<label className="text-[10px] uppercase tracking-widest text-stone-500 font-bold">Presença</label>
...
<span className="text-sm text-stone-600 group-hover:text-stone-900 z-10">Sim, irei</span>
</label>
...
<span className="text-sm text-stone-600 group-hover:text-stone-900">Não poderei</span>
</label>
</div>
</div>
<div className="space-y-3 group">
<label className="text-[10px] uppercase tracking-widest text-stone-500 font-bold group-focus-within:text-stone-800 transition-colors">Mensagem (Opcional)</label>
<textarea className="w-full bg-stone-50 border-b border-stone-200 p-3 text-stone-800 focus:outline-none focus:border-stone-800 focus:bg-transparent transition-all font-body text-sm placeholder-stone-400/50 resize-none" placeholder="Restrições alimentares..." rows="2"></textarea>
</div>
...
<a className="hover:text-stone-900 transition-colors" href="#">Início</a>
<a className="hover:text-stone-900 transition-colors" href="#">Localização</a>
<a className="hover:text-stone-900 transition-colors" href="#">Contato</a>
</div>

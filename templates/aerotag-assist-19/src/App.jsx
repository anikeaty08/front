...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      function i18nApply() {
        ...
        // Placeholders that need translation
      ...
      function setActiveTab(tab) {
        $$('#home, #orders, #orderDetails').forEach(s => s.classList.add('hidden'));
      ...
      function openOrderDetails(orderId, fromScreen = 'home') {
        ...
        renderOrderDetails();
        $$('#home, #orders').forEach(s => s.classList.add('hidden'));
      ...
      function bindInteractions() {
        ...
        $('#orderDetails').addEventListener('click', (e) => {
          ...
          if (action === 'delivered' && active) {
            ...
            renderHome();
            renderOrders($$('#ordersFilter button.bg-black')[0]?.dataset.filter || 'All');
            // Keep details open but show updated status (may no longer be active)
            renderOrderDetails();
            showToast('order_delivered');
          }
...
<path d="M26 40c2-6 6-10 -10 4 0 8 4 10 10" fill="none" stroke="#fff" strokeLinecap="round" strokeWidth="3"></path>
...
<svg className="w-14 h-14" viewbox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
<path d="M12 48c4-10 12-16 20-16s16 6 20 16" fill="none" stroke="#fff" strokeLinecap="round" strokeWidth="3"></path>
...
<div className="mx-auto max-w-sm grid grid-cols-2">

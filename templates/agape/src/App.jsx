...
<img alt="Meditation Teacher" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="https://res.cloudinary.com/dgcc9xqvi/image/upload/v1769154676/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA_%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0_2026-01-23_%D0%B2_2.43.46_PM_n9wbf0.png"/>
</div>
...
<section className="relative py-24 lg:py-32 overflow-hidden z-10 bg-transparent" id="space">
...
<div className="absolute bottom-0 left-0 w-full p-8 md:p-12 bg-gradient-to-t from-black/60 to-transparent">
<span className="text-white/80 text-xs font-bold uppercase tracking-widest mb-2 block">Manifesto</span>
<h3 className="text-white text-2xl md:text-3xl font-bold tracking-tight">Welcome to the Sanctuary</h3>
</div>
</div>
</section>
...
<div className="snap-start shrink-0 w-[300px] md:w-[340px] rounded-3xl sun-card-bg overflow-hidden group cursor-pointer hover:shadow-gold-aura transition-all duration-300 relative flex flex-col">
...
<img alt="Breathwork" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
...
<img alt="Focus" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1528756514091-c447d2d2a912?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-4 left-4 right-4 text-white">
...
<div className="flex items-center gap-1 text-slate-400 text-xs">
<iconify-icon icon="solar:users-group-rounded-linear"></iconify-icon> 212
                            </div>
</div>
<div className="space-y-1.5">
<div className="flex justify-between text-[10px] font-bold uppercase text-slate-400 tracking-wider">
...
<img alt="Loving Kindness" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1519834785169-98be25ec3f84?q=80&amp;w=400&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-4 left-4 right-4 text-white">
...
<div className="flex items-center gap-4">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover grayscale group-hover:grayscale-0 transition-all duration-300" src="https://images.unsplash.com/photo-1528756514091-c447d2d2a912?q=80&amp;w=100&amp;auto=format&amp;fit=crop"/>
<div>

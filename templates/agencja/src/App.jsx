...
<h1 className="max-w-xl text-5xl font-medium uppercase tracking-tight text-white sm:text-6xl lg:text-7xl xl:text-[5.35rem] xl:leading-[0.95]">
<span className="line-animate-1 block">SKALUJ FIRMĘ</span>
<span className="line-animate-2 block">
...
<p className="paragraph-animate mt-7 text-base leading-8 text-slate-300 sm:text-lg max-w-xl">
            Kompletny program mentoringowy dla firm, które chcą pozyskiwać
            więcej leadów i sprzedaży wdrażając automatyzację i technologię AI
          </p>
...
<div>
<p className="text-2xl font-medium tracking-tight text-white">120+</p>
...
<div className="">
<p className="text-2xl font-medium tracking-tight text-white">38%</p>
<p className="mt-1 text-xs font-medium uppercase tracking-[0.18em] text-slate-500">
                Avg. lift
              </p>
</div>
...
<div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.12)_0%,transparent_46%)]"></div>
...
<span className="text-slate-500 text-sm mt-1 font-light">
                    Optimized seamlessly for every device.
                  </span>
</div>
</li>
<li className="flex items-center gap-5">
...
<div className="absolute -top-[30%] -left-[10%] w-[60%] h-[60%] bg-violet-600/10 rounded-full blur-[120px] mix-blend-screen transition-transform duration-1000 group-hover/section:translate-x-10 group-hover/section:translate-y-10"></div>
<div className="absolute bottom-[0%] -right-[10%] w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[120px] mix-blend-screen transition-transform duration-1000 group-hover/section:-translate-x-10 group-hover/section:-translate-y-10"></div>
</div>
...
<div className="absolute top-1/2 left-[10%] w-[80%] h-px bg-gradient-to-r from-transparent via-white/10 to-transparent hidden md:block -rotate-12 z-0 pointer-events-none"></div>
...
<div className="absolute inset-0 bg-gradient-to-b from-fuchsia-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<span className="absolute -bottom-4 -right-4 text-[10rem] font-bold text-white/[0.02] transition-all duration-700 group-hover:text-white/[0.04] group-hover:-translate-y-4 group-hover:-translate-x-2 leading-none select-none pointer-events-none">
                  3
                </span>
<div className="relative z-10">
...
<div className="absolute -left-[10%] top-1/2 -translate-y-1/2 w-[50rem] h-[50rem] bg-violet-600/10 rounded-full blur-[120px] mix-blend-screen"></div>
<div className="absolute -right-[10%] top-1/2 -translate-y-1/2 w-[50rem] h-[50rem] bg-fuchsia-600/10 rounded-full blur-[120px] mix-blend-screen"></div>
</div>
...
<div className="absolute top-[12%] left-1/2 h-[30rem] w-[30rem] -translate-x-1/2 rounded-full bg-violet-500/[0.08] blur-[140px]"></div>
</div>
...
<div className="absolute -top-20 -left-20 w-56 h-56 bg-violet-500 rounded-full blur-[85px] opacity-[0.13] group-hover/card:opacity-[0.22] transition-opacity duration-700"></div>
</div>
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "Nexora translated a messy product story into a site
                    customers understood immediately. Our demo requests doubled
                    within weeks."
                  </p>
</div>
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "The process was crisp, collaborative, and fast. We launched
                    a premium brand without slowing our product roadmap."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "Their growth system gave us the confidence to ship
                    campaigns, measure impact, and keep improving every month."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "If you want something safe, go elsewhere. If you want
                    something unforgettable, follow the brief and trust their
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "The architecture was pristine. We scaled to 100k users
                    without a single hiccup in performance or latency."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "Their design system unified our entire product suite.
                    Development speed increased by 40% in just two months."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "Finally, an engineering partner that understands business
                    metrics. Our conversion rate jumped significantly."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<p className="text-slate-300 text-sm md:text-base leading-relaxed font-light">
                    "From concept to deployment, the workflow was incredibly
                    transparent. A masterclass in modern digital execution."
                  </p>
</div>
<div className="flex items-center justify-between w-full mt-8">
<div className="flex items-center gap-3">
...
<div className="max-w-[90%] mx-auto h-[1px] bg-gradient-to-r from-transparent via-violet-500/35 to-transparent"></div>
</div>
...
<div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(139,92,246,0.15)_1px,transparent_1px),linear-gradient(to_bottom,rgba(139,92,246,0.15)_1px,transparent_1px)] bg-[size:50px_50px]"></div>
<div className="absolute left-1/2 top-0 -translate-x-1/2 w-[800px] h-[800px] bg-blue-500/10 blur-[150px] rounded-full"></div>
</div>
...
<div className="absolute -top-[100px] -left-[100px] w-[250px] h-[250px] rounded-full bg-fuchsia-500/10 blur-[70px] group-hover:bg-fuchsia-500/20 transition-colors duration-700"></div>
<div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-[2.5rem] pointer-events-none"></div>
...
<p className="text-[0.65rem] font-medium uppercase tracking-[0.25em] text-fuchsia-300/80 mb-6">
                  Includes
                </p>
...
<div className="absolute -top-[150px] -right-[150px] w-[350px] h-[350px] rounded-full bg-blue-500/15 blur-[90px] group-hover:bg-blue-500/25 transition-colors duration-700"></div>
<div className="absolute bottom-0 left-0 w-[250px] h-[250px] rounded-full bg-cyan-500/10 blur-[80px] group-hover:bg-cyan-500/20 transition-colors duration-700"></div>
<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(96,165,250,0.1),transparent_60%)] pointer-events-none"></div>
<div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-[2.5rem] pointer-events-none"></div>
<div className="flex flex-col h-full relative z-10">
...
<div className="mb-10">
<span className="text-6xl font-medium tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-blue-200 drop-shadow-sm">
                  $9.5k
                </span>
</div>
<div className="flex-1 mt-auto">
<p className="text-[0.65rem] font-medium uppercase tracking-[0.25em] text-blue-300/90 mb-6">
                  Core System
                </p>
...
<div className="absolute -bottom-[100px] -right-[100px] w-[250px] h-[250px] rounded-full bg-slate-400/10 blur-[70px] group-hover:bg-slate-400/20 transition-colors duration-700"></div>
<div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-[2.5rem] pointer-events-none"></div>
<div className="flex flex-col h-full relative z-10">
<div className="mb-6 border-b border-white/5 pb-6">
<h3 className="text-2xl font-medium tracking-tight text-white">
...
<div className="flex-1 mt-auto">
<p className="text-[0.65rem] font-medium uppercase tracking-[0.25em] text-slate-400/80 mb-6">
                  Includes
                </p>
...
<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(96,165,250,0.13)_0%,rgba(139,92,246,0.08)_34%,transparent_68%)]"></div>
<div className="pointer-events-none absolute left-1/2 top-1/2 h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/10 blur-[110px]"></div>
<div className="pointer-events-none absolute bottom-[-8rem] left-1/2 h-[18rem] w-[42rem] -translate-x-1/2 rounded-full bg-violet-500/10 blur-[100px]"></div>
...
<div className="pointer-events-none absolute left-1/2 top-0 h-80 w-[40rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/15 blur-[5rem]"></div>
<div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-white/[0.035] to-transparent"></div>

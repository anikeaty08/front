...
<section className="min-h-screen flex flex-col overflow-hidden w-full pt-6 pb-20 relative gap-x-8 gap-y-8 items-center justify-start">

<div className="aura-background-component -z-10 pointer-events-none w-full h-[1000px] absolute top-0 gap-x-8 gap-y-8" data-alpha-mask="80" style={{maskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)'}}>

<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/40 via-zinc-950/0 to-zinc-950/0 opacity-70">
</div>
<div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-blue-500/10 blur-[120px] rounded-full mix-blend-screen">
</div>
</div>

<nav className="flex z-50 md:mb-24 [animation:animationIn_0.8s_ease-out_0.1s_both] w-full max-w-6xl mb-24 pr-6 pl-6 gap-x-8 gap-y-8 items-center justify-between">
<div className="flex gap-2 group cursor-pointer gap-x-2 gap-y-2 items-center">

<svg aria-label="agenticflows logo" className="w-[250px] h-[42px]" data-icon-replaced="true" height="120" role="img" strokeWidth="2" style={{width: '250px', height: '42px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 420 120" width="420" xmlns="http://www.w3.org/2000/svg">
<text className="" fill="currentColor" fontFamily="Questrial, Inter, SF Pro Display, system-ui, -apple-system, BlinkMacSystemFont, sans-serif" fontSize="72" font-weight="600" letter-spacing="-1.5" x="0" y="80">
      agenticflows
    </text>
</svg>
...
<div className="hidden md:flex gap-8 text-sm font-medium text-zinc-400 gap-x-8 gap-y-8 items-center">
<a className="hover:text-white transition-colors font-geist" href="/#features">Features</a>
<a className="hover:text-white transition-colors font-geist" href="#customers">Customers</a>
<a className="hover:text-white transition-colors font-geist" href="/#pricing">Pricing</a>
<a className="hover:text-white transition-colors font-geist" href="#docs">Docs</a>
</div>
<div className="">
...
<div className="flex flex-col [animation:animationIn_0.8s_ease-out_0.3s_both] text-center w-full max-w-7xl z-10 pr-4 pl-4 gap-x-8 gap-y-8 items-center">
...
<p className="md:text-xl leading-relaxed text-lg font-light text-zinc-400 tracking-tight font-geist max-w-2xl mb-10">In today’s competitive digital landscape, businesses that automate win faster. AI Automation reduces operational costs, increases productivity, and creates seamless customer experiences</p>

<div className="flex flex-col sm:flex-row gap-4 mb-20 gap-x-2 gap-y-2 items-center">

<button className="hover:brightness-110 transition-all flex cursor-pointer text-sm font-medium text-white bg-white border-transparent border rounded-full pt-3 pr-6 pb-3 pl-6 shadow-[0_0_20px_rgba(59,130,246,0.5)] gap-x-2 gap-y-2 items-center" onclick="window.location.href='/demo'" role="button" style={{background: 'linear-gradient(135deg, #2563eb 0%, #3b82f6 50%, #60a5fa 100%)'}}>
...
<span className="z-10 flex items-center justify-center transition-all duration-300 ease-in-out transform -translate-y-8 group-hover:translate-y-0 group-hover:opacity-100 group-hover:blur-none text-sm font-medium font-geist opacity-0 absolute top-0 right-0 bottom-0 left-0">View Documentation</span>
</button>
</div>

<div className="group [animation:animationIn_0.8s_ease-out_0.5s_both] w-full relative">

<div className="flex lg:pl-0 lg:pr-0 font-geist w-full h-[800px] pt-4 pr-4 pb-4 pl-4 relative items-center justify-center cursor-pointer" onclick="window.location.href='/demo'" role="button">
...
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16"><path d="m15 18-6-6 6-6"></path></svg>
</button>
<button className="text-zinc-500 hover:text-zinc-200 transition">
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16"><path d="m9 18 6-6-6-6"></path></svg>
</button>
</div>
</div>
...
<path className="" d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" x2="12" y1="2" y2="15"></line>
</svg>
</button>
<button className="w-9 h-9 inline-flex items-center justify-center rounded-md hover:bg-white/5 hover:text-white transition border border-transparent hover:border-white/10">
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16">
...
<svg className="text-zinc-500" fill="none" height="14" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="14">
...
<div className="px-3 py-2">
<div className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest px-3 mb-2">Automation
              </div>
<nav className="space-y-0.5">
...
<svg fill="none" height="14" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="14"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg>
</button>
</div>
</div>
</div>
...
<svg fill="none" height="16" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="16"><path d="m15 18-6-6 6-6"></path></svg>
</button>
...
<path className="" d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
<circle className="" cx="8.5" cy="7" r="4"></circle>
...
<svg fill="none" height="14" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="14"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
</button>
</div>
...
<div className="text-xs text-zinc-200 truncate">Welcome to Nexus — let’s automate your onboarding
                    </div>
</div>
...
<div className="text-xs text-zinc-400">
                    Apply:
                    <span className="text-sky-200 bg-sky-500/10 border border-sky-500/20 px-1.5 py-0.5 rounded-md">Onboarded</span>
</div>
</div>
<div className="absolute -left-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-white/60 rounded-full border-4 border-[#050507]">
</div>
...
<svg className="text-white/60 group-hover/node:text-blue-400 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="text-zinc-400" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
</div>
<div className="w-5 h-5 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center">
<svg className="text-zinc-400" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="1.5" width="3" x="13" y="2"></rect><path d="M19 8.5V10h1.5A1.5 1.5 0 1 0 19 8.5"></path><rect height="8" rx="1.5" width="3" x="8" y="14"></rect><path d="M5 15.5V14H3.5A1.5 1.5 0 1 0 5 15.5"></path><rect height="3" rx="1.5" width="8" x="14" y="13"></rect><path d="M15.5 19H14v1.5a1.5 1.5 0 1 0 1.5-1.5"></path><rect height="3" rx="1.5" width="8" x="2" y="8"></rect><path d="M8.5 5H10V3.5A1.5 1.5 0 1 0 8.5 5"></path></svg>
</div>
</div>
</div>
...
<svg className="text-blue-400 drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<svg className="text-white/60 group-hover/node:text-purple-400 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<rect height="8" rx="1.5" width="3" x="13" y="2"></rect><path d="M19 8.5V10h1.5A1.5 1.5 0 1 0 19 8.5"></path><rect height="8" rx="1.5" width="3" x="8" y="14"></rect><path d="M5 15.5V14H3.5A1.5 1.5 0 1 0 5 15.5"></path><rect height="3" rx="1.5" width="8" x="14" y="13"></rect><path d="M15.5 19H14v1.5a1.5 1.5 0 1 0 1.5-1.5"></path><rect height="3" rx="1.5" width="8" x="2" y="8"></rect><path d="M8.5 5H10V3.5A1.5 1.5 0 1 0 8.5 5"></path>
</svg>
</div>
...
<svg className="text-white/60 group-hover/node:text-white transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="text-white/60 group-hover/node:text-red-400 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="text-white/60 group-hover/node:text-cyan-400 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="absolute inset-2 rounded-full border-t-2 border-t-blue-500/80 border-l-0 border-r-0 border-b-0"></div>
<div className="absolute inset-10 rounded-full border border-zinc-800"></div>
<div className="absolute inset-10 rounded-full border-t-2 border-t-cyan-400/80 border-l-0 border-r-0 border-b-0"></div>
...
<svg aria-hidden="true" className="lucide lucide-cpu w-6 h-6 text-white" data-lucide="cpu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 20v2"></path><path d="M12 2v2"></path><path d="M17 20v2"></path><path d="M17 2v2"></path><path d="M2 12h2"></path><path d="M2 17h2"></path><path d="M2 7h2"></path><path d="M20 12h2"></path><path d="M20 17h2"></path><path d="M20 7h2"></path><path d="M7 20v2"></path><path d="M7 2v2"></path><rect height="16" rx="2" width="16" x="4" y="4"></rect><rect height="8" rx="1" width="8" x="8" y="8"></rect></svg>
</div>
...
<svg aria-hidden="true" className="lucide lucide-code w-3 h-3 text-zinc-400" data-lucide="code" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 18 6-6-6-6"></path><path d="m8 6-6 6 6 6"></path></svg>
</div>
</div>
</div>
</div>
...
<div className="stack-card sticky top-28 overflow-hidden group bg-[#02050e] w-full border-white/10 border rounded-[32px] relative transition-all duration-75 ease-linear origin-top" data-card-index="0" style={{filter: 'brightness(100%)'}}>
...
<svg className="text-zinc-300 group-hover:text-blue-400 transition-colors" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
...
<div className="stack-card sticky top-32 overflow-hidden group bg-[#02050e] w-full border-white/10 border rounded-[32px] relative transition-all duration-75 ease-linear origin-top" data-card-index="1" style={{filter: 'brightness(100%)'}}>
<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-blue-900/25 via-transparent to-transparent pointer-events-none"></div>
...
<div className="stack-card sticky top-36 overflow-hidden group bg-[#02050e] w-full border-white/10 border rounded-[32px] relative transition-all duration-75 ease-linear origin-top" data-card-index="2" style={{filter: 'brightness(100%)'}}>
<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-blue-900/25 via-transparent to-transparent pointer-events-none"></div>
...
<div className="">
<svg aria-hidden="true" className="lucide lucide-quote w-8 h-8 text-zinc-700 fill-current mb-6" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path></svg>
...
<div className="">
<svg aria-hidden="true" className="lucide lucide-quote w-8 h-8 text-blue-500/50 fill-current mb-6" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path></svg>
...
<button className="billing-tab px-4 py-2 rounded-lg text-xs font-semibold uppercase tracking-wide bg-zinc-800 text-white shadow-sm ring-1 ring-white/10 transition-all font-geist" data-billing="monthly">Monthly</button>
<button className="billing-tab px-4 py-2 rounded-lg text-xs font-semibold uppercase tracking-wide text-zinc-500 hover:text-white transition-all font-geist" data-billing="annual">Yearly</button>
</div>
<span className="text-xs text-blue-400 font-medium tracking-tight font-geist">Save 20% on yearly</span>
</div>

<div className="space-y-3">
<button className="plan-select-btn w-full text-left p-5 rounded-xl border border-blue-500/50 bg-blue-500/10 transition-all flex items-center justify-between group" data-plan-select="starter">
<div className="">
...
<button className="plan-select-btn w-full text-left p-5 rounded-xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.05] transition-all flex items-center justify-between group" data-plan-select="pro">
<div className="">
...
<button className="plan-select-btn w-full text-left p-5 rounded-xl border border-white/5 hover:border-white/10 bg-white/[0.02] hover:bg-white/[0.05] transition-all flex items-center justify-between group" data-plan-select="enterprise">
<div className="">
...
<div className="md:p-12 lg:border-l flex flex-col border-white/5 pt-8 pr-8 pb-8 pl-8 justify-center cursor-pointer" onclick="window.location.href='/#pricing'" role="button">
<div className="space-y-8" id="plan-details">
<div className="">
<h3 className="text-2xl text-white tracking-tight font-geist mb-2" id="planName">Starter</h3>
<div className="flex items-baseline gap-1">
<span className="text-6xl text-white font-geist tracking-tight" id="planPrice">$0</span>
<span className="text-zinc-500 text-lg font-geist" id="planPeriod">/mo</span>
</div>
<p className="text-zinc-400 text-sm mt-4 font-geist" id="planDesc">Perfect for exploring Loopra
                        capabilities.</p>
</div>
<ul className="space-y-4" id="featureList">
<li className="flex items-center gap-3 text-sm text-zinc-300">
<div className="w-5 h-5 rounded-full bg-blue-500/20 flex items-center justify-center shrink-0">
<svg fill="none" height="12" stroke="#60a5fa" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewbox="0 0 24 24" width="12">
...
<a className="w-full flex items-center justify-center py-4 text-center rounded-xl text-white font-medium tracking-tight hover:brightness-110 transition-all border border-transparent shadow-[0_0_20px_rgba(59,130,246,0.5)] font-geist" href="#" id="ctaBtn" style={{background: 'linear-gradient(135deg, #2563eb 0%, #3b82f6 50%, #60a5fa 100%)'}}>Get Started Free</a>
</div>
</div>
</div>
</div>
...
<div className="">
<svg aria-label="Looper logo" className="w-[147px] h-[42px]" data-icon-replaced="true" height="120" role="img" strokeWidth="2" style={{width: '147px', height: '42px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 420 120" width="420" xmlns="http://www.w3.org/2000/svg">
<text className="" fill="currentColor" fontFamily="Inter, SF Pro Display, system-ui, -apple-system, BlinkMacSystemFont, sans-serif" fontSize="72" font-weight="600" letter-spacing="-1.5" x="0" y="80">
    Looper
  </text>
</svg>
...
<input className="bg-zinc-950 border border-white/10 rounded-full px-4 py-2.5 text-sm text-white w-full focus:outline-none focus:border-blue-500/50 transition" placeholder="Enter your email" type="email"/>
...
<li className=""><a className="hover:text-blue-400 transition font-geist" href="#">Features</a></li>
<li className=""><a className="hover:text-blue-400 transition font-geist" href="#">Integrations</a></li>
<li className=""><a className="hover:text-blue-400 transition font-geist" href="#">Pricing</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">Changelog</a></li>
</ul>
</div>
<div className="">
<h4 className="text-white font-medium mb-4 font-geist">Company</h4>
<ul className="space-y-2 text-sm text-zinc-500">
<li><a className="hover:text-blue-400 transition font-geist" href="#">About</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">Blog</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">Careers</a></li>
<li className=""><a className="hover:text-blue-400 transition font-geist" href="#">Contact</a></li>
</ul>
</div>
<div>
<h4 className="text-white font-medium mb-4 font-geist">Social</h4>
<ul className="space-y-2 text-sm text-zinc-500">
<li><a className="hover:text-blue-400 transition font-geist" href="#">Twitter</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">GitHub</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">Discord</a></li>
<li><a className="hover:text-blue-400 transition font-geist" href="#">LinkedIn</a></li>
</ul>
</div>
</div>
</div>
...
<a className="hover:text-zinc-400 transition font-geist" href="#">Privacy Policy</a>
<a className="hover:text-zinc-400 transition font-geist" href="#">Terms of Service</a>
</div>
</div>
</div>
</footer>

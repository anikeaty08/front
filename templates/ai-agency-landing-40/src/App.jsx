...
<span className="text-lg font-semibold tracking-tight text-white">Bezaleel<span className="text-[#D4AF37]">.</span></span>
</a>
...
<div className="mb-8 flex items-center gap-2 animate-on-scroll">
...
<span className="text-xs font-medium tracking-wide text-neutral-200 uppercase">AI Powered Agency</span>
</div>
</div>
</div>
<h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-white leading-[1.1] mb-6 animate-on-scroll" style={{transitionDelay: '100ms'}}>
                    Constructing<br/>
<span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-neutral-400">Digital Intelligence</span><br/>
<span className="text-[#D4AF37] animate-gold-glow">For Future.</span>
</h1>
<p className="text-lg text-neutral-400 font-light leading-relaxed max-w-lg mb-10 animate-on-scroll" style={{transitionDelay: '200ms'}}>
                    We fuse cutting-edge AI integration with premium web &amp; mobile development. Elevate your business with autonomous systems.
                </p>
<div className="flex flex-wrap items-center gap-6 animate-on-scroll" style={{transitionDelay: '300ms'}}>
<button className="shiny-cta h-[56px] px-8">
...
<div className="absolute bottom-0 left-0 w-full border-t border-white/10 bg-black/60 backdrop-blur-md pt-5 pb-5 z-20 flex flex-col justify-center">
...
<p className="text-neutral-400 text-sm leading-relaxed font-[Inter]">
                        We ardently strive to engineer the future of digital intelligence, weaving a tapestry of complex algorithms and a hint of enchanting magic with the timeless essence of human experience.
                    </p>
</div>
...
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[0ms] text-white">Intelligence</span>
...
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[150ms] text-neutral-500">driven</span>
...
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[300ms] text-neutral-500">a</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[375ms] text-white">deep</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[450ms] text-white">passion</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[525ms] text-neutral-500">for</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[600ms] text-white">crafting</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[675ms] text-white">autonomous</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[750ms] text-white">systems</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[825ms] text-neutral-500">that</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[900ms] text-white">define</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[975ms] text-white">future</span>
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[1050ms] text-white">possibilities</span>
...
<span className="inline-block opacity-0 blur-[4px] translate-y-4 group-[.animate]:opacity-100 group-[.animate]:blur-0 group-[.animate]:translate-y-0 transition-all duration-700 ease-out delay-[1275ms] text-neutral-500">and</span>
...
<div className="w-full flex justify-center items-center py-20 md:py-32 relative animate-on-scroll">
...
<h4 className="text-white font-semibold mb-6 text-lg font-[Space_Grotesk]">Bezaleel - San Francisco</h4>
<p className="text-neutral-500 text-sm leading-relaxed font-light">401 Market St, 24th Floor,Orchard View, CA 94105,United States</p>
</div>

<div className="p-10 md:p-16 flex flex-col justify-between min-h-[400px] animate-on-scroll" style={{transitionDelay: '300ms'}}>
<div className="self-end mb-12">
<div className="w-12 h-12 border border-[#D4AF37] rounded-xl flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37]/10 transition-colors cursor-pointer">
<svg className="lucide lucide-atom w-6 h-6" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><path d="M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z"></path><path d="M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z"></path></svg>
</div>
</div>
<div>
<h4 className="text-white font-semibold mb-6 text-lg font-[Space_Grotesk]">Bezaleel - Singapore</h4>
<p className="text-neutral-500 text-sm leading-relaxed mb-8 font-light">27 Eden Walk Eden Centre,Orchard View, Singapore</p>
<p className="text-white font-medium mb-1 tracking-tight">+1 (555) 123-8901</p>
<a className="text-neutral-400 text-sm hover:text-[#D4AF37] transition-colors underline decoration-neutral-800 underline-offset-4 decoration-1" href="mailto:info@bezaleel.ai">info@bezaleel.ai</a>
</div>
</div>
</div>
</section>

...
<p className="text-neutral-400 max-w-xl">I don't just "use AI". I architect robust infrastructure that handles communication and data processing for you.</p>
</div>
...
<img alt="Ankush Mehra" className="w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b1215c84-a614-448d-9358-8d4515451e7d_800w.png"/>
</div>
</div>
...
<p className="text-neutral-400 leading-relaxed">
                            I am a developer focused on  and . My background in software engineering means I build automation infrastructures that scale with your business, handle errors gracefully, and actually deliver the time-savings promised.
                        </p>

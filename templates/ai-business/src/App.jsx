...
<div className="fade-in-blur delay-100 flex h-16 items-center justify-between rounded-b-xl bg-black/60 backdrop-blur border border-white/5 px-3 sm:px-4">
...
<span className="flex items-center justify-center gap-2 text-[15px] leading-none min-w-[140px] transition-colors duration-300 group-hover:bg-black/50 font-medium bg-black/80 w-full h-full rounded-lg pt-3 pr-5 pb-3 pl-5" id="aura-emfvc2gfm">
<span className="cursor-pointer" id="aura-emfvc2d7p" onclick="window.location.href='/sign up'" role="button">Get Started</span>
...
<div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 pb-16 sm:pb-24 text-center">
...
<span className="text-[12px] font-medium text-white/80">AI-Powered Business Automation</span>
</div>

<h1 className="fade-in-up delay-300 mx-auto max-w-4xl text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-tight">
            Transform Your Business with Smart AI Automation
          </h1>

<p className="fade-in-up delay-400 mt-5 max-w-2xl mx-auto text-base sm:text-lg text-white/70">
            We build intelligent systems that streamline operations, boost productivity, and drive growth for modern enterprises.
          </p>

<div className="fade-in-up delay-500 mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
...
<a className="sm:w-auto inline-flex items-center gap-2 ring-inset hover:bg-white/5 transition ring-white/15 ring-1 text-sm font-medium text-white/90 bg-[#ffffff]/30 w-full rounded-lg pt-3 pr-6 pb-3 pl-6 backdrop-blur-3xl" href="#services">
              Watch Demo
...
<section className="relative z-10 py-12 sm:py-20 fade-in-up delay-600">
...
<section className="relative z-10 py-12 sm:py-20 max-w-7xl mr-auto ml-auto px-4 sm:px-6 lg:px-8">
...
<h2 className="mt-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight">AI-Powered Solutions That Scale Your Business</h2>
...
<div className="grid gap-8 lg:gap-16 md:grid-cols-2 items-center mb-16 sm:mb-24">

<div className="fade-in-left delay-200 relative order-2 md:order-1">
<div className="ring-inset p-4 sm:p-6 bg-[#000000]/5 ring-white/10 ring-1 rounded-2xl">
...
<div>
<div className="text-sm font-medium text-white/90">Invoice processing</div>
<div className="text-[11px] text-white/50">Automated approval sent</div>
</div>
</div>
<span className="inline-flex h-6 w-6 items-center justify-center rounded-md bg-white/5 ring-1 ring-inset ring-white/10">
...
<h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight">Eliminate Manual Work Forever</h3>
<p className="mt-3 text-sm sm:text-base lg:text-lg text-white/70">Transform repetitive tasks into intelligent workflows. Our AI handles everything from data entry to complex approval chains, reducing errors by 95% and saving 20+ hours per week.</p>
...
<h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight">Your 24/7 Business Intelligence</h3>
...
<h2 className="mt-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight">How We Transform Your Business in 4 Steps</h2>
...
<h2 className="mt-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight">Real Results from Real Businesses</h2>
...
<img alt="Advanced quantum computing setup" className="w-full h-full object-cover rounded-2xl pt-4 pr-4 pb-4 pl-4 saturate-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/988b7631-f2b3-46c9-af7d-b03d473ee2a7_1600w.jpg"/>
</div>
...
<img alt="Modern business automation dashboard" className="w-full h-full object-cover rounded-2xl pt-4 pr-4 pb-4 pl-4" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d7050fd5-9b66-45d7-a30a-569d8f5e9017_1600w.jpg"/>
</div>
...
<h2 className="mt-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight">Choose Your AI Transformation Package</h2>
...
<span className="text-white/80" id="monthly-label">Monthly</span>
...
<span className="text-white/90 font-medium" id="annual-label">Annually <span className="text-purple-300 text-xs">(Save 20%)</span></span>
</div>
</div>
<div className="mt-10 sm:mt-12 px-4 sm:px-6 lg:px-8">
...
<span id="growth-price">$89</span><span className="text-base align-top font-medium text-white/70">/month</span>
</div>
...
<div className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight">
<span id="scale-price">$199</span><span className="text-base align-top font-medium text-white/70">/month</span>
</div>
...
<h2 className="mt-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight">Ready to Transform Your Business?</h2>
...
<div className="text-2xl sm:text-3xl font-semibold tracking-tight">5K+</div>
<div className="text-xs sm:text-sm text-white/70">Businesses Automated</div>
</div>
<div className="text-center p-4 rounded-lg bg-white/5 ring-1 ring-inset ring-white/10">
<div className="text-2xl sm:text-3xl font-semibold tracking-tight">99.9%</div>
<div className="text-xs sm:text-sm text-white/70">Uptime Guaranteed</div>
</div>
<div className="text-center p-4 rounded-lg bg-white/5 ring-1 ring-inset ring-white/10">
<div className="text-2xl sm:text-3xl font-semibold tracking-tight">47%</div>

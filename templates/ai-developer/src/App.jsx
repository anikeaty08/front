...
<canvas className="" height="2356" id="three-canvas" style={{width: '1819px', height: '1178px'}} width="3638"></canvas>
...
<a className="text-white font-semibold text-sm tracking-tight font-geist" href="#">
                    DesignFlow
                  </a>
<nav className="hidden md:flex items-center gap-6 text-sm">
<a className="text-zinc-300 hover:text-white transition font-geist" href="#features">
                      Features
                    </a>
<a className="text-zinc-300 hover:text-white transition font-geist" href="#pricing">
                      Pricing
                    </a>
<a className="text-zinc-300 hover:text-white transition font-geist" href="#testimonials">
                      Testimonials
                    </a>
</nav>
</div>
...
<svg className="w-4 h-4 text-cyan-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<style>
    ...
    @keyframes typing-sequence {
      0% { opacity: 0; max-height: 0; margin-top: 0; display: none; }
      1% { display: flex; opacity: 0; max-height: 0; }
      10% { opacity: 1; max-height: 40px; margin-top: 1rem; }
      90% { opacity: 1; max-height: 40px; margin-top: 1rem; }
      99% { opacity: 0; max-height: 0; margin-top: 0; }
      100% { opacity: 0; max-height: 0; margin-top: 0; display: none; }
    }
    @keyframes dot-bounce {
      0%, 100% { transform: translateY(0); opacity: 0.5; }
      50% { transform: translateY(-3px); opacity: 1; }
    }
    .animate-enter { animation: chat-enter 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards; opacity: 0; }
    .delay-0 { animation-delay: 0s; opacity: 1; } /* Already visible */
    .delay-1000 { animation-delay: 1.2s; }
    .delay-3500 { animation-delay: 3.8s; }
    .animate-typing { animation: typing-sequence 2.4s ease-in-out 1.3s forwards; opacity: 0; max-height: 0; overflow: hidden; }
  </style>
...
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
</button>
</header>
...
<svg className="text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2v0a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z"></path><path d="m4.93 10.93 1.41 1.41"></path><path d="M2 18h2"></path><path d="M20 18h2"></path><path d="m19.07 10.93-1.41 1.41"></path><path d="M22 22v-4a6 6 0 0 0-12 0v4"></path><rect height="4" rx="1" width="4" x="10" y="10"></rect></svg>
</div>
...
<svg className="text-neutral-300" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
</div>
...
<div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-cyan-500 shadow-lg shadow-cyan-500/20 flex items-center justify-center flex-shrink-0">
<svg className="text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2v0a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z"></path><rect height="4" rx="1" width="4" x="10" y="10"></rect><path d="M22 22v-4a6 6 0 0 0-12 0v4"></path></svg>
</div>
...
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18" x="3" y="3"></rect><circle cx="9" cy="9" r="2"></circle><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"></path></svg>
</button>
<input className="bg-transparent border-none outline-none text-sm text-white w-full placeholder-neutral-500 font-geist" placeholder="Describe component logic..." type="text"/>
</div>
...
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m5 12 7-7 7 7"></path><path d="M12 19V5"></path></svg>
</button>
</div>
...
<style>
          ...
          @keyframes loop-fade-2 {
            0%, 15%, 95% { opacity: 0; transform: translateY(10px); }
            20%, 90% { opacity: 1; transform: translateY(0); }
            100% { opacity: 0; transform: translateY(-5px); }
          }
          @keyframes loop-typing {
            0%, 25% { display: none; opacity: 0; max-height: 0; margin-top: 0; }
            26% { display: flex; opacity: 0; max-height: 0; margin-top: 0.5rem; }
            30%, 45% { opacity: 1; max-height: 40px; margin-top: 0.5rem; }
            46%, 100% { opacity: 0; max-height: 0; margin-top: 0; display: none; }
          }
          @keyframes loop-fade-3 {
            0%, 48%, 95% { opacity: 0; transform: translateY(10px); }
          ...
          .anim-cycle-1 { animation: loop-fade-1 12s cubic-bezier(0.16, 1, 0.3, 1) infinite; }
          .anim-cycle-2 { animation: loop-fade-2 12s cubic-bezier(0.16, 1, 0.3, 1) infinite; }
          .anim-cycle-typing { animation: loop-typing 12s ease-in-out infinite; }
          .anim-cycle-3 { animation: loop-fade-3 12s cubic-bezier(0.16, 1, 0.3, 1) infinite; }
        </style>
...
<div className="flex items-center gap-2">
<svg className="text-cyan-400" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="m5 12 7-7 7 7"></path><path d="M12 19V5"></path></svg>
...
<svg className="text-neutral-500" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
...
<style>
      ...
      .typing-effect {
        ...
        width: 0;
        animation: typeWithCursor 6s steps(42) infinite, blinkCursor .75s step-end infinite;
      }
    </style>
...
<style>
          ...
          .anim-active-indicator {
            animation: active-cycle 9s ease-in-out infinite;
          }
        </style>
...
<img alt="" className="w-6 h-6 rounded-full ring-2 ring-neutral-900 object-cover" src="https://images.unsplash.com/photo-1621619856624-42fd193a0661?w=120&amp;q=80"/>
<img alt="" className="w-6 h-6 rounded-full ring-2 ring-neutral-900 object-cover" src="https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?q=80&amp;w=120&amp;auto=format&amp;fit=crop"/>
</div>
...
<style>
             ...
             .anim-comment { animation: comment-fade 8s ease-in-out infinite; }
             .anim-response { animation: response-fade 8s ease-in-out infinite; }
          </style>
...
<svg className="mr-2" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg>
            Changes approved!
          </div>
</div>
<div className="mt-3 flex items-center gap-2">
...
<style>
               @keyframes button-click-loop {
                 ...
                 48% { transform: scale(0.95); background: #2563eb; } 
                 50%, 95% { transform: scale(1); filter: grayscale(1); opacity: 0.5; } 
                 100% { transform: scale(1); }
               }
               .anim-btn-click { animation: button-click-loop 8s ease-in-out infinite; }
             </style>
...
<style>
           @keyframes hover-pulse {
             0%, 100% { background-color: rgba(9, 9, 11, 0.8); border-color: rgba(255,255,255,0.1); }
             50% { background-color: rgba(30, 41, 59, 0.8); border-color: rgba(59, 130, 246, 0.3); }
           }
           .anim-hover-1 { animation: hover-pulse 4s ease-in-out infinite; }
           .anim-hover-2 { animation: hover-pulse 4s ease-in-out infinite 2s; }
        </style>
...
<div className="opacity-60 absolute inset-0" style="
...
<svg className="w-6 h-6 text-white" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="w-4.5 h-4.5 text-white" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="1.5" width="8" x="13" y="2"></rect><path d="M13 10V3a2 2 0 0 1 2-2h4"></path><rect height="8" rx="1.5" width="8" x="3" y="14"></rect><path d="M11 14v7a2 2 0 0 1-2 2H5"></path><rect height="8" rx="1.5" width="8" x="14" y="13"></rect><path d="M14 13h7a2 2 0 0 1 2 2v4"></path><rect height="8" rx="1.5" width="8" x="2" y="3"></rect><path d="M10 3H3a2 2 0 0 0-2 2v4"></path></svg>
</div>
...
<svg className="w-5 h-5 text-blue-400" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
</div>
</div>
</div>
</div>
...
<style>
      ...
      @keyframes active-content-reveal {
        0%, 30% { opacity: 1; }
        36%, 100% { opacity: 0; }
      }
      .animate-step-cycle {
        animation: active-step-anim 9s ease-in-out infinite;
      }
      .animate-content-cycle {
        animation: active-content-reveal 9s ease-in-out infinite;
      }
...
<svg className="text-cyan-400 animate-spin" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M21 12a9 9 0 1 1-6.219-8.56"></path></svg>
</div>
...
<span className="text-5xl text-white font-geist font-light tracking-tighter" data-counter="">0</span>
</div>
...
<svg className="w-full h-full text-neutral-700" preserveaspectratio="none" style={{overflow: 'visible'}} viewbox="0 0 300 100">
<defs>
<lineargradient id="graph-gradient-fill" x1="0" x2="0" y1="0" y2="1">
<stop offset="0%" stop-color="rgb(34, 211, 238)" stop-opacity="0.1"></stop>
<stop offset="100%" stop-color="rgb(34, 211, 238)" stop-opacity="0"></stop>
</lineargradient>
<lineargradient id="line-shine" x1="0" x2="1" y1="0" y2="0">
<stop offset="0%" stop-color="#22d3ee" stop-opacity="0.5"></stop>
<stop offset="50%" stop-color="#fff" stop-opacity="1"></stop>
<stop offset="100%" stop-color="#22d3ee" stop-opacity="0.5"></stop>
</lineargradient>
<filter height="200%" id="glow-marker" width="200%" x="-50%" y="-50%">
...
<path className="opacity-0" d="M0,80 C50,80 50,40 100,40 C150,40 150,70 200,70 C250,70 250,20 300,20 V100 H0 Z" fill="url(#graph-gradient-fill)" style={{animation: 'fadeIn 1.5s ease-out 0.5s forwards'}}></path>

<path d="M0,80 C50,80 50,40 100,40 C150,40 150,70 200,70 C250,70 250,20 300,20" fill="none" stroke="currentColor" stroke-dasharray="600" stroke-dashoffset="600" strokeWidth="1.5" style={{animation: 'drawWave 2.5s ease-out forwards'}}></path>

<path d="M0,80 C50,80 50,40 100,40 C150,40 150,70 200,70 C250,70 250,20 300,20" fill="none" stroke="url(#line-shine)" stroke-dasharray="600" stroke-dashoffset="600" strokeWidth="2" style={{animation: 'drawWave 2.5s ease-out forwards'}}></path>
...
<circle fill="#22d3ee" filter="url(#glow-marker)" r="4"></circle>
<circle fill="white" r="1.5"></circle>
</g>
</g>
</svg>
</div>
...
<img alt="" className="w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c92852bb-a510-405a-85ab-ffa0fde136a4_1600w.jpg"/>
</div>
</div>
...
<img alt="" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a34e7279-3582-477a-8b2b-d9e9789eb63c_1600w.jpg"/>
</div>
</div>
...
<div className="w-14 h-14 rounded-xl ring-1 ring-white/10 overflow-hidden bg-neutral-800">
<img alt="" className="w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2dadd731-6120-4637-ada0-dcaa8dbc507e_1600w.jpg"/>
</div>
</div>
<p className="text-neutral-300 text-base sm:text-lg leading-relaxed font-geist">
...
<button className="relative px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 text-white bg-gradient-to-r from-cyan-500 to-blue-500 shadow-lg shadow-blue-500/25 font-geist" id="billing-monthly" onclick="switchBilling('monthly')">
                    Monthly
                  </button>
<button className="transition-all duration-300 hover:text-white text-sm font-medium text-zinc-400 font-geist rounded-full pt-2 pr-5 pb-2 pl-5 relative" id="billing-yearly" onclick="switchBilling('yearly')">
...
<div className="overflow-hidden sm:px-8 sm:py-8 bg-gradient-to-br from-white/10 to-white/0 rounded-3xl ring-0 pt-6 pr-5 pb-6 pl-5 relative" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0))', '--border-radius-before': '24px'}}>
...
<div className="relative">
<div className="flex items-end gap-3">
<p className="bg-clip-text sm:text-6xl text-5xl font-light text-transparent tracking-tighter font-geist bg-[#ffffff]" id="price-starter">
                        $49
                      </p>
<span className="text-[11px] uppercase text-neutral-400 mb-1 font-geist" id="period-starter">
                        /month
                      </span>
</div>
...
<div className="sm:px-8 sm:py-8 overflow-hidden bg-gradient-to-br from-white/10 to-white/0 rounded-3xl ring-0 pt-6 pr-5 pb-6 pl-5 relative" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0))', '--border-radius-before': '24px'}}>
<div className="pointer-events-none absolute inset-0 opacity-[0.18]" style={{backgroundImage: 'radial-gradient(rgba(255,255,255,0.25) 1px, transparent 1px)', backgroundSize: '18px 18px'}}></div>
<div className="relative">
<div className="flex items-end gap-3">
<p className="bg-clip-text sm:text-6xl text-5xl font-light text-transparent tracking-tighter font-geist bg-[#ffffff]" id="price-pro">
                        $149
                      </p>
<span className="text-[11px] uppercase text-neutral-400 mb-1 font-geist" id="period-pro">
                        /month
                      </span>
</div>
<p className="mt-4 text-sm sm:text-base text-neutral-300 font-geist">

...
<span className="text-xs font-medium text-zinc-300 tracking-wide uppercase">AI-Powered Marketing v2.0</span>
</div>
<h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-white tracking-tight leading-[1.1]">
                    AI-Driven Digital Marketing That <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1800ad] to-purple-500">Scales</span>
</h1>
<p className="text-lg text-zinc-400 max-w-lg leading-relaxed">
                    Data-powered strategy. Automation-led growth. We leverage proprietary AI models to predict trends and optimize global campaigns in real-time.
                </p>
...
<div>
<h3 className="text-sm font-medium text-white">Projected Growth</h3>
<p className="text-xs text-zinc-500">Real-time AI prediction</p>
</div>
...
<div className="text-[10px] uppercase tracking-wider text-zinc-500">Traffic</div>
</div>
<div className="text-center border-l border-white/5 border-r">
<div className="text-lg font-semibold text-white">3.5x</div>
<div className="text-[10px] uppercase tracking-wider text-zinc-500">Leads</div>
</div>
<div className="text-center">
<div className="text-lg font-semibold text-white">24/7</div>
<div className="text-[10px] uppercase tracking-wider text-zinc-500">Support</div>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-4">Powered by Neural Intelligence</h2>
<p className="text-zinc-400 max-w-2xl mx-auto">We don't just guess. We use advanced predictive algorithms to ensure your marketing budget delivers maximum efficiency.</p>
</div>
...
<h3 className="text-lg font-medium text-white mb-2">Predictive SEO</h3>
<p className="text-sm text-zinc-500">AI analysis of keyword intent gaps before competitors find them.</p>
</div>
...
<h3 className="text-lg font-medium text-white mb-2">Smart Targeting</h3>
<p className="text-sm text-zinc-500">Audience segmentation based on behavioral probability scores.</p>
</div>
...
<p className="text-sm text-zinc-500">Ads that adjust bids and creatives automatically 24/7.</p>
</div>
...
<h3 className="text-lg font-medium text-white mb-2">Instant Insights</h3>
<p className="text-sm text-zinc-500">Real-time reporting dashboards eliminating manual data entry.</p>
</div>
</div>
</div>
</section>
...
<div className="inline-block text-[#1800ad] font-semibold text-xs tracking-widest uppercase mb-4">Global Operations</div>
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-6">We work across borders and time zones.</h2>
<p className="text-zinc-400 mb-8">Our decentralized team and AI infrastructure allow us to serve industries globally without latency.</p>
...
<li className="flex items-center gap-3 text-sm text-zinc-300">
<svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check-circle" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11l3 3L22 4"></path></g></svg> Real Estate &amp; Healthcare
                    </li>
<li className="flex items-center gap-3 text-sm text-zinc-300">
<svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check-circle" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11l3 3L22 4"></path></g></svg> Enterprise Solutions
                    </li>
</ul>
</div>
...
<span className="text-xs font-medium text-white">Active Campaigns: 842</span>
</div>
</div>
</div>
</section>
...
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-12 text-center">Comprehensive Solutions</h2>
...
<h3 className="text-white font-medium mb-1">Advanced SEO</h3>
<p className="text-xs text-zinc-500">Technical, Off-page, AI Content</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<h3 className="text-white font-medium mb-1">SMO &amp; Branding</h3>
<p className="text-xs text-zinc-500">Reels, Organic Growth, Identity</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<p className="text-xs text-zinc-500">Fast, Scalable, Secure</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<h3 className="text-white font-medium mb-1">Video Editing</h3>
<p className="text-xs text-zinc-500">Cinematic Ads, Promo</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<h3 className="text-white font-medium mb-1">Graphic Design</h3>
<p className="text-xs text-zinc-500">UI Assets, Creatives</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<h3 className="text-white font-medium mb-1">PPC &amp; Funnels</h3>
<p className="text-xs text-zinc-500">Google Ads, Conversion Focus</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<p className="text-xs text-zinc-500">IG &amp; FB Scaling Systems</p>
</div>
<div className="glass-card p-6 rounded-lg hover:bg-white/5 transition-all cursor-pointer group">
...
<h3 className="text-white font-medium mb-1">Calling Agent</h3>
<p className="text-xs text-zinc-500">Lead Follow-up &amp; Sales</p>
</div>
</div>
</div>
</section>
...
<div className="text-sm font-medium text-zinc-500">Avg. ROI Increase</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-bold text-white mb-2" data-target="350">0%</div>
<div className="text-sm font-medium text-zinc-500">Lead Growth</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-bold text-white mb-2" data-target="85">0+</div>
<div className="text-sm font-medium text-zinc-500">Global Clients</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-bold text-white mb-2" data-target="12">0%</div>
<div className="text-sm font-medium text-zinc-500">Conv. Improvement</div>
</div>
</div>
</div>
</section>
...
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-4">How We Scale You</h2>
</div>
...
<h3 className="text-xl font-medium text-white">1. AI Audit &amp; Research</h3>
<p className="text-sm text-zinc-500 mt-2">Deep dive into data, competitors, and market gaps.</p>
</div>
...
<h3 className="text-xl font-medium text-white">2. Strategy &amp; Funnel Design</h3>
<p className="text-sm text-zinc-500 mt-2">Architecting the path from stranger to loyal customer.</p>
</div>
</div>
<div className="relative flex flex-col md:flex-row items-center justify-between group">
<div className="md:w-5/12 text-left md:text-right pr-8 pl-12 md:pl-0">
<h3 className="text-xl font-medium text-white">3. Execution &amp; Optimization</h3>
<p className="text-sm text-zinc-500 mt-2">Launching campaigns with real-time AI adjustments.</p>
</div>
<div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 bg-black border-2 border-zinc-700 group-hover:border-[#1800ad] rounded-full z-10 transition-colors"></div>
<div className="hidden md:block md:w-5/12 pl-8"></div>
</div>
...
<div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 bg-black border-2 border-zinc-700 group-hover:border-[#1800ad] rounded-full z-10 transition-colors"></div>
<div className="md:w-5/12 text-left pl-12 md:pl-8">
<h3 className="text-xl font-medium text-white">4. Scaling &amp; Automation</h3>
<p className="text-sm text-zinc-500 mt-2">Expanding reach while reducing manual input.</p>
</div>
</div>
</div>
</div>
...
<div>
<h2 className="text-3xl font-semibold text-white tracking-tight mb-6">Why Modern Brands Choose Us</h2>
...
<div>
<h4 className="text-white font-medium">AI-First Strategy</h4>
<p className="text-sm text-zinc-500 mt-1">We don't retro-fit AI. We build strategies around it.</p>
</div>
</div>
<div className="flex gap-4">
<div className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center shrink-0">
...
<div>
<h4 className="text-white font-medium">Transparent Reporting</h4>
<p className="text-sm text-zinc-500 mt-1">Live dashboards. No hidden fees. Total clarity.</p>
</div>
</div>
<div className="flex gap-4">
<div className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center shrink-0">
...
<div>
<h4 className="text-white font-medium">Global Experience</h4>
<p className="text-sm text-zinc-500 mt-1">Strategies tested across 4 continents and 12 verticals.</p>
</div>
</div>
</div>
</div>
<div>
<h3 className="text-lg font-medium text-white mb-6">Our Tech Stack</h3>
...
<span className="text-[10px] text-zinc-500">Automation</span>
</div>
<div className="glass-card h-24 flex flex-col items-center justify-center rounded-lg hover:border-[#1800ad]/50 transition-colors">
...
<span className="text-[10px] text-zinc-500">Heatmaps</span>
</div>
</div>
</div>
</div>
...
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-12">Proven Results</h2>
...
<h3 className="text-xl font-medium text-white mt-1">FinTech Startup Scale</h3>
</div>
</div>
<div className="p-6">
<p className="text-xs text-zinc-500 mb-4 line-clamp-2">Challenge: High CPA and low retention.Solution: AI-driven funnel optimization.</p>
<div className="flex justify-between items-center border-t border-white/5 pt-4">
<div>
<div className="text-lg font-bold text-white">+210%</div>
<div className="text-[10px] text-zinc-500">MRR Growth</div>
</div>
...
<h3 className="text-xl font-medium text-white mt-1">Fashion Brand Global</h3>
</div>
</div>
<div className="p-6">
<p className="text-xs text-zinc-500 mb-4 line-clamp-2">Challenge: Stagnant ROAS on Meta Ads.Solution: Predictive audience modeling.</p>
<div className="flex justify-between items-center border-t border-white/5 pt-4">
<div>
...
<div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-80"></div>
<div className="absolute bottom-4 left-4">
<span className="px-2 py-1 bg-[#1800ad] text-white text-[10px] uppercase font-bold tracking-wider rounded">Real Estate</span>
<h3 className="text-xl font-medium text-white mt-1">Luxury Property Leads</h3>
</div>
</div>
<div className="p-6">
<p className="text-xs text-zinc-500 mb-4 line-clamp-2">Challenge: Poor lead quality.Solution: Automated calling agent qualification.</p>
<div className="flex justify-between items-center border-t border-white/5 pt-4">
<div>
<div className="text-lg font-bold text-white">-45%</div>
<div className="text-[10px] text-zinc-500">CPL</div>
</div>
<button className="text-[#1800ad] hover:text-white transition-colors">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:arrow-up-right" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10M7 17L17 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</button>
...
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-12 text-center">Engagement Models</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">

<div className="glass-card p-8 rounded-xl">
<h3 className="text-lg font-medium text-white">Starter</h3>
<p className="text-sm text-zinc-500 mt-2">Perfect for local businesses.</p>
<div className="my-6">
<span className="text-3xl font-bold text-white">$1.5k</span><span className="text-zinc-500 text-sm">/mo</span>
</div>
<ul className="space-y-3 mb-8">
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Basic SEO Setup</li>
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Google Ads Management</li>
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Monthly Reporting</li>
</ul>
<a className="block w-full py-3 border border-white/10 rounded-lg text-center text-sm text-white hover:bg-white/5 transition-colors" href="#contact">Start Project</a>
</div>

<div className="glass-card p-8 rounded-xl border-[#1800ad] relative shadow-[0_0_30px_-10px_#1800ad]">
<div className="absolute top-0 right-0 -mt-3 mr-4 bg-[#1800ad] text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">Most Popular</div>
<h3 className="text-lg font-medium text-white">Growth</h3>
<p className="text-sm text-zinc-500 mt-2">For scaling brands.</p>
<div className="my-6">
<span className="text-3xl font-bold text-white">$4.5k</span><span className="text-zinc-500 text-sm">/mo</span>
</div>
<ul className="space-y-3 mb-8">
<li className="flex items-center gap-2 text-sm text-zinc-300"><svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> AI-Driven SEO &amp; Content</li>
<li className="flex items-center gap-2 text-sm text-zinc-300"><svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Meta &amp; Google Ads Scaling</li>
<li className="flex items-center gap-2 text-sm text-zinc-300"><svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Weekly Strategy Calls</li>
<li className="flex items-center gap-2 text-sm text-zinc-300"><svg aria-hidden="true" className="iconify text-[#1800ad] iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> CRO &amp; Funnel Design</li>
</ul>
<a className="block w-full py-3 bg-[#1800ad] rounded-lg text-center text-sm text-white hover:bg-[#120085] transition-colors" href="#contact">Get Started</a>
</div>

<div className="glass-card p-8 rounded-xl">
<h3 className="text-lg font-medium text-white">Enterprise</h3>
<p className="text-sm text-zinc-500 mt-2">Custom AI solutions.</p>
<div className="my-6">
<span className="text-3xl font-bold text-white">Custom</span>
</div>
<ul className="space-y-3 mb-8">
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Dedicated AI Squad</li>
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Custom Automation Bots</li>
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> 24/7 Global Support</li>
<li className="flex items-center gap-2 text-sm text-zinc-400"><svg aria-hidden="true" className="iconify text-zinc-600 iconify--lucide" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Full-Service Marketing</li>
</ul>
<a className="block w-full py-3 border border-white/10 rounded-lg text-center text-sm text-white hover:bg-white/5 transition-colors" href="#contact">Contact Sales</a>
</div>
</div>
</div>
</section>
...
<section className="py-24 bg-black">
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-3xl font-semibold text-white mb-12">The Minds Behind the Machines</h2>
...
<div className="text-xs text-zinc-500">Lead AI Strategist</div>
</div>
</div>
<div className="flex items-center gap-4 glass-card pr-6 rounded-full p-1">
<div className="w-12 h-12 rounded-full bg-zinc-800"></div>
...
<div className="text-xs text-zinc-500">Head of Performance</div>
</div>
</div>
<div className="flex items-center gap-4 glass-card pr-6 rounded-full p-1">
<div className="w-12 h-12 rounded-full bg-zinc-800"></div>
...
<div className="text-xs text-zinc-500">Creative Director</div>
</div>
</div>
<div className="flex items-center gap-4 glass-card pr-6 rounded-full p-1">
<div className="w-12 h-12 rounded-full bg-zinc-800"></div>
...
<summary className="flex items-center justify-between p-6 cursor-pointer list-none text-white font-medium">
                        How does AI improve my marketing results?
...
<div className="px-6 pb-6 text-sm text-zinc-400 leading-relaxed">
                        AI analyzes vast amounts of data to predict trends, optimize ad bids in real-time, and personalize content for specific audience segments, resulting in higher conversion rates and lower acquisition costs.
                    </div>
</details>
<details className="group glass-card rounded-lg open:bg-white/5 transition-all">
<summary className="flex items-center justify-between p-6 cursor-pointer list-none text-white font-medium">
...
<div className="px-6 pb-6 text-sm text-zinc-400 leading-relaxed">
                        Yes, our team is distributed across multiple time zones, allowing us to manage campaigns and offer support 24/7 for clients in the US, Europe, and Asia.
                    </div>
</details>
<details className="group glass-card rounded-lg open:bg-white/5 transition-all">
<summary className="flex items-center justify-between p-6 cursor-pointer list-none text-white font-medium">
...
<div className="px-6 pb-6 text-sm text-zinc-400 leading-relaxed">
                        We work on a month-to-month basis for our Starter plans, while Growth and Enterprise plans typically require a 3-month commitment to allow sufficient time for AI learning and optimization.
                    </div>
</details>
</div>
</div>
...
<h2 className="text-4xl md:text-5xl font-semibold text-white tracking-tight mb-6">Ready to Scale Your Business with AI?</h2>
<p className="text-zinc-400 mb-10 text-lg">Stop guessing. Start growing. Join the agency that is redefining digital performance.</p>
...
<p className="text-zinc-400 mb-8">Fill out the form and our AI agent will route you to the best strategist for your industry.</p>
<form className="space-y-4">
<div className="grid grid-cols-2 gap-4">
<input className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-[#1800ad] transition-colors" placeholder="Name" type="text"/>
...
<input className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-[#1800ad] transition-colors" placeholder="Company Website" type="text"/>
...
<textarea className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-[#1800ad] transition-colors" placeholder="Tell us about your goals..." rows="4"></textarea>
<button className="w-full bg-white text-black font-semibold py-4 rounded-lg hover:bg-zinc-200 transition-colors" type="button">Send Request</button>
</form>
</div>
...
<li><a className="hover:text-[#1800ad] transition-colors" href="#">SEO Optimization</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">PPC Management</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">Social Media</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">Web Design</a></li>
</ul>
</div>
<div>
<h4 className="text-white font-medium mb-4">Company</h4>
<ul className="space-y-2 text-sm text-zinc-500">
<li><a className="hover:text-[#1800ad] transition-colors" href="#">About Us</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">Careers</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">Blog</a></li>
<li><a className="hover:text-[#1800ad] transition-colors" href="#">Privacy Policy</a></li>
</ul>
</div>
</div>
<div className="mt-12">
...
<p className="text-xs text-zinc-600">© 2024 GENHAWKZ. All rights reserved.</p>
</div>
</div>
</div>
</section>

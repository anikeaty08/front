...
<div className="fixed z-0 opacity-100 top-0 right-0 bottom-0 left-0" id="canvas-container"></div>
...
<svg className="text-[#111111]" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20" x="2" y="4"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
</div>
<h3 className="text-xl font-semibold text-[#111111] tracking-tight mb-2">Stay in the loop</h3>
...
<label className="text-xs font-medium text-[#111111] tracking-tight" htmlFor="modal-email-input">Email address</label>
...
<button className="group relative isolate overflow-hidden w-full mt-5 h-12 bg-[#111111] text-white text-sm font-semibold rounded-lg shadow-[0_1px_2px_rgba(0,0,0,0.08)] ring-1 ring-white/10 transition-all duration-300 hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.3)] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[#111111]/20 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2" id="modal-submit-btn">
...
<h3 className="text-xl font-semibold text-[#111111] tracking-tight mb-2">You're on the list</h3>
...
<div className="w-5 h-5 bg-[#111111] text-white flex items-center justify-center rounded-sm">
...
<span className="text-[#111111] text-sm font-bold tracking-tight font-sans">Total Health</span>
</div>
<nav className="hidden md:flex items-center gap-8" style={{display: 'flex'}}></nav>
...
<h1 className="md:text-7xl lg:text-8xl text-[#111111] leading-[0.95] text-6xl font-semibold tracking-tighter font-sans">Medicine<br/><span className="text-subtle">Personalized.</span></h1>
...
<button className="group relative isolate overflow-hidden bg-[#111111] text-white text-sm font-semibold px-8 py-3.5 rounded shadow-[0_1px_2px_rgba(0,0,0,0.08)] ring-1 ring-white/10 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:scale-[1.03] hover:shadow-[0_12px_32px_-8px_rgba(0,0,0,0.3)] hover:ring-white/20 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[#111111]/20 focus:ring-offset-2 flex items-center gap-2 cursor-pointer" data-open-modal="">
...
<a className="group flex items-center justify-center gap-2 px-8 py-3.5 rounded text-sm font-semibold bg-gray-100 text-subtle hover:text-[#111111] hover:bg-gray-200 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#111111]/10" href="mailto:eric.dai@trytotalhealth.com">
...
<svg className="w-[380px] h-[285px]" data-icon-replaced="true" strokeWidth="2" style={{width: '380px', height: '285px', color: '#111111'}} viewbox="0 0 400 300">
<style>
...
<text className="" fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="10" font-weight="600" text-anchor="middle" x="50" y="175">Context</text>
...
<text dy="1" fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="9" font-weight="600" text-anchor="middle" x="190" y="223">Counterfactual</text>
...
<text className="" fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="10" font-weight="600" text-anchor="middle" x="320" y="178">Outcome</text>
</svg>
</div>
</div>
</div>
...
<p className="text-[#111111] whitespace-nowrap md:w-auto md:text-left text-xs font-semibold text-center w-full">BUILT BY LEADERS FROM</p>
...
<span className="text-[#111111] text-lg font-bold tracking-tight font-sans">Mount Sinai</span>
</div>
</div>
</section>

<section className="md:px-12 lg:px-20 pt-32 pr-6 pb-32 pl-6">
<div className="max-w-7xl mr-auto ml-auto">
<div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
<div className="max-w-xl">
<h2 className="md:text-5xl text-[#111111] leading-[1.1] text-4xl font-semibold tracking-tight font-sans mb-6">Structured Reasoning. <span className="text-subtle block">World Class Care.</span></h2>
...
<a className="pb-1 border-b border-[#111111] text-sm font-medium hover:opacity-70 transition-opacity mb-2" href="#">Explore Platform Features</a>
</div>
...
<h3 className="text-2xl font-semibold text-[#111111] mb-3">Decision Lineage</h3>
...
<div className="px-3 py-1 bg-canvas border border-border rounded text-[10px] font-mono text-subtle uppercase tracking-wider group-hover:text-[#111111] group-hover:border-[#111111]/30 transition-colors">Live Trace</div>
</div>
</div>
...
<h3 className="text-xl font-semibold text-[#111111] mb-3">Immutable Audit</h3>
...
<span className="text-[10px] font-bold text-[#111111] uppercase tracking-wide">Current State</span>
</div>
<div className="h-1 w-full bg-canvas rounded overflow-hidden"><div className="h-full w-2/3 bg-[#111111]/20"></div></div>
</div>
</div>
</div>
</div>
...
<h3 className="text-[#111111] text-xl font-semibold mb-2"></h3>
...
<div className="h-1.5 w-full bg-[#111111]/10 rounded overflow-hidden"><div className="h-full w-0 bg-[#111111] group-hover:w-full transition-all duration-700 delay-300 ease-out"></div></div>
<div className="h-1.5 w-3/4 bg-[#111111]/10 rounded overflow-hidden"><div className="h-full w-0 bg-[#111111] group-hover:w-full transition-all duration-700 delay-500 ease-out"></div></div>
<div className="h-1.5 w-5/6 bg-[#111111]/10 rounded overflow-hidden"><div className="h-full w-0 bg-[#111111] group-hover:w-full transition-all duration-700 delay-700 ease-out"></div></div>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-2">
<span className="text-[#111111] text-sm font-bold tracking-tight">Total Health</span>
</div>
...
<div className="text-[10px] text-border">© 2026 Total Health Inc.</div>
</div>
...
<div className="space-y-4">
<h4 className="text-xs font-bold text-[#111111]">Connect</h4>
<ul className="space-y-2 text-xs text-subtle">
<li className=""></li>
<li className=""><a className="hover:text-[#111111]" href="#">Email</a></li>
</ul>
</div>
</div>
</div>

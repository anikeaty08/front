...
<span className="font-mono text-xs text-rust uppercase tracking-widest">
              AGENTIC AI — MARKETING &amp; CONSULTING
            </span>
</div>
...
<p className="mt-8 max-w-md font-sans text-sm md:text-base font-light leading-relaxed text-neutral-400">
            simple.ai orchestrates and personalizes every customer touchpoint —
            from first impression to brand loyalty — through a single intelligent
            layer that scales your marketing autonomously.
          </p>
...
<p className="font-serif italic text-xl md:text-2xl text-ink leading-snug mb-8 tracking-tight">
              "The future of marketing intelligence is already here."
            </p>
...
<iconify-icon className="text-3xl text-rust/40 mb-4" icon="solar:quote-left-linear"></iconify-icon>
<p className="font-serif italic text-xl md:text-2xl text-ink leading-snug mb-8 tracking-tight">
              "ROAS increased by 300% in week one. Truly autonomous."
            </p>
<div className="border-t pt-4 border-neutral-800/50">
<span className="block font-mono text-xs uppercase tracking-widest text-neutral-400">
                VP of Growth
...
<iconify-icon className="text-3xl text-rust/40 mb-4" icon="solar:quote-left-linear"></iconify-icon>
<p className="font-serif italic text-xl md:text-2xl text-ink leading-snug mb-8 tracking-tight">
              "Finally, an agency partner that genuinely understands our data."
            </p>
<div className="border-t pt-4 border-neutral-800/50">
<span className="block font-mono text-xs uppercase tracking-widest text-neutral-400">
...
<p className="font-sans font-light leading-relaxed max-w-sm text-neutral-400">
                Fragmented systems. Manual optimization. Zero personalization.
...
<p className="font-sans font-light text-ink leading-relaxed max-w-sm">
                One intelligent platform. Unified data. Every touchpoint
                personalized. Every interaction measured.
              </p>
</div>
</div>
</div>
...
<p className="font-sans font-light text-lg leading-relaxed max-w-lg text-neutral-400">
              simple.ai doesn't replace your existing marketing stack. It sits
              above your CRM and Ad platforms as an intelligent orchestration layer —
              unifying fragmented customer data, automating campaigns in real time,
              and delivering hyper-personalized experiences without a single
              rip-and-replace.
            </p>
</div>
</div>
...
<p className="font-sans font-light leading-relaxed text-sm text-neutral-400">
              Integrates flawlessly with existing CRMs &amp; ad networks. Zero
...
<p className="font-sans font-light leading-relaxed text-sm text-neutral-400">
              Autonomous decision-making that optimizes each user's
...
<p className="font-sans font-light leading-relaxed text-sm text-neutral-400">
              One unified approach controls Strategy, Acquisition,
              Retention, and Analytics reporting.
            </p>
</div>
</div>
</section>
...
<h2 className="font-serif text-5xl md:text-6xl text-ink leading-none tracking-tight">
            Five Pillars.
            <br/>
<span className="italic text-neutral-400">One Seamless Strategy.</span>
</h2>
</div>
...
<p className="font-sans font-light text-sm text-neutral-400">
                Data-driven roadmaps. Integrated market research.
                Predictive audience modeling built in from step one.
              </p>
</div>
...
<p className="font-sans font-light text-sm text-neutral-400">
                Agentic ad buying. Fully automated campaign deployment.
                Zero manual bidding adjustments required.
              </p>
</div>
...
<p className="font-sans font-light text-sm text-neutral-400">
                End-to-end campaign automation. Multi-channel workflow control.
                AI-driven creative and copy generation.
              </p>
</div>
...
<p className="font-sans font-light text-sm text-neutral-400">
                Nurture leads with hyper-personalized logic. Instant churn
                prediction and seamless re-engagement routing.
              </p>
</div>
...
<p className="font-sans font-light text-sm text-neutral-400">
                Real-time dashboarding. Multi-touch attribution models.
                Automated KPI tracking and ROI reporting.
              </p>
</div>
</div>
</div>
...
<p className="font-sans font-light text-lg leading-relaxed mt-auto border-t pt-8 text-neutral-400 border-neutral-800">
              simple.ai was featured by the WSJ as a landmark example of
              AI-driven consulting — the first platform to fully automate the
...
<span className="font-mono text-xs text-neutral-500 uppercase tracking-widest">
                  Average ROAS increase within 30 days
                </span>
</div>
<div className="flex flex-col border-b pb-8 border-neutral-800">
<span className="font-serif text-6xl text-ink tracking-tight mb-2">
...
<span className="font-mono text-xs text-neutral-500 uppercase tracking-widest">
                  Partner to orchestrate your growth
                </span>
</div>
</div>
</div>
...
<img alt="Data Analytics" className="absolute inset-0 w-full h-full object-cover grayscale opacity-60 group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"/>
...
<span className="block font-sans font-light text-sm text-neutral-400">
              Automated their entire ad workflow
            </span>
</div>
...
<div className="relative w-full aspect-video border overflow-hidden mb-4 rounded-sm flex items-center justify-center bg-neutral-800 border-neutral-700">
<div className="absolute inset-0 group-hover:bg-white/10 transition-colors z-10 bg-white/5"></div>
<img alt="Agency Workspace" className="absolute inset-0 w-full h-full object-cover grayscale opacity-60 group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"/>
<div className="w-16 h-16 rounded-full backdrop-blur border flex items-center justify-center relative z-20 group-hover:scale-110 transition-transform bg-neutral-900/90 border-neutral-700">
<iconify-icon className="text-2xl text-ink translate-x-0.5" icon="solar:play-linear"></iconify-icon>
</div>
</div>
...
<div className="relative w-full aspect-video border overflow-hidden mb-4 rounded-sm flex items-center justify-center bg-neutral-800 border-neutral-700">
<div className="absolute inset-0 group-hover:bg-white/10 transition-colors z-10 bg-white/5"></div>
<img alt="Charts on Computer" className="absolute inset-0 w-full h-full object-cover grayscale opacity-60 group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"/>
<div className="w-16 h-16 rounded-full backdrop-blur border flex items-center justify-center relative z-20 group-hover:scale-110 transition-transform bg-neutral-900/90 border-neutral-700">
<iconify-icon className="text-2xl text-ink translate-x-0.5" icon="solar:play-linear"></iconify-icon>
</div>
</div>
...
<h2 className="font-serif text-5xl md:text-7xl text-ink leading-none tracking-tight mb-8">
            ...
            <br/>
<span className="italic text-neutral-400">Every Campaign?</span>
</h2>
<p className="font-sans font-light text-lg mb-12 max-w-lg text-neutral-400">
            Join the brands already delivering the future. Schedule a
            personalized consultation and see simple.ai live.
          </p>
...
<span className="font-mono text-xs uppercase tracking-widest text-neutral-500">
            SIMPLE.AI — AGENTIC MARKETING INTELLIGENCE
          </span>
</div>
</section>
</main>

...
<span className="group-hover:text-rose-600 transition-colors text-2xl font-medium italic text-gray-900 tracking-tight font-serif">Revenue Partners.</span>
</a>
...
<a className="hover:bg-rose-600 transition-all duration-300 flex items-center gap-2 group text-xs font-medium text-white font-montserrat bg-gray-900 rounded-full pt-2.5 pr-5 pb-2.5 pl-5" href="#contact">Book a call</a>
</nav>
</header>
<main className="max-w-7xl mr-auto ml-auto pt-32 pr-6 pb-24 pl-6">
...
<div className="grid lg:grid-cols-12 gap-16 z-10 relative gap-x-16 gap-y-16 items-center">

<div className="lg:col-span-7 flex flex-col justify-center">
<div className="animate-fade-up inline-flex gap-2 text-[10px] font-medium text-gray-500 tracking-wide font-montserrat bg-white w-fit border-gray-200 border-2 rounded-full mb-8 pt-1 pr-3 pb-1 pl-1.5 shadow-sm gap-x-2 gap-y-2 items-center">UK's #1 Revenue engine for Small businesses</div>
<h1 className="animate-fade-up delay-100 leading-[0.95] md:text-7xl lg:text-[5.5rem] lg:text-8xl text-6xl font-medium text-gray-900 tracking-tighter font-dm-sans pt-8 pb-8">Build the sales engine your <span className="font-light italic text-gray-400"> </span>  sme deserves.</h1>
<p className="animate-fade-up delay-200 leading-relaxed text-2xl font-light text-gray-500 font-dm-sans max-w-lg mb-10">Revenue-Partners is the growth team that builds real outbound systems for ambitious UK small businesses fast.
</p>
<div className="animate-fade-up delay-300 flex flex-wrap gap-4 items-center">
<a className="hover:bg-rose-600 hover:shadow-lg hover:shadow-rose-500/20 transition-all duration-300 flex items-center gap-3 group text-sm font-medium text-white font-montserrat bg-gray-900 rounded-full pt-3.5 pr-5 pb-3.5 pl-6" href="#contact">Book a call</a>
<a className="hover:text-gray-900 transition-all duration-300 flex items-center gap-2 group text-sm font-medium text-gray-500 font-montserrat rounded-full pt-3.5 pr-6 pb-3.5 pl-6" href="#work">
                            View Case Studies
...
<img alt="Dashboard" className="hover:grayscale-0 transition-all duration-700 ease-out transform hover:scale-105 w-full h-full object-cover grayscale" src="https://images.unsplash.com/photo-1585417461683-6412aead26f1?w=1600&amp;q=80"/>
...
<div className="">
<p className="leading-tight text-sm font-semibold text-gray-900 font-montserrat">£2.9M </p>
<p className="text-[11px] text-gray-400 font-montserrat mt-0.5">Pipeline generted</p>
</div>
</div>
</div>
</div>
...
<span className="text-[11px] uppercase font-semibold text-gray-600 tracking-wide font-montserrat bg-gray-100 rounded-full pt-1 pr-3 pb-1 pl-3">Professional Services</span>
...
<div className="">
<h3 className="leading-tight group-hover:text-rose-600 transition-colors text-3xl font-medium text-gray-900 font-serif mb-4">Accountants - Leeds</h3>
<p className="leading-relaxed text-sm font-light text-gray-500 mb-8">We'd run on referrals for six years. Revenue-Partners had sequences running and meetings booking within three weeks. First new client from cold outreach landed in month two.</p>
...
<div className="flex gap-3">
<span className="text-[11px] uppercase font-semibold text-gray-600 tracking-wide font-montserrat bg-gray-100 rounded-full pt-1 pr-3 pb-1 pl-3">Professional Services</span>
<span className="text-[11px] flex items-center gap-1 font-medium text-gray-400 font-montserrat pt-1">Commercial infrastructure</span>
</div>
<div className="bg-gray-50 p-3 rounded-full group-hover:bg-rose-600 group-hover:text-white transition-all duration-300">
<i className="w-5 h-5" data-lucide="arrow-up-right"></i>
</div>
...
<div className="grid md:grid-cols-2 gap-12 items-end">
<div className="">
<h3 className="leading-tight group-hover:text-rose-600 transition-colors text-3xl font-medium text-gray-900 font-serif mb-4">Management Consultants - Manchester</h3>
<p className="leading-relaxed text-sm font-light text-gray-500 mb-8">We'd tried cold outreach before and it did nothing. Revenue-Partners rebuilt it from scratch — better targeting, better messaging, better timing. Pipeline went from zero to consistent within 60 days.</p>
<div className="flex gap-8 border-t border-gray-100 pt-6">
<div className="">
<div className="text-lg font-semibold text-rose-500 font-montserrat">£80k +</div>
<div className="text-[11px] uppercase font-semibold text-gray-400 tracking-wide font-montserrat mt-1">Pipeline</div>
</div>
<div className="">
...
<div className="flex justify-between items-start mb-12">
<div className="flex gap-3">
<span className="text-[11px] uppercase font-semibold text-gray-600 tracking-wide font-montserrat bg-gray-100 rounded-full pt-1 pr-3 pb-1 pl-3">HR</span>
<span className="text-[11px] flex items-center gap-1 font-medium text-gray-400 font-montserrat pt-1">Commercial infrastructure</span>
</div>
<div className="bg-gray-50 p-3 rounded-full group-hover:bg-rose-600 group-hover:text-white transition-all duration-300">
<i className="w-5 h-5" data-lucide="arrow-up-right"></i>
...
<div className="grid md:grid-cols-2 gap-12 items-end">
<div className="">
<h3 className="leading-tight group-hover:text-rose-600 transition-colors text-3xl font-medium text-gray-900 font-serif mb-4">HR Consultants - Bristol</h3>
<p className="leading-relaxed text-sm font-light text-gray-500 mb-8">We knew we needed to do something about sales but never had the time or the system to make it happen. Revenue-Partners took it completely off our plate. Within 90 days we had a pipeline we could actually forecast from</p>
<div className="flex gap-8 border-t border-gray-100 pt-6">
<div>
...
</section><section className="border-gray-200/60 border-t pt-24 pb-24" id="services">
<h2 className="md:text-5xl text-4xl font-medium text-gray-900 tracking-tight font-serif text-center mb-16">What we do</h2>
...
<div className="group hover:border-rose-200/60 hover:shadow-[0_20px_40px_-12px_rgba(244,63,94,0.1)] transition-all duration-500 bg-white border-gray-200/60 border rounded-3xl pt-10 pr-10 pb-10 pl-10">
<div className="inline-flex group-hover:bg-rose-50 group-hover:text-rose-600 transition-colors text-gray-900 bg-gray-50 rounded-xl mb-6 pt-3 pr-3 pb-3 pl-3">
<i className="w-6 h-6" data-lucide="layers"></i>
</div>
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">Lead Generation</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">We identify the right businesses at the right time using real buying signals — not random lists.</p>
...
</div><div className="group hover:border-rose-200/60 hover:shadow-[0_20px_40px_-12px_rgba(244,63,94,0.1)] transition-all duration-500 bg-white border-gray-200/60 border rounded-3xl pt-10 pr-10 pb-10 pl-10">
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">Cold Email Outreach</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">Signal-driven sequences built and managed for you. No templates. No spam. Just relevant outreach that lands in inboxes and gets replies.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">Phone Outreach
</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">We get on the phone so you don't have to. Targeted calling to warm up the accounts that matter most.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">LinkedIn Outreach</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">Connection requests, messaging sequences, and profile optimisation to turn LinkedIn into a consistent lead source.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">CRM Setup</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">We build your CRM from scratch — clean, structured, and ready to use from day one. No more spreadsheets.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">CRM Automations</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">Follow-ups, reminders, pipeline updates, and reporting — all running automatically so nothing falls through the cracks.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">Sales Team Hiring</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">When you're ready to build in-house, we help you find, screen, and onboard the right sales talent for your business.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Start Building
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<div className="inline-flex group-hover:bg-rose-50 group-hover:text-rose-600 transition-colors text-gray-900 bg-gray-50 rounded-xl mb-6 pt-3 pr-3 pb-3 pl-3">
<svg aria-hidden="true" className="lucide lucide-layers w-[24px] h-[24px]" data-icon-replaced="true" data-lucide="layers" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '24px', height: '24px', color: 'rgb(225, 29, 72)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path></svg></div>
<h3 className="group-hover:text-rose-600 transition-colors text-2xl font-medium text-gray-900 font-montserrat mb-3">Sales Team Coaching</h3>
<p className="leading-relaxed min-h-[3rem] text-sm font-light text-gray-500 mb-8">We train your team on the systems, sequences, and skills they need to keep the pipeline moving without you.</p>
<a className="flex items-center text-xs font-bold text-gray-900 hover:text-rose-600 font-montserrat transition-colors group/link" href="#contact">
                        Automate Now
                        <i className="w-3 h-3 ml-2 group-hover/link:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</a>
...
<section className="grid lg:grid-cols-2 gap-20 pt-24 pb-24 gap-x-20 gap-y-20 items-center" id="about">
...
<p className="">We are <span className="font-medium text-gray-900">Revenue partners</span>. We build out your commercial infrastructure.</p>
<p className="">

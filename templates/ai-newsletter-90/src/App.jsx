...
<div className="font-semibold text-base text-slate-900 tracking-tighter uppercase">
                STORYLINE
            </div>
<div className="flex items-center gap-4">
<a className="hidden md:block text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors" href="#pricing">Pricing</a>
...
<div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[40vh] bg-gradient-to-b from-slate-200/50 to-transparent -z-10 blur-3xl rounded-full"></div>
<div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-white shadow-sm mb-8">
<iconify-icon className="text-slate-900" icon="solar:pen-new-round-linear" style={{strokeWidth: '1.5'}} width="16"></iconify-icon>
...
<h1 className="text-5xl md:text-7xl font-semibold text-slate-900 tracking-tight max-w-4xl leading-[1.1] mb-8">
            Turn Subscribers into Buyers with <span className="text-slate-400">Story-Driven</span> Newsletters
        </h1>
...
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-slate-900 text-white px-8 py-3.5 rounded-xl text-base font-medium hover:bg-slate-800 transition-colors shadow-sm" href="#pricing">
...
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-slate-900 border border-slate-200 px-8 py-3.5 rounded-xl text-base font-medium hover:bg-slate-50 transition-colors shadow-sm" href="#demo">
                See how it works
                <iconify-icon icon="solar:arrow-down-linear" style={{strokeWidth: '1.5'}} width="18"></iconify-icon>
</a>
</div>
</section>
...
<span className="text-xs font-medium text-slate-500 uppercase tracking-widest mb-3 block">How Our AI Newsletter Generator Works</span>
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight">Watch It Write Your First Storytelling Newsletter</h2>
</div>
...
<div className="p-3 border border-slate-900 rounded-lg bg-slate-900 text-white text-sm font-medium shadow-sm flex justify-between items-center cursor-pointer">
...
<div className="text-sm font-medium text-slate-900">Subject: Why your product roadmap is killing your sales</div>
<div className="flex gap-2">
<div className="h-8 w-8 rounded-lg border border-slate-200 bg-white flex items-center justify-center">
<iconify-icon className="text-slate-500" icon="solar:copy-linear" width="16"></iconify-icon>
</div>
<div className="h-8 px-4 rounded-lg bg-slate-900 text-white text-xs font-medium flex items-center justify-center">
                                Export
                            </div>
</div>
</div>
...
<div className="absolute -top-3 left-4 bg-white px-2 text-xs font-medium text-slate-400 uppercase tracking-widest">Live Output</div>
...
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight">Same Inbox. Two Very Different Emails.</h2>
</div>
...
<div>
<div className="text-xs font-medium text-slate-500 uppercase tracking-widest">Our Approach</div>
...
<div className="md:col-span-3 bg-slate-50 rounded-3xl p-8 border border-slate-200 flex flex-col justify-center">
...
<p className="text-2xl md:text-3xl font-medium text-slate-900 tracking-tight leading-snug mb-4">
...
<div className="md:col-span-5 bg-slate-900 rounded-3xl p-8 md:p-10 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-8 mt-2">
...
<div className="inline-flex items-center gap-3 bg-slate-800/50 border border-slate-700 rounded-xl px-5 py-3">
<iconify-icon className="text-slate-500 shrink-0" icon="solar:quote-left-linear" width="24"></iconify-icon>
...
<div className="mt-6 text-slate-400 bg-slate-50 border border-slate-200 rounded-full w-10 h-10 flex items-center justify-center animate-bounce">
...
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight mb-6">The Weekly Newsletter Trap</h2>
...
<div className="relative pl-6">
<div className="absolute -left-1.5 top-1.5 w-3 h-3 rounded-full bg-slate-600 border-2 border-white"></div>
...
<p className="text-lg text-slate-900 font-medium mb-6">You become part of their routine. Trust builds naturally. Sales feel effortless.</p>
<p className="text-base text-slate-600 mb-8 pb-8 border-b border-slate-100">No hype. No tricks. Just compound consistency.</p>
<h4 className="text-sm font-medium text-slate-900 uppercase tracking-widest mb-4">Think about it:</h4>
<div className="space-y-4 mb-8">
<div className="flex justify-between items-center p-4 rounded-xl bg-slate-50 border border-slate-100">
<span className="text-sm text-slate-600">1 email / week</span>
<span className="text-sm font-medium text-slate-900">52 touchpoints / year</span>
</div>
<div className="flex justify-between items-center p-4 rounded-xl bg-slate-900 text-white shadow-md">
<span className="text-sm text-slate-300">1 email / day</span>
<span className="text-sm font-medium text-white">365 touchpoints / year</span>
</div>
</div>
<p className="text-sm font-medium text-slate-900 text-center">Which relationship would YOU trust more?</p>
</div>
</div>
...
<p className="text-lg text-slate-900 font-semibold tracking-tight">That's exactly where we come in.</p>
</div>
</section>

<section className="py-24 px-6 bg-slate-900 text-white rounded-[2.5rem] max-w-[96%] mx-auto my-12">
<div className="max-w-7xl mx-auto">
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-white mb-4">Daily Storytelling, Made Easy</h2>
...
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:rocket-linear" width="24"></iconify-icon>
</div>
...
<div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl backdrop-blur-sm">
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:user-speak-linear" width="24"></iconify-icon>
</div>
...
<div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl backdrop-blur-sm">
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:brain-linear" width="24"></iconify-icon>
</div>
...
<div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl backdrop-blur-sm">
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:wallet-money-linear" width="24"></iconify-icon>
</div>
...
<div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl backdrop-blur-sm">
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:mailbox-linear" width="24"></iconify-icon>
</div>
...
<div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl backdrop-blur-sm">
<div className="h-10 w-10 bg-slate-800 rounded-lg flex items-center justify-center mb-4 border border-slate-700">
<iconify-icon className="text-slate-200" icon="solar:leaf-linear" width="24"></iconify-icon>
</div>
...
<section className="py-24 px-6 max-w-7xl mx-auto">
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight mb-4">Built for People Who Sell Through Trust</h2>
</div>
...
<span className="text-indigo-600 mr-2">→</span>Daily stories keep your list warm while you build the next thing.
                </div>
</div>
...
<div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm font-medium text-slate-900">
<span className="text-indigo-600 mr-2">→</span>Daily stories keep your list warm so every launch starts hot, not cold.
                </div>
</div>
...
<div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm font-medium text-slate-900">
<span className="text-indigo-600 mr-2">→</span>5–10 minutes per morning. Your list stays active without stealing client hours.
                </div>
</div>
...
<div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm font-medium text-slate-900">
<span className="text-indigo-600 mr-2">→</span>Fresh angles from your existing ideas that you genuinely didn't think of. The well never runs dry.
                </div>
</div>
</div>
...
<div className="max-w-6xl mx-auto">
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight mb-4">We Didn't Invent Storytelling.<br/><span className="text-slate-400">We Just Made It Daily.</span></h2>
</div>

<div className="max-w-3xl mx-auto text-center mb-24">
<iconify-icon className="text-slate-200 mb-6" icon="solar:quote-left-linear" width="40"></iconify-icon>
...
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight mb-4">Simple Pricing. Serious Storytelling.</h2>
...
<div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-xl flex flex-col h-full relative transform lg:-translate-y-4">
<div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-indigo-500 text-white px-3 py-1 rounded-full text-xs font-medium tracking-wide flex items-center gap-1">
...
<a className="w-full inline-flex justify-center items-center py-3 px-4 rounded-xl text-sm font-medium bg-white text-slate-900 hover:bg-slate-50 transition-colors shadow-sm" href="#">
                        Start 7-Day Free Trial →
                    </a>
</div>
<ul className="space-y-5 flex-1 mt-4 border-t border-slate-800 pt-8">
<li className="flex items-start gap-3">
<iconify-icon className="text-indigo-400 shrink-0 mt-0.5" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}} width="20"></iconify-icon>
<div>
...
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold text-slate-900 tracking-tight mb-4">Questions You're Probably Asking</h2>
</div>
<div className="space-y-4">

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
...
<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q6: What if I don't have stories or content ideas for my newsletter?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>You don't need a library of stories. You need one insight about your business — one belief your customers hold that you know is wrong, one lesson you've learned, one thing your industry gets backwards.</p>
<p>From that single insight, our Multi-Angle Generator creates multiple completely different story angles. Not variations of the same email — genuinely different approaches, different hooks, different emotional entry points.</p>
<p>One insight can fuel weeks of newsletter content. The well doesn't run dry because the AI finds angles you genuinely didn't think of — through psychology, competition analysis, myth-breaking, identity, and financial logic.</p>
<p>This is specifically designed for people who think "I don't have anything to write about." You do. You just need a tool that finds the stories hiding inside your business.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q7: I'm not a good writer. Will this help me write better newsletters?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>That's exactly who this is for.</p>
<p>You don't write newsletters from scratch. You don't stare at a blank page. The AI handles the hard part — finding the story angle, building the hook, structuring the belief shift, and drafting the full email.</p>
<p>Your job: pick the angle that feels right, tweak a line or two if you want, and hit send. The storytelling structure, the emotional arc, the persuasion framework — that's all built in.</p>
<p>Most users say they spend 5–10 minutes per newsletter. No writing courses required. No copywriting experience needed. If you can pick from a list and edit a sentence, you can send story-driven newsletters that outperform anything a "good writer" creates with a blank template.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q8: Will this work for my industry? I sell coaching, ecommerce, SaaS...
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>If you sell to humans, storytelling works. Full stop.</p>
<p>Stories aren't industry-specific — they're human-specific. What changes is the angle, not the framework. Here's how it looks across industries:</p>
<ul className="list-disc pl-5 space-y-1">
<li><strong>Coaches and course creators</strong> use it to share client transformation moments that make prospects think "I want that result."</li>
<li><strong>Ecommerce brands</strong> use it to tell origin stories that make customers feel connected to the brand, not just the product.</li>
<li><strong>SaaS founders</strong> use it to explain complex problems through simple stories that make readers realize they need the solution.</li>
<li><strong>Freelancers and consultants</strong> use it to build authority through daily insights that position them as the obvious expert to hire.</li>
</ul>
<p>The storytelling frameworks inside our AI newsletter generator are industry-agnostic by design. You bring the business insight. The AI finds the story that makes your specific audience care.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q9: What if my email list is small? Is it worth investing in a newsletter tool?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>A 500-person list that trusts you will outsell a 50,000-person list that ignores you. Every time.</p>
<p>Small lists are actually where story-driven newsletters work best. Here's why: with a small list, every subscriber matters more. Trust compounds faster because the relationship feels personal. And when you finally make an offer, a higher percentage converts because they've been reading your stories daily — not ignoring your monthly template blast.</p>
<p>The worst time to start daily storytelling is when your list is already big and cold. The best time is when your list is small and you can build trust from the beginning. By the time your list grows, you'll have an audience that actually opens, reads, replies, and buys.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q10: Does it work with my email platform? How do I send the newsletters?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>Yes — it works with every email platform.</p>
<p>We built Universal Export specifically so you never have to switch your ESP. Write your story-driven newsletter in our editor, then copy-paste directly into Beehiiv, Substack, Mailchimp, ConvertKit, Kit, Klaviyo, ActiveCampaign, or any other platform you already use.</p>
<p>We handle the writing. Your platform handles the sending. No complex integrations to configure. No migration headaches. No new tools to learn for your team. Just better newsletters going through the same system you already have.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q11: How long does it take to create one newsletter?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>5–10 minutes. Seriously.</p>
<p>Here's the process: drop in one insight about your business, your product, or your audience. The AI generates multiple story angles. Pick the one that feels right. Tweak a line if you want to. Send.</p>
<p>Compare that to writing from scratch: staring at a blank page for 30 minutes, drafting for an hour, editing for another hour, second-guessing yourself, and sending something you're not even happy with.</p>
<p>Most users say the hardest part isn't the writing anymore — it's choosing which angle to use, because there are too many good ones. That's a much better problem to have.</p>
</div>
</details>

<details className="group bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer p-6 font-medium text-slate-900 list-none">
                        Q12: Do you offer a free trial? What if I don't like it?
                        <span className="transition group-open:rotate-180">
<iconify-icon icon="solar:alt-arrow-down-linear" width="20"></iconify-icon>
</span>
</summary>
<div className="px-6 pb-6 text-sm text-slate-600 space-y-3 border-t border-slate-100 pt-4">
<p>Yes — 7-day free trial on the Starter plan. You get full access to the AI Story Engine, Multi-Angle Generator, Copy Chief Assistant, and all core features.</p>
<p>That's enough to generate several newsletters and see the difference storytelling makes compared to whatever you're doing now. Most users say they notice the difference within the first 3–5 newsletters — more replies, more engagement, more "I love your emails" messages.</p>
<p>If it's not for you, cancel anytime. No lock-in contracts. Upgrade or downgrade freely as your publishing pace changes.</p>
</div>
</details>
</div>
</div>
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl aspect-square bg-indigo-500/10 rounded-full blur-3xl pointer-events-none"></div>
<div className="max-w-2xl relative z-10">
<h2 className="text-4xl md:text-5xl font-semibold text-white tracking-tight mb-6">Create a Newsletter That Brings In Real Customers</h2>
...
<a className="inline-flex items-center justify-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-xl text-base font-medium hover:bg-slate-50 transition-colors shadow-sm mb-4" href="#pricing">
...
<div className="font-semibold text-base text-white tracking-tighter uppercase mb-4">
            STORYLINE
        </div>

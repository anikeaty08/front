...
gtag('config', 'G-2M6V79H761');
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Shimmer and Matrix animations replacing CSS keyframes
            ...
            gsap.to(".footer-letter", { 
                opacity: 1, rotationX: 0, rotationY: 0, y: 0, z: 0, duration: 1, stagger: 0.05, ease: "back.out(1.5)", 
                scrollTrigger: { trigger: ".footer-brand", start: "top 80%" } 
            });
...
<h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extralight tracking-tighter text-slate-900 leading-[1] mb-6 relative perspective-[1000px] z-20" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>
...
<button className="relative overflow-hidden flex items-center justify-center gap-3 px-8 py-3.5 text-sm font-light text-white bg-slate-900 rounded-full shadow-md hover:shadow-lg transition-all duration-300 group z-10 flex-1 sm:flex-none">
<div className="absolute inset-0 w-0 bg-gradient-to-r from-[#C2410C] to-[#ea580c] transition-all duration-500 ease-out group-hover:w-full z-0"></div>
...
<button className="relative flex items-center justify-center gap-2 px-8 py-3.5 text-sm font-light text-slate-600 bg-white/50 backdrop-blur-md border border-slate-200/80 hover:border-[#C2410C]/30 hover:bg-white rounded-full transition-all duration-300 flex-1 sm:flex-none group">
...
<div className="absolute top-3 left-4 text-xs font-mono font-light text-slate-500 z-10">Neural Net Output</div>
...
<div className="text-xs font-mono font-light text-emerald-400/60 leading-relaxed whitespace-nowrap" id="hero-scrolling-code">
...
<div className="text-xs text-orange-200/50 mb-1 font-mono font-light">Inference</div>
...
<span className="text-xs font-light text-emerald-400 font-mono" id="hero-percent">99.9%</span>
</div>
...
<div className="absolute -right-6 -bottom-6 text-7xl md:text-8xl font-extralight tracking-tighter text-slate-800 opacity-20 group-hover/card:text-[#C2410C] group-hover/card:opacity-10 transition-all duration-700 pointer-events-none" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>01</div>
<div className="relative z-10">
...
<div className="grid grid-cols-2 grid-rows-2 gap-4 h-full w-full">
<div className="col-span-2 row-span-1 bg-white/5 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between border border-white/5">
<div className="absolute -right-6 -bottom-6 text-7xl md:text-8xl font-extralight tracking-tighter text-slate-800 opacity-20 group-hover/card:text-[#C2410C] group-hover/card:opacity-10 transition-all duration-700 pointer-events-none" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>02</div>
<div className="relative z-10">
...
<div className="grid grid-cols-2 grid-rows-2 gap-4 h-full w-full">
<div className="col-span-2 row-span-1 bg-white/5 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between border border-white/5">
<div className="absolute -right-6 -bottom-6 text-7xl md:text-8xl font-extralight tracking-tighter text-slate-800 opacity-20 group-hover/card:text-[#C2410C] group-hover/card:opacity-10 transition-all duration-700 pointer-events-none" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>03</div>
<div className="relative z-10">
...
<div className="grid grid-cols-2 grid-rows-2 gap-4 h-full w-full">
<div className="col-span-2 row-span-1 bg-white/5 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between border border-white/5">
<div className="absolute -right-6 -bottom-6 text-7xl md:text-8xl font-extralight tracking-tighter text-slate-800 opacity-20 group-hover/card:text-[#C2410C] group-hover/card:opacity-10 transition-all duration-700 pointer-events-none" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>04</div>
<div className="relative z-10">
...
<div className="grid grid-cols-2 grid-rows-2 gap-4 h-full w-full">
<div className="col-span-2 row-span-1 bg-white/5 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between border border-white/5">
<div className="absolute -right-6 -bottom-6 text-7xl md:text-8xl font-extralight tracking-tighter text-slate-800 opacity-20 group-hover/card:text-[#C2410C] group-hover/card:opacity-10 transition-all duration-700 pointer-events-none" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>05</div>
<div className="relative z-10">
...
<h2 className="footer-brand flex justify-between w-full px-4 text-7xl sm:text-8xl md:text-9xl leading-[0.8] tracking-tighter text-[#C2410C] uppercase font-normal" style={{fontFamily: '\'Space Grotesk\', sans-serif'}}>

...
<div className="fixed top-0 w-full h-screen -z-10 bg-cover bg-center" data-alpha-mask="80" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3ab96646-c4fc-436c-929a-8449215f3419_3840w.png")', maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}></div>
...
<div className="flex bg-white w-8 h-8 rounded-lg items-center justify-center shadow-lg shadow-orange-900/10">
<span className="font-bold text-orange-600 text-xl lowercase leading-none pb-1">d</span>
</div>
<span className="text-xl font-semibold text-white tracking-tight drop-shadow-sm">
                    digalook
                </span>
</div>
<div className="hidden md:flex items-center gap-6">
<a className="text-sm font-medium text-white/90 hover:text-white transition-colors" href="#login">Log in</a>
<a className="bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-slate-800 transition-all shadow-xl border border-slate-700/50" href="#book">
                    Book Full Demo
                </a>
</div>
</div>
...
<div className="relative min-h-[100svh] flex items-center bg-orange-600 overflow-hidden">

<div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-orange-400 via-orange-600 to-orange-700"></div>
<div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-orange-700/50 to-transparent"></div>

<div className="opacity-[0.03] bg-[url('https://www.transparenttextures.com/patterns/noise.png')] absolute top-0 right-0 bottom-0 left-0"></div>
<div className="relative z-10 max-w-7xl mx-auto w-full px-6 grid lg:grid-cols-12 gap-12 items-center pt-20 pb-10">

<div className="lg:col-span-6 flex flex-col justify-center">

<div className="mb-8">
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm text-white text-xs font-medium tracking-wide uppercase mb-6">
<span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
                        Live System Status: Online
                    </div>
<h1 className="text-5xl lg:text-7xl font-semibold text-white tracking-tight leading-[1] mb-6 drop-shadow-md">
                        I’ll handle your 
                        calls &amp; messages. 
                        <span className="text-orange-200">24/7.</span>
</h1>
<p className="text-lg lg:text-xl text-orange-50 font-medium leading-relaxed max-w-lg mb-2">
                        Request a <span className="text-white font-semibold border-b border-white/40">FREE real-time demo</span>.
                    </p>
<p className="text-base text-orange-100 mb-8 max-w-md">
                        Our AI agent will call your phone immediately to simulate a customer booking.
                    </p>
</div>

<div className="relative group">

<div className="hidden lg:block absolute -right-12 top-1/2 -translate-y-1/2 translate-x-full">
<svg className="text-white/30 rotate-12" fill="none" height="60" viewbox="0 0 100 60" width="100">
<path d="M10 10 C 40 10, 60 50, 90 50" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="2"></path>
<path d="M85 45 L 90 50 L 85 55" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
<text className="text-xs font-medium fill-current" style={{fontFamily: '\'Inter\''}} x="10" y="30">No setup needed</text>
</svg>
</div>
<div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-2 shadow-2xl">
<form className="bg-white rounded-2xl p-6 sm:p-8 space-y-4 shadow-inner">
<div className="grid grid-cols-2 gap-4">
<div className="space-y-1.5">
<label className="text-xs font-semibold text-slate-500 uppercase tracking-wider ml-1">First Name</label>
<input className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium" placeholder="Jane" type="text"/>
</div>
<div className="space-y-1.5">
<label className="text-xs font-semibold text-slate-500 uppercase tracking-wider ml-1">Last Name</label>
<input className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium" placeholder="Doe" type="text"/>
</div>
</div>
<div className="space-y-1.5">
...
<input className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium" placeholder="+1 (555) 000-0000" type="tel"/>
</div>
</div>
<div className="space-y-1.5">
<label className="text-xs font-semibold text-slate-500 uppercase tracking-wider ml-1">Email</label>
<input className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium" placeholder="jane@company.com" type="email"/>
</div>
<button className="group relative w-full flex items-center justify-center gap-3 bg-slate-900 hover:bg-slate-800 text-white py-4 px-6 rounded-xl font-semibold text-lg transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 mt-2" type="button">
<div className="absolute inset-0 bg-white/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
<span className="relative">Try our AI receptionist now</span>
<svg className="lucide lucide-arrow-right relative transition-transform group-hover:translate-x-1" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
<div className="flex items-start gap-2 pt-2">
<input className="mt-1 w-4 h-4 rounded border-slate-300 text-orange-600 focus:ring-orange-500" id="consent" type="checkbox"/>
<label className="text-xs text-slate-400 leading-snug" htmlFor="consent">
                                    I consent to receiving a call from the AI agent for demo purposes. No spam, we promise.
                                </label>
</div>
</form>
</div>
...
<div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-8 text-orange-100 text-sm font-medium">
<div className="flex items-center gap-2">
<svg className="lucide lucide-check-circle text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><path d="M22 4 12 14.01l-3-3"></path></svg>
                        Instant Callback
                    </div>
<div className="flex items-center gap-2">
<svg className="lucide lucide-check-circle text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><path d="M22 4 12 14.01l-3-3"></path></svg>
...
<div className="hidden lg:block col-span-6 min-h-[600px] flex h-full relative items-end justify-center">

<div className="absolute bottom-0 right-0 w-[120%] h-[110%] pointer-events-none select-none">

<img alt="AI Receptionist Avatar" className="w-full h-full object-contain object-bottom drop-shadow-2xl mask-image-fade" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3ab96646-c4fc-436c-929a-8449215f3419_1600w.png" style={{WebkitMaskImage: 'linear-gradient(to top, black 80%, transparent 100%)'}}/>
</div>

<div className="absolute top-1/4 -left-10 bg-white/90 backdrop-blur-xl p-4 rounded-2xl shadow-xl border border-white/40 max-w-xs animate-in slide-in-from-bottom duration-1000 delay-300">
<div className="flex gap-3 items-center">
<div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600">
<svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><polyline points="16 2 16 8 22 8"></polyline><line x1="23" x2="16" y1="1" y2="8"></line><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
</div>
<div className="">
<p className="text-xs font-bold text-slate-500 uppercase">Status</p>
<p className="text-sm font-bold text-slate-900">Incoming Call Answered</p>
</div>
</div>
</div>
<div className="absolute bottom-1/4 -right-4 bg-white/90 backdrop-blur-xl p-4 rounded-2xl shadow-xl border border-white/40 max-w-xs animate-in slide-in-from-right duration-1000 delay-500">
<div className="flex gap-3 items-center">
<div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center text-orange-600">
<svg className="lucide lucide-calendar-check-2" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect height="18" rx="2" width="18" x="3" y="4"></rect><path d="M3 10h18"></path><path d="m9 16 2 2 4-4"></path></svg>
</div>
<div>
...
<a className="w-full md:w-auto text-center px-8 py-3 bg-slate-900 text-white font-medium rounded-full hover:bg-slate-800 transition-colors shadow-lg" href="#">
          Start Free Trial
        </a>
</div>
</div>
...
<div className="bg-white border-2 border-orange-500 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
<div className="absolute top-0 right-0 bg-orange-500 px-4 py-1.5 text-xs font-bold text-white uppercase tracking-wider rounded-bl-xl">
              Most Popular
            </div>
<div className="mb-8">
...
<p className="text-sm text-slate-500 mt-4">
                Ideal for small businesses and freelancers wanting to increase
                profits.
              </p>
</div>
<ul className="space-y-4 mb-8">
<li className="flex items-center gap-3 text-sm font-medium text-slate-700">
<svg className="lucide lucide-check w-5 h-5 text-orange-500" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<path d="M20 6 9 17l-5-5"></path>
                ...
                Includes VoIP line &amp; number
              </li>
<li className="flex items-center gap-3 text-sm font-medium text-slate-700">
<svg className="lucide lucide-check w-5 h-5 text-orange-500" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M20 6 9 17l-5-5"></path>
</svg>
                WhatsApp &amp; traditional calls
              </li>
<li className="flex items-center gap-3 text-sm font-medium text-slate-700">
<svg className="lucide lucide-check w-5 h-5 text-orange-500" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M20 6 9 17l-5-5"></path>
...
<a className="block w-full py-4 bg-orange-600 text-white text-center font-bold rounded-xl hover:bg-orange-700 transition-colors shadow-lg shadow-orange-200" href="#">
              Get Started
            </a>
</div>

<div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 hover:border-slate-300 transition-all">
<div className="mb-8">
<div className="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center text-slate-600 mb-4">
<svg className="lucide lucide-building w-6 h-6" data-lucide="building" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h3 className="text-slate-900 text-2xl font-bold mb-2">Enterprise</h3>
<div className="flex items-baseline gap-1">
...
<p className="text-sm text-slate-500 mt-4">
                For franchises or multi-location businesses needing attention at
                scale.
              </p>
</div>
<ul className="space-y-4 mb-8">
<li className="flex items-center gap-3 text-sm font-medium text-slate-600">
<svg className="lucide lucide-check w-5 h-5 text-slate-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M20 6 9 17l-5-5"></path>
</svg>
...
<a className="block w-full py-4 bg-white border border-slate-300 text-slate-700 text-center font-bold rounded-xl hover:bg-slate-100 transition-colors" href="#">
              Contact Sales
            </a>
</div>
</div>
...
<a className="inline-flex justify-center items-center px-10 py-5 rounded-full bg-slate-900 text-white font-bold hover:bg-slate-800 transition-all shadow-2xl hover:-translate-y-1" href="#">
            Start Today
          </a>
<a className="inline-flex justify-center items-center px-10 py-5 rounded-full bg-white text-orange-600 font-bold hover:bg-orange-50 transition-all shadow-xl" href="#">

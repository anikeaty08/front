...
<div className="z-1 absolute top-0 right-0 bottom-0 left-0" id="canvas-container"><canvas className="" height="1333" style={{display: 'block', width: '1227px', height: '889px'}} width="1840"></canvas><canvas className="" height="1333" style={{display: 'block', width: '1227px', height: '889px'}} width="1840"></canvas></div>

<main className="absolute inset-0 z-20 pointer-events-none flex flex-col justify-between p-6 md:p-12">

<header className="flex justify-between items-start animate-fade-in" style={{animationDelay: '0.1s'}}>

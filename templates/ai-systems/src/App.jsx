...
<canvas className="particles-js-canvas-el" height="2478" style={{width: '100%', height: '100%'}} width="3768"></canvas></div></div>
...
<img alt="" className="pointer-events-none w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/92a4234b-15fa-4d5f-8821-48d3f9f7e2f1_3840w.jpg" style={{}}/>
...
<a className="inline-flex items-center gap-2 transition hover:bg-white/10 hover:ring-white/20 text-sm font-medium text-white/90 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" data-element-id="aura-emgc2lheiw8tthm6" data-element-locator="html &gt; body:nth-of-type(1) &gt; div:nth-of-type(2) &gt; header:nth-of-type(1) &gt; div:nth-of-type(1) &gt; div:nth-of-type(1) &gt; nav:nth-of-type(1) &gt; a:nth-of-type(1)" href="/#solutions">
              Solutions
            </a>
<a className="inline-flex items-center gap-2 transition hover:bg-white/10 hover:ring-white/20 text-sm font-medium text-white/90 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" data-element-id="aura-emgc2llrexi4laxv" data-element-locator="html &gt; body:nth-of-type(1) &gt; div:nth-of-type(2) &gt; header:nth-of-type(1) &gt; div:nth-of-type(1) &gt; div:nth-of-type(1) &gt; nav:nth-of-type(1) &gt; a:nth-of-type(2)" href="/#showcase">
              Showcase
            </a>
<a className="inline-flex items-center gap-2 transition hover:bg-white/10 hover:ring-white/20 text-sm font-medium text-white/90 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" data-element-id="aura-emgc2lpszydobvts" data-element-locator="html &gt; body:nth-of-type(1) &gt; div:nth-of-type(2) &gt; header:nth-of-type(1) &gt; div:nth-of-type(1) &gt; div:nth-of-type(1) &gt; nav:nth-of-type(1) &gt; a:nth-of-type(3)" href="/#resources">
              Resources
            </a>
</nav>
</div>
...
<a className="hidden sm:inline-flex items-center gap-2 transition hover:bg-white/10 hover:ring-white/20 [animation:fadeSlideIn_1s_ease-out_0.2s_both] text-sm font-medium text-white/90 font-geist bg-white/5 ring-white/10 ring-1 rounded-full pt-2 pr-3.5 pb-2 pl-3.5 backdrop-blur-sm" data-element-id="aura-emgc2ltlfznlx104" data-element-locator="html &gt; body:nth-of-type(1) &gt; div:nth-of-type(2) &gt; header:nth-of-type(1) &gt; div:nth-of-type(1) &gt; div:nth-of-type(2) &gt; a:nth-of-type(1)" href="/#start">
            Get Started
          </a>
...
<main className="z-10 flex h-[calc(100vh-80px)] relative items-end" data-element-id="aura-emgc2jmgsqot961n" data-element-locator="html &gt; body:nth-of-type(1) &gt; div:nth-of-type(2) &gt; main:nth-of-type(1)">
...
<section className="overflow-hidden lg:py-20 pt-8 pb-8 relative" data-element-id="aura-emgc2e9bjov5gk8e" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(1)" id="solutions">
...
<div className="z-10 md:px-8 flex flex-col h-full max-w-7xl mr-auto ml-auto pr-6 pl-6 relative" data-element-id="aura-emgc2e9sspd8b6mm">
...
<div className="flex gap-2 h-24 gap-x-2 gap-y-2 items-end" data-element-id="aura-emgc8ego4">
<div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8e6ez" style={{height: '28px'}}></div>
<div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8e52k" style={{height: '46px'}}></div><div className="bg-white/10 w-4 rounded" style={{height: '46px'}}></div>
<div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8e4jj" style={{height: '54px'}}></div>
<div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8e3v9" style={{height: '64px'}}></div><div className="bg-orange-400/70 w-4 rounded" style={{height: '88px'}}></div>
<div className="bg-orange-400/80 w-4 rounded" style={{height: '96px'}}></div><div className="bg-orange-400/80 w-4 rounded" data-element-id="aura-emgc8e1b9" style={{height: '96px'}}></div><div className="bg-orange-400/70 w-4 rounded" data-element-id="aura-emgc8e2be" style={{height: '88px'}}></div><div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8ej5a" style={{height: '64px'}}></div><div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8f2v1" style={{height: '54px'}}></div><div className="bg-white/10 w-4 rounded" data-element-id="aura-emgc8e7a6" style={{height: '28px'}}></div><div className="bg-white/10 w-4 rounded" style={{height: '28px'}}></div>
</div>
...
<img alt="Face scan" className="min-h-[256px] md:min-h-[320px] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/863c6d3d-359c-471a-8fd8-543677b59c4c_800w.webp"/>
...
<section className="overflow-hidden lg:py-24 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d521c037-f8b6-43a7-ae68-c6c1d0215733_3840w.webp)] bg-cover pt-16 pb-16 relative" data-element-id="aura-emgc2k9npsqxgjwr" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(2)" id="showcase">
...
<img alt="Team portrait" className="w-48 h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/20253914-1507-436f-a56d-f7abbc5d0c73_800w.webp"/>
</div>
<p className="text-[11px] text-slate-400 font-geist mt-2">Mia Chen — Lead Researcher</p>
</div>
<div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 gap-x-8 gap-y-8 items-center" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(2) &gt; div:nth-of-type(3) &gt; div:nth-of-type(1)">

<div className="lg:col-span-7">
<div className="aspect-[16/11] md:aspect-[5/4] overflow-hidden rounded-3xl relative">
<img alt="Generative systems visual" className="[animation:parallaxElement_linear_both] [animation-timeline:view()] [animation-range:entry_0%_entry_100%] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2bad1237-d4b7-4abc-a4ff-4bb6e105b47d_1600w.png"/>
</div>
</div>
...
<h2 className="animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.15s_both] sm:text-5xl md:text-6xl md:font-normal md:tracking-tighter text-4xl font-semibold tracking-tight font-geist mt-4" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(2) &gt; div:nth-of-type(3) &gt; div:nth-of-type(1) &gt; div:nth-of-type(2) &gt; h2:nth-of-type(1)">
            Outcomes, Engineered with Intention
          </h2>
<p className="md:mt-5 md:text-lg leading-relaxed animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.25s_both] text-base text-white/70 font-geist mt-5" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(2) &gt; div:nth-of-type(3) &gt; div:nth-of-type(1) &gt; div:nth-of-type(2) &gt; p:nth-of-type(1)">
...
<a className="group inline-flex items-center gap-2 mt-6 text-sm font-medium font-geist text-white underline decoration-white/30 underline-offset-4 hover:decoration-white/60 animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.35s_both]" href="#">
            Discover our work
            <svg className="lucide lucide-arrow-right w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" data-lucide="arrow-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
</div>
</div>
</section><section className="overflow-hidden lg:py-24 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/72c90007-7638-4902-8dda-5a6c20e92741_3840w.jpg)] bg-cover pt-16 pb-16 relative" data-element-id="aura-emgc2kprpuw6pszh" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3)" id="resources">
...
<div className="inline-flex text-[11px] ring-1 ring-white/10 animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.05s_both] font-medium text-white/70 font-geist bg-white/5 rounded-full pt-1.5 pr-3 pb-1.5 pl-3 gap-x-2 gap-y-2 items-center" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(1) &gt; div:nth-of-type(1)">Key Features</div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mt-10 gap-x-6 gap-y-6" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2)">

<div className="md:p-6 overflow-hidden animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.2s_both] bg-slate-900/50 ring-white/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(1)">
...
<img alt="Seamless connection" className="opacity-70 w-full h-full object-cover" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(1) &gt; img:nth-of-type(1)" data-element-src="https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&amp;w=1600&amp;auto=format&amp;fit=crop" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/459579f4-e2d0-4218-a12d-f974a4b89651_800w.jpg"/>
<div className="bg-gradient-to-t from-slate-950/80 via-slate-950/30 to-transparent absolute top-0 right-0 bottom-0 left-0" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(1) &gt; div:nth-of-type(1)"></div>
</div>
...
<div className="md:p-6 overflow-hidden animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.36s_both] bg-slate-900/50 ring-white/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(2) &gt; div:nth-of-type(3)">
...
<div className="flex flex-wrap animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.4s_both] mt-10 gap-x-3 gap-y-3" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(3) &gt; div:nth-of-type(2) &gt; div:nth-of-type(3)">
...
</section><section className="overflow-hidden lg:py-24 pt-16 pb-16 relative" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(4)">
...
<div className="z-10 md:px-8 max-w-7xl mr-auto ml-auto pr-6 pl-6 relative" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(4) &gt; div:nth-of-type(2)">
...
<a className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-white/10 text-white ring-1 ring-white/15 px-4 py-2.5 text-sm font-medium font-geist hover:bg-white/15 transition w-full" href="#">
        Get Started
      </a>
</div>
...
<a className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-white text-neutral-900 ring-1 ring-white/20 px-4 py-2.5 text-sm font-medium font-geist hover:bg-neutral-100 transition w-full" href="#">
        Start Free Trial
      </a>
</div>
...
</section><section className="overflow-hidden lg:py-24 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/32b67867-f241-44ab-a57c-c87e60b99c25_3840w.webp)] bg-cover pt-16 pb-16 relative" data-element-id="aura-emgc2l778vludacc" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(5)" id="start">
...
<div className="z-10 md:px-8 animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.1s_both] max-w-7xl mr-auto ml-auto pr-6 pl-6 relative" data-element-locator="html &gt; body:nth-of-type(1) &gt; section:nth-of-type(5) &gt; div:nth-of-type(2)">
...
</section><footer className="overflow-hidden bg-slate-950 border-white/5 border-t relative" data-element-locator="html &gt; body:nth-of-type(1) &gt; footer:nth-of-type(1)">
...
<div className="z-10 md:px-8 lg:py-20 max-w-7xl mr-auto ml-auto pt-16 pr-6 pb-16 pl-6 relative" data-element-locator="html &gt; body:nth-of-type(1) &gt; footer:nth-of-type(1) &gt; div:nth-of-type(2)">
...
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Changelog</a></li>
</ul>
</div>
...
<ul className="mt-4 space-y-3">
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">About</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Blog</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Careers</a></li>
...
<ul className="mt-4 space-y-3">
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Documentation</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Help Center</a></li>
...
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Security</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition font-geist" href="#">Cookies</a></li>
</ul>
</div>
</div>

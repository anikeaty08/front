...
<div className="flex text-white bg-gradient-to-br from-white/10 to-white/5 w-28 h-9 border-white/10 border rounded-full items-center justify-center">Marqait</div>

<div className="hidden md:flex items-center px-4 gap-6">
<a className="hover:text-neutral-200 transition-colors text-sm font-medium text-white" href="#" style={{}}>Header 1</a>
<a className="hover:text-white transition-colors text-sm font-medium text-neutral-400" href="#" style={{}}>Header 2</a>
<a className="hover:text-white transition-colors text-sm font-medium text-neutral-400" href="#" style={{}}>Header 3</a>
<a className="hover:text-white transition-colors text-sm font-medium text-neutral-400" href="#" style={{}}>Header 4</a>
</div>
...
<span className="text-sm font-medium text-white" style={{}}>Get Started</span>
...
<span className="text-sm font-medium text-indigo-100" style={{}}>AI Workflows</span>
</div>
...
<span className="block" style={{}}>NEURAL</span>
<span className="block mt-2 text-white/80">AUTOMATION</span>
</h1>


<p className="md:text-xl leading-relaxed [animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll animate text-lg font-normal text-neutral-400 text-center max-w-2xl mt-8" style={{}}>Orchestrate autonomous agents that plan, execute, and optimize marketing processes in real-time. Replace manual toil with intelligent logic.</p>
...
<span className="text-xs font-medium text-neutral-400" style={{}}>Header Text</span>
...
<span className="text-sm font-medium text-white" style={{}}>Webhook Event</span>
</div>
...
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:mail" data-icon-replaced="true" data-icon-set="lucide" data-lucide="mail" fill="none" height="16" role="img" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(163, 163, 163)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20" x="2" y="4"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
...
<span className="text-sm font-medium" style={{}}>Analyze Sentiment</span>
<span className="text-[10px] text-neutral-500" style={{}}>Gemini 3.5 Pro</span>
</div>
</div>
...
<span className="text-[10px] text-neutral-500" style={{}}>Vision Model</span>
</div>
</div>
...
<div className="overflow-hidden flex-1 bg-gradient-to-br from-black/10 to-black/0 w-full rounded-xl mb-4 relative" style={{position: 'relative', -BorderGradient: 'linear-gradient(90deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', -BorderRadiusBefore: '12px'}}>
...
<div className="flex-1 overflow-y-auto custom-scrollbar bg-neutral-950/40 rounded-lg pt-4 pr-4 pb-4 pl-4" style={{position: 'relative', -BorderGradient: 'linear-gradient(90deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', -BorderRadiusBefore: '8px'}}>
...
<textarea className="-edit" style={{fontSize: '14px', fontWeight: '500', fontFamily: 'Inter, sans-serif', color: 'rgb(255, 255, 255)', lineHeight: '20px', textAlign: 'start', textTransform: 'none', letterSpacing: 'normal', position: 'absolute', left: '204.875px', top: '194.6px', width: '104.75px', height: '20px', boxSizing: 'border-box', padding: '0px', margin: '0px', border: 'none', outline: 'none', background: 'transparent', resize: 'none', overflow: 'auto', zIndex: '2147483647'}}></textarea><textarea className="-edit" style={{fontSize: '144px', fontWeight: '600', fontFamily: 'Inter, sans-serif', color: 'rgba(0, 0, 0, 0)', lineHeight: '115.2px', textAlign: 'center', textTransform: 'none', letterSpacing: '-7.2px', position: 'absolute', left: '297.863px', top: '298.8px', width: '917.075px', height: '115.2px', boxSizing: 'border-box', padding: '0px', margin: '0px', border: 'none', outline: 'none', background: 'transparent', resize: 'none', overflow: 'auto', zIndex: '2147483647'}}></textarea>
    </>
  );
}

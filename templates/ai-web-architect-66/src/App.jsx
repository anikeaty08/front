...
<a className="font-brand tracking-widest text-lg text-white hover:text-cyan-400 transition-colors duration-300" href="#">
          VA
          <span className="text-cyan-500 text-xs align-top">AI</span>
</a>
...
<p className="text-lg md:text-xl text-slate-400 max-w-2xl font-light tracking-wide animate-title border-l-2 border-cyan-500 pl-6">
            The full-stack partner for founders and enterprises building the future.
            We deploy modern, fast architectures and autonomous agents that help close more customers.
          </p>
...
<div className="p-2 border border-white/10 rounded bg-black/50 backdrop-blur hover:border-cyan-500/50 transition-colors">
<i className="w-5 h-5 text-cyan-400" data-lucide="bot"></i>
</div>
<div className="p-2 border border-white/10 rounded bg-black/50 backdrop-blur hover:border-cyan-500/50 transition-colors">
...
<a className="group flex items-center gap-4 text-xl text-white hover:text-cyan-400 transition-colors" href="mailto:hello@vaultagentics.ai">
...
<span className="font-light tracking-wide">hello@vaultagentics.ai</span>
</a>
...
<h5 className="font-brand text-2xl text-white mb-2">VAULTAGENTICS</h5>

...
<div className="loader fixed flex uppercase text-2xl font-semibold text-orange-500 tracking-[0.3em] bg-stone-950 z-[100] top-0 right-0 bottom-0 left-0 items-center justify-center" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0%, -100%)'}}>bienvenido a cvefectiva</div><nav className="fixed top-0 left-0 w-full px-6 md:px-12 py-8 flex justify-between items-center z-50 text-[#291D00]">
<a className="uppercase flex items-center gap-2 text-lg font-semibold tracking-[0.3em]" href="#">cvefectiva</a>
...
<svg aria-hidden="true" data-icon="lucide:menu" data-width="18" height="18" role="img" strokeWidth="1.5" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16M4 12h16M4 19h16" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</button>
</nav>
...
<img alt="Architectural Concrete" className="hero-img w-full h-full object-cover scale-110 grayscale contrast-125" src="https://images.unsplash.com/photo-1516962215378-7fa2e137ae93?q=80&amp;w=2570&amp;auto=format&amp;fit=crop" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}/>
<div className="bg-slate-50 absolute top-0 right-0 bottom-0 left-0"></div>
</div>
<div className="z-10 flex flex-col gap-8 mt-20 relative gap-x-8 gap-y-8 items-start">
...
<span className="hero-line block overflow-hidden"><span className="block translate-y-full" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>A L B A</span></span>
</h1>
...
<span className="block translate-y-full" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>Engineered <span className="text-[#934910]" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>Clarity.</span></span>
</h2>
<p className="hero-line text-sm md:text-base font-normal text-[#291D00]/70 leading-[1.7] overflow-hidden max-w-lg">
<span className="block translate-y-full" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>Digitale architectuur in zijn puurste vorm. Wij combineren ruwe esthetiek met verfijnde technologie voor tijdloze systemen.</span>
</p>
<div className="hero-line overflow-hidden pt-4">

<a className="block translate-y-full inline-flex items-center gap-3 text-xs font-semibold tracking-widest uppercase bg-[#291D00] text-[#B8B8B8] px-8 py-4 border border-[#291D00] hover:bg-transparent hover:text-[#291D00] transition-all duration-300 group shadow-lg shadow-[#291D00]/10" href="#contact" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>
                                Start een project
...
<p className="reveal-text text-lg md:text-xl leading-[1.7] text-[#291D00]/80 font-normal" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)', opacity: '1'}}>
...
<img alt="Brushed Metal Texture" className="w-full h-full object-cover grayscale brightness-110 contrast-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'scale(1.2, 1.2)'}}/>
<div className="absolute inset-0 bg-[#291D00]/5 mix-blend-overlay"></div>
</div>
</div>
</section>

<div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1440px', height: '2376px', padding: '0px 0px 1392px'}}><div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1440px', height: '2376px', padding: '0px 0px 1392px'}}><div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1440px', height: '2376px', padding: '0px 0px 1392px'}}><div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1440px', height: '2376px', padding: '0px 0px 1392px'}}><div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1440px', height: '2376px', padding: '0px 0px 1392px'}}><section className="relative py-20 bg-[#B8B8B8] text-[#291D00] overflow-hidden border-t border-b border-[#291D00]/10" id="work" style={{translate: 'none', rotate: 'none', scale: 'none', inset: '0px auto auto 0px', margin: '0px', maxWidth: '1440px', width: '1440px', maxHeight: '984.391px', height: '984.391px', padding: '80px 0px', transform: 'translate(0px, 0px)'}}>
...
<svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                        Sleep om te ontdekken
                    </div>
</div>
<div className="horizontal-scroll-container w-full overflow-hidden">
<div className="horizontal-wrapper flex gap-6 md:gap-12 px-6 md:px-12 w-fit" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>
...
<img alt="Konzenzie" className="w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-all duration-700 scale-100 group-hover:scale-105 grayscale contrast-125" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
</div>
...
<div className="w-full h-[40vh] md:h-[60vh] overflow-hidden bg-[#A0A0A0] border border-[#291D00]/10 relative rounded-sm">
<div className="absolute inset-0 bg-[#291D00]/0 group-hover:bg-[#291D00]/10 transition-colors duration-500 z-10"></div>
<img alt="Veldboom" className="w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-all duration-700 scale-100 group-hover:scale-105 grayscale contrast-125" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
</div>
<div className="flex flex-col gap-2">
<div className="flex justify-between items-baseline border-b border-[#291D00]/20 pb-2 group-hover:border-[#934910] transition-colors">
...
<div className="marquee-track flex gap-0 text-[6vw] md:text-[4vw] font-light uppercase tracking-tight leading-none text-[#934910]/30" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(-44.456%, 0%) translate3d(0px, 0px, 0px)'}}>
...
<span className="block" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0', transform: 'translate(0px, 100px)'}}>Klaar voor de</span>
<span className="block text-[#934910]" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0', transform: 'translate(0px, 100px)'}}>Transformatie?</span>
</div>
</div>
...
<div className="footer-col" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0', transform: 'translate(0px, 20px)'}}>
...
<button className="flex items-center gap-2 hover:text-[#FFEA47] transition-colors group" onclick="window.lenis.scrollTo(0)">
                        Back to Top <svg aria-hidden="true" data-icon="lucide:arrow-up" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="m5 12l7-7l7 7m-7 7V5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</button>
</div>
</footer>
</div>

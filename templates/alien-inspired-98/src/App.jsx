...
<img alt="Monospace" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105" src="https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
</div>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded-tl-[200px] rounded-tr-[10px] rounded-bl-[10px] rounded-br-[200px] bg-neutral-100 relative">
<img alt="Objet Noir" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105" src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
</div>
<div className="mt-4 flex justify-between items-start">
<div>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded-tl-[200px] rounded-tr-[10px] rounded-bl-[10px] rounded-br-[200px] bg-neutral-100 relative">
<img alt="Vogue Edit" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105" src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&amp;w=2727&amp;auto=format&amp;fit=crop"/>
</div>
<div className="mt-4 flex justify-between items-start">
<div>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded-tl-[200px] rounded-tr-[10px] rounded-bl-[10px] rounded-br-[200px] bg-neutral-100 relative">
<img alt="Clay Forms" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105" src="https://images.unsplash.com/photo-1516483638261-f4dbaf036963?q=80&amp;w=986&amp;auto=format&amp;fit=crop"/>
</div>
<div className="mt-4 flex justify-between items-start">
<div>
...
<div className="group cursor-pointer">
<div className="relative w-full aspect-square bg-neutral-100 rounded-[100px] overflow-hidden mb-6">
<img alt="Neon Abstract" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://images.unsplash.com/photo-1563089145-599997674d42?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
</div>
<div className="flex justify-between items-baseline px-2">

...
<div className="absolute inset-0 -z-10" id="particles-js"><canvas className="particles-js-canvas-el" height="0" style={{width: '100%', height: '100%'}} width="0"></canvas></div>
</div>
...
<a className="nav-link flex-shrink-0 flex gap-1.5 items-center transition-colors text-xs font-medium rounded-full pt-1.5 pr-4 pb-1.5 pl-4" href="#projects">
...
<section className="flex flex-col min-h-screen overflow-hidden pt-32 pb-32 relative justify-center">

<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-indigo-100/50 via-purple-100/30 to-rose-100/50 dark:from-indigo-900/10 dark:via-purple-900/10 dark:to-rose-900/10 blur-[100px] rounded-full -z-10 pointer-events-none">
</div>
<div className="w-full max-w-6xl mr-auto ml-auto pr-35 pl-35">
...
<h1 className="leading-tight dark:text-white sm:text-4xl md:text-5xl lg:text-6xl text-3xl font-medium text-zinc-900 tracking-tight mb-12">
<span className="inline-block origin-bottom-right hover:rotate-12 transition-transform duration-300">🏕️</span>
      Hi, I'm Shafin
      <span className="inline-block align-middle">
<img alt="Profile" className="h-[1em] object-top w-auto object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c4577a00-fb58-4059-bcc9-7b63bfb2351d_800w.png"/>
</span>
      a Web Designer, Enthusiast &amp; a CS Student <span className="inline-block animate-pulse">✨</span>
<span className="dark:text-zinc-500 selection:bg-zinc-200 dark:selection:bg-zinc-800 selection:text-zinc-400 text-zinc-400">
...
<a className="group relative overflow-hidden dark:bg-white dark:text-black transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 hover:shadow-xl sm:w-auto text-sm font-semibold text-white bg-zinc-900 w-full rounded-full px-8 py-4 shadow-lg" href="#projects">
<span className="relative z-10 flex items-center gap-2">
          View Selected Work
          <svg className="group-hover:translate-x-1 transition-transform" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14"></path>
<path d="m12 5 7 7-7 7"></path>
</svg>
</span>
</a>
<a className="w-full sm:w-auto px-8 py-4 rounded-full border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-zinc-900/50 text-zinc-900 dark:text-white font-semibold text-sm transition-all hover:bg-white dark:hover:bg-zinc-800 hover:shadow-md" href="#contact">
        Get in Touch
      </a>
</div>
</div>
...
<div className="grid grid-cols-2 md:grid-cols-4 max-w-5xl mr-auto ml-auto pt-7 pr-6 pb-7 pl-6 gap-x-8 gap-y-8">
...
<section className="dark:bg-black/60 pt-24 pb-24" id="projects">
<div className="max-w-6xl mx-auto px-6">
<h2 className="text-5xl md:text-6xl font-medium tracking-tighter mb-20 dark:text-white text-zinc-900">My Projects</h2>
...
<h4 className="mt-12 text-center font-bold text-2xl leading-tight max-w-[80%] z-10 text-zinc-900">We stimulate your business growth!</h4>
</div>
</div>
...
<div className="group cursor-pointer">
<div className="p-3 dark:bg-zinc-900 rounded-[2rem] shadow-sm border dark:border-white/10 transition-transform duration-500 hover:-translate-y-2 hover:shadow-xl bg-white border-zinc-200">
<div className="aspect-[4/3] overflow-hidden flex flex-col bg-[#F5F5F7] w-full border-white/50 rounded-[1.5rem] border-t border-l pt-8 pl-8 relative">
...
<div className="flex gap-4 text-[10px] font-medium text-zinc-400"><span className="">About</span><span className="">Features</span><span>Contacts</span><span className="px-2 py-0.5 rounded bg-black text-white">Log in</span></div>
</div>
<h4 className="leading-none text-3xl font-extrabold text-zinc-900 tracking-tight mb-2">Your passport to cashback rewards</h4>
...
<div className="w-48 h-64 rounded-lg shadow-2xl p-3 flex flex-col gap-2 transform rotate-[-2deg] opacity-90 hover:scale-105 transition-transform bg-zinc-100">
...
<div className="w-40 h-72 rounded-2xl shadow-2xl p-4 flex flex-col gap-3 transform translate-y-4 hover:scale-105 transition-transform z-20 bg-white">
...
<div className="h-32 rounded-xl border p-2 bg-zinc-50 border-zinc-100">
...
<div className="h-8 w-full rounded-lg shadow-lg text-[6px] flex items-center justify-center bg-emerald-900 text-white">Claim now</div>
</div>
<div className="w-48 h-60 bg-[#FBF8F1] rounded-lg shadow-2xl p-3 transform rotate-[2deg] translate-y-8 opacity-90 hover:scale-105 transition-transform">
...
<section className="dark:bg-black/60 overflow-hidden pt-32 pb-32 relative" id="how-i-build">
<div className="max-w-5xl mx-auto px-6">
<h2 className="md:text-6xl dark:text-white text-5xl font-medium text-zinc-900 tracking-tighter mb-20">How I Build</h2>
...
<section className="dark:bg-black/60 pt-32 pb-32" id="expertise">
<div className="max-w-5xl mx-auto px-6">
<div className="mb-24">
<h2 className="md:text-6xl dark:text-white text-5xl font-medium text-zinc-900 tracking-tight mb-6">I've got your back with...</h2>
...
<div className="relative h-[280px] w-full max-w-2xl mx-auto mb-28 group">

...
<div className="loader" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0%, -100%)'}}>
<div className="loader-text" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0', transform: 'translate(0px, -50px)'}}>AETHEREAL</div>
...
<img alt="Hero" className="absolute inset-0 w-full h-full object-cover brightness-75 hero-img" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/482e7b6a-168c-4d0d-b35d-0e2ff4014577_3840w.webp" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}/>
...
<span className="block translate-y-full" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>CONCRETE</span>
</h1>
<h1 className="display text-[12vw] leading-none hero-text overflow-hidden">
<span className="block translate-y-full" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 0px)'}}>DREAMS</span>
</h1>

<p className="mt-8 text-sm uppercase tracking-[0.5em] opacity-0 hero-fade mix-blend-difference" style={{opacity: '1'}}>Future Architecture</p>
</div>
</section>

<section className="py-32 px-6 md:px-20 grid md:grid-cols-2 gap-16 max-w-[1800px] mx-auto bg-[var(--c-bg)]">
<div>
<h2 className="display text-4xl md:text-5xl leading-tight split-animate"><span className="word-wrap"><span className="word-inner" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 110%)'}}>Structure </span></span><span className="word-wrap"><span className="word-inner">as
sculpture. </span></span></h2>
</div>
<div className="text-xl font-light leading-relaxed text-gray-700">
<p className="mb-8 split-animate"><span className="word-wrap"><span className="word-inner" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 108.333%)'}}>We </span></span><span className="word-wrap"><span className="word-inner">believe </span></span><span className="word-wrap"><span className="word-inner">that </span></span><span className="word-wrap"><span className="word-inner">architecture </span></span><span className="word-wrap"><span className="word-inner">is </span></span><span className="word-wrap"><span className="word-inner">frozen </span></span><span className="word-wrap"><span className="word-inner">music. </span></span><span className="word-wrap"><span className="word-inner">Our </span></span><span className="word-wrap"><span className="word-inner">studio </span></span><span className="word-wrap"><span className="word-inner">specializes </span></span><span className="word-wrap"><span className="word-inner">in </span></span><span className="word-wrap"><span className="word-inner">brutalist </span></span><span className="word-wrap"><span className="word-inner">forms </span></span><span className="word-wrap"><span className="word-inner">softened </span></span><span className="word-wrap"><span className="word-inner">by </span></span><span className="word-wrap"><span className="word-inner">biophilic </span></span><span className="word-wrap"><span className="word-inner">integration. </span></span><span className="word-wrap"><span className="word-inner">We </span></span><span className="word-wrap"><span className="word-inner">create </span></span><span className="word-wrap"><span className="word-inner">spaces </span></span><span className="word-wrap"><span className="word-inner">that </span></span><span className="word-wrap"><span className="word-inner">do </span></span><span className="word-wrap"><span className="word-inner">not </span></span><span className="word-wrap"><span className="word-inner">just </span></span><span className="word-wrap"><span className="word-inner">shelter, </span></span><span className="word-wrap"><span className="word-inner">but </span></span><span className="word-wrap"><span className="word-inner">inspire. </span></span></p>
<div className="h-px w-full bg-black/10 my-8"></div>
<div className="flex gap-12 text-sm uppercase tracking-widest split-animate"><span className="word-wrap"><span className="word-inner" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0px, 110%)'}}>EST. </span></span><span className="word-wrap"><span className="word-inner">2024
TOKYO </span></span><span className="word-wrap"><span className="word-inner">/ </span></span><span className="word-wrap"><span className="word-inner">LONDON </span></span></div>
</div>
</section>
...
<div className="card-inner" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '1', transform: 'translate(0px, 0px)'}}>
...
<div className="relative z-10 text-center" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0.5', transform: 'translate(0px, 100px) scale(0.9, 0.9)'}}>

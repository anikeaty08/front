...
<iconify-icon className="text-6xl" icon="simple-icons:nasa"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:spacex"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:uber"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:visa"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:sony"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:bose"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:nasa"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:spacex"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:uber"></iconify-icon>
<iconify-icon className="text-6xl" icon="simple-icons:visa"></iconify-icon>

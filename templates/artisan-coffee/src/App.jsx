...
(function(){const once=true;if(!window.__inViewIO){window.__inViewIO=new IntersectionObserver((entries)=>{entries.forEach((entry)=>{if(entry.isIntersecting){entry.target.classList.add('animate');if(once)window.__inViewIO.unobserve(entry.target);}});},{threshold:0.2,rootMargin:'0px 0px -10% 0px'});}window.initInViewAnimations=function(selector='.animate-on-scroll'){document.querySelectorAll(selector).forEach((el)=>{window.__inViewIO.observe(el);});};document.addEventListener('DOMContentLoaded',()=>initInViewAnimations());})();
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen -z-10 bg-cover bg-center mix-blend-soft-light opacity-50" data-alpha-mask="80" id="aura-image" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e8a73c34-737c-4f43-bbd4-ce204f94152c_3840w.webp")', maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}></div>
...
<span className="bg-center text-3xl italic text-white tracking-tight font-script w-[120px] h-[36px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a68dc15f-fb85-48af-b6c2-5c189e6f4c23_1600w.png)] bg-cover"></span>
</a>
...
<img alt="Forest-inspired coffee bag under studio spotlight" className="z-10 w-full max-w-md object-cover rounded-xl relative shadow-2xl" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b4de7807-d550-431a-b3c2-07885c82aef4_1600w.jpg"/>
</div>
...
<img alt="Steaming Latte in Kraft Paper Cup" className="w-full h-72 sm:h-80 lg:h-[360px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/dfb3b1af-e254-413c-9eee-298cb5f9a877_800w.jpg"/>
</div>
<div className="rounded-2xl overflow-hidden border border-amber-900/30 bg-amber-950/20 hover-lift">
<img alt="Paper cup latte with heart latte art" className="w-full h-72 sm:h-80 lg:h-[360px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e91ebfd7-5404-48d3-a52f-3b1820ecc451_800w.webp"/>
</div>
<div className="rounded-2xl overflow-hidden border border-amber-900/30 bg-amber-950/20 hover-lift">
<img alt="Minimal smartphone flat lay with coffee" className="w-full h-72 sm:h-80 lg:h-[360px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9135951f-bf3a-47d0-b8e0-04b5cecefaac_800w.webp"/>
</div>
<div className="rounded-2xl overflow-hidden border border-amber-900/30 bg-amber-950/20 hover-lift">
<img alt="Sleek black coffee bags with floating beans" className="w-full h-72 sm:h-80 lg:h-[360px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b480f873-fdea-4b10-95db-08a8ebc3d830_800w.webp"/>
</div>
</div>
</div>
</div>
...
<div className="overflow-hidden bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/70fcd867-fd43-4c84-9ad4-393392e5c36e_800w.jpg)] bg-cover rounded-2xl ring-amber-900/30 ring-1 relative">
...
<span className="bg-center text-3xl italic text-white tracking-tight font-script w-[60px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a68dc15f-fb85-48af-b6c2-5c189e6f4c23_1600w.png)] bg-cover"></span>

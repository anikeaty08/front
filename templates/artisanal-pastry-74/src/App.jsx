...
<span className="text-xl italic text-slate-50 tracking-widest font-['Instrument_Serif',serif] opacity-100 tracking-tight">
            TRADIȚIE DULCE
          </span>
<div className="h-px w-16 bg-white/40"></div>
</div>
<a className="group relative overflow-hidden bg-transparent hover:bg-white hover:text-[#7D1D1D] transition-all duration-500 ease-out text-white border border-white/30 px-8 py-3.5 inline-block rounded-sm" href="#">
...
<span className="text-[#7D1D1D] font-normal tracking-[0.2em] uppercase text-xs">
...
<span className="font-['Inter',sans-serif] font-normal text-lg text-[#7D1D1D] leading-none tracking-tight">
                125 RON
              </span>
</div>
...
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Gramaj:
                <span className="text-stone-500">1.2 kg</span>
</p>
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Ingrediente:
                <span className="text-stone-500">Cacao, Vișine, Frișcă</span>
</p>
</div>
</div>
<div className="w-[340px] flex-shrink-0 group select-none pointer-events-none md:pointer-events-auto">
...
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Cantitate:
                <span className="text-stone-500">Cutie 6 buc</span>
</p>
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Arome:
                <span className="text-stone-500">Fistic, Zmeură, Ciocolată</span>
</p>
</div>
</div>
<div className="w-[340px] flex-shrink-0 group select-none pointer-events-none md:pointer-events-auto">
...
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Gramaj:
                <span className="text-stone-500">120g / buc</span>
</p>
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Ingrediente:
                <span className="text-stone-500">Cremă vanilie, Glazură</span>
</p>
</div>
</div>
<div className="w-[340px] flex-shrink-0 group select-none pointer-events-none md:pointer-events-auto">
...
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Gramaj:
                <span className="text-stone-500">180g / porție</span>
</p>
<p className="text-xs uppercase text-[#7D1D1D] font-light tracking-wide">
                Ingrediente:
                <span className="text-stone-500">Mascarpone, Cafea, Pișcoturi</span>
</p>
</div>
</div>
...
<p className="text-lg text-stone-600 font-['Inter',sans-serif] leading-relaxed font-extralight tracking-tight">
                Din 1995, la Cofetaria Alex am păstrat intactă pasiunea pentru
...
<span className="block text-xs uppercase text-white/80 tracking-[0.25em] font-['Inter',sans-serif] text-center">
                  pentru detalii
                </span>
</div>
</div>
...
<span className="font-['Instrument_Serif',serif] italic text-[#7D1D1D] text-xl mb-4 block tracking-tight">
              Esența Noastră
            </span>
...
<p className="text-stone-600 font-['Inter',sans-serif] text-sm leading-relaxed font-extralight">
                  Cofetaria Alex a pornit din dorința de a aduce pe mesele
...
<span className="absolute top-8 left-0 text-[#7D1D1D] text-4xl font-['Instrument_Serif',serif] font-semibold opacity-20 tracking-tight">
                “
              </span>
...
<span className="text-[#F5E6CA] font-['Instrument_Serif',serif] italic text-2xl tracking-widest uppercase">
            Creat cu Pasiune
          </span>
...
<p className="font-['Inter',sans-serif] text-white/60 font-light text-base">
...
<div>
<h4 className="text-lg font-normal font-['Inter',sans-serif] mb-1 text-white/90 tracking-tight">
                    Telefon
                  </h4>
<p className="font-['Inter',sans-serif] text-white/60 font-light text-base">
                    0784320376
...
<div className="space-y-4 font-['Inter',sans-serif] text-xs text-white/60 font-light">
<div className="flex gap-12">
<div>
<strong className="text-white/80 block mb-2 font-normal">
                    Social
                  </strong>
<a className="block mb-1 hover:text-white transition-colors" href="#">
                    Instagram
                  </a>
...
<span className="text-7xl md:text-9xl leading-none block -mb-4 md:-mb-6 text-[#F5E6CA] font-['Pinyon_Script',cursive] opacity-80 tracking-tight">
              1995
            </span>
...
<div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-white/40 font-['Inter',sans-serif] font-light gap-4">
<p>© 2024 Cofetaria Alex.</p>

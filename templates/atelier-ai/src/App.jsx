...
<a className="font-logo shrink-0 text-[1.95rem] font-medium tracking-[0.20em] text-[#171411] sm:text-[2.15rem]" href="#">
          ATELIER AI
        </a>

<div className="hidden items-center gap-10 text-[15px] font-semibold tracking-[-0.02em] text-[#2c2722] lg:flex xl:gap-14">
<a className="transition hover:text-[#98704a]" href="#">How It Works</a>
<a className="transition hover:text-[#98704a]" href="#">Styles</a>
<a className="transition hover:text-[#98704a]" href="#">Pricing</a>
<a className="transition hover:text-[#98704a]" href="#">Inspiration</a>
<a className="transition hover:text-[#98704a]" href="#">
            For Professionals
          </a>
</div>

<div className="flex items-center gap-5 sm:gap-7">
<a className="hidden text-[15px] font-semibold text-[#2c2722] transition hover:text-[#98704a] sm:inline-flex" href="#">
            Log in
          </a>
<a className="inline-flex h-[54px] items-center justify-center rounded-[12px] bg-[#171614] px-7 text-[15px] font-bold text-white shadow-[0_18px_42px_rgba(25,21,18,0.16)] transition hover:bg-[#29231e]" href="#">
            Get Started
          </a>
</div>
</nav>
...
<a className="inline-flex h-[66px] items-center justify-center gap-4 rounded-[12px] bg-[#171614] px-8 text-[1rem] font-bold text-white shadow-[0_24px_54px_rgba(28,22,17,0.18)] transition hover:-translate-y-0.5 hover:bg-[#29231f] sm:min-w-[250px]" href="#">
<i className="h-6 w-6" data-lucide="upload"></i>
                    Upload Your Room
                  </a>
<a className="inline-flex h-[66px] items-center justify-center gap-4 rounded-[12px] border border-[#d1c4b7] bg-[#f1ebe3] px-8 text-[1rem] font-bold text-[#1c1915] shadow-[0_12px_28px_rgba(88,72,58,0.055)] transition hover:-translate-y-0.5 hover:border-[#c6b49f] hover:bg-[#f8f2ea] sm:min-w-[250px]" href="#">
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#1d1a16]">
<i className="ml-0.5 h-4 w-4" data-lucide="play"></i>
</span>
                    See How It Works
                  </a>
</div>
...
<i className="h-8 w-8 shrink-0 text-[#9d7650]" data-lucide="users-round"></i>
<div>
...
<i className="h-8 w-8 shrink-0 text-[#9d7650]" data-lucide="badge-check"></i>
<div>
<div className="whitespace-nowrap text-[0.8rem] font-semibold text-[#756b60]">
                          User Rating
                        </div>
...
<i className="h-8 w-8 shrink-0 text-[#9d7650]" data-lucide="shield-check"></i>
<div>
<div className="whitespace-nowrap text-[0.8rem] font-semibold text-[#756b60]">
                          Trusted by
                        </div>
...
<video aria-label="Warm editorial living room with stone fireplace, organic textures, cream sofa, wood shelving, and soft daylight" className="h-full w-full object-cover object-center" data-aura-generated-video="true" data-aura-video-preset="loop-in-view" loop="" muted="" playsinline="" poster="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png" preload="metadata" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/generated-videos/66a84ecf-0972-40f3-8a4c-15b11d3aee0a/1779500363762-9c8dfe0b-f52e-462c-ab07-46cb6e1859e9.mp4"></video>
...
<img alt="Before empty room" className="h-[122px] w-full object-cover grayscale-[12%] saturate-[0.78] sm:h-[132px]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de7c127b-e2ce-4fbc-af38-233509c064a3_800w.png"/>
...
<svg aria-hidden="true" className="pointer-events-none absolute left-[95px] top-[155px] z-20 hidden h-32 w-44 text-white/95 drop-shadow-[0_3px_10px_rgba(0,0,0,0.20)] sm:block lg:left-[105px] lg:top-[160px]" fill="none" viewbox="0 0 180 130">
<path d="M8 9C72 18 126 48 151 102" stroke="currentColor" stroke-dasharray="5 7" strokeLinecap="round" strokeWidth="2"></path>
<path d="M137 94L153 105L158 86" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<i className="h-3.5 w-3.5 text-[#9d7650]" data-lucide="sparkles"></i>
</span>
</div>
...
<img alt="" className="h-[54px] w-[62px] rounded-[8px] object-cover shadow-[0_6px_14px_rgba(46,35,27,0.14)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_320w.png"/>
...
<img alt="" className="h-[54px] w-[62px] rounded-[8px] object-cover opacity-78 saturate-[0.72] shadow-[0_5px_12px_rgba(46,35,27,0.10)] transition duration-300 group-hover:opacity-95 group-hover:saturate-[0.92]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
...
<span className="pointer-events-none absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#b38a5f]/0 transition group-hover:bg-[#b38a5f]/70"></span>
<img alt="" className="h-[54px] w-[62px] rounded-[8px] object-cover opacity-68 saturate-[0.68] shadow-[0_5px_12px_rgba(46,35,27,0.10)] transition duration-300 group-hover:opacity-92 group-hover:saturate-[0.9]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
<span className="flex min-w-0 flex-1 items-center justify-between gap-2">
...
<span className="pointer-events-none absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#b38a5f]/0 transition group-hover:bg-[#b38a5f]/70"></span>
<img alt="" className="h-[54px] w-[62px] rounded-[8px] object-cover opacity-58 saturate-[0.62] shadow-[0_5px_12px_rgba(46,35,27,0.10)] transition duration-300 group-hover:opacity-90 group-hover:saturate-[0.9]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
<span className="flex min-w-0 flex-1 items-center justify-between gap-2">
...
<a className="mt-4 flex items-center justify-between rounded-[9px] px-1.5 py-1 text-[0.74rem] font-bold tracking-[-0.02em] text-[#75695e] transition hover:bg-[#f7f1e9] hover:text-[#1c1814]" href="#">
                    View all styles
...
<i className="mt-0.5 h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="crosshair"></i>
<div>
...
<i className="mt-0.5 h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="bookmark"></i>
<div>
<h3 className="whitespace-nowrap text-[0.98rem] font-extrabold tracking-[-0.025em] text-[#1c1814]">
                        Design, Refined
                      </h3>
...
<i className="mt-0.5 h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="shield-check"></i>
<div>
<h3 className="whitespace-nowrap text-[0.98rem] font-extrabold tracking-[-0.025em] text-[#1c1814]">
                        Trusted Results
                      </h3>
...
<img alt="Organic modern interior concept" className="h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
...
<i className="h-4 w-4 text-[#9d7650]" data-lucide="sparkles"></i>
</span>
</div>
...
<i className="h-4 w-4 text-[#9d7650]" data-lucide="scan-search"></i>
</span>
<div>
...
<div className="flex items-center gap-4">
<span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#d6c5b2] bg-[#f7efe6] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]">
<i className="h-4 w-4 text-[#9d7650]" data-lucide="palette"></i>
</span>
<div>
<p className="text-[0.78rem] font-extrabold tracking-[-0.02em] text-[#1c1814]">
                        Palette Match
...
<div className="flex items-center gap-4">
<span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#d6c5b2] bg-[#f7efe6] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]">
<i className="h-4 w-4 text-[#9d7650]" data-lucide="layout-dashboard"></i>
</span>
<div>
<p className="text-[0.78rem] font-extrabold tracking-[-0.02em] text-[#1c1814]">
                        Spatial Balance
...
<span>Before</span>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#d6c5b2] bg-[#f7efe6] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]">
<i className="h-4 w-4 text-[#9d7650]" data-lucide="arrow-right"></i>
</span>
...
<img alt="Before empty room" className="h-[220px] w-full rounded-[8px] object-cover object-center shadow-[0_12px_26px_rgba(46,35,27,0.12)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de7c127b-e2ce-4fbc-af38-233509c064a3_800w.png"/>
</div>
<div className="overflow-hidden rounded-[11px] border border-[#e2d5c8] bg-[#f7f1e9] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]">
<img alt="After organic modern room" className="h-[220px] w-full rounded-[8px] object-cover object-center shadow-[0_12px_26px_rgba(46,35,27,0.12)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
</div>
</div>
...
<a className="mt-9 inline-flex items-center gap-3 text-[0.98rem] font-extrabold tracking-[-0.02em] text-[#9a744d] transition hover:text-[#171411] reveal-on-scroll delay-500" href="#">
                View all styles
...
<img alt="Editorial Luxe interior direction" className="h-full w-full object-cover object-center transition duration-700 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
...
<a className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#d6c5b2] bg-[#f7efe6] text-[#9d7650] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition group-hover:translate-x-0.5 group-hover:border-[#ad8356]" href="#">
<i className="h-4 w-4" data-lucide="arrow-right"></i>
</a>
</div>
</article>
...
<div className="relative h-[250px] overflow-hidden border-b border-[#d8c9b8]">
<img alt="Soft Minimal interior direction" className="h-full w-full object-cover object-center transition duration-700 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
...
<img alt="Japandi interior direction" className="h-full w-full object-cover object-center transition duration-700 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
</div>
<div className="flex items-end justify-between gap-5 p-5">
<div>
...
<a className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#d6c5b2] bg-[#f7efe6] text-[#9d7650] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition group-hover:translate-x-0.5 group-hover:border-[#ad8356]" href="#">
<i className="h-4 w-4" data-lucide="arrow-right"></i>
</a>
</div>
</article>
...
<div className="relative h-[145px] overflow-hidden border-b border-[#d8c9b8]">
<img alt="Modern Organic interior direction" className="h-full w-full object-cover object-center transition duration-700 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_320w.png"/>
</div>
<div className="flex items-end justify-between gap-5 p-5">
<div>
<h3 className="font-display text-[1.45rem] font-normal leading-none tracking-[-0.045em] text-[#171411]">
...
<div className="relative h-[145px] overflow-hidden border-b border-[#d8c9b8]">
<img alt="Warm Contemporary interior direction" className="h-full w-full object-cover object-center transition duration-700 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
</div>
<div className="flex items-end justify-between gap-5 p-5">
<div>
<h3 className="font-display text-[1.45rem] font-normal leading-none tracking-[-0.045em] text-[#171411]">
...
<svg aria-hidden="true" className="absolute left-[calc(100%-5rem)] top-[0px] hidden h-8 w-[7rem] text-[#b8956d]/70 lg:block" fill="none" viewbox="0 0 180 32">
<path d="M2 16C52 16 104 16 160 16" stroke="currentColor" stroke-dasharray="3 5" strokeLinecap="round" strokeWidth="1.4"></path>
<path d="M153 9L162 16L153 23" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.4"></path>
</svg>
</div>
...
<i className="h-4.5 w-4.5" data-lucide="cloud-upload"></i>
</span>
...
<img alt="Uploaded empty room" className="h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de7c127b-e2ce-4fbc-af38-233509c064a3_800w.png"/>
...
<i className="h-4 w-4 text-[#9d7650]" data-lucide="check-circle-2"></i>
                  IMG_9421.jpg
                  <i className="h-3.5 w-3.5 text-[#9d7650]" data-lucide="chevron-down"></i>
</div>
</div>
</article>
...
<img alt="" className="h-[56px] w-[68px] rounded-[8px] object-cover shadow-[0_6px_14px_rgba(46,35,27,0.14)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_320w.png"/>
<span className="min-w-0 flex-1 text-[0.76rem] font-extrabold tracking-[-0.025em] text-[#1c1814]">
                    Editorial Luxe
                  </span>
...
<span className="pointer-events-none absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#b38a5f]/0 transition group-hover:bg-[#b38a5f]/70"></span>
<img alt="" className="h-[56px] w-[68px] rounded-[8px] object-cover opacity-78 saturate-[0.72]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
<span className="text-[0.76rem] font-extrabold tracking-[-0.025em] text-[#302922]">
                    Japandi
                  </span>
</button>
...
<span className="pointer-events-none absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#b38a5f]/0 transition group-hover:bg-[#b38a5f]/70"></span>
<img alt="" className="h-[56px] w-[68px] rounded-[8px] object-cover opacity-68 saturate-[0.68]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
<span className="text-[0.76rem] font-extrabold tracking-[-0.025em] text-[#4b4036]">
                    Modern Organic
                  </span>
</button>
...
<span className="pointer-events-none absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#b38a5f]/0 transition group-hover:bg-[#b38a5f]/70"></span>
<img alt="" className="h-[56px] w-[68px] rounded-[8px] object-cover opacity-58 saturate-[0.62]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
<span className="text-[0.76rem] font-extrabold tracking-[-0.025em] text-[#5a4d41]">
                    Soft Minimal
                  </span>
</button>
</div>
<a className="mt-5 flex items-center justify-between rounded-[9px] px-1.5 py-1 text-[0.74rem] font-bold tracking-[-0.02em] text-[#75695e] transition hover:bg-[#f7f1e9] hover:text-[#1c1814]" href="#">
                View all styles
                <i className="h-4 w-4" data-lucide="chevron-right"></i>
</a>
</article>
...
<img alt="Generated room concept" className="h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
...
<img alt="" className="h-[66px] w-full rounded-[0.65rem] border border-[#ad8356] object-cover shadow-[0_8px_18px_rgba(70,54,42,0.08)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_320w.png"/>
<img alt="" className="h-[66px] w-full rounded-[0.65rem] border border-[#e2d5c8] object-cover shadow-[0_8px_18px_rgba(70,54,42,0.05)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
<img alt="" className="h-[66px] w-full rounded-[0.65rem] border border-[#e2d5c8] object-cover shadow-[0_8px_18px_rgba(70,54,42,0.05)]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
</div>
</article>
...
<i className="h-3.5 w-3.5" data-lucide="upload"></i>
                  Share
                </button>
</div>
<div className="relative min-h-0 flex-1 overflow-hidden">
<img alt="Final exported concept" className="h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
...
<i className="h-6 w-6 text-[#9d7650]" data-lucide="shield-check"></i>
...
<i className="h-4 w-4" data-lucide="scan-search"></i>
</span>
...
<img alt="AI generated interior concept" className="absolute inset-0 h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>

<div className="ai-slider-before absolute inset-0 overflow-hidden" data-before="" style={{clipPath: 'inset(0 50% 0 0)'}}>
<img alt="Original room before AI concept" className="absolute inset-0 h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de7c127b-e2ce-4fbc-af38-233509c064a3_800w.png"/>
</div>
...
<button aria-label="Drag to compare before and AI concept" className="ai-slider-handle absolute left-1/2 top-1/2 z-30 inline-flex h-14 w-14 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/70 bg-[#f7efe6] text-[#9d7650] shadow-[0_18px_48px_rgba(35,27,20,0.24),inset_0_1px_0_rgba(255,255,255,0.72)]" data-handle="" type="button">
<i className="h-5 w-5" data-lucide="chevrons-left-right"></i>
</button>
...
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="scan-line"></i>
...
<i className="h-5 w-5 shrink-0 text-[#caa57c]" data-lucide="check-circle-2"></i>
</div>
</div>

<div className="rounded-[0.9rem] border border-white/10 bg-white/[0.065] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="blend"></i>
<div className="min-w-0 flex-1">
<p className="text-[0.82rem] font-extrabold tracking-[-0.02em] text-white">
                            Style Match
                          </p>
...
<div className="rounded-[0.9rem] border border-white/10 bg-white/[0.065] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="sparkles"></i>
<div className="min-w-0 flex-1">
<p className="text-[0.82rem] font-extrabold tracking-[-0.02em] text-white">
                            Materials Palette
                          </p>
...
<div className="rounded-[0.9rem] border border-white/10 bg-white/[0.065] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="lightbulb"></i>
<div className="min-w-0 flex-1">
<p className="text-[0.82rem] font-extrabold tracking-[-0.02em] text-white">
                            Lighting Analysis
                          </p>
...
<div className="rounded-[0.9rem] border border-white/10 bg-white/[0.065] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="sofa"></i>
<div className="min-w-0 flex-1">
<p className="text-[0.82rem] font-extrabold tracking-[-0.02em] text-white">
                            Furniture Zoning
                          </p>
...
<div className="rounded-[0.9rem] border border-white/10 bg-white/[0.065] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<i className="h-6 w-6 shrink-0 text-[#caa57c]" data-lucide="wallet-cards"></i>
<div className="min-w-0 flex-1">
<p className="text-[0.82rem] font-extrabold tracking-[-0.02em] text-white">
                            Budget Range
                          </p>
...
<a className="inline-flex w-full items-center justify-center gap-3 rounded-[0.95rem] bg-[#f7efe6] px-5 py-4 text-[0.86rem] font-extrabold tracking-[-0.02em] text-[#171411] shadow-[0_18px_42px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.72)] transition hover:bg-white" href="#">
                      View Full Report
                      <i className="h-4 w-4" data-lucide="arrow-right"></i>
</a>
</div>
...
<div className="flex items-center gap-4">
<i className="h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="database"></i>
...
<div className="flex items-center gap-4">
<i className="h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="sparkles"></i>
<p className="text-[0.92rem] font-semibold leading-[1.35] tracking-[-0.02em] text-[#3a332d]">
                  Design logic meets
                  <br className="hidden xl:block"/>
...
<div className="flex items-center gap-4">
<i className="h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="refresh-cw"></i>
<p className="text-[0.92rem] font-semibold leading-[1.35] tracking-[-0.02em] text-[#3a332d]">
...
<div className="flex items-center gap-4">
<i className="h-9 w-9 shrink-0 text-[#9d7650]" data-lucide="user-round"></i>
<p className="text-[0.92rem] font-semibold leading-[1.35] tracking-[-0.02em] text-[#3a332d]">
                  Your vision,
                  <br className="hidden xl:block"/>
...
<img alt="Home plan interior preview" className="h-[128px] w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0141fd7-e67a-4967-b6eb-a5ad3dd479e8_320w.png"/>
...
<i className="h-4.5 w-4.5 shrink-0 text-[#9d7650]" data-lucide="check-circle-2"></i>
                      20 AI renders / month
                    </li>
<li className="flex items-center gap-3 text-[0.84rem] font-semibold tracking-[-0.02em] text-[#3a332d]">
<i className="h-4.5 w-4.5 shrink-0 text-[#9d7650]" data-lucide="check-circle-2"></i>
...
<a className="mt-auto inline-flex w-full items-center justify-center rounded-[0.8rem] border border-[#bfa994] bg-[#f7efe6] px-5 py-4 text-[0.88rem] font-extrabold tracking-[-0.02em] text-[#171411] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition hover:border-[#9d7650] hover:bg-white" href="#">
                    Start with Home
                  </a>
</article>
...
<div className="mt-7 overflow-hidden rounded-[1rem] border border-[#d8c9b8] bg-[#d7cabc] shadow-[0_16px_36px_rgba(49,37,28,0.12)]">
<img alt="Studio plan interior preview" className="h-[128px] w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_320w.png"/>
<div className="flex items-center justify-center gap-2 bg-[#eee5da] px-3 py-3">
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
...
<a className="mt-auto inline-flex w-full items-center justify-center rounded-[0.8rem] bg-[#171614] px-5 py-4 text-[0.88rem] font-extrabold tracking-[-0.02em] text-white shadow-[0_18px_42px_rgba(25,21,18,0.18)] transition hover:bg-[#29231f]" href="#">
                    Start with Studio
                  </a>
</article>
...
<div className="mt-7 overflow-hidden rounded-[1rem] border border-[#d8c9b8] bg-[#d7cabc] shadow-[0_16px_36px_rgba(49,37,28,0.12)]">
<img alt="Pro plan interior preview" className="h-[128px] w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aaa4a07b-8f7b-407d-83bb-124126fea659_320w.png"/>
<div className="flex items-center justify-center gap-2 bg-[#eee5da] px-3 py-3">
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
<span className="material-dot h-8 w-8 rounded-full border border-white/60 shadow-[0_4px_10px_rgba(46,35,27,0.10)]"></span>
...
<i className="h-6 w-6" data-lucide="users-round"></i>
</span>
<div>
...
<a className="inline-flex items-center justify-center gap-3 rounded-[0.85rem] border border-[#d6c5b2] bg-[#f7efe6] px-7 py-4 text-[0.88rem] font-extrabold tracking-[-0.02em] text-[#171411] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition hover:border-[#9d7650] hover:bg-white" href="#">
...
<img alt="Warm editorial living room interior" className="h-full w-full object-cover object-center" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/545b052a-b0c2-4ec1-aeac-c36a8f948a5d_3840w.png"/>
...
<a className="inline-flex h-[62px] w-full items-center justify-center gap-4 rounded-[12px] bg-[#171614] px-8 text-[0.98rem] font-extrabold tracking-[-0.02em] text-white shadow-[0_24px_54px_rgba(28,22,17,0.22)] transition hover:-translate-y-0.5 hover:bg-[#29231f] sm:w-auto sm:min-w-[245px]" href="#">
<i className="h-5 w-5" data-lucide="upload"></i>
                Upload Your Room
              </a>
<a className="inline-flex h-[62px] w-full items-center justify-center gap-4 rounded-[12px] border border-[#d1c4b7] bg-[#f7f1e9] px-8 text-[0.98rem] font-extrabold tracking-[-0.02em] text-[#1c1915] shadow-[0_12px_28px_rgba(88,72,58,0.07),inset_0_1px_0_rgba(255,255,255,0.72)] transition hover:-translate-y-0.5 hover:border-[#c6b49f] hover:bg-white sm:w-auto sm:min-w-[220px]" href="#">
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#1d1a16]">
<i className="ml-0.5 h-4 w-4" data-lucide="play"></i>
</span>
                Book a Demo
...
<i className="h-7 w-7 shrink-0 text-[#9d7650]" data-lucide="users-round"></i>
<div>
...
<div className="flex items-center justify-center gap-3 sm:px-4">
<i className="h-7 w-7 shrink-0 text-[#9d7650]" data-lucide="shield-check"></i>
<div>
<p className="text-[0.78rem] font-semibold tracking-[-0.02em] text-[#756b60]">
                      Trusted by
                    </p>
...
<div className="flex items-center justify-center gap-3 sm:px-4">
<i className="h-7 w-7 shrink-0 text-[#9d7650]" data-lucide="badge-check"></i>
<div>
<p className="text-[0.78rem] font-semibold tracking-[-0.02em] text-[#756b60]">
                      User Rating
                    </p>
...
<i className="h-8 w-8 shrink-0 text-[#caa57c]" data-lucide="user-round"></i>
...
<div className="flex flex-col items-center border-t border-[rgba(202,165,124,0.24)] px-6 pt-7 text-center lg:border-l lg:border-t-0 lg:pt-0">
<i className="h-8 w-8 shrink-0 text-[#caa57c]" data-lucide="briefcase-business"></i>
<p className="mt-4 text-[0.95rem] font-extrabold tracking-[-0.02em] text-white">
                  For Designers
                </p>
<p className="mt-2 max-w-[12rem] text-[0.82rem] font-semibold leading-[1.48] tracking-[-0.02em] text-white/66">
...
<div className="flex flex-col items-center border-t border-[rgba(202,165,124,0.24)] px-6 pt-7 text-center lg:border-l lg:border-t-0 lg:pt-0">
<i className="h-8 w-8 shrink-0 text-[#caa57c]" data-lucide="building-2"></i>
<p className="mt-4 text-[0.95rem] font-extrabold tracking-[-0.02em] text-white">
...
<div>
<a className="font-logo text-[2rem] font-medium tracking-[0.20em] text-[#171411]" href="#">
                ATELIER AI
              </a>
...
<input className="min-w-0 flex-1 bg-transparent px-3 text-[0.86rem] font-semibold text-[#171411] placeholder:text-[#9b8f82] focus:outline-none" placeholder="Email address" type="email"/>
<button className="inline-flex h-10 shrink-0 items-center justify-center rounded-[0.7rem] bg-[#171614] px-5 text-[0.82rem] font-extrabold tracking-[-0.02em] text-white shadow-[0_14px_30px_rgba(25,21,18,0.16)] transition hover:bg-[#29231f]" type="submit">
                  Join
                </button>
</form>
</div>
...
<a className="transition hover:text-[#171411]" href="#">Privacy</a>
<a className="transition hover:text-[#171411]" href="#">Terms</a>
<a className="transition hover:text-[#171411]" href="#">Security</a>
</div>
</div>
</div>
</footer>

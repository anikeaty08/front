...
gtag('config', 'G-2M6V79H761');
        ...
        function initScrollTimeline() {
            ...
            // PHASE 3: Content Emergence (Upgraded with Context)
            ...
            // PHASE 4: Bridge Moment (Upgraded with staggered elements)
...
<a className="nav-link text-xs uppercase tracking-widest text-[var(--muted)] hover:text-[var(--accent)] transition-colors relative pb-1" href="#manifesto">Thesis</a>
<a className="nav-link text-xs uppercase tracking-widest text-[var(--muted)] hover:text-[var(--accent)] transition-colors relative pb-1" href="#overview">Overview</a>
<a className="nav-link text-xs uppercase tracking-widest text-[var(--muted)] hover:text-[var(--accent)] transition-colors relative pb-1" href="#interface">Engine</a>
<a className="nav-link text-xs uppercase tracking-widest text-[var(--muted)] hover:text-[var(--accent)] transition-colors relative pb-1" href="#modules">Modules</a>
<a className="nav-link text-xs uppercase tracking-widest text-[var(--muted)] hover:text-[var(--accent)] transition-colors relative pb-1" href="#pricing">Access</a>
</div>
...
<div className="text-[10px] uppercase tracking-[0.3em] text-[var(--muted)] mb-3">ATLAS / IDLE</div>
<div className="text-sm md:text-base text-[var(--fg)]/80 tracking-tight">Signal / Structure / Output</div>
...
<p className="text-sm md:text-base text-[var(--muted)] mt-2 font-normal max-w-lg opacity-0 translate-y-4" id="hero-descriptor">
                            Spatial intelligence for interface design.
                        </p>
...
<h3 className="text-2xl md:text-4xl tracking-tight font-normal leading-relaxed text-[var(--fg)] drop-shadow-2xl">
                            Structure precedes style.
                            <br/>
<span className="text-[var(--muted)]">Systems precede screens.</span>
</h3>
</div>
</div>
...
<div className="text-[10px] text-[var(--muted)] font-medium tracking-widest mb-3 uppercase">SYS.02 / CAPABILITIES</div>
<h3 className="text-2xl md:text-3xl tracking-tight text-[var(--fg)] font-medium mb-2">The system measures space before it draws.</h3>
<p className="text-sm md:text-base text-[var(--muted)] font-normal max-w-xl mx-auto">Atlas establishes constraint geometry—then allows style to emerge safely.</p>
</div>
...
<iconify-icon className="text-[var(--accent)]" icon="solar:scanner-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h4 className="text-lg tracking-tight font-medium text-[var(--fg)] mb-2 group-hover:text-white transition-colors">Spatial Mapping</h4>
<p className="text-[11px] text-[var(--muted)] leading-relaxed font-normal">Define boundaries, density, and grid intent before decoration.</p>
</div>
...
<iconify-icon className="text-[var(--accent)]" icon="solar:sort-from-bottom-to-top-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h4 className="text-lg tracking-tight font-medium text-[var(--fg)] mb-2 group-hover:text-white transition-colors">Depth Control</h4>
<p className="text-[11px] text-[var(--muted)] leading-relaxed font-normal">Enforce hierarchy through Z-logic and relational layer weight.</p>
</div>
<div className="absolute bottom-0 left-0 w-full h-[1px] bg-[var(--accent)] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
</div>
<div className="feature-card w-full md:w-1/3 aspect-[3/4] bg-[rgba(15,15,15,0.4)] backdrop-blur-xl border border-[var(--border)] flex flex-col rounded-none group relative overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:border-[var(--muted)]">
...
<div className="text-[8px] text-[var(--muted)]">00:00</div>
<div className="text-[8px] text-[var(--accent)]">01:42</div>
<div className="text-[8px] text-[var(--muted)]">03:00</div>
</div>
...
<iconify-icon className="text-[var(--accent)]" icon="solar:history-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h4 className="text-lg tracking-tight font-medium text-[var(--fg)] mb-2 group-hover:text-white transition-colors">Temporal Sync</h4>
<p className="text-[11px] text-[var(--muted)] leading-relaxed font-normal">Scrub functional states and sequence like a controlled timeline.</p>
</div>
<div className="absolute bottom-0 left-0 w-full h-[1px] bg-[var(--accent)] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
</div>
</div>
...
<p className="bridge-stagger text-sm md:text-base text-[var(--muted)] font-normal max-w-[680px] mx-auto mb-2 opacity-0 translate-y-[12px]">
                            It’s constraints, relationships, and rules that survive every viewport.
                        </p>
<p className="bridge-stagger text-sm md:text-base text-[var(--fg)] font-medium max-w-[680px] mx-auto opacity-0 translate-y-[12px]">
                            Atlas builds the system—<span className="text-[var(--accent)]">so the interface becomes inevitable.</span>
</p>
</div>
</div>
</div>
...
<h2 className="text-2xl md:text-4xl font-medium tracking-tight text-[var(--fg)] mb-6 reveal-item">
                        Interface is spatial logic.
                    </h2>
<p className="text-sm md:text-lg text-[var(--muted)] leading-relaxed font-normal reveal-item">
                        Atlas converts intent into constraints—grid, hierarchy, rhythm, and tokens—so visual style becomes an inevitable consequence of structure, not a guess.
                    </p>
</div>
</div>
</section>
...
<span className="block reveal-text">Spatial Intelligence</span>
</span>
<span className="overflow-hidden pb-2 block text-[var(--muted)]">
<span className="block reveal-text">for Interface Design.</span>
</span>
</h2>
<p className="text-sm text-[var(--muted)] mb-10 max-w-2xl leading-relaxed reveal-item">
                        Atlas interprets intent as layout constraints. It resolves hierarchy, spacing, and component rhythm before applying any visual treatment. The output isn’t a mockup—it’s a robust system you can ship to production.
                    </p>
...
<iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear"></iconify-icon>
                            Constraint-first layout
                        </div>
<div className="flex items-center gap-3">
<iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear"></iconify-icon>
                            Token-accurate outputs
                        </div>
<div className="flex items-center gap-3">
<iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear"></iconify-icon>
...
<button className="w-full sm:w-auto px-8 py-4 text-xs tracking-widest uppercase font-medium border border-[var(--border)] text-[var(--fg)] hover:bg-[var(--fg)] hover:text-black transition-colors duration-300 focus:outline-none" onclick="lenis.scrollTo('#interface')">
                            View Pipeline
                        </button>
</div>
</div>
...
<iconify-icon icon="solar:alt-arrow-right-linear"></iconify-icon>
<span className="text-[var(--fg)]">Code</span>
</div>
...
<span className="block reveal-text">Command the Canvas.</span>
</span>
</h2>
<p className="text-sm text-[var(--muted)] mb-10 leading-relaxed font-normal reveal-item">
                            Write explicit intent. Atlas returns absolute structure: relational grid math, modular type scales, spatial rhythms, and locked token maps—aligned precisely to production environments.
                        </p>
...
<span className="leading-relaxed">Translate human language into layout mathematics with hierarchy preserved.</span>
</li>
<li className="flex items-start gap-4">
<iconify-icon className="text-[var(--accent)] mt-0.5" icon="solar:alt-arrow-right-linear" width="16"></iconify-icon>
<span className="leading-relaxed">Component variants mathematically generated from core grid constraints.</span>
</li>
<li className="flex items-start gap-4">
<iconify-icon className="text-[var(--accent)] mt-0.5" icon="solar:alt-arrow-right-linear" width="16"></iconify-icon>
<span className="leading-relaxed">Export immediately to semantic HTML/CSS or structured React component maps.</span>
</li>
</ul>
</div>
...
<div className="text-[10px] text-[var(--muted)] font-mono uppercase tracking-widest">Workspace / Alpha</div>
</div>
...
<div className="text-[10px] text-[var(--muted)] font-mono uppercase mb-2 border-b border-[var(--border)] pb-2">DOM Tree</div>
...
<div className="absolute top-2 right-2 text-[10px] text-[var(--accent)] font-mono uppercase">Node: Hero</div>
...
<div className="absolute top-2 right-2 text-[10px] text-[var(--muted)] font-mono uppercase">Col.1</div>
</div>
<div className="flex-1 border border-[var(--border)] bg-[var(--panel)] p-3 relative hover:border-[var(--muted)] transition-colors rounded-none">
<div className="absolute top-2 right-2 text-[10px] text-[var(--muted)] font-mono uppercase">Col.2</div>
</div>
</div>
</div>
</div>
...
<div className="text-[10px] text-[var(--muted)] font-medium tracking-widest mb-4 uppercase">SYS.03 / ARCHITECTURE</div>
<h2 className="text-3xl font-medium tracking-tight text-[var(--fg)] mb-4">System Architecture</h2>
<p className="text-sm text-[var(--muted)] max-w-2xl mx-auto leading-relaxed">
                            Atlas is a pipeline: intent → constraints → tokens → export. Each module is isolated, testable, and composable.
                        </p>
</div>
...
<span className="text-[var(--fg)]">Prompt Engine</span>
...
<span className="text-[var(--fg)]">Layout Matrix</span>
<iconify-icon className="hidden md:block text-[var(--accent)]" icon="solar:arrow-right-linear" width="16"></iconify-icon>
<iconify-icon className="md:hidden text-[var(--accent)]" icon="solar:arrow-down-linear" width="16"></iconify-icon>
<span className="text-[var(--fg)]">Token Resolver</span>
<iconify-icon className="hidden md:block text-[var(--accent)]" icon="solar:arrow-right-linear" width="16"></iconify-icon>
<iconify-icon className="md:hidden text-[var(--accent)]" icon="solar:arrow-down-linear" width="16"></iconify-icon>
<span className="text-[var(--accent)]">Export Layer</span>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 reveal-item">
...
<iconify-icon className="text-[var(--accent)] mb-6" icon="solar:terminal-outline" width="24"></iconify-icon>
<h3 className="text-base text-[var(--fg)] font-medium mb-2 group-hover:text-white transition-colors">Prompt Engine</h3>
<p className="text-xs text-[var(--muted)] leading-relaxed flex-1 mb-2">Translates semantic instructions into spatial math.</p>
<p className="text-[10px] text-[var(--muted)] opacity-60 flex-1 leading-relaxed">Analyzes intent to establish strict baseline grid variables.</p>
<div className="mt-8 pt-4 border-t border-[var(--border)] text-[10px] uppercase tracking-widest text-[var(--muted)] flex justify-between">
<span>Status</span>
<span className="text-[var(--accent)]">Active</span>
</div>
</div>
<div className="border border-[var(--border)] bg-[var(--panel)] backdrop-blur-md p-6 flex flex-col hover:border-[var(--accent)] transition-colors duration-500 rounded-none group relative overflow-hidden">
<iconify-icon className="text-[var(--accent)] mb-6" icon="solar:black-hole-linear" width="24"></iconify-icon>
<h3 className="text-base text-[var(--fg)] font-medium mb-2 group-hover:text-white transition-colors">Layout Matrix</h3>
<p className="text-xs text-[var(--muted)] leading-relaxed flex-1 mb-2">Enforces relational proportions across all viewports.</p>
<p className="text-[10px] text-[var(--muted)] opacity-60 flex-1 leading-relaxed">Computes dynamic constraints to guarantee zero DOM reflow.</p>
<div className="mt-8 pt-4 border-t border-[var(--border)] text-[10px] uppercase tracking-widest text-[var(--muted)] flex justify-between">
<span>Constraints</span>
<span className="text-[var(--accent)]">Locked</span>
</div>
</div>
<div className="border border-[var(--border)] bg-[var(--panel)] backdrop-blur-md p-6 flex flex-col hover:border-[var(--accent)] transition-colors duration-500 rounded-none group relative overflow-hidden">
<iconify-icon className="text-[var(--accent)] mb-6" icon="solar:layers-linear" width="24"></iconify-icon>
<h3 className="text-base text-[var(--fg)] font-medium mb-2 group-hover:text-white transition-colors">Token Resolver</h3>
<p className="text-xs text-[var(--muted)] leading-relaxed flex-1 mb-2">Compiles color, type, and space into actionable primitives.</p>
<p className="text-[10px] text-[var(--muted)] opacity-60 flex-1 leading-relaxed">Maps design tokens directly to mathematical values.</p>
<div className="mt-8 pt-4 border-t border-[var(--border)] text-[10px] uppercase tracking-widest text-[var(--muted)] flex justify-between">
<span>Variables</span>
...
<div className="border border-[var(--border)] bg-[var(--panel)] backdrop-blur-md p-6 flex flex-col hover:border-[var(--accent)] transition-colors duration-500 rounded-none group relative overflow-hidden">
<iconify-icon className="text-[var(--accent)] mb-6" icon="solar:box-linear" width="24"></iconify-icon>
<h3 className="text-base text-[var(--fg)] font-medium mb-2 group-hover:text-white transition-colors">Export Layer</h3>
<p className="text-xs text-[var(--muted)] leading-relaxed flex-1 mb-2">Packages abstract structure into production-ready syntax.</p>
<p className="text-[10px] text-[var(--muted)] opacity-60 flex-1 leading-relaxed">Generates component maps instantly for modern stacks.</p>
<div className="mt-8 pt-4 border-t border-[var(--border)] text-[10px] uppercase tracking-widest text-[var(--muted)] flex justify-between">
<span>Output</span>
...
<div className="pt-8 border-t border-[var(--border)] flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 text-[10px] text-[var(--muted)] uppercase tracking-widest reveal-item font-medium">
<div className="flex items-center gap-3">
<iconify-icon className="text-[var(--accent)]" icon="solar:verified-check-linear" width="16"></iconify-icon>
                            Viewport-Safe Hierarchy
                        </div>
<div className="flex items-center gap-3">
<iconify-icon className="text-[var(--accent)]" icon="solar:verified-check-linear" width="16"></iconify-icon>
                            Token Parity
...
<div className="mb-12 text-center reveal-item">
<h2 className="text-3xl font-medium tracking-tight text-[var(--fg)] mb-4">Access Credentials</h2>
<p className="text-sm text-[var(--muted)]">Atlas is released as a curated system—membership is highly intentional.</p>
</div>
...
<div className="text-[10px] uppercase tracking-widest text-[var(--muted)] font-medium mb-3">Observer</div>
<div className="text-3xl font-medium text-[var(--fg)] mb-8">Free</div>
<div className="flex-1">
<div className="text-[10px] uppercase tracking-widest text-[var(--muted)] font-medium mb-3 pb-2 border-b border-[var(--border)]">Core Capabilities</div>
<ul className="text-xs text-[var(--muted)] space-y-4 font-normal">
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Read-only layout previews</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Limited grid generations</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Public system documentation</li>
</ul>
</div>
</div>
...
<div className="absolute top-0 right-0 bg-[var(--accent)] text-black text-[10px] px-3 py-1.5 uppercase tracking-widest font-medium">Invite Only</div>
<div className="text-[10px] uppercase tracking-widest text-[var(--accent)] font-medium mb-3">Architect</div>
<div className="text-3xl font-medium text-[var(--fg)] mb-8">$49 <span className="text-xs text-[var(--muted)] font-normal">/mo</span></div>
<div className="flex-1 space-y-6">
<div>
<div className="text-[10px] uppercase tracking-widest text-[var(--accent)] font-medium mb-3 pb-2 border-b border-[var(--accent)]/30">Core Engine</div>
<ul className="text-xs text-[var(--muted)] space-y-3 font-normal">
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Full layout computation matrix</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Deep token resolution</li>
</ul>
</div>
<div>
<div className="text-[10px] uppercase tracking-widest text-[var(--accent)] font-medium mb-3 pb-2 border-b border-[var(--accent)]/30">Exports</div>
<ul className="text-xs text-[var(--muted)] space-y-3 font-normal">
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Production-ready components</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--accent)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Semantic HTML / CSS outputs</li>
</ul>
</div>
</div>
</div>
...
<span>Council</span>
<span className="text-[var(--border)] border border-[var(--border)] px-2 py-0.5 text-[8px]">14 / 50 Remaining</span>
</div>
<div className="text-3xl font-medium text-[var(--fg)] mb-8">$199 <span className="text-xs text-[var(--muted)] font-normal">/mo</span></div>
<div className="flex-1 space-y-6">
<div>
<div className="text-[10px] uppercase tracking-widest text-[var(--muted)] font-medium mb-3 pb-2 border-b border-[var(--border)]">Governance</div>
<ul className="text-xs text-[var(--muted)] space-y-3 font-normal">
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Priority system releases</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Private architectural workshop</li>
<li className="flex items-center gap-3"><iconify-icon className="text-[var(--border)]" icon="solar:check-circle-linear" width="16"></iconify-icon>Custom baseline presets</li>
</ul>
</div>
</div>
</div>
...
<div className="text-[10px] text-[var(--accent)] font-medium tracking-widest mb-6 uppercase reveal-item">
                        Release Window / Controlled
                    </div>
<h2 className="text-4xl md:text-6xl font-medium tracking-tight text-[var(--fg)] mb-6 flex flex-col reveal-item">
<span className="overflow-hidden pb-1 block">
<span className="block reveal-text">Enter the Atlas Index.</span>
</span>
</h2>
<p className="text-sm text-[var(--muted)] mb-12 max-w-md leading-relaxed font-normal reveal-item">
                        Request access. Receive a system key. Build with absolute constraints intact.
                    </p>
...
<span>System Index: 01</span>
<span className="hidden md:inline text-[var(--border)]">•</span>
<span>All Structure Preserved</span>
</footer>
</div>
</div>
</section>

...
<span className="font-manrope font-bold text-lg px-2 tracking-tight">Audaces</span>
<a className="text-gray-300 hover:text-white transition-colors font-sans hidden md:block" href="#">Websites</a>
<a className="text-gray-300 hover:text-white transition-colors font-sans hidden md:block" href="#">CRM &amp; Vendas</a>
<a className="text-gray-300 hover:text-white transition-colors font-sans hidden md:block" href="#">Automações</a>
<button className="bg-white text-black px-4 py-1.5 rounded-full text-sm hover:bg-emerald-50 transition-colors font-sans font-medium">
                            Agendar Reunião
                        </button>
</nav>
</div>
...
<h1 className="text-5xl md:text-7xl leading-[1.1] mb-8 text-white font-manrope font-medium tracking-tighter">
                        O motor de crescimento para <br/>
<span className="text-gray-400 font-manrope font-medium tracking-tighter">empresas modernas</span> <br/>
                        em Portimão.
                    </h1>
</div>
...
<div className="">
<p className="text-xs text-gray-400 uppercase tracking-widest font-sans">Tecnologia</p>
<p className="text-sm text-white font-sans">IA &amp; Automação de Processos</p>
</div>
</div>
</section>
...
<h3 className="text-3xl lg:text-4xl text-gray-900 leading-tight mb-6 font-manrope font-medium tracking-tighter">
                            Sistemas Criados <br/>
<span className="text-gray-400 font-manrope font-medium tracking-tighter">Sob Medida Para</span> <br/>
                            Dominar o Mercado.
                        </h3>
<p className="text-lg text-gray-500 leading-relaxed mb-8 font-sans">
                            Eliminamos a complexidade e o trabalho manual do seu dia a dia com CRMs, automação de redes sociais e inteligência artificial para que se foque em fechar negócios.
                        </p>
...
<span className="font-sans">Falar com um Especialista</span>
...
<p className="text-lg tracking-tight font-sans">Geração de Leads</p>
<p className="text-sm text-gray-300 font-sans">Atendimento 24/7</p>
</div>
<div className="absolute bottom-6 w-full px-6 flex justify-between items-end text-white">
<div>
<p className="text-xl font-manrope font-medium tracking-tighter">Automação Social</p>
<button className="mt-4 flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm hover:bg-white/30 transition font-sans">
                                     Ver Vantagens <iconify-icon className="text-base" icon="lucide:plus"></iconify-icon>
</button>
</div>
...
<p className="text-lg tracking-tight font-sans">Construção &amp; Limpeza</p>
<p className="text-sm text-gray-400 font-sans">Personalizado</p>
</div>
<div className="absolute bottom-6 w-full px-6 flex justify-between items-end text-white">
<div className="max-w-[70%]">
<p className="text-xl mb-2 font-manrope font-medium tracking-tighter">Sistemas de Cálculo</p>
<p className="text-sm text-gray-400 line-clamp-2 font-sans">Calculadoras interativas para o seu site gerarem orçamentos precisos em segundos.</p>
<button className="mt-4 flex items-center gap-2 bg-white text-black px-4 py-2 rounded-full text-sm hover:bg-gray-200 transition font-sans">
                                     Saber Mais <iconify-icon className="text-base" icon="lucide:arrow-right"></iconify-icon>
</button>
</div>
...
<h2 className="text-4xl md:text-5xl text-gray-900 mb-6 leading-[1.1] font-manrope font-medium tracking-tighter">
                Otimize cada etapa do seu <br className="hidden md:block"/> processo comercial
            </h2>
<p className="text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto font-sans">
                Aumente conversões, reduza tarefas repetitivas e ganhe controlo total sobre a sua empresa de serviços com uma única infraestrutura digital.
            </p>
</div>
...
<iconify-icon className="text-emerald-600 text-sm" icon="lucide:line-chart"></iconify-icon>
</div>
...
<iconify-icon className="text-xs" icon="lucide:check-circle-2"></iconify-icon> Lead Capturada
                            </span>
</div>
</div>
...
<h3 className="text-lg text-gray-900 mb-3 tracking-tight font-sans">Aumente as Vendas</h3>
<p className="text-[15px] text-gray-500 leading-relaxed max-w-xs mx-auto font-sans">
                    Não deixe contactos arrefecerem. Páginas focadas na conversão que transformam visitantes em pedidos de orçamento qualificados.
                </p>
</div>
...
<iconify-icon className="text-2xl text-emerald-500" icon="lucide:bot"></iconify-icon>
</div>
...
<h3 className="text-lg text-gray-900 mb-3 tracking-tight font-sans">Otimize a Produtividade</h3>
<p className="text-[15px] text-gray-500 leading-relaxed max-w-xs mx-auto font-sans">
                    Liberte a sua equipa com o poder da IA. Agendamentos, follow-ups no WhatsApp e criação de orçamentos em piloto automático.
                </p>
</div>
...
<span className="block text-[10px] text-gray-400 uppercase tracking-wider mb-0.5 font-sans">Eficiência</span>
...
<h3 className="text-lg text-gray-900 mb-3 tracking-tight font-sans">Gira Processos Sem Stress</h3>
<p className="text-[15px] text-gray-500 leading-relaxed max-w-xs mx-auto font-sans">
                    Tenha controlo total com o nosso CRM. Visualize todos os seus clientes e orçamentos num painel intuitivo e feche mais negócios.
                </p>
</div>
</div>
</div>
...
<h2 className="text-4xl md:text-5xl lg:text-6xl text-gray-900 max-w-4xl leading-[1.05] font-manrope font-medium tracking-tighter">
                Ajudamos empresas algarvias <span className="text-gray-400 font-manrope font-medium tracking-tighter">a criar experiências que escalam e dominam a concorrência.</span>
</h2>
...
<h3 className="text-xl text-gray-900 mb-6 leading-snug font-manrope font-medium tracking-tighter">
                        Sistemas que escalam.<br/>Automação que funciona.
                    </h3>
<p className="text-gray-500 leading-relaxed text-[15px] font-sans">
                        "A Audaces Growth Dev transformou a nossa empresa de limpezas. O CRM automatizou os nossos orçamentos e ganhamos dezenas de horas por semana para nos focarmos no serviço."
                    </p>
</div>
...
<div>
<p className="text-sm text-gray-900 font-sans">Sofia M.</p>
<p className="text-xs text-gray-500 font-sans">Gerente Operacional</p>
</div>
</div>
</div>
...
<span className="text-white text-lg tracking-tight mix-blend-overlay font-sans">Domínio Local©</span>
</div>
<div className="absolute bottom-8 right-8 z-10">
<span className="text-white/60 text-xs uppercase tracking-widest font-sans">Algarve, PT</span>
</div>
</div>
...
<p className="text-gray-500 text-lg mt-8 font-sans">Aumento médio na <br/> taxa de conversão</p>
...
<span className="text-5xl text-gray-900 font-manrope font-medium tracking-tighter">+45%</span>
</div>
</div>
</div>
...
<span className="text-xl font-manrope font-medium tracking-tighter">Transformação</span>
...
<p className="text-gray-400 leading-relaxed mb-12 max-w-[260px] text-[15px] font-sans">
                        Pronto para modernizar a sua empresa? Seja um negócio local de serviços ou um projeto de construção, nós temos a solução tecnológica ideal.
                    </p>
<div className="space-y-2 text-sm text-gray-400 font-mono">
<a className="block hover:text-emerald-400 transition-colors font-sans" href="mailto:geral@audacesgrowth.pt">geral@audacesgrowth.pt</a>
<a className="block hover:text-emerald-400 transition-colors font-sans" href="#">+351 912 345 678</a>
<a className="block hover:text-emerald-400 transition-colors font-sans" href="#">Portimão, Faro</a>
</div>
</div>
...
<span className="text-[12rem] lg:text-[18rem] text-white/[0.02] leading-none font-manrope font-medium tracking-tighter">PLANOS</span>
</div>
...
<h2 className="text-4xl md:text-5xl text-white mb-4 font-manrope font-medium tracking-tighter">
                        Pague pelo <br/> crescimento.
                    </h2>
<p className="text-gray-400 text-sm md:text-base max-w-md mx-auto leading-relaxed font-sans">
                        Sistemas de alta performance acessíveis para negócios locais que querem dominar a região do Algarve.
                    </p>
</div>
...
<iconify-icon className="text-white text-xl" icon="lucide:layout"></iconify-icon>
</div>
</div>
<div className="mb-6">
<div className="flex items-baseline gap-1">
<span className="text-3xl text-white font-manrope font-medium tracking-tighter">490€</span>
</div>
<h3 className="text-lg text-white mt-4 font-sans">Presença Digital</h3>
<p className="text-sm text-gray-400 mt-2 leading-relaxed font-sans">Para negócios locais que precisam de gerar contactos qualificados.</p>
</div>
<button className="w-full bg-white text-black py-3 rounded-xl text-sm mb-8 hover:bg-gray-200 transition-colors flex items-center justify-center gap-2 font-sans">
                            Começar Projeto <iconify-icon className="text-base" icon="lucide:arrow-right"></iconify-icon>
</button>
<div className="space-y-4 mt-auto">
<p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Inclui</p>
<ul className="space-y-3">
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Website de Alta Conversão
                                </li>
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Formulários de Captura de Leads
                                </li>
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Botão Direto para o WhatsApp
                                </li>
</ul>
</div>
</div>
...
<span className="bg-emerald-400 text-black text-[10px] px-2 py-1 rounded uppercase tracking-wider font-sans font-bold">Mais Popular</span>
</div>
<div className="mb-6 relative z-10">
<div className="flex items-baseline gap-1">
<span className="text-3xl text-white font-manrope font-medium tracking-tighter">990€</span>
</div>
<h3 className="text-lg text-white mt-4 font-sans">Crescimento &amp; Automação</h3>
<p className="text-sm text-gray-400 mt-2 leading-relaxed font-sans">Para empresas de serviços prontas para escalar a sua operação.</p>
</div>
<button className="relative z-10 w-full bg-[#10b981] text-white py-3 rounded-xl text-sm mb-8 hover:bg-[#059669] transition-colors flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.3)] font-sans">
                            Agendar Consultoria <iconify-icon className="text-base" icon="lucide:arrow-right"></iconify-icon>
</button>
<div className="space-y-4 mt-auto relative z-10">
<p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Tudo no anterior e ainda</p>
<ul className="space-y-3">
<li className="flex items-center gap-3 text-sm text-white font-sans">
<iconify-icon className="text-emerald-400" icon="lucide:check-circle"></iconify-icon> CRM de Vendas Completo
                                </li>
<li className="flex items-center gap-3 text-sm text-white font-sans">
<iconify-icon className="text-emerald-400" icon="lucide:check-circle"></iconify-icon> Automação de Redes Sociais com IA
                                </li>
<li className="flex items-center gap-3 text-sm text-white font-sans">
<iconify-icon className="text-emerald-400" icon="lucide:check-circle"></iconify-icon> Follow-ups Automáticos
                                </li>
</ul>
</div>
</div>
...
<div className="mb-6 flex items-start justify-between">
<div className="h-10 w-10 rounded-xl bg-white/10 flex items-center justify-center border border-white/10">
<iconify-icon className="text-white text-xl" icon="lucide:calculator"></iconify-icon>
</div>
</div>
<div className="mb-6">
<div className="flex items-baseline gap-1">
<span className="text-3xl text-white font-manrope font-medium tracking-tighter">Sob medida</span>
</div>
<h3 className="text-lg text-white mt-4 font-sans">Sistemas Complexos</h3>
<p className="text-sm text-gray-400 mt-2 leading-relaxed font-sans">Para construtoras, empresas de limpeza e operações com fluxos específicos.</p>
</div>
<button className="w-full bg-white text-black py-3 rounded-xl text-sm mb-8 hover:bg-gray-200 transition-colors flex items-center justify-center gap-2 font-sans">
                            Pedir Orçamento <iconify-icon className="text-base" icon="lucide:arrow-right"></iconify-icon>
</button>
<div className="space-y-4 mt-auto">
<p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Características</p>
<ul className="space-y-3">
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Calculadoras de Orçamentos
                                </li>
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Integrações à Medida (Make/Zapier)
                                </li>
<li className="flex items-center gap-3 text-sm text-gray-300 font-sans">
<iconify-icon className="text-gray-500" icon="lucide:check-circle"></iconify-icon> Portais de Cliente e Funcionário
                                </li>
</ul>
</div>
</div>
...
<span className="text-sm text-gray-500 mb-2 block font-sans">/ Suporte</span>
<h2 className="text-3xl text-gray-900 font-manrope font-medium tracking-tighter">Perguntas Frequentes</h2>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">

<div className="group">
<h3 className="text-lg text-gray-900 mb-2 flex items-center gap-2 font-sans font-medium">
...
<iconify-icon className="text-gray-400 text-sm" icon="lucide:plus"></iconify-icon>
                                ...
                                Como a Inteligência Artificial pode ajudar a minha empresa em Portimão?
                            </h3>
<p className="text-gray-500 text-sm leading-relaxed pl-8 font-sans">
                                A IA atua como um funcionário incansável: qualifica leads nas redes sociais, gera orçamentos automáticos para os seus serviços (limpeza, obras) e otimiza as suas campanhas de vendas 24/7 sem que tenha de intervir.
                            </p>
</div>
...
<iconify-icon className="text-gray-400 text-sm" icon="lucide:plus"></iconify-icon>
                                ...
                                O que está incluído nos sistemas de CRM e Automação?
                            </h3>
<p className="text-gray-500 text-sm leading-relaxed pl-8 font-sans">
                                Implementamos pipelines de vendas visuais, mensagens automáticas de acompanhamento no WhatsApp e email, e painéis de controlo para gerir todos os seus potenciais e atuais clientes num só lugar.
                            </p>
</div>
...
<iconify-icon className="text-gray-400 text-sm" icon="lucide:plus"></iconify-icon>
                                ...
                                Fazem sistemas de cálculo sob medida para orçamentos?
                            </h3>
<p className="text-gray-500 text-sm leading-relaxed pl-8 font-sans">
                                Sim. Criamos calculadoras personalizadas para o seu website ou uso interno. O seu cliente insere os metros quadrados ou o tipo de serviço pretendido, e o sistema gera o orçamento e envia a proposta em PDF automaticamente.
                            </p>
</div>
...
<iconify-icon className="text-gray-400 text-sm" icon="lucide:plus"></iconify-icon>
                                ...
                                Quanto tempo demora a implementar o sistema?
                            </h3>
<p className="text-gray-500 text-sm leading-relaxed pl-8 font-sans">
                                Projetos focados em presença digital levam cerca de 2-3 semanas. Sistemas de automação de CRM e calculadoras complexas podem levar de 4 a 6 semanas, dependendo da especificidade do seu processo comercial.
                            </p>
</div>
</div>
</div>
...
<iconify-icon className="text-emerald-400 text-2xl drop-shadow-[0_0_8px_rgba(52,211,153,0.5)]" icon="lucide:rocket"></iconify-icon>
</div>
</div>
<h2 className="text-4xl md:text-5xl lg:text-6xl text-white mb-6 font-manrope font-medium tracking-tighter">Pronto para digitalizar o seu negócio?</h2>
<p className="text-gray-400 text-lg mb-10 max-w-lg mx-auto leading-relaxed font-sans">Junte-se às empresas locais em Portimão que já automatizam os seus processos e aumentam vendas com a Audaces.</p>
...
<button className="px-8 py-3 rounded-full bg-gradient-to-b from-emerald-500 to-emerald-700 text-white hover:brightness-110 transition-all shadow-[0_0_25px_rgba(16,185,129,0.2)] flex items-center gap-2 border border-emerald-400/20 font-sans">
                            Agendar Reunião Gratuita <iconify-icon className="text-lg" icon="lucide:arrow-right"></iconify-icon>
</button>
...
<h3 className="text-3xl text-white font-manrope font-bold tracking-tighter">Audaces<span className="text-emerald-500 font-manrope font-medium tracking-tighter">.</span></h3>
<p className="text-gray-500 text-sm leading-relaxed max-w-sm font-sans">
                            Tecnologia, desenvolvimento web e Inteligência Artificial para alavancar e automatizar negócios em Portimão e no Algarve.
                        </p>
...
<h4 className="text-white font-sans">Serviços</h4>
<ul className="space-y-3 text-sm text-gray-500">
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Websites de Conversão</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Sistemas de CRM</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Automação com IA</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Calculadoras Sob Medida</a></li>
</ul>
</div>

<div className="space-y-6">
<h4 className="text-white font-sans">Empresa</h4>
<ul className="space-y-3 text-sm text-gray-500">
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Sobre Nós</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Casos de Sucesso</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Contactos</a></li>
</ul>
</div>

<div className="space-y-6 hidden sm:block">
<h4 className="text-white font-sans">Legal</h4>
<ul className="space-y-3 text-sm text-gray-500">
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Termos e Condições</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Política de Privacidade</a></li>
<li><a className="hover:text-emerald-400 transition-colors font-sans" href="#">Aviso Legal</a></li>
</ul>
</div>
</div>
</div>

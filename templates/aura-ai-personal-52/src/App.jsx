...
<style>
    @keyframes auraAmbientDriftOne {
      ...
      70% {
        transform: translate3d(-2vw, 5vh, 0) scale(0.98);
      }
    }
  
    @keyframes auraAmbientDriftTwo {
      ...
      75% {
        transform: translate3d(3vw, -5vh, 0) scale(0.96);
      }
    }
  
    @keyframes auraAmbientDriftThree {
    ...
    .aura-bg-blob-one {
      animation: auraAmbientDriftOne 26s ease-in-out infinite;
    }
  
    .aura-bg-blob-two {
      animation: auraAmbientDriftTwo 32s ease-in-out infinite;
    }
  
    .aura-bg-blob-three {
      animation: auraAmbientDriftThree 30s ease-in-out infinite;
    }
  
    .aura-bg-dots {
      animation: auraDotDrift 38s linear infinite;
    }
...
<a className="relative transition-colors duration-300 hover:text-blue-600 after:absolute after:left-0 after:-bottom-1.5 after:h-px after:w-0 after:bg-blue-500 after:transition-all after:duration-300 hover:after:w-full" href="#features">
  
              Features
  
            </a>
<a className="relative transition-colors duration-300 hover:text-blue-600 after:absolute after:left-0 after:-bottom-1.5 after:h-px after:w-0 after:bg-blue-500 after:transition-all after:duration-300 hover:after:w-full" href="#workflow">
  
              Workflow
  
            </a>
<a className="relative transition-colors duration-300 hover:text-blue-600 after:absolute after:left-0 after:-bottom-1.5 after:h-px after:w-0 after:bg-blue-500 after:transition-all after:duration-300 hover:after:w-full" href="#built-for">
  
              Built For
  
            </a>
<a className="relative transition-colors duration-300 hover:text-blue-600 after:absolute after:left-0 after:-bottom-1.5 after:h-px after:w-0 after:bg-blue-500 after:transition-all after:duration-300 hover:after:w-full" href="#privacy">
  
              Privacy
  
            </a>
<a className="relative transition-colors duration-300 hover:text-blue-600 after:absolute after:left-0 after:-bottom-1.5 after:h-px after:w-0 after:bg-blue-500 after:transition-all after:duration-300 hover:after:w-full" href="#pricing">
...
<a className="hidden sm:inline-flex items-center justify-center rounded-full px-4 py-2 text-xs text-slate-700 bg-white/78 border border-slate-200 shadow-[0_1px_2px_rgba(15,23,42,0.04),inset_0_1px_0_white] hover:bg-white hover:text-blue-600 hover:-translate-y-0.5 transition-all duration-300" href="#workflow">
  
              Explore Workflow
  
            </a>
<a className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs text-white bg-gradient-to-b from-blue-500 to-blue-600 border border-blue-700 shadow-[0_5px_14px_rgba(59,130,246,0.28),inset_0_1px_0_rgba(255,255,255,0.35)] hover:from-blue-400 hover:to-blue-500 hover:-translate-y-0.5 transition-all duration-300" href="#pricing">
...
<iconify-icon className="text-base text-blue-500" icon="solar:stars-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</span>
...
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 bg-gradient-to-b from-blue-500 to-blue-600 border border-blue-700 text-white text-sm font-normal shadow-[0_10px_24px_rgba(59,130,246,0.26),inset_0_1px_0_rgba(255,255,255,0.35)] hover:from-blue-400 hover:to-blue-500 hover:-translate-y-0.5 active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.18)] transition-all duration-300" href="#pricing">
              Start Free Trial
              <iconify-icon className="text-lg" icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 bg-gradient-to-b from-white to-slate-50 border border-slate-200 text-slate-700 text-sm font-normal shadow-[0_4px_12px_rgba(15,23,42,0.05),inset_0_1px_0_white] hover:from-slate-50 hover:to-slate-100 hover:-translate-y-0.5 transition-all duration-300" href="#workflow">
<iconify-icon className="text-lg text-blue-500" icon="solar:play-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
              See How It Works
            </a>
</div>
...
<iconify-icon className="text-base text-blue-500" icon="solar:shield-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
              Private by design
            </span>
<span className="hidden sm:block w-1 h-1 rounded-full bg-slate-300"></span>
<span className="inline-flex items-center gap-2">
<iconify-icon className="text-base text-blue-500" icon="solar:devices-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
              Works across desktop and mobile
            </span>
<span className="hidden sm:block w-1 h-1 rounded-full bg-slate-300"></span>
<span className="inline-flex items-center gap-2">
<iconify-icon className="text-base text-blue-500" icon="solar:bolt-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<iconify-icon className="text-lg text-emerald-500" icon="solar:bell-bing-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<iconify-icon className="text-lg text-blue-500" icon="solar:document-text-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-900 font-normal">
                      Summary ready
...
<iconify-icon className="text-lg text-indigo-500" icon="solar:calendar-mark-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-900 font-normal">
                      Focus block saved
...
<iconify-icon className="text-lg text-slate-600" icon="solar:chat-round-dots-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-900 font-normal">
                      Reply drafted
...
<iconify-icon className="text-lg text-blue-500" icon="solar:microphone-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<iconify-icon className="text-lg text-indigo-500" icon="solar:checklist-minimalistic-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<iconify-icon className="text-base text-blue-500" icon="solar:lock-keyhole-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-xs text-blue-500" icon="solar:shield-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<iconify-icon className="text-2xl" icon="solar:lightbulb-bolt-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<div className="group flex flex-col gap-4 rounded-[2rem] bg-white/62 border border-white p-6 shadow-[0_10px_28px_-20px_rgba(15,23,42,0.24),inset_0_1px_0_white] hover:-translate-y-1 hover:bg-white/82 transition-all duration-300">
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-500 shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl" icon="solar:widget-5-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<h3 className="text-lg font-normal tracking-tight text-slate-950">
...
<a className="group flex items-center justify-center gap-3 bg-white hover:bg-slate-100 transition-all text-slate-900 text-sm font-normal rounded-full px-6 py-3 w-fit shadow-[inset_0_1px_0_white] hover:-translate-y-0.5" href="#workflow">
...
<a className="group flex items-center justify-center gap-3 bg-white/[0.07] hover:bg-white/[0.1] transition-all text-white text-sm font-normal rounded-full px-6 py-3 w-fit border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]" href="#pricing">
...
<iconify-icon className="text-base text-blue-500" icon="solar:microphone-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<div className="flex items-center gap-3 rounded-2xl bg-white border border-slate-200 px-3 py-3 shadow-[0_2px_8px_rgba(15,23,42,0.03),inset_0_1px_0_white]">
<div className="w-8 h-8 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center">
<iconify-icon className="text-base text-blue-500" icon="solar:letter-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs font-normal text-slate-900">
...
<div className="flex items-center gap-3 rounded-2xl bg-white border border-slate-200 px-3 py-3 shadow-[0_2px_8px_rgba(15,23,42,0.03),inset_0_1px_0_white]">
<div className="w-8 h-8 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center">
<iconify-icon className="text-base text-blue-500" icon="solar:document-text-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs font-normal text-slate-900">
...
<iconify-icon className="text-base text-slate-600" icon="solar:calendar-mark-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs font-normal text-slate-900">
...
<div className="flex items-center gap-3">
<iconify-icon className="text-lg text-white" icon="solar:checklist-minimalistic-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<div>
<p className="text-xs font-normal text-white">
...
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center">
<iconify-icon className="text-lg text-blue-500" icon="solar:bolt-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-900 font-normal">
...
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center">
<iconify-icon className="text-lg text-blue-500" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-900 font-normal">
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:sun-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<div className="flex items-center justify-between gap-4">
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:microphone-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<div className="flex items-center justify-between gap-4">
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:case-round-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<span className="font-['JetBrains_Mono',monospace] text-[10px] text-blue-500 bg-blue-50 border border-blue-100 rounded-full px-2.5 py-1">
...
<div className="flex items-center justify-between gap-4">
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:checklist-minimalistic-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<span className="font-['JetBrains_Mono',monospace] text-[10px] text-blue-500 bg-blue-50 border border-blue-100 rounded-full px-2.5 py-1">
...
<div className="flex items-center justify-between gap-4">
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:chat-round-dots-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<span className="font-['JetBrains_Mono',monospace] text-[10px] text-blue-500 bg-blue-50 border border-blue-100 rounded-full px-2.5 py-1">
...
<iconify-icon className="text-2xl text-slate-600" icon="solar:database-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<span className="font-['JetBrains_Mono',monospace] text-[10px] text-slate-500 bg-white border border-slate-200 rounded-full px-2.5 py-1 shadow-[inset_0_1px_0_white]">
...
<iconify-icon className="text-xl text-blue-500" icon="solar:moon-stars-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<section className="max-w-7xl mx-auto px-6 py-20" id="workflow">
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:inbox-in-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<div className="mt-4 rounded-[2rem] bg-white/70 border border-white p-6 min-h-[15rem] shadow-[0_16px_36px_-26px_rgba(15,23,42,0.32),inset_0_1px_0_white] group-hover:-translate-y-1 group-hover:bg-white/85 transition-all duration-300">
<div className="w-11 h-11 mx-auto rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white] mb-5">
<iconify-icon className="text-2xl text-blue-500" icon="solar:document-text-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-xl font-normal tracking-tight text-slate-950">
...
<div className="mt-4 rounded-[2rem] bg-white/70 border border-white p-6 min-h-[15rem] shadow-[0_16px_36px_-26px_rgba(15,23,42,0.32),inset_0_1px_0_white] group-hover:-translate-y-1 group-hover:bg-white/85 transition-all duration-300">
<div className="w-11 h-11 mx-auto rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white] mb-5">
<iconify-icon className="text-2xl text-blue-500" icon="solar:target-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-xl font-normal tracking-tight text-slate-950">
...
<a className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 bg-gradient-to-b from-white to-slate-50 border border-slate-200 text-slate-700 text-sm font-normal shadow-[0_6px_16px_rgba(15,23,42,0.06),inset_0_1px_0_white] hover:from-slate-50 hover:to-slate-100 hover:-translate-y-0.5 transition-all duration-300" href="#features">

        Explore Capabilities

      </a>
<a className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 bg-gradient-to-b from-blue-500 to-blue-600 border border-blue-700 text-white text-sm font-normal shadow-[0_10px_24px_rgba(59,130,246,0.26),inset_0_1px_0_rgba(255,255,255,0.35)] hover:from-blue-400 hover:to-blue-500 hover:-translate-y-0.5 transition-all duration-300" href="#pricing">
...
<section className="max-w-7xl mx-auto px-6 py-20" id="built-for">
...
<a className="inline-flex items-center gap-2 justify-center rounded-full px-6 py-3.5 text-sm font-normal text-white bg-gradient-to-b from-blue-500 to-blue-600 border border-blue-700 shadow-[0_10px_24px_rgba(59,130,246,0.26),inset_0_1px_0_rgba(255,255,255,0.35)] hover:from-blue-400 hover:to-blue-500 hover:-translate-y-0.5 transition-all duration-300" href="#pricing">

        Try AURA Free

        <iconify-icon className="text-lg" icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
<a className="inline-flex items-center justify-center rounded-full px-6 py-3.5 text-sm font-normal text-slate-700 bg-gradient-to-b from-white to-slate-50 border border-slate-200 shadow-[0_6px_16px_rgba(15,23,42,0.06),inset_0_1px_0_white] hover:from-slate-50 hover:to-slate-100 hover:-translate-y-0.5 transition-all duration-300" href="#workflow">
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:rocket-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<h3 className="text-xl font-normal tracking-tight text-slate-950">
              Founders &amp; Builders
...
<iconify-icon className="text-lg text-blue-500" icon="solar:case-round-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
<div className="space-y-3">
...
<iconify-icon className="text-2xl text-white" icon="solar:user-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<iconify-icon className="text-lg text-blue-500" icon="solar:pen-new-square-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
<div className="rounded-2xl bg-white text-slate-900 border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.03),inset_0_1px_0_white]">
<p className="text-xs text-slate-400 font-light">
...
<div className="flex items-start gap-4">
<div className="w-11 h-11 shrink-0 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:magic-stick-3-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<h3 className="text-xl font-normal tracking-tight text-slate-950">
...
<iconify-icon className="text-xl text-blue-500" icon="solar:widget-5-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<div className="bg-white/68 border border-white rounded-[2rem] p-6 shadow-[0_12px_30px_-24px_rgba(15,23,42,0.3),inset_0_1px_0_white]">
<div className="w-10 h-10 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white] mb-5">
<iconify-icon className="text-xl text-blue-500" icon="solar:target-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<p className="text-3xl font-normal tracking-tight text-slate-950">
...
<div className="bg-white/68 border border-white rounded-[2rem] p-6 shadow-[0_12px_30px_-24px_rgba(15,23,42,0.3),inset_0_1px_0_white]">
<div className="w-10 h-10 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white] mb-5">
<iconify-icon className="text-xl text-blue-500" icon="solar:bell-bing-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<p className="text-3xl font-normal tracking-tight text-slate-950">
...
<iconify-icon className="text-xl text-blue-500" icon="solar:sun-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<section className="max-w-7xl mx-auto px-6 py-20" id="privacy">
...
<iconify-icon className="text-base text-blue-500" icon="solar:database-linear" style={{strokeWidth: '1.5'}}></iconify-icon>

            Controlled memory

          </span>
<span className="inline-flex items-center gap-2 rounded-full bg-white/72 border border-white px-4 py-2 text-xs text-slate-600 font-light shadow-[0_8px_20px_-16px_rgba(15,23,42,0.24),inset_0_1px_0_white]">
<iconify-icon className="text-base text-blue-500" icon="solar:tuning-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>

            Clear boundaries

          </span>
<span className="inline-flex items-center gap-2 rounded-full bg-white/72 border border-white px-4 py-2 text-xs text-slate-600 font-light shadow-[0_8px_20px_-16px_rgba(15,23,42,0.24),inset_0_1px_0_white]">
<iconify-icon className="text-base text-blue-500" icon="solar:restart-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:lock-keyhole-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-lg text-slate-600" icon="solar:clock-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-sm font-normal text-slate-900">
...
<iconify-icon className="text-lg text-blue-500" icon="solar:shield-warning-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-sm font-normal text-slate-900">
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:database-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-lg font-normal tracking-tight text-slate-950">
...
<div className="absolute inset-x-6 top-0 h-px bg-gradient-to-r from-transparent via-blue-200/60 to-transparent"></div>
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-5 shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:folder-security-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-lg font-normal tracking-tight text-slate-950">
...
<div className="absolute inset-x-6 top-0 h-px bg-gradient-to-r from-transparent via-blue-200/60 to-transparent"></div>
<div className="w-11 h-11 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-5 shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-2xl text-blue-500" icon="solar:tuning-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-lg font-normal tracking-tight text-slate-950">
...
<iconify-icon className="text-2xl text-blue-500" icon="solar:trash-bin-minimalistic-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-lg font-normal tracking-tight text-slate-950">
...
<input className="sr-only" id="toggle-checkbox" onchange="togglePricing()" type="checkbox"/>

<div className="absolute left-1 top-1 bottom-1 w-[calc(50%-0.25rem)] bg-gradient-to-b from-white to-slate-50 rounded-full shadow-[0_2px_5px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,1)] border border-slate-200 transition-transform duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]" id="toggle-pill">
</div>
<span className="relative w-1/2 text-center text-xs text-slate-800 font-normal transition-colors duration-300 py-2.5 z-10" id="label-mo">
    
          Monthly
    
        </span>
<span className="relative w-1/2 flex items-center justify-center gap-1.5 text-center text-xs text-slate-400 font-normal transition-colors duration-300 py-2.5 z-10" id="label-yr">
...
<iconify-icon className="block text-[22px] leading-none" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-blue-400 text-lg" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<iconify-icon className="block text-[22px] leading-none" icon="solar:stars-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<div className="w-11 h-11 min-w-11 min-h-11 shrink-0 rounded-2xl bg-gradient-to-b from-white to-slate-50 shadow-[0_6px_16px_rgba(15,23,42,0.08),inset_0_1px_0_white] flex items-center justify-center text-slate-400 border border-slate-200">
<iconify-icon className="block text-[22px] leading-none" icon="solar:buildings-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-2xl text-blue-200" icon="solar:question-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<div className="flex items-center gap-3">
<iconify-icon className="text-xl text-blue-200" icon="solar:shield-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<div className="rounded-2xl bg-white/[0.07] border border-white/10 px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<iconify-icon className="text-xl text-blue-200" icon="solar:document-text-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<span className="text-sm text-white font-normal">
...
<div className="rounded-2xl bg-white/[0.07] border border-white/10 px-4 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
<div className="flex items-center gap-3">
<iconify-icon className="text-xl text-blue-200" icon="solar:restart-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<span className="text-sm text-white font-normal">
...
<a className="inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 bg-white text-slate-950 text-sm font-normal border border-white shadow-[inset_0_1px_0_white] hover:bg-slate-100 hover:-translate-y-0.5 transition-all" href="#pricing">

              Try AURA Free

              <iconify-icon className="text-lg" icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
<a className="inline-flex items-center justify-center rounded-full px-5 py-3 bg-white/[0.07] text-white text-sm font-normal border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] hover:bg-white/[0.1] transition-all" href="#privacy">
...
<iconify-icon className="text-xl text-blue-500" icon="solar:chat-round-like-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
...
<iconify-icon className="text-xl text-slate-500 group-open:rotate-45 transition-transform" icon="solar:add-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
</summary>
...
<div className="flex items-center gap-4">
<div className="w-10 h-10 shrink-0 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-xl text-blue-500" icon="solar:microphone-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-base md:text-lg font-normal tracking-tight text-slate-950">
...
<div className="flex items-center gap-4">
<div className="w-10 h-10 shrink-0 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-xl text-blue-500" icon="solar:devices-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-base md:text-lg font-normal tracking-tight text-slate-950">
...
<div className="flex items-center gap-4">
<div className="w-10 h-10 shrink-0 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-xl text-blue-500" icon="solar:shield-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-base md:text-lg font-normal tracking-tight text-slate-950">
...
<div className="flex items-center gap-4">
<div className="w-10 h-10 shrink-0 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center shadow-[inset_0_1px_0_white]">
<iconify-icon className="text-xl text-blue-500" icon="solar:user-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-base md:text-lg font-normal tracking-tight text-slate-950">
...
<section className="max-w-7xl mx-auto px-6 pt-14 pb-20" id="final-cta">
...
<iconify-icon className="text-lg text-blue-500" icon="solar:sun-2-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
...
<iconify-icon className="text-lg text-emerald-500" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<div>
<p className="text-xs text-slate-950 font-normal">
              Follow-ups handled
...
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-7 py-3.5 bg-gradient-to-b from-white to-blue-50 border border-white text-blue-600 text-sm font-normal shadow-[0_14px_30px_rgba(15,23,42,0.18),inset_0_1px_0_white] hover:from-white hover:to-white hover:-translate-y-0.5 active:shadow-[inset_0_2px_4px_rgba(15,23,42,0.08)] transition-all duration-300" href="#pricing">
          Try AURA Free
          <iconify-icon className="text-lg" icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
<a className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full px-7 py-3.5 bg-white/14 border border-white/24 text-white text-sm font-normal shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] hover:bg-white/20 hover:-translate-y-0.5 transition-all duration-300" href="#workflow">
          See Workflow
        </a>
</div>
...
<span className="inline-flex items-center gap-2">
<iconify-icon className="text-base text-white" icon="solar:shield-check-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
          Private by design
        </span>
<span className="hidden sm:block w-1 h-1 rounded-full bg-white/40"></span>
<span className="inline-flex items-center gap-2">
<iconify-icon className="text-base text-white" icon="solar:database-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
          Controlled memory
        </span>
<span className="hidden sm:block w-1 h-1 rounded-full bg-white/40"></span>
<span className="inline-flex items-center gap-2">
<iconify-icon className="text-base text-white" icon="solar:restart-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
          Reset anytime
        </span>
</div>
</div>
...
<a className="hover:text-blue-600 transition-colors" href="#features">

              Features

            </a>
<a className="hover:text-blue-600 transition-colors" href="#workflow">

              Workflow

            </a>
<a className="hover:text-blue-600 transition-colors" href="#built-for">
...
<a className="hover:text-blue-600 transition-colors" href="#faq">

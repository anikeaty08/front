...
<a className="text-xs font-medium text-white/50 hover:text-white transition-colors" href="#">Philosophy</a>
<a className="text-xs font-medium text-white/50 hover:text-white transition-colors" href="#">Ecosystem</a>
<a className="text-xs font-medium text-white/50 hover:text-white transition-colors" href="#">Rates</a>
</div>
...
<h1 className="lg:text-7xl leading-[1.1] text-brand-sky text-glow text-5xl italic tracking-tight font-serif mb-6" style={{}}>Coaching agency and Tech Operator <br/> <span className="text-white opacity-90">for top coaches</span></h1>
...
<li><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">API
                        Reference</a></li>
<li><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Governance</a>
</li>
<li><a className="flex items-center gap-2 text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">
                        System Status
                        <span className="relative flex h-1.5 w-1.5">

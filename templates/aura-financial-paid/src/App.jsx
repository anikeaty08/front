...
<div className="flex mr-8 gap-x-2.5 gap-y-2.5 items-center" onclick="window.location.href='/home'" role="button">
...
<path className="" d="M18.521 4.418L4.418 18.521a10 10 0 0 0 1.06 1.061L19.583 5.479a10 10 0 0 0-1.06-1.06" fill="#38bdf8">
</path>
</svg>
</div>
...
<a className="hover:text-white transition-colors text-xs font-medium text-white/50" href="/features">Features</a>
<a className="hover:text-white transition-colors text-xs font-medium text-white/50" href="/about">About</a>
<a className="hover:text-white transition-colors text-xs font-medium text-white/50" href="/pricing">Pricing</a>
</div>

<button className="flex hover:bg-brand-sky transition-colors group flex-none text-xs font-semibold text-black bg-white rounded-full pt-2 pr-4 pb-2 pl-4 gap-x-2 gap-y-2 items-center" onclick="window.location.href='/login'" role="button">
            Start Engine
            <svg aria-hidden="true" className="iconify group-hover:translate-x-0.5 transition-transform" data-icon="solar:arrow-right-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path className="" d="M13.25 12.75V18a.75.75 0 0 0 1.28.53l6-6a.75.75 0 0 0 0-1.06l-6-6a.75.75 0 0 0-1.28.53z" fill="currentColor"></path></svg>
</button>
</nav>
...
<button className="hover:bg-white/10 hover:text-white transition-all flex text-sm font-medium text-slate-300 bg-white/5 rounded-full pt-3 pr-6 pb-3 pl-6 gap-x-2 gap-y-2 items-center group" style={{boxShadow: '0 4px 20px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.05)', position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.15))', -BorderRadiusBefore: '9999px'}}>
<span className="text-sm font-medium tracking-tight">
                        View Ecosystem
                    </span>
<svg className="opacity-70 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
</div>
...
<path className="beam-line animate-beam opacity-60" d="M -50 150 C 100 150, 100 300, 300 300" fill="none" stroke="#38BDF8" strokeWidth="1.5"></path>
</g>

<g>
<path className="opacity-[0.08]" d="M -50 450 C 100 450, 100 300, 300 300" fill="none" stroke="white" strokeWidth="1"></path>
<path className="beam-line animate-beam opacity-60" d="M -50 450 C 100 450, 100 300, 300 300" fill="none" stroke="#38BDF8" strokeWidth="1.5" style={{animationDelay: '-1s'}}></path>
</g>

<g>
<path className="opacity-[0.08]" d="M 650 100 C 500 100, 500 300, 300 300" fill="none" stroke="white" strokeWidth="1"></path>
<path className="beam-line animate-beam opacity-60" d="M 650 100 C 500 100, 500 300, 300 300" fill="none" stroke="#38BDF8" strokeWidth="1.5" style={{animationDelay: '-2s'}}></path>
</g>

<g>
<path className="opacity-[0.08]" d="M 650 500 C 500 500, 500 300, 300 300" fill="none" stroke="white" strokeWidth="1"></path>
<path className="beam-line animate-beam opacity-60" d="M 650 500 C 500 500, 500 300, 300 300" fill="none" stroke="#38BDF8" strokeWidth="1.5" style={{animationDelay: '-1.5s'}}></path>
</g>
...
<circle className="animate-sonar" fill="none" opacity="0.5" r="20" stroke="#38BDF8" strokeWidth="1"></circle>
<circle className="animate-sonar delay-1000" fill="none" opacity="0.5" r="20" stroke="#38BDF8" strokeWidth="1">
</circle>
<circle className="animate-sonar delay-2000" fill="none" opacity="0.5" r="20" stroke="#38BDF8" strokeWidth="1">
</circle>
...
<circle className="animate-spin-slow-reverse" fill="none" r="45" stroke="#38BDF8" stroke-dasharray="4 6" stroke-opacity="0.2" strokeWidth="1"></circle>
...
<circle fill="#0A0A0A" r="8" stroke="#38BDF8" strokeWidth="2"></circle>
<circle className="animate-pulse-fast" fill="#38BDF8" r="4"></circle>
</g>
</svg>
...
<h2 className="md:text-6xl lg:text-7xl text-5xl italic text-white tracking-tight font-serif mb-8">
...
<path d="M200,0 L200,160" fill="none" stroke="rgba(255,255,255,0.03)" stroke-dasharray="2 4" strokeWidth="1">
</path>
</svg>
...
<svg className="lucide lucide-gem text-white/40 group-hover:text-brand-sky transition-colors" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-credit-card text-white/40 group-hover:text-brand-sky transition-colors" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-layers text-white relative z-20 group-hover:text-brand-sky transition-colors duration-500" fill="none" height="32" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-history text-white/40" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
</section><section className="overflow-hidden flex flex-col md:px-8 lg:px-12 z-10 bg-[#030303]/80 w-full border-white/5 border-t pt-32 pr-6 pb-32 pl-6 relative backdrop-blur-xl items-center">
...
<h2 className="md:text-5xl lg:text-7xl leading-[1.1] text-4xl italic text-white tracking-tight font-serif">
...
<div className="lg:col-span-4 relative group" data-aos="fade-up" data-aos-delay="100" style={{}}>
<div className="relative w-full aspect-[3.5/4] rounded-[24px] overflow-hidden border border-white/10 bg-white/[0.02]">

<img alt="Trader Profile" className="w-full h-full object-cover grayscale mix-blend-luminosity opacity-60 group-hover:opacity-80 group-hover:scale-105 transition-all duration-700 ease-out" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/346c8983-c047-4169-902a-df1305819be6_800w.jpg"/>
...
<svg className="text-brand-sky transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<h2 className="md:text-5xl lg:text-6xl leading-[1.1] text-4xl italic text-white tracking-tight font-serif">
                    Liquidate &amp; Exchange
...
<h3 className="md:text-4xl text-3xl italic text-white tracking-tight font-serif mb-6">
...
</section><section className="lg:px-12 flex flex-col overflow-hidden z-10 bg-[#030303]/50 w-full border-white/5 border-t px-6 py-32 relative backdrop-blur-xl items-center" id="pricing">
...
<div className="text-center mb-16 space-y-8 flex flex-col items-center" data-aos="fade-up">
<h2 className="md:text-5xl lg:text-6xl text-4xl italic text-white tracking-tight font-serif leading-[1.1]">
                Scale your <span className="text-white/40">market exposure.</span>
</h2>

<div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-full p-1.5 pr-6 pl-6 backdrop-blur-md">
<span className="text-xs font-mono text-white font-medium tracking-wide">MONTHLY</span>
<button className="relative w-11 h-6 bg-brand-sky rounded-full transition-colors focus:outline-none">
<span className="absolute right-1 top-1 bg-[#030303] w-4 h-4 rounded-full shadow-sm transition-transform transform"></span>
</button>
<span className="text-xs font-mono text-white/40 tracking-wide">ANNUAL</span>
</div>
</div>

<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">

<div className="group relative flex flex-col p-8 rounded-[32px] border border-white/10 bg-[#080808] hover:border-white/20 transition-all duration-300">
<div className="flex justify-between items-start mb-8">
<div className="flex flex-col">
<span className="text-3xl font-serif italic text-white mb-1">$299<span className="text-base text-white/40 font-sans not-italic font-light">/mo</span></span>
<h3 className="text-xs font-mono text-brand-sky tracking-widest uppercase">Execution</h3>
</div>
<button className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-white/5 hover:text-white transition-colors group-hover:border-white/20">
...
<p className="text-white/50 text-sm leading-relaxed mb-10 font-light border-b border-white/5 pb-8">
                    Essential market access for individual algorithmic traders with standard latency requirements.
                </p>
<div className="flex flex-col gap-4 mt-auto">
<span className="text-xs text-white font-medium mb-2">Protocol Specs</span>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Spot Market Access</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">50ms Execution Latency</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Standard API Limits</span>
</div>
<div className="flex items-center gap-3 opacity-30">
<svg className="w-4 h-4 text-white shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><line x1="18" x2="6" y1="6" y2="18"></line><line x1="6" x2="18" y1="6" y2="18"></line></svg>
<span className="text-xs text-white/60 font-light">Leverage &amp; Margin</span>
</div>
<div className="flex items-center gap-3 opacity-30">
<svg className="w-4 h-4 text-white shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><line x1="18" x2="6" y1="6" y2="18"></line><line x1="6" x2="18" y1="6" y2="18"></line></svg>
<span className="text-xs text-white/60 font-light">Dedicated Node</span>
</div>
</div>
</div>

<div className="group relative flex flex-col p-8 rounded-[32px] border border-brand-sky/30 bg-white/[0.03] hover:bg-white/[0.04] transition-all duration-300">

<div className="absolute inset-0 bg-brand-sky/5 rounded-[32px] blur-xl opacity-20 pointer-events-none"></div>
<div className="flex justify-between items-start mb-8 relative z-10">
<div className="flex flex-col">
<span className="text-3xl font-serif italic text-white mb-1">$799<span className="text-base text-white/40 font-sans not-italic font-light">/mo</span></span>
<div className="flex items-center gap-2">
<h3 className="text-xs font-mono text-brand-sky tracking-widest uppercase">Institution</h3>
<span className="px-2 py-0.5 rounded-full bg-white text-black text-[9px] font-bold tracking-wider uppercase">Pro</span>
</div>
</div>
<button className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center hover:bg-white/90 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.2)]">
...
<p className="text-white/70 text-sm leading-relaxed mb-10 font-light border-b border-white/10 pb-8 relative z-10">
                    Full-suite infrastructure for proprietary trading desks and small funds requiring deeper liquidity.
                </p>
<div className="flex flex-col gap-4 mt-auto relative z-10">
<span className="text-xs text-white font-medium mb-2">Everything in Execution, plus:</span>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-brand-sky shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/90 font-light">Cross-Margin &amp; Perps</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-brand-sky shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/90 font-light">&lt; 10ms Latency Guarantee</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-brand-sky shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/90 font-light">Sub-account Management</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-brand-sky shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/90 font-light">Compliance &amp; Audit Logs</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-brand-sky shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/90 font-light">Priority 24/7 Support</span>
</div>
</div>
</div>
...
<div className="flex justify-between items-start mb-8">
<div className="flex flex-col">
<span className="text-3xl font-serif italic text-white mb-1">$2,499<span className="text-base text-white/40 font-sans not-italic font-light">/mo</span></span>
<h3 className="text-xs font-mono text-brand-sky tracking-widest uppercase">Sovereign</h3>
</div>
<button className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-white/5 hover:text-white transition-colors group-hover:border-white/20">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
...
<p className="text-white/50 text-sm leading-relaxed mb-10 font-light border-b border-white/5 pb-8">
                    Custom-built architecture for exchanges, market makers, and sovereign wealth treasuries.
                </p>
<div className="flex flex-col gap-4 mt-auto">
<span className="text-xs text-white font-medium mb-2">Everything in Institution, plus:</span>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Direct Colocation</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Custom Matching Engine</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">White Label Interface</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Unlimited API Throughput</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-4 h-4 text-white/80 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg>
<span className="text-xs text-white/60 font-light">Dedicated Engineer Access</span>
</div>
</div>
</div>
</div>
</div>
</section><section className="lg:px-12 flex flex-col overflow-hidden z-10 bg-[#030303] w-full border-white/5 border-t px-6 py-32 relative items-center">

<div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:100px_200px] [mask-image:radial-gradient(ellipse_at_center,black_40%,transparent_100%)] pointer-events-none"></div>
...
<div className="relative group w-full aspect-[4/3] lg:aspect-video rounded-[32px] overflow-hidden border border-white/10 bg-[#080808]" data-aos="fade-right">

<img alt="Lead Architect" className="contrast-125 group-hover:scale-105 group-hover:opacity-90 transition-all duration-1000 opacity-80 mix-blend-luminosity w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a91c1566-41b6-46c6-9605-e4fbe4ed2f39_1600w.jpg"/>

<div className="bg-gradient-to-t from-[#030303] via-[#030303]/20 to-transparent opacity-80 absolute top-0 right-0 bottom-0 left-0"></div>
...
<iconify-icon className="text-brand-sky text-lg" icon="solar:verified-check-bold-duotone"></iconify-icon>
<div className="flex flex-col leading-none">
<span className="text-[10px] font-mono text-white/40 uppercase tracking-wider mb-0.5">Clearance</span>
<span className="text-xs font-medium text-white tracking-wide">Level 4: Architect</span>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-4">
<span className="w-8 h-[1px] bg-brand-sky/50"></span>
<span className="text-xs font-mono text-brand-sky uppercase tracking-[0.2em]">The Visionary</span>
</div>
<h2 className="md:text-5xl lg:text-6xl text-4xl italic text-white tracking-tight font-serif leading-[1.1]">
                    25k+ Active 
                    <span className="text-white/40">Institutions Worldwide.</span>
</h2>
<div className="space-y-6">
<p className="text-lg text-white/70 font-light leading-relaxed">
<span className="text-white font-medium">Dr. Elias Thorne</span> is a renowned expert in high-frequency distributed systems, trusted by over 25,000 sovereign and private desks across the globe.
                    </p>
<p className="text-lg text-white/70 font-light leading-relaxed">
                        With two decades of experience at top-tier quant firms, Elias has architected Aura to be the only cutting-edge digital experience capable of handling nation-state transaction volumes.
                    </p>
</div>

<div className="pt-4">
<button className="group relative flex items-center gap-3 px-6 py-3 rounded-full bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] hover:border-white/20 transition-all">
<iconify-icon className="text-brand-sky group-hover:rotate-12 transition-transform duration-300" icon="solar:user-id-bold-duotone"></iconify-icon>
<span className="text-sm font-mono text-white/80 uppercase tracking-wide">View Profile</span>
<span className="absolute right-4 w-1.5 h-1.5 rounded-full bg-brand-sky shadow-[0_0_8px_rgba(56,189,248,0.8)] animate-pulse"></span>
</button>
</div>
</div>
</div>

<div className="flex flex-col gap-6 w-full pt-8 pb-8 relative gap-x-6 gap-y-6" style={{maskImage: 'linear-gradient(90deg, transparent, black 10%, black 90%, transparent)', WebkitMaskImage: 'linear-gradient(90deg, transparent, black 10%, black 90%, transparent)'}}>

<div className="flex overflow-hidden w-full">
<div className="flex animate-marquee gap-6 w-max gap-x-6 gap-y-6 items-stretch">

<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
<div className="flex justify-between items-start">
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=33"/>
<div className="absolute -bottom-0.5 -right-0.5 bg-[#080808] p-0.5 rounded-full">
<div className="w-2.5 h-2.5 bg-brand-sky rounded-full border border-[#080808]"></div>
</div>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@quant_fund_Alpha</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"Aura transformed our outdated execution layer into a modern, stunning infrastructure that truly reflects our algorithmic speed."</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">Happy Client</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
<div className="flex justify-between items-start">
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=68"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@DesignGenius87</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"Beautifully crafted API with all the features I needed. The settlement times are instant. Highly recommend!"</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">Professional Trader</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
...
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=52"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@CodeWizPro</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"Perfectly designed template! It saved me so much development time integrating with the banking layer."</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">Satisfied Customer</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
...
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=12"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@PixelCrafter</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"Hands down the best protocol I've used. Clean, sleek, and customizable parameters."</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">Template Buyer</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
...
<div className="flex overflow-hidden w-full">
<div className="flex animate-marquee-reverse w-max gap-6 items-stretch">

<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
<div className="flex justify-between items-start">
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=47"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@StudioFlair</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"The flexibility of this template is amazing. It's perfect for any project requiring high-yield outputs!"</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">Web Designer</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
...
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=60"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@TechVentures</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
<p className="text-sm text-white/60 font-light leading-relaxed">"Security is paramount for us, and the audit logs here are detailed and compliant."</p>
<div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
<span className="text-xs font-medium text-white/80">CTO</span>
<span className="text-[10px] text-white/30 font-mono">Verified</span>
</div>
</div>
<div className="w-[380px] shrink-0 bg-[#080808] border border-white/10 p-7 rounded-2xl flex flex-col gap-5 group hover:border-brand-sky/30 hover:bg-white/[0.02] transition-colors relative">
...
<div className="flex items-center gap-3">
<div className="relative">
<img alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-300" src="https://i.pravatar.cc/150?img=15"/>
</div>
<div className="flex flex-col gap-1">
<span className="text-sm font-semibold text-white/90 leading-none">@GlobalMacro</span>
</div>
</div>
<iconify-icon className="text-white/20 group-hover:text-brand-sky/50 transition-colors" height="20" icon="solar:file-text-bold-duotone" width="20"></iconify-icon>
</div>
...
<img alt="User" className="w-10 h-10 rounded-full border-2 border-[#030303] grayscale hover:grayscale-0 transition-all" src="https://i.pravatar.cc/100?img=11"/>
<img alt="User" className="w-10 h-10 rounded-full border-2 border-[#030303] grayscale hover:grayscale-0 transition-all" src="https://i.pravatar.cc/100?img=33"/>
<img alt="User" className="w-10 h-10 rounded-full border-2 border-[#030303] grayscale hover:grayscale-0 transition-all" src="https://i.pravatar.cc/100?img=12"/>
<img alt="User" className="w-10 h-10 rounded-full border-2 border-[#030303] grayscale hover:grayscale-0 transition-all" src="https://i.pravatar.cc/100?img=59"/>
<div className="w-10 h-10 rounded-full border-2 border-[#030303] bg-white/10 flex items-center justify-center text-[10px] font-medium text-white backdrop-blur-sm">+10k</div>
</div>
</div>
<p className="text-sm text-white/40 font-mono tracking-wide">
                Trusted by <span className="text-white">10,000+</span> Audience worldwide
            </p>
</div>
</div>
</section><section className="lg:px-12 flex flex-col overflow-hidden z-10 bg-[#030303]/50 w-full border-white/5 border-t px-6 py-32 relative backdrop-blur-xl items-center" id="faq">
...
<div className="flex flex-col gap-8 max-w-md" data-aos="fade-right">
<span className="text-xs font-mono text-brand-sky tracking-widest uppercase flex items-center gap-2">
<svg className="iconify text-brand-sky" data-icon="solar:info-square-bold-duotone" height="14" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<path d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2c4.714 0 7.071 0 8.535 1.464C22 4.93 22 7.286 22 12c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22c-4.714 0-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z" fill="currentColor" fillOpacity="0.5"></path>
<path d="M12 7.25a.75.75 0 0 1 .75.75v8a.75.75 0 0 1-1.5 0V8a.75.75 0 0 1 .75-.75Z" fill="currentColor"></path>
<path d="M12 17a1 1 0 1 0 0-2a1 1 0 0 0 0 2Z" fill="currentColor"></path>
</svg>
                    Knowledge Base
                </span>
<p className="text-white/60 text-lg font-light leading-relaxed">
                    Whether you are deploying capital via API or structuring a complex hedge, our documentation engine provides the granular details required for execution.
                </p>
</div>

<div className="flex lg:justify-end" data-aos="fade-left">
<h2 className="md:text-5xl lg:text-6xl text-4xl italic text-white tracking-tight font-serif leading-[1.1] lg:text-right">
                    Protocol specifications 
                    <span className="text-white/40">decoded for clarity.</span>
</h2>
</div>
</div>
...
<div className="group border-b border-white/5 py-8 cursor-pointer relative overflow-hidden transition-all duration-300 hover:bg-white/[0.02] px-4 -mx-4 rounded-xl">
<div className="flex items-center justify-between gap-6">
<div className="flex flex-col gap-2">
<h4 className="text-xl md:text-2xl text-white font-serif italic group-hover:text-brand-sky transition-colors duration-300">Architecture &amp; Latency</h4>
</div>
<button className="w-12 h-12 shrink-0 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:bg-brand-sky group-hover:border-brand-sky group-hover:text-black transition-all duration-300 relative z-10">
<svg className="iconify transition-transform duration-300 group-hover:rotate-90" data-icon="solar:add-circle-bold-duotone" height="24" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10Z" fill="currentColor" fillOpacity="0.5"></path>
<path d="M12 15.5a1 1 0 0 1-1-1V13H9.5a1 1 0 0 1 0-2H11V9.5a1 1 0 0 1 2 0V11h1.5a1 1 0 0 1 0 2H13v1.5a1 1 0 0 1-1 1Z" fill="currentColor"></path>
</svg>
</button>
</div>

<div className="h-0 group-hover:h-auto overflow-hidden transition-all duration-300">
<p className="pt-4 text-white/50 text-sm leading-relaxed max-w-xl font-light">
                             Our matching engine is colocated in LD4 and NY4 data centers, providing guaranteed sub-10ms execution latency for institutional tiers.
                         </p>
</div>
</div>
...
<div className="group border-b border-white/5 py-8 cursor-pointer relative overflow-hidden transition-all duration-300 hover:bg-white/[0.02] px-4 -mx-4 rounded-xl">
<div className="flex items-center justify-between gap-6">
<h4 className="text-xl md:text-2xl text-white font-serif italic group-hover:text-brand-sky transition-colors duration-300">Liquidity &amp; Depth</h4>
<button className="w-12 h-12 shrink-0 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:bg-brand-sky group-hover:border-brand-sky group-hover:text-black transition-all duration-300 relative z-10">
<svg className="iconify transition-transform duration-300 group-hover:rotate-90" data-icon="solar:add-circle-bold-duotone" height="24" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10Z" fill="currentColor" fillOpacity="0.5"></path>
<path d="M12 15.5a1 1 0 0 1-1-1V13H9.5a1 1 0 0 1 0-2H11V9.5a1 1 0 0 1 2 0V11h1.5a1 1 0 0 1 0 2H13v1.5a1 1 0 0 1-1 1Z" fill="currentColor"></path>
...
<div className="group border-b border-white/5 py-8 cursor-pointer relative overflow-hidden transition-all duration-300 hover:bg-white/[0.02] px-4 -mx-4 rounded-xl">
<div className="flex items-center justify-between gap-6">
<h4 className="text-xl md:text-2xl text-white font-serif italic group-hover:text-brand-sky transition-colors duration-300">Custody &amp; Security</h4>
<button className="w-12 h-12 shrink-0 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:bg-brand-sky group-hover:border-brand-sky group-hover:text-black transition-all duration-300 relative z-10">
<svg className="iconify transition-transform duration-300 group-hover:rotate-90" data-icon="solar:add-circle-bold-duotone" height="24" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10Z" fill="currentColor" fillOpacity="0.5"></path>
<path d="M12 15.5a1 1 0 0 1-1-1V13H9.5a1 1 0 0 1 0-2H11V9.5a1 1 0 0 1 2 0V11h1.5a1 1 0 0 1 0 2H13v1.5a1 1 0 0 1-1 1Z" fill="currentColor"></path>
...
<div className="group border-b border-white/5 py-8 cursor-pointer relative overflow-hidden transition-all duration-300 hover:bg-white/[0.02] px-4 -mx-4 rounded-xl">
<div className="flex items-center justify-between gap-6">
<h4 className="text-xl md:text-2xl text-white font-serif italic group-hover:text-brand-sky transition-colors duration-300">API &amp; WebSockets</h4>
<button className="w-12 h-12 shrink-0 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:bg-brand-sky group-hover:border-brand-sky group-hover:text-black transition-all duration-300 relative z-10">
<svg className="iconify transition-transform duration-300 group-hover:rotate-90" data-icon="solar:add-circle-bold-duotone" height="24" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10Z" fill="currentColor" fillOpacity="0.5"></path>
<path d="M12 15.5a1 1 0 0 1-1-1V13H9.5a1 1 0 0 1 0-2H11V9.5a1 1 0 0 1 2 0V11h1.5a1 1 0 0 1 0 2H13v1.5a1 1 0 0 1-1 1Z" fill="currentColor"></path>
...
<div className="w-full aspect-[4/3] rounded-[24px] overflow-hidden border border-white/10 bg-[#080808] relative group shadow-2xl">

<div className="absolute inset-0 bg-[#050505]">
<div className="absolute top-0 right-0 w-[300px] h-[300px] bg-brand-sky/20 blur-[100px] rounded-full mix-blend-screen opacity-60"></div>
<div className="absolute bottom-0 left-0 w-[200px] h-[200px] bg-indigo-600/20 blur-[80px] rounded-full mix-blend-screen opacity-50"></div>
...
<div className="absolute inset-0 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-1000">
<div className="relative w-48 h-64 bg-white/5 border border-white/10 rounded-lg backdrop-blur-md transform -rotate-12 shadow-xl flex flex-col p-4">
<div className="w-8 h-8 rounded bg-brand-sky/20 mb-4 flex items-center justify-center text-brand-sky">
<svg className="iconify" data-icon="solar:file-text-bold-duotone" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M10 2h4a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h6Z" fill="currentColor" fillOpacity="0.5"></path><path d="M13.5 2.5V8a1.5 1.5 0 0 0 1.5 1.5h5.5l-5.354-6.883A2 2 0 0 0 13.5 2.5ZM8 13a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Zm0 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Z" fill="currentColor"></path></svg>
</div>
<div className="space-y-2">
<div className="h-2 w-3/4 bg-white/10 rounded"></div>
<div className="h-2 w-1/2 bg-white/10 rounded"></div>
<div className="h-2 w-full bg-white/5 rounded mt-4"></div>
<div className="h-2 w-full bg-white/5 rounded"></div>
</div>
</div>
<div className="absolute w-48 h-64 bg-[#0A0A0A] border border-white/20 rounded-lg shadow-[0_0_30px_rgba(0,0,0,0.5)] flex flex-col p-5">
<div className="flex justify-between items-center mb-6">
<span className="text-[10px] font-mono text-white/40 uppercase">Aura_Docs_v2</span>
<div className="flex gap-1">
<div className="w-1.5 h-1.5 rounded-full bg-brand-sky animate-pulse"></div>
</div>
</div>
...
<div className="h-1.5 w-3/4 bg-brand-sky/40 rounded-full"></div>
<div className="h-1.5 w-5/6 bg-white/10 rounded-full"></div>
</div>
<div className="mt-auto flex items-center gap-2">
<div className="px-2 py-1 rounded bg-brand-sky/10 border border-brand-sky/20">
<span className="text-[8px] font-mono text-brand-sky">API_REF</span>
</div>
</div>
</div>
</div>
...
<div className="flex flex-col gap-2">
<span className="text-brand-sky font-mono text-xs uppercase tracking-widest font-medium">Developer Resources</span>
<h5 className="text-white text-lg font-medium tracking-tight">Your Aura cheat sheet.</h5>
<p className="text-white/50 text-sm leading-relaxed font-light">
                        In a rush? Find fast and clear answers in our <a className="text-brand-sky hover:text-white transition-colors underline decoration-brand-sky/30 underline-offset-4" href="#">Quick Start Guide</a> to initialize your first trade.
                    </p>
</div>
</div>
</div>
...
<h2 className="leading-[1.05] md:text-5xl lg:text-6xl text-4xl italic text-[#030303] tracking-tight font-serif mb-8">
                Uncertain about your <span className="opacity-60 italic">allocation strategy?</span>
</h2>

<a className="group/card relative mt-4 w-full sm:w-80 h-36 bg-[#030303]/5 border border-[#030303]/10 rounded-2xl p-6 flex flex-col justify-between hover:bg-[#030303]/10 hover:border-[#030303]/20 hover:scale-[1.02] transition-all duration-300" href="#">
<div className="flex justify-between items-start">
<svg aria-hidden="true" className="iconify text-[#030303] w-8 h-8 opacity-80 iconify--solar" data-icon="solar:chat-round-line-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12c0 1.6.376 3.112 1.043 4.453c.178.356.237.763.134 1.148l-.595 2.226a1.3 1.3 0 0 0 1.591 1.592l2.226-.596a1.63 1.63 0 0 1 1.149.133A9.96 9.96 0 0 0 12 22" fill="currentColor" opacity=".5"></path>
<path d="M7.825 12.85a.825.825 0 0 0 0 1.65h6.05a.825.825 0 0 0 0-1.65zm0-3.85a.825.825 0 0 0 0 1.65h8.8a.825.825 0 0 0 0-1.65z" fill="currentColor">
</path>
</svg>
<svg aria-hidden="true" className="iconify text-[#030303] w-6 h-6 opacity-40 group-hover/card:opacity-100 group-hover/card:translate-x-1 group-hover/card:-translate-y-1 transition-all iconify--solar" data-icon="solar:arrow-right-up-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
</section><footer className="lg:px-12 flex flex-col overflow-hidden bg-[#030303] w-full z-10 border-white/5 border-t pt-12 pr-6 pb-12 pl-6 relative items-center">
...
<svg aria-hidden="true" className="iconify iconify--solar w-[24px] h-[24px]" data-icon="solar:layers-minimalistic-bold-duotone" data-icon-replaced="true" data-icon-set="solar" data-solar="forbidden-circle-bold-duotone" height="24" role="img" strokeWidth="2" style={{width: '24px', height: '24px', color: 'rgb(56, 189, 248)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M4.929 4.929c-3.905 3.905-3.905 10.237 0 14.142s10.237 3.905 14.142 0s3.905-10.237 0-14.142s-10.237-3.905-14.142 0" fill="#38bdf8" opacity=".5"></path>
<path d="M18.521 4.418L4.418 18.521a10 10 0 0 0 1.06 1.061L19.583 5.479a10 10 0 0 0-1.06-1.06" fill="#38bdf8">
</path>
</svg>
</div>
...
<a className="text-white/30 hover:text-white transition-colors" href="#"><svg aria-hidden="true" data-icon="ri:twitter-x-fill" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<a className="text-white/30 hover:text-white transition-colors" href="#"><svg aria-hidden="true" data-icon="ri:github-fill" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<a className="text-white/30 hover:text-white transition-colors" href="#"><svg aria-hidden="true" data-icon="ri:linkedin-fill" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<a className="text-white/30 hover:text-white transition-colors" href="#"><svg aria-hidden="true" data-icon="ri:discord-fill" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<li className=""><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Documentation</a>
</li>
<li className=""><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">API
                        Reference</a></li>
<li className=""><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Governance</a>
</li>
<li className=""><a className="flex items-center gap-2 text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">
                        System Status
                        <span className="relative flex h-1.5 w-1.5">
...
<ul className="flex flex-col gap-3.5">
<li className=""><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Philosophy</a>
</li>
<li><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Careers</a></li>
<li><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Press
                        Kit</a></li>
<li><a className="text-white/40 hover:text-brand-sky text-sm transition-colors font-light" href="#">Legal</a></li>
</ul>
</div>

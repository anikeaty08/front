...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors">
<img alt="Detailing" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&amp;fit=crop&amp;q=80&amp;w=200"/>
</div>
<div>
<h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">
                            Detailing
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors">
<img alt="Reklamní polepy" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&amp;fit=crop&amp;q=80&amp;w=200"/>
</div>
<div>
<h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">
                            Reklamní polepy
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block" href="/detailing">
<img alt="Detailing" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110" src="https://images.unsplash.com/photo-1520340356584-f9917d1eea6f?auto=format&amp;fit=crop&amp;q=80&amp;w=1000"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent opacity-90 transition-opacity duration-500 group-hover:opacity-80"></div>
<div className="absolute inset-0 p-8 flex flex-col justify-end z-10">
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block" href="/reklamni-polepy" style={{'--reveal-delay': '100ms'}}>
<img alt="Reklamní polepy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110" src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&amp;fit=crop&amp;q=80&amp;w=1000"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent opacity-90 transition-opacity duration-500 group-hover:opacity-80"></div>
<div className="absolute inset-0 p-8 flex flex-col justify-end z-10">

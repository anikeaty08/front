...
<a className="hidden lg:flex items-center gap-2 text-base font-light text-zinc-300 hover:text-white transition-colors" href="tel:469-804-5279">
...
<i className="w-4 h-4" data-lucide="star" strokeWidth="1.5"></i>
        5.0 | 46 Reviews • Serving Dallas &amp; Surrounding Areas
    </div>
...
<a className="w-full sm:w-auto bg-transparent border border-white/20 hover:border-white/40 hover:bg-white/5 text-white px-8 py-4 rounded-full text-lg font-light transition-all flex items-center justify-center gap-2 backdrop-blur-sm" href="tel:469-804-5279">
...
<p className="text-lg md:text-xl text-zinc-400 font-extralight leading-relaxed">
                        Looking for reliable mobile car detailing in Dallas? <span className="text-zinc-200 font-light">Prizm Detailing</span> brings the shine straight to your driveway. We proudly serve Dallas and nearby communities, with a focus on convenience and quality results. Simply choose a time that works best for you and we'll handle the rest.
                    </p>
<p className="text-lg md:text-xl text-zinc-400 font-extralight leading-relaxed">
...
<h2 className="text-3xl md:text-5xl font-normal tracking-tight text-white">Popular Services in Dallas</h2>
</div>
...
<h2 className="text-3xl md:text-5xl font-normal tracking-tight text-white mb-8 max-w-3xl mx-auto leading-tight">
                Discover the <span className="text-zinc-500">Prizm Difference</span>
</h2>
<p className="text-lg md:text-xl text-zinc-400 font-extralight leading-relaxed max-w-2xl mx-auto mb-12">
                Your vehicle is more than just a way to get around. At Prizm Detailing, we give every car the attention it deserves so it not only looks great but also keeps its value over time. Let our team handle the hard work while you enjoy the peace of mind.
            </p>
...
<span>Dallas</span> <span className="text-zinc-800">•</span>
<span>Irving</span> <span className="text-zinc-800">•</span>
<span>Richardson</span> <span className="text-zinc-800">•</span>
<span>Garland</span> <span className="text-zinc-800">•</span>
<span>Mesquite</span> <span className="text-zinc-800">•</span>
...
<p className="text-lg text-zinc-400 font-extralight">Answers to the most common questions from Dallas drivers.</p>
</div>
...
<summary className="flex justify-between items-center cursor-pointer p-6 text-lg md:text-xl font-light text-zinc-200 hover:text-white select-none">
                        What makes Prizm Detailing different from others?
...
<details className="group bg-zinc-900/30 rounded-2xl border border-white/5 overflow-hidden transition-all duration-300 open:bg-zinc-900/60 open:border-white/10">
<summary className="flex justify-between items-center cursor-pointer p-6 text-lg md:text-xl font-light text-zinc-200 hover:text-white select-none">
                        Do you offer fully mobile car detailing in Dallas?
                        <span className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 group-open:rotate-180 transition-transform duration-300">
<i className="w-5 h-5 text-zinc-400" data-lucide="chevron-down" strokeWidth="1.5"></i>
</span>
</summary>
<div className="px-6 pb-6 text-base md:text-lg text-zinc-400 font-extralight leading-relaxed border-t border-white/5 pt-4">
                        Yes. Prizm Detailing is a 100% mobile auto detailing service in Dallas, TX. We come to your home, apartment, or workplace with everything needed.
                    </div>
</details>
<details className="group bg-zinc-900/30 rounded-2xl border border-white/5 overflow-hidden transition-all duration-300 open:bg-zinc-900/60 open:border-white/10">
<summary className="flex justify-between items-center cursor-pointer p-6 text-lg md:text-xl font-light text-zinc-200 hover:text-white select-none">
                        Is ceramic coating worth it for cars in Texas?
                        <span className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 group-open:rotate-180 transition-transform duration-300">
<i className="w-5 h-5 text-zinc-400" data-lucide="chevron-down" strokeWidth="1.5"></i>
</span>
</summary>
<div className="px-6 pb-6 text-base md:text-lg text-zinc-400 font-extralight leading-relaxed border-t border-white/5 pt-4">
                        Absolutely. Ceramic coating provides long-term paint protection against the harsh Texas sun, oxidation, road grime, and contaminants.
                    </div>
</details>
<details className="group bg-zinc-900/30 rounded-2xl border border-white/5 overflow-hidden transition-all duration-300 open:bg-zinc-900/60 open:border-white/10">
<summary className="flex justify-between items-center cursor-pointer p-6 text-lg md:text-xl font-light text-zinc-200 hover:text-white select-none">
...
<a className="text-2xl tracking-tight font-normal text-white mb-6 block" href="#">PRIZM</a>
<p className="text-base text-zinc-500 font-extralight leading-relaxed mb-8">
                        Prizm Detailing takes care of your car so you can reclaim your time and enjoy peace of mind.
                    </p>
<div className="flex gap-4">
<a className="text-zinc-500 hover:text-white transition-colors" href="mailto:info@prizmdetailingdallas.com">
<i className="w-6 h-6" data-lucide="mail" strokeWidth="1.5"></i>
</a>
<a className="text-zinc-500 hover:text-white transition-colors" href="tel:469-804-5279">
...
<a className="text-lg text-white font-light hover:text-zinc-300 transition-colors" href="tel:469-804-5279">
                            469-804-5279
                        </a>
</div>
</div>
...
<p>© 2025 Prizm Detailing. All Rights Reserved.</p>

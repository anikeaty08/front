...
<iconify-icon height="40" icon="solar:code-linear" style={{color: '#2B3624', strokeWidth: '1.5'}} width="40"></iconify-icon>
</div>
<nav className="hidden md:flex items-center gap-10 text-sm text-[#4B5563] font-medium tracking-wide">
<a className="hover:text-[#2B3624] transition-colors" href="#">
            Solutions
          </a>
<a className="hover:text-[#2B3624] transition-colors" href="#">
            Platform
...
<a className="hover:text-[#2B3624] transition-colors" href="#">Plans</a>
</nav>
<div className="flex items-center gap-6">
<a className="hidden sm:block text-sm text-[#4B5563] font-medium hover:text-[#2B3624] transition-colors" href="#">
            Log in
          </a>
<a className="bg-[#2B3624] text-[#F6F3EC] text-sm font-medium px-5 py-2.5 rounded-md hover:bg-[#1f281a] transition-colors tracking-wide" href="#">
            Start Building
          </a>
</div>
</header>
...
<h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-[84px] leading-[1.05] text-[#2B3624] mb-8 font-light tracking-tighter" id="hero-headline">
...
<a className="bg-[#2B3624] text-[#F6F3EC] text-sm font-medium px-6 py-3 rounded-md hover:bg-[#1f281a] transition-colors shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]" href="#">
            Deploy Now
          </a>
</div>
...
<canvas className="absolute inset-0 w-full h-full object-cover" id="mesh-canvas" style={{filter: 'hue-rotate(35deg) saturate(0.75) brightness(0.95)'}}></canvas>
...
<iconify-icon height="20" icon="lucide:zap" style={{color: '#E8EE9B'}} width="20"></iconify-icon>
</div>
...
<div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 shadow-sm">
<div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center mb-6 bg-white/[0.08] shadow-sm">
<iconify-icon height="20" icon="lucide:clipboard-edit" style={{color: '#E8EE9B'}} width="20"></iconify-icon>
</div>
<h3 className="font-medium text-[#F6F3EC] mb-2 text-lg">
...
<div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 shadow-sm">
<div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center mb-6 bg-white/[0.08] shadow-sm">
<iconify-icon height="20" icon="lucide:target" style={{color: '#E8EE9B'}} width="20"></iconify-icon>
</div>
<h3 className="font-medium text-[#F6F3EC] mb-2 text-lg">
...
<iconify-icon className="text-xs" icon="lucide:users"></iconify-icon>
                      Team lunch
                    </div>
<div>12 - 1PM</div>
</div>
...
<iconify-icon className="text-xs" icon="lucide:headphones"></iconify-icon>
                      Coding
                    </div>
<div>3 - 5PM</div>
</div>
...
<iconify-icon className="text-[#6A7165] text-sm" icon="lucide:chevron-down"></iconify-icon>
...
<iconify-icon className="text-[#2B3624] flex-shrink-0 text-sm" icon="lucide:zap"></iconify-icon>
                      Call doctor
                    </div>
<div className="flex items-center gap-3 text-xs text-[#4B5563] font-medium">
<div className="w-3.5 h-3.5 rounded-[3px] border border-[#2B3624]/20 flex-shrink-0"></div>
...
<iconify-icon className="text-[#2B3624] text-[10px]" icon="lucide:zap"></iconify-icon>
</div>
...
<iconify-icon className="text-[#6A7165] text-sm" icon="lucide:external-link"></iconify-icon>
</div>
...
<iconify-icon className="text-[#2B3624] text-xs" icon="lucide:zap"></iconify-icon>
...
<img alt="Avatar" className="w-full h-full object-cover" src="https://i.pravatar.cc/100?img=1"/>
</div>
...
<div className="flex items-center gap-2">
<div className="w-5 h-5 bg-gray-300 rounded-full overflow-hidden flex items-center justify-center">
<img alt="Avatar" className="w-full h-full object-cover" src="https://i.pravatar.cc/100?img=2"/>
</div>
<div className="text-xs font-semibold text-[#2B3624]">
                          System B
                        </div>
...
<iconify-icon className="text-[#6A7165] text-sm" icon="solar:lock-bold"></iconify-icon>
</div>
<div>
<div className="text-xs font-semibold text-[#2B3624]">
                        Private Instance
...
<a className="inline-flex items-center gap-2 border border-[#C9D68A]/60 text-[#C9D68A] text-sm font-medium px-6 py-3 rounded-full hover:bg-[#C9D68A] hover:text-[#1D2718] transition-colors" href="#">
              Get Started
              <iconify-icon className="text-sm" icon="lucide:arrow-up-right"></iconify-icon>
</a>
</div>
...
<input className="w-full bg-white/5 border border-white/35 px-4 py-3 text-sm rounded-full text-[#F6F3EC] placeholder:text-white/55 focus:outline-none focus:border-[#E8EE9B]/70" placeholder="First name" type="text"/>
<input className="w-full bg-white/5 border border-white/35 px-4 py-3 text-sm rounded-full text-[#F6F3EC] placeholder:text-white/55 focus:outline-none focus:border-[#E8EE9B]/70" placeholder="Email address" type="email"/>
<input className="w-full bg-white/5 border border-white/35 px-4 py-3 text-sm rounded-full text-[#F6F3EC] placeholder:text-white/55 focus:outline-none focus:border-[#E8EE9B]/70" placeholder="Phone" type="tel"/>
<input className="w-full bg-white/5 border border-white/35 px-4 py-3 text-sm rounded-full text-[#F6F3EC] placeholder:text-white/55 focus:outline-none focus:border-[#E8EE9B]/70" placeholder="Company" type="text"/>
<textarea className="sm:col-span-2 w-full bg-white/5 border border-white/35 px-4 py-3 text-sm rounded-2xl text-[#F6F3EC] placeholder:text-white/55 focus:outline-none focus:border-[#E8EE9B]/70 h-28" placeholder="Write your message here"></textarea>
...
<input className="bg-transparent border-none outline-none text-white text-sm w-full placeholder:text-neutral-600 font-mono focus:ring-0" placeholder="Join the waitlist..." type="text"/>
...
<iconify-icon className="absolute -right-4 -top-4 text-black/10 text-[8rem] rotate-12" icon="lucide:code-2"></iconify-icon>
...
<iconify-icon className="text-xl text-[#10140E]" icon="lucide:arrow-up-right"></iconify-icon>
</div>
</div>
</div>
</div>
...
<a className="hover:text-[#C9D68A] transition-colors" href="#">
              Privacy
            </a>
<a className="hover:text-[#C9D68A] transition-colors" href="#">Terms</a>
<a className="hover:text-[#C9D68A] transition-colors" href="#">Docs</a>
</div>
</div>
</footer>
</div>

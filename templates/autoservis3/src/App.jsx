...
<h1 className="text-[20vw] leading-[0.8] font-medium text-white tracking-tighter opacity-90 mix-blend-overlay"><span style={{display: 'inline-block', overflow: 'hidden', verticalAlign: 'top', marginRight: '0.25em'}}><span className="reveal-word" style={{display: 'inline-block'}}>SERVIS</span></span></h1>
...
<img alt="Mechanik pod autem" className="w-full h-full object-cover grayscale brightness-75 contrast-125" src="https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=1600&amp;q=80" style={{filter: 'blur(0px)'}}/>
...
<img alt="Klimatizace" className="group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 group-hover:scale-105 opacity-60 w-full h-full object-cover grayscale" src="https://images.unsplash.com/photo-1587121892719-1711ec9cc798?w=800&amp;q=80" style={{filter: 'blur(0px)'}}/>
<div className="group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-t from-neutral-950/80 via-transparent to-transparent opacity-0 absolute inset-0"></div>
</div>
</div>
</div>
...
<img alt="Podvozek" className="transition-transform duration-700 group-hover:scale-110 opacity-80 w-full h-full object-cover absolute inset-0 grayscale contrast-125" src="https://images.unsplash.com/photo-1711746888471-b0e331dbbeae?w=800&amp;q=80"/>
...
<div className="group overflow-hidden hover:-translate-y-1 transition-transform duration-300 bg-neutral-900 h-[450px] border-neutral-800 border rounded-none relative" style={{filter: 'blur(0px)'}}>
<img alt="Detailing" className="transition-transform duration-700 group-hover:scale-110 opacity-80 w-full h-full object-cover absolute inset-0 grayscale contrast-125" src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800&amp;q=80"/>
<div className="bg-gradient-to-t from-black via-black/50 to-transparent opacity-90 absolute inset-0"></div>
<div className="absolute bottom-0 left-0 right-0 p-8 pb-10">
...
<h2 className="text-6xl md:text-8xl font-oswald font-bold uppercase tracking-tighter text-white leading-[0.9]"><span className="" style={{display: 'inline-block', overflow: 'hidden', verticalAlign: 'top', marginRight: '0.25em'}}><span className="reveal-word" style={{display: 'inline-block'}}>POZNEJTE EXPERTY</span></span></h2>
</div>
<div className="flex flex-col items-start md:items-end gap-6">
</div>
</div>
...
<div className="overflow-hidden group w-full h-64 rounded-none relative">
<img alt="Detail práce" className="transition-transform duration-500 group-hover:scale-105 contrast-125 w-full h-full object-cover grayscale" src="https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?w=1600&amp;q=80" style={{filter: 'blur(0px)'}}/>
<div className="absolute bottom-4 right-4 bg-white px-4 py-2 rounded-full shadow-lg">

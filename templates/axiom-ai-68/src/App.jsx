...
<img alt="" className="pointer-events-none sm:max-h-full w-full h-full max-h-[600px] object-cover absolute top-0 right-0 bottom-0 left-0" src="https://images.unsplash.com/photo-1542644384-49f9febd8443?w=2560&amp;q=80" style={{maskImage: 'linear-gradient(to bottom, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black 85%, transparent)'}}/>
<header className="z-20 relative">
<div className="flex md:px-8 max-w-7xl mr-auto ml-auto pt-6 pr-6 pb-6 pl-6 items-center justify-between">
<a className="flex items-center gap-3" href="/">
<div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/15 backdrop-blur">
<svg className="lucide lucide-asterisk h-4 w-4 text-white/90" data-lucide="asterisk" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6v12"></path><path d="M17.196 9 6.804 15"></path><path d="m6.804 9 10.392 6"></path></svg>
</div>
<span className="text-base tracking-tight text-white/90 font-sans" style={{}}>Axiom</span>
</a>
<nav className="hidden items-center gap-8 md:flex">
<a className="uppercase hover:text-white/90 text-xs text-white/70 tracking-[0.18em]" href="/case">Home</a><a className="uppercase hover:text-white/90 text-xs text-white/70 tracking-[0.18em]" href="/case">ABOUT US</a><a className="uppercase hover:text-white/90 text-xs text-white/70 tracking-[0.18em]" href="/case">AUSTRALIA</a>
<a className="uppercase hover:text-white/90 text-xs text-white/70 tracking-[0.18em]" href="/journal">INTERNATIONAL</a><a className="uppercase hover:text-white/90 text-xs text-white/70 tracking-[0.18em]" href="/journal">BLOG</a>
...
<div className="grid grid-cols-1 grid-rows-[minmax(0,1fr)] gap-12 md:px-8 md:pb-24 md:pt-16 lg:grid-cols-12 lg:gap-8 lg:pb-28 lg:pt-20 min-h-[calc(100vh-96px)] max-w-7xl mr-auto ml-auto pt-16 pr-6 pb-24 pl-6 gap-x-12 gap-y-12 items-center">
...
<h1 className="sm:text-6xl lg:font-normal lg:text-8xl lg:tracking-tighter text-5xl font-medium text-white tracking-tighter font-playfair drop-shadow-xl" style={{animation: 'fadeSlideIn 1s ease-out 0.2s both'}}>Surrogacy for Australians.</h1>
<p className="leading-relaxed text-lg text-white/85 max-w-2xl mt-6" style={{animation: 'fadeSlideIn 1s ease-out 0.4s both'}}>
    Design, deploy, and adapt AI that turns your data into action—securely, reliably, and fast. Build once, iterate continuously, and deliver outcomes with confidence.
  </p>
<p className="leading-relaxed text-base text-white/75 max-w-2xl mt-4" style={{animation: 'fadeSlideIn 1s ease-out 0.6s both'}}>
    From ingestion pipelines to aligned reasoning and safe execution, Axiom helps teams move from prototype to production without losing control or velocity.
  </p>
...
<img alt="Abstract 3D render background" className="pointer-events-none sm:max-h-full w-full h-full max-h-[600px] object-cover absolute top-0 right-0 bottom-0 left-0" src="https://images.unsplash.com/photo-1498159551354-e44d84854c2f?w=3840&amp;q=80" style={{maskImage: 'linear-gradient(to bottom, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black 85%, transparent)'}}/>
<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_20%,rgba(255,255,255,0.06),transparent),linear-gradient(to_top,rgba(0,0,0,0.85),rgba(0,0,0,0.35))]">
</div>
...
<h2 className="sm:text-5xl lg:text-6xl animate-on-scroll text-4xl font-medium text-white tracking-tight font-playfair drop-shadow-xl" style={{animation: 'fadeSlideIn 1.0s ease-out 0.2s both'}}>A surrogacy resource to help you navigate your journey.</h2>
...
<div className="absolute left-1/2 bottom-6 h-2 w-2 -translate-x-1/2 rounded-full bg-sky-400 shadow-[0_0_0_4px_rgba(56,189,248,0.15)]">
</div>
...
<div className="absolute inset-0 bg-[radial-gradient(60%_30%_at_50%_55%,rgba(163,230,53,0.25),transparent)]">
</div>
...
<div className="col-span-6 row-span-6 [background-image:linear-gradient(to_right,rgba(255,255,255,0.12)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.12)_1px,transparent_1px)] [background-size:16.666%_100%,100%_16.666%]">
</div>
</div>
...
<p className="text-lg leading-relaxed text-white/90">
          Achieving <span className="text-lime-400">92%</span> accuracy rate, our platform delivers consistent
...
<div className="absolute inset-0 bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.2)_0_6px,rgba(255,255,255,0.05)_6px_12px)]">
</div>
</div>
</div>
</div>
...
<img alt="Atmospheric mountain landscape" className="pointer-events-none w-full h-full absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6b428a64-0de1-4837-bab2-9729ce2e28c2_3840w.jpg"/><img alt="Atmospheric mountain landscape" className="pointer-events-none w-full h-full absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6b428a64-0de1-4837-bab2-9729ce2e28c2_3840w.jpg" style={{visibility: 'hidden'}}/>
...
</section><section className="isolate overflow-hidden pt-24 pb-24 relative"><div className="absolute top-0 right-0 bottom-0 left-0" data-container-bg="true"><div className="spline-container absolute top-0 left-0 w-full h-full -z-10"><iframe className="" frameborder="0" height="100%" src="https://my.spline.design/aidatamodelinteraction-mdTL3FktFVHgDvFr5TKtnYDV" style={{display: 'none'}} width="100%"></iframe></div></div>
<div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_80%_at_50%_0%,rgba(255,255,255,0.05),transparent_60%)]"></div>
...
<li className=""><a className="text-sm text-white/70 hover:text-white/90" href="#">Features</a></li>
<li className=""><a className="text-sm text-white/70 hover:text-white/90" href="#">Console</a></li>
<li className=""><a className="text-sm text-white/70 hover:text-white/90" href="#">API</a></li>

...
<img alt="" className="pointer-events-none sm:max-h-full w-full h-full max-h-[600px] object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a687f7c0-d9cf-4cce-8e7e-13863f4a592e_3840w.jpg" style={{maskImage: 'linear-gradient(to bottom, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black 85%, transparent)'}}/>
<header className="fixed z-50 bg-black/75 border-white/20 border-b top-0 right-0 left-0 shadow-lg backdrop-blur-xl" role="banner">
<div className="flex items-center justify-between max-w-7xl mx-auto px-6 py-4 md:px-8">
<a className="flex items-center gap-2 md:gap-3" href="/">
<div className="flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-md rounded-full ring-2 ring-white/20 shadow-md hover:bg-white/15 transition-all">
<img alt="Logo Gardien du Coeur" className="w-6 h-6 object-contain" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/4897f08a-d79d-40b8-ab8c-c6ffbf2bdac0_320w.png"/>
</div>
<span className="text-sm md:text-base lg:text-lg font-semibold text-white tracking-tight" style={{letterSpacing: '0.02em', textShadow: '0 1px 3px rgba(0,0,0,0.5)'}}>GARDIEN DU COEUR</span>
</a>
<nav className="hidden md:flex items-center gap-6 lg:gap-8" role="navigation">
<a className="text-white/90 text-xs uppercase font-medium tracking-[0.18em] hover:text-white hover:bg-white/10 px-3 py-2 rounded-md transition-all duration-200" href="/case" style={{textShadow: '0 1px 2px rgba(0,0,0,0.3)'}}>Case Studies</a>
<a className="text-white/90 text-xs uppercase font-medium tracking-[0.18em] hover:text-white hover:bg-white/10 px-3 py-2 rounded-md transition-all duration-200" href="/journal" style={{textShadow: '0 1px 2px rgba(0,0,0,0.3)'}}>Journal</a>
<a className="text-white/90 text-xs uppercase font-medium tracking-[0.18em] hover:text-white hover:bg-white/10 px-3 py-2 rounded-md transition-all duration-200" href="/contact" style={{textShadow: '0 1px 2px rgba(0,0,0,0.3)'}}>Contact</a>
</nav>
<div className="hidden md:flex">
<a className="inline-flex items-center gap-2 bg-white/15 border-2 border-white/30 text-white px-6 py-2.5 rounded-xl text-xs uppercase font-semibold tracking-[0.18em] backdrop-blur-md shadow-lg hover:bg-white/25 hover:border-white/50 hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/40 focus:ring-offset-2 focus:ring-offset-black" href="/signin" style={{textShadow: '0 1px 2px rgba(0,0,0,0.3)'}}>
              Get Started
...
<button aria-label="Ouvrir le menu" className="md:hidden inline-flex items-center justify-center bg-white/15 border-2 border-white/25 text-white w-10 h-10 rounded-xl backdrop-blur-md hover:bg-white/25 shadow-md transition-all" id="menuBtn">
...
<div className="fixed z-50 origin-top transition bg-black/85 opacity-0 invisible border border-white/20 rounded-3xl p-6 top-20 right-4 left-4 shadow-2xl backdrop-blur-xl scale-95" id="mobileNav" style={{opacity: '0', transform: 'scale(0.95)', visibility: 'hidden'}}>
<div className="flex flex-col gap-0">
<a className="text-white/90 text-sm font-medium hover:bg-white/10 px-4 py-3 rounded-lg transition-all border-b border-white/10" href="/case">Case Studies</a>
<a className="text-white/90 text-sm font-medium hover:bg-white/10 px-4 py-3 rounded-lg transition-all border-b border-white/10" href="/journal">Journal</a>
<a className="text-white/90 text-sm font-medium hover:bg-white/10 px-4 py-3 rounded-lg transition-all border-b border-white/10" href="/contact">Contact</a>
<a className="inline-flex items-center justify-center gap-2 bg-white/15 border-2 border-white/30 text-white text-xs uppercase font-semibold tracking-[0.18em] rounded-xl mt-4 px-6 py-3 hover:bg-white/25 transition-all" href="/signin">
              Get Started
              <svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
...
<div className="z-10 relative pt-24">
...
<div className="absolute inset-0 -inset-x-8 -inset-y-6 bg-black/40 backdrop-blur-md rounded-3xl" style={{zIndex: '-1'}}></div>
<h1 className="sm:text-6xl lg:font-normal lg:text-8xl lg:text-zinc-50 text-5xl font-medium text-white tracking-tighter font-manrope relative" style={{animation: '1s ease-out 0.2s 1 normal both running fadeSlideIn'}}>
Et si vous pouviez anticiper la crise d'AVC avant qu'il ne soit trop tard?
    <div className="absolute inset-0 blur-2xl opacity-60 -z-10" style={{background: 'radial-gradient(ellipse at center, rgba(255, 255, 255, 0.15) 0%, transparent 70%)'}}></div></h1>
<p className="leading-relaxed text-lg text-white/95 max-w-2xl mt-6" style={{animation: '1s ease-out 0.4s 1 normal both running fadeSlideIn'}}>GARDIEN du Coeur est la première plateforme dédiée à surveillance de la tension artérielle 24/7 et au suivi medicale pesrsonalisé de l'Hypertension.</p>
...
<a className="inline-flex items-center justify-center gap-2 hover:bg-white/10 text-sm text-white/90 tracking-tight bg-white/5 border-white/15 border rounded-xl pt-3 pr-5 pb-3 pl-5 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]" href="#">
        See Demo
        <svg className="h-4 w-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</a>
</div>
</div>
</div>
...
<p className="leading-relaxed text-xl font-normal text-white/90 tracking-tight">A modular stack for ingestion, reasoning, and safe execution. Start small, scale to production, and stay in control at every step.</p>
<div className="mt-5 flex flex-wrap gap-2">
<span className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/80 font-sans">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg> Ingest
                </span>
<span className="inline-flex items-center gap-2 text-xs text-white/80 bg-white/5 border-white/10 border rounded-md pt-1.5 pr-3 pb-1.5 pl-3">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg> Reason
                </span>
<span className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/80 font-sans">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg> Orchestrate
                </span>
<span className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/80 font-sans">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg> Measure
                </span>
</div>
</div>
</div>
...
</section><section className="isolate overflow-hidden min-h-[1000px] md:h-screen relative">
<img alt="Abstract 3D render background" className="pointer-events-none sm:max-h-full w-full h-full max-h-[600px] object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d953ad7f-2dd7-42f7-8f74-593d55181036_3840w.jpg" style={{maskImage: 'linear-gradient(to bottom, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black 85%, transparent)'}}/>
...
<span className="text-xs uppercase tracking-[0.18em] text-white/60">Performance metrics</span>
...
<img alt="Identity verification" className="h-56 w-full object-cover sm:h-64" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/993d5154-c104-4507-8c0a-55364d2a948c_800w.jpg" style={{}}/>
...
<img alt="Atmospheric mountain landscape" className="pointer-events-none absolute inset-0 h-full w-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6b428a64-0de1-4837-bab2-9729ce2e28c2_3840w.jpg" style={{}}/>
...
<img alt="Premium background" className="h-48 w-full rounded-t-2xl object-cover opacity-60" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/4ca8123b-2b44-4ef6-9ce7-51db6671104c_800w.jpg" style={{}}/>

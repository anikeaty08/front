...
<span className="agency-logo-mark flex items-center justify-center shadow-orange-500/20 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(251,146,60,0.4)] transition-all duration-300 bg-center text-sm font-semibold text-white bg-gradient-to-br from-primary via-orange-400 to-blue-500 w-8 h-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f6887be8-6c10-464c-ba5b-a4546c65136f_320w.webp)] bg-cover rounded-xl relative shadow-lg">
              A
            </span>
...
<span className="hidden sm:inline text-[10px] uppercase tracking-[0.28em] text-text-muted ml-1 group-hover:text-gray-400 transition-colors duration-300">
              Studio
            </span>
</a>
...
<p className="md:text-xl text-text-secondary leading-relaxed text-lg font-light max-w-2xl mb-10">
        Axiom Studio partners with growing teams to shape strategy, design
        polished interfaces, build scalable systems, and connect every launch
...
<svg aria-hidden="true" className="lucide lucide-check-square w-5 h-5" data-lucide="check-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344"></path><path d="m9 11 3 3L22 4"></path></svg>
<div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 bg-white rounded-r-full"></div>
</button>
<button className="w-10 h-10 rounded-xl flex items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-colors">
<svg aria-hidden="true" className="lucide lucide-clock w-5 h-5" data-lucide="clock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 6v6l4 2"></path></svg>
</button>
<button className="w-10 h-10 rounded-xl flex items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-colors">
...
<svg aria-hidden="true" className="lucide lucide-folder w-4 h-4 text-white/40 group-hover:text-white/70" data-lucide="folder" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"></path></svg>
              My issues
            </button>
<button className="w-full flex items-center gap-3 px-2 py-1.5 text-white/70 hover:bg-white/5 hover:text-white rounded-md text-sm transition-colors group">
<svg aria-hidden="true" className="lucide lucide-check-square w-4 h-4 text-white/40 group-hover:text-white/70" data-lucide="check-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344"></path><path d="m9 11 3 3L22 4"></path></svg>
              All issues
            </button>
...
<svg aria-hidden="true" className="lucide lucide-chevron-down w-3 h-3" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
...
<button className="text-white/40 hover:text-white transition-colors">
<svg aria-hidden="true" className="lucide lucide-x w-4 h-4" data-lucide="x" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
</div>
...
<button className="text-white/40 hover:text-white/80 transition-colors flex items-center gap-1.5 pb-1 -mb-3">
<svg aria-hidden="true" className="lucide lucide-message-square w-3.5 h-3.5" data-lucide="message-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z"></path></svg>
              Chat
            </button>
</div>
...
<style>
        ...
        @keyframes s-float-delayed {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(-6px); }
        }
        @keyframes s-spin-slow {
          from { transform: rotate(0deg) scale(1); }
          to { transform: rotate(360deg) scale(1); }
        }
        @keyframes s-pulse-ring {
          0% { transform: scale(0.8); opacity: 0.8; }
          100% { transform: scale(1.8); opacity: 0; }
        }
        @keyframes s-pulse-badge {
        ...
        .s-sweep-line::after {
          ...
          animation: s-sweep 6s infinite;
        }
      </style>

<div className="absolute inset-0 s-noise pointer-events-none z-0"></div>
<div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-gradient-to-b from-blue-900/10 via-purple-900/5 to-transparent blur-[120px] rounded-full pointer-events-none z-0"></div>
<div className="z-10 max-w-[80rem] mx-auto pr-12 pl-12 relative">

<h2 className="md:text-7xl lg:text-[80px] font-normal tracking-tight leading-none mb-6 text-center text-balance text-white text-5xl sm:text-6xl">
          Agency-grade momentum
        </h2>
<p className="md:text-2xl text-balance text-xl font-light text-gray-400 text-center max-w-3xl mr-auto mb-20 ml-auto">
          Axiom brings strategy, project planning, time, and knowledge
          management into a refined operating system for creative teams building
          high-impact digital products.
        </p>

<div className="grid grid-cols-1 md:grid-cols-12 gap-6">

<div className="md:col-span-5 relative overflow-hidden flex flex-col bg-[#0a0a0c] rounded-[32px] border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_24px_48px_rgba(0,0,0,0.4)] h-[520px] group transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:scale-[1.02] hover:border-white/[0.12] hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
<style>
              @keyframes panelGodRaySway {
              ...
              @keyframes panelKeyPress {
                ...
                50% {
                  ...
                  box-shadow: 0 0px 2px rgba(0, 0, 0, 0.8), inset 0 1px 1px rgba(255, 255, 255, 0.02);
                }
              }

              @keyframes panelKeyGlow {
                ...
                50% {
                  box-shadow: 0 0 16px rgba(249, 115, 22, 0.3), inset 0 1px 1px rgba(255, 255, 255, 0.1);
                  background-color: rgba(249, 115, 22, 0.1);
                  color: rgba(255, 255, 255, 0.8);
                }
              }

              @keyframes panelTextFadeUp {
                0% {
                  opacity: 0;
...
<div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-blue-600/15 blur-[100px] z-0 pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-70"></div>
<div className="absolute top-[20%] right-[-20%] w-[50%] h-[50%] bg-purple-600/15 blur-[100px] z-0 pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-70"></div>

<div className="absolute top-[-30%] left-[20%] w-[60%] h-[120%] origin-top z-0 pointer-events-none animate-[panelGodRaySway_8s_ease-in-out_infinite]">
<div className="absolute inset-0 bg-gradient-to-b from-orange-500/40 via-orange-500/10 to-transparent blur-[60px]"></div>
<div className="absolute inset-x-[30%] top-0 h-full bg-gradient-to-b from-white/20 via-orange-300/10 to-transparent blur-[20px]"></div>
</div>

<div className="absolute inset-0 z-0 pointer-events-none mix-blend-screen animate-[panelShimmerDot_4s_ease-in-out_infinite]" style={{backgroundImage: 'radial-gradient(circle, rgba(255,160,100,0.3) 1px, transparent 1px)', backgroundSize: '12px 12px', WebkitMaskImage: 'linear-gradient(to bottom, black 10%, transparent 70%)', maskImage: 'linear-gradient(to bottom, black 10%, transparent 70%)'}}></div>

<div className="absolute bottom-0 inset-x-0 h-[65%] z-10 flex flex-col items-center justify-end pb-24 sm:scale-110 pointer-events-none scale-100" style={{WebkitMaskImage: 'linear-gradient(to top, transparent 10%, black 50%, black 100%)', maskImage: 'linear-gradient(to top, transparent 10%, black 50%, black 100%)'}}>
<div className="flex flex-col gap-1.5 sm:gap-2 w-max mx-auto filter blur-[1px] group-hover:blur-[0px] transition-all duration-700">

<div className="flex justify-center gap-1.5 sm:gap-2 opacity-50">
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
...
<div className="flex justify-center gap-1.5 sm:gap-2 opacity-70 ml-3 sm:ml-4">
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    Q
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    W
...
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] animate-[panelKeyPress_3s_infinite_0.5s]">
                    R
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] animate-[panelKeyGlow_5s_infinite_1s]">
                    T
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    Y
...
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] animate-[panelKeyGlow_6s_infinite_2.5s]">
                    I
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    O
...
<div className="flex justify-center gap-1.5 sm:gap-2 opacity-90 ml-6 sm:ml-8">
<div className="flex items-center justify-center text-[10px] sm:text-xs font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-orange-500/20 border border-orange-500/50 shadow-[0_0_20px_rgba(249,115,22,0.5),inset_0_1px_1px_rgba(255,255,255,0.2)] text-orange-200">
                    A
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    S
...
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] animate-[panelKeyPress_4s_infinite_1.5s]">
                    K
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    L
...
<div className="flex justify-center gap-1.5 sm:gap-2 opacity-100 ml-9 sm:ml-12">
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    Z
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
...
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] animate-[panelKeyGlow_4s_infinite_0s]">
                    N
                  </div>
<div className="flex items-center justify-center text-[10px] sm:text-xs text-white/20 font-light w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    M
...
<div className="flex justify-center gap-1.5 sm:gap-2 ml-10 sm:ml-12 opacity-100">
<div className="w-10 h-8 sm:w-14 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-32 h-8 sm:w-48 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
<div className="w-10 h-8 sm:w-14 sm:h-10 rounded-md sm:rounded-lg bg-white/[0.03] border border-white/[0.05] shadow-[0_2px_4px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]"></div>
...
<div className="relative z-20 flex-1 flex items-start sm:items-center justify-center pt-20 sm:pt-0 pointer-events-none">
<div className="w-[85%] max-w-md bg-[#111216]/80 backdrop-blur-2xl rounded-2xl border border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.7),inset_0_1px_1px_rgba(255,255,255,0.1)] overflow-hidden pointer-events-auto relative opacity-0 animate-[panelModalFloatIn_1s_cubic-bezier(0.16,1,0.3,1)_0.2s_forwards] hover:shadow-[0_40px_80px_rgba(0,0,0,0.8)] transition-all duration-500 animate-[panelFloatHover_6s_ease-in-out_infinite]">

<div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-orange-400/80 to-transparent"></div>

<div className="absolute inset-0 pointer-events-none overflow-hidden rounded-2xl">
<div className="absolute top-0 left-[-100%] w-[50%] h-[100%] bg-gradient-to-r from-transparent via-white/[0.04] to-transparent transform -skew-x-[15deg] animate-[panelGlassShine_6s_infinite_2s]"></div>
</div>

<div className="flex items-center px-4 py-3 border-b border-white/[0.06]">
<svg className="text-gray-500 mr-3 shrink-0" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<circle cx="11" cy="11" r="8"></circle>
<path d="m21 21-4.3-4.3"></path>
</svg>
<div className="flex-1 flex items-center min-w-0">
<span className="text-sm sm:text-base text-gray-200 font-light relative truncate">
                      Search actions
                      <span className="absolute top-0.5 -right-1 w-px h-[80%] bg-white/70 animate-[panelBlinkCursor_1s_infinite]"></span>
</span>
<span className="text-sm sm:text-base text-gray-600 font-light ml-1">
                      ...
                    </span>
</div>
<button className="text-gray-500 hover:text-white transition-colors ml-2 shrink-0 bg-white/5 rounded-md p-1">
...
<div className="px-2.5 py-2 text-[10px] font-medium tracking-wider text-gray-500 uppercase opacity-0 animate-[panelTextFadeUp_0.5s_ease-out_0.6s_forwards]">
                    QUICK ACTIONS
                  </div>
<div className="flex flex-col gap-0.5">

<button className="w-full flex justify-between items-center px-3 py-2.5 rounded-lg text-sm text-gray-400 font-light hover:bg-white/[0.06] hover:text-white transition-colors cursor-pointer group text-left opacity-0 animate-[panelTextFadeUp_0.5s_ease-out_0.7s_forwards]">
...
<div className="md:col-span-7 bg-[#0a0a0c] rounded-[32px] overflow-hidden border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_24px_48px_rgba(0,0,0,0.4)] flex flex-col relative group transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-white/[0.12] hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)] h-[520px]">
<style>
              ...
              .anim-tp-fade {
                animation: tp-fade-up 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;
                opacity: 0;
              }
...
<div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.06)_1px,transparent_1px)] bg-[size:16px_16px] pointer-events-none" style={{animation: 'tp-shimmer 4s ease-in-out infinite'}}></div>

<div className="absolute top-[-15%] left-1/2 -translate-x-1/2 w-[500px] h-[350px] bg-blue-500/20 blur-[100px] pointer-events-none rounded-full" style={{animation: 'tp-glow-breathe 7s ease-in-out infinite'}}></div>
<div className="absolute top-[-5%] left-1/2 -translate-x-1/2 w-[300px] h-[200px] bg-white/5 blur-[80px] pointer-events-none rounded-full"></div>
<div className="relative w-full h-full flex justify-center items-start pt-14">

<div className="hidden md:block absolute left-[-40px] lg:left-8 top-24 w-[280px] bg-[#111216]/80 backdrop-blur-md rounded-2xl border border-white/5 p-5 opacity-40 scale-[0.85] blur-[2px] transition-all duration-700 group-hover:blur-[3px] group-hover:opacity-30 anim-tp-fade delay-500 z-0">
<div className="flex justify-between items-center mb-4">
<span className="text-white/60 font-medium text-lg tracking-tight">
                    Yesterday
                  </span>
</div>
<div className="bg-white/5 border border-white/5 rounded-xl p-3.5 shadow-sm">
<p className="text-sm text-white/70 font-medium leading-snug">
                    Update hero section with client changes
                  </p>
</div>
</div>

<div className="hidden md:block absolute right-[-40px] lg:right-8 top-28 w-[280px] bg-[#111216]/80 backdrop-blur-md rounded-2xl border border-white/5 p-5 opacity-40 scale-[0.85] blur-[2px] transition-all duration-700 group-hover:blur-[3px] group-hover:opacity-30 anim-tp-fade delay-600 z-0">
<div className="flex justify-between items-center mb-4">
<span className="text-white/60 font-medium text-lg tracking-tight">
                    Create New Task
                  </span>
</div>
<div className="bg-white/5 border border-white/5 border-dashed rounded-xl p-3.5 mb-3 shadow-sm">
<p className="text-sm text-white/30 font-medium">
                    What should be done next?
                  </p>
</div>
<span className="inline-flex items-center px-2.5 py-0.5 rounded-md bg-blue-500/10 text-blue-400 text-xs font-medium border border-blue-500/20">
                  UI Design
                </span>
</div>

<div className="relative z-20 w-[92%] sm:w-[360px] bg-[#15161a]/95 backdrop-blur-2xl border border-white/10 rounded-[24px] p-5 shadow-[0_24px_48px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.1)] overflow-hidden" style={{animation: 'tp-float 8s ease-in-out infinite'}}>

<div className="absolute inset-0 pointer-events-none overflow-hidden rounded-[24px]">
<div className="absolute top-0 left-[-100%] w-[50%] h-[100%] bg-gradient-to-r from-transparent via-white/[0.03] to-transparent transform -skew-x-[15deg]" style={{animation: 'tp-sweep 6s infinite 2s'}}></div>
</div>

<div className="flex justify-between items-center mb-5 anim-tp-fade delay-100">
<h3 className="text-white font-medium text-xl tracking-tight">
                    Today
                  </h3>
<div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-white/40 border border-white/10 hover:text-white hover:bg-white/10 transition-colors cursor-pointer shadow-sm">
...
<div className="bg-white/[0.03] border border-white/[0.05] rounded-xl p-4 hover:bg-white/[0.06] hover:border-white/[0.1] transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer shadow-sm anim-tp-fade delay-200">
<div className="flex justify-between items-center mb-2.5">
<span className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-orange-500/10 text-orange-400 border border-orange-500/20 tracking-wide uppercase" style={{animation: 'tp-pulse 3s infinite'}}>
                        Medium
                      </span>
<svg className="text-white/20" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="1"></circle>
<circle cx="19" cy="12" r="1"></circle>
<circle cx="5" cy="12" r="1"></circle>
</svg>
</div>
<p className="text-[14px] text-white/90 font-medium leading-snug mb-3.5">
                      Review launch checklist before handoff
                    </p>
...
<div className="flex -space-x-1.5" style={{animation: 'tp-avatar-float 4s ease-in-out infinite'}}>
<div className="w-5 h-5 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-400 border border-[#1a1c23] shadow-sm"></div>
<div className="w-5 h-5 rounded-full bg-gradient-to-tr from-purple-500 to-pink-400 border border-[#1a1c23] shadow-sm"></div>
</div>
</div>
</div>

<div className="bg-white/[0.03] border border-white/[0.05] rounded-xl p-4 hover:bg-white/[0.06] hover:border-white/[0.1] transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer shadow-sm anim-tp-fade delay-300">
<div className="flex justify-between items-center mb-2.5">
<span className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-red-500/10 text-red-400 border border-red-500/20 tracking-wide uppercase" style={{animation: 'tp-pulse 3s infinite 1s'}}>
                        High
                      </span>
<svg className="text-white/20" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="1"></circle>
...
<p className="text-[14px] text-white/90 font-medium leading-snug mb-3.5">
                      Finalize homepage sections and animations
                    </p>
<div className="flex justify-between items-center text-[11px] text-white/40 font-medium">
<div className="flex items-center gap-3.5">
<span className="flex items-center gap-1.5">
...
<div className="flex -space-x-1.5" style={{animation: 'tp-avatar-float 4s ease-in-out infinite 0.5s'}}>
<div className="w-5 h-5 rounded-full bg-gradient-to-tr from-green-500 to-emerald-400 border border-[#1a1c23] shadow-sm"></div>
</div>
</div>
</div>

<div className="bg-white/[0.03] border border-white/[0.05] rounded-xl p-4 hover:bg-white/[0.06] hover:border-white/[0.1] transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer shadow-sm anim-tp-fade delay-400">
<div className="flex justify-between items-center mb-2.5">
<span className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 tracking-wide uppercase" style={{animation: 'tp-pulse 3s infinite 2s'}}>
                        Low
                      </span>
<svg className="text-white/20" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="1"></circle>
...
<div className="flex -space-x-1.5" style={{animation: 'tp-avatar-float 4s ease-in-out infinite 1s'}}>
<div className="w-5 h-5 rounded-full bg-gradient-to-tr from-yellow-500 to-orange-400 border border-[#1a1c23] shadow-sm"></div>
<div className="w-5 h-5 rounded-full bg-gradient-to-tr from-gray-500 to-gray-400 border border-[#1a1c23] shadow-sm"></div>
<div className="w-5 h-5 rounded-full bg-[#111216] border border-[#1a1c23] shadow-sm flex items-center justify-center text-[8px] font-medium text-white/60">
                          +1
                        </div>
</div>
</div>
...
<div className="absolute bottom-0 left-0 right-0 p-8 pt-40 bg-gradient-to-t from-[#0a0a0c] via-[#0a0a0c]/95 to-transparent z-30 pointer-events-none rounded-b-[32px]">
<div className="anim-tp-fade delay-700">
<p className="text-white/50 text-lg leading-relaxed max-w-sm">
<span className="text-white font-medium">Team Planner.</span>
                  See every task, deadline, owner, and priority in one shared
                  calendar built for fast-moving teams.
                </p>
</div>
</div>
</div>

<div className="md:col-span-7 bg-[#0a0a0c] rounded-[32px] overflow-hidden border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_24px_48px_rgba(0,0,0,0.4)] flex flex-col relative group h-[520px] transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-white/[0.12] hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
<style>
...
<div className="absolute top-[20%] left-[30%] w-[400px] h-[400px] bg-blue-500/20 blur-[120px] rounded-full pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-60"></div>
<div className="absolute bottom-[10%] right-[10%] w-[300px] h-[300px] bg-purple-500/10 blur-[100px] rounded-full pointer-events-none transition-opacity duration-700 group-hover:opacity-100 opacity-50"></div>

<div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.04)_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none"></div>

<div className="relative w-full h-full" style={{animation: 'section-reveal 1s cubic-bezier(0.16, 1, 0.3, 1) forwards'}}>

<div className="absolute left-6 top-8 bottom-32 w-16 border-r border-white/10 flex flex-col justify-between text-xs font-medium text-white/30 z-10 pointer-events-none">
<div className="relative">9 AM</div>
<div className="relative">10 AM</div>
<div className="relative">11 AM</div>
<div className="relative">12 PM</div>
<div className="relative text-blue-400 font-medium flex items-center">
                  2 PM
                  <div className="absolute -right-[3px] top-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-blue-500 rounded-full" style={{animation: 'pulse-dot 2s infinite'}}></div>
</div>
<div className="relative">3 PM</div>
<div className="relative">4 PM</div>
<div className="relative">5 PM</div>
</div>

<div className="absolute top-10 right-8 md:right-24 w-56 p-4 bg-[#18181b]/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl opacity-60 hover:opacity-100 transition-all duration-500 z-10 border-l-2 border-l-purple-500 cursor-default hidden sm:block" style={{animation: 'float-sec-1 7s ease-in-out infinite'}}>
...
<div className="w-5 h-5 rounded-full border border-[#18181b] bg-gradient-to-tr from-blue-400 to-cyan-300 shadow-sm"></div>
<div className="w-5 h-5 rounded-full border border-[#18181b] bg-gradient-to-tr from-purple-400 to-pink-400 shadow-sm"></div>
<div className="w-5 h-5 rounded-full border border-[#18181b] bg-gradient-to-tr from-orange-400 to-yellow-300 shadow-sm"></div>
</div>
</div>

<div className="absolute top-44 right-4 md:right-12 w-60 p-4 bg-[#18181b]/70 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl opacity-50 hover:opacity-100 transition-all duration-500 z-10 border-l-2 border-l-orange-500 cursor-default hidden sm:block" style={{animation: 'float-sec-2 8s ease-in-out infinite 1s'}}>
<p className="text-sm font-medium text-white/90 tracking-tight">
                  Client Call
                </p>
<p className="text-xs font-light text-white/50 mt-1">
...
<div className="flex -space-x-1.5">
<div className="w-5 h-5 rounded-full border border-[#18181b] bg-gradient-to-tr from-green-400 to-emerald-300 shadow-sm"></div>
<div className="w-5 h-5 rounded-full border border-[#18181b] bg-gradient-to-tr from-gray-400 to-gray-300 shadow-sm"></div>
</div>
<span className="text-xs font-light text-white/40">+1 guest</span>
</div>
</div>

<div className="absolute bottom-40 right-16 md:right-32 w-48 p-3 bg-[#18181b]/50 backdrop-blur-xl rounded-2xl border border-white/5 shadow-xl opacity-40 hover:opacity-100 transition-all duration-500 z-10 border-l-2 border-l-green-500 cursor-default hidden sm:block" style={{animation: 'float-sec-1 9s ease-in-out infinite 2s'}}>
...
<div className="absolute top-28 md:left-28 w-[320px] bg-white/95 backdrop-blur-2xl rounded-[24px] shadow-[0_32px_64px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,1)] border border-white/20 z-30 p-1 flex flex-col cursor-default left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-16 w-[90%] sm:w-[320px]" style={{animation: 'float-main 6s ease-in-out infinite'}}>

<div className="px-5 py-4 flex justify-between items-start border-b border-gray-100 bg-gray-50/50 rounded-t-[20px]">
<div>
<h3 className="text-lg font-medium text-gray-900 tracking-tight">
                      Deep Work Session
                    </h3>
<p className="text-sm font-normal text-blue-600 mt-0.5">
                      02:00 - 04:00 pm
                    </p>
</div>
...
<div className="p-5">
<p className="text-base font-normal text-gray-600 leading-relaxed mb-6">
                    Work on high-priority tasks without distractions.
                  </p>

<div className="flex items-center gap-3 mb-6">
<button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-sm font-medium transition-colors shadow-sm shadow-blue-600/20 flex items-center justify-center gap-2">
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="5 3 19 12 5 21 5 3"></polygon>
</svg>
                      Start Session
                    </button>
<button className="p-2.5 text-gray-500 hover:text-gray-900 bg-white border border-gray-200 rounded-xl shadow-sm transition-colors">
...
<path d="M18 8A6 6 0 1 0 3-2 3-9"></path>
<path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
</svg>
                      Do Not Disturb enabled
                    </div>
<div className="flex items-center justify-between text-sm font-normal text-gray-500">
<div className="flex items-center gap-3">
<svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex -space-x-1.5">
<div className="w-6 h-6 rounded-full border-2 border-white bg-gradient-to-tr from-blue-400 to-indigo-500 shadow-sm"></div>
</div>
</div>
</div>
</div>
...
<div className="absolute bottom-0 left-0 right-0 p-8 pt-32 bg-gradient-to-t from-[#0a0a0c] via-[#0a0a0c]/90 to-transparent z-40 pointer-events-none rounded-b-[32px]">
...
<span className="text-white font-medium tracking-tight">
                  ...
                  Organize your day with clarity and intention.
                </p>
</div>
</div>
</div>

<div className="md:col-span-5 bg-[#0a0a0c] rounded-[32px] overflow-hidden border border-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_24px_48px_rgba(0,0,0,0.4)] flex flex-col relative group h-[520px] transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:scale-[1.02] hover:border-white/[0.12] hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)]">

<div className="absolute inset-0 flex items-center justify-center z-0 mb-10 pointer-events-none">

<div className="absolute w-64 h-64 rounded-full opacity-60 mix-blend-screen group-hover:opacity-90 transition-opacity duration-700" style={{background: 'conic-gradient(from 0deg, #3b82f6, #0a0a0c, #f97316, #0a0a0c, #3b82f6)', filter: 'blur(28px)', animation: 's-spin-slow 8s linear infinite'}}></div>

<div className="absolute w-36 h-36 border-2 border-white/10 rounded-full" style={{animation: 's-pulse-ring 3s cubic-bezier(0.25, 0.8, 0.25, 1) infinite'}}></div>
<div className="absolute w-36 h-36 border border-white/5 rounded-full" style={{animation: 's-pulse-ring 3s cubic-bezier(0.25, 0.8, 0.25, 1) infinite 1.5s'}}></div>

<div className="relative w-24 h-24 bg-[#141417] border border-white/10 rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.1)] group-hover:scale-110 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]">
<svg className="text-white group-hover:text-orange-100 transition-colors duration-700" fill="none" height="32" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
<path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"></path>
<path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"></path>
</svg>

<div className="absolute top-2 right-1.5 w-6 h-6 bg-gradient-to-tr from-orange-600 to-orange-400 rounded-full border-2 border-[#141417] flex items-center justify-center text-xs text-white font-medium shadow-lg" style={{animation: 's-pulse-badge 2s infinite'}}>
                  28
                </div>
</div>
</div>
<div className="relative z-20 mt-auto p-8 bg-gradient-to-t from-[#0a0a0c] via-[#0a0a0c]/80 to-transparent pointer-events-none">
...
<style>
        ...
        .aura-dotted-orange {
          background-image: radial-gradient(circle, rgba(249, 115, 22, 0.42) 1.4px, transparent 1.4px);
          background-size: 8px 8px;
          -webkit-mask-image: linear-gradient(105deg, transparent 0%, black 18%, black 68%, transparent 100%);
          mask-image: linear-gradient(105deg, transparent 0%, black 18%, black 68%, transparent 100%);
        }

        .aura-dotted-blue {
          background-image: radial-gradient(circle, rgba(96, 165, 250, 0.42) 1.4px, transparent 1.4px);
          background-size: 8px 8px;
          -webkit-mask-image: linear-gradient(105deg, transparent 0%, black 16%, black 68%, transparent 100%);
          mask-image: linear-gradient(105deg, transparent 0%, black 16%, black 68%, transparent 100%);
        }
        ...
        .aura-clock-shell {
          box-shadow:
            ...
            inset 0 -40px 70px rgba(0, 0, 0, 0.9);
        }

        .aura-clock-face {
          background:
            radial-gradient(circle at 35% 35%, rgba(255, 255, 255, 0.08), transparent 26%),
            radial-gradient(circle at 30% 48%, rgba(249, 115, 22, 0.35), transparent 34%),
            radial-gradient(circle at 68% 38%, rgba(79, 112, 255, 0.42), transparent 38%),
            linear-gradient(180deg, rgba(18, 20, 26, 0.88), rgba(4, 5, 7, 0.98));
        ...
        .aura-clock-dots {
          ...
          -webkit-mask-image: radial-gradient(circle, black 0%, black 70%, transparent 96%);
          mask-image: radial-gradient(circle, black 0%, black 70%, transparent 96%);
        }

        .aura-clock-ticks {
          background: repeating-conic-gradient(from 0deg,
              rgba(255, 255, 255, 0.18) 0deg,
              rgba(255, 255, 255, 0.18) 0.6deg,
              transparent 0.6deg,
              transparent 6deg);
          -webkit-mask-image: radial-gradient(circle, transparent 67%, black 68%, black 70%, transparent 71%);
          mask-image: radial-gradient(circle, transparent 67%, black 68%, black 70%, transparent 71%);
        }

        .aura-clock-major-ticks {
          background: repeating-conic-gradient(from 0deg,
              rgba(255, 255, 255, 0.42) 0deg,
              rgba(255, 255, 255, 0.42) 1deg,
              transparent 1deg,
              transparent 30deg);
          -webkit-mask-image: radial-gradient(circle, transparent 66%, black 67%, black 72%, transparent 73%);
          mask-image: radial-gradient(circle, transparent 66%, black 67%, black 72%, transparent 73%);
        }
        ...
        .aura-arc-blue {
          background: conic-gradient(from 292deg,
              transparent 0deg,
              transparent 10deg,
              rgba(96, 165, 250, 0.15) 18deg,
              rgba(96, 165, 250, 0.75) 42deg,
              rgba(255, 255, 255, 1) 64deg,
              transparent 76deg,
              transparent 360deg);
          ...
          filter: drop-shadow(0 0 10px rgba(96, 165, 250, 0.95)) drop-shadow(0 0 22px rgba(96, 165, 250, 0.65));
        }
        ...
        .aura-arc-orange {
          background: conic-gradient(from 128deg,
              transparent 0deg,
              transparent 12deg,
              rgba(249, 115, 22, 0.18) 22deg,
              rgba(249, 115, 22, 0.8) 52deg,
              rgba(255, 255, 255, 1) 72deg,
              transparent 86deg,
              transparent 360deg);
          -webkit-mask-image: radial-gradient(circle, transparent 61%, black 62%, black 65%, transparent 66%);
          mask-image: radial-gradient(circle, transparent 61%, black 62%, black 65%, transparent 66%);
          filter: drop-shadow(0 0 10px rgba(249, 115, 22, 0.95)) drop-shadow(0 0 24px rgba(249, 115, 22, 0.65));
        }
        ...
        .aura-hand-blue {
          ...
          border-radius: 999px;
          background: linear-gradient(90deg, rgba(96, 165, 250, 0), rgba(96, 165, 250, 0.35), rgba(147, 197, 253, 1));
        ...
        .aura-hand-orange {
          ...
          transform-origin: left center;
          border-radius: 999px;
          background: linear-gradient(90deg, rgba(249, 115, 22, 0), rgba(249, 115, 22, 0.45), rgba(255, 237, 213, 1));
          box-shadow: 0 0 12px rgba(249, 115, 22, 0.9), 0 0 26px rgba(249, 115, 22, 0.48);
        }
...
<div className="absolute top-[20%] left-[-18%] w-[68vw] h-[190px] -rotate-[160deg] z-0 pointer-events-none animate-[beam-breathe_7s_ease-in-out_infinite]">
<div className="absolute inset-0 aura-dotted-orange"></div>
<div className="absolute inset-y-0 left-0 w-2/3 bg-orange-500/25 blur-[95px]"></div>
</div>

<div className="z-10 flex-1 lg:px-12 lg:py-24 flex flex-col lg:flex-row gap-16 lg:gap-28 w-full max-w-[88rem] mr-auto ml-auto pt-20 pr-6 pb-20 pl-6 relative gap-x-16 gap-y-16 items-center justify-center px-4 sm:px-6">

<div className="w-full lg:w-1/2 flex items-center justify-center select-none">
<div className="relative w-[280px] h-[280px] min-[380px]:w-[340px] min-[380px]:h-[340px] sm:w-[440px] sm:h-[440px] lg:w-[560px] lg:h-[560px]">

<div className="absolute -inset-8 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.08),transparent_60%)] blur-xl"></div>

<div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/18 via-[#17181d] to-black aura-clock-shell z-10"></div>

<div className="absolute inset-[14px] rounded-full bg-[#050608] shadow-[inset_0_0_35px_rgba(0,0,0,1)] z-20"></div>

<div className="absolute inset-[28px] rounded-full aura-clock-face overflow-hidden z-30 border border-white/[0.06]">

<div className="absolute left-[-12%] top-[18%] w-[65%] h-[65%] bg-orange-500/38 blur-[56px]"></div>
<div className="absolute right-[-12%] top-[10%] w-[70%] h-[70%] bg-blue-500/42 blur-[58px]"></div>
<div className="absolute inset-0 bg-gradient-to-b from-white/[0.06] via-transparent to-black/55"></div>

<div className="absolute inset-0 aura-clock-dots"></div>

<div className="absolute -top-[35%] left-[10%] w-[80%] h-[55%] rounded-full bg-white/[0.08] blur-2xl"></div>
</div>

<div className="absolute inset-[28px] rounded-full aura-clock-ticks z-40 pointer-events-none"></div>
<div className="absolute inset-[28px] rounded-full aura-clock-major-ticks z-40 pointer-events-none"></div>
<div className="absolute inset-[72px] rounded-full border border-black/45 z-40 pointer-events-none"></div>
<div className="absolute inset-[104px] rounded-full border border-black/35 z-40 pointer-events-none"></div>

<div className="absolute inset-[48px] z-50 text-[13px] text-white/20 font-medium pointer-events-none">
<span className="absolute left-1/2 top-0 -translate-x-1/2">12</span>
<span className="absolute right-[18%] top-[10%]">1</span>
<span className="absolute right-[6%] top-[29%]">2</span>
<span className="absolute right-0 top-1/2 -translate-y-1/2">3</span>
<span className="absolute right-[13%] bottom-[23%]">4</span>
<span className="absolute left-1/2 bottom-0 -translate-x-1/2">6</span>
<span className="absolute left-[13%] bottom-[23%]">8</span>
<span className="absolute left-0 top-1/2 -translate-y-1/2">9</span>
<span className="absolute left-[8%] top-[28%]">10</span>
</div>

<div className="absolute inset-0 flex items-center justify-center z-[55] pointer-events-none">
<div className="relative w-[130px] h-[130px] sm:w-[155px] sm:h-[155px] lg:w-[180px] lg:h-[180px] flex items-center justify-center">
<div className="absolute inset-0 rounded-full bg-black/10 blur-xl"></div>
<svg className="relative w-full h-full drop-shadow-[0_18px_30px_rgba(0,0,0,0.8)]" viewbox="0 0 140 140">
<path d="M70 14 L126 124 H101 L90 101 H51 L39 124 H14 L70 14 Z M70 54 L59 80 H82 L70 54 Z" fill="#08090c" stroke="rgba(255,255,255,0.08)" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
</div>

<div className="absolute inset-[28px] z-[70] rounded-full pointer-events-none animate-[rotate-clockwise_14s_linear_infinite]">
<div className="absolute inset-0 rounded-full aura-arc-blue"></div>
<div className="absolute left-1/2 top-1/2 h-[4px] w-[42%] origin-left -translate-y-1/2 rotate-[335deg] rounded-full bg-gradient-to-r from-transparent via-blue-400 to-white shadow-[0_0_18px_rgba(96,165,250,1),0_0_38px_rgba(96,165,250,0.7)]">
<div className="absolute right-[-5px] top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-white shadow-[0_0_12px_#fff,0_0_28px_rgba(96,165,250,1)]"></div>
</div>
</div>

<div className="absolute inset-[28px] z-[75] rounded-full pointer-events-none animate-[rotate-counter_24s_linear_infinite]">
<div className="absolute inset-0 rounded-full aura-arc-orange"></div>
<div className="absolute left-1/2 top-1/2 h-[5px] w-[34%] origin-left -translate-y-1/2 rotate-[220deg] rounded-full bg-gradient-to-r from-transparent via-orange-400 to-white shadow-[0_0_18px_rgba(249,115,22,1),0_0_38px_rgba(249,115,22,0.7)]">
<div className="absolute right-[-5px] top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-white shadow-[0_0_12px_#fff,0_0_28px_rgba(249,115,22,1)]"></div>
</div>
</div>

<div className="absolute inset-[28px] z-[80] rounded-full pointer-events-none animate-[rotate-clockwise_36s_linear_infinite] opacity-70">
<div className="absolute top-1/2 left-1/2 h-[2px] w-[38%] origin-left -translate-y-1/2 rotate-[76deg] rounded-full bg-white/25 shadow-[0_0_10px_rgba(255,255,255,0.25)]"></div>
</div>

<div className="absolute left-1/2 top-1/2 z-[90] w-7 h-7 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#111318] border border-white/[0.12] shadow-[0_4px_14px_rgba(0,0,0,0.9)]">
<div className="absolute inset-2 rounded-full bg-gray-300/80 animate-[pulse-soft_2.8s_ease-in-out_infinite] shadow-[0_0_10px_rgba(255,255,255,0.55)]"></div>
</div>

<div className="absolute right-[-8px] top-1/2 z-10 w-[16px] h-[42px] -translate-y-1/2 rounded-r-xl bg-gradient-to-b from-[#1b1c20] to-[#07080a] border border-white/[0.04] border-l-0 shadow-[0_10px_24px_rgba(0,0,0,0.8)]"></div>
</div>
</div>

<div className="w-full lg:w-1/2 flex flex-col justify-center items-start z-20">
<div className="text-xs font-medium text-gray-400 tracking-widest uppercase mb-5 opacity-0 animate-[fade-in-up_0.8s_ease-out_forwards] anim-delay-1">
            AXIOM STUDIO
          </div>
<h2 className="md:text-6xl lg:text-7xl leading-[1.05] animate-[fade-in-up_0.8s_ease-out_forwards] anim-delay-2 text-balance font-normal text-white tracking-tight opacity-0 mb-6 text-4xl sm:text-5xl">
            Build your next digital presence
          </h2>
<p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed mb-12 max-w-xl opacity-0 animate-[fade-in-up_0.8s_ease-out_forwards] anim-delay-3 text-balance">
            We design high-end websites, brand systems, and interactive
            experiences that help modern companies stand out with clarity.
          </p>
<div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto opacity-0 animate-[fade-in-up_0.8s_ease-out_forwards] anim-delay-4">

<div className="relative group w-full sm:w-auto">
<div className="absolute -inset-1.5 bg-gradient-to-r from-amber-500 via-orange-400 to-amber-500 rounded-full blur-md opacity-50 group-hover:opacity-100 group-hover:blur-lg transition-all duration-500 animate-[pulse-soft_3s_ease-in-out_infinite]"></div>
<button className="relative w-full sm:w-auto bg-gradient-to-b from-white to-gray-200 text-black px-10 py-4 rounded-full text-base font-medium flex items-center justify-center gap-2 transform group-hover:-translate-y-[2px] transition-transform duration-300 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.15)]">
                Start a project
                <span className="text-lg">→</span>
</button>
</div>

<button className="w-full sm:w-auto px-8 py-4 rounded-full border border-white/10 text-white text-base font-medium flex items-center justify-center gap-3 hover:bg-white/[0.03] hover:border-white/20 transition-all duration-300 group hover:shadow-[0_0_20px_rgba(255,255,255,0.06)]">
<span className="w-5 h-5 rounded-full bg-gradient-to-br from-blue-400 to-orange-400 shadow-[0_0_16px_rgba(96,165,250,0.45)]"></span>
              View portfolio
            </button>
</div>
</div>
...
<div className="w-full relative z-10 border-t border-white/[0.06] mt-auto bg-black/20 backdrop-blur-sm opacity-0 animate-[fade-in-up_0.8s_ease-out_forwards]" style={{animationDelay: '0.6s'}}>
<div className="max-w-7xl mx-auto px-6 lg:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-gray-500 font-light tracking-wide text-center md:text-left">
<div>Copyright © 2026 Axiom Studio. All rights reserved.</div>
<div className="flex items-center gap-8 flex-wrap justify-center md:justify-start gap-4 sm:gap-8">
<a className="hover:text-gray-200 transition-colors duration-300" href="#">
              Terms of Use
            </a>
<a className="hover:text-gray-200 transition-colors duration-300" href="#">
              Privacy Protocol
...
<div className="flex items-center gap-5 text-gray-400 flex-wrap justify-center md:justify-start">
<a aria-label="X" className="hover:text-white transition-colors duration-300" href="#">
              𝕏
            </a>
<a aria-label="LinkedIn" className="hover:text-white transition-colors duration-300" href="#">
              in
            </a>
<a aria-label="GitHub" className="hover:text-white transition-colors duration-300" href="#">
              GH
            </a>
<a aria-label="YouTube" className="hover:text-white transition-colors duration-300" href="#">
              ▶
            </a>
<a aria-label="Community" className="hover:text-white transition-colors duration-300" href="#">
              ●
            </a>
<a aria-label="Telegram" className="hover:text-white transition-colors duration-300" href="#">
              ↗
            </a>
</div>
<div className="flex items-center gap-2 group cursor-pointer">
<span className="text-orange-500 text-base group-hover:scale-110 transition-transform duration-300">
              ♥
            </span>
<span className="group-hover:text-gray-300 transition-colors duration-300">
              Made with passion by Axiom Studio
            </span>
</div>
</div>
</div>

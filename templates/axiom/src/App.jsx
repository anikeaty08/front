...
<img alt="" className="pointer-events-none sm:max-h-full w-full h-full max-h-[600px] object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6d30fe29-43aa-4fc2-a513-6aa41d38a7d0_3840w.jpg" style={{maskImage: 'linear-gradient(to bottom, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black 85%, transparent)'}}/>
...
<h1 className="sm:text-6xl lg:font-normal lg:text-8xl text-5xl font-medium text-white tracking-tighter font-manrope drop-shadow-xl" style={{animation: 'fadeSlideIn 1s ease-out 0.2s both'}}>Systems that learn. Decisions that scale.<br className="hidden sm:block"/></h1>
...
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/10">
<svg className="lucide lucide-plus h-4 w-4 text-white/70" data-faq-plus="" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path className="" d="M12 5v14"></path></svg>
<svg className="lucide lucide-minus hidden h-4 w-4 text-white/70" data-faq-minus="" data-lucide="minus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path></svg>
</span>
</button>
<div className="px-4 pb-4 text-sm text-white/70 hidden" data-faq-answer="">

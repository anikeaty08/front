...
<img alt="AXION" className="opacity-90 w-auto h-00 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5deecba8-dc0a-4556-9777-de9a588a4428_1600w.png"/>
...
<img className="w-full h-full object-cover contrast-100 brightness-50 group-hover:brightness-100 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8721dd74-22c0-4f42-a5e2-c29bfc289ba2_1600w.jpg"/>
...
<iconify-icon className="text-zinc-600 group-hover:text-white transition-colors mb-6" icon="solar:code-circle-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-orange-600 mb-6 drop-shadow-[0_0_15px_rgba(234,88,12,0.5)]" icon="solar:server-square-bold" width="40"></iconify-icon>
...
<iconify-icon className="text-zinc-600 group-hover:text-white transition-colors mb-6" icon="solar:shield-keyhole-linear" width="32"></iconify-icon>
<h3 className="text-xl font-medium text-white uppercase tracking-tight mb-3">
                  Custom Infra
                </h3>
<p className="text-xs text-zinc-500 font-mono leading-relaxed mb-8 max-w-[240px]">
...
<iconify-icon className="absolute -top-4 -right-8 text-orange-600 opacity-50 text-4xl hidden md:block animate-pulse" icon="solar:star-fall-minimalistic-linear"></iconify-icon>
</h2>

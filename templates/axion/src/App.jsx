...
<div className="flex bg-[#050505] h-full border-zinc-800 border-r pr-8 pl-6 items-center">
<a className="flex items-center group" href="/home">
<span className="uppercase group-hover:text-orange-600 transition-all duration-300 cursor-pointer text-2xl font-semibold text-white tracking-tight ml-10" onclick="window.location.href='/home'" role="button">
            Axion
          </span>
</a>
...
<a className="flex items-center text-[10px] uppercase hover:text-white hover:bg-zinc-900/50 transition-colors group text-zinc-400 tracking-widest font-mono h-full border-zinc-800/50 border-r pr-6 pl-6 relative" href="/system-core">
            System Core
...
<a className="flex items-center text-[10px] uppercase hover:text-white hover:bg-zinc-900/50 transition-colors group text-zinc-400 tracking-widest font-mono h-full border-zinc-800/50 border-r pr-6 pl-6 relative" href="/deployments">
            Deployments
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
</a>
<a className="flex items-center text-[10px] uppercase hover:text-white hover:bg-zinc-900/50 transition-colors group text-zinc-400 tracking-widest font-mono h-full border-zinc-800/50 border-r pr-6 pl-6 relative" href="/security">
            Security
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
</a>
<a className="flex items-center text-[10px] uppercase hover:text-white hover:bg-zinc-900/50 transition-colors group text-zinc-400 tracking-widest font-mono h-full border-zinc-800/50 border-r pr-6 pl-6 relative" href="/pricing">
            Pricing
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
</a>
<a className="flex items-center text-[10px] uppercase hover:text-white hover:bg-zinc-900/50 transition-colors group text-zinc-400 tracking-widest font-mono h-full pr-6 pl-6 relative" href="/docs">
            Docs
            <div className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
</a>
</div>
...
<button className="h-full px-8 bg-orange-600 text-white text-[10px] font-mono uppercase tracking-widest hover:bg-orange-500 transition-all flex items-center gap-2 group shadow-[inset_0_0_20px_rgba(0,0,0,0.2)] font-medium" data-demo-trigger="true">
          Request Demo
...
<button className="w-full py-4 bg-orange-600 text-white text-xs font-mono uppercase tracking-widest hover:bg-orange-500 flex items-center justify-center gap-2 transition-all shadow-lg shadow-orange-900/20 font-medium" data-demo-trigger="true">
          Request Demo
...
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 border-orange-600 text-orange-600 bg-zinc-900" href="#hero">
              01
...
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 text-zinc-600 border-zinc-800" href="#features">
              02
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 border border-zinc-800 text-white text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-xl">
                Features
              </div>
</a>
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 text-zinc-600 border-zinc-800" href="#deployments">
              03
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 border border-zinc-800 text-white text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-xl">
                Deployments
              </div>
</a>
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 text-zinc-600 border-zinc-800" href="#flow">
              04
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 border border-zinc-800 text-white text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-xl">
                System_Flow
              </div>
</a>
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 text-zinc-600 border-zinc-800" href="#validation">
              05
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 border border-zinc-800 text-white text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-xl">
                Validation
              </div>
</a>
<a className="nav-link group relative flex items-center justify-center w-6 h-6 bg-[#050505] border text-[9px] font-mono hover:text-white hover:border-orange-600 transition-all duration-300 text-zinc-600 border-zinc-800" href="#access">
              06
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 border border-zinc-800 text-white text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-xl">
                Pricing
              </div>
...
<div className="flex flex-col justify-center max-w-2xl" data-anim-group="hero-left">

<div className="flex items-center gap-3 mb-8 animate" data-anim="fade-up">
...
<h1 className="text-5xl md:text-7xl lg:text-7xl font-medium text-white uppercase tracking-tight leading-[0.9] mb-8 animate" data-anim="fade-up">
                Autonomous Infrastructure

                <span className="text-zinc-600">Platform</span>
</h1>

<p className="md:text-lg leading-relaxed animate text-base text-zinc-500 font-mono max-w-md border-orange-600 border-l-2 mb-10 pl-4" data-anim="fade-up">
...
<div className="flex items-center gap-3 animate" data-anim="fade-up" style={{animationDelay: '0s'}}>
<span className="w-1.5 h-1.5 bg-orange-600"></span>
<span className="uppercase text-xs text-zinc-300 tracking-wide font-mono">
                    Global distributed control plane
                  </span>
</div>
<div className="flex items-center gap-3 animate" data-anim="fade-up" style={{animationDelay: '0.1s'}}>
<span className="w-1.5 h-1.5 bg-orange-600"></span>
<span className="uppercase text-xs text-zinc-300 tracking-wide font-mono">
                    Autonomous agent orchestration
                  </span>
</div>
<div className="flex items-center gap-3 animate" data-anim="fade-up" style={{animationDelay: '0.2s'}}>
<span className="w-1.5 h-1.5 bg-orange-600"></span>
<span className="uppercase text-xs text-zinc-300 tracking-wide font-mono">
...
<div className="flex flex-col sm:flex-row gap-4 mb-8 animate" data-anim="fade-up">
...
<div className="flex items-center gap-4 text-[10px] font-mono text-zinc-600 uppercase tracking-wide pl-1 animate" data-anim="fade-up">
<span className="">Production ready</span>
<span className="w-1 h-1 bg-zinc-800 rounded-full"></span>
<span className="">Instant Environment Provisioning</span>
</div>
</div>

<div className="hidden lg:flex flex-col items-end justify-center relative h-full pointer-events-none select-none">
<div className="relative w-full max-w-lg bg-[#09090b] border border-zinc-800 rounded-sm shadow-2xl overflow-hidden flex flex-col mt-12 mr-8 select-none animate" data-anim="card-in" style={{animationDelay: '0.2s', boxShadow: '0 0 50px -12px rgba(0,0,0,0.5)'}}>
<div className="h-9 border-b border-zinc-800 bg-[#050505] flex items-center justify-between px-4 shrink-0">
...
<div className="h-[400px] flex flex-col relative bg-[#050505]">
<div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none"></div>
<div className="grid grid-cols-2 border-b border-zinc-800 h-28 relative z-10 bg-zinc-900/5">
<div className="border-r border-zinc-800 p-5 flex flex-col justify-between">
<div>
...
<div className="w-20 h-20 border border-zinc-700 rounded-full animate-[spin_10s_linear_infinite]"></div>
<div className="w-32 h-32 border border-zinc-800 rounded-full absolute"></div>
</div>
...
<div className="absolute w-full h-[1px] bg-zinc-800 -rotate-45"></div>
<div className="absolute top-1/2 left-4 w-1.5 h-1.5 bg-zinc-600 rounded-full -translate-y-1/2"></div>
<div className="absolute top-1/2 right-4 w-1.5 h-1.5 bg-zinc-600 rounded-full -translate-y-1/2"></div>
<div className="absolute bottom-4 left-1/2 w-1.5 h-1.5 bg-zinc-600 rounded-full -translate-x-1/2"></div>
</div>
</div>
</div>
<div className="flex-1 relative overflow-hidden bg-[#050505] p-5 font-mono text-[10px] text-zinc-500">
<div className="absolute inset-x-0 top-0 h-8 bg-gradient-to-b from-[#050505] to-transparent z-10"></div>
<div className="absolute inset-x-0 bottom-0 h-8 bg-gradient-to-t from-[#050505] to-transparent z-10"></div>
<div className="animate-scroll-y space-y-3">
<div className="flex gap-3">
<span className="text-zinc-700">10:42:01</span>
<span>System initialization started</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:02</span>
<span>
...
<div className="flex gap-3">
<span className="text-zinc-700">10:42:03</span>
...
<div className="flex gap-3">
<span className="text-zinc-700">10:42:04</span>
<span>New node provisioned: node-884</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:05</span>
<span>Syncing database shards...</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:06</span>
<span>Pipeline throughput: 100%</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:07</span>
<span>Agent deployed successfully</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:08</span>
<span>Monitoring active</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:09</span>
<span>Optimizing cache layer...</span>
</div>
<div className="flex gap-3">
<span className="text-zinc-700">10:42:10</span>
...
<div className="h-14 border-t border-zinc-800 bg-[#080808] flex items-center px-5 gap-4">
...
<div className="absolute inset-0 bg-gradient-to-r from-transparent via-orange-600 to-transparent w-1/3 animate-slide-x"></div>
</div>
<div className="flex gap-1.5">
<div className="w-1 h-3 bg-green-500 rounded-sm animate-pulse"></div>
<div className="w-1 h-3 bg-green-500 rounded-sm animate-pulse" style={{animationDelay: '0.15s'}}></div>
<div className="w-1 h-3 bg-green-500 rounded-sm animate-pulse" style={{animationDelay: '0.3s'}}></div>
</div>
</div>
</div>
</div>
...
<div className="flex flex-col bg-center md:px-12 md:flex-row md:items-end md:pt-36 md:pb-28 border-zinc-800 border-b pt-24 pr-8 pb-20 pl-8 gap-x-6 gap-y-6 justify-between">
<div className="max-w-2xl animate" data-anim="fade-up">
...
<div className="group relative border-r border-b lg:border-b-0 border-zinc-800 p-8 min-h-[320px] flex flex-col justify-between hover:bg-zinc-900/30 transition-colors animate" data-anim="fade-up" style={{animationDelay: '0s'}}>
<div className="">
...
<div className="group relative border-r border-b lg:border-b-0 border-zinc-800 p-8 min-h-[320px] flex flex-col justify-between hover:bg-zinc-900/30 transition-colors animate" data-anim="fade-up" style={{animationDelay: '0.1s'}}>
<div className="">
<div className="flex justify-between items-start mb-6">
<span className="text-[10px] font-mono text-zinc-600 border border-zinc-800 px-2 py-1 group-hover:border-orange-600/50 group-hover:text-orange-600 transition-colors">
                    FIG. 02
...
<div className="group relative border-r border-b md:border-b-0 border-zinc-800 p-8 min-h-[320px] flex flex-col justify-between hover:bg-zinc-900/30 transition-colors animate" data-anim="fade-up" style={{animationDelay: '0.2s'}}>
<div className="">
<div className="flex justify-between items-start mb-6">
<span className="text-[10px] font-mono text-zinc-600 border border-zinc-800 px-2 py-1 group-hover:border-orange-600/50 group-hover:text-orange-600 transition-colors">
                    FIG. 03
...
<div className="group relative border-b md:border-b-0 border-zinc-800 p-8 min-h-[320px] flex flex-col justify-between hover:bg-zinc-900/30 transition-colors animate" data-anim="fade-up" style={{animationDelay: '0.3s'}}>
<div className="">
<div className="flex justify-between items-start mb-6">
<span className="text-[10px] font-mono text-zinc-600 border border-zinc-800 px-2 py-1 group-hover:border-orange-600/50 group-hover:text-orange-600 transition-colors">
                    FIG. 04
...
<div className="flex flex-col md:px-12 md:flex-row md:items-end md:pt-36 md:pb-28 bg-center bg-gradient-to-t from-blue-500/0 via-[#ff9300]/10 to-blue-500/0 border-zinc-800 pt-24 pr-8 pb-20 pl-8 gap-x-6 gap-y-6 justify-between">
<div className="max-w-2xl animate" data-anim="fade-up">
...
<div className="hidden lg:grid grid-cols-12 border-t border-zinc-800 min-h-[550px] animate" data-anim="fade-up">

<div className="col-span-4 border-r border-zinc-800 bg-[#050505] flex flex-col">

<button className="scenario-tab group w-full text-left p-8 border-b border-zinc-800 transition-all border-l-2 border-l-orange-600 bg-zinc-900/20" data-index="0" onclick="window.switchTab(0)">
...
<button className="scenario-tab group w-full text-left p-8 border-b border-zinc-800 hover:bg-zinc-900/10 transition-all border-l-2 border-l-transparent" data-index="1" onclick="window.switchTab(1)">
<div className="flex justify-between items-start mb-3">
<span className="text-[10px] font-mono text-zinc-500 group-hover:text-orange-600 transition-colors uppercase tracking-wider">
                    AI_OPS
                  </span>
...
<button className="scenario-tab group w-full text-left p-8 border-b border-zinc-800 hover:bg-zinc-900/10 transition-all border-l-2 border-l-transparent" data-index="2" onclick="window.switchTab(2)">
<div className="flex justify-between items-start mb-3">
<span className="text-[10px] font-mono text-zinc-500 group-hover:text-orange-600 transition-colors uppercase tracking-wider">
                    ENTERPRISE
                  </span>
...
<button className="scenario-tab group w-full text-left p-8 border-b border-zinc-800 hover:bg-zinc-900/10 transition-all border-l-2 border-l-transparent" data-index="3" onclick="window.switchTab(3)">
<div className="flex justify-between items-start mb-3">
<span className="text-[10px] font-mono text-zinc-500 group-hover:text-orange-600 transition-colors uppercase tracking-wider">
                    SECURITY
                  </span>
...
<h3 className="text-3xl text-white font-medium uppercase tracking-tight mb-4">
                      Cloud Infrastructure Automation
                    </h3>
<p className="text-sm font-mono text-zinc-500 mb-8 border-l border-zinc-800 pl-4">
...
<span className="w-1.5 h-1.5 bg-orange-600 rounded-sm"></span>
...
<div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-10 border-t border-zinc-800/50 pt-6">
<div className="flex items-center gap-2">
<span>DEPLOY_TIME:</span>
<span className="text-white bg-green-500/10 px-1 rounded">
                          -63%
                        </span>
</div>
<div className="flex items-center gap-2">
...
<button className="bg-orange-600 text-white px-6 py-3 text-[10px] font-mono uppercase tracking-widest hover:bg-orange-500 transition-colors font-medium shadow-[0_0_15px_rgba(234,88,12,0.3)]">
                        Request Demo
                      </button>
<button className="bg-transparent border border-zinc-700 text-zinc-400 px-6 py-3 text-[10px] font-mono uppercase tracking-widest hover:text-white hover:border-white transition-colors">
                        Read Documentation
                      </button>
</div>
</div>
<div className="hidden xl:flex w-72 border border-zinc-800 bg-[#050505] p-4 flex-col gap-3 shadow-2xl rotate-1 group-hover:rotate-0 transition-transform duration-500 self-center">
...
<div className="text-green-500">No drift detected.</div>
<div className="text-zinc-400">
                        &gt; deploying to us-east-1...
                      </div>
<div className="h-1 w-full bg-zinc-800 mt-2 overflow-hidden">
<div className="h-full bg-orange-600 w-2/3 animate-pulse"></div>
</div>
</div>
...
<span className="text-[9px] font-mono text-zinc-600">4s</span>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-2">
<span>TASKS:</span>
<span className="text-zinc-300">14k/day</span>
</div>
<div className="flex items-center gap-2">
<span>QUEUE:</span>
...
<button className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-orange-600 hover:text-white transition-colors group">
                        See Implementation
                        <iconify-icon className="group-hover:translate-x-1 transition-transform" icon="solar:arrow-right-linear"></iconify-icon>
</button>
<button className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-zinc-500 hover:text-white transition-colors">
                        View Runbook
                      </button>
</div>
</div>
<div className="hidden xl:grid w-72 border border-zinc-800 bg-[#050505] p-4 grid-cols-2 gap-2 shadow-2xl rotate-1 group-hover:rotate-0 transition-transform self-center">
...
<div className="hidden xl:flex w-72 border border-zinc-800 bg-[#050505] p-4 flex-col gap-1 items-end shadow-2xl rotate-1 group-hover:rotate-0 transition-transform self-center">
...
<div className="hidden xl:flex w-72 items-center justify-center h-48 border border-zinc-800 bg-[#050505] p-4 shadow-2xl rotate-1 group-hover:rotate-0 transition-transform self-center">
...
<button className="flex-1 py-3 bg-orange-600 text-white text-[10px] font-mono uppercase tracking-widest hover:bg-orange-500 transition-colors font-medium" data-demo-trigger="true">
                Request Demo
              </button>
...
<p className="text-sm text-zinc-500 font-mono leading-relaxed max-w-xl mt-4" data-anim="fade-up">
...
<div className="lg:col-span-3 border-r border-zinc-800 p-8 flex flex-col relative bg-zinc-900/10 group hover:bg-zinc-900/20 transition-colors" data-anim="fade-right">
...
<div className="lg:col-span-6 border-r border-zinc-800 bg-[#080808] relative flex flex-col overflow-hidden group" data-anim="scale-in" data-delay="0.1" style={{animationDelay: '0.1s'}}>
...
<div className="lg:col-span-3 flex flex-col border-r lg:border-r-0 border-zinc-800" data-anim="fade-left" data-delay="0.2" style={{animationDelay: '0.2s'}}>
...
<div className="flex flex-col bg-center md:px-12 md:flex-row md:items-end md:pt-36 md:pb-28 bg-gradient-to-t from-blue-500/0 via-[#ff9300]/10 to-blue-500/0 border-zinc-800 border-b pt-24 pr-8 pb-20 pl-8 gap-x-6 gap-y-6 justify-between">
...
<h2 className="text-3xl md:text-4xl font-medium text-white uppercase tracking-tight leading-none" data-anim="fade-up">
                Validation
...
<div className="flex-1 p-8 md:p-12 relative overflow-hidden group border-b border-zinc-800 bg-zinc-900/5 hover:bg-zinc-900/10 transition-colors" data-anim="fade-up">
...
<div className="border-r border-zinc-800 p-8 flex flex-col justify-between hover:bg-zinc-900/20 transition-colors" data-anim="fade-up" style={{animationDelay: '0s'}}>
...
<div className="p-8 flex flex-col justify-between hover:bg-zinc-900/20 transition-colors relative overflow-hidden group" data-anim="fade-up" style={{animationDelay: '0.1s'}}>
...
<div className="lg:col-span-4 flex flex-col bg-zinc-950/30" data-delay="0.2">

<div className="flex-1 p-8 border-b border-zinc-800 hover:bg-zinc-900 transition-colors flex flex-col justify-center" data-anim="fade-up" style={{animationDelay: '0s'}}>
...
<div className="flex-1 p-8 border-b border-zinc-800 hover:bg-zinc-900 transition-colors flex flex-col justify-center" data-anim="fade-up" style={{animationDelay: '0.1s'}}>
<div className="flex justify-between items-end mb-4">
<span className="text-[9px] font-mono text-zinc-500 uppercase tracking-wider">
                    Active_Clusters
                  </span>
...
<div className="flex-1 p-8 hover:bg-zinc-900 transition-colors flex flex-col justify-center" data-anim="fade-up" style={{animationDelay: '0.2s'}}>
...
<h2 className="text-4xl md:text-5xl lg:text-6xl font-medium text-white uppercase tracking-tight leading-[0.9] mb-6" data-anim="fade-up">
                Scale Your
...
<div className="group relative bg-zinc-900/20 border border-zinc-800 p-8 flex flex-col hover:border-zinc-700 transition-colors rounded-sm" data-anim="fade-up" style={{animationDelay: '0s'}}>
...
<div className="relative bg-[#080808] border border-zinc-800 p-10 flex flex-col shadow-2xl lg:-mt-6 lg:mb-6 z-10 rounded-sm group hover:border-orange-600/30 transition-colors" data-anim="fade-up" style={{animationDelay: '0.1s'}}>
...
<div className="group relative bg-zinc-900/20 border border-zinc-800 p-8 flex flex-col hover:border-zinc-700 transition-colors rounded-sm" data-anim="fade-up" style={{animationDelay: '0.2s'}}>
<div className="flex justify-between items-start mb-8">
<span className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest border border-zinc-800 px-2 py-1 bg-zinc-950">
                    Level_03
                  </span>
...
<div className="w-full max-w-6xl border-t border-zinc-800 bg-zinc-900/20 backdrop-blur-sm rounded-sm" data-anim="fade-up">
...
<div className="flex flex-col text-left items-start" data-anim="fade-up">
...
<div className="relative w-full" data-anim="scale-in" data-delay="0.1" style={{animationDelay: '0.1s'}}>
...
<div aria-hidden="true" className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] hidden opacity-0 transition-opacity duration-300" id="demo-panel-overlay"></div>
<div aria-label="Request a Guided Demo" aria-modal="true" className="fixed top-0 right-0 h-full w-full md:w-[420px] bg-[#050505] border-l border-zinc-800 z-[70] shadow-2xl transform translate-x-full transition-transform duration-300 flex flex-col font-mono" id="demo-panel" role="dialog">

<div className="flex items-start justify-between p-6 md:p-8 border-b border-zinc-800 bg-zinc-900/10">
<div>
<h2 className="text-lg text-white font-medium uppercase tracking-tight mb-2">
...
<button aria-label="Close panel" className="text-zinc-500 hover:text-white transition-colors p-1" id="demo-panel-close">
...
<label className="text-[10px] uppercase tracking-widest text-zinc-500" htmlFor="demo-name">
            Full Name
          </label>
<input className="w-full bg-zinc-900/30 border border-zinc-800 text-zinc-300 text-xs p-3 focus:border-orange-600 focus:bg-zinc-900/80 outline-none transition-colors placeholder:text-zinc-700" id="demo-name" placeholder="e.g. Alex Chen" type="text"/>
</div>
<div className="space-y-1">
<label className="text-[10px] uppercase tracking-widest text-zinc-500" htmlFor="demo-email">
            Work Email
          </label>
<input className="w-full bg-zinc-900/30 border border-zinc-800 text-zinc-300 text-xs p-3 focus:border-orange-600 focus:bg-zinc-900/80 outline-none transition-colors placeholder:text-zinc-700" id="demo-email" placeholder="name@company.com" type="email"/>
</div>
<div className="space-y-1">
<label className="text-[10px] uppercase tracking-widest text-zinc-500" htmlFor="demo-company">
            Company
          </label>
<input className="w-full bg-zinc-900/30 border border-zinc-800 text-zinc-300 text-xs p-3 focus:border-orange-600 focus:bg-zinc-900/80 outline-none transition-colors placeholder:text-zinc-700" id="demo-company" placeholder="Company Name" type="text"/>
</div>
<div className="space-y-1">
<label className="text-[10px] uppercase tracking-widest text-zinc-500" htmlFor="demo-usecase">
            Use Case
          </label>
<div className="relative">
<select className="w-full bg-zinc-900/30 border border-zinc-800 text-zinc-300 text-xs p-3 appearance-none focus:border-orange-600 focus:bg-zinc-900/80 outline-none transition-colors cursor-pointer" id="demo-usecase">
...
<div className="space-y-1">
<label className="text-[10px] uppercase tracking-widest text-zinc-500" htmlFor="demo-notes">
            What are you evaluating?
            <span className="text-zinc-700 normal-case tracking-normal">
              (Optional)
            </span>
</label>
<textarea className="w-full bg-zinc-900/30 border border-zinc-800 text-zinc-300 text-xs p-3 focus:border-orange-600 focus:bg-zinc-900/80 outline-none transition-colors placeholder:text-zinc-700 resize-none" id="demo-notes" placeholder="Brief details about your infrastructure..." rows="3"></textarea>
</div>
</div>

<div className="p-6 md:p-8 border-t border-zinc-800 bg-zinc-900/5 flex flex-col gap-4">
<button className="w-full py-4 bg-orange-600 hover:bg-orange-500 text-white text-[10px] uppercase tracking-widest font-medium transition-all shadow-[0_0_20px_rgba(234,88,12,0.2)] hover:shadow-[0_0_30px_rgba(234,88,12,0.4)] flex items-center justify-center gap-2 group">
          Request Demo
          <iconify-icon className="group-hover:translate-x-1 transition-transform" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</button>
...
<a className="inline-block text-[10px] text-zinc-500 hover:text-white border-b border-transparent hover:border-zinc-500 transition-all uppercase tracking-wider" href="#" onclick="closeDemoPanel()">
            View Documentation
          </a>
</div>
</div>

...
<img alt="Block Blast logo" className="w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d1123bcd-0ff6-4600-9186-17334068a6f9_3840w.png"/>
</div>
<h1 className="flex flex-col items-center text-center w-full max-w-4xl mr-auto mb-10 ml-auto" style={{textWrap: 'balance'}}>
<span className="block leading-[1.1] sm:text-4xl md:text-5xl lg:text-6xl xl:text-[4rem] text-4xl font-semibold text-white tracking-tight pt-3 pb-3">The ORGANIC feed rns 24/7.Azur isn't in it.</span>
...
<p className="leading-relaxed md:text-2xl text-base font-medium text-gray-300 text-center w-full max-w-2xl mr-auto ml-auto" style={{textWrap: 'balance'}}>Your users watch 300+ organic videos a day. None of them are Loopoo. We change that.</p>
</div>
...
<video autoplay="" className="w-full h-full object-cover z-0 absolute top-0 right-0 bottom-0 left-0" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1774616157/AQOWGfdahcFrQvwGYc5KhlOebydij3-ktzWOyOSggBKGk50BoPDPvQJrFSFYGbGrzfAJ4OrQDxVk7he5g2b3ShiwuL3oq79JHL4u4lfp5g_hp520q.mp4"></video>
...
<div className="relative w-full h-1/2 bg-black">
<video 202603141920_2_jw85a1.mp4utoplay="" ahttps:="" className="absolute inset-0 w-full h-full object-cover z-0" dpklxai6v="" loop="" muted="" playsinline="" res.cloudinary.com="" src=" " upload="" v1774616154="" video=""></video>
...
<h2 className="md:text-4xl text-2xl font-medium text-white tracking-tight mb-3">What Loopoo looks like in the feed.</h2>
</div>
...
<video autoplay="" className="w-full h-full object-cover z-0 absolute top-0 right-0 bottom-0 left-0" loading="lazy" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1774616154/202603141920_2_jw85a1.mp4"></video>
...
<h2 className="md:text-4xl text-3xl font-semibold text-white tracking-tight mb-6">Loopoo players are scrolling right now.</h2>
...
<div className="uppercase text-base text-white tracking-widest">are from AZUR</div>
</div>
<div className="glass-panel rounded-xl p-6 min-w-[180px] flex-1">
<div className="text-4xl font-semibold text-white tracking-tight mb-2">
              80%
...
<p className="text-base font-medium text-slate-400 text-center mt-12">We show data. Book 15 minutes and we walk you through Azur on the organic feed.</p>
</div>
</section>
...
<p className="md:text-xl text-lg font-normal text-white">15 minutes. We show you what Azur looks like in the organic feed.</p>

...
<button className="px-8 py-4 bg-[#111111] text-white rounded-full text-lg font-medium hover:bg-[#4F46E5] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg group">
                        Start Retargeting <i className="w-5 h-5 group-hover:translate-x-1 transition-transform" data-lucide="arrow-right"></i>
</button>
...
<i className="w-3 h-3 text-[#4F46E5]" data-lucide="check-circle-2"></i> GDPR &amp; CCPA Compliant
                </p>
</div>
...
<i className="w-5 h-5 text-gray-400" data-lucide="globe"></i>
</div>
...
<li><a className="hover:text-[#4F46E5]" href="#">Ad Studio</a></li>

...
<div className="w-16 h-16 bg-[#252525] rounded-full overflow-hidden mr-4 flex-shrink-0">
<div className="w-full h-full bg-gradient-to-br from-green-500 to-blue-500 opacity-80"></div>
</div>
<div>
<h2 className="text-white text-xl font-medium">Alex Johnson</h2>
...
<button className="w-full mt-4 bg-[#252525] hover:bg-[#303030] text-white font-medium py-2.5 rounded-xl transition duration-200">
            Edit Profile
          </button>
</div>
</div>
...
<div className="bg-[#1a1a1a] rounded-xl overflow-hidden shadow border border-[#252525]">
<h3 className="text-white font-medium p-4 border-b border-[#252525]">Personal Info</h3>
<div>
<a className="flex items-center justify-between p-4 border-b border-[#252525] hover:bg-[#252525] transition duration-200" href="#">
<div className="flex items-center">
...
<svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
<svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<a className="flex items-center justify-between p-4 hover:bg-[#252525] transition duration-200" href="#">
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
<svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</div>
...
<div className="bg-[#1a1a1a] rounded-xl overflow-hidden shadow border border-[#252525]">
<h3 className="text-white font-medium p-4 border-b border-[#252525]">Payment</h3>
<div>
<a className="flex items-center justify-between p-4 border-b border-[#252525] hover:bg-[#252525] transition duration-200" href="#">
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
<svg className="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
<svg className="w-5 h-5 text-red-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</div>
<span className="text-gray-300">Ride History &amp; Receipts</span>
</div>
<svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 4.5l7.5 7.5-7.5 7.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
...
<div className="bg-[#1a1a1a] rounded-xl overflow-hidden shadow border border-[#252525]">
<h3 className="text-white font-medium p-4 border-b border-[#252525]">Preferences</h3>
<div>
<a className="flex items-center justify-between p-4 border-b border-[#252525] hover:bg-[#252525] transition duration-200" href="#">
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
<svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 01-3.827-5.802" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</div>
...
<div className="bg-[#1a1a1a] rounded-xl overflow-hidden shadow border border-[#252525] mb-6">
<div>
<a className="flex items-center justify-between p-4 border-b border-[#252525] hover:bg-[#252525] transition duration-200" href="#">
<div className="flex items-center">
<div className="bg-[#252525] p-2 rounded-full mr-3">
...
<span className="text-gray-300">About RideNow</span>
</div>
<svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 4.5l7.5 7.5-7.5 7.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>

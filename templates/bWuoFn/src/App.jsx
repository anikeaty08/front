...
<div className="h-40 bg-gray-900 rounded flex items-end space-x-1">
<div className="w-1/7 h-[30%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[45%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[60%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[75%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[65%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[80%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
<div className="w-1/7 h-[90%] bg-blue-500 bg-opacity-20 border-t border-blue-500 rounded-sm"></div>
</div>

...
<a className="text-lg tracking-tight font-medium lowercase magnetic hover:text-emerald-500 transition-colors" href="#" style={{transform: 'translate(0px, 0px)'}}>baha.banwaz</a>
...
<div className="bg-white/90 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-lg mt-8 border border-neutral-200/50 flex items-center gap-3">
<span className="relative flex h-2.5 w-2.5">
<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75"></span>
<span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500"></span>
</span>
<span className="text-xs font-mono font-medium text-neutral-900 uppercase tracking-widest">Agent Connected</span>
</div>
</div>
</div>
</article>
...
<blockquote className="md:text-4xl leading-tight text-2xl font-medium tracking-tight mb-8">"The GTM research agent alone saved us 200+ hours in the first month. Baha he doesn’t just automate—He architect systems that genuinely transform how we operate."</blockquote>
...
<p className="text-lg text-neutral-600 max-w-sm mr-auto mb-12 ml-auto">Have a process that needs automating? Whether you have a specific plan or need help identifying opportunities, let's connect.</p>
<div className="space-y-4 mb-16">
<a className="block text-2xl md:text-3xl hover:text-emerald-500 transition-colors magnetic" href="mailto:b.banwaz@gmail.com" style={{transform: 'translate(0px, 0px)'}}>b.banwaz@gmail.com</a>
<a className="block text-xl text-neutral-500 hover:text-neutral-900 transition-colors magnetic" href="tel:+21623035527" style={{transform: 'translate(0px, 0px)'}}>+216 23 03 55 27</a>
</div>
<div className="flex justify-center">
<a className="magnetic group inline-flex items-center gap-2 bg-neutral-900 text-cream pl-6 pr-2 py-2 rounded-full hover:bg-emerald-500 transition-all duration-300" href="https://www.linkedin.com/in/baha-banwaz" rel="noopener noreferrer" target="_blank">
...
<span className="font-medium text-neutral-900">© 2026 Baha Banwaz</span>

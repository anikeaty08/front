...
<a className="uppercase flex items-center gap-2 hover:text-amber-500 transition-colors text-xl font-medium text-white tracking-tight" href="#">Beast</a>
...
<img alt="Gym Background" className="w-full h-full object-cover grayscale opacity-20" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=2000&amp;auto=format&amp;fit=crop"/>
...
<div className="inline-flex text-sm font-medium text-amber-500 bg-amber-500/10 border-amber-500/30 border rounded-full mb-8 pt-1.5 pr-4 pb-1.5 pl-4 gap-x-2 gap-y-2 items-center">Premium Facility in Hyderabad City</div>
<h1 className="md:text-7xl leading-tight text-5xl font-medium text-white tracking-tight mb-6">Beast Garage.<br/>The GYM. <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-500"></span></h1>
<p className="md:text-xl leading-relaxed text-base text-neutral-400 max-w-2xl mr-auto mb-10 ml-auto">
...
<p className="leading-relaxed text-base text-neutral-400 mb-6">At Beast Grarage, we believe that true fitness encompasses both structural integrity and muscular strength. Our facility is uniquely designed to serve athletes recovering from injury as well as individuals pushing their physical limits.</p>
...
<img alt="Levo Gym Training" className="relative z-10 rounded-2xl object-cover w-full h-[600px] grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
</div>
</div>
</section>
...
<button className="transition-colors hover:bg-neutral-900 text-base font-medium text-white w-max border-neutral-700 border rounded-full pt-2.5 pr-6 pb-2.5 pl-6">
                        View Full Gallery
                    </button>
</div>
...
<img alt="Free Weights Area" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://images.unsplash.com/photo-1540497077202-7c8a3999166f?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
...
<img alt="Cardio Zone" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<div className="group-hover:opacity-100 transition-opacity duration-300 flex bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 pt-6 pr-6 pb-6 pl-6 absolute top-0 right-0 bottom-0 left-0 items-end">
<div className="">
...
<div className="relative group overflow-hidden rounded-xl aspect-[4/3] lg:col-span-2">
<img alt="Personal Training" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
<div className="group-hover:opacity-100 transition-opacity duration-300 flex bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 pt-6 pr-6 pb-6 pl-6 absolute top-0 right-0 bottom-0 left-0 items-end">
<div className="">
...
<div className="relative group overflow-hidden rounded-xl aspect-[4/3]">
<img alt="Clinical Rehab Area" className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
<div>
...
<span className="text-5xl font-medium text-white tracking-tight">KD 45</span>
...
<p className="text-base italic text-neutral-300 mb-8">"Following knee surgery, I needed a place that understood rehab isn't just stretching. The team at BEAST GARAGE integrated strength work perfectly. I'm stronger than before my injury."</p>
<div className="flex items-center gap-4">
...
<p className="text-base italic text-neutral-300 mb-8">"Best facility in hyderabad City hands down. The integration of clinical staff with gym floor trainers creates a seamless experience for anyone serious about health."</p>
<div className="flex items-center gap-4">
...
<img alt="Blog 1" className="w-28 h-28 object-cover rounded-xl grayscale group-hover:grayscale-0 transition-all duration-300" src="https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&amp;w=300&amp;auto=format&amp;fit=crop"/>
...
<article className="flex gap-5 group cursor-pointer items-center">
<img alt="Blog 2" className="w-28 h-28 object-cover rounded-xl grayscale group-hover:grayscale-0 transition-all duration-300" src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&amp;w=300&amp;auto=format&amp;fit=crop"/>
<div className="flex flex-col justify-center">
...
<p className="text-base text-neutral-400">17-1-177/10,  Srinagar Colony, Madannapet Colony,<br/>Hyderabad, Telangana 500059, India</p>
</div>
</div>
<div className="flex items-start gap-5">
<div className="w-12 h-12 rounded-full border flex items-center justify-center shrink-0 bg-neutral-900 border-neutral-800 text-amber-500">
...
<p className="text-base text-neutral-400">+91  9989491949</p>
</div>
</div>
...
<p className="text-base text-neutral-400">BeastGarage@GYM.com</p>
</div>
</div>
</div>
</div>
...
<input className="focus:outline-none focus:border-amber-500 transition-colors placeholder:text-neutral-600 text-base text-white bg-transparent w-full border-neutral-700 border-b pt-2.5 pb-2.5" placeholder="John" type="text"/>
</div>
<div>
...
<a className="uppercase flex items-center gap-2 text-2xl font-medium tracking-tight mb-6" href="#">BEAST</a>

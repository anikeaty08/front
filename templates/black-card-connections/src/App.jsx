...
<div className="md:px-12 flex h-20 max-w-[1600px] mr-auto ml-auto pr-6 pl-6 items-center justify-between">
...
<div className="reveal lg:col-span-5 md:p-12 lg:p-16 flex flex-col overflow-hidden group active bg-[#3a3532] rounded-[2rem] pt-8 pr-8 pb-8 pl-8 relative justify-center">
...
<h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold uppercase leading-[0.9] tracking-tight mb-8">
                        Elegant Leather<br/>
<span className="text-white/90">Women's Backpacks</span>
</h1>
...
<div className="flex gap-3 opacity-60 mt-auto pt-12 gap-x-3 gap-y-3 items-center">
<i className="w-4 h-4 text-brand" data-lucide="map-pin"></i>
<span className="uppercase text-xs font-medium tracking-wider">: G-78, near Metro Pillar no. 39, Vijay Chowk Area, Block H, Guru Nanak Pura, Laxmi Nagar, New Delhi, Delhi, 110092</span>
</div>
</div>

<div className="reveal delay-100 lg:col-span-7 relative rounded-[2rem] overflow-hidden group h-[500px] lg:h-auto active">
...
<section className="reveal delay-200 py-16 px-6 border-b border-white/5 active">
...
<img alt="Man with bag" className="cursor-pointer w-full h-full object-cover" onclick="window.location.href='https://instasize.com/p/2a4be630c9b4c1b0c111ff8079f212f216f0fc4cede39ecb8a0b3f181ea417e0'" role="button" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8a7b8eac-464a-490c-a52e-814cce537a55_3840w.jpg"/>
</div>
</div>
</div>
</section>
...
<img alt="Briefcase" className="w-full h-full object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d0c68fc2-a591-4355-86b9-f62ffd833c18_800w.webp"/>
</div>
...
<img alt="Black Backpack" className="w-full h-full object-contain mix-blend-multiply group-hover:scale-110 transition-transform duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a7045730-245b-4ca7-adcd-354f701b6f85_800w.webp"/>
</div>
<div className="flex justify-between items-end">
<div className="">
...
<img alt="Leather texture" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b8380dd4-d8a1-4af0-83b0-b837d9f83de8_3840w.webp"/>
<div className="backdrop-blur-[2px] bg-black/50 absolute top-0 right-0 bottom-0 left-0"></div>
...
<p className="text-brand text-3xl font-script rotate-[-3deg]"></p>
</div>
</section>
...
<img alt="Blog 1" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6888c006-cae3-48e6-a192-bd33d9ca1010_800w.webp"/>
</div>
<div className="">
...
<img alt="Blog 2" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2d9d681e-c20c-41a3-bc0a-426ecdea6c77_800w.webp"/>
</div>
<div className="">
...
<img alt="Blog 3" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?q=80&amp;w=2038&amp;auto=format&amp;fit=crop"/>
</div>
<div className="">
...
<ul className="space-y-3 text-xs text-white/50">
<li className=""><a className="hover:text-brand transition-colors" href="#">Mobile App</a></li>
<li className=""><a className="hover:text-brand transition-colors" href="#">Gift Vouchers</a></li>
<li className=""><a className="hover:text-brand transition-colors" href="#">Black Friday</a></li>
</ul>
</div>
</div>

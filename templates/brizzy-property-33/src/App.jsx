...
<a className="transition-colors hover:text-[#5F726F]" href="#services">Services</a>
<a className="transition-colors hover:text-[#5F726F]" href="#work">Developments</a>
<a className="transition-colors hover:text-[#5F726F]" href="#process">Process</a>
<a className="transition-colors hover:text-[#5F726F]" href="#about">Studio</a>
</div>
...
<span className="relative inline-flex rounded-full h-2 w-2" style={{background: '#5F726F'}}></span>
                ...
                LAUNCHING DEVELOPMENTS BEFORE THE HOARDING COMES DOWN
              </div>
<h1 className="text-5xl sm:text-6xl lg:text-7xl leading-[0.95] tracking-tight mb-8 text-gray-900 font-medium">
                Property brands that
                <span className="italic" style={{color: '#808187'}}>sell the story</span>
<br/>
                and websites that
...
<p className="text-base sm:text-lg leading-relaxed max-w-xl mb-10 font-medium" style={{color: '#808187'}}>
                Brizzy creates
                <span className="font-semibold" style={{color: '#5F726F'}}>branding</span>,
                <span className="font-semibold" style={{color: '#5F726F'}}>campaign-ready messaging</span>, and
                <span className="font-semibold" style={{color: '#5F726F'}}>marketing websites</span>
                for property developments—so you can nurture interest, register buyers, and de-risk the launch before completion.
              </p>
...
<div className="mt-3 text-sm font-medium" style={{color: '#5F726F'}}>
                    Narrative that matches the neighbourhood.
                  </div>
</div>
<div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 hover:bg-white hover:shadow-sm transition-all">
<div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>
...
<div className="mt-3 text-sm font-medium" style={{color: '#5F726F'}}>
                    Registrations, brochures, viewings—built in.
                  </div>
</div>
<div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 hover:bg-white hover:shadow-sm transition-all">
<div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>
...
<div className="mt-3 text-sm font-medium" style={{color: '#5F726'}}>
                    Pre-completion marketing that builds momentum.
                  </div>
</div>
</div>
</div>
...
<span className="text-xs font-semibold tracking-wide uppercase" style={{color: '#808187'}}>Pre-launch outcomes</span>
...
<div className="">
<p className="text-sm font-semibold" style={{color: '#5F726F'}}>Higher-quality registrants</p>
<p className="text-xs font-medium" style={{color: '#808187'}}>Clear positioning + intent-first journeys</p>
</div>
</div>
<div className="mt-4 grid grid-cols-3 gap-3">
<div className="bg-gray-50 border border-gray-100 rounded-xl p-3">
<div className="text-xs font-medium" style={{color: '#808187'}}>Register</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Interest list</div>
</div>
<div className="bg-gray-50 border border-gray-100 rounded-xl p-3">
<div className="text-xs font-medium" style={{color: '#808187'}}>Download</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Brochure</div>
</div>
<div className="bg-gray-50 border border-gray-100 rounded-xl p-3">
<div className="text-xs font-medium" style={{color: '#808187'}}>Book</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Viewing</div>
</div>
</div>
</div>
</div>
...
<span className="text-xs font-semibold" style={{color: '#808187'}}>CGI • Spec • Phased releases</span>
</div>
</div>
</div>
</section>
...
<span className="text-lg font-semibold">Developers</span>
</div>
<div className="flex items-center gap-3 transition-colors" style={{color: '#808187'}}>
...
<span className="text-lg font-semibold">Mixed-use</span>
</div>
<div className="flex items-center gap-3 transition-colors" style={{color: '#808187'}}>
...
<span className="text-lg font-semibold">Brochures</span>
</div>
<div className="flex items-center gap-3 transition-colors" style={{color: '#808187'}}>
...
<p className="mt-4 text-sm sm:text-base font-medium max-w-2xl mx-auto" style={{color: '#808187'}}>
              A few examples of what we build for property teams: positioning, identity, and digital journeys that convert interest into qualified enquiries.
            </p>
</div>
...
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Logo</div>
<div className="mt-4">
<div className="text-4xl tracking-tight font-semibold leading-none" style={{color: '#5F726F'}}>
                          RQ
                        </div>
<div className="mt-2 text-sm font-semibold tracking-tight" style={{color: '#5F726F'}}>Riverside Quarter</div>
<div className="mt-1 text-xs font-medium" style={{color: '#808187'}}>Battersea, London</div>
</div>
</div>
<div className="mt-5">
<h3 className="text-2xl sm:text-3xl tracking-tight leading-tight font-semibold" style={{color: '#5F726F'}}>
                        Demand before handover
                      </h3>
...
<p className="mt-5 text-sm sm:text-base font-medium leading-relaxed" style={{color: '#808187'}}>
                        Identity, key visuals and an image-forward launch site designed for phased releases and CGI-to-photography transitions.
                      </p>
</div>
</div>
...
<img alt="Riverside Quarter hero visual" className="w-full h-64 sm:h-72 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1494526585095-c41746248156?w=1400&amp;q=80"/>
</div>
<div className="col-span-12 sm:col-span-4 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="Riverside Quarter detail visual" className="w-full h-64 sm:h-72 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=900&amp;q=80"/>
</div>
<div className="col-span-12 sm:col-span-5 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="Riverside Quarter interior visual" className="w-full h-52 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1501183638710-841dd1904471?w=900&amp;q=80"/>
</div>
<div className="col-span-12 sm:col-span-7 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 relative">
<img alt="Riverside Quarter lifestyle visual" className="w-full h-52 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1449844908441-8829872d2607?w=1100&amp;q=80"/>
...
<div>
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Launch actions</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Register • Download • Book</div>
</div>
...
<div className="mt-2 text-sm font-semibold tracking-tight" style={{color: '#5F726F'}}>Foundry Yards</div>
<div className="mt-1 text-xs font-medium" style={{color: '#808187'}}>Ancoats, Manchester</div>
</div>
</div>
<div className="mt-5">
<h3 className="text-2xl sm:text-3xl tracking-tight leading-tight font-semibold" style={{color: '#5F726F'}}>
                        A system for availability updates
                      </h3>
<div className="mt-4 flex flex-wrap items-center gap-2">
...
<p className="mt-5 text-sm sm:text-base font-medium leading-relaxed" style={{color: '#808187'}}>
                        A brand-led visual system paired with an image-heavy site that supports paid media, content modules, and leasing flows.
                      </p>
</div>
</div>
<div className="lg:col-span-8">
...
<img alt="Foundry Yards hero visual" className="w-full h-64 sm:h-80 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1400&amp;q=80"/>
</div>
<div className="col-span-6 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="Foundry Yards detail visual" className="w-full h-48 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=900&amp;q=80"/>
</div>
<div className="col-span-6 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="Foundry Yards lifestyle visual" className="w-full h-48 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1494526585095-c41746248156?w=900&amp;q=80"/>
</div>
</div>
<div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
<div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Module</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Availability</div>
</div>
<div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Module</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Amenities</div>
</div>
<div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Module</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Floorplans</div>
</div>
</div>
</div>
</div>
...
<div className="mt-2 text-sm font-semibold tracking-tight" style={{color: '#5F726F'}}>The Courtyard</div>
<div className="mt-1 text-xs font-medium" style={{color: '#808187'}}>Clifton, Bristol</div>
</div>
</div>
<div className="mt-5">
<h3 className="text-2xl sm:text-3xl tracking-tight leading-tight font-semibold" style={{color: '#5F726F'}}>
                        Identity that feels inevitable
                      </h3>
<div className="mt-4 flex flex-wrap items-center gap-2">
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>
                          Key visual suite
...
<p className="mt-5 text-sm sm:text-base font-medium leading-relaxed" style={{color: '#808187'}}>
                        A premium identity and an image-dominant rollout across brochure, hoarding, and digital to build confidence without overselling.
                      </p>
</div>
</div>
<div className="lg:col-span-8">
...
<img alt="The Courtyard hero visual" className="w-full h-64 sm:h-80 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1617357283170-d924176b7f92?w=1200&amp;q=80"/>
</div>
<div className="col-span-12 sm:col-span-5 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="The Courtyard detail visual" className="w-full h-64 sm:h-80 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1449844908441-8829872d2607?w=1000&amp;q=80"/>
</div>
<div className="col-span-6 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="The Courtyard interior visual" className="w-full h-44 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1501183638710-841dd1904471?w=900&amp;q=80"/>
</div>
<div className="col-span-6 rounded-2xl overflow-hidden border border-gray-100 bg-gray-50">
<img alt="The Courtyard lifestyle visual" className="w-full h-44 object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1494526585095-c41746248156?w=900&amp;q=80"/>
</div>
</div>
<div className="mt-5 flex items-center justify-between gap-4 rounded-2xl border border-gray-100 bg-gray-50 p-4">
<div>
<div className="text-xs font-semibold uppercase tracking-wide" style={{color: '#808187'}}>Deliverables</div>
<div className="mt-1 text-sm font-semibold" style={{color: '#5F726F'}}>Logo • Typography • Brochure layouts</div>
</div>
...
<p className="mt-4 text-sm sm:text-base font-medium max-w-2xl mx-auto" style={{color: '#808187'}}>
              Everything you need to market a development before completion—without compromising the brand when the reality arrives.
            </p>
</div>
...
<button className="filter-btn group bg-white border border-gray-200 px-5 py-2.5 rounded-full text-sm transition-all font-medium" data-filter="branding" style={{color: '#808187'}}>Branding</button>
<button className="filter-btn group bg-white border border-gray-200 px-5 py-2.5 rounded-full text-sm transition-all font-medium" data-filter="web" style={{color: '#808187'}}>Websites</button>
<button className="filter-btn group bg-white border border-gray-200 px-5 py-2.5 rounded-full text-sm transition-all font-medium" data-filter="campaigns" style={{color: '#808187'}}>Marketing</button>
</div>
...
<h3 className="text-2xl tracking-tight mb-4 font-semibold transition-colors" style={{color: '#5F726F'}}>
                Property <span style={{color: '#808187'}}>Branding</span>
</h3>
<p className="text-sm sm:text-base leading-relaxed mb-8 font-medium min-h-20" style={{color: '#808187'}}>
                Naming, identity, messaging, and guidelines that align the vision, the architecture, and the buyer mindset—built to scale across print and digital.
              </p>
<div className="flex flex-wrap gap-2 mb-8">
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>Naming</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>Visual identity</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>Tone of voice</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>Brochure-ready assets</span>
</div>
<a className="w-full flex justify-between items-center py-4 px-6 rounded-xl text-sm font-semibold transition-all duration-300 group/link" href="#contact" style={{background: 'rgba(227,244,136,0.25)', color: '#5F726F'}}>
                Build the brand
...
<div className="service-card group bg-white rounded-3xl p-10 shadow-sm border border-gray-100 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1" data-category="web">
...
<h3 className="text-2xl tracking-tight mb-4 font-semibold transition-colors" style={{color: '#5F726F'}}>
                Marketing <span style={{color: '#808187'}}>Websites</span>
</h3>
<p className="text-sm sm:text-base leading-relaxed mb-8 font-medium min-h-20" style={{color: '#808187'}}>
                Launch websites that evolve with the build: CGIs → photography, spec changes, phased availability, lead capture, and compliance-ready content structures.
              </p>
<div className="flex flex-wrap gap-2 mb-8">
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(214,231,129,0.25)', color: '#5F726F'}}>Registration</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(214,231,129,0.25)', color: '#5F726F'}}>Brochure download</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(214,231,129,0.25)', color: '#5F726F'}}>Floorplans</span>
<span className="text-xs font-semibold rounded-full px-3 py-1 border border-gray-100" style={{background: 'rgba(214,231,129,0.25)', color: '#5F726F'}}>Analytics</span>
</div>

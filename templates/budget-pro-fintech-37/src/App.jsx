...
<div className="w-9 h-9 rounded-[14px] bg-indigo-500/20 flex items-center justify-center p-1.5">
<div className="w-full h-full rounded-full bg-[#5372e7] flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-indigo-500/30 pt-[1px]">B</div>
</div>
...
<a className="hover:text-white transition-colors" href="/cennik">Cennik</a>
</div>
...
<div className="animate-text-reveal inline-flex items-center gap-2 px-3 py-1 rounded-full border border-indigo-500/20 bg-indigo-500/10 text-indigo-300 text-xs font-medium mb-6">
...
<h1 className="animate-text-reveal delay-100 text-5xl md:text-7xl font-semibold text-white tracking-tight mb-6 leading-tight">
                Twoje finanse.<br/>
<span className="text-gradient">Pod pełną kontrolą.</span>
</h1>
<p className="animate-text-reveal delay-200 text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
...
<div className="animate-text-reveal delay-300 flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
...
<div className="animate-text-reveal delay-500 relative max-w-[1200px] mx-auto">
...
<div className="w-8 h-8 rounded-xl bg-indigo-500/20 flex items-center justify-center p-1.5">
<div className="w-full h-full rounded-full bg-[#5372e7] flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-indigo-500/30 pt-[0.5px]">B</div>
</div>
<div className="">
...
<div className="group relative p-6 rounded-2xl bg-[#0b0f19] border border-white/5 hover:border-orange-500/30 transition-all duration-300 overflow-hidden">
...
<h3 className="text-lg font-medium text-white mb-2">Inteligentna Lista Zakupów</h3>
<p className="text-sm text-slate-400 leading-relaxed mb-4">
                            Twórz listy zakupów zintegrowane z budżetem. System zasugeruje gdzie kupić produkty najtaniej i przewidzi łączny koszt koszyka.
                        </p>
<div className="flex items-center gap-2 text-xs font-medium text-orange-400 bg-orange-500/10 px-2 py-1 rounded w-fit">
...
<div className="group relative p-6 rounded-2xl bg-[#0b0f19] border border-white/5 hover:border-blue-500/30 transition-all duration-300 overflow-hidden">
<div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="relative z-10 flex flex-col justify-between h-full">
<div>
<div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-400 shrink-0 border border-blue-500/20 mb-4">
<iconify-icon icon="solar:document-text-linear" width="20"></iconify-icon>
</div>
<h3 className="text-lg font-medium text-white mb-2">Zaawansowane Raporty &amp; Eksporty</h3>
<p className="text-sm text-slate-400 leading-relaxed mb-4">
                                Generowanie raportów podatkowych (PIT), zestawienia dla księgowej oraz customowe raporty. Eksport do Google Sheets.
                            </p>
</div>
...
<p className="text-sm text-slate-400 leading-relaxed mb-4">
                            Automatyczne dodawanie transakcji w określone dni. Przewidywanie kosztów i opcja "pomiń następną płatność".
                        </p>
<div className="flex items-center gap-2 text-xs font-medium text-slate-400 bg-slate-800 px-2 py-1 rounded w-fit">
                            Backlog (2027)
                        </div>
</div>
</div>
...
<p className="text-sm text-slate-400 leading-relaxed mb-4">
                            Bezpieczny import transakcji bezpośrednio z Twojego banku w czasie rzeczywistym. Auto-kategoryzacja.
                        </p>
<div className="flex items-center gap-2 text-xs font-medium text-slate-400 bg-slate-800 px-2 py-1 rounded w-fit">
                            Backlog (2027)
                        </div>
...
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">Wybierz swój plan</h2>
<p className="text-slate-400">Elastyczne opcje dopasowane do Twoich potrzeb finansowych.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">

<div className="p-8 rounded-2xl bg-[#0b0f19] border border-white/5 flex flex-col h-full relative group hover:border-white/10 transition-colors">
<div className="mb-6">
<h3 className="text-xl font-medium text-white mb-2">Starter</h3>
<p className="text-slate-400 text-sm h-10">Idealny do podstawowej kontroli wydatków i nauki oszczędzania.</p>
</div>
<div className="mb-8">
<span className="text-4xl font-bold text-white tracking-tight">0 zł</span>
...
<button className="w-full py-3 rounded-lg border border-white/10 bg-white/5 text-white font-medium text-sm hover:bg-white/10 transition-colors">
                        Twój obecny plan
                    </button>
</div>

<div className="relative p-8 rounded-2xl bg-[#0b0f19] border border-orange-500/50 shadow-[0_0_40px_-10px_rgba(249,115,22,0.15)] overflow-hidden flex flex-col h-full">

<div className="absolute top-0 right-0 p-4">
<div className="px-3 py-1 bg-[#2e2315] border border-orange-500/20 rounded-full text-xs font-semibold text-orange-400 flex items-center gap-1.5">
...
<p className="text-slate-400 text-xs">Dla wymagających</p>
</div>
</div>
<div className="mb-8">
<span className="text-3xl font-bold text-white tracking-tight">19.99 zł</span>
<span className="text-slate-500 text-sm">/miesiąc</span>
</div>
<div className="space-y-4 mb-8 flex-1">

<div className="flex items-center gap-3 text-sm text-slate-300">
<iconify-icon className="text-emerald-500 shrink-0" icon="solar:check-circle-bold"></iconify-icon>
...
<div className="flex items-center gap-3 text-sm text-slate-300">
<iconify-icon className="text-emerald-500 shrink-0" icon="solar:check-circle-bold"></iconify-icon>
                            Spersonalizowane insights AI
                        </div>
<div className="flex items-center gap-3 text-sm text-slate-300">
<iconify-icon className="text-emerald-500 shrink-0" icon="solar:check-circle-bold"></iconify-icon>
                            Prognoza wydatków AI
                        </div>
<div className="flex items-center gap-3 text-sm text-slate-300">
<iconify-icon className="text-emerald-500 shrink-0" icon="solar:check-circle-bold"></iconify-icon>
                            3 analizy AI dziennie
                        </div>
<div className="flex items-center gap-3 text-sm text-slate-300">
<iconify-icon className="text-emerald-500 shrink-0" icon="solar:check-circle-bold"></iconify-icon>
...
<button className="w-full py-3 rounded-lg bg-gradient-to-r from-orange-500 to-amber-600 hover:opacity-90 text-white font-bold text-sm transition-all shadow-lg shadow-orange-500/20 flex items-center justify-center gap-2">
<iconify-icon icon="solar:crown-bold"></iconify-icon>
                        Uaktualnij do Pro Plus
                    </button>
</div>
</div>
</div>

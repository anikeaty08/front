...
<div className="aura-background-component fixed top-0 w-full h-screen -z-10"><div className="absolute top-0 left-0 -z-10 w-full h-full" data-us-project="OMO2zbNkRGUqAVYhB4jD"></div>
</div>
<div className="relative isolate overflow-hidden">

<header className="max-w-7xl mr-auto ml-auto pt-6 pr-6 pl-6">
<div className="flex items-center justify-between">
<a className="text-xl font-semibold text-white tracking-tight" data-element-id="aura-emg03ade6" href="/home">BuildAI</a>
...
<a className="hover:text-white transition" data-element-id="aura-emg013kgv" href="/documentation">Documentation</a>
...
<svg className="lucide lucide-menu h-5 w-5" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
</button>
</div>
</header>
...
<svg className="lucide lucide-sparkles h-3 w-3" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
                            AI-Powered Development
                        </div>
<h1 className="text-5xl lg:text-7xl font-semibold text-white tracking-tight leading-[1.05] mb-6">
                            Ship Products<br/>
<span className="text-teal-400">10x Faster</span>
</h1>
<p className="text-xl text-slate-300 leading-relaxed max-w-2xl mb-8">
                            From concept to production in minutes. BuildAI generates complete, production-ready applications with intelligent architecture, beautiful interfaces, and scalable code.
                        </p>
...
<button className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-slate-200 hover:text-white bg-white/5 hover:bg-white/10 ring-1 ring-white/20 rounded-lg transition">
                                View Examples
                                <svg className="lucide lucide-play ml-2 h-4 w-4" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</button>
</div>
...
<svg className="lucide lucide-bot h-4 w-4 text-teal-400" data-lucide="bot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8V4H8"></path><rect height="12" rx="2" width="16" x="4" y="8"></rect><path d="M2 14h2"></path><path d="M20 14h2"></path><path d="M15 13v2"></path><path d="M9 13v2"></path></svg>
</div>
<div>
...
<p className="text-sm text-white">Create a SaaS dashboard for project management</p>
</div>
</div>

<div className="flex items-start gap-3">
<div className="h-6 w-6 rounded-full bg-teal-400/20 flex items-center justify-center flex-shrink-0 mt-1">
<svg className="lucide lucide-bot h-3 w-3 text-teal-400" data-lucide="bot" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8V4H8"></path><rect height="12" rx="2" width="16" x="4" y="8"></rect><path d="M2 14h2"></path><path d="M20 14h2"></path><path d="M15 13v2"></path><path d="M9 13v2"></path></svg>
</div>
...
<span className="text-xs text-slate-400" id="typingStatus">Generating your app...</span>
</div>
<p className="text-sm text-white min-h-[60px]" id="aiResponse">P</p>

<div className="mt-3 space-y-2">
<div className="flex items-center gap-2 text-xs">
<div className="h-1 w-1 bg-teal-400 rounded-full"></div>
<span className="text-slate-300">Frontend: React + TypeScript</span>
</div>
<div className="flex items-center gap-2 text-xs">
<div className="h-1 w-1 bg-teal-400 rounded-full"></div>
<span className="text-slate-300">Backend: Node.js + Express</span>
</div>
<div className="flex items-center gap-2 text-xs">
...
<svg className="lucide lucide-send h-4 w-4 text-slate-900" data-lucide="send" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"></path><path d="m21.854 2.147-10.94 10.939"></path></svg>
</button>
</div>
</div>
</div>
...
<svg className="lucide lucide-code h-4 w-4 text-slate-300" data-lucide="code" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m16 18 6-6-6-6"></path><path d="m8 6-6 6 6 6"></path></svg>
</div>
</div>
</div>
</div>
...
<p className="text-xl text-slate-300 max-w-2xl mx-auto">
      From idea to production-ready application in minutes, not months. Our AI handles the complexity so you can focus on what matters.
    </p>
</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          AI that writes production-ready code with optimal architecture, security best practices, and modern design patterns built-in.
        </p>
</div>
...
<div className="text-emerald-300">// Auto-generated with security &amp; performance</div>
<div className="text-slate-200">const app = <span className="text-teal-400">express</span>();</div>
<div className="text-slate-200">app.<span className="text-purple-400">use</span>(<span className="text-yellow-400">helmet</span>());</div>
<div className="text-slate-200">app.<span className="text-purple-400">use</span>(<span className="text-yellow-400">rateLimit</span>());</div>
</div>
</div>
</div>
</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          Modern, responsive interfaces that look professional out of the box. Customizable themes and components that match your brand.
        </p>
</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          Built-in performance monitoring, user analytics, and business intelligence. Make data-driven decisions to grow your product.
        </p>
</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          Built-in authentication, authorization, and security best practices. GDPR compliant, SOC 2 certified infrastructure you can trust.
        </p>
</div>
...
<div className="flex items-center justify-between">
<span className="text-sm text-white font-medium">Security Status</span>
<div className="flex items-center gap-1">
<div className="h-2 w-2 rounded-full bg-emerald-400"></div>
...
<div className="flex items-center gap-2">
<svg className="text-emerald-400" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-xs text-slate-300">Two-Factor Auth</span>
</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          Automatic Git integration with branching, merging, and collaboration features. Track changes and work with your team seamlessly.
        </p>
</div>
...
<div className="w-full rounded-xl bg-black/40 ring-1 ring-white/10 backdrop-blur-sm p-4">
<div className="flex items-center justify-between mb-4">
<span className="text-sm text-white font-medium">Git Repository</span>
<div className="flex items-center gap-1">
...
<div className="flex-1">
<div className="text-xs text-white font-medium">feat: Add user dashboard</div>
...
<div className="flex-1">
<div className="text-xs text-white font-medium">fix: Update API endpoints</div>
...
<div className="flex-1">
<div className="text-xs text-white font-medium">docs: Update README</div>
...
<p className="text-slate-300 leading-relaxed mb-6">
          Deploy to AWS, Vercel, or any cloud platform instantly. Automated CI/CD pipelines, SSL certificates, and CDN setup included.
        </p>
</div>
...
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<svg className="text-teal-400" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<svg className="lucide lucide-workflow h-3 w-3" data-lucide="workflow" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="8" rx="2" width="8" x="3" y="3"></rect><path d="M7 11v4a2 2 0 0 0 2 2h4"></path><rect height="8" rx="2" width="8" x="13" y="13"></rect></svg>
      How it works
    </div>
<h2 className="text-4xl lg:text-5xl font-semibold text-white tracking-tight leading-tight mb-6">
...
<p className="text-xl text-slate-300 leading-relaxed mb-12">
      A streamlined flow that mirrors how teams ship with BuildAI—fast, secure, and beautifully executed.
    </p>
...
<h3 className="text-lg font-semibold text-white tracking-tight">Simple setup to get started</h3>
...
<p className="text-slate-300 leading-relaxed">
            Describe your product and pick preferences. Our guided onboarding prepares a tailored architecture in minutes.
          </p>
</div>
</div>
...
<svg className="lucide lucide-activity h-5 w-5 text-white" data-lucide="activity" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
</div>
<div className="absolute left-1/2 -translate-x-0.5 top-12 w-px h-8 bg-gradient-to-b from-white/40 to-white/10"></div>
</div>
<div className="pt-1 flex-1">
<div className="flex items-center gap-3 mb-3 justify-between">
<h3 className="text-lg font-semibold text-white tracking-tight">Real‑time generation &amp; preview</h3>
...
<p className="text-slate-300 leading-relaxed">
            Watch BuildAI generate backend, UI, and integrations in real time—preview and refine before you commit.
          </p>
</div>
</div>
...
<svg className="lucide lucide-rocket h-5 w-5 text-emerald-400" data-lucide="rocket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"></path><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"></path><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path></svg>
</div>
...
<div className="pt-1 flex-1">
<div className="flex items-center gap-3 mb-3 justify-between">
<h3 className="text-lg font-semibold text-white tracking-tight">Deploy and grow with support</h3>
...
<p className="text-slate-300 leading-relaxed">
            One‑click deploy with CI/CD, security baked in, and ongoing updates. Our team and community are here 24/7.
          </p>
</div>
</div>
</div>
...
<span className="text-sm text-white font-medium">BuildAI Console</span>
</div>
...
<svg className="lucide lucide-sidebar h-4 w-4" data-lucide="sidebar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" width="18" x="3" y="3"></rect><path d="M9 3v18"></path></svg>
</div>
</div>
...
<svg className="lucide lucide-sparkles h-4 w-4 text-teal-400" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
</div>
<div className="">
<div className="text-sm font-medium text-white">Create new app</div>
<div className="text-xs text-slate-400">Generate UI, backend, and DB</div>
</div>
</div>
<svg className="lucide lucide-arrow-right h-4 w-4 text-slate-400 group-hover:text-white transition-colors" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</div>
</button>
...
<svg className="lucide lucide-layout-dashboard h-4 w-4 text-slate-300" data-lucide="layout-dashboard" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="9" rx="1" width="7" x="3" y="3"></rect><rect height="5" rx="1" width="7" x="14" y="3"></rect><rect height="9" rx="1" width="7" x="14" y="12"></rect><rect height="5" rx="1" width="7" x="3" y="16"></rect></svg>
</div>
<div className="flex-1">
<div className="text-sm font-medium text-white">Try a template</div>
<div className="text-xs text-slate-400">SaaS, e‑commerce, admin</div>
</div>
</div>
<span className="text-xs px-2 py-0.5 rounded-full bg-white/10 text-slate-300 ring-1 ring-white/10">Starter</span>
</div>
</div>
</div>
...
<span className="text-base font-medium text-white">Analytics</span>
...
<div className="inline-flex items-center gap-2 px-3 py-1 text-xs font-medium text-teal-300 bg-teal-400/10 ring-1 ring-teal-400/20 rounded-full mb-6">
<svg className="lucide lucide-credit-card h-3 w-3" data-lucide="credit-card" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="14" rx="2" width="20" x="2" y="5"></rect><line x1="2" x2="22" y1="10" y2="10"></line></svg>
      Pricing
    </div>
...
<p className="text-xl text-slate-300 max-w-2xl mx-auto">Scale as you grow. No surprises.</p>
</div>
...
<button aria-pressed="false" className="z-[1] transition-colors text-sm font-medium text-white/70 rounded-none pt-2 pr-4 pb-2 pl-4 relative" data-plan="annual" type="button">Annual</button>
<button aria-pressed="true" className="z-[1] transition-colors text-sm font-medium text-[#000000] bg-[#ffffff] rounded-full pt-2 pr-4 pb-2 pl-4 relative" data-plan="monthly" type="button">Monthly</button>
...
<span className="ml-3 hidden px-2.5 py-1 text-xs font-medium rounded-full bg-emerald-400/10 text-emerald-300 ring-1 ring-emerald-400/20" id="saveBadge">Save 20%</span>
</div>
...
<span className="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-slate-300 ring-1 ring-white/10">Basic</span>
</div>
<div className="mb-3">
<div className="flex items-baseline gap-2">
<span className="text-5xl font-semibold tracking-tight text-white" data-annual="0" data-monthly="0" data-price="">$0</span>
<span className="text-slate-400" data-term="">/month</span>
</div>
<p className="text-slate-300 mt-3">Ideal for startups getting started with AI‑powered workflows.</p>
</div>
<div className="my-8 h-px bg-white/10"></div>
<ul className="space-y-3 text-slate-300 flex-1">
<li className="flex items-start gap-3">
<svg className="lucide lucide-check h-4 w-4 text-teal-400 mt-0.5" data-lucide="check" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<button className="w-full inline-flex items-center justify-center px-6 py-3 text-base font-medium text-slate-200 bg-white/5 hover:bg-white/10 ring-1 ring-white/10 rounded-xl transition">Get started</button>
</div>
</div>

<div className="relative bg-black/40 backdrop-blur-xl ring-1 ring-white/10 rounded-3xl p-8 flex flex-col">
<div className="flex items-center justify-between mb-8">
<span className="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-slate-300 ring-1 ring-white/10">Pro</span>
<span className="px-2.5 py-1 text-xs font-medium rounded-full bg-emerald-400/10 text-emerald-300 ring-1 ring-emerald-400/20">Most popular</span>
</div>
<div className="mb-3">
<div className="flex items-baseline gap-2">
<span className="text-5xl font-semibold tracking-tight text-white" data-annual="192" data-monthly="20" data-price="">$20</span>
<span className="text-slate-400" data-term="">/month</span>
</div>
<p className="text-slate-300 mt-3">For growing teams that need advanced features and priority support.</p>
</div>
<div className="my-8 h-px bg-white/10"></div>
<ul className="space-y-3 text-slate-300 flex-1">
<li className="flex items-start gap-3">
...
<div className="my-8 h-px bg-white/10"></div>
<div className="space-y-2">
<button className="w-full inline-flex items-center justify-center px-6 py-3 text-base font-medium text-slate-900 bg-teal-400 hover:bg-teal-300 rounded-xl ring-1 ring-teal-400/30 transition">Get started</button>
</div>
</div>

<div className="bg-black/40 backdrop-blur-xl ring-1 ring-white/10 rounded-3xl p-8 flex flex-col">
<div className="flex items-center justify-between mb-8">
<span className="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-slate-300 ring-1 ring-white/10">Enterprise</span>
</div>
<div className="mb-3">
<div className="flex items-baseline gap-2">
<span className="text-5xl font-semibold tracking-tight text-white" data-annual="490" data-monthly="49" data-price="">$49</span>
<span className="text-slate-400" data-term="">/month</span>
</div>
<p className="text-slate-300 mt-3">Custom solutions for large organizations with advanced needs.</p>
</div>
<div className="my-8 h-px bg-white/10"></div>
<ul className="space-y-3 text-slate-300 flex-1">
<li className="flex items-start gap-3">
...
<h3 className="text-xl font-semibold text-white tracking-tight mb-4">BuildAI</h3>
<p className="text-slate-300/80 max-w-md mb-6">AI that builds your product, front to back. Making software development accessible to everyone.</p>
...
<li><a className="hover:text-white transition" href="#">Examples</a></li>
...
<p className="text-sm text-slate-400">© 2024 BuildAI. All rights reserved.</p>

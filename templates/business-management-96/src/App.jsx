...
<iconify-icon className="" icon="solar:alt-arrow-right-linear"></iconify-icon>
</button>
</div>
</div>
<div className="flex overflow-x-auto gap-3 sm:gap-4 snap-x sm:pb-8 no-scrollbar -mx-6 sm:-mx-8 sm:px-8 md:-mx-12 md:px-12 pr-6 pb-6 pl-6 gap-x-3 gap-y-3 items-start">
...
<svg className="sm:w-6 sm:h-6 sm:mb-4 text-2xl text-blue-400 w-5 h-5 mb-3" data-icon-set="solar" data-solar="calculator-linear" height="20" style={{color: 'rgb(96, 165, 250)'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M4.318 20.536C5.636 22 7.758 22 12 22s6.364 0 7.682-1.465C21 19.072 21 16.714 21 12s0-7.071-1.318-8.536S16.242 2 12 2S5.636 2 4.318 3.464C3 4.93 3 7.286 3 12s0 7.071 1.318 8.535Z" stroke="currentColor" strokeWidth="1.5"></path><path d="M7 8c0-.465 0-.697.051-.888a1.5 1.5 0 0 1 1.06-1.06C8.304 6 8.536 6 9 6h6c.465 0 .697 0 .888.051a1.5 1.5 0 0 1 1.06 1.06C17 7.304 17 7.536 17 8s0 .697-.051.888a1.5 1.5 0 0 1-1.06 1.06C15.697 10 15.464 10 15 10H9c-.465 0-.697 0-.888-.051a1.5 1.5 0 0 1-1.06-1.06C7 8.696 7 8.464 7 8Z" stroke="currentColor" strokeWidth="1.5"></path><circle cx="8" cy="13" fill="currentColor" r="1"></circle><circle cx="8" cy="17" fill="currentColor" r="1"></circle><circle cx="12" cy="13" fill="currentColor" r="1"></circle><circle cx="12" cy="17" fill="currentColor" r="1"></circle><circle cx="16" cy="13" fill="currentColor" r="1"></circle><circle cx="16" cy="17" fill="currentColor" r="1"></circle></g></svg>

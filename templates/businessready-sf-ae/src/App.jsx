...
colors: {
brand: {
blue: '#00A1E0', // Salesforce-adjacent blue
navy: '#060B3D', // New Logo Navy
yellow: '#FCBC32',
dark: '#0a0a0a',
light: '#ffffff',
grey: '#f5f5f5'
...
<div className="h-9 w-9 bg-brand-navy rounded-sm flex items-center justify-center shadow-sm">
<span className="text-white font-sans font-black text-2xl leading-none pt-0.5">Z</span>
</div>

<span className="text-brand-navy dark:text-white text-2xl font-bold tracking-tight lowercase font-sans">kompetenza</span>
</a>
...
<p className="font-slab text-lg md:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed font-light">
                        The AI-First, Fully Managed, Turnkey Growth Engine. No upfront implementation fees. No internal technical team required. Subscription-based.
                    </p>
</div>
...
<p className="text-sm text-slate-500 dark:text-slate-400 max-w-2xl">
                        Instead of selling software plus uncertainty, you present a fully built, AI-powered revenue engine that goes live in up to 14 days.
                    </p>
</div>
...
<div className="flex flex-col items-center text-center sm:items-start sm:text-left">
<div className="text-3xl font-bold text-brand-blue tracking-tight mb-1">Up to 14 Days</div>
...
<li className="flex items-start gap-3 text-sm font-medium text-slate-900 dark:text-white">
<iconify-icon className="text-brand-blue text-lg flex-shrink-0" icon="solar:check-circle-bold"></iconify-icon>
<span>Up to 14 day deployment</span>
</li>
<li className="flex items-start gap-3 text-sm font-medium text-slate-900 dark:text-white">
<iconify-icon className="text-brand-blue text-lg flex-shrink-0" icon="solar:check-circle-bold"></iconify-icon>
...
<div className="max-w-7xl mx-auto px-6">
<div className="mb-16">
<span className="text-brand-blue font-semibold tracking-wide uppercase text-xs mb-3 block">Complete Customer Value Catalogue</span>
<h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white tracking-tight">Everything Included in Your Subscription</h2>
<p className="mt-4 font-slab text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
                    No code. No custom projects. No internal technical team required. A Rolls-Royce CRM at a subscription price.
                </p>
</div>
...
<h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Core Foundation</h3>
<p className="text-xs font-semibold uppercase tracking-wider text-brand-blue mb-4">Included in your subscription</p>
<div className="space-y-4">
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white">Data Migration &amp; Config</h4>
<p className="text-xs text-slate-500 mt-1">Accounts, Contacts, Leads &amp; Opportunities, Historical imports, User profiles &amp; permissions, Pipeline framework.</p>
</div>
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white">Customer Portal</h4>
<p className="text-xs text-slate-500 mt-1">Self-service access, Case management, Knowledge base, Account visibility.</p>
</div>
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white">Integration Hub</h4>
<p className="text-xs text-slate-500 mt-1">Smart integrations, Data orchestration, WhatsApp built-in, 3rd-party connectivity.</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">AI-Powered Modules</h3>
<p className="text-xs font-semibold uppercase tracking-wider text-brand-blue mb-4">Included in your subscription</p>
<div className="space-y-4">
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2"><iconify-icon className="text-brand-blue" icon="solar:check-circle-bold"></iconify-icon> AI Onboarding Accelerator</h4>
<p className="text-xs text-slate-500 mt-1 pl-6">Automated journeys, Milestone tracking, Lifecycle automation, Reduced churn.</p>
</div>
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2"><iconify-icon className="text-brand-blue" icon="solar:check-circle-bold"></iconify-icon> AI Project Management</h4>
<p className="text-xs text-slate-500 mt-1 pl-6">Project dashboards, Timesheets, Margin visibility, AI task management.</p>
</div>
<div>
<h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2"><iconify-icon className="text-brand-blue" icon="solar:check-circle-bold"></iconify-icon> AI SDR (Agentforce)</h4>
<p className="text-xs text-slate-500 mt-1 pl-6">Automated prospecting, Lead nurturing, Meeting booking, Smart qualification.</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Revenue Automation</h3>
<ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400 font-medium">
<li className="flex flex-col gap-1">
<span className="font-bold text-slate-900 dark:text-white">Renewal Automation</span>
<span className="text-xs text-slate-500">Automated renewal workflows, lifecycle logic, account management.</span>
</li>
<li className="flex flex-col gap-1">
<span className="font-bold text-slate-900 dark:text-white">Lead Scoring</span>
<span className="text-xs text-slate-500">Qualification framework, opportunity scoring, smart routing.</span>
</li>
<li className="flex flex-col gap-1">
<span className="font-bold text-slate-900 dark:text-white">Smart Messaging</span>
<span className="text-xs text-slate-500">WhatsApp-integrated sales process, automated follow-ups.</span>
</li>
<li className="flex flex-col gap-1">
<span className="font-bold text-slate-900 dark:text-white">AI Proposal Generator</span>
<span className="text-xs text-slate-500">Data-driven workflows, AI document builder, e-signature.</span>
</li>
</ul>
</div>
</div>
...
<h3 className="text-xl font-bold mb-4">Additional AI Capabilities</h3>
<ul className="space-y-4 text-sm text-blue-50 font-medium">
<li className="flex flex-col gap-1">
<span className="font-bold text-white">Intelligent Invoicing</span>
<span className="text-xs text-blue-100/80">Smart billing automation and revenue tracking built in.</span>
</li>
<li className="flex flex-col gap-1">
<span className="font-bold text-white">Predictive Analytics</span>
<span className="text-xs text-blue-100/80">KPI reporting, pipeline visibility, and forecast dashboards.</span>
</li>
<li className="flex flex-col gap-1">
<span className="font-bold text-white">Strategic Messaging</span>
<span className="text-xs text-blue-100/80">Automated email triggers, lifecycle workflows, engagement tracking.</span>
</li>
</ul>
</div>
...
<p className="text-lg font-bold text-slate-900 dark:text-white mb-2">This is not configuration. This is a ready-to-run revenue machine.</p>
<p className="text-slate-500 dark:text-slate-400 text-sm">No internal technical team required. No upfront implementation cost. Everything included in your subscription.</p>
</div>
</div>
</section>
...
<h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-4">Why BRS Wins</h2>
<p className="text-lg text-slate-600 dark:text-slate-400 font-slab">A Rolls-Royce CRM at a Subscription Price</p>
</div>
...
<iconify-icon className="text-3xl text-brand-blue mb-4" icon="solar:users-group-rounded-linear"></iconify-icon>
<h3 className="font-bold text-slate-900 dark:text-white mb-2">No Internal Tech Team</h3>
<p className="text-sm text-slate-500 leading-relaxed">We handle all configuration, deployment, and ongoing management. Your team focuses on selling.</p>
</div>

<div className="bg-white dark:bg-slate-950 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<iconify-icon className="text-3xl text-brand-blue mb-4" icon="solar:wallet-money-linear"></iconify-icon>
<h3 className="font-bold text-slate-900 dark:text-white mb-2">No Upfront Cost</h3>
<p className="text-sm text-slate-500 leading-relaxed">Zero project fees. Zero consulting invoices. Everything is included in a predictable monthly subscription.</p>
</div>

<div className="bg-white dark:bg-slate-950 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<iconify-icon className="text-3xl text-brand-blue mb-4" icon="solar:card-transfer-linear"></iconify-icon>
<h3 className="font-bold text-slate-900 dark:text-white mb-2">Subscription-Based</h3>
<p className="text-sm text-slate-500 leading-relaxed">Starting at $599/mo. AI, automation, managed service, and premium support — all included.</p>
</div>

<div className="bg-white dark:bg-slate-950 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<iconify-icon className="text-3xl text-brand-blue mb-4" icon="solar:cup-star-linear"></iconify-icon>
<h3 className="font-bold text-slate-900 dark:text-white mb-2">Beats Zoho &amp; HubSpot</h3>
<p className="text-sm text-slate-500 leading-relaxed">Matches their bundled simplicity but delivers enterprise AI, scalability, and the power of Salesforce.</p>
</div>
</div>
</div>
</section>
...
<p className="text-sm text-slate-900 dark:text-white font-medium">$599/mo, AI live in up to 14 days, No large upfront cost. Revenue automation active immediately.</p>
</div>
</div>
...
<td className="p-4 sm:p-6 font-bold text-brand-blue bg-brand-blue/5">Up to 14 Days</td>
...
<iconify-icon className="text-brand-blue text-lg" icon="solar:check-circle-bold"></iconify-icon>
                            Full AI stack included in your subscription
                        </li>
<li className="flex items-center gap-3 text-sm font-medium">
<iconify-icon className="text-brand-blue text-lg" icon="solar:check-circle-bold"></iconify-icon>
                            Dedicated AI Agent (Sales or Support)
                        </li>
<li className="flex items-center gap-3 text-sm font-medium">
<iconify-icon className="text-brand-blue text-lg" icon="solar:check-circle-bold"></iconify-icon>
...
<li className="flex items-center gap-3 text-sm font-medium">
<iconify-icon className="text-brand-blue text-lg" icon="solar:check-circle-bold"></iconify-icon>
                            Deployment in up to 14 days
                        </li>
<li className="flex items-center gap-3 text-sm font-medium">
<iconify-icon className="text-brand-blue text-lg" icon="solar:check-circle-bold"></iconify-icon>
                            Premium managed service &amp; support
                        </li>
</ul>
...
<p className="text-sm text-slate-600 dark:text-slate-400">Live in up to 14 days. Speed approaches immediate.</p>
</div>
</div>
</div>
</div>
...
<p className="font-slab text-slate-600 dark:text-slate-400 leading-relaxed">
                                System goes live in up to 14 days.
                            </p>
</div>
</div>
...
<p className="font-slab text-lg text-slate-600 dark:text-slate-400 mb-6 font-light">
                Stop letting implementation cost stall momentum. Present a complete AI-powered revenue engine — no upfront fees, no internal tech team needed, subscription-based — with value delivered immediately.
            </p>
...
<p className="text-brand-blue font-bold text-sm uppercase tracking-wide mb-10">
                A Rolls-Royce CRM at a subscription price. Competes directly with Zoho &amp; HubSpot.
            </p>
...
<span className="text-white font-sans font-black text-xl leading-none pt-0.5">Z</span>
</div>

<span className="text-brand-navy dark:text-white text-xl font-bold tracking-tight lowercase font-sans">kompetenza</span>
</div>
...
<p>© 2025 Kompetenza. All rights reserved.</p>

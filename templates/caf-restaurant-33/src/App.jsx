...
<span className="text-xl lg:text-2xl font-semibold tracking-tight text-amber-900" style={{fontFamily: '\'Playfair Display\', serif'}}>Vibez</span>
<span className="hidden sm:block text-xs text-stone-500">The Vibez Inn'</span>
</a>
...
<img alt="Coffee at The Vibez Inn'" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&amp;h=600&amp;fit=crop"/>
</div>
...
<p>
                            Nestled in the heart of Civil Lines, Raipur, <span className="font-medium text-stone-800">The Vibez Inn'</span> is more than just a café—it's a sanctuary for coffee lovers, food enthusiasts, and anyone seeking a cozy escape from the everyday hustle.
                        </p>
<p>
...
<li className="flex justify-between items-center">
<span className="text-sm text-stone-700">Vibez Special</span>
<span className="text-sm font-medium text-amber-800">₹189</span>
</li>
<li className="flex justify-between items-center">
...
<p className="text-stone-400 mt-3 max-w-xl mx-auto">A glimpse into the Vibez Inn experience</p>
</div>
...
<div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
<div className="flex items-center gap-1 mb-4">
<svg aria-hidden="true" data-icon="lucide:star" data-width="16" height="16" role="img" style={{strokeWidth: '1.5', fill: 'currentColor'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"></svg></div></div></div></div></section>
    </>
  );
}

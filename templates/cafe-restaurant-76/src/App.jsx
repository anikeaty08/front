...
<section className="py-24 bg-stone-50 scroll-mt-20 border-y border-stone-200/60" id="menu">
<div className="max-w-6xl mx-auto px-6">
<div className="text-center mb-16">
<span className="text-green-700 text-xs font-bold tracking-widest uppercase mb-2 block">Our Kitchen</span>
<h2 className="font-['DM_Serif_Display'] text-4xl text-stone-900 tracking-tight">Explore The Menu</h2>
<p className="text-stone-500 mt-3 max-w-lg mx-auto font-light">From quick bites to hearty meals, everything is prepared fresh upon order.</p>
</div>

<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">

<div className="bg-white p-8 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.03)] border border-stone-100 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 group">
...
<h3 className="text-lg font-semibold text-stone-800">Quick Snacks</h3>
</div>
<ul className="space-y-4">
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Plain Toast (2 pcs)</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹40</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Butter Toast</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹50</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Veg Sandwich</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹70</span></li>
</ul>
</div>
...
<h3 className="text-lg font-semibold text-stone-800">Burgers &amp; Rolls</h3>
</div>
<ul className="space-y-4">
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Veg Burger</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹80</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Cheese Veg Burger</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹100</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Paneer Burger</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹120</span></li>
</ul>
</div>
...
<h3 className="text-lg font-semibold text-stone-800">Italian Corner</h3>
</div>
<ul className="space-y-4">
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Plain Cheese Pizza</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹120</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Veg Pizza</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹140</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Paneer Pizza</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹160</span></li>
</ul>
</div>

<div className="bg-white p-8 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.03)] border border-stone-100 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 group">
<div className="flex items-center gap-4 mb-6 pb-4 border-b border-stone-100">
<div className="p-3 bg-stone-100 rounded-xl text-stone-600 group-hover:scale-110 transition-transform">
<iconify-icon icon="solar:cup-hot-linear" width="24"></iconify-icon>
</div>
<h3 className="text-lg font-semibold text-stone-800">Hot Brews</h3>
</div>
<ul className="space-y-4">
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Masala Tea</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹25</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Coffee</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹30</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Cappuccino</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹60</span></li>
</ul>
</div>
...
<h3 className="text-lg font-semibold text-stone-800">Sweet Treats</h3>
</div>
<ul className="space-y-4">
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Brownie (Small)</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹80</span></li>
<li className="flex justify-between items-center text-sm"><span className="text-stone-600">Ice Cream Cup</span><span className="font-bold text-stone-800 bg-stone-50 px-2 py-1 rounded">₹50</span></li>
</ul>
</div>

<div className="bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.03)] border border-green-100 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 group flex flex-col items-center justify-center text-center">
<div className="w-16 h-16 bg-white text-green-700 rounded-full shadow-sm flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
<iconify-icon icon="solar:arrow-right-linear" width="32"></iconify-icon>
</div>
<h3 className="text-lg font-semibold text-green-900 mb-2">Full Menu Online</h3>
<p className="text-xs text-green-800/70 mb-4">View real-time availability</p>
<a className="text-xs font-semibold uppercase tracking-wider text-green-700 hover:underline" href="#order-online">Start Order</a>
</div>
</div>
</div>
</section>

<section className="py-24 bg-white scroll-mt-20" id="gallery">
<div className="max-w-7xl mx-auto px-6">
...
<section className="py-24 bg-stone-50 border-t border-stone-200 scroll-mt-20" id="reviews">
<div className="max-w-7xl mx-auto px-6">
...
<span>Est. Prep Time: <span className="font-semibold text-stone-900">15 mins</span></span>
</div>
</div>
...
<input checked="" className="menu-radio hidden" name="category" type="radio"/>
<div className="px-5 py-2.5 rounded-full border border-stone-200 text-sm font-medium text-stone-600 hover:border-green-600 transition-all select-none">
                                    All Items
                                </div>
</label>
<label className="cursor-pointer whitespace-nowrap">
<input className="menu-radio hidden" name="category" type="radio"/>
<div className="hover:border-green-600 transition-all select-none text-sm font-medium text-stone-600 border-stone-200 border rounded-full pt-2.5 pr-5 pb-2.5 pl-5">
                                    ☕ Coffee &amp; Tea
                                </div>
</label>
<label className="cursor-pointer whitespace-nowrap">
...
<div className="flex gap-4 p-4 rounded-xl border border-stone-100 bg-white hover:border-green-200 hover:shadow-lg hover:shadow-green-900/5 transition-all group">
<div className="w-24 h-24 rounded-lg bg-stone-100 overflow-hidden flex-shrink-0">
<img alt="Coffee" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1576485290814-1c72aa4bbb8e?q=80&amp;w=200&amp;auto=format&amp;fit=crop"/>
</div>
<div className="flex flex-col justify-between flex-grow">
<div className="">
<div className="flex justify-between items-start">

...
<span className="lg:text-2xl text-xl font-semibold text-amber-900 tracking-tight" style={{fontFamily: '\'Playfair Display\', serif'}}>Fenil restaurant 
</span>
...
<div className="flex items-center" onclick="window.location.href='/#tel:9825375672'" role="button">
...
<span className="">9825375672</span>
</a>
<a className="hover:bg-amber-900 transition-colors text-sm font-medium text-white bg-amber-800 rounded-full pt-2 pr-4 pb-2 pl-4" href="/9825375672">
                        Order Now
                    </a>
...
<div className="z-10 sm:px-6 lg:px-8 lg:py-20 max-w-7xl mr-auto ml-auto pt-12 pr-4 pb-12 pl-4 relative">
...
<h1 className="sm:text-5xl lg:text-6xl xl:text-7xl text-4xl font-medium text-stone-900 tracking-tight mb-6" style={{fontFamily: '\'Playfair Display\', serif'}}>
                        Brewed for<br/>
...
<p className="text-base lg:text-lg text-stone-600 mb-8 max-w-lg mx-auto lg:mx-0">
                        Experience the perfect blend of artisanal coffee, delicious food, and cozy ambiance at Civil Lines, Raipur.
                    </p>
...
<p className="text-sm font-medium text-stone-800">Nr L.H. RD</p>
<p className="text-xs text-stone-500">Kapodra surat</p>
</div>
</div>
</div>
...
<p>
                            Nestled in the heart of Civil Lines, Raipur, <span className="font-medium text-stone-800">More Over Coffee (MOC)</span> is more than just a café—it's a sanctuary for coffee lovers, food enthusiasts, and anyone seeking a cozy escape from the everyday hustle.
                        </p>
<p>
...
<p className="text-stone-600 text-sm leading-relaxed mb-4">
                        "Best café in Civil Lines! The pasta and sizzlers are absolutely fantastic. The interiors are Instagram-worthy. Will definitely come back again."
                    </p>
<div className="flex items-center gap-3">
...
<p className="text-stone-600 text-sm leading-relaxed mb-4">
                        "Great place for date nights! The lighting is perfect and food is consistently good. The paneer tandoori sandwich is our favorite. Highly recommended!"
                    </p>
<div className="flex items-center gap-3">
...
<p className="text-xs text-stone-500">1 week ago</p>
</div>
</div>
</div>
...
<p className="text-stone-600 text-sm leading-relaxed mb-4">
                        "Cheesecakes are heavenly! Tried the biscoff cheesecake and it was pure bliss. The café has such a warm and welcoming atmosphere. Perfect for coffee lovers."
                    </p>
<div className="flex items-center gap-3">
...
<p className="text-xs text-stone-500">5 days ago</p>
</div>
</div>
</div>
...
<p className="text-stone-600 text-sm leading-relaxed mb-4">
                        "Italian sizzler was amazing! The portion size is generous and the taste is authentic. Quick service and polite staff. One of the best cafés in Raipur."
                    </p>
<div className="flex items-center gap-3">
...
<div className="text-center mt-10">
<a className="inline-flex items-center gap-2 text-amber-800 hover:text-amber-900 font-medium text-sm transition-colors" href="https://www.google.com/maps" target="_blank">
<span className="">Read all reviews on Google</span>
<svg aria-hidden="true" data-icon="lucide:external-link" data-width="16" height="16" role="img" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M15 3h6v6m-11 5L21 3m-3 10v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</a>
</div>
</div>
</section>
...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 gap-x-12 gap-y-20">
<div className="">
<span className="text-xs font-medium text-amber-700 uppercase tracking-wider">Get in Touch</span>
...
<div className="">
<h3 className="text-base font-medium text-stone-800 mb-1">Address</h3>
<p className="text-sm text-stone-600">F1, Lambe Hanuman Road,kiran chowk,kapodra, surat </p>
</div>
</div>
<div className="flex gap-4 gap-x-4 gap-y-4">
<div className="flex flex-shrink-0 cursor-pointer bg-amber-100 w-12 h-12 rounded-xl items-center justify-center" onclick="window.location.href='tel:9825375672'" role="button">
<svg aria-hidden="true" className="w-[22px] h-[22px]" data-icon="lucide:phone" data-icon-replaced="true" data-width="22" height="22" role="img" strokeWidth="2" style={{strokeWidth: '1.5', width: '22px', height: '22px', color: 'rgb(41, 37, 36)'}} viewbox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233a14 14 0 0 0 6.392 6.384" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
<div className="">
<h3 className="text-base font-medium text-stone-800 mb-1">Phone</h3>
<a className="hover:text-amber-900 transition-colors text-sm text-amber-800 translate-x-3" href="tel:9825375672">9825375672</a>
</div>
</div>
<div className="flex gap-4">
<div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center flex-shrink-0">
<svg aria-hidden="true" data-icon="lucide:clock" data-width="22" height="22" role="img" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M12 6v6l4 2"></path><circle cx="12" cy="12" r="10"></circle></g></svg>
</div>
<div>
<h3 className="text-base font-medium text-stone-800 mb-1">Hours</h3>
<p className="text-sm text-stone-600">Open DailyCloses at 11:30 PM</p>
</div>
</div>
</div>
<div className="flex flex-wrap gap-3 mt-8">
<a className="inline-flex items-center gap-2 hover:bg-amber-900 transition-all text-sm font-medium text-white bg-amber-800 rounded-full pt-2.5 pr-5 pb-2.5 pl-5" href="tel:9825375672">
<svg aria-hidden="true" className="w-[18px] h-[18px]" data-icon="lucide:phone" data-icon-replaced="true" data-width="18" height="18" role="img" strokeWidth="2" style={{strokeWidth: '1.5', width: '18px', height: '18px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233a14 14 0 0 0 6.392 6.384" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
</path>
</svg>
    Call Now
</a>
<a className="inline-flex items-center gap-2 hover:bg-stone-900 transition-all text-sm font-medium text-white bg-stone-800 rounded-full pt-2.5 pr-5 pb-2.5 pl-5" href="https://maps.app.goo.gl/mgK5mDRg8rU6oXhi9?g_st=ac" target="_blank">
<svg aria-hidden="true" data-icon="lucide:navigation" data-width="18" height="18" role="img" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m3 11l19-9l-9 19l-2-8z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                            Get Directions
                        </a>
<a className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium px-5 py-2.5 rounded-full transition-all" href="https://www.swiggy.com" target="_blank">
<svg aria-hidden="true" data-icon="lucide:shopping-bag" data-width="18" height="18" role="img" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M16 10a4 4 0 0 1-8 0M3.103 6.034h17.794"></path><path d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z"></path></g></svg>
                            Order on Swiggy
                        </a>
</div>
...
<iframe allowfullscreen="" className="" height="100%" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://maps.google.com/maps?q=HPCL%20Pump,%20opp.%20Science%20centre,%20City%20Light%20Town,%20Citylight,%20Surat,%20Gujarat%20395007&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=&amp;output=embed" style={{border: '0', minHeight: '300px'}} width="100%"></iframe>
</div>

<div className="sm:left-auto sm:right-4 sm:w-72 bg-white border-stone-100 border rounded-xl pt-5 pr-5 pb-5 pl-5 absolute right-4 bottom-4 left-4 shadow-xl gap-x-2 gap-y-2">
<h3 className="text-base font-medium text-stone-800 mb-2">Reserve a Table</h3>
<a className="inline-flex items-center justify-center gap-2 hover:bg-amber-900 transition-all text-sm font-medium text-white bg-amber-800 w-full rounded-lg pt-2.5 pr-4 pb-2.5 pl-4" href="tel:9825375672">
<svg aria-hidden="true" className="w-[16px] h-[16px]" data-icon="lucide:calendar" data-icon-replaced="true" data-width="16" height="16" role="img" strokeWidth="2" style={{strokeWidth: '1.5', width: '16px', height: '16px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-xs text-stone-500 mb-4">Book your spot for a memorable dining experience</p>
</div>
</div>
</div>
</div>
...
<span className="-translate-y-2 text-2xl font-semibold text-white tracking-tight absolute" style={{fontFamily: '\'Playfair Display\', serif'}}>Fenil restaurant </span>
</a>
<p className="text-sm text-stone-400 mb-4">Brewed for Comfort,<br/>Crafted for Conversations</p>
<div className="flex gap-3 gap-x-3 gap-y-3">
<a className="hover:bg-amber-800 flex items-center justify-center transition-colors -translate-y-3 bg-stone-800 w-10 h-10 rounded-lg translate-x-3 translate-y-1" href="https://www.instagram.com/sarthu___.07?igsh=ZzljZjdweDBueDVk">
<svg aria-hidden="true" className="w-[18px] h-[18px]" data-icon="lucide:instagram" data-icon-replaced="true" data-icon-set="lucide" data-lucide="instagram" data-width="18" fill="none" height="18" role="img" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '18px', height: '18px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="5" ry="5" width="20" x="2" y="2"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
</a>
<a className="hover:bg-amber-800 flex items-center justify-center transition-colors -translate-y-1 bg-stone-800 w-10 h-10 rounded-lg translate-x-4 translate-y-1" href="https://www.facebook.com/share/1KJmGLRefg/">
<svg aria-hidden="true" className="w-[18px] h-[18px]" data-icon="lucide:facebook" data-icon-replaced="true" data-width="18" height="18" role="img" strokeWidth="2" style={{strokeWidth: '1.5', width: '18px', height: '18px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path className="" d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</a>
</div>
</div>
<div className="">
...
<li><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#home">Home</a></li>
<li><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#about">About Us</a></li>
<li className=""><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#menu">Menu</a></li>
<li><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#gallery">Gallery</a></li>
<li><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#reviews">Reviews</a></li>
</ul>
</div>
<div className="">
<h4 className="text-sm font-medium text-white mb-4">Order &amp; Reserve</h4>
<ul className="space-y-2">
<li className=""><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="https://www.swiggy.com" target="_blank">Order on Swiggy</a></li>
<li className=""><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="https://www.zomato.com" target="_blank">Order on Zomato</a></li>
<li className=""><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="tel:07737283668">Book a Table</a></li>
<li className=""><a className="text-sm text-stone-400 hover:text-amber-400 transition-colors" href="#">Download Menu</a></li>
</ul>
</div>
<div className="">
<h4 className="text-sm font-medium text-white mb-4">Contact</h4>
<ul className="space-y-2">
<li className="text-sm text-stone-400">F1, Lambe Hanuman Road</li>
<li className="text-sm text-stone-400">Kiran chowk , kapodra, surat </li>
<li className=""><a className="hover:text-amber-300 transition-colors text-sm text-amber-400" href="/tel:9825375672">9825375672</a></li>
<li className="text-sm text-stone-400">Open till 11:30 PM</li>
</ul>
</div>
</div>
...
<p className="text-xs text-stone-500">© 2024 Fenil Restaurant (FR). All rights reserved.</p>
<p className="text-xs text-stone-500">Made by SHUBH RAJ
</p>
</div>
</div>
</footer>

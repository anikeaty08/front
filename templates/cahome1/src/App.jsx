      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        window.addEventListener('scroll', () => {
          if (window.scrollY > 20) {
            ...
            nav.classList.add('bg-white/50', 'backdrop-
...
<nav className="z-50 md:px-8 lg:px-16 flex w-full border-slate-200/60 border-b pt-4 pr-6 pb-4 pl-6 top-0 items-center justify-between fixed transition-all duration-300">
...
<button className="hover:bg-slate-800 hover:shadow-md transition-all duration-300 text-sm font-medium font-extralight bg-slate-900 text-white rounded-sm pt-2.5 pr-6 pb-2.5 pl-6 shadow-sm shadow-slate-900/10 cursor-pointer whitespace-nowrap" onclick="window.location.href='https://api.leadconnectorhq.com/widget/bookings/circle-aesthetics-appointment'" role="button">
          Book Consultation
        </button>
</div>

      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        window.addEventListener('scroll', () => {
          if (window.scrollY > 20) {
            nav.classList.add('bg-white/85', 'backdrop-blur-lg', 'border-slate-200/60', 'shadow-[0_8px_30px_rgb(0,0,0,0.06)]', 'pt-3', 'pb-3');
            nav.classList.remove('bg-white/20', 'backdrop-blur-md', 'border-white/10', 'pt-4', 'pb-4');
          } else {
            nav.classList.remove('bg-white/85', 'backdrop-blur-lg', 'border-slate-200/60', 'shadow-[0_8px_30px_rgb(0,0,0,0.06)]', 'pt-3', 'pb-3');
            nav.classList.add('bg-white/20', 'backdrop-blur-md', 'border-white/10', 'pt-4', 'pb-4');
          }
        });
...
<nav className="z-50 md:px-8 lg:px-16 flex w-full border-b pr-6 pl-6 top-0 items-center justify-between fixed transition-all duration-500 ease-in-out bg-white/20 backdrop-blur-md border-white/10 pt-4 pb-4">
...
<div className="hidden md:flex gap-5 lg:gap-8 text-sm font-extralight text-slate-500">
<a className="hover:text-[#A9898B] transition-colors font-medium" href="/home">
          Home
        </a>
<a className="hover:text-[#A9898B] transition-colors font-medium" href="/treatments">
          Treatments
        </a>
<a className="hover:text-[#A9898B] transition-colors font-medium" href="/skin-analysis">
          Skin Analysis
        </a>
<a className="hover:text-[#A9898B] transition-colors font-medium" href="/consultant-led">
          Consultant Led
        </a>
<a className="hover:text-[#A9898B] transition-colors font-medium" href="/clinical-technology">
          Technology
        </a>
</div>

<div className="hidden md:flex items-center gap-5 lg:gap-6 shrink-0">
<a className="text-slate-400 hover:text-[#A9898B] transition-colors duration-300 flex items-center justify-center" href="https://www.instagram.com/circleaesthetics.ie/" rel="noopener noreferrer" target="_blank" title="Instagram">
<iconify-icon className="text-[20px]" icon="lucide:instagram" style={{strokeWidth: '1.5px'}}></iconify-icon>
</a>
<a className="flex items-center gap-2 text-sm font-medium font-extralight text-slate-500 hover:text-[#A9898B] transition-colors duration-300" href="tel:012064219">
<iconify-icon className="text-[18px]" icon="solar:phone-linear" style={{strokeWidth: '1.5px'}}></iconify-icon>
          01 206 4219
        </a>
<button className="hover:bg-slate-800 hover:shadow-md transition-all duration-300 shadow-slate-900/10 cursor-pointer whitespace-nowrap text-sm font-medium text-white font-extralight bg-slate-900 rounded-sm pt-2.5 pr-6 pb-2.5 pl-6 shadow-sm" onclick="window.location.href='https://api.leadconnectorhq.com/widget/bookings/circle-aesthetics-appointment'" role="button">
          Book Consultation
        </button>
</div>

<div className="flex items-center gap-3 md:hidden">
<a className="text-slate-400 hover:text-[#A9898B] p-1 flex items-center justify-center transition-colors" href="https://www.instagram.com/circleaesthetics.ie/" rel="noopener noreferrer" target="_blank" title="Instagram">
<iconify-icon className="text-[20px]" icon="lucide:instagram" style={{strokeWidth: '1.5px'}}></iconify-icon>
</a>
<a className="text-slate-400 hover:text-[#A9898B] p-1 flex items-center justify-center transition-colors" href="tel:012064219">
<iconify-icon className="text-[22px]" icon="solar:phone-linear" style={{strokeWidth: '1.5px'}}></iconify-icon>
</a>
<button className="hover:bg-slate-800 transition-all duration-300 text-xs font-medium font-extralight bg-slate-900 text-white rounded-sm pt-2 pr-4 pb-2 pl-4 shadow-sm cursor-pointer whitespace-nowrap" onclick="window.location.href='https://api.leadconnectorhq.com/widget/bookings/circle-aesthetics-appointment'" role="button">
<span className="hidden sm:inline">Book Consultation</span>
<span className="sm:hidden">Book</span>
</button>
<button className="text-slate-800 p-1 -mr-1 focus:outline-none flex items-center justify-center transition-opacity hover:opacity-70" id="mobile-menu-btn">
<iconify-icon className="text-[28px]" icon="solar:hamburger-menu-linear" style={{strokeWidth: '1.5px'}}></iconify-icon>
</button>
</div>
</nav>
...
<p className="leading-relaxed md:text-2xl text-lg font-light text-slate-300 tracking-tight w-full max-w-6xl mb-14 pr-4 pl-4">
          Powered by advanced Sciton TRIBRID laser technology and regenerative
          treatment protocols.
        </p>
<div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
<a className="hover:bg-slate-200 transition-all duration-300 flex justify-center items-center text-sm text-slate-900 font-extralight bg-white border-white border rounded-sm pt-4 pr-8 pb-4 pl-8 shadow-sm" href="https://api.leadconnectorhq.com/widget/bookings/circle-aesthetics-appointment">
            Book Consultation
          </a>
<a className="hover:border-white/20 hover:bg-white/10 transition-all duration-300 flex justify-center items-center gap-2 group text-sm text-white font-extralight bg-white/5 border-white/10 border rounded-sm pt-4 pr-8 pb-4 pl-8 shadow-sm backdrop-blur-sm" href="/treatments">
            Explore Treatments
...
<span className="uppercase text-sm text-slate-800 tracking-[0.2em] font-extralight" style={{fontFamily: '\'JetBrains Mono\', monospace'}}>
                CIRCLE AESTHETICS
              </span>
</div>
<h2 className="md:text-5xl text-4xl text-slate-900 tracking-tight font-extralight">
              The Clinical Treatment Platform
              <span className="block md:mt-5 md:text-xl leading-relaxed text-lg font-light text-slate-600 tracking-normal max-w-2xl mt-4">
                A structured clinical system combining advanced laser technology
                and regenerative therapies to treat, repair, and optimise skin
                at multiple levels.
              </span>
</h2>
</div>
...
<p className="md:text-lg text-base font-light text-slate-600 max-w-2xl mb-4">
          Each component plays a specific role within a personalised treatment
          pathway.
        </p>
...
<span className="uppercase text-xs text-slate-600 tracking-[0.15em] font-extralight bg-slate-50 border-slate-200 border rounded-sm pt-1 pr-2 pb-1 pl-2" style={{fontFamily: '\'JetBrains Mono\', monospace'}}>
                  SCITON TRIBRID PLATFORM
                </span>
<span className="uppercase text-xs text-[#C5A8AA] tracking-[0.15em] font-extralight" style={{fontFamily: '\'JetBrains Mono\', monospace'}}>
                  IN CLINIC
                </span>
</div>
</div>
<div className="relative z-10 mt-auto border-t border-slate-100 pt-8 group-hover:border-[#E3D5D6] transition-colors">
<h3 className="md:text-3xl cursor-pointer text-2xl text-slate-900 hover:text-[#A9898B] transition-colors duration-300 tracking-tight font-extralight mb-3" onclick="window.location.href='/sciton'" role="button">
                Sciton TRIBRID Laser System
              </h3>
<p className="md:text-lg leading-relaxed text-base font-thin text-slate-800 max-w-sm">
                Advanced laser platform combining BBL HEROic, MOXI, and HALO
                TRIBRID for precision skin correction, resurfacing, and
...
<div className="relative z-10 mt-auto border-t border-slate-100 pt-8 group-hover:border-[#E3D5D6] transition-colors">
<h3 className="md:text-3xl cursor-pointer text-2xl text-slate-900 hover:text-[#A9898B] transition-colors duration-300 tracking-tight font-extralight mb-3" onclick="window.location.href='/skin-analysis'" role="button">
                Aura 3D Facial Analysis
              </h3>
<p className="md:text-lg leading-relaxed text-base font-thin text-slate-800 max-w-sm">
                Swiss-engineered 3D imaging technology enabling precise skin
                assessment and personalised, evidence-based treatment planning.
              </p>
</div>
</div>
...
<h3 className="md:text-3xl cursor-pointer text-2xl text-slate-900 hover:text-[#A9898B] transition-colors duration-300 tracking-tight font-extralight mb-3" onclick="window.location.href='/medical-led-therapy'" role="button">
                Photobiomodulation (LED)
              </h3>
<p className="leading-relaxed md:text-lg text-base font-thin text-slate-800 max-w-sm">
                Medical-grade LED therapy designed to accelerate healing, reduce
                inflammation, and optimise results following advanced
                treatments.
              </p>
</div>
</div>
...
<div className="group-hover:border-[#E3D5D6] transition-colors z-10 border-slate-100 border-t mt-auto pt-8 relative">
<h3 className="md:text-3xl cursor-pointer text-2xl text-slate-900 hover:text-[#A9898B] transition-colors duration-300 tracking-tight font-extralight mb-3" onclick="window.location.href='/regenerative-treatments'" role="button">
                Regenerative Therapies
              </h3>
<p className="md:text-lg leading-relaxed text-base font-thin text-slate-800 max-w-sm">
...
<h2 className="md:text-5xl leading-tight text-3xl text-white tracking-tight font-extralight mb-6">
          Begin Your Personalised Skin Treatment Plan
        </h2>
<p className="md:text-xl text-lg font-thin text-slate-400 max-w-xl mr-auto mb-12 ml-auto">
          Book a comprehensive consultation to assess your skin and develop a
          tailored treatment strategy.
        </p>
<button className="hover:text-[#A9898B] hover:bg-white transition-all duration-300 cursor-pointer text-sm text-slate-900 font-extralight bg-white border-white border rounded-sm pt-4 pr-10 pb-4 pl-10 shadow-[0_4px_14px_rgba(255,255,255,0.1)]" onclick="window.location.href='https://api.leadconnectorhq.com/widget/bookings/circle-aesthetics-appointment'" role="button">
          Book Consultation
        </button>
</div>
</section>
...
<li className="">
<a className="hover:text-[#C5A8AA] transition-colors" href="/clinical-technology">
                Technology
              </a>
</li>
<li className="">
<a className="hover:text-[#C5A8AA] transition-colors" href="/skin-analysis">
                Skin Analysis
              </a>
</li>
<li className="">
...
<ul className="space-y-4 text-sm font-extralight">
<li className="">Dublin Ireland</li>
<li className="">
<a className="hover:text-[#C5A8AA] transition-colors" href="mailto:info@circleaesthetics.ie">
                info@circleaesthetics.ie
              </a>
</li>
<li className="pt-2">
<a className="hover:text-[#C5A8AA] transition-colors flex items-center gap-2" href="https://www.instagram.com/circleaesthetics.ie/" rel="noopener noreferrer" target="_blank">
<iconify-icon className="text-base" icon="lucide:instagram"></iconify-icon>
                Instagram
              </a>
</li>
</ul>
...
<a className="hover:text-[#C5A8AA] transition-colors" href="/privacy-policy">
            Privacy Policy
          </a>
<a className="hover:text-[#C5A8AA] transition-colors" href="/terms-of-use">
            Terms of Use
          </a>
</div>
</div>
...
<a className="mobile-link mt-8 text-base font-medium font-extralight bg-slate-900 text-white px-8 py-4 rounded-sm hover:bg-slate-800 shadow-sm w-full max-w-[240px] text-center transition-all duration-300" href="#consultation">
          Book Consultation
        </a>
<div className="flex flex-col items-center gap-4 mt-6">
<a className="mobile-link text-lg font-extralight text-slate-500 hover:text-[#A9898B] flex items-center gap-2 transition-colors duration-300" href="tel:012064219">
<iconify-icon className="text-xl" icon="solar:phone-linear"></iconify-icon>
            01 206 4219
          </a>
<a className="mobile-link text-slate-400 hover:text-[#A9898B] transition-colors duration-300 p-2" href="https://www.instagram.com/circleaesthetics.ie/" target="_blank">
<iconify-icon className="text-2xl" icon="lucide:instagram"></iconify-icon>
</a>
</div>
</div>
</div>

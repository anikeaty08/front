...
<aside className="w-64 bg-white border-r border-gray-100 hidden md:flex flex-col justify-between h-full z-10">
<div className="">
...
<span className="text-slate-900 font-semibold tracking-tight text-sm">OFFERBD</span>
</div>
</div>

<nav className="mt-6 px-3 space-y-1">
<a className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md bg-gray-50 text-slate-900" href="#">
...
<a className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-slate-500 hover:text-slate-900 hover:bg-gray-50 transition-colors" href="#">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:bar-chart-3" data-width="18" height="18" role="img" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v18h18m-3-4V9m-5 8V5M8 17v-3" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                    Analytics
                </a>
<a className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-slate-500 hover:text-slate-900 hover:bg-gray-50 transition-colors" href="#">
...
<button className="flex items-center gap-3 w-full px-3 py-2 text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">
...
<header className="h-16 bg-white/80 backdrop-blur-md sticky top-0 z-20 border-b border-gray-100 flex items-center justify-between px-6 md:px-8">
...
<a className="hover:text-slate-600" href="#">Dashboard</a>
<svg aria-hidden="true" className="iconify mx-2 iconify--lucide" data-icon="lucide:chevron-right" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="m9 18l6-6l-6-6" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
<span className="text-slate-800">Active Campaigns</span>
</nav>
</div>
<div className="flex items-center gap-4">
...
<div className="h-8 w-8 rounded-full bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-200 flex items-center justify-center text-xs font-semibold text-slate-600">
                    AD
                </div>
</div>
</header>

<div className="md:p-8 w-full max-w-7xl mr-auto ml-auto pt-6 pr-6 pb-6 pl-6 space-y-8">

<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
<div className="">
<h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Campaign Overview</h1>
<p className="text-sm text-slate-500 mt-1">Manage discounts and brand partnerships across Bangladesh.</p>
</div>
<div className="flex items-center gap-3">
<button className="px-4 py-2 bg-white border border-gray-200 text-slate-700 text-sm font-medium rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-slate-200 transition-all">
                        Export Data
                    </button>
<button className="px-4 py-2 bg-slate-900 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-all flex items-center gap-2">
...
<div className="">
<p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Total Views</p>
<h3 className="text-2xl font-semibold text-slate-900 mt-2 tracking-tight">2.4M</h3>
</div>
...
<svg aria-hidden="true" className="iconify mr-1 iconify--lucide" data-icon="lucide:trending-up" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M16 7h6v6"></path><path d="m22 7l-8.5 8.5l-5-5L2 17"></path></g></svg>
                            +12.5%
                        </span>
...
<div className="flex justify-between items-start">
<div>
<p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Active Deals</p>
<h3 className="text-2xl font-semibold text-slate-900 mt-2 tracking-tight">142</h3>
</div>
<span className="p-2 bg-emerald-50 text-emerald-600 rounded-lg">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:tag" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"></path><circle cx="7.5" cy="7.5" fill="currentColor" r=".5"></circle></g></svg>
</span>
</div>
<div className="mt-4 flex items-center text-xs">
<span className="text-emerald-600 flex items-center font-medium">
...
<span className="text-slate-400 ml-2">added today</span>
</div>
</div>
<div className="p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
<div className="flex justify-between items-start">
<div>
<p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Avg. Discount</p>
<h3 className="text-2xl font-semibold text-slate-900 mt-2 tracking-tight">25%</h3>
</div>
<span className="p-2 bg-orange-50 text-orange-600 rounded-lg">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:percent" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M19 5L5 19"></path><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></g></svg>
</span>
</div>
<div className="mt-4 flex items-center text-xs">
<span className="text-slate-400">Stable across top categories</span>
</div>
</div>
</div>
...
<h3 className="text-sm font-semibold text-slate-900">Quick Upload</h3>
</div>
<div className="p-6">
...
<div>
<label className="block text-xs font-medium text-slate-700 mb-1.5">Brand Name</label>
<div className="relative">
<span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
<svg aria-hidden="true" className="iconify text-slate-400 iconify--lucide" data-icon="lucide:shopping-bag" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M16 10a4 4 0 0 1-8 0M3.103 6.034h17.794"></path><path d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z"></path></g></svg>
</span>
<input className="pl-10 block w-full rounded-md border-gray-200 bg-gray-50 text-sm focus:border-slate-500 focus:bg-white focus:ring-0 transition-colors py-2 placeholder:text-slate-400 text-slate-900 border shadow-sm" placeholder="e.g. Aarong" type="text"/>
</div>
</div>
<div>
...
<div className="relative">
<span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
<svg aria-hidden="true" className="iconify text-slate-400 iconify--lucide" data-icon="lucide:ticket" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Zm11-4v2m0 10v2m0-8v2" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</span>
<input className="pl-10 block w-full rounded-md border-gray-200 bg-gray-50 text-sm focus:border-slate-500 focus:bg-white focus:ring-0 transition-colors py-2 placeholder:text-slate-400 text-slate-900 border shadow-sm" placeholder="e.g. 50% OFF" type="text"/>
</div>
</div>
</div>
<div>
<label className="block text-xs font-medium text-slate-700 mb-1.5">Campaign Duration</label>
<div className="flex items-center gap-2">
<div className="relative flex-1">
<input className="block w-full rounded-md border-gray-200 bg-gray-50 text-sm focus:border-slate-500 focus:bg-white focus:ring-0 transition-colors py-2 text-slate-600 border shadow-sm px-3" type="date"/>
</div>
...
<label className="block text-xs font-medium text-slate-700 mb-1.5">Brand Logo</label>
<div className="w-full h-32 border-2 border-dashed border-gray-200 rounded-lg flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer group">
<svg aria-hidden="true" className="iconify text-slate-400 group-hover:text-slate-600 transition-colors mb-2 iconify--lucide" data-icon="lucide:upload-cloud" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M12 13v8m-8-6.101A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="m8 17l4-4l4 4"></path></g></svg>
<span className="text-xs text-slate-500 group-hover:text-slate-700">Click to upload or drag here</span>
</div>
</div>
</div>
<div className="mt-4 flex justify-end">
<button className="px-4 py-2 bg-slate-900 text-white text-xs font-medium rounded-md hover:bg-slate-800 transition-colors">Publish Campaign</button>
</div>
</div>
</div>
...
<div className="flex items-center gap-2">
<div className="relative">
<svg aria-hidden="true" className="iconify absolute left-2.5 top-2 text-slate-400 iconify--lucide" data-icon="lucide:search" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="m21 21l-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></g></svg>
<input className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-md bg-gray-50 focus:bg-white focus:border-slate-300 focus:outline-none w-48 transition-all" placeholder="Search brands..." type="text"/>
</div>
<button className="p-1.5 border border-gray-200 rounded-md text-slate-500 hover:bg-gray-50">
...
<input className="rounded border-gray-300 text-slate-900 focus:ring-0 cursor-pointer" type="checkbox"/>
</th>
<th className="px-6 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Brand</th>
...
<th className="px-6 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider text-right">Views</th>
<th className="px-6 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider text-right">Action</th>
</tr>
</thead>
...
<div>
<p className="font-medium text-slate-900">Aarong</p>
...
<div>
<p className="font-medium text-slate-900">Pathao Food</p>
...
<div>
<p className="font-medium text-slate-900">Apex</p>
...
<span className="text-xs font-medium text-slate-700">Ending Soon</span>
</div>
</td>
<td className="px-6 py-4 text-right font-medium text-slate-700 text-xs">
                                    45,330
...
<div>
<p className="font-medium text-slate-900">Daraz Mall</p>
<p className="text-xs text-slate-500">Ecommerce</p>
</div>
</div>
</td>
<td className="px-6 py-4">
...
<td className="px-6 py-4">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-700 font-bold text-xs border border-pink-200">
                                            B
                                        </div>
<div>
<p className="font-medium text-slate-900">bKash</p>
<p className="text-xs text-slate-500">Fintech</p>
</div>
</div>
</td>
<td className="px-6 py-4">
<span className="inline-flex items-center px-2 py-1 rounded-md bg-pink-50 text-pink-700 text-xs font-medium border border-pink-100">
                                        20% CASHBACK
                                    </span>
</td>
<td className="px-6 py-4 text-slate-500 text-xs">
...
<span className="text-xs text-slate-500">Showing <span className="font-medium text-slate-900">1-5</span> of <span className="font-medium text-slate-900">24</span> results</span>
<div className="flex gap-2">
<button className="px-3 py-1 text-xs font-medium text-slate-500 border border-gray-200 rounded-md hover:bg-gray-50 disabled:opacity-50" disabled="">Previous</button>
<button className="px-3 py-1 text-xs font-medium text-slate-900 border border-gray-200 rounded-md hover:bg-gray-50">Next</button>
</div>
</div>
</div>

...
<nav className="pointer-events-auto w-full max-w-[1100px] border shadow-[0_8px_32px_rgba(0,0,0,0.3)] rounded-full transition-all duration-300 opacity-0" id="main-nav" style={{animation: 'fadeInNav 0.6s ease-out forwards'}}>
...
<img alt="FoilWrap Logo" className="md:h-10 lg:h-11 group-hover:scale-105 transition-transform duration-300 w-auto h-8 object-contain drop-shadow-md scale-150" src="https://res.cloudinary.com/detrjtngk/image/upload/v1774261683/FW_logo_new_zelen%C3%A1_web_tlnlod.png"/>
</a>
...
<p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">
                              Prémiové celopolepy v matných i lesklých
                              odstínech.
                            </p>
</div>
</a>
...
<p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">
                              Zatemnění s certifikací pro soukromí a ochranu
                              před UV.
                            </p>
</div>
</a>
...
<section className="relative bg-[#0a0a0a] z-20 border-b border-white/5">
...
<section className="relative py-16 z-20" id="sluzby" style={{background: 'radial-gradient(circle, #8cb314 0%, #507e0c 50%, #1f3603 100%)'}}>
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
...
<p className="leading-relaxed text-sm font-light text-zinc-50 mb-6">
                  Odolné polepy a ochranné vrstvy pro cyklistická kola. Unikátní
                  design a špičková ochrana pro karbonové i hliníkové ráfky.
                </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                  Detail služby
                  <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
...
<img alt="Interiér" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent opacity-90 transition-opacity duration-500 group-hover:opacity-80"></div>
<div className="absolute inset-0 p-8 flex flex-col justify-end z-10">
...
<section className="relative py-24 bg-[#0a0a0a] z-20 overflow-hidden border-t border-white/5">
...
<img alt="Detail polepu" className="w-full h-full object-cover transition-transform duration-[2s] ease-out group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
...
<section className="relative py-12 lg:py-16 bg-[#0a0a0a] overflow-hidden z-20 border-t border-white/5" id="ochrana">
...
<section className="relative py-32 z-20" style={{background: 'radial-gradient(circle, #8cb314 0%, #507e0c 50%, #1f3603 100%)'}}>
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
...
<section className="relative py-32 bg-[#0a0a0a] z-20 border-t border-white/5" id="galerie">
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
...
<section className="relative py-32 bg-[#0a0a0a] overflow-hidden z-20" id="recenze">
...
<section className="relative py-32 overflow-hidden z-20 border-t border-white/5" id="kontakt" style={{background: 'radial-gradient(circle, #8cb314 0%, #507e0c 50%, #1f3603 100%)'}}>
...
<span className="">Odeslat poptávku</span>
...
<p className="text-zinc-600 text-[10px] font-orbitron uppercase tracking-widest">
            © 2024 FoilWrap Praha. Všechna práva vyhrazena.
          </p>

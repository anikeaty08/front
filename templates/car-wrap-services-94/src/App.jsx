      ...
      this.onScroll = () => {
        ...
        if (mainNav) {
          if (winScroll > 50) {
            ...
            if (navInner) { navInner.classList.remove('h-14','md:h-16'); navInner.classList.add('h-12','md:h-14'); }
            navLinks.forEach(l => { l.classList.remove('py-5'); l.classList.add('py-3'); });
          } else {
            ...
            if (navInner) { navInner.classList.add('h-14','md:h-16'); navInner.classList.remove('h-12','md:h-14'); }
            navLinks.forEach(l => { l.classList.add('py-5'); l.classList.remove('py-3'); });
          }
        }
      };
...
<img alt="FoilWrap Logo" className="h-8 md:h-10 lg:h-11 w-auto object-contain group-hover:scale-105 transition-transform duration-300 drop-shadow-md" src="https://res.cloudinary.com/detrjtngk/image/upload/v1774261683/FW_logo_new_zelen%C3%A1_web_tlnlod.png"/>
</a>
<div className="hidden md:flex items-center gap-5 lg:gap-8">
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-white/70 hover:text-[#bbcf1d] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#bbcf1d] after:transition-transform after:duration-300 after:ease-out hover:after:scale-x-100" href="/">Domov</a>
<div className="relative group h-full flex items-center">
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-white/70 group-hover:text-[#bbcf1d] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#bbcf1d] after:transition-transform after:duration-300 after:ease-out group-hover:after:scale-x-100" href="/#sluzby">Služby</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Ochranné fólie" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://images.unsplash.com/photo-1614200187524-dc4b892acf16?auto=format&amp;fit=crop&amp;q=80&amp;w=200"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Ochranné fólie</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Neviditelný PPF štít proti kamínkům a škrábancům.</p></div>
</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Změna barvy vozu" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&amp;fit=crop&amp;q=80&amp;w=200"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Změna barvy vozu</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Prémiové celopolepy v matných i lesklých odstínech.</p></div>
</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Tónování skel" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Tónování skel</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Zatemnění s certifikací pro soukromí a ochranu před UV.</p></div>
</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Dechroming" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Dechroming</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Odstranění chromových prvků pro sportovní "Shadow" look.</p></div>
</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Polepy interiéru" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://images.unsplash.com/photo-1603569283847-aa295f0d016a?auto=format&amp;fit=crop&amp;q=80&amp;w=200"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Polepy interiéru</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Renovace a změna barvy dekorativních lišt ve voze.</p></div>
</a>
...
<div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 border border-[#222222] group-hover/card:border-[#bbcf1d]/50 transition-colors"><img alt="Polepy kol" className="w-full h-full object-cover transition-transform duration-500 group-hover/card:scale-110 filter grayscale group-hover/card:grayscale-0 opacity-80 group-hover/card:opacity-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/></div>
<div><h4 className="font-orbitron font-medium text-sm text-white uppercase tracking-wider mb-1 group-hover/card:text-[#bbcf1d] transition-colors">Polepy kol</h4><p className="text-xs text-[#a0a0a0] font-light leading-relaxed whitespace-normal">Odolné polepy a specifické ochranné vrstvy pro alu kola.</p></div>
</a>
</div>
</div>
</div>
</div>
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-white/70 hover:text-[#bbcf1d] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#bbcf1d] after:transition-transform after:duration-300 after:ease-out hover:after:scale-x-100" href="/galerie">Galerie</a>
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-white/70 hover:text-[#bbcf1d] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#bbcf1d] after:transition-transform after:duration-300 after:ease-out hover:after:scale-x-100" href="/o-nas">O nás</a>
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-white/70 hover:text-[#bbcf1d] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#bbcf1d] after:transition-transform after:duration-300 after:ease-out hover:after:scale-x-100" href="/kontakt">Kontakt</a>
<a className="js-nav-link relative whitespace-nowrap text-[11px] lg:text-xs font-orbitron font-semibold uppercase tracking-[0.2em] text-[#bbcf1d] hover:text-[#d4e34a] transition-colors duration-300 py-5 after:absolute after:bottom-4 after:left-0 after:h-[1px] after:w-full after:origin-left after:scale-x-0 after:bg-[#d4e34a] after:transition-transform after:duration-300 after:ease-out hover:after:scale-x-100" href="/blog">Blog</a>
</div>
</div>
<div className="flex items-center gap-4 flex-1 justify-end">
<button className="md:hidden text-white/70 hover:text-[#bbcf1d] transition-colors"><iconify-icon icon="solar:hamburger-menu-linear" width="28"></iconify-icon></button>
<a className="hidden md:inline-flex items-center gap-2 whitespace-nowrap text-xs font-orbitron font-semibold uppercase tracking-[0.2em] bg-[#bbcf1d] text-[#0a0a0a] px-6 py-2.5 rounded-full hover:bg-[#d4e34a] transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(187,207,29,0.15)] hover:shadow-[0_0_30px_rgba(187,207,29,0.3)]" href="/#kontakt">Nezávazná poptávka</a>
</div>
</div>
</nav>
</header>
...
<section className="relative w-full h-[100svh] overflow-hidden flex items-center shrink-0 bg-[#050505]" id="home">
...
<div style={{opacity: '0', animation: 'blurReveal 1.5s cubic-bezier(0.16, 1, 0.3, 1) forwards'}}>
<div className="flex items-center gap-4 mb-8">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron font-medium tracking-widest text-[#bbcf1d] uppercase">Prémiové Polepy &amp; Ochrana Aut</span>
</div>
<h1 className="font-orbitron font-medium uppercase leading-[1.05] tracking-tighter text-5xl md:text-6xl lg:text-[6.5rem] text-white drop-shadow-2xl">
              Dokonalost v <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#bbcf1d]">každém detailu</span>
</h1>
</div>
<div style={{opacity: '0', animation: 'blurReveal 1.5s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards'}}>
<p className="mt-8 text-base md:text-xl text-zinc-300 font-light max-w-2xl leading-relaxed">
              Realizujeme polepy aut, ochranné PPF fólie, tónování skel i reklamní polepy. Poskytujeme nekompromisní kvalitu a materiály pro váš vůz i byznys.
            </p>
...
<iconify-icon className="text-[#bbcf1d]" icon="solar:shield-check-linear" width="22"></iconify-icon>
              500+ realizací <span className="text-white/20">|</span> 98% spokojenost
            </p>
</div>
</div>
</div>
...
<span className="text-[10px] font-orbitron tracking-widest uppercase text-zinc-500">Scroll</span>
<div className="w-[1px] h-16 bg-gradient-to-b from-zinc-500 to-transparent"></div>
</div>
</section>

<section className="relative bg-[#050505] z-20 border-b border-white/5">
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
<div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10 py-10">
<div className="flex flex-col items-center justify-center text-center reveal-on-scroll py-6 md:py-0">
...
<section className="relative py-16 bg-[#050505] z-20" id="sluzby">
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
<div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 reveal-on-scroll">
<div>
<div className="flex items-center gap-4 mb-6">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron tracking-widest text-[#bbcf1d] uppercase">Služby</span>
</div>
<h2 className="font-orbitron font-medium uppercase tracking-tighter text-4xl md:text-5xl lg:text-6xl text-white">Co pro vás<br/>umíme udělat</h2>
</div>
<p className="text-[#FFFFFF] font-light max-w-md border-l-2 border-white/20 pl-6 text-lg md:text-xl leading-[1.8] drop-shadow-md tracking-wide">
            Fólie aplikujeme na všechny typy povrchů s maximálním důrazem na detail. Proměňte a chraňte svůj vůz.
          </p>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block" href="/zmena-barvy-vozu">
<img alt="Změna barvy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110" src="https://images.unsplash.com/photo-1614200179396-2bdb77ebf81b?q=80&amp;w=1000"/>
...
<iconify-icon className="text-[#bbcf1d] mb-4 transform transition-transform duration-500 group-hover:-translate-y-2" icon="solar:pallete-2-linear" width="32"></iconify-icon>
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Změna barvy (Wrap)</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Stovky prémiových odstínů s hlubokým leskem i dokonalým matem. Změňte vzhled vozu a chraňte originální lak.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
</div>
</a>
...
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Ochranné PPF fólie</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Neviditelný štít, který absorbuje nárazy kamínků a brání vzniku škrábanců. Váš vůz neztratí hodnotu.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
...
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Tónování autoskel</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Maximální soukromí, ochrana před horkem a UV zářením. Homologované fólie s nezaměnitelným puncem luxusu.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block" href="/polepy-kol">
<img alt="Polepy kol" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110" src="https://images.unsplash.com/photo-1511994298241-608e28f14fde?q=80&amp;w=1000"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-[#050505]/60 to-transparent opacity-90 transition-opacity duration-500 group-hover:opacity-80"></div>
<div className="absolute inset-0 p-8 flex flex-col justify-end z-10">
...
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Polepy kol</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Odolné polepy a ochranné vrstvy pro cyklistická kola. Unikátní design a špičková ochrana pro karbonové i hliníkové ráfky.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
...
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Interiérové fólie</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Renovace dekorativních lišt vozu. Luxusní vzhled dřeva, mramoru či karbonu k nerozeznání od originálu.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
...
<h3 className="font-orbitron font-medium text-2xl uppercase tracking-tight text-white mb-3">Dechroming</h3>
<p className="text-zinc-400 font-light text-sm leading-relaxed mb-6">
                Zbavte se rušivého chromu. Aplikujeme černé lesklé nebo matné detaily pro čistý, sportovní Shadow look.
              </p>
<span className="inline-flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest text-white group-hover:text-[#bbcf1d] transition-colors mt-auto">
                Detail služby <iconify-icon className="transform group-hover:translate-x-2 transition-transform duration-500" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</span>
...
<section className="relative py-24 bg-[#050505] z-20 overflow-hidden border-t border-white/5">
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-base md:text-lg mb-2 tracking-wide text-white">Nekompromisní kvalita</h4>
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-base md:text-lg mb-2 tracking-wide text-white">Individuální přístup na míru</h4>
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-base md:text-lg mb-2 tracking-wide text-white">Garance špičkové práce</h4>
<p className="text-sm md:text-base text-zinc-400 font-light leading-relaxed">Náš tým prochází pravidelnými školeními a na provedenou instalaci poskytujeme nadstandardní záruky.</p>
</div>
</li>
</ul>
</div>
...
<section className="relative py-12 lg:py-16 bg-[#050505] overflow-hidden z-20 border-t border-white/5" id="ochrana">
...
<iconify-icon className="text-[#bbcf1d]" icon="solar:shield-star-linear" width="16"></iconify-icon> Nejvyšší Ochrana Laku
            </span>
<h2 className="font-orbitron font-semibold uppercase tracking-tighter text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-[1.05] drop-shadow-md">
              Neviditelný štít<br/>pro váš vůz
            </h2>
<p className="text-zinc-400 font-light leading-relaxed mb-8 text-base md:text-lg">
              Chraňte originální lak před škrábanci, odletujícími kamínky a agresivním UV zářením. Naše špičková transparentní PPF fólie absorbuje nárazy, uchovává hodnotu vozu a dodává mu nepřekonatelný lesk.
            </p>
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-sm mb-1 tracking-wide text-white">Samoregenerační povrch</h4>
<p className="text-sm text-zinc-500 font-light leading-relaxed">Drobné škrábance se na slunci nebo působením tepla samy zacelí.</p>
</div>
</li>
<li className="flex items-start gap-6 group">
<div className="w-10 h-10 rounded-full border border-[#bbcf1d]/30 bg-[#bbcf1d]/10 shadow-[0_0_20px_rgba(187,207,29,0.25)] flex items-center justify-center shrink-0 text-[#bbcf1d] group-hover:bg-[#bbcf1d] group-hover:text-black transition-all duration-500">
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-sm mb-1 tracking-wide text-white">Absolutní neviditelnost</h4>
<p className="text-sm text-zinc-500 font-light leading-relaxed">Křišťálově čistý materiál, který nemění odstín laku, ale prohlubuje jeho lesk.</p>
</div>
</li>
<li className="flex items-start gap-6 group">
<div className="w-10 h-10 rounded-full border border-[#bbcf1d]/30 bg-[#bbcf1d]/10 shadow-[0_0_20px_rgba(187,207,29,0.25)] flex items-center justify-center shrink-0 text-[#bbcf1d] group-hover:bg-[#bbcf1d] group-hover:text-black transition-all duration-500">
...
<div>
<h4 className="font-orbitron font-semibold uppercase text-sm mb-1 tracking-wide text-white">Dlouhodobá trvanlivost</h4>
<p className="text-sm text-zinc-500 font-light leading-relaxed">Záruka ochrany před poškozením a žloutnutím na dlouhá léta dopředu.</p>
</div>
</li>
</ul>
...
<span className="font-orbitron text-[10px] uppercase tracking-widest text-white">Instalace PPF na luxusní vůz</span>
</div>
</div>
</div>
</div>
...
<section className="relative py-32 bg-[#050505] z-20">
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
<div className="flex flex-col items-center text-center mb-20 reveal-on-scroll">
<div className="flex items-center gap-4 mb-6">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron tracking-widest text-[#bbcf1d] uppercase">Jak pracujeme</span>
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
</div>
<h2 className="font-orbitron font-medium uppercase tracking-tighter text-4xl md:text-5xl text-white">Proces k dokonalosti</h2>
</div>
...
<span className="font-orbitron font-medium text-2xl text-white group-hover:text-[#bbcf1d] transition-colors">01</span>
</div>
<h3 className="font-orbitron font-medium text-lg text-white uppercase tracking-tight mb-3">Konzultace</h3>
...
<h3 className="font-orbitron font-medium text-lg text-white uppercase tracking-tight mb-3">Návrh</h3>
...
<h3 className="font-orbitron font-medium text-lg text-white uppercase tracking-tight mb-3">Realizace</h3>
...
<h3 className="font-orbitron font-medium text-lg text-white uppercase tracking-tight mb-3">Předání</h3>
<p className="text-zinc-500 font-light text-sm">Finální kontrola kvality, seznámení s údržbou a předání vašeho "nového" vozu.</p>
</div>
</div>
</div>
</section>

<section className="relative py-32 bg-[#050505] z-20 border-t border-white/5" id="galerie">
<div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
<div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 reveal-on-scroll">
<div>
<div className="flex items-center gap-4 mb-6">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron tracking-widest text-[#bbcf1d] uppercase">Showroom</span>
</div>
<h2 className="font-orbitron font-medium uppercase tracking-tighter text-4xl md:text-5xl lg:text-6xl text-white">Naše realizace</h2>
</div>
<a className="hidden md:inline-flex text-xs font-orbitron uppercase tracking-widest text-zinc-400 hover:text-white transition-colors gap-2 items-center pb-2 border-b border-white/10 hover:border-white" href="/galerie">
            Otevřít celou galerii <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
</a>
</div>
...
<span className="text-[10px] uppercase block text-[#bbcf1d] tracking-widest font-orbitron mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-700">PPF ochrana</span>
<h3 className="text-2xl font-medium tracking-tight font-orbitron text-white">BMW M3 Competition</h3>
</div>
</div>
</div>
...
<div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500"></div>
<div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-700 cubic-bezier(0.16, 1, 0.3, 1)">
<span className="text-[10px] uppercase block text-[#bbcf1d] tracking-widest font-orbitron mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-700">Změna barvy</span>
<h3 className="text-2xl font-medium tracking-tight font-orbitron text-white">Mercedes A35 AMG</h3>
</div>
</div>
</div>
...
<div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500"></div>
<div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-700 cubic-bezier(0.16, 1, 0.3, 1)">
<span className="text-[10px] uppercase block text-[#bbcf1d] tracking-widest font-orbitron mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-700">Tónování Skel</span>
<h3 className="text-2xl font-medium tracking-tight font-orbitron text-white">Tesla Model 3</h3>
</div>
</div>
</div>
</div>
...
<section className="relative py-32 bg-[#050505] overflow-hidden z-20" id="recenze">
...
<div className="flex items-center gap-4 mb-6">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron tracking-widest text-[#bbcf1d] uppercase">Zkušenosti klientů</span>
</div>
<h2 className="font-orbitron font-medium uppercase tracking-tighter text-4xl md:text-5xl text-white">Nekompromisní hodnocení</h2>
</div>
...
<span className="font-orbitron font-semibold text-white tracking-tight leading-none text-lg">4,9 <span className="text-[#bbcf1d] text-base">★</span> <span className="text-zinc-500 text-sm font-light">/ 5 ★</span></span>
<span className="text-[9px] font-inter uppercase tracking-widest text-zinc-500 mt-1">Google Hodnocení</span>
</div>
</div>
<a className="mt-4 flex items-center gap-2 text-[10px] md:text-xs font-orbitron uppercase tracking-widest text-zinc-400 hover:text-[#bbcf1d] transition-colors group" href="https://www.google.com/search?sa=X&amp;sca_esv=539c00fc8c0dc83a&amp;sxsrf=ANbL-n4NKroEuWUi98YUkhUuyRdZazO5Lg:1774293704046&amp;q=FoilWrap+Recenze&amp;rflfq=1&amp;num=20&amp;stick=H4sIAAAAAAAAAONgkxI2MTMzMzUzNzMyNzI1MDIzNDYw3sDI-IpRwC0_Mye8KLFAISg1OTWvKnURK4YQAIPuEqlAAAAA&amp;rldimm=4666567627250261303&amp;tbm=lcl&amp;hl=cs-CZ&amp;ved=2ahUKEwjmyNOP37aTAxU887sIHelaApsQ9fQKegQIShAG&amp;biw=1912&amp;bih=948&amp;dpr=1#lkt=LocalPoiReviews" rel="noopener noreferrer" target="_blank">
              Zobrazit všechny recenze <iconify-icon className="transform group-hover:translate-x-1 transition-transform" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</a>
</div>
</div>
</div>
...
<p className="text-zinc-300 font-light leading-relaxed mb-10 text-lg flex-1">
              "Perfektní práce, auto vypadá jako naprosto nové. Skvělá domluva a dodržení všech termínů. Prvotřídní přístup od A do Z."
            </p>
<div className="flex items-center gap-4 mt-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white font-orbitron font-semibold text-sm">MN</div>
<div>
<h4 className="font-orbitron font-semibold text-xs text-white uppercase tracking-widest mb-1">Martin Novák</h4>
<span className="text-[10px] text-zinc-500 font-inter uppercase tracking-widest">Ověřený klient</span>
</div>
</div>
</div>
...
<p className="text-zinc-300 font-light leading-relaxed mb-10 text-lg flex-1">
              "Nechal jsem aplikovat PPF na předek vozu. Křišťálově čistá práce, okraje perfektně zahnuté. Doporučuji všem s luxusními vozy."
            </p>
<div className="flex items-center gap-4 mt-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white font-orbitron font-semibold text-sm">TD</div>
<div>
<h4 className="font-orbitron font-semibold text-xs text-white uppercase tracking-widest mb-1">Tomáš Dvořák</h4>
<span className="text-[10px] text-zinc-500 font-inter uppercase tracking-widest">Ověřený klient</span>
</div>
</div>
</div>
...
<p className="text-zinc-300 font-light leading-relaxed mb-10 text-lg flex-1">
              "Tónování skel i dechroming proběhly přesně podle mých představ. Komunikace na jedničku, auto vypadá mnohem agresivněji."
            </p>
<div className="flex items-center gap-4 mt-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white font-orbitron font-semibold text-sm">LK</div>
<div>
<h4 className="font-orbitron font-semibold text-xs text-white uppercase tracking-widest mb-1">Lukáš Král</h4>
<span className="text-[10px] text-zinc-500 font-inter uppercase tracking-widest">Ověřený klient</span>
</div>
</div>
</div>
...
<section className="relative py-32 bg-[#050505] overflow-hidden z-20 border-t border-white/5" id="kontakt">
...
<div className="flex items-center gap-4 mb-6">
<span className="w-12 h-[1px] bg-[#bbcf1d]"></span>
<span className="text-xs font-orbitron tracking-widest text-[#bbcf1d] uppercase">Zajistěte si termín</span>
</div>
<h2 className="font-orbitron font-medium uppercase tracking-tighter text-5xl md:text-6xl text-white mb-8 leading-[1.1]">
              Změňte svůj vůz k <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#bbcf1d] to-[#d4e34a]">nepoznání.</span>
</h2>
<p className="text-zinc-300 font-light leading-relaxed mb-10 text-lg">
              Termíny se rychle plní. Máte-li zájem o prvotřídní polep či PPF fólii, vyplňte formulář a rezervujte si svůj čas v našem studiu.
            </p>
...
<div className="pt-1">
<h4 className="font-orbitron font-medium text-[10px] text-zinc-500 uppercase tracking-widest mb-1">Naše studio</h4>
<p className="text-sm text-white font-light">Na Šilbochu 2392/2, Praha 8</p>
</div>
</div>
<div className="flex items-start gap-6">
<div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center shrink-0 text-white">
...
<div className="pt-1">
<h4 className="font-orbitron font-medium text-[10px] text-zinc-500 uppercase tracking-widest mb-1">Telefon</h4>
<a className="text-sm text-white font-light hover:text-[#bbcf1d] transition-colors block" href="tel:+420608002608">+420 608 002 608</a>
</div>
</div>
<div className="flex items-start gap-6">
<div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center shrink-0 text-white">
...
<div className="pt-1">
<h4 className="font-orbitron font-medium text-[10px] text-zinc-500 uppercase tracking-widest mb-1">E-mail</h4>
<a className="text-sm text-white font-light hover:text-[#bbcf1d] transition-colors block" href="mailto:obchod@foilwrap.cz">obchod@foilwrap.cz</a>
</div>
</div>
</div>
</div>
...
<label className="font-orbitron text-[10px] uppercase tracking-widest text-zinc-500 pl-1" htmlFor="name">Jméno a příjmení</label>
<input className="form-input bg-transparent border-t-0 border-x-0 border-b-white/10 rounded-none px-1 py-3 focus:border-b-[#bbcf1d] focus:bg-transparent focus:shadow-none transition-colors" id="name" name="name" placeholder="Jan Novák" required="" type="text"/>
</div>
<div className="space-y-3">
<label className="font-orbitron text-[10px] uppercase tracking-widest text-zinc-500 pl-1" htmlFor="phone">Telefonní číslo</label>
<input className="form-input bg-transparent border-t-0 border-x-0 border-b-white/10 rounded-none px-1 py-3 focus:border-b-[#bbcf1d] focus:bg-transparent focus:shadow-none transition-colors" id="phone" name="phone" placeholder="+420 123 456 789" required="" type="tel"/>
</div>
</div>
<div className="space-y-3">
<label className="font-orbitron text-[10px] uppercase tracking-widest text-zinc-500 pl-1" htmlFor="email">E-mailová adresa</label>
<input className="form-input bg-transparent border-t-0 border-x-0 border-b-white/10 rounded-none px-1 py-3 focus:border-b-[#bbcf1d] focus:bg-transparent focus:shadow-none transition-colors" id="email" name="email" placeholder="jan.novak@email.cz" required="" type="email"/>
</div>
<div className="space-y-3">
<label className="font-orbitron text-[10px] uppercase tracking-widest text-zinc-500 pl-1" htmlFor="service">Zvolte službu</label>
<div className="relative">
<select className="form-input bg-transparent border-t-0 border-x-0 border-b-white/10 rounded-none px-1 py-3 focus:border-b-[#bbcf1d] focus:bg-transparent focus:shadow-none transition-colors appearance-none relative z-10" id="service" name="service" required="">
<option disabled="" selected="" value="">Vyberte z možností</option>
<option value="wrap">Kompletní polep vozu (Wrap)</option>
<option value="ppf">Ochranná PPF fólie</option>
<option value="tinting">Tónování autoskel</option>
<option value="commercial">Reklamní polep</option>
<option value="dechroming">Dechroming</option>
<option value="interior">Polep interiéru</option>
<option value="other">Jiná služba / Nevím</option>
</select>
...
<div className="space-y-3">
<label className="font-orbitron text-[10px] uppercase tracking-widest text-zinc-500 pl-1" htmlFor="message">Značka vozu / Vaše představa</label>
<textarea className="form-input resize-none bg-transparent border-t-0 border-x-0 border-b-white/10 rounded-none px-1 py-3 focus:border-b-[#bbcf1d] focus:bg-transparent focus:shadow-none transition-colors" id="message" name="message" placeholder="Např. BMW M3, chci matný PPF..." required="" rows="3"></textarea>
</div>
<div className="pt-6">
...
<iconify-icon icon="solar:lock-password-linear"></iconify-icon> Bezpečná komunikace
                </p>
</div>
</form>
</div>
...
<p className="text-zinc-500 font-light text-sm max-w-sm mb-8 leading-relaxed">
            Prémiové polepy aut a ochranné fólie. Bezkompromisní kvalita pro ty, kteří vyžadují dokonalost.
          </p>
...
<div>
<h4 className="font-orbitron font-medium text-[10px] text-zinc-600 uppercase tracking-widest mb-6">Služby</h4>
<ul className="space-y-4">
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/zmena-barvy-vozu">Změna barvy (Wrap)</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/ochranne-folie">Ochranné PPF fólie</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/tonovani-skel">Tónování autoskel</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/reklamni-polepy">Reklamní polepy</a></li>
</ul>
</div>
<div>
<h4 className="font-orbitron font-medium text-[10px] text-zinc-600 uppercase tracking-widest mb-6">Navigace</h4>
<ul className="space-y-4">
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/">Domov</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/o-nas">O nás</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/galerie">Showroom</a></li>
<li><a className="text-zinc-400 hover:text-white transition-colors text-sm font-light" href="/kontakt">Kontakt</a></li>
</ul>
</div>
</div>
<div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
<p className="text-zinc-600 text-[10px] font-orbitron uppercase tracking-widest">© 2024 FoilWrap Praha. Všechna práva vyhrazena.</p>
<div className="flex gap-6">
<a className="text-zinc-600 hover:text-white text-[10px] font-orbitron uppercase tracking-widest transition-colors" href="/ochrana-osobnich-udaju">Soukromí</a>
<a className="text-zinc-600 hover:text-white text-[10px] font-orbitron uppercase tracking-widest transition-colors" href="/obchodni-podminky">Podmínky</a>
</div>
</div>
</div>
</footer>

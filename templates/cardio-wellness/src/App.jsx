...
gtag('config', 'G-2M6V79H761');
        ...
        function toggleFaq(button) {
            ...
            // Close all others (optional, but good for clean UI)
...
<a className="btn-primary w-full py-4 rounded-2xl flex items-center justify-center gap-2 font-medium text-base" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
<iconify-icon icon="solar:cart-large-2-linear" strokeWidth="1.5" width="20"></iconify-icon>
            Επίσημη Προσφορά
        </a>
</div>

<a className="fixed bottom-8 right-8 z-50 hidden md:flex btn-primary py-4 px-6 rounded-full items-center gap-2 font-medium text-sm group" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="btn-primary py-4 px-8 rounded-2xl flex justify-center items-center gap-2 font-medium text-base text-center w-full sm:w-auto" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="btn-primary py-4 px-8 rounded-2xl flex items-center gap-2 font-medium text-base w-full sm:w-auto justify-center" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="btn-secondary py-3 px-8 rounded-full flex items-center gap-2 font-medium text-sm" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="btn-primary py-3 px-8 rounded-full inline-flex items-center gap-2 font-medium text-sm" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="mt-2 text-teal-600 font-medium text-sm flex items-center gap-1 hover:text-teal-700 transition-colors w-fit group" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
...
<a className="btn-primary py-3 px-8 rounded-2xl flex items-center justify-center gap-2 font-medium text-sm w-fit mt-4" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
                        Δείτε την Επίσημη Προσφορά
                    </a>
</div>
</div>
...
<a className="btn-primary mt-4 py-4 px-8 rounded-full font-medium text-base flex items-center gap-2 shadow-lg shadow-amber-500/20 w-full sm:w-auto justify-center" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">
                        Άνοιγμα Επίσημης Προσφοράς
...
<a className="btn-primary mt-4 py-5 px-10 rounded-full font-medium text-lg flex items-center justify-center gap-3 w-full sm:w-auto shadow-[0_0_40px_rgba(245,158,11,0.3)]" href="https://uhf66a7c60uh.uewhbgfvds.cc/?target=-7EBNQCgQAAAep9wQDy5AABQEBEREKEQkKEQ1CEQ0SAAF_YWRjb21ibwEx&amp;al=99861&amp;ap=-1" rel="noopener noreferrer" target="_blank">

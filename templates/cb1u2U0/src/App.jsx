...
<p className="text-gray-500 text-sm">Improve your mental health</p>
</div>
<button className="rounded-full p-2 bg-white shadow-md">
<svg className="h-6 w-6" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<h2 className="font-bold text-lg">Uneasy sleeping</h2>
</div>
<p className="text-gray-400 text-xs mb-2">May 2025</p>
<div className="flex items-center space-x-2">
...
<div className="w-28 h-16 flex items-end">
<div className="h-[10%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
<div className="h-[20%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
<div className="h-[15%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
<div className="h-[25%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
<div className="h-[20%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
<div className="h-[30%] w-3 bg-purple-300 rounded-t-sm mx-0.5"></div>
</div>
</div>
</div>
...
<h2 className="font-bold text-lg">Depression</h2>
</div>
<p className="text-gray-400 text-xs mb-2">May 2025</p>
<div className="flex items-center space-x-2">
...
<div className="w-28 h-16 flex items-end">
<div className="h-[5%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
<div className="h-[15%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
<div className="h-[10%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
<div className="h-[20%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
<div className="h-[15%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
<div className="h-[25%] w-3 bg-gray-300 rounded-t-sm mx-0.5"></div>
</div>
</div>
</div>
</div>

...
<h1 className="md:text-5xl uppercase text-4xl font-semibold text-slate-950 tracking-tighter font-display mb-4">Terms
        and Conditions</h1>
<p className="uppercase text-sm font-medium text-[#E85424] tracking-wider">Effective Date: May 2026</p>
</div>
<div className="space-y-12 text-[#000000]/80 leading-relaxed text-base sm:text-lg">

<div className="">
<p className="mb-4">These Terms and Conditions (“Terms”) govern your use of the Rollicious Vietnamese website and
          services. By accessing or using our website, you agree to comply with these Terms.</p>
<p className="">If you do not agree, you should not use our website or services.</p>
</div>

<div className="">
<h2 className="text-2xl font-semibold text-slate-950 font-display tracking-tight uppercase mb-4">1. About Us</h2>
<p className="">Rollicious Vietnamese (“we”, “our”, “us”) is a Christchurch-based food business offering Vietnamese
          food products and services, including online ordering.</p>
</div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">2. Use of Website
        </h2>
<p className="">You agree to use this website:</p>
<span className="block mt-4 mb-6 space-y-3 pl-2">
<span className="flex items-start gap-3"><span className="select-none">•</span><span>For lawful purposes only</span></span>
<span className="flex items-start gap-3"><span className="select-none">•</span><span className="">In a way that does not infringe the rights of others</span></span>
<span className="flex items-start gap-3"><span className="select-none">•</span><span>Without attempting to disrupt or damage the website</span></span>
</span>
<p className="">We reserve the right to restrict or terminate access if misuse is detected.</p>
</div>

<div className="">
<h2 className="text-2xl font-semibold text-slate-950 font-display tracking-tight uppercase mb-4">3. Orders and
          Payments</h2>
<div className="mb-8">
<h3 className="text-xl font-semibold text-slate-950 font-display tracking-tight mb-3">3.1 Placing Orders</h3>
<p className="">All orders placed through our website are subject to acceptance and availability.</p>
<p className="mt-4">We reserve the right to:</p>
<span className="block mt-4 space-y-3 pl-2">
<span className="flex items-start gap-3"><span className="select-none">•</span><span>Refuse or cancel any order</span></span>
<span className="flex items-start gap-3"><span className="select-none">•</span><span>Limit quantities</span></span>
<span className="flex items-start gap-3"><span className="select-none">•</span><span>Correct pricing or product errors</span></span>
</span>
</div>
<div className="mb-8">
<h3 className="text-xl font-semibold text-slate-950 font-display tracking-tight mb-3">3.2 Pricing</h3>
<p className="mb-4">All prices are listed in
            <span className="font-semibold text-slate-950">New Zealand Dollars (NZD)</span> and include GST unless stated
            otherwise.</p>
<p className="">Prices may change at any time without notice.</p>
</div>
<div className="">
<h3 className="text-xl font-semibold text-slate-950 font-display tracking-tight mb-3">3.3 Payment</h3>
<p className="">Payment must be made at the time of ordering via our accepted payment methods. We use secure
            third-party payment gateways; we do not store your credit card details.</p>
</div>
</div>

<div className="">
<h2 className="text-2xl font-semibold text-slate-950 font-display tracking-tight uppercase mb-4">4. Cancellations
          and Refunds</h2>
<span className="block space-y-3 pl-2">
<span className="flex items-start gap-3"><span className="select-none">•</span><span>Orders cannot be cancelled once preparation has begun.</span></span>
<span className="flex items-start gap-3"><span className="select-none">•</span><span>If there is an issue with your order (e.g., incorrect or damaged items), please contact us immediately upon receipt. Refunds or replacements are issued at our sole discretion.</span></span>
</span>
</div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">5. Intellectual
          Property</h2>
<p className="">All content on this website (logos, text, images, etc.) is the property of Rollicious Vietnamese or
          its licensors. You may not reproduce, distribute, or use this content without prior written permission.</p>
</div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">6. Limitation of
          Liability</h2>
<p className="">To the maximum extent permitted by New Zealand law, Rollicious Vietnamese will not be liable for any
          indirect, incidental, or consequential damages arising from your use of the website or our services.</p>
</div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">7. Governing Law
        </h2>
<p className="">These Terms are governed by the laws of New Zealand. Any disputes will be subject to the exclusive
          jurisdiction of New Zealand courts.</p>
</div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">8. Changes to Terms
        </h2>
<p className="">We may update these Terms periodically. Continued use of the website after changes constitutes
          acceptance of the new Terms.</p>
</div>
<div className="border-b border-gray-100"></div>

<div className="">
<h2 className="uppercase text-2xl font-semibold text-slate-950 tracking-tight font-display mb-4">9. Contact Us</h2>
<p className="mb-6">For questions or concerns regarding these Terms, contact us at:</p>
...
<div className="flex flex-col sm:flex-row uppercase text-xs text-[#E85424] tracking-widest border-white/10 border-t pt-8 gap-x-4 gap-y-4 items-center justify-between cursor-pointer" onclick="window.location.href='/terms-page'" role="button">

...
<path d="M4 6v6c0 2.21 3.582 4 8 4s8-1.79 8-4V6c0 2.21-3.582 4-8 4S4 8.21 4 6" fill="#ffffff" opacity=".7"></path>
</svg>
</div>
</div>
...
<a className="px-4 py-1.5 text-sm font-medium text-zinc-400 hover:text-white transition-colors" href="#services">
            Services
          </a>
<a className="px-4 py-1.5 text-sm font-medium text-zinc-400 hover:text-white transition-colors" href="#results">
            Results
          </a>
<a className="px-4 py-1.5 text-sm font-medium text-zinc-400 hover:text-white transition-colors" href="#process">
            Process
          </a>
<a className="px-4 py-1.5 text-sm font-medium text-zinc-400 hover:text-white transition-colors" href="#faq">
            FAQ
          </a>
</div>
...
<div className="flex-1 flex flex-col md:flex-row h-full z-20 relative">
...
<div className="pointer-events-auto md:mx-0 max-w-xl mr-auto ml-auto">
...
<span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse shadow-[0_0_8px_rgba(56,189,248,0.8)]"></span>
              AI AUTOMATION &amp; DATA AGENCY
            </div>

<h1 className="leading-[0.95] text-6xl font-normal text-white tracking-tight font-serif-custom mb-8 drop-shadow-2xl sm:text-6xl md:leading-[0.9] md:mb-8 md:text-5xl lg:text-6xl">
              Your manual processes are costing you time and money.
...
<p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-zinc-400 mb-8 md:mb-12 max-w-md font-light">
              LeSage Digital designs intelligent systems that work for you 24/7:
              automated workflows, AI agents, data extraction. You save hours
              every week, and your teams focus on what matters most.
            </p>
...
<span className="w-5 h-5 rounded flex items-center justify-center bg-zinc-800 text-[10px] font-bold text-zinc-400">
                    03
                  </span>
...
<h2 className="text-3xl font-normal text-white tracking-tight font-serif-custom mb-6 md:text-6xl">
              While you're reading this, your
...
<p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed">
              Copying and pasting data between tools. Manually following up with
              prospects. Answering the same questions over and over again. These
              repetitive tasks eat away at your time — and your teams' time. In
              2026, automation is a competitive advantage accessible to
              everyone.
            </p>
</div>
...
<svg className="lucide lucide-clock w-7 h-7 text-zinc-400" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-zinc-400 font-light mb-12 text-base leading-relaxed">
                  Slow, error-prone, and boring. Your team wastes 20% of their
                  week on low-value tasks.
                </p>
...
<path className="opacity-50" d="M0 12 C 16 12, 16 24, 32 24" stroke-dasharray="3 3"></path>
<path className="opacity-50" d="M0 36 C 16 36, 16 24, 32 24" stroke-dasharray="3 3"></path>
</svg>
...
<svg className="w-8 h-12 text-zinc-600" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 32 48">
<path className="opacity-50" d="M0 24 C 16 24, 16 12, 32 12" stroke-dasharray="3 3"></path>
<path className="opacity-50" d="M0 24 C 16 24, 16 36, 32 36" stroke-dasharray="3 3"></path>
</svg>
...
<span className="px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-[10px] shadow-[0_0_15px_rgba(99,102,241,0.2)] backdrop-blur-sm transform -rotate-2 hover:scale-105 transition-transform cursor-default select-none">
                      Latency High
                    </span>
<span className="px-3 py-1 rounded-full bg-sky-500/10 border border-sky-500/30 text-sky-300 text-[10px] shadow-[0_0_15px_rgba(14,165,233,0.2)] backdrop-blur-sm transform rotate-3 hover:scale-105 transition-transform cursor-default select-none">
                      API Timeout
                    </span>
<span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-300 text-[10px] shadow-[0_0_15px_rgba(168,85,247,0.2)] backdrop-blur-sm transform -translate-y-2 hover:scale-105 transition-transform cursor-default select-none">
                      DB Lock
                    </span>
</div>
</div>
...
<svg className="lucide lucide-zap w-7 h-7 text-sky-400" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path>
</svg>
                  Competitive Advantage
                </h3>
<p className="text-zinc-400 font-light mb-12 text-base leading-relaxed">
                  Scalable, instant, and reliable. Systems that work 24/7
                  without complaining.
                </p>

<div className="mt-auto w-full bg-[#0A0A0A] rounded-xl border border-white/10 p-6 shadow-2xl relative overflow-hidden group-hover:shadow-blue-500/10 transition-shadow duration-500">
...
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-zinc-800 text-zinc-400 border border-white/5">
                        4 active
                      </span>
</div>
...
<div className="space-y-3 font-mono text-xs z-10 relative">

<div className="flex items-center gap-3">
<div className="w-12 text-right text-zinc-500">Where</div>
<div className="flex-1 px-3 py-2 rounded bg-[#111] border border-white/10 text-blue-400">
                        region
                      </div>
<div className="w-8 py-2 rounded bg-[#111] border border-white/10 text-center text-zinc-400">
                        =
                      </div>
<div className="w-24 px-3 py-2 rounded bg-[#111] border border-white/10 text-white">
                        us-east-1
                      </div>
<button className="text-zinc-600 hover:text-white">
<svg aria-hidden="true" data-icon="solar:menu-dots-bold" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-3">
<div className="w-12 text-right text-zinc-500">And</div>
<div className="flex-1 px-3 py-2 rounded bg-[#111] border border-white/10 text-blue-400">
                        latency
                      </div>
<div className="w-8 py-2 rounded bg-[#111] border border-white/10 text-center text-zinc-400">
...
<div className="w-24 px-3 py-2 rounded bg-[#111] border border-white/10 text-emerald-400">
                        500ms
                      </div>
<button className="text-zinc-600 hover:text-white">
<svg aria-hidden="true" data-icon="solar:menu-dots-bold" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="absolute left-[1.6rem] -top-3 bottom-1/2 w-px border-l border-zinc-800"></div>

<div className="absolute left-[1.6rem] top-1/2 w-3 border-t border-zinc-800"></div>
<div className="text-[10px] font-bold text-zinc-600 uppercase tracking-wider ml-8">
                        OR GROUP
                      </div>
</div>
...
<div className="absolute left-[1.6rem] -top-6 bottom-1/2 w-px border-l border-zinc-800"></div>
<div className="absolute left-[1.6rem] top-1/2 w-3 border-t border-zinc-800"></div>
<div className="w-12 text-right text-zinc-500">Where</div>
<div className="flex-1 px-3 py-2 rounded bg-[#111] border border-white/10 text-blue-400">
                        status
                      </div>
<div className="w-10 py-2 rounded bg-[#111] border border-white/10 text-center text-zinc-400">
                        in
                      </div>
<div className="w-28 px-3 py-2 rounded bg-[#111] border border-white/10 text-orange-400">
                        [500, 502]
                      </div>
<button className="text-zinc-600 hover:text-white opacity-0 pointer-events-none">
<svg aria-hidden="true" data-icon="solar:menu-dots-bold" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
<path d="M7 12a2 2 0 1 1-4 0a2 2 0 0 1 4 0m7 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0m7 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0" fill="currentColor"></path>
</svg>
</button>
...
<div className="absolute -right-10 -bottom-10 w-40 h-40 bg-blue-500/10 rounded-full blur-[50px] pointer-events-none"></div>
</div>
</div>
</div>
</div>
...
<p className="text-lg text-zinc-400 font-light leading-relaxed mb-8">
                  Capture telemetry across any infrastructure interaction—from
                  server logs to API webhooks—and normalize it into a single
                  structured stream linked to your data warehouse.
                </p>
<p className="text-base text-zinc-500 font-light leading-relaxed mb-10">
                  Nexastream integrates seamlessly with the tools you already
                  use, so you can create pipelines directly from your cloud
                  providers, SaaS platforms, or custom event emitters without
                  managing complex schema registries.
                </p>
...
<path d="M6.763 10.036q.002.446.088.71c.064.176.144.368.256.576c.04.063.056.127.056.183q.002.12-.152.24l-.503.335a.4.4 0 0 1-.208.072q-.12-.002-.239-.112a2.5 2.5 0 0 1-.287-.375a6 6 0 0 1-.248-.471q-.934 1.101-2.347 1.101c-.67 0-1.205-.191-1.596-.574q-.588-.575-.59-1.533c0-.678.239-1.23.726-1.644c.487-.415 1.133-.623 1.955-.623c.272 0 .551.024.846.064c.296.04.6.104.918.176v-.583q-.001-.909-.375-1.277c-.255-.248-.686-.367-1.3-.367c-.28 0-.568.031-.863.103q-.443.106-.862.272a2 2 0 0 1-.28.104a.5.5 0 0 1-.127.023q-.168.002-.168-.247v-.391c0-.128.016-.224.056-.28a.6.6 0 0 1 .224-.167a4.6 4.6 0 0 1 1.005-.36a4.8 4.8 0 0 1 1.246-.151c.95 0 1.644.216 2.091.647q.66.645.662 1.963v2.586zm-3.24 1.214c.263 0 .534-.048.822-.144a1.8 1.8 0 0 0 .758-.51a1.3 1.3 0 0 0 .272-.512c.047-.191.08-.423.08-.694v-.335a7 7 0 0 0-.735-.136a6 6 0 0 0-.75-.048c-.535 0-.926.104-1.19.32c-.263.215-.39.518-.39.917c0 .375.095.655.295.846c.191.2.47.296.838.296m6.41.862c-.144 0-.24-.024-.304-.08c-.064-.048-.12-.16-.168-.311L7.586 5.55a1.4 1.4 0 0 1-.072-.32c0-.128.064-.2.191-.2h.783q.227-.001.31.08c.065.048.113.16.16.312l1.342 5.284l1.245-5.284q.058-.24.151-.312a.55.55 0 0 1 .32-.08h.638c.152 0 .256.025.32.08c.063.048.12.16.151.312l1.261 5.348l1.381-5.348q.074-.24.16-.312a.52.52 0 0 1 .311-.08h.743c.127 0 .2.065.2.2c0 .04-.009.08-.017.128a1 1 0 0 1-.056.2l-1.923 6.17q-.072.24-.168.311a.5.5 0 0 1-.303.08h-.687c-.151 0-.255-.024-.32-.08c-.063-.056-.119-.16-.15-.32l-1.238-5.148l-1.23 5.14c-.04.16-.087.264-.15.32c-.065.056-.177.08-.32.08zm10.256.215c-.415 0-.83-.048-1.229-.143c-.399-.096-.71-.2-.918-.32c-.128-.071-.215-.151-.247-.223a.6.6 0 0 1-.048-.224v-.407c0-.167.064-.247.183-.247q.072 0 .144.024c.048.016.12.048.2.08q.408.181.878.279c.319.064.63.096.95.096c.502 0 .894-.088 1.165-.264a.86.86 0 0 0 .415-.758a.78.78 0 0 0-.215-.559c-.144-.151-.416-.287-.807-.415l-1.157-.36c-.583-.183-1.014-.454-1.277-.813a1.9 1.9 0 0 1-.4-1.158q0-.502.216-.886c.144-.255.335-.479.575-.654c.24-.184.51-.32.83-.415c.32-.096.655-.136 1.006-.136c.175 0 .359.008.535.032c.183.024.35.056.518.088q.24.058.455.127q.216.072.336.144a.7.7 0 0 1 .24.2a.43.43 0 0 1 .071.263v.375q-.002.254-.184.256a.8.8 0 0 1-.303-.096a3.65 3.65 0 0 0-1.532-.311c-.455 0-.815.071-1.062.223s-.375.383-.375.71c0 .224.08.416.24.567c.159.152.454.304.877.44l1.134.358c.574.184.99.44 1.237.767s.367.702.367 1.117c0 .343-.072.655-.207.926a2.2 2.2 0 0 1-.583.703c-.248.2-.543.343-.886.447c-.36.111-.734.167-1.142.167m1.509 3.88c-2.626 1.94-6.442 2.969-9.7222.969s-6.907-1.123-9.45-3.141l1.41-3.644c2.201 1.636 4.909 2.474 7.575 2.474c1.889 0 3.036-.516 3.036-1.554c0-.986-1.096-1.464-3.097-2.182c-4.228-1.508-6.38-3.766-6.38-6.684c0-3.376 2.628-5.914 6.643-5.914c2.95 0 5.642.946 8.163 2.508l-1.353 3.633z" fill="currentColor"></path>
</svg>
</div>

<div className="flex hover:border-white/20 hover:text-white text-white/50 bg-zinc-900 w-12 h-12 border-dashed border-white/10 border rounded-xl items-center justify-center transition-colors cursor-pointer">
<svg className="lucide lucide-plus w-5 h-5" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</div>
</div>
</div>

<div className="absolute top-[3rem] left-[4rem] w-full h-full pointer-events-none -z-10">
<svg className="w-full h-full overflow-visible" viewbox="0 0 400 200">
<defs>
<lineargradient id="pipe-gradient" x1="0%" x2="100%" y1="0%" y2="0%">
<stop offset="0%" style={{stopColor: 'rgba(56, 189, 248, 0.1)'}}></stop>
<stop offset="50%" style={{stopColor: 'rgba(56, 189, 248, 0.5)'}}></stop>
<stop offset="100%" style={{stopColor: 'rgba(56, 189, 248, 0)'}}></stop>
</lineargradient>
</defs>

<path d="M 50 10 C 150 10, 150 80, 250 80" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="2"></path>
<path className="animate-[dash-flow_3s_linear_infinite]" d="M 50 10 C 150 10, 150 80, 250 80" fill="none" stroke="url(#pipe-gradient)" stroke-dasharray="10 200" strokeWidth="2"></path>

<path d="M 50 80 C 150 80, 150 80, 250 80" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="2"></path>
<path className="animate-[dash-flow_3s_linear_infinite_1s]" d="M 50 80 C 150 80, 150 80, 250 80" fill="none" stroke="url(#pipe-gradient)" stroke-dasharray="10 200" strokeWidth="2"></path>
</svg>
</div>

<div className="absolute right-0 top-[40px] md:top-[20px] transform translate-x-4 md:translate-x-0">
<div className="relative w-32 h-32 flex items-center justify-center">

<div className="absolute inset-0 border border-sky-500/20 rounded-full animate-[spin_10s_linear_infinite]"></div>
<div className="absolute inset-2 border border-dashed border-indigo-500/20 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>

<div className="w-16 h-16 bg-gradient-to-br from-zinc-800 to-black rounded-xl border border-white/10 shadow-[0_0_30px_rgba(14,165,233,0.3)] flex items-center justify-center relative z-10 backdrop-blur-md">
<svg className="lucide lucide-boxes w-8 h-8 text-white" fill="none" height="32" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg"><path d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .99 1.74l6 3.5a2 2 0 0 0 2.02 0l6-3.5a2 2 0 0 0 .99-1.74v-3.24a2 2 0 0 0-.97-1.71l-6-1.2a2 2 0 0 0-1.22 0l-6 1.2z"></path><path d="m10 8 4.66-2.59a2 2 0 0 1 1.94 0l3 1.68a2 2 0 0 1 .98 1.75l.02 3.86a2 2 0 0 1-.98 1.74l-4.7 2.6a2 2 0 0 1-1.94 0l-3-1.68a2 2 0 0 1-.98-1.75V9.75a2 2 0 0 1 .98-1.74Z"></path><path d="m12.61 7.21 4.7 2.6c.63.35.98 1.02.98 1.74v3.86c0 .72-.35 1.39-.98 1.74l-4.7 2.6c-.63.35-1.61.35-2.24 0l-4.7-2.6a1.99 1.99 0 0 1-.98-1.74V9.75c0-.72.35-1.39.98-1.74l4.7-2.6c.63-.35 1.61-.35 2.24 0Z"></path></svg>
</div>

<div className="absolute inset-0 bg-sky-500/20 blur-xl rounded-full -z-10 animate-pulse"></div>

<div className="absolute -bottom-6 px-3 py-1 bg-black/80 border border-white/10 rounded-full text-[10px] font-mono text-sky-300 whitespace-nowrap">
                        Processing: 4.2k/sec
                      </div>
</div>
</div>
...
<footer className="w-full border-t border-white/10 bg-black/40 backdrop-blur-lg relative z-20 mt-auto">
<div className="max-w-[1400px] mx-auto px-6 py-12 md:px-12 md:py-16">
<div className="flex flex-col md:flex-row justify-between items-center gap-8">
<div>
<h3 className="text-2xl font-serif-custom text-white mb-2">Ready to automate?</h3>
<p className="text-zinc-400 text-sm">Stop wasting time on manual data entry today.</p>
</div>
<div className="flex flex-col sm:flex-row gap-4">
<a className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-white text-black font-medium text-sm hover:bg-zinc-200 transition-colors" href="#">
                  Get Started
                </a>
<a className="inline-flex items-center justify-center px-6 py-3 rounded-full border border-white/10 text-white font-medium text-sm hover:bg-white/5 transition-colors" href="#">
                  Contact Sales
                </a>
</div>
</div>
...
<p>© 2024 LeSage Digital. All rights reserved.</p>
...
<div className="absolute top-[20%] left-[10%] w-1 h-1 bg-white/20 rounded-full animate-[float-subtle_8s_ease-in-out_infinite]"></div>
<div className="absolute top-[60%] right-[10%] w-1.5 h-1.5 bg-blue-500/20 rounded-full animate-[float-subtle_12s_ease-in-out_infinite_reverse]"></div>
<div className="absolute bottom-[20%] left-[30%] w-1 h-1 bg-indigo-500/20 rounded-full animate-[float-subtle_10s_ease-in-out_infinite]"></div>
</div>

...
<div className="flex overflow-x-auto no-scrollbar mask-edges w-full h-[500px] pr-12 pl-12 relative gap-x-4 gap-y-4 items-center justify-center" id="gallery-container"><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-blue-900 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">

<div className="flex flex-col items-center gap-2">
<div className="w-6 h-6 border border-white/20 flex items-center justify-center">
<span className="text-[8px] font-bold text-white/50">VHS</span>
</div>
<div className="w-full h-[1px] bg-white/10"></div>
</div>

<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-blue-100 whitespace-nowrap drop-shadow-md">
                                    High and Low
                                </h4>
</div>
...
<div className="absolute top-20 left-0 w-full h-12 bg-black/20 blur-sm rotate-3 transform"></div>
<div className="absolute bottom-32 left-0 w-full h-8 bg-white/5 blur-sm -rotate-6 transform"></div>

<div className="flex flex-col items-center gap-2">
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">63</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-red-900 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-red-100 whitespace-nowrap drop-shadow-md">
                                    Red Beard
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">65</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-amber-950 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-amber-100 whitespace-nowrap drop-shadow-md">
                                    Stray Dog
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">49</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-zinc-900 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-white whitespace-nowrap drop-shadow-md">
                                    Seven Samurai
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">54</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-[320px] z-10 mx-8 scale-105" style={{height: '480px'}}><div className="vhs-case w-full h-full relative shadow-2xl active">

<div className="absolute inset-0 w-full h-full bg-zinc-900 overflow-hidden rounded-sm border-r border-white/10">
<img alt="Throne of Blood" className="w-full h-full object-cover opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/40 mix-blend-multiply"></div>

<div className="absolute inset-0 distress"></div>

<div className="absolute top-6 left-0 w-full text-center z-10">
<span className="bg-red-600 text-white text-[10px] px-2 py-0.5 rounded-sm font-medium tracking-widest">MASTERPIECE COLLECTION</span>
</div>
<div className="absolute bottom-12 left-6 right-6 z-10">
<h3 className="text-3xl font-serif text-white leading-none mb-2 drop-shadow-lg">THRONE OF BLOOD</h3>
<p className="text-xs text-zinc-300 font-mono tracking-widest">蜘蛛巣城 // DIR. YAMAMOTO</p>
</div>

<div className="absolute top-1/2 -translate-y-1/2 right-2 w-8 h-32 border border-white/20 rounded flex items-center justify-center bg-black/40 backdrop-blur-sm">
<div className="vertical-text text-[9px] tracking-widest text-zinc-400 font-mono">VHS-HQ-Stereo</div>
</div>
</div>

<div className="absolute top-0 bottom-0 -left-[16px] w-8 bg-zinc-950 border-r border-zinc-800 transform origin-right -rotate-y-90 flex flex-col items-center py-4 overflow-hidden" style={{transform: 'rotateY(-90deg) translateX(-16px)'}}>
<div className="flex-1 vertical-text text-xs tracking-[0.2em] text-zinc-500 font-medium uppercase">Throne of Blood</div>
<div className="mt-4 w-4 h-4 rounded-full bg-red-600/50"></div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-emerald-950 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-emerald-100 whitespace-nowrap drop-shadow-md">
                                    Yojimbo
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">61</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-indigo-950 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-indigo-100 whitespace-nowrap drop-shadow-md">
                                    Ran
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">85</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-purple-950 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-purple-100 whitespace-nowrap drop-shadow-md">
                                    Dreams
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">90</span>
</div>
</div>
</div>
</div></div><div className="relative cursor-pointer transition-all duration-500 ease-out group vhs-scene w-12 hover:w-14 opacity-60 hover:opacity-100 z-0 grayscale hover:grayscale-0" style={{height: '440px'}}><div className="vhs-case w-full h-full relative shadow-2xl">
<div className="w-full h-full bg-stone-900 relative overflow-hidden border-l border-r border-white/5 shadow-lg flex flex-col items-center py-6 justify-between transition-colors">
...
<div className="flex-1 flex items-center justify-center py-4">
<h4 className="vertical-text text-sm sm:text-base font-medium tracking-widest uppercase text-stone-100 whitespace-nowrap drop-shadow-md">
                                    Ikiru
                                </h4>
</div>
...
<span className="vertical-text text-[9px] text-white/40 font-mono">NTSC-J</span>
<div className="w-5 h-8 bg-white/10 rounded-sm flex items-center justify-center">
<span className="text-[8px] font-bold text-white/80">52</span>
</div>
</div>
</div>
</div></div></div>
...
<div className="text-center space-y-3 pointer-events-auto transition-all duration-500" id="info-panel" style={{opacity: '1', transform: 'translateY(0px)'}}>
<h2 className="text-4xl font-serif tracking-tight text-zinc-100" id="movie-title">Throne of Blood</h2>
<div className="flex items-center justify-center gap-3 text-xs tracking-widest text-red-500/90">
<span id="movie-jp">蜘蛛巣城</span>
<span className="w-1 h-1 rounded-full bg-zinc-700"></span>
<span className="text-zinc-400" id="movie-year">1957</span>
</div>
</div>

...
<a className="cursor-hover group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-full bg-white px-8 py-4 text-sm font-medium text-black transition duration-500 hover:scale-[1.02]" href="#contact">

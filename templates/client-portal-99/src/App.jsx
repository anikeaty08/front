...
<div className="fixed top-0 left-1/4 w-96 h-96 bg-violet-600/20 rounded-full blur-[120px] -translate-y-1/2 pointer-events-none"></div>
<div className="fixed bottom-0 right-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] translate-y-1/3 pointer-events-none"></div>
...
<button className="group h-10 w-10 flex items-center justify-center rounded-full border border-white/5 bg-white/5 hover:bg-white/10 hover:border-white/10 transition-all duration-300">
<iconify-icon className="text-zinc-400 group-hover:text-white transition-colors" icon="solar:logout-2-linear" width="20"></iconify-icon>
</button>
</div>
</header>
...
<p className="text-zinc-400 font-medium mb-4">
                Fáze 4 ze 6 – Programování front-endu
              </p>
...
<iconify-icon className="text-violet-400" icon="solar:cloud-upload-linear"></iconify-icon>
...
<iconify-icon className="text-zinc-400 group-hover:text-violet-400 transition-colors" icon="solar:add-folder-linear" width="24"></iconify-icon>
</div>
...
<p className="text-xs text-zinc-500">14.3 KB • Nahráno včera</p>
</div>
</div>
...
<button className="w-full py-3 px-4 rounded-xl border border-white/5 bg-zinc-800 text-zinc-500 font-medium text-sm cursor-not-allowed flex items-center justify-center gap-2" disabled="">
...
<iconify-icon className="text-zinc-500 group-hover:text-white transition-colors" icon="solar:alt-arrow-down-linear" width="18"></iconify-icon>
</button>
...
<a className="text-xs text-zinc-300 hover:text-white flex items-center gap-1 transition-colors" href="#">

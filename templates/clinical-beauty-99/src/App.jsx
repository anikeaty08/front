...
<a className="text-xl tracking-tighter uppercase font-medium" href="#">Deltanova</a>
<div className="hidden md:flex gap-12 text-sm tracking-wide">
<a className="hover:text-[#BBA88E] transition-colors" href="#">Technologies</a>
<a className="hover:text-[#BBA88E] transition-colors" href="#">Expertise</a>
<a className="hover:text-[#BBA88E] transition-colors" href="#">Masterclass</a>
</div>
<a className="text-xs uppercase tracking-widest border border-white/30 px-6 py-3 rounded-full hover:bg-white hover:text-black transition-colors" href="#">Contact</a>
</nav>
...
<p className="text-base md:text-lg text-white/80 font-light mb-12 max-w-lg leading-relaxed">
      Visage, corps, épilation définitive, diagnostic et accompagnement sur-mesure pour faire évoluer votre carte de
      soins.
    </p>
<div className="flex flex-wrap items-center gap-6">
<a className="bg-white text-[#1A1A1A] text-sm uppercase tracking-widest px-8 py-4 rounded-full hover:bg-[#BBA88E] hover:text-white transition-colors duration-500" href="#">
        Découvrir nos technologies
      </a>
<a className="flex items-center gap-3 text-sm uppercase tracking-widest text-white hover:text-[#BBA88E] transition-colors duration-500" href="#">
        Être rappelé
...
<a className="group flex items-center justify-between border-b border-white/10 pb-6 hover:border-white/40 transition-colors" href="#">
<div className="flex items-center gap-4">
<iconify-icon className="text-2xl text-white/50 group-hover:text-[#BBA88E] transition-colors" icon="solar:stars-linear"></iconify-icon>
<span className="text-lg font-light tracking-wide">Renouveler mes technologies</span>
</div>
<iconify-icon className="text-xl opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" icon="solar:alt-arrow-right-linear"></iconify-icon>
</a>
<a className="group flex items-center justify-between border-b border-white/10 pb-6 hover:border-white/40 transition-colors" href="#">
<div className="flex items-center gap-4">
<iconify-icon className="text-2xl text-white/50 group-hover:text-[#BBA88E] transition-colors" icon="solar:buildings-linear"></iconify-icon>
<span className="text-lg font-light tracking-wide">Ouvrir un nouveau centre</span>
</div>
<iconify-icon className="text-xl opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" icon="solar:alt-arrow-right-linear"></iconify-icon>
</a>
<a className="group flex items-center justify-between pb-2 hover:border-white/40 transition-colors" href="#">
<div className="flex items-center gap-4">
<iconify-icon className="text-2xl text-white/50 group-hover:text-[#BBA88E] transition-colors" icon="solar:graph-up-linear"></iconify-icon>
...
<p className="text-base text-gray-500">Une approche globale qui sécurise votre investissement et pérennise vos
      résultats.</p>
</div>
...
<p className="text-sm text-gray-500 leading-relaxed">
        Des équipements audités pour leur efficacité clinique, leur fiabilité technique et leur rentabilité sur le
        marché français.
      </p>
</div>
...
<p className="text-sm text-gray-500 leading-relaxed">
        Support marketing, maintenance préventive et points réguliers pour optimiser le taux de remplissage de la
        machine.
      </p>
</div>
</div>
...
<a className="group relative aspect-[4/3] overflow-hidden bg-white" href="#">
<img alt="Visage" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-80 mix-blend-multiply grayscale group-hover:grayscale-0" src="https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
...
<a className="group relative aspect-[4/3] overflow-hidden bg-white" href="#">
<img alt="Corps" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-80 mix-blend-multiply grayscale group-hover:grayscale-0" src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#1A1A1A]/80 via-[#1A1A1A]/20 to-transparent"></div>
<div className="absolute bottom-0 left-0 p-10 w-full text-white">
<div className="flex justify-between items-end">
<div>
...
<a className="group relative aspect-[4/3] overflow-hidden bg-white" href="#">
<img alt="Epilation" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-80 mix-blend-multiply grayscale group-hover:grayscale-0" src="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#1A1A1A]/80 via-[#1A1A1A]/20 to-transparent"></div>
<div className="absolute bottom-0 left-0 p-10 w-full text-white">
<div className="flex justify-between items-end">
<div>
...
<a className="group relative aspect-[4/3] overflow-hidden bg-[#1A1A1A]" href="#">
<img alt="Diagnostic IA" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-40 mix-blend-luminosity" src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&amp;w=1200&amp;auto=format&amp;fit=crop"/>
...
<iconify-icon className="text-2xl text-[#1A1A1A]" icon="solar:shop-linear"></iconify-icon>
</div>
...
<a className="inline-flex items-center gap-2 text-sm uppercase tracking-widest text-[#1A1A1A] hover:text-[#BBA88E] transition-colors pb-1 border-b border-[#1A1A1A] hover:border-[#BBA88E]" href="#">
...
<div className="bg-[#F9F8F6] p-12 hover:bg-white transition-colors duration-500">
<div className="w-12 h-12 bg-[#EBE9E4] rounded-full flex items-center justify-center mb-8">
<iconify-icon className="text-2xl text-[#1A1A1A]" icon="solar:stethoscope-linear"></iconify-icon>
</div>
...
<div className="bg-[#F9F8F6] p-12 hover:bg-white transition-colors duration-500">
<div className="w-12 h-12 bg-[#EBE9E4] rounded-full flex items-center justify-center mb-8">
<iconify-icon className="text-2xl text-[#1A1A1A]" icon="solar:health-linear"></iconify-icon>
</div>
...
<iconify-icon className="text-2xl text-[#8F9A90] mb-3" icon="solar:chart-square-linear"></iconify-icon>
...
<div className="border-l border-[#BBA88E] pl-6">
<iconify-icon className="text-2xl text-[#8F9A90] mb-3" icon="solar:diploma-linear"></iconify-icon>
...
<div className="border-l border-[#BBA88E] pl-6">
<iconify-icon className="text-2xl text-[#8F9A90] mb-3" icon="solar:gallery-linear"></iconify-icon>
...
<div className="border-l border-[#BBA88E] pl-6">
<iconify-icon className="text-2xl text-[#8F9A90] mb-3" icon="solar:settings-linear"></iconify-icon>
...
<iconify-icon className="text-2xl text-[#8F9A90] mb-3" icon="solar:verified-check-linear"></iconify-icon>
...
<img alt="Delta Lift" className="w-full h-full object-cover mix-blend-luminosity opacity-60 group-hover:mix-blend-normal group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" src="https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=800&amp;q=80"/>
...
<iconify-icon className="text-2xl text-white/30 group-hover:text-white transition-colors" icon="solar:add-circle-linear"></iconify-icon>
</div>
</div>

<div className="min-w-[300px] md:min-w-[400px] snap-start group cursor-pointer">
<div className="aspect-[3/4] bg-[#2A2A2A] relative mb-6 overflow-hidden flex items-center justify-center">
<img alt="Jetskin Pro" className="w-full h-full object-cover mix-blend-luminosity opacity-60 group-hover:mix-blend-normal group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" src="https://images.unsplash.com/photo-1542833807-ad5af0977050?w=800&amp;q=80"/>
...
<div className="min-w-[300px] md:min-w-[400px] snap-start group cursor-pointer">
<div className="aspect-[3/4] bg-[#2A2A2A] relative mb-6 overflow-hidden flex items-center justify-center">
<img alt="Novashape" className="w-full h-full object-cover mix-blend-luminosity opacity-60 group-hover:mix-blend-normal group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" src="https://images.unsplash.com/photo-1670201203208-055d6d79db4a?w=800&amp;q=80"/>
<div className="absolute inset-0 border border-white/10 group-hover:border-[#BBA88E]/50 transition-colors duration-500"></div>
</div>
<div className="flex justify-between items-start">
<div>
...
<div className="min-w-[300px] md:min-w-[400px] snap-start group cursor-pointer">
<div className="aspect-[3/4] bg-[#2A2A2A] relative mb-6 overflow-hidden flex items-center justify-center">
<img alt="Deltadiode+" className="w-full h-full object-cover mix-blend-luminosity opacity-60 group-hover:mix-blend-normal group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" src="https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?w=800&amp;q=80"/>
<div className="absolute inset-0 border border-white/10 group-hover:border-[#BBA88E]/50 transition-colors duration-500"></div>
</div>
<div className="flex justify-between items-start">
<div>
...
<a className="inline-flex items-center gap-2 text-sm uppercase tracking-widest text-[#1A1A1A] pb-1 border-b border-[#1A1A1A] hover:text-[#BBA88E] hover:border-[#BBA88E] transition-colors" href="#">
                        Toutes les dates
                    </a>
</div>
</div>
...
<a className="group flex flex-col md:flex-row gap-8 bg-white p-8 border border-[#EBE9E4] hover:shadow-lg hover:shadow-gray-100 transition-all duration-500" href="#">
<div className="md:w-2/5 aspect-[4/3] bg-[#EBE9E4] overflow-hidden">
<img alt="Formation" className="w-full h-full object-cover grayscale opacity-80 group-hover:scale-105 group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1556760544-74068565f05c?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
...
<a className="group flex flex-col md:flex-row gap-8 bg-white p-8 border border-[#EBE9E4] hover:shadow-lg hover:shadow-gray-100 transition-all duration-500" href="#">
<div className="md:w-2/5 aspect-[4/3] bg-[#EBE9E4] overflow-hidden">
<img alt="Formation Médicale" className="w-full h-full object-cover grayscale opacity-80 group-hover:scale-105 group-hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
<div className="md:w-3/5 flex flex-col justify-center">
...
<a className="w-full sm:w-auto bg-[#1A1A1A] text-white text-sm uppercase tracking-widest px-10 py-5 rounded-full hover:bg-black transition-colors duration-300" href="#">
                    Nous contacter
                </a>
<a className="w-full sm:w-auto border border-[#1A1A1A] text-[#1A1A1A] text-sm uppercase tracking-widest px-10 py-5 rounded-full hover:bg-[#1A1A1A] hover:text-white transition-colors duration-300" href="#">
                    Être rappelé
                </a>
</div>
</div>
...
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">Visage &amp; Anti-âge</a></li>
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">Remodelage Corps</a></li>
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">Épilation Définitive</a></li>
</ul>
</div>
<div>
<h4 className="text-xs uppercase tracking-widest text-[#1A1A1A] mb-6">Entreprise</h4>
<ul className="space-y-4 text-sm text-gray-500 font-light">
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">L'accompagnement</a></li>
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">Masterclass</a></li>
<li><a className="hover:text-[#BBA88E] transition-colors" href="#">Financement</a></li>
</ul>
</div>
</div>
...
<a className="hover:text-[#1A1A1A] transition-colors" href="#">Mentions légales</a>
<a className="hover:text-[#1A1A1A] transition-colors" href="#">Politique de confidentialité</a>
</div>
</div>
</footer>

...
<span className="block text-lg font-bold leading-none tracking-tight text-stone-900">Cloud La Med Spa</span>
...
<h1 className="text-4xl sm:text-5xl lg:text-7xl font-medium text-stone-900 leading-[1.1] tracking-tight">
                        New Jersey's <br/>
<span className="italic text-stone-500">Ultimate Med Spa</span>
</h1>

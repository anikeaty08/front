...
<nav className="fixed top-0 w-full z-40 bg-stone-50/90 backdrop-blur-md border-b border-stone-200">
...
<a className="hidden sm:flex items-center gap-2 text-xs font-medium text-stone-600 px-4 py-2 hover:bg-stone-100 rounded-full transition-colors border border-transparent hover:border-stone-200" href="#">
...
<header className="relative pt-32 pb-24 md:pt-48 md:pb-40 px-6 overflow-hidden flex items-center min-h-[600px]">

<img alt="Coffee Shop Background" className="absolute inset-0 w-full h-full object-cover -z-20" src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&amp;w=2047&amp;auto=format&amp;fit=crop"/>

<div className="absolute inset-0 bg-stone-950/70 -z-10"></div>
<div className="max-w-6xl mx-auto relative z-10 w-full">
<div className="max-w-2xl space-y-8">
<div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full w-fit">
<iconify-icon className="text-orange-200 text-sm" icon="solar:map-point-linear" strokeWidth="1.5"></iconify-icon>
<span className="text-xs font-medium text-orange-50">Located in Tangub City</span>
</div>
<h1 className="text-5xl md:text-7xl font-semibold tracking-tight text-white leading-[1.1]">
                    Route 80 <br/>
<span className="serif italic text-stone-300 font-normal">Coffee Roasters</span>
</h1>
<p className="text-lg md:text-xl text-stone-200 max-w-md leading-relaxed">
                    Your local stop for freshly roasted coffee and hot pizza in Misamis Occidental. Dine-in or takeout available.
                </p>
<div className="flex flex-col sm:flex-row gap-4 pt-2">
<button className="inline-flex items-center justify-center bg-white text-stone-950 px-6 py-3 rounded-lg text-sm font-medium hover:bg-stone-100 transition-all shadow-lg shadow-black/20 gap-2" onclick="toggleModal('reservation-modal')">
<iconify-icon icon="solar:calendar-add-linear" width="18"></iconify-icon>
                        Reserve Now
                    </button>
<a className="inline-flex items-center justify-center bg-transparent border border-white/20 text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-white/10 transition-all" href="#menu">
                        View Menu
                    </a>
</div>
</div>
...
<div className="fixed inset-0 bg-stone-900/60 backdrop-blur-sm z-50 hidden transition-opacity" id="reservation-modal-backdrop" onclick="toggleModal('reservation-modal')"></div>
...
<iconify-icon className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400" icon="solar:calendar-linear" width="16"></iconify-icon>
...
<div className="relative">
<iconify-icon className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400" icon="solar:clock-circle-linear" width="16"></iconify-icon>
...
<input className="w-full text-sm px-3 py-2 bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-stone-900 focus:border-stone-900 transition-all" placeholder="+63 ..." required="" type="tel"/>
</div>
<div className="space-y-1">
...
<iconify-icon className="text-4xl text-stone-400" icon="solar:cup-hot-linear" strokeWidth="1.2"></iconify-icon>
<h2 className="text-3xl font-semibold tracking-tight text-stone-900">Great coffee in Tangub City.</h2>
<div className="prose prose-stone prose-lg mx-auto text-stone-500 leading-relaxed">
<p>
                    Route 80 Coffee Roasters brings the art of brewing to Misamis Occidental. We are a locally oriented coffee shop dedicated to serving the community with robust flavors and a welcoming atmosphere.
                </p>
<p className="mt-4">
                    Whether you are stopping by for a quick takeout cup on your way to work or settling in for a dine-in meal with friends, we are here for you. From our signature roasts to our freshly made pizzas, we aim to be your favorite stop on the route.
                </p>
</div>
...
<span className="text-xs text-stone-500">Casual &amp; Relaxed</span>
</div>
<div className="text-center">
<span className="block text-sm font-medium text-stone-900">Service</span>
<span className="text-xs text-stone-500">Dine-in &amp; Takeout</span>
</div>
<div className="text-center">
<span className="block text-sm font-medium text-stone-900">Audience</span>
<span className="text-xs text-stone-500">Locals &amp; Visitors</span>
</div>
<div className="text-center">
<span className="block text-sm font-medium text-stone-900">Location</span>
<span className="text-xs text-stone-500">Tangub City</span>
</div>
</div>
</div>
</section>
...
<iconify-icon className="text-stone-700" icon="solar:cup-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h3 className="text-lg font-medium text-stone-900">Coffee &amp; Drinks</h3>
<p className="text-sm text-stone-500 leading-relaxed">
                        Expertly brewed coffee specialties and refreshing beverages to start your day right.
                    </p>
</div>

<div className="bg-stone-100 rounded-xl p-8 space-y-4 hover:bg-stone-200/50 transition-colors">
<div className="h-10 w-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
<iconify-icon className="text-stone-700" icon="solar:users-group-rounded-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h3 className="text-lg font-medium text-stone-900">Gather Together</h3>
<p className="text-sm text-stone-500 leading-relaxed">
                        A welcoming environment for groups and families. Spacious and comfortable seating available.
                    </p>
</div>

<div className="bg-stone-100 rounded-xl p-8 space-y-4 hover:bg-stone-200/50 transition-colors">
<div className="h-10 w-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
<iconify-icon className="text-stone-700" icon="solar:chef-hat-linear" strokeWidth="1.5" width="20"></iconify-icon>
</div>
<h3 className="text-lg font-medium text-stone-900">Fresh Pizza</h3>
<p className="text-sm text-stone-500 leading-relaxed">
                        Hungry? We serve hot pizzas and snacks perfect for lunch or a casual dinner.
                    </p>
</div>
</div>
</div>
...
<p className="text-stone-400 max-w-sm text-sm">Comfort food, pizza, and artisanal coffee.</p>
</div>
<div className="flex gap-2">
<span className="px-3 py-1 rounded-full border border-stone-700 text-xs text-stone-300">Coffee</span>
<span className="px-3 py-1 rounded-full border border-stone-700 text-xs text-stone-300">Pizza</span>
<span className="px-3 py-1 rounded-full border border-stone-700 text-xs text-stone-300">Snacks</span>
</div>
</div>
...
<img alt="Pizza" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700 opacity-90" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
<div className="overflow-hidden rounded-lg -mt-8">
...
<iconify-icon className="text-orange-400" icon="solar:cup-hot-linear" width="20"></iconify-icon> Coffee Specialties
                        </h3>
<p className="text-sm text-stone-400">Hand-crafted lattes, espressos, and cold brews using roasted beans.</p>
</div>
<div className="space-y-2 border-b border-stone-800 pb-6">
<h3 className="text-lg font-medium text-white flex items-center gap-2">
<iconify-icon className="text-orange-400" icon="solar:chef-hat-heart-linear" width="20"></iconify-icon> Hand-tossed Pizza
                        </h3>
<p className="text-sm text-stone-400">Freshly made pizzas with various toppings, perfect for sharing.</p>
</div>
<div className="space-y-2 border-b border-stone-800 pb-6">
<h3 className="text-lg font-medium text-white flex items-center gap-2">
<iconify-icon className="text-orange-400" icon="solar:donut-bitten-linear" width="20"></iconify-icon> Quick Bites
                        </h3>
<p className="text-sm text-stone-400">Savory options and snacks available for dine-in or takeout.</p>
</div>
<div className="pt-2">
<p className="text-xs text-stone-500 uppercase tracking-widest">Pricing</p>
<p className="text-xl text-white font-serif italic">Affordable Rates</p>
</div>
</div>
</div>
</div>
...
<iconify-icon className="text-stone-400 mt-1" icon="solar:map-point-linear" strokeWidth="1.5" width="20"></iconify-icon>
<div>
<p className="text-sm font-medium text-stone-900">Address</p>
<p className="text-sm text-stone-500">3Q82+8MQ, Tangub City, Misamis Occidental</p>
</div>
</li>
<li className="flex items-start gap-4">
<iconify-icon className="text-stone-400 mt-1" icon="solar:clock-circle-linear" strokeWidth="1.5" width="20"></iconify-icon>
<div>
...
<li className="flex items-start gap-4">
<iconify-icon className="text-stone-400 mt-1" icon="solar:bag-linear" strokeWidth="1.5" width="20"></iconify-icon>
<div>
<p className="text-sm font-medium text-stone-900">Services</p>
<p className="text-sm text-stone-500">Dine-in &amp; Takeout</p>
</div>
</li>
</ul>
</div>
...
<blockquote className="text-sm text-stone-600 mb-4">
                        "A new spot in Tangub City to enjoy coffee and food. Great for a quick stop."
                    </blockquote>
<a className="text-xs font-medium text-stone-900 underline decoration-stone-300 hover:decoration-stone-900 underline-offset-4" href="#">
                        Leave a Review
                    </a>
</div>
</div>
...
<iframe allowfullscreen="" className="absolute inset-0 w-full h-full" height="100%" loading="lazy" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15786.123456789!2d123.75!3d8.06!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2s3Q82%2B8MQ%2C%20Tangub%20City%2C%20Misamis%20Occidental!5e0!3m2!1sen!2sph!4v1600000000000!5m2!1sen!2sph" style={{border: '0'}} title="Google Map Location" width="100%">
</iframe>
...
<h4 className="text-white font-semibold tracking-tight text-lg mb-1">Route 80 Coffee Roasters</h4>
<p className="text-sm">Tangub City, Misamis Occidental</p>
</div>
<div className="flex items-center gap-2 text-sm bg-stone-900 py-1 px-3 rounded-full border border-stone-800">
<div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
<span className="text-stone-300">Open Daily</span>
</div>
...
<div className="max-w-6xl mx-auto mt-8 pt-8 border-t border-stone-900 text-center md:text-left text-xs text-stone-600">
            © 2023 Route 80 Coffee Roasters. All rights reserved.
        </div>
</footer>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
        ...
        function showBrandStep(step) {
            document.getElementById('brand-step-1').classList.add('hidden');
            document.getElementById('brand-step-2').classList.add('hidden');
            document.getElementById('brand-step-3').classList.add('hidden');
        ...
        function showDashboardTab(tabId) {
            ...
            document.querySelectorAll('.nav-link').forEach(link => {
                link.classList.remove('active', 'text-gray-900', 'bg-gray-100');
                link.classList.add('text-gray-600');
            });
            event.target.closest('.nav-link').classList.add('active', 'text-gray-900', 'bg-gray-100');
...
<div className="text-xl font-semibold tracking-tight cursor-pointer" onclick="showPage('home')">
...
<button className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200" onclick="showPage('login')">Sign In</button>
<button className="px-4 py-2 bg-gray-900 text-white text-sm rounded-lg hover:bg-gray-800 transition-all duration-200" onclick="showPage('signup')">Get Started</button>
</div>
</div>
</div>
</nav>
...
<div className="inline-flex items-center space-x-2 px-3 py-1 bg-gray-100 rounded-full text-sm animate-fadeIn">
<i className="w-4 h-4" data-lucide="sparkles"></i>
<span className="text-gray-700">The Creator-Brand Marketplace</span>
</div>
<h1 className="text-5xl lg:text-6xl font-semibold tracking-tight leading-tight animate-fadeIn delay-100">
...
<button className="px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" onclick="showPage('signup'); switchSignupTab('brand')">
                                I'm a Brand
                            </button>
<button className="px-6 py-3 border border-gray-300 rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 font-medium" onclick="showPage('signup'); switchSignupTab('creator')">
                                I'm a Creator
                            </button>
</div>
<div className="flex items-center space-x-8 pt-4 animate-fadeIn delay-400">
<div>
...
<div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-gray-200 animate-scaleIn delay-600">
<div className="flex items-center space-x-3">
<div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center">
<i className="w-5 h-5 text-green-600" data-lucide="check"></i>
</div>
<div>
<div className="text-sm font-medium">Campaign Approved</div>
...
<h2 className="text-4xl font-semibold tracking-tight">Everything You Need to Succeed</h2>
<p className="text-lg text-gray-600 max-w-2xl mx-auto">Powerful features designed for seamless creator-brand collaboration</p>
</div>
...
<h3 className="text-lg font-semibold mb-2">Advanced Creator Discovery</h3>
...
<i className="w-6 h-6 text-purple-600" data-lucide="target"></i>
</div>
...
<i className="w-6 h-6 text-green-600" data-lucide="message-circle"></i>
</div>
...
<i className="w-6 h-6 text-pink-600" data-lucide="bar-chart-3"></i>
</div>
...
<section className="py-20 px-6 lg:px-8 bg-gray-50" id="how-it-works">
<div className="max-w-7xl mx-auto">
<div className="text-center space-y-4 mb-16">
<h2 className="text-4xl font-semibold tracking-tight">How Connectify Works</h2>
<p className="text-lg text-gray-600 max-w-2xl mx-auto">Simple steps to successful collaborations</p>
</div>
<div className="grid md:grid-cols-4 gap-8">
<div className="text-center">
<div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-semibold mx-auto mb-4">1</div>
...
<div className="text-center">
<div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-semibold mx-auto mb-4">2</div>
...
<div className="text-center">
<div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-semibold mx-auto mb-4">3</div>
...
<div className="text-center">
<div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-semibold mx-auto mb-4">4</div>
...
<section className="py-20 px-6 lg:px-8 bg-white" id="for-brands">
<div className="max-w-7xl mx-auto">
<div className="grid lg:grid-cols-2 gap-12 items-center">
<div>
<h2 className="text-4xl font-semibold tracking-tight mb-6">Built for Brands</h2>
<p className="text-lg text-gray-600 mb-8">Find the perfect creators for your campaigns with intelligent matching and comprehensive management tools.</p>
...
<i className="w-5 h-5 text-purple-600" data-lucide="trending-up"></i>
</div>
<div>
...
<button className="mt-8 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" onclick="showPage('signup'); switchSignupTab('brand')">
                            Start as a Brand
                        </button>
</div>
<div className="relative">
<img alt="Brands" className="rounded-2xl shadow-2xl" src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&amp;h=600&amp;fit=crop"/>
</div>
</div>
</div>
</section>

<section className="py-20 px-6 lg:px-8 bg-gray-50" id="for-creators">
<div className="max-w-7xl mx-auto">
<div className="grid lg:grid-cols-2 gap-12 items-center">
<div className="order-2 lg:order-1 relative">
<img alt="Creators" className="rounded-2xl shadow-2xl" src="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&amp;h=600&amp;fit=crop"/>
</div>
<div className="order-1 lg:order-2">
<h2 className="text-4xl font-semibold tracking-tight mb-6">Empowering Creators</h2>
<p className="text-lg text-gray-600 mb-8">Showcase your work, connect with top brands, and grow your creator business with professional tools.</p>
<div className="space-y-6">
<div className="flex items-start space-x-4">
<div className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0">
<i className="w-5 h-5 text-orange-600" data-lucide="briefcase"></i>
</div>
<div>
...
<i className="w-5 h-5 text-pink-600" data-lucide="dollar-sign"></i>
</div>
<div>
...
<button className="mt-8 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" onclick="showPage('signup'); switchSignupTab('creator')">
                            Join as a Creator
                        </button>
</div>
</div>
...
<h2 className="text-4xl font-semibold tracking-tight mb-6">Ready to Transform Your Collaborations?</h2>
<p className="text-lg text-gray-300 mb-8">Join thousands of brands and creators already using Connectify</p>
<button className="px-8 py-4 bg-white text-gray-900 rounded-lg hover:bg-gray-100 transition-all duration-200 font-medium text-lg" onclick="showPage('signup')">
                    Get Started Free
                </button>
</div>
</section>
...
<div className="grid md:grid-cols-4 gap-8">
<div>
<div className="text-xl font-semibold tracking-tight mb-4">CONNECTIFY</div>
...
<div className="text-2xl font-semibold tracking-tight mb-2">CONNECTIFY</div>
<h1 className="text-3xl font-semibold tracking-tight mb-2">Welcome back</h1>
<p className="text-gray-600">Sign in to your account</p>
</div>
<div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm animate-scaleIn delay-100">
<form className="space-y-6" onsubmit="event.preventDefault(); showPage('dashboard');">
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="you@example.com" required="" type="email"/>
</div>
<div>
...
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="••••••••" required="" type="password"/>
</div>
<button className="w-full px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" type="submit">
                            Sign In
                        </button>
</form>
<p className="text-center text-sm text-gray-600 mt-6">
                        Don't have an account? 
                        <button className="text-gray-900 font-medium hover:underline" onclick="showPage('signup')">Sign up</button>
</p>
</div>
<div className="text-center mt-6">
<button className="text-sm text-gray-600 hover:text-gray-900" onclick="showPage('home')">
                        ← Back to home
                    </button>
</div>
</div>
...
<div className="flex space-x-2 mb-6 bg-gray-100 p-1 rounded-lg animate-scaleIn delay-100">
...
<div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm animate-scaleIn delay-200">
...
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="Your brand name" required="" type="text"/>
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="you@company.com" required="" type="email"/>
</div>
<div>
...
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="Your full name" required="" type="text"/>
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="you@example.com" required="" type="email"/>
...
<p className="text-center text-sm text-gray-600 mt-6">
                        ...
                        <button className="text-gray-900 font-medium hover:underline" onclick="showPage('login')">Sign in</button>
</p>
</div>
<div className="text-center mt-6">
<button className="text-sm text-gray-600 hover:text-gray-900" onclick="showPage('home')">
...
<div className="flex items-center justify-center mb-8 animate-fadeIn delay-100">
...
<input className="mr-3" name="platform" type="checkbox" value="instagram"/>
<i className="w-5 h-5 mr-2" data-lucide="instagram"></i>
<span className="text-sm font-medium">Instagram</span>
</label>
<label className="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition-all duration-200">
<input className="mr-3" name="platform" type="checkbox" value="tiktok"/>
<i className="w-5 h-5 mr-2" data-lucide="music"></i>
<span className="text-sm font-medium">TikTok</span>
</label>
<label className="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition-all duration-200">
<input className="mr-3" name="platform" type="checkbox" value="youtube"/>
<i className="w-5 h-5 mr-2" data-lucide="youtube"></i>
<span className="text-sm font-medium">YouTube</span>
</label>
<label className="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition-all duration-200">
<input className="mr-3" name="platform" type="checkbox" value="twitter"/>
<i className="w-5 h-5 mr-2" data-lucide="twitter"></i>
<span className="text-sm font-medium">Twitter/X</span>
</label>
<label className="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition-all duration-200">
<input className="mr-3" name="platform" type="checkbox" value="facebook"/>
<i className="w-5 h-5 mr-2" data-lucide="facebook"></i>
<span className="text-sm font-medium">Facebook</span>
</label>
<label className="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition-all duration-200">
<input className="mr-3" name="platform" type="checkbox" value="linkedin"/>
<i className="w-5 h-5 mr-2" data-lucide="linkedin"></i>
<span className="text-sm font-medium">LinkedIn</span>
</label>
</div>
</div>
<button className="w-full px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" type="submit">Continue</button>
</form>
...
<button className="flex-1 px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium" onclick="showBrandStep(1)" type="button">Back</button>
<button className="flex-1 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" type="submit">Continue</button>
</div>
</form>
...
<div className="flex space-x-3">
<button className="flex-1 px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium" onclick="showBrandStep(2)" type="button">Back</button>
<button className="flex-1 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" type="submit">Complete Setup</button>
</div>
</form>
</div>
</div>
...
<i className="w-8 h-8 text-gray-500" data-lucide="camera"></i>
</div>
<div>
...
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="@yourhandle" required="" type="text"/>
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Bio</label>
<textarea className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="Tell brands about yourself..." required="" rows="3"></textarea>
</div>
<div>
...
<div className="space-y-3">
<div className="flex items-center space-x-3">
<i className="w-5 h-5 text-gray-400" data-lucide="instagram"></i>
<input className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="Instagram handle" type="text"/>
</div>
<div className="flex items-center space-x-3">
<i className="w-5 h-5 text-gray-400" data-lucide="youtube"></i>
<input className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="YouTube channel" type="text"/>
</div>
<div className="flex items-center space-x-3">
<i className="w-5 h-5 text-gray-400" data-lucide="twitter"></i>
<input className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="Twitter/X handle" type="text"/>
</div>
</div>
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Location</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200" placeholder="City, Country" required="" type="text"/>
</div>
<button className="w-full px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" type="submit">Complete Profile</button>
</form>
</div>
</div>
</div>
...
<div className="text-xl font-semibold tracking-tight">CONNECTIFY</div>
<div className="text-xs text-gray-500 mt-1">Brand Dashboard</div>
</div>
<nav className="flex-1 p-4 space-y-1 overflow-y-auto">
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-900 bg-gray-100 rounded-lg transition-colors" href="#" onclick="showDashboardTab('overview')">
<i className="w-5 h-5" data-lucide="layout-dashboard"></i>
<span className="text-sm font-medium">Overview</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('campaigns')">
<i className="w-5 h-5" data-lucide="target"></i>
<span className="text-sm font-medium">Campaigns</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('discover')">
<i className="w-5 h-5" data-lucide="users"></i>
<span className="text-sm font-medium">Discover Creators</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('messages')">
<i className="w-5 h-5" data-lucide="message-circle"></i>
<span className="text-sm font-medium">Messages</span>
<span className="ml-auto px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full">3</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('analytics')">
<i className="w-5 h-5" data-lucide="bar-chart-3"></i>
<span className="text-sm font-medium">Analytics</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('payments')">
<i className="w-5 h-5" data-lucide="credit-card"></i>
<span className="text-sm font-medium">Payments</span>
</a>
<a className="nav-link flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#" onclick="showDashboardTab('settings')">
...
<button className="text-gray-400 hover:text-gray-600" onclick="showPage('home')">
...
<i className="w-6 h-6 text-purple-600" data-lucide="users"></i>
</div>
<span className="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">+8%</span>
</div>
<div className="text-2xl font-semibold text-gray-900 mb-1">156</div>
...
<span className="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">+24%</span>
</div>
...
<i className="w-6 h-6 text-orange-600" data-lucide="dollar-sign"></i>
</div>
<span className="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">+16%</span>
</div>
<div className="text-2xl font-semibold text-gray-900 mb-1">$48.5K</div>
...
<button className="text-sm text-gray-600 hover:text-gray-900" onclick="showDashboardTab('campaigns')">View all</button>
</div>
...
<img className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=80&amp;h=80&amp;fit=crop"/>
...
<div className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
<img className="w-16 h-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=80&amp;h=80&amp;fit=crop"/>
<div className="flex-1">
...
<h2 className="text-xl font-semibold tracking-tight mb-6">Campaign Performance</h2>
...
<div>
<h1 className="text-3xl font-semibold tracking-tight mb-2">Campaigns</h1>
<p className="text-gray-600">Manage all your marketing campaigns</p>
</div>
<button className="px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" onclick="showModal('create-campaign')">
<i className="w-5 h-5 inline mr-2" data-lucide="plus"></i>New Campaign
                            </button>
</div>

<div className="flex space-x-1 mb-6 border-b border-gray-200">
<button className="px-4 py-2 text-sm font-medium border-b-2 border-gray-900 text-gray-900">All (57)</button>
<button className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Active (24)</button>
<button className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">In Review (8)</button>
<button className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Completed (22)</button>
<button className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Drafts (3)</button>
</div>
...
<div className="flex items-start space-x-4">
<img className="w-20 h-20 rounded-lg object-cover" src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=80&amp;h=80&amp;fit=crop"/>
<div>
<h3 className="text-lg font-semibold mb-2">Summer Collection Launch</h3>
<div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="calendar"></i> Jun 15 - Jun 30</span>
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="users"></i> 12 creators</span>
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="dollar-sign"></i> $8,400</span>
</div>
...
<div className="flex items-start justify-between mb-4">
<div className="flex items-start space-x-4">
<img className="w-20 h-20 rounded-lg object-cover" src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=80&amp;h=80&amp;fit=crop"/>
<div>
<h3 className="text-lg font-semibold mb-2">Product Review Campaign</h3>
<div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="calendar"></i> Jun 10 - Jun 25</span>
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="users"></i> 8 creators</span>
<span className="flex items-center"><i className="w-4 h-4 mr-1" data-lucide="dollar-sign"></i> $5,200</span>
</div>
<div className="flex flex-wrap gap-2">
...
<div className="p-8">
<div className="mb-8">
<h1 className="text-3xl font-semibold tracking-tight mb-2">Discover Creators</h1>
...
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Location</label>
<input className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" placeholder="Enter location" type="text"/>
</div>
</div>
<div className="flex items-center justify-between pt-4 border-t border-gray-200">
<div className="flex items-center space-x-4">
...
<div className="flex items-start justify-between mb-3">
<div>
<h3 className="font-semibold text-lg mb-1">Mike Chen</h3>
...
<input className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" placeholder="Search messages..." type="text"/>
</div>
...
<div className="flex items-start space-x-3">
<img className="w-10 h-10 rounded-full" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&amp;h=40&amp;fit=crop"/>
<div className="flex-1 min-w-0">
<div className="flex items-center justify-between mb-1">
...
<div className="flex items-start space-x-3">
<img className="w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=32&amp;h=32&amp;fit=crop"/>
...
<div className="flex items-center space-x-3">
<input className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" placeholder="Type your message..." type="text"/>
<button className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">Send</button>
</div>
</div>
</div>
</div>
...
<p className="text-gray-600">Manage your transactions and invoices</p>
</div>
<button className="px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium">
                                Add Payment Method
                            </button>
</div>
...
<div className="text-3xl font-semibold mb-4">$12,450</div>
<button className="px-4 py-2 bg-white text-gray-900 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors" onclick="showPaymentModal()">
                                    Withdraw
                                </button>
</div>
<div className="bg-white rounded-xl border border-gray-200 p-6">
<div className="text-sm text-gray-600 mb-2">Pending Payments</div>
<div className="text-3xl font-semibold mb-4">$5,200</div>
<div className="text-sm text-gray-600">8 transactions</div>
</div>
<div className="bg-white rounded-xl border border-gray-200 p-6">
<div className="text-sm text-gray-600 mb-2">Total Spent (30 days)</div>
<div className="text-3xl font-semibold mb-4">$18,300</div>
...
<i className="w-5 h-5 text-green-600" data-lucide="arrow-down-left"></i>
</div>
<div>
<div className="font-medium">Payment to Sarah Johnson</div>
<div className="text-sm text-gray-600">Summer Collection Campaign</div>
</div>
</div>
<div className="text-right">
<div className="font-semibold">-$850.00</div>
<div className="text-sm text-gray-600">Jun 18, 2024</div>
</div>
</div>
</div>
<div className="p-6 hover:bg-gray-50 transition-colors">
...
<div>
<div className="font-medium">Payment to Mike Chen</div>
<div className="text-sm text-gray-600">Product Review Campaign</div>
</div>
</div>
<div className="text-right">
<div className="font-semibold">-$650.00</div>
<div className="text-sm text-gray-600">Jun 15, 2024</div>
</div>
</div>
</div>
</div>
...
<img className="w-20 h-20 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&amp;h=80&amp;fit=crop"/>
<div>
...
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Brand Name</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" type="text" value="TrendStyle Co."/>
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Industry</label>
<select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900">
<option>Fashion &amp; Beauty</option>
<option>Tech &amp; Gaming</option>
<option>Food &amp; Beverage</option>
</select>
...
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Email</label>
<input className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" type="email" value="brand@company.com"/>
</div>
<div className="flex justify-end space-x-3">
<button className="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium">Cancel</button>
<button className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors font-medium">Save Changes</button>
</div>
</div>
</div>
...
<div className="text-sm text-gray-600">Get notified about campaign status changes</div>
</div>
...
<div className="text-sm text-gray-600">Receive alerts for new messages from creators</div>
</div>
<input checked="" className="w-5 h-5" type="checkbox"/>
</label>
</div>
...
<nav className="flex-1 p-4 space-y-1 overflow-y-auto">
<a className="flex items-center space-x-3 px-4 py-3 text-gray-900 bg-gray-100 rounded-lg transition-colors" href="#">
<i className="w-5 h-5" data-lucide="layout-dashboard"></i>
<span className="text-sm font-medium">Overview</span>
</a>
<a className="flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#">
...
<i className="w-5 h-5" data-lucide="message-circle"></i>
<span className="text-sm font-medium">Messages</span>
<span className="ml-auto px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full">2</span>
</a>
<a className="flex items-center space-x-3 px-4 py-3 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" href="#">
<i className="w-5 h-5" data-lucide="bar-chart-3"></i>
<span className="text-sm font-medium">Analytics</span>
...
<div className="mb-8">
<h1 className="text-3xl font-semibold tracking-tight mb-2">Welcome back, Sarah!</h1>
...
<div className="flex items-center justify-between mb-4">
<div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
<i className="w-6 h-6 text-blue-600" data-lucide="briefcase"></i>
</div>
</div>
...
<div className="flex items-center justify-between mb-4">
<div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
<i className="w-6 h-6 text-green-600" data-lucide="dollar-sign"></i>
</div>
</div>
...
<div className="flex items-center justify-between mb-4">
<div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
<i className="w-6 h-6 text-purple-600" data-lucide="trending-up"></i>
</div>
</div>
...
<div className="text-2xl font-semibold text-gray-900 mb-1">5.0</div>
<div className="text-sm text-gray-600">Rating (203)</div>
</div>
</div>

<div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
<h2 className="text-xl font-semibold tracking-tight mb-6">Active Campaigns</h2>
<div className="space-y-4">
<div className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
<img className="w-14 h-14 rounded-lg object-cover" src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=60&amp;h=60&amp;fit=crop"/>
<div className="flex-1">
<h3 className="font-semibold mb-1">Summer Collection Launch</h3>
...
<div className="bg-white rounded-xl border border-gray-200 p-6">
<div className="flex items-center justify-between mb-6">
<h2 className="text-xl font-semibold tracking-tight">Recommended Campaigns</h2>
<button className="text-sm text-gray-600 hover:text-gray-900">Browse all</button>
</div>
...
<div className="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-6" id="payment-modal">
...
<span className="font-semibold text-sm">TXN-2024-0618</span>
</div>
</div>
<button className="w-full px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-all duration-200 font-medium" onclick="hidePaymentModal()">
                    Done
                </button>
</div>
</div>

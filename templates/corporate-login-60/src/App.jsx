...
<span className="iconify text-zinc-600 mb-6" data-height="24" data-icon="lucide:quote" data-width="24"></span>
...
<input autocomplete="email" className="w-full bg-zinc-950 border border-zinc-800 text-white text-sm rounded-lg px-4 py-3 focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder-zinc-700 shadow-sm" id="email" placeholder="name@company.com" type="email"/>
</div>
</div>
...
<div className="relative group">
<input autocomplete="current-password" className="w-full bg-zinc-950 border border-zinc-800 text-white text-sm rounded-lg px-4 py-3 focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder-zinc-700 shadow-sm" id="password" placeholder="••••••••" type="password"/>
</div>
</div>
...
<span className="iconify text-black absolute top-0.5 left-0.5 opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" data-height="12" data-icon="lucide:check" data-width="12" style={{strokeWidth: '3'}}></span>
...
<button className="w-full bg-white text-black hover:bg-zinc-200 focus:ring-4 focus:ring-zinc-800 font-medium rounded-lg text-sm px-5 py-3 text-center transition-all duration-200 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]" type="submit">
                        Sign in
                    </button>
</form>
...
<span className="iconify text-zinc-400 group-hover:text-white transition-colors" data-height="18" data-icon="lucide:github" data-width="18"></span>
<span className="text-xs font-medium text-zinc-400 group-hover:text-white transition-colors">GitHub</span>
</button>
<button className="flex items-center justify-center gap-2 bg-zinc-950 border border-zinc-800 hover:border-zinc-600 hover:bg-zinc-900 text-white rounded-lg py-2.5 transition-all duration-200 group">

<span className="iconify text-zinc-400 group-hover:text-white transition-colors" data-height="18" data-icon="lucide:chrome" data-width="18"></span>
...
<p className="text-center text-xs text-zinc-500 pt-4">
                    ...
                    <a className="font-medium text-white hover:underline decoration-zinc-500 underline-offset-4 transition-all" href="#">Request access</a>
</p>
</div>

<div className="absolute bottom-8 right-8">
<a className="flex items-center gap-2 text-zinc-600 hover:text-zinc-400 transition-colors" href="#">

...
<header className="fixed top-0 w-full bg-white/80 dark:bg-gray-950/80 z-50" style={{-FxFilter: 'blur(4px) liquid-glass(2, 10) saturate(1.25)', filter: 'var(--fx-filter)', WebkitBackdropFilter: 'var(--fx-filter)'}}>

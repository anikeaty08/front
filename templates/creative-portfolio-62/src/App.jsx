...
<nav className="fixed flex md:px-12 md:py-8 z-50 text-[#fcfbf9] mix-blend-difference w-full pt-6 pr-6 pb-6 pl-6 top-0 left-0 items-center justify-between">
<a className="lowercase hover:opacity-60 transition-opacity text-9xl font-medium tracking-tight max-w-none max-h-none" href="#">
<img alt="IntelligentSO Logo" className="" src="https://images.squarespace-cdn.com/content/v1/6443bd9f6184622c5ba61727/43bfae13-ead9-4c59-b219-2e829013c381/ISE+LOGO+BLACK+WHITETransparent.png?format=1500w" style={{height: '40px'}}/>
</a>
...
<header className="min-h-screen flex flex-col md:px-12 md:pb-16 overflow-hidden w-full border-neutral-200 border-b pr-6 pb-12 pl-6 relative justify-end" id="hero">

<canvas className="absolute inset-0 w-full h-full z-0 opacity-30 mix-blend-multiply pointer-events-none" height="733" id="particle-canvas" width="1000"></canvas>
<div className="max-w-[1920px] w-full mx-auto relative z-10 pointer-events-none">
<div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
<div className="md:col-span-4 reveal-up flex flex-col pointer-events-auto h-full justify-end">
<p className="text-xs md:text-sm font-light leading-relaxed text-neutral-500 lowercase max-w-xs tracking-wide">
                            We are a software and hardware company based out of Nairobi, Kenya.
                        </p>
...
<h1 className="lowercase leading-[0.85] lg:text-9xl md:text-3xl text-6xl font-medium text-neutral-900 tracking-tighter">Helping African insitutions make better decisions<span className="text-neutral-300 block text-2xl md:text-4xl lg:text-8xl mt-4 tracking-tight font-normal">Using AI</span></h1>
</div>
</div>
</div>
</header>
...
<span className="text-xs font-medium tracking-widest uppercase text-neutral-400">Industries</span>
<span className="text-xs font-medium tracking-widest uppercase text-neutral-400">01 — 05</span>
</div>

<div className="flex items-center gap-6 md:gap-16 pl-6 md:pl-12 w-max will-change-transform" id="carousel-track" style={{transform: 'translateX(0px)'}}>
...
<img alt="Monospace" className="w-full h-full object-cover opacity-90 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 card-zoom" src="https://images.squarespace-cdn.com/content/v1/6443bd9f6184622c5ba61727/7cd21336-6947-4f85-aad7-9073b0670dd6/ISE+POLICE+IMAGE1a.png?format=2500w"/>
</div>
<div className="mt-6 flex justify-between items-start border-t border-neutral-100 pt-4">
<div>
<h3 className="text-xl md:text-2xl font-medium tracking-tight lowercase text-neutral-900">National Secutiry</h3>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded bg-neutral-100 relative">
<img alt="Objet Noir" className="w-full h-full object-cover grayscale opacity-90 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 card-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
</div>
<div className="mt-6 flex justify-between items-start border-t border-neutral-100 pt-4">
<div>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded bg-neutral-100 relative">
<img alt="Vogue Edit" className="w-full h-full object-cover grayscale opacity-90 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 card-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
</div>
<div className="mt-6 flex justify-between items-start border-t border-neutral-100 pt-4">
<div>
...
<article className="group relative w-[80vw] md:w-[35vw] shrink-0 cursor-pointer">
<div className="w-full aspect-[3/4] overflow-hidden rounded bg-neutral-100 relative">
<img alt="Clay Forms" className="w-full h-full object-cover grayscale opacity-90 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 card-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp"/>
</div>
<div className="mt-6 flex justify-between items-start border-t border-neutral-100 pt-4">
<div>
...
<div className="w-full aspect-[3/4] overflow-hidden rounded bg-neutral-100 relative">
<img alt="Liquid Oil" className="w-full h-full object-cover grayscale opacity-90 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 card-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp"/>
</div>
<div className="mt-6 flex justify-between items-start border-t border-neutral-100 pt-4">
<div>
...
<div className="h-full bg-neutral-900 w-0 transition-all duration-100 ease-linear" id="progress-bar" style={{width: '0%'}}></div>
</div>
</div>
</section>
</div>

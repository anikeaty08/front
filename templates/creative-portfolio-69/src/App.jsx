...
<h1 className="text-4xl sm:text-6xl lg:text-7xl leading-[1.06] tracking-tighter font-sans font-semibold">
                ...
                <span className="block bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent tracking-tighter font-sans font-semibold" style={{color: 'rgba(0, 0, 0, 0)', position: 'static'}}>
                  the world.
                </span>
</h1>
</div>
...
<div className="relative">
<span className="inline-flex items-center gap-2 border-gradient before:rounded-full text-sm font-medium text-white bg-blue-600 rounded-full pt-1.5 pr-3.5 pb-1.5 pl-3.5 shadow-md">Developer <svg aria-hidden="true" className="lucide lucide-arrow-up-right lucide-at-sign w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="arrow-up-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(255, 255, 255)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg></span>
...
<div className="relative">
<span className="inline-flex items-center gap-2 border-gradient before:rounded-full text-sm font-medium text-white bg-orange-500 rounded-full pt-1.5 pr-3.5 pb-1.5 pl-3.5 shadow-md">Frontend <svg aria-hidden="true" className="lucide lucide-arrow-up-right lucide-at-sign w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="arrow-up-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(255, 255, 255)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg></span>
...
<img alt="Artwork card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3d5923b9-321c-4e35-ac04-0d7fb5c483b1_320w.webp"/>
</div>
</div>
...
<div className="aspect-[3/4] overflow-hidden rounded-2xl ring-1 ring-black/10 shadow-lg border-gradient before:rounded-2xl transition-shadow duration-500 hover:shadow-2xl">
<img alt="3D render card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c5fb864f-cf3d-4942-9629-249d52477022_800w.webp"/>
</div>
</div>
...
<div className="aspect-[3/4] overflow-hidden rounded-2xl ring-1 ring-black/10 shadow-lg border-gradient before:rounded-2xl transition-shadow duration-500 hover:shadow-2xl">
<img alt="Minimal shapes card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/58cdb928-9435-44fa-b69e-7acebfffa0f7_800w.webp"/>
</div>
</div>
...
<div className="aspect-[3/4] overflow-hidden rounded-2xl ring-1 ring-black/10 shadow-lg border-gradient before:rounded-2xl transition-shadow duration-500 hover:shadow-2xl">
<img alt="Abstract red card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3c4f1dea-f838-465a-bfd2-8fbbf334a6bc_320w.webp"/>
</div>
</div>
...
<div className="aspect-[3/4] overflow-hidden rounded-2xl ring-1 ring-black/10 shadow-lg border-gradient before:rounded-2xl transition-shadow duration-500 hover:shadow-2xl">
<img alt="Mountains card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/773cd99d-a5ac-4c9a-b312-b9b3e3a42002_800w.webp"/>
</div>
</div>
...
<div className="aspect-[3/4] overflow-hidden rounded-2xl ring-1 ring-black/10 shadow-lg border-gradient before:rounded-2xl transition-shadow duration-500 hover:shadow-2xl">
<img alt="Green minimal card" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/97837bc2-4cb4-44a3-8f15-444c524bd4c0_800w.webp"/>
</div>
</div>
...
<p className="mx-auto mt-8 max-w-xl text-center text-base text-neutral-300 font-sans" style={{animation: 'fadeSlideIn 1s ease-out 0.5s both'}}>
              I craft fast, beautiful, and accessible interfaces that live at
              the intersection of design and engineering. From pixel-perfect
              layouts to smooth animations — I turn ideas into experiences users
              remember.
            </p>
...
<section className="sm:pt-24 sm:pb-24 animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.1s_both] max-w-7xl mr-auto ml-auto pt-24 pr-6 pb-24 pl-6 animate">
...
<p className="text-base text-neutral-300 mt-4 font-sans">
          From initial discovery to full deployment, we guide you through every
          stage of your automation journey.
        </p>
</div>
...
<h3 className="mt-4 text-2xl sm:text-3xl tracking-tight font-sans font-semibold">
            Discovery &amp; Analysis
          </h3>
<p className="mt-2 text-sm sm:text-base text-neutral-300 font-sans">
            We dive deep into your operations to identify bottlenecks and
...
<canvas className="" height="220" id="processRadar" style={{display: 'block', boxSizing: 'border-box', height: '176px', width: '176px'}} width="220"></canvas>
</div>
...
<p className="mt-2 text-sm sm:text-base text-neutral-300 font-sans">
            Our engineers create custom solutions that seamlessly integrate with
...
<svg className="w-4 h-4 text-neutral-200" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 7V5a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v2"></path>
<path d="M20 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7"></path>
</svg>
</button>
...
<path d="M6.34 17.66l1.41-1.41"></path>
<path d="M16.24 7.76l1.41-1.41"></path>
...
<span className="ml-auto text-[10px] text-neutral-400 font-sans">
                    workflow_engine.py
                  </span>
</div>
...
<section className="sm:px-6 lg:px-8 sm:pb-20 max-w-7xl mr-auto ml-auto pt-16 pr-4 pb-20 pl-4">
<div className="text-center max-w-4xl mr-auto ml-auto">
<span className="inline-flex items-center gap-2 sm:px-4 sm:py-2 animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.1s_both] text-xs font-medium text-violet-300 bg-violet-500/15 border-violet-400/30 border rounded-full pt-1.5 pr-3 pb-1.5 pl-3">
          Creative Community
        </span>
<h2 className="sm:mt-6 sm:text-4xl lg:text-5xl xl:text-6xl animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.2s_both] text-3xl font-semibold tracking-tight mt-6">
          Join 50,000+ creative professionals from 180+ countries
        </h2>
<p className="sm:mt-4 sm:text-base animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.3s_both] text-sm font-normal text-neutral-300 mt-3">
          Connect with designers, artists, photographers, and creative
          innovators building exceptional portfolios and growing their careers.
        </p>
...
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2f563338-39fa-47ea-9761-658d4f3f84db_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de692cd3-6ed5-40da-b589-663e89889a1c_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/42dfe760-aef6-44a2-bff9-70aa005c5961_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c18d9fac-84d4-4727-95df-38b04c62ac05_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c3e3fffd-33c5-442f-924a-7bc1032b2c0f_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/31996fe3-f9da-42d7-bf65-2cc5d5417271_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5989c16d-4aa3-4351-bfdb-fac959736459_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6c39c735-18f1-4b74-aa61-180fbb2b4770_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6209234e-73ff-4176-bf91-c05fa95cc596_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3f4ec54c-12b4-4eb2-a0c3-1d78cb6c9e02_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8cfa0961-8c53-4d57-b87c-3b8eaffcd08b_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/42f0787e-2f7f-4ae7-9c64-3f1d597bf1b8_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c8701b7a-a3f2-4ad0-95be-f2f027c8e390_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/83ca20c0-64e5-412d-9c79-224a4ae90b74_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c920d31f-46c8-4f39-957b-9a8d8e511a1a_800w.jpg"/>
</div>
</div>
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9a421cf7-e975-430b-88c5-f554775493e1_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0c82a12e-5af1-47d3-963d-65c3987dd2be_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e63aa468-ae44-4756-84db-fcacd6cec9e2_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/>
</div>
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a160135e-dfe8-4d26-b2e5-2915ebe6f3a2_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9a3ff98a-df58-478d-a4ae-f3c6d3f3ba61_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7063bc06-62fe-4811-b5fa-4b1e09b26a81_800w.jpg"/>
</div>
</div>
</div>
</div>
...
<p className="text-base text-neutral-300 mt-4 font-sans">
          Discover how creative professionals are transforming their portfolios
          with our platform.
        </p>
</div>
...
<p className="mt-4 text-base sm:text-lg text-neutral-200 font-sans">
            "This platform completely changed how I present my work. The
            intuitive interface and beautiful layouts helped me land three major
...
<div className="">
<p className="text-sm font-sans font-medium text-neutral-100">
                Marcus Chen
              </p>
<p className="text-xs text-neutral-400 font-sans">
                UI/UX Designer at Creative Studio
              </p>
</div>
</div>
</div>
...
<p className="mt-4 text-base sm:text-lg text-neutral-200 font-sans">
            "Finally, a portfolio platform that understands photographers. The
            galleries are stunning and my images have never looked better. My
            bookings increased by 60%."
          </p>
<div className="mt-6 flex items-center gap-3">
...
<p className="mt-4 text-base sm:text-lg text-neutral-200 font-sans">
            "As an illustrator, showing my process is crucial. The customizable
            project pages let me tell the full story behind each piece. It's a
            game changer."
          </p>
<div className="mt-6 flex items-center gap-3">
...
<p className="mt-4 text-base sm:text-lg text-neutral-200 font-sans">
            "I moved my entire studio portfolio here and couldn't be happier.
            The client feedback has been overwhelmingly positive—they love the
...
<p className="text-xs text-neutral-400 font-sans">
                Creative Director at Nexus Design
              </p>
</div>
</div>
</div>
...
<div className="mt-6">
<span className="text-5xl tracking-tight font-sans font-semibold">
              $0
            </span>
...
<span className="inline-flex items-center rounded-full bg-violet-500 px-3 py-1 text-xs font-medium text-white font-sans">
              Most Popular
            </span>
</div>
...
<p className="text-base sm:text-lg text-neutral-300 mt-6 font-sans">
            Join thousands of creative professionals who trust our platform to
            present their best work. Start building your portfolio today.
          </p>
...
<p className="mt-4 text-sm text-neutral-400 max-w-xs font-sans">
              The professional platform for creative portfolios. Showcase your
              work beautifully.
            </p>
...
<li>
<a className="text-sm text-neutral-400 hover:text-white transition font-sans" href="#">
                  Features
                </a>
</li>
<li>

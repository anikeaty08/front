...
<span className="anim-text-glitch" data-text="Coming" style={{-GlitchDelay: '0s'}}>Coming</span>
</span>
<span className="anim-load-misalign inline-block pr-3 sm:pr-4" style={{animationDelay: '1.4s'}}>
<span className="anim-text-glitch" data-text="Soon" style={{-GlitchDelay: '2s'}}>Soon</span>
</span>

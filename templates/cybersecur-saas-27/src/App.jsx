...
<a className="text-sm font-medium text-slate-400 hover:text-white transition-colors" href="#integration">Integration</a>
<a className="text-sm font-medium text-slate-400 hover:text-white transition-colors" href="#developers">Developers</a>
</div>
</div>
<div className="flex items-center gap-4">
<a className="hidden text-xs font-medium text-slate-300 hover:text-white sm:block" href="#">Log in</a>
<a className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-lg bg-cyan-600 px-4 py-2 text-xs font-semibold text-white transition-all hover:bg-cyan-500 shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_25px_rgba(34,211,238,0.5)]" href="#">
...
<div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-950/20 px-4 py-1.5 mb-8 backdrop-blur-md shadow-[0_0_20px_rgba(34,211,238,0.1)]">
<div className="h-1.5 w-1.5 animate-pulse bg-cyan-400 rounded-full"></div>
<span className="text-[10px] font-semibold tracking-widest uppercase text-cyan-300 font-jakarta">
                Next Gen Defense
              </span>
</div>
...
<div className="glass-surface border-x overflow-hidden transition-all duration-500 animate-enter [--fx-filter:blur(10px)_liquid-glass(5,10)_saturate(1.25)_noise(0.5,1,0)] bg-zinc-900/95 border-white/20 rounded-t-2xl border-b relative backdrop-blur-md">
...
<svg className="lucide lucide-shield-check" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path><path className="" d="m9 12 2 2 4-4"></path></svg>
...
<svg className="lucide lucide-activity" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path className="" d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
</div>
...
<div className="">
<p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Total Threats</p>
<h3 className="text-2xl font-bold text-white tracking-tight">8,942</h3>
</div>
<div className="text-cyan-400 bg-cyan-500/10 rounded-md pt-1.5 pr-1.5 pb-1.5 pl-1.5">
<svg className="lucide lucide-shield-alert" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
</div>
</div>
<div className="w-full h-1 bg-white/10 rounded-full overflow-hidden mt-2">
<div className="h-full w-[70%] bg-cyan-400 rounded-full shadow-[0_0_10px_rgba(34,211,238,0.5)]"></div>
</div>
</div>
...
<div className="flex justify-between items-start">
<div className="">
<p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Sys Latency</p>
<h3 className="text-2xl font-bold text-white tracking-tight">12<span className="text-sm font-medium text-slate-500 ml-1">ms</span></h3>
</div>
<div className="text-cyan-400 bg-cyan-500/10 rounded-md pt-1.5 pr-1.5 pb-1.5 pl-1.5">
...
<svg className="lucide lucide-trend-down" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><polyline points="22 17 13.5 8.5 8.5 13.5 2 7"></polyline><polyline points="16 17 22 17 22 11"></polyline></svg>
                                -4.2% vs last hour
                             </div>
</div>
...
<h3 className="text-2xl font-bold text-white tracking-tight">99.99%</h3>
</div>
<div className="text-cyan-400 bg-cyan-500/10 rounded-md pt-1.5 pr-1.5 pb-1.5 pl-1.5">
...
<h4 className="text-xs font-semibold text-white">Network Traffic</h4>
<div className="flex gap-2">
...
<span className="text-cyan-400">INFO</span>
<span className="group-hover:text-white transition-colors">Heal check passed</span>
</div>
...
<span className="text-cyan-400">INFO</span>
<span className="group-hover:text-white transition-colors">User authenticated</span>
</div>
</div>
</div>
</div>
...
<div className="pointer-events-none absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent via-black/70 to-black z-[15]">
</div>
...
<path d="M 125,280 C 125,550 480,500 500,680" fill="none" stroke="rgba(255,255,255,0.03)" strokeWidth="1"></path>
<path d="M 375,280 C 375,550 490,500 500,680" fill="none" stroke="rgba(255,255,255,0.03)" strokeWidth="1"></path>
<path d="M 625,280 C 625,550 510,500 500,680" fill="none" stroke="rgba(255,255,255,0.03)" strokeWidth="1"></path>
<path d="M 875,280 C 875,550 520,500 500,680" fill="none" stroke="rgba(255,255,255,0.03)" strokeWidth="1"></path>

<path className="animate-flow-custom" d="M 125,280 C 125,550 480,500 500,680" fill="none" stroke="url(#blueFlowGradient)" stroke-dasharray="200, 400" stroke-dashoffset="0" strokeWidth="2" style={{animationDuration: '8s', opacity: '0.4'}}></path>
<path className="animate-flow-custom" d="M 375,280 C 375,550 490,500 500,680" fill="none" stroke="url(#blueFlowGradient)" stroke-dasharray="200, 400" stroke-dashoffset="-200" strokeWidth="2" style={{animationDuration: '10s', opacity: '0.4'}}></path>
<path className="animate-flow-custom" d="M 625,280 C 625,550 510,500 500,680" fill="none" stroke="url(#blueFlowGradient)" stroke-dasharray="200, 400" stroke-dashoffset="-100" strokeWidth="2" style={{animationDuration: '9s', opacity: '0.4'}}></path>
<path className="animate-flow-custom" d="M 875,280 C 875,550 520,500 500,680" fill="none" stroke="url 0.4;" stroke-dasharray="200, 400" stroke-dashoffset="-300"></path>

<path className="animate-flow-custom" d="M 125,280 C 125,550 480,500 500,680" fill="none" filter="url(#glow)" stroke="#60a5fa" stroke-dasharray="20, 600" stroke-dashoffset="0" strokeWidth="3" style={{animationDuration: '4s', opacity: '1', strokeLinecap: 'round'}}></path>
<path className="animate-flow-custom" d="M 375,280 C 375,550 490,500 500,680" fill="none" filter="url(#glow)" stroke="#60a5fa" stroke-dasharray="20, 600" stroke-dashoffset="-200" strokeWidth="3" style={{animationDuration: '5s', opacity: '1', strokeLinecap: 'round'}}></path>
<path className="animate-flow-custom" d="M 625,280 C 625,550 510,500 500,680" fill="none" filter="url(#glow)" stroke="#60a5fa" stroke-dasharray="20, 600" stroke-dashoffset="-100" strokeWidth="3" style={{animationDuration: '4.5s', opacity: '1', strokeLinecap: 'round'}}></path>
<path className="animate-flow-custom" d="M 875,280 C 875,550 520,500 500,680" fill="none" filter="url(#glow)" stroke="#60a5fa" stroke-dasharray="20, 600" stroke-dashoffset="-300" strokeWidth="3" style={{animationDuration: '6s', opacity: '1', strokeLinecap: 'round'}}></path>
</svg>
<style>
            ...
            .lottie-stroke polyline {
              ...
              stroke-dasharray: 60; /* Approx path length for 24px icon */
            }
...
<div className="grid grid-cols-2 gap-6 md:grid-cols-4 z-10 mb-20 relative gap-x-6 gap-y-6">
...
<svg className="lucide lucide-slack h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-chevrons-right h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="group flex transition-all duration-300 hover:bg-white/[0.02] hover:border-blue-500/30 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] overflow-hidden bg-[#0B0C10] w-full h-24 border-white/5 border relative items-center justify-center">
<div className="absolute top-0 left-0 h-1.5 w-1.5 border-t border-l border-blue-600/30 group-hover:w-2."></div>
<div className="absolute top-0 right-0 h-1.5 w-1.5 border-t border-r border-blue-600/30 group-hover:w-2.5 group-hover:h-2.5 group-hover:border-blue-500 transition-all">
</div>
<div className="absolute bottom-0 left-0 h-1.5 w-1.5 border-b border-l border-blue-600/30 group-hover:w-2.5 group-hover:h-2.5 group-hover:border-blue-500 transition-all">
</div>
...
<svg className="lucide lucide-command h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-figma h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-asterisk h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-link h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-aperture h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-300 lottie-stroke" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-toggle-right group-hover:text-white transition-all duration-300 lottie-stroke w-[32px] h-[32px]" data-icon-replaced="true" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(255, 255, 255)', width: '32px', height: '32px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<rect className="" height="12" rx="6" ry="6" width="20" x="2" y="6"></rect>
<circle className="" cx="16" cy="12" r="2"></circle>
</svg>
</div>
</div>
</div>
...
<div className="absolute inset-0 flex items-center justify-center">
<div className="center-ray-horizontal center-ray-left bg-gradient-to-l from-blue-400/80 via-blue-400/60 to-transparent w-14 gap-x-32 gap-y-32"></div>
</div>
...
<div className="absolute inset-0 flex items-center justify-center">
<div className="flex bg-blue-600 w-16 h-16 rounded-full ring-[#020215] ring-8 relative shadow-[0_0_40px_rgba(37,99,235,0.65)] gap-x-32 gap-y-32 items-center justify-center">
...
<svg className="text-slate-400 group-hover:text-white transition-colors" fill="none" height="28" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-check-circle-2 h-5 w-5 text-blue-500" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
<span className="">Type-safe policy definitions</span>
</li>
<li className="flex items-center gap-3 text-base text-slate-300">
<svg className="lucide lucide-check-circle-2 h-5 w-5 text-blue-500" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
<span className="">Integrates with Terraform &amp; Pulumi</span>
</li>
<li className="flex items-center gap-3 text-base text-slate-300">
<svg className="lucide lucide-check-circle-2 h-5 w-5 text-blue-500" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
...
<span className="text-xs font-medium text-indigo-300">Sentrix Assistant</span>
</div>
...
<svg className="lucide lucide-sparkles h-3 w-3 text-indigo-400" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
</div>
...
<span className="text-yellow-200">RevenueCard</span>
                        () {
                      </p>
<p className="pl-4">
...
<div className="p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:border-white/20 transition-colors flex flex-col">
...
<a className="block w-full py-3 px-4 bg-white/5 hover:bg-white/10 text-white text-center rounded-lg font-medium transition-colors" href="#">
                Get Started
              </a>
</div>

<div className="p-8 rounded-2xl border border-blue-500/50 bg-blue-900/10 relative flex flex-col">
<div className="-translate-y-1/2 uppercase text-xs font-bold text-white tracking-wider bg-blue-500 rounded-full pt-1 pr-3 pb-1 pl-3 absolute top-0 right-1/2 translate-x-1/2">
                Popular
              </div>
...
<a className="block w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white text-center rounded-lg font-medium transition-colors shadow-lg shadow-blue-500/25" href="#">
                Start Free Trial
              </a>
</div>
...
<details className="group border border-white/10 bg-white/[0.02] rounded-xl open:bg-white/[0.04] transition-all">
...
<div className="px-6 pb-6 text-slate-400 leading-relaxed">
                NeonShield integrates directly with your CI/CD pipeline via a
                simple config file. It takes less than 5 minutes to set up and
                start monitoring your infrastructure drift and security
                policies.
              </div>
</details>
<details className="group border border-white/10 bg-white/[0.02] rounded-xl open:bg-white/[0.04] transition-all">
...
<div className="px-6 pb-6 text-slate-400 leading-relaxed">
                Absolutely. We never store your source code. Our agent analyzes
                metadata and configuration patterns locally within your
                environment and only sends anonymized telemetry for the
                dashboard.
              </div>
</details>
<details className="group border border-white/10 bg-white/[0.02] rounded-xl open:bg-white/[0.04] transition-all">
<summary className="flex cursor-pointer list-none font-medium text-white pt-6 pr-6 pb-6 pl-6 items-center justify-between">
<span>Do you offer on-premise deployment?</span>
<svg className="w-5 h-5 text-slate-500 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path d="M19 9l-7 7-7-7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</summary>
<div className="px-6 pb-6 text-slate-400 leading-relaxed">
                Yes, our Enterprise plan includes an option for self-hosted
                runners and on-premise control planes for air-gapped
                environments. Contact sales for details.
              </div>
</details>
</div>
</div>
...
<p className="mx-auto mt-6 max-w-xl text-lg text-slate-400">
          Join the thousands of developers who have switched to NeonShield for a
          safer, faster, and more reliable infrastructure.
        </p>
<div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
<a className="inline-flex h-12 items-center justify-center rounded-full bg-white px-8 text-sm font-semibold text-black transition-transform hover:scale-105 hover:bg-slate-200" href="#">
            Get Started for Free
          </a>
<a className="inline-flex h-12 items-center justify-center rounded-full px-8 text-sm font-medium text-white hover:bg-white/5 transition-colors" href="#">
            Contact Sales
          </a>
</div>
</section>
...
<span className="text-xl font-bold text-white tracking-tight">SENTRIX</span>
</a>
<p className="text-slate-400 text-sm leading-relaxed max-w-xs mb-8">
              The first unified security platform designed for engineering
              teams. Secure your infrastructure at the speed of code.
            </p>
...
<li>
<a className="text-slate-400 hover:text-blue-400 transition-colors" href="#features">
                  Features
                </a>
</li>
<li>
<a className="text-slate-400 hover:text-blue-400 transition-colors" href="#integration">
                  Integrations
                </a>
</li>
<li>
<a className="text-slate-400 hover:text-blue-400 transition-colors" href="#pricing">
                  Pricing
                </a>
</li>
</ul>
...
<p className="text-xs text-slate-500">
            © 2024 NeonShield Inc. All rights reserved.
          </p>
<div className="flex items-center gap-2">

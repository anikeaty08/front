...
<a className="hidden md:block font-['Tenor_Sans',sans-serif] text-xs tracking-[0.2em] uppercase text-[#5c2035] no-underline hover:text-[#e8a0b4] transition-colors duration-300" href="#about">
          Fragments
        </a>
<a className="hidden md:block uppercase no-underline hover:text-[#e8a0b4] transition-colors duration-300 text-xs text-[#5c2035] tracking-[0.2em] font-['Tenor_Sans',sans-serif]" href="#cta">
          Playlist
        </a>
<div className="font-['Tenor_Sans',sans-serif] text-xs tracking-[0.15em] text-[#5c2035] tabular-nums" id="navTime">
          16:38:22
        </div>
</div>
</nav>
...
<h1 className="md:text-[13vw] leading-[0.88] animate-slide-up-2 text-7xl text-[#f5ece8] tracking-tighter font-['Cormorant_Garamond',serif]">
        Welcome
        <br/>
</h1>
...
<div className="font-['Tenor_Sans',sans-serif] text-xs tracking-[0.25em] uppercase text-[#5c2035] [writing-mode:vertical-lr]">
          Scroll
        </div>
</div>
</section>
...
<h2 className="font-['Cormorant_Garamond',serif] text-5xl md:text-7xl font-light leading-[1.02] tracking-tighter text-[#f5ece8] reveal">
          ...
          behind
          <br/>
<em className="not-italic text-[#d4547a]">Un Esprit Curieux.</em>
</h2>
<div className="mt-16 reveal flex flex-col gap-8 w-full max-w-[320px]">
<div className="font-['Tenor_Sans',sans-serif] text-[10px] tracking-[0.25em] uppercase text-[#5c2035] mb-2">
            Current Obsessions
          </div>
<div className="flex flex-col">
<a className="group flex justify-between items-end py-4 border-b border-[#2a0812]/50 hover:border-[#5c2035] transition-colors duration-500 cursor-none" href="#book">
<div className="flex flex-col gap-1.5">
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.2em] uppercase text-[#5c2035] group-hover:text-[#d4547a] transition-colors duration-500">
                  Book
                </span>
<span className="font-['Cormorant_Garamond',serif] text-xl font-light text-[#e8a0b4] group-hover:text-[#f5ece8] transition-colors duration-500">
                  The Poetics of Space
                </span>
</div>
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.15em] text-[#5c2035]/60 group-hover:text-[#5c2035] transition-colors duration-500">
                amazon.com
              </span>
</a>
<a className="group flex justify-between items-end py-4 border-b border-[#2a0812]/50 hover:border-[#5c2035] transition-colors duration-500 cursor-none" href="#album">
<div className="flex flex-col gap-1.5">
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.2em] uppercase text-[#5c2035] group-hover:text-[#d4547a] transition-colors duration-500">
                  Album
                </span>
...
<a className="group flex justify-between items-end py-4 border-b border-[#2a0812]/50 hover:border-[#5c2035] transition-colors duration-500 cursor-none" href="#film">
<div className="flex flex-col gap-1.5">
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.2em] uppercase text-[#5c2035] group-hover:text-[#d4547a] transition-colors duration-500">
                  Film
                </span>
...
<a className="group flex justify-between items-end py-4 border-b border-[#2a0812]/50 hover:border-[#5c2035] transition-colors duration-500 cursor-none" href="#place">
<div className="flex flex-col gap-1.5">
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.2em] uppercase text-[#5c2035] group-hover:text-[#d4547a] transition-colors duration-500">
                  Place
                </span>
...
<a className="group flex justify-between items-end py-4 border-b border-[#2a0812]/50 hover:border-[#5c2035] transition-colors duration-500 cursor-none" href="#object">
<div className="flex flex-col gap-1.5">
<span className="font-['Tenor_Sans',sans-serif] text-[9px] tracking-[0.2em] uppercase text-[#5c2035] group-hover:text-[#d4547a] transition-colors duration-500">
                  Object
                </span>
...
<div className="pt-2">
<p className="md:text-4xl leading-relaxed reveal text-3xl text-[#f5ece8] tracking-tighter font-['Cormorant_Garamond',serif] mb-12">
          Observing is also a form of
          <em className="italic text-[#d4547a]">expression.</em>
</p>
<div className="flex flex-col gap-24 my-24 reveal">
<div className="group relative w-full md:w-[80%] ml-auto cursor-none">
<div className="overflow-hidden aspect-[3/4] bg-[#110008]">
<div className="w-full h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cdaa3547-e8c6-425d-bfc0-19c7c30bb842_800w.jpg)] bg-cover bg-center transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.05]"></div>
<div className="absolute inset-0 bg-gradient-to-t from-[#04000a] via-[#04000a]/20 to-[#04000a]/40 pointer-events-none transition-opacity duration-[2s] group-hover:opacity-60"></div>
</div>
<div className="absolute -bottom-6 left-4 md:-left-12 font-['Tenor_Sans',sans-serif] text-[10px] tracking-[0.25em] uppercase text-[#5c2035] flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6 transition-all duration-700 group-hover:text-[#d4547a]">
<span className="font-['Cormorant_Garamond',serif] text-sm italic text-[#2a0812] group-hover:text-[#d4547a] transition-colors duration-700">
                01
              </span>
<span>Visual Archive — I</span>
</div>
</div>
<div className="group relative w-full md:w-[65%] mr-auto cursor-none">
<div className="overflow-hidden aspect-[2/3] bg-[#110008]">
<div className="w-full h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/66e55e56-9c23-4c36-a926-77044f27b908_800w.png)] bg-cover bg-center transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.05]"></div>
<div className="absolute inset-0 bg-gradient-to-t from-[#04000a] via-[#04000a]/20 to-[#04000a]/40 pointer-events-none transition-opacity duration-[2s] group-hover:opacity-60"></div>
</div>
<div className="absolute -bottom-6 right-4 md:-right-12 font-['Tenor_Sans',sans-serif] text-[10px] tracking-[0.25em] uppercase text-[#5c2035] flex flex-col md:flex-row items-end md:items-center gap-2 md:gap-6 transition-all duration-700 group-hover:text-[#d4547a] text-right">
<span>Solitude Study</span>
<span className="font-['Cormorant_Garamond',serif] text-sm italic text-[#2a0812] group-hover:text-[#d4547a] transition-colors duration-700">
                02
              </span>
</div>
</div>
<div className="group relative w-full md:w-[75%] mx-auto cursor-none">
<div className="overflow-hidden aspect-[3/4] bg-[#110008]">
<div className="w-full h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/29592b70-5289-4a61-a3f4-b1e539b4e07b_800w.png)] bg-cover bg-center transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.05]"></div>
<div className="absolute inset-0 bg-gradient-to-t from-[#04000a] via-[#04000a]/20 to-[#04000a]/40 pointer-events-none transition-opacity duration-[2s] group-hover:opacity-60"></div>
</div>
<div className="absolute -bottom-6 left-1/2 -translate-x-1/2 font-['Tenor_Sans',sans-serif] text-[10px] tracking-[0.25em] uppercase text-[#5c2035] flex items-center gap-6 transition-all duration-700 group-hover:text-[#d4547a] w-max">
<span className="font-['Cormorant_Garamond',serif] text-sm italic text-[#2a0812] group-hover:text-[#d4547a] transition-colors duration-700">
                03
              </span>
...
<div className="transition-colors duration-300 group-hover:text-[#d4547a] text-2xl font-light text-[#f5ece8] tracking-tight font-['Cormorant_Garamond',serif]">
              Pyar chahiye?
            </div>
<div className="uppercase text-xs text-red-500 tracking-[0.15em] font-['Tenor_Sans',sans-serif] text-right max-w-[200px]">
              NO need
            </div>
</div>
...
<div className="font-['Cormorant_Garamond',serif] text-5xl italic font-extralight text-[#d4547a]">
            Un Esprit Curieux
          </div>
</div>
</div>
...
<div className="md:text-6xl reveal text-4xl text-[#f5ece8] tracking-tighter font-['Cormorant_Garamond',serif] mb-1">
        ISS IT YOUR BRAIN OR SOUL??
      </div>
...
<div className="uppercase text-xs text-[#5c2035] tracking-[0.18em] font-['Tenor_Sans',sans-serif]">
        © 2025 Un Esprit Curieux
      </div>

...
<p className="text-[#a19f9a] text-base font-light mb-6 leading-relaxed">
                        At Dark, a private event is more than just a reservation—it is a carefully orchestrated experience. We combine cinematic atmospheres, world-class culinary execution, and anticipatory service to create moments that linger long after the final toast.
                    </p>
...
<img alt="Details" className="w-full h-48 object-cover rounded-sm grayscale opacity-70 md:hidden mt-8" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
</div>
...
<img alt="The Emerald Room" className="w-full h-full object-cover img-zoom opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
</div>
...
<img alt="The Terrace Suite" className="w-full h-full object-cover img-zoom opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
</div>
</div>
</div>
</div>
...
<h2 className="font-serif text-3xl md:text-4xl font-medium tracking-tight text-white mb-2">A Glimpse of Dark</h2>
...
<img alt="Restaurant Interior" className="w-full h-full object-cover img-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp"/>
</div>
<div className="img-zoom-container h-[145px] md:h-[292px] rounded-sm reveal delay-100">
<img alt="Wine" className="w-full h-full object-cover img-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
</div>
<div className="img-zoom-container h-[145px] md:h-[292px] rounded-sm reveal delay-200">
<img alt="Table Setting" className="w-full h-full object-cover img-zoom" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
</div>
<div className="img-zoom-container h-[145px] md:h-[292px] rounded-sm reveal delay-100">
...
<p className="text-[#a19f9a] font-light text-sm max-w-md">Thank you for considering Dark for your event. Our events team is reviewing your details and will be in touch within 24 hours.</p>
...
<span className="w-2 h-2 rounded-full bg-gold"></span>DARK
                    </a>
...
<p className="text-[#555] text-xs font-light">© 2023 Dark Dining. All rights reserved.</p>

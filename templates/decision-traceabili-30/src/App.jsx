...
<div className="fixed inset-0 z-0 opacity-100" id="canvas-container"><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="912" style={{display: 'block', width: '768px', height: '912px'}} width="768"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="985" style={{display: 'block', width: '1872px', height: '985px'}} width="1872"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas><canvas height="852" style={{display: 'block', width: '393px', height: '852px'}} width="393"></canvas></div>
...
<span className="text-obsidian text-sm font-bold tracking-tight font-sans">Temis</span>
</div>
...
<span className="text-[11px] text-subtle font-medium tracking-tight font-sans">Temis v0.2 Disponible</span>
</div>
<h1 className="text-obsidian leading-[0.95] md:text-7xl lg:text-6xl text-4xl font-semibold tracking-tighter font-sans">Velocidad <span className="text-subtle">de IA,</span><br className=""/> Criterio <span className="text-subtle">de Abogado.</span></h1><p className="text-subtle leading-relaxed text-base font-sans max-w-md">El departamento legal siempre disponible. Envía consultas, recibe respuestas validadas por abogados senior y escala sin fricciones legales.</p>
</div>
...
<div className="flex border-border/50 border-b items-center justify-between">
<div className="flex items-center gap-2">
<div className="w-3 h-3 rounded-full bg-border"></div>
<span className="text-[10px] uppercase text-subtle font-semibold tracking-wider">Nuestra Plataforma</span>
</div>
<div className="flex gap-2">
<span className="w-12 h-1.5 rounded-full bg-border/50"></span>
</div>
</div>
<div className="flex-1 relative min-w-0 flex items-center justify-center overflow-hidden">


<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[9px] sm:text-[10px] font-medium text-white bg-slate-950 rounded px-2 py-1 sm:px-3 sm:py-1.5 shadow-xl">
  Confianza: 99%
</div><svg className="w-full h-auto" data-icon-replaced="true" preserveaspectratio="xMidYMid meet" strokeWidth="2" style={{maxWidth: '100%', height: 'auto', display: 'block', color: 'rgb(17, 17, 17)'}} viewbox="0 0 400 300">
<style>
...
<path className="" d="M50,150 C100,150 100,80 150,80" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>
<path className="" d="M150,80 C200,80 200,120 250,120" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>
...
<path className="" d="M150,220 C200,220 200,180 250,180" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>
<path d="M250,180 L320,150" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>


<path className="signal-path" d="M50,150 C100,150 100,80 150,80 C200,80 200,120 250,120 L320,150" fill="none" stroke="#111" strokeWidth="2.5"></path>

<path className="signal-path-bottom" d="M50,150 C100,150 100,220 150,220 C200,220 200,180 250,180 L320,150" fill="none" stroke="#111" strokeWidth="2.5"></path>

<circle className="node-context" cx="50" cy="150" fill="#111" r="6"></circle>
<text fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" text-anchor="middle" x="50" y="175">Consulta</text>
<rect className="node-assumptions" fill="white" height="20" rx="4" stroke="#111" strokeWidth="1.5" width="80" x="150" y="70"></rect>
<text className="" dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="190" y="83">IA Propietaria</text>
<rect className="" fill="white" height="20" rx="4" stroke="#E5E5E5" width="80" x="150" y="210"></rect>
<text className="" dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="190" y="222">BBDD Cliente</text>
<rect className="" fill="white" height="20" rx="4" stroke="#E5E5E5" width="60" x="230" y="170"></rect>
<text dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="260" y="180">Memoria</text>
<rect className="node-evidence" fill="white" height="20" rx="4" stroke="#111" strokeWidth="1.5" width="60" x="250" y="110"></rect>
<text dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="280" y="123">Abogados</text>
...
<text fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" text-anchor="middle" x="320" y="178">Solución</text>
<svg className="w-full h-auto max-w-full" data-icon-replaced="true" preserveaspectratio="xMidYMid meet" strokeWidth="2" style={{display: 'block', maxWidth: '100%', height: 'auto'}} viewbox="0 0 400 300">
  ...
</svg>
</svg></div>
</div>
...
<span className="text-obsidian text-lg font-bold tracking-tight font-sans">
              VERCEL
            </span>
...
<div className="pt-8 pb-8 relative space-y-16">
...
<span className="">Pivot Approved</span>
...
<div className="h-full bg-obsidian w-0 transition-all duration-700 ease-in-out" id="def-line-fill" style={{width: '80%'}}></div>
</div>
...
<div className="">
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-0">5x</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out" id="t-stat-lbl-0">Faster Consensus</div>
</div>
<div className="">
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-1">100%</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out" id="t-stat-lbl-1">Audit Coverage</div>
</div>
<div className="">
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-2">Zero</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out" id="t-stat-lbl-2">Ambiguity</div>
</div>
</div>
</div>
</div>

...
<div className="fixed inset-0 z-0 opacity-100" id="canvas-container"><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1568" style={{display: 'block', width: '1072px', height: '784px'}} width="2144"></canvas><canvas height="1704" style={{display: 'block', width: '393px', height: '852px'}} width="786"></canvas></div>
...
<span className="text-obsidian text-sm font-bold tracking-tight font-sans" style={{}}>Minrond</span>
</div>
<nav className="hidden md:flex items-center gap-8">
<a className="text-subtle hover:text-obsidian transition-colors text-xs font-medium font-sans" href="/#" style={{}}>Testy</a>
<a className="text-xs font-medium text-subtle hover:text-obsidian transition-colors font-sans" href="#" style={{}}>
          Solutions
        </a>
<a className="text-xs font-medium text-subtle hover:text-obsidian transition-colors font-sans" href="#" style={{}}>
          Research
...
<a className="hidden md:block text-xs font-medium text-subtle hover:text-obsidian transition-colors font-sans" href="#" style={{}}>
          Sign in
        </a>
...
<span className="relative z-20 font-sans" style={{}}>Start Trial</span>
</button>
</div>
</header>
...
<span className="text-[11px] font-medium text-subtle tracking-tight font-sans" style={{}}>
                System v2.4 Available
              </span>
</div>
<h1 className="md:text-7xl lg:text-8xl text-obsidian leading-[0.95] text-6xl font-semibold tracking-tighter font-sans">
              Decision
              
              <span className="text-subtle" style={{}}>Traceability.</span>
</h1>
<p className="max-w-md text-base text-subtle leading-relaxed font-sans" style={{}}>
...
<span className="relative z-10 font-sans" style={{}}>Request Demo</span>
...
<span className="text-[10px] uppercase tracking-wider font-semibold text-subtle font-sans" style={{}}>
...
<style className="font-sans" style={{}}>
                    .signal-path {
...
<text className="font-sans" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" style={{}} text-anchor="middle" x="50" y="175">
                    Context
                  </text>
<rect className="node-assumptions" fill="white" height="20" rx="4" stroke="#111" strokeWidth="1.5" width="80" x="150" y="70"></rect>
<text className="font-sans" dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" style={{}} text-anchor="middle" x="190" y="83">
                    Assumptions
                  </text>
...
<text className="font-sans" dy="1" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" style={{}} text-anchor="middle" x="280" y="123">
                    Evidence
                  </text>
...
<text className="font-sans" fill="#111" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" style={{}} text-anchor="middle" x="320" y="178">
                    Outcome
                  </text>
</svg>

<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-obsidian text-white text-[10px] font-medium px-3 py-1.5 rounded shadow-xl font-sans" style={{}}>
                  Confidence: 98.4%
                </div>
</div>
</div>
...
<p className="text-xs font-semibold text-obsidian whitespace-nowrap md:w-auto w-full text-center md:text-left font-sans" style={{}}>
...
<span className="text-lg font-bold text-obsidian tracking-tight font-sans" style={{}}>
              VERCEL
            </span>
<span className="text-lg font-bold text-obsidian tracking-tight font-sans" style={{}}>
              stripe
...
<div className="text-center mb-12 shrink-0 opacity-0 transition-opacity duration-700" id="lifecycle-header" style={{opacity: '1'}}>
<h2 className="font-sans text-2xl md:text-3xl font-semibold text-obsidian tracking-tight mb-3" style={{}}>
                Traceability Lifecycle
              </h2>
<p className="text-subtle text-sm max-w-md mx-auto font-sans" style={{}}>
...
<div className="absolute left-1/2 top-4 w-px bg-obsidian -translate-x-1/2 transition-all duration-75 ease-linear h-0 max-h-[calc(100%-2rem)]" id="lifecycle-line" style={{height: '20.2074%'}}></div>
<div className="space-y-16 py-8 relative">
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.1" style={{transform: 'scale(1.05)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle uppercase tracking-wider block mb-1 font-sans" style={{}}>
                      01 Context
                    </span>
<h3 className="text-base font-semibold text-obsidian font-sans" style={{}}>
                      Decision Trigger
                    </h3>
<p className="text-xs text-subtle mt-1 hidden md:block font-sans" style={{}}>
...
<span className="text-xs font-medium text-obsidian font-sans" style={{}}>
...
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.25" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<div className="bg-white border border-border p-3 rounded shadow-sm inline-block text-left">
<span className="text-[10px] text-subtle block mb-1 font-sans" style={{}}>
                        Assumption
                      </span>
<span className="text-xs font-medium text-obsidian font-sans" style={{}}>
...
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.4" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle uppercase tracking-wider block mb-1 font-sans" style={{}}>
                      03 Data
                    </span>
...
<div>
<div className="text-[10px] text-subtle font-sans" style={{}}>
                          Q3 Churn Analysis
                        </div>
<div className="text-xs font-bold text-obsidian font-sans" style={{}}>
                          Churn up 12%
                        </div>
</div>
</div>
...
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.55" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
...
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.7" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle uppercase tracking-wider block mb-1 font-sans" style={{}}>
                      05 Result
                    </span>
...
<span className="font-sans" style={{}}>Pivot Approved</span>
...
<div className="lifecycle-step group flex items-center justify-between w-full transition-all duration-500" data-threshold="0.85" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle bg-slate-100 px-2 py-1 rounded inline-block font-sans" style={{}}>
                      SHA: 8f2a...9c1
                    </span>
</div>
<div className="relative shrink-0 z-10">
...
<h2 className="font-sans text-4xl md:text-5xl font-semibold text-obsidian tracking-tight mb-6 leading-[1.1]" style={{}}>
                Structured reasoning.
                <span className="text-subtle block" style={{}}>Not just data points.</span>
</h2>
<p className="text-subtle text-lg leading-relaxed font-sans" style={{}}>
                Bridge the gap between raw analytics and executive decisions
                with a platform designed for defensibility.
              </p>
</div>
<a className="pb-1 border-b border-obsidian text-sm font-medium hover:opacity-70 transition-opacity mb-2 font-sans" href="#" style={{}}>
...
<h3 className="text-2xl font-semibold text-obsidian mb-3" style={{}}>
                      Decision Lineage
                    </h3>
<p className="text-subtle leading-relaxed font-sans" style={{}}>
                      Traverse the reasoning graph from outcome to assumption.
                      Every node is traceable.
                    </p>
</div>
<div className="hidden lg:block">
<div className="px-3 py-1 bg-canvas border border-border rounded text-[10px] font-mono text-subtle uppercase tracking-wider group-hover:text-obsidian group-hover:border-obsidian/30 transition-colors font-sans" style={{}}>
                      Live Trace
                    </div>
</div>
</div>
...
<text className="text-[8px] font-mono fill-subtle opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-sans" style={{}} text-anchor="middle" x="20" y="70">
                        INPUT
                      </text>
</g>
...
<circle className="" cx="200" cy="20" fill="#fff" r="4" stroke="#111" strokeWidth="1.5"></circle>
<text className="text-[8px] font-mono fill-subtle opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-sans" style={{}} text-anchor="middle" x="200" y="40">
                        LOGIC A
                      </text>
</g>
...
<text className="text-[8px] font-mono fill-subtle opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-sans" style={{}} text-anchor="middle" x="380" y="100">
                        LOGIC B
                      </text>
</g>
...
<text className="text-[8px] font-mono fill-obsidian font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-sans" style={{}} text-anchor="middle" x="560" y="70">
                        RESULT
                      </text>
</g>
</svg>
...
<h3 className="text-xl font-semibold text-obsidian mb-3 font-sans" style={{}}>
                  Immutable Audit
                </h3>
<p className="text-sm text-subtle leading-relaxed mb-8 font-sans" style={{}}>
...
<span className="text-[10px] font-bold text-obsidian uppercase tracking-wide font-sans" style={{}}>
                          Current State
                        </span>
<span className="text-[10px] font-mono text-subtle font-sans" style={{}}>
                          v2.4.1
                        </span>
</div>
...
<h3 className="text-xl font-semibold text-obsidian mb-2 font-sans" style={{}}>
                    Automated Synthesis
                  </h3>
<p className="text-subtle leading-relaxed font-sans" style={{}}>
...
<h2 className="font-sans text-3xl font-semibold text-obsidian tracking-tight mb-4" style={{}}>
                How a Decision Becomes Defensible
              </h2>
<p className="text-subtle text-base leading-relaxed font-sans" style={{}}>
...
<div className="h-full bg-obsidian w-0 transition-all duration-700 ease-in-out" id="def-line-fill" style={{width: '0%'}}></div>
</div>
...
<div className="def-num w-9 h-9 bg-white border border-border rounded flex items-center justify-center text-[10px] font-mono font-medium text-subtle shadow-sm transition-all duration-500 z-10 font-sans" style={{}}>
                    01
                  </div>
<div className="h-px flex-1 bg-border/60 lg:hidden"></div>
</div>
<div className="def-content transition-all duration-500">
<h3 className="text-sm font-semibold text-obsidian mb-1.5 font-sans" style={{}}>
                    Decision Context
                  </h3>
<p className="text-xs text-subtle leading-relaxed font-sans" style={{}}>
...
<h2 className="text-4xl font-semibold tracking-tighter mb-8" style={{}}>
...
<div>
<div className="font-medium text-white font-sans" style={{}}>Marcus Alvarez</div>
<div className="text-sm text-white/50 font-sans" style={{}}>
                          Lead Analyst, Stripe
                        </div>
</div>
</div>
...
<div>
<div className="font-medium text-white font-sans" style={{}}>Sarah Chen</div>
<div className="text-sm text-white/50 font-sans" style={{}}>
...
<div>
<div className="font-medium text-white font-sans" style={{}}>David Ross</div>
<div className="text-sm text-white/50 font-sans" style={{}}>COO, Linear</div>
</div>
</div>
</div>
</div>
...
<div>
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-0" style={{}}>5x</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out font-sans" id="t-stat-lbl-0" style={{}}>Faster Consensus</div>
</div>
<div className="">
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-1" style={{}}>100%</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out font-sans" id="t-stat-lbl-1" style={{}}>Audit Coverage</div>
</div>
<div>
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform" id="t-stat-val-2" style={{}}>Zero</div>
<div className="text-sm text-white/50 transition-opacity duration-300 ease-out font-sans" id="t-stat-lbl-2" style={{}}>Ambiguity</div>
</div>
</div>
</div>
</div>
...
<section className="md:px-12 lg:px-20 border-border border-b pt-32 pr-6 pb-32 pl-6">
<div className="max-w-5xl mx-auto">
<div className="text-center mb-16">
<h2 className="font-sans text-3xl md:text-4xl font-semibold text-obsidian tracking-tight mb-4" style={{}}>
              Transparent Pricing
            </h2>
<p className="text-subtle text-base font-sans" style={{}}>
...
<span className="font-semibold text-obsidian transition-colors group-[.selected]:text-black font-sans" style={{}}>
                  Individual
                </span>
</div>
<div className="mb-4 flex items-baseline gap-1 relative z-10">
<span className="text-3xl font-semibold text-obsidian" style={{}}>$49</span>
<span className="text-sm text-subtle font-sans" style={{}}>/mo</span>
</div>
<p className="text-sm text-subtle mb-8 leading-relaxed relative z-10 font-sans" style={{}}>
                For solo analysts, product owners, or researchers exploring
                decision traceability.
              </p>
<ul className="space-y-4 mb-8 flex-1 relative z-10">
<li className="flex gap-3 text-sm text-subtle font-sans" style={{}}>
<span className="text-obsidian font-sans" style={{}}>✓</span>
...
<button className="w-full py-3 rounded-lg border border-border text-xs font-semibold text-obsidian bg-white transition-all duration-300 ease-out hover:scale-[1.03] hover:border-obsidian hover:shadow-[0_0_15px_rgba(0,0,0,0.05)] active:scale-[0.97] active:duration-100 relative z-10 font-sans" style={{}}>
                Start Trial
              </button>
</div>
...
<div className="mb-4">
<span className="font-semibold font-sans" style={{}}>Team</span>
</div>
<div className="mb-4 flex items-baseline gap-1">
<span className="text-3xl font-semibold" style={{}}>Contact Sales</span>
</div>
<p className="text-sm text-white/60 mb-8 leading-relaxed font-sans" style={{}}>
                For teams formalizing shared decisions, reviews, and internal
                accountability.
              </p>
<ul className="space-y-4 mb-8 flex-1">
<li className="flex gap-3 text-sm text-white/80 font-sans" style={{}}>
<span className="text-white font-sans" style={{}}>✓</span>
...
<button className="w-full py-3 rounded-lg bg-white text-obsidian text-xs font-semibold transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] active:scale-[0.97] active:duration-100 relative z-10 font-sans" style={{}}>
                Contact Sales
              </button>
</div>

<div className="pricing-card group relative p-8 rounded-xl border border-border bg-white flex flex-col cursor-pointer hover:-translate-y-1 hover:shadow-xl hover:border-obsidian/30 focus:outline-none focus:ring-2 focus:ring-obsidian focus:ring-offset-2 pricing-transition scale-[0.98] opacity-60" id="pricing-ent" role="button" tabindex="0">

<div className="absolute inset-0 rounded-xl bg-gradient-to-b from-obsidian/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
<div className="mb-4 relative z-10">
<span className="font-semibold text-obsidian font-sans" style={{}}>Enterprise</span>
</div>
<div className="mb-4 flex items-baseline gap-1 relative z-10">
<span className="text-3xl font-semibold text-obsidian" style={{}}>
                  Contact Sales
                </span>
</div>
<p className="text-sm text-subtle mb-8 leading-relaxed relative z-10 font-sans" style={{}}>
...
<span className="font-bold text-sm tracking-tight text-obsidian font-sans" style={{}}>
                ORAVIA
              </span>
</div>
<p className="text-xs text-subtle leading-relaxed font-sans" style={{}}>
...
<div className="text-[10px] text-border font-sans" style={{}}>
              © 2024 Oravia Systems Inc.
            </div>
</div>
<div className="flex gap-16">
<div className="space-y-4">
<h4 className="text-xs font-bold text-obsidian font-sans" style={{}}>Platform</h4>
<ul className="space-y-2 text-xs text-subtle">
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Features</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Security</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Enterprise</a></li>
</ul>
</div>
<div className="space-y-4">
<h4 className="text-xs font-bold text-obsidian font-sans" style={{}}>Company</h4>
<ul className="space-y-2 text-xs text-subtle">
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>About</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Careers</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Contact</a></li>
</ul>
</div>
<div className="space-y-4">
<h4 className="text-xs font-bold text-obsidian font-sans" style={{}}>Connect</h4>
<ul className="space-y-2 text-xs text-subtle">
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>Twitter</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>LinkedIn</a></li>
<li><a className="hover:text-obsidian font-sans" href="#" style={{}}>GitHub</a></li>
</ul>
</div>
</div>
</div>

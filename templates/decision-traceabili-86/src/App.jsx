...
<div className="fixed inset-0 z-0 opacity-100" id="canvas-container"><canvas height="1724" style={{display: 'block', width: '1440px', height: '958px'}} width="2591"></canvas><canvas height="1724" style={{display: 'block', width: '1440px', height: '958px'}} width="2591"></canvas><canvas height="1724" style={{display: 'block', width: '1440px', height: '958px'}} width="2591"></canvas></div>
...
<section className="min-h-[90vh] flex flex-col lg:flex-row md:px-12 lg:px-20 gap-16 pt-32 pr-6 pb-20 pl-6 relative gap-x-16 gap-y-16 items-center justify-between">
...
<h1 className="md:text-7xl lg:text-8xl text-obsidian leading-[0.95] text-6xl font-semibold tracking-tighter font-sans">We Design <span className="text-subtle">Decisions</span></h1>

...
<a className="flex items-center gap-2 px-3 group" href="#">
...
<a className="bg-white text-black px-4 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1 hover:bg-gray-200 transition-colors shadow-lg shadow-emerald-500/10" href="#">
          Start Engine
          <svg className="lucide lucide-arrow-right w-3 h-3 ml-0.5" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
</nav>
...
<button aria-label="Initialize" className="btn md:px-8 md:py-3 focus:outline-none sm:w-auto w-full h-full pt-3 pr-5 pb-3 pl-5" title="Initialize" type="button">

<svg aria-hidden="true" className="btn-svg" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="2"></path>
</svg>
...
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="36" icon="logos:vercel" width="96"></iconify-icon>
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="36" icon="logos:stripe" width="80"></iconify-icon>
...
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="36" icon="logos:microsoft" width="96"></iconify-icon>
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="30" icon="logos:google" width="90"></iconify-icon>
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="36" icon="simple-icons:github" width="80"></iconify-icon>
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="30" icon="logos:airbnb" width="96"></iconify-icon>
<iconify-icon className="grayscale brightness-50 opacity-60 hover:opacity-100 hover:grayscale-0 transition-all duration-300" height="30" icon="logos:linear" width="96"></iconify-icon>
</div>
...
<iconify-icon className="text-xs text-emerald-400" icon="solar:layers-minimalistic-linear"></iconify-icon>
...
<iconify-icon className="text-blue-400 text-xs" icon="solar:chip-linear"></iconify-icon>
...
<circle cx="64" cy="64" fill="none" r="60" stroke="#27272a" strokeWidth="4"></circle>
<circle className="transition-all duration-1000 ease-out" cx="64" cy="64" fill="none" r="60" stroke="#10b981" stroke-dasharray="377" stroke-dashoffset="100" strokeWidth="4"></circle>
</svg>
...
<iconify-icon className="text-[10px]" icon="solar:bell-linear"></iconify-icon>
...
<line stroke="#333" strokeWidth="0.5" x1="0" x2="100" y1="10" y2="10"></line>
<line stroke="#333" strokeWidth="0.5" x1="0" x2="100" y1="30" y2="30"></line>

<polyline fill="none" points="0,45 20,40 40,25 60,35 80,10 100,15" stroke="#10b981" strokeWidth="1.5"></polyline>

<polyline fill="none" points="0,40 20,35 40,38 60,25 80,30 100,20" stroke="#0ea5e9" strokeWidth="1.5"></polyline>

<circle cx="20" cy="40" fill="#10b981" r="1.5"></circle>
<circle cx="60" cy="35" fill="#10b981" r="1.5"></circle>
<circle cx="60" cy="25" fill="#0ea5e9" r="1.5"></circle>
</svg>
</div>
</div>
</div>
...
<iconify-icon height="30" icon="logos:chainlink" width="96"></iconify-icon>
<iconify-icon height="30" icon="logos:ethereum" width="96"></iconify-icon>
<iconify-icon height="30" icon="logos:consensys" width="96"></iconify-icon>
</div>
</div>
</div>
...
<iconify-icon className="text-emerald-400 drop-shadow-[0_0_25px_rgba(16,185,129,0.4)]" icon="solar:shield-check-linear" width="160"></iconify-icon>
</div>
...
<iconify-icon className="text-emerald-400 text-sm" icon="solar:lock-password-broken"></iconify-icon>
...
<iconify-icon className="text-blue-400 text-sm" icon="solar:code-scan-linear"></iconify-icon>
<span className="text-[10px] text-zinc-300 font-mono uppercase">
                        On-Chain Verified
                      </span>
</div>
...
<span className="relative z-10 flex items-center gap-2">
              Initialize Protocol
              <svg className="transition-transform group-hover:translate-x-1" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<a className="flex items-center gap-2 mb-6 group w-fit" href="#">

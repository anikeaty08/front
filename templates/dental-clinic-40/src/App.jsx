...
<a className="text-sm font-medium transition-colors text-slate-600 hover:text-emerald-600" href="#about">Chi Siamo</a>
<a className="text-sm font-medium transition-colors text-slate-600 hover:text-emerald-600" href="#team">Team</a>
<a className="text-sm font-medium transition-colors text-slate-600 hover:text-emerald-600" href="#services">Servizi</a>
<a className="text-sm font-medium transition-colors text-slate-600 hover:text-emerald-600" href="#contact">Contatti</a>
</div>
...
<h1 className="text-5xl lg:text-7xl font-semibold tracking-tighter leading-[1.1] text-slate-900">
                        Il tuo percorso verso un <br/>
<span className="text-transparent bg-clip-text bg-gradient-to-r to-teal-500 from-emerald-600">Sorriso Sicuro</span> inizia qui.
                    </h1>
<p className="text-lg md:text-xl text-slate-500 font-medium max-w-lg leading-relaxed">
                        Sperimenta cure dentali di classe mondiale progettate per il tuo comfort. Combiniamo tecnologia avanzata con un tocco gentile per far risplendere il tuo sorriso migliore.
                    </p>
...
<p className="text-sm font-medium mt-1 text-slate-600">Scelto da <span className="font-semibold text-slate-900">20k+ Pazienti</span></p>
</div>
</div>
</div>
...
<img alt="Trattamento Dentale" className="w-full h-[600px] object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&amp;w=2068&amp;auto=format&amp;fit=crop"/>
...
<svg className="lucide lucide-check-circle-2 w-3.5 h-3.5" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg> Cure di Qualità
                            </span>
<span className="inline-flex items-center gap-1.5 backdrop-blur-md px-3 py-1.5 rounded-full text-xs font-semibold shadow-lg bg-white/90 text-emerald-800">
<svg className="lucide lucide-zap w-3.5 h-3.5" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg> Tecnologia Moderna
                            </span>
</div>
...
<div>
<p className="text-xs font-bold uppercase tracking-wider mb-1 text-emerald-600">La Nostra Promessa</p>
<p className="font-medium text-slate-900">Il tuo comfort, la nostra priorità.</p>
</div>
...
<p className="text-xl font-medium mb-4">Scelta dei Pazienti</p>
<p className="text-sm leading-relaxed text-emerald-100">Ci dedichiamo al tuo comfort e alla tua salute, rendendoci una scelta top nella regione.</p>
</div>

<div className="p-6 md:p-8">
<h3 className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 text-white">25K+</h3>
<p className="font-medium mb-2 text-emerald-400">Pazienti Felici</p>
<p className="text-sm text-emerald-100/60">Raggiungiamo sorrisi più sani e luminosi ogni singolo giorno.</p>
</div>

<div className="p-6 md:p-8">
<h3 className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 text-white">15K+</h3>
<p className="font-medium mb-2 text-emerald-400">Trattamenti Riusciti</p>
<p className="text-sm text-emerald-100/60">Completati con tecniche avanzate e massima cura.</p>
</div>

<div className="p-6 md:p-8">
<h3 className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 text-white">20A+</h3>
<p className="font-medium mb-2 text-emerald-400">Anni di Esperienza</p>
<p className="text-sm text-emerald-100/60">Anni di servizio dentale esperto e compassionevole.</p>
</div>
</div>
</div>
</section>
...
<h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight mb-6 text-slate-900">
                    I Nostri <span className="text-emerald-600">Servizi</span> Completi
                </h2>
<p className="text-lg text-slate-500 font-medium">
                    Offriamo una gamma completa di soluzioni dentali moderne su misura per ogni tua esigenza.
                </p>
</div>
...
<img alt="Odontoiatria Generale" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&amp;fit=crop&amp;q=80&amp;w=800"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Odontoiatria Generale</h3>
<p className="leading-relaxed text-base text-slate-500">Offriamo pulizia, otturazioni e cure preventive per un sorriso sano.</p>
</div>
</div>

<div className="group p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border relative overflow-hidden bg-white hover:shadow-emerald-900/5 border-slate-100">
<div className="relative h-56 rounded-2xl overflow-hidden bg-slate-100">
<img alt="Odontoiatria Estetica" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&amp;fit=crop&amp;q=80&amp;w=800"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Odontoiatria Estetica</h3>
<p className="leading-relaxed text-base text-slate-500">Ottieni il sorriso dei tuoi sogni con sbiancamento professionale e faccette.</p>
</div>
</div>

<div className="group p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border relative overflow-hidden bg-white hover:shadow-emerald-900/5 border-slate-100">
<div className="relative h-56 rounded-2xl overflow-hidden bg-slate-100">
<img alt="Chirurgia Orale" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Chirurgia Orale</h3>
<p className="text-slate-500 leading-relaxed text-base">Il nostro team fornisce cure delicate per tutte le esigenze chirurgiche orali complesse.</p>
</div>
</div>

<div className="group p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border relative overflow-hidden bg-white hover:shadow-emerald-900/5 border-slate-100">
<div className="relative h-56 rounded-2xl overflow-hidden bg-slate-100">
<img alt="Odontoiatria Pediatrica" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Odontoiatria Pediatrica</h3>
<p className="text-slate-500 leading-relaxed text-base">Forniamo cure dentali delicate e divertenti per i bambini per garantire sorrisi sani.</p>
</div>
</div>

<div className="group p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border relative overflow-hidden bg-white hover:shadow-emerald-900/5 border-slate-100">
<div className="relative h-56 rounded-2xl overflow-hidden bg-slate-100">
<img alt="Ortodonzia" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&amp;fit=crop&amp;q=80&amp;w=800"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Ortodonzia</h3>
<p className="text-slate-500 leading-relaxed text-base">Ottieni un sorriso perfettamente allineato con le nostre moderne soluzioni ortodontiche.</p>
</div>
</div>

<div className="group p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border relative overflow-hidden bg-white hover:shadow-emerald-900/5 border-slate-100">
<div className="relative h-56 rounded-2xl overflow-hidden bg-slate-100">
<img alt="Sedazione Cosciente" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&amp;fit=crop&amp;q=80&amp;w=800"/>
...
<h3 className="text-2xl font-semibold mb-3 tracking-tight text-slate-900 mt-2">Sedazione Cosciente</h3>
<p className="text-slate-500 leading-relaxed text-base">Vivi una visita senza stress con le nostre opzioni di sedazione sicure ed efficaci.</p>
</div>
</div>
</div>
</div>
...
<div className="">
<span className="inline-block px-3 py-1 rounded-full text-xs font-semibold mb-4 uppercase tracking-wider bg-slate-100 text-slate-600">Il Team</span>
<h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-4 text-slate-900">
                        Il Nostro Team <span className="text-emerald-500">Professionale</span>
</h2>
<p className="text-lg text-slate-500 font-medium max-w-xl">
                        Il nostro team si dedica a fornire la massima qualità di cura in un ambiente confortevole.
                    </p>
</div>
...
<p className="text-sm font-medium text-emerald-600">Odontoiatra</p>
</div>
</div>
...
<p className="text-sm font-medium text-emerald-600">Chirurgo Orale</p>
</div>
</div>
...
<span className="inline-block px-2 py-0.5 rounded-md backdrop-blur-md text-[10px] font-bold uppercase tracking-widest mb-2 bg-white/20">Capo Medico</span>
<h4 className="text-xl font-semibold">Dr. Sofia Rodriguez</h4>
<p className="text-sm font-medium text-emerald-100">Odontoiatra Estetico</p>
</div>
</div>
...
<p className="text-sm font-medium text-emerald-600">Ortodontista</p>
</div>
</div>
...
<p className="text-sm font-medium text-emerald-600">Dentista Pediatrico</p>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-4 text-slate-900">
                    Domande <span className="text-emerald-500">Frequenti</span>
</h2>
<p className="text-lg text-slate-500 font-medium">
                    Se hai domande, puoi consultare le nostre domande frequenti.
                </p>
</div>
...
<h2 className="text-lg font-semibold">Accettate assicurazioni dentali?</h2>
...
<p className="px-6 pb-6 text-slate-500 leading-relaxed font-medium">
                        Sì, accettiamo la maggior parte dei principali piani assicurativi dentali. Contatta il nostro ufficio con i dettagli della tua assicurazione e verificheremo la copertura per te.
                    </p>
</details>

<details className="group rounded-2xl shadow-sm [&amp;_summary::-webkit-details-marker]:hidden open:ring-1 open:ring-emerald-500/20 bg-white">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-slate-900">
<h2 className="text-lg font-semibold">Quanto spesso dovrei fare un controllo?</h2>
<div className="rounded-full p-1.5 text-emerald-500 transition duration-300 group-open:-rotate-180 bg-emerald-50">
<svg className="lucide lucide-chevron-down w-5 h-5" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
<p className="px-6 pb-6 text-slate-500 leading-relaxed font-medium">
                        Raccomandiamo di visitare il dentista ogni sei mesi per un controllo di routine e una pulizia per mantenere una salute orale ottimale.
                    </p>
</details>

<details className="group rounded-2xl shadow-sm [&amp;_summary::-webkit-details-marker]:hidden open:ring-1 open:ring-emerald-500/20 bg-white">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-slate-900">
<h2 className="text-lg font-semibold">Offrite appuntamenti di emergenza?</h2>
<div className="rounded-full p-1.5 text-emerald-500 transition duration-300 group-open:-rotate-180 bg-emerald-50">
<svg className="lucide lucide-chevron-down w-5 h-5" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
<p className="px-6 pb-6 text-slate-500 leading-relaxed font-medium">
                        Sì, riserviamo del tempo ogni giorno per le emergenze dentali. Chiamaci immediatamente se provi dolore o hai subito un trauma dentale.
                    </p>
</details>

<details className="group rounded-2xl shadow-sm [&amp;_summary::-webkit-details-marker]:hidden open:ring-1 open:ring-emerald-500/20 bg-white">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-slate-900">
<h2 className="text-lg font-semibold">Offrite odontoiatria estetica?</h2>
<div className="rounded-full p-1.5 text-emerald-500 transition duration-300 group-open:-rotate-180 bg-emerald-50">
<svg className="lucide lucide-chevron-down w-5 h-5" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
<p className="px-6 pb-6 text-slate-500 leading-relaxed font-medium">
                        Assolutamente. Offriamo faccette, sbiancamento dentale, bonding e rifacimenti completi del sorriso per aiutarti a ottenere il sorriso sicuro che desideri.
                    </p>
</details>

<details className="group rounded-2xl shadow-sm [&amp;_summary::-webkit-details-marker]:hidden open:ring-1 open:ring-emerald-500/20 bg-white">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 p-6 text-slate-900">
<h2 className="text-lg font-semibold">Posso prenotare il mio appuntamento online?</h2>
<div className="rounded-full p-1.5 text-emerald-500 transition duration-300 group-open:-rotate-180 bg-emerald-50">
<svg className="lucide lucide-chevron-down w-5 h-5" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
<p className="px-6 pb-6 text-slate-500 leading-relaxed font-medium">
                        Sì! Puoi utilizzare il nostro modulo di prenotazione online qui sotto per programmare la tua visita nell'orario che preferisci.
                    </p>
</details>
</div>
</div>
...
<img alt="Staff Medico" className="rounded-[2.5rem] shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500 object-cover border-4 border-emerald-900/50" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp"/>
...
<span className="font-bold text-lg">Prenotazione Rapida</span>
</div>
<p className="text-sm text-slate-500 font-medium">Ottieni la conferma del tuo appuntamento in meno di 2 minuti.</p>
</div>
</div>

<div>
<h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-4">
                        Inizia il tuo viaggio verso il sorriso con noi.
                    </h2>
<p className="font-medium mb-10 text-lg text-emerald-200/80">
                        Prenotare la tua prossima visita è semplice. Compila il modulo sottostante e confermeremo il tuo appuntamento a breve.
                    </p>
...
<input className="w-full border rounded-xl px-5 py-4 placeholder-emerald-400/60 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all bg-emerald-900/50 border-emerald-800 text-white" placeholder="Numero di Telefono" type="tel"/>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
<div className="relative">
...
<option className="text-slate-900">Seleziona Servizio</option>
<option className="text-slate-900">Controllo Generale</option>
<option className="text-slate-900">Pulizia</option>
<option className="text-slate-900">Sbiancamento</option>
</select>
...
<div className="relative">
<select className="w-full border rounded-xl px-5 py-4 placeholder-emerald-400/60 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 appearance-none cursor-pointer bg-emerald-900/50 border-emerald-800 text-white">
<option className="text-slate-900">Qualsiasi Dottore</option>
...
<p className="text-slate-500 font-medium leading-relaxed">
                        La tua destinazione per un sorriso sano e sicuro. Ci impegniamo a fornire cure eccezionali in un ambiente moderno.
                    </p>
...
<div>
<h4 className="font-bold mb-6 text-slate-900">Contattaci</h4>
...
<div>
<h4 className="font-bold mb-6 text-slate-900">Orari di Apertura</h4>
...
<div>
<h4 className="font-bold mb-6 text-slate-900">Servizi</h4>
<ul className="space-y-3 text-slate-500 font-medium">
<li><a className="hover:text-emerald-500 transition-colors" href="#">Odontoiatria Generale</a></li>
<li><a className="hover:text-emerald-500 transition-colors" href="#">Odontoiatria Estetica</a></li>
<li><a className="hover:text-emerald-500 transition-colors" href="#">Chirurgia Orale</a></li>
</ul>
</div>
</div>

<div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4 border-slate-200">
<p className="text-slate-500 font-medium text-sm">© 2024 Swarnim Dental Care. Tutti i Diritti Riservati.</p>
<div className="flex gap-8 text-sm font-medium text-slate-500">
<a className="hover:text-emerald-600" href="#">Privacy Policy</a>
<a className="hover:text-emerald-600" href="#">Termini &amp; Condizioni</a>
</div>
</div>
</div>
</footer>

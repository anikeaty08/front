...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '111.5px', '--mouse-y': '68px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '155.5px', '--mouse-y': '75px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '114.5px', '--mouse-y': '50px'}}>
...
<div className="carousel-card active lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2" id="card-0" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '909.5px', '--mouse-y': '274.96875px'}}>
...
<div className="carousel-card prev w-full lg:w-3/4 h-full glass-panel rounded-3xl p-2 spotlight-card cursor-pointer" id="card-2" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '742.219482421875px', '--mouse-y': '99.342529296875px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">

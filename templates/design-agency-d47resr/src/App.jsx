...
<aside className="lg:w-64 lg:fixed lg:h-screen flex flex-col glass-panel lg:bg-transparent lg:backdrop-blur-none lg:border-none lg:border-r w-full z-50 border-neutral-200/50 border-b pt-8 pr-8 pb-8 pl-8 justify-between">
<div className="">
<div className="mb-12 animate-clip-in" style={{animationDelay: '0.1s'}}>
<a className="block group text-3xl font-medium tracking-tighter font-geist" href="/#">design<span className="group-hover:text-neutral-900 transition-colors text-sky-500 font-geist">.angel</span></a>
</div>
...
<a className="block hover:text-neutral-900 hover:translate-x-1 transition-all text-lg text-neutral-500 font-geist" href="/pricing">Pricing</a>
...
<p className="font-medium text-neutral-900 font-geist">design.angel</p>
<p className="text-neutral-500 font-geist">@DAstudio</p>
</div>
</div>
...
<h1 className="leading-[0.95] lg:text-7xl xl:text-7xl text-5xl font-medium text-neutral-900 tracking-tight font-geist">Drowning in design requests? We fix that.</h1>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '123px', -MouseY: '3.6015625px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '-1px', -MouseY: '54.6015625px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '22px', -MouseY: '1.6015625px'}}>
...
<div className="carousel-card active lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2" id="card-0" onmousemove="handleSpotlight(event)" style={{-MouseX: '640px', -MouseY: '317.6015625px'}}>
...
<div className="carousel-card next lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 gap-x-4 gap-y-4" id="card-1" onmousemove="handleSpotlight(event)" style={{-MouseX: '92.879150390625px', -MouseY: '252.86090850830078px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist">Kickoff &amp;
          alignment</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist">Goals,
          constraints,
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist">Design &amp;
          iteration</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist">Fast
          cycles,
          constant
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist">Delivery &amp;
          handoff</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist">Clean
          files, clear
...
<h2 className="leading-tight md:text-4xl lg:text-5xl text-2xl font-normal text-white tracking-tight mb-8 font-geist">
            Redesigned
...
<p className="text-xs text-white/50 uppercase tracking-widest mb-4 font-medium font-geist">Trusted by
              teams at
            </p>
...
<span className="text-xs font-semibold text-zinc-900 font-geist">9:41</span>
...
<div className="">
<p className="text-lg font-normal text-zinc-900 tracking-tight font-geist">Hi, Marcus</p>
</div>
...
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist">Today's
                      suggestion</p>
<p className="text-base font-normal text-white tracking-tight mb-3 font-geist">Complete Module
                      3
                    </p>
...
<span className="text-zinc-400 font-geist">2h 15m · Zone 2</span>
<span className="text-indigo-400 font-geist">65%</span>
</div>
</div>
</div>

<div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4">
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist">Weekly
                      Progress
                    </p>
<p className="text-xl font-normal text-zinc-900 tracking-tight mb-2 font-geist">87% Learning
                      Load</p>
<div className="flex items-center gap-2">
...
<span className="text-[10px] text-emerald-600 font-medium font-geist">Optimal</span>
</div>
</div>

<div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4">
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist">XP Balance
                    </p>
<div className="flex items-baseline gap-1">
<p className="text-xl font-semibold text-zinc-900 tracking-tight font-geist">4,850</p>
<span className="text-sm text-zinc-400 font-geist">XP</span>
</div>
</div>
</div>
</div>

...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '123px', '--mouse-y': '3.6015625px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '-1px', '--mouse-y': '54.6015625px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '22px', '--mouse-y': '1.6015625px'}}>
...
<div className="carousel-card active lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2" id="card-0" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '640px', '--mouse-y': '317.6015625px'}}>
...
<div className="carousel-card next lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 gap-x-4 gap-y-4" id="card-1" onmousemove="handleSpotlight(event)" style={{'--mouse-x': '92.879150390625px', '--mouse-y': '252.86090850830078px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">

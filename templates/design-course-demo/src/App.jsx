...
<h1 className="reveal delay-100 text-5xl md:text-6xl text-gray-900 leading-[1.1] mb-6 font-semibold tracking-tighter">
              ...
              <br/>
<span className="text-gray-400">Start building systems.</span>
</h1>
<p className="reveal delay-200 text-lg text-gray-500 leading-relaxed mb-8 max-w-md">
              Transition from subjective visual design to objective product
              architecture with a methodology built for scale.
            </p>
<div className="reveal delay-300 flex flex-col sm:flex-row gap-4">
<button className="inline-flex justify-center items-center gap-2 bg-gray-900 text-white px-6 py-3.5 font-medium text-sm hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 rounded-full px-8">
                Get Full Access
                <svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
<button className="inline-flex justify-center items-center gap-2 bg-white text-gray-700 border border-gray-200 px-6 py-3.5 font-medium text-sm hover:bg-gray-50 hover:border-gray-300 transition-all rounded-full px-8">
                View Syllabus
              </button>
</div>
<div className="reveal delay-300 mt-8 flex items-center gap-4 text-sm text-gray-500">
...
<div className="w-12 h-12 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
<svg className="lucide lucide-zap text-gray-900" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg>
</div>
<h3 className="text-lg font-medium text-gray-900 mb-2">
...
<div className="w-12 h-12 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
<svg className="lucide lucide-trending-up text-gray-900" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 7h6v6"></path><path d="m22 7-8.5 8.5-5-5L2 17"></path></svg>
</div>
<h3 className="text-lg font-medium text-gray-900 mb-2">
              Career Strategy
            </h3>
...
<p className="text-gray-500">
            Invest in your career with a plan that fits your learning style.
          </p>
</div>
...
<span className="text-4xl font-medium text-gray-900">$149</span>
<span className="text-gray-400">/one-time</span>
</div>
<p className="text-sm text-gray-500 mb-8 pb-8 border-b border-gray-100">
              Perfect for designers who want to learn at their own speed with
              lifetime access to materials.
            </p>
<ul className="space-y-4 mb-8 flex-1">
<li className="flex items-start gap-3 text-sm text-gray-600">
<svg className="lucide lucide-check w-5 h-5 text-gray-900 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<p className="text-sm text-gray-400 mb-8 pb-8 border-b border-gray-800">
              Intensive 8-week program with weekly live feedback, portfolio
              reviews, and direct mentorship.
            </p>
<ul className="space-y-4 mb-8 flex-1">
<li className="flex items-start gap-3 text-sm text-gray-300">
<svg className="lucide lucide-check w-5 h-5 text-white shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<svg className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>

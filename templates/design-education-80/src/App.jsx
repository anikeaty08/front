...
<div className="flex bg-center bg-blue-600 w-8 h-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/91f4a3ef-f195-4cfc-81e0-e38179e7b815_3840w.jpg)] bg-cover rounded-lg items-center justify-center">
</div>
<span className="text-lg font-medium tracking-tight">toprep</span>
</div>
...
<a className="hover:text-slate-900 text-sm font-medium text-slate-600" href="#">Войти</a>
<button className="transition hover:bg-blue-700 text-sm font-medium text-white bg-blue-600 rounded-lg pt-2 pr-4 pb-2 pl-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">Регистрация</button>
</div>
</div>
</nav>
...
<span className="uppercase text-xs tracking-[0.2em] text-slate-500">
        ГОТОВИМ: умную систему тестирований
      </span>
<h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-slate-900 leading-tight">ТОПРЕП. Платформа для организации работы репетитора.
</h1>
<p className="mt-6 text-lg text-slate-600 max-w-2xl mx-auto">Ведите учеников, расписание и оплаты в одном месте.
Меньше рутины — больше времени на преподавание.</p>

<div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
<a className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-white font-medium transition hover:bg-slate-800" href="#contact">
          Попробуй бесплатно
...
<a className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-6 py-3 text-slate-700 transition hover:bg-slate-50" href="#product">
          Узнать подробнее
        </a>
</div>
...
<h3 className="">Сообщения теряются</h3>
<p className=""></p>
</div>
...
<h3 className="">Контроль оплаты</h3>
<p className=""></p>
</div>
...
<h3 className="">Расписание отдельно</h3>
<p className=""></p>
</div>
<div className="chaos-card chaos-card-4">
<div className="chaos-icon">
<svg className="w-[23px] h-[23px]" data-icon-replaced="true" fill="none" stroke="currentColor" strokeWidth="1.8" style={{width: '23px', height: '23px', color: 'rgb(37, 99, 235)'}} viewbox="0 0 24 24">
<path className="" d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
</svg>
</div>
<h3 className="">Файлы разбросаны</h3>
<p className=""></p>
</div>
<div className="platform-core">
<div className="platform-core-icon">
<div className="flex bg-center w-16 h-16 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/91f4a3ef-f195-4cfc-81e0-e38179e7b815_3840w.jpg)] bg-cover rounded-lg items-center justify-center">
</div>
</div>
...
<div className="benefit-item">✓ Расписание занятий</div>
<div className="benefit-item">✓ Учёт оплат и долгов</div>
<div className="benefit-item">✓ Домашние задания</div>
<div className="benefit-item">✓ Материалы курса</div>
<div className="benefit-item">✓ Общение со студентами</div>
<div className="benefit-item">✓ История обучения каждого ученика</div>
<div className="benefit-item">✓ Встроенные онлайн-звонки</div>
<div className="benefit-item">✓ Интерактивная доска для уроков</div>
<div className="benefit-item">✓ Тесты и автоматическая проверка</div>
</div>
<div className="result-block">
<p className=""> Откройте один сайт и управляйте всей своей практикой из одного кабинета. </p>
<h3 className=""> Меньше хаоса. Меньше рутины. Больше времени на работу, отдых и развитие. </h3>
</div>
</div>
</section>
...
<main className="min-h-[70vh] flex pt-0 pb-0 relative items-center justify-center">

<div className="absolute inset-0 z-0 pointer-events-none overflow-hidden flex items-center justify-center">
<div className="w-[700px] h-[700px] bg-cyan-400/10 blur-[140px] rounded-full translate-x-1/3 opacity-70"></div>
</div>
...
<h2 className="text-4xl lg:text-5xl font-medium tracking-tight text-slate-900 leading-[1.15]">Наша история</h2>
<p className="text-base lg:text-lg text-slate-600 leading-relaxed font-normal">Мы последовательно развиваем
            продукт, добавляя новые функции и улучшая пользовательский опыт. Каждый этап дорожной карты приближает нас к
            созданию полноценного решения для наших клиентов.</p>
</div>
...
<span className="text-xs font-medium text-slate-400 tracking-wider">ВЕСНА 2026</span>
</div>
...
<iconify-icon className="text-cyan-600 text-lg" icon="solar:cpu-bolt-linear">
</iconify-icon>
</div>
<h3 className="text-base font-medium text-slate-900">Запуск</h3>
</div>
<div className="flex items-center gap-3">
...
<span className="">v1.4.15 релиз версия</span>
</div>
<div className="flex items-center gap-3 text-sm text-slate-700">
<span className="">исправление ошибок, сбор обратной связи</span>
</div>
</div>
</div>
</div>
...
<div className="relative flex flex-col md:flex-row gap-6 md:gap-10 mb-10">
<div className="hidden md:flex w-[70px] justify-end shrink-0 pt-5">
<span className="text-xs font-medium text-slate-400 tracking-wider">ОСЕНЬ 2026</span>
</div>
...
<iconify-icon className="text-slate-500 text-lg" icon="solar:database-linear">
</iconify-icon>
</div>
<h3 className="text-base font-medium text-slate-700">Расширение сервисов</h3>
</div>
<div className="space-y-3 pl-11">
<div className="flex gap-3 text-sm text-slate-500 gap-x-3 gap-y-3 items-center">
<span className="">модуль курсы</span>
</div>
<div className="flex items-center gap-3 text-sm text-slate-500">
<span className="">модуль системы экзаменов/тестирований</span>
</div>
</div>
</div>
</div>
...
<div className="hidden md:flex w-[70px] justify-end shrink-0 pt-5">
<span className="text-xs font-medium text-slate-400 tracking-wider">2027</span>
</div>
<div className="absolute left-[-4px] md:left-[107px] top-6 w-[8px] h-[8px] rounded-full bg-slate-300 ring-4 ring-white">
</div>
<div className="flex-1 bg-slate-50 border border-slate-200 rounded-2xl p-6">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center">
<iconify-icon className="text-slate-500 text-lg" icon="solar:global-linear">
</iconify-icon>
</div>
<h3 className="text-base font-medium text-slate-600">Подключение ИИ</h3>
</div>
</div>
</div>
</div>
...
<h2 className="md:text-5xl lg:text-6xl leading-[1.1] text-4xl font-semibold text-[#0a2540] tracking-tight">Нам доверяют.</h2>
</div>
<div className="lg:col-span-5 pt-1 lg:pt-3">
<div className="space-y-8">
<p className="md:text-xl leading-relaxed text-lg text-[#425466]">Всё необходимое для успешной работы. Посмотрите, как наша платформа помогает достигать максимальной эффективности в своей работе.</p>
...
<h3 className="text-[22px] leading-snug font-semibold text-gray-900 tracking-tight mb-2.5 drop-shadow-[0_1px_1px_rgba(255,255,255,1)]">Онлайн-доска и звонки</h3>
<p className="text-[15px] leading-relaxed text-gray-600">Проводите занятия на платформе: видеосвязь один на один или с группой, чат, демонстрация экрана и встроенная интерактивная доска с инструментами как в Miro. Все материалы и заметки сохраняются автоматически и доступны после урока.</p>
</div>
<div className="flex flex-col">
<div className="w-14 h-14 rounded-2xl bg-gradient-to-b from-white to-blue-50 border border-blue-200 shadow-[inset_0_2px_4px_rgba(255,255,255,1),_0_5px_10px_rgba(37,99,235,0.15)] text-[#2563eb] flex items-center justify-center mb-5">
<svg className="w-6 h-6 drop-shadow-sm" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h3 className="text-[22px] leading-snug font-semibold text-gray-900 tracking-tight mb-2.5 drop-shadow-[0_1px_1px_rgba(255,255,255,1)]">Управление учениками</h3>
<p className="text-[15px] leading-relaxed text-gray-600">Ведите учет учеников и предметов, создавайте расписание занятий и группы. Добавляйте материалы, назначайте домашние задания и пробники, отмечайте прогресс по кодификатору. Храните контакты и условия оплаты, анализируйте статистику и результаты — всё в одном месте.</p>
</div>
</div>
...
<button className="text-[15px] hover:from-gray-50 hover:to-gray-200 active:shadow-[inset_0_4px_6px_rgba(0,0,0,0.1)] active:translate-y-[2px] transition-all font-semibold text-gray-700 bg-gradient-to-b from-white to-gray-100 w-full border-gray-300 border rounded-full pt-3.5 pb-3.5 shadow-[inset_0_2px_2px_rgba(255,255,255,1),_0_4px_6px_rgba(0,0,0,0.05)]">Узнать подробнее</button>
</div>
<div className="px-8 pt-10 pb-10 relative z-0">
<h4 className="text-[11px] uppercase font-extrabold text-blue-900 tracking-[0.15em] mb-3 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">Включает</h4>
...
<div className="px-8 pt-10 pb-10 relative z-0">
<h4 className="text-[11px] uppercase font-extrabold text-gray-800 tracking-[0.15em] mb-3 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">Включает</h4>
<ul className="space-y-4">
<li className="flex items-start gap-3">
...
<div className="">
<p className="text-[11px] sm:text-xs tracking-widest text-neutral-500 uppercase font-geist">Познакомьтесь с возможностями платформы ближе</p>
...
<img alt="Cloud Analytics dashboard project" className="h-56 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/af5c4f11-0653-43c0-b21e-5b8cc085c9f3_800w.jpg"/>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="E-commerce platform" className="h-72 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/60f49edd-2009-43cf-a12a-d82fd91aae5e_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">E-commerce • Platform</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Управление занятиями</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Portfolio website" className="h-48 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/27aa90c0-b947-4bfd-b8da-7cf0ab291ab1_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
...
<div className="flex flex-col gap-4 sm:gap-5">
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Product launch landing page" className="h-64 w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b19e7d3a-309c-4d55-9373-80ca043c0f49_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Platform • Website</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Управление предметами</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Mobile app design" className="h-56 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a76e4f7e-e0f8-4732-8b99-5b3abe6fd91d_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Mobile • App</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Управление финансами</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Data visualization" className="h-56 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cac77434-d322-40be-a298-4e2198a61175_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Data • Visualization</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Занятия для студента</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<div className="flex flex-col gap-4 sm:gap-5">
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Design system" className="h-72 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7df94c66-5d1e-4235-a476-1d2d8881a456_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Design • System</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Управление учениками</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Brand identity and campaign visuals" className="h-48 w-full object-cover transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b1350108-f0ef-4f66-83ae-fe50447f6f74_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Identity • Campaign</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Функции в разработке</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="group relative overflow-hidden ring-1 ring-neutral-200 bg-white rounded-3xl shadow-sm" href="#work">
<img alt="Web application" className="h-56 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/68a7825c-0f07-4225-a8e0-d22929426aa3_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<p className="text-xs text-white/70 font-geist">Web • Application</p>
<div className="mt-1 flex items-center justify-between">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">Календарь для студента</h4>
<span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-neutral-900">
<i className="h-4 w-4 transition-transform group-hover:translate-x-1" data-lucide="arrow-right"></i>
</span>
</div>
...
<a className="inline-flex items-center gap-2 rounded-full bg-white ring-1 ring-neutral-200 px-5 py-3 text-sm text-neutral-700 hover:shadow font-geist" href="#work">Переходите на вики</a>
</div>
</section>
...
<h2 className="text-[44px] sm:text-6xl lg:text-7xl xl:text-8xl leading-[0.9] text-zinc-950 tracking-tighter font-geist">Как это работает.</h2>
<span aria-hidden="true" aria-orientation="vertical" className="w-px bg-neutral-200 h-10" role="separator"></span>
<p className="sm:text-base text-sm text-zinc-400 tracking-tight font-geist mt-1">Три простых шага</p>
</div>
...
<div className="lg:col-span-4 sm:p-8 hover-lift flex flex-col bg-white w-full h-full max-w-full max-h-full border-neutral-200 border rounded-[28px] pt-6 pr-6 pb-6 pl-6 relative">
...
<div className="bg-center flex-1 min-h-[240px] bg-white/90 w-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/71d57c47-0204-46c4-aa8d-433436dd34ae_800w.png)] bg-cover border-neutral-200 border rounded-xl shadow-2xl">
</div>

<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter font-geist mt-6">Зарегистрируйтесь</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight font-geist max-w-[52ch] mt-2">Получите доступ к личному кабинету
</p>
</div>

<div className="lg:col-span-4 sm:p-8 hover-lift flex flex-col bg-white h-full border-neutral-200 border rounded-[28px] pt-6 pr-6 pb-6 pl-6 relative">
...
<div className="bg-center flex-1 min-h-[240px] bg-white/90 w-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7fd610af-6178-4129-8aec-1fdc0af04a57_800w.png)] max-h-full bg-cover border-neutral-200 border rounded-xl mt-full mb-full pt-4 pr-4 pb-4 pl-4 shadow-2xl">
</div>

<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter font-geist mt-6">Выберите тариф</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight font-geist max-w-[52ch] mt-2">Два тарифных плана под Ваши цели</p>
</div>
...
<div className="bg-center flex-1 min-h-[240px] bg-white/90 w-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a474a1bd-3ca6-4e36-bef3-6175b432d280_800w.jpg)] max-h-full bg-cover border-neutral-200 border rounded-xl mt-full mb-full pt-4 pr-4 pb-4 pl-4 shadow-2xl">
</div>

<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter font-geist mt-6">Приступайте к работе

</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight font-geist max-w-[52ch] mt-2">Проводите онлайн-занятия с Вашими учениками, все инструменты теперь под рукой</p>
</div>
</div>
</section>
...
<h3 className="text-sm font-medium">У меня уже есть ученики.</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '16px', height: '16px', color: 'rgb(107, 114, 128)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<h3 className="text-sm font-medium">Мне нужен стабильный сервис.</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
...
<details className="group border border-gray-200 rounded-xl p-4 [&amp;_summary::-webkit-details-marker]:hidden open:bg-gray-50/50">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
<h3 className="text-sm font-medium">Я развиваю свою практику.</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<details className="group border border-gray-200 rounded-xl p-4 [&amp;_summary::-webkit-details-marker]:hidden open:bg-gray-50/50">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
<h3 className="text-sm font-medium">Я устал от таблиц и чатов.</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<details className="group border border-gray-200 rounded-xl p-4 [&amp;_summary::-webkit-details-marker]:hidden open:bg-gray-50/50">
<summary className="flex cursor-pointer gap-1.5 text-gray-900 gap-x-1.5 gap-y-1.5 items-center justify-between">
<h3 className="text-sm font-medium">Зачем мне переходить, если всё работает?</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<details className="group border border-gray-200 rounded-xl p-4 [&amp;_summary::-webkit-details-marker]:hidden open:bg-gray-50/50">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
<h3 className="text-sm font-medium">А если сервис закроется?</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<details className="group border border-gray-200 rounded-xl p-4 [&amp;_summary::-webkit-details-marker]:hidden open:bg-gray-50/50">
<summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
<h3 className="text-sm font-medium">Я не хочу несколько дней всё настраивать.</h3>
<div className="white-bg p-1 rounded-md border border-gray-100 shadow-sm group-open:rotate-180 transition-transform">
<svg aria-hidden="true" className="lucide lucide-chevron-down w-4 h-4 text-gray-500" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
</summary>
...
<p className="leading-relaxed text-xl text-gray-300 max-w-2xl mr-auto mb-12 ml-auto">Присоединяйтесь к нашему сообществу,
...
<p className="leading-relaxed text-xl text-gray-300 max-w-2xl mr-auto mb-12 ml-auto" id="contact">Мы всегда рады вашим вопросам!
info@toprep.space</p>
</div>
</div>
</div>
...
<div className="bg-black w-4 h-4 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/91f4a3ef-f195-4cfc-81e0-e38179e7b815_3840w.jpg?w=800&amp;q=80)] bg-cover bg-center rounded-full">
</div>
<span className="text-sm font-semibold tracking-tight">toprep</span>
</div>
<p className="leading-relaxed text-sm text-gray-500 pr-4">Видеозвонки, онлайн-доска, сохранение материалов - все в
        одном месте.</p>
</div>
<div className="">
<h4 className="text-sm font-medium text-gray-900 mb-4">toprep</h4>
...
<li className=""><a className="hover:text-gray-900" href="#">Документы</a></li>
</ul>
</div>
<div className="">

...
<a className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-lg focus:bg-emerald-900 focus:px-4 focus:py-2 font-geist" href="#main" style={{}}>Pular para o conteúdo</a>
...
<a className="hover:text-emerald-200 transition-colors text-xs font-medium text-slate-200/80 font-geist" href="/platform">Plataforma</a>
<a className="hover:text-emerald-200 transition-colors text-xs font-medium text-slate-200/80 font-geist" href="/neural">Motor Neural</a>
<a className="hover:text-emerald-200 transition-colors text-xs font-medium text-slate-200/80 font-geist" href="/analytics">Análises</a>
<a className="hover:text-emerald-200 transition-colors text-xs font-medium text-slate-200/80 font-geist" href="/pricing">Preços</a>
</nav>
...
<a className="rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/10 transition-colors font-geist" href="#">Plataforma</a>
<a className="rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/10 transition-colors font-geist" href="#">Motor Neural</a>
<a className="rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/10 transition-colors font-geist" href="#">Análises</a>
<a className="rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/10 transition-colors font-geist" href="#">Preços</a>
...
<svg className="lucide lucide-brain-cog lucide-brain w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="brain-cog" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: '16px', height: '16px', color: 'rgb(167, 243, 208)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m10.852 14.772-.383.923"></path><path d="m10.852 9.228-.383-.923"></path><path d="m13.148 14.772.382.924"></path><path d="m13.531 8.305-.383.923"></path><path d="m14.772 10.852.923-.383"></path><path d="m14.772 13.148.923.383"></path><path d="M17.598 6.5A3 3 0 1 0 12 5a3 3 0 0 0-5.63-1.446 3 3 0 0 0-.368 1.571 4 4 0 0 0-2.525 5.771"></path><path d="M17.998 5.125a4 4 0 0 1 2.525 5.771"></path><path d="M19.505 10.294a4 4 0 0 1-1.5 7.706"></path><path d="M4.032 17.483A4 4 0 0 0 11.464 20c.18-.311.892-.311 1.072 0a4 4 0 0 0 7.432-2.516"></path><path d="M4.5 10.291A4 4 0 0 0 6 18"></path><path d="M6.002 5.125a3 3 0 0 0 .4 1.375"></path><path d="m9.228 10.852-.923-.383"></path><path d="m9.228 13.148-.923.383"></path><circle cx="12" cy="12" r="3"></circle></svg>
    Plataforma de Aprimoramento Neural
  </div>
<h1 className="sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[0.95] text-4xl tracking-tighter font-geist">
<span className="inline-block opacity-0 blur-md translate-y-12" style={{animation: 'fadeSlideUnblur 1s ease-out 0.6s forwards'}}>Amplifique</span>
<span className="inline-block opacity-0 blur-md translate-y-12" style={{animation: 'fadeSlideUnblur 1s ease-out 0.8s forwards'}}>Seu</span><br className="hidden sm:block"/>
<span className="text-emerald-200 tracking-tighter font-geist inline-block opacity-0 blur-lg translate-y-16" style={{animation: 'fadeSlideUnblur 1.2s ease-out 1.0s forwards'}}>Poder</span>
<span className="text-emerald-200 tracking-tighter font-geist inline-block opacity-0 blur-lg translate-y-16" style={{animation: 'fadeSlideUnblur 1.2s ease-out 1.2s forwards'}}>Mental</span>
</h1>
<p className="leading-relaxed sm:text-lg lg:text-xl lg:max-w-xl sm:mt-6 lg:mx-0 text-base font-medium text-slate-300/90 font-geist opacity-0 max-w-2xl mt-4 mr-auto ml-auto blur-md translate-y-8" style={{animation: 'fadeSlideUnblur 1s ease-out 1.6s forwards'}}>
    Transforme sua capacidade cognitiva com treinamento neural potencializado por IA. Desbloqueie foco máximo, criatividade aprimorada e aprendizado acelerado através de protocolos personalizados de otimização cerebral.
  </p>
...
<span className="flex items-center gap-3 relative z-10 font-medium transition-all duration-500 ease-out group-hover:transform group-hover:translate-y-8 group-hover:opacity-0 group-hover:blur-md font-geist rounded-full">Iniciar Treino Neural <svg className="lucide lucide-arrow-right w-[16px] h-[16px]" data-icon-replaced="true" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{width: '16px', height: '16px', color: 'rgb(241, 245, 249)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path className="" d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>

<span className="absolute inset-0 z-10 flex items-center justify-center transition-all duration-300 ease-in-out transform -translate-y-8 group-hover:translate-y-0 group-hover:opacity-100 group-hover:blur-none font-medium font-geist opacity-0 rounded-full blur-md">É grátis</span>
...
<div className="text-slate-200 font-medium font-geist">+25,8 mil mentes aprimoradas</div>
<div className="text-slate-400 text-xs font-geist">média de 4,2x de impulso cognitivo</div>
</div>
</div>
</div>
<style>
...
<span className="sm:px-3 sm:py-1.5 text-xs font-medium text-cyan-200 font-inter bg-cyan-400/20 rounded-full pt-1 pr-2 pb-1 pl-2">Sessão Ativa</span>
</div>
<div className="animate-in slide-in-from-left duration-700 delay-500">
<p className="text-xl sm:text-2xl lg:text-3xl tracking-tight font-geist">Estado de Foco Profundo</p>
<p className="sm:text-base sm:mt-2 text-sm text-slate-50 font-inter mt-1">Treino de Fluxo Neural</p>
</div>
...
<p className="sm:text-sm text-xs font-light text-slate-50 font-inter">restantes</p>
</div>
</div>
</div>
...
<p className="leading-relaxed text-xs sm:text-sm text-slate-50 font-inter font-light font-geist">
          Sincronização avançada de ondas cerebrais para desempenho cognitivo máximo e atenção sustentada.
        </p>
<div className="flex justify-between items-center animate-in fade-in duration-700 delay-800">
<div className="flex items-center gap-2">
<span className="text-xs tracking-wider font-inter font-semibold font-geist">ONDAS GAMA</span>
...
<a className="text-cyan-200 text-xs sm:text-sm hover:underline hover:text-cyan-100 transition-colors font-inter font-medium font-geist" href="#">Continuar treino</a>
</div>
</div>
</div>
</div>
...
<div className="text-sm font-medium text-slate-400 font-geist mt-1">Aprimoramento cognitivo</div>
</div>
<div className="text-center">
<div className="text-3xl sm:text-4xl text-emerald-200 tracking-tighter font-geist">3,5h</div>
<div className="text-sm font-medium text-slate-400 font-geist mt-1">Foco máximo diário</div>
</div>
<div className="text-center">
<div className="text-3xl sm:text-4xl text-emerald-200 tracking-tighter font-geist">420%</div>
<div className="text-sm font-medium text-slate-400 mt-1 font-geist">Aceleração de aprendizado</div>
</div>
</div>
</div>
</section>
...
<div className="text-center">
<p className="uppercase text-sm font-medium text-white/50 tracking-wide">Impulsionando as equipes de produtos mais focadas do mundo
    </p>
</div>
...
<span className="inline-flex items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-400/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-medium text-emerald-200 font-geist">Capacidades</span>
<h2 className="mt-4 sm:mt-6 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tight font-geist">
      Como te ajudamos a <span className="italic text-emerald-200">crescer</span>
</h2>
</div>
...
<h3 className="text-lg sm:text-xl font-semibold tracking-tight font-geist">Produção Criativa</h3>
<p className="mt-2 text-sm font-medium text-slate-300/90 leading-relaxed font-geist">
        Vídeos curtos, UGC, motion design e visuais projetados para capturar atenção e gerar compartilhamentos.
      </p>
</div>
...
<h3 className="text-lg sm:text-xl font-semibold tracking-tight font-geist">Operações de Mídias Sociais</h3>
<p className="mt-2 text-sm font-medium text-slate-300/90 leading-relaxed font-geist">
        Estratégia, calendário de conteúdo, publicação, comunidade e caixa de entrada—gerenciados ponta a ponta.
      </p>
</div>
...
<h3 className="text-lg sm:text-xl font-semibold tracking-tight font-geist">Anúncios de Performance</h3>
<p className="leading-relaxed text-sm font-medium text-slate-300/90 font-geist mt-2">
        Campanhas de funil completo em Meta, TikTok e YouTube—otimizadas para CPA e ROAS.
      </p>
</div>
</div>
...
<div className="mx-auto max-w-4xl text-center">
<span className="inline-flex items-center gap-2 rounded-full border border-violet-400/30 bg-violet-500/15 px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-medium text-violet-300 font-geist">Rede Global</span>
<h2 className="mt-4 sm:mt-6 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tighter font-geist">Junte-se a mais de 50.000 pioneiros cognitivos de mais de 180 países</h2>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium text-slate-300/90 font-geist">Conecte-se com pesquisadores de neurociência, performers de alto desempenho e entusiastas de aprimoramento cognitivo ultrapassando os limites do potencial humano.</p>
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2f563338-39fa-47ea-9761-658d4f3f84db_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/de692cd3-6ed5-40da-b589-663e89889a1c_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/42dfe760-aef6-44a2-bff9-70aa005c5961_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c18d9fac-84d4-4727-95df-38b04c62ac05_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c3e3fffd-33c5-442f-924a-7bc1032b2c0f_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/31996fe3-f9da-42d7-bf65-2cc5d5417271_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5989c16d-4aa3-4351-bfdb-fac959736459_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6c39c735-18f1-4b74-aa61-180fbb2b4770_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6209234e-73ff-4176-bf91-c05fa95cc596_800w.jpg" style={{outline: 'rgb(245, 158, 11) solid 2px', outlineOffset: '2px', transition: 'outline 0.1s ease-in-out'}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3f4ec54c-12b4-4eb2-a0c3-1d78cb6c9e02_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8cfa0961-8c53-4d57-b87c-3b8eaffcd08b_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/42f0787e-2f7f-4ae7-9c64-3f1d597bf1b8_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c8701b7a-a3f2-4ad0-95be-f2f027c8e390_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/83ca20c0-64e5-412d-9c79-224a4ae90b74_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c920d31f-46c8-4f39-957b-9a8d8e511a1a_800w.jpg"/></div>
</div>
<div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 sm:gap-4 flex-shrink-0 pr-2 sm:pr-4">
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2f563338-39fa-47ea-9761-658d4f3f84db_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/de692cd3-6ed5-40da-b589-663e89889a1c_800w.jpg" style={{}}/></div>
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c18d9fac-84d4-4727-95df-38b04c62ac05_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c3e3fffd-33c5-442f-924a-7bc1032b2c0f_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9a421cf7-e975-430b-88c5-f554775493e1_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0c82a12e-5af1-47d3-963d-65c3987dd2be_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e63aa468-ae44-4756-84db-fcacd6cec9e2_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6209234e-73ff-4176-bf91-c05fa95cc596_800w.jpg" style={{outline: 'rgb(245, 158, 11) solid 2px', outlineOffset: '2px', transition: 'outline 0.1s ease-in-out'}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3f4ec54c-12b4-4eb2-a0c3-1d78cb6c9e02_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8cfa0961-8c53-4d57-b87c-3b8eaffcd08b_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/42f0787e-2f7f-4ae7-9c64-3f1d597bf1b8_800w.jpg"/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a160135e-dfe8-4d26-b2e5-2915ebe6f3a2_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9a3ff98a-df58-478d-a4ae-f3c6d3f3ba61_800w.jpg" style={{}}/></div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5"><img alt="Membro da comunidade" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7063bc06-62fe-4811-b5fa-4b1e09b26a81_800w.jpg"/></div>
</div>
</div>
</div>
</div>
...
<span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 sm:px-4 py-1.5 text-xs font-medium text-slate-200 font-geist">Nossa visão</span>
<h2 className="sm:mt-6 sm:text-5xl lg:text-6xl text-3xl font-normal text-slate-100 tracking-tight font-geist mt-4">
          Desbloqueando o potencial humano através do aprimoramento <span className="italic text-emerald-200">neural</span>
</h2>
<div className="mt-4 sm:mt-6 max-w-3xl text-slate-300/90 font-geist">
<p className="text-sm sm:text-base font-medium leading-relaxed">Fazemos parceria com visionários que entendem que o aprimoramento cognitivo é a próxima fronteira da evolução humana.</p>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium leading-relaxed">Não apenas aumentos temporários de desempenho, mas otimização neural sustentável que transforma como você pensa, aprende e cria.</p>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium leading-relaxed">Para nós, o treinamento neural é a base de tudo.</p>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium leading-relaxed">Nossa abordagem integra neurociência, IA e protocolos personalizados. Lidamos com a complexidade para que você possa se concentrar em alcançar o desempenho máximo.</p>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium leading-relaxed">Se você está pronto para desbloquear o verdadeiro potencial da sua mente, estamos aqui para orientá-lo.</p>
...
<span className="text-sm sm:text-base font-semibold text-slate-100 font-geist">aprimorado</span>
</div>
</div>
</div>
</div>
...
<div className="mx-auto max-w-4xl text-center">
<span className="inline-flex items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-400/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-medium text-emerald-200 font-geist">Histórias de Sucesso</span>
<h2 className="mt-4 sm:mt-6 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tighter font-geist">Transformando mentes pelo mundo</h2>
<p className="mt-3 sm:mt-4 text-sm sm:text-base font-medium text-slate-300/90 font-geist">De executivos da Fortune 500 a atletas olímpicos, descubra como o aprimoramento neural está revolucionando o desempenho humano.</p>
</div>
...
<h3 className="text-base sm:text-lg font-semibold tracking-tight text-slate-100 font-geist">"Resultados impressionantes"</h3>
<p className="mt-2 sm:mt-3 text-xs sm:text-sm font-medium text-slate-300/90 leading-relaxed font-geist">Aumentei meu tempo de foco em 300% em 30 dias. O feedback neural é incrivelmente preciso e personalizado.</p>
...
<div className="text-xs text-slate-400 font-geist">Neurocientista</div>
</div>
</div>
</div>
<div className="group rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 hover:bg-white/10 transition-colors">
<h3 className="text-base sm:text-lg font-semibold tracking-tight text-slate-100 font-geist">"Desempenho máximo desbloqueado"</h3>
<p className="mt-2 sm:mt-3 text-xs sm:text-sm font-medium text-slate-300/90 leading-relaxed font-geist">Minha resistência cognitiva durante competições melhorou dramaticamente. Esta tecnologia é revolucionária.</p>
<div className="mt-4 sm:mt-6 flex items-center gap-2 sm:gap-3">
...
<div className="text-xs text-slate-400 font-geist">Grande Mestre de Xadrez</div>
</div>
</div>
</div>
<div className="group rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 hover:bg-white/10 transition-colors">
<h3 className="text-base sm:text-lg font-semibold tracking-tight text-slate-100 font-geist">"Aprendizado acelerado"</h3>
<p className="mt-2 sm:mt-3 text-xs sm:text-sm font-medium text-slate-300/90 leading-relaxed font-geist">Dominei cálculo avançado em semanas em vez de meses. A otimização das vias neurais é incrível.</p>
<div className="mt-4 sm:mt-6 flex items-center gap-2 sm:gap-3">
...
<div className="text-xs text-slate-400 font-geist">Estudante do MIT</div>
</div>
</div>
</div>
<div className="group rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 hover:bg-white/10 transition-colors">
<h3 className="text-base sm:text-lg font-semibold tracking-tight text-slate-100 font-geist">"Avanço criativo"</h3>
<p className="mt-2 sm:mt-3 text-xs sm:text-sm font-medium text-slate-300/90 leading-relaxed font-geist">Aprimorou meus estados de fluxo criativo além do que eu achava possível. As ideias fluem sem esforço agora.</p>
<div className="mt-4 sm:mt-6 flex items-center gap-2 sm:gap-3">
...
<div className="text-xs text-slate-400 font-geist">Diretor Criativo</div>
</div>
</div>
</div>
</div>
...
<a className="inline-flex items-center gap-2 hover:text-teal-200 transition-colors text-sm font-medium text-teal-300 font-geist" href="/pricing">
            Ler todas as histórias de sucesso
            <svg className="lucide lucide-arrow-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</a>
</div>
</section>
...
<p className="text-xs sm:text-sm font-medium text-slate-400 font-geist text-center sm:text-left">© <span className="font-geist" id="y">2025</span> FlowMind Technologies. Aprimoramento cognitivo através de IA.</p>
</div>
<div className="flex items-center gap-4 sm:gap-6 flex-wrap justify-center">
<a className="text-xs sm:text-sm font-medium text-slate-300 hover:text-emerald-200 transition-colors font-geist" href="#">Privacidade Neural</a>
<a className="text-xs sm:text-sm font-medium text-slate-300 hover:text-emerald-200 transition-colors font-geist" href="#">Ética em Pesquisa</a>

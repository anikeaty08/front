...
<span className="bg-center text-xl font-semibold tracking-tight w-32 h-12 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a13e5050-9ecb-43fb-a5ac-6fafd5827e9f_320w.png)] bg-cover mt-4 mb-4"></span>
</div>
...
<div className="bg-gradient-to-b via-transparent to-transparent from-pink-500/10 absolute top-0 right-0 bottom-0 left-0"></div>
...
<h1 className="md:text-8xl bg-clip-text text-6xl font-bold text-transparent tracking-tighter bg-gradient-to-r from-white mb-6 via-pink-200 to-rose-200" style={{maskImage: 'linear-gradient(90deg, transparent, black 50%, black 50%, transparent)', WebkitMaskImage: 'linear-gradient(90deg, transparent, black 50%, black 50%, transparent)'}}>
...
<button className="px-8 py-4 bg-gradient-to-r rounded-xl font-medium hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-1 from-pink-500 hover:shadow-pink-500/50 to-rose-500">
        Start Creating Free
      </button>
...
<div className="text-3xl font-bold bg-gradient-to-r bg-clip-text text-transparent from-pink-400 to-rose-400">2M+</div>
<div className="text-sm text-slate-500 mt-1">Designs Created</div>
</div>
<div className="text-center fade-in-up delay-200 animated">
<div className="text-3xl font-bold bg-gradient-to-r bg-clip-text text-transparent from-pink-400 to-rose-400">50K+</div>
<div className="text-sm text-slate-500 mt-1">Active Creators</div>
</div>
<div className="text-center fade-in-up delay-300 animated">
<div className="text-3xl font-bold bg-gradient-to-r bg-clip-text text-transparent from-pink-400 to-rose-400">99.9%</div>
...
<div className="flex items-center justify-center h-8 w-8 rounded-full bg-gradient-to-br text-xs font-medium tracking-tight hover:scale-110 transition-transform duration-300 from-pink-500 to-rose-500">
          DF
        </div>
<div>
...
<div className="h-full bg-gradient-to-r transition-all duration-500 from-pink-500 to-rose-500" style={{width: '64%'}}></div>
</div>
...
<div className="rounded-xl border border-white/10 bg-black/60 px-4 py-3 transition-all duration-300 hover:scale-105 cursor-pointer hover:border-pink-500/50">
...
<div className="rounded-xl border border-white/10 bg-black/70 p-4 transition-all duration-300 hover:border-pink-500/30">
<div className="flex flex-col md:flex-row md:items-end gap-3">
<div className="flex-1">
<label className="text-[11px] uppercase tracking-wide text-neutral-500 mb-1 block">New prompt</label>
<div className="rounded-lg border border-white/10 bg-black/60 transition-colors focus-within:border-pink-500/50">
...
<div className="rounded-lg border border-white/10 bg-black/60 px-3 py-3 transition-all duration-300 cursor-pointer hover:border-pink-500/50">
...
<div className="bg-gradient-to-b to-transparent absolute top-0 right-0 bottom-0 left-0 from-pink-500/5"></div>
<div className="max-w-7xl mx-auto px-6">
<div className="text-center mb-20">
...
<div className="hidden lg:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r transform -translate-y-1/2 from-pink-500 to-pink-500 via-rose-500"></div>
<div className="grid lg:grid-cols-3 gap-12 relative">

<div className="relative fade-in-up delay-100">
<div className="bg-black border border-white/10 rounded-3xl p-8 transition-all duration-500 hover:scale-105 hover:-translate-y-2 hover:border-pink-500/50">
...
<svg className="lucide lucide-download w-4 h-4 text-pink-400" data-lucide="download" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 15V3"></path><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><path d="m7 10 5 5 5-5"></path></svg>
</div>
<div className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-all duration-300 hover:scale-105 cursor-pointer">
...
<div className="bg-gradient-to-br border-2 rounded-3xl p-8 relative fade-in-up delay-200 hover:scale-105 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl from-pink-500/20 border-pink-500 hover:shadow-pink-500/50 to-rose-500/20">
<div className="absolute -top-4 left-1/2 transform -translate-x-1/2 px-4 py-1 bg-gradient-to-r rounded-full text-sm font-medium from-pink-500 to-rose-500">
          Most Popular
        </div>
...
<button className="w-full py-3 bg-gradient-to-r rounded-xl font-medium hover:shadow-lg transition-all duration-300 hover:scale-105 from-pink-500 hover:shadow-pink-500/50 to-rose-500">
          Start Free Trial
        </button>
</div>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="top-0 w-full -z-10 h-[1140px] bg-cover bg-center absolute blur-2xl" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a321d955-bf50-4745-bd6a-5555c9e712e7_3840w.webp")'}}></div>
...
<a className="inline-flex items-center justify-center bg-center mix-blend-multiply w-[130px] h-[20px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f3db1202-96e3-416d-8235-c9d02c748d03_1600w.png)] bg-cover rounded pt-2 pb-2 invert" href="#"></a>
...
<img alt="E-commerce design preview" className="w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/fa91f7af-c0ee-487e-9b71-34905a5f7414_1600w.webp" style={{}}/>
...
<img alt="SaaS dashboard design" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5929dfb3-6ba0-482e-8054-7c6b716e45bc_1600w.jpg" style={{}}/>
<div className="absolute top-4 right-4">
...
<img alt="Landing page design" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/ce6d7146-78eb-4530-bc2a-2885666e1383_1600w.webp" style={{}}/>
<div className="absolute top-4 right-4">
<button className="save-btn rounded-full backdrop-blur px-2.5 py-2 shadow-sm transition bg-black/80 hover:bg-black">
<svg className="lucide lucide-plus w-5 h-5 text-slate-100" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
...
<article className="coach-card absolute w-[78%] sm:w-[420px] aspect-[4/5] rounded-2xl shadow-xl overflow-hidden ring-1 bg-slate-900 shadow-slate-100/10 ring-white/5" style={{opacity: '1', pointerEvents: 'none', transform: 'translate3d(72px, 20px, 0px) rotate(-5deg) scale(0.965)', zIndex: '99', filter: 'drop-shadow(rgba(15, 23, 42, 0.12) 0px 8px 16px)', transition: 'transform 400ms cubic-bezier(0.2, 0.7, 0, 1), opacity 300ms'}}>
<img alt="Mobile app design" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c75a3e33-28d5-4996-97d3-cabbf3908ede_1600w.webp" style={{}}/>
<div className="absolute top-4 right-4">
<button className="save-btn rounded-full backdrop-blur px-2.5 py-2 shadow-sm transition bg-black/80 hover:bg-black">
<svg className="lucide lucide-plus w-5 h-5 text-slate-100" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
...
<article className="coach-card absolute w-[78%] sm:w-[420px] aspect-[4/5] rounded-2xl shadow-xl overflow-hidden ring-1 bg-slate-900 shadow-slate-100/10 ring-white/5" style={{opacity: '1', pointerEvents: 'none', transform: 'translate3d(144px, 34px, 0px) rotate(-10deg) scale(0.93)', zIndex: '98', filter: 'drop-shadow(rgba(15, 23, 42, 0.12) 0px 8px 16px)', transition: 'transform 400ms cubic-bezier(0.2, 0.7, 0, 1), opacity 300ms'}}>
<img alt="Brand identity design" className="absolute inset-0 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c4ba3f45-b7fb-47e5-a442-3c55bd9f9f1c_1600w.webp" style={{}}/>
<div className="absolute top-4 right-4">
<button className="save-btn rounded-full backdrop-blur px-2.5 py-2 shadow-sm transition bg-black/80 hover:bg-black">
<svg className="lucide lucide-plus w-5 h-5 text-slate-100" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
...
<img alt="Michael Torres" className="h-8 w-8 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/096dab35-ecaf-418f-a932-5b514543b035_320w.jpg"/>
...
<div className="flex items-center gap-3">
<div className="h-9 w-9 flex bg-cover border rounded-md items-center justify-center border-slate-700 bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6931cecd-5f27-498d-90aa-86489df2ef35_320w.webp)]">
</div>
<div className="">
...
<article className="flex xl:bg-zinc-800/50 bg-slate-800/50 border-zinc-800 border rounded-2xl pt-4 pr-4 pb-4 pl-4 backdrop-blur-lg items-center justify-between">
<div className="h-9 w-9 flex bg-cover border rounded-md items-center justify-center border-slate-700 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/287ca1e2-ccca-409b-b256-664c7ae20a40_320w.webp)] bg-center">
</div>
<div className="">
...
<article className="flex xl:bg-zinc-800/50 bg-slate-800/50 border-zinc-800 border rounded-2xl pt-4 pr-4 pb-4 pl-4 backdrop-blur-lg items-center justify-between">
<div className="flex items-center gap-3">
<div className="h-9 w-9 flex bg-cover border rounded-md items-center justify-center border-slate-700 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cb364025-2387-4977-a5e2-b5466b778b1d_320w.webp)] bg-center">
</div>
<div className="">
...
</section><section className="sm:px-8 sm:py-24 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5f52e2f1-d904-420f-82c5-91ee43087973_3840w.webp)] max-w-full bg-cover mr-auto ml-auto pt-16 pr-6 pb-16 pl-6 relative">

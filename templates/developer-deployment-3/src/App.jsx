...
<div className="relative rounded-3xl border border-blue-500/30 bg-neutral-900/60 p-8 backdrop-blur shadow-[0_0_40px_-10px_rgba(59,130,246,0.15)]" style={{-BorderGradient: 'linear-gradient(135deg, rgba(59,130,246,0.5), rgba(0,0,0,0))'}}>

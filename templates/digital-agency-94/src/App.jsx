...
<div className="loader" id="loader" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(0%, -100%) translate(0px, -21900.6px)'}}>
...
<div className="cursor-dot" style={{translate: 'none', rotate: 'none', scale: 'none', transform: 'translate(94px, 374px)'}}></div>
<div className="cursor-circle" style={{left: '93.5879px', top: '374.217px'}}></div>
...
<canvas className="absolute top-0 left-0 w-full h-full opacity-30 pointer-events-none" height="1024" id="hero-canvas" width="1440"></canvas>
...
<p className="text-secondary leading-relaxed text-balance text-lg md:text-2xl font-medium max-w-2xl mt-8 tracking-tight" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '1', transform: 'translate(0px, 0px)'}}>
...
<a className="px-8 py-4 bg-[#0f0f0f] text-white rounded-full font-mono text-xs font-bold uppercase tracking-widest hover:bg-accent hover:shadow-lg hover:shadow-accent/20 transition-all duration-300 magnetic-btn" href="#contact">
            Get a Quote
          </a>
<a className="px-8 py-4 border border-black/10 bg-white/50 backdrop-blur-sm rounded-full font-mono text-xs font-bold uppercase tracking-widest hover:bg-white hover:shadow-lg transition-all duration-300 magnetic-btn" href="#contact">
            Let's Connect
          </a>
</div>
</div>
...
<svg className="lucide lucide-arrow-down w-5 h-5 text-secondary/50" data-lucide="arrow-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h3 className="text-3xl font-bold mb-4">Discovery &amp; Strategy</h3>
...
<h3 className="text-3xl font-bold mb-4">Deployment &amp; Support</h3>
<div className="space-y-4 text-secondary text-lg leading-relaxed mb-8">
<p>
...
<p className="text-secondary">Drag to explore recent projects.</p>
</div>
</div>

...
<div className="loader" id="loader"><div className="loader__brand">FORMA</div></div>
...
<a data-mobile-link="" href="#work">Work</a>
<a data-mobile-link="" href="#about">Studio</a>
<a data-mobile-link="" href="#services">Services</a>
<a data-mobile-link="" href="#journal">Journal</a>
...
<div className="hero__label">Digital Design Studio</div>
<h1 className="hero__title">
<span className="hero__line"><span>WE DESIGN</span></span>
<span className="hero__line"><span>DIGITAL</span></span>
<span className="hero__line hero__line--accent"><span>REALITIES</span></span>
</h1>
...
<div>
<h2 className="about__title">We believe design<br/>is a catalyst for<br/>meaningful change.</h2>
...
<span className="iconify" data-icon="solar:arrow-right-up-linear" data-width="16"></span>
</div>
</div>
...
<span className="iconify services__arrow" data-icon="solar:add-circle-linear" data-width="22"></span>
</div>
<div className="services__item" data-accordion="">
...
<a className="btn btn--primary btn--large" href="mailto:hello@forma.studio">
                    Start a Project
                    <span className="iconify" data-icon="solar:arrow-right-linear" data-width="18"></span>
</a>
</div>
</div>
</section>

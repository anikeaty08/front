...
<img alt="Dubai Holiday Home Management Services for Landlords" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ac8a92d3-83da-4d2d-9255-88cf93065051_3840w.webp"/>
...
<h1 className="text-4xl md:text-6xl lg:text-7xl tracking-tight leading-[1.1] mb-8 font-montserrat font-medium" style={{}}>
                Dubai Holiday Home <br/> Co-Hosting &amp; <br/> Property Management
            </h1>
<p className="text-lg text-[#F5E9D3] font-light max-w-2xl mx-auto mb-12 leading-relaxed font-manrope" style={{}}>
                Hands-off hosting for landlords. High-ROI short-term rentals managed professionally. Experience the pinnacle of Airbnb management service Dubai for property owners.
            </p>
...
<p className="leading-relaxed mb-6 font-light text-gray-800 font-manrope" style={{}}>
                        Wego Holiday Homes was founded on a simple premise: luxury properties deserve luxury management. We are experienced Dubai co-hosting experts who bridge the gap between premium hospitality and high-yield property investment.
                    </p>
<p className="leading-relaxed font-light text-gray-800 font-manrope" style={{}}>
                        We specialize in holiday home compliance and licensing support Dubai landlords need to navigate the market safely. Our mission is to provide landlord-focused short-term rental services in Dubai that are transparent, legal, and exceptionally profitable.
                    </p>
</div>
...
<img alt="Nwaego Muoma - Founder of Wego Holiday Homes" className="w-full h-full object-cover grayscale contrast-125" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/636fd14c-e60e-4ef5-b8e4-03e7e7db33c4_800w.jpg" style={{}}/>
</div>
</div>
...
<p className="text-sm text-gray-500 font-light leading-relaxed font-manrope" style={{}}>
                        Professional guest communication service Dubai. From inquiry to check-out, our multilingual team handles every question instantly.
                    </p>
</div>
...
<p className="text-sm text-gray-500 font-light leading-relaxed font-manrope" style={{}}>
                        Premium Dubai holiday home cleaning and housekeeping service. Hotel-grade linens and toiletries provided for every stay.
                    </p>
</div>
...
<p className="text-sm text-gray-500 font-light leading-relaxed font-manrope" style={{}}>
                        Advanced Dubai dynamic pricing and revenue management algorithms that adjust rates daily based on demand, events, and seasonality.
                    </p>
</div>
...
<p className="text-sm text-gray-500 font-light leading-relaxed font-manrope" style={{}}>
                        Expert short-let property setup service Dubai. We advise on interior styling to make your property irresistible to high-value guests.
                    </p>
</div>
</div>
</div>
...
<p className="text-[#F5E9D3] font-light leading-relaxed mb-8 font-manrope" style={{}}>
                        Why lock your asset into a fixed annual contract? Holiday home management for Dubai landlords typically yields 20-40% higher returns than long-term leasing. We provide a hands-off hosting solution for Dubai landlords who value performance.
                    </p>
...
<div className="mt-12">
<a className="inline-block px-8 py-4 bg-[#D4AF37] font-semibold text-xs uppercase tracking-widest transition-all duration-300 text-black hover:bg-white font-manrope" href="#contact" style={{}}>
                            Book a Consultation
                        </a>
</div>
</div>
...
<div className="p-10 lg:p-12 bg-white text-black">
<h4 className="text-xl font-medium mb-8 font-manrope" style={{}}>Request Free ROI Estimate</h4>
<form className="space-y-6">
<div className="grid md:grid-cols-2 gap-6">
<div>
<label className="block text-[10px] font-bold uppercase tracking-widest mb-1 default font-manrope" style={{}}>Name</label>
<input className="w-full custom-input" placeholder="Full Name" type="text"/>
</div>
<div>
<label className="block text-[10px] font-bold uppercase tracking-widest mb-1 default font-manrope" style={{}}>Phone</label>
<input className="w-full custom-input" placeholder="+971 ..." type="tel"/>
</div>
</div>
<div>
<label className="block text-[10px] font-bold uppercase tracking-widest mb-1 default font-manrope" style={{}}>Email</label>
<input className="w-full custom-input" placeholder="email@address.com" type="email"/>
</div>
<div>
<label className="block text-[10px] font-bold uppercase tracking-widest mb-1 default font-manrope" style={{}}>Property Area</label>
<select className="w-full custom-input bg-transparent">
<option className="font-manrope" style={{}}>Dubai Marina</option>
<option className="font-manrope" style={{}}>Downtown Dubai</option>
<option className="font-manrope" style={{}}>Palm Jumeirah</option>
<option className="font-manrope" style={{}}>JBR</option>
<option className="font-manrope" style={{}}>Business Bay</option>
<option className="font-manrope" style={{}}>Other</option>
</select>
</div>
<div>
<label className="block text-[10px] font-bold uppercase tracking-widest mb-1 default font-manrope" style={{}}>Message</label>
<textarea className="w-full custom-input resize-none" placeholder="Tell us about your property..." rows="3"></textarea>
</div>
<button className="w-full bg-[#D4AF37] font-semibold py-4 text-xs uppercase tracking-widest transition-all duration-300 mt-4 text-black hover:bg-black hover:text-white font-manrope" style={{}} type="button">
                            Submit Inquiry
                        </button>
</form>
</div>
...
<a className="fixed bottom-8 right-8 z-50 p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center default text-white" href="#">

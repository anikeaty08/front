...
<a className="bg-white/5 hover:bg-white/10 px-5 py-2 text-xs tracking-widest uppercase transition-all text-neutral-300 font-geist" href="#">DVolt.io</a>
<div className="hidden md:flex items-center gap-1">
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#strategy">Platform</a>
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#workflows">Protocols</a>
</div>
...
<div className="hidden md:flex items-center gap-1">
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#results">Integrity</a>
...
<span className="relative z-10 font-geist">Secure Now</span>
...
<span className="text-[10px] uppercase tracking-widest text-neutral-500 font-geist">Ver. 3.1.0</span>
...
<span className="[animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll tracking-tighter font-space-grotesk font-light">Quantum</span>
<span className="text-gradient [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll font-light tracking-tighter font-space-grotesk">Immunity</span>
</h1>
</div>
...
<iconify-icon className="text-lg text-white" icon="solar:shield-check-bold-duotone"></iconify-icon>
</div>
<div className="flex flex-col text-left">
<span className="text-[10px] uppercase tracking-widest text-neutral-500 font-geist">Sys_Status</span>
<span className="text-xs md:text-sm leading-none text-white font-geist">Secure</span>
</div>
</div>
</div>
...
<div className="leading-relaxed [animation:animationIn_0.8s_ease-out_0.6s_both] animate-on-scroll md:text-2xl text-xs text-neutral-500 font-space-grotesk text-center max-w-lg">We leverage predictive AI to secure your infrastructure, automate compliance, and neutralize threats before execution.</div>
</div>
...
<iconify-icon className="text-2xl text-neutral-300" icon="solar:shield-warning-bold-duotone"></iconify-icon>
<div className="px-2 py-0.5 border border-green-900/30 bg-green-900/10 text-green-400 text-[10px] uppercase tracking-wider font-geist">Active</div>
</div>
<div className="">
<div className="text-4xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
<span data-prefix="" data-suffix="%" data-target="99.9">99.9%</span>
</div>
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Threats Blocked</h3>
</div>
</div>
...
<div className="flex justify-between items-start">
<iconify-icon className="text-2xl text-neutral-300" icon="solar:server-square-bold-duotone"></iconify-icon>
</div>
<div className="">
<div className="text-4xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
<span className="" data-suffix="M" data-target="2.5">2.5M</span>
</div>
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Endpoints Secured</h3>
</div>
</div>
...
<div className="flex justify-between items-start">
<iconify-icon className="text-2xl text-neutral-300" icon="solar:stopwatch-bold-duotone"></iconify-icon>
</div>
<div className="">
<div className="text-4xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
<span data-suffix="ms" data-target="35">35ms</span>
</div>
...
<span className="reveal-word font-space-grotesk font-light">Stop</span> <span className="reveal-word font-space-grotesk font-light">reacting.</span> <span className="reveal-word font-space-grotesk font-light">Start</span>
...
<iconify-icon className="text-2xl mr-2 text-neutral-300" icon="solar:shield-network-bold-duotone"></iconify-icon> Anticipating
                    </span>
...
<span className="reveal-word font-space-grotesk font-light">that</span> <span className="reveal-word font-space-grotesk font-light">turns</span> <span className="reveal-word font-space-grotesk font-light">vulnerability</span> <span className="reveal-word font-space-grotesk font-light">into</span>
<span className="reveal-word inline-flex align-middle border border-subtle text-white px-4 py-1 mx-1">
<iconify-icon className="text-2xl" icon="solar:lock-password-bold-duotone"></iconify-icon>
</span>
<span className="reveal-word font-space-grotesk font-light">impenetrable</span> <span className="reveal-word font-space-grotesk font-light">armor.</span>
</h2>
</div>
</div>
</section>
...
<h2 className="text-5xl md:text-6xl uppercase mb-8 lg:mb-8 text-white tracking-tighter font-space-grotesk font-light">
                        Defense<br/><span className="text-neutral-600">Protocol</span>
</h2>
...
<div className="">
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">01 / Threat Recon</h3>
<p className="step-text text-sm text-neutral-500 font-geist">AI monitors 50M+ vectors daily.</p>
</div>
</div>
...
<div>
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">02 / Auto-Remediation</h3>
<p className="step-text text-sm text-neutral-500 font-geist">Patches vulnerabilities instantly.</p>
</div>
</div>
...
<div>
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">03 / Forensic Analysis</h3>
<p className="step-text text-sm text-neutral-500 font-geist">Deep dive into attack vectors.</p>
</div>
</div>
</div>
...
<iconify-icon className="text-4xl text-white mb-2" icon="solar:radar-bold-duotone"></iconify-icon>
<div className="text-xs font-mono text-green-400">SCANNING NETWORK...</div>
</div>
</div>
...
<div className="relative z-10 text-center">
<iconify-icon className="text-4xl text-white mb-2" icon="solar:bug-bold-duotone"></iconify-icon>
<div className="text-xs font-mono text-blue-400">ISOLATING THREAT...</div>
</div>
</div>
...
<div className="relative z-10 text-center">
<iconify-icon className="text-4xl text-white mb-2" icon="solar:document-text-bold-duotone"></iconify-icon>
<div className="text-xs font-mono text-purple-400">AUDIT COMPLETE</div>
</div>
</div>
</div>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">Threat Reconnaissance</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            Our neural networks scan global traffic patterns in real-time, identifying zero-day anomalies before they can exploit your perimeter. This allows for proactive hardening.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Behavioral Analysis</li>
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Dark Web Monitoring</li>
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Vulnerability Scoring</li>
</ul>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">Auto-Remediation</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            From detection to patch, our agents handle the heavy lifting. We deploy instant countermeasures to isolate infected nodes and patch vulnerabilities across your stack.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Automated Patching</li>
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Sandbox Isolation</li>
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:shield-check-bold-duotone"></iconify-icon> A/B Policy Testing</li>
</ul>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">Forensic Analysis</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            Prevention is key, but understanding the attack vector is crucial. Our automated reporting logs every attempt, ensuring compliance and improving future defenses.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:shield-check-bold-duotone"></iconify-icon> 24/7 Logging</li>
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:shield-check-bold-duotone"></iconify-icon> SIEM Integration</li>
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:shield-check-bold-duotone"></iconify-icon> Compliance Mapping</li>
</ul>
</div>
</div>
</div>
...
<div className="">
<h2 className="text-5xl md:text-7xl uppercase mb-2 text-white tracking-tighter font-space-grotesk font-light">Integrity</h2>
<p className="text-xs uppercase tracking-widest text-neutral-500 font-geist">/ System Logs / Coverage</p>
</div>
</div>
...
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Device Control</h3>
</div>
</div>
</div>
...
<div className="absolute top-4 right-4 z-20 text-[10px] text-white/50 border border-white/5 px-2 py-0.5 font-geist">CLOUD</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Perimeter Defense</h3>
</div>
</div>

<div className="relative flex-1 group overflow-hidden border border-subtle bg-white/[0.02]">
<div className="absolute top-4 right-4 z-20 text-[10px] text-white/50 border border-white/5 px-2 py-0.5 font-geist">CORE</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Anomaly Detect</h3>
</div>
</div>

<div className="relative flex-1 group overflow-hidden border border-subtle bg-white/[0.02]">
<div className="absolute top-4 right-4 z-20 text-[10px] text-white/50 border border-white/5 px-2 py-0.5 font-geist">LOGS</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Real-time Audit</h3>
</div>
</div>
</div>
...
<div className="flex flex-col gap-1 h-full">
<div className="bg-white/[0.02] border border-subtle w-full aspect-[9/16] relative group overflow-hidden">
<div className="absolute top-4 right-4 z-20 text-[10px] text-white/50 border border-white/5 px-2 py-0.5 font-geist">IOT</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Edge Security</h3>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-5xl uppercase text-center text-white tracking-tighter font-space-grotesk font-light">
                CISO <span className="text-neutral-600">Feedback</span>
</h2>
</div>
...
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"DVolt's zero-trust protocols didn't just patch our system, they fundamentally changed our security posture. We reduced incidents by 99%."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
<iconify-icon className="text-2xl text-white" icon="simple-icons:vercel"></iconify-icon>
</div>
<div><div className="text-xs text-white uppercase font-bold font-geist">Sarah Jenks</div><div className="text-[10px] text-neutral-500 uppercase font-geist">CISO, Vercel</div></div>
</div>
</div>

<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"The precision in anomaly detection is unlike anything we've seen. We reduced false positives by 40% while securing all endpoints."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
<iconify-icon className="text-2xl text-white" icon="simple-icons:openai"></iconify-icon>
</div>
<div><div className="text-xs text-white uppercase font-bold font-geist">David K.</div><div className="text-[10px] text-neutral-500 uppercase font-geist">Head of Sec, OpenAI</div></div>
</div>
</div>

<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"Automated penetration testing is keeping our compliance updated while we sleep. The ROI was evident after the first audit."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
<iconify-icon className="text-2xl text-white" icon="simple-icons:stripe"></iconify-icon>
</div>
<div><div className="text-xs text-white uppercase font-bold font-geist">Elena R.</div><div className="text-[10px] text-neutral-500 uppercase font-geist">VP Eng, Stripe</div></div>
</div>
</div>
</div>
...
<h2 className="md:text-8xl uppercase text-5xl font-light text-white tracking-tighter font-space-grotesk mix-blend-plus-lighter mb-8">
                Ready to <span className="text-neutral-600">Secure?</span>
</h2>
<p className="text-xl text-neutral-400 font-geist mix-blend-plus-lighter max-w-xl mr-auto mb-10 ml-auto">
    Join the 1% of enterprises leveraging autonomous security infrastructure.
</p>
<div className="">
...
<div className="">
<h3 className="text-3xl uppercase text-white mb-6 tracking-tighter font-space-grotesk font-light">Initialize Handshake</h3>
<p className="text-sm text-neutral-400 mb-8 leading-relaxed font-geist">
                        Fill out the parameters for your security inquiry. Our AI agents will categorize your request and a human strategist will deploy a response within 24 hours.
                    </p>
...
<span className="font-geist">hello@dvolt.sec</span>
</div>
<div className="flex items-center gap-4 text-neutral-300">
...
<label className="absolute left-0 -top-3 text-[10px] text-neutral-500 uppercase tracking-widest transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-neutral-600 peer-focus:-top-3 peer-focus:text-[10px] peer-focus:text-white font-geist" htmlFor="name">Identity</label>
</div>
<div className="group relative">
...
<label className="absolute left-0 -top-3 text-[10px] text-neutral-500 uppercase tracking-widest transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-neutral-600 peer-focus:-top-3 peer-focus:text-[10px] peer-focus:text-white font-geist" htmlFor="message">Threat Logs</label>
</div>
...
<p className="font-geist">© 2024 DVolt Security. // All Rights Reserved</p>

...
<div className="absolute bottom-0 right-0 bg-blue-500 rounded-full p-1.5 border-2 border-[#101010]">
...
<h3 className="text-gray-200 font-medium text-sm">Account</h3>
</div>
...
<span className="text-gray-300 text-sm">Personal Information</span>
</div>
<svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-gray-300 text-sm">Password &amp; Security</span>
</div>
<svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 4.5l7.5 7.5-7.5 7.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
...
<div className="w-full bg-[#151515] rounded-xl overflow-hidden shadow-lg border border-[#232323] mb-4">
<div className="px-4 pt-3 pb-2 border-b border-[#232323]">
<h3 className="text-gray-200 font-medium text-sm">Preferences</h3>
</div>
<div className="divide-y divide-[#232323]">
<div className="flex justify-between items-center p-4">
<div className="flex items-center">
...
<span className="text-gray-300 text-sm">Units &amp; Settings</span>
</div>
<svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 4.5l7.5 7.5-7.5 7.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
...
<div className="bg-blue-500/10 p-2 rounded-full mr-3">
<svg className="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4.098 19.902a3.75 3.75 0 005.304 0l6.401-6.402M6.75 21A3.75 3.75 0 013 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 003.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.88-2.88c.438-.439 1.15-.439 1.59 0l3.712 3.713c.44.44.44 1.152 0 1.59l-2.879 2.88M6.75 17.25h.008v.008H6.75v-.008z" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</div>
...
<span className="text-gray-300 text-sm">Location Services</span>
</div>
<svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 4.5l7.5 7.5-7.5 7.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
...
<div className="w-full bg-[#151515] rounded-xl overflow-hidden shadow-lg border border-[#232323] mb-4">
<div className="px-4 pt-3 pb-2 border-b border-[#232323]">
<h3 className="text-gray-200 font-medium text-sm">Support &amp; About</h3>
</div>
<div className="divide-y divide-[#232323]">
<div className="flex justify-between items-center p-4">
<div className="flex items-center">
...
<button className="w-full py-3 bg-red-500/10 rounded-lg text-red-500 font-medium mt-4 hover:bg-red-500/20 transition-colors">
        Log Out
      </button>
</div>

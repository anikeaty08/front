...
<h2 className="text-4xl md:text-6xl font-bold text-white tracking-tighter mb-2 leading-none">DEPOSIT<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-emerald-400">BONUS EVENT</span></h2>
...
<img className="w-full h-full object-cover opacity-50 mix-blend-overlay" src="https://images.unsplash.com/photo-1596838132731-3301c3fd4317?q=80&amp;w=2670&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-12">
...
<div className="p-4 space-y-4" id="matches-container"></div>
</div>
...
<div className="flex justify-between text-[10px] font-medium text-gray-500"><span id="stake-label">Stake (Combo)</span><span className="text-white" id="display-total-stake">$10.00</span></div>
...
<div className="lg:hidden fixed bottom-0 left-0 w-full bg-gray-950/95 backdrop-blur-md border-t border-gray-800 flex justify-between px-6 pt-3 pb-safe min-h-[80px] z-40">

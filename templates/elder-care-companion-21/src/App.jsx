...
<div className="relative w-full max-w-5xl aspect-[16/9] glass-panel rounded-3xl overflow-hidden fade-in-section shadow-2xl" id="constellation-map">
...
<div className="star-tooltip absolute top-8 left-1/2 -translate-x-1/2 w-72 p-6 glass-panel rounded-xl bg-[#0A1128]/95 border border-white/10 z-20">
...
<div className="star-tooltip absolute top-8 left-1/2 -translate-x-1/2 w-72 p-6 glass-panel rounded-xl bg-[#0A1128]/95 border border-white/10 z-20">
<p className="text-base font-normal text-[#E2E8F0]">The sound of the ocean at night.</p>
</div>
</div>
...
<div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] mb-2">
<span className="iconify" data-icon="lucide:heart-handshake" data-width="26"></span>
</div>
...
<div className="glass-panel p-8 rounded-2xl flex flex-col gap-4 hover:bg-white/5 transition-colors duration-500">
<div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] mb-2">
<span className="iconify" data-icon="lucide:sparkles" data-width="26"></span>
</div>
...
<div className="flex flex-col gap-16 fade-in-section">
...
<p className="mb-6 text-sm">Designed for peace of mind in the Village.</p>
<div className="flex justify-center gap-8 text-xs tracking-widest uppercase text-[#D4AF37]/80">

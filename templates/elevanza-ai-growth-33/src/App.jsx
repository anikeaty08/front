...
<span className="text-xs font-semibold tracking-tight">EA</span>
</div>
...
<span className="text-sm font-medium text-white">Book Growth Call</span>
...
<span className="text-sm font-medium text-indigo-100">
          Growth Automation for Ambitious Brands
        </span>
</div>
...
<span className="block mt-2 text-white/80">GROWTH</span>
</h1>
...
<p className="mt-8 text-lg md:text-xl text-neutral-400 text-center max-w-2xl leading-relaxed font-normal [animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll">
        Elevanza.ai helps brands scale smarter with automation, performance marketing,
        and e‑commerce systems. We blend creativity and data to turn traffic into
        revenue and clicks into loyal customers.
      </p>
...
<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" fill="currentColor" stroke="none"></path>
</svg>
</div>
...
<span className="text-sm text-white font-medium">New Lead Captured</span>
</div>
<span className="text-xs font-mono text-neutral-500">FORM</span>
</div>
...
<span className="text-sm font-medium">Abandoned Cart Email</span>
</div>
...
<span className="text-sm font-medium">New Purchase Event</span>
</div>
<div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-colors opacity-60">
...
<span className="text-sm font-medium">Scheduled Campaign</span>
</div>
</div>
</div>
...
<span className="text-[10px] font-semibold tracking-tight">ROAS</span>
</div>
<div className="flex flex-col">
<span className="text-sm font-medium">Optimize Ad Spend</span>
<span className="text-[10px] text-neutral-500">Performance Model</span>
</div>
</div>
...
<div className="flex flex-col">
<span className="text-sm font-medium">Generate Ad Copy</span>
<span className="text-[10px] text-neutral-500">Creative AI</span>
</div>
</div>
...
<div className="flex flex-col">
<span className="text-sm font-medium">Personalize Messages</span>
<span className="text-[10px] text-neutral-500">CRM Intelligence</span>
</div>
</div>
</div>
...
<span className="text-sm font-medium">Lifecycle Journey</span>
</div>
...
<path d="M3 3L10.07 19.97L12.58 12.58L19.97 10.07L3 3Z" fill="#F5F5F5" stroke="black" strokeLinejoin="round" strokeWidth="1.5"></path>
</svg>
...
<span className="text-sm font-medium">Add growth step</span>
</div>
</div>
</div>
</div>
...
<span className="text-neutral-300">New signup from Meta Ads</span>
</div>
<div className="flex gap-2">
<span className="text-neutral-600">10:42:02</span>
<span className="text-purple-400">segment</span>
<span className="text-neutral-300">Assigned to: High‑value cohort</span>
</div>
<div className="flex gap-2">
<span className="text-neutral-600">10:42:03</span>
<span className="text-yellow-400">journey</span>
<span className="text-neutral-300">Triggered: Nurture sequence v3</span>
</div>
<div className="flex gap-2">
<span className="text-neutral-600">10:42:04</span>
<span className="text-emerald-400">result</span>
<span className="text-neutral-300">Expected LTV uplift: +32%</span>
</div>
</div>
<div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
<div className="text-xs text-neutral-500">
            CPA:
            <span className="text-neutral-300">$7.40</span>
</div>
<div className="text-xs text-neutral-500">
            ROAS:
            <span className="text-neutral-300">4.2x</span>
</div>
</div>
</div>
</main>
...
<p className="md:text-lg leading-relaxed text-base font-light text-neutral-400">
            Elevanza.ai partners with brands to improve customer acquisition,
            streamline operations, and boost revenue through data‑driven strategies
            and smart technology. We focus on real results, not just reports.
          </p>
</div>
</div>
...
<span className="">Growth score: 87</span>
</div>
...
<p className="text-sm text-neutral-400 leading-relaxed font-light">
              Turn fragmented ad data into clear decisions. Elevanza.ai helps you
              forecast, allocate, and scale spend where it actually converts.
            </p>
</div>
</div>
...
<h3 className="text-2xl font-semibold text-white tracking-tight mb-2">
              Automated Brand Journeys
            </h3>
<p className="text-sm text-neutral-400 leading-relaxed font-light">
              Build always‑on experiences that nurture, convert, and retain customers
              across channels without adding more manual work to your team.
            </p>
</div>
</div>
...
<p className="text-sm text-neutral-400 leading-relaxed font-light">
                From store optimization to funnels and upsells, we design systems
                that increase AOV, repeat purchase rate, and lifetime value across
                your e‑commerce stack.
              </p>
</div>
</div>
</div>
...
<p className="leading-relaxed text-lg font-light text-neutral-400">
              Elevanza.ai connects with the tools you already use, keeping your
              marketing, data, and e‑commerce systems in sync instead of siloed.
            </p>
</div>
</div>
...
<p className="text-neutral-500 text-sm leading-relaxed font-normal">
                  Connect Meta, Google, TikTok and more to unify performance,
                  audiences, and reporting in one place.
                </p>
</div>
...
<h3 className="text-lg font-medium text-white">CRM &amp; Email</h3>
</div>
<p className="leading-relaxed text-sm font-normal text-neutral-500">
                  Sync journeys across HubSpot, Klaviyo, and other CRMs so
                  automation matches your full funnel.
                </p>
</div>
...
<p className="leading-relaxed text-sm font-normal text-neutral-500">
                  Plug into Shopify, WooCommerce and custom stores to optimize
                  checkout, upsells, and retention.
                </p>
</div>
</div>
</div>
...
<div className="max-w-md">
<p className="md:text-lg leading-relaxed text-base font-light text-neutral-400">
            With 100+ businesses supported across industries, Elevanza.ai is
            built for teams who care about measurable impact, not vanity metrics.
          </p>
</div>
</div>
...
<p className="text-neutral-300 text-lg font-light leading-relaxed mb-8">
                  "Their automation stack replaced three separate tools and
                  halved our manual workload. We finally have campaigns running
                  24/7 without babysitting dashboards."
                </p>
...
<p className="text-neutral-300 text-lg font-light leading-relaxed mb-8">
                  "We launched three new paid funnels with Elevanza.ai and saw a
                  40% lift in qualified leads while keeping ad spend flat."
                </p>
<div className="flex items-center justify-between border-t border-white/5 pt-6">
<div>
<h4 className="text-white font-semibold tracking-tight">

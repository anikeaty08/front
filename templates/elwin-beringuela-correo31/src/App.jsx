...
<div className="sm:p-6 bg-center rounded-3xl ring-0 pt-5 pr-5 pb-5 pl-5 relative shadow-[0_10px_40px_-10px_rgba(0,0,0,0.6)] backdrop-blur-lg" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', -BorderRadiusBefore: '24px'}}>
<div className="flex items-center gap-3">
<div className="h-9 w-9 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center">

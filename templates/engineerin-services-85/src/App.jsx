...
<span className="fs-3xl fw-semibold text-dark-blue tracking-tight">Vector</span>
</div>
...
<p className="scroll-animate fs-base fw-medium fst-italic text-cyan mb-3">Your Trusted Partner</p>
<h1 className="scroll-animate delay-100 fs-5xl fw-semibold text-dark-blue tracking-tight lh-sm mb-4">
                        Precision Engineering.<br/>Future-Ready Results.
                    </h1>
<p className="scroll-animate delay-200 fs-lg text-slate-600 mb-5 lh-lg" style={{maxWidth: '500px'}}>
                        Partnering with global industries to deliver end-to-end engineering excellence across Building, Infrastructure, and BIM services.
                    </p>

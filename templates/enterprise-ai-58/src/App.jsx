...
<div className="absolute w-full h-full left-0 top-0 z-0" data-us-project="U7tLRvdF7ikcfxcCHs65">
</div>
...
<a className="text-xs uppercase tracking-widest text-white font-medium" href="#">Platform</a>
<a className="text-xs uppercase tracking-widest text-neutral-400 hover:text-white transition-colors font-medium" href="#">Solutions</a>
<a className="text-xs uppercase tracking-widest text-neutral-400 hover:text-white transition-colors font-medium" href="#">Enterprise</a>
<a className="text-xs uppercase tracking-widest text-neutral-400 hover:text-white transition-colors font-medium" href="#">Developers</a>
</div>
...
<iconify-icon className="text-slate-500 group-hover:text-white transition-colors" icon="lucide:chevron-down" width="12"></iconify-icon>
</div>
</div>
...
<span className="px-2.5 py-1.5 rounded-lg bg-white/[0.03] border border-white/5 text-xs text-slate-300 flex items-center gap-1.5 shadow-sm hover:border-white/20 cursor-pointer transition-colors">
<iconify-icon className="text-yellow-500" icon="simple-icons:slack" width="12"></iconify-icon> Slack
              </span>
</div>
</div>
</div>
...
<iconify-icon className="text-lg" icon="solar:cloud-bold"></iconify-icon>
</div>
<div className="flex flex-col">
...
<iconify-icon className="text-lg" icon="solar:server-bold"></iconify-icon>
</div>
<div className="flex flex-col">
...
<iconify-icon className="text-2xl text-white drop-shadow-md" icon="solar:brain-bold"></iconify-icon>
</div>
...
<line className="opacity-50" stroke="url(#pinkGradient)" stroke-dasharray="4 4" strokeWidth="1" x1="50%" x2="30%" y1="50%" y2="30%"></line>
<line className="opacity-50" stroke="url(#pinkGradient)" stroke-dasharray="4 4" strokeWidth="1" x1="50%" x2="70%" y1="50%" y2="70%"></line>
<defs>
<lineargradient id="pinkGradient" x1="0%" x2="100%" y1="0%" y2="0%">
<stop offset="0%" stop-color="rgba(236, 72, 153, 0)"></stop>
<stop offset="50%" stop-color="rgba(236, 72, 153, 0.5)"></stop>
...
<iconify-icon className="text-4xl text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]" icon="solar:shield-check-bold"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-cyan-400" icon="solar:lock-password-linear"></iconify-icon>
</div>
...
<div className="uc-visual w-full h-full flex flex-col animate-in fade-in zoom-in-95 duration-500" id="uc-visual-1">
...
<iconify-icon className="text-white text-sm" icon="lucide:sparkles"></iconify-icon>
</div>
...
<iconify-icon className="text-indigo-400 text-lg drop-shadow-[0_0_5px_rgba(99,102,241,0.8)]" icon="lucide:bot"></iconify-icon>
</div>
...
<input className="relative w-full bg-black/40 border border-white/10 rounded-xl pl-5 pr-12 py-4 text-sm text-white placeholder-slate-600 shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)] focus:outline-none focus:border-indigo-500/50 transition-all" placeholder="Ask anything..." type="text"/>
...
<iconify-icon className="text-base" icon="lucide:arrow-up"></iconify-icon>
</button>
</div>
</div>
</div>
<div className="uc-visual hidden w-full h-full flex flex-col animate-in fade-in zoom-in-95 duration-500" id="uc-visual-2">
...
<iconify-icon className="text-slate-400 text-lg" icon="lucide:monitor"></iconify-icon>
</div>
<div>
...
<iconify-icon className="text-slate-500 text-xs" icon="lucide:plus"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-white text-xl" icon="simple-icons:notion"></iconify-icon>
</div>
<div>
<h4 className="text-slate-200 font-bold text-sm">Requirements v1</h4>
<div className="flex items-center gap-2 text-xs text-slate-500 mt-1">
<iconify-icon className="text-[10px]" icon="lucide:clock"></iconify-icon> Edited 2h ago
                          </div>
</div>
</div>
...
<iconify-icon className="text-[#20C073] text-xl" icon="lucide:table-2"></iconify-icon>
</div>
<div>
<h4 className="text-slate-200 font-bold text-sm">Delivery Schedule</h4>
<div className="flex items-center gap-2 text-xs text-slate-500 mt-1">
<iconify-icon className="text-[10px]" icon="lucide:users"></iconify-icon> 16 Viewers
                          </div>
</div>
</div>
<div className="px-3 py-1 rounded-full bg-black/50 border border-white/5 text-xs text-slate-400">
...
<div className="uc-visual hidden w-full h-full flex flex-col animate-in fade-in zoom-in-95 duration-500" id="uc-visual-3">
...
<iconify-icon className="text-[#5865F2]" icon="simple-icons:discord"></iconify-icon>
</div>
<div className="flex-1">
...
<iconify-icon className="text-[#2DA44E]" icon="simple-icons:github"></iconify-icon>
</div>
<div className="flex-1">
<div className="flex justify-between items-center mb-1">
...
<iconify-icon className="text-slate-600" icon="lucide:git-commit"></iconify-icon> 8f3d2a1
                            </div>
</div>
</div>
</div>
...
<div className="uc-visual hidden w-full h-full flex flex-col animate-in fade-in zoom-in-95 duration-500" id="uc-visual-4">
<div className="h-20 px-8 flex items-center justify-between border-b border-white/5 rounded-t-[2rem]">
...
<div className="uc-tab group relative p-6 cursor-pointer hover:bg-white/[0.02] transition-colors border-t-2 border-indigo-500" id="uc-tab-1" onclick="switchUseCase(1)">
<div className="flex items-center gap-3 mb-2">
<iconify-icon className="text-indigo-400 text-base tab-icon" icon="lucide:sparkles"></iconify-icon>
...
<div className="uc-tab group relative p-6 cursor-pointer hover:bg-white/[0.02] transition-colors border-t-2 border-transparent hover:border-white/10" id="uc-tab-2" onclick="switchUseCase(2)">
<div className="flex items-center gap-3 mb-2">
<iconify-icon className="text-slate-500 text-base tab-icon group-hover:text-slate-300" icon="lucide:layers"></iconify-icon>
...
<div className="uc-tab group relative p-6 cursor-pointer hover:bg-white/[0.02] transition-colors border-t-2 border-transparent hover:border-white/10" id="uc-tab-3" onclick="switchUseCase(3)">
<div className="flex items-center gap-3 mb-2">
<iconify-icon className="text-slate-500 text-base tab-icon group-hover:text-slate-300" icon="lucide:zap"></iconify-icon>
...
<div className="uc-tab group relative p-6 cursor-pointer hover:bg-white/[0.02] transition-colors border-t-2 border-transparent hover:border-white/10" id="uc-tab-4" onclick="switchUseCase(4)">
<div className="flex items-center gap-3 mb-2">
<iconify-icon className="text-slate-500 text-base tab-icon group-hover:text-slate-300" icon="lucide:bar-chart-3"></iconify-icon>
...
<style>
        ...
        .pricing-card:hover {
          ...
          box-shadow: 0 0 50px -10px rgba(59, 130, 246, 0.2);
        }
        ...
        .pricing-card:hover .pricing-card-button {
          background-image: linear-gradient(to bottom right, rgb(59 130 246), rgb(30 64 175));
...
<iconify-icon className="text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]" icon="lucide:scan" width="24"></iconify-icon>
</div>
...
<iconify-icon className="text-cyan-400 group-hover/item:text-cyan-300 transition-colors" icon="lucide:check" width="12"></iconify-icon>
</div>
...
<iconify-icon className="text-indigo-400 drop-shadow-[0_0_10px_rgba(99,102,241,0.5)]" icon="lucide:atom" width="28"></iconify-icon>
</div>
...
<iconify-icon className="text-indigo-300 group-hover/item:text-indigo-200 transition-colors" icon="lucide:check" width="12"></iconify-icon>
</div>
...
<div className="relative z-10 mb-8">
<div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-slate-800 to-black border border-white/5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.8)] flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
<iconify-icon className="text-pink-400 drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]" icon="lucide:box" width="24"></iconify-icon>
</div>
...
<iconify-icon className="text-neutral-400 group-hover:text-white transition-colors group-hover:translate-x-0.5 duration-300" icon="lucide:arrow-right"></iconify-icon>
</button>
</div>
</div>
</div>
...
<button className="group w-14 h-14 rounded-full bg-gradient-to-b from-[#23262d] to-[#181a20] border-t border-white/10 border-b border-black shadow-[0_8px_20px_-5px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.1)] flex items-center justify-center text-slate-400 hover:text-white active:translate-y-[2px] active:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:active:translate-y-0 disabled:hover:text-slate-400" onclick="handleTestimonialSwipe(-1)">
<svg className="group-hover:-translate-x-0.5 transition-transform w-[20px] h-[20px]" data-icon-replaced="true" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '20px', height: '20px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m15 18-6-6 6-6"></path>
</svg>
</button>
<button className="group w-14 h-14 rounded-full bg-gradient-to-b from-[#23262d] to-[#181a20] border-t border-white/10 border-b border-black shadow-[0_8px_20px_-5px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.1)] flex items-center justify-center text-slate-400 hover:text-white active:translate-y-[2px] active:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:active:translate-y-0 disabled:hover:text-slate-400" onclick="handleTestimonialSwipe(1)">
<svg className="w-5 h-5 group-hover:translate-x-0.5 transition-transform" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m9 18 6-6-6-6"></path>
</svg>
</button>
</div>
<div className="transition-all duration-500 ease-out md:absolute md:top-1/2 md:left-1/2 w-full mb-6 md:mb-0 group cursor-pointer md:w-[400px] md:-translate-x-[125%] md:-translate-y-[60%] md:-rotate-[6deg] md:scale-75 z-10 md:opacity-50 hover:md:opacity-100 hover:z-40" id="testimonial-card-1">
...
<div className="transition-all duration-500 ease-out md:absolute md:top-1/2 md:left-1/2 w-full mb-6 md:mb-0 group cursor-pointer md:w-[480px] md:-translate-x-1/2 md:-translate-y-[65%] z-30 opacity-100 md:rotate-0 md:scale-110" id="testimonial-card-2">
...
<div className="transition-all duration-500 ease-out md:absolute md:top-1/2 md:left-1/2 w-full mb-6 md:mb-0 group cursor-pointer md:w-[400px] md:translate-x-[25%] md:-translate-y-[60%] md:rotate-[6deg] md:scale-75 z-10 md:opacity-50 hover:md:opacity-100 hover:z-40" id="testimonial-card-3">
<div className="relative flex flex-col bg-gradient-to-b from-slate-800/90 to-slate-900/90 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-2 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.6)]">
<div className="absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent opacity-70 z-30">
</div>
<div className="relative h-full bg-[#0B1120]/80 backdrop-blur-lg ring-1 ring-white/5 shadow-[inset_0_2px_8px_rgba(0,0,0,0.8)] rounded-[2rem] overflow-hidden p-8 flex flex-col">
...
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Agent Runtime</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Memory Engine</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Observability</a></li>
</ul>
</div>
<div>
<h4 className="text-white text-xs font-bold mb-6 tracking-widest uppercase opacity-80">Solutions</h4>
<ul className="space-y-4">
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Financial Ops</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Customer Success</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>DevOps Automation</a></li>
</ul>
</div>
<div>
<h4 className="text-white text-xs font-bold mb-6 tracking-widest uppercase opacity-80">Company</h4>
<ul className="space-y-4">
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>About</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Careers</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Blog</a></li>
</ul>
</div>
<div>
<h4 className="text-white text-xs font-bold mb-6 tracking-widest uppercase opacity-80">Resources</h4>
<ul className="space-y-4">
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Documentation</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>API Reference</a></li>
<li><a className="group flex items-center text-sm text-slate-400 hover:text-indigo-300 transition-colors font-light" href="#"><span className="w-0 overflow-hidden group-hover:w-3 transition-all duration-300 text-indigo-400 opacity-0 group-hover:opacity-100">›</span>Community</a></li>
</ul>
</div>
</div>

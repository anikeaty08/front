...
to: { 'stroke-dashoffset': '1000' }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const openBtn = document.getElementById('start-instance-btn');
            ...
            if (modal && openBtn) {
                function openModal() {
                    ...
                    // Disable body scroll via Lenis and CSS
                    lenis.stop();
...
<button className="bg-accent text-black px-8 py-4 font-bold text-sm uppercase tracking-widest hover:bg-white transition-all hover-trigger w-full sm:w-auto btn-magnetic cursor-pointer z-30" id="start-instance-btn">
                        Start Instance
                    </button>
...
<div className="text-3xl font-bold text-white mb-6 z-10 relative">10 PLN <span className="text-sm font-normal text-gray-500">/mo</span></div>
...
<div className="text-3xl font-bold text-white mb-6 z-10 relative">20 PLN <span className="text-sm font-normal text-gray-500">/ mo</span></div>
<ul className="space-y-4 text-sm text-gray-300 mb-8 font-mono z-10 relative">
...
<div className="text-3xl font-bold text-white mb-6 z-10 relative">40 PLN <span className="text-sm font-normal text-gray-500">/ mo</span></div>
<ul className="space-y-4 text-sm text-gray-300 mb-8 font-mono z-10 relative">
...
<div className="fixed inset-0 z-[9999] hidden flex items-center justify-center p-4" id="instance-modal">

<div className="absolute inset-0 bg-[#000000]/90 backdrop-blur-sm cursor-pointer transition-opacity duration-300 opacity-0" id="modal-backdrop"></div>

<div className="relative w-full max-w-4xl h-[85vh] bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col transform scale-95 opacity-0 transition-all duration-300 z-50" id="modal-content">

<div className="flex justify-between items-center px-6 py-4 border-b border-white/10 bg-white/5 backdrop-blur-md z-20">
<div className="flex items-center gap-3">
<span className="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
<span className="font-display font-bold text-white tracking-tight">INITIALIZE INSTANCE</span>
</div>
<button className="text-gray-500 hover:text-white transition-colors p-2 cursor-pointer" id="close-modal">
<svg fill="none" height="20" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="20"><line x1="18" x2="6" y1="6" y2="18"></line><line x1="6" x2="18" y1="6" y2="18"></line></svg>
</button>
</div>

<div className="flex-1 w-full relative bg-[#0a0a0a]">

<iframe frameborder="0" height="100%" marginheight="0" marginwidth="0" src="https://tally.so/r/mZpg9e?transparentBackground=1" title="3 Video - Agencja AI " width="100%"></iframe>
</div>
</div>
</div>

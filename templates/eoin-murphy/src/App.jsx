...
<a aria-label="Eoin Murphy Home" className="flex items-center gap-3 pr-4 group shrink-0" href="/">
...
<span className="text-white font-semibold tracking-tight text-sm">Eoin Murphy</span>
</a>
...
<span className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-signal"></span>
                    Eoin Murphy · Outbound Execution
                </div>
<h1 className="md:text-6xl lg:text-7xl leading-[1.1] text-5xl font-semibold text-white tracking-tight mb-8">
                    You’re Doing the Work.<br/>
<span className="bg-clip-text text-transparent bg-gradient-to-br from-white via-white to-zinc-500 drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">You’re Just Not Getting Replies.</span>
</h1>
<p className="leading-relaxed text-lg font-light text-zinc-400 max-w-2xl mr-auto mb-10 ml-auto">Most reps aren’t lazy they’re just running outreach that doesn’t land. Eoin Murphy focuses on fixing what actually happens when you hit send.</p>
...
<span className="text-sm font-mono tracking-widest">[VIDEO PLACEHOLDER]</span>
</div>
</div>
<div className="mt-4 flex items-center gap-2 px-2">
<span className="w-2 h-2 rounded-full bg-orange-500 shadow-[0_0_8px_rgba(234,88,12,0.8)]"></span>
<span className="text-sm text-zinc-400 font-medium">Watch: Why Your Outreach Isn’t Converting</span>
</div>
</div>

<div className="w-full lg:w-[40%] flex flex-col justify-center">
<p className="text-white text-base leading-relaxed mb-6 font-medium">
                                If you’re sending messages every day but not booking meetings, this isn’t a work ethic problem.
                            </p>
...
<span className="text-zinc-300 text-sm">Sound like every other outbound message</span>
</li>
<li className="flex items-start gap-3">
<div className="w-5 h-5 rounded flex items-center justify-center bg-red-500/10 text-red-400 shrink-0 mt-0.5">
<iconify-icon icon="solar:close-square-linear" width="14"></iconify-icon>
</div>
<span className="text-zinc-300 text-sm">Rely on “personalization” that doesn’t matter</span>
</li>
<li className="flex items-start gap-3">
<div className="w-5 h-5 rounded flex items-center justify-center bg-red-500/10 text-red-400 shrink-0 mt-0.5">
<iconify-icon icon="solar:close-square-linear" width="14"></iconify-icon>
</div>
<span className="text-zinc-300 text-sm">Push too early instead of opening conversations</span>
</li>
<li className="flex items-start gap-3">
<div className="w-5 h-5 rounded flex items-center justify-center bg-red-500/10 text-red-400 shrink-0 mt-0.5">
<iconify-icon icon="solar:close-square-linear" width="14"></iconify-icon>
</div>
<span className="text-zinc-300 text-sm">Don’t know what actually earns a reply</span>
</li>
</ul>
<div className="p-4 rounded-xl bg-black/50 border border-white/5">
<div className="text-xs text-zinc-500 uppercase tracking-wide mb-2">In this video, Eoin breaks down:</div>
<div className="text-sm text-zinc-300 leading-relaxed">
                                    • What makes someone respond<br/>
                                    • Where outreach actually fails<br/>
                                    • How to fix it without sending more volume
                                </div>
</div>
</div>
</div>
...
<section className="py-12 border-t border-white/5 bg-[#020202] relative z-20 overflow-hidden">
<div className="max-w-7xl mx-auto px-6 text-center">
<p className="text-xs font-mono text-zinc-500 uppercase tracking-wide mb-8">Reps improving outbound consistency</p>
...
<div className="w-32 h-12 bg-zinc-900 border border-white/10 rounded-lg flex items-center justify-center text-xs text-zinc-600 font-mono">[IMAGE PLACEHOLDER]</div>
<div className="w-32 h-12 bg-zinc-900 border border-white/10 rounded-lg flex items-center justify-center text-xs text-zinc-600 font-mono">[IMAGE PLACEHOLDER]</div>
<div className="w-32 h-12 bg-zinc-900 border border-white/10 rounded-lg flex items-center justify-center text-xs text-zinc-600 font-mono">[IMAGE PLACEHOLDER]</div>
<div className="w-32 h-12 bg-zinc-900 border border-white/10 rounded-lg flex items-center justify-center text-xs text-zinc-600 font-mono hidden md:flex">[IMAGE PLACEHOLDER]</div>
<div className="w-32 h-12 bg-zinc-900 border border-white/10 rounded-lg flex items-center justify-center text-xs text-zinc-600 font-mono hidden lg:flex">[IMAGE PLACEHOLDER]</div>
</div>
</div>
</section>
...
<h2 className="md:text-5xl leading-tight text-4xl font-semibold text-white tracking-tight mb-16">
                    Why Your Messages <br className="hidden md:block"/>Aren’t Getting Replies
                </h2>
...
<h3 className="text-xl text-white font-medium mb-3">Everything sounds familiar</h3>
<p className="text-zinc-400 text-base leading-relaxed">Prospects have seen it before. If your message looks like a standard template, it gets ignored instantly.</p>
</div>
...
<h3 className="text-xl text-white font-medium mb-3">Wrong type of personalization</h3>
<p className="text-zinc-400 text-base leading-relaxed">Mentioning their college or a generic recent post isn't relevance. The effort is there, but the impact isn’t.</p>
</div>
...
<h3 className="text-xl text-white font-medium mb-3">Too focused on pitching</h3>
<p className="text-zinc-400 text-base leading-relaxed">You're trying to close a meeting in the first touch. You're not focused on starting a conversation first.</p>
</div>
...
<h3 className="text-xl text-white font-medium mb-3">No feedback loop</h3>
<p className="text-zinc-400 text-base leading-relaxed">You’re sending volume blindly. You don’t know what’s actually working, so you repeat the same mistakes.</p>
</div>
</div>
</div>
</section>
...
<h2 className="text-3xl md:text-5xl font-semibold text-white tracking-tight mb-8 leading-tight">
                        The Issue Isn’t Volume.<br/>
<span className="text-orange-500">It’s Relevance.</span>
</h2>
<div className="space-y-4 text-zinc-400 text-lg leading-relaxed">
<p>Sending more won’t fix this. Working harder won’t fix this.</p>
<p>Replies come when the message feels different, the context makes sense, and the ask isn’t forced.</p>
</div>
</div>
...
<div className="text-xs font-mono text-zinc-500 uppercase tracking-widest mb-12 ml-4 md:ml-12 border-b border-white/10 pb-4">
                        How Eoin Fixes Outbound: <span className="text-white font-medium ml-2">Response-Driven Outreach</span>
</div>
...
<span className="text-orange-400 font-mono text-xs uppercase tracking-wide mb-3 block">Step 01</span>
<h3 className="text-3xl text-white font-semibold mb-4 tracking-tight">Break down your current messaging</h3>
<p className="text-zinc-400 text-base leading-relaxed">
                                    Instead of optimizing for activity, we focus on what gets opened, what gets read, and what gets answered. We strip away the fluff.
                                </p>
</div>
...
<h4 className="text-white text-base font-medium">Audit &amp; Teardown</h4>
</div>
<p className="text-zinc-500 text-sm leading-relaxed">We analyze your sequences, cold emails, and LinkedIn messages to pinpoint exactly where prospects stop reading and drop off.</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-3xl text-white font-semibold mb-4 tracking-tight">Remove patterns that get ignored</h3>
<p className="text-zinc-400 text-base leading-relaxed">
                                    If it looks like a sales pitch, it gets deleted. We eliminate the generic hooks, the fake personalization, and the desperate calls-to-action.
                                </p>
</div>
<div className="lg:col-span-7">
<div className="bg-zinc-900/40 border border-white/5 rounded-2xl p-6 hover:bg-zinc-900/80 hover:border-white/10 transition-colors">
...
<h4 className="text-white text-base font-medium">Pattern Interruption</h4>
</div>
<p className="text-zinc-500 text-sm leading-relaxed">We replace standard opening lines with sharp, context-driven observations that immediately separate you from the noise in their inbox.</p>
</div>
</div>
</div>
</div>
...
<div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
<div className="lg:col-span-5 pt-1">
<span className="text-green-400 font-mono text-xs uppercase tracking-wide mb-3 block">Step 03</span>
<h3 className="text-3xl text-white font-semibold mb-4 tracking-tight">Rebuild around response triggers</h3>
<p className="text-zinc-400 text-base leading-relaxed">
                                    That’s what separates messages from conversations. We construct outreach that forces a reply by lowering friction and aligning perfectly with their current reality.
                                </p>
</div>
<div className="lg:col-span-7">
<div className="bg-zinc-900/40 border border-white/5 rounded-2xl p-6 hover:bg-zinc-900/80 hover:border-white/10 transition-colors">
...
<h4 className="text-white text-base font-medium">Frictionless Frameworks</h4>
</div>
<p className="text-zinc-500 text-sm leading-relaxed">Deployment of simple, soft-ask frameworks designed to start a dialogue rather than force a 30-minute demo on the first interaction.</p>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight">What’s Included</h2>
</div>
...
<h3 className="text-2xl text-white font-semibold tracking-tight mb-3">Outbound Messaging Reviews &amp; Reply Optimization</h3>
<p className="text-zinc-400 text-base leading-relaxed max-w-md">Continuous teardowns of what you’re sending. We tweak subject lines, context hooks, and CTAs daily until the reply rate hits the target benchmark.</p>
</div>
<div className="mt-8 flex flex-wrap gap-2">
<span className="px-2 py-1 bg-black/50 rounded border border-white/5 text-xs text-zinc-500">A/B Testing</span>
<span className="px-2 py-1 bg-black/50 rounded border border-white/5 text-xs text-zinc-500">Hook Creation</span>
<span className="px-2 py-1 bg-black/50 rounded border border-white/5 text-xs text-white">Conversion Focus</span>
</div>
</div>
...
<h3 className="text-2xl text-white font-semibold tracking-tight mb-3">Prospecting Structure</h3>
<p className="text-zinc-400 text-base leading-relaxed mb-4">Stop guessing who to contact. We build strict frameworks for targeting, prioritization, and account mapping.</p>
</div>
...
<div>
<h3 className="text-2xl text-white font-semibold tracking-tight mb-2">Daily Execution Systems</h3>
<p className="text-zinc-400 text-base leading-relaxed">Practical rhythms to ensure you hit your outbound numbers without burning out or wasting hours on admin.</p>
</div>
</div>
...
<h3 className="text-2xl text-white font-semibold tracking-tight mb-3">1:1 Sales Coaching</h3>
<p className="text-zinc-400 text-base leading-relaxed">Direct, operator-level feedback. Not theory. We look at your actual inbox and fix the bottlenecks holding back your pipeline.</p>
</div>
<div className="flex items-center gap-2 opacity-80">
<div className="px-3 py-2 bg-zinc-900 border border-white/10 rounded text-xs text-zinc-400">Activity</div>
<iconify-icon aria-hidden="true" className="text-zinc-600" icon="solar:arrow-right-linear" width="16"></iconify-icon>
<div className="px-3 py-2 bg-purple-900/30 border border-purple-500/30 rounded text-xs text-purple-300">Coaching</div>
<iconify-icon aria-hidden="true" className="text-zinc-600" icon="solar:arrow-right-linear" width="16"></iconify-icon>
<div className="px-3 py-2 bg-orange-900/30 border border-orange-500/30 rounded text-xs text-orange-300">Meetings</div>
</div>
</div>
</div>
</div>
...
<div className="max-w-7xl mx-auto px-6">
<div className="text-center mb-16">
<div className="text-orange-500 font-mono text-xs uppercase tracking-wide mb-2">Social Proof</div>
<h2 className="md:text-4xl text-3xl font-semibold text-white tracking-tight mb-4">
                        Outbound improving at the message level
                    </h2>
<p className="text-zinc-400 text-base max-w-xl mx-auto">
                        Reps applying Eoin’s approach focus less on volume and more on what actually drives replies.
                    </p>
</div>
...
<span className="text-xs font-mono text-zinc-600">[IMAGE PLACEHOLDER]</span>
</div>
<p className="text-zinc-400 text-sm leading-relaxed mb-6 flex-grow">
                            "Before working with Eoin, I was sending 100+ emails a day with zero replies. We stripped my messaging down, changed the angle, and booked 3 meetings in the first week."
                        </p>
<div className="flex items-center gap-3 pt-4 border-t border-white/5">
<div className="w-8 h-8 rounded-full bg-zinc-800"></div>
<div>
<div className="text-white text-sm font-medium">SDR</div>
<div className="text-zinc-500 text-xs">B2B SaaS</div>
</div>
</div>
</div>
<div className="group relative p-8 rounded-[2rem] bg-[#0A0A0A] border border-white/10 hover:border-white/20 transition-all duration-300 flex flex-col h-full">
...
<p className="text-zinc-400 text-sm leading-relaxed mb-6 flex-grow">
                            "The focus on response-driven outreach completely changed my daily workflow. I'm actually sending less, but my conversion rate from open to reply has tripled."
                        </p>
<div className="flex items-center gap-3 pt-4 border-t border-white/5">
<div className="w-8 h-8 rounded-full bg-zinc-800"></div>
<div>
<div className="text-white text-sm font-medium">Account Executive</div>
<div className="text-zinc-500 text-xs">Tech Agency</div>
</div>
</div>
</div>
<div className="group relative p-8 rounded-[2rem] bg-[#0A0A0A] border border-white/10 hover:border-white/20 transition-all duration-300 flex flex-col h-full">
...
<p className="text-zinc-400 text-sm leading-relaxed mb-6 flex-grow">
                            "Eoin's frameworks removed the guesswork. I know exactly what to say to start a conversation without sounding like a desperate pitch."
                        </p>
<div className="flex items-center gap-3 pt-4 border-t border-white/5">
<div className="w-8 h-8 rounded-full bg-zinc-800"></div>
<div>
<div className="text-white text-sm font-medium">Founder</div>
<div className="text-zinc-500 text-xs">Boutique Consultancy</div>
</div>
</div>
</div>
</div>
...
<span className="text-xs font-mono text-zinc-500">[IMAGE PLACEHOLDER]</span>
</div>
...
<div className="space-y-4 text-zinc-400 text-lg leading-relaxed">
<p>I work with reps who are putting in the effort but not seeing replies.</p>
<p>Most of the time, the issue isn’t how much you’re doing — it’s how your outreach is landing.</p>
<p className="text-white font-medium">I focus on fixing that.</p>
</div>
</div>
</div>
</div>
...
<div className="text-center mb-16">
<h2 className="text-3xl font-semibold text-white tracking-tight">FAQ</h2>
</div>
...
<div className="text-zinc-400 mt-4 text-sm leading-relaxed border-t border-white/5 pt-4">
                            SDRs, BDRs, and reps doing outbound.
                        </div>
</details>

<details className="group bg-zinc-900/30 border border-white/5 rounded-2xl p-6 open:bg-zinc-900/60 transition-colors cursor-pointer">
<summary className="flex justify-between items-center font-medium text-white list-none">
                            Is this messaging or full sales training?
                            <iconify-icon className="text-zinc-500 transition-transform group-open:rotate-180" icon="solar:alt-arrow-down-linear"></iconify-icon>
</summary>
<div className="text-zinc-400 mt-4 text-sm leading-relaxed border-t border-white/5 pt-4">
                            Primarily messaging and outbound execution.
                        </div>
</details>

<details className="group bg-zinc-900/30 border border-white/5 rounded-2xl p-6 open:bg-zinc-900/60 transition-colors cursor-pointer">
<summary className="flex justify-between items-center font-medium text-white list-none">
                            Does this work if I’m already sending volume?
                            <iconify-icon className="text-zinc-500 transition-transform group-open:rotate-180" icon="solar:alt-arrow-down-linear"></iconify-icon>
</summary>
<div className="text-zinc-400 mt-4 text-sm leading-relaxed border-t border-white/5 pt-4">
                            Yes — especially if replies are low.
                        </div>
</details>
...
<div className="text-zinc-400 mt-4 text-sm leading-relaxed border-t border-white/5 pt-4">
                            Focus on response, not activity.
                        </div>
</details>
...
<h2 className="text-4xl md:text-5xl font-semibold text-white mb-6 tracking-tight leading-[1.1]">
                            Get More Replies Without Sending More Messages
                        </h2>
<p className="text-zinc-400 text-lg mb-10 leading-relaxed max-w-md">
                            Book a call to fix how your outreach actually performs.
                        </p>
<div className="flex">
<a className="group relative inline-flex h-12 items-center justify-center gap-2.5 rounded-full bg-white px-8 text-sm font-medium text-black transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]" href="#demo">
                                Book My Call
...
<div className="text-zinc-500 font-mono text-sm uppercase tracking-widest">[CALENDLY PLACEHOLDER]</div>
</div>
</div>
</div>
</section>
...
<a aria-label="Eoin Murphy Home" className="flex items-center gap-3 text-white font-semibold tracking-tight text-lg mb-6 group" href="/">
...
<p className="text-zinc-500 mb-6 leading-relaxed max-w-xs">
                        Outbound execution and messaging optimization for SDRs, founders, and AE teams.
                    </p>
</div>
<div className="flex flex-col gap-4">
<h4 className="text-white font-medium">Links</h4>
<a className="text-zinc-500 hover:text-orange-400 transition-colors flex items-center gap-2" href="https://www.linkedin.com/in/eoin-murphy1999" target="_blank">
                        LinkedIn
                        <iconify-icon icon="solar:arrow-right-up-linear" width="14"></iconify-icon>
</a>
<a className="text-zinc-500 hover:text-orange-400 transition-colors flex items-center gap-2" href="https://www.youtube.com/@EoinMurphy-q8r" target="_blank">
                        YouTube
                        <iconify-icon icon="solar:arrow-right-up-linear" width="14"></iconify-icon>
</a>
<a className="text-zinc-500 hover:text-orange-400 transition-colors flex items-center gap-2" href="https://thesalescircle.io" target="_blank">
                        The Sales Circle
                        <iconify-icon icon="solar:arrow-right-up-linear" width="14"></iconify-icon>
</a>
</div>
...
<a className="text-zinc-500 hover:text-orange-400 transition-colors" href="#problem">The Problem</a>
<a className="text-zinc-500 hover:text-orange-400 transition-colors" href="#process">Process</a>
<a className="text-zinc-500 hover:text-orange-400 transition-colors" href="#about">About</a>
</div>
</div>
<div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
<div className="text-zinc-600 text-xs">
                    © 2024 Eoin Murphy. All rights reserved.
                </div>
</div>
</div>
</footer>

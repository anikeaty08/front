...
<h1 className="text-5xl md:text-7xl font-serif leading-[1.1] tracking-tight">
                    Build the life <span className="text-muted font-normal text-4xl md:text-6xl align-middle italic">&amp;</span> business you actually want.
                </h1>
...
<div className="relative lg:h-[600px] w-full flex justify-center lg:justify-end reveal delay-200">
...
<div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-40 grayscale hover:grayscale-0 hover:opacity-80 transition-all duration-500">

<span className="text-xl font-serif italic font-bold">Forbes</span>
...
<div className="bg-page border border-white/5 p-8 hover:border-white/20 transition-colors reveal delay-200">
<div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-muted mb-6">
...
<h2 className="text-3xl md:text-4xl font-serif text-center mb-16 reveal">Common Questions</h2>

...
<div className="relative w-[380px] h-[240px] rounded-2xl shadow-2xl overflow-hidden perspective-card">

<div className="absolute inset-0 z-0">
<svg className="block" height="240" viewbox="0 0 380 240" width="380">
<defs>
<radialgradient cx="50%" cy="50%" fx="50%" fy="50%" id="cardGrad" r="80%">
<stop offset="0%" stop-color="#1a1a3a"></stop>
<stop offset="100%" stop-color="#0a0a1a"></stop>
</radialgradient>
</defs>
<rect fill="url(#cardGrad)" height="240" rx="16" ry="16" width="380"></rect>
<g>

...
<span className="font-medium tracking-tighter text-lg">KINETIC</span>
</div>
...
<a className="group relative px-4 py-1.5 rounded-full bg-white text-black text-sm font-medium transition-transform hover:scale-105 active:scale-95" href="#">
<span>Shop Now</span>
...
<div className="effect-option cursor-pointer px-3 py-2 text-sm text-zinc-400 hover:text-white hover:bg-white/5 rounded-md flex items-center justify-between" onclick="setEffect('fade', 'Fade')">
                        Fade <iconify-icon className="check-icon text-white opacity-0" icon="lucide:check" width="14"></iconify-icon>
</div>
...
<div className="flex gap-3" id="pagination-container">

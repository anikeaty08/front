...
<section className="spotlight-group overflow-hidden group reveal-item bg-gray-900 w-full h-[800px] max-w-[1500px] ring-white/5 ring-1 rounded-[32px] relative shadow-2xl is-visible" style={{'--mouse-x': '838px', '--mouse-y': '4px'}}>
...
<nav className="spotlight-content z-20 flex md:px-10 md:py-8 reveal-item delay-100 text-sm font-medium tracking-wide w-full absolute top-0 left-0 items-center justify-between p-4 is-visible">
...
<div className="spotlight-content md:p-12 lg:p-16 flex flex-col lg:flex-row w-full absolute bottom-0 left-0 gap-x-12 gap-y-12 items-end justify-between p-4">
...
<div className="z-10 md:p-12 lg:p-16 flex flex-col absolute right-0 bottom-0 items-end p-4">
...
<section className="spotlight-group overflow-hidden md:p-16 bg-gradient-to-br from-white/10 via-white/0 to-white/10 from-white/20 to-white/20 w-full h-[1200px] max-w-[1500px] rounded-[32px] ring-0 relative reveal-item p-4" id="work">
...
<div className="spotlight-content overflow-hidden md:p-16 w-full max-w-[1500px] rounded-[32px] ring-white/5 ring-1 relative p-4" id="about-me">
...
<div className="grid grid-cols-1 md:p-8 md:grid-cols-3 md:gap-16 bg-gradient-to-br from-black/10 to-black/0 rounded-3xl gap-x-8 gap-y-8 reveal-item delay-200 p-4">
...
<section className="spotlight-group overflow-hidden md:p-16 bg-gradient-to-br from-white/10 via-white/0 to-white/10 w-full max-w-[1500px] rounded-[32px] ring-0 relative reveal-item p-4" id="experience">
<div className="spotlight-content grid grid-cols-1 md:grid-cols-2 mb-16 pb-8">
<div className="col-span-1 reveal-item">
...
<section className="spotlight-group md:p-20 overflow-hidden flex flex-col text-center bg-gradient-to-br from-white/10 to-white/0 w-full max-w-[1500px] ring-white/5 ring-1 rounded-[32px] relative items-center reveal-item p-4" id="contact">

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  */
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen -z-10 bg-cover bg-center" data-alpha-mask="80" id="aura-image" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/fc7f3c21-e337-4290-8b30-7f4445eba4fb_3840w.jpg")', maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}></div>
<style className="">
  /* 
...
<a className="inline-flex items-center justify-center bg-center w-[150px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3185425e-0207-434a-9554-cdb5bd455ea5_320w.png)] bg-cover rounded" href="/"></a>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 animate-[fadeInUp_1s_ease-out_0.2s_forwards] opacity-0 gap-x-12 gap-y-12 items-center">

<div className="order-1 animate-[slideInBlur_1.2s_ease-out_0.4s_forwards] opacity-0" style={{transform: 'translateY(30px)', filter: 'blur(10px)'}}>
<h1 className="sm:text-7xl lg:text-8xl xl:text-9xl leading-[0.9] text-6xl font-semibold tracking-tighter font-geist" style={{}}>Stronger. Lighter. Transform.<br className=""/><br className=""/></h1>
</div>

<div className="order-2 lg:order-2">
<p className="sm:text-xl leading-relaxed animate-[fadeInUp_0.8s_ease-out_0.8s_forwards] text-lg text-white/80 font-geist opacity-0 mb-8" style={{transform: 'translateY(20px)', filter: 'blur(5px)'}}>My mission is to support you on your fitness and mental
        journey to create long-lasting change.</p>
<div className="animate-[fadeInScale_0.8s_ease-out_1s_forwards] opacity-0 border-white/10 border-t mb-6 pt-6" style={{transform: 'scale(0.95)', filter: 'blur(3px)'}}>
...
<span className="z-10 inline-flex items-center gap-2 font-normal font-geist rounded-full relative">Start Forging<svg className="h-5 w-5 transition-transform duration-200 ease-out group-hover:translate-x-0.5 rounded-full" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
...
<button className="inline-flex gap-2 transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60 animate-[fadeInSlide_0.8s_ease-out_1.4s_forwards] cursor-pointer text-base font-normal text-white/90 font-geist opacity-0 border-white/10 border rounded-full pt-2.5 pr-5 pb-2.5 pl-5 backdrop-blur gap-x-2 gap-y-2 items-center" onclick="window.location.href='/programs'" role="button" style={{transform: 'translateX(20px)', filter: 'blur(4px)'}}>
...
<div className="animate-[fadeInUp_0.6s_ease-out_1.6s_forwards] opacity-0 border-white/10 border-t pt-4" style={{transform: 'translateY(15px)', filter: 'blur(2px)'}}>
<p className="text-sm text-white/45 font-geist" style={{}}>Get started today with one-on-one fitness and nutrition
          coaching.</p>
</div>
</div>
<style className="">
...
<span className="inline-flex items-center gap-2 text-[11px] uppercase animate-on-scroll text-white/70 tracking-widest font-geist bg-white/5 border-white/10 border rounded-full pt-1 pr-3 pb-1 pl-3" style={{animation: 'fadeSlideIn 1.0s ease-out 0.1s both'}}><svg className="lucide lucide-sparkles h-3.5 w-3.5" data-lucide="sparkles" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg> Transformations</span>
<h2 className="sm:text-5xl animate-on-scroll text-3xl font-semibold tracking-tight font-geist mt-4" style={{animation: 'fadeSlideIn 1.0s ease-out 0.1s both'}}>See how my clients have transformed</h2>
<p className="leading-relaxed animate-on-scroll text-white/70 font-geist mt-3" style={{animation: 'fadeSlideIn 1.0s ease-out 0.3s both'}}>Real results with real people. My clients have achieved amazing results for many different starting points.</p>
</div>

<div className="text-center mt-10">
<p className="text-[11px] animate-on-scroll text-white/50 tracking-widest font-geist" style={{animation: 'fadeSlideIn 1.0s ease-out 0.4s both'}}>01 / 04</p>
</div>
...
<div className="text-center max-w-3xl mr-auto ml-auto">
<span className="inline-flex items-center gap-2 text-[11px] uppercase animate-on-scroll text-white/70 tracking-widest font-geist bg-white/5 border-white/10 border rounded-full pt-1 pr-3 pb-1 pl-3" style={{animation: '1s ease-out 0.1s 1 normal both running fadeSlideIn'}}><svg className="lucide lucide-sparkles w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="lucide" data-lucide="weight" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="5" r="3"></circle><path d="M6.5 8a2 2 0 0 0-1.905 1.46L2.1 18.5A2 2 0 0 0 4 21h16a2 2 0 0 0 1.925-2.54L19.4 9.5A2 2 0 0 0 17.48 8Z"></path></svg> Custom fitness plan</span>
...
<p className="leading-relaxed animate-on-scroll text-white/70 font-geist mt-3" style={{animation: 'fadeSlideIn 1.0s ease-out 0.3s both'}}>My coaching is custom built for you. I have developed a state-of-the-art fitness and nutrition app designed to get you to your goals.</p>
</div>
...
<svg className="lucide lucide-trending-up w-[20px] h-[20px]" data-icon-replaced="true" data-icon-set="lucide" data-lucide="biceps-flexed" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '20px', height: '20px'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M12.409 13.017A5 5 0 0 1 22 15c0 3.866-4 7-9 7-4.077 0-8.153-.82-10.371-2.462-.426-.316-.631-.832-.62-1.362C2.118 12.723 2.627 2 10 2a3 3 0 0 1 3 3 2 2 0 0 1-2 2c-1.105 0-1.64-.444-2-1"></path><path d="M15 14a5 5 0 0 0-7.584 2"></path><path d="M9.964 6.825C8.019 7.977 9.5 13 8 15"></path></svg>
</div>
<p className="font-medium tracking-tight font-geist mt-3">Workout Tutorials</p>
<p className="text-sm text-white/60 font-geist mt-1">Whether you have a gym or not I have easy-to-follow workouts for every level.</p>
</div>
<div className="group hover:bg-white/10 transition-colors bg-white/5 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur">
<div className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5">
<svg className="lucide lucide-heart-handshake h-4.5 w-4.5 text-white/90" data-lucide="heart-handshake" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path className="" d="M19.414 14.414C21 12.828 22 11.5 22 9.5a5.5 5.5 0 0 0-9.591-3.676.6.6 0 0 1-.818.001A5.5 5.5 0 0 0 2 9.5c0 2.3 1.5 4 3 5.5l5.535 5.362a2 2 0 0 0 2.879.052 2.12 2.12 0 0 0-.004-3 2.124 2.124 0 1 0 3-3 2.124 2.124 0 0 0 3.004 0 2 2 0 0 0 0-2.828l-1.881-1.882a2.41 2.41 0 0 0-3.409 0l-1.71 1.71a2 2 0 0 1-2.828 0 2 2 0 0 1 0-2.828l2.823-2.762"></path></svg>
</div>
...
<div className="group hover:bg-white/10 transition-colors bg-white/5 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur">
<div className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5">
<svg className="lucide lucide-moon-star w-[20px] h-[20px]" data-icon-replaced="true" data-icon-set="lucide" data-lucide="users" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '20px', height: '20px'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
</div>
...
<div className="group hover:bg-white/10 transition-colors bg-white/5 border-white/10 border rounded-xl pt-5 pr-5 pb-5 pl-5 backdrop-blur">
<div className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5">
<svg className="lucide lucide-shield-check w-[20px] h-[20px]" data-icon-replaced="true" data-icon-set="lucide" data-lucide="banana" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '20px', height: '20px'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M4 13c3.5-2 8-2 10 2a5.5 5.5 0 0 1 8 5"></path><path d="M5.15 17.89c5.52-1.52 8.65-6.89 7-12C11.55 4 11.5 2 13 2c3.22 0 5 5.5 5 8 0 6.5-4.2 12-10.49 12C5.11 22 2 22 2 20c0-1.5 1.14-1.55 3.15-2.11Z"></path></svg>
</div>
...
</div><div className="grid grid-cols-1 lg:grid-cols-5 animate-on-scroll mt-14 gap-x-10 gap-y-10 items-start" style={{animation: 'fadeSlideIn 1.0s ease-out 0.2s both'}}>
...
<img alt="Minimal kettlebell on stone block" className="aspect-[4/3] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a5a3060b-c23f-4c61-96e2-35dc5b8c4ebc_1600w.jpg"/>
...
<img alt="Focused athlete during recovery with serum dropper" className="aspect-square w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/10a44c44-ef78-4c36-aa57-e016e3ef9a39_1600w.jpg"/>
...
<svg className="lucide lucide-gauge h-4 w-4 text-white/90" data-lucide="gauge" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m12 14 4-4"></path><path d="M3.34 19a10 10 0 1 1 17.32 0"></path></svg>
...
<svg className="lucide lucide-activity h-4 w-4 text-white/90" data-lucide="activity" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
<span className="text-xs font-medium text-white/90 font-geist">HRV 92</span>
</div>
<div className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-black/40 backdrop-blur px-3 py-2">
<svg className="lucide lucide-heart-pulse h-4 w-4 text-white/90" data-lucide="heart-pulse" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path><path d="M3.22 13H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.27"></path></svg>
...
<div className="flex items-center gap-3">
<div className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5">
<svg className="lucide lucide-dumbbell h-4.5 w-4.5" data-lucide="dumbbell" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M17.596 12.768a2 2 0 1 0 2.829-2.829l-1.768-1.767a2 2 0 0 0 2.828-2.829l-2.828-2.828a2 2 0 0 0-2.829 2.828l-1.767-1.768a2 2 0 1 0-2.829 2.829z"></path><path d="m2.5 21.5 1.4-1.4"></path><path d="m20.1 3.9 1.4-1.4"></path><path d="M5.343 21.485a2 2 0 1 0 2.829-2.828l1.767 1.768a2 2 0 1 0 2.829-2.829l-6.364-6.364a2 2 0 1 0-2.829 2.829l1.768 1.767a2 2 0 0 0-2.828 2.829z"></path><path d="m9.6 14.4 4.8-4.8"></path></svg>
</div>
<div>
...
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> Periodized compound lifts</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> RPE-based progression</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> 3–4 days/week</li>
</ul>
<div className="mt-5">
...
<ul className="mt-4 space-y-2">
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> Volume and intensity blocks</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> Isolation precision</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> 5 days/week</li>
</ul>
<div className="mt-5">
...
<ul className="mt-4 space-y-2">
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> Zone 2 + intervals</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> Mobility integration</li>
<li className="flex items-center gap-2 text-sm text-white/80"><svg className="lucide lucide-check h-4 w-4 text-white/80" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg> 3 days/week</li>
</ul>
<div className="mt-5">
...
<a className="inline-flex items-center gap-1 text-xs text-white/70 hover:text-white transition font-geist" href="#">
            Status
            <svg className="lucide lucide-activity h-3 w-3" data-lucide="activity" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
</a>
</div>
</div>
</div>

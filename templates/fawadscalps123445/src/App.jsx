...
<span className="group-hover:text-accent transition-colors text-xl font-bold text-white tracking-tighter font-display">FAWAD<span className="text-accent group-hover:text-white transition-colors">//</span>FX</span>
</a>
<div className="hidden md:flex gap-8 text-xs font-mono tracking-widest text-gray-400">
<a className="hover:text-white transition-colors hover-trigger" href="#features">[01] Course Structure</a>
<a className="hover:text-white transition-colors hover-trigger" href="#developers">[02] Basic Course</a>
<a className="hover:text-white transition-colors hover-trigger" href="#pipeline">[03] Advance Course</a>
</div>
...
<button className="uppercase hover:bg-white hover:text-black transition-all hover-trigger btn-magnetic text-xs font-bold text-white tracking-wider border-white/20 border pt-2 pr-6 pb-2 pl-6" style={{}}>Sign Up</button>
</div>
</div>
</nav>
<main className="">
...
<div className="z-20 text-center max-w-5xl pr-6 pl-6 relative">
...
<h1 className="md:text-9xl leading-[0.9] text-6xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-200 to-gray-500 tracking-tighter font-display mix-blend-screen mb-6 drop-shadow-[0_0_30px_rgba(255,255,255,0.4)]" style={{animation: 'slowVibrate 6s ease-in-out infinite'}}>
<style>
        @keyframes slowVibrate {
            0%, 100% { transform: translate3d(0, 0, 0) scale(1); filter: blur(0px); }
            25% { transform: translate3d(1px, 1px, 0) scale(1.01); filter: blur(1px); }
            50% { transform: translate3d(-1px, -1px, 0) scale(0.99); filter: blur(0px); }
            75% { transform: translate3d(-1px, 1px, 0) scale(1.01); filter: blur(0.5px); }
        }
    </style>
    Fawad Scalps
</h1>
<p className="leading-relaxed md:text-xl md:bg-clip-text md:text-transparent text-lg italic bg-gradient-to-tr from-blue-500/50 via-blue-500 to-blue-500/50 max-w-2xl mr-auto mb-10 ml-auto">Easy 3 Month Forex Course Simple Price Action Course Support Resistance</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
<button className="uppercase hover:bg-white hover:text-[#120ee1] hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] transition-all hover-trigger btn-magnetic sm:w-auto text-sm font-semibold text-white tracking-widest bg-black w-full pt-4 pr-8 pb-4 pl-8" style={{}}>Enroll in course</button>
</div>
</div>
</section>
...
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">ORBITAL</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">SYNTHETICS</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">HYPERION</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">VERTEX</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">QUANTUM</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">NVIDIA</span>
</div>
<div className="flex gap-20 px-10 items-center">
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">ORBITAL</span>
<span className="font-display font-bold text-2xl text-white/30 hover:text-white transition-colors">SYNTHETICS</span>
...
<svg fill="none" height="24" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" x2="12" y1="22.08" y2="12"></line></svg>
</div>
...
<div className="absolute text-white font-mono text-xs tracking-widest">PROCESSING</div>
</div>
...
<h3 className="text-4xl font-display font-bold mb-4 text-white">01. Ingestion</h3>
...
<div className="step-item mb-48 opacity-30 transition-opacity duration-500">
<h3 className="text-4xl font-display font-bold mb-4 text-white">02. Reasoning</h3>
<p className="text-xl text-white leading-relaxed font-light">
...
<h3 className="text-4xl font-display font-bold mb-4 text-white">03. Synthesis</h3>
<p className="text-xl text-white leading-relaxed font-light">
...
<section className="skew-target z-20 bg-[#050505] border-white/5 border-t pt-32 pr-6 pb-32 pl-6 relative" id="pricing">
<div className="max-w-7xl mr-auto ml-auto">
<h2 className="scramble-text text-4xl font-bold text-white font-display text-center mb-16">Fee Structure</h2>
...
<div className="text-xs text-gray-500 font-mono z-10 mb-4 relative">/ Free First Demo Class</div>
...
<li className="flex gap-x-3 gap-y-3">Only 1 Class</li>
<li className="flex gap-x-3 gap-y-3">No Vip Slack Access</li>
</ul>
...
<div className="border-accent hover-trigger transform md:-translate-y-4 spotlight-card bg-[#0a0a0a] max-h-none border rounded-2xl pt-8 pr-8 pb-8 pl-8 relative shadow-[0_0_30px_rgba(255,59,0,0.1)]">
...
<div className="text-accent text-xs font-mono z-10 mb-4 relative">/ Vip Students</div>
<div className="text-3xl font-bold text-white z-10 mb-6 relative">$450</div>
<ul className="space-y-4 text-sm text-gray-300 mb-8 font-mono z-10 relative">
<li className="flex gap-x-3 gap-y-3">Life Time Classes Access</li>
<li className="flex gap-x-3 gap-y-3">Life Time Slack Access</li>
</ul>
<button className="uppercase hover:bg-white transition-all text-xs font-bold text-black tracking-wider bg-[#fc4e03] w-full z-10 rounded pt-3 pb-3 relative">Get Started</button>
</div>
<div className="hover:bg-white/5 transition-colors hover-trigger spotlight-card glass-panel border-white/10 border rounded-2xl pt-8 pr-8 pb-8 pl-8">
<div className="text-xs text-gray-500 font-mono z-10 mb-4 relative">/ 3 Months Program</div>
<div className="text-3xl font-bold text-white z-10 mb-6 relative">$189</div>
<ul className="space-y-4 text-sm text-gray-300 mb-8 font-mono z-10 relative">
<li className="flex gap-x-3 gap-y-3">50 Classes</li>
<li className="flex gap-x-3 gap-y-3">3 Months Access to Slack</li>
</ul>
<button className="uppercase hover:bg-white hover:text-black transition-all text-xs font-bold text-white tracking-wider w-full z-10 border-white/20 border rounded pt-3 pb-3 relative">Start Course</button>
</div>
</div>
</div>
</section>
...
<div className="">
<h3 className="text-2xl font-bold text-white font-display mb-6">Ready to Start?</h3>
<div className="flex gap-4">
<input className="focus:outline-none focus:border-accent text-sm text-white bg-white/5 w-64 border-white/10 border rounded pt-3 pr-4 pb-3 pl-4" placeholder="email@company.com" type="email"/>
...
<span className="">© 2025 NEXUS LABS INC.</span>

...
<iconify-icon className="text-neutral-900" icon="solar:graph-up-linear" width="28"></iconify-icon>
<span className="text-xl font-semibold tracking-tight font-sans">FinanceFlow</span>
</div>
<div className="hidden md:flex items-center gap-8 text-base font-medium text-neutral-800">
<a className="hover:text-black transition-colors font-sans" href="#">Platform</a>
<a className="hover:text-black transition-colors font-sans" href="#">Solutions</a>
<a className="hover:text-black transition-colors font-sans" href="#">Developers</a>
<a className="hover:text-black transition-colors font-sans" href="#">Pricing</a>
</div>
<div className="flex items-center gap-4">
<iconify-icon icon="solar:magnifer-linear" width="24"></iconify-icon>
<span className="text-base font-medium font-sans">Help</span>
</div>
</nav>
...
<h1 className="lg:text-7xl leading-[1.1] text-5xl tracking-tight font-dm-sans font-light [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll">
                        Master your global finances instantly.
                    </h1>
<p className="text-xl text-neutral-800 max-w-md leading-relaxed font-sans [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll">
                        Effortless money management designed for the modern era. Track, spend, and invest with zero friction.
                    </p>
<div className="flex flex-wrap gap-4 pt-4 [animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll">
<button className="hover:bg-neutral-800 transition-colors text-base font-medium text-white bg-neutral-900 rounded-full px-8 py-4 shadow-xl">
                            Start for free
                        </button>
...
<img alt="Woman Portrait" className="object-top grayscale-[20%] sepia-[30%] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/496075b4-61b8-49d2-b69f-b1d4da70d9c3_1600w.webp"/>
</div>
...
<iconify-icon className="text-yellow-400" icon="solar:graph-new-linear" width="28"></iconify-icon>
<span className="bg-yellow-400/10 text-yellow-400 px-3 py-1 rounded-full text-sm font-medium font-sans">Active</span>
</div>
<div className="space-y-1 mb-8">
<p className="text-sm text-neutral-400 font-sans">Total Balance</p>
<h3 className="text-3xl tracking-tight font-dm-sans font-light">$124,592.00</h3>
<p className="text-sm text-neutral-500 font-mono pt-1 font-sans">**** **** 4291</p>
</div>
<div className="flex justify-between items-end">
<div className="uppercase text-sm tracking-widest text-neutral-500 font-sans">David Miller</div>
<div className="bg-yellow-400 text-black h-12 w-8 rounded-lg flex flex-col items-center justify-center gap-0.5">
...
<iconify-icon className="text-white" height="28" icon="simple-icons:dbt" width="70"></iconify-icon>
<iconify-icon className="text-white" height="28" icon="simple-icons:tableau" width="96"></iconify-icon>
<iconify-icon className="text-white" height="28" icon="simple-icons:microsoftazure" width="96"></iconify-icon>
<iconify-icon className="text-white" height="28" icon="simple-icons:python" width="96"></iconify-icon>
<iconify-icon className="text-white" height="28" icon="simple-icons:snowflake" width="96"></iconify-icon>
</div>
</div>
</header>
...
<span className="inline-block px-4 py-1 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-slate-400 font-sans">Core Features</span>
<h2 className="text-4xl lg:text-5xl text-white tracking-tight leading-tight font-dm-sans font-light">
                    Smart tools for simpler  financial decisions.
                </h2>
<p className="text-slate-400 font-sans">Manage currencies, track expenses, and earn rewards seamlessly.</p>
</div>
...
<iconify-icon icon="solar:bolt-circle-linear" width="48"></iconify-icon>
<div className="w-10 h-10 bg-neutral-900 rounded-full"></div>
</div>
<h3 className="text-2xl mb-3 tracking-tight font-dm-sans font-light">Instant Analytics</h3>
<p className="text-neutral-800 leading-relaxed text-base font-sans">Real-time data visualization of your cash flow. Adapt instantly to market changes with our predictive engine.</p>
</div>
...
<div className="">
<div className="flex justify-between items-start mb-6">
<iconify-icon className="" icon="solar:gift-linear" width="48"></iconify-icon>
<div className="w-10 h-10 bg-neutral-900 rounded-full"></div>
</div>
<h3 className="text-2xl mb-3 tracking-tight font-dm-sans font-light">Loyalty Rewards</h3>
<p className="text-neutral-600 leading-relaxed text-base font-sans">Earn points on every transaction. Redeem for exclusive perks, travel discounts, or direct cashback.</p>
</div>
<div className="flex gap-[-8px] mt-8">
<div className="flex items-center gap-1 bg-neutral-100 rounded-full p-1 pr-4">
<div className="w-6 h-6 bg-black rounded-full text-white flex items-center justify-center text-xs font-sans">∞</div>
<span className="text-xs font-semibold font-sans">Points</span>
</div>
</div>
</div>
...
<h3 className="text-2xl mb-3 tracking-tight font-dm-sans font-light">Zero Hidden Fees</h3>
<p className="text-neutral-800 leading-relaxed text-base font-sans">What you see is what you pay. No surprise charges at checkout, transparent pricing built on trust.</p>
</div>
<div className="mt-8">
<iconify-icon className="text-neutral-900" icon="solar:eye-linear" width="32"></iconify-icon>
</div>
</div>
</div>
</section>
...
<h2 className="text-5xl lg:text-7xl text-white tracking-tight leading-[1.1] font-dm-sans font-light">
                            We take your wealth seriously.
                        </h2>
<p className="text-white/80 text-xl max-w-md font-sans mt-4">
                            Adapting quickly to changing needs with flexible controls that fit your workflow.
                        </p>
</div>
...
<p className="text-xs font-medium leading-tight mt-1 opacity-80 font-sans">Active users worldwide</p>
</div>
<div className="bg-emerald-300/90 backdrop-blur-md p-6 rounded-3xl w-40 text-emerald-900">
<h4 className="text-3xl tracking-tight font-dm-sans font-light">$85m</h4>
<p className="text-xs font-medium leading-tight mt-1 opacity-80 font-sans">Processed in Q1 2024</p>
</div>
...
<p className="text-xs font-medium leading-tight mt-1 opacity-80 font-sans">Customer satisfaction</p>
</div>
</div>
</div>
</div>
...
<img alt="Smiling Man" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/33f44bf5-8b59-437b-a1e3-87e3db3f82ec_1600w.webp"/>
...
<h2 className="text-5xl lg:text-7xl text-white tracking-tight leading-[1.1] mb-6 font-dm-sans font-light">
                        Open your account  and experience  the future.
                    </h2>
<p className="text-white/90 text-xl max-w-lg mb-8 font-sans">
                        Join over 200,000 users who are saving 2x more when they spend and withdraw in 40 currencies.
                    </p>
...
<span className="font-dm-sans font-medium text-neutral-900 tracking-tight">FinanceFlow</span>
</div>
...
<span className="text-xs font-medium text-neutral-800/60 uppercase tracking-wider font-sans block mb-1">Total Balance</span>
<div className="flex items-baseline gap-2 mb-6">
<span className="text-4xl tracking-tighter font-dm-sans font-light text-neutral-900">$12,765</span>
<span className="text-sm font-medium text-green-700 bg-green-500/10 px-2 py-0.5 rounded-full font-sans">+2.4%</span>
</div>
...
<iconify-icon icon="solar:card-recive-linear" width="18"></iconify-icon>
                                Request
                            </button>
</div>
</div>
...
<h3 className="font-dm-sans text-lg font-medium text-neutral-900">Recent</h3>
...
<div>
<p className="font-medium text-sm text-neutral-900 font-sans">Apple Store</p>
<p className="text-xs text-neutral-400 font-sans">Electronics</p>
</div>
</div>
<span className="font-medium text-sm text-neutral-900 font-sans">-$129.00</span>
</div>
...
<div>
<p className="font-medium text-sm text-neutral-900 font-sans">Spotify</p>
<p className="text-xs text-neutral-400 font-sans">Subscription</p>
</div>
</div>
<span className="font-medium text-sm text-neutral-900 font-sans">-$14.99</span>
</div>

<div className="flex justify-between items-center group cursor-pointer">
<div className="flex items-center gap-3">
<div className="w-12 h-12 rounded-2xl bg-neutral-50 flex items-center justify-center group-hover:bg-yellow-50 transition-colors">
<iconify-icon className="text-neutral-900" icon="solar:wallet-money-linear" width="24"></iconify-icon>
</div>
<div>
<p className="font-medium text-sm text-neutral-900 font-sans">Top Up</p>
<p className="text-xs text-neutral-400 font-sans">Transfer</p>
</div>
</div>
<span className="font-medium text-sm text-green-600 font-sans">+$500.00</span>
</div>
</div>
</div>
</div>
...
<p className="text-slate-400 font-sans">Optimized infrastructure for startups to enterprise giants.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
...
<h3 className="text-2xl mb-2 tracking-tight font-dm-sans font-light">Small Business</h3>
<p className="text-neutral-800 text-base leading-relaxed font-sans">Automated invoicing and quick access to micro-loans. Keep cash flow positive without complexity.</p>
</div>
<div className="mt-auto rounded-3xl overflow-hidden h-48 relative">
<img alt="Small Business" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e4b4f6bc-45b8-4bbb-8dda-c4bb651cb859_800w.webp"/>
...
<p className="text-neutral-600 text-base leading-relaxed font-sans">Reshaping landscapes. Get VC-ready reports and seamless payroll integration for growing teams.</p>
</div>
...
<p className="text-neutral-800 text-base leading-relaxed font-sans">Reimagining tradition. Custom API integration, dedicated account managers, and bulk transaction tools.</p>
</div>
<div className="mt-auto rounded-3xl overflow-hidden h-48 relative">
...
<p className="text-slate-400 text-lg leading-relaxed max-w-lg font-sans">
                        Fintech enterprises are transforming the landscape by combining technology, data, and design to deliver faster, smarter, and more inclusive services. Be part of the revolution.
                    </p>
...
<iconify-icon className="text-yellow-400" icon="solar:graph-up-linear" width="24"></iconify-icon>
<span className="text-lg font-semibold tracking-tight font-sans">FinanceFlow</span>
</div>
<p className="text-slate-400 text-sm leading-relaxed max-w-sm font-sans">
                            Fintech enterprises are transforming the financial landscape by designing inclusive financial services. By reimagining traditional banking, payments, and lending.
                        </p>
...
<li className=""><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Overview</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Solution</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Services</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Pricing</a></li>
</ul>
</div>
<div className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll">
<h4 className="text-white font-medium mb-6 text-sm font-sans">Help</h4>
<ul className="space-y-3 text-sm text-slate-400">
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Customer Support</a></li>
<li className=""><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Delivery Details</a></li>
...
<ul className="space-y-3 text-sm text-slate-400">
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Free Brochures</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Business Development</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Blog</a></li>
<li><a className="hover:text-yellow-400 transition-colors font-sans" href="#">Youtube Playlist</a></li>
</ul>
</div>
</div>
...
<p className="font-sans">© 2024 FinanceFlow Inc. All rights reserved.</p>
<div className="flex gap-6 mt-4 md:mt-0">
<span className="font-sans">San Francisco</span>
<span className="font-sans">London</span>
<span className="font-sans">Tokyo</span>
</div>
</div>
</div>
</footer>

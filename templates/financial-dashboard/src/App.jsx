...
<div className="aura-background-component top-0 w-full -z-20 saturate-0 fixed brightness-50 h-[1200px]" data-alpha-mask="80" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}><div className="absolute w-full h-full left-0 top-0 -z-10" data-us-project="qpSlPSWA2bdkUAYztz8z"></div>
</div>
...
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors font-sans" href="#">Product</a>
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors font-sans" href="#">Features</a>
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors font-sans" href="#">Pricing</a>
</div>
<div className="flex items-center gap-4">
<a className="hidden md:block text-xs font-medium text-slate-400 hover:text-white font-sans" href="#">Log in</a>
...
<img alt="User" className="bg-black w-full h-full object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/63742d70-5f5b-4f91-bcd7-d6e4040161a3_320w.webp"/>
</div>
<div className="">
...
<svg aria-hidden="true" data-icon="solar:music-note-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m10.09 11.963l9.273-3.332L21 7.952v-.46c0-1.12 0-2.059-.088-2.807a7 7 0 0 0-.043-.31c-.085-.51-.234-.988-.523-1.386a2.2 2.2 0 0 0-.675-.617l-.01-.005c-.77-.461-1.638-.428-2.532-.224c-.864.198-1.935.6-3.249 1.095l-2.284.859c-.616.231-1.138.427-1.547.63c-.436.216-.811.471-1.092.851s-.399.79-.452 1.234c-.05.418-.05.926-.05 1.525v4.265z" fill="currentColor" fill-rule="evenodd"></path><path d="M8.455 16.13a3.8 3.8 0 0 0-1.91-.5C4.587 15.63 3 17.056 3 18.815S4.587 22 6.545 22c1.959 0 3.546-1.426 3.546-3.185v-6.852l-1.636.638zm10.909-7.5v5.54a3.8 3.8 0 0 0-1.91-.5c-1.958 0-3.545 1.426-3.545 3.185s1.587 3.185 3.545 3.185c1.959 0 3.546-1.426 3.546-3.185V7.952z" fill="currentColor" opacity=".5"></path></svg>
</div>
<div>
...
<svg aria-hidden="true" data-icon="solar:bag-4-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M4.035 11.573c.462-2.309.693-3.463 1.522-4.143s2.007-.68 4.362-.68h4.162c2.355 0 3.532 0 4.361.68c.83.68 1.06 1.834 1.523 4.143l.6 3c.664 3.32.996 4.98.096 6.079s-2.594 1.098-5.98 1.098H9.32c-3.386 0-5.08 0-5.98-1.098s-.568-2.758.096-6.079z" fill="currentColor" opacity=".5"></path><circle cx="15" cy="9.75" fill="currentColor" r="1"></circle><circle cx="9" cy="9.75" fill="currentColor" r="1"></circle><path d="M9.75 5.75a2.25 2.25 0 0 1 4.5 0v1h.431q.565 0 1.069.002V5.75a3.75 3.75 0 1 0-7.5 0v1.002q.504-.003 1.069-.002h.431z" fill="currentColor"></path></svg>
</div>
<div>
...
<svg aria-hidden="true" data-icon="solar:home-smile-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2 12.204c0-2.289 0-3.433.52-4.381c.518-.949 1.467-1.537 3.364-2.715l2-1.241C9.889 2.622 10.892 2 12 2s2.11.622 4.116 1.867l2 1.241c1.897 1.178 2.846 1.766 3.365 2.715S22 9.915 22 12.203v1.522c0 3.9 0 5.851-1.172 7.063S17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.212S2 17.626 2 13.725z" fill="currentColor" opacity=".5"></path><path d="M9.447 15.398a.75.75 0 0 0-.894 1.205A5.77 5.77 0 0 0 12 17.75a5.77 5.77 0 0 0 3.447-1.147a.75.75 0 0 0-.894-1.206A4.27 4.27 0 0 1 12 16.25a4.27 4.27 0 0 1-2.553-.852" fill="currentColor"></path></svg>
</button>
...
<button className="flex flex-col items-center gap-1 text-slate-500 hover:text-white transition-colors">
<svg aria-hidden="true" className="" data-icon="solar:card-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path className="" d="M10 20h4c3.771 0 5.657 0 6.828-1.172S22 15.771 22 12c0-.442-.002-1.608-.004-2H2c-.002.392 0 1.558 0 2c0 3.771 0 5.657 1.171 6.828S6.23 20 10 20" fill="currentColor" opacity=".5"></path><path className="" d="M9.995 4h4.01c3.781 0 5.672 0 6.846 1.116c.846.803 1.083 1.96 1.149 3.884v1H2V9c.066-1.925.303-3.08 1.149-3.884C4.323 4 6.214 4 9.995 4M12.5 15.25a.75.75 0 0 0 0 1.5H14a.75.75 0 0 0 0-1.5zm-6.5 0a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z" fill="currentColor"></path></svg>
</button>
<button className="flex flex-col items-center gap-1 text-slate-500 hover:text-white transition-colors">
<svg aria-hidden="true" data-icon="solar:settings-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M14.279 2.152C13.909 2 13.439 2 12.5 2s-1.408 0-1.779.152a2 2 0 0 0-1.09 1.083c-.094.223-.13.484-.145.863a1.62 1.62 0 0 1-.796 1.353a1.64 1.64 0 0 1-1.579.008c-.338-.178-.583-.276-.825-.308a2.03 2.03 0 0 0-1.49.396c-.318.242-.553.646-1.022 1.453c-.47.807-.704 1.21-.757 1.605c-.07.526.074 1.058.4 1.479c.148.192.357.353.68.555c.477.297.783.803.783 1.361s-.306 1.064-.782 1.36c-.324.203-.533.364-.682.556a2 2 0 0 0-.399 1.479c.053.394.287.798.757 1.605s.704 1.21 1.022 1.453c.424.323.96.465 1.49.396c.242-.032.487-.13.825-.308a1.64 1.64 0 0 1 1.58.008c.486.28.774.795.795 1.353c.015.38.051.64.145.863c.204.49.596.88 1.09 1.083c.37.152.84.152 1.779.152s1.409 0 1.779-.152a2 2 0 0 0 1.09-1.083c.094-.223.13-.483.145-.863c.02-.558.309-1.074.796-1.353a1.64 1.64 0 0 1 1.579-.008c.338.178.583.276.825.308c.53.07 1.066-.073 1.49-.396c.318-.242.553-.646 1.022-1.453c.47-.807.704-1.21.757-1.605a2 2 0 0 0-.4-1.479c-.148-.192-.357-.353-.68-.555c-.477-.297-.783-.803-.783-1.361s.306-1.064.782-1.36c.324-.203.533-.364.682-.556a2 2 0 0 0 .399-1.479c-.053-.394-.287-.798-.757-1.605s-.704-1.21-1.022-1.453a2.03 2.03 0 0 0-1.49-.396c-.242.032-.487.13-.825.308a1.64 1.64 0 0 1-1.58-.008a1.62 1.62 0 0 1-.795-1.353c-.015-.38-.051-.64-.145-.863a2 2 0 0 0-1.09-1.083" fill="currentColor" fill-rule="evenodd" opacity=".5"></path><path d="M15.523 12c0 1.657-1.354 3-3.023 3s-3.023-1.343-3.023-3S10.83 9 12.5 9s3.023 1.343 3.023 3" fill="currentColor"></path></svg>
</button>
</div>
...
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M11.55 15.7L8.12 12.27a.77.77 0 0 1 0-1.06l3.43-3.44c.79-.79 2.2-.22 2.2.89v6.13c0 1.12-1.41 1.68-2.2.91" fill="currentColor" opacity=".5"></path><path d="M8.5 12c0-.41.34-.75.75-.75h9.5a.75.75 0 0 1 0 1.5h-9.5a.75.75 0 0 1-.75-.75" fill="currentColor"></path></svg>
</button>
...
<svg aria-hidden="true" data-icon="simple-icons:ethereum" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M11.944 17.97L4.58 13.62L11.943 24l7.37-10.38l-7.372 4.35zM12.056 0L4.69 12.223l7.365 4.354l7.365-4.35z" fill="currentColor"></path></svg>
<span className="text-xs font-medium text-slate-200 font-sans">Ethereum</span>
</div>
<div className="flex gap-2">
<button className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-white transition-colors hover:bg-white/10">

<svg height="18" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M12.94 3.47a1.5 1.5 0 0 0-2.88 0l-1.3 4.01H4.64a1.5 1.5 0 0 0-1.18 2.56l3.36 2.44l-1.28 3.95a1.5 1.5 0 0 0 2.31 1.68l3.4-2.47l3.4 2.47a1.5 1.5 0 0 0 2.31-1.68l-1.28-3.95l3.36-2.44a1.5 1.5 0 0 0-1.18-2.56h-4.12l-1.3-4.01Z" fill="currentColor" opacity=".5"></path><path d="M11.5 7.48L12.94 3.47a1.5 1.5 0 0 1 2.88 0l1.3 4.01h4.12a1.5 1.5 0 0 1 .88 2.7l-3.36 2.44l1.28 3.95a1.5 1.5 0 0 1-2.31 1.68L12 14.66V7.48h-.5Z" fill="currentColor"></path></svg>
</button>
</div>
</div>
...
<svg height="12" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M5 17.75a.75.75 0 0 1-.75-.75V7a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 .75.75v10a.75.75 0 0 1-.75.75H5Z" fill="currentColor" opacity=".5"></path><path d="M8.25 12a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Z" fill="currentColor"></path></svg>
...
<svg className="w-full h-full overflow-visible px-2" preserveaspectratio="none" viewbox="0 0 100 50">
<defs>
</defs>

<path className="opacity-0 [animation:fadeSlideInLoop_8s_ease-in-out_infinite]" d="M0,40 C10,35 15,42 25,30 C35,18 40,25 50,15 C60,5 70,20 80,10 C85,5 90,15 100,8 V 50 H 0 Z" fill="url(#chartGradient)"></path>

<path className="drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] [stroke-dasharray:120] [stroke-dashoffset:120] [animation:drawChartLoop_8s_ease-in-out_infinite]" d="M0,40 C10,35 15,42 25,30 C35,18 40,25 50,15 C60,5 70,20 80,10 C85,5 90,15 100,8" fill="none" stroke="#3B82F6" strokeLinecap="round" strokeWidth="0.8"></path>

<circle className="animate-pulse shadow-[0_0_10px_#3B82F6]" cx="50" cy="15" fill="#3B82F6" r="1.5"></circle>

<g transform="translate(32, 0)">
<rect className="opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="#1A1A1A" height="12" rx="4" stroke="#333" strokeWidth="0.2" width="36" x="0" y="0"></rect>
<text className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-sans" fill="#fff" fontFamily="monospace" fontSize="5" text-anchor="middle" x="18" y="8">$2,701</text>
</g>
</svg>
<style>
                                @keyframes drawChartLoop { 
...
<svg height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M16 15a1 1 0 0 0-1.4 0l-1.6 1.6V8a1 1 0 0 0-2 0v8.6l-1.6-1.6a1 1 0 0 0-1.4 1.4l3.29 3.3a1 1 0 0 0 1.42 0l3.29-3.3A1 1 0 0 0 16 15" fill="currentColor" opacity=".5"></path><path d="M13 4.7V8a1 1 0 0 1-2 0V4.7l-1.6 1.6a1 1 0 0 1-1.4-1.41l3.29-3.3a1 1 0 0 1 1.42 0l3.29 3.3a1 1 0 0 1-1.4 1.41Z" fill="currentColor"></path></svg>
</button>
<button className="flex flex-col items-center justify-center gap-1 bg-blue-50 text-blue-900 rounded-xl py-3 hover:bg-blue-100 transition-all active:scale-95 shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 group">
...
<svg height="18" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4" fill="currentColor" opacity=".5"></path><path className="text-blue-400" d="M12 15c-2.7 0-5.8 1.29-7 4.12c-.26.61.18 1.3.85 1.3h12.31c.66 0 1.11-.69.85-1.3C17.8 16.29 14.7 15 12 15M20.5 8.7l-2.1 2.1l-.6-.6a.996.996 0 1 0-1.41 1.41l1.3 1.3c.39.39 1.02.39 1.41 0l2.8-2.8a.996.996 0 1 0-1.41-1.41" fill="currentColor"></path></svg>
...
<svg className="w-[18px] h-[18px]" data-icon-replaced="true" height="18" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '18px', height: '18px'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path className="" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2" fill="currentColor" opacity=".5"></path><path className="text-blue-400" d="M15.5 12a1 1 0 0 1-.82.43l-2.6-.02l-1.5.02a1 1 0 0 1-1-1V7a1 1 0 1 1 2 0v3.6l2.22-.01a1 1 0 0 1 .7 1.71" fill="currentColor"></path></svg>
                            24/7 Global Access
                        </h3>
<p className="text-slate-400 text-sm leading-relaxed max-w-xs font-sans">
...
<svg className="" height="18" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C7.58 2 4 3.79 4 6c0 7.73 5.61 12.82 8 14c2.39-1.18 8-6.27 8-14c0-2.21-3.58-4-8-4" fill="currentColor" opacity=".5"></path><path className="text-blue-400" d="m15.3 9.3l-3.8 3.8a.75.75 0 0 1-1.06 0l-1.75-1.75a.75.75 0 0 1 1.06-1.06l1.22 1.22l3.27-3.27a.75.75 0 0 1 1.06 1.06" fill="currentColor"></path></svg>
                            Bank-Grade Security
                        </h3>
<p className="text-slate-400 text-sm leading-relaxed max-w-xs font-sans">
...
<svg height="18" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M12.94 3.47a1.5 1.5 0 0 0-2.88 0l-1.3 4.01H4.64a1.5 1.5 0 01.28 3.95a1.5 1.5 0 0 0 2.31 1.68l3.4-2.47l3.4 2.47a1.5 1.5 0 0 0 2.31-1.68l-1.28-3.95l3.36-2.44a1.5 1.5 0 0 0-1.18-2.56h-4.12l-1.3-4.01Z" fill="currentColor" opacity=".5"></path><path d="M11.5 7.48L12.94 3.47a1.5 1.5 0 0 1 2.88 0l1.3 4.01h4.12a1.5 1.5 0 0 1 .88 2.7l-3.36 2.44l1.28 3.95a1.5 1.5 0 0 1-2.31 1.68L12 14.66V7.48h-.5Z" fill="currentColor"></path></svg>
</div>
...
<h2 className="text-5xl lg:text-7xl text-white tracking-tighter leading-[1.05] font-sans font-semibold">
                    ...
                    Power <span className="relative whitespace-nowrap text-blue-400 font-sans font-semibold">
                        Exponential
                        <svg className="absolute -bottom-2 left-0 w-full text-blue-400/30 -z-10" height="10" preserveaspectratio="none" viewbox="0 0 100 10"><path d="M0 5 Q 50 10 100 5" fill="none" stroke="currentColor" strokeWidth="8"></path></svg>
</span>
                    Growth.
                </h2>
...
<svg className="lucide lucide-play-circle h-5 w-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>
...
<path d="M0 35 Q 25 35 35 20 T 70 25 T 100 10" fill="none" stroke="#3B82F6" strokeLinecap="round" strokeWidth="2" vector-effect="non-scaling-stroke"></path>
<circle className="animate-pulse shadow-[0_0_10px_#3B82F6]" cx="100" cy="10" fill="#3B82F6" r="3"></circle>
</svg>
</div>
...
<path className="text-blue-400" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="98, 100" strokeLinecap="round" strokeWidth="3"></path>
</svg>
</div>
</div>
...
<svg className="w-full h-full -rotate-90" viewbox="0 0 36 36">
<path className="text-white/5" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="3"></path>
<path className="text-blue-400" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="45, 100" strokeLinecap="round" strokeWidth="3"></path>
</svg>
</div>
</div>
</div>
...
<svg className="w-3.5 h-3.5 text-white" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
</div>
...
<span className="relative inline-block">
                        Currency.
                        <svg className="absolute -bottom-1 left-0 w-full text-blue-500/30" height="8" preserveaspectratio="none" viewbox="0 0 100 8"><path d="M0 4 Q 50 8 100 4" fill="none" stroke="currentColor" strokeWidth="6"></path></svg>
</span>
</h2>
...
<svg className="lucide lucide-arrow-right-left" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-history" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l4 2"></path></svg>
</button>
</div>
</div>
...
<div className="flex flex-col">
<input className="bg-transparent text-2xl font-bold text-white w-32 focus:outline-none font-sans" readonly="" type="text" value="5,000"/>
...
<svg className="lucide lucide-chevron-down text-slate-400" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-arrow-down" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex justify-between items-center">
<div className="flex flex-col">
<input className="bg-transparent text-2xl font-bold text-white w-32 focus:outline-none font-sans" readonly="" type="text" value="0.1184"/>
...
<svg className="lucide lucide-bitcoin" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-info" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-fuel" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg">
...
<path d="M0 35 Q 20 30 35 20 T 65 25 T 100 10" fill="none" stroke="#3B82F6" strokeLinecap="round" strokeWidth="2"></path>
<defs>
</defs>
</svg>
...
<svg className="lucide lucide-arrow-right-left" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="m16 3 4 4-4 4"></path>
<path d="M20 7H4"></path>
<path d="m8 21-4-4 4-4"></path>
<path d="M4 17h16"></path>
...
<svg className="w-full h-full" preserveaspectratio="none" viewbox="0 0 100 40">
<path className="" d="M0 30 Q 25 40 50 20 T 100 15" fill="none" stroke="#3B82F6" strokeLinecap="round" strokeWidth="2"></path>
</svg>
</div>
</div>
</div>
...
<a className="group flex items-center justify-between p-6 md:p-8 border-r border-white/5 border-b md:border-b-0 hover:bg-white/[0.02] transition-all duration-300" href="#">
<div className="flex items-center gap-3 text-slate-400 group-hover:text-white transition-colors">
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231l5.45-6.231h.001Zm-1.161 17.52h1.833L7.084 4.126H5.117l11.966 15.644Z" fill="currentColor"></path></svg>
...
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M18.07 12.47a.76.76 0 0 0 0-1.06l-4.14-4.14a.76.76 0 0 0-1.06 0a.76.76 0 0 0 0 1.06l2.81 2.81H5.75a.75.75 0 1 0 0 1.5h9.93l-2.81 2.81a.76.76 0 0 0 0 1.06a.77.77 0 0 0 1.06 0l4.14-4.04Z" fill="currentColor" opacity=".5"></path><path d="M12.93 11.41a.76.76 0 0 0 0 1.06l4.14 4.14a.77.77 0 0 0 1.06 0a.76.76 0 0 0 0-1.06l-2.81-2.81H18a.75.75 0 1 0 0-1.5h-2.68l2.81-2.81a.76.76 0 0 0 0-1.06a.76.76 0 0 0-1.06 0l-4.14 4.14Z" fill="currentColor"></path></svg>
</div>
</a>

<a className="group flex items-center justify-between p-6 md:p-8 border-r border-white/5 border-b md:border-b-0 hover:bg-white/[0.02] transition-all duration-300" href="#">
<div className="flex items-center gap-3 text-slate-400 group-hover:text-white transition-colors">
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M12 2A10 10 0 0 0 2 12c0 4.42 2.87 8.17 6.84 9.5c.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34c-.46-1.16-1.11-1.47-1.11-1.47c-.91-.62.07-.6.07-.6c1 .07 1.53 1.03 1.53 1.03c.87 1.52 2.34 1.07 2.91.83c.09-.65.35-1.09.63-1.34c-2.22-.25-4.55-1.11-4.55-4.92c0-1.11.38-2 1.03-2.71c-.1-.25-.45-1.29.1-2.64c0 0 .84-.27 2.75 1.02c.79-.22 1.65-.33 2.5-.33c.85 0 1.71.11 2.5.33c1.91-1.29 2.75-1.02 2.75-1.02c.55 1.35.2 2.39.1 2.64c.65.71 1.03 1.6 1.03 2.71c0 3.82-2.34 4.66-4.57 4.91c.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0 0 12 2Z" fill="currentColor"></path></svg>
...
<a className="group flex items-center justify-between p-6 md:p-8 border-r border-white/5 border-b md:border-b-0 hover:bg-white/[0.02] transition-all duration-300" href="#">
<div className="flex items-center gap-3 text-slate-400 group-hover:text-white transition-colors">
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M19.27 5.33C17.94 4.71 16.5 4.26 15 4a.09.09 0 0 0-.07.03c-.18.33-.39.76-.53 1.09a16.09 16.09 0 0 0-4.8 0c-.14-.34-.35-.76-.54-1.09c-.01-.02-.04-.03-.07-.03c-1.5.26-2.93.71-4.27 1.33c-.01 0-.02.01-.03.02c-2.72 4.07-3.47 8.03-3.1 11.95c0 .02.01.04.03.05c1.8 1.32 3.53 2.12 5.2 2.65c.03.01.06 0 .07-.02c.4-.55.76-1.13 1.07-1.74c.02-.04 0-.08-.04-.09c-.57-.22-1.11-.48-1.64-.78c-.04-.02-.04-.08.01-.11c.11-.08.22-.17.33-.25c.02-.02.05-.02.07-.01c3.44 1.57 7.15 1.57 10.55 0c.02-.01.05-.01.07.01c.11.09.22.17.33.26c.04.03.04.09-.01.11c-.53.31-1.07.57-1.64.78c-.04.01-.05.06-.04.09c.31.61.66 1.19 1.07 1.74c.03.01.06.02.09.01c1.67-.53 3.4-1.33 5.2-2.65c.02-.01.03-.03.03-.05c.44-4.53-.73-8.46-3.1-11.95c-.01-.01-.02-.02-.04-.02zM8.52 14.91c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.84 2.12-1.89 2.12zm6.97 0c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.85 2.12-1.89 2.12z" fill="currentColor"></path></svg>
...
<a className="group flex items-center justify-between p-6 md:p-8 hover:bg-white/[0.02] transition-all duration-300" href="#">
<div className="flex items-center gap-3 text-slate-400 group-hover:text-white transition-colors">
<svg height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" fill="currentColor"></path></svg>
...
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Features</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Integrations</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Enterprise</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Solutions</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Changelog</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Pricing</a></li>
</ul>
</div>
...
<ul className="flex flex-col gap-3">
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Documentation</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">API Reference</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Community</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Help Center</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Status</a></li>
</ul>
</div>
...
<ul className="flex flex-col gap-3">
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">About Us</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Careers</a> <span className="bg-blue-500/20 text-blue-400 text-[9px] font-bold px-1.5 py-0.5 rounded ml-1.5 border border-blue-500/20">WE'RE HIRING</span></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Blog</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Brand Assets</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Partners</a></li>
</ul>
</div>
...
<ul className="flex flex-col gap-3">
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Privacy Policy</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Terms of Service</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Cookie Policy</a></li>
<li><a className="text-sm text-slate-400 hover:text-white transition-colors hover:translate-x-1 duration-200 inline-block" href="#">Security</a></li>
</ul>
</div>
</div>
...
<svg height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M6.25 19a.75.75 0 0 0 1.32.488l6-7a.75.75 0 0 0 0-.976l-6-7A.75.75 0 0 0 6.25 5z" fill="white" opacity=".5"></path><path clip-rule="evenodd" d="M10.512 19.57a.75.75 0 0 1-.081-1.058L16.012 12l-5.581-6.512a.75.75 0 1 1 1.139-.976l6 7a.75.75 0 0 1 0 .976l-6 7a.75.75 0 0 1-1.058.082" fill="white" fill-rule="evenodd"></path></svg>
</div>
...
<svg height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10" fill="currentColor" opacity=".5"></path><path d="M12 18.5a6.5 6.5 0 0 0 0-13z" fill="currentColor"></path></svg>
</button>
<button className="text-slate-500 hover:text-white transition-colors">
<svg height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10" fill="currentColor" opacity=".5"></path><path d="m14.55 15.8l-2.12-7.06a1.21 1.21 0 0 0-2.32-.01L7.98 15.8a.75.75 0 0 0 1.44.4l.39-1.28h2.88l.39 1.29a.75.75 0 0 0 1.44-.41zm-4.3-2.53l.83-2.78h.04l.84 2.78z" fill="currentColor"></path></svg>
</button>
</div>
</div>
</div>

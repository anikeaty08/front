...
<div className="w-full bg-gray-100 rounded-md animate-grow-bar" style={{'--target-height': '40%'}}></div>
<div className="w-full bg-gray-100 rounded-md animate-grow-bar" style={{'--target-height': '60%', animationDelay: '100ms'}}></div>
<div className="w-full bg-gray-100 rounded-md animate-grow-bar" style={{'--target-height': '50%', animationDelay: '200ms'}}></div>
<div className="w-full bg-gold/30 rounded-md animate-grow-bar" style={{'--target-height': '75%', animationDelay: '300ms'}}></div>
<div className="w-full bg-gradient-to-t from-gold to-goldLight rounded-md animate-grow-bar relative group shadow-lg shadow-gold/20" style={{'--target-height': '90%', animationDelay: '400ms'}}>

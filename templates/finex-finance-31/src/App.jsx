...
<svg className="lucide lucide-arrow-right w-3 h-3 text-gray-500 group-hover:text-white transition-colors" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-play-circle w-4 h-4 text-blue-400 group-hover:text-blue-300 transition-colors" data-lucide="play-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
</div><div className="flex flex-col bg-[#0A0A0C] border-[#ffffff]/10 border rounded-3xl mt-24 mb-24 py-32 relative overflow-hidden items-center justify-center group">

<div className="absolute inset-0 w-full h-full pointer-events-none opacity-30">
<svg className="w-full h-full text-white/10" fill="none" preserveaspectratio="xMidYMid slice" viewbox="0 0 800 600">
<path className="animate-[pulse_4s_ease-in-out_infinite]" d="M-100 300 C 100 100, 300 500, 400 300 S 700 100, 900 300" stroke="currentColor" stroke-dasharray="8 8" strokeWidth="2"></path>
<path className="opacity-50" d="M-100 450 C 50 550, 300 200, 500 400 S 800 200, 950 400" stroke="currentColor" stroke-dasharray="12 12" strokeWidth="1.5"></path>
<circle className="animate-ping" cx="100" cy="150" fill="currentColor" r="2" style={{animationDuration: '3s'}}></circle>
<circle className="animate-ping" cx="700" cy="450" fill="currentColor" r="2" style={{animationDuration: '5s'}}></circle>
</svg>
</div>

<div className="relative z-10 w-full max-w-[420px] flex flex-col items-center filter drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)] hover:drop-shadow-[0_30px_60px_rgba(59,130,246,0.15)] transition-all duration-500">

<div className="absolute top-[180px] left-[-20px] right-[-20px] h-40 flex justify-between items-start -z-10 opacity-80 pointer-events-none">
<div className="w-24 h-24 bg-gradient-to-br from-blue-900/40 to-black transform skew-y-[20deg] rounded-l-2xl border-l border-white/5"></div>
<div className="w-24 h-24 bg-gradient-to-bl from-purple-900/40 to-black transform -skew-y-[20deg] rounded-r-2xl border-r border-white/5"></div>
</div>

<div className="w-full bg-[#121215] border border-white/10 border-b-0 rounded-t-2xl p-10 flex flex-col items-center relative z-20">

<div className="absolute top-0 inset-x-0 h-32 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div>

<div className="relative w-20 h-20 rounded-full bg-[#1A1A1E] border border-white/10 flex items-center justify-center mb-8 shadow-[0_0_20px_rgba(59,130,246,0.2)] group-hover:scale-105 transition-transform duration-300">
<div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-500/20 to-purple-500/20 animate-spin-slow" style={{animationDuration: '10s'}}></div>
...
<h3 className="text-6xl text-white font-oswald font-light tracking-tight mb-8 drop-shadow-lg">
        Welcome!
      </h3>

<div className="w-full flex flex-col items-center gap-3 opacity-40">
<div className="h-[1px] w-full bg-gradient-to-r from-transparent via-white to-transparent"></div>
<div className="h-[1px] w-3/4 bg-gradient-to-r from-transparent via-white to-transparent"></div>
<div className="h-[1px] w-1/2 bg-gradient-to-r from-transparent via-white to-transparent"></div>
</div>
</div>

<div className="relative w-full h-[120px] z-20 -mt-[1px]">
<svg className="w-full h-full" preserveaspectratio="none" viewbox="0 0 420 120">
<defs>
<lineargradient id="flapGradient" x1="0%" x2="0%" y1="0%" y2="100%">
<stop offset="0%" stop-color="#121215"></stop>
<stop offset="100%" stop-color="#0A0A0C"></stop>
</lineargradient>
</defs>

<path d="M0 0 L210 120 L420 0 Z" fill="url(#flapGradient)" stroke="none"></path>

<line stroke="rgba(255,255,255,0.1)" strokeWidth="1" x1="0" x2="210" y1="0" y2="120"></line>
<line stroke="rgba(255,255,255,0.1)" strokeWidth="1" x1="420" x2="210" y1="0" y2="120"></line>
</svg>

<div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-32 h-32 bg-blue-500/20 blur-[50px] rounded-full pointer-events-none"></div>
</div>
</div>

<div className="mt-16 text-center z-10">
<p className="text-gray-400 font-sans font-light tracking-wide uppercase text-sm mb-4">
      Get started in minutes
    </p>
<button className="group flex items-center gap-2 pl-8 pr-7 py-3.5 bg-white text-black rounded-full text-sm font-medium hover:bg-gray-200 transition-all duration-300 font-sans shadow-[0_0_20px_rgba(255,255,255,0.2)]">
...
<div className="pointer-events-none absolute top-0 right-0 bottom-0 left-0 gap-x-12 gap-y-12 scroll-item scroll-blur-in delay-300" style={{animationPlayState: 'running'}}>

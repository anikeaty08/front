...
colors: {
orange: {
450: '#FF5A1F', // Custom vibrant orange
500: '#F74E09',
600: '#D93D00',
},
neutral: {
...
<a className="flex items-center gap-2 text-lg font-medium group" href="#">
            Sign up 
...
<header className="relative pt-20 pb-32 px-6 lg:px-12 max-w-7xl mx-auto">

<div className="absolute top-10 right-20 text-orange-500 opacity-80 animate-pulse">
<svg fill="currentColor" height="60" viewbox="0 0 24 24" width="60" xmlns="http://www.w3.org/2000/svg"><path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z"></path></svg>
</div>
<div className="absolute top-32 right-10 text-orange-500 opacity-60">
<svg fill="currentColor" height="40" viewbox="0 0 24 24" width="40" xmlns="http://www.w3.org/2000/svg"><path d="M12 0L14.59 9.41L24 12L14.59 14.59L12 24L9.41 14.59L0 12L9.41 9.41L12 0Z"></path></svg>
</div>
...
<div className="w-12 h-12 rounded-full border-4 border-neutral-900 bg-neutral-800 flex items-center justify-center text-xs font-medium">+</div>
</div>
</div>
</div>
</div>

<div className="lg:col-span-4 relative h-[400px] flex justify-center items-center perspective-1000">
...
<div className="absolute w-64 h-96 bg-neutral-300 rounded-3xl shadow-2xl transform rotate-[5deg] translate-y-6 translate-x-4 flex flex-col p-6 justify-between text-neutral-900">
...
<span className="text-xl font-medium group-hover:text-orange-500 transition-colors">Selecting your provider</span>
<i className="w-5 h-5 text-neutral-500 group-hover:text-orange-500" data-lucide="arrow-up-right"></i>
</a>
<a className="group flex items-center justify-between py-6 border-b border-white/10 hover:border-orange-500/50 transition-colors" href="#">
<span className="text-xl font-medium group-hover:text-orange-500 transition-colors">Set Up Your Account</span>
<i className="w-5 h-5 text-neutral-500 group-hover:text-orange-500" data-lucide="arrow-right"></i>
</a>
<a className="group flex items-center justify-between py-6 border-b border-white/10 hover:border-orange-500/50 transition-colors" href="#">
<span className="text-xl font-medium group-hover:text-orange-500 transition-colors">Enjoy Seamless Banking</span>
<i className="w-5 h-5 text-neutral-500 group-hover:text-orange-500" data-lucide="arrow-down-right"></i>
</a>
</div>
</div>
</header>

<section className="bg-neutral-50 text-neutral-900 py-24 px-6 lg:px-12 rounded-t-[3rem]">
...
<i className="w-4 h-4 cursor-pointer hover:opacity-100" data-lucide="facebook"></i>
<i className="w-4 h-4 cursor-pointer hover:opacity-100" data-lucide="instagram"></i>
<i className="w-4 h-4 cursor-pointer hover:opacity-100" data-lucide="twitter"></i>
<i className="w-4 h-4 cursor-pointer hover:opacity-100" data-lucide="linkedin"></i>
</div>
</div>
</footer>

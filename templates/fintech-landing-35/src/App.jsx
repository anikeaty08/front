...
<span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-200 via-orange-100/80 to-amber-200">for the internet.</span>
</h1>
...
<div className="flex items-center gap-3 px-3 py-2 text-zinc-500 rounded-md cursor-pointer transition-colors hover:text-white hover:bg-white/5">
<svg className="lucide lucide-arrow-left-right w-4 h-4" data-lucide="arrow-left-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8 3 4 7l4 4"></path><path d="M4 7h16"></path><path d="m16 21 4-4-4-4"></path><path d="M20 17H4"></path></svg>
...
<div className="flex pop-out mb-8 items-end justify-between">
<div className="">
...
<div className="w-10 h-10 rounded-full border flex items-center justify-center mb-4 group-hover:bg-orange-500/10 group-hover:text-orange-400 transition-colors border-white/10 bg-white/5 text-zinc-400">
<svg className="lucide lucide-terminal w-5 h-5" data-lucide="terminal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 19h8"></path><path d="m4 17 6-6-6-6"></path></svg>
</div>
...
<div className="flex items-center gap-2 text-xl font-bold transition-colors text-white hover:text-white"><svg className="lucide lucide-triangle w-5 h-5 fill-white" data-lucide="triangle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"></path></svg> Vercel</div>
<div className="flex items-center gap-2 text-xl font-bold transition-colors text-white hover:text-white"><svg className="lucide lucide-circle w-5 h-5 fill-white" data-lucide="circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle></svg> Linear</div>
<div className="flex items-center gap-2 text-xl font-bold transition-colors text-white hover:text-white"><svg className="lucide lucide-box w-5 h-5 fill-white" data-lucide="box" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"></path><path d="m3.3 7 8.7 5 8.7-5"></path><path d="M12 22V12"></path></svg> Dropbox</div>
<div className="flex items-center gap-2 text-xl font-bold transition-colors text-white hover:text-white"><svg className="lucide lucide-hexagon w-5 h-5 fill-white" data-lucide="hexagon" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" strokewidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg> Stripe</div>
</div>

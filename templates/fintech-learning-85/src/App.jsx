      ...
      function drawDots() {
          ...
          dots.forEach(dot => {
              ...
              if (distance < config.mouseRadius) {
                  ...
                  currentOpacity = Math.min(1, dot.baseOpacity + force * 0.8);
              }

              ctx.beginPath();
              ctx.arc(dot.x, dot.y, dot.radius, 0, Math.PI * 2);
              ctx.fillStyle = `rgba(0, 230, 118, ${currentOpacity})`;
              ctx.fill();
          });
...
<a className="text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#how-it-works">
            How It Works
          </a>
<a className="text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#features">
            Features
          </a>
<a className="text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#simulator">
            Simulator
          </a>
<a className="text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#pricing">
            Join
          </a>
</div>
...
<a className="mobile-link text-[clamp(2rem,6vw,3rem)] font-['Clash_Display',sans-serif] tracking-tight opacity-0 translate-y-4 transition-all duration-500 font-normal" href="#how-it-works">
        How It Works
      </a>
<a className="mobile-link text-[clamp(2rem,6vw,3rem)] font-['Clash_Display',sans-serif] tracking-tight opacity-0 translate-y-4 transition-all duration-500 delay-100 font-normal" href="#features">
        Features
      </a>
<a className="mobile-link text-[clamp(2rem,6vw,3rem)] font-['Clash_Display',sans-serif] tracking-tight opacity-0 translate-y-4 transition-all duration-500 delay-200 font-normal" href="#simulator">
        Simulator
      </a>
<a className="mobile-link text-[clamp(2rem,6vw,3rem)] font-['Clash_Display',sans-serif] tracking-tight opacity-0 translate-y-4 transition-all duration-500 delay-[300ms] font-normal" href="#pricing">
        Join
      </a>
</div>
...
<span className="font-['JetBrains_Mono',monospace] text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.1em] text-[#A1A1AA] font-light [writing-mode:vertical-rl] rotate-180">
              /001/ Welcome
            </span>
...
<h1 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(3.5rem,7vw,8rem)] leading-[0.9] tracking-tight text-[#FFFFFF] mb-[clamp(2rem,4vh,3rem)] reveal-up z-10">
              LEARN TO
              <br/>
<span className="text-transparent border-text relative z-10" style={{WebkitTextStroke: '1px #00E676'}}>
                INVEST.
              </span>
<br/>
              ZERO FEAR.
...
<p className="text-[#A1A1AA] text-[clamp(1rem,1.1vw,1.125rem)] font-light leading-[1.6] max-w-[40ch]">
                Master your money with bite-sized lessons and a zero-risk
                simulator. Built for India's next generation.
              </p>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.05em] text-[#A1A1AA] mb-1">
                Simulated Capital
              </div>
<div className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2.5rem,3.5vw,3.5rem)] text-[#00E676] tracking-tight leading-none">
                ₹
...
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.65rem,0.7vw,0.75rem)] text-[#00E676]/50">
                  MARKET_SIM_ACTIVE
                </span>
...
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.05em] text-[#00E676] mb-[clamp(2rem,4vw,4rem)] block">
                /002/ The Core Benefits
              </span>
...
<span>
<strong>Zero-Risk Simulator:</strong>
                    Practice with virtual money. Make mistakes and learn without
                    losing a single real rupee.
                  </span>
</li>
<li className="flex items-start gap-3">
<iconify-icon className="text-[#00E676] mt-1 shrink-0" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<strong>Bite-Sized Lessons:</strong>
                    Ditch overwhelming advice. Learn through simple, jargon-free
                    modules that actually make sense.
                  </span>
</li>
<li className="flex items-start gap-3">
<iconify-icon className="text-[#00E676] mt-1 shrink-0" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<strong>24/7 AI Coach:</strong>
                    Ask anything without judgment. Get instant, verified answers
                    to build your investing confidence.
                  </span>
</li>
</ul>
</div>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#00E676] mb-8 border-b border-[#FFFFFF]/10 pb-4 uppercase tracking-widest">
                Interactive Dashboard
              </div>
<h3 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2rem,3vw,3rem)] text-[#FFFFFF] tracking-tight mb-4">
                Zero-Risk Simulator
              </h3>
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] leading-[1.6]">
                Test strategies in live market conditions. We give you a virtual
                ₹10,000 portfolio to practice compounding, making mistakes, and
                learning mechanics without losing a single real rupee.
              </p>
</div>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#A1A1AA] mb-8 border-b border-[#FFFFFF]/10 pb-4 uppercase tracking-widest">
                Instant Clarification
              </div>
<h3 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2rem,3vw,3rem)] text-[#FFFFFF] tracking-tight mb-4">
                24/7 AI Finance Coach
              </h3>
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] leading-[1.6] mb-6">
                Stuck on a concept? Fearful of a market drop? Our AI coach
                provides instant, verified, and jargon-free answers to keep your
                momentum going.
              </p>
<div className="bg-[#050505] border border-[#FFFFFF]/10 p-4 font-['JetBrains_Mono',monospace] font-light text-sm text-[#A1A1AA]">
<span className="text-[#00E676]">User:</span>
                What exactly is a mutual fund?
                <br/>
<br/>
<span className="text-[#FFFFFF]">Coach:</span>
                Imagine buying a slice of a giant pizza instead of ordering 50
...
<div>
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.05em] text-[#00E676] mb-4 block reveal-up">
              /003/ The Roadmap
            </span>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#A1A1AA]">
              PROGRESSION
            </div>
...
<div className="absolute -right-4 -bottom-10 font-['Clash_Display',sans-serif] font-normal text-[clamp(10rem,15vw,20rem)] leading-none text-[#FFFFFF]/5 group-hover:text-[#00E676]/5 transition-colors duration-500 pointer-events-none select-none tracking-tighter">
              1
            </div>
<div className="relative z-10">
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(1rem,1.2vw,1.25rem)] text-[#00E676] mb-[clamp(1.5rem,2vw,2rem)] border border-[#00E676]/20 inline-block px-3 py-1">
                STEP 01
              </div>
<h3 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2rem,3vw,2.5rem)] text-[#FFFFFF] mb-[clamp(1rem,1.5vw,1.5rem)] tracking-tight">
                Master the Basics
              </h3>
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] leading-[1.6] max-w-lg">
                Start with simple, jargon-free lessons you can finish on your
                phone. Build a solid financial foundation in minutes without any
                boring textbooks.
              </p>
</div>
</div>
...
<div className="relative z-10">
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(1rem,1.2vw,1.25rem)] text-[#FFFFFF] mb-[clamp(1.5rem,2vw,2rem)] border border-[#FFFFFF]/20 inline-block px-3 py-1">
                STEP 02
              </div>
<h3 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2rem,3vw,2.5rem)] text-[#FFFFFF] mb-[clamp(1rem,1.5vw,1.5rem)] tracking-tight">
...
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] leading-[1.6]">
                Test strategies in our live market simulator. Build muscle
                memory and confidence before using your actual savings.
              </p>
</div>
</div>
...
<div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-['Clash_Display',sans-serif] font-normal text-[clamp(15rem,25vw,30rem)] leading-none text-[#FFFFFF]/5 group-hover:text-[#00E676]/5 transition-colors duration-500 pointer-events-none select-none tracking-tighter">
              3
            </div>
...
<h3 className="font-['Clash_Display',sans-serif] font-normal text-[clamp(2rem,3vw,3.5rem)] text-[#FFFFFF] mb-[clamp(1rem,1.5vw,1.5rem)] tracking-tight">
                Invest With Confidence
              </h3>
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] leading-[1.6]">
                Graduate to real wealth creation. Use our verified frameworks
                and guided pathways to start compounding your ₹1k–₹10k safely.
              </p>
</div>
<div className="relative z-10 hidden lg:block text-right border-l border-[#FFFFFF]/10 pl-8">
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#00E676] mb-2 uppercase tracking-widest">
                End Goal
              </div>
<div className="font-['Clash_Display',sans-serif] font-normal text-[clamp(1.5rem,2vw,2rem)] tracking-tight">
                FINANCIAL FREEDOM
              </div>
</div>
</div>
...
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.05em] text-[#00E676] mb-[clamp(1.5rem,2vw,2rem)] block reveal-up">
              /004/ Terminal Projection
            </span>
...
<label className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase text-[#A1A1AA] tracking-widest">
                    Current Savings (₹)
                  </label>
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(1.25rem,1.5vw,1.5rem)] text-[#FFFFFF]" id="val-starting">
                    ₹10,000
                  </span>
</div>
...
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(1.25rem,1.5vw,1.5rem)] text-[#FFFFFF]" id="val-monthly">
                    ₹2,000
                  </span>
</div>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.65rem,0.7vw,0.75rem)] text-[#00E676] mb-6 uppercase tracking-widest border-b border-[#FFFFFF]/10 pb-2">
                  Log entry #4092
                </div>
<p className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6] mb-8 font-['Clash_Display',sans-serif] tracking-tight">
                  "FinFlow took my ₹2k monthly savings and showed me exactly how
                  to grow it without the fear of losing it all in the market."
                </p>
<div className="flex justify-between items-end border-t border-[#FFFFFF]/10 pt-4">
<div className="font-['JetBrains_Mono',monospace] font-light text-[#FFFFFF] text-[clamp(0.875rem,1vw,1rem)]">
                    Rahul S.
                  </div>
<div className="text-[#A1A1AA] text-[clamp(0.75rem,0.8vw,0.875rem)] font-light font-['Inter',sans-serif]">
                    Design Student
                  </div>
</div>
</div>
...
<p className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6] mb-8 font-['Clash_Display',sans-serif] tracking-tight">
                  "The gamified simulator is addictive. I practiced for 3 weeks
                  before putting real money in. Highly recommend for complete
                  beginners."
                </p>
<div className="flex justify-between items-end border-t border-[#FFFFFF]/10 pt-4">
<div className="font-['JetBrains_Mono',monospace] font-light text-[#FFFFFF] text-[clamp(0.875rem,1vw,1rem)]">
...
<p className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6] mb-8 font-['Clash_Display',sans-serif] tracking-tight">
                  "Finally, a finance app that doesn't feel like a textbook. The
                  AI coach explained mutual funds to me in 30 seconds."
                </p>
<div className="flex justify-between items-end border-t border-[#FFFFFF]/10 pt-4">
<div className="font-['JetBrains_Mono',monospace] font-light text-[#FFFFFF] text-[clamp(0.875rem,1vw,1rem)]">
                    Aman K.
...
<span className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] uppercase tracking-[0.05em] text-[#00E676] mb-4 block">
              /006/ Subscription
            </span>
...
<div className="font-['JetBrains_Mono',monospace] font-normal text-[clamp(1rem,1.2vw,1.25rem)] text-[#FFFFFF] uppercase tracking-widest mb-4 border border-[#FFFFFF]/20 inline-block px-4 py-2 w-max">
                  Smart Start
                </div>
<p className="text-[#A1A1AA] font-light text-[clamp(1rem,1.1vw,1.125rem)] mb-10 leading-[1.6]">
                  Everything you need to master your money and build long-term
                  financial confidence.
                </p>
<div className="mb-10">
<div className="flex items-baseline gap-3 mb-4">
<span className="font-['Clash_Display',sans-serif] font-normal text-[clamp(4rem,5vw,5.5rem)] leading-none text-[#00E676] tracking-tight">
                      ₹399
                    </span>
<span className="font-['JetBrains_Mono',monospace] font-light text-[#A1A1AA] text-[clamp(1rem,1.1vw,1.125rem)] uppercase tracking-wider">
                      / month
                    </span>
</div>
</div>
...
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#A1A1AA] uppercase tracking-widest border-b border-[#FFFFFF]/10 pb-4 mb-8">
                  What's included in Smart Start
                </div>
...
<span className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.5] mt-1">
                      Master investing with real-world market simulations
                    </span>
</li>
...
<span className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.5] mt-1">
                      Get a personalized roadmap to build your wealth
                    </span>
</li>
...
<span className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.5] mt-1">
                      Learn faster with expert-curated learning paths
                    </span>
</li>
...
<span className="text-[#FFFFFF] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.5] mt-1">
                      Unlock premium tools, strategies, and content
                    </span>
</li>
</ul>
</div>
...
<span className="font-['Clash_Display',sans-serif] font-normal text-[clamp(1.5rem,2vw,2rem)] text-[#FFFFFF] pr-8 group-hover:text-[#00E676] transition-colors tracking-tight">
                  Do I need any finance background?
                </span>
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(1.5rem,2vw,2rem)] text-[#FFFFFF]/50 faq-icon group-hover:text-[#00E676] transition-colors">
                  +
                </div>
</button>
...
<p className="text-[#A1A1AA] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6]">
                    Zero. FinFlow is built entirely for complete beginners. We
                    explain everything from scratch using simple analogies and
...
<div className="w-2 h-2 bg-[#00E676] mt-2 flex-shrink-0"></div>
<p className="text-[#A1A1AA] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6]">
                    No. Our simulator gives you virtual money to practice with.
                    You experience real market conditions, but you only invest
                    actual rupees when you feel 100% confident.
                  </p>
</div>
</div>
</div>
...
<div className="w-2 h-2 bg-[#00E676] mt-2 flex-shrink-0"></div>
<p className="text-[#A1A1AA] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] leading-[1.6]">
                    It's available 24/7 right inside the platform. Ask it
                    anything from "What is a stock?" to "How do taxes work in
                    India?" and get instant, verified, simple answers.
                  </p>
</div>
</div>
</div>
...
<p className="text-[#A1A1AA] font-light text-[clamp(1.125rem,1.2vw,1.25rem)] max-w-sm mb-10 leading-[1.6]">
            Learn to invest without risking a single rupee. Built for India's
            next generation.
          </p>
<div className="font-['JetBrains_Mono',monospace] font-light text-[clamp(0.75rem,0.8vw,0.875rem)] text-[#00E676] mb-3 uppercase tracking-widest">
            Platform Updates
          </div>
...
<div className="text-[#FFFFFF]/40 mb-6 text-[clamp(0.75rem,0.8vw,0.875rem)] border-b border-[#FFFFFF]/10 pb-2">
              Index
            </div>
<a className="block text-[#A1A1AA] hover:text-[#00E676] transition-colors hover-target" href="#how-it-works">
              How It Works
            </a>
<a className="block text-[#A1A1AA] hover:text-[#00E676] transition-colors hover-target" href="#features">
              Features
            </a>
<a className="block text-[#A1A1AA] hover:text-[#00E676] transition-colors hover-target" href="#simulator">
              Simulator
            </a>
</div>
<div className="space-y-4">
...
<a className="block text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target flex items-center gap-2" href="#">
              Instagram
...
<a className="block text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#">
              Terms
            </a>
<a className="block text-[#A1A1AA] hover:text-[#FFFFFF] transition-colors hover-target" href="#">
              Privacy

...
<div className="h-full bg-neutral-100 rounded-none overflow-hidden relative group">
<img className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
...
<div className="text-center group">
<div className="relative overflow-hidden mb-6 h-[350px]">
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?w=600&amp;q=80"/>
<div className="absolute bottom-6 left-0 right-0 flex justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
<a className="w-8 h-8 rounded-full bg-lime-500 text-black flex items-center justify-center hover:bg-white" href="#"><i className="w-4 h-4" data-lucide="facebook"></i></a>
<a className="w-8 h-8 rounded-full bg-lime-500 text-black flex items-center justify-center hover:bg-white" href="#"><i className="w-4 h-4" data-lucide="instagram"></i></a>
</div>
...
<div className="text-center group">
<div className="relative overflow-hidden mb-6 h-[350px]">
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://images.unsplash.com/photo-1594381898411-846e7d193883?w=600&amp;q=80"/>
<div className="absolute bottom-6 left-0 right-0 flex justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
<a className="w-8 h-8 rounded-full bg-lime-500 text-black flex items-center justify-center hover:bg-white" href="#"><i className="w-4 h-4" data-lucide="facebook"></i></a>
</div>
</div>
...
<img className="absolute inset-0 w-full h-full object-cover opacity-20" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=800"/>
...
<img className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-multiply" src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&amp;w=800"/>
<div className="relative z-10 p-8 flex flex-col items-center h-full justify-between">
<div className="text-center w-full">
...
<div className="bg-neutral-900 h-[500px] relative group overflow-hidden border border-neutral-800">
<img className="absolute inset-0 w-full h-full object-cover opacity-20" src="https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&amp;w=800"/>
<div className="relative z-10 p-8 flex flex-col items-center h-full justify-between">
<div className="text-center w-full">
...
<img className="w-14 h-14 rounded-full border-2 border-lime-500" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&amp;h=100&amp;fit=crop"/>
<div>
...
<img className="rounded-lg shadow-2xl border-4 border-white/10 opacity-80 rotate-3" src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=800&amp;q=80"/>
...
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 opacity-70 group-hover:opacity-100" src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&amp;q=80"/>
</div>
...
<div className="relative overflow-hidden mb-6 h-64 bg-black">
<div className="absolute top-4 left-4 bg-lime-500 text-black px-4 py-1 text-xs font-bold uppercase z-10">7 March 2021</div>
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 opacity-70 group-hover:opacity-100" src="https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?w=800&amp;q=80"/>
</div>
<h3 className="text-xl font-bold text-black leading-tight mb-3 group-hover:text-lime-600 transition-colors">Going to the gym for the first time</h3>
<p className="text-neutral-500 text-sm mb-4 line-clamp-3">Praesent id ipsum pellentesque lectus dapibus condimentum curabitur eget risus quam. In hac habitasse platea dictumst.</p>
<a className="text-xs font-bold uppercase tracking-widest text-black hover:text-lime-600 transition-colors" href="#">Read More</a>
...
<div className="relative overflow-hidden mb-6 h-64 bg-black">
<div className="absolute top-4 left-4 bg-lime-500 text-black px-4 py-1 text-xs font-bold uppercase z-10">7 March 2021</div>
<img className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 opacity-70 group-hover:opacity-100" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&amp;q=80"/>
</div>
<h3 className="text-xl font-bold text-black leading-tight mb-3 group-hover:text-lime-600 transition-colors">Going to the gym for the first time</h3>
<p className="text-neutral-500 text-sm mb-4 line-clamp-3">Praesent id ipsum pellentesque lectus dapibus condimentum curabitur eget risus quam. In hac habitasse platea dictumst.</p>
<a className="text-xs font-bold uppercase tracking-widest text-black hover:text-lime-600 transition-colors" href="#">Read More</a>

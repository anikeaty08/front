...
<div className="pt-10 pb-2 grid grid-cols-1 md:grid-cols-12 gap-8 items-start cursor-default" onclick="event.stopPropagation()">
<div className="md:col-span-5 md:col-start-2">
<img alt="Kimchi Kick" className="w-full h-80 object-cover transition-all duration-700 rounded-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/af261c15-b582-4988-95b3-55dbfc08d5a3_1600w.png"/>
</div>
...
<div className="mt-10 flex flex-col text-black font-semibold">
<span className="text-sm tracking-widest uppercase mb-2">Price</span>
<div className="flex items-baseline gap-2">
<span className="text-5xl tracking-tight">7.99$</span>
...
<div className="pt-10 pb-2 grid grid-cols-1 md:grid-cols-12 gap-8 items-start cursor-default" onclick="event.stopPropagation()">
<div className="md:col-span-5 md:col-start-2">
<img alt="Hot Chicken Flavor" className="w-full h-80 object-cover transition-all duration-700 rounded-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1493ae9e-7c06-44d5-a55e-ca5e08300943_1600w.png"/>
</div>
<div className="md:col-span-5 flex flex-col">
<p className="text-xl md:text-2xl text-neutral-600 leading-relaxed font-extralight">
...
<div className="pt-10 pb-2 grid grid-cols-1 md:grid-cols-12 gap-8 items-start cursor-default" onclick="event.stopPropagation()">
<div className="md:col-span-5 md:col-start-2">
<img alt="Garlic Flavor" className="w-full h-80 object-cover transition-all duration-700 rounded-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a12bb4da-30a5-4c39-ae16-88455706d466_1600w.png"/>
</div>
<div className="md:col-span-5 flex flex-col">
<p className="text-xl md:text-2xl text-neutral-600 leading-relaxed font-extralight">
...
<div className="pt-10 pb-2 grid grid-cols-1 md:grid-cols-12 gap-8 items-start cursor-default" onclick="event.stopPropagation()">
<div className="md:col-span-5 md:col-start-2">
<img alt="Masala Flavor" className="w-full h-80 object-cover transition-all duration-700 rounded-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/95df1e82-5599-4505-aa10-3d708def7b8b_1600w.png"/>
</div>
<div className="md:col-span-5 flex flex-col">
<p className="text-xl md:text-2xl text-neutral-600 leading-relaxed font-extralight">

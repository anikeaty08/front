...
<svg className="lucide lucide-plane w-6 h-6 text-sky-400" data-lucide="plane" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2 12h20"></path><path d="m13 2-3.5 10"></path><path d="m11 22 3.5-10"></path></svg>
</div>
<div>
<h1 className="text-xl font-bold text-white tracking-tight uppercase leading-none">Redhill Aviation</h1>
<p className="text-[10px] text-sky-200 tracking-widest uppercase">Flight Centre</p>
</div>
</div>
...
<a className="bg-white text-slate-900 px-5 py-2.5 rounded hover:bg-sky-50 transition-colors font-semibold" href="#">Buy Voucher</a>
</div>
...
<img alt="Cessna Aircraft on Runway" className="opacity-60 w-full h-full object-cover" src="https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=2560&amp;q=80"/>
...
<h1 className="serif-font text-5xl md:text-7xl text-white leading-[1.1] mb-6 tracking-tight">
                LEARN TO FLY <br/>
<span className="italic font-light text-sky-300">IN THE UK SKIES</span>
</h1>
<p className="text-slate-300 text-lg md:text-xl font-light max-w-2xl mx-auto mb-8">
                A well-established, friendly UK CAA Approved Training Organisation (ATO) and Aero Club based in Redhill, Surrey.
            </p>
</div>
</header>
...
<p className="text-xs font-semibold text-slate-500 py-2 tracking-widest uppercase">Book a Trial Lesson or Enquire Today</p>
</div>
...
<input className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded text-sm focus:outline-none focus:border-sky-500" placeholder="07700 900000" type="text"/>
</div>
</div>
<div className="space-y-1">
<label className="text-xs font-medium text-slate-700">Interested In</label>
<div className="relative">
<svg className="lucide lucide-plane-takeoff absolute left-3 top-2.5 w-4 h-4 text-slate-400" data-lucide="plane-takeoff" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2 22h20"></path><path d="M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 2.9.5l.6.6a2.41 2.41 0 0 1-.5 2.9l-2.06 4.19a2 2 0 0 0 .2 2.1l3 4.02a2 2 0 0 1 .2 2.1l-.45.9L18 20l-6-3-4.1 1.76a2 2 0 0 0-1.8 0l-.17.1a2 2 0 0 1-1.8 0l-1.1-.55L4 17"></path></svg>
...
<option>Trial Lesson / Experience</option>
<option>PPL / LAPL Training</option>
<option>Commercial / CPL</option>
<option>Instrument Rating</option>
<option>Instructor Course</option>
</select>
</div>
</div>
<button className="w-full bg-red-700 text-white font-medium py-2.5 rounded hover:bg-red-800 transition-colors flex items-center justify-center gap-2">
                    Start Your Journey <svg className="lucide lucide-arrow-right w-4 h-4" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
...
<div className="flex items-center gap-2"><svg className="lucide lucide-check-circle w-5 h-5 text-slate-400" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><path d="m9 11 3 3L22 4"></path></svg> <span className="text-xs font-bold font-serif text-slate-500">UK CAA APPROVED</span></div>
<div className="flex items-center gap-2"><svg className="lucide lucide-map w-5 h-5 text-slate-400" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"></polygon><line x1="9" x2="9" y1="3" y2="18"></line><line x1="15" x2="15" y1="6" y2="21"></line></svg> <span className="text-xs font-bold font-serif text-slate-500">6 GRASS RUNWAYS</span></div>
<div className="flex items-center gap-2"><svg className="lucide lucide-star w-5 h-5 text-slate-400" data-lucide="star" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg> <span className="text-xs font-bold font-serif text-slate-500">TRIPADVISOR EXCELLENCE</span></div>
<div className="flex items-center gap-2"><svg className="lucide lucide-calendar w-5 h-5 text-slate-400" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18" x="3" y="4"></rect><line x1="16" x2="16" y1="2" y2="6"></line><line x1="8" x2="8" y1="2" y2="6"></line><line x1="3" x2="21" y1="10" y2="10"></line></svg> <span className="text-xs font-bold font-serif text-slate-500">OPEN 7 DAYS A WEEK</span></div>
</div>
</div>
</div>
...
<h2 className="serif-font text-3xl md:text-5xl mb-4">COMPREHENSIVE <span className="italic text-sky-400">FLIGHT</span> TRAINING</h2>
<p className="text-slate-400 max-w-xl mx-auto">From your first trial lesson to becoming a Commercial Pilot or Flight Instructor, we offer a complete pathway to the skies.</p>
</div>
...
<svg className="lucide lucide-graduation-cap w-5 h-5" data-lucide="graduation-cap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg>
</div>
<h3 className="text-lg font-semibold mb-2">Private Pilot Licence</h3>
<p className="text-slate-400 text-sm leading-relaxed mb-4">Training for PPL, LAPL, Night Ratings, and IMC/IR(R). 7 days a week instruction availability.</p>
<a className="text-xs font-bold text-white flex items-center gap-1 group-hover:gap-2 transition-all" href="#">VIEW COURSES <svg className="lucide lucide-chevron-right w-3 h-3" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg></a>
</div>
...
<p className="text-slate-400 text-sm leading-relaxed mb-4">From 30-minute taster flights to "Land-away" experiences and Aerobatics. The perfect gift voucher.</p>
<a className="text-xs font-bold text-white flex items-center gap-1 group-hover:gap-2 transition-all" href="#">BUY VOUCHERS <svg className="lucide lucide-chevron-right w-3 h-3" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg></a>
</div>
</div>

<div className="relative h-[400px] lg:h-[500px]">
<div className="absolute inset-0 bg-sky-500/20 blur-3xl rounded-full"></div>
<img alt="Cockpit View" className="z-10 transform lg:scale-110 w-full h-full object-cover border-slate-800/50 border-4 rounded-2xl relative shadow-2xl" src="https://images.unsplash.com/photo-1559627748-c44d1891b072?w=800&amp;q=80"/>
...
<p className="text-slate-400 text-sm leading-relaxed mb-4">CPL, Multi-Engine Piston, Instrument Ratings (CB-IR, Full IR, En-route IR). Fast track your career.</p>
<a className="text-xs font-bold text-white flex items-center gap-1 group-hover:gap-2 transition-all" href="#">PROFESSIONAL COURSES <svg className="lucide lucide-chevron-right w-3 h-3" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg></a>
</div>
...
<p className="text-slate-400 text-sm leading-relaxed mb-4">Complete range including FI(R), Aerobatics, Night, MEP, IRI, FIC, and CRI (ME and SE) training.</p>
<a className="text-xs font-bold text-white flex items-center gap-1 group-hover:gap-2 transition-all" href="#">BECOME AN INSTRUCTOR <svg className="lucide lucide-chevron-right w-3 h-3" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg></a>
</div>
</div>
</div>
</div>
...
<span className="flex items-center gap-2"><svg className="lucide lucide-map w-4 h-4 text-sky-600" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"></polygon></svg> 6 Grass Runways</span>
<span className="text-slate-300">///</span>
<span className="flex items-center gap-2"><svg className="lucide lucide-coffee w-4 h-4 text-sky-600" data-lucide="coffee" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10 2v2"></path><path d="M14 2v2"></path><path d="M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1"></path><path d="M6 2v2"></path></svg> On-site Cafe &amp; Wi-Fi</span>
<span className="text-slate-300">///</span>
<span className="flex items-center gap-2"><svg className="lucide lucide-calendar w-4 h-4 text-sky-600" data-lucide="calendar" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18" x="3" y="4"></rect></svg> Open 7 Days a Week</span>
<span className="text-slate-300">///</span>
...
<span className="text-slate-300">///</span>
<span className="flex items-center gap-2"><svg className="lucide lucide-wifi w-4 h-4 text-sky-600" data-lucide="wifi" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" x2="12.01" y1="20" y2="20"></line></svg> Free Parking</span>
</div>
</div>
...
<h2 className="serif-font text-4xl text-slate-900">DISCOVER OUR <span className="italic text-red-700 font-serif">DIVERSE</span><br/>TRAINING FLEET</h2>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">

<div className="group relative aspect-[4/5] overflow-hidden rounded-lg bg-slate-100">
<img alt="Cessna 152" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://images.unsplash.com/photo-1543888775-6c1753c15d74?q=80&amp;w=1600"/>
...
<p className="text-xs text-slate-300 mb-4 opacity-0 group-hover:opacity-100 transition-opacity delay-100 line-clamp-2">Ideal for initial training and PPL. We operate multiple two-seat C152s including an Aerobat.</p>
<span className="text-xs font-bold uppercase tracking-wider flex items-center gap-2">View Specs <svg className="lucide lucide-arrow-right w-3 h-3" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>
</div>
</div>
...
<p className="text-xs text-slate-300 mb-4 opacity-0 group-hover:opacity-100 transition-opacity delay-100 line-clamp-2">The ubiquitous 4-seater tourer. 180hp variant with Garmin 430 and leather seats.</p>
<span className="text-xs font-bold uppercase tracking-wider flex items-center gap-2">View Specs <svg className="lucide lucide-arrow-right w-3 h-3" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>
</div>
</div>
...
<p className="text-xs text-slate-300 mb-4 opacity-0 group-hover:opacity-100 transition-opacity delay-100 line-clamp-2">Complex single with retractable undercarriage and variable-pitch prop for advanced training.</p>
<span className="text-xs font-bold uppercase tracking-wider flex items-center gap-2">View Specs <svg className="lucide lucide-arrow-right w-3 h-3" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>
</div>
</div>

<div className="group relative aspect-[4/5] overflow-hidden rounded-lg bg-slate-100">
<img alt="Aerobatics" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://images.unsplash.com/photo-1520625981656-7876a47a195b?q=80&amp;w=1600"/>
<div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-transparent to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
<div className="absolute bottom-0 left-0 w-full p-6 text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
<h3 className="font-serif text-xl mb-1">Aerobatics</h3>
<p className="text-xs text-slate-300 mb-4 opacity-0 group-hover:opacity-100 transition-opacity delay-100 line-clamp-2">Experience the thrill of loops and rolls in our Cessna 152 Aerobat.</p>
<span className="text-xs font-bold uppercase tracking-wider flex items-center gap-2">View Specs <svg className="lucide lucide-arrow-right w-3 h-3" data-lucide="arrow-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>
</div>
</div>
</div>
...
<img alt="Pilot Checking Aircraft" className="w-full h-auto rounded-lg grayscale hover:grayscale-0 transition-all duration-700 relative z-10 shadow-2xl" src="https://images.unsplash.com/photo-1559815049-74e50259b381?q=80&amp;w=1600"/>
</div>
...
<img className="h-64 w-80 object-cover rounded grayscale hover:grayscale-0 transition-all duration-500 flex-shrink-0" src="https://images.unsplash.com/photo-1629813292440-660c00df0b89?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
<img className="h-64 w-80 object-cover rounded grayscale hover:grayscale-0 transition-all duration-500 flex-shrink-0" src="https://images.unsplash.com/photo-1543888775-6c1753c15d74?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
<img className="h-64 w-80 object-cover rounded grayscale hover:grayscale-0 transition-all duration-500 flex-shrink-0" src="https://images.unsplash.com/photo-1506456209581-2c0696a40552?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
<img className="h-64 w-80 object-cover rounded grayscale hover:grayscale-0 transition-all duration-500 flex-shrink-0" src="https://images.unsplash.com/photo-1542296332-2e44a996aa0d?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
...
<svg className="lucide lucide-plane w-6 h-6 text-sky-500" data-lucide="plane" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2 12h20"></path><path d="m13 2-3.5 10"></path><path d="m11 22 3.5-10"></path></svg>

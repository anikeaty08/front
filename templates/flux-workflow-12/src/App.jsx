...
<div className="flex pt-4 pb-4 sm:pt-6 sm:pb-6 items-center justify-between">
<a className="inline-flex items-center justify-center bg-center w-[100px] h-[30px] sm:w-[120px] sm:h-[36px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/92f8c97d-c6ce-4088-95e1-67dfbfddffa0_1600w.png)] bg-cover rounded-full" href="#"></a>
<nav className="hidden md:flex items-center gap-7 text-sm text-zinc-300">
<a className="hover:text-white transition-colors" href="#">
              Piattaforma
            </a>
<a className="hover:text-white transition-colors" href="#">Soluzioni</a>
<a className="hover:text-white transition-colors" href="#">
              Laboratorio
            </a>
<a className="hover:text-white transition-colors" href="#">
...
<a className="hidden sm:inline-flex items-center text-sm text-zinc-300 hover:text-white" href="#">
              Accedi
            </a>
<div className="hidden sm:inline-block group relative overflow-visible">
<button className="group inline-flex min-w-[140px] cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:scale-105 border-gradient hover:text-white gap-2 text-sm font-medium text-white/80 tracking-tight bg-white/5 rounded-full pt-3 pr-3 pb-3 pl-3 relative backdrop-blur-xl gap-x-2 gap-y-2 items-center justify-center">
...
<button className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-lg bg-white/5 border border-white/10 text-zinc-300 hover:text-white hover:bg-white/10 transition-colors" id="mobile-menu-button">
...
<div className="hidden md:hidden absolute top-full left-0 right-0 mt-2 mx-4 rounded-2xl border border-white/10 bg-black/95 backdrop-blur-xl overflow-hidden shadow-xl" id="mobile-menu">
<nav className="flex flex-col p-4 gap-1">
<a className="px-4 py-3 text-sm text-zinc-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors" href="#">
                Piattaforma
              </a>
<a className="px-4 py-3 text-sm text-zinc-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors" href="#">
                Soluzioni
...
<a className="block px-4 py-3 text-sm text-zinc-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors" href="#">
                  Accedi
                </a>
<button className="w-full mt-2 inline-flex items-center justify-center gap-2 text-sm font-medium text-white/80 tracking-tight bg-white/5 rounded-full py-3 px-4 border border-white/10 hover:bg-white/10 transition-colors">
                  Inizia ora
                </button>
</div>
</nav>
...
<span className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-zinc-300 backdrop-blur animate-fade-in-up delay-200">
              Il CRM intelligente per gioiellerie moderne
            </span>
...
<textpath className="" href="#curve-subtitle" startoffset="50%">
                    La piattaforma gestionale creata per orafi e gioiellieri.
                    Vendi di più con l'automazione intelligente.
                  </textpath>
</text>
</svg>
</div>
...
<input className="w-full rounded-lg border border-white/5 bg-white/[0.03] pl-9 pr-20 py-2 text-sm text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/30 backdrop-blur-sm" placeholder="Cerca clienti, riparazioni, inventario..." type="text"/>
...
<p className="mt-1 text-xs text-blue-400">
                        +23% rispetto settimana scorsa
                      </p>
</div>
<div className="bg-[#1a1a1f]/60 border-white/5 border rounded-xl pt-4 pr-4 pb-4 pl-4 backdrop-blur-sm">
<div className="flex items-center justify-between">
<span className="text-xs text-zinc-400">Tasso Vendita</span>
...
<span className="text-fuchsia-400">›</span>
                          ordine anello personalizzato
                        </div>
<div className="text-zinc-400">
                          Inizializzazione verifica pietre...
                        </div>
<div className="text-zinc-400">
                          Caricamento listino diamanti
                        </div>
<div className="text-zinc-400">
                          Connessione database fornitori (3/3)
                        </div>
<div className="text-emerald-400">
                          ✓ Presa in carico [ord-a8n3j]
                        </div>
<div className="text-emerald-400">
                          ✓ Fase 1/5 completata in 1.2s
                        </div>
<div className="text-zinc-400">
<span className="text-blue-400">Stato:</span>
<span className="text-white">
                            78% completato · 2 fasi rimanenti
                          </span>
</div>
<div className="text-emerald-400">
                          ✓ Fase 2/5 completata in 0.8s
                        </div>
<div className="text-zinc-400">
                          Aggiornamento inventario in corso...
                        </div>
<div className="text-emerald-400">
                          ✓ Fase 3/5 completata in 1.5s
                        </div>
<div className="text-zinc-400">
                          Controllo qualità dati...
                        </div>
<div className="text-emerald-400">
                          ✓ Fase 4/5 completata in 0.9s
                        </div>
<div className="text-zinc-400">
                          Finalizzazione ordine...
                        </div>
<div className="text-emerald-400">
                          ✓ Fase 5/5 completata in 1.1s
                        </div>
<div className="text-emerald-400">
...
<p className="text-sm text-zinc-200">
                            Incastonatura completata
                          </p>
<p className="text-xs text-zinc-400 mt-0.5">
                            ordine-anello • 5 min fa
                          </p>
</div>
</div>
<div className="flex items-start gap-3">
...
<p className="text-xs text-zinc-400 mt-0.5">
                            mario.rossi@email.it • 28 min fa
                          </p>
</div>
</div>
<div className="flex items-start gap-3">
...
<div className="flex-1 min-w-0">
<p className="text-sm text-zinc-200">Nota aggiunta</p>
<p className="text-xs text-zinc-400 mt-0.5">
                            preventivo-collana • 1 ora fa
                          </p>
</div>
</div>
</div>
...
<span className="text-xs text-zinc-400" style={{animation: 'fade-in 0.6s ease-out 1s forwards', opacity: '1'}}>
                            In orario
                          </span>
</div>
</div>
...
<span className="text-zinc-400">Riparazioni/sett</span>
...
<span className="text-zinc-400">Soddisfazione</span>
...
<p className="text-xs text-zinc-300/80 leading-relaxed">
                      Le vendite di diamanti sono aumentate del 38% questo mese.
                      Considera di riassortire i solitari.
                    </p>
</div>
</aside>
</div>
...
<p className="uppercase text-xs font-medium text-zinc-500 tracking-wide">
                Scelto dalle migliori gioiellerie
              </p>
</div>
...
<p className="text-sm text-white leading-relaxed">
                        "Gioiello.ai ha trasformato il nostro laboratorio. Siamo
                        passati da consegne settimanali a giornaliere con totale
                        sicurezza."
                      </p>
</div>
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/787e2344-3f85-4363-8310-e17766fc9f61_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                          Maya
                          <span className="text-fuchsia-300">Rossi</span>
</div>
<div className="text-xs text-zinc-300 truncate">
                          Resp. Laboratorio — Oro Puro
                        </div>
</div>
</div>
</div>
...
<div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 flex-1 flex items-center">
<p className="text-sm text-white leading-relaxed">
                        "L'automazione dell'inventario ci ha fatto risparmiare
                        15 ore a settimana. Semplicemente rivoluzionario."
                      </p>
</div>
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8996ab12-550b-417f-859c-e60383fc6ce0_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                          Luca
                          <span className="text-fuchsia-300">Bianchi</span>
</div>
<div className="text-xs text-zinc-300 truncate">
                          Titolare — Gioielli Bianchi
                        </div>
</div>
</div>
</div>
...
<div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 flex-1 flex items-center">
<p className="text-sm text-white leading-relaxed">
                        "La migliore esperienza gestionale mai provata. Rende
                        semplici anche i flussi di riparazione più complessi."
                      </p>
</div>
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dd395f37-778e-426f-9685-a0a3d48a3c14_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                          Giulia
                          <span className="text-fuchsia-300">Verdi</span>
</div>
<div className="text-xs text-zinc-300 truncate">
                          Manager — Diamanti &amp; Co.
                        </div>
...
<div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 flex-1 flex items-center">
<p className="text-sm text-white leading-relaxed">
                        "Costi di gestione ridotti del 40% e clienti molto più
                        soddisfatti grazie agli aggiornamenti automatici."
                      </p>
</div>
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5fe45363-dc90-4109-807a-3fefa11826ac_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                          Marco
                          <span className="text-fuchsia-300">Neri</span>
</div>
<div className="text-xs text-zinc-300 truncate">
                          Direttore — Luxury Gems
                        </div>
</div>
</div>
</div>
...
<span className="text-zinc-200">Funzionalità</span>
<span className="text-white">principali</span>
</h1>
<p className="mt-4 text-base sm:text-lg text-zinc-400 max-w-3xl">
          Strumenti potenti progettati per accelerare la tua gioielleria e
...
<svg className="h-4 w-4 text-zinc-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-[13.5px] leading-6 text-zinc-300" id="userMessage">
                    Fissa un appuntamento per il ritiro dell'anello domani alle
                    11
                  </p>
</div>
</div>
...
<p className="text-[13.5px] leading-6 text-zinc-300" id="aiMessage">
                    Fatto. Ho fissato l'appuntamento per il ritiro dell'anello
                    per Giovedì alle 11:00.
                  </p>
...
<svg className="h-4 w-4 text-zinc-400" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"></path>
<rect height="12" rx="2" width="14" x="2" y="6"></rect>
</svg>
<span className="" id="meetingDetails">
                          Ritiro Anello • Giovedì 11:00
                        </span>
</div>
...
<input className="flex-1 h-10 rounded-md bg-white/5 border border-white/10 px-3 text-[13.5px] text-zinc-200 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-sky-500/40" id="chatInput" placeholder="Chiedi a Gioiello.ai..." type="text"/>
...
<h3 className="text-2xl sm:text-[26px] tracking-tight font-semibold text-zinc-100">
              Automazione AI per Gioiellerie
            </h3>
<p className="mt-2 text-[14.5px] leading-7 text-zinc-400">
              Assistenti intelligenti che comprendono il contesto, automatizzano
              le prenotazioni e si integrano con il tuo inventario.
            </p>
</div>
</div>
...
<div className="text-xs text-zinc-500 mb-0.5">Articoli</div>
<div className="text-sm font-semibold text-zinc-200">47k</div>
</div>
<div className="rounded-lg border border-white/10 bg-white/[0.02] p-2">
<div className="text-xs text-zinc-500 mb-0.5">Clienti</div>
<div className="text-sm font-semibold text-sky-300">12k</div>
</div>
<div className="rounded-lg border border-white/10 bg-white/[0.02] p-2">
<div className="text-xs text-zinc-500 mb-0.5">Vendite</div>
...
<div className="text-[10px] text-sky-400">Brand</div>
</div>
</div>
</div>
...
<span className="text-zinc-400">Cataloghi</span>
<span className="text-sky-300 transition-all" style={{animation: 'fade-in-out 2s ease-in-out infinite'}}>
                120+
              </span>
</div>
<div className="flex items-center justify-between text-xs">
<span className="text-zinc-400">Listini</span>
<span className="text-zinc-200 transition-all" style={{animation: 'fade-in-out 2s ease-in-out infinite 0.5s'}}>
                850+
              </span>
</div>
<div className="flex items-center justify-between text-xs">
<span className="text-zinc-400">Ordini Auto</span>
<span className="text-emerald-400 transition-all" style={{animation: 'fade-in-out 2s ease-in-out infinite 1s'}}>
                Illimitati
              </span>
</div>
</div>
...
<span className="font-medium">Prezzo oro oggi?</span>
</div>
<p className="text-[13.5px] text-zinc-300 leading-relaxed">
                      Quotazione in rialzo a 65€/gr. Consiglio acquisto stock.
                    </p>
</div>
</div>
</div>
...
<div className="text-[10px] text-zinc-500">Risposta</div>
</div>
...
<div className="text-[10px] text-zinc-500">Precisione</div>
</div>
...
<div className="text-[10px] text-zinc-500">Disponibile</div>
</div>
</div>
<style>
            @keyframes float-up {
...
<p className="mt-2 text-[13.5px] leading-7 text-zinc-400">
              Ottieni analisi di mercato per massimizzare il valore del tuo
              magazzino.
            </p>
</div>
</div>
...
<p className="mt-4 text-base sm:text-lg text-zinc-400 max-w-3xl">
        Traccia ogni vendita e riparazione. Dashboard visive ti danno visibilità
        istantanea sulla salute del tuo negozio.
      </p>
</header>
...
<button className="step-button active rounded-xl border border-white/20 bg-white/10 backdrop-blur-xl text-center py-2 text-xs text-zinc-400 tracking-wide transition-all duration-300 hover:bg-white/[0.15] hover:border-white/30 cursor-pointer shadow-[0_8px_32px_0_rgba(255,255,255,0.1)]" data-step="1">
            FASE 1
          </button>
<button className="step-button rounded-xl border border-white/20 bg-white/10 backdrop-blur-xl text-center py-2 text-xs text-zinc-400 tracking-wide transition-all duration-300 hover:bg-white/[0.15] hover:border-white/30 cursor-pointer shadow-[0_8px_32px_0_rgba(255,255,255,0.1)]" data-step="2">
            FASE 2
          </button>
<button className="step-button rounded-xl border border-white/20 bg-white/10 backdrop-blur-xl text-center py-2 text-xs text-zinc-400 tracking-wide transition-all duration-300 hover:bg-white/[0.15] hover:border-white/30 cursor-pointer shadow-[0_8px_32px_0_rgba(255,255,255,0.1)]" data-step="3">
            FASE 3
          </button>
</div>
...
<text fill="#fff" fontSize="32" font-weight="600" text-anchor="middle" x="100" y="95">
                            75%
                          </text>
<text fill="#a1a1aa" fontSize="12" text-anchor="middle" x="100" y="115">
                            Completato
                          </text>
</svg>
</div>
...
<svg className="text-zinc-400" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10"></circle>
</svg>
</div>
<div className="flex-1">
...
<svg className="w-5 h-5 text-cyan-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h2 className="mt-6 text-3xl sm:text-5xl tracking-tight font-semibold text-white">
                Monitora ogni carato
              </h2>
<p className="sm:text-lg text-base text-zinc-400 max-w-xl mt-4">
                Dashboard collegate al tuo inventario. Traccia vendite, giacenze
                e ordini in tempo reale con precisione assoluta.
              </p>
<div className="mt-7">
...
<span className="z-10 text-xs font-normal rounded-full relative">
                      Esplora Analisi
                    </span>
...
<div className="relative flex h-10 w-10 items-center justify-center rounded-full bg-white/[0.05] backdrop-blur-sm">
<svg className="w-5 h-5 text-violet-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
</svg>
</div>
</div>
<h2 className="mt-6 text-3xl sm:text-5xl tracking-tight font-semibold text-white">
                Segui le lavorazioni in tempo reale
              </h2>
<p className="mt-4 text-base sm:text-lg text-zinc-400 max-w-xl">
                Indicatori visivi per ogni riparazione o creazione su misura.
                Aggiorna i clienti automaticamente sullo stato dei loro
                gioielli.
              </p>
<div className="mt-7">
<div className="relative inline-block group text-sm rounded-full">
...
<h2 className="mt-6 text-3xl sm:text-5xl tracking-tight font-semibold text-white">
                Analisi Performance Store
              </h2>
<p className="mt-4 text-base sm:text-lg text-zinc-400 max-w-xl">
                Visualizza il flusso dei clienti e delle vendite. Ottimizza lo
                stock e il personale per massimizzare i profitti.
              </p>
<div className="mt-7">
<div className="relative inline-block group text-sm rounded-full">
<button className="group relative inline-flex min-w-[120px] cursor-pointer transition-all duration-[1000ms] ease-[cubic-bezier(0.15,0.83,0.66,1)] hover:-translate-y-[3px] hover:scale-[1.1] hover:text-white text-xs font-semibold text-white/70 tracking-tight rounded-full pt-[12px] pr-[17px] pb-[12px] pl-[17px] items-center justify-center" style={{boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.1)', background: 'radial-gradient(ellipse at bottom,rgba(55,55,55,1) 0%,rgba(0,0,0,1) 100%)'}}>
...
<p className="text-lg text-zinc-400">
                Attività che crescono velocemente con Gioiello.ai ogni giorno
              </p>
</div>
...
<div className="text-sm text-zinc-400">Gioiellieri</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 bg-gradient-to-br from-white to-zinc-300 bg-clip-text text-transparent">
                  8.2M
                </div>
<div className="text-sm text-zinc-400">Clienti gestiti</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 bg-gradient-to-br from-white to-zinc-300 bg-clip-text text-transparent">
                  99.99%
                </div>
<div className="text-sm text-zinc-400">Precisione Inv.</div>
</div>
<div className="text-center">
<div className="text-4xl md:text-5xl font-semibold tracking-tight mb-2 bg-gradient-to-br from-white to-zinc-300 bg-clip-text text-transparent">
                  180+
                </div>
<div className="text-sm text-zinc-400">Città</div>
</div>
</div>
</div>
</div>
...
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ebf98776-9b0f-49cd-a030-c0ce87f6abe5_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                        Alex
...
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4618126b-8a10-4e68-ab3d-91fcf5fea504_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                        Casey
...
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1539de7e-4610-498e-924c-f475f92a9a74_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                        Morgan
...
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8af5e860-0834-42ee-9c28-7a688c9c1907_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                        Quinn
...
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d6224ed7-9233-425c-968a-2fb3fa272849_3840w.webp"/>
<div className="min-w-0">
<div className="text-sm font-medium truncate text-white">
                        Maya
                        <span className="text-fuchsia-300">Rodriguez</span>
...
<div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 flex-1 flex items-center">
<p className="text-sm text-white leading-relaxed">
                  "L'automazione dell'inventario ci ha fatto risparmiare 15 ore
                  a settimana. Semplicemente rivoluzionario."
                </p>
</div>
<div className="mt-auto pt-4 flex items-center gap-3">
<img alt="" className="h-9 w-9 rounded-full object-cover flex-shrink-0 ring-2 ring-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8996ab12-550b-417f-859c-e60383fc6ce0_3840w.webp"/>
...
<section className="sm:pt-16 sm:pb-20 md:pt-20 md:pb-24 lg:pt-24 lg:pb-32 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0bcb241d-7f62-4899-8da0-434927914200_3840w.webp)] bg-cover mt-44 mb-24 pt-12 pb-16 relative" style={{maskImage: 'linear-gradient(180deg, transparent, black 50%, black 50%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 50%, black 50%, transparent)'}}>
<div className="mx-auto max-w-7xl px-6 lg:px-8">
...
<h2 className="sm:text-5xl md:text-6xl text-4xl font-semibold tracking-tight mb-6">
              Pronto a modernizzare la tua gioielleria?
            </h2>
<p className="sm:text-xl text-lg text-zinc-50 max-w-2xl mb-10">
              Unisciti a migliaia di orafi che usano l'automazione intelligente
            </p>
...
<span className="text-base font-medium z-10 rounded-full relative">
                    Contattaci
                  </span>
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4">Prodotto</h3>
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4">Azienda</h3>
<ul className="space-y-3 text-sm text-zinc-400">
<li>
<a className="hover:text-white transition-colors" href="#">
                  Chi siamo
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4">Risorse</h3>
<ul className="space-y-3 text-sm text-zinc-400">
<li className="">
<a className="hover:text-white transition-colors" href="#">
                  Documentazione
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4">Legale</h3>
<ul className="space-y-3 text-sm text-zinc-400">
<li>
<a className="hover:text-white transition-colors" href="#">
                  Privacy
...
<div className="flex items-center gap-2">
<a className="inline-flex items-center justify-center bg-center w-[120px] h-[36px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/92f8c97d-c6ce-4088-95e1-67dfbfddffa0_1600w.png)] bg-cover rounded-full" href="#"></a>
</div>
<p className="text-sm text-zinc-500">
            © 2024 Gioiello.ai. Tutti i diritti riservati.
          </p>

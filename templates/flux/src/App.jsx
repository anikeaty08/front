...
<div className="aura-background-component top-0 w-full -z-10 absolute h-[800px] hue-rotate-90 brightness-125 opacity-40" data-alpha-mask="80" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}>
...
<nav className="sticky bg-[#0b0c15]/60 w-full z-50 border-white/5 border-b top-0 backdrop-blur-lg">
<div className="flex md:h-20 md:px-6 z-50 bg-transparent h-16 max-w-7xl mr-auto ml-auto pr-4 pl-4 relative items-center justify-between">

<div className="flex items-center gap-12">
<a className="inline-flex items-center justify-center bg-center transition-opacity hover:opacity-80 w-[120px] h-[30px] md:w-[140px] md:h-[36px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3b763a66-5dbf-4079-af7e-a616cc333698_320w.png)] bg-cover rounded-full" href="/home"></a>
<div className="hidden md:flex gap-8 uppercase text-xs font-medium text-slate-400 tracking-widest items-center">
<a className="hover:text-white transition-colors duration-200" href="/curriculum">
          Curriculum
        </a>
<a className="hover:text-white transition-colors duration-200" href="/workshops">
          Workshops
        </a>
<a className="hover:text-white transition-colors duration-200" href="/mentors">
          Mentors
        </a>
<a className="hover:text-white transition-colors duration-200" href="/community">
          Community
        </a>
</div>
</div>
...
<a className="hidden md:block uppercase hover:text-white transition-colors text-xs font-medium text-slate-400 tracking-widest" href="/login">
        Log In
      </a>

<button aria-label="Toggle Menu" className="text-white md:hidden p-2 -mr-2 hover:text-orange-400 transition-colors focus:outline-none group" id="mobile-menu-toggle">

<svg className="lucide lucide-menu block transition-all duration-300 group-hover:scale-110" fill="none" height="24" id="icon-menu" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<line x1="4" x2="20" y1="12" y2="12"></line>
<line x1="4" x2="20" y1="6" y2="6"></line>
<line x1="4" x2="20" y1="18" y2="18"></line>
</svg>

<svg className="lucide lucide-x hidden transition-all duration-300 rotate-90 scale-75 opacity-0 group-hover:scale-110" fill="none" height="24" id="icon-close" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="fixed hidden flex-col -translate-y-2 transition-all duration-300 ease-out md:top-20 md:hidden z-40 bg-[#000000] opacity-0 border-white/5 border-t top-16 right-0 bottom-0 left-0 backdrop-blur-xl" id="mobile-menu-overlay">
<div className="flex flex-col bg-[#000000] h-full pt-5 pb-5">
<nav className="flex flex-col bg-[#000000] pt-2 pr-5 pl-5">
<a className="mobile-nav-item flex items-center justify-between hover:text-white transition-all duration-500 ease-out text-lg font-medium text-slate-200 tracking-tight opacity-0 border-white/5 border-b py-3 translate-y-4" href="/curriculum">
          Curriculum
          <iconify-icon className="text-xl text-orange-500" icon="solar:arrow-right-linear"></iconify-icon>
</a>
<a className="mobile-nav-item flex items-center justify-between hover:text-white transition-all duration-500 ease-out text-lg font-medium text-slate-200 tracking-tight opacity-0 border-white/5 border-b py-3 translate-y-4" href="/workshops">
          Workshops
          <iconify-icon className="text-xl text-orange-500" icon="solar:arrow-right-linear"></iconify-icon>
</a>
<a className="mobile-nav-item flex items-center justify-between hover:text-white transition-all duration-500 ease-out text-lg font-medium text-slate-200 tracking-tight opacity-0 border-white/5 border-b py-3 translate-y-4" href="/mentors">
          Mentors
          <iconify-icon className="text-xl text-orange-500" icon="solar:arrow-right-linear"></iconify-icon>
</a>
<a className="mobile-nav-item flex items-center justify-between hover:text-white transition-all duration-500 ease-out text-lg font-medium text-slate-200 tracking-tight opacity-0 border-white/5 border-b py-3 translate-y-4" href="/community">
          Community
          <iconify-icon className="text-xl text-orange-500" icon="solar:arrow-right-linear"></iconify-icon>
</a>
</nav>
<div className="mobile-nav-item transition-all duration-500 ease-out bg-[#000000] opacity-100 mt-auto pt-4 pr-5 pb-8 pl-5 translate-y-4" style={{maskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)'}}>
<a className="flex items-center justify-center w-full py-3 text-xs font-semibold uppercase tracking-widest bg-white text-black hover:bg-slate-200 transition-colors mb-6 rounded-full" href="/login">
          Log In
        </a>
<div className="flex items-center justify-center gap-8">
<a className="text-slate-500 hover:text-white transition-colors" href="#">
<svg className="lucide lucide-twitter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
</svg>
</a>
<a className="text-slate-500 hover:text-white transition-colors" href="#">
<svg className="lucide lucide-instagram" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<a className="text-slate-500 hover:text-white transition-colors" href="#">
<svg className="lucide lucide-linkedin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<header className="overflow-hidden z-10 border-white/5 border-b pt-20 pb-32 relative">

<div className="max-w-7xl mx-auto px-6 relative">
<div className="max-w-3xl">
<div className="flex items-center gap-3 mb-6">
<span className="inline-flex items-center justify-center w-2 h-2 rounded-full animate-pulse bg-orange-500"></span>
<span className="text-xs font-medium tracking-widest uppercase text-orange-300">
...
<div className="absolute top-1/2 -right-20 -translate-y-1/2 w-[600px] h-[600px] hidden lg:block">
...
<h3 className="text-xl font-medium text-white tracking-tight mb-1 transition-colors group-hover:text-orange-400" style={{}}>
            Foundations
          </h3>
...
<div className="relative p-8 bg-panel border-b-2 md:border-b-0 md:border-t-2 border-orange-500 md:border-t-orange-500">
<div className="absolute inset-0 bg-orange-500/5"></div>
<span className="relative text-xs font-medium uppercase tracking-widest mb-2 block text-orange-400">
            Module 04
          </span>
...
<div className="absolute bottom-10 left-10 text-9xl font-semibold text-white/5 select-none transition-all duration-500 ease-out transform" id="crs-num-v2">
              01
            </div>
</div>
...
<span className="text-xs font-medium uppercase tracking-widest mb-6 text-orange-400 block transition-all duration-300 ease-out transform" id="crs-sub">
            Module 01
          </span>
<h2 className="lg:text-5xl transition-all duration-300 ease-out min-h-[2.4em] transform text-4xl font-medium text-white tracking-tight mb-6" id="crs-title">
            Foundations of Topology
          </h2>
<p className="text-lg text-slate-400 mb-10 leading-relaxed font-light transition-all duration-300 ease-out min-h-[6em] transform" id="crs-desc">
...
<svg className="group-hover:translate-x-0.5 transition-transform w-[20px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="arrow-right-linear" height="1em" strokeWidth="2" style={{width: '20px', height: '16px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<section className="overflow-hidden bg-[#0B0C15] border-white/5 border-b pt-24 pb-24 relative">

<div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[500px] h-[500px] bg-orange-500/10 blur-[100px] rounded-full pointer-events-none"></div>
...
<div className="flex items-center gap-4 text-xs font-medium tracking-widest uppercase mb-2 text-orange-400">
...
<div className="flex group-hover:border-orange-500/50 group-hover:text-orange-400 transition-colors text-white bg-white/5 w-12 h-12 border-white/10 border rounded-full mb-6 items-center justify-center">
<svg className="" data-icon-set="solar" data-solar="box-minimalistic-bold-duotone" height="1em" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="z-20 flex flex-col h-full pt-10 pr-10 pb-10 pl-10 relative justify-between">
<div className="flex group-hover:border-orange-500/50 group-hover:text-orange-400 transition-colors text-white bg-white/5 w-12 h-12 border-white/10 border rounded-full mb-6 items-center justify-center">
<svg className="w-[24px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="users-group-rounded-bold-duotone" height="16" strokeWidth="2" style={{color: 'rgb(251, 146, 60)', width: '24px', height: '16px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<circle className="" cx="15" cy="6" fill="#fb923c" opacity=".4" r="3"></circle>
<ellipse cx="16" cy="17" fill="#fb923c" opacity=".4" rx="5" ry="3"></ellipse>
<circle cx="9.001" cy="6" fill="#fb923c" r="4"></circle>
...
<p className="text-xs uppercase tracking-widest mb-4 text-orange-400">
                Lead Art Director
              </p>
...
<button className="-mb-8.5 text-orange-400 border-orange-400 border-b-2 year-btn active-year" data-year="2024">
              2024
            </button>
...
<div className="flex transition-transform duration-500 ease-out gap-x-8 gap-y-8" id="showcase-carousel" style={{transform: 'translateX(0px)'}}>
...
<button className="px-3 py-1 rounded text-xs text-white shadow-lg bg-orange-600 shadow-orange-500/30" style={{}}>
                        Winner
                      </button>
</div>
</div>
...
<section className="overflow-hidden border-white/5 border-b pt-32 pb-32 relative">

<div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[500px] blur-[120px] rounded-full pointer-events-none mix-blend-screen bg-orange-900/10"></div>
<div className="z-10 max-w-7xl mr-auto ml-auto pr-6 pl-6 relative">
...
<span className="text-4xl font-medium text-white tracking-tight price-amount">
                  $49
                </span>
<span className="text-sm text-slate-500 font-medium price-period">
                  /mo
                </span>
</div>
</div>
...
<iconify-icon className="mt-0.5 text-lg shrink-0 text-orange-400" icon="solar:check-circle-bold"></iconify-icon>
...
<svg className="text-slate-600 mt-0.5 text-lg shrink-0" data-icon-set="solar" data-solar="close-circle-linear" height="1em" style={{}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="">
<span className="text-xs font-semibold tracking-widest uppercase mb-4 block text-orange-400">
                    Live Cohort
                  </span>
<div className="flex items-baseline gap-1 transition-opacity duration-300" id="price-card-2">
<span className="text-4xl font-medium text-white tracking-tight text-glow price-amount">
                      $99
                    </span>
<span className="text-sm text-slate-400 font-medium price-period">
                      /mo
                    </span>
</div>
</div>
<span className="text-white text-[10px] font-semibold uppercase tracking-widest px-2 py-1 rounded shadow-lg bg-orange-500 shadow-orange-500/20" style={{}}>
                  Popular
                </span>
</div>
<p className="text-sm mb-8 pb-8 border-b leading-relaxed text-orange-100/70 border-orange-500/20">
...
<button className="w-full py-4 text-white text-xs font-semibold uppercase tracking-widest transition-all duration-300 shadow-lg bg-orange-600 hover:bg-orange-500 shadow-orange-600/20 hover:shadow-orange-600/40" style={{}}>
                Secure Your Spot
              </button>
</div>
</div>
...
<li className="flex items-start gap-3 text-sm text-slate-300">
<iconify-icon className="mt-0.5 text-lg shrink-0 text-orange-400" icon="solar:check-circle-bold"></iconify-icon>
<span className="">Everything in Cohort</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-300">
<iconify-icon className="mt-0.5 text-lg shrink-0 text-orange-400" icon="solar:check-circle-bold"></iconify-icon>
...
<span className="text-lg font-bold font-serif text-white" style={{}}>
              Apple
            </span>
<span className="text-lg font-bold font-sans text-white tracking-tighter" style={{}}>
              Meta
            </span>
<span className="text-lg font-bold font-mono text-white" style={{}}>
              Netflix
            </span>
<span className="text-lg font-bold font-sans text-white italic" style={{}}>
              Nike
            </span>
<span className="text-lg font-bold font-sans text-white" style={{}}>
              Buck
            </span>
</div>
</div>
...
<h5 className="text-xs font-bold uppercase tracking-widest text-orange-400">
                Platform
              </h5>
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="#">
                Courses
              </a>
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="/workshops">
                Workshops
              </a>
<a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="#">
                Podcast
...
<input className="bg-white/5 border border-white/10 px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none transition-colors w-full focus:border-orange-500" placeholder="Enter your email" style={{}} type="email"/>
<button className="uppercase hover:bg-slate-800 hover:text-dark transition-all duration-300 group-hover:border-white text-xs font-semibold text-white tracking-widest w-full border-white/10 border pt-4 pb-4">
                  Subscribe
                </button>
</form>

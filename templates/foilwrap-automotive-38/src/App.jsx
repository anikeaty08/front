...
<div className="flex flex-col items-center justify-center text-center reveal-on-scroll py-6 md:py-0 in-view" style={{'--reveal-delay': '100ms'}}>
...
<div className="flex flex-col items-center justify-center text-center reveal-on-scroll py-6 md:py-0 in-view" style={{'--reveal-delay': '200ms'}}>
<h4 className="font-orbitron font-medium text-2xl text-white tracking-tight mb-2">
                Prémiové Materiály
              </h4>
<span className="text-xs font-inter uppercase tracking-widest text-zinc-500">
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block in-view" href="/ochranne-folie" style={{'--reveal-delay': '100ms'}}>
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block in-view" href="/tonovani-skel" style={{'--reveal-delay': '200ms'}}>
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block in-view" href="/interierove-folie" style={{'--reveal-delay': '100ms'}}>
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] lg:aspect-[5/4] reveal-on-scroll block in-view" href="/dechroming" style={{'--reveal-delay': '200ms'}}>
...
<a className="group relative overflow-hidden rounded-[2rem] aspect-[4/3] reveal-on-scroll block lg:aspect-[15/8] in-view" href="/reklamni-polepy" style={{'--reveal-delay': '100ms'}}>

...
<canvas className="particles-js-canvas-el" height="1726" style={{width: '100%', height: '100%'}} width="3426"></canvas></div></div>
...
<img alt="" className="pointer-events-none w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://2cc418.online-server.cloud/resources/images/laptop.jpg" style={{}}/>

<div className="absolute top-0 right-0 bottom-0 left-0" style={{}}></div>

<header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/40 backdrop-blur-md border-b border-white/10">
<div className="max-w-7xl mx-auto px-6 md:px-8 py-4 flex items-center justify-between">

<div className="flex items-center gap-8">
<a className="inline-flex items-center justify-center bg-center font-bold italic w-[190px] h-[36px]" href="#">Wellington</a>
<nav className="hidden md:flex items-center gap-6">
<a className="text-sm font-medium text-white/80 hover:text-white transition" href="/#solutions">
          Solutions
        </a>
<a className="text-sm font-medium text-white/80 hover:text-white transition" href="/#showcase">
          Showcase
        </a>
<a className="text-sm font-medium text-white/80 hover:text-white transition" href="/#resources">
          Resources
        </a>
</nav>
</div>
...
<a className="hidden sm:inline-flex text-sm font-medium text-white/80 hover:text-white transition" href="/#start">
        Get Started
      </a>
<a className="inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-medium text-white border border-white/20 hover:border-white/40 transition" href="#">
        Contact
      </a>
</div>
</div>

<div className="pointer-events-none absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-b from-transparent to-slate-950/40"></div>
</header>

<main className="flex h-[calc(100vh-80px)] bg-center -translate-y-16 z-10 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f3fc3a11-daf9-462b-893c-2008f3b30990_3840w.jpg)] bg-cover relative items-end">
<section className="-translate-y-16 md:pl-6 w-full max-w-7xl mr-auto ml-auto pr-6 pb-12 pl-6 translate-x-1 scale-105">

<div className="mb-12 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
<h1 className="leading-tight sm:text-5xl md:text-5xl lg:text-6xl text-4xl tracking-tight font-geist w-full max-w-none">
<span className="block md:whitespace-nowrap font-extrabold text-white font-geist text-center translate-y-16">
    Una nueva forma de aprender inglés
  </span>
<span className="block font-light italic text-[#f35c57] text-center translate-y-16">
    Enfoque interactivo IA conversacional
  </span>
</h1>
...
<section className="overflow-hidden lg:py-20 bg-center bg-[#33234a] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7e74635a-873c-47ca-8844-ddc487749573_3840w.jpg)] bg-cover pt-8 pb-8 relative" id="solutions">
...
<div className="flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.1s_both] md:p-6 bg-stone-950 h-full ring-stone-950/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md">
...
<div className="overflow-hidden md:p-4 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.2s_both] bg-stone-950 h-full ring-stone-950/10 ring-1 rounded-3xl pt-3 pr-3 pb-3 pl-3 relative backdrop-blur-md">
...
<div className="md:px-1 pt-4 pr-2 pl-2 relative">
...
<div className="md:p-6 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.3s_both] bg-stone-950 h-full ring-stone-950/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md">
...
<div className="">
<p className="md:text-lg leading-relaxed text-base text-slate-300 font-geist">
                With a <span className="text-orange-300 font-normal">75%</span> project success rate,
                we help teams ship reliable AI to production.
              </p>

<div className="mt-5 space-y-3">

<div className="relative h-5 rounded-full bg-white/5 ring-1 ring-white/10 overflow-hidden">
<div className="absolute inset-y-0 left-0 bg-orange-400/80" style={{width: '63%'}}></div>
...
<div className="">
<p className="text-xs text-slate-400 font-geist">Succeeded</p>
<div className="text-2xl md:text-3xl font-normal tracking-tighter font-geist text-slate-300">63%</div>
</div>
<div>
<p className="text-xs text-slate-400 font-geist">In progress</p>
<div className="text-2xl md:text-3xl font-normal tracking-tighter font-geist text-slate-300">24%</div>
</div>
<div className="">
<p className="text-xs text-slate-400 font-geist">Failed</p>
<div className="text-2xl md:text-3xl font-normal tracking-tighter font-geist text-slate-300">13%</div>
</div>
</div>
...
<div className="md:p-6 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.35s_both] bg-stone-950 h-full ring-stone-950/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md">
<div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 text-xs font-medium text-white/80 ring-1 ring-white/10 font-geist w-fit">
...
<div className="md:p-6 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.4s_both] bg-stone-950 h-full ring-stone-950/10 ring-1 rounded-3xl pt-5 pr-5 pb-5 pl-5 backdrop-blur-md">
<div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 text-xs font-medium text-white/80 ring-1 ring-white/10 font-geist w-fit">
...
<div className="rounded-3xl bg-stone-950 h-full ring-stone-950/10 ring-1 backdrop-blur-md p-5 md:p-6 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.45s_both]">
...
<div className="">
<div className="text-4xl md:text-5xl font-normal tracking-tighter font-geist">
                120ms
              </div>

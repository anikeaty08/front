...
<div className="relative w-full h-screen overflow-hidden bg-transparent hero-container">
...
<p className="max-w-md text-white/60 text-sm sm:text-base font-mono leading-relaxed mt-4">
            Discover the next generation of proprietary trading. Pass the
            evaluation, get funded, and keep up to 90% of your profits.
          </p>
<div className="mt-6 flex flex-col sm:flex-row items-center gap-4 pointer-events-auto">
<button className="h-12 px-8 rounded bg-blue-600 text-white text-sm font-semibold hover:bg-blue-500 transition-all shadow-[0_0_30px_rgba(37,99,235,0.4)] flex items-center gap-2 hover:scale-105 active:scale-95 duration-200">
              Start Challenge
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24">
<path d="m9 18 6-6-6-6"></path>
</svg>
</button>
<button className="h-12 px-8 rounded border border-white/20 text-white text-sm font-medium hover:bg-white/10 transition-all backdrop-blur-sm">
              Compare Platforms
            </button>
</div>
</div>
...
<h2 className="font-mono text-3xl sm:text-4xl text-stone-400 leading-tight tracking-tight max-w-sm group-hover:text-stone-800 transition-colors duration-500">
              Precision Trading, Institutional Capital.
            </h2>
</div>
...
<p className="font-mono text-xs text-stone-500 leading-relaxed max-w-[200px]">
                FundedX is the ultimate ecosystem for retail traders. We've
                dismantled the barriers of undercapitalization to build a prop
                firm that actually wants you to succeed.
              </p>
</div>
...
<p className="font-mono text-xs sm:text-sm text-stone-400 leading-7">
            Instant account deployment. Institutional-grade spreads. From raw
            zero-pip execution to rapid bi-weekly payouts, FundedX provides the
            definitive trading environment.
          </p>
...
<span className="mr-2">Get Funded</span>
...
<path d="M100 130L30 90L100 50L170 90L100 130Z" fill="#0B0C0E" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5"></path>
...
<path className="animate-[pulse_2s_ease-in-out_infinite]" d="M85 75L115 75" stroke="#fbbf24" strokeLinecap="round" strokeWidth="1.5" transform="rotate(-5 100 75) translate(0 -10)"></path>
<path className="animate-[pulse_2.5s_ease-in-out_infinite]" d="M75 85L125 85" stroke="rgba(255,255,255,0.3)" strokeLinecap="round" strokeWidth="1.5" transform="rotate(-5 100 85) translate(0 -10)"></path>
<path className="animate-[pulse_3s_ease-in-out_infinite]" d="M80 95L120 95" stroke="rgba(255,255,255,0.3)" strokeLinecap="round" strokeWidth="1.5" transform="rotate(-5 100 95) translate(0 -10)"></path>
</svg>
</div>
<div className="">
...
<p className="text-base text-[#8A8F98] leading-relaxed">
                  Keep the lion's share of your earnings. We believe in
                  rewarding consistent, profitable traders.
                </p>
</div>
</div>
...
<div className="mb-10 flex h-32 items-center justify-center opacity-80 group-hover:opacity-100 transition-opacity">
<svg className="transition-transform duration-500 group-hover:-translate-y-2" fill="none" height="120" viewbox="0 0 200 150" width="160" xmlns="http://www.w3.org/2000/svg">
<path d="M70 100L40 85L70 70L100 85L70 100Z" fill="#0B0C0E" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5"></path>
...
<g className="animate-[spin_4s_linear_infinite]" style={{transformOrigin: '105px 75px'}}>
...
<p className="text-base text-[#8A8F98] leading-relaxed">
                  Trade at your own pace. There are no minimum or maximum
                  trading days on your evaluation phase.
                </p>
</div>
</div>
...
<g className="animate-[bounce_3s_infinite] -translate-y-4">
...
<path d="M100 40L160 70L100 100" fill="none" stroke="rgba(245,158,11,0.5)" strokeWidth="1.5"></path>
</g>
</svg>
</div>
<div className="">
...
<path d="M100 85L100 95" stroke="#fbbf24" strokeLinecap="round" strokeWidth="3"></path>
</g>
...
<path d="M70 90V110L100 125V105L70 90Z" fill="#131418" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5"></path>
<path d="M130 90V110L100 125V105L130 90Z" fill="#0F1014" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5"></path>
<circle className="animate-[ping_2s_ease-in-out_infinite] origin-center" cx="100" cy="90" fill="rgba(245,158,11,0.3)" r="10" stroke="#fbbf24" strokeWidth="1.5" transform="scale(1, 0.5)"></circle>
</svg>
</div>
<div className="">
<h3 className="text-xs font-mono font-semibold uppercase tracking-widest text-amber-500 mb-3">
...
<section className="bg-[#050505] w-full border-t border-white/5 pt-24 pb-24 relative z-20 overflow-hidden">
<div className="absolute top-12 left-1/2 -translate-x-1/2 font-mono text-[10px] text-white/20 tracking-widest uppercase">
          04 — The Path
        </div>
<div className="absolute inset-0 w-full max-w-[1400px] mx-auto pointer-events-none z-0 hidden lg:block">
...
<h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-white tracking-tight leading-[1.05] mb-6 drop-shadow-lg">
              From Retail to Institutional.
            </h2>
<p className="text-lg text-[#8A8F98] leading-relaxed">
              A streamlined, objective-based evaluation. Prove your edge and
              scale your capital instantly.
            </p>
</div>
<div className="relative max-w-4xl mx-auto">
<div className="absolute top-0 bottom-0 left-[28px] md:left-1/2 w-px bg-gradient-to-b from-amber-500/50 via-white/10 to-transparent -translate-x-1/2"></div>
...
<p className="text-[#8A8F98]">
                  Trade our simulated environment with strict risk management.
                  Hit the 8% profit target while respecting the 5% daily
                  drawdown limit.
                </p>
</div>
<div className="absolute left-0 md:left-1/2 w-14 h-14 bg-[#050505] border border-white/10 rounded-full flex items-center justify-center -translate-x-1/2 shadow-[0_0_20px_rgba(245,158,11,0.1)] group-hover:border-amber-500/50 transition-colors">
<span className="font-mono text-amber-500">01</span>
</div>
<div className="md:w-1/2 md:pl-12 hidden md:block">
<div className="w-full h-32 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center relative overflow-hidden group-hover:bg-white/[0.07] transition-colors">
<div className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-500/10 to-transparent -translate-x-full group-hover:animate-[scan_2s_ease-in-out_infinite]"></div>
<span className="font-mono text-[10px] text-white/40 uppercase tracking-widest">
                    Target: 8%
                  </span>
</div>
...
<p className="text-[#8A8F98]">
                  Demonstrate consistency. A lower 5% profit target with the
                  same drawdown parameters to prove your edge wasn't a fluke.
                </p>
</div>
</div>
...
<p className="text-[#8A8F98]">
                  Receive your live funded account up to $200,000. Keep up to
                  90% of your profits and scale your capital up to $2,000,000.
                </p>
</div>
<div className="absolute left-0 md:left-1/2 w-14 h-14 bg-[#050505] border border-amber-500/30 rounded-full flex items-center justify-center -translate-x-1/2 shadow-[0_0_30px_rgba(245,158,11,0.2)] group-hover:border-amber-500 transition-colors">
<div className="w-3 h-3 bg-amber-500 rounded-full animate-pulse"></div>
</div>
<div className="md:w-1/2 md:pl-12 hidden md:block">
<div className="w-full h-32 bg-amber-500/5 border border-amber-500/20 rounded-lg flex items-center justify-center relative overflow-hidden group-hover:bg-amber-500/10 transition-colors shadow-[inset_0_0_20px_rgba(245,158,11,0.05)]">
...
<section className="bg-[#08090A] w-full border-t border-white/5 pt-24 pb-24 relative z-10 text-white">
<div className="absolute top-12 left-1/2 -translate-x-1/2 font-mono text-[10px] text-white/20 tracking-widest uppercase">
          05 — Evaluations
        </div>
<div className="absolute inset-0 w-full max-w-[1400px] mx-auto pointer-events-none z-0 hidden lg:block">
...
<div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
<div className="max-w-3xl mb-20 text-center mx-auto">
<h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-[#F2F2F3] tracking-tight leading-[1.05] mb-6">
              Choose your challenge.
            </h2>
<p className="text-lg text-[#8A8F98] max-w-xl mx-auto leading-relaxed">
              Select an evaluation size that fits your trading style. Simple
              rules, transparent objectives, and no hidden fees.
            </p>
</div>
<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0 bg-[#0B0C0E] border border-white/5 rounded-2xl overflow-hidden shadow-2xl">
<div className="p-8 lg:p-12 lg:border-r border-white/5 flex flex-col h-full relative group hover:bg-white/[0.02] transition-colors">
<div className="mb-8">
<div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-white/5 border border-white/10 mb-6">
<span className="w-1.5 h-1.5 rounded-full bg-white/30"></span>
<span className="text-[10px] font-mono uppercase tracking-wide text-white/60">
                    Starter
                  </span>
</div>
...
<p className="text-[#8A8F98] text-sm leading-6">
                  10K Account. Perfect for testing your strategy.
                </p>
</div>
<div className="space-y-4 mb-8 flex-1">
<div className="flex items-start gap-3">
<svg className="w-4 h-4 text-white/60 mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24">
...
<span className="text-sm text-white/80">5% Max Daily Loss</span>
</div>
<div className="flex items-start gap-3">
<svg className="w-4 h-4 text-white/60 mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24">
<path d="M20 6 9 17l-5-5"></path>
</svg>
<span className="text-sm text-white/80">10% Max Total Loss</span>
</div>
</div>
<button className="w-full py-3 px-4 rounded border border-white/10 text-white text-sm font-medium bg-transparent hover:bg-white/5 hover:border-white/20 transition-all text-left flex justify-between items-center group-hover:border-white/30">
                Start Challenge
...
<div className="p-8 lg:p-12 lg:border-r border-white/5 flex flex-col h-full relative group bg-white/[0.02]">
...
<div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
<span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse shadow-[0_0_8px_rgba(245,158,11,0.8)]"></span>
<span className="text-[10px] font-mono uppercase tracking-wide text-amber-500">
                    Popular
                  </span>
</div>
<div className="flex items-baseline gap-1 mb-2">
...
<p className="text-[#8A8F98] text-sm leading-6">
                  50K Account. Our most balanced funding tier.
                </p>
</div>
<div className="space-y-4 mb-8 flex-1 relative z-10">
<div className="flex items-start gap-3">
<svg className="w-4 h-4 text-amber-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24">
<path d="M20 6 9 17l-5-5"></path>
</svg>
...
<span className="text-sm text-white/80">1:100 Leverage</span>
</div>
</div>
<button className="w-full py-3 px-4 rounded bg-amber-500 text-[#050505] text-sm font-semibold hover:bg-amber-400 transition-all text-left flex justify-between items-center shadow-[0_0_20px_rgba(245,158,11,0.3)] relative z-10 hover:scale-[1.02]">
                Start Challenge
                <span>→</span>
</button>
</div>
<div className="p-8 lg:p-12 flex flex-col h-full relative group hover:bg-white/[0.02] transition-colors">
<div className="mb-8">
<div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
<span className="w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.6)]"></span>
<span className="text-[10px] font-mono uppercase tracking-wide text-blue-500">
                    Pro
                  </span>
</div>
<div className="flex items-baseline gap-1 mb-2">
...
<p className="text-[#8A8F98] text-sm leading-6">
                  100K Account. For serious, experienced traders.
                </p>
</div>
<div className="space-y-4 mb-8 flex-1">
<div className="flex items-start gap-3">
...
<span className="text-sm text-white/80">Bi-weekly Payouts</span>
</div>
</div>
<button className="w-full py-3 px-4 rounded border border-white/10 text-white text-sm font-medium bg-transparent hover:bg-white/5 hover:border-white/20 transition-all text-left flex justify-between items-center group-hover:border-white/30">
                Start Challenge
...
<div className="w-8 h-8 rounded-full border-2 border-[#08090A] bg-stone-800 flex items-center justify-center overflow-hidden">
...
<p className="text-sm text-white/50">
                Trusted by 50,000+ funded traders.
              </p>
</div>
<a className="text-sm font-medium text-white/80 border-b border-white/20 hover:border-white hover:text-white transition-colors pb-0.5" href="#">
              View Full Trading Rules
            </a>
</div>
</div>
</section>
<section className="bg-[#050505] w-full border-t border-white/5 pt-24 pb-24 relative z-10 text-white overflow-hidden">
<div className="absolute top-12 left-1/2 -translate-x-1/2 font-mono text-[10px] text-white/20 tracking-widest uppercase">
          06 — Ecosystem
        </div>
<div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[400px] h-[400px] bg-amber-500/5 rounded-full blur-[120px] pointer-events-none"></div>
<div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[400px] h-[400px] bg-emerald-500/5 rounded-full blur-[120px] pointer-events-none"></div>
<div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
...
<p className="text-lg text-[#8A8F98] leading-relaxed">
                Our infrastructure connects seamlessly with the industry's most
                powerful platforms. No latency, no excuses.
              </p>
</div>
<button className="px-6 py-3 rounded border border-white/10 text-white text-sm font-medium hover:bg-white/5 transition-all whitespace-nowrap">
              Compare Platforms
            </button>
</div>
<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
<div className="bg-[#0B0C0E] border border-white/5 rounded-xl p-8 hover:bg-white/[0.02] hover:border-white/10 transition-all flex flex-col justify-between aspect-square group relative overflow-hidden">
<div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center text-white relative z-10">
...
<p className="text-sm text-[#8A8F98]">The industry standard</p>
</div>
</div>
<div className="bg-[#0B0C0E] border border-white/5 rounded-xl p-8 hover:bg-white/[0.02] hover:border-white/10 transition-all flex flex-col justify-between aspect-square group relative overflow-hidden">
...
<p className="text-sm text-[#8A8F98]">Advanced analytics</p>
</div>
</div>
<div className="bg-[#0B0C0E] border border-white/5 rounded-xl p-8 hover:bg-white/[0.02] hover:border-white/10 transition-all flex flex-col justify-between aspect-square group relative overflow-hidden">
...
<div className="relative z-10">
<h3 className="text-lg font-medium text-white mb-1">cTrader</h3>
<p className="text-sm text-[#8A8F98]">Premium execution</p>
</div>
</div>
<div className="bg-[#0B0C0E] border border-white/5 rounded-xl p-8 hover:bg-white/[0.02] hover:border-white/10 transition-all flex flex-col justify-between aspect-square group relative overflow-hidden">
<div className="absolute inset-0 bg-gradient-to-br from-stone-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center text-white relative z-10">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="relative z-10">
<h3 className="text-lg font-medium text-white mb-1">TradingView</h3>
<p className="text-sm text-[#8A8F98]">Direct chart trading</p>
</div>
</div>
</div>
</div>
</section>
<section className="bg-[#08090A] w-full border-t border-white/5 pt-24 pb-32 relative z-10 overflow-hidden">
<div className="absolute top-12 left-1/2 -translate-x-1/2 font-mono text-[10px] text-white/20 tracking-widest uppercase">
          07 — Elite Collective
        </div>
<div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
...
<p className="text-lg text-[#8A8F98]">
              Join a network of professional operators who have already scaled
              their capital with FundedX.
            </p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="bg-[#0B0C0E] border border-white/5 rounded-2xl p-8 relative">
...
<p className="text-white/80 leading-relaxed mb-8">
                "The raw spreads are actually raw. Slippage is virtually
                non-existent even during high-impact news events. Easiest 100k
                account I've scaled."
              </p>
<div className="flex items-center gap-4">
<div className="w-10 h-10 rounded-full bg-white/10 overflow-hidden grayscale">
<img alt="User" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&amp;q=80"/>
</div>
<div>
<div className="text-sm font-medium text-white">Michael T.</div>
...
<p className="text-white/80 leading-relaxed mb-8">
                "Got my payout exactly 14 days after my first live trade. The
                dashboard is clean, rules are simple, and support answers in
                minutes."
              </p>
<div className="flex items-center gap-4">
<div className="w-10 h-10 rounded-full bg-white/10 overflow-hidden grayscale">
<img alt="User" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&amp;q=80"/>
</div>
<div>
...
<p className="text-white/80 leading-relaxed mb-8">
                "Finally a firm that doesn't hunt your stop loss. Trade
                execution is identical to my personal A-book broker. Exceptional
                environment."
              </p>
<div className="flex items-center gap-4">
<div className="w-10 h-10 rounded-full bg-white/10 overflow-hidden grayscale">
<img alt="User" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&amp;q=80"/>
</div>
<div>
...
<section className="bg-[#050505] w-full border-t border-white/5 py-32 relative overflow-hidden text-white">
<div className="absolute inset-0 z-0 opacity-20" style={{backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(37, 99, 235, 0.2), transparent 60%)'}}></div>
<div className="absolute inset-0 z-0 opacity-[0.03]" style={{backgroundImage: 'linear-gradient(rgba(255,255,255,1) 1px, transparent 1px), linear-gradient(to right, rgba(255,255,255,1) 1px, transparent 1px)', backgroundSize: '40px 40px'}}></div>
<div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
<div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 text-blue-500 mb-8 shadow-[0_0_30px_rgba(37,99,235,0.25)]">
...
<h2 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-white tracking-tighter leading-none mb-8 drop-shadow-lg">
            Ready to deploy
...
<p className="text-lg md:text-xl text-[#8A8F98] mb-12 max-w-xl mx-auto leading-relaxed">
            Step into the next generation of prop trading. Prove your edge and
            access up to $2,000,000 in simulated funding.
          </p>
<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
<button className="h-14 px-10 rounded bg-blue-600 text-white font-semibold hover:bg-blue-500 transition-all shadow-[0_0_30px_rgba(37,99,235,0.4)] flex items-center gap-2 hover:scale-105 active:scale-95 duration-200">
<span>Start Evaluation</span>
<svg className="w-4 h-4" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24">
<path d="m9 18 6-6-6-6"></path>
</svg>
</button>
<button className="h-14 px-10 rounded border border-white/10 text-white font-medium hover:bg-white/5 transition-all backdrop-blur-sm">
              Join Discord
            </button>
</div>
</div>
...
<p className="text-sm leading-7 text-[#8A8F98] max-w-xs mb-8">
                The next generation proprietary trading firm. Empowering traders
                worldwide with institutional capital.
              </p>
<div className="flex items-center gap-4">

...
<img alt="Block Blast logo" className="object-auto bg-center w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/81433cb5-ff81-46f0-bf59-11cf46868389_800w.png"/>
</div>
<h1 className="flex flex-col items-center text-center w-full max-w-4xl mr-auto mb-10 ml-auto" style={{textWrap: 'balance'}}>
<span className="block leading-[1.1] sm:text-4xl md:text-5xl lg:text-6xl xl:text-[4rem] text-4xl font-semibold text-white tracking-tight pt-3 pb-3">The ORGANIC feed runs 24/7. Funplus isn't in it.</span>
...
<p className="leading-relaxed md:text-2xl text-base font-medium text-gray-300 text-center w-full max-w-2xl mr-auto ml-auto" style={{textWrap: 'balance'}}>Your users watch 300+ organic videos a day. None of them are from Funplus. We change that.</p>
</div>
...
<video autoplay="" className="z-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1775561452/AQNwFe_bAjd6Dy0lZ-pHJ8Wp4tOhvkGLN74sUtwBREo5xa6KT4qJU4us_YgEB1GonU-O9mCOhoibUZpfV5EoHctk_f4fy5z.mp4"></video>
...
<div className="relative w-full h-1/2 bg-black">
<video autoplay="" className="absolute inset-0 w-full h-full object-cover z-0" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1775561579/202603141815_mroihv.mp4"></video>
...
<h2 className="md:text-4xl text-2xl font-medium text-white tracking-tight mb-3">What State Of Survival looks like in the feed.</h2>
</div>
...
<video autoplay="" className="z-0 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" loading="lazy" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1775561579/202603141815_mroihv.mp4"></video>
...
<h2 className="md:text-4xl text-3xl font-semibold text-white tracking-tight mb-6">Funplus players are scrolling right now.</h2>
...
<div className="uppercase text-base text-white tracking-widest">are from State Of Survival</div>
</div>
<div className="glass-panel rounded-xl p-6 min-w-[180px] flex-1">
<div className="text-4xl font-semibold text-white tracking-tight mb-2">
              80%
...
<p className="text-base font-medium text-slate-400 text-center mt-12">We show data. Book 15 minutes and we walk you through Funplus on the organic feed.</p>
</div>
</section>
...
<p className="md:text-xl text-lg font-normal text-white">15 minutes. We show you what Funplus looks like in the organic feed.</p>

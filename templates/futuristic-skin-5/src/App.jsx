...
<span className="font-serif italic text-lg relative z-10">K</span>
</div>
<div className="flex flex-col">
<span className="text-xs tracking-[0.25em] font-bold text-qms-blue uppercase">Kat Walkowiak</span>
...
<span className="absolute inset-0 opacity-0 group-hover:opacity-100 text-qms-blue transition-opacity flex items-center justify-center font-mono">&lt;Vision&gt;</span>
</a>
...
<div className="absolute inset-0 bg-[linear-gradient(rgba(15,30,54,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(15,30,54,0.03)_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_at_center,black,transparent_80%)]"></div>
</div>
...
<iconify-icon icon="simple-icons:vogue" width="50"></iconify-icon>
<span className="font-bold text-lg tracking-tighter">QMS</span>
...
<div className="glass-tech p-8 group hover:-translate-y-2 transition-all duration-500 rounded-sm relative overflow-hidden reveal-on-scroll delay-100">
...
<div className="glass-tech p-8 group hover:-translate-y-2 transition-all duration-500 rounded-sm relative overflow-hidden reveal-on-scroll delay-200">
<div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-tech-cyan to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
<div className="flex justify-between items-start mb-8">
...
<div className="glass-tech p-8 group hover:-translate-y-2 transition-all duration-500 rounded-sm relative overflow-hidden reveal-on-scroll delay-300">
<div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-tech-cyan to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
<div className="flex justify-between items-start mb-8">
...
<div className="group relative bg-white border border-white/50 hover:border-tech-cyan/50 p-8 shadow-sm hover:shadow-glow-blue transition-all duration-300 rounded-sm overflow-hidden reveal-on-scroll delay-100 cursor-pointer">
...
<div className="group relative bg-white border border-white/50 hover:border-tech-cyan/50 p-8 shadow-sm hover:shadow-glow-blue transition-all duration-300 rounded-sm overflow-hidden reveal-on-scroll delay-200 cursor-pointer">
<div className="absolute inset-0 bg-gradient-to-b from-transparent via-tech-cyan/5 to-transparent translate-y-[-100%] group-hover:animate-scan"></div>
<div className="flex flex-col md:flex-row justify-between relative z-10">
<div className="flex-1">
<div className="flex items-center gap-4 mb-2">
...
<div className="group relative bg-white border border-white/50 hover:border-tech-cyan/50 p-8 shadow-sm hover:shadow-glow-blue transition-all duration-300 rounded-sm overflow-hidden reveal-on-scroll delay-300 cursor-pointer">
<div className="absolute inset-0 bg-gradient-to-b from-transparent via-tech-cyan/5 to-transparent translate-y-[-100%] group-hover:animate-scan"></div>
<div className="flex flex-col md:flex-row justify-between relative z-10">
<div className="flex-1">
<div className="flex items-center gap-4 mb-2">
...
<span>Advanced Digital Analysis Included</span>
</div>
<div className="flex items-center gap-4 text-xs font-mono text-slate-400">
<iconify-icon className="text-tech-cyan" icon="lucide:check-circle"></iconify-icon>
<span>Customized QMS Product Prescription</span>
</div>
<div className="flex items-center gap-4 text-xs font-mono text-slate-400">
<iconify-icon className="text-tech-cyan" icon="lucide:check-circle"></iconify-icon>
<span>Long-term Treatment Roadmap</span>
</div>
</div>
</div>
...
<p className="font-serif text-3xl tracking-wide mb-2 text-white">Kat Walkowiak</p>

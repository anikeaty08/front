...
<span className="text-sm font-semibold text-white tracking-tight font-display">Instagram Slides</span>
</div>
...
<div className="w-1.5 h-1.5 rounded-full bg-white cursor-pointer hover:scale-125 transition-transform" data-index="4"></div>
...
<div className="w-1.5 h-1.5 rounded-full bg-white/20 hover:bg-white/50 cursor-pointer transition-colors hover:scale-125 transition-transform" data-index="7"></div>
</div>

<div className="hidden md:flex w-1/3 gap-x-2 gap-y-2 items-center justify-end">
...
<svg className="lucide lucide-arrow-right w-[24px] h-[20px]" data-icon-replaced="true" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(255, 255, 255)', width: '24px', height: '20px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path className="" d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
...
<div className="flex flex-col bg-center md:p-10 z-10 h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/78a7f95a-822a-4dff-a244-82e426de4587_1600w.jpg?w=800&amp;q=80)] bg-cover pt-6 pr-6 pb-6 pl-6 relative">
...
<h1 className="leading-[0.9] [animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll animate md:text-7xl md:mb-8 text-5xl tracking-tighter font-space-grotesk mb-4">Creative AI <span className="block text-white/60 tracking-tighter font-space-grotesk">Animations</span></h1>
...
<div className="flex-grow md:space-y-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/78a7f95a-822a-4dff-a244-82e426de4587_1600w.jpg)] bg-cover bg-center space-y-6">

<div className="overflow-hidden [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll animate md:p-8 bg-gradient-to-b from-white/30 to-white/0 rounded-lg pt-6 pr-6 pb-6 pl-6 relative shadow-inner backdrop-blur-xl" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '8px'}}>
...
<div className="animate-pulse delay-75 md:h-32 bg-gradient-to-b from-white/10 to-white/0 w-full h-24 rounded backdrop-blur-lg" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '4px'}}></div>
...
<div className="flex flex-col bg-center md:p-10 h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/83b6dc45-6d15-4020-8469-4c8e695a4a88_1600w.jpg)] bg-cover pt-6 pr-6 pb-6 pl-6">
<header className="flex justify-between items-center mb-6 md:mb-10 [animation:animationIn_0.8s_ease-out_0.1s_both] animate-on-scroll">
...
<div className="flex-grow flex flex-col bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/78a7f95a-822a-4dff-a244-82e426de4587_1600w.jpg)] bg-cover bg-center justify-center">

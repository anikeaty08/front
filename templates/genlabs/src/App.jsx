...
<div className="flex text-white bg-gradient-to-b from-black/60 to-black/20 w-8 h-8 rounded-full items-center justify-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.1))', '--border-radius-before': '9999px'}}>
<svg aria-hidden="true" className="lucide lucide-layers w-[16px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="link-circle-bold-duotone" fill="none" height="16" role="img" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.5" style={{width: '16px', height: '16px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M3.464 20.536C4.93 22 7.286 22 12 22s7.071 0 8.535-1.465C22 19.072 22 16.714 22 12s0-7.071-1.465-8.536C19.072 2 16.714 2 12 2S4.929 2 3.464 3.464C2 4.93 2 7.286 2 12s0 7.071 1.464 8.535" fill="#ffffff" opacity=".5"></path>
<path d="M9.5 8.75A3.25 3.25 0 1 0 12.75 12a.75.75 0 0 1 1.5 0A4.75 4.75 0 1 1 9.5 7.25a.75.75 0 0 1 0 1.5" fill="#ffffff">
</path>
<path className="" d="M17.75 12a3.25 3.25 0 0 1-3.25 3.25a.75.75 0 0 0 0 1.5A4.75 4.75 0 1 0 9.75 12a.75.75 0 0 0 1.5 0a3.25 3.25 0 0 1 6.5 0" fill="#ffffff"></path>
</svg>
</div>
...
<a className="hover:text-zinc-900 transition-colors duration-300" href="#">Curriculum</a>
<a className="hover:text-zinc-900 transition-colors duration-300" href="#">Pricing</a>
<a className="hover:text-zinc-900 transition-colors duration-300" href="#">Mentors</a>
<a className="hover:text-zinc-900 transition-colors duration-300 hidden lg:block" href="#">Community</a>
</nav>

<a className="-all flex items-center gap-2 group hover:bg-zinc-50 text-xs font-medium text-zinc-600 tracking-wide bg-gradient-to-b from-black/10 via-black/20 to-black/10 rounded-lg pt-2.5 pr-5 pb-2.5 pl-5 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]" href="#" style={{boxShadow: '0 18px 35px rgba(31, 41, 55, 0.25), 0 0 0 1px rgba(209, 213, 219, 0.3)', color: '#e5e7eb', position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.8), rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.8))', '--border-radius-before': '8px'}}>
<span className="text-[11px] uppercase font-medium text-black/60 tracking-tight">
                    Join waitlist
                </span>
<svg className="w-[14px] h-[14px] group-hover:translate-x-1 transition-transform" data-lucide="arrow-right" fill="none" height="14" stroke="#666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<svg className="group-hover:translate-x-1 transition-transform" data-icon-replaced="true" data-icon-set="lucide" data-lucide="arrow-up-right" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(15, 23, 42)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
</span>
</button>
...
<svg className="" data-icon-replaced="true" data-icon-set="lucide" data-lucide="arrow-right" fill="none" height="16" stroke="#666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(229, 231, 235)'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
...
<img alt="Sci-fi landscape" className="transition-transform duration-[2s] ease-in-out group-hover:scale-110 filter saturate-[0.8] w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/96e3ccfa-3799-4c9c-9f2a-263c0ff6a449_1600w.webp"/>
...
<div className="flex gap-2 bg-gradient-to-b from-white/10 to-white/0 rounded-full pt-1.5 pr-3 pb-1.5 pl-3 gap-x-2 gap-y-2 items-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}>
...
<div className="flex hover:bg-white/20 transition-colors cursor-pointer text-white bg-gradient-to-b from-white/10 to-white/0 w-10 h-10 rounded-full items-center justify-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}>
<svg className="lucide lucide-bell" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<div className="self-end transform group-hover:translate-y-0 transition-transform duration-700 ease-out bg-gradient-to-b from-white/10 to-white/0 w-full max-w-[240px] rounded-xl mt-60 pt-4 pr-4 pb-4 pl-4 backdrop-blur translate-y-4" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '12px'}}>
...
<img alt="Reviewer" className="w-8 h-8 rounded-full object-cover border border-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7b1ee7e8-7554-433d-a435-029da35fee50_320w.webp"/>
<div className="flex flex-col">
...
<img alt="Reviewer" className="w-8 h-8 rounded-full object-cover border border-white/20" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b3f17582-5cb8-4efd-895a-b59c93e3ac02_320w.webp"/>
<div className="flex flex-col">
...
<a className="group flex items-center gap-2 hover:text-indigo-600 transition-colors text-sm font-normal text-zinc-900 pb-1" href="#">
                View full syllabus
                <svg aria-hidden="true" className="iconify group-hover:translate-x-1 transition-transform iconify--solar" data-icon="solar:arrow-right-linear" height="1em" role="img" style={{fontSize: '16px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:users-group-rounded-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:check-circle-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-2 mb-3 text-zinc-400">
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:chart-square-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<path d="M12 5.25a.75.75 0 0 1 .75.75v12a.75.75 0 0 1-1.5 0V6a.75.75 0 0 1 .75-.75m-5 3a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-1.5 0V9A.75.75 0 0 1 7 8.25m10 4a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-1.5 0v-5a.75.75 0 0 1 .75-.75" fill="currentColor">
</path>
</svg>
</div>
...
<svg aria-hidden="true" data-icon="solar:wallet-money-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="relative z-10">
<div className="flex items-center gap-2 mb-3 text-zinc-400">
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:code-square-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" className="text-zinc-300" data-icon="solar:programming-bold-duotone" height="1em" role="img" style={{fontSize: '20px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="relative z-10">
<div className="flex items-center gap-2 mb-3 text-zinc-400">
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:graph-up-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
<path d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12" fill="currentColor" opacity=".5"></path>
...
<svg aria-hidden="true" className="iconify text-zinc-400 iconify--solar" data-icon="solar:magnifer-linear" height="1em" role="img" style={{fontSize: '20px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" data-icon="simple-icons:ethereum" height="1em" role="img" style={{fontSize: '14px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
<path d="M11.944 17.97L4.58 13.62L11.943 24l7.37-10.38l-7.372 4.35zM12.056 0L4.69 12.223l7.365 4.354l7.365-4.35z" fill="currentColor">
</path>
</svg>
...
<svg aria-hidden="true" className="iconify text-white iconify--solar" data-icon="solar:database-bold-duotone" height="1em" role="img" style={{fontSize: '20px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
<path d="M12 10c4.418 0 8-1.79 8-4s-3.582-4-8-4s-8 1.79-8 4s3.582 4 8 4" fill="currentColor">
</path>
<path d="M4 12v6c0 2.21 3.582 4 8 4s8-1.79 8-4v-6c0 2.21-3.582 4-8 4s-8-1.79-8-4" fill="currentColor" opacity=".5">
</path>
<path d="M4 6v6c0 2.21 3.582 4 8 4s8-1.79 8-4V6c0 2.21-3.582 4-8 4S4 8.21 4 6" fill="currentColor" opacity=".7">
</path>
</svg>
</div>
</div>
...
<div className="relative z-10">
<div className="flex items-center gap-2 mb-3 text-zinc-400">
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:shield-check-bold-duotone" height="1em" role="img" style={{fontSize: '24px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<path d="M15.06 10.5a.75.75 0 0 0-1.12-1l-3.011 3.374l-.87-.974a.75.75 0 0 0-1.118 1l1.428 1.6a.75.75 0 0 0 1.119 0z" fill="currentColor">
</path>
</svg>
</div>
...
<svg aria-hidden="true" className="" data-icon="solar:lock-password-unlocked-bold-duotone" height="1em" role="img" style={{fontSize: '40px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<path className="" d="M8 17a1 1 0 1 0 0-2a1 1 0 0 0 0 2m4 0a1 1 0 1 0 0-2a1 1 0 0 0 0 2m5-1a1 1 0 1 1-2 0a1 1 0 0 1 2 0M6.75 8a5.25 5.25 0 0 1 10.335-1.313a.75.75 0 0 0 1.452-.374A6.75 6.75 0 0 0 5.25 8v2.055a24 24 0 0 1 1.5-.051z" fill="currentColor"></path>
</svg>
...
<path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2" fill="currentColor" opacity=".5">
</path>
<path d="M12 6a1 1 0 0 1 1 1v4.586l2.707 2.707a1 1 0 0 1-1.414 1.414l-3-3A1 1 0 0 1 11 12V7a1 1 0 0 1 1-1" fill="currentColor">
</path>
</svg>
</div>
...
<div className="flex flex-col gap-4">
<div className="text-zinc-900">
<svg aria-hidden="true" className="" height="28" role="img" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12" fill="currentColor" opacity=".5"></path>
<path d="M12 7.75a.75.75 0 0 1 .75.75v3.69l2.28 2.28a.75.75 0 1 1-1.06 1.06l-2.5-2.5a.75.75 0 0 1-.22-.53V8.5a.75.75 0 0 1 .75-.75" fill="currentColor">
</path>
</svg>
</div>
<p className="leading-relaxed text-base font-medium text-zinc-900 font-normal">
...
<svg aria-hidden="true" height="28" role="img" viewbox="0 0 24 24" width="28" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22c-4.714 0-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22" fill="currentColor" opacity=".5"></path>
<path d="M16.03 8.97a.75.75 0 0 1 0 1.06l-5 5a.75.75 0 0 1-1.06 0l-2-2a.75.75 0 1 1 1.06-1.06l1.47 1.47l4.47-4.47a.75.75 0 0 1 1.06 0" fill="currentColor">
</path>
</svg>
</div>
<p className="leading-relaxed text-base font-medium text-zinc-900 font-normal">
...
<path d="m103.257 78.015l16.918-20.194c-6.731-2.02-12.946-8.077-19.386-15.594L84.319 62.31a74 74 0 0 0 18.938 15.706M84.993 22.415A76.1 76.1 0 0 0 66.168 6.35l-16.94 20.418c6.44 2.244 12.138 8.032 18.197 15.414l.673.472z" fill="#ffffff">
</path>
...
<path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4m0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4" fill="currentColor">
</path>
</svg>
</div>
</div>
...
<path d="M12 2C6.477 2 2 .477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2" fill="currentColor" opacity=".5">
</path>
<path d="M12 6a1 1 0 0 1 1 1v4.586l2.707 2.707a1 1 0 0 1-1.414 1.414l-3-3A1 1 0 0 1 11 12V7a1 1 0 0 1 1-1" fill="currentColor">
</path>
</svg>
...
<div className="flex flex-col gap-4">
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Home</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Curriculum</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">About</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Pricing</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Community</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Contact</a>
</div>

<div className="flex flex-col gap-4">
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Privacy
                    Policy</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Terms
                    of Service</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">Disclaimer</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium font-normal" href="#">404</a>
<a className="text-base text-znic-700 hover:text-orange-500 transition-colors font-medium underline decoration-znic-300 underline-offset-4 font-normal" href="#">More
                    Resources</a>
</div>
...
<input className="text-znic-700 placeholder:text-znic-400 outline-none flex-1 text-sm font-medium bg-transparent" placeholder="Your email frequency" type="email"/>
<button className="text-orange-500 hover:text-orange-600 transition-colors">
<svg aria-hidden="true" className="w-[20px] h-[20px]" data-icon-replaced="true" data-icon-set="mingcute" data-mingcute="arrow-right-circle-line" height="20" role="img" strokeWidth="2" style={{color: 'rgb(234, 88, 12)', width: '20px', height: '20px'}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M24 0v24H0V0zM12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.105.074l.014.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.092l.01-.009l.004-.011l.017-.43l-.003-.012l-.01-.01z"></path><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2m0 2a8 8 0 1 0 0 16a8 8 0 0 0 0-16m.005 3.758a1 1 0 0 1 1.32-.084l.094.084l3.535 3.535a1 1 0 0 1 .083 1.32l-.083.094l-3.535 3.536a1 1 0 0 1-1.498-1.32l.084-.094l1.828-1.83H7.757a1 1 0 0 1-.116-1.992L7.757 11h6.076l-1.828-1.828a1 1 0 0 1 0-1.414" fill="#ea580c"></path></g></svg>
</button>
</div></div>
...
<a className="group flex items-center justify-between hover:bg-znic-50 transition-colors border-znic-100 border-b pt-4 pr-5 pb-4 pl-5" href="#">
<div className="flex items-center gap-3">
<svg className="text-znic-400 group-hover:text-orange-500 transition-colors" height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M19.27 5.33C17.94 4.71 16.5 4.26 15 4a.09.09 0 0 0-.07.03c-.18.33-.39.76-.53 1.09a16.09 16.09 0 0 0-4.8 0c-.14-.34-.36-.76-.54-1.09c-.01-.02-.04-.03-.07-.03c-1.5.26-2.93.71-4.27 1.33c-.01 0-.02.01-.03.02c-2.72 4.07-3.47 8.03-3.1 11.95c0 .02.01.04.03.05c1.8 1.32 3.53 2.12 5.24 2.65c.03.01.06 0 .07-.02c.4-.55.76-1.13 1.07-1.74c.02-.04 0-.08-.04-.09c-.57-.22-1.11-.48-1.64-.78c-.04-.02-.04-.08-.01-.11c.11-.08.22-.17.33-.25c.02-.02.05-.02.07-.01c3.44 1.57 7.15 1.57 10.55 0c.02-.01.05-.01.07.01c.11.09.22.17.33.26c.04.03.04.09-.01.11c-.52.31-1.07.56-1.64.78c-.04.01-.05.06-.04.09c.32.61.68 1.19 1.07 1.74c.03.01.06.02.09.01c1.72-.53 3.45-1.33 5.25-2.65c.02-.01.03-.03.03-.05c.44-4.53-.73-8.46-3.1-11.95c-.01-.01-.02-.02-.04-.02M8.52 14.91c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.84 2.12-1.89 2.12m6.97 0c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.83 2.12-1.89 2.12" fill="currentColor"></path>
</svg>
<span className="text-base font-medium text-znic-700 group-hover:text-znic-900 transition-colors">Discord</span>
</div>
<svg className="text-orange-500 opacity-0 group-hover:opacity-100 group-hover:tranznic-x-1 transition-all" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="m9 5l6 7l-6 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
</svg>
</a>

<a className="group flex items-center justify-between px-5 py-4 border-b border-znic-100 hover:bg-znic-50 transition-colors" href="#">
<div className="flex items-center gap-3">
<svg className="text-znic-400 group-hover:text-orange-500 transition-colors" height="18" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<path d="M18.205 2.25h3.308l-7.227 8.26l8.502 11.24H16.13l-5.214-6.817L4.95 21.75H1.64l7.73-8.835L1.215 2.25H8.04l4.713 6.231zm-1.161 17.52h1.833L7.045 4.126H5.078z" fill="currentColor">
</path>
</svg>
...
<div className="flex items-center gap-3">
<svg className="text-znic-400 group-hover:text-orange-500 transition-colors" height="20" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814M9.545 15.568V8.432L15.818 12z" fill="currentColor">
</path>
</svg>
...
<a className="group flex items-center justify-between px-5 py-4 hover:bg-znic-50 transition-colors" href="#">
<div className="flex items-center gap-3">
<svg aria-hidden="true" className="text-znic-400 group-hover:text-orange-500 transition-colors" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="M2 12c0-3.771 0-5.657 1.172-6.828S6.229 4 10 4h4c3.771 0 5.657 0 6.828 1.172S22 8.229 22 12s0 5.657-1.172 6.828S17.771 20 14 20h-4c-3.771 0-5.657 0-6.828-1.172S2 15.771 2 12" fill="currentColor" opacity=".5"></path>
<path d="M18.572 7.473a.75.75 0 0 1 .044 1.06l-4.142 4.47a2.75 2.75 0 0 1-4.034 0l-4.142-4.47a.75.75 0 0 1 1.1-1.016l4.143 4.469a1.25 1.25 0 0 0 1.834 0l4.142-4.47a.75.75 0 0 1 1.055-.043" fill="currentColor">
</path>
</svg>
...
<svg className="w-[60px] h-[14px]" data-icon-replaced="true" data-icon-set="logos" data-logos="openai" height="14" strokeWidth="2" style={{color: 'rgb(71, 85, 105)', width: '60px', height: '14px'}} viewbox="0 0 512 126" width="60" xmlns="http://www.w3.org/2000/svg">

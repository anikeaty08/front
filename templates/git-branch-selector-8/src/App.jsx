...
<iconify-icon className="text-xl text-blue-600" icon="lucide:git-branch"></iconify-icon>
<h2 className="text-2xl font-normal text-gray-900 tracking-tight">Select Branch</h2>
</div>
<div className="flex items-center gap-1.5">

<button className="hover:text-gray-900 hover:bg-gray-100/80 transition-colors outline-none focus:ring-2 focus:ring-gray-200 flex text-gray-600 rounded-lg pt-1.5 pr-3 pb-1.5 pl-2.5 items-center justify-center gap-1.5" title="Fetch for new branches">
<iconify-icon className="text-[17px]" icon="lucide:refresh-cw"></iconify-icon>
...
<iconify-icon className="text-lg" icon="lucide:list"></iconify-icon>
</button>
</div>
</div>
...
<iconify-icon className="text-lg text-gray-400 shrink-0" icon="lucide:search"></iconify-icon>
...
<iconify-icon className="text-xl text-blue-600 mt-0.5 shrink-0" icon="lucide:check-circle-2"></iconify-icon>
<div className="flex-1 min-w-0 pr-8">
<div className="text-base font-normal text-blue-900 truncate">origin/main</div>
<div className="flex gap-2 text-sm font-normal text-blue-700/70 mt-1 gap-x-2 gap-y-2 items-center">
...
<iconify-icon className="text-lg" icon="lucide:refresh-cw"></iconify-icon>
</button>
</div>

<div className="mx-2 px-3 py-3 hover:bg-gray-50 rounded-xl flex items-start gap-3.5 cursor-pointer group transition-colors">
<iconify-icon className="text-xl text-gray-400 mt-0.5 shrink-0 group-hover:text-gray-500 transition-colors" icon="lucide:help-circle"></iconify-icon>
...
<iconify-icon className="text-xl text-red-500 mt-0.5 shrink-0 group-hover:text-red-600 transition-colors" icon="lucide:x-circle"></iconify-icon>
<div className="flex-1 min-w-0">
...
<div className="hover:bg-gray-50 flex gap-3.5 cursor-pointer group transition-colors rounded-xl mx-2 p-3 items-start">
<iconify-icon className="text-xl text-green-500 mt-0.5 shrink-0 transition-colors" icon="lucide:check-circle-2"></iconify-icon>
<div className="flex-1 min-w-0">
...
<div className="hover:bg-gray-50 flex gap-3.5 cursor-pointer group transition-colors opacity-75 rounded-xl mx-2 p-3 items-start">
<iconify-icon className="shrink-0 group-hover:text-gray-500 transition-colors text-xl text-gray-400 mt-0.5" icon="lucide:ghost"></iconify-icon>
<div className="flex-1 min-w-0">
...
<div className="hover:bg-blue-50/50 flex gap-3.5 cursor-pointer group transition-colors rounded-xl mx-2 p-3 items-start">
<iconify-icon className="text-xl text-blue-500 mt-0.5 shrink-0 animate-[spin_2s_linear_infinite]" icon="lucide:hourglass"></iconify-icon>
<div className="flex-1 min-w-0">
<div className="truncate text-base font-normal text-gray-900">origin/feature/dark-mode-palette</div>
<div className="truncate text-sm font-normal text-blue-600 mt-1">Building in progress</div>
</div>
</div>

...
<span className="font-serif text-xl md:text-2xl tracking-tight italic font-medium group-hover:text-rose-500 transition-colors text-white">Varga Media</span>
</a>
...
<div className="animate-fade-up w-fit border px-3 py-1 rounded-full text-[10px] tracking-widest uppercase font-montserrat font-semibold mb-6 md:mb-8 bg-rose-950/30 border-rose-900/50 text-rose-400">Attention Home Improvement Companies</div>

<h1 className="animate-fade-up delay-100 leading-[1.1] sm:text-5xl md:text-7xl md:leading-[0.95] md:mb-8 lg:text-[5rem] lg:text-6xl text-4xl font-medium text-white tracking-tighter font-serif mb-6">Fully Qualified Quotes Booked In Your Diary For <span className="bg-clip-text italic text-transparent bg-gradient-to-br from-[#7877f6] to-[#e15ef7] pr-2">Trades Companies</span> That Actually Close...</h1>

<p className="animate-fade-up delay-200 text-base md:text-xl text-gray-400 leading-relaxed max-w-2xl mb-8 md:mb-12 font-light px-2">Don't buy shared, time-waster leads. We fill your diary with fully qualified and exclusive quotes that close, every single day...</p>
...
<h3 className="text-xl md:text-2xl font-serif mb-2 text-white">Trusted by 50+ Home Improvement Companies</h3>
<p className="text-[10px] md:text-xs font-montserrat uppercase tracking-widest mb-8 md:mb-10 text-gray-500">Join the fastest growing trades working with Varga Media</p>
...
<h2 className="md:text-5xl text-3xl font-medium text-white tracking-tight font-serif mb-4">Why Choose  Varga Media</h2>
...
<div className="font-montserrat font-semibold text-white">Connor Lee</div>
<div className="text-xs md:text-sm font-light text-gray-500">Owner, Waterstone Bathrooms</div>
</div>
</div>
</section>

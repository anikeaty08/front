...
<a className="hover:text-white hover:bg-white/10 transition-all duration-300 text-sm text-white/90 rounded-full pt-2 pr-5 pb-2 pl-5" href="#units">Lifestyle</a>
<a className="hover:text-white hover:bg-white/10 transition-all duration-300 text-sm text-white/90 rounded-full pt-2 pr-5 pb-2 pl-5" href="#video">Team</a>
<a className="hover:text-white hover:bg-white/10 transition-all duration-300 text-sm text-white/90 rounded-full pt-2 pr-5 pb-2 pl-5" href="#contact">Contact</a>
</div>
...
<img alt="Interior Design" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d5f8a6a3-9b20-4be2-8977-55f59234d709_3840w.jpg" style={{transition: 'outline 0.1s ease-in-out'}}/>
...
<img alt="Bali Coast" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f609bc8d-0b8b-4668-bcb4-b2d9d27f65f6_3840w.jpg" style={{}}/>
</div>
...
<img alt="Villa" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d0f7b419-0647-4406-80bd-b7728a0d3512_1600w.png"/>
...
<div className="h-64 rounded-2xl overflow-hidden mb-4 relative">
<img alt="Penthouse" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d57bd6e-bcf3-463e-8d26-639cdfed7cb4_1600w.jpg" style={{}}/>
...
<div className="group relative bg-white p-2 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300">
<div className="h-64 rounded-2xl overflow-hidden mb-4 relative">
<img alt="Apartment" className="group-hover:scale-105 transition-transform duration-500 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e158eda3-1e80-4d87-a10d-8bfd444a26f3_1600w.jpg"/>
...
<p className="text-lg font-light text-stone-600 mb-8" style={{}}>We’ve prepared a comprehensive presentation with detailed ROI calculations.</p>
...
<span className="">Get Presentation with Prices &amp; ROI</span>
...
<img alt="Video thumbnail" className="w-full h-full object-cover opacity-80 group-hover:opacity-60 transition-opacity" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7d39f590-8fe6-419c-9f3a-9291159b4018_1600w.png" style={{}}/>
...
<svg className="lucide lucide-play fill-stone-900 w-[24px] h-[24px]" data-icon-replaced="true" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(28, 25, 23)', width: '24px', height: '24px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
</div>
</div>
</div>
</div>
...
<a className="hover:underline text-lg font-medium text-stone-900" href="mailto:office@estetico.estate" style={{}}>info@habitats.com</a>
</div>
</div>
<div className="flex items-center gap-4 group">
<div className="w-12 h-12 rounded-full bg-stone-50 flex items-center justify-center group-hover:bg-stone-900 group-hover:text-white transition-colors">
...
<a className="hover:text-stone-900 transition-colors" href="#units">Lifestyle</a>
<a className="hover:text-stone-900 transition-colors" href="/#video">Team</a>

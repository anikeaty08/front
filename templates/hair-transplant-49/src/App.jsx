...
<span className="leading-none group-hover:text-zinc-600 transition-colors text-sm font-semibold text-zinc-900 tracking-tight">
              SOLVE Clinics
            </span>
</div>
</a>
<div className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-500">
<a className="hover:text-zinc-900 transition-colors" href="#procedures">
            Procedures
          </a>
...
<a className="hidden lg:flex items-center gap-2 text-zinc-500 text-xs font-medium hover:text-zinc-900 transition-colors" href="tel:+18474109748">
...
<span className="text-xs font-medium text-zinc-600 tracking-wide uppercase">
              Premier Hair Restoration in Chicago
            </span>
</div>
</div>
<h1 className="fade-enter md:text-6xl lg:text-7xl leading-[1.1] text-4xl font-medium text-zinc-900 tracking-tight mb-8" style={{animationDelay: '0.2s'}}>
          Sick of Hair Solutions That Don't Work?
          <br/>
<span className="bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-800 to-zinc-900">
            Get it Back For Good at Chicago’s Highest Rated Hair and Cosmetic
            Clinic
          </span>
</h1>
<p className="fade-enter md:text-xl leading-relaxed text-lg font-light text-zinc-500 max-w-2xl mr-auto mb-12 ml-auto" style={{animationDelay: '0.3s'}}>
          Custom FUE, beard, and hairline tailored to your unique physiology.
...
<a className="sm:w-auto hover:bg-zinc-800 transition-all flex items-center justify-center gap-2 shadow-zinc-200 hover:shadow-2xl hover:shadow-zinc-300 hover:-translate-y-0.5 text-sm font-medium text-white bg-zinc-900 w-full rounded-full pt-4 pr-8 pb-4 pl-8 shadow-xl" href="#contact">
            Start Your Journey
            <i className="w-[18px] h-[18px]" data-lucide="calendar-plus"></i>
</a>
<a className="w-full sm:w-auto px-8 py-4 bg-white border border-zinc-200 text-zinc-700 rounded-full font-medium text-sm hover:border-zinc-300 hover:bg-zinc-50 transition-all flex items-center justify-center gap-2 shadow-sm" href="#results">
            View Gallery
            <i className="w-[18px] h-[18px]" data-lucide="image"></i>
</a>
</div>
...
<div className="w-px h-8 bg-zinc-200 hidden sm:block"></div>
<div className="flex flex-col gap-1 gap-x-1 gap-y-1 items-center">
<span className="text-2xl font-semibold text-zinc-900 tracking-tight">
              4.9/5 Stars With Hundreds of Reviews
            </span>
<span className="text-xs font-medium tracking-wide uppercase">
              Patient Rating
            </span>
...
<img alt="Chicago HTC Clinic Interior" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&amp;w=2068&amp;auto=format&amp;fit=crop"/>

<div className="absolute inset-0 bg-zinc-900/10 group-hover:bg-zinc-900/20 transition-colors duration-500"></div>

<div className="absolute inset-0 flex items-center justify-center">
<div className="w-20 h-20 bg-white/30 backdrop-blur-md border border-white/40 rounded-full flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500 ease-out z-10">
<div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-zinc-900 shadow-sm pl-1">
<i className="w-8 h-8 fill-zinc-900" data-lucide="play"></i>
</div>
</div>
</div>

<div className="absolute bottom-0 left-0 right-0 p-8 md:p-10 bg-gradient-to-t from-black/60 to-transparent flex flex-col md:flex-row md:items-end justify-between gap-4">
<div className="flex flex-col items-start gap-3">
<div className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-lg border border-white/20 shadow-lg">
<span className="text-white text-[0.625rem] font-bold tracking-wider uppercase">
                  Facility Tour
                </span>
</div>
<h3 className="md:text-2xl text-xl font-medium text-white tracking-tight" style={{}}>
                State-of-the-art facilities in Chicago
              </h3>
</div>
</div>
</div>
...
<section className="py-32 bg-zinc-50 border-t border-zinc-200 relative" id="procedures">
<div className="max-w-7xl mx-auto px-6 relative z-10">
<div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-20">
<div className="">
<h2 className="md:text-4xl text-3xl font-medium text-zinc-900 tracking-tight mb-4" style={{}}>
              Natural Transplant and Restoration
            </h2>
<p className="text-zinc-500 font-light max-w-xl text-lg">
              We utilize proprietary technology to ensure maximum graft survival
              and natural direction of growth.
            </p>
</div>
...
<i className="w-5 h-5 text-zinc-400" data-lucide="arrow-up-right"></i>
</div>
...
<i className="w-7 h-7" data-lucide="scan-face"></i>
</div>
...
<p className="text-sm text-zinc-500 font-normal leading-relaxed">
              Restore your natural hairline density with precise follicular unit
              placement for a completely seamless look.
            </p>
</div>
...
<p className="text-sm text-zinc-500 font-normal leading-relaxed">
              Achieve a fuller, thicker beard or fill in patchy areas using your
              body's own natural hair follicles.
            </p>
</div>
...
<div className="w-14 h-14 rounded-xl bg-zinc-50 border border-zinc-100 flex items-center justify-center mb-6 group-hover:bg-zinc-900 group-hover:text-white transition-colors duration-300">
<i className="w-7 h-7" data-lucide="circle-user"></i>
</div>
<h3 className="text-lg font-semibold text-zinc-900 mb-3 tracking-tight">
              African American Hair Transplant
            </h3>
<p className="text-sm text-zinc-500 font-normal leading-relaxed">
              Specialized care for curly hair follicles, utilizing unique
              extraction techniques to ensure maximum viability.
            </p>
</div>
...
<div className="w-14 h-14 rounded-xl bg-zinc-50 border border-zinc-100 flex items-center justify-center mb-6 group-hover:bg-zinc-900 group-hover:text-white transition-colors duration-300">
<i className="w-7 h-7" data-lucide="briefcase-medical"></i>
</div>
<h3 className="text-lg font-semibold text-zinc-900 mb-3 tracking-tight">
              FUE Transplant
            </h3>
<p className="text-sm text-zinc-500 font-normal leading-relaxed">
              Follicular Unit Extraction allows for individual harvesting
              without linear scarring. Ideal for minimal downtime.
            </p>
</div>
</div>
</div>
...
<div className="">
<div className="inline-flex items-center gap-2 mb-4 text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100">
<i className="w-3.5 h-3.5" data-lucide="check-circle-2"></i>
<span className="text-[0.625rem] uppercase font-bold tracking-wider">
                Proven Results
              </span>
</div>
...
<p className="text-zinc-500 font-light max-w-xl text-lg">
              See the transformative power of our hair restoration procedures.
            </p>
</div>
...
<img alt="Smiling patient showing successful hair transplant results with before photo inset" className="bg-zinc-100 w-full h-auto object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/da7e2960-fc0b-4952-99b3-6f3d7c8805b0_3840w.png"/>
</div>
</div>
</div>
</section>
...
<h2 className="md:text-4xl text-3xl font-medium text-zinc-900 tracking-tight text-center mb-20">
          Trusted by over 4,000 patients
        </h2>
...
<p className="leading-relaxed text-base text-zinc-600 mb-8 font-light">
                “I’d highly recommend using Solve for your FUE or PRP! My hair
                transplant at Solve was an excellent experience! Their team did
                an excellent job! The entire process was comfortable, laid back,
                and professional. I’m loving the results!”
              </p>
</div>
...
<div>
<p className="text-sm font-semibold text-zinc-900">Rob Scholl</p>
<p className="text-xs text-zinc-400">July 3, 2025</p>
</div>
</div>
</div>
...
<p className="leading-relaxed text-base text-zinc-600 mb-8 font-light">
                “I got a 1,700 FUE procedure done on the first Wednesday of
                2024. Great price. No regrets whatsoever. My hair looks great
                now. They were very accommodating of my tight work schedule to
                squeeze in an appointment for me.”
              </p>
</div>
<div className="flex items-center gap-3 pt-6 border-t border-zinc-100">
<div className="w-10 h-10 rounded-full bg-zinc-100 flex items-center justify-center text-zinc-500 font-semibold text-xs">
...
<div>
<p className="text-sm font-semibold text-zinc-900">July Hizon</p>
<p className="text-xs text-zinc-400">May 26, 2025</p>
</div>
</div>
</div>
...
<p className="leading-relaxed text-base text-zinc-600 mb-8 font-light">
                “I have nothing but GREAT things to say about Solve Clinics. I
                am on the 7-8 month mark on my FUE hair transplant procedure and
                the results have been absolutely incredible so far. Getting a
                procedure done with this organization is one of the best
                decisions I’ve made, my hair looks awesome!! I highly recommend
...
<div>
<p className="text-sm font-semibold text-zinc-900">Jessie L.</p>
<p className="text-xs text-zinc-400">May 9, 2023</p>
</div>
</div>
</div>
</div>
...
<p className="text-zinc-400 font-light text-lg">
            Schedule your complimentary consultation and hair analysis.
          </p>
</div>
...
<div className="bg-zinc-900 text-white w-8 h-8 flex items-center justify-center rounded-lg"></div>
<span className="text-sm font-semibold text-zinc-900">
                Solve Clinics
              </span>
</div>
<p className="leading-relaxed text-sm font-light text-zinc-500 max-w-sm">
              Restore your hair &amp; live confidently.
            </p>
</div>
<div className="">

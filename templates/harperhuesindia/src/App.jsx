...
<div className="lg:hidden font-bold text-lg tracking-tight">Harper Hues</div>

<div className="hidden lg:flex gap-6 items-center mix-blend-plus-lighter">
<a className="hover:opacity-70 transition-opacity font-medium" href="#">Services</a>
<a className="hover:opacity-70 transition-opacity" href="#">Portfolio</a>
...
<span className="text-xs font-medium uppercase tracking-wider opacity-80">Available for projects</span>
</div>

<a className="hidden lg:block hover:opacity-70 transition-opacity mix-blend-plus-lighter" href="#">Contact Us</a>
...
<span className="text-hero-mobile font-[800] tracking-tighter text-white mix-blend-overlay opacity-90 block">HARPER</span>
<span className="text-hero-mobile font-[800] tracking-tighter text-white mix-blend-overlay opacity-90 block text-right">HUES</span>
</div>
...
<span className="text-hero font-[800] tracking-tighter text-white mix-blend-overlay opacity-90 block whitespace-nowrap pl-4 lg:pl-0">HARPER</span>
</div>
...
<img alt="Animation Still" className="transition-transform duration-700 group-hover:scale-105 opacity-80 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/fa10ce6c-f914-4d7e-90ee-9546128a33e4_800w.webp"/>
...
<p className="text-sm font-normal opacity-90 leading-relaxed text-white drop-shadow-md flex-1">
                        Directing captivating 2D narratives and explainer videos for global campaigns.
                    </p>
...
<span className="text-sm font-medium tracking-tight mr-2">Get Quote</span>
...
<span className="text-hero font-[800] tracking-tighter text-white mix-blend-overlay opacity-90 block pr-4 lg:pr-0">HUES</span>
</div>
...
<h3 className="text-lg font-bold tracking-tight text-neutral-900">explainer.mp4</h3>
<span className="w-2 h-2 rounded-full bg-neutral-900 mt-2"></span>
</div>
<p className="text-xs text-neutral-500 mt-1 font-medium tracking-wide">2D E-LEARNING • 2024</p>
</div>
...
<p className="text-sm font-semibold tracking-tight mt-0.5 text-neutral-800">Full Production Studio</p>
</div>
</div>
...
<h2 className="text-4xl lg:text-7xl font-semibold tracking-tighter text-white mb-6 leading-[0.9]">
                        Simplify concepts.<br/>
<span className="text-neutral-500">Entertain viewers.</span>
</h2>
<p className="text-neutral-400 text-lg max-w-xl leading-relaxed">
                        A leading Indian animation studio bridging the gap between artistic vision and effective marketing. 
                    </p>
</div>
<div className="mb-2">
...
<div className="absolute bottom-4 right-4 text-[10px] font-mono text-neutral-500">EXP-01</div>
</div>
<div>
...
<h3 className="text-xl font-bold tracking-tight mb-2">Explainer Videos</h3>
<p className="text-sm text-neutral-400 leading-relaxed">
                        Convert visitors into leads with customized, original animated explainer videos for your brand.
                    </p>
</div>
</div>
...
<p className="pl-2 text-neutral-600">// Optimized Render</p>
<p className="pl-2"><span className="text-purple-400">return</span> <span className="text-green-400">&lt;Motion /&gt;</span></p>
<p className="">}</p>
...
<h3 className="text-xl font-bold tracking-tight mb-2">2D Animation</h3>
<p className="text-sm text-neutral-400 leading-relaxed">
                        Custom animated videos, whiteboard animations, and semi-classical animation tailored for you.
                    </p>
</div>
</div>
...
<iconify-icon className="" icon="lucide:layers" width="12"></iconify-icon>
</div>
</div>
</div>
<div className="">
<div className="w-8 h-8 flex items-center justify-center bg-white text-black mb-6">
<iconify-icon className="" icon="lucide:layers" width="16"></iconify-icon>
</div>
<h3 className="text-xl font-bold tracking-tight mb-2">Educational Videos</h3>
<p className="text-sm text-neutral-400 leading-relaxed">
                        Engaging e-learning videos, educational rhymes, and interactive training modules.
                    </p>
</div>
</div>
...
<h3 className="text-xl font-bold tracking-tight mb-2">Digital Illustration</h3>
<p className="text-sm text-neutral-400 leading-relaxed mb-4">
                        10k+ Illustrations created. Storyboards, children's books, and medical.
                    </p>
<a className="text-xs font-mono uppercase tracking-widest border-b border-white/20 pb-1 self-start hover:border-white transition-colors" href="#">Explore Portfolio</a>
</div>
</div>
</div>
...
<div className="p-8 border-r border-white/10">© 2024 Harper Hues</div>
<div className="p-8 border-r border-white/10">Noida, India</div>
...
<span className="text-xs font-medium tracking-wide text-white/90 uppercase">Top Studio</span>
</div>
<h2 className="text-5xl lg:text-8xl font-medium tracking-tighter text-white leading-[0.9]">
                Harper Hues<span className="text-white/40">.</span>
</h2>
<p className="text-white/70 text-xl lg:text-2xl max-w-2xl font-light leading-relaxed">
                Leading animation studio in India offering high-impact 2D animation, explainer videos, and motion graphics.
            </p>
</div>
...
<div>
<h3 className="text-3xl font-medium tracking-tight mb-2">Welcome to Harper Hues</h3>
<p className="text-base text-white/60 leading-relaxed font-light">
                        Top 2D Animation &amp; Explainer Video Studio Based in Noida, India.
                    </p>
</div>
...
<p className="text-2xl lg:text-3xl font-normal leading-snug text-white/90 max-w-3xl">
                    We are a dedicated Animation Studio based in Noida. We specialize in creative storytelling with seamless technical execution, simplifying complex concepts to convert leads.
                </p>

<div className="flex flex-wrap gap-2 mt-12">
<span className="px-4 py-2 bg-white/5 border border-white/10 rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">2D Animation</span>
<span className="px-4 py-2 bg-white/5 border border-white/10 rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">Explainer Videos</span>
<span className="px-4 py-2 bg-white/5 border border-white/10 rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">Educational</span>
<span className="px-4 py-2 bg-white/5 border border-white/10 rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">Whiteboard</span>
<span className="px-4 py-2 bg-white/5 border border-white/10 rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">Illustration</span>
<span className="px-4 py-2 bg-white/5 border border-white/10 border-transparent rounded-md text-xs font-mono uppercase tracking-wider text-white/80 hover:bg-white/10 transition-colors cursor-default">Voice Over</span>
</div>
</div>
...
<iconify-icon className="text-white/40" icon="solar:check-circle-linear" width="16"></iconify-icon>
<span className="text-sm font-mono text-white/40 group-hover:text-white/60 transition-colors">100% Original</span>
</div>
<h4 className="text-lg font-medium tracking-tight">Customized Artwork</h4>
</div>
<div className="flex items-center justify-between w-full lg:w-auto lg:flex-1 lg:justify-end gap-8">
<span className="text-sm text-white/40 group-hover:text-white transition-colors">No ready-made templates.</span>
...
<div className="flex items-center gap-8 w-full lg:w-auto">
<div className="flex items-center gap-3 w-32">
<iconify-icon className="text-white/40" icon="solar:wallet-linear" width="16"></iconify-icon>
<span className="text-sm font-mono text-white/40 group-hover:text-white/60 transition-colors">Friendly</span>
</div>
<h4 className="text-lg font-medium tracking-tight">Budget Options</h4>
</div>
<div className="flex items-center justify-between w-full lg:w-auto lg:flex-1 lg:justify-end gap-8">
<span className="text-sm text-white/40 group-hover:text-white transition-colors">High value for your investment.</span>
<iconify-icon className="text-white/20 group-hover:text-white group-hover:translate-x-2 transition-transform" icon="solar:arrow-right-linear" width="24"></iconify-icon>
</div>
</div>
...
<div className="flex items-center gap-8 w-full lg:w-auto">
<div className="flex items-center gap-3 w-32">
<iconify-icon className="text-white/40" icon="solar:global-linear" width="16"></iconify-icon>
<span className="text-sm font-mono text-white/40 group-hover:text-white/60 transition-colors">Global</span>
</div>
<h4 className="text-lg font-medium tracking-tight">Any Language</h4>
</div>
<div className="flex items-center justify-between w-full lg:w-auto lg:flex-1 lg:justify-end gap-8">
<span className="text-sm text-white/40 group-hover:text-white transition-colors">Spanish, Arabic, German &amp; more.</span>
<iconify-icon className="text-white/20 group-hover:text-white group-hover:translate-x-2 transition-transform" icon="solar:arrow-right-linear" width="24"></iconify-icon>
</div>
</div>
...
<div className="flex items-center gap-8 w-full lg:w-auto">
<div className="flex items-center gap-3 w-32">
<iconify-icon className="text-white/40" icon="solar:stopwatch-linear" width="16"></iconify-icon>
<span className="text-sm font-mono text-white/40 group-hover:text-white/60 transition-colors">On-Time</span>
</div>
<h4 className="text-lg font-medium tracking-tight">Unlimited Revisions</h4>
</div>
<div className="flex items-center justify-between w-full lg:w-auto lg:flex-1 lg:justify-end gap-8">
<span className="text-sm text-white/40 group-hover:text-white transition-colors">Strict adherence to deadlines.</span>
<iconify-icon className="text-white/20 group-hover:text-white group-hover:translate-x-2 transition-transform" icon="solar:arrow-right-linear" width="24"></iconify-icon>
</div>
</div>
</div>
...
</section><section className="relative z-20 bg-black text-white w-full border-b border-white/10 pointer-events-auto font-sans">
<div className="grid grid-cols-1 lg:grid-cols-4 w-full">
...
<div className="text-7xl lg:text-9xl font-semibold tracking-tighter text-white mb-2">
                            10K<span className="text-[#6D28D9]">+</span>
</div>
<p className="text-xl text-white/60 font-light max-w-md">
                            Illustrations &amp; Videos successfully delivered globally in the last decade.
                        </p>
</div>
</div>
</div>
...
<p className="text-xl lg:text-2xl font-normal leading-relaxed text-white mb-8">
                        "After having tried for a couple of other animation companies for my promotional videos, I have finally got the right people. They always come up with innovative ideas that are very catchy. Strongly recommend."
                    </p>
...
<div>
<div className="text-sm font-semibold text-white">Shoko Mugikura</div>
<div className="text-xs text-white/60 uppercase tracking-wider mt-0.5">Design Manager</div>
</div>
</div>
...
<p className="text-lg text-white/80 font-light leading-relaxed mb-8">
                        "Very co-operative and professional, knew exactly what I wanted and delivered the same in the given time, one of the very few companies I've had a good experience with, highly recommend to all."
                    </p>
...
<div>
<div className="text-sm font-medium text-white">Alexander Harvard</div>
<div className="text-[10px] text-white/40 uppercase tracking-wider mt-0.5">Co Founder / CEO</div>
</div>
</div>
...
<p className="text-lg text-white/80 font-light leading-relaxed mb-6">
                            "A brilliant animation company providing 2D animation services. The team is so talented, they hear your ideas and implement it with their creative visuals. I am very satisfied with their commitments."
                        </p>
</div>
...
<div>
<div className="text-sm font-medium text-white">Angelina Johnson</div>
<div className="text-[10px] text-white/40 uppercase tracking-wider mt-0.5">Creative Director</div>
</div>
</div>
...
<p className="text-sm text-white/50 mt-1">Join 350+ brands scaling with better animation.</p>
</div>
</div>
...
<h2 className="text-4xl lg:text-6xl font-medium tracking-tighter text-white leading-[0.95] mb-6">
                        Ready to bring your vision <span className="text-violet-300">to life?</span>
</h2>
<p className="text-lg text-white/50 font-light leading-relaxed max-w-md">
                        Share your video idea, and we'll hook you up with the scoop on info and pricing!
                    </p>
</div>
...
<input className="w-full bg-transparent border-b border-white/10 py-3 text-lg text-white placeholder-white/20 focus:border-white/0 transition-colors" placeholder="Jane Doe" type="text"/>
...
<input className="w-full bg-transparent border-b border-white/10 py-3 text-lg text-white placeholder-white/20 focus:border-white/0 transition-colors" placeholder="hello@harperhues.com" type="email"/>
<div className="absolute bottom-0 left-0 h-[1px] bg-green-400 w-0 input-line opacity-0"></div>
</div>
</div>
...
<textarea className="w-full bg-transparent border-b border-white/10 py-3 text-lg text-white placeholder-white/20 focus:border-white/0 transition-colors resize-none" placeholder="I need a new 2D explainer video for..." rows="3"></textarea>
<div className="absolute bottom-0 left-0 h-[1px] bg-green-400 w-0 input-line opacity-0"></div>
</div>
...
<h3 className="text-xl font-medium tracking-tight text-white">Harper Hues Animation Studio</h3>
<p className="text-sm text-white/40 leading-relaxed max-w-xs">
                            Office No. 1403A, 14th Floor, The Iconic Corenthum, Sector 62, Noida 201301<br/><br/>
                            sales@harperhues.com<br/>
                            (+91) 120 988625
                        </p>
</div>
</div>
...
<h4 className="text-xs font-mono uppercase tracking-widest text-white/40 mb-8">Explainer Videos</h4>
...
<div className="p-8 lg:p-12 border-r border-b lg:border-b-0 border-white/10">
<h4 className="text-xs font-mono uppercase tracking-widest text-white/40 mb-8">2D Animation</h4>
<ul className="space-y-4">
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">2D Animated Videos</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Whiteboard Videos</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Cartoon Animation</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Custom Animated Videos</a></li>
</ul>
</div>

<div className="col-span-2 md:col-span-1 p-8 lg:p-12">
<h4 className="text-xs font-mono uppercase tracking-widest text-white/40 mb-8">Educational &amp; Illus.</h4>
<ul className="space-y-4">
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">E-learning Videos</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Educational Rhymes</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Storytelling Videos</a></li>
<li><a className="text-sm text-white/70 hover:text-white transition-colors" href="#">Children's Book Illustration</a></li>
</ul>
</div>
</div>
</div>
...
<div className="text-xs text-white/30 font-light tracking-wide">
                © 2024 Harper Hues Animation Studio. All rights reserved. Noida, India.
            </div>

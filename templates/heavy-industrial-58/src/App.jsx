...
<a className="text-sm font-medium text-[var(--text-sec)] hover:text-[var(--accent)] transition-colors" href="#services">Services</a>
<a className="text-sm font-medium text-[var(--text-sec)] hover:text-[var(--accent)] transition-colors" href="#capabilities">Capabilities</a>
<a className="text-sm font-medium text-[var(--text-sec)] hover:text-[var(--accent)] transition-colors" href="#quality">Quality</a>
<a className="text-sm font-medium text-[var(--text-sec)] hover:text-[var(--accent)] transition-colors" href="#training">Training</a>
<a className="text-sm font-medium text-[var(--text-sec)] hover:text-[var(--accent)] transition-colors" href="#experience">Experience</a>
</nav>
...
<a className="inline-flex items-center justify-center px-5 py-2.5 bg-[var(--accent)] text-[var(--cta-text)] text-sm font-medium rounded-[4px] hover:scale-[1.02] hover:bg-[var(--accent-soft)] transition-all duration-200" href="#contact">
                        Request a Quote
                    </a>
</div>
...
<a className="block text-base font-medium text-[var(--text-sec)] hover:text-[var(--accent)]" href="#services">Services</a>
<a className="block text-base font-medium text-[var(--text-sec)] hover:text-[var(--accent)]" href="#capabilities">Capabilities</a>
<a className="block text-base font-medium text-[var(--text-sec)] hover:text-[var(--accent)]" href="#quality">Quality</a>
<a className="block text-base font-medium text-[var(--text-sec)] hover:text-[var(--accent)]" href="#training">Training</a>
<a className="block text-base font-medium text-[var(--text-sec)] hover:text-[var(--accent)]" href="#experience">Experience</a>
...
<a className="inline-flex items-center justify-center px-4 py-3 bg-[var(--accent)] text-[var(--cta-text)] text-base font-medium rounded-[4px]" href="#contact">
                    Request a Quote
                </a>
</div>
</div>
...
<img alt="Heavy Mining Equipment" className="w-full h-full object-cover opacity-20 dark:opacity-30 mix-blend-luminosity" src="https://images.unsplash.com/photo-1578319439584-104c94d37334?q=80&amp;w=2940&amp;auto=format&amp;fit=crop"/>
...
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-6 flex items-center gap-3">
...
<a className="inline-flex items-center justify-center px-8 py-4 bg-[var(--accent)] text-[var(--cta-text)] text-base font-medium rounded-[4px] hover:scale-[1.02] hover:bg-[var(--accent-soft)] transition-all duration-200" href="#contact">
                            Request a Quote
                        </a>
<a className="inline-flex items-center justify-center px-8 py-4 bg-[var(--surface)] text-[var(--text-pri)] border border-[var(--accent)] text-base font-medium rounded-[4px] hover:scale-[1.02] hover:bg-[var(--surface-alt)] transition-all duration-200 gap-2" href="tel:928-965-6524">
...
<div className="bg-[var(--bg)] p-6 hover:bg-[var(--surface-alt)] transition-colors">
<div className="text-[var(--text-sec)] text-xs font-semibold uppercase tracking-widest mb-2">Founded</div>
<div className="font-heading text-2xl font-semibold text-[var(--text-pri)]">2012</div>
</div>
<div className="bg-[var(--bg)] p-6 hover:bg-[var(--surface-alt)] transition-colors">
<div className="text-[var(--text-sec)] text-xs font-semibold uppercase tracking-widest mb-2">Technicians</div>
<div className="font-heading text-2xl font-semibold text-[var(--text-pri)]">11 Specialized</div>
</div>
<div className="bg-[var(--bg)] p-6 hover:bg-[var(--surface-alt)] transition-colors">
<div className="text-[var(--text-sec)] text-xs font-semibold uppercase tracking-widest mb-2">Structure</div>
<div className="font-heading text-2xl font-semibold text-[var(--text-pri)]">Employee-Owned</div>
</div>
<div className="bg-[var(--bg)] p-6 hover:bg-[var(--surface-alt)] transition-colors">
<div className="text-[var(--text-sec)] text-xs font-semibold uppercase tracking-widest mb-2">Service Area</div>
<div className="font-heading text-2xl font-semibold text-[var(--text-pri)]">AZ / NV / NM</div>
</div>
</div>
</div>
</section>
...
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-4">About IMM</p>
...
<section className="py-20 lg:py-28 bg-[var(--surface)] border-b border-[var(--border)]" id="services">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="mb-16 fade-in-up">
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-4">Core Capabilities</p>
...
<div className="bg-[var(--bg)] border border-[var(--border)] rounded-[4px] p-8 hover:border-[var(--accent)] transition-colors duration-300 flex flex-col fade-in-up group">
...
<section className="py-20 lg:py-28 bg-[var(--surface-alt)] border-b border-[var(--border)]" id="capabilities">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
<div className="lg:col-span-4 fade-in-up">
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-4">Technical Specs</p>
<h2 className="font-heading font-semibold text-[clamp(1.875rem,4vw,3.25rem)] leading-[1] tracking-tight text-[var(--text-pri)] mb-6 uppercase">
...
<span className="px-4 py-2 border border-[var(--border)] rounded-[4px] text-sm text-[var(--text-pri)] bg-[var(--bg)]">Shovel and Drill</span>
<span className="px-4 py-2 border border-[var(--border)] rounded-[4px] text-sm text-[var(--text-pri)] bg-[var(--bg)]">Heavy Duty Truck Shop</span>
<span className="px-4 py-2 border border-[var(--border)] rounded-[4px] text-sm text-[var(--text-pri)] bg-[var(--bg)]">Crush and Convey</span>
<span className="px-4 py-2 border border-[var(--border)] rounded-[4px] text-sm text-[var(--text-pri)] bg-[var(--bg)]">Light Duty Truck Shop</span>
<span className="px-4 py-2 border border-[var(--border)] rounded-[4px] text-sm text-[var(--text-pri)] bg-[var(--bg)]">Acid Plant / Hydromet</span>
</div>
</div>
</div>
</div>
...
<section className="py-20 lg:py-28 bg-[var(--surface)] border-b border-[var(--border)]" id="experience">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="text-center mb-16 fade-in-up">
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-4">Trusted By Industry</p>
...
<span className="text-[var(--accent)]">Certified</span> Support &amp; Client Roster
                    </h2>
</div>
...
<div className="px-8 py-4 border border-[var(--border)] bg-[var(--bg)] rounded-[4px] flex items-center justify-center min-w-[140px]">
...
<p className="inline-block px-6 py-2 border border-[var(--border)] bg-[var(--bg)] text-sm text-[var(--text-sec)] italic rounded-[4px]">References available on request.</p>
</div>
</div>
</div>
</section>

<section className="py-20 lg:py-28 bg-[var(--surface-alt)] border-b border-[var(--border)]" id="quality">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="max-w-3xl mb-16 fade-in-up">
<p className="text-[clamp(0.75rem,1vw,0.875rem)] font-semibold tracking-[0.18em] uppercase text-[var(--accent)] mb-4">Standards</p>
...
<section className="py-16 bg-[var(--surface)] border-b border-[var(--border)]" id="training">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<div className="bg-[var(--bg)] border border-[var(--border)] px-5 py-3 rounded-[4px] flex items-center gap-3">
...
<section className="py-20 lg:py-28 bg-[var(--surface-alt)] relative overflow-hidden" id="contact">
...
<h2 className="font-heading font-semibold text-[clamp(2rem,5vw,3.5rem)] leading-[0.95] tracking-tight text-[var(--text-pri)] uppercase mb-8">
                            Talk to IMM about your <span className="text-[var(--accent)]">next shutdown</span>, rebuild, or field repair.
                        </h2>
...
<div className="text-xl font-medium text-[var(--text-pri)] group-hover:text-[var(--accent)] transition-colors">928-965-6524</div>
</div>
</a>
...
<div className="text-xl font-medium text-[var(--text-pri)] group-hover:text-[var(--accent)] transition-colors">imm_arizona@yahoo.com</div>
</div>
</a>
</div>
</div>
...
<input className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" required="" type="text"/>
</div>
<div>
...
<input className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" required="" type="tel"/>
</div>
<div>
<label className="block text-xs font-semibold text-[var(--text-sec)] uppercase tracking-wider mb-2">Email</label>
<input className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" required="" type="email"/>
</div>
</div>
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
<div>
<label className="block text-xs font-semibold text-[var(--text-sec)] uppercase tracking-wider mb-2">Mine Site / Location</label>
<input className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" type="text"/>
</div>
<div>
<label className="block text-xs font-semibold text-[var(--text-sec)] uppercase tracking-wider mb-2">Urgency</label>
<select className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow appearance-none">
...
<input className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" placeholder="e.g. Line boring, Shovel rebuild..." type="text"/>
</div>
<div>
<label className="block text-xs font-semibold text-[var(--text-sec)] uppercase tracking-wider mb-2">Message</label>
<textarea className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-[4px] px-4 py-3 text-[var(--text-pri)] text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] outline-none transition-shadow" rows="4"></textarea>
</div>
<button className="w-full py-4 bg-[var(--accent)] text-[var(--cta-text)] text-base font-semibold uppercase tracking-wide rounded-[4px] hover:bg-[var(--accent-soft)] transition-colors mt-4" type="submit">
                                Submit Request
                            </button>
</form>
</div>
...
<a className="flex-1 inline-flex items-center justify-center py-3 bg-[var(--accent)] text-[var(--cta-text)] text-sm font-semibold uppercase rounded-[4px]" href="#contact">
            Quote
        </a>
</div>

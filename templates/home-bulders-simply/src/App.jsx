...
<div className="relative flex items-center justify-between h-[72px] px-1.5 sm:px-2.5 lg:px-3 rounded-full border border-[#d8d1c6]/75 bg-[rgba(242,238,231,0.82)] shadow-[0_10px_30px_rgba(25,20,16,0.06)]" id="main-nav-inner" style={{'--fx-filter': 'blur(4px) liquid-glass(2, 10) saturate(1.25)'}}>

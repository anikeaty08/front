...
<img alt="Luxury Fashion Campaign" className="w-full h-full object-cover object-top opacity-90" src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
...
<img alt="The Silk Dress" className="w-full h-full object-cover transition duration-700 ease-in-out group-hover:scale-105" src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&amp;w=1683&amp;auto=format&amp;fit=crop"/>
...
<div className="flex-none w-[280px] md:w-[400px] group cursor-pointer">
<div className="relative aspect-[3/4] overflow-hidden mb-6 bg-luxury-grey/30">
<img alt="Wool Blazer" className="w-full h-full object-cover transition duration-700 ease-in-out group-hover:scale-105" src="https://images.unsplash.com/photo-1532453288672-3a27e9be9efd?q=80&amp;w=1664&amp;auto=format&amp;fit=crop"/>
<div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<button className="bg-white text-black h-10 w-10 flex items-center justify-center rounded-full hover:bg-black hover:text-white transition-colors">
<iconify-icon icon="lucide:plus" strokeWidth="1.5" width="20"></iconify-icon>
</button>
...
<div className="flex-none w-[280px] md:w-[400px] group cursor-pointer">
<div className="relative aspect-[3/4] overflow-hidden mb-6 bg-luxury-grey/30">
<img alt="Trousers" className="w-full h-full object-cover transition duration-700 ease-in-out group-hover:scale-105" src="https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&amp;w=1588&amp;auto=format&amp;fit=crop"/>
<div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<button className="bg-white text-black h-10 w-10 flex items-center justify-center rounded-full hover:bg-black hover:text-white transition-colors">
<iconify-icon icon="lucide:plus" strokeWidth="1.5" width="20"></iconify-icon>
</button>
...
<img alt="Background Texture" className="w-full h-full object-cover grayscale" src="https://images.unsplash.com/photo-1500917293891-ef795e70e1f6?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
</div>
...
<img alt="Detail" className="w-full h-full object-cover opacity-90 hover:scale-110 transition duration-[1.5s]" src="https://images.unsplash.com/photo-1620799140188-3b2a02fd9a77?q=80&amp;w=1572&amp;auto=format&amp;fit=crop"/>
</div>
</div>
</div>
</section>

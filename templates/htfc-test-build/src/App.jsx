...
<img alt="HTFC Logo" className="w-10 h-10 object-contain group-hover:scale-110 transition-transform duration-300" src="https://htfc.co.uk/wp-content/uploads/2024/05/htfc-badge-2-hi-res-trans.png"/>
<div className="flex flex-col">
<span className="font-display font-semibold tracking-tight text-white leading-none">HEDNESFORD TOWN</span>
<span className="text-[10px] text-red-500 tracking-[0.2em] font-medium">EST. 1880</span>
</div>
</div>
...
<a className="hover:text-white transition-colors flex items-center gap-1" href="#">CLUB <i className="w-3 h-3" data-lucide="chevron-down"></i></a>
<a className="hover:text-white transition-colors flex items-center gap-1" href="#">TEAMS <i className="w-3 h-3" data-lucide="chevron-down"></i></a>
<a className="hover:text-white transition-colors" href="#">TICKETS</a>
<a className="hover:text-white transition-colors text-red-500" href="#">SHOP</a>
...
<span className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse"></span> Club Shop Christmas Opening Times</span>
<span className="hover:text-white cursor-pointer transition-colors">Read More -&gt;</span>
</div>
</div>
</nav>
...
<h1 className="text-[12vw] leading-[0.85] font-display font-semibold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-neutral-600 mix-blend-overlay">
                WE ARE<br/>THE PITMEN
            </h1>
<p className="mt-8 text-neutral-400 max-w-md text-sm md:text-base font-light tracking-wide">
                KEYS PARK STADIUM <span className="mx-2 text-red-600">•</span> ESTABLISHED 1880
            </p>

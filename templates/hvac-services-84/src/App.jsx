...
<span className="text-xl font-semibold tracking-tighter text-slate-900">AM</span>
</a>
...
<p className="text-base sm:text-lg text-slate-400 max-w-2xl mb-10 font-normal leading-relaxed">
                    24/7 emergency repairs, furnace &amp; AC installs, and expert service you can trust. Locally owned and operated in Ottawa.
                </p>
...
<a className="w-full sm:w-auto bg-transparent text-white px-6 py-3 rounded-md text-sm font-medium border border-slate-700 flex items-center justify-center gap-2 hover:bg-slate-800 transition-colors" href="https://clienthub.getjobber.com/hubs/bd7dc0fc-bd4f-4830-826b-5f2f7f44c802/public/requests/2763892/new" rel="noopener noreferrer" target="_blank">
                        Request Service
                    </a>
</div>
...
<h2 className="text-3xl font-semibold tracking-tight text-slate-900 mb-4">Expert HVAC Ottawa Services</h2>
<p className="text-base text-slate-500 font-normal">Comprehensive heating, cooling, and ventilation solutions designed for Canadian weather.</p>
</div>
...
<h3 className="text-xl font-medium tracking-tight text-slate-900 mb-2">Furnace Repair &amp; Install</h3>
<p className="text-sm text-slate-500 mb-6 font-normal leading-relaxed">Stay warm with high-efficiency furnace installation Ottawa trusts, plus rapid diagnostics and repair for all makes.</p>
...
<h3 className="text-xl font-medium tracking-tight text-slate-900 mb-2">AC Repair &amp; Install</h3>
<p className="text-sm text-slate-500 mb-6 font-normal leading-relaxed">Beat the summer heat. We provide full-service AC repair Ottawa residents rely on, along with premium central air upgrades.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 hover:text-slate-600 transition-colors" href="https://clienthub.getjobber.com/hubs/bd7dc0fc-bd4f-4830-826b-5f2f7f44c802/public/requests/2763892/new" rel="noopener noreferrer" target="_blank">
                            Book Now <iconify-icon icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
</div>
...
<div className="group border border-slate-200 rounded-xl p-8 hover:border-slate-300 hover:shadow-sm transition-all bg-slate-50/50">
<div className="w-12 h-12 bg-white border border-slate-200 rounded-lg flex items-center justify-center mb-6 text-slate-900 shadow-sm">
<iconify-icon className="text-2xl" icon="solar:home-wifi-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h3 className="text-xl font-medium tracking-tight text-slate-900 mb-2">Heat Pumps</h3>
<p className="text-sm text-slate-500 mb-6 font-normal leading-relaxed">Energy-efficient heating and cooling in one system. Expert guidance on rebates and professional installation.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 hover:text-slate-600 transition-colors" href="https://clienthub.getjobber.com/hubs/bd7dc0fc-bd4f-4830-826b-5f2f7f44c802/public/requests/2763892/new" rel="noopener noreferrer" target="_blank">
                            Book Now <iconify-icon icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
</div>

<div className="group border border-slate-200 rounded-xl p-8 hover:border-slate-300 hover:shadow-sm transition-all bg-slate-50/50 lg:col-span-2">
...
<div>
<h3 className="text-xl font-medium tracking-tight text-slate-900 mb-2">Emergency HVAC Service</h3>
<p className="text-sm text-slate-500 mb-4 font-normal leading-relaxed">No heat? AC failed? Our technicians are standing by 24/7 for emergency HVAC Ottawa calls to restore your comfort immediately.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium text-red-600 hover:text-red-700 transition-colors" href="tel:6138788381">
                                    Call 613-878-8381 Now <iconify-icon icon="solar:phone-calling-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
</div>
</div>
</div>
...
<h3 className="text-xl font-medium tracking-tight text-slate-900 mb-2">Maintenance Plans</h3>
<p className="text-sm text-slate-500 mb-6 font-normal leading-relaxed">Preventative care to extend equipment life, lower energy bills, and ensure peak performance year-round.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 hover:text-slate-600 transition-colors" href="https://clienthub.getjobber.com/hubs/bd7dc0fc-bd4f-4830-826b-5f2f7f44c802/public/requests/2763892/new" rel="noopener noreferrer" target="_blank">
                            View Plans <iconify-icon icon="solar:arrow-right-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</a>
</div>
</div>
</div>
...
<h2 className="text-3xl font-semibold tracking-tight text-slate-900 mb-6">Why Choose AIRMECHANICS</h2>
<p className="text-base text-slate-500 font-normal mb-10 leading-relaxed">
                            We know that HVAC issues disrupt your life. That's why we've built our company around speed, transparency, and doing the job right the very first time. No shortcuts, just solid mechanics.
                        </p>
...
<div>
<h4 className="text-base font-medium text-slate-900 mb-1">Fast Response Times</h4>
<p className="text-sm text-slate-500 font-normal">We prioritize urgency. When your heat goes out in January, we're already on our way.</p>
</div>
</div>
<div className="flex gap-4">
<div className="w-10 h-10 rounded-full bg-slate-200/50 flex items-center justify-center text-slate-700 shrink-0 mt-1">
...
<div>
<h4 className="text-base font-medium text-slate-900 mb-1">Experienced Technicians</h4>
<p className="text-sm text-slate-500 font-normal">Fully certified, highly trained experts who respect your home and clean up after themselves.</p>
</div>
</div>
<div className="flex gap-4">
<div className="w-10 h-10 rounded-full bg-slate-200/50 flex items-center justify-center text-slate-700 shrink-0 mt-1">
...
<div>
<h4 className="text-base font-medium text-slate-900 mb-1">Transparent Pricing</h4>
<p className="text-sm text-slate-500 font-normal">Upfront quotes before any work begins. No hidden fees, no surprise bills.</p>
</div>
</div>
</div>
</div>
<div className="lg:w-1/2 w-full relative">
<div className="aspect-square max-w-md mx-auto bg-slate-200 rounded-2xl overflow-hidden relative border border-slate-300/50 shadow-sm">
<div className="absolute inset-0 bg-gradient-to-tr from-slate-300 to-slate-100 flex items-center justify-center">
<iconify-icon className="text-6xl text-slate-400" icon="solar:smart-home-linear" style={{strokeWidth: '1.0'}}></iconify-icon>
</div>

<div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm border border-slate-200 p-4 rounded-xl shadow-sm flex items-center gap-3">
...
<p className="text-sm font-medium text-slate-900">Ottawa &amp; Surrounding</p>
</div>
</div>
</div>
</div>
...
<p className="text-base text-slate-500 font-normal">See why homeowners across Ottawa rate us 5 stars for reliability and speed.</p>
</div>
...
<p className="text-sm text-slate-600 font-normal italic mb-6 leading-relaxed">
                                "Our furnace died on the coldest night in January. AIRMECHANICS answered at 2 AM and had a tech out within the hour. Absolute lifesavers. Professional, fast, and fair pricing."
                            </p>
</div>
...
<div className="text-sm font-medium text-slate-900">John D. <span className="text-xs text-slate-400 font-normal ml-1">Ottawa South</span></div>
</div>
</div>
<div className="p-8 border border-slate-200 rounded-xl bg-slate-50/50 flex flex-col justify-between">
<div>
...
<p className="text-sm text-slate-600 font-normal italic mb-6 leading-relaxed">
                                "Booked them for a new AC installation. The crew was incredibly clean, respectful of our property, and explained the new system perfectly. Top tier service."
                            </p>
</div>
<div className="flex items-center gap-3 mt-auto">
...
<div className="text-sm font-medium text-slate-900">Sarah M. <span className="text-xs text-slate-400 font-normal ml-1">Kanata</span></div>
</div>
</div>
<div className="p-8 border border-slate-200 rounded-xl bg-slate-50/50 flex flex-col justify-between">
<div>
...
<p className="text-sm text-slate-600 font-normal italic mb-6 leading-relaxed">
                                "Honest diagnostic. Another company told me I needed a whole new furnace. AIRMECHANICS found a $50 part that needed replacing. Earned a customer for life."
                            </p>
</div>
<div className="flex items-center gap-3 mt-auto">
<div className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-xs font-medium text-slate-600">RT</div>
<div className="text-sm font-medium text-slate-900">Robert T. <span className="text-xs text-slate-400 font-normal ml-1">Orléans</span></div>
</div>
</div>
</div>
</div>
...
<div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mb-6 text-white border border-white/20">
<iconify-icon className="text-3xl" icon="solar:siren-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
</div>
<h2 className="text-3xl sm:text-4xl font-semibold tracking-tight mb-4">HVAC Emergency? We're Available 24/7</h2>
<p className="text-base text-slate-400 mb-8 font-normal max-w-xl">Don't freeze or sweat it out. Our emergency technicians are ready to dispatch anywhere in the Ottawa area immediately.</p>
<a className="bg-white text-slate-900 px-8 py-4 rounded-md text-base font-medium inline-flex items-center gap-3 hover:bg-slate-100 transition-colors shadow-sm w-full sm:w-auto justify-center" href="tel:6138788381">
...
<div>
<h2 className="text-3xl font-semibold tracking-tight mb-4">Request Service</h2>
<p className="text-sm text-slate-400 font-normal mb-8 leading-relaxed">Need reliable HVAC work? Connect with our team quickly to schedule your appointment or receive a quote.</p>
<div className="space-y-6">
...
<a className="text-base font-medium hover:text-slate-200 transition-colors" href="tel:6138788381">613-878-8381</a>
</div>
</div>
<div className="flex items-start gap-4">
...
<a className="text-base font-medium hover:text-slate-200 transition-colors" href="mailto:airmechanicsottawa@gmail.com">airmechanicsottawa@gmail.com</a>
</div>
</div>
<div className="flex items-start gap-4">
...
<p className="text-base font-medium">Ottawa, Kanata, Nepean, Orléans, Barrhaven</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl font-semibold tracking-tight text-slate-900 mb-4">Book Your Service Online</h3>
<p className="text-base text-slate-500 mb-8 max-w-md mx-auto leading-relaxed">
                            We use Jobber to manage our quotes and bookings securely. Click below to open our portal and request your service instantly.
                        </p>
...
<span className="text-xl font-semibold tracking-tighter text-slate-900">AM</span>
<span className="text-sm text-slate-500 font-medium border-l border-slate-300 pl-2 ml-1">AIRMECHANICS</span>
</div>

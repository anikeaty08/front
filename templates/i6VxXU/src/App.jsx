...
<div className="w-16 h-16 rounded-full bg-indigo-900/50 flex items-center justify-center mr-4">
<span className="text-indigo-400 font-bold text-2xl">AJ</span>
</div>
<div>
<h2 className="text-white font-bold text-xl">Alex Johnson</h2>
<p className="text-gray-400">alex.johnson@example.com</p>
</div>
<button className="ml-auto p-2 bg-gray-800 rounded-full">
...
<div className="mb-6">
<h3 className="text-gray-400 text-sm font-medium mb-2">Account</h3>
<div className="bg-gray-800 rounded-xl overflow-hidden">
<a className="flex items-center justify-between p-4 border-b border-gray-700" href="#">
...
<div className="mb-6">
<h3 className="text-gray-400 text-sm font-medium mb-2">App Settings</h3>
<div className="bg-gray-800 rounded-xl overflow-hidden">
...
<input checked="" className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 border-gray-800 appearance-none cursor-pointer right-0" id="toggle" name="toggle" type="checkbox"/>
<label className="toggle-label block overflow-hidden h-6 rounded-full bg-indigo-600 cursor-pointer" htmlFor="toggle"></label>
</div>
</div>
<div className="flex items-center justify-between p-4 border-b border-gray-700">
<div className="flex items-center">
...
<svg className="h-5 w-5 text-cyan-400" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<button className="w-full bg-gray-800 hover:bg-gray-700 text-red-500 font-medium py-4 px-4 rounded-xl transition duration-200 mb-20">
          Log Out
        </button>
</div>

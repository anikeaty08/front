...
<header className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden hero-bg">
...
<h1 className="text-5xl md:text-7xl font-medium text-white tracking-tight leading-[1.1] mb-6">
                    Autonomous systems for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500 glow-text">precision industry.</span>
</h1>

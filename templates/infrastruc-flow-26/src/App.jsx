...
<div className="relative w-full max-w-[1200px] h-screen flex items-center justify-center pointer-events-none">

<div className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300/50 to-transparent -translate-y-1/2 z-0"></div>

<div className="absolute top-1/2 left-1/2 -mt-[135px] -ml-[115px] w-[230px] h-[270px] z-30 flex flex-col items-center justify-center">

<div className="absolute inset-0 bg-[#FFFFFF] rounded-[2.1rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.03)] z-10"></div>
...
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-16 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-12 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 flex-1 bg-gray-200 rounded-full"></div></div>
</div>
</div>
...
<div className="space-y-2 font-mono text-xs">
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-12 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-10 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 flex-1 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
...
<div className="space-y-2 font-mono text-xs">
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-20 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-16 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 w-12 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
<div className="text-xs text-gray-400 tracking-tight">Verified by payment processor at treasury platform</div>
<div className="text-xs text-gray-400/60 font-mono mt-0.5">via Humanos API</div>
</div>
</div>
</div>
...
<div className="space-y-2 font-mono text-xs">
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-14 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-20 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 w-10 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
...
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-16 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 flex-1 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 w-14 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
<div className="text-xs text-gray-400 tracking-tight">Verified by underwriting workflow at insurer platform</div>
<div className="text-xs text-gray-400/60 font-mono mt-0.5">via Humanos API</div>
</div>
</div>
</div>
...
<div className="space-y-2 font-mono text-xs">
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-10 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-12 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 w-16 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
...
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-14 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-10 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 w-20 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">
...
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">identity</span><div className="h-1.5 flex-1 data-shimmer rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-[#E4D8C8] w-16 text-right">action</span><div className="h-1.5 w-16 bg-gray-700 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">rules</span><div className="h-1.5 w-14 bg-gray-300 rounded-full"></div></div>
<div className="flex items-center gap-3"><span className="text-gray-400 w-16 text-right">context</span><div className="h-1.5 flex-1 bg-gray-200 rounded-full"></div></div>
</div>
</div>
<div className="absolute top-full mt-3.5 w-max text-center pointer-events-none opacity-[0.92]">

...
<div className="fade-in-up inline-flex gap-2 text-xs font-medium text-slate-600 bg-slate-50 border-slate-200 border rounded-full mb-4 pt-1 pr-3 pb-1 pl-3 gap-x-2 gap-y-2 items-center" style={{}}>Accepting limited new clients for Q1 2026<span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span></div>

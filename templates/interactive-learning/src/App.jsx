...
<svg aria-hidden="true" className="iconify w-4 h-4 iconify--solar" data-icon="solar:alt-arrow-left-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M11.596 8.303L8.165 11.63a.5.5 0 0 0 0 .74l6.63 6.43c.414.401 1.205.158 1.205-.37v-5.723z" fill="currentColor"></path><path d="M16 11.293V5.57c0-.528-.791-.771-1.205-.37l-2.482 2.406z" fill="currentColor" opacity=".5"></path></svg>
...
<img alt="Attendee avatar" className="h-9 w-9 rounded-full border border-neutral-900 object-cover" src="https://images.unsplash.com/photo-1525134479668-1bee5c7c6845?auto=format&amp;fit=crop&amp;w=200&amp;q=80"/>
<img alt="Attendee avatar" className="h-9 w-9 rounded-full border border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dbf5085e-0341-4243-aa8f-73a531c46290_320w.webp"/>
<img alt="Attendee avatar" className="h-9 w-9 rounded-full border border-neutral-900 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e57b7081-23fd-4dd7-981e-59fc4fda47dc_320w.webp"/>
</div>
...
<svg aria-hidden="true" className="iconify w-4 h-4 iconify--solar" data-icon="solar:cloud-upload-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 18v-.09c0-.865 0-1.659.087-2.304c.095-.711.32-1.463.938-2.08c.618-.619 1.37-.844 2.08-.94c.646-.086 1.44-.086 2.306-.086h.178c.866 0 1.66 0 2.305.087c.711.095 1.463.32 2.08.938c.619.618.844 1.37.94 2.08c.085.637.086 1.416.086 2.267c2.573-.55 4.5-2.812 4.5-5.52c0-2.47-1.607-4.572-3.845-5.337C17.837 4.194 15.415 2 12.476 2C9.32 2 6.762 4.528 6.762 7.647c0 .69.125 1.35.354 1.962a4.4 4.4 0 0 0-.83-.08C3.919 9.53 2 11.426 2 13.765S3.919 18 6.286 18z" fill="currentColor" opacity=".5"></path><path clip-rule="evenodd" d="M12 14c-1.886 0-2.828 0-3.414.586S8 16.114 8 18s0 2.828.586 3.414S10.114 22 12 22s2.828 0 3.414-.586S16 19.886 16 18s0-2.828-.586-3.414S13.886 14 12 14m1.805 3.084l-1.334-1.333a.667.667 0 0 0-.942 0l-1.334 1.333a.667.667 0 1 0 .943.943l.195-.195v1.946a.667.667 0 0 0 1.334 0v-1.946l.195.195a.667.667 0 0 0 .943-.943" fill="currentColor" fill-rule="evenodd"></path></svg>
<span>Upload</span>
</button>
</div>
</div>
...
<img alt="Student portrait" className="w-full h-80 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/89c17836-ca19-4c7c-9bb2-b8a36b6a0bde_800w.webp"/>
...
<svg aria-hidden="true" className="iconify w-4 h-4 iconify--solar" data-icon="solar:menu-dots-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M7 12a2 2 0 1 1-4 0a2 2 0 0 1 4 0m14 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0" fill="currentColor"></path><path d="M14 12a2 2 0 1 1-4 0a2 2 0 0 1 4 0" fill="currentColor" opacity=".5"></path></svg>
</button>
</div>
</div>
...
<svg aria-hidden="true" className="iconify w-5 h-5 translate-x-[1px] iconify--solar" data-icon="solar:play-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M23 12c0-1.035-.53-2.07-1.591-2.647L8.597 2.385C6.534 1.264 4 2.724 4 5.033V12z" fill="currentColor" fill-rule="evenodd"></path><path d="m8.597 21.615l12.812-6.968A2.99 2.99 0 0 0 23 12H4v6.967c0 2.31 2.534 3.769 4.597 2.648" fill="currentColor" opacity=".5"></path></svg>
</button>
...
<svg aria-hidden="true" className="iconify iconify--solar w-[16px] h-[16px]" data-icon="solar:phone-calling-rounded-bold-duotone" data-icon-replaced="true" data-icon-set="solar" data-solar="eye-bold-duotone" height="16" role="img" strokeWidth="2" style={{color: 'rgb(212, 212, 212)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M2 12c0 1.64.425 2.191 1.275 3.296C4.972 17.5 7.818 20 12 20s7.028-2.5 8.725-4.704C21.575 14.192 22 13.639 22 12c0-1.64-.425-2.191-1.275-3.296C19.028 6.5 16.182 4 12 4S4.972 6.5 3.275 8.704C2.425 9.81 2 10.361 2 12" fill="#d4d4d4" opacity=".5"></path><path clip-rule="evenodd" d="M8.25 12a3.75 3.75 0 1 1 7.5 0a3.75 3.75 0 0 1-7.5 0m1.5 0a2.25 2.25 0 1 1 4.5 0a2.25 2.25 0 0 1-4.5 0" fill="#d4d4d4" fill-rule="evenodd"></path></svg>
</button>
<button className="flex hover:bg-neutral-700 transition outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-emerald-500/80 bg-neutral-800 w-10 h-10 rounded-full items-center justify-center" type="button">
<svg aria-hidden="true" className="iconify iconify--solar w-[16px] h-[16px]" data-icon="solar:phone-calling-rounded-bold-duotone" data-icon-replaced="true" height="1em" role="img" strokeWidth="2" style={{color: 'rgb(212, 212, 212)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path className="" d="m10.038 5.316l.649 1.163c.585 1.05.35 2.426-.572 3.349c0 0-1.12 1.119.91 3.148c2.027 2.027 3.146.91 3.147.91c.923-.923 2.3-1.158 3.349-.573l1.163.65c1.585.884 1.772 3.106.379 4.5c-.837.836-1.863 1.488-2.996 1.53c-1.908.073-5.149-.41-8.4-3.66c-3.25-3.251-3.733-6.492-3.66-8.4c.043-1.133.694-2.159 1.53-2.996c1.394-1.393 3.616-1.206 4.5.38" fill="currentColor" opacity=".5"></path><path d="M13.26 1.88a.75.75 0 0 1 .861-.62c.025.005.107.02.15.03q.129.027.352.09c.297.087.712.23 1.21.458c.996.457 2.321 1.256 3.697 2.631c1.376 1.376 2.175 2.702 2.632 3.698c.228.498.37.912.457 1.21a6 6 0 0 1 .113.454l.005.031a.765.765 0 0 1-.617.878a.75.75 0 0 1-.86-.617a3 3 0 0 0-.081-.327a7.4 7.4 0 0 0-.38-1.004c-.39-.85-1.092-2.024-2.33-3.262s-2.411-1.939-3.262-2.329a7.4 7.4 0 0 0-1.003-.38a6 6 0 0 0-.318-.08a.76.76 0 0 1-.626-.861" fill="currentColor"></path><path clip-rule="evenodd" d="M13.486 5.33a.75.75 0 0 1 .927-.516l-.206.721l.206-.72h.003l.003.001l.008.002l.02.006l.056.02q.067.023.177.07c.146.062.345.158.59.303c.489.29 1.157.77 1.942 1.556c.785.785 1.266 1.453 1.556 1.942c.145.245.241.444.303.59a3 3 0 0 1 .09.233l.005.02l.003.008v.003l.001.001s0 .002-.72.208l.72-.206a.75.75 0 0 1-1.439.422l-.003-.01l-.035-.088a4 4 0 0 0-.216-.417c-.223-.376-.626-.946-1.326-1.646s-1.269-1.102-1.646-1.325a4 4 0 0 0-.504-.25l-.01-.004a.75.75 0 0 1-.505-.925" fill="currentColor" fill-rule="evenodd"></path></svg>
</button>
...
<svg aria-hidden="true" className="iconify iconify--solar w-[16px] h-[16px]" data-icon="solar:widget-3-bold-duotone" data-icon-replaced="true" height="1em" role="img" strokeWidth="2" style={{color: 'rgb(212, 212, 212)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g className="" clip-rule="evenodd" fill="currentColor" fill-rule="evenodd"><path d="M22.25 6.5a4.75 4.75 0 1 0-9.5 0a4.75 4.75 0 0 0 9.5 0m-11 11a4.75 4.75 0 1 0-9.5 0a4.75 4.75 0 0 0 9.5 0"></path><path className="" d="M1.75 6.5a4.75 4.75 0 1 1 9.5 0a4.75 4.75 0 0 1-9.5 0m11 11a4.75 4.75 0 1 1 9.5 0a4.75 4.75 0 0 1-9.5 0" opacity=".5"></path></g></svg>
</button>
</div>
</div>
...
<button className="h-8 w-8 flex items-center justify-center rounded-full bg-neutral-900 border border-neutral-800 text-neutral-300 hover:bg-neutral-800 transition outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-emerald-500/80" type="button">
<svg aria-hidden="true" className="iconify iconify--solar w-[16px] h-[16px]" data-icon="solar:phone-calling-rounded-bold-duotone" data-icon-replaced="true" data-icon-set="solar" data-solar="sort-horizontal-bold-duotone" height="16" role="img" strokeWidth="2" style={{color: 'rgb(212, 212, 212)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M10.875 4a.75.75 0 0 0-1.272-.538l-4.125 4a.75.75 0 0 0 0 1.076l4.125 4A.75.75 0 0 0 10.875 12V8.75H18a.75.75 0 0 0 0-1.5h-7.125z" fill="#d4d4d4"></path><path d="M13.125 12a.75.75 0 0 1 1.272-.538l4.125 4a.75.75 0 0 1 0 1.076l-4.125 4A.75.75 0 0 1 13.125 20v-3.25H6a.75.75 0 0 1 0-1.5h7.125z" fill="#d4d4d4" opacity=".5"></path></svg>
</button>
</div>
</div>
...
<img alt="Instructor portrait" className="h-16 w-16 rounded-full object-cover border border-neutral-800" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aa213242-cfaa-4e7a-8277-f98114018a97_320w.webp"/>
<div className="">

...
<a className="group relative block p-[1px] rounded-3xl bg-gradient-to-br from-white/10 to-white/0 hover:from-white/20 hover:to-white/5 transition-all duration-500 animate-on-scroll delay-300" href="#">
<div className="relative h-full bg-neutral-900/80 backdrop-blur-xl rounded-[23px] p-6 md:p-8 flex flex-col md:flex-row gap-6 items-center border border-white/5 group-hover:border-transparent transition-colors overflow-hidden">
<div className="absolute -right-20 -top-20 w-64 h-64 bg-white/5 rounded-full blur-[80px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white shrink-0 group-hover:scale-110 group-hover:bg-white/10 group-hover:text-white group-hover:border-white/30 transition-all duration-500 z-10">
...
<div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group cursor-default">
<iconify-icon className="text-emerald-500 mb-4 text-2xl group-hover:scale-110 transition-transform duration-300" icon="solar:heart-pulse-bold"></iconify-icon>
<h5 className="text-white font-medium mb-1 text-sm">Bio-Stasis</h5>
<p className="text-xs text-neutral-500 leading-relaxed font-light">
                  Full medical coverage including cryo-preservation.
                </p>
</div>
<div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group cursor-default">
<iconify-icon className="text-blue-500 mb-4 text-2xl group-hover:scale-110 transition-transform duration-300" icon="solar:graph-new-bold"></iconify-icon>
<h5 className="text-white font-medium mb-1 text-sm">Equity</h5>
<p className="text-xs text-neutral-500 leading-relaxed font-light">
                  Shares in high-yield asteroid mining ops.
                </p>
</div>
<div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group cursor-default">
<iconify-icon className="text-purple-500 mb-4 text-2xl group-hover:scale-110 transition-transform duration-300" icon="solar:rocket-bold"></iconify-icon>
<h5 className="text-white font-medium mb-1 text-sm">Transit</h5>
<p className="text-xs text-neutral-500 leading-relaxed font-light">
                  Unlimited orbital transits for family.
                </p>
</div>
<div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group cursor-default">
<iconify-icon className="text-amber-500 mb-4 text-2xl group-hover:scale-110 transition-transform duration-300" icon="solar:cup-hot-bold"></iconify-icon>
<h5 className="text-white font-medium mb-1 text-sm">Supplies</h5>
<p className="text-xs text-neutral-500 leading-relaxed font-light">
                  Premium synthetic rations and supplements.
                </p>
</div>
</div>
</div>

<div className="lg:col-span-4 lg:pl-8 animate-on-scroll delay-500">
<div className="sticky top-32 p-8 rounded-3xl bg-neutral-900/50 backdrop-blur-md border border-white/5 shadow-2xl">
...
<iconify-icon className="text-emerald-400 opacity-0 peer-checked:opacity-100 transition-opacity text-xs" icon="solar:check-read-linear" width="14"></iconify-icon>
</div>
...
<input checked="" className="peer appearance-none absolute inset-0 w-full h-full cursor-pointer" name="location" type="radio"/>
...
<label className="flex items-center gap-3 cursor-pointer group">
<div className="relative w-5 h-5 rounded-full border border-white/20 group-hover:border-white/50 bg-white/5 flex items-center justify-center transition-colors">
<input className="peer appearance-none absolute inset-0 w-full h-full cursor-pointer" name="location" type="radio"/>
<div className="w-2 h-2 bg-white rounded-full opacity-0 peer-checked:opacity-100 transition-opacity shadow-[0_0_10px_rgba(255,255,255,0.5)]"></div>
</div>
<span className="text-sm text-neutral-400 group-hover:text-white transition-colors font-light">
                      Earth HQ
...
<section className="text-white bg-neutral-950 border-white/5 border-t pt-32 pr-6 pb-32 pl-6 relative" id="methodology">
...
<h2 className="text-4xl md:text-5xl font-bricolage font-light text-white mb-6">
            The Trajectory
          </h2>
<p className="text-white/50 text-lg max-w-xl font-light">
            Precision is not an option; it is a requirement for survival in the
            vacuum. Every sequence is calculated.
          </p>
</div>
...
<div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 text-white flex items-center justify-center mb-6 group-hover:bg-white group-hover:text-neutral-950 transition-colors">
<iconify-icon className="" icon="solar:star-fall-linear" width="28"></iconify-icon>
</div>
<span className="block text-xs font-semibold text-white/40 mb-2 uppercase tracking-wider">
              T-Minus
            </span>
<h3 className="text-xl font-bricolage font-medium mb-3 text-white">
              Simulation
            </h3>
<p className="text-sm text-white/50 leading-relaxed">
              Modeling every variable of the cosmic environment before hardware
              is even forged.
            </p>
</div>
...
<p className="text-sm text-white/50 leading-relaxed">
              Breaking the terrestrial bonds. Raw energy focused into a vertical
              escape vector.
            </p>
</div>
...
<div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 text-white flex items-center justify-center mb-6 group-hover:bg-white group-hover:text-neutral-950 transition-colors">
<iconify-icon className="" icon="solar:route-linear" width="28"></iconify-icon>
</div>
<span className="block text-xs font-semibold text-white/40 mb-2 uppercase tracking-wider">
              Cruise
            </span>
...
<p className="text-sm text-white/50 leading-relaxed">
              Silent navigation through the void. Systems operating at peak
              autonomy.
            </p>
</div>
...
<div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 text-white flex items-center justify-center mb-6 group-hover:bg-white group-hover:text-neutral-950 transition-colors">
<iconify-icon icon="solar:flag-linear" width="28"></iconify-icon>
</div>
<span className="block text-xs font-semibold text-white/40 mb-2 uppercase tracking-wider">
              Arrival
            </span>
...
<p className="text-sm text-white/50 leading-relaxed">
              Establishing a permanent foothold on new soil. The mission begins
              anew.
            </p>
</div>
</div>
<div className="mt-20 text-center animate-on-scroll">
<a className="inline-flex items-center gap-2 text-white border-b border-white pb-0.5 hover:text-white/70 hover:border-white/70 transition-colors" href="#">
...
<section className="overflow-hidden bg-neutral-950 z-20 border-white/10 border-t pt-24 pb-24 relative" style={{maskImage: 'linear-gradient(90deg, transparent, black 50%, black 50%, transparent)', WebkitMaskImage: 'linear-gradient(90deg, transparent, black 50%, black 50%, transparent)'}}>
<div className="max-w-7xl mx-auto px-6 mb-12 flex items-center gap-4 animate-on-scroll">
...
<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
<div className="flex items-center gap-3 mb-4 text-white/40 text-xs font-mono">
<iconify-icon className="" icon="solar:radio-minimalistic-linear"></iconify-icon>
<span className="">Station Alpha • 2m ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Docking sequence complete for Ares-7. Payload secured. Crew
              vitals normal."
            </p>
</div>
<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
...
<span>Lunar Relay • 15m ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Solar flare activity subsiding. Communication channels restored
              to 100%."
            </p>
</div>
<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
...
<span className="">Cmdr. Vance • 1h ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Visual on the anomaly. It's beautiful. Sending telemetry now."
            </p>
</div>
<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
<div className="flex items-center gap-3 mb-4 text-white/40 text-xs font-mono">
<iconify-icon icon="solar:box-linear"></iconify-icon>
<span>Logistics AI • 2h ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Route optimization complete. Saving 3 weeks of travel time to
              Jupiter."
            </p>
</div>
<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
<div className="flex items-center gap-3 mb-4 text-white/40 text-xs font-mono">
<iconify-icon icon="solar:shield-linear"></iconify-icon>
<span>Security • 4h ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Perimeter breach test negative. Systems green."
            </p>
</div>

<div className="w-80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
<div className="flex items-center gap-3 mb-4 text-white/40 text-xs font-mono">
<iconify-icon icon="solar:radio-minimalistic-linear"></iconify-icon>
<span>Station Alpha • 2m ago</span>
</div>
<p className="text-white text-sm font-mono leading-relaxed">
              "Docking sequence complete for Ares-7. Payload secured. Crew
              vitals normal."
...
<h2 className="text-2xl font-bricolage font-semibold">ORION</h2>
</div>
<p className="text-white/50 max-w-xs mb-8">
            Connecting humanity across the stars. Building the logistics for a
...
<p className="">© 2024 Velos Group. All rights reserved.</p>
...
<iconify-icon icon="ri:twitter-x-line" width="14"></iconify-icon>
</a>
<a className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all" href="#">
<iconify-icon icon="ri:instagram-line" width="14"></iconify-icon>
</a>
<a className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all" href="#">
<iconify-icon icon="ri:linkedin-fill" width="14"></iconify-icon>
</a>
</div>
</div>
</footer>

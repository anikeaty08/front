...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" id="aura-image" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5d4bd2fc-2ce8-4a3f-9a83-a09824b23ced_3840w.jpg")'}}></div>
...
<p className="font-bold mt-1 text-blue-600 font-sans">¥45,000</p>
</div>
...
<p className="font-bold mt-1 text-blue-600 font-sans">¥28,000</p>
</div>
<button className="w-8 h-8 rounded-full flex items-center justify-center bg-blue-600">
<svg className="lucide lucide-plus w-4 h-4 text-white" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
...
<div className="flex items-center justify-between">
<span className="font-bold text-black font-sans">¥45,000</span>
...
<div className="flex items-center justify-between">
<span className="font-bold text-black font-sans">¥28,500</span>
<button className="w-7 h-7 rounded-full flex items-center justify-center bg-blue-600">
<svg className="lucide lucide-plus w-3 h-3 text-white" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
</div>
...
<div className="flex items-center justify-between">
<span className="font-bold text-black font-sans">¥65,000</span>
<button className="w-7 h-7 rounded-full flex items-center justify-center bg-blue-600">
<svg className="lucide lucide-plus w-3 h-3 text-white" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
</div>
...
<div className="flex items-center justify-between">
<span className="font-bold text-black font-sans">¥185,000</span>
<button className="w-7 h-7 rounded-full flex items-center justify-center bg-blue-600">
<svg className="lucide lucide-plus w-3 h-3 text-white" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</button>
</div>
...
<p className="font-medium text-blue-600 font-sans">MONARK</p>
</div>
<div className="text-right">
<span className="sf-display text-2xl text-black font-sans font-semibold">¥45,000</span>
<p className="line-through text-sm text-gray-500 font-sans">¥52,000</p>
</div>
</div>

...
<iconify-icon className="text-3xl transition-transform group-hover:scale-110" icon="solar:satellite-linear"></iconify-icon>
<span className="text-xl tracking-tighter lowercase font-jakarta font-medium">ioty<span className="opacity-50">.com</span></span>
</a>
<div className="hidden md:flex items-center gap-10 text-sm font-medium tracking-tight opacity-70">
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Discover</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">For Startups</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">For Investors</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Curation Process</a>
</div>
<div className="flex items-center gap-5">
<a className="hidden md:block text-sm font-medium opacity-70 hover:opacity-100 transition-opacity font-geist uppercase" href="#">Investor Login</a>
...
<span className="">IoT Intelligence Platform</span>
...
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.45s'}}>o</span></span>
<span className="clip-text-container"><span className="animate-letter font-light font-jakarta" style={{animationDelay: '0.5s'}}>T</span></span>
</span>

<span className="flex text-black/90">
...
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.65s'}}>n</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.7s'}}>o</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.75s'}}>v</span></span>
...
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.85s'}}>t</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.9s'}}>i</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.95s'}}>o</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '1.0s'}}>n</span></span>
</span>
</h1>
...
<p className="text-base opacity-70 font-normal leading-relaxed font-geist">
                        Discover emerging startups, evaluate breakthrough technologies, and connect with verified founders.
                    </p>
</div>
<div className="max-w-sm flex flex-col items-start md:items-end text-left md:text-right gap-6">
<p className="text-base opacity-70 font-normal leading-relaxed font-geist">
                        The authoritative source for IoT innovation intelligence and investor matchmaking globally.
                    </p>
...
<span className="font-geist uppercase">Investor Access</span>
<iconify-icon className="text-lg" icon="solar:arrow-right-up-linear"></iconify-icon>
</a>
<a className="text-sm font-medium opacity-70 hover:opacity-100 transition-opacity font-geist uppercase border-b border-black/20 pb-1" href="#">Submit Startup</a>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3 font-geist"><span>01</span> STARTUP DISCOVERY</div>
<div className="flex items-center gap-3 md:justify-center font-geist"><span>02</span> VERIFIED FOUNDERS</div>
<div className="flex items-center gap-3 md:justify-end font-geist"><span>03</span> INVESTOR MATCHMAKING</div>
</div>
</div>
</section>
...
<p className="text-center text-xs font-geist uppercase tracking-widest opacity-40 mb-8">Trusted by leading VCs and Tech Scouts</p>
<div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-40 grayscale hover:grayscale-0 transition-all duration-700 text-2xl font-jakarta font-light tracking-tighter">
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon icon="solar:chart-bold-duotone"></iconify-icon> Sequoia IoT</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:cpu-bold-duotone"></iconify-icon> Intel Capital</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:rocket-bold-duotone"></iconify-icon> TechStars</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2 hidden sm:flex"><iconify-icon className="" icon="solar:eye-bold-duotone"></iconify-icon> Vision Fund</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2 hidden md:flex"><iconify-icon className="" icon="solar:plug-circle-bold-duotone"></iconify-icon> Plug &amp; Play</div>
</div>
</div>
</section>
...
<span className="font-jakarta font-light uppercase">Industrial IoT</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Smart Cities &amp; Grid</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Edge AI &amp; Computing</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Connected Healthcare</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Autonomous Systems</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Industrial IoT</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
</div>
...
<h2 className="text-5xl md:text-6xl tracking-tighter font-jakarta font-light">Uncover the next<br/>breakthrough.</h2>
</div>
...
<span className="px-3 py-1 bg-white/80 backdrop-blur text-xs font-geist uppercase tracking-widest rounded-full">Data Room UI</span>
</div>
</div>
</div>
</div>
...
<iconify-icon className="text-6xl opacity-20 group-hover:opacity-60 transition-opacity" icon="solar:users-group-two-rounded-linear"></iconify-icon>
<p className="text-xs font-geist uppercase tracking-widest opacity-50 mt-4">Connect Platform</p>
</div>
</div>
</div>
...
<div className="absolute w-32 h-20 border border-black/20 rounded-lg rotate-6 bg-white shadow-sm left-4 transition-transform group-hover:rotate-12 group-hover:-translate-y-1 flex items-center justify-center px-3">
<iconify-icon className="text-2xl text-black/40" icon="solar:document-text-linear"></iconify-icon>
</div>
</div>
</div>
</div>
...
</section><section className="section-container py-32">
<div className="max-w-[88rem] mx-auto px-6 lg:px-12">

<div className="mb-20 max-w-3xl">
<h2 className="text-4xl md:text-5xl lg:text-6xl tracking-tighter font-jakarta font-light text-[#2C2824] mb-6">
                Purpose-built for the<br/>IoT ecosystem.
            </h2>
<p className="text-lg md:text-xl opacity-70 font-normal leading-relaxed font-geist max-w-2xl text-[#2C2824]">
                Tools designed to facilitate discovery, deep due diligence, and deal flow for both hardware and software innovations globally.
            </p>
</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-md leading-tight text-[#2C2824]">
                            Evaluate connected devices and scalable platforms
                        </h3>
...
<iconify-icon className="text-4xl text-[#2C2824] opacity-80" icon="solar:cpu-bold-duotone"></iconify-icon>
</div>
<div className="text-center space-y-1 mb-8">
<p className="text-xs font-geist text-gray-500 uppercase tracking-widest">Company: Sensara</p>
<h4 className="text-3xl font-jakarta font-semibold tracking-tighter">$2.5M Seed</h4>
</div>
<div className="mt-auto space-y-3">
<div className="h-12 w-full bg-black text-white rounded-xl flex items-center justify-center font-medium text-sm font-geist">View Pitch Deck</div>
<div className="h-12 w-full border border-gray-200 rounded-xl flex items-center justify-center font-medium text-sm text-gray-500 font-geist">Request Intro</div>
</div>
</div>
</div>
</div>
...
<div className="mx-auto h-5 w-40 bg-gray-100 rounded text-[10px] text-gray-400 flex items-center justify-center font-geist">ioty.com/startup/sensara</div>
</div>
<div className="p-6 space-y-4">
<div className="flex gap-4 mb-6">
<div className="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400"><iconify-icon className="text-2xl" icon="solar:gallery-bold"></iconify-icon></div>
<div className="">
...
<div className="h-10 w-full border border-gray-200 rounded-lg px-3 flex items-center text-sm text-gray-800 font-geist">investor@vcfirm.com</div>
<div className="grid grid-cols-2 gap-3">
<div className="h-10 bg-[#05C168] rounded-lg flex items-center justify-center text-white text-xs font-bold font-geist">Data Room</div>
<div className="h-10 bg-black rounded-lg flex items-center justify-center text-white text-xs font-bold font-geist">Message</div>
</div>
</div>
</div>
</div>
...
<div>
<div className="text-sm font-semibold font-jakarta text-[#2C2824]">Deal Room</div>
<div className="text-xs text-gray-500 font-geist">Active Q3 Pipeline</div>
</div>
</div>
<div className="mb-2 flex justify-between items-end">
<span className="text-xs text-gray-500 font-geist">Due Diligence Progress</span>
...
<div className="text-[10px] uppercase tracking-wider text-gray-400 font-geist mb-3">Startups Evaluated (30d)</div>
<div className="text-2xl font-jakarta font-medium tracking-tight mb-4">142</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[240px] text-[#2C2824]">
                            AI-assisted technology scouting
                        </h3>
<div className="w-8 h-8 rounded-full bg-black/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
<iconify-icon className="text-lg opacity-60" icon="solar:maximize-square-minimalistic-linear"></iconify-icon>
</div>
...
<p className="">Find me seed-stage startups in industrial predictive maintenance.</p>
</div>
...
<p className="mb-1.5">Based on your thesis, here are 3 verified matches:</p>
</div>
...
<span className="px-2 py-1 rounded-md text-[8px] font-semibold uppercase tracking-wider text-[#2C2824] bg-white/90 shadow-sm backdrop-blur-sm font-geist">98% Match</span>
...
<h3 className="text-base font-light text-white tracking-tight font-jakarta leading-tight">MechSense</h3>
<span className="text-xs font-medium text-white font-geist">$1.2M</span>
</div>
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Acoustic sensors for heavy machinery monitoring.</p>
...
<iconify-icon className="text-[10px]" icon="solar:letter-linear"></iconify-icon>
                        Request Intro
                    </button>
</div>
</div>
...
<div className="transform transition-transform duration-500 group-hover:translate-y-0 mt-auto translate-y-2">
<div className="flex mb-1 items-end justify-between gap-2">
<h3 className="text-base font-light text-white tracking-tight font-jakarta leading-tight">GridAI</h3>
<span className="text-xs font-medium text-white font-geist">$3M</span>
</div>
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Edge analytics for power grid anomaly detection.</p>
<button className="hover:bg-gray-50 transition-colors flex gap-1.5 text-[9px] font-semibold text-[#2C2824] font-geist bg-white w-full rounded-lg py-1.5 shadow-sm items-center justify-center">
<iconify-icon className="text-[10px]" icon="solar:letter-linear"></iconify-icon>
                        Request Intro
                    </button>
...
<div className="transform transition-transform duration-500 group-hover:translate-y-0 mt-auto translate-y-2">
<div className="flex mb-1 items-end justify-between gap-2">
<h3 className="text-base font-light text-white tracking-tight font-jakarta leading-tight">VibraTech</h3>
<span className="text-xs font-medium text-white font-geist">$800k</span>
</div>
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Low-cost vibration sensors for manufacturing.</p>
<button className="hover:bg-gray-50 transition-colors flex gap-1.5 text-[9px] font-semibold text-[#2C2824] font-geist bg-white w-full rounded-lg py-1.5 shadow-sm items-center justify-center">
<iconify-icon className="text-[10px]" icon="solar:letter-linear"></iconify-icon>
                        Request Intro
                    </button>
...
<div className="w-48 h-72 rounded-2xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 shadow-xl relative z-10 transform rotate-12 group-hover:rotate-[15deg] group-hover:scale-105 transition-all duration-700 ease-out flex flex-col justify-between p-5 overflow-hidden border border-white/10">
...
<iconify-icon className="text-white/80 text-4xl" icon="solar:lock-password-linear"></iconify-icon>
<iconify-icon className="text-white/60 text-xl" icon="solar:document-bold"></iconify-icon>
</div>
<div className="text-white/90 font-jakarta font-medium tracking-widest text-sm relative rotate-90 origin-bottom-left translate-x-8 -translate-y-8 uppercase opacity-50">
                            Confidential
                        </div>
<div className="text-white font-bold text-xl tracking-tighter text-right relative">
                            PITCH DECK
                        </div>
</div>
</div>
...
<div className="flex justify-between items-start mb-6">
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[240px] text-[#2C2824]">
                            Track innovation across global markets
                        </h3>
<div className="w-8 h-8 rounded-full bg-black/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
<iconify-icon className="text-lg opacity-60" icon="solar:maximize-square-minimalistic-linear"></iconify-icon>
</div>
...
<div className="w-4 h-4 rounded-full bg-[#2775CA] flex items-center justify-center text-[8px] text-white font-bold">CN</div>
<span className="text-xs font-medium font-geist text-gray-800">Shenzhen Hub</span>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl md:text-3xl tracking-tighter font-jakarta font-light text-[#2C2824]">
                                Manage your scouting<br/>network
                            </h3>
</div>
<p className="text-sm opacity-60 font-geist leading-relaxed max-w-xs">
                            Orchestrate complex deal flows, track interactions with founders, manage diligence documents, and collaborate with your investment committee.
                        </p>
</div>
...
<iconify-icon className="text-lg" icon="solar:file-check-bold"></iconify-icon>
</div>
<div>
<div className="text-xs font-bold font-jakarta text-gray-900">VitalSense</div>
<div className="text-[10px] text-gray-500 font-geist mb-2">Data room updated</div>
<div className="flex justify-between text-[10px] border-t border-gray-100 pt-2 w-full gap-8">
<span className="text-gray-400">Financials FY23</span>
...
<iconify-icon icon="solar:lock-linear"></iconify-icon> app.ioty.com/pipeline
                                </div>
</div>
<div className="p-6">
<div className="flex justify-between items-end mb-6">
<h4 className="text-sm font-semibold font-jakarta">Active Pipeline</h4>
<button className="text-[10px] bg-black text-white px-3 py-1.5 rounded-full font-geist">Export Report</button>
</div>
...
<div className="w-5 h-5 rounded bg-blue-100 text-blue-600 flex items-center justify-center"><iconify-icon icon="solar:health-linear"></iconify-icon></div>
                                                VitalSense
                                            </td>
<td className="py-3">MedTech</td>
<td className="py-3 text-right font-medium text-gray-900">Seed</td>
<td className="py-3 text-right"><span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block"></span></td>
</tr>
<tr className="group/row">
<td className="py-3 group-hover/row:text-indigo-600 transition-colors flex items-center gap-2">
<div className="w-5 h-5 rounded bg-orange-100 text-orange-600 flex items-center justify-center"><iconify-icon icon="solar:bolt-linear"></iconify-icon></div>
                                                Daybreak Grid
                                            </td>
<td className="py-3">Energy</td>
<td className="py-3 text-right font-medium text-gray-900">Series A</td>
<td className="py-3 text-right"><span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block"></span></td>
</tr>
<tr className="group/row">
<td className="py-3 group-hover/row:text-indigo-600 transition-colors flex items-center gap-2">
<div className="w-5 h-5 rounded bg-purple-100 text-purple-600 flex items-center justify-center"><iconify-icon icon="solar:home-smile-linear"></iconify-icon></div>
                                                Sacred Space
                                            </td>
<td className="py-3">PropTech</td>
<td className="py-3 text-right font-medium text-gray-900">Pre-Seed</td>
...
<td className="py-3 group-hover/row:text-indigo-600 transition-colors flex items-center gap-2">
<div className="w-5 h-5 rounded bg-rose-100 text-rose-600 flex items-center justify-center"><iconify-icon icon="solar:box-linear"></iconify-icon></div>
                                                Jackson Logistics
                                            </td>
<td className="py-3">Supply Chain</td>
<td className="py-3 text-right font-medium text-gray-900">Series B</td>
<td className="py-3 text-right"><span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block"></span></td>
</tr>
</tbody>
</table>
...
<h2 className="text-4xl md:text-5xl font-semibold tracking-tight leading-[1.15] mb-6 max-w-4xl text-white">
                A robust curation and matchmaking engine.
                <span className="text-[#adbdcc] font-normal">Connecting verified IoT founders with the right capital and strategic partners.</span>
</h2>
...
<h2 className="text-4xl font-medium tracking-tight text-white sm:text-5xl mb-6">
            Curated deal flow from global sources.
        </h2>
<p className="text-lg font-light text-slate-400 leading-relaxed">
            We aggregate innovative IoT startups from top accelerators, university labs, and direct submissions, subjecting them to rigorous verification before matching.
        </p>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Accelerators</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">University Labs</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Direct Submissions</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Scout Network</span>
</div>
</div>
...
<div className="text-sm font-semibold text-white tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">ioty.com Curation</div>
<div className="text-[10px] text-blue-400 uppercase tracking-widest mt-1">Matchmaking Engine</div>
</div>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Venture Capital</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Corporate Dev</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Angel Syndicates</span>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl font-semibold text-white mb-3 tracking-tight">Access global innovation. <span className="text-[#adbdcc] font-normal">Discover hardware and software advancements across emerging tech hubs worldwide, curated for quality and readiness.</span></h3>
</div>
...
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">5,000<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Verified Startups</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">50<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Global Tech Hubs</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">$2B<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Facilitated Funding</div>
</div>
</div>
</div>
...
<h3 className="text-2xl font-semibold text-white mb-3 tracking-tight">Start sourcing today. <span className="text-[#adbdcc] font-normal">With rich documentation, verified founder checks, and AI-powered matchmaking tools, you can quickly discover the best opportunities for your fund.</span></h3>
</div>
</div>
</div>
</section>
...
<div className="mb-12">
<iconify-icon className="text-4xl opacity-40 mb-6" icon="solar:rocket-linear"></iconify-icon>
<h2 className="text-4xl md:text-5xl tracking-tighter mb-6 font-jakarta font-light">For Ambitious<br/>IoT Founders.</h2>
<p className="text-lg opacity-70 font-normal leading-relaxed font-geist">
                    Gain visibility among top-tier investors. Our platform showcases your technology to the exact people looking to fund your specific vertical, removing the friction from fundraising.
                </p>
</div>
...
<div className="">
<h4 className="font-jakarta tracking-tighter text-lg mb-1 group-hover:opacity-60 transition-opacity">Stand out with a verified profile</h4>
<p className="text-sm opacity-60 font-geist">Complete our verification process to build instant trust with investors.</p>
</div>
</li>
<li className="flex items-start gap-4 group cursor-pointer">
<span className="opacity-30 text-xs font-geist mt-1">02</span>
<div className="">
<h4 className="font-jakarta tracking-tighter text-lg mb-1 group-hover:opacity-60 transition-opacity">Bypass cold outreach</h4>
<p className="text-sm opacity-60 font-geist">Get introduced directly to VCs and scouts looking for your exact tech stack.</p>
</div>
</li>
</ul>
</div>
...
<canvas className="transition-transform duration-1000 group-hover:scale-105 opacity-90 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" height="1335" width="2000"></canvas><img alt="Server Infrastructure" className="transition-transform duration-1000 group-hover:scale-105 opacity-90 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 grayscale" data-webgl-init="true" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/variants/5a8e99c8-1b9f-44cb-8706-b0117addd162/1600w.jpg" style={{display: 'block'}}/>
...
<span className="text-xs font-geist uppercase tracking-widest">Global Network Active</span>
</div>
</div>
</section>
...
<h2 className="text-4xl md:text-5xl tracking-tighter mb-6 font-jakarta font-light">Accelerate<br/>Innovation</h2>
<p className="text-lg opacity-80 font-normal leading-relaxed mb-12 border-b border-black/10 pb-12 font-geist">
                    Join the premier network of IoT innovators and investors. Get tailored deal flow or showcase your breakthrough technology to the world.
                </p>
<div className="flex gap-8 items-start mb-12">
<iconify-icon className="text-5xl text-black/20 flex-shrink-0" icon="solar:shield-check-linear"></iconify-icon>
<div className="">

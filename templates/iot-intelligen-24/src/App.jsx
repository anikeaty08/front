...
<div className="aura-background-component top-0 w-full -z-10 absolute h-[700px]" data-alpha-mask="80" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}><div className="absolute w-full h-full left-0 top-0 -z-10" data-us-project="JxWpqc8BCimZ8u7Rswg3"></div>
</div>
...
<iconify-icon className="text-3xl transition-transform group-hover:scale-110" icon="solar:radar-linear"></iconify-icon>
<span className="text-xl tracking-tighter uppercase font-jakarta font-light">IOTY</span>
</a>
<div className="hidden md:flex items-center gap-10 text-sm font-medium tracking-tight opacity-70">
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Trends</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Deep Dives</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Sectors</a>
<a className="hover:opacity-100 transition-opacity font-geist uppercase" href="#">Platform Preview</a>
</div>
<div className="flex items-center gap-5">
<a className="hidden md:block text-sm font-medium opacity-70 hover:opacity-100 transition-opacity font-geist uppercase" href="#waitlist">Join Waitlist</a>
...
<span className="">Intelligence Platform</span>
<span className="w-1 h-1 rounded-full bg-current"></span>
<span className="">Pre-Launch Beta</span>
</div>
...
<span className="flex">
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.1s'}}>D</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.15s'}}>e</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.2s'}}>c</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.25s'}}>o</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.3s'}}>d</span></span>
...
<span className="flex">
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.4s'}}>T</span></span>
...
<span className="clip-text-container"><span className="animate-letter font-light font-jakarta" style={{animationDelay: '0.5s'}}>e</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.55s'}}>n</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.6s'}}>d</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.65s'}}>s</span></span>
</span>
...
<span className="flex">
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.85s'}}>E</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '0.9s'}}>d</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light pb-5" style={{animationDelay: '0.95s'}}>g</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '1.0s'}}>e</span></span>
<span className="clip-text-container"><span className="animate-letter font-jakarta font-light" style={{animationDelay: '1.05s'}}>.</span></span>
</span>
</h1>
<div className="absolute inset-0 z-[-1] flex items-center justify-center opacity-40 mt-20 hidden md:flex pointer-events-none">

<canvas className="w-full max-w-5xl object-cover h-[60vh] mix-blend-multiply grayscale" height="1520" style={{maskImage: 'linear-gradient(black 40%, transparent 100%)'}} width="2000"></canvas><img alt="Abstract Tech" className="w-full max-w-5xl object-cover h-[60vh] mix-blend-multiply grayscale" data-webgl-init="true" src="https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&amp;w=2000&amp;auto=format&amp;fit=crop" style={{maskImage: 'linear-gradient(black 40%, transparent 100%)', display: 'none'}}/>
</div>
...
<p className="text-base opacity-70 font-normal leading-relaxed font-geist">
                        Discover emerging protocols, track edge computing shifts, and preview hardware evolution before the market catches on.
                    </p>
</div>
<div className="max-w-sm flex flex-col items-start md:items-end text-left md:text-right gap-6">
<p className="text-base opacity-70 font-normal leading-relaxed font-geist">
                        Launching soon. Equipping enterprise leaders and founders with actionable IoT intelligence.
                    </p>
<div className="flex items-center gap-4">
<a className="btn-beam dark-btn inline-flex items-center gap-2 bg-[#2C2824] text-[#F2EFEA] px-6 py-3 rounded-full text-sm font-medium transition-transform hover:scale-105" href="#waitlist">
<span className="font-geist uppercase">Join Waitlist</span>
<iconify-icon className="text-lg" icon="solar:bell-linear"></iconify-icon>
</a>
<a className="text-sm font-medium opacity-70 hover:opacity-100 transition-opacity font-geist uppercase border-b border-black/20 pb-1" href="#">Read Manifesto</a>
</div>
</div>
</div>
</div>
...
<div className="flex items-center gap-3 font-geist"><span>01</span> EDGE COMPUTING</div>
<div className="flex items-center gap-3 md:justify-center font-geist"><span>02</span> IIOT PROTOCOLS</div>
<div className="flex items-center gap-3 md:justify-end font-geist"><span>03</span> SMART SENSORS</div>
</div>
</div>
</section>
...
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon icon="solar:server-square-linear"></iconify-icon> EdgeCore</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:radar-2-linear"></iconify-icon> SensorFlow</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:cpu-linear"></iconify-icon> ChipGlobal</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2 hidden sm:flex"><iconify-icon className="" icon="solar:monitor-linear"></iconify-icon> TechVision</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2 hidden md:flex"><iconify-icon className="" icon="solar:routing-linear"></iconify-icon> MeshNet Pro</div>
</div>
</section>

<section className="relative overflow-hidden text-[#F2EFEA] bg-[#1A1714] pt-8 pb-8">
...
<span className="font-jakarta font-light uppercase text-[#C48C56]">Beta Signups Open</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Industrial IoT Forecasts</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Connectivity Protocols</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase text-[#C48C56]">Launching Soon</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Industrial IoT Forecasts</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
<span className="font-jakarta font-light uppercase">Edge Computing Trends</span>
<iconify-icon className="text-3xl" icon="solar:asterisk-bold-duotone"></iconify-icon>
</div>
</section>
...
<div className="flex flex-col md:flex-row md:items-end gap-8 mb-24 gap-x-8 gap-y-8 items-start justify-between">
<h2 className="text-5xl md:text-6xl tracking-tighter font-jakarta font-light">Deep tech analysis<br/>for strategic decisions.</h2>
</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-xs">Track shifting connectivity standards</h3>
<iconify-icon className="text-2xl opacity-40 group-hover:opacity-100 transition-opacity" icon="solar:lock-linear"></iconify-icon>
</div>
<div className="mt-auto aspect-[21/9] rounded-t-xl overflow-hidden bg-black/5 relative">
<canvas className="transition-transform duration-700 group-hover:scale-105 opacity-80 mix-blend-multiply w-full h-full bg-[url(https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&amp;w=1600&amp;auto=format&amp;fit=crop)] bg-cover grayscale" height="1333" width="2000"></canvas>
<div className="absolute bottom-4 left-4">
<span className="px-3 py-1 bg-white/80 backdrop-blur text-xs font-geist uppercase tracking-widest rounded-full">Coming Soon</span>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light">Forecast edge AI adoption</h3>
<iconify-icon className="text-2xl opacity-40 group-hover:opacity-100 transition-opacity" icon="solar:lock-linear"></iconify-icon>
</div>
<div className="mt-auto aspect-square rounded-t-xl overflow-hidden bg-black/5 relative">
<img alt="Abstract Code" className="transition-transform duration-700 group-hover:scale-105 opacity-60 mix-blend-multiply w-full h-full object-cover grayscale" data-webgl-init="true" src="https://images.unsplash.com/photo-1593640408182-31c70c8268f5?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
</div>
</div>
...
<div className="flex justify-between items-start mb-8">
<h3 className="text-2xl tracking-tighter font-jakarta font-light">Analyze IIoT security frameworks</h3>
<iconify-icon className="text-2xl opacity-40 group-hover:opacity-100 transition-opacity" icon="solar:lock-linear"></iconify-icon>
</div>
<div className="mt-auto">
<iconify-icon className="text-6xl opacity-20 group-hover:opacity-60 transition-opacity" icon="solar:shield-network-linear"></iconify-icon>
<p className="text-xs font-geist uppercase tracking-widest opacity-50 mt-4">Security Reports Preview</p>
</div>
</div>
</div>
...
<div className="card-content h-full flex flex-col">
<div className="flex justify-between items-start mb-8">
<h3 className="text-2xl tracking-tighter font-jakarta font-light">Evaluate hardware supply chains</h3>
<iconify-icon className="text-2xl opacity-40 group-hover:opacity-100 transition-opacity" icon="solar:lock-linear"></iconify-icon>
</div>
<div className="mt-auto relative w-full h-24">
<div className="absolute w-32 h-20 border border-black/20 rounded-lg -rotate-6 bg-white/50 backdrop-blur shadow-sm transition-transform group-hover:-rotate-12 group-hover:-translate-y-2 flex items-center justify-center"><iconify-icon className="text-3xl opacity-20" icon="solar:cpu-bold-duotone"></iconify-icon></div>
<div className="absolute w-32 h-20 border border-black/20 rounded-lg rotate-6 bg-white shadow-sm left-4 transition-transform group-hover:rotate-12 group-hover:-translate-y-1 flex items-center px-3 justify-center">
<iconify-icon className="text-4xl opacity-40" icon="solar:motherboard-bold-duotone"></iconify-icon>
</div>
</div>
</div>
</div>
...
<div className="card-content h-full flex flex-col">
<div className="flex justify-between items-start mb-8">
<h3 className="text-2xl tracking-tighter font-jakarta font-light">Monitor regulatory compliance</h3>
<iconify-icon className="text-2xl opacity-40 group-hover:opacity-100 transition-opacity" icon="solar:lock-linear"></iconify-icon>
</div>
...
<iconify-icon className="text-5xl opacity-80 relative z-10" icon="solar:document-text-linear"></iconify-icon>
</div>
</div>
</div>
</div>
...
<h2 className="text-4xl md:text-5xl lg:text-6xl tracking-tighter font-jakarta font-light text-[#2C2824] mb-6">
                A glimpse into our<br/>upcoming platform.
            </h2>
<p className="text-lg md:text-xl opacity-70 font-normal leading-relaxed font-geist max-w-2xl text-[#2C2824]">
                Navigate the complex landscape of connected devices with our in-depth research suite. Sign up for the waitlist to get exclusive early access.
            </p>
</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-md leading-tight text-[#2C2824]">
                            Access real-time trend data and expert market forecasts
                        </h3>
...
<iconify-icon className="text-lg opacity-60" icon="solar:lock-linear"></iconify-icon>
</div>
</div>
</div>
...
<iconify-icon className="text-4xl text-[#2C2824] opacity-20" icon="solar:cpu-linear"></iconify-icon>
</div>
<div className="text-center space-y-1 mb-8">
<p className="text-xs font-geist text-gray-500 uppercase tracking-widest">Edge AI Growth</p>
<h4 className="text-3xl font-jakarta font-semibold tracking-tighter text-green-600">+42.5%</h4>
</div>
<div className="mt-auto space-y-3">
<div className="h-12 w-full bg-black text-white rounded-xl flex items-center justify-center font-medium text-sm font-geist">Unlock Full Report</div>
<div className="h-12 w-full border border-gray-200 rounded-xl flex items-center justify-center font-medium text-sm text-gray-500 font-geist">Join Beta to Access</div>
</div>
</div>
</div>
</div>
...
<div className="mx-auto h-5 w-40 bg-gray-100 rounded text-[10px] text-gray-400 flex items-center justify-center font-geist">research.ioty.com</div>
</div>
<div className="p-6 space-y-4">
<div className="flex gap-4 mb-6">
<div className="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center">
<iconify-icon className="text-gray-300 text-2xl" icon="solar:lock-bold"></iconify-icon>
</div>
<div className="pt-2">
...
<div className="h-10 w-full border border-gray-200 rounded-lg px-3 flex items-center text-sm text-gray-400 font-geist">Enter your work email...</div>
<div className="grid grid-cols-1 gap-3">
<div className="h-10 bg-[#05C168] rounded-lg flex items-center justify-center text-white text-xs font-bold font-geist">Join the Waitlist</div>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[200px] text-[#2C2824]">
                            Track specific technology adoption rates
                        </h3>
</div>
</div>
...
<div>
<div className="text-sm font-semibold font-jakarta text-[#2C2824]">LoRaWAN Deployments</div>
<div className="text-xs text-gray-500 font-geist">YOY Growth Tracking</div>
</div>
</div>
<div className="mb-2 flex justify-between items-end">
<span className="text-xs text-gray-500 font-geist">Adoption Target</span>
...
<div className="text-[10px] uppercase tracking-wider text-gray-400 font-geist mb-3">Active Nodes (30d)</div>
<div className="text-2xl font-jakarta font-medium tracking-tight mb-4 blur-[2px] select-none text-gray-300">14,205,000</div>
<div className="flex items-end gap-1 h-12 opacity-50 grayscale">
...
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[240px] text-[#2C2824]">
                            Curated hardware recommendations
                        </h3>
</div>
</div>
...
<p className="">Looking for low-power sensors for smart agriculture.</p>
</div>
...
<p className="mb-1.5">Based on your deployment needs, here are 3 top-rated modules:</p>
</div>
...
<span className="px-2 py-1 rounded-md text-[8px] font-semibold uppercase tracking-wider text-[#2C2824] bg-white/90 shadow-sm backdrop-blur-sm font-geist">Top Match</span>
</div>
...
<h3 className="text-base font-light text-white tracking-tight font-jakarta leading-tight">Soil Moisture Node</h3>
</div>
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Ultra-low power LoRaWAN compatible sensor.</p>
<button className="hover:bg-gray-50 transition-colors flex gap-1.5 text-[9px] font-semibold text-[#2C2824] font-geist bg-white w-full rounded-lg py-1.5 shadow-sm items-center justify-center">
...
<div className="flex justify-between items-start mb-6">
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[200px] text-[#2C2824]">
                            Exclusive insights for premium beta testers
                        </h3>
</div>
</div>
...
<div className="w-48 h-72 rounded-2xl bg-gradient-to-br from-gray-800 via-gray-900 to-black shadow-xl relative z-10 transform rotate-12 group-hover:rotate-[15deg] group-hover:scale-105 transition-all duration-700 ease-out flex flex-col justify-between p-5 overflow-hidden">
...
<iconify-icon className="text-white/60 text-xl rotate-90" icon="solar:wifi-router-minimalistic-bold"></iconify-icon>
</div>
...
<div className="text-white/50 font-bold text-xl tracking-tighter italic text-right relative">
                            EARLY
                        </div>
</div>
</div>
...
<div className="flex justify-between items-start mb-6">
<h3 className="text-2xl tracking-tighter font-jakarta font-light max-w-[240px] text-[#2C2824]">
                            Map global IoT deployment hotspots
                        </h3>
</div>
</div>
...
<canvas className="w-full h-full object-cover grayscale brightness-125 contrast-125" height="399" width="600"></canvas><img alt="Global Network" className="w-full h-full object-cover grayscale brightness-125 contrast-125" data-webgl-init="true" src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&amp;w=600&amp;auto=format&amp;fit=crop" style={{display: 'none'}}/>
</div>
...
<iconify-icon className="text-gray-400" icon="solar:lock-linear"></iconify-icon>
<span className="text-xs font-medium font-geist text-gray-800">Sign in to view locations</span>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl md:text-3xl tracking-tighter font-jakarta font-light text-[#2C2824]">
                                Monitor emerging<br/>startup ecosystems
                            </h3>
</div>
<p className="text-sm opacity-60 font-geist leading-relaxed max-w-xs">
                            Track funding rounds, technological breakthroughs, and market penetration of rising IoT startups globally.
                        </p>
</div>
<div className="mt-8 md:mt-0">
<a className="inline-flex items-center gap-2 text-sm font-medium border-b border-black/20 pb-1 hover:border-black/50 transition-colors font-geist uppercase tracking-wide" href="#waitlist">
                            Join Beta to Access
...
<div>
<div className="text-xs font-bold font-jakarta text-gray-900">SensoryTech Ltd</div>
<div className="text-[10px] text-gray-500 font-geist mb-2">Series A Funding: $12M</div>
<div className="flex justify-between text-[10px] border-t border-gray-100 pt-2 w-full gap-8">
<span className="text-gray-400">#RND-442</span>
...
<div className="ml-4 text-[10px] text-gray-400 font-geist flex items-center gap-1">
<iconify-icon icon="solar:lock-linear"></iconify-icon> insights.ioty.com (Preview)
                                </div>
</div>
<div className="p-6">
<div className="flex justify-between items-end mb-6">
<h4 className="text-sm font-semibold font-jakarta">Rising Startups</h4>
<button className="text-[10px] bg-black opacity-50 cursor-not-allowed text-white px-3 py-1.5 rounded-full font-geist">Export CSV</button>
</div>
<table className="w-full text-left">
<thead>
<tr className="text-[10px] text-gray-400 font-geist uppercase tracking-wider border-b border-gray-100">
...
<td className="py-3 blur-[2px] select-none">Canada</td>
<td className="py-3 text-right font-medium text-gray-900 blur-[2px] select-none">$24M</td>
...
<td className="py-3 blur-[2px] select-none">USA</td>
<td className="py-3 text-right font-medium text-gray-900 blur-[2px] select-none">$8M</td>
<td className="py-3 text-right"><span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block"></span></td>
</tr>
<tr className="group/row">
<td className="py-3 group-hover/row:text-indigo-600 transition-colors flex items-center gap-2">
...
<td className="py-3 blur-[2px] select-none">UK</td>
<td className="py-3 text-right font-medium text-gray-900 blur-[2px] select-none">$15M</td>
...
<td className="py-3 blur-[2px] select-none">Australia</td>
<td className="py-3 text-right font-medium text-gray-900 blur-[2px] select-none">$32M</td>
<td className="py-3 text-right"><span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block"></span></td>
</tr>
</tbody>
</table>
...
<section className="overflow-hidden text-[#ffffff] font-jakarta bg-[#25221E] pt-24 pb-24 relative" id="waitlist">
...
<h2 className="text-4xl md:text-5xl font-semibold tracking-tight leading-[1.15] mb-6 max-w-4xl text-white">
                A glimpse into our predictive engine. 
                <span className="text-[#adbdcc] font-normal">Our forecasting models combine quantitative data with qualitative expert insights to shape what's coming.</span>
</h2>
<div className="flex flex-wrap gap-4 mt-8">
<a className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-[#635BFF] rounded-full hover:bg-[#5851df] transition-all shadow-lg shadow-indigo-500/20 group" href="#waitlist">
...
<style>
        ...
        @keyframes lottieDraw {
            0% { stroke-dasharray: 60; stroke-dashoffset: 60; opacity: 0.5; }
            40% { opacity: 1; }
        ...
        .lottie-stroke path, .lottie-stroke rect, .lottie-stroke circle, .lottie-stroke line, .lottie-stroke polyline, .lottie-stroke ellipse {
...
<h2 className="text-4xl font-medium tracking-tight text-white sm:text-5xl mb-6">
            How we process market signals.
        </h2>
<p className="text-lg font-light text-slate-400 leading-relaxed">
            We aggregate data from patents, academic research, supply chain manifests, and enterprise deployments to form accurate predictions for our upcoming release.
        </p>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Patent Filings</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Supply Chains</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Academic Papers</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Market Reports</span>
</div>
</div>
...
<div className="text-sm font-semibold text-white tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">IOTY Analysis Engine</div>
<div className="text-[10px] text-blue-400 uppercase tracking-widest mt-1">Synthesis</div>
</div>
</div>
...
<div className="absolute top-0 right-0 h-1.5 w-1.5 border-t border-r border-blue-600/30 group-hover:w-2.5 group-hover:h-2.5 group-hover:border-blue-500 transition-all hidden md:block"></div>
<div className="absolute bottom-0 left-0 h-1.5 w-1.5 border-b border-l border-blue-600/30 group-hover:w-2.5 group-hover:h-2.5 group-hover:border-blue-500 transition-all hidden md:block"></div>
<div className="absolute bottom-0 right-030 group-hover:w-2.5 group-hover:h-2.5 group-hover:border-blue-500 transition-all hidden md:block"></div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Trend Reports</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Sector Deep-Dives</span>
</div>
...
<span className="text-xs font-medium text-slate-400 group-hover:text-white transition-colors tracking-wide">Vendor Guides</span>
</div>
</div>
</div>
</div>
...
<h3 className="text-2xl font-semibold text-white mb-3 tracking-tight">Data-backed confidence. <span className="text-[#adbdcc] font-normal">Our forecasts are built on millions of data points processed continuously.</span></h3>
</div>
...
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">5M<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Data points analyzed daily</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">500<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Active market monitors</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">50<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">Expert analysts worldwide</div>
</div>
</div>
</div>
...
<h3 className="text-3xl font-semibold text-white tracking-tight mb-2">Be the first to access our intelligence.</h3>
<p className="text-slate-400 font-light text-sm">Join the exclusive waitlist for our upcoming beta launch and early insights.</p>
</div>
<div className="flex w-full md:w-auto items-center gap-3">
<input className="bg-white/5 border border-white/10 text-white rounded-full px-5 py-3 text-sm focus:outline-none focus:border-blue-500 transition-colors w-full md:w-64" placeholder="work@email.com" type="email"/>
<button className="bg-white text-black px-6 py-3 rounded-full text-sm font-medium hover:bg-gray-200 transition-colors whitespace-nowrap">Join Waitlist</button>
</div>
</div>
</div>
</section>

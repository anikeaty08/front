...
<div className="text-indigo-600 relative">
<svg className="w-10 h-10" fill="none" height="40" viewbox="0 0 100 100" width="40" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-xl font-medium tracking-tight text-slate-900">Isaprefix</span>
</div>
<div className="hidden md:flex items-center gap-8">
<a className="text-base font-medium text-slate-500 hover:text-slate-900 transition-colors" href="#como-funciona">Cómo funciona</a>
<a className="text-base font-medium text-slate-500 hover:text-slate-900 transition-colors" href="#precios">Tarifa</a>
<a className="text-base font-medium text-slate-500 hover:text-slate-900 transition-colors" href="#faq">Preguntas</a>
</div>
<a className="bg-slate-900 text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-slate-800 transition-colors flex items-center gap-2" href="#evaluar">
                Evaluar mi caso
...
<div className="absolute top-20 left-1/4 w-96 h-96 bg-indigo-100 rounded-full blur-3xl mix-blend-multiply"></div>
<div className="absolute top-20 right-1/4 w-96 h-96 bg-blue-50 rounded-full blur-3xl mix-blend-multiply"></div>
</div>
<div className="max-w-4xl mx-auto px-6 text-center relative z-10">
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-slate-600 text-sm mb-8 animate-fade-in-up">
...
<button className="w-full md:w-auto bg-slate-900 text-white h-12 px-8 rounded-full font-medium hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/20 text-lg">
                    Evaluar mi caso gratis
                </button>
<button className="w-full md:w-auto bg-white text-slate-700 border border-slate-200 h-12 px-8 rounded-full font-medium hover:bg-slate-50 transition-all flex items-center justify-center gap-2 text-lg">
...
<i className="w-6 h-6 text-indigo-600 mt-0.5 shrink-0" data-lucide="check-circle-2"></i>
...
<div>
<p className="text-sm text-slate-500 uppercase tracking-wide font-medium">Situación Actual</p>
<p className="text-slate-900 font-medium text-lg">Cobertura limitada (Plan Antiguo)</p>
</div>
</div>
<div className="p-4 bg-orange-50 rounded-lg text-orange-700 text-base mb-4 font-medium flex gap-2">
<i className="w-5 h-5 mt-0.5 shrink-0" data-lucide="info"></i>
...
<div>
<p className="text-sm text-indigo-600 uppercase tracking-wide font-medium">Resultado Isaprefix</p>
...
<p className="text-xl text-slate-500 max-w-2xl mx-auto">No es necesario ir presencialmente a ningún lugar. Nos encargamos de todo el proceso legal de forma remota.</p>
</div>
<div className="grid md:grid-cols-3 gap-8">

<div className="group p-8 rounded-2xl border border-slate-200 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-500/5 transition-all bg-white">
<div className="w-12 h-12 bg-slate-50 rounded-lg flex items-center justify-center text-slate-900 mb-6 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
<i className="w-6 h-6" data-lucide="file-search"></i>
</div>
<h3 className="text-xl font-medium text-slate-900 mb-3">1. Evaluación Gratuita</h3>
<p className="text-lg text-slate-500 leading-relaxed">
                        Solo nos adjuntas los documentos necesarios y nosotros nos encargamos del resto.
                    </p>
</div>
...
<h3 className="text-xl font-medium text-slate-900 mb-3">2. Gestión &amp; Notificaciones</h3>
<p className="text-lg text-slate-500 leading-relaxed">
                        Nuestro equipo legal apoyado de tecnología automatizada, llevan el recurso en los tiempos más rápidos del mercado, se te notificara cada avance del proceso en tiempo real.
                    </p>
</div>
...
<h3 className="text-xl font-medium text-slate-900 mb-3">3. Altísima tasa de éxito</h3>
<p className="text-lg text-slate-500 leading-relaxed">
                        Dado el respaldo legal que tenemos, confiamos tanto en nuestro proceso, que si fallamos, te devolvemos tu dinero.
                    </p>
</div>
</div>
</div>
...
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-sm mb-6">
...
<p className="text-sm font-medium text-slate-500 uppercase tracking-wide mb-2">Tarifa única</p>
<div className="flex items-baseline gap-1 mb-6">
<span className="text-5xl font-semibold tracking-tight">$39.990</span>
<span className="text-slate-500">CLP</span>
</div>
<button className="w-full bg-indigo-600 text-white h-12 rounded-lg font-medium hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 mb-4 text-lg">
                        Comenzar evaluación gratuita
                    </button>
<p className="text-center text-sm text-slate-400 leading-snug">
...
<h3 className="flex items-center gap-3 text-xl font-medium text-slate-900 mb-2">
<i className="w-5 h-5 text-indigo-500" data-lucide="laptop"></i>
                        ¿Tengo que ir a algún lugar presencialmente?
                    </h3>
<p className="text-slate-500 leading-relaxed pl-8 text-lg">
...
<p className="text-sm text-slate-400">© 2024 Isaprefix. Todos los derechos reservados. Chile.</p>
</div>
</footer>

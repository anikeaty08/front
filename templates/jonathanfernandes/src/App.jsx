...
<a className="hover:text-black transition-colors" href="#main-content">sobre</a>
<a className="hover:text-black transition-colors" href="#work">projetos</a>
<a className="hover:text-black transition-colors" href="https://www.linkedin.com/in/jonathan-fernandes-a8208410a/">Linkedin</a>
<a className="hover:text-black transition-colors" href="https://api.whatsapp.com/send/?phone=5521972139499&amp;text=Preciso+de+ajuda+com+a+plataforma+Gamble+Sports&amp;type=phone_number&amp;app_absent=0">contato</a>
</nav>
</div>
...
<p className="text-sm leading-relaxed text-neutral-600 font-medium">
                    Senior Product Designer na Allos. Construo Design Systems e experiências de produto escaláveis, aplicando IA para criar, acelerar consistência, documentação e entrega.
                </p>
...
<img alt="Portrait" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/27df3787-21a9-4fa7-b980-f3d42a608eed_800w.png"/>
</div>
</div>
...
<p className="text-lg leading-relaxed text-neutral-600 mb-8 font-geist-mono">
                                Sou Product Designer com 9 anos de experiência e atualmente atuo como Senior Product Designer na Allos. Crio interfaces escaláveis com Design Systems sólidos — de tokens a componentes — garantindo consistência, eficiência e experiências digitais de alta qualidade para times de produto e tecnologia.
                            </p>

<div className="grid grid-cols-2 gap-4 mb-10">
<div className="space-y-3">
<h3 className="text-sm font-semibold text-neutral-900 font-geist-mono uppercase tracking-wide">SKILLS</h3>
...
<div className="space-y-3">
<h3 className="text-sm font-semibold text-neutral-900 font-geist-mono uppercase tracking-wide">INDUSTRIAS</h3>
<ul className="text-sm text-neutral-500 space-y-2">
...
<a className="px-6 py-3 rounded-lg border border-neutral-200 text-neutral-900 font-medium hover:bg-neutral-50 transition-colors font-geist-mono text-sm" href="https://api.whatsapp.com/send/?phone=5521972139499&amp;text=Preciso+de+ajuda+com+a+plataforma+Gamble+Sports&amp;type=phone_number&amp;app_absent=0">
                                    Falar no Whatsapp
                                </a>
</div>
</div>
...
<a className="inline-flex items-center gap-2 text-sm font-semibold text-neutral-900 hover:text-blue-600 transition-colors border-b border-transparent hover:border-blue-600 pb-0.5" href="#">
                                Ver projeto <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>
...
<a className="inline-flex items-center gap-2 px-8 py-4 bg-white border border-neutral-200 rounded-full text-neutral-900 hover:bg-neutral-50 transition-all font-geist-mono text-sm shadow-sm hover:shadow-md" href="#">
                        Ver todos os projetos <i className="w-4 h-4" data-lucide="plus"></i>
</a>
</div>
</div>
</section>
...
<h3 className="text-3xl md:text-4xl font-medium text-neutral-900 leading-tight mb-8">
                        "Jonathan é um dos melhores profissionais com quem tive a oportunidade de trabalhar, principalmente por sua capacidade de
                        superar expectativas observando detalhes que poucos se atentam. Seu olhar do todo agrega resultados efetivos ao negócio.
                        Além de ser um ser humano íntegro e que veste a camisa do time em que atua."
                    </h3>
<div className="flex items-center justify-center gap-4">
<div className="w-12 h-12 rounded-full bg-neutral-200 overflow-hidden">
<img alt="Client" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cf795bec-e9bc-4ecf-9989-d83620709311_320w.jpg"/>
</div>
...
<a className="hover:text-black transition" href="https://www.instagram.com/ux.jonny/">Instagram</a>
<a className="hover:text-black transition" href="https://www.linkedin.com/in/jonathan-fernandes-a8208410a/">Linkedin</a>
</nav>
</div>
</div>
</div>

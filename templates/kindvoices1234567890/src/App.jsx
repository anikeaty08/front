...
<span className="font-semibold tracking-tight text-sm">KINVO AI</span>
</div>
...
<h1 className="md:text-7xl leading-[1.1] text-5xl font-semibold text-white tracking-tight" style={{}}>We Build AI Systems That <br/> <span className="text-neutral-500">Call, Chat, and Convert.</span></h1>
...
<p className="text-neutral-400 max-w-xl">We don't just "use AI". We architect robust infrastructure that handles communication and data processing for you.</p>
</div>
...
<li className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Sub-1s latency</li>
...
<ul className="text-xs text-neutral-500 space-y-2">
<li className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Instant lead response</li>
<li className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 6L9 17l-5-5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> Multi-step flows</li>
</ul>
</div>
...
<h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-6">How We Build Your System</h2>
...
<img alt="Kinvo AI" className="w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b1215c84-a614-448d-9358-8d4515451e7d_800w.png"/>
</div>
</div>
<div className="w-full md:w-2/3 space-y-6">
<h2 className="text-3xl font-semibold tracking-tight">Kinvo AI.</h2>
<h3 className="text-xl text-neutral-400 font-medium">We build systems, not demos.</h3>
...
<p className="text-neutral-400 leading-relaxed">
                            We are developers focused on stability and scale. Our background in software engineering means we build automation infrastructures that scale with your business, handle errors gracefully, and actually deliver the time-savings promised.
                        </p>
...
<div className="text-sm text-neutral-500">
                © 2024 Kinvo AI. All rights reserved.
            </div>
<div className="flex gap-8 text-sm font-medium text-neutral-400">
<a className="hover:text-white" href="#">Privacy</a>
<a className="hover:text-white" href="#">Terms</a>
<a className="hover:text-white" href="mailto:hello@kinvo.ai">Email Us</a>
</div>
</div>
</footer>

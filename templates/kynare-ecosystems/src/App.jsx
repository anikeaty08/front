...
<h1 className="display-xl reveal active hover-trigger tracking-tight" onmouseenter="this.classList.add('filled')" onmouseleave="this.classList.remove('filled')" style={{fontFamily: '"Helios Extended", sans-serif', textAlign: 'center'}}>ecosystem</h1>
...
<img alt="Mah Sing Healthcare Ecosystems Logo" className="sm:h-32 md:h-40 lg:h-48 w-auto h-24 object-contain translate-x-16 scale-150" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4f09887b-57a7-46d9-8cb6-e5f75ede51dc_800w.png"/>
</div>
...
<div className="avatar-indicator-2 hover-trigger cursor-pointer overflow-hidden w-64 h-64 transition-all duration-500 relative flex items-center justify-center active" data-target="0">
...
<img className="w-full h-full object-contain -translate-y-16 scale-125" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/055638fb-5f5d-4943-8a9a-a6e96269b86e_800w.png"/>
</div>
</div>
</div>
...
<div className="testimonial-item-2 group relative aura-reveal active" data-index="0">
<div className="md:pl-12 relative">
<div className="absolute -left-2 -top-6 md:-left-12 md:-top-8 opacity-20">
<svg className="text-white transform rotate-180" fill="currentColor" height="64" viewbox="0 0 24 24" width="64">
...
<span className="text-[10px] uppercase text-xl font-medium italic text-zinc-300 tracking-wider font-sans">
                        KYNARE education
                      </span>
</div>
</div>
...
<blockquote className="leading-[1.1] md:text-5xl xl:pr-16 text-3xl font-light text-white tracking-tight mb-8">
                    MAH SING leading new norm with medical interventions, rehab
                    &amp; performance are all experienced as a branded
                    healthcare experience throughout the nation. (GP Model)
                  </blockquote>
<div className="flex items-center gap-4">
<div className="lg:hidden overflow-hidden w-24 h-24 sm:w-32 sm:h-32">
<img className="w-full h-full object-contain scale-125" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/055638fb-5f5d-4943-8a9a-a6e96269b86e_800w.png"/>
</div>
<div className="flex flex-col">
<span className="text-5xl font-medium text-white">
...
<p className="">- Tan KS &amp; Venketasubramanian N. Cerebrovasc Dis Extra. 2022;12(2):58–67. Karger Publishers. Available: karger.com/cee/article/12/2/58/821900</p>
</div>
</div>
</div>

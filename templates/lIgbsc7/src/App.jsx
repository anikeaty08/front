...
<h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">Why Choose Nebula Banking</h2>
<p className="text-gray-400 text-center max-w-xl mx-auto mb-16">Experience the future of finance with features designed for the modern world</p>
...
<p className="text-gray-300">Our advanced encryption and biometric authentication ensure your assets are protected by the most secure technology available today.</p>
</div>
<div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-800/30 backdrop-blur-sm hover:bg-indigo-900/30 transition duration-300">
<div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-5">
<svg className="h-6 w-6 text-purple-400" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<h3 className="text-xl font-semibold text-white mb-3">Instant Transfers</h3>
<p className="text-gray-300">Send money globally in seconds with zero fees. Our network processes transactions 24/7, eliminating traditional banking delays.</p>
</div>
<div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-800/30 backdrop-blur-sm hover:bg-indigo-900/30 transition duration-300">
<div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-5">
<svg className="h-6 w-6 text-purple-400" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<h3 className="text-xl font-semibold text-white mb-3">AI Financial Advisor</h3>
<p className="text-gray-300">Our AI analyzes your spending patterns and market trends to provide personalized investment strategies and savings recommendations.</p>
</div>
</div>
</div>
</section>

...
<a className="flex items-center gap-2 group mx-auto z-10" href="#">
...
<button className="md:hidden absolute right-6 text-stone-600 z-20">
<iconify-icon height="24" icon="solar:hamburger-menu-linear" width="24"></iconify-icon>
</button>
</div>
</nav>

<section className="relative h-[800px] flex items-center justify-center overflow-hidden pt-20" id="hero">
...
<div className="bg-gradient-to-r from-stone-50/80 to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
</div>
<div className="relative z-20 max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center">
<div className="reveal active">
<div className="inline-flex gap-2 uppercase text-xs font-medium text-emerald-800 tracking-wider bg-emerald-50 border-emerald-100 border rounded-full mb-6 pt-1 pr-3 pb-1 pl-3 gap-x-2 gap-y-2 items-center">Now Available in Wellington</div>
...
<div className="hidden md:grid grid-cols-2 gap-4 reveal delay-200 active">
...
<iconify-icon className="text-emerald-600 mb-4" height="32" icon="solar:leaf-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-emerald-600 mb-4" height="32" icon="solar:layers-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-emerald-600 mb-4" height="32" icon="solar:smart-home-linear" width="32"></iconify-icon>
...
<div className="leaf" style={{left: '72.7795%', animation: '10.3003s linear 0.942985s infinite normal none running float'}}></div><div className="leaf" style={{left: '41.3653%', animation: '6.35881s linear 2.30816s infinite normal none running float'}}></div><div className="leaf" style={{left: '89.9096%', animation: '5.55614s linear 2.04808s infinite normal none running float'}}></div><div className="leaf" style={{left: '34.5072%', animation: '13.9028s linear 4.06665s infinite normal none running float'}}></div><div className="leaf" style={{left: '43.1913%', animation: '12.1736s linear 1.2024s infinite normal none running float'}}></div><div className="leaf" style={{left: '94.7458%', animation: '6.51253s linear 1.01596s infinite normal none running float'}}></div><div className="leaf" style={{left: '97.8637%', animation: '7.89075s linear 4.06473s infinite normal none running float'}}></div><div className="leaf" style={{left: '17.4565%', animation: '13.8416s linear 0.161723s infinite normal none running float'}}></div></section>
...
<li className="">• Site Planning &amp; Design</li>
...
<li className="">• Garden Construction</li>
...
<button className="btn-robotic w-full py-4 bg-emerald-700 text-white rounded-lg font-medium hover:bg-emerald-800 transition-all flex justify-center items-center gap-2 group" type="button">
                            Submit Request
                            <iconify-icon className="group-hover:translate-x-1 transition-transform" height="16" icon="solar:plain-linear" width="16"></iconify-icon>
</button>
</form>
</div>
...
<p className="text-sm text-stone-500 leading-relaxed mt-1">29 Association Ave,Ilupeju, Lagos 100271, Lagos</p>
</div>
</div>
<div className="flex items-start gap-4">
<div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-emerald-600 shrink-0">

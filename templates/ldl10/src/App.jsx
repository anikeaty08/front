...
<svg aria-hidden="true" className="iconify text-lg iconify--solar" data-icon="solar:widget-2-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M2 6.634a4.634 4.634 0 1 1 9.268 0a4.634 4.634 0 0 1-9.268 0" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M12.732 17.366a4.634 4.634 0 1 1 9.269 0a4.634 4.634 0 0 1-9.269 0" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M2 17.5c0-2.121 0-3.182.659-3.841S4.379 13 6.5 13s3.182 0 3.841.659S11 15.379 11 17.5s0 3.182-.659 3.841S8.621 22 6.5 22s-3.182 0-3.841-.659S2 19.621 2 17.5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M13 6.5c0-2.121 0-3.182.659-3.841S15.379 2 17.5 2s3.182 0 3.841.659S22 4.379 22 6.5s0 3.182-.659 3.841S19.621 11 17.5 11s-3.182 0-3.841-.659S13 8.621 13 6.5" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</button>
...
<svg aria-hidden="true" className="iconify text-lg iconify--solar" data-icon="solar:list-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M3.25 7A.75.75 0 0 1 4 6.25h16a.75.75 0 0 1 0 1.5H4A.75.75 0 0 1 3.25 7" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M3.25 12a.75.75 0 0 1 .75-.75h11a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1-.75-.75" data-darkreader-inline-fill="" fill="currentColor" opacity=".7" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M3.25 17a.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1-.75-.75" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</button>
</div>
</div>
...
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:add-circle-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12.75 9a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V15a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25z" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</button>
...
<svg aria-hidden="true" className="iconify text-xl text-gray-400 iconify--solar" data-icon="solar:user-circle-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M16.807 19.011A8.46 8.46 0 0 1 12 20.5a8.46 8.46 0 0 1-4.807-1.489c-.604-.415-.862-1.205-.51-1.848C7.41 15.83 8.91 15 12 15s4.59.83 5.318 2.163c.35.643.093 1.433-.511 1.848M12 12a3 3 0 1 0 0-6a3 3 0 0 0 0 6" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</button>
</div>
</div>
...
<div className="ios-icon app-icon-bg flex items-center justify-center z-10">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-3xl text-gray-200 iconify--solar" data-icon="solar:cloud-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M22 14.353C22 17.472 19.442 20 16.286 20h-5.787a7.5 7.5 0 0 1 7.487-11.853q.119.422.17.868C20.392 9.78 22 11.881 22 14.353" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12.476 4C9.32 4 6.762 6.528 6.762 9.647c0 .69.125 1.35.354 1.962a4.4 4.4 0 0 0-.83-.08C3.919 11.53 2 13.426 2 15.765S3.919 20 6.286 20H10.5a7.5 7.5 0 0 1 7.487-11.853l-.047-.158C17.224 5.68 15.048 4 12.476 4" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div className="flex flex-col items-center gap-0.5 text-center">
...
<div className="ios-icon app-icon-bg flex items-center justify-center z-10">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-3xl text-gray-200 iconify--solar" data-icon="solar:chat-round-dots-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 23c6.075 0 11-4.925 11-11S18.075 1 12 1S1 5.925 1 12c0 1.76.413 3.423 1.148 4.898c.195.392.26.84.147 1.263l-.655 2.448a1.43 1.43 0 0 0 1.75 1.751l2.45-.655a1.8 1.8 0 0 1 1.262.147A10.96 10.96 0 0 0 12 23" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M10.9 12a1.1 1.1 0 1 0 2.2 0a1.1 1.1 0 0 0-2.2 0m-4.4 0a1.1 1.1 0 1 0 2.2 0a1.1 1.1 0 0 0-2.2 0m8.8 0a1.1 1.1 0 1 0 2.2 0a1.1 1.1 0 0 0-2.2 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div className="flex flex-col items-center gap-0.5 text-center">
...
<div className="ios-icon app-icon-bg flex items-center justify-center z-10">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-3xl text-gray-200 iconify--solar" data-icon="solar:users-group-two-rounded-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 7.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M19.5 7.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0m-15 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 0 0-5 0" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M18 16.5c0 1.933-2.686 3.5-6 3.5s-6-1.567-6-3.5S8.686 13 12 13s6 1.567 6 3.5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M22 16.5c0 1.38-1.79 2.5-4 2.5s-4-1.12-4-2.5s1.79-2.5 4-2.5s4 1.12 4 2.5m-20 0C2 17.88 3.79 19 6 19s4-1.12 4-2.5S8.21 14 6 14s-4 1.12-4 2.5" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div className="flex flex-col items-center gap-0.5 text-center">
...
<div className="ios-icon app-icon-bg flex items-center justify-center z-10">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-3xl text-gray-200 iconify--solar" data-icon="solar:map-point-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c-4.418 0-8 4.003-8 8.5c0 4.462 2.553 9.312 6.537 11.174a3.45 3.45 0 0 0 2.926 0C17.447 19.812 20 14.962 20 10.5C20 6.003 16.418 2 12 2" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12 12.5a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div className="flex flex-col items-center gap-0.5 text-center">
...
<svg :data-icon="app.icon || 'solar:gallery-bold-duotone'" aria-hidden="true" className="iconify text-3xl text-gray-500 iconify--solar" data-icon="solar:gallery-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M18 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M11.943 1.25h.114c2.309 0 4.118 0 5.53.19c1.444.194 2.584.6 3.479 1.494c.895.895 1.3 2.035 1.494 3.48c.19 1.411.19 3.22.19 5.529v.088c0 1.909 0 3.471-.104 4.743c-.104 1.28-.317 2.347-.795 3.235q-.314.586-.785 1.057c-.895.895-2.035 1.3-3.48 1.494c-1.411.19-3.22.19-5.529.19h-.114c-2.309 0-4.118 0-5.53-.19c-1.444-.194-2.584-.6-3.479-1.494c-.793-.793-1.203-1.78-1.42-3.006c-.215-1.203-.254-2.7-.262-4.558Q1.25 12.792 1.25 12v-.058c0-2.309 0-4.118.19-5.53c.194-1.444.6-2.584 1.494-3.479c.895-.895 2.035-1.3 3.48-1.494c1.411-.19 3.22-.19 5.529-.19m-5.33 1.676c-1.278.172-2.049.5-2.618 1.069c-.57.57-.897 1.34-1.069 2.619c-.174 1.3-.176 3.008-.176 5.386q0 .793.002 1.495c.008 1.874.05 3.246.238 4.303c.184 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.086-.002 5.386-.176c1.279-.172 2.05-.5 2.62-1.069c.21-.21.381-.442.524-.707c.332-.616.523-1.44.621-2.645s.099-2.707.099-4.653c0-2.378-.002-4.086-.176-5.386c-.172-1.279-.5-2.05-1.069-2.62c-.57-.569-1.34-.896-2.619-1.068c-1.3-.174-3.008-.176-5.386-.176s-4.086.002-5.386.176" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m20.607 19.146l-2.83-2.547a3 3 0 0 0-3.732-.225l-.299.21a2 2 0 0 1-2.564-.222l-4.29-4.29a2.3 2.3 0 0 0-3.14-.104l-1.002.876l.002.65c.008 1.875.05 3.247.238 4.304c.185 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.087-.002 5.387-.176c1.278-.172 2.049-.5 2.618-1.069a3 3 0 0 0 .602-.859" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</div>
...
<div className="w-12 h-12 rounded-[10px] bg-gray-800 flex items-center justify-center overflow-hidden flex-shrink-0 relative border border-white/5">
<div>
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-xl text-white iconify--solar" data-icon="solar:cloud-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M22 14.353C22 17.472 19.442 20 16.286 20h-5.787a7.5 7.5 0 0 1 7.487-11.853q.119.422.17.868C20.392 9.78 22 11.881 22 14.353" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12.476 4C9.32 4 6.762 6.528 6.762 9.647c0 .69.125 1.35.354 1.962a4.4 4.4 0 0 0-.83-.08C3.919 11.53 2 13.426 2 15.765S3.919 20 6.286 20H10.5a7.5 7.5 0 0 1 7.487-11.853l-.047-.158C17.224 5.68 15.048 4 12.476 4" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</div>
<div className="flex-grow min-w-0">
<div className="flex items-center gap-2">
...
<div className="w-12 h-12 rounded-[10px] bg-gray-800 flex items-center justify-center overflow-hidden flex-shrink-0 relative border border-white/5">
<div>
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-xl text-white iconify--solar" data-icon="solar:users-group-two-rounded-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 7.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M19.5 7.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0m-15 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 0 0-5 0" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M18 16.5c0 1.933-2.686 3.5-6 3.5s-6-1.567-6-3.5S8.686 13 12 13s6 1.567 6 3.5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M22 16.5c0 1.38-1.79 2.5-4 2.5s-4-1.12-4-2.5s1.79-2.5 4-2.5s4 1.12 4 2.5m-20 0C2 17.88 3.79 19 6 19s4-1.12 4-2.5S8.21 14 6 14s-4 1.12-4 2.5" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</div>
<div className="flex-grow min-w-0">
<div className="flex items-center gap-2">
...
<svg :data-icon="app.icon || 'solar:gallery-bold-duotone'" aria-hidden="true" className="iconify text-xl text-gray-500 iconify--solar" data-icon="solar:gallery-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M18 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M11.943 1.25h.114c2.309 0 4.118 0 5.53.19c1.444.194 2.584.6 3.479 1.494c.895.895 1.3 2.035 1.494 3.48c.19 1.411.19 3.22.19 5.529v.088c0 1.909 0 3.471-.104 4.743c-.104 1.28-.317 2.347-.795 3.235q-.314.586-.785 1.057c-.895.895-2.035 1.3-3.48 1.494c-1.411.19-3.22.19-5.529.19h-.114c-2.309 0-4.118 0-5.53-.19c-1.444-.194-2.584-.6-3.479-1.494c-.793-.793-1.203-1.78-1.42-3.006c-.215-1.203-.254-2.7-.262-4.558Q1.25 12.792 1.25 12v-.058c0-2.309 0-4.118.19-5.53c.194-1.444.6-2.584 1.494-3.479c.895-.895 2.035-1.3 3.48-1.494c1.411-.19 3.22-.19 5.529-.19m-5.33 1.676c-1.278.172-2.049.5-2.618 1.069c-.57.57-.897 1.34-1.069 2.619c-.174 1.3-.176 3.008-.176 5.386q0 .793.002 1.495c.008 1.874.05 3.246.238 4.303c.184 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.086-.002 5.386-.176c1.279-.172 2.05-.5 2.62-1.069c.21-.21.381-.442.524-.707c.332-.616.523-1.44.621-2.645s.099-2.707.099-4.653c0-2.378-.002-4.086-.176-5.386c-.172-1.279-.5-2.05-1.069-2.62c-.57-.569-1.34-.896-2.619-1.068c-1.3-.174-3.008-.176-5.386-.176s-4.086.002-5.386.176" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m20.607 19.146l-2.83-2.547a3 3 0 0 0-3.732-.225l-.299.21a2 2 0 0 1-2.564-.222l-4.29-4.29a2.3 2.3 0 0 0-3.14-.104l-1.002.876l.002.65c.008 1.875.05 3.247.238 4.304c.185 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.087-.002 5.387-.176c1.278-.172 2.049-.5 2.618-1.069a3 3 0 0 0 .602-.859" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</div>
</div>
<div className="flex-grow min-w-0">
...
<svg aria-hidden="true" className="iconify text-xl iconify--solar" data-icon="solar:widget-add-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M17.5 2.75a.75.75 0 0 1 .75.75v2.25h2.25a.75.75 0 0 1 0 1.5h-2.25V9.5a.75.75 0 0 1-1.5 0V7.25H14.5a.75.75 0 0 1 0-1.5h2.25V3.5a.75.75 0 0 1 .75-.75" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M2 6.5c0-2.121 0-3.182.659-3.841S4.379 2 6.5 2s3.182 0 3.841.659S11 4.379 11 6.5s0 3.182-.659 3.841S8.621 11 6.5 11s-3.182 0-3.841-.659S2 8.621 2 6.5m11 11c0-2.121 0-3.182.659-3.841S15.379 13 17.5 13s3.182 0 3.841.659S22 15.379 22 17.5s0 3.182-.659 3.841S19.621 22 17.5 22s-3.182 0-3.841-.659S13 19.621 13 17.5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M2 17.5c0-2.121 0-3.182.659-3.841S4.379 13 6.5 13s3.182 0 3.841.659S11 15.379 11 17.5s0 3.182-.659 3.841S8.621 22 6.5 22s-3.182 0-3.841-.659S2 19.621 2 17.5" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div>
...
<svg aria-hidden="true" className="iconify text-xl iconify--solar" data-icon="solar:folder-with-files-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2 6.95c0-.883 0-1.324.07-1.692A4 4 0 0 1 5.257 2.07C5.626 2 6.068 2 6.95 2c.386 0 .58 0 .766.017a4 4 0 0 1 2.18.904c.144.119.28.255.554.529L11 4c.816.816 1.224 1.224 1.712 1.495a4 4 0 0 0 .848.352C14.098 6 14.675 6 15.828 6h.374c2.632 0 3.949 0 4.804.77q.119.105.224.224c.77.855.77 2.172.77 4.804V14c0 3.771 0 5.657-1.172 6.828S17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172S2 17.771 2 14z" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M20 6.238c0-.298-.005-.475-.025-.63a3 3 0 0 0-2.583-2.582C17.197 3 16.965 3 16.5 3H9.988c.116.104.247.234.462.45L11 4c.816.816 1.224 1.224 1.712 1.495a4 4 0 0 0 .849.352C14.098 6 14.675 6 15.829 6h.373c1.78 0 2.957 0 3.798.238" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M12.25 10a.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 0 1.5h-5a.75.75 0 0 1-.75-.75" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div>
...
<svg aria-hidden="true" className="iconify text-xl iconify--solar" data-icon="solar:gallery-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M18 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M11.943 1.25h.114c2.309 0 4.118 0 5.53.19c1.444.194 2.584.6 3.479 1.494c.895.895 1.3 2.035 1.494 3.48c.19 1.411.19 3.22.19 5.529v.088c0 1.909 0 3.471-.104 4.743c-.104 1.28-.317 2.347-.795 3.235q-.314.586-.785 1.057c-.895.895-2.035 1.3-3.48 1.494c-1.411.19-3.22.19-5.529.19h-.114c-2.309 0-4.118 0-5.53-.19c-1.444-.194-2.584-.6-3.479-1.494c-.793-.793-1.203-1.78-1.42-3.006c-.215-1.203-.254-2.7-.262-4.558Q1.25 12.792 1.25 12v-.058c0-2.309 0-4.118.19-5.53c.194-1.444.6-2.584 1.494-3.479c.895-.895 2.035-1.3 3.48-1.494c1.411-.19 3.22-.19 5.529-.19m-5.33 1.676c-1.278.172-2.049.5-2.618 1.069c-.57.57-.897 1.34-1.069 2.619c-.174 1.3-.176 3.008-.176 5.386q0 .793.002 1.495c.008 1.874.05 3.246.238 4.303c.184 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.086-.002 5.386-.176c1.279-.172 2.05-.5 2.62-1.069c.21-.21.381-.442.524-.707c.332-.616.523-1.44.621-2.645s.099-2.707.099-4.653c0-2.378-.002-4.086-.176-5.386c-.172-1.279-.5-2.05-1.069-2.62c-.57-.569-1.34-.896-2.619-1.068c-1.3-.174-3.008-.176-5.386-.176s-4.086.002-5.386.176" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m20.607 19.146l-2.83-2.547a3 3 0 0 0-3.732-.225l-.299.21a2 2 0 0 1-2.564-.222l-4.29-4.29a2.3 2.3 0 0 0-3.14-.104l-1.002.876l.002.65c.008 1.875.05 3.247.238 4.304c.185 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.087-.002 5.387-.176c1.278-.172 2.049-.5 2.618-1.069a3 3 0 0 0 .602-.859" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
<div>
...
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:import-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M4 12a8 8 0 1 0 16 0z" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M15.53 10.47a.75.75 0 0 0-1.06 0l-1.72 1.72V4a.75.75 0 0 0-1.5 0v8.19l-1.72-1.72a.75.75 0 0 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l3-3a.75.75 0 0 0 0-1.06" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg> Import
                        </button>
...
<svg aria-hidden="true" className="iconify text-2xl text-gray-500 group-hover:text-white iconify--solar" data-icon="solar:add-circle-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12.75 9a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V15a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25z" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
...
<button @click="showImportModal = false" className="text-gray-400 hover:text-white"><svg aria-hidden="true" className="iconify text-xl iconify--solar" data-icon="solar:close-circle-bold" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10M8.97 8.97a.75.75 0 0 1 1.06 0L12 10.94l1.97-1.97a.75.75 0 0 1 1.06 1.06L13.06 12l1.97 1.97a.75.75 0 0 1-1.06 1.06L12 13.06l-1.97 1.97a.75.75 0 0 1-1.06-1.06L10.94 12l-1.97-1.97a.75.75 0 0 1 0-1.06" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg></button>
</div>
...
<div className="w-8 h-8 rounded bg-black border border-gray-700 flex items-center justify-center overflow-hidden">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-lg text-white iconify--solar" data-icon="solar:cloud-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M22 14.353C22 17.472 19.442 20 16.286 20h-5.787a7.5 7.5 0 0 1 7.487-11.853q.119.422.17.868C20.392 9.78 22 11.881 22 14.353" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12.476 4C9.32 4 6.762 6.528 6.762 9.647c0 .69.125 1.35.354 1.962a4.4 4.4 0 0 0-.83-.08C3.919 11.53 2 13.426 2 15.765S3.919 20 6.286 20H10.5a7.5 7.5 0 0 1 7.487-11.853l-.047-.158C17.224 5.68 15.048 4 12.476 4" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
...
<div className="w-8 h-8 rounded bg-black border border-gray-700 flex items-center justify-center overflow-hidden">
<svg :data-icon="app.icon" aria-hidden="true" className="iconify text-lg text-white iconify--solar" data-icon="solar:users-group-two-rounded-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 7.5a3.5 3.5 0 1 1-7 0a3.5 3.5 0 0 1 7 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M19.5 7.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0m-15 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 0 0-5 0" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M18 16.5c0 1.933-2.686 3.5-6 3.5s-6-1.567-6-3.5S8.686 13 12 13s6 1.567 6 3.5" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M22 16.5c0 1.38-1.79 2.5-4 2.5s-4-1.12-4-2.5s1.79-2.5 4-2.5s4 1.12 4 2.5m-20 0C2 17.88 3.79 19 6 19s4-1.12 4-2.5S8.21 14 6 14s-4 1.12-4 2.5" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
...
<div className="flex items-center gap-4">
<div className="flex items-center gap-2">
<svg aria-hidden="true" className="iconify text-2xl text-pink-500 iconify--solar" data-icon="solar:gallery-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M18 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M11.943 1.25h.114c2.309 0 4.118 0 5.53.19c1.444.194 2.584.6 3.479 1.494c.895.895 1.3 2.035 1.494 3.48c.19 1.411.19 3.22.19 5.529v.088c0 1.909 0 3.471-.104 4.743c-.104 1.28-.317 2.347-.795 3.235q-.314.586-.785 1.057c-.895.895-2.035 1.3-3.48 1.494c-1.411.19-3.22.19-5.529.19h-.114c-2.309 0-4.118 0-5.53-.19c-1.444-.194-2.584-.6-3.479-1.494c-.793-.793-1.203-1.78-1.42-3.006c-.215-1.203-.254-2.7-.262-4.558Q1.25 12.792 1.25 12v-.058c0-2.309 0-4.118.19-5.53c.194-1.444.6-2.584 1.494-3.479c.895-.895 2.035-1.3 3.48-1.494c1.411-.19 3.22-.19 5.529-.19m-5.33 1.676c-1.278.172-2.049.5-2.618 1.069c-.57.57-.897 1.34-1.069 2.619c-.174 1.3-.176 3.008-.176 5.386q0 .793.002 1.495c.008 1.874.05 3.246.238 4.303c.184 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.086-.002 5.386-.176c1.279-.172 2.05-.5 2.62-1.069c.21-.21.381-.442.524-.707c.332-.616.523-1.44.621-2.645s.099-2.707.099-4.653c0-2.378-.002-4.086-.176-5.386c-.172-1.279-.5-2.05-1.069-2.62c-.57-.569-1.34-.896-2.619-1.068c-1.3-.174-3.008-.176-5.386-.176s-4.086.002-5.386.176" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m20.607 19.146l-2.83-2.547a3 3 0 0 0-3.732-.225l-.299.21a2 2 0 0 1-2.564-.222l-4.29-4.29a2.3 2.3 0 0 0-3.14-.104l-1.002.876l.002.65c.008 1.875.05 3.247.238 4.304c.185 1.035.498 1.7 1.005 2.207c.57.57 1.34.897 2.619 1.069c1.3.174 3.008.176 5.386.176s4.087-.002 5.387-.176c1.278-.172 2.049-.5 2.618-1.069a3 3 0 0 0 .602-.859" data-darkreader-inline-fill="" fill="currentColor" opacity=".4" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
<div>
...
<svg aria-hidden="true" className="iconify text-lg iconify--solar" data-icon="solar:widget-3-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g clip-rule="evenodd" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}><path d="M22.25 6.5a4.75 4.75 0 1 0-9.5 0a4.75 4.75 0 0 0 9.5 0m-11 11a4.75 4.75 0 1 0-9.5 0a4.75 4.75 0 0 0 9.5 0"></path><path d="M1.75 6.5a4.75 4.75 0 1 1 9.5 0a4.75 4.75 0 0 1-9.5 0m11 11a4.75 4.75 0 1 1 9.5 0a4.75 4.75 0 0 1-9.5 0" opacity=".5"></path></g></svg>
</button>
...
<svg aria-hidden="true" className="iconify group-hover:text-indigo-400 transition-colors iconify--solar" data-icon="solar:upload-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M22 16v-1c0-2.829 0-4.242-.879-5.121S18.828 9 16 9H8c-2.83 0-4.243 0-5.122.88C2 10.757 2 12.17 2 14.998V16c0 2.828 0 4.242.879 5.121C3.757 22 5.172 22 8 22h8c2.828 0 4.243 0 5.121-.879S22 18.828 22 16" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M12 15.75a.75.75 0 0 0 .75-.75V4.027l1.68 1.961a.75.75 0 1 0 1.14-.976l-3-3.5a.75.75 0 0 0-1.14 0l-3 3.5a.75.75 0 1 0 1.14.976l1.68-1.96V15c0 .414.336.75.75.75" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
<span>Add</span>
...
<svg aria-hidden="true" className="iconify text-gray-700 group-hover:text-gray-500 transition-colors text-sm iconify--solar" data-icon="solar:pen-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20.849 8.713a3.932 3.932 0 0 0-5.562-5.561l-.887.887l.038.111a8.75 8.75 0 0 0 2.093 3.32a8.75 8.75 0 0 0 3.43 2.13z" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m14.439 4l-.039.038l.038.112a8.75 8.75 0 0 0 2.093 3.32a8.75 8.75 0 0 0 3.43 2.13l-8.56 8.56c-.578.577-.867.866-1.185 1.114a6.6 6.6 0 0 1-1.211.748c-.364.174-.751.303-1.526.561l-4.083 1.361a1.06 1.06 0 0 1-1.342-1.341l1.362-4.084c.258-.774.387-1.161.56-1.525q.309-.646.749-1.212c.248-.318.537-.606 1.114-1.183z" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>
</div>
...
<svg aria-hidden="true" className="iconify text-lg opacity-70 iconify--solar" data-icon="solar:plain-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m16.245 7.76l5.172-5.171l-.003-.003c-1.187-1.187-3.436-.438-7.935 1.062L8.33 5.364C4.7 6.574 2.885 7.18 2.37 8.067a2.72 2.72 0 0 0 0 2.73c.515.888 2.33 1.493 5.96 2.704c.45.15.957.042 1.294-.291l5.506-5.455a.79.79 0 0 1 1.116.005" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m18.635 15.67l1.717-5.15c1.498-4.495 2.248-6.744 1.064-7.932l-5.172 5.171a.79.79 0 0 1-.005 1.117l-5.416 5.367a1.4 1.4 0 0 0-.324 1.426c1.21 3.631 1.815 5.446 2.703 5.962a2.71 2.71 0 0 0 2.73 0c.888-.516 1.493-2.33 2.703-5.962" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg> Open
                </button>
...
<svg aria-hidden="true" className="iconify text-lg opacity-70 iconify--solar" data-icon="solar:pen-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20.849 8.713a3.932 3.932 0 0 0-5.562-5.561l-.887.887l.038.111a8.75 8.75 0 0 0 2.093 3.32a8.75 8.75 0 0 0 3.43 2.13z" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="m14.439 4l-.039.038l.038.112a8.75 8.75 0 0 0 2.093 3.32a8.75 8.75 0 0 0 3.43 2.13l-8.56 8.56c-.578.577-.867.866-1.185 1.114a6.6 6.6 0 0 1-1.211.748c-.364.174-.751.303-1.526.561l-4.083 1.361a1.06 1.06 0 0 1-1.342-1.341l1.362-4.084c.258-.774.387-1.161.56-1.525q.309-.646.749-1.212c.248-.318.537-.606 1.114-1.183z" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg> Edit
            </button>
...
<svg aria-hidden="true" className="iconify text-lg opacity-70 iconify--solar" data-icon="solar:trash-bin-trash-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M3 6.386c0-.484.345-.877.771-.877h2.665c.529-.016.996-.399 1.176-.965l.03-.1l.115-.391c.07-.24.131-.45.217-.637c.338-.739.964-1.252 1.687-1.383c.184-.033.378-.033.6-.033h3.478c.223 0 .417 0 .6.033c.723.131 1.35.644 1.687 1.383c.086.187.147.396.218.637l.114.391l.03.1c.18.566.74.95 1.27.965h2.57c.427 0 .772.393.772.877s-.345.877-.771.877H3.77c-.425 0-.77-.393-.77-.877" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path clip-rule="evenodd" d="M9.425 11.482c.413-.044.78.273.821.707l.5 5.263c.041.433-.26.82-.671.864c-.412.043-.78-.273-.821-.707l-.5-5.263c-.041-.434.26-.821.671-.864m5.15 0c.412.043.713.43.671.864l-.5 5.263c-.04.434-.408.75-.82.707c-.413-.044-.713-.43-.672-.864l.5-5.264c.041-.433.409-.75.82-.707" data-darkreader-inline-fill="" fill="currentColor" fill-rule="evenodd" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M11.596 22h.808c2.783 0 4.174 0 5.08-.886c.904-.886.996-2.339 1.181-5.245l.267-4.188c.1-1.577.15-2.366-.303-2.865c-.454-.5-1.22-.5-2.753-.5H8.124c-1.533 0-2.3 0-2.753.5s-.404 1.288-.303 2.865l.267 4.188c.185 2.906.277 4.36 1.182 5.245c.905.886 2.296.886 5.079.886" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg> Delete
            </button>
</div>
...
<svg :data-icon="modalData.icon || 'solar:question-circle-bold-duotone'" aria-hidden="true" className="iconify text-4xl text-gray-500 iconify--solar" data-icon="solar:question-circle-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" data-darkreader-inline-fill="" fill="currentColor" opacity=".5" style={{-DarkreaderInlineFill: 'currentColor'}}></path><path d="M12 7.75c-.621 0-1.125.504-1.125 1.125a.75.75 0 0 1-1.5 0a2.625 2.625 0 1 1 4.508 1.829q-.138.142-.264.267a7 7 0 0 0-.571.617c-.22.282-.298.489-.298.662V13a.75.75 0 0 1-1.5 0v-.75c0-.655.305-1.186.614-1.583c.229-.294.516-.58.75-.814q.106-.105.193-.194A1.125 1.125 0 0 0 12 7.75M12 17a1 1 0 1 0 0-2a1 1 0 0 0 0 2" data-darkreader-inline-fill="" fill="currentColor" style={{-DarkreaderInlineFill: 'currentColor'}}></path></svg>
</div>

        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('livedesk', () => ({
                ...
                updateTime() {
                    ...
                    this.versionString = `ldl3b-7_v14_${day}.${month}.${year}_${strHours}:${minutes} ${ampm}`;
                },
                handleProfileClick() {
                    if (this.user) {
                        if(confirm('Log out?')) {
...
<h1 className="text-lg font-bold tracking-tight text-white hidden md:block">LIVEDESKLAUNCHER <span className="text-xs text-gray-600 ml-1">v14</span></h1>
...
<img :src="item.data" @error="$el.src='https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&amp;w=200&amp;auto=format&amp;fit=crop'" className="w-full h-full object-cover" x-show="item.type!=='video'"/>

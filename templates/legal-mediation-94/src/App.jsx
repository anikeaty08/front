...
<div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-[#0A262D]/90"></div>
</div>

<nav className="relative z-20 flex w-full items-center justify-between px-6 py-6 lg:px-12 border-b border-white/10">
<div className="flex items-center gap-2">
<div className="flex items-center justify-center w-8 h-8 bg-[#4FBFA5] rounded-md text-[#0A262D]">
<span className="font-semibold text-lg">M</span>
</div>
<span className="text-white font-semibold tracking-tight text-lg uppercase">Miles</span>
</div>

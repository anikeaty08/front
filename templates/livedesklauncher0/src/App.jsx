...
<img :src="win.icon" className="w-3.5 h-3.5 object-cover rounded-sm" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'"/>
...
<img :src="file.url" className="w-full h-full object-cover" onerror="this.style.display='none'"/>
...
<img :src="app.icon" className="w-full h-full object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'"/>
...
<template x-if="win.icon &amp;&amp; (win.icon.includes('http') || win.icon.includes('data:'))">
<img :src="win.icon" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 p-1 rounded-lg" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'"/>

...
<section className="animate-entry delay-200 [animation:animationIn_0.8s_ease-out_0.1s_both] animate-on-scroll lg:mx-auto bg-gradient-to-br from-white/5 via-transparent to-white/5 max-w-7xl rounded-[2rem] mt-24 mx-4 mb-24 p-8 md:p-12 relative border border-white/5" id="features" style={{-BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.05))'}}>

...
<div className="absolute inset-0 backdrop-blur-none border-transparent transition-all duration-300" id="nav-bg"></div>
...
<span className="group-hover:opacity-80 transition-opacity text-xl font-medium text-slate-50 tracking-tight font-serif" id="logo-text">Lumina AI</span>
</a>

<div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/80" id="nav-links">
<a className="transition-colors" href="#services">AI Photobooths</a>
<a className="transition-colors" href="#portfolio">Portfolio</a>
<a className="transition-colors" href="#reviews">Stories</a>
<a className="transition-colors" href="#contact">Contact</a>
</div>
...
<div className="bg-gradient-to-r from-black/60 via-black/20 to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
</div>
...
<h1 className="md:text-8xl leading-[0.9] animate-fade-in-up text-6xl text-white tracking-tight font-serif mb-8" style={{animationDelay: '200ms'}}>The Future of Events <span className="italic font-light text-white/80">is Here.</span>
</h1>
...
<p className="text-lg text-neutral-300 font-light max-w-md mb-10 leading-relaxed animate-fade-in-up" style={{animationDelay: '300ms'}}>
      AI-Powered Photobooths for Dubai’s Most Exclusive Celebrations.
    </p>
...
<h3 className="text-lg text-white font-serif mb-1">Super Hero Photobooth</h3>
<p className="text-xs text-neutral-400 mb-4">Turn yourself into your favourite Super Hero!</p>
<div className="flex gap-2 text-xs text-indigo-300 gap-x-2 gap-y-2 items-center">
...
<div>
<h2 className="text-3xl md:text-4xl mb-2 tracking-tight">Our AI Photobooths</h2>
<p className="text-neutral-500 dark:text-neutral-400 text-sm font-light">We don't just take photos. We create digital assets</p>
</div>
...
<img alt="Hair Styling" className="group-hover:scale-105 transition-transform duration-700 w-full h-full object-cover" src="https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&amp;w=1000&amp;auto=format&amp;fit=crop"/>
</div>
<div className="flex justify-between items-start">
<div className="">
<h3 className="text-xl mb-1 font-serif italic">Celebrity Selphie</h3>
<p className="text-neutral-500 dark:text-neutral-400 text-xs">Your Guests. Their Heroes.</p>
</div>
...
<div className="flex justify-between items-start">
<div className="">
<h3 className="text-xl mb-1 font-serif italic">Superhero Transformation</h3>
<p className="text-neutral-500 dark:text-neutral-400 text-xs">Your Guests. Their Dreams.</p>
</div>
...
<div className="flex justify-between items-start">
<div>
<h3 className="text-xl mb-1 font-serif italic">Brand Ambassador</h3>
<p className="text-neutral-500 dark:text-neutral-400 text-xs">Your Guests. Your Brand Universe.</p>
</div>
<span className="text-sm font-medium">from AED 3,000</span>
</div>
</div>
</div>
</div>
...
<h2 className="md:text-4xl text-3xl tracking-tight">AI Photobooth Results</h2>
</div>

<div className="max-w-4xl mx-auto mb-24 reveal-on-scroll">
<div className="aspect-[16/9] md:aspect-[21/9] overflow-hidden comparison-slider w-full rounded-2xl relative shadow-2xl" id="comparisonSlider">

<img alt="After" className="w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7fe5b4c3-d530-47ff-9a33-88198c09d7ed_1600w.jpg?w=800&amp;q=80"/>
<span className="absolute top-4 right-4 bg-black/50 text-white px-2 py-1 text-xs rounded backdrop-blur-sm">AFTER</span>

<div className="comparison-item" id="comparisonOverlay" style={{width: '50.558%'}}>
<span className="absolute top-4 left-4 bg-black/50 text-white px-2 py-1 text-xs rounded backdrop-blur-sm">BEFORE</span><img alt="Before" className="md:w-[64rem] lg:w-[56rem] w-[100vw] h-full max-w-none object-cover absolute top-0 left-0" id="comparisonImageBefore" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7fe5b4c3-d530-47ff-9a33-88198c09d7ed_3840w.jpg?w=800&amp;q=80" style={{width: '896px'}}/>
</div>

<div className="comparison-handle" id="comparisonHandle" style={{left: '50.558%'}}>
...
<div className="min-w-[300px] md:min-w-[400px] dark:bg-dark-800 snap-center bg-neutral-50 rounded-2xl pt-8 pr-8 pb-8 pl-8">
...
<span className="text-xl text-white tracking-tight font-serif">Lumina AI</span>
</div>
<p className="leading-relaxed text-xs font-light text-neutral-500 max-w-xs">AI-Powered Photobooths for Dubai’s Most Exclusive Celebrations. Located in the heart of Dubai.</p>
...
<span className="">123 Fifth Avenue, New York, NY 10010</span>
</li>
...
<p className="">©2025 Lumina AI. All rights reserved.</p>

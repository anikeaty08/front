...
<img alt="Landscape" className="w-full h-full object-cover opacity-40 mix-blend-luminosity" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2b5079f4-4ddd-433b-a936-fc8f7dea9df0_3840w.webp"/>
...
<svg className="lucide lucide-play w-4 h-4 fill-current" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path>
</svg>
</div>
<span className="absolute bottom-8 text-orange-500/30 text-xs font-mono">
          03
        </span>
</div>
...
<div className="flex-1 flex flex-col w-full max-w-7xl mr-auto ml-auto relative" style={{}}>

<nav className="flex justify-between items-center py-8 px-6 md:px-10 animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.1s_both]">
<div className="flex items-center gap-3 group cursor-pointer">
<div className="flex bg-gradient-to-tr from-orange-500 to-amber-500 w-8 h-8 rounded-full items-center justify-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}>
<div className="w-2.5 h-2.5 bg-black rounded-full" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}></div>
</div>
...
<a className="text-xs font-medium tracking-widest uppercase hover:text-white transition-colors text-neutral-400" href="#" style={{}}>
            Workflow
          </a>
<a className="text-xs font-medium tracking-widest uppercase hover:text-white transition-colors text-neutral-400" href="#" style={{}}>
            Resources
...
<a className="text-sm font-medium hover:text-white transition-colors text-neutral-400" href="#" style={{}}>
            Log In
          </a>
...
<span className="inner">Get Access</span>
</button>
</div>
</nav>

<div className="flex-1 grid grid-cols-1 lg:grid-cols-12 pt-24 pb-10 gap-x-4 gap-y-4 items-center" style={{}}>

<div className="col-span-1 lg:col-span-6 pl-6 md:pl-10 pt-10 lg:pt-0 flex flex-col justify-center">
<div className="inline-flex items-center gap-2 text-orange-500 mb-8 animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.1s_both]">
<span className="flex h-2 w-2 rounded-full bg-orange-500"></span>
<span className="text-xs font-bold tracking-widest uppercase text-orange-500/80">
              Creative Suite 2.0
            </span>
</div>
<h1 className="text-6xl md:text-7xl lg:text-8xl leading-[0.9] tracking-tighter text-white font-medium mb-6 animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.2s_both]">
            Craft Visual
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-200 to-neutral-500" style={{}}>
              Stories.
            </span>
</h1>
<p className="leading-relaxed text-lg font-medium text-white/60 max-w-lg animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.35s_both]">
...
<div className="mt-10 flex flex-wrap gap-6 items-center animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.5s_both]">
...
<svg className="lucide lucide-sparkles w-3.5 h-3.5 text-white fill-white" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<path d="M3.845 3.845a2.883 2.883 0 0 0 0 4.077L5.432 9.51c.012-.014.555.503.568.49l4-4c.013-.013-.504-.556-.49-.568L7.922 3.845a2.883 2.883 0 0 0-4.077 0m1.288 11.462a.483.483 0 0 1 .9 0l.157.4a.48.48 0 0 0 .272.273l.398.157a.486.486 0 0 1 0 .903l-.398.158a.48.48 0 0 0-.272.273l-.157.4a.483.483 0 0 1-.9 0l-.157-.4a.48.48 0 0 0-.272-.273l-.398-.158a.486.486 0 0 1 0-.903l.398-.157a.48.48 0 0 0 .272-.274z" fill="#ffffff" opacity=".5"></path>
<path d="M19.967 9.13a.483.483 0 0 1 .9 0l.156.399c.05.125.148.224.273.273l.398.158a.486.486 0 0 1 0 .902l-.398.158a.5.5 0 0 0-.273.273l-.156.4a.483.483 0 0 1-.9 0l-.157-.4a.5.5 0 0 0-.272-.273l-.398-.158a.486.486 0 0 1 0-.902l.398-.158a.5.5 0 0 0 .272-.273z" fill="#ffffff" opacity=".2"></path>
<path d="M16.1 2.307a.483.483 0 0 1 .9 0l.43 1.095a.48.48 0 0 0 .272.274l1.091.432a.486.486 0 0 1 0 .903l-1.09.432a.5.5 0 0 0-.273.273L17 6.81a.483.483 0 0 1-.9 0l-.43-1.095a.5.5 0 0 0-.273-.273l-1.09-.432a.486.486 0 0 1 0-.903l1.09-.432a.5.5 0 0 0 .273-.274z" fill="#ffffff" opacity=".7"></path>
<path d="M10.568 6.49c-.012.014-.555-.503-.568-.49l-4 4c-.013.013.504.556.49.568l9.588 9.587a2.883 2.883 0 1 0 4.078-4.077z" fill="#ffffff"></path>
</svg>
</div>
...
<div className="flex items-center gap-2 text-xs font-medium text-neutral-500" style={{}}>
<svg className="lucide lucide-check w-3.5 h-3.5 text-orange-500" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="col-span-1 lg:col-span-6 md:pr-10 flex flex-col lg:pt-20 h-full pt-10 pr-6 items-end justify-center" style={{}}>

<div className="relative mb-12 mr-4 w-64 md:w-72 aspect-video group perspective-1000 animate-on-scroll [animation:fadeSlideIn_1.2s_cubic-bezier(0.2,0.8,0.2,1)_0.4s_both]">
...
<div className="card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900" id="card-3" style={{transform: 'translateY(24px) scale(0.9)', zIndex: '10', opacity: '0.4'}}>
<img alt="Export" className="w-full h-full object-cover opacity-60" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c3337c33-82ae-4ad6-9c83-f9f1a5bdc53c_800w.webp"/>
...
<div className="card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900" id="card-2" style={{transform: 'translateY(12px) scale(0.95)', zIndex: '20', opacity: '0.6'}}>
<img alt="AI Processing" className="w-full h-full object-cover opacity-70" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6e8af32c-e155-4b33-9e0a-eb91a91debbe_800w.webp"/>
<div className="absolute inset-0 bg-black/20"></div>
<div className="absolute bottom-3 left-3 flex items-center gap-2">
<div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" style={{}}></div>
...
<div className="card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900" id="card-1" style={{transform: 'translateY(0px) scale(1)', zIndex: '30', opacity: '1'}}>
<img alt="Import" className="w-full h-full object-cover opacity-90" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2b5079f4-4ddd-433b-a936-fc8f7dea9df0_800w.webp"/>
...
<svg className="lucide lucide-play w-4 h-4 fill-white text-white ml-1" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path>
</svg>
</div>
</div>
...
<div className="step-item flex cursor-pointer transition-all duration-300 bg-white/5 rounded-lg pt-2 pr-2 pb-2 pl-2 shadow-xl backdrop-blur-md translate-x-[-10px] gap-x-4 gap-y-4 items-center animate-on-scroll [animation:fadeSlideIn_0.8s_cubic-bezier(0.2,0.8,0.2,1)_0.6s_both]" id="step-1" onclick="activateStep(1)" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '8px'}}>
<div className="w-6 h-6 rounded-full bg-orange-500 flex items-center justify-center text-[10px] font-bold text-black shadow-lg shadow-orange-500/20 transition-colors duration-300" id="badge-1">
                01
              </div>
<span className="text-sm font-medium text-white transition-colors duration-300" id="text-1">
                Import Footage
              </span>
<svg className="lucide lucide-video w-3 h-3 ml-auto transition-all duration-300 text-orange-500 opacity-100" data-lucide="video" fill="none" height="24" id="icon-1" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"></path>
<rect height="12" rx="2" width="14" x="2" y="6"></rect>
</svg>
</div>

<div className="step-item flex gap-4 hover:bg-white/5 transition-all duration-300 cursor-pointer group rounded-lg pt-2 pr-2 pb-2 pl-2 gap-x-4 gap-y-4 items-center animate-on-scroll [animation:fadeSlideIn_0.8s_cubic-bezier(0.2,0.8,0.2,1)_0.7s_both]" id="step-2" onclick="activateStep(2)" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '8px'}}>
<div className="w-6 h-6 rounded-full bg-transparent flex items-center justify-center text-[10px] font-bold group-hover:text-orange-400 transition-colors duration-300 text-neutral-500" id="badge-2" style={{}}>
                02
              </div>
<span className="text-sm font-medium group-hover:text-white transition-colors duration-300 text-neutral-400" id="text-2" style={{}}>
                AI Scene Detect
              </span>
<svg className="lucide lucide-scan-line w-3 h-3 ml-auto transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:text-white text-neutral-600" data-lucide="scan-line" fill="none" height="24" id="icon-2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="step-item flex hover:bg-white/5 transition-all duration-300 cursor-pointer group rounded-lg pt-2 pr-2 pb-2 pl-2 gap-x-4 gap-y-4 items-center animate-on-scroll [animation:fadeSlideIn_0.8s_cubic-bezier(0.2,0.8,0.2,1)_0.8s_both]" id="step-3" onclick="activateStep(3)" style={{position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '8px'}}>
<div className="w-6 h-6 rounded-full bg-transparent flex items-center justify-center text-[10px] font-bold group-hover:text-orange-400 transition-colors duration-300 text-neutral-500" id="badge-3" style={{}}>
                03
              </div>
<span className="text-sm font-medium group-hover:text-white transition-colors duration-300 text-neutral-400" id="text-3" style={{}}>
                Export 4K
              </span>
<svg className="lucide lucide-download w-3 h-3 ml-auto transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:text-white text-neutral-600" data-lucide="download" fill="none" height="24" id="icon-3" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-quote w-5 h-5 text-black/40 fill-black/20" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path>
<path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path>
</svg>
</div>
<div className="">
<p className="text-lg font-semibold leading-snug tracking-tight max-w-[80%]">
...
<svg className="lucide lucide-sparkles w-3 h-3" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h2 className="text-4xl lg:text-5xl font-normal tracking-tighter text-white animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.2s_both]">
              Next generation
              <span className="text-white/60">creative suite.</span>
</h2>
</div>
</div>
</div>
...
<svg className="lucide lucide-zap w-[16px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="info-circle-bold-duotone" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" style={{color: 'rgb(251, 146, 60)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" fill="#fb923c" opacity=".5"></path>
<path d="M12 17.75a.75.75 0 0 0 .75-.75v-6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75M12 7a1 1 0 1 1 0 2a1 1 0 0 1 0-2" fill="#fb923c"></path>
</svg>
...
<span className="text-white">We are a creative intelligence engine</span>
          ...
          <span className="text-white">visualizes stories.</span>
          With a team of researchers, engineers, and artists, we build tools
          that empower
          <span className="text-white">ambitious creators</span>
          to design, animate, and ship cinematic experiences at the speed of
          thought.
        </h3>
</div>
...
<div className="text-xl font-medium pl-1 text-neutral-500" style={{}}>
            Creator Revenue
          </div>
</div>
...
<div className="mt-24 animate-on-scroll [animation:fadeSlideIn_1.2s_cubic-bezier(0.2,0.8,0.2,1)_0.8s_both] [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.6s_both] [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.7s_both]">
<p className="text-lg font-medium mb-8 uppercase tracking-widest text-center md:text-left text-neutral-500" style={{}}>
...
<svg className="fill-white w-[256px] h-[32px]" data-icon-replaced="true" data-icon-set="logos" data-logos="100tb" height="32" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '256px', height: '32px'}} viewbox="0 0 512 190" width="256" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-[10px] text-neutral-400">News</span>
</div>
...
<span className="text-[10px] text-neutral-400">Updates</span>
</div>
...
<div className="w-14 h-14 rounded-full p-[2px] bg-gradient-to-tr from-orange-400 to-pink-600">
<div className="w-full h-full rounded-full bg-black flex items-center justify-center border-2 border-black">
<div className="text-[9px] font-bold text-white">New</div>
</div>
</div>
<span className="text-[10px] text-neutral-400">Feature</span>
</div>
</div>
...
<span className="font-semibold text-white">Lumina_official</span>
                  Transform your workflow with our new Creative Engine 2.0 🚀
                  <span className="text-blue-400">#MadeWithLumina</span>
</p>
</div>
</div>
...
<p className="text-sm leading-relaxed text-neutral-300">
                  ...
                  <span className="text-white font-medium">asset pipelines</span>
...
<img alt="Texture" className="opacity-20 mix-blend-luminosity w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0 blur-sm" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4c087a1e-aa65-42f7-9a89-dc582f5d807a_3840w.webp"/>
</div>
...
<a className="relative z-10 text-5xl md:text-7xl lg:text-8xl font-medium tracking-tighter text-white group-hover/item:text-transparent group-hover/item:bg-clip-text group-hover/item:bg-gradient-to-r group-hover/item:from-white group-hover/item:to-neutral-500 transition-all duration-500 animate-on-scroll [animation:fadeSlideIn_1s_cubic-bezier(0.2,0.8,0.2,1)_0.4s_both]" href="mailto:hello@lumina.ai">
              HELLO@LUMINA.AI
            </a>
<div className="absolute -right-8 top-4 opacity-0 group-hover/item:opacity-100 transition-opacity duration-500 translate-x-2 group-hover/item:translate-x-0">
<span className="flex items-center justify-center w-5 h-5 rounded bg-orange-500 text-[9px] font-bold text-black uppercase tracking-wider shadow-[0_0_15px_rgba(249,115,22,0.6)]">

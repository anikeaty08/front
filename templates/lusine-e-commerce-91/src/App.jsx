...
<h3 className="md:text-base text-sm font-bold tracking-tight -translate-y-3">Lits</h3>
</div>
<div className="group cursor-pointer">
<div className="relative aspect-[4/3] md:aspect-square overflow-hidden bg-stone-200 mb-3 md:mb-4 rounded-lg">
...
<h3 className="md:text-base text-sm font-bold tracking-tight -translate-y-3">Rangement</h3>
</div>
<div className="group cursor-pointer">
<div className="relative aspect-[4/3] md:aspect-square overflow-hidden bg-stone-200 mb-3 md:mb-4 rounded-lg">
...
<h3 className="md:text-base text-sm font-bold tracking-tight -translate-y-3">Tapis</h3>
</div>
</div>
</section>
...
<img className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?q=80&amp;w=2670&amp;auto=format&amp;fit=crop"/>
...
<h2 className="leading-[1.1] text-lusine-dark text-5xl tracking-tight font-serif md:text-3xl">
              L'art de recevoir avec élégance
            </h2>
<p className="leading-relaxed text-base font-medium text-stone-600">
              Créez un espace où chaque moment devient mémorable. Nos
              collections allient confort contemporain et design intemporel pour
              sublimer votre intérieur durant les fêtes et au-delà.
            </p>
<button className="border-lusine-dark text-lusine-dark uppercase hover:bg-lusine-dark hover:text-white transition-colors duration-300 text-sm font-bold tracking-widest border-2 rounded-full pt-2 pr-2 pb-2 pl-2">Explorer le look</button>
</div>
...
<span className="leading-tight text-[10px] md:text-sm font-bold text-stone-900">Canapé Lowell</span>
...
<span className="leading-tight text-[10px] md:text-sm font-bold text-stone-900">Fauteuil Lucky</span>
...
<div className="flex justify-between items-start mb-2" style={{}}>
<span className="leading-tight text-[10px] md:text-sm font-bold text-stone-900">Table Clovis</span>
...
<div className="flex justify-between items-start mb-2">
<span className="leading-tight text-[10px] md:text-sm font-bold text-stone-900">Tapis Meghan</span>
...
<p className="uppercase text-xs font-bold tracking-widest mb-2">DÉCOR VIRTUEL</p>
<h3 className="text-3xl font-bold tracking-tight mb-4 md:text-2xl">Visualisez les meubles dans votre pièce</h3>
<span className="underline decoration-2 underline-offset-4 font-semibold">Essayer maintenant</span>
</div>
</div>
...
<h2 className="text-3xl tracking-tight text-lusine-dark font-bold md:text-2xl">Venez nous rendre visite</h2>
...
<p className="">Design intemporel pour la vie moderne.</p>
</div>
<div className="">
<h5 className="text-white font-bold mb-4">Service Client</h5>
...
<div>
<h5 className="text-white font-bold mb-4">Compagnie</h5>
<ul className="space-y-2 font-medium">
<li>
<a className="hover:text-white transition-colors" href="#">
                À propos
...
<div className="">
<h5 className="text-white font-bold mb-4">Infolettre</h5>
<div className="flex gap-2">
<input className="bg-stone-800 border-none px-4 py-2 w-full focus:ring-1 focus:ring-white outline-none rounded-full px-6" placeholder="Votre courriel" type="email"/>

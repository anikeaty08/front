...
<main className="md:pt-12 md:pl-10 md:pr-10 max-w-[1920px] mr-auto ml-auto pt-12 pr-6 pb-20 pl-6">
...
<div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 md:gap-x-10 md:gap-y-16 gap-x-4 gap-y-10">

<div className="group cursor-pointer relative">
<div className="aspect-square overflow-hidden bg-[#F6F6F6] rounded-[2rem] mb-5 relative">

<img alt="Modulaire Delano - Grey" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover absolute inset-0" data-img-index="0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/37e89851-ca0a-4488-84c5-781f5bd88b87_1600w.jpg"/>

<img alt="Modulaire Delano - Brown" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" data-img-index="1" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/52e39de4-4df5-42e6-9053-5122fd2522a6_1600w.jpg"/>

<img alt="Modulaire Delano - Beige" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" data-img-index="2" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ac6d6a5e-195c-4099-966f-c28ee48bd8b3_1600w.jpg"/>

<img alt="Modulaire Delano - Dark Grey" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" data-img-index="3" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d39b74df-b868-4d81-b4ff-e0626a33975f_1600w.jpg"/>
</div>
...
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative" style={{}}>
<img alt="Sofa Beige" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1c2b5051-0274-41ba-ab80-3d25d9afaa72_800w.jpg"/>
...
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Sofa White" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8f3f25ce-372e-459c-8722-4d63af1ea027_800w.jpg"/>
<div className="absolute top-5 right-5">
<span className="bg-[#1A3C34] text-white text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wider">
                Nouveau
              </span>
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Lounge Sofa" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b9d0c2f4-d75d-4995-af23-a8bd0e9c88e0_800w.jpg"/>
<div className="absolute top-5 right-5">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Armchair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/fe7cc508-45b3-41c4-85cf-b645b97e0512_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex w-full items-baseline justify-between">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Green Velvet Sofa" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8b5b034f-5e2b-4027-962a-20dd5654573b_1600w.jpg"/>
<div className="absolute top-5 right-5">
<span className="bg-[#1A3C34] text-white text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wider">
                Nouveau
              </span>
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="White Chair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a23dbe4d-1702-40ca-acb2-bb52dd617bb1_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Modern Couch" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8d97842c-89f2-4d6f-b86b-aa00195820ab_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Chair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6a881918-2fcd-4cef-aba6-bcbebd69c7ce_1600w.jpg"/>
<div className="absolute top-5 right-5">
<span className="bg-[#1A3C34] text-white text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wider">
                Nouveau
              </span>
...
<div className="group cursor-pointer">
<div className="aspect-square overflow-hidden bg-[#F6F6F6] rounded-[2rem] mb-5 relative">
<img alt="Grey Chair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6f760b6a-55e0-4511-9259-3e2b9fb09585_1600w.jpg"/>
<div className="absolute top-5 right-5">
<span className="bg-[#C0562F] text-white text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wider">
      Solde
    </span>
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Sofa" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e493df80-e76d-449d-9389-bfb311b1fd7d_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex w-full items-baseline justify-between">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Chair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/37e6ea2c-341a-458c-9c7b-e8972ee756d5_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Sofa" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/502c3fc3-8ac7-4d1e-825b-1cc545be4537_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Chair" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b7b9d5b9-3c18-4d98-af59-a5be6207338b_1600w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Sofa" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/765f6ac0-2975-47dc-8c3d-54c381659533_1600w.png"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex w-full items-baseline justify-between">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">
...
<div className="group cursor-pointer">
<div className="aspect-square bg-[#F6F6F6] rounded-[2rem] overflow-hidden mb-5 relative">
<img alt="Fauteuil" className="group-hover:scale-105 transition-transform duration-700 ease-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cc685b9c-62e5-45e4-b225-0a1e0b952477_800w.jpg"/>
</div>
<div className="flex flex-col gap-1 px-1">
<div className="flex justify-between items-baseline w-full">
<h3 className="text-base font-semibold text-[#0B1E3D] tracking-tight">

...
<div className="display font-bold text-xl tracking-tighter">AURUM</div>
<div className="hidden md:flex gap-10 text-xs uppercase tracking-widest">
<a className="hover:text-gray-300 transition-colors" href="#">Residences</a>
<a className="hover:text-gray-300 transition-colors" href="#">About</a>
<a className="hover:text-gray-300 transition-colors" href="#">Private Office</a>
</div>
...
<h1 className="display text-[12vw] leading-none hero-text overflow-hidden">
<span className="block translate-y-full">VISION</span>
</h1>

<p className="mt-8 text-sm uppercase tracking-[0.5em] opacity-0 hero-fade mix-blend-difference">Ultra-Luxury Developments</p>
</div>
</section>

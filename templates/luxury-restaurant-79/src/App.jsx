...
'body': ['Inter', 'sans-serif']
            ...
            grid.innerHTML = items.map(item => `
                <div class="group bg-charcoal-light rounded-xl overflow-hidden border border-cream/10 hover:border-gold/30 transition-all duration-500">
                    <div class="relative h-48 overflow-hidden">
                        <img src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg" alt="${item.name} - Placeholder" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy">
                ...
                <div class="flex-shrink-0 w-full md:w-1/2 lg:w-1/3 px-3">
                    <div class="bg-charcoal p-8 rounded-xl border border-cream/10 h-full">
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg" alt="${t.name}" class="w-12 h-12 rounded-full object-cover">
                            <div>
        ...
        function renderBlog() {
            ...
            grid.innerHTML = pagePosts.map(post => `
                <article class="group bg-charcoal-light rounded-xl overflow-hidden border border-cream/10 hover:border-gold/30 transition-all duration-500 cursor-pointer" onclick="openBlogPost(${post.id})">
                    <div class="relative h-48 overflow-hidden">
                        <img src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg" alt="${post.title} - Placeholder" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy">
        ...
        function openBlogPost(id) {
            ...
            content.innerHTML = `
                <article>
                    <img src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg" alt="${post.title}" class="w-full h-64 md:h-96 object-cover rounded-xl mb-8">

...
<a className="text-2xl md:text-3xl font-serif text-[#F8FAFC] tracking-tight hover:opacity-80 transition-opacity" href="#">
                RALSS LUXE
            </a>

<nav className="hidden md:flex items-center gap-8">
<a className="text-sm font-light text-slate-200 hover:text-[#00D7E7] transition-colors tracking-wide uppercase" href="#about">About</a>
...
<span className="iconify w-6 h-6" data-icon="lucide:chevron-down"></span>
</div>
</section>
...
<span className="iconify w-full h-full" data-icon="lucide:scissors"></span>
</div>
...
<div className="w-12 h-12 mb-6 text-[#00D7E7] group-hover:text-[#0F172A] transition-colors duration-500">
<span className="iconify w-full h-full" data-icon="lucide:sparkles"></span>
</div>
...
<div className="w-12 h-12 mb-6 text-[#00D7E7] group-hover:text-[#0F172A] transition-colors duration-500">
<span className="iconify w-full h-full" data-icon="lucide:user-check"></span>
</div>
...
<div className="w-12 h-12 mb-6 text-[#00D7E7] group-hover:text-[#0F172A] transition-colors duration-500">
<span className="iconify w-full h-full" data-icon="lucide:gem"></span>
</div>
...
<a className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-[#0F172A] border-b border-[#00D7E7] pb-1 hover:text-[#00D7E7] transition-colors" href="#">
                    View Full Gallery <span className="iconify" data-icon="lucide:arrow-up-right"></span>
</a>
</div>
...
<span className="iconify text-4xl text-slate-400" data-icon="lucide:map"></span>
</div>
...
<span className="iconify text-[#C9A24D]" data-icon="lucide:phone"></span> +1 (555) 123-4567
                            </a>
<div className="flex items-center gap-3 text-sm text-slate-600">
<span className="iconify text-[#C9A24D]" data-icon="lucide:clock"></span> Mon-Sun: 10AM - 9PM
                            </div>
</div>
...
<div className="flex flex-col gap-3 mb-6">
<a className="flex items-center gap-3 text-sm text-slate-600 hover:text-[#00D7E7]" href="tel:+1234567890">
<span className="iconify text-[#C9A24D]" data-icon="lucide:phone"></span> +1 (555) 987-6543
                            </a>
<div className="flex items-center gap-3 text-sm text-slate-600">
<span className="iconify text-[#C9A24D]" data-icon="lucide:clock"></span> Mon-Sun: 10AM - 9PM
                            </div>
...
<span className="iconify w-6 h-6" data-icon="lucide:phone-call"></span>
</div>
<div>
...
<div className="flex items-start gap-4">
<div className="p-3 bg-white/5 rounded-full text-[#00D7E7]">
<span className="iconify w-6 h-6" data-icon="lucide:mail"></span>
</div>
<div>
...
<a className="text-slate-400 hover:text-[#00D7E7] transition-colors" href="#"><span className="iconify" data-icon="lucide:instagram"></span></a>
<a className="text-slate-400 hover:text-[#00D7E7] transition-colors" href="#"><span className="iconify" data-icon="lucide:facebook"></span></a>
<a className="text-slate-400 hover:text-[#00D7E7] transition-colors" href="#"><span className="iconify" data-icon="lucide:twitter"></span></a>
</div>
</div>
...
<li><a className="hover:text-[#00D7E7] transition-colors" href="#services">Services</a></li>
...
<li><a className="hover:text-[#00D7E7] transition-colors" href="#">Bridal Makeup</a></li>
...
<ul className="space-y-3 text-sm font-light">
<li className="flex items-center gap-2"><span className="iconify text-[#00D7E7]" data-icon="lucide:phone"></span> +1 (555) 123-4567</li>
<li className="flex items-center gap-2"><span className="iconify text-[#00D7E7]" data-icon="lucide:mail"></span> hello@ralssluxe.com</li>
</ul>
</div>
</div>

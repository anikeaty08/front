...
<span className="text-sm font-semibold tracking-tight text-white uppercase">MANAGABLE</span>
</a>
...
<h2 className="text-3xl md:text-5xl font-semibold text-white tracking-tight mb-6">This is Managable.</h2>
...
<p className="text-2xl md:text-3xl font-light text-white leading-relaxed mb-8">
                    "Outsourcing comms is as bad as outsourcing code. <span className="text-red-500 font-normal">Managable is the antidote.</span>"
                </p>
...
<span className="text-base font-semibold tracking-tight text-white uppercase">Managable</span>
</div>
...
<p className="text-[10px] text-slate-600 uppercase tracking-wider">© 2024 Managable.</p>

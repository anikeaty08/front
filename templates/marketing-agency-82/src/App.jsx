...
<a className="text-xs px-4 py-2 md:px-5 md:py-2.5 rounded-full transition-all duration-300 flex items-center gap-2 font-montserrat font-medium group shadow-md hover:shadow-lg hover:shadow-rose-500/20 bg-white text-black hover:bg-rose-600 hover:text-white shrink-0" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
          Get Started
...
<div className="animate-fade-up w-fit border px-3 py-1 rounded-full text-[10px] tracking-widest uppercase font-montserrat font-semibold mb-6 md:mb-8 bg-rose-950/30 border-rose-900/50 text-rose-400">
            Attention Established Coaches, Consultants, or Course Creators
          </div>
...
<h1 className="animate-fade-up delay-100 text-4xl sm:text-5xl md:text-7xl lg:text-[5rem] leading-[1.1] md:leading-[0.95] tracking-tighter mb-6 md:mb-8 font-serif font-medium text-white">
            ...
            in Email Revenue In 90 Days or You Don't Pay A Dime
          </h1>
...
<p className="animate-fade-up delay-200 text-base md:text-xl text-gray-400 leading-relaxed max-w-2xl mb-8 md:mb-12 font-light px-2">
            Our proprietary "Revenue Reactivation System" adds $20,000-$50,000
            in email revenue to your business in 90 days without you lifting a
            finger.
          </p>
...
<a className="w-full sm:w-auto px-8 py-3.5 md:py-4 rounded-full text-sm hover:shadow-xl hover:shadow-rose-500/20 transition-all duration-300 flex items-center justify-center gap-2 font-montserrat font-medium group bg-white text-black hover:bg-rose-600 hover:text-white" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
              Get Started
...
<h3 className="text-lg md:text-xl font-montserrat font-semibold mb-2 md:mb-3 text-white">
              Being Overwhelmed Running Your Business?
            </h3>
<p className="text-gray-400 font-light leading-relaxed text-sm">
              I'll write all the emails, manage the calendar, handle the
              optimization, you just approve and send. The money you've been
              leaving on the table from not sending emails will flow right into
              your bank account.
            </p>
</div>
...
<h3 className="text-lg md:text-xl font-montserrat font-semibold mb-2 md:mb-3 text-white">
              Being Stuck On The Revenue Rollercoaster?
            </h3>
<p className="text-gray-400 font-light leading-relaxed text-sm">
              The Revenue Reactivation System creates consistent, predictable
              revenue between launches by building automated nurture sequences
              and weekly relationship-building emails that sell without seeming
              sleazy
            </p>
</div>
...
<h3 className="text-lg md:text-xl font-montserrat font-semibold mb-2 md:mb-3 text-white">
              Not Having Time To Do Email Yourself?
            </h3>
<p className="text-gray-400 font-light leading-relaxed text-sm">
              You're already maxed out with client delivery, sales calls, and
              content. Email keeps getting pushed to the bottom of your to-do
              list. You need someone who can handle this thing for you so you
...
<h2 className="md:text-5xl text-3xl font-medium text-white tracking-tight font-serif mb-4">
            Why Choose IronPeak Marketing
          </h2>
<p className="text-gray-400 max-w-2xl mx-auto font-light text-sm md:text-base">
            We use a unique Story-Driven Relationship System that your
...
<a className="w-full sm:w-auto justify-center px-8 py-3.5 rounded-full text-sm transition-all duration-300 font-montserrat font-medium flex items-center gap-2 bg-white text-black hover:bg-rose-600 hover:text-white" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
            Book a Call
...
<h3 className="text-2xl md:text-4xl lg:text-5xl font-serif leading-tight mb-8 md:mb-10 italic text-white px-2">
            "We added $50k in recurring revenue within just 90 days of working
            with IronPeak Marketing. Their systems are unlike anything we've
            seen before."
          </h3>
...
<img className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7c962ecc-91be-43f7-a432-788cc2f184fa_320w.jpg"/>
</div>
<div className="font-montserrat font-semibold text-white">Oliver Anwar</div>
<div className="text-xs md:text-sm font-light text-gray-500">
              CEO Elite Performance
            </div>
</div>
</div>
</section>
...
<div className="grid md:grid-cols-3 gap-10 md:gap-8 max-w-6xl mr-auto ml-auto relative gap-x-10 gap-y-10">
...
<p className="text-sm text-gray-400 font-light leading-relaxed max-w-xs px-4 md:px-0">
              Sales start flowing. You focus on closing deals and servicing
              clients while we handle growth.
            </p>
</div>
</div>
...
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" className="w-full h-full absolute inset-0" frameborder="0" referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/-RbcyvZUxDI?si=NjU2hYMv19PkdTOS" title="YouTube video player"></iframe>
</div>
<div className="flex justify-center">
<a className="w-full sm:w-auto justify-center px-10 py-4 rounded-full text-sm transition-all duration-300 font-montserrat font-medium flex items-center gap-2 shadow-lg shadow-black/50 hover:shadow-rose-500/20 bg-white text-black hover:bg-rose-600 hover:text-white" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
                Apply Now
...
<h3 className="text-2xl md:text-4xl font-serif mb-4 md:mb-6 text-white">
                  All-In-One Email Growth Infrastructure
                </h3>
...
<span className="font-medium font-montserrat text-sm md:text-lg text-gray-300">
                      Email Copywriting (Automated Sequences • Weekly
                      Broadcasts)
                    </span>
</li>
<li className="flex items-center gap-3 md:gap-4">
...
<span className="font-medium font-montserrat text-sm md:text-lg text-gray-300">
                      Behavioral Segmentation &amp; List Management
                    </span>
</li>
<li className="flex items-center gap-3 md:gap-4">
<div className="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center shrink-0 bg-rose-900/20 text-rose-400 border border-rose-500/10">
...
<span className="font-medium font-montserrat text-sm md:text-lg text-gray-300">
                      Zero-Lift Implementation &amp; Management
                    </span>
</li>
<li className="flex items-center gap-3 md:gap-4">
<div className="w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center shrink-0 bg-rose-900/20 text-rose-400 border border-rose-500/10">
...
<span className="font-bold font-montserrat text-sm md:text-lg border-b-2 text-white border-rose-500/40">
                      If You Don't Make At Least $20k in Revenue in 90 Days You
                      Get A Full Refund
                    </span>
</li>
</ul>
...
<a className="w-full md:w-auto text-base md:text-lg px-8 md:px-12 py-4 md:py-5 rounded-full transition-all duration-300 shadow-xl font-montserrat font-medium flex items-center justify-center gap-3 group bg-white text-black hover:bg-rose-600 hover:text-white shadow-black/50" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
...
<p className="text-gray-400 text-sm leading-relaxed italic mb-6">"I never made a single dollar from my email list until Parker helped me"</p>
<div className="flex gap-3 gap-x-3 gap-y-3 items-center">
<div className="bg-neutral-800 w-10 h-10 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/542bd98f-fd5f-4331-b17a-a244b695b8a5_320w.jpg)] bg-cover bg-center rounded-full"></div>
<div className="">
<div className="text-sm font-bold text-white">Charlie Bennett</div>
<div className="text-xs text-gray-500">Founder, Cedar Scale</div>
</div>
</div>
</div>

<div className="p-6 rounded-2xl border shadow-sm bg-[#0a0a0a] border-white/5">
<p className="text-gray-400 text-sm leading-relaxed italic mb-6">"The best investment we made this year. The ROI tracking is phenomenal, we earned 5 figures in the first 7 days"</p>
<div className="flex items-center gap-3">
<div className="bg-neutral-800 w-10 h-10 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/26024fd9-cb5b-4af5-9732-5e6c60d1124a_320w.png)] bg-cover bg-center rounded-full"></div>
<div className="">
<div className="text-sm font-bold text-white">Alexandre Olim</div>
<div className="text-xs text-gray-500">CEO, Plutus Media</div>
</div>
</div>
</div>

<div className="p-6 rounded-2xl border shadow-sm bg-[#0a0a0a] border-white/5">
<p className="text-gray-400 text-sm leading-relaxed italic mb-6">"The IronPeak Marketing team are wizards. They helped my business earn $200k+ in additional revenue, with an email list of 6,000 people"</p>
<div className="flex gap-3 gap-x-3 gap-y-3 items-center">
<div className="bg-neutral-800 w-10 h-10 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a8f5b34d-1bb4-4acf-a29c-4fb39f234505_320w.jpg)] bg-cover bg-center rounded-full"></div>
<div className="">
<div className="text-sm font-bold text-white">Taylin Simmonds</div>
<div className="text-xs text-gray-500">Founder, Ghostlii</div>
</div>
</div>
</div>
</div>
...
<p className="">
              I founded
              <span className="font-medium text-white">IronPeak Marketing</span>
              with one mission: to eliminate the guesswork in digital growth.
            </p>
<p className="">
              After managing over $1M+ in ad spend for top-tier brands, I
              realized most agencies are broken. They focus on vanity metrics
              like "likes" instead of revenue. We built IronPeak Marketing to
              change that.
            </p>
</div>
<a className="inline-block mt-6 md:mt-8 font-semibold border-b pb-0.5 transition-all text-rose-400 border-rose-900 hover:border-rose-400" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
            Let's Talk!
          </a>
</div>
<div className="relative order-1 lg:order-2 h-64 md:h-[500px] w-full rounded-[2rem] overflow-hidden bg-neutral-900">
<img alt="Founder" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700 opacity-80 hover:opacity-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e51087f5-1f64-4173-b005-8e07c2e2f93d_1600w.jpg"/>
</div>
</section>
...
<div className="px-5 md:px-6 pb-6 text-sm text-gray-400 leading-relaxed font-light border-t pt-4 border-white/5">
              We specialize in B2B SaaS and high-ticket coaching. This allows us
              to maintain our high success rate and revenue guarantees.
            </div>
</details>
...
<div className="px-5 md:px-6 pb-6 text-sm text-gray-400 leading-relaxed font-light border-t pt-4 border-white/5">
              If we don't hit the agreed-upon KPI ($20k in new revenue) within
              90 days, we work for free until we do. It's written in the
              contract.
            </div>
</details>
...
<p className="text-center text-sm mt-8 text-gray-500">
          ...
          <a className="underline transition-all text-rose-400 decoration-rose-900 hover:decoration-rose-400" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
            Get in touch
          </a>
          .
        </p>
...
<section className="mx-auto py-16 md:py-24 px-4 md:px-6 max-w-7xl">
...
<iframe className="" frameborder="0" height="800" src="https://savvycal.com/Parker-Worth/725b7357" style={{minHeight: '800px'}} title="Book a Call - SavvyCal" width="100%"></iframe>
</div>
</section>
</main>
...
<a className="text-sm transition-colors font-medium text-gray-400 hover:text-rose-400" href="https://savvycal.com/Parker-Worth/725b7357" target="_blank">
            Contact
          </a>
</div>
</div>

...
<a className="vertical-text block bg-black border-y border-r border-red-900/50 text-red-600 text-xs font-semibold tracking-[0.2em] py-8 px-3 hover:bg-red-600 hover:text-black hover:shadow-[0_0_30px_rgba(220,38,38,0.4)] transition-all duration-500 uppercase" href="#">
...
<div className="text-lg tracking-tighter text-white uppercase flex items-center gap-3 font-medium">
<div className="text-red-600 text-2xl font-bold flex items-center tracking-tighter">
             HSK
          </div>
...
<a className="hover:text-red-600 transition-colors" href="#programs">
            Programs
          </a>
<a className="hover:text-red-600 transition-colors" href="#methodology">
            System
          </a>
...
<img alt="BJJ Rolling" className="w-full h-full object-cover grayscale brightness-[0.35] contrast-125 scale-105 animate-[pulse_10s_ease-in-out_infinite]" src="https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&amp;w=3840&amp;auto=format&amp;fit=crop"/>
...
<h1 className="text-8xl md:text-9xl leading-none font-bold text-red-700 tracking-tighter flex items-center" style={{filter: 'drop-shadow(0 0 30px rgba(185,28,28,0.4))'}}>
                HSK
              </h1>
</div>
...
<h2 className="animate-logo-text text-4xl md:text-6xl text-neutral-300 tracking-tight leading-[0.9] uppercase font-semibold reveal-on-scroll reveal-visible">
                Jiu-Jitsu
                <br/>
<span className="text-neutral-500">Syndicate</span>
</h2>
</div>
</div>
<p className="text-sm md:text-lg text-neutral-400 max-w-lg leading-relaxed border-l-2 border-red-700 pl-6 reveal-on-scroll reveal-visible">
            Comfort is the enemy of progress. Welcome to the proving ground.
            Technical grappling and elite striking for those who demand reality.
          </p>
</div>
...
<span className="block text-2xl text-white font-medium mb-1">Gi</span>
...
<span className="block text-2xl text-white font-medium mb-1">No-Gi</span>
<span className="text-[10px] uppercase tracking-widest text-neutral-500 group-hover:text-red-500 transition-colors">
                Submission
              </span>
</div>
...
<section className="relative py-32 bg-black overflow-hidden border-t border-neutral-900" id="programs">
<div className="absolute inset-0 laser-grid opacity-10 pointer-events-none"></div>
<div className="max-w-7xl mx-auto px-6 relative z-10">
<div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">

<div className="md:col-span-7">
<span className="inline-block text-red-600 text-xs font-semibold tracking-[0.2em] mb-6 uppercase flex items-center gap-2">
...
<h2 className="text-4xl md:text-6xl font-semibold text-white tracking-tight leading-tight mb-8 reveal-on-scroll">
              WE DON'T TEACH
              <span className="text-neutral-700">MOVES.</span>
<br/>
              WE TEACH
              <span className="text-red-700">SURVIVAL.</span>
</h2>
...
<p className="reveal-on-scroll">
                In a world of theory, we practice reality. HSK Combat Academy removes the fluff. 
                No kata, no mysticism. Just leverage, timing, and the undeniable truth of pressure.
                Whether you are 5 or 50, the mats don't lie.
              </p>
<p className="reveal-on-scroll">
                Our curriculum integrates high-level Brazilian Jiu-Jitsu with modern striking arts. 
                Designed for kids to build indestructible confidence, and adults to forge 
                capabilities that cannot be bought, only earned through sweat.
              </p>
</div>
...
<span className="text-3xl font-light text-white">
                  300
                  <span className="text-red-600 text-lg align-top">m²</span>
</span>
...
<span className="text-3xl font-light text-white">
                  6
                  <span className="text-red-600 text-lg align-top">AM</span>
</span>
<span className="text-[10px] uppercase text-neutral-500 tracking-wider mt-1">
                  First Session
                </span>
...
<div className="h-full w-full bg-cover bg-center grayscale contrast-125 brightness-75 opacity-60 group-hover:opacity-80 transition-opacity duration-700 bg-[url(https://images.unsplash.com/photo-1555597673-b21d5c935865?w=1600&amp;q=80)]"></div>
...
<section className="py-24 bg-neutral-950 border-y border-neutral-900 relative overflow-hidden" id="methodology">
...
<p className="mx-auto mt-6 max-w-xl text-sm text-neutral-400 reveal-on-scroll">
            We apply a conceptual approach to martial arts. Positional hierarchy, 
            mechanical leverage, and psychological warfare trained in a controlled environment.
          </p>
</div>
...
<iconify-icon className="text-neutral-400" icon="solar:dumbbell-small-linear" width="24"></iconify-icon>
</span>
</div>

<div className="absolute top-[13.33%] left-[50%] -translate-x-1/2 -translate-y-[180%] z-20">
<span className="inline-flex items-center justify-center bg-white/5 w-12 h-12 ring-white/10 ring-1 rounded-lg hover:bg-red-900/10 hover:ring-red-600/40 transition-all duration-500 shadow-lg">
<iconify-icon className="text-neutral-400" icon="solar:book-2-linear" width="24"></iconify-icon>
</span>
</div>

<div className="absolute top-[13.33%] left-[78.89%] -translate-x-1/2 -translate-y-[180%] z-20">
<span className="inline-flex items-center justify-center bg-white/5 w-12 h-12 ring-white/10 ring-1 rounded-lg hover:bg-red-900/10 hover:ring-red-600/40 transition-all duration-500 shadow-lg">
<iconify-icon className="text-neutral-400" icon="solar:fire-linear" width="24"></iconify-icon>
</span>
</div>
...
<iconify-icon className="text-red-600 animate-pulse" icon="solar:shield-star-linear" width="32"></iconify-icon>
</span>
</div>
</div>
...
<img className="w-full h-full object-cover grayscale brightness-90 transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0 group-hover:brightness-100" src="https://images.unsplash.com/photo-1595078475328-1ab05d0a6a0e?q=80&amp;w=1600&amp;auto=format&amp;fit=crop"/>
...
<p className="text-xs text-neutral-400 mt-1 uppercase tracking-widest reveal-on-scroll">
                1500sqft Seamless Mat
              </p>
</div>
</div>

<div className="md:col-span-1 md:row-span-1 relative group overflow-hidden bg-neutral-900 reveal-on-scroll">
<img className="w-full h-full object-cover grayscale brightness-75 transition-all duration-700 group-hover:scale-105 group-hover:brightness-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
...
<span className="text-[10px] text-white bg-black/50 px-2 py-1 uppercase backdrop-blur-sm">Striking / MMA</span>
</div>
</div>
...
<iconify-icon className="text-red-600" icon="solar:user-hand-up-linear" width="14"></iconify-icon>
                  Respect All
                </li>
<li className="flex items-center gap-3 border-b border-red-900/20 pb-2">
<iconify-icon className="text-red-600" icon="solar:shield-warning-linear" width="14"></iconify-icon>
                  Fear Nothing
                </li>
<li className="flex items-center gap-3 pb-2">
<iconify-icon className="text-red-600" icon="solar:flag-linear" width="14"></iconify-icon>
                  Earn Everything
                </li>
</ul>
</div>
...
<img className="w-full h-full object-cover grayscale brightness-75 transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
...
<p className="text-xs text-neutral-500 mt-2">Perfect for beginners or youth.</p>
<div className="mt-4 flex items-baseline">
<span className="text-4xl font-bold text-white tracking-tight">80€</span>
<span className="ml-2 text-sm text-neutral-500">/mo</span>
</div>
</div>
...
<li className="flex items-start gap-3 text-sm text-neutral-400">
<iconify-icon className="text-neutral-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>Gi or No-Gi</span>
</li>
<li className="flex items-start gap-3 text-sm text-neutral-400">
<iconify-icon className="text-neutral-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>Fundamentals Only</span>
</li>
</ul>
...
<p className="text-xs text-neutral-400 mt-2">Unlimited Access.</p>
<div className="mt-4 flex items-baseline">
<span className="glow-text text-5xl font-bold text-white tracking-tight">120€</span>
<span className="ml-2 text-sm text-neutral-400">/mo</span>
</div>
</div>
<ul className="space-y-5 mb-10 flex-1">
<li className="flex items-start gap-3 text-sm text-white">
<iconify-icon className="text-red-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>Unlimited BJJ (All Levels)</span>
</li>
<li className="flex items-start gap-3 text-sm text-white">
<iconify-icon className="text-red-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>Striking &amp; MMA Classes</span>
</li>
<li className="flex items-start gap-3 text-sm text-white">
<iconify-icon className="text-red-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
...
<p className="text-xs text-neutral-500 mt-2">Accelerated Learning.</p>
<div className="mt-4 flex items-baseline">
...
<li className="flex items-start gap-3 text-sm text-neutral-400">
<iconify-icon className="text-neutral-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>All Ronin Benefits</span>
</li>
<li className="flex items-start gap-3 text-sm text-neutral-400">
<iconify-icon className="text-neutral-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
<span>1 Private Session / Month</span>
</li>
<li className="flex items-start gap-3 text-sm text-neutral-400">
<iconify-icon className="text-neutral-600 mt-0.5" icon="solar:check-read-linear" width="16"></iconify-icon>
...
<span className="text-xs font-semibold uppercase text-neutral-500 tracking-widest">
            Monthly
          </span>
...
<span className="text-xs font-semibold uppercase text-white tracking-widest">
            Annual
            <span className="text-red-600 ml-1">(-15%)</span>
</span>
</div>
</div>
</section>
...
<p className="text-neutral-500 text-sm max-w-sm leading-relaxed reveal-on-scroll">
              An underground facility for those who refuse mediocrity. 
              We exist in the shadows to ignite the fighter within.
              Gi. No-Gi. Striking.
            </p>
...
<h4 className="text-white text-[10px] font-bold uppercase tracking-[0.2em] mb-6 text-red-700">
              Location
            </h4><p className="leading-relaxed reveal-on-scroll text-sm text-neutral-500">HSK Combat Academy<br/>Sector 4, Industrial Zone<br/>Berlin, DE</p>
<p className="text-neutral-500 text-sm mt-4 hover:text-red-500 transition-colors cursor-pointer reveal-on-scroll">
              train@hsk-combat.com
            </p>
</div>
<div className="">
<h4 className="text-white text-[10px] font-bold uppercase tracking-[0.2em] mb-6 text-red-700">
...
<p className="text-neutral-800 text-[10px] uppercase tracking-widest reveal-on-scroll">
            © 2024 HSK Combat Academy. All Rights Reserved.
          </p>

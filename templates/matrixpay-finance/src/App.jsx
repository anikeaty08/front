...
<div className="aura-background-component top-0 w-full -z-10 absolute h-[800px]" data-alpha-mask="49" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 49%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 49%, transparent)'}}><div className="absolute w-full h-full left-0 top-0 -z-10" data-us-project="FA91ypkIWKOhjZEGAfQR"></div>
</div>

<div className="min-h-screen">

<nav className="sticky z-50 bg-black/50 border-white/5 border-b top-0 backdrop-blur-xl">
...
<svg className="lucide lucide-zap h-3.5 w-3.5 text-black fill-black" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(0, 0, 0)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<path d="M10.453 16.443v.31c0 3.284 0 4.927.923 5.21s1.913-1.056 3.893-3.734l3.062-4.143c1.284-1.739 1.927-2.608 1.573-3.291l-.018-.034c-.375-.673-1.485-.673-3.704-.673c-1.233 0-1.85 0-2.236-.363l-3.872 4.57c.379.371.379.963.379 2.148" fill="#000000" opacity=".5"></path>
</svg>
</div>
</a>
<a className="inline-flex items-center justify-center bg-center w-[85px] sm:w-[100px] h-[17px] sm:h-[20px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b4674867-ad22-44ca-a6fb-71b735de0443_320w.png)] bg-cover rounded-full" href="/home"></a>
<div className="hidden md:flex mx-4 gap-x-1 items-center">
<a className="hover:bg-white/5 hover:text-slate-200 transition-colors text-xs font-medium text-slate-400 rounded-md pt-1.5 pr-3 pb-1.5 pl-3" href="/dashboard">Dashboard</a>
<a className="hover:bg-white/5 hover:text-slate-200 transition-colors text-xs font-medium text-slate-400 rounded-md pt-1.5 pr-3 pb-1.5 pl-3" href="/treasury">Treasury</a>
<a className="hover:bg-white/5 hover:text-slate-200 transition-colors text-xs font-medium text-slate-400 rounded-md pt-1.5 pr-3 pb-1.5 pl-3" href="/payments">Payments</a>
<a className="hover:bg-white/5 hover:text-slate-200 transition-colors text-xs font-medium text-slate-400 rounded-md pt-1.5 pr-3 pb-1.5 pl-3" href="/reports">Reports</a>
<a className="hidden lg:block hover:bg-white/5 hover:text-slate-200 transition-colors text-xs font-medium text-slate-400 rounded-md pt-1.5 pr-3 pb-1.5 pl-3" href="/api">API</a>
</div>
</div>

<div className="flex gap-2 sm:gap-3 items-center">
<div className="relative hidden lg:block">
<svg aria-hidden="true" className="lucide lucide-search absolute left-2.5 top-1.5 h-3.5 w-3.5 text-slate-500" data-lucide="search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m21 21-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></svg>
<input className="h-7 w-48 rounded-full border border-white/10 bg-white/5 pl-8 pr-3 text-xs text-slate-300 placeholder:text-slate-600 focus:border-emerald-500/50 focus:bg-white/10 focus:outline-none" placeholder="Search..." type="text"/>
</div>
...
<svg aria-hidden="true" className="lucide lucide-bell h-3.5 w-3.5" data-lucide="bell" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M10.268 21a2 2 0 0 0 3.464 0"></path><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"></path></svg>
</button>
<div className="overflow-hidden cursor-pointer bg-emerald-900/20 w-7 h-7 border-emerald-500/30 border rounded-full pt-0.5 pr-0.5 pb-0.5 pl-0.5" onclick="window.location.href='/profile'" role="button">
...
<button className="md:hidden flex h-7 w-7 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-400 hover:text-emerald-400 transition-colors" onclick="document.getElementById('mobile-nav-emmiwr8ablzwtkhz').classList.toggle('hidden'); document.getElementById('menu-icon-emmiwr8ablzwtkhz').classList.toggle('hidden'); document.getElementById('close-icon-emmiwr8ablzwtkhz').classList.toggle('hidden');">
<svg aria-hidden="true" className="lucide lucide-menu h-4 w-4" data-lucide="menu" fill="none" height="24" id="menu-icon-emmiwr8ablzwtkhz" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
<svg aria-hidden="true" className="lucide lucide-x h-4 w-4 hidden" fill="none" height="24" id="close-icon-emmiwr8ablzwtkhz" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
</div>
</div>

<div className="hidden md:hidden absolute top-full left-0 w-full bg-black/95 border-b border-white/10 backdrop-blur-xl flex-col px-4 py-6 shadow-2xl transition-all" id="mobile-nav-emmiwr8ablzwtkhz">
<div className="flex flex-col gap-2">
<a className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg px-4 py-2.5 transition-colors" href="/dashboard">Dashboard</a>
<a className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg px-4 py-2.5 transition-colors" href="/treasury">Treasury</a>
<a className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg px-4 py-2.5 transition-colors" href="/payments">Payments</a>
<a className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg px-4 py-2.5 transition-colors" href="/reports">Reports</a>
<a className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg px-4 py-2.5 transition-colors" href="/api">API</a>
</div>
<div className="mt-6 pt-6 border-t border-white/10 flex flex-col gap-4">
<div className="relative w-full">
<svg className="lucide lucide-search absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m21 21-4.34-4.34"></path>
<circle cx="11" cy="11" r="8"></circle>
</svg>
<input className="h-10 w-full rounded-lg border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-slate-300 placeholder:text-slate-600 focus:border-emerald-500/50 focus:bg-white/10 focus:outline-none" placeholder="Search..." type="text"/>
</div>
</div>
</div>
</nav>
...
<p className="text-4xl font-medium tracking-tight text-slate-50 tabular-nums" id="treasury-balance">$412,906</p>
...
<img alt="Risk" className="transition-transform duration-700 group-hover:scale-110 group-hover:opacity-100 opacity-80 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e8d396e9-fbdf-477e-a5e9-a0438a8f8124_800w.jpg"/>
...
<div className="group overflow-hidden transition-colors hover:border-emerald-500/30 bg-slate-900 h-[220px] border-white/10 border rounded-2xl relative">
<img alt="Compliance" className="transition-transform duration-700 group-hover:scale-110 group-hover:opacity-100 opacity-80 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a426f4a1-03c0-47b7-9887-6d7b137874f7_800w.jpg"/>
<div className="bg-gradient-to-b from-black/0 via-black/0 to-transparent/25 absolute top-0 right-0 bottom-0 left-0">
</div>
<div className="absolute left-3 top-3">
<div className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-black/40 text-emerald-400 backdrop-blur-md">
...
<svg aria-hidden="true" className="text-slate-400" data-icon="solar:letter-bold-duotone" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M18 20c1.886 0 2.828 0 3.414-.586S22 17.886 22 16V8c0-1.886 0-2.828-.586-3.414S19.886 4 18 4H6c-1.886 0-2.828 0-3.414.586S2 6.114 2 8v8c0 1.886 0 2.828.586 3.414S4.114 20 6 20z" fill="currentColor" opacity=".5"></path><path d="M12.004 13.574a.75.75 0 0 1-.924-.266l-3.92-6.092A.75.75 0 0 1 7.16 6h9.68a.75.75 0 0 1 0 1.216l-3.912 6.092a.75.75 0 0 1-.924.266" fill="currentColor"></path></svg>
<span className="">Contact Sales</span>
</button>
</div>
<div className="mt-8 flex items-center gap-6 text-[10px] text-slate-500">
<div className="flex items-center gap-1.5">
<svg className="text-emerald-500" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<div className="flex bg-gradient-to-br from-emerald-400 to-emerald-600 w-6 h-6 rounded-full shadow-[0_0_15px_rgba(16,185,129,0.4)] items-center justify-center">
<svg className="lucide lucide-zap fill-black w-[14px] h-[14px]" data-icon-replaced="true" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '14px', height: '14px', color: 'rgb(0, 0, 0)'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<path clip-rule="evenodd" d="M8.732 5.771L5.67 9.914c-1.285 1.739-1.928 2.608-1.574 3.291l.018.034c.375.673 1.485.673 3.704.673c1.233 0 1.85 0 2.236.363l.02.02l3.872-4.57l-.02-.02c-.379-.371-.379-.963-.379-2.148v-.31c0-3.285 0-4.927-.923-5.21s-1.913 1.056-3.892 3.734" fill="#000000" fill-rule="evenodd"></path>
<path d="M10.453 16.443v.31c0 3.284 0 4.927.923 5.21s1.913-1.056 3.893-3.734l3.062-4.143c1.284-1.739 1.927-2.608 1.573-3.291l-.018-.034c-.375-.673-1.485-.673-3.704-.673c-1.233 0-1.85 0-2.236-.363l-3.872 4.57c.379.371.379.963.379 2.148" fill="#000000" opacity=".5"></path>
</svg>
</div>
<span className="text-sm font-semibold text-slate-100 tracking-tight">MatrixPay</span>
</a>
<p className="mt-4 text-xs leading-relaxed text-slate-500">
          The financial operating system for internet-native organizations.
        </p>
<div className="mt-4 flex gap-4">
<a className="text-slate-500 transition-colors hover:text-white" href="#"><svg fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg></a>
...
<li><a className="hover:text-emerald-400 transition-colors" href="#">Treasury</a></li>
<li><a className="hover:text-emerald-400 transition-colors" href="#">Payments</a></li>
<li><a className="hover:text-emerald-400 transition-colors" href="#">Intelligence</a></li>
<li><a className="hover:text-emerald-400 transition-colors" href="#">Vault</a></li>
</ul>
</div>
<div>
...
<li><a className="hover:text-emerald-400 transition-colors" href="#">System Status</a></li>

...
<main className="flex-1 w-full sm:px-6 bg-cover pr-4 pb-12 pl-4 bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/77b5f635-64b5-4508-b41f-b23c19cb2b02_3840w.webp)]">
<div className="mx-auto max-w-7xl">
<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 my-12">

<div className="card-animate flex flex-col sm:p-10 aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-3xl group animate-in text-white w-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/fc511783-a087-472e-923f-1fc12eac9262_800w.webp)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] justify-between" style={{boxShadow: 'rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(16, 185, 129, 0.1) 0px 0px 0px 1px'}}>
...
<div className="card-animate flex flex-col sm:p-10 aspect-[3/5] hover:scale-105 transition-all duration-300 hover:shadow-3xl group animate-in text-white w-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e44cf6cd-e2f6-4dc1-9665-78b7984addd8_800w.webp)] bg-cover rounded-3xl pt-8 pr-8 pb-8 pl-8 shadow-2xl justify-between" style={{boxShadow: 'rgba(0, 0, 0, 0.5) 0px 25px 50px -12px, rgba(139, 92, 246, 0.1) 0px 0px 0px 1px'}}>
<div className="space-y-6">
<div className="flex items-center justify-between">
...
<div className="flex flex-1 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/eea4d996-ebf2-499b-b4fb-27ddba650bd5_800w.webp)] bg-cover border-zinc-800/50 border rounded-2xl pt-8 pr-8 pb-8 pl-8 items-center justify-center">
<div className="relative">
</div>
</div>
<div className="space-y-6 mt-8">

...
<section className="sm:px-8 bg-[#f7f4eb] border-black/5 border-t pt-24 pr-4 pb-24 pl-4">
<div className="max-w-7xl mr-auto ml-auto">
<div className="flex flex-col md:flex-row mt-20 mb-8 gap-x-3 gap-y-3 items-end justify-between">
<div className="">
<h2 className="sm:text-7xl uppercase leading-none text-5xl font-semibold text-[#E85424] tracking-tighter font-display mt-2">
      bánh mì<br className=""/></h2>
</div>
...
<img alt="Grilled pork banh mi" className="transition-transform duration-500 group-hover:scale-105 bg-stone-950 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6af9d9c1-eb48-45d5-a2a9-b9b74be3ad81_3840w.jpg"/>
</div>
...
<p className="line-clamp-2 text-xs text-black mt-2">Grilled pork served inside freshly baked crispy bread, with mayo, pâté, pickled vegetables &amp; coriander.</p>
</div>

<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Beef cheek banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cea493bf-387c-4cb1-ad79-8ae7027d7630_1600w.png"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">grilled chicken</h3>
<span className="text-sm font-semibold font-mono">15.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">Grilled chicken served inside freshly baked crispy bread, with mayo, pâté, pickled vegetables &amp; coriander.</p>
</div>

<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Tofu Banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9bacda86-0836-4ba6-8c8f-9ffe19d7c612_3840w.jpg"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">
        tofu bánh mì</h3>
...
<p className="line-clamp-2 text-xs text-black mt-2">Tofu served inside freshly baked crispy bread, with house-made peanut sauce, pickled vegetables &amp; coriander.</p>
</div>
</div><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 gap-x-8 gap-y-12">

<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Grilled pork banh mi" className="transition-transform duration-500 group-hover:scale-105 bg-stone-950 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/64824e9f-03bd-4d7c-b8ad-65660489d00f_3840w.jpg?w=800&amp;q=80"/>
</div>
<div className="flex border-dashed border-black/20 border-b pb-2 items-baseline justify-between">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">beef cheek</h3>
<span className="text-sm font-semibold font-mono">17.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">Slow cooked tender beef cheek served inside freshly baked crispy bread, with mayo, pâté, pickled vegetables &amp; coriander.</p>
</div><div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Grilled pork banh mi" className="transition-transform duration-500 group-hover:scale-105 bg-stone-950 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/59a92400-c696-4c4f-b801-86a8b66f964b_1600w.png"/>
</div>
<div className="flex border-dashed border-black/20 border-b pb-2 items-baseline justify-between">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">pork belly</h3>
<span className="text-sm font-semibold font-mono">17.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">???</p>
</div>


</div><div className="flex flex-col md:flex-row gap-6 mt-10 mb-8 gap-x-3 gap-y-3 items-end justify-between">
<div className="">
<h2 className="sm:text-7xl uppercase leading-none text-5xl font-semibold text-[#E85424] tracking-tighter font-display mt-2">
      Noodles</h2>
</div>
...
</div><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">


<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Beef cheek banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/358674c7-1b4b-4090-b0ad-bbe34e260ac0_1600w.png"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">Crispy Noodle Salad</h3>
<span className="text-sm font-semibold font-mono">from 18.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">Crispy noodles, shredded cabbage, lettuce, pickled carrots &amp; nước chấm sauce. Choice of grilled pork, chicken, tofu, or pork belly.</p>
</div>

<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Tofu Banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7ffbf608-4985-4b01-83cd-0afb15443638_1600w.png"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">Hà Nội style phở noodle soup</h3>
<span className="text-sm font-semibold font-mono">19.5</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">18-hour beef broth, rice noodles, beef, onions &amp; coriander.</p>
</div>
</div><div className="flex flex-col md:flex-row mt-10 mb-8 gap-x-3 gap-y-3 items-end justify-between">
<div className="">
<h2 className="sm:text-7xl uppercase leading-none text-5xl font-semibold text-[#E85424] tracking-tighter font-display mt-2">Drinks</h2>
</div>
<div className="md:max-w-xs text-right md:text-left">
</div>
</div><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
...
<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Beef cheek banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/309fb435-9a81-4eb5-acf4-62dc2e1c3b2b_1600w.png"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">Vietnamese Iced Coffee</h3>
<span className="text-sm font-semibold font-mono">8.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">Vientamese coffee brewed slow &amp; poured over ice, with creamy 
condensed milk for a rich, smooth, slightly sweet kick.</p>
</div>

<div className="group">
<div className="mb-4 overflow-hidden rounded-2xl bg-gray-100 aspect-[4/3]">
<img alt="Tofu Banh mi" className="transition-transform duration-500 group-hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4a0a23a6-2302-4a1e-b648-91e90679a50f_1600w.png"/>
</div>
<div className="flex justify-between items-baseline border-b border-dashed border-black/20 pb-2">
<h3 className="uppercase transition-colors group-hover:text-brand-orange text-xl font-semibold text-[#E85424] font-display">mango iced tea</h3>
<span className="text-sm font-semibold font-mono">8.0</span>
</div>
<p className="line-clamp-2 text-xs text-black mt-2">Authentic green tea from lam dong, infused with sweet mango
for a light, crisp &amp; tropical finish.</p>
</div>
</div>
</div>
...
<h2 className="sm:text-6xl uppercase text-brand-black text-4xl font-semibold font-display">Loved by Christchurch locals</h2>
</div>
...
<div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-500 text-xs">TH
    </div>
<div className="">
...
<p className="leading-relaxed text-sm text-[#000000]">"Hands down the BEST Banh Mi &amp; Pho!! One bite of the Banh Mi
...
<div className="flex text-xs font-bold text-gray-500 bg-gray-200 w-10 h-10 rounded-full items-center justify-center">LC
</div>
<div className="">
...
<p className="leading-relaxed text-sm text-[#000000]">"Beef Broth is flavourful and I like that they are Very generous with
  beef slices and garnishes! I like how the cold fresh roll doesn’t come in set so you could mix and match according
  to
...
<div className="flex items-center gap-4 mb-4">
<div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-gray-500 text-xs">PC
</div>
<div className="">
...
<p className="leading-relaxed text-sm text-[#000000]">"Absolutely delicious! Rollicious serves up some of the best Banh Mi
  I've ever had with great flavour and fresh
  ingredients. Their iced coffee is hands down the best in town. The staff are friendly and welcoming. Highly recommend
...
<p className="relative z-10 text-sm text-white/90 mb-8 px-4">We also have multiple food truck locations, weekly
        events, markets and festivals we serve at!</p>
...
<p className="leading-relaxed text-sm text-[#E85424]">Rollicious is a Christchurch-based Vietnamese shop
  specialising in Northern-style bánh mì, with light, balanced flavours and bread baked fresh daily at 5am for that
  perfect crispy outside and fluffy inside.</p>
<div className="flex mt-6 gap-x-4 gap-y-4 justify-center md:justify-start w-full">
...
<div className="grid grid-cols-2 sm:grid-cols-3 gap-x-12 gap-y-12 text-center md:text-left">

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      VANTA.FOG({el:"#bg-animation",mouseControls:true,touchControls:true,gyroControls:false,minHeight:200.00,minWidth:200.00,highlightColor:0x6C4DFF,midtoneColor:0xffffff,lowlightColor:0xe0e7ff,baseColor:0xffffff,blurFactor:0.73,speed:1.50,zoom:0.80});document.addEventListener('DOMContentLoaded',()=>{const observer=new IntersectionObserver((entries)=>{entries.forEach(entry=>{if(entry.isIntersecting){entry.target.classList.add('opacity-100','translate-y-0');entry.target.classList.remove('opacity-0','translate-y-10');}});},{threshold:0.1});const sections=document.querySelectorAll('section > div');sections.forEach(sec=>{if(!sec.classList.contains('animate-fade-in')){sec.classList.add('transition-all','duration-700','ease-out','opacity-0','translate-y-10');observer.observe(sec);}});});
...
<div className="fixed inset-0 w-full h-full -z-10 opacity-60 pointer-events-none" id="bg-animation">
...
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
...
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1432px', height: '1059px'}} width="1288"></canvas>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
<span style={{position: 'relative', zIndex: '1'}}></span>
...
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
<canvas className="vanta-canvas" height="383" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '385px', height: '852px'}} width="173"></canvas>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
<canvas className="vanta-canvas" height="383" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '385px', height: '852px'}} width="173"></canvas>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
<canvas className="vanta-canvas" height="953" style={{display: 'block', position: 'absolute', zIndex: '0', top: '0px', left: '0px', width: '1912px', height: '1059px'}} width="1720"></canvas>
...
<a className="px-4 py-2 text-sm font-medium text-white bg-[#6C4DFF] hover:bg-[#5B3FE6] rounded-full shadow-sm shadow-[#6C4DFF]/30 hover:shadow-md hover:shadow-[#6C4DFF]/40 transition-all transform hover:-translate-y-0.5" href="#">
            Demander une démo
          </a>
</div>
...
<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#6C4DFF] opacity-75"></span>
...
<span className="uppercase font-semibold text-slate-600 leading-tight text-[11px] tracking-normal sm:text-xs sm:tracking-wide">
            Bornes de commande • Sites web • 0% commission
          </span>
</div>

<h1 className="md:text-7xl leading-[1.1] animate-fade-in delay-100 text-5xl font-semibold text-slate-900 tracking-tight mb-6">
          Les
          <span className="blur-text-reveal">bornes de commande</span>
          qui augmentent vos ventes.
        </h1>

<p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto animate-fade-in delay-200">
          Installez des bornes de commande intelligentes et un site de commande
          sans commission pour votre restaurant. Reprenez le contrôle de vos
          ventes.
        </p>

<div className="flex flex-col sm:flex-row justify-center items-center gap-4 animate-fade-in delay-300 mb-8">
<a className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-white bg-[#6C4DFF] hover:bg-[#5B3FE6] rounded-full shadow-lg shadow-[#6C4DFF]/25 transition-all transform hover:scale-[1.02]" href="#">
...
<svg className="group-hover:text-[#6C4DFF] transition-colors" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<svg className="text-[#6C4DFF]" fill="none" height="16" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
<polyline points="22 4 12 14.01 9 11.01"></polyline>
</svg>
<span className="text-sm font-medium text-slate-600">
<span className="font-bold text-slate-800">+500</span>
            restaurants équipés en France
          </span>
</div>
...
<span className="block text-[#6C4DFF] font-semibold tracking-wider text-sm uppercase mb-3">
            Le problème
          </span>
<h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 mb-4">
            Les plateformes et la caisse traditionnelle réduisent votre marge.
          </h2>
<p className="text-slate-500 text-lg">
            Jusqu'à 30% de commissions, files d'attente, erreurs de commande...
...
<div className="w-12 h-12 rounded-xl bg-[#6C4DFF]/10 flex items-center justify-center text-[#6C4DFF] mb-6">
...
<p className="text-slate-600 mb-8 max-w-md">
                Commande tactile rapide, paiement CB &amp; sans contact, upsell
                automatique. Augmentez votre panier moyen de 20 à 30%.
              </p>

<div className="space-y-3 max-w-sm">
<div className="flex items-center gap-3 p-3 rounded-xl bg-white/50 border border-white/60">
<div className="w-5 h-5 rounded-full border-2 border-[#6C4DFF] flex items-center justify-center">
<div className="w-2.5 h-2.5 rounded-full bg-[#6C4DFF]"></div>
</div>
...
<div className="h-full w-[72%] bg-[#6C4DFF] rounded-full"></div>
</div>
</div>
<div className="bg-white/60 rounded-2xl p-4 border border-white/50 backdrop-blur-sm">
<div className="text-xs font-semibold text-slate-500">
...
<div className="text-xs text-slate-500">réduit en caisse</div>
</div>
</div>
<div className="mt-3 flex items-center gap-1 text-xs text-slate-500">
<span className="inline-block w-2 h-2 rounded-full bg-[#6C4DFF]"></span>
...
<span className="text-xs font-semibold text-[#6C4DFF]">
                    Économies
                  </span>
</div>
<p className="mt-2 text-sm text-slate-600">
                  0% de commission sur toutes vos commandes Rool'z
                </p>
...
<svg className="text-[#6C4DFF]" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M20 6L9 17l-5-5"></path>
</svg>
<span>Référencement Google</span>
</li>
<li className="flex items-center gap-2">
...
<p className="text-sm text-slate-600 mb-4">
              Votre propre app, quand vous êtes prêt.
            </p>
...
<p className="text-slate-600 mb-8 max-w-xl">
                    Envoi automatique des commandes vers votre système de caisse
                    ou écran cuisine. Zéro ressaisie, zéro erreur.
                  </p>
</div>
...
<div className="w-5 h-5 rounded-full bg-[#6C4DFF] flex items-center justify-center text-white">
...
<svg className="text-slate-700" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<rect height="14" rx="2" ry="2" width="20" x="2" y="3"></rect>
<line x1="8" x2="16" y1="21" y2="21"></line>
<line x1="12" x2="12" y1="17" y2="21"></line>
</svg>
...
<div className="inline-block text-[#6C4DFF] font-semibold tracking-wider text-sm uppercase mb-4">
            Comparatif
          </div>
<h2 className="md:text-5xl text-3xl font-semibold text-slate-900 tracking-tight mb-6">
            Pour 10 000€ de CA mensuel, combien payez-vous ?
          </h2>
<p className="text-lg text-slate-600 mb-8 leading-relaxed">
            Les plateformes vous coûtent cher. Rool'z vous libère des
            commissions.
          </p>
<ul className="space-y-4">
<li className="flex items-start gap-3">
<div className="mt-1 text-[#6C4DFF]">
...
<span className="text-slate-700">
                Rool'z :
                <span className="text-[#6C4DFF] font-bold">0€</span>
                de commission
              </span>
</li>
</ul>
...
<div className="absolute -top-[50%] -left-[20%] w-[80%] h-[150%] bg-[#6C4DFF] opacity-20 blur-[100px] rounded-full"></div>
...
<p className="text-slate-400 text-sm mt-2 font-medium">
                Installation incluse. Support 7j/7.
              </p>
</div>
...
<p className="text-slate-500 max-w-xs mb-6">
              La solution digitale complète pour les restaurants modernes.
              Bornes, site web, application.
            </p>
<div className="flex gap-4">
<a className="text-slate-400 hover:text-[#6C4DFF] transition-colors" href="#">
<svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<p className="">© 2025 Rool'z. Tous droits réservés.</p>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-cover bg-center -z-10" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1554034483-04fda0d3507b?w=3840&amp'}}></div>
...
<img alt="avatar" className="w-9 h-9 rounded-full ring-2 ring-blue-200/60 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c0f3907b-87b7-4671-99d8-ab70af2fa691_320w.jpg" style={{}}/>
<div className="">
...
<circle cx="21" cy="21" fill="none" r="16" stroke="url(#gradient1)" stroke-dasharray="68 32" strokeLinecap="round" strokeWidth="3.2"></circle>
<defs>
</defs>
</svg>
...
<img alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/04b430ce-45fe-4c6d-b375-4a4d349051a7_320w.jpg" style={{}}/>
<img alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/41090330-fe39-452d-9deb-7474038a7941_320w.jpg" style={{}}/>
<img alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/66a5e5ed-3351-4e00-9e1f-296cd649a7aa_320w.jpg"/>
...
<div className="flex -space-x-2">
<img alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2a59325f-6c7c-497d-be59-b73f7bbb9e60_320w.jpg"/>
<img alt="" className="w-7 h-7 rounded-full border-2 border-white object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1ef2b9e6-728c-4b89-845c-b9052fb25ec8_320w.jpg"/>
</div>
<div className="flex items-center gap-3 text-gray-400 text-xs font-sans" style={{}}>
<svg className="lucide lucide-message-circle w-4 h-4" data-lucide="message-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"></path></svg>15

...
<h1 className="md:text-7xl leading-tight text-5xl font-medium text-zinc-950 tracking-tight font-montserrat mb-8">Redefine your core <br className="hidden md:block"/> <span className="text-emerald-800 font-montserrat font-medium">elevate your movement.</span></h1>
<p className="text-lg text-zinc-500 mb-10 max-w-2xl mx-auto leading-relaxed font-sans">
...
<section className="py-24 px-6 bg-white border-y border-zinc-200/50" id="classes">

...
<div className="text-2xl font-grotesk tracking-tighter font-semibold text-white">MRX</div>
<div className="hidden sm:block h-4 w-px bg-stone-700"></div>
<div className="hidden sm:block text-xs text-stone-400 font-sans">Octopus AI Network</div>
</a>
<nav className="hidden md:flex items-center gap-6 text-sm text-stone-400 font-sans">
...
<a className="hidden sm:block text-sm text-stone-400 hover:text-white transition-colors font-sans" href="tel:+919817818578">
          +91 98178 18578
        </a>
<button className="inline-flex hover:bg-stone-200 transition-colors text-sm font-medium text-stone-950 bg-white rounded-lg pt-2.5 pr-5 pb-2.5 pl-5 gap-x-2 gap-y-2 items-center">
          Start Your 30 Days
...
<div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(99,102,241,0.15),transparent_50%),radial-gradient(circle_at_80%_80%,rgba(251,146,60,0.15),transparent_50%)]"></div>
...
<a className="inline-flex items-center gap-2 text-sm text-stone-400 hover:text-white transition font-sans" href="#results">
...
<div>
<div className="text-3xl font-grotesk font-semibold tracking-tight text-white">5X</div>
<div className="text-sm text-stone-500 font-sans">Brand Recall</div>
</div>
<div className="h-8 w-px bg-stone-800"></div>
<div>
<div className="text-3xl font-grotesk font-semibold tracking-tight text-white">3X</div>
<div className="text-sm text-stone-500 font-sans">Faster Launch</div>
</div>
</div>
</div>
...
<div className="text-2xl font-grotesk font-semibold text-white">10K+</div>
<div className="text-xs text-stone-500 mt-1 font-sans">Creators</div>
</div>
<div className="text-center p-4 bg-stone-800 rounded-lg">
<div className="text-2xl font-grotesk font-semibold text-white">50+</div>
<div className="text-xs text-stone-500 mt-1 font-sans">Markets</div>
</div>
<div className="text-center p-4 bg-stone-800 rounded-lg">
<div className="text-2xl font-grotesk font-semibold text-white">24/7</div>
<div className="text-xs text-stone-500 mt-1 font-sans">AI Engine</div>
</div>
</div>
</div>
<div className="absolute -bottom-6 -right-6 w-72 h-72 bg-orange-500/10 rounded-full blur-3xl -z-10"></div>
</div>
</div>
</div>
</section>
...
<p className="text-lg text-stone-400 font-sans">
        Why your world-class product gets lost in translation
      </p>
</div>
...
<h3 className="text-xl font-grotesk font-semibold text-white mb-3">Wasted Ad Spend</h3>
<p className="text-stone-400 font-sans">Generic campaigns that don't resonate with local audiences. Your budget burns while conversions stay flat.</p>
...
<span>Industry avg: 10% conversion</span>
</div>
</div>
</div>
...
<h3 className="text-xl font-grotesk font-semibold text-white mb-3">Slow Market Entry</h3>
<p className="text-stone-400 font-sans">Missing crucial seasonal peaks and opportunities. By the time your campaign goes live, the moment has passed.</p>
<div className="mt-6 pt-6 border-t border-stone-700">
<div className="flex items-center gap-2 text-sm text-stone-500 font-sans">
<i className="w-4 h-4" data-lucide="alert-circle"></i>
<span>Typical: 30+ days to launch</span>
</div>
</div>
</div>
...
<h3 className="text-xl font-grotesk font-semibold text-white mb-3">Poor Lead Quality</h3>
<p className="text-stone-400 font-sans">Sales teams drowning in unqualified leads. "Taste Level... What does even mean?" Sound familiar?</p>
<div className="mt-6 pt-6 border-t border-stone-700">
<div className="flex items-center gap-2 text-sm text-stone-500 font-sans">
<i className="w-4 h-4" data-lucide="alert-circle"></i>
<span>Lost time &amp; morale</span>
</div>
</div>
</div>
</div>
...
<h2 className="text-4xl sm:text-5xl font-grotesk font-semibold tracking-tight text-white mb-4">
        The Octopus AI Agentic Network
      </h2>
<p className="text-lg text-stone-400 font-sans">
        We replace <span className="line-through">Slow, Expensive, Generic agencies</span> and <span className="line-through">Fast, Cold, Uncreative AI tools</span> with our integrated MRX Trinity
      </p>
</div>
...
<h3 className="text-2xl font-grotesk font-semibold text-white mb-3">AI-Powered Precision</h3>
<p className="text-stone-400 font-sans mb-6">
          Our AI analyzes thousands of data points to find high-intent buyers you'd never reach manually.
        </p>
<div className="bg-indigo-900/30 rounded-lg p-4 mb-6">
<div className="text-3xl font-grotesk font-semibold text-indigo-400 mb-1">2X</div>
<div className="text-sm text-stone-400 font-sans">Lead Accuracy vs. Industry</div>
</div>
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Deep behavioral analysis</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
...
<h3 className="text-2xl font-grotesk font-semibold text-white mb-3">Human-Led Creativity</h3>
<p className="text-stone-400 font-sans mb-6">
          Content crafted by our global network of 10,000+ creators that feels native, not translated.
        </p>
<div className="bg-orange-900/30 rounded-lg p-4 mb-6">
<div className="text-3xl font-grotesk font-semibold text-orange-400 mb-1">5X</div>
<div className="text-sm text-stone-400 font-sans">Brand Recall Increase</div>
</div>
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Poets, directors, micro-influencers</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Cultural authenticity guaranteed</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Native, not translated</span>
</li>
</ul>
</div>
...
<h3 className="text-2xl font-grotesk font-semibold text-white mb-3">Performance Automation</h3>
<p className="text-stone-400 font-sans mb-6">
          Launch multiple micro-campaigns within hours. We handle the "grunt work" so you can focus on closing.
        </p>
<div className="bg-green-900/30 rounded-lg p-4 mb-6">
<div className="text-3xl font-grotesk font-semibold text-green-400 mb-1">3X</div>
<div className="text-sm text-stone-400 font-sans">Faster Campaign Launch</div>
</div>
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Hours, not weeks to launch</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>AI bot lead qualification</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Sales-ready opportunities only</span>
</li>
</ul>
</div>
</div>
...
<p className="text-lg text-stone-400 font-sans">
        Our self-improving 3-step process
      </p>
</div>
...
<span>Customized by TA1, TA2, TA3... for maximum relevance</span>
</div>
</div>
</div>
<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
...
<div className="text-xs text-stone-500 font-sans">Only sales-ready leads reach your team—no more "taste level" confusion</div>
</div>
</div>
</div>
</div>
...
<p className="text-lg text-stone-400 font-sans">
        Stop running low-yield campaigns. Source: MRX Pilot Data — 12 Clients
      </p>
</div>
...
<div className="text-xs text-stone-600 mb-2 font-sans">Industry</div>
<div className="h-20 bg-stone-800 rounded flex items-end justify-center pb-2">
<span className="text-2xl font-grotesk font-semibold">10%</span>
</div>
</div>
<div className="flex-1">
<div className="text-xs text-green-400 mb-2 font-sans">MRX</div>
<div className="h-40 bg-gradient-to-t from-green-600 to-green-500 rounded flex items-end justify-center pb-2">
<span className="text-2xl font-grotesk font-semibold">20%</span>
</div>
</div>
</div>
...
<div className="flex items-end gap-4 mb-4">
<div className="flex-1">
<div className="text-xs text-stone-600 mb-2 font-sans">Generic Ads</div>
<div className="h-16 bg-stone-800 rounded flex items-center justify-center">
<span className="text-lg font-grotesk font-semibold">Low</span>
</div>
</div>
<div className="flex-1">
<div className="text-xs text-purple-400 mb-2 font-sans">MRX Hyper-Local</div>
<div className="h-40 bg-gradient-to-t from-purple-600 to-purple-500 rounded flex items-end justify-center pb-2">
<span className="text-lg font-grotesk font-semibold">High</span>
</div>
</div>
</div>
...
<div className="flex-1">
<div className="text-xs text-stone-600 mb-2 font-sans">Industry</div>
<div className="h-32 bg-stone-800 rounded flex items-end justify-center pb-2">
<span className="text-xl font-grotesk font-semibold">30+ Days</span>
</div>
</div>
<div className="flex-1">
<div className="text-xs text-orange-400 mb-2 font-sans">MRX</div>
<div className="h-16 bg-gradient-to-t from-orange-600 to-orange-500 rounded flex items-end justify-center pb-2">
<span className="text-xl font-grotesk font-semibold">Hours</span>
</div>
</div>
</div>
<div className="text-3xl font-grotesk font-semibold text-orange-400 mb-2">3X Faster</div>
...
<p className="text-lg text-stone-400 font-sans">
        A clear path to hyper-local growth
      </p>
</div>
...
<h3 className="text-lg font-grotesk font-semibold text-white">Brand Deep Dive</h3>
<span className="text-sm text-stone-500 font-sans">Days 1-3</span>
</div>
...
<div className="bg-stone-800 rounded-xl p-6 border border-stone-700 shadow-sm hover-lift">
<div className="flex items-center justify-between mb-3">
<h3 className="text-lg font-grotesk font-semibold text-white">Campaign Creation</h3>
<span className="text-sm text-stone-500 font-sans">Days 4-7</span>
</div>
...
<div className="bg-stone-800 rounded-xl p-6 border border-stone-700 shadow-sm hover-lift">
<div className="flex items-center justify-between mb-3">
<h3 className="text-lg font-grotesk font-semibold text-white">Content Production</h3>
<span className="text-sm text-stone-500 font-sans">Days 8-14</span>
</div>
...
<div className="bg-stone-800 rounded-xl p-6 border border-stone-700 shadow-sm hover-lift">
<div className="flex items-center justify-between mb-3">
<h3 className="text-lg font-grotesk font-semibold text-white">Campaign Execution</h3>
<span className="text-sm text-stone-500 font-sans">Days 15-25</span>
</div>
...
<div className="bg-stone-800 rounded-xl p-6 border border-stone-700 shadow-sm hover-lift">
<div className="flex items-center justify-between mb-3">
<h3 className="text-lg font-grotesk font-semibold text-white">Conversion &amp; Decision</h3>
<span className="text-sm text-stone-500 font-sans">Days 25-30</span>
</div>
<p className="text-stone-400 font-sans">Convert leads and decide your next move. Experience the MRX difference firsthand.</p>
</div>
</div>
</div>
</div>
...
<p className="text-lg text-stone-400 font-sans">
        You can expect more. Choose the plan that fits your ambition.
      </p>
</div>
<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
...
<h3 className="text-2xl font-grotesk font-semibold text-white mb-2">Growth Partner</h3>
<p className="text-stone-400 font-sans mb-6">For you if you're growing fast, but cash is tight</p>
<div className="mb-6">
<div className="flex items-baseline gap-2 mb-1">
<span className="text-4xl font-grotesk font-semibold text-white">$399</span>
<span className="text-stone-500 font-sans">/month</span>
</div>
<div className="text-sm text-stone-400 font-sans">+ $15 per qualified lead</div>
</div>
<button className="w-full py-3 px-6 bg-white text-stone-950 rounded-lg font-medium hover:bg-stone-200 transition-colors mb-6 font-sans">
          Start Growing
        </button>
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>MRX Trinity (AI + Human + Automation)</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>3-step Glo-Cal process</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Micro-campaigns in 2-3 markets</span>
</li>
</ul>
</div>
...
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-900/50 text-indigo-400 text-xs font-medium mb-6 font-sans">
          For Scale Seekers
        </div>
<h3 className="text-2xl font-grotesk font-semibold text-white mb-2">Revenue Accelerator</h3>
<p className="text-stone-400 font-sans mb-6">For you if you want to scale globally, profitably</p>
<div className="mb-6">
<div className="flex items-baseline gap-2 mb-1">
<span className="text-4xl font-grotesk font-semibold text-white">Custom</span>
</div>
<div className="text-sm text-stone-400 font-sans">Call us to know more</div>
</div>
<button className="w-full py-3 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:from-indigo-700 hover:to-purple-700 transition-all mb-6 font-sans">
          Let's Talk Growth
        </button>
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-indigo-400 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Everything in Growth Partner</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-indigo-400 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>5-10 markets simultaneously</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-indigo-400 flex-shrink-0 mt-0.5" data-lucide="check"></i>
...
<h3 className="text-2xl font-grotesk font-semibold text-white mb-2">Strategic Partnership</h3>
<p className="text-stone-400 font-sans mb-6">For you if you're a brand with ambition</p>
<div className="mb-6">
<div className="flex items-baseline gap-2 mb-1">
<span className="text-4xl font-grotesk font-semibold text-white">Enterprise</span>
</div>
<div className="text-sm text-stone-400 font-sans">Call us to know more</div>
</div>
<button className="w-full py-3 px-6 bg-white text-stone-950 rounded-lg font-medium hover:bg-stone-200 transition-colors mb-6 font-sans">
...
<ul className="space-y-3">
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
<span>Everything in Revenue Accelerator</span>
</li>
<li className="flex items-start gap-3 text-sm text-stone-400 font-sans">
<i className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" data-lucide="check"></i>
...
<h3 className="text-2xl font-grotesk font-semibold mb-3">Join MRX</h3>
<p className="text-stone-300 font-sans mb-6">Think clearly and quickly become the best</p>
<button className="px-6 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors font-sans">
          Start Now
        </button>
</div>
...
<h3 className="text-2xl font-grotesk font-semibold mb-3">Keep Suffering</h3>
...
<h3 className="text-2xl font-grotesk font-semibold mb-3">Try Another Agency</h3>
<p className="text-stone-400 font-sans mb-6">Same old boring but desperate story</p>
<div className="text-sm text-stone-500 font-sans">We've heard this before</div>
</div>
</div>
</div></section>
    </>

...
<span className="col-start-1 row-start-1">talk</span>
<span className="col-start-1 row-start-1">listen</span>
<span className="col-start-1 row-start-1">cares</span>
</span>
              like founders.
            </h1>
...
<p className="" id="status">Ready to play</p>
</div>
</div>
...
<div className="bar" style={{height: '35.0396px'}}></div><div className="bar" style={{height: '26.8569px'}}></div><div className="bar" style={{height: '35.9603px'}}></div><div className="bar" style={{height: '31.4623px'}}></div><div className="bar" style={{height: '20.3296px'}}></div><div className="bar" style={{height: '27.9436px'}}></div><div className="bar" style={{height: '28.1154px'}}></div><div className="bar" style={{height: '34.2554px'}}></div><div className="bar" style={{height: '22.6447px'}}></div><div className="bar" style={{height: '30.0927px'}}></div><div className="bar" style={{height: '20.4059px'}}></div><div className="bar" style={{height: '38.7656px'}}></div><div className="bar" style={{height: '28.9741px'}}></div><div className="bar" style={{height: '27.6695px'}}></div><div className="bar" style={{height: '21.3764px'}}></div><div className="bar" style={{height: '32.3351px'}}></div><div className="bar" style={{height: '22.1267px'}}></div><div className="bar" style={{height: '35.0503px'}}></div><div className="bar" style={{height: '38.2059px'}}></div><div className="bar" style={{height: '21.4774px'}}></div><div className="bar" style={{height: '20.9743px'}}></div><div className="bar" style={{height: '32.168px'}}></div><div className="bar" style={{height: '30.0068px'}}></div><div className="bar" style={{height: '32.763px'}}></div><div className="bar" style={{height: '35.184px'}}></div></div>
</div>

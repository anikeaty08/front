...
<a className="inline-flex items-center justify-center bg-center mix-blend-screen w-[100px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/37ca2d38-ce15-47f0-ae52-58f146479732_1600w.png)] bg-cover rounded invert-0" href="#"></a>
</div>
...
<article className="relative overflow-hidden aspect-[4/3] bg-center bg-cover rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/01296f44-0b19-41ad-b7cb-1d401455f1af_800w.jpg)] border-gradient before:rounded-2xl">
...
<article className="relative overflow-hidden aspect-[4/3] bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8d8ff092-132d-4cec-88a1-ac20bce98b33_800w.jpg)] bg-cover rounded-2xl border-gradient before:rounded-2xl">
...
<article className="relative overflow-hidden aspect-[4/5] bg-center bg-cover rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/cf8a505e-077b-4767-a4a6-5f049de93919_800w.jpg)] border-gradient before:rounded-2xl">
<div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/20 to-black/60"></div>
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1.5 px-1.5 backdrop-blur">
...
<article className="relative overflow-hidden aspect-[4/5] bg-center bg-cover rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f7d84a3f-8703-4f20-b660-fd8965a83b5c_800w.jpg)] border-gradient before:rounded-2xl">
<div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/20 to-black/60"></div>
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1.5 px-1.5 backdrop-blur">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<section className="sm:p-8 bg-zinc-900/50 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f02f2d97-2f6e-4565-af29-5029e146b6ad_3840w.jpg)] bg-cover border-zinc-800 rounded-[36px] mt-10 mr-8 ml-8 pt-6 pr-6 pb-6 pl-6 border-gradient before:rounded-[36px] [animation:fadeSlideIn_0.8s_ease-out_0.3s_both] animate-on-scroll" id="pricing">
<div className="flex gap-6 sm:px-0 pr-1 pl-1 gap-x-6 gap-y-6 items-center">
<span className="inline-flex items-center gap-2 text-sm">

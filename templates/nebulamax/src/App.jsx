...
<div className="flashlight-card bg-[#11131A] border border-white/5 rounded-xl p-0 shadow-lg hover:border-white/10 transition-colors overflow-hidden" style={{'--mouse-x': '278px', '--mouse-y': '6px'}}>
...
<div className="flashlight-card bg-[#11131A] border border-indigo-500/20 rounded-xl p-0 shadow-2xl hover:border-indigo-500/30 transition-all duration-300" style={{'--mouse-x': '235px', '--mouse-y': '3px'}}>
<div className="p-4 border-b border-white/5 bg-white/[0.01] flex justify-between items-center">
...
<div className="flashlight-card bg-[#11131A] border border-white/5 rounded-xl p-0 shadow-lg hover:border-white/10 transition-colors" style={{'--mouse-x': '105.84375px', '--mouse-y': '133px'}}>
<div className="p-4 border-b border-white/5 bg-white/[0.01] flex justify-between items-center">
<div className="flex items-center gap-3">
...
<div className="flashlight-card bg-[#11131A] border border-white/5 rounded-xl p-0 shadow-lg hover:border-white/10 transition-colors opacity-80 hover:opacity-100" style={{'--mouse-x': '98.84375px', '--mouse-y': '85px'}}>

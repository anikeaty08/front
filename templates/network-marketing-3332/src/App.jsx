...
<a className="btn-aura-custom group relative inline-flex items-center justify-center gap-2 rounded-full transition-all !hidden md:!inline-flex" href="#pricing" style={{'--border-radius': '9999px', '--padding': '3px', '--transition': '0.4s', '--button-color': '#171717', '--highlight-color-hue': '25deg', textDecoration: 'none'}}>
<style>
              .btn-aura-custom {
                  position: relative;
                  display: inline-flex;

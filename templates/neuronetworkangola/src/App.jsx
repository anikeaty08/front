...
<a className="group isolate inline-flex cursor-pointer overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_40px_10px_rgba(255,255,255,0.18)] rounded-full relative shadow-[0_10px_50px_rgba(255,255,255,0.08)] w-full sm:w-auto justify-center" href="#auditoria" style={{-Spread: '90deg', -ShimmerColor: 'rgba(255,255,255,0.65)', -Radius: '9999px', -Speed: '4s', -Cut: '1px', -Bg: 'rgba(255, 255, 255, 0.05)'}}>

...
<h1 className="leading-[0.95] sm:text-6xl lg:text-8xl md:leading-[0.9] md:mb-8 md:text-6xl text-6xl font-normal text-white tracking-tight font-serif-custom mb-8 drop-shadow-2xl">Welcome to <span className="bg-clip-text italic text-transparent bg-gradient-to-r from-sky-400 to-blue-600 pr-2">cigul inc.</span></h1>

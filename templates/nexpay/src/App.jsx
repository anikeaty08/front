...
<span className="">API Platform</span>
...
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:music-note-linear"></iconify-icon> AudioFlow</div>
<div className="hover:opacity-100 transition-opacity flex items-center gap-2"><iconify-icon className="" icon="solar:shop-linear"></iconify-icon> ShopGlobal</div>
...
<div className="hover:opacity-100 transition-opacity flex items-center gap-2 hidden md:flex"><iconify-icon className="" icon="solar:bus-linear"></iconify-icon> LogisticsPro</div>
</div>
</section>
...
<div className="mx-auto h-5 w-40 bg-gray-100 rounded text-[10px] text-gray-400 flex items-center justify-center font-geist">checkout.nexpay.io</div>
</div>
...
<div className="h-10 bg-[#05C168] rounded-lg flex items-center justify-center text-white text-xs font-bold font-geist">Link</div>
<div className="h-10 bg-black rounded-lg flex items-center justify-center text-white text-xs font-bold font-geist">Pay</div>
</div>
</div>
</div>
</div>
...
<div>
<div className="text-sm font-semibold font-jakarta text-[#2C2824]">Pro Plan</div>
...
<div className="text-[10px] uppercase tracking-wider text-gray-400 font-geist mb-3">API Requests (30d)</div>
...
<p className="">I'm looking for a minimal desk setup. Any recommendations?</p>
</div>
...
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Elevates your screen &amp; provides storage space.</p>
...
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Minimalist solid oak workspace setup.</p>
<button className="hover:bg-gray-50 transition-colors flex gap-1.5 text-[9px] font-semibold text-[#2C2824] font-geist bg-white w-full rounded-lg py-1.5 shadow-sm items-center justify-center">
<svg className="lucide lucide-shopping-cart" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="21" r="1"></circle><circle cx="19" cy="21" r="1"></circle><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"></path></svg>
                        Add
                    </button>
...
<p className="text-[9px] leading-relaxed text-white/70 mb-3 font-geist line-clamp-2">Tactile feedback with a clean, wire-free design.</p>
<button className="hover:bg-gray-50 transition-colors flex gap-1.5 text-[9px] font-semibold text-[#2C2824] font-geist bg-white w-full rounded-lg py-1.5 shadow-sm items-center justify-center">
<svg className="lucide lucide-shopping-cart" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="21" r="1"></circle><circle cx="19" cy="21" r="1"></circle><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"></path></svg>
                        Add
                    </button>
...
<div className="text-white font-bold text-xl tracking-tighter italic text-right relative">
                            VISA
                        </div>
</div>
</div>
...
<div className="w-4 h-4 rounded-full bg-[#2775CA] flex items-center justify-center text-[8px] text-white font-bold">U</div>
...
<div>
<div className="text-xs font-bold font-jakarta text-gray-900">Quiet Fire Yoga</div>
<div className="text-[10px] text-gray-500 font-geist mb-2">Payment successful</div>
...
<h4 className="text-sm font-semibold font-jakarta">Connected Accounts</h4>
<button className="text-[10px] bg-black text-white px-3 py-1.5 rounded-full font-geist">Export CSV</button>
</div>
...
<div className="text-sm font-semibold text-white tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">NexPay Engine</div>
<div className="text-[10px] text-blue-400 uppercase tracking-widest mt-1">Orchestration</div>
</div>
</div>
...
<h3 className="text-2xl font-semibold text-white mb-3 tracking-tight">Scale with confidence. <span className="text-[#adbdcc] font-normal">Handle thousands of transactions per second with consistent speed and reliability, even during peak traffic periods.</span></h3>
</div>
...
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">500M<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">API requests per day</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">10K<span className="text-[#635BFF]">+</span></div>
<div className="text-sm font-medium text-[#adbdcc]">API requests per second</div>
</div>
<div className="border-l border-[#635BFF]/30 pl-6">
<div className="text-5xl font-semibold text-white mb-2 tracking-tight">150K<span className="text-[#635BFF]">+</span></div>
...
<h3 className="text-2xl font-semibold text-white mb-3 tracking-tight">Choose an integration path. <span className="text-[#adbdcc] font-normal">With AI-powered support, rich documentation, and built-in debugging tools, you can quickly get started with the best option for your business.</span></h3>
</div>
</div>
</div>
</section>
...
<div className="h-full min-h-[400px] relative rounded-2xl overflow-hidden card-flashlight bg-[#2C2824] p-1" style={{'--mouse-x': '140px', '--mouse-y': '121.6640625px'}}>
...
<footer className="section-container dark-section text-[#F2EFEA] bg-[#26221E] border-white/10 border-t pt-24 pb-12">
<div className="max-w-[88rem] mx-auto px-6 lg:px-12">
...
<iconify-icon className="text-lg" icon="ri:twitter-x-fill"></iconify-icon>
</a>
<a className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center opacity-50 hover:opacity-100 hover:bg-white/5 transition-all" href="#">
<iconify-icon className="text-lg" icon="ri:linkedin-fill"></iconify-icon>
</a>
<a className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center opacity-50 hover:opacity-100 hover:bg-white/5 transition-all" href="#">
<iconify-icon className="text-lg" icon="ri:github-fill"></iconify-icon>
</a>
</div>
</div>
<div className="col-span-1 lg:col-span-2 space-y-8">
<h4 className="text-xs font-semibold tracking-widest uppercase opacity-40 font-geist">Products</h4>
...
<li className=""><a className="hover:opacity-100 transition-opacity" href="#">Billing</a></li>
</ul>
</div>
<div className="col-span-1 lg:col-span-2 space-y-8">
<h4 className="text-xs font-semibold tracking-widest uppercase opacity-40 font-geist">Resources</h4>
<ul className="space-y-4 text-sm font-normal opacity-60 font-geist">
<li><a className="hover:opacity-100 transition-opacity" href="#">Documentation</a></li>
<li><a className="hover:opacity-100 transition-opacity" href="#">API Reference</a></li>
</ul>
</div>
<div className="col-span-1 lg:col-span-2 space-y-8">
<h4 className="text-xs font-semibold tracking-widest uppercase opacity-40 font-geist">Solutions</h4>
<ul className="space-y-4 text-sm font-normal opacity-60 font-geist">
<li><a className="hover:opacity-100 transition-opacity" href="#">SaaS Platforms</a></li>
<li><a className="hover:opacity-100 transition-opacity" href="#">Marketplaces</a></li>
</ul>
</div>
<div className="col-span-1 lg:col-span-2 space-y-8">
<h4 className="text-xs font-semibold tracking-widest uppercase opacity-40 font-geist">Company</h4>
<ul className="space-y-4 text-sm font-normal opacity-60 font-geist">
<li><a className="hover:opacity-100 transition-opacity" href="#">About Us</a></li>
<li><a className="hover:opacity-100 transition-opacity" href="#">Careers</a></li>
</ul>
</div>
</div>
<div className="flex flex-col md:flex-row justify-between items-center gap-10 text-xs font-medium tracking-widest opacity-50 uppercase border-t border-white/10 pt-10">
<div className="flex flex-wrap items-center justify-center md:justify-start gap-x-8 gap-y-4 font-geist text-[10px] md:text-xs">
<div className="flex items-center gap-2">
<iconify-icon className="text-base" icon="solar:map-point-linear"></iconify-icon> 
                    Global Operations
                </div>
<div className="hidden sm:flex items-center gap-2 border-l border-white/10 pl-8 ml-0 md:ml-0">
<iconify-icon className="text-base" icon="solar:global-linear"></iconify-icon> 
                    English (US)
                </div>
<div className="sm:border-l border-white/10 sm:pl-8 ml-0 md:ml-0">© 2024 NexPay, Inc.</div>
</div>
<div className="flex items-center gap-2 py-1.5 px-4 rounded-full bg-white/5 border border-white/5 font-geist">

...
<a className="text-sm font-normal text-neutral-400 hover:text-white transition-colors" href="#">Platform</a>
...
<a className="hidden sm:block text-sm font-normal text-neutral-400 hover:text-white transition-colors" href="#">Log in</a>
...
<svg className="lucide lucide-play w-4 h-4 fill-current" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
            Watch Demo
        </span>
</button>
</div>
...
<div aria-label="Window controls" className="flex items-center gap-1.5">
<div className="w-2.5 h-2.5 rounded-full bg-[#FF5F57]"></div>
<div className="w-2.5 h-2.5 rounded-full bg-[#FEBC2E]"></div>
<div className="w-2.5 h-2.5 rounded-full bg-[#28C840]"></div>
</div>
<div className="text-[10px] font-medium text-neutral-500 flex items-center gap-1 opacity-50">
<svg aria-hidden="true" className="lucide lucide-lock w-2.5 h-2.5" fill="none" height="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="10" xmlns="http://www.w3.org/2000/svg">
...
<nav aria-label="Main Navigation" className="w-64 border-r border-white/5 bg-[#080808] hidden md:flex flex-col flex-shrink-0">
...
<svg className="lucide lucide-bot" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-plus w-4 h-4 text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<a aria-current="page" className="group flex items-center justify-between px-3 py-2 rounded-lg text-sm text-white bg-white/5 border border-white/5 transition-colors" href="#">
<span className="flex items-center gap-3 truncate min-w-0">
<svg className="lucide lucide-file-text w-4 h-4 text-rose-400 shrink-0" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-pencil" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M17 3a2.85 2.85 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"></path></svg>
</button>
<button aria-label="Delete chat" className="p-0.5 text-neutral-500 hover:text-red-500">
<svg className="lucide lucide-trash-2" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M3 6h18"></path><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"></path><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M15 6V4c0-1-1-2-2-2h-2c-1 0-2 1-2 2v2"></path></svg>
</button>
</div>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-neutral-400 hover:text-white hover:bg-white/5 transition-colors" href="#">
<svg className="lucide lucide-message-square w-4 h-4 text-neutral-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
</svg>
<span className="truncate">Marketing Strategy</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-neutral-400 hover:text-white hover:bg-white/5 transition-colors" href="#">
<svg className="lucide lucide-image w-4 h-4 text-neutral-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<div aria-label="Plan Usage" className="bg-neutral-900/50 rounded-lg p-3 border border-white/5 mb-4">
...
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="85" className="h-1 w-full bg-white/5 rounded-full overflow-hidden" role="progressbar">
...
<svg aria-hidden="true" className="lucide lucide-settings w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1-1-1.74v-.47a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg>
</button>
</footer>
</nav>
<main className="flex-1 relative bg-[#050505] flex flex-col min-w-0">
<div aria-hidden="true" className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none">
</div>
<div className="flex-1 p-6 sm:p-10 overflow-y-auto relative z-10 flex flex-col max-w-4xl mx-auto w-full">
<div aria-label="Action Templates" className="flex-1 flex flex-col justify-center mb-10" role="region">
...
<button aria-label="Analyze Document template" className="group p-4 rounded-xl border border-white/5 bg-neutral-900/30 hover:bg-neutral-900/60 hover:border-white/10 transition-all text-left relative overflow-hidden" role="listitem">
<div aria-hidden="true" className="absolute inset-0 bg-gradient-to-br from-rose-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
...
<svg className="lucide lucide-file-search" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M4.268 21a2 2 0 0 0 1.727 1H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3"></path><path d="m9 18-1.5-1.5"></path><circle cx="5" cy="14" r="3"></circle></svg>
</div>
<div>
...
<button aria-label="Content Creation template" className="group p-4 rounded-xl border border-white/5 bg-neutral-900/30 hover:bg-neutral-900/60 hover:border-white/10 transition-all text-left relative overflow-hidden" role="listitem">
<div aria-hidden="true" className="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="flex items-start gap-4">
...
<svg className="lucide lucide-pen-tool" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m12 19 7-7 3 3-7 7-3-3z"></path><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"></path><path d="m2 2 7.586 7.586"></path><circle cx="11" cy="11" r="2"></circle></svg>
</div>
<div>
...
<button aria-label="Code Assistant template" className="group p-4 rounded-xl border border-white/5 bg-neutral-900/30 hover:bg-neutral-900/60 hover:border-white/10 transition-all text-left relative overflow-hidden" role="listitem">
<div aria-hidden="true" className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="flex items-start gap-4">
...
<svg className="lucide lucide-code-2" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m18 16 4-4-4-4"></path><path d="m6 8-4 4 4 4"></path><path d="m14.5 4-5 16"></path></svg>
</div>
<div>
...
<button aria-label="Brainstorming template" className="group p-4 rounded-xl border border-white/5 bg-neutral-900/30 hover:bg-neutral-900/60 hover:border-white/10 transition-all text-left relative overflow-hidden" role="listitem">
<div aria-hidden="true" className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
<div className="flex items-start gap-4">
...
<svg className="lucide lucide-sparkles" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275z"></path></svg>
</div>
<div>
...
<input aria-label="Message input" className="w-full h-14 pl-4 pr-14 bg-transparent text-sm text-white placeholder-neutral-500 focus:outline-none font-light focus:ring-2 focus:ring-rose-500/50 transition-shadow duration-150" placeholder="Send a message..." type="text"/>
...
<svg className="lucide lucide-paperclip" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"></path></svg>
</button>
...
<svg className="lucide lucide-send" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="m22 2-7 20-4-9-4 9-2-7-14-3 20-3z"></path></svg>
</button>
</div>
</div>
...
<aside aria-label="Live Content Analysis" className="absolute -bottom-12 -right-12 w-[380px] bg-[#0A0A0A]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-5 z-50 hidden lg:block animate-in fade-in slide-in-from-bottom-8 duration-700 ring-1 ring-white/5" role="complementary">
<div className="flex items-center justify-between mb-4">
<div className="flex items-center gap-2">
<div aria-hidden="true" className="w-2 h-2 rounded-full bg-rose-500 animate-pulse"></div>
...
<blockquote className="bg-neutral-900/50 rounded-lg p-4 border border-white/5 text-sm text-neutral-300 font-light leading-relaxed">
                ...
                <span aria-label="exceptional (Positive)" className="bg-rose-500/10 text-rose-400 border-b border-rose-500/30 pb-0.5">exceptional</span>
                and customer support is
                <span aria-label="fantastic (Positive)" className="bg-orange-500/10 text-orange-400 border-b border-orange-500/30 pb-0.5">fantastic</span>.
                They
                <span aria-label="assisted (Action)" className="bg-purple-500/10 text-purple-400 border-b border-purple-500/30 pb-0.5">assisted</span>
...
<span aria-hidden="true" className="w-1 h-1 rounded-full bg-rose-500"></span>
                    Opinion
                    </span>
...
<span aria-hidden="true" className="w-1 h-1 rounded-full bg-orange-500"></span>
                    Reaction
                    </span>
...
<span aria-hidden="true" className="w-1 h-1 rounded-full bg-purple-500"></span>
                    Action
                    </span>
</div>
</div>
<div className="pt-3 border-t border-white/5">
<button aria-label="Use suggested reply" className="flex items-center gap-3 w-full p-2 rounded-lg bg-neutral-900 hover:bg-neutral-800 transition-colors border border-white/5 group">
<div className="w-8 h-8 rounded bg/5 flex items-center justify-center shrink-0">
<svg className="lucide lucide-sparkles text-white" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<path d="M200 150 C 200 100, 120 100, 120 80" fill="none" stroke="white" strokeWidth="1.5"></path>

<path d="M200 150 C 200 100, 280 100, 280 80" fill="none" stroke="white" strokeWidth="1.5"></path>

<path d="M200 150 C 200 150, 80 150, 80 140" fill="none" stroke="white" strokeWidth="1.5"></path>

<path d="M200 150 C 200 150, 320 150, 320 140" fill="none" stroke="white" strokeWidth="1.5"></path>

<path d="M200 150 L 200 90" fill="none" stroke="white" strokeWidth="1.5"></path>
</svg>
...
<div className="flex flex-col gap-5 group">
<div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 group-hover:text-white group-hover:bg-white/10 transition-all">
<svg className="lucide lucide-terminal-square w-5 h-5" data-lucide="terminal-square" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m7 11 2-2-2-2"></path><path d="M11 13h4"></path><rect height="18" rx="2" ry="2" width="18" x="3" y="3"></rect></svg>
</div>
<div className="">
...
<svg className="lucide lucide-check w-4 h-4 text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<ul className="space-y-4">
<li className="flex items-center gap-3 text-sm text-neutral-400 font-light">
<svg className="lucide lucide-check w-4 h-4 text-rose-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<svg className="lucide lucide-plus w-5 h-5 text-neutral-400 group-hover:text-white" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</span>
</summary>
...
<svg className="lucide lucide-twitter transition-transform group-hover/icon:scale-110" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
</a>
<a className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all group/icon" href="#">
<svg className="lucide lucide-github transition-transform group-hover/icon:scale-110" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M15 22v-4a4.8 5 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
</a>
<a className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all group/icon" href="#">
<svg className="lucide lucide-linkedin transition-transform group-hover/icon:scale-110" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect height="12" width="4" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
</a>
<a className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all group/icon" href="#">
<svg className="lucide lucide-discord transition-transform group-hover/icon:scale-110" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="12" r="1"></circle><circle cx="15" cy="12" r="1"></circle><path d="M7.5 7.2c.3-.4 1-.5 1.4-.2 1.9 1.2 4.3 1.2 6.2 0 .5-.2 1.1-.1 1.4.3l.5.7c.3.4.2 1-.2 1.3-2.3 1.7-5.5 1.7-7.8 0-.4-.3-.5-1-.2-1.4l.5-.7z"></path><path d="M22 12a10 10 0 0 1-20 0c0-1.2.2-2.3.5-3.3.1-.4.5-.6.9-.5l.1.1c.4.1.7.5.6.9-.2.8-.4 1.7-.4 2.6 0 4.6 3.9 8.3 8.7 8.3s8.7-3.7 8.7-8.3c0-.9-.2-1.8-.4-2.6-.1-.4.2-.8.6-.9l.1-.1c.4-.1.8.1.9.5.3 1 .5 2.1.5 3.3Z"></path></svg>
</a>
</div>
</div>

...
<a className="group hover-trigger z-50" href="#">
<span className="group-hover:text-accent transition-colors text-xl font-bold text-white tracking-tighter font-display" onclick="window.location.href='/home'" role="button">NEXUS<span className="text-accent group-hover:text-white transition-colors">//</span>OS</span>
</a>
...
<button className="uppercase hover:bg-white hover:text-black transition-all hover-trigger btn-magnetic text-xs font-bold text-white tracking-wider border-white/20 border pt-2 pr-6 pb-2 pl-6" onclick="window.location.href='/login-signup'" role="button">
                    Login
                </button>
</div>
...
<a className="text-2xl font-display font-bold text-white hover:text-accent transition-colors mobile-link" href="/about">ABOUT</a>
<a className="text-2xl font-display font-bold text-white hover:text-accent transition-colors mobile-link" href="/pricing">PRICING</a>
<a className="text-2xl font-display font-bold text-white hover:text-accent transition-colors mobile-link" href="/documentation">DOCUMENTATION</a>
<a className="text-2xl font-display font-bold text-white hover:text-accent transition-colors mobile-link" href="/changelog">CHANGELOG</a>
<div className="w-12 h-[1px] bg-white/10 mx-auto my-4"></div>
<button className="text-xl font-mono text-accent hover:text-white transition-colors" onclick="window.location.href='/login-signup'">
                LOGIN_TERMINAL
            </button>
</div>
</div>

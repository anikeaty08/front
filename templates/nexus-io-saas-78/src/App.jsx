...
<span className="text-lg font-bold text-white tracking-tight">Rate Talks<span className="text-white/40">.ai</span></span>
</div>
...
<div className="text-center max-w-5xl mr-auto mb-24 ml-auto">

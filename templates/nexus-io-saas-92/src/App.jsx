...
<input className="w-full sm:flex-1 bg-[#161616] border border-white/10 rounded-full px-6 py-3.5 text-base outline-none focus:ring-1 focus:ring-white/20 focus:border-white/20 transition-all placeholder:text-neutral-600 shadow-lg h-[52px] text-white" placeholder="work@company.com" type="email"/>

<button className="group flex overflow-hidden transition-all duration-300 hover:from-white/15 hover:via-white/10 hover:to-white/5 focus:ring-2 focus:ring-white/20 focus:outline-none sm:w-auto bg-gradient-to-b from-white/20 via-white/0 to-white/20 w-full h-[52px] rounded-full pt-3 pr-6 pb-3 pl-6 relative gap-x-2 gap-y-2 items-center justify-center" style={{boxShadow: '0 0 0 1px rgba(255, 255, 255, 0.08), 0 2px 8px rgba(0, 0, 0, 0.4)', position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.1))', -BorderRadiusBefore: '9999px'}}>
<span className="text-sm font-semibold tracking-tight relative z-10 text-white/90 group-hover:text-white transition-colors">
        Get Access
    </span>
<svg className="w-4 h-4 relative z-10 text-white/60 group-hover:text-white transition-colors group-hover:translate-x-0.5" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
...
<svg className="text-neutral-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path><path d="m9 12 2 2 4-4"></path></svg>
...
<svg className="animate-on-scroll [animation:animationIn_0.8s_ease-out_0.6s_both] absolute -left-12 -top-16 w-32 h-32 text-neutral-700 hidden lg:block" fill="none" stroke="currentColor" viewbox="0 0 100 100">
<path d="M80 80 C 40 80, 20 60, 20 20" marker-end="url(#arrowhead)" stroke-dasharray="4 4" strokeWidth="1"></path>
<defs>
...
<svg className="" fill="none" height="12" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 3H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3Z"></path><path d="M15 3v6h6"></path><path d="M2 13.5h20"></path></svg>
</div>
...
<div className="text-sm text-neutral-500 mt-1 font-medium">Press  + </div>
</div>
...
<button className="w-12 h-12 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center text-neutral-400 hover:bg-white/10 hover:text-white transition-colors">
<svg fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18" x="3" y="3"></rect><line x1="12" x2="12" y1="8" y2="16"></line><line x1="8" x2="16" y1="12" y2="12"></line></svg>
</button>
</div>
</div>
</div>
...
<svg className="text-white" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M3 3v18h18"></path><path d="m19 9-5 5-4-4-3 3"></path></svg>
...
<svg className="absolute -right-12 -top-12 w-32 h-32 text-neutral-700 hidden lg:block rotate-90" fill="none" stroke="currentColor" viewbox="0 0 100 100">
<path d="M20 80 C 60 80, 80 60, 80 20" marker-end="url(#arrowhead)" stroke-dasharray="4 4" strokeWidth="1"></path>
</svg>
...
<iconify-icon height="18" icon="logos:jira" style={{filter: 'grayscale(100%)'}} width="18"></iconify-icon>
...
<iconify-icon height="18" icon="logos:discord-icon" style={{filter: 'grayscale(100%)'}} width="18"></iconify-icon>
...
<iconify-icon height="18" icon="logos:notion-icon" style={{filter: 'invert(1)'}} width="18"></iconify-icon>
</div>
...
<svg className="mr-2 text-neutral-600" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" ry="2" width="18" x="3" y="4"></rect><line x1="16" x2="16" y1="2" y2="6"></line><line x1="8" x2="8" y1="2" y2="6"></line><line x1="3" x2="21" y1="10" y2="10"></line></svg>
                                        Nov 24
                                    </div>
<div className="flex items-center text-neutral-500 text-xs font-semibold">
<svg className="mr-2 text-neutral-600" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                                        2:00 PM
                                    </div>
</div>
</div>
...
<iconify-icon className="text-white" height="32" icon="simple-icons:stripe"></iconify-icon>
<iconify-icon className="text-white" height="26" icon="simple-icons:vercel"></iconify-icon>
<iconify-icon className="text-white" height="26" icon="simple-icons:linear"></iconify-icon>
<iconify-icon className="text-white" height="28" icon="simple-icons:airbnb"></iconify-icon>
<iconify-icon className="text-white" height="26" icon="simple-icons:shopify"></iconify-icon>
</div>
</div>
</div><div className="relative border-b border-white/5 bg-[#050505]">
...
<iconify-icon className="text-white text-xs" icon="solar:check-circle-bold"></iconify-icon>
...
<svg className="absolute inset-0 w-full h-full text-white/10 drop-shadow-[0_0_15px_rgba(255,255,255,0.05)]" viewbox="0 0 100 100">
<path d="M50 0 L95 25 L95 75 L50 100 L5 75 L5 25 Z" fill="#0F0F0F" stroke="currentColor" strokeWidth="1"></path>
</svg>

<iconify-icon className="text-white text-3xl relative z-20" icon="solar:users-group-rounded-linear"></iconify-icon>
</div>
</div>
...
<path className="" d="M0 120 L 50 100 L 100 105 L 150 60 L 200 20" fill="url(#chartGradient)" stroke="none"></path>

<path className="drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]" d="M0 120 L 50 100 L 100 105 L 150 60 L 200 20" fill="none" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>

<circle cx="0" cy="120" fill="#262626" r="2" stroke="white" strokeWidth="1.5"></circle>
<circle cx="50" cy="100" fill="#262626" r="2" stroke="white" strokeWidth="1.5"></circle>
<circle cx="100" cy="105" fill="#262626" r="2" stroke="white" strokeWidth="1.5"></circle>
<circle cx="150" cy="60" fill="#262626" r="2" stroke="white" strokeWidth="1.5"></circle>
<circle className="group-hover:scale-150 transition-transform origin-center" cx="200" cy="20" fill="#fff" r="3"></circle>

<rect className="" fill="#fff" fillOpacity="0.1" height="20" rx="4" stroke="rgba(255,255,255,0.2)" width="40" x="175" y="0"></rect>
<text fill="white" fontFamily="sans-serif" fontSize="10" text-anchor="middle" x="195" y="14">100%</text>
</svg>
</div>
...
</div><section className="relative bg-[#050505] text-white py-32 overflow-hidden border-b border-white/5">
...
<div className="flex flex-col md:flex-row md:items-end text-[10px] md:text-xs uppercase text-neutral-500 tracking-[0.2em] font-mono mb-24 gap-x-4 gap-y-4 items-start justify-between">
<div className="flex items-center gap-2">
...
<p className="text-lg md:text-xl text-neutral-400 font-light max-w-2xl mx-auto leading-relaxed tracking-tight">
        We employed intelligent adaptive protocols to maintain consistency and velocity across all development
        environments.
      </p>
</div>
...
<p className="text-sm text-neutral-500 font-medium leading-relaxed">
          Identify bottlenecks in your data pipeline. Our agents automatically map your infrastructure to find
...
<h3 className="text-lg font-bold uppercase tracking-wide text-white mb-3 group-hover:text-blue-400 transition-colors">
          Build &amp; Implement</h3>
<p className="text-sm text-neutral-500 font-medium leading-relaxed">
          Deploy solutions instantly. The system generates and tests code patches, ensuring zero downtime during
          implementation.
        </p>
</div>
...
<h3 className="text-lg font-bold uppercase tracking-wide text-white mb-3 group-hover:text-blue-400 transition-colors">
          Deliver &amp; Monitor</h3>
<p className="text-sm text-neutral-500 font-medium leading-relaxed">
          Ensure efficient execution and tracking. Real-time dashboards give you visibility into performance metrics and
          health.
        </p>
</div>
</div>
...
<p className="text-sm text-neutral-400 mb-8 leading-relaxed">Perfect for side projects and learning the basics.
          </p>
...
<div className="px-3 py-1 rounded-full bg-white text-[10px] text-black font-bold uppercase tracking-wide">
                Popular</div>
</div>
<div className="mb-6 flex items-baseline gap-1">
...
<p className="text-sm text-neutral-400 mb-8 leading-relaxed">For professional teams shipping into production.
            </p>
...
<p className="text-sm text-neutral-400 mb-8 leading-relaxed">Advanced security and controls for large
            organizations.</p>

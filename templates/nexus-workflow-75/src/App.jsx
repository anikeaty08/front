...
<h1 className="md:text-7xl lg:text-8xl leading-[1.1] text-5xl font-medium text-white tracking-tight max-w-4xl mr-auto mb-6 ml-auto">Sync your reality <br className=""/> <span className="text-stone-500">with the digital edge.</span></h1>
...
<div className="md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 pt-0 pr-0 pb-0 pl-0 gap-x-6 gap-y-6">
...
<div className="flex flex-wrap opacity-40 grayscale gap-x-12 gap-y-8 justify-center">
...
<p className="leading-relaxed text-sm text-stone-400">Changes propagate instantly across all connected clients via our edge network. No polling required.</p>
</div>
...
<p className="leading-relaxed text-sm text-stone-400">Deployed to 35+ regions worldwide, ensuring low latency regardless of where your users are located.</p>
</div>
...
<div className="bg-stone-900/50 w-full border-white/10 border rounded-l-xl pt-4 pr-4 pb-4 pl-4 absolute top-4 right-4 bottom-4 backdrop-blur-sm">
<div className="space-y-3">
...
<p className="leading-relaxed text-sm text-stone-300 mb-6">"Nexus has completely transformed how our distributed team stays in sync. The latency is practically non-existent, and the UI is a joy to use."</p>
</div>
<div className="flex gap-3 gap-x-3 gap-y-3 items-center">

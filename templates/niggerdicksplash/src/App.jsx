...
<span className="text-xl font-bold tracking-tight">SpendsIn</span>
</a>

<div className="hidden md:flex items-center gap-8 font-semibold text-sm">
<a className="hover:underline decoration-2 underline-offset-4" href="#features">Features</a>
<a className="hover:underline decoration-2 underline-offset-4" href="#ai">Sai AI Assistant</a>
<a className="hover:underline decoration-2 underline-offset-4" href="#portfolio">Portfolio</a>
<a className="hover:underline decoration-2 underline-offset-4" href="#">Login</a>
</div>
...
<span className="text-xs font-bold tracking-wide uppercase">New: Live Stock Tracking</span>
</div>
...
<p className="text-xl text-zinc-600 mb-10 leading-relaxed font-medium">
                    Track income, expenses, and Indian stocks in one beautiful place. Chat with Sai, your AI financial assistant, to add transactions via voice or text. Real-time sync, zero clutter.
                </p>
...
<div>
<div className="font-bold text-sm">Grocery Shopping</div>
<div className="text-xs text-zinc-500">Just now • Reliance Fresh</div>
</div>
</div>
<div className="font-bold text-red-500">- ₹2,450</div>
</div>
...
<div className="font-bold text-lg">Portfolio Growth</div>
<div className="bg-green-400 text-black text-xs font-bold px-2 py-1 border border-black rounded">+12.5%</div>
</div>
...
<div className="w-full bg-blue-400 border border-black h-[50%]"></div>
...
<div className="text-xs font-bold text-center">Last 7 Days Trend</div>
</div>
...
<div>
<div className="text-xs text-zinc-400 mb-1">Sai (AI Assistant)</div>
<div className="text-sm font-medium">"Added ₹500 for coffee to 'Dining' category."</div>
</div>
</div>
</div>
</div>
...
<span className="text-sm font-bold tracking-widest uppercase text-zinc-500 mb-3 block">Complete Financial Control</span>
<h2 className="text-4xl md:text-5xl tracking-tight font-medium">Everything you need to grow wealth</h2>
</div>
...
<h3 className="text-xl font-bold mb-4">AI-Powered Tracking</h3>
<p className="font-medium text-zinc-800 mb-6 flex-1">
                        Chat with "Sai" to add transactions naturally. "Spent 200 on chai" is all you need to say.
                    </p>
<ul className="space-y-3 text-sm font-semibold">
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Voice Input Support</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Smart Categorization</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Witty Insights</li>
</ul>
</div>
...
<div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-black text-white px-4 py-1.5 rounded-md border-2 border-black text-xs font-bold uppercase tracking-wider brutal-shadow-sm">Top Feature</div>
<div className="w-12 h-12 bg-white rounded-lg border-2 border-black flex items-center justify-center mb-6">
<i className="w-6 h-6 stroke-[1.5]" data-lucide="trending-up"></i>
</div>
<h3 className="text-xl font-bold mb-4">Portfolio Tracker</h3>
<p className="font-medium text-zinc-800 mb-6 flex-1">
                        Track NSE/BSE stocks and mutual funds. Get real-time prices and sector allocation charts.
                    </p>
<ul className="space-y-3 text-sm font-semibold">
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Live Yahoo Finance API</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Daily NAV Updates</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Gain/Loss Analytics</li>
</ul>
</div>
...
<p className="font-medium text-zinc-800 mb-6 flex-1">
                        Set monthly limits for categories like Food or Entertainment and get alerts before you overspend.
                    </p>
<ul className="space-y-3 text-sm font-semibold">
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Visual Progress Bars</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Recurring Transactions</li>
<li className="flex items-center gap-2"><i className="w-4 h-4" data-lucide="check"></i> Savings Goals</li>
</ul>
</div>
</div>
</div>
...
<span className="text-xs font-bold uppercase tracking-widest">Meet Sai</span>
</div>
<h2 className="text-4xl md:text-5xl tracking-tight mb-16 font-medium">Your Personal Financial Genius</h2>
...
<h3 className="text-2xl text-center mb-6 font-medium">You Ask</h3>
...
<h3 className="text-2xl font-medium">Sai Analyzes</h3>
</div>
<ul className="space-y-3">
<li className="flex items-center gap-2 font-bold text-indigo-100"><i className="w-4 h-4" data-lucide="search"></i> Scans transactions</li>
<li className="flex items-center gap-2 font-bold text-indigo-100"><i className="w-4 h-4" data-lucide="filter"></i> Filters category</li>
<li className="flex items-center gap-2 font-bold text-indigo-100"><i className="w-4 h-4" data-lucide="calculator"></i> Calculates totals</li>
<li className="flex items-center gap-2 font-bold text-indigo-100"><i className="w-4 h-4" data-lucide="shield-check"></i> 100% Private</li>
</ul>
</div>
...
<section className="py-24 px-6 bg-[#bfdbfe] border-t-2 border-black" id="portfolio">
<div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
<div>
<span className="text-sm font-bold tracking-widest uppercase text-black/70 mb-3 block">Wealth Management</span>
<h2 className="text-4xl mb-6 font-medium">All your assets. One Dashboard.</h2>
...
<div className="bg-white p-2 rounded border border-black"><i className="w-5 h-5" data-lucide="bar-chart-3"></i></div>
<span className="font-bold">Sector Allocation Charts</span>
</div>
<div className="flex items-center gap-4 bg-white/50 p-3 rounded-lg border-2 border-black/10">
<div className="bg-white p-2 rounded border border-black"><i className="w-5 h-5" data-lucide="bell"></i></div>
...
<span className="bg-green-100 text-green-800 border border-green-300 px-2 py-1 rounded text-xs font-bold">Live</span>
</div>

<div className="space-y-3">
<div className="flex items-center justify-between p-3 bg-zinc-50 border border-zinc-200 rounded-lg">
<div className="flex items-center gap-3">
<div className="w-10 h-10 bg-blue-600 text-white rounded flex items-center justify-center font-bold">R</div>
<div>
<div className="font-bold text-sm">RELIANCE.NS</div>
<div className="text-xs text-zinc-500">10 Qty</div>
</div>
</div>
<div className="text-right">
<div className="font-bold">₹2,450.00</div>
<div className="text-xs text-green-600 font-bold">+1.2% ▲</div>
</div>
</div>
<div className="flex items-center justify-between p-3 bg-zinc-50 border border-zinc-200 rounded-lg">
<div className="flex items-center gap-3">
<div className="w-10 h-10 bg-red-600 text-white rounded flex items-center justify-center font-bold">H</div>
<div>
<div className="font-bold text-sm">HDFCBANK.NS</div>
<div className="text-xs text-zinc-500">25 Qty</div>
</div>
</div>
<div className="text-right">
<div className="font-bold">₹1,520.00</div>
<div className="text-xs text-red-500 font-bold">-0.5% ▼</div>
</div>
</div>
</div>
<div className="mt-4 pt-4 border-t-2 border-dashed border-zinc-200 flex justify-between items-center">
<span className="font-bold text-zinc-500">Total Value</span>
<span className="font-bold text-xl">₹62,500.00</span>
</div>
</div>
</div>
</div>
...
<h2 className="text-4xl md:text-5xl mb-12 font-medium">Track every rupee</h2>
...
<i className="text-purple-600" data-lucide="smartphone"></i>
<span className="font-bold text-lg">UPI</span>
</div>
<div className="bg-white border-2 border-black rounded-xl px-8 py-4 flex items-center gap-3 brutal-shadow hover:-translate-y-1 transition-all cursor-default min-w-[160px]">
<i className="text-orange-500" data-lucide="credit-card"></i>
<span className="font-bold text-lg">Credit Cards</span>
</div>
<div className="bg-white border-2 border-black rounded-xl px-8 py-4 flex items-center gap-3 brutal-shadow hover:-translate-y-1 transition-all cursor-default min-w-[160px]">
<i className="text-blue-500" data-lucide="landmark"></i>
<span className="font-bold text-lg">Net Banking</span>
</div>
<div className="bg-white border-2 border-black rounded-xl px-8 py-4 flex items-center gap-3 brutal-shadow hover:-translate-y-1 transition-all cursor-default min-w-[160px]">
<i className="text-green-600" data-lucide="banknote"></i>
...
<h3 className="text-2xl leading-tight mb-4 font-bold">Sign Up Free</h3>
<p className="font-medium border-l-2 border-[#fde047] pl-3">Create your secure account. We use Supabase with Row Level Security (RLS) to ensure your data is yours alone.</p>
</div>
</div>
...
<h3 className="text-2xl leading-tight mb-4 font-bold">Add Transactions</h3>
<p className="font-medium border-l-2 border-[#86efac] pl-3">Use the dashboard or just tell Sai: "Income 50000 Salary". Set up recurring bills and budget limits instantly.</p>
</div>
</div>
...
<h3 className="text-2xl leading-tight mb-4 font-bold">Visualize &amp; Grow</h3>
<p className="font-medium border-l-2 border-[#ff9ebb] pl-3">Watch your dashboard update in real-time. Export reports to CSV and analyze your spending habits to save more.</p>
</div>
</div>
</div>
</div>
...
<th className="p-4 md:p-6 border-b-2 border-black w-1/3">Feature</th>
<th className="p-4 md:p-6 border-b-2 border-white/20 w-1/3 text-zinc-400">Excel / Others</th>
<th className="p-4 md:p-6 border-b-2 border-black bg-[#fde047] text-black w-1/3">SpendsIn</th>
</tr>
</thead>
<tbody className="font-medium">
<tr className="border-b-2 border-black">
<td className="p-4 md:p-6 font-bold bg-zinc-50">Data Entry</td>
<td className="p-4 md:p-6">Manual &amp; Boring</td>
<td className="p-4 md:p-6 bg-yellow-50 font-bold">AI Chat &amp; Voice</td>
</tr>
<tr className="border-b-2 border-black">
<td className="p-4 md:p-6 font-bold bg-zinc-50">Stock Tracking</td>
<td className="p-4 md:p-6">Complicated Formulas</td>
<td className="p-4 md:p-6 bg-yellow-50 font-bold">Real-time (NSE/BSE)</td>
</tr>
<tr className="border-b-2 border-black">
<td className="p-4 md:p-6 font-bold bg-zinc-50">Cost</td>
<td className="p-4 md:p-6">Expensive Subscription</td>
<td className="p-4 md:p-6 bg-yellow-50 font-bold">Free &amp; Open Source</td>
</tr>
<tr className="border-b-2 border-black">
<td className="p-4 md:p-6 font-bold bg-zinc-50">Real-time Sync</td>
<td className="p-4 md:p-6">Rarely</td>
<td className="p-4 md:p-6 bg-yellow-50 font-bold">Instant (WebSockets)</td>
</tr>
</tbody>
</table>
</div>
...
<span className="text-xs font-bold uppercase tracking-widest">Mobile First</span>
</div>
<h2 className="text-4xl md:text-5xl mb-6 font-medium">Finances in your pocket.</h2>
...
<li className="flex items-center gap-3 font-bold"><i className="w-5 h-5" data-lucide="check"></i> Dark Mode Support</li>
<li className="flex items-center gap-3 font-bold"><i className="w-5 h-5" data-lucide="check"></i> CSV Export on Mobile</li>
<li className="flex items-center gap-3 font-bold"><i className="w-5 h-5" data-lucide="check"></i> Secure Biometric (Device) Login</li>
</ul>
</div>
...
<div className="text-zinc-400 text-xs uppercase">Net Balance</div>
<div className="text-3xl font-bold mt-1">₹1,24,500</div>
</div>
<div className="grid grid-cols-2 gap-3">
<div className="bg-zinc-800 p-3 rounded-xl border border-zinc-700">
<div className="text-green-400 text-xs mb-1">Income</div>
<div className="font-bold">₹85k</div>
</div>
<div className="bg-zinc-800 p-3 rounded-xl border border-zinc-700">
...
<div className="text-xs text-zinc-500">Food &amp; Dining</div>
</div>
...
<p className="text-xl font-bold text-black/80 mb-12 max-w-2xl mx-auto">
                Join thousands of users tracking their finances with SpendsIn. 
                Built with React 19 &amp; Supabase for speed and security.
            </p>
...
<span className="font-bold text-xl">SpendsIn</span>
</div>
...
<div className="text-zinc-500 text-sm font-medium">
                © 2025 SpendsIn. Built with ❤️ in India.
            </div>
</div>
</footer>

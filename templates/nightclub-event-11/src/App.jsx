...
<nav className="fixed md:px-12 flex backdrop-blur-[2px] bg-gradient-to-b from-neutral-950/80 to-transparent mix-blend-difference w-full z-50 pt-6 pr-6 pb-6 pl-6 top-0 shadow-md backdrop-blur-none items-center justify-between">
<a className="uppercase z-50 text-xl font-semibold text-white tracking-tighter" href="/home">DEJA VU</a>
<div className="hidden md:flex text-sm font-medium text-neutral-300 tracking-wide gap-x-8 gap-y-8">
...
<div className="bg-gradient-to-t from-neutral-950 via-neutral-950/40 to-neutral-950/30 absolute top-0 right-0 bottom-0 left-0 shadow-lg blur-sm grayscale-0"></div>
</div>
...
<p className="md:text-base leading-relaxed text-sm text-neutral-400 max-w-md mt-4 mr-auto ml-auto animate-text-reveal">Afro/African Club Celebrating Sound, Style, And Culture. Expect The Hottest Afrobeats, Amapiano, And Dancehall, A Vibrant Crowd, And Nights That Hit So Hard They Feel Familiar</p>

...
<nav className="fixed md:px-12 flex backdrop-blur-[2px] z-50 bg-gradient-to-b to-transparent from-neutral-950/80 mix-blend-normal invisible w-full max-h-none pt-6 pr-6 pb-6 pl-6 top-0 items-center justify-between">
<a className="uppercase text-xl font-semibold tracking-tighter z-50 text-white" href="#">DEJA VU</a>
<div className="hidden md:flex gap-8 text-sm tracking-wide font-medium text-neutral-300">
<a className="transition-colors hover:text-white" href="/home">Home</a>
<a className="transition-colors hover:text-white" href="/#portfolio">Social Events</a>
<a className="transition-colors hover:text-white" href="#studio">Studio</a>
<a className="transition-colors hover:text-white" href="#contact">Become A Partner</a>
</div>
...
<div className="z-0 absolute top-0 right-0 bottom-0 left-0 gap-x-8 gap-y-8">
<img alt="Tattoo Artist Work" className="filter contrast-125 opacity-60 w-full h-full object-cover z-10 grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f2f61e32-f7d9-46ee-9655-df126da6fdd8_original.gif"/>
<div className="bg-gradient-to-t from-neutral-950 via-neutral-950/40 to-neutral-950/30 mix-blend-normal absolute top-0 right-0 bottom-0 left-0 grayscale-0"></div>
</div>
<div className="z-10 flex flex-col gap-8 text-center max-w-4xl mr-auto ml-auto pr-6 pl-6 relative gap-x-8 gap-y-8 items-center">
<p className="uppercase text-xs tracking-[0.2em] text-neutral-400"> 1 Diamond St, Aberdeen AB10 1QX</p>
<h1 className="md:text-7xl lg:text-8xl leading-[1.1] text-5xl italic tracking-tight font-serif text-white">DEJA VU </h1>
<p className="md:text-base leading-relaxed text-sm max-w-md mt-4 mr-auto ml-auto text-neutral-400">Afro/African Club Celebrating Sound, Style, And Culture. Expect The Hottest Afrobeats, Amapiano, And Dancehall, A Vibrant Crowd, And Nights That Hit So Hard They Feel Familiar.</p>
...
<section className="md:py-32 md:px-12 bg-neutral-950 z-50 pt-24 pr-6 pb-24 pl-6">
<div className="max-w-2xl mx-auto text-center space-y-8">
<svg aria-hidden="true" className="iconify mx-auto iconify--lucide text-neutral-600" data-height="24" data-icon="lucide:pen-tool" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><g className="" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z"></path><path className="" d="m18 13l-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18M2.3 2.3l7.286 7.286"></path><circle cx="11" cy="11" r="2"></circle></g></svg>
<h2 className="md:text-4xl serif leading-snug text-2xl tracking-tight text-white">"Where Sophistication Meets the Night."</h2>
...
<section className="md:px-12 pr-4 pb-24 pl-4 bg-neutral-950" id="portfolio">
<div className="flex justify-between items-end mb-12 border-b pb-6 border-neutral-900">
<h3 className="serif text-xl tracking-tight text-white">Social Events</h3>
<a className="uppercase transition-colors flex items-center gap-2 text-xs text-neutral-500 tracking-widest hover:text-white" href="/#">
...
<section className="md:px-12 border-y pt-24 pr-6 pb-24 pl-6 bg-neutral-900/30 border-neutral-900" id="process">
<div className="max-w-6xl mx-auto">
<div className="mb-16">
<h3 className="text-3xl serif tracking-tight mb-2 text-white">The Process</h3>
...
<div className="group">
<span className="block text-5xl serif group-hover:text-neutral-600 transition-colors mb-6 text-neutral-800">01</span>
<h4 className="text-lg font-medium mb-3 text-white">Afrobeat</h4>
<p className="leading-relaxed text-sm text-neutral-400" style={{}}></p>
</div>

<div className="group">
<span className="block text-5xl serif group-hover:text-neutral-600 transition-colors mb-6 text-neutral-800">02</span>
<h4 className="text-lg font-medium mb-3 text-white">R&amp;B &amp; More</h4>
<p className="leading-relaxed text-sm text-neutral-400"></p>
</div>

<div className="group">
<span className="block text-5xl serif group-hover:text-neutral-600 transition-colors mb-6 text-neutral-800">03</span>
<h4 className="text-lg font-medium mb-3 text-white">Amapiano</h4>
<p className="leading-relaxed text-sm text-neutral-400"></p>
</div>
</div>
</div>
...
<section className="md:px-12 pt-24 pr-6 pb-24 pl-6 bg-neutral-950" id="studio">
<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mr-auto ml-auto gap-x-16 gap-y-16 items-center">
<div className="overflow-hidden w-full h-[500px] border rounded-sm relative shadow-2xl bg-neutral-900 border-neutral-800">
...
<div className="absolute bottom-4 left-4 backdrop-blur-sm border px-4 py-2 rounded-sm z-10 pointer-events-none bg-neutral-950/80 border-neutral-800">
<span className="text-xs uppercase tracking-widest flex items-center gap-2 text-white">
...
<div className="">
<h3 className="serif text-3xl tracking-tight mb-4 text-white">The Club</h3>
...
<div className="p-2 rounded-full bg-neutral-900 text-neutral-300">
...
<div className="">
<h5 className="text-sm font-medium mb-1 text-white">Impeccable Hygiene</h5>
...
<section className="py-20 border-t bg-neutral-950 border-neutral-900">
<div className="max-w-4xl mx-auto px-6 text-center">
<svg aria-hidden="true" className="iconify mx-auto mb-6 iconify--lucide text-neutral-700" data-icon="lucide:quote" data-width="32" height="32" role="img" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg"><path className="" d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2a1 1 0 0 1 1 1v1a2 2 0 0 1-2 2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1a6 6 0 0 0 6-6V5a2 2 0 0 0-2-2zM5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2a1 1 0 0 1 1 1v1a2 2 0 0 1-2 2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1a6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
<p className="md:text-xl serif leading-relaxed text-lg italic mb-6 text-neutral-300">"Excellent nightlife experience in the bustling Aberdeen city centre."</p>
<p className="uppercase text-xs text-neutral-500 tracking-widest">— Taiwo A</p>
</div>
</section>

<section className="md:px-12 pt-24 pr-6 pb-24 pl-6 bg-neutral-900" id="contact">
<div className="max-w-3xl mx-auto">
<div className="text-center mb-16">
<h3 className="md:text-4xl serif text-3xl tracking-tight mb-4 text-white">GET IN TOUCH</h3>
</div>
...
<input className="w-full border text-sm p-4 rounded-sm focus:border-neutral-500 outline-none transition-colors bg-neutral-950 border-neutral-800 text-neutral-200" placeholder="Your name" type="text"/>
</div>
<div className="space-y-2">
<label className="text-xs uppercase tracking-wider text-neutral-500 font-medium">Email</label>
<input className="w-full border text-sm p-4 rounded-sm focus:border-neutral-500 outline-none transition-colors bg-neutral-950 border-neutral-800 text-neutral-200" placeholder="your@email.com" type="email"/>
</div>
</div>
...
<div className="relative border border-dashed p-8 text-center rounded-sm hover:border-neutral-500 transition-colors cursor-pointer group border-neutral-700 bg-neutral-950/50">
<svg aria-hidden="true" className="iconify mx-auto group-hover:text-neutral-400 mb-2 iconify--lucide text-neutral-600" data-icon="lucide:upload-cloud" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M12 13v8m-8-6.101A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="m8 17l4-4l4 4"></path></g></svg>
...
<button className="group relative inline-flex items-center justify-center px-8 py-4 text-sm font-medium tracking-widest uppercase border transition-all duration-300 w-full md:w-auto text-white border-neutral-700 hover:bg-white hover:text-black" type="button">
...
<p className="text-[10px] mt-4 text-neutral-600">By submitting this form, you consent to being contacted to discuss your request.</p>
</div>
</form>
</div>
</section>

<footer className="border-t pt-12 pr-6 pb-12 pl-6 bg-neutral-950 border-neutral-900">
...
<p className="text-xl tracking-tight font-serif text-white">DEJA VU.</p>
<p className="text-xs mt-1 text-neutral-600">Nightclub</p>
</div>
<div className="flex gap-x-6 gap-y-6">
<a className="transition-colors text-neutral-500 hover:text-white" href="https://www.instagram.com/dejavunightclub_?igsh=MXBwOXVkcmR6anphdA==">
...
<a className="transition-colors text-neutral-500 hover:text-white" href="https://www.facebook.com/share/18F89k5gqA/?mibextid=wwXIfr">

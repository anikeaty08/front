...
<div className="cursor" style={{left: '9px', top: '65px', background: 'white'}}></div>
<div className="cursor-follower" style={{left: '9px', top: '65px', transform: 'translate(-50%, -50%) scale(1)', borderColor: 'rgba(255, 255, 255, 0.5)'}}></div>

<canvas height="1155" id="neural-canvas" width="2960"></canvas>

<header className="fixed top-0 w-full z-50 transition-all duration-300 border-b" id="main-header">
<div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
<div className="flex items-center gap-2">
<div className="relative w-10 h-12 bg-gradient-to-b from-slate-800 to-black rounded-md border-2 border-slate-700 flex flex-col items-center justify-start pt-1.5 shadow-lg">
<div className="w-7 h-5 bg-gradient-to-tr from-blue-600 to-purple-600 rounded-sm flex items-center justify-center shadow-[0_0_8px_rgba(147,51,234,0.5)]">
<span className="text-[10px] font-['Audiowide'] text-white tracking-tighter leading-none">VV</span>
</div>
<div className="w-7 mt-1.5 flex justify-between items-center px-0.5">
<div className="w-1 h-1 bg-slate-600 rounded-full"></div>
<div className="w-3 h-0.5 bg-slate-700 rounded-full"></div>
</div>
<div className="absolute bottom-1.5 w-6 h-2 bg-slate-900 rounded-sm border border-slate-800"></div>
</div>
<a className="uppercase glitch text-xl text-white tracking-widest font-['Audiowide']" data-text="VERIFIED VENDING" href="#">VERIFIED VENDING</a>
</div>
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/20 rounded-full blur-[120px] -z-10 animate-pulse">
</div>
...
<h1 className="text-4xl md:text-6xl lg:text-7xl font-['Audiowide'] text-white tracking-tight mb-6 leading-none">
      ELIMINATING THE <br/>
<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-600" id="typed-output"></span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span><span aria-hidden="true" className="typed-cursor">_</span>
</h1>
<p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto mb-10 font-light leading-relaxed">
      Automated vending infrastructure. 100% compliant vape sales without staff intervention. Keep patrons inside and
      bar tabs open.
    </p>
...
<svg aria-hidden="true" className="iconify text-blue-400 w-5 h-5 iconify--lucide" data-icon="lucide:chevrons-down" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<div className="h-[500px] w-full glass rounded-xl relative flex items-center justify-center overflow-hidden aos-init" data-aos="fade-left">
...
<svg aria-hidden="true" className="iconify text-neutral-600 iconify--lucide" data-icon="lucide:nfc" data-width="12" height="12" role="img" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><path d="M6 8.32a7.43 7.43 0 0 1 0 7.36m3.46-9.47a11.76 11.76 0 0 1 0 11.58M12.91 4.1a15.91 15.91 0 0 1 .01 15.8M16.37 2a20.16 20.16 0 0 1 0 20" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
...
<div className="glass p-8 rounded-none border-l-2 border-l-blue-400/50 hover:border-l-blue-400 transition-all group" data-tilt="" data-tilt-glare="" data-tilt-max="10" data-tilt-max-glare="0.2" data-tilt-speed="400" style={{willChange: 'transform', transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)'}}>
<div className="w-12 h-12 bg-white/5 flex items-center justify-center mb-6 group-hover:bg-blue-400/20 transition-colors">
<svg aria-hidden="true" className="iconify text-white group-hover:text-blue-400 w-6 h-6 iconify--lucide" data-icon="lucide:scan-face" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M3 7V5a2 2 0 0 1 2-2h2m10 0h2a2 2 0 0 1 2 2v2m0 10v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2m5-3s1.5 2 4 2s4-2 4-2M9 9h.01M15 9h.01" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</div>
...
<div className="js-tilt-glare" style={{position: 'absolute', top: '0px', left: '0px', width: '100%', height: '100%', overflow: 'hidden', pointerEvents: 'none', borderRadius: 'inherit'}}><div className="js-tilt-glare-inner" style={{position: 'absolute', top: '50%', left: '50%', pointerEvents: 'none', backgroundImage: 'linear-gradient(0deg, rgba(255, 255, 255, 0) 0%, rgb(255, 255, 255) 100%)', transform: 'rotate(180deg) translate(-50%, -50%)', transformOrigin: '0% 0%', opacity: '0', width: '580px', height: '580px'}}></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div><div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div></div>

<div className="glass p-8 rounded-none border-l-2 border-l-purple-500/50 hover:border-l-purple-500 transition-all group" data-tilt="" data-tilt-glare="" data-tilt-max="10" data-tilt-max-glare="0.2" data-tilt-speed="400" style={{willChange: 'transform', transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)'}}>
<div className="w-12 h-12 bg-white/5 flex items-center justify-center mb-6 group-hover:bg-purple-500/20 transition-colors">
<svg aria-hidden="true" className="iconify text-white group-hover:text-purple-400 w-6 h-6 iconify--lucide" data-icon="lucide:ghost" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M9 10h.01M15 10h.01M12 2a8 8 0 0 0-8 8v12l3-3l2.5 2.5L12 19l2.5 2.5L17 19l3 3V10a8 8 0 0 0-8-8" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</div>
...
<div className="glass p-8 rounded-none border-l-2 border-l-green-500/50 hover:border-l-green-500 transition-all group" data-tilt="" data-tilt-glare="" data-tilt-max="10" data-tilt-max-glare="0.2" data-tilt-speed="400" style={{willChange: 'transform', transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)'}}>
<div className="w-12 h-12 bg-white/5 flex items-center justify-center mb-6 group-hover:bg-green-500/20 transition-colors">
<svg aria-hidden="true" className="iconify text-white group-hover:text-green-400 w-6 h-6 iconify--lucide" data-icon="lucide:file-check-2" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4"></path><path d="M14 2v4a2 2 0 0 0 2 2h4M3 15l2 2l4-4"></path></g></svg>
</div>
...
<div className="glass p-8 rounded-none border-l-2 border-l-cyan-500/50 hover:border-l-cyan-500 transition-all group" data-tilt="" data-tilt-glare="" data-tilt-max="10" data-tilt-max-glare="0.2" data-tilt-speed="400" style={{willChange: 'transform', transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)'}}>
<div className="w-12 h-12 bg-white/5 flex items-center justify-center mb-6 group-hover:bg-cyan-500/20 transition-colors">
<svg aria-hidden="true" className="iconify text-white group-hover:text-cyan-400 w-6 h-6 iconify--lucide" data-icon="lucide:package-check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="m16 16l2 2l4-4"></path><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14M7.5 4.27l9 5.15"></path><path d="M3.29 7L12 12l8.71-5M12 22V12"></path></g></svg>
</div>
...
<div className="lg:w-1/2 relative aos-init" data-aos="zoom-in">
...
<h2 className="text-4xl md:text-6xl font-['Audiowide'] text-white mb-8 text-glow leading-tight aos-init" data-aos="fade-up">
...
<canvas height="152" id="matrix-canvas" width="2954"></canvas>
...
<span className="text-2xl text-white font-['Audiowide']" style={{}}>VERIFIED VENDING</span>
</div>
<p className="text-xs text-gray-600 font-mono">© 2025 VERIFIED VENDING INC.</p>
</div>
<div className="flex gap-6">
<a className="hover:text-blue-400 transition-colors uppercase text-xs text-gray-500 font-mono" href="#">Privacy</a>
...
<style data-typed-js-cursor-css="true">
      ...
      </style><style data-typed-js-cursor-css="true">
        .typed-cursor{
          opacity: 1;
        }
        .typed-cursor.typed-cursor--blink{

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        // Reveal on scroll (slide/blur/fade)
      ...
      // Ensure icons render after assets load
...
<div className="absolute inset-0 bg-center bg-cover bg-fixed" style={{backgroundImage: 'url(\'https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7aa3f483-3978-4416-8322-fa9964864dcb_3840w.jpg\')'}}>
<div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-black/80"></div>
</div>
<nav className="relative z-10" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 800ms cubic-bezier(0.22, 1, 0.36, 1), filter 800ms cubic-bezier(0.22, 1, 0.36, 1), opacity 800ms cubic-bezier(0.22, 1, 0.36, 1)', willChange: 'transform, filter, opacity'}}>
<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
<div className="flex h-16 items-center justify-between">

<a className="flex items-center gap-2 group" href="#">
<span className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-white/10 ring-1 ring-white/15 backdrop-blur group-hover:bg-white/15 group-hover:ring-white/25 transition-colors">
...
<a className="px-3 py-1.5 rounded-full bg-white/5 ring-1 ring-white/15 text-sm font-medium text-white/90 hover:bg-white/10 hover:ring-white/25 transition font-geist" href="#">Discover</a>
<a className="px-3 py-1.5 rounded-full bg-white/5 ring-1 ring-white/15 text-sm font-medium text-white/70 hover:text-white/90 hover:bg-white/10 hover:ring-white/25 transition font-geist" href="#">Toolkit</a>
...
<a className="px-3 py-1.5 rounded-full bg-white/5 ring-1 ring-white/15 text-sm font-medium text-white/70 hover:text-white/90 hover:bg-white/10 hover:ring-white/25 transition font-geist" href="#">Library</a>
</div>

<div className="hidden md:flex items-center gap-3">
<a className="text-sm font-medium text-white/80 hover:text-white transition font-geist" href="#">Sign in</a>
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-4 py-2 text-sm font-semibold hover:bg-white/90 hover:shadow-sm hover:-translate-y-0.5 transition font-geist" href="#">Get started</a>
</div>

<button aria-expanded="false" aria-label="Open menu" className="md:hidden inline-flex h-9 w-9 items-center justify-center rounded-md bg-white/10 ring-1 ring-white/15 hover:bg-white/15 transition" id="menuBtn">
<svg className="lucide lucide-menu h-5 w-5 text-white/90" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><line x1="4" x2="20" y1="12" y2="12"></line><line x1="4" x2="20" y1="6" y2="6"></line><line x1="4" x2="20" y1="18" y2="18"></line></svg>
</button>
</div>
...
<a className="px-3 py-2 rounded-lg bg-white/5 ring-1 ring-white/10 text-sm font-medium text-white/80 font-geist hover:bg-white/10 hover:text-white/90 hover:ring-white/20 transition" href="#">Journal</a>
<a className="px-3 py-2 rounded-lg bg-white/5 ring-1 ring-white/10 text-sm font-medium text-white/80 font-geist hover:bg-white/10 hover:text-white/90 hover:ring-white/20 transition" href="#">Library</a>
<div className="flex items-center justify-between gap-2 pt-2">
<a className="text-sm font-medium text-white/80 font-geist hover:text-white" href="#">Sign in</a>
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-4 py-2 text-sm font-semibold hover:bg-white/90 hover:-translate-y-0.5 transition font-geist" href="#">
...
<div className="sm:px-6 lg:px-8 sm:pt-24 lg:pt-28 lg:pb-40 text-center max-w-5xl mr-auto ml-auto pt-24 pr-4 pb-40 pl-4">
<div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 ring-1 ring-white/20 backdrop-blur" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
...
<h1 className="mt-6 text-4xl sm:text-5xl lg:text-7xl text-white font-geist font-light tracking-tighter" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 1000ms cubic-bezier(0.22, 1, 0.36, 1), filter 1000ms cubic-bezier(0.22, 1, 0.36, 1), opacity 1000ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
            Go anywhere, effortlessly.
          </h1>
<p className="mx-auto mt-4 max-w-3xl text-base sm:text-lg text-white/80 font-geist" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 1000ms cubic-bezier(0.22, 1, 0.36, 1) 80ms, filter 1000ms cubic-bezier(0.22, 1, 0.36, 1) 80ms, opacity 1000ms cubic-bezier(0.22, 1, 0.36, 1) 80ms'}}>
...
<div className="flex gap-3 mt-[300px] gap-x-3 gap-y-3 items-center justify-center" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 1000ms cubic-bezier(0.22, 1, 0.36, 1) 120ms, filter 1000ms cubic-bezier(0.22, 1, 0.36, 1) 120ms, opacity 1000ms cubic-bezier(0.22, 1, 0.36, 1) 120ms'}}>
<a className="inline-flex items-center gap-2 rounded-full bg-white text-gray-900 px-5 py-3 text-sm sm:text-base font-semibold transition font-geist hover:bg-white/90 hover:-translate-y-0.5 hover:shadow" href="#">
              Plan my trip
...
<a className="inline-flex items-center gap-2 sm:text-base hover:bg-white/15 hover:ring-white/25 transition text-sm font-medium text-white font-geist bg-white/10 ring-white/15 ring-1 rounded-full pt-3 pr-5 pb-3 pl-5 backdrop-blur" href="#">
              See how it works
...
<div className="flex gap-2 text-xs text-white/60 mt-8 gap-x-2 gap-y-2 items-center justify-center" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1) 160ms, filter 900ms cubic-bezier(0.22, 1, 0.36, 1) 160ms, opacity 900ms cubic-bezier(0.22, 1, 0.36, 1) 160ms'}}>
...
<section aria-label="Popular destinations" className="relative z-10 -mt-10 sm:-mt-16">
<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
<div className="rounded-2xl ring-1 ring-white/10 bg-white/5 backdrop-blur overflow-hidden" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 800ms cubic-bezier(0.22, 1, 0.36, 1), filter 800ms cubic-bezier(0.22, 1, 0.36, 1), opacity 800ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="flex items-center gap-2 px-4 py-2 text-xs text-white/70">
...
<span className="font-geist">Trending now</span>
</div>
...
<section className="z-10 -mt-12 -top-20 pb-24 relative">
<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
<div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4 backdrop-blur hover:bg-white/[0.08] hover:ring-white/20 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 800ms cubic-bezier(0.22, 1, 0.36, 1), filter 800ms cubic-bezier(0.22, 1, 0.36, 1), opacity 800ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
...
<div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4 backdrop-blur hover:bg-white/[0.08] hover:ring-white/20 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 850ms cubic-bezier(0.22, 1, 0.36, 1), filter 850ms cubic-bezier(0.22, 1, 0.36, 1), opacity 850ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="flex gap-3 items-start">
<span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 ring-1 ring-white/15">
<svg className="lucide lucide-clock h-4 w-4 text-white/90" data-lucide="clock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
</span>
<div className="">
...
<div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-4 backdrop-blur hover:bg-white/[0.08] hover:ring-white/20 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="flex gap-3 items-start">
<span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 ring-1 ring-white/15">
...
<div className="ring-1 ring-white/10 bg-white/5 rounded-2xl p-4 backdrop-blur hover:bg-white/[0.08] hover:ring-white/20 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 950ms cubic-bezier(0.22, 1, 0.36, 1), filter 950ms cubic-bezier(0.22, 1, 0.36, 1), opacity 950ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="flex gap-3 items-start">
<span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 ring-1 ring-white/15">
...
<section className="sm:p-8 bg-white/5 ring-1 ring-white/10 backdrop-blur rounded-3xl mx-8 pt-6 pr-6 pb-6 pl-6" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
...
<article className="sm:p-6 flex flex-col min-h-[420px] bg-white/10 ring-1 ring-white/15 backdrop-blur rounded-2xl p-5 justify-between hover:ring-white/25 hover:bg-white/15 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
...
<svg className="lucide lucide-clock h-4 w-4" data-lucide="clock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
...
<article className="sm:p-6 flex flex-col min-h-[420px] bg-white/10 ring-1 ring-white/15 backdrop-blur rounded-2xl p-5 justify-between hover:ring-white/25 hover:bg-white/15 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 950ms cubic-bezier(0.22, 1, 0.36, 1), filter 950ms cubic-bezier(0.22, 1, 0.36, 1), opacity 950ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="space-y-5">
<div className="flex items-center gap-3">
<div className="h-12 w-12 rounded-full bg-white/20 ring-1 ring-white/25 flex items-center justify-center">
...
<article className="sm:p-6 flex flex-col min-h-[420px] bg-white/10 ring-1 ring-white/15 backdrop-blur rounded-2xl p-5 justify-between hover:ring-white/25 hover:bg-white/15 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 1000ms cubic-bezier(0.22, 1, 0.36, 1), filter 1000ms cubic-bezier(0.22, 1, 0.36, 1), opacity 1000ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="space-y-5">
<div className="flex items-center gap-3">
<div className="h-12 w-12 rounded-full bg-white/20 ring-1 ring-white/25 flex items-center justify-center">
...
<article className="sm:p-6 flex flex-col min-h-[420px] bg-white/10 ring-1 ring-white/15 backdrop-blur rounded-2xl p-5 justify-between hover:ring-white/25 hover:bg-white/15 transition" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 1050ms cubic-bezier(0.22, 1, 0.36, 1), filter 1050ms cubic-bezier(0.22, 1, 0.36, 1), opacity 1050ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="space-y-5">
<div className="flex items-center gap-3">
<div className="h-12 w-12 rounded-full bg-white/20 ring-1 ring-white/25 flex items-center justify-center">
...
<div className="mt-8 text-center" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<button className="inline-flex hover:bg-white/90 hover:-translate-y-0.5 hover:shadow transition cursor-pointer text-sm font-semibold text-neutral-900 font-geist bg-white rounded-full pt-3 pr-6 pb-3 pl-6 gap-x-2 gap-y-2 items-center" onclick="window.location.href='/beacons.ai/dbcreations';window.location.href='/beacons.ai/dbcreations'" role="button">
<svg className="lucide lucide-play h-4 w-4" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><polygon points="6 3 20 12 6 21 6 3"></polygon></svg>
          Begin your journey
        </button>
...
<section className="max-w-7xl sm:px-6 sm:mt-20 mr-auto mb-24 ml-auto pr-4 pl-4" data-reveal="" id="faq" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<div className="relative overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur">
<div className="relative sm:p-8 p-6">
<div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">

<div className="md:col-span-5" data-reveal="" style={{transform: 'translateY(0px)', filter: 'blur(0px)', opacity: '1', transition: 'transform 900ms cubic-bezier(0.22, 1, 0.36, 1), filter 900ms cubic-bezier(0.22, 1, 0.36, 1), opacity 900ms cubic-bezier(0.22, 1, 0.36, 1)'}}>
<h2 className="text-[56px] sm:text-[80px] leading-none font-semibold text-white tracking-tighter font-geist">Questions.</h2>
<p className="mt-3 text-sm sm:text-base text-white/80 font-geist">Find answers to common questions about NomadIQ, our adaptive trip planning, and how we can help craft your perfect journey.</p>
<a className="mt-5 inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-sm font-medium tracking-tight text-white/90 bg-white/10 hover:bg-white/15 ring-1 ring-white/15 hover:ring-white/25 backdrop-blur transition" href="#contact">
...
<div className="rounded-2xl ring-1 ring-white/10 bg-white/5 backdrop-blur" data-accordion-item="" data-open="">
<button aria-expanded="true" className="w-full flex items-center justify-between gap-4 p-5 text-left hover:bg-white/10 transition" data-accordion="faq" type="button">
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist" data-qa="a">NomadIQ analyzes your pace, interests, and past choices to understand your travel rhythm. It starts with a brief onboarding questionnaire, then refines suggestions based on your feedback and interactions. The more you use it, the better it gets at matching your vibe.</div>
</div>

<div className="rounded-2xl ring-1 ring-white/10 bg-white/5 backdrop-blur" data-accordion-item="">
<button aria-expanded="false" className="w-full flex items-center justify-between gap-4 p-5 text-left hover:bg-white/10 transition" data-accordion="faq" type="button">
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist hidden" data-qa="a">Absolutely. NomadIQ can balance different group preferences and find activities that work for everyone. You can share planning responsibilities, vote on options, and create itineraries that keep the whole group happy without the usual coordination headaches.</div>
</div>
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist hidden" data-qa="a">That's where NomadIQ shines. It adapts in real-time to weather changes, crowds, closures, or simply if you're feeling spontaneous. Tap "replan" and it'll instantly suggest alternatives that fit your current mood and location. Flexibility is built into every suggestion.</div>
</div>
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist hidden" data-qa="a">Core features work offline once your trip is downloaded. You'll have access to your itinerary, maps, saved places, and emergency contacts. Real-time updates and new suggestions require connection, but you won't be stranded without your plans.</div>
</div>
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist hidden" data-qa="a">Set your budget range and NomadIQ finds the sweet spots—great experiences that won't break the bank. It tracks pricing patterns, suggests optimal timing for bookings, and balances splurges with savings so you get maximum value from every trip dollar.</div>
</div>
...
<div className="px-5 pb-5 text-sm text-white/70 font-geist hidden" data-qa="a">Most planners give you lists and leave you to figure it out. NomadIQ understands your personal travel rhythm and creates experiences that feel natural to you. It's adaptive, intuitive, and privacy-focused—your data never leaves your device unless you choose to share it.</div>
</div>
</div>
</div>
</div>
...
<input className="mt-1 w-full pl-3 pr-3 py-2.5 text-sm rounded-xl ring-1 ring-black/10 focus:ring-2 focus:ring-neutral-900 outline-none bg-white placeholder:text-neutral-400 font-geist transition" id="ct-name" name="name" placeholder="Jane Doe" required="" type="text"/>
</div>
<div>
...
<input className="w-full pl-9 pr-3 py-2.5 text-sm rounded-xl ring-1 ring-black/10 focus:ring-2 focus:ring-neutral-900 outline-none bg-white placeholder:text-neutral-400 font-geist transition" id="ct-email" name="email" placeholder="you@example.com" required="" type="email"/>
</div>
</div>
<div>
<label className="block text-xs text-neutral-600 font-geist" htmlFor="ct-msg">Message</label>
<textarea className="mt-1 w-full resize-y pl-3 pr-3 py-2.5 text-sm rounded-xl ring-1 ring-black/10 focus:ring-2 focus:ring-neutral-900 outline-none bg-white placeholder:text-neutral-400 font-geist transition" id="ct-msg" name="message" placeholder="How can we help?" rows="4"></textarea>
</div>
<button className="w-full inline-flex items-center justify-center rounded-xl bg-neutral-900 text-white px-4 py-3 text-sm font-semibold hover:bg-neutral-800 hover:-translate-y-0.5 hover:shadow transition-colors font-geist" type="submit">
                      Send message
...
<svg className="lucide lucide-clock-3 h-4 w-4" data-lucide="clock-3" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16.5 12"></polyline></svg>
</div>
<div>
...
<a className="ml-1 inline-flex items-center gap-2 rounded-xl bg-neutral-900 text-white px-3 py-2 text-xs font-semibold hover:bg-neutral-800 hover:-translate-y-0.5 transition-colors font-geist" href="mailto:hello@nomadiq.com">
                      Ask directly
                      <svg className="lucide lucide-message-circle h-3.5 w-3.5" data-lucide="message-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"></path></svg>
</a>
</div>
</div>
</div>
...
<img alt="Temple" className="rounded-xl ring-1 ring-white/10 hover:ring-white/25 transition" src="https://images.unsplash.com/photo-1530648672449-81f6c723e2f1?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
</div>
</div>
</div>
...
<p className="text-sm text-white/60 leading-relaxed mb-8 font-geist">Adaptive trip planning that learns your travel rhythm. Go anywhere, effortlessly, with journeys crafted just for you.</p>
...
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">AI Trip Planning</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Smart Routing</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Budget Optimization</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Real-time Updates</a></li>
</ul>
</div>
<div>
<h4 className="text-sm font-medium text-white mb-6 uppercase tracking-wide font-geist">Toolkit</h4>
<ul className="space-y-4">
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Trip Builder</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Travel Journal</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Offline Maps</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Group Planning</a></li>
</ul>
</div>
<div>
...
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Contact Us</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Community</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-300 font-geist" href="#">Travel Resources</a></li>
</ul>
</div>
</div>
...
<div <div="" className="flex flex-wrap items-center gap-4 text-xs text-white/40">
<span className="inline-flex items-center gap-2">
<span className="h-1.5 w-1.5 rounded-full bg-emerald-400"></span>
              All systems normal
            </span>
<span className="hidden sm:inline-block h-4 w-px bg-white/10"></span>
<a className="inline-flex items-center gap-2 hover:text-white/60 transition-colors font-geist" href="#">

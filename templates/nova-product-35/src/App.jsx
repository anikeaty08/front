...
<div className="aura-background-component -z-10 w-full absolute top-0 h-[760px]" data-alpha-mask="80" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}>
...
<a className="text-xl font-bold tracking-tight text-white font-sans" href="#">
            Aeterna
          </a>
...
<a className="hover:text-white text-sm font-medium text-zinc-300 pt-2 pr-3 pb-2 pl-3" href="#">
              Vision
            </a>
<a className="px-3 py-2 text-sm font-medium text-zinc-300 hover:text-white" href="#">
              The Problem
            </a>
<a className="px-3 py-2 text-sm font-medium text-zinc-300 hover:text-white" href="#">
              How it Works
...
<svg className="lucide lucide-user-plus h-4 w-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
<circle cx="9" cy="7" r="4"></circle>
<line x1="19" x2="19" y1="8" y2="14"></line>
<line x1="22" x2="16" y1="11" y2="11"></line>
</svg>
<span className="">Get Whitelisted</span>
</span>
</button>
</div>
</div>
...
<svg className="lucide lucide-flask-conical h-3.5 w-3.5 text-violet-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<span className="block bg-clip-text text-8xl font-semibold text-transparent tracking-tight bg-gradient-to-r from-[#d8ccff] to-[#a39fea] pt-0 pb-3" style={{maskImage: 'linear-gradient(140deg, transparent, black 10%, black 65%, transparent)', WebkitMaskImage: 'linear-gradient(140deg, transparent, black 10%, black 65%, transparent)'}}>
            Legacy, reimagined as conversation.
          </span>
<p className="sm:text-lg text-base text-purple-300 bg-gray-950/50 max-w-2xl mt-0 pt-2 pr-4 pb-2 pl-4 drop-shadow-lg" style={{maskImage: 'linear-gradient(180deg, transparent, black 25%, black 70%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 25%, black 70%, transparent)'}}>
            Aeterna is an early-stage concept for a legacy archive that could
            capture voice, tone, and real-life stories—then let future
            generations interact with them through a private, family-owned
            interface.
          </p>
...
<svg className="lucide lucide-mail h-4 w-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-zinc-200 backdrop-blur">
<span className="w-2 h-2 rounded-full bg-red-400"></span>
                The Problem
              </div>
<h2 className="text-2xl font-semibold text-white tracking-tight">
                What gets lost after we’re gone
              </h2>
<p className="text-zinc-400 leading-relaxed">
                Wills preserve assets, not presence. Most families have
                thousands of photos but very few hours of meaningful recorded
                conversation. When people perform for the camera, authenticity
                disappears.
              </p>
</div>
<div className="space-y-4">
...
<h2 className="text-2xl font-semibold text-white tracking-tight">
                A legacy that feels like a conversation
              </h2>
<p className="text-zinc-400 leading-relaxed">
                Combine structured storytelling with gentle guided reflection.
                Aeterna aims to build an interactive archive that holds not just
                facts, but cadence, humor, and emotional context.
              </p>
</div>
</div>
...
<nav aria-label="Primary" className="hidden sm:flex flex-col z-10 w-16 border-slate-50/0 ring-white/10 ring-1 border-r pt-4 pr-2 pb-4 pl-2 absolute top-0 bottom-0 left-0 backdrop-blur items-center justify-between">
<div className="flex flex-col gap-4 items-center">
<button className="h-10 w-10 rounded-xl bg-white/5 ring-1 ring-white/10 text-slate-400 flex items-center justify-center" title="Passive Capture">
<svg className="lucide lucide-mic h-5 w-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"></path>
<path d="M19 10v2a7 7 0 0 1-14 0v-2"></path>
<line x1="12" x2="12" y1="19" y2="22"></line>
</svg>
</button>
<button className="h-10 w-10 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-700 ring-1 ring-white/20 shadow-lg text-white flex items-center justify-center" title="Active Calibration">
<svg className="lucide lucide-message-circle-heart h-5 w-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<button className="h-10 w-10 rounded-xl bg-white/5 ring-1 ring-white/10 text-slate-400 flex items-center justify-center" title="Synthesis">
<svg className="lucide lucide-sparkles h-5 w-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="h-8 w-8 rounded-full bg-slate-500/20 ring-1 ring-white/10"></div>
</div>
</nav>
<div className="sm:pl-16 p-8 h-full flex flex-col justify-center">
...
<div className="text-xs text-zinc-400 border border-white/10 rounded-full px-3 py-1">
                  Step 2: Active Calibration
                </div>
</div>
<div className="max-w-2xl mx-auto w-full space-y-6">
<div className="flex gap-4">
<div className="w-10 h-10 rounded-full bg-indigo-500/20 flex items-center justify-center ring-1 ring-indigo-500/30">
<svg className="w-5 h-5 text-indigo-300" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
<div className="flex-1 bg-white/5 rounded-2xl rounded-tl-none p-4 ring-1 ring-white/10">
<p className="text-zinc-200 text-sm">
                      I noticed you paused when you mentioned 1998. That seemed
                      like a heavy year. Do you want to share what came up for
                      you?
                    </p>
</div>
</div>
...
<div className="flex-1 bg-violet-600/20 rounded-2xl rounded-tr-none p-4 ring-1 ring-violet-500/30">
<div className="flex gap-1 mb-2">
<span className="w-1 h-4 bg-violet-400 rounded-full animate-pulse"></span>
<span className="w-1 h-3 bg-violet-400/50 rounded-full"></span>
<span className="w-1 h-5 bg-violet-400/80 rounded-full"></span>
<span className="w-1 h-2 bg-violet-400/40 rounded-full"></span>
</div>
<p className="text-violet-100 text-sm">
                      That was the year we sold the house... honestly, I haven't
                      thought about the day we packed the truck in twenty years.
                    </p>
</div>
</div>
<div className="flex justify-center pt-4">
<button className="text-xs text-zinc-500 hover:text-zinc-300 flex items-center gap-2">
...
<svg className="h-3.5 w-3.5 text-violet-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="mt-3 text-base text-zinc-300">
            Concepts for a future where memory is active, not passive.
          </p>
</div>
...
<div className="h-full bg-violet-500 w-[88%]"></div>
</div>
<div className="flex justify-between text-xs text-zinc-300">
...
<div className="h-1.5 bg-zinc-800 rounded-full overflow-hidden">
<div className="h-full bg-zinc-600 w-[12%]"></div>
</div>
<div className="mt-2 p-2 bg-violet-500/10 border border-violet-500/20 rounded text-xs text-violet-200 text-center">
                        "Tell us a joke from your childhood?"
                      </div>
</div>
</div>
</div>
...
<svg className="lucide lucide-map h-5 w-5 text-violet-300" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-sm leading-relaxed text-neutral-300" style={{}}>
                  Turn legacy-building into a gentle game. The system identifies
                  gaps in your timeline and suggests what’s missing so the
                  archive feels complete.
                </p>
...
<svg className="lucide lucide-gantt-chart h-3.5 w-3.5" data-lucide="gantt-chart" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M6 5h12"></path>
...
<svg className="lucide lucide-calendar-range h-3.5 w-3.5" data-lucide="calendar-range" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-users h-3.5 w-3.5 text-indigo-300" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
...
<div className="flex text-xs font-semibold text-white bg-slate-50/5 w-6 h-6 rounded-full items-center justify-center">
                          S
                        </div>
...
<svg className="lucide lucide-radio h-3.5 w-3.5 text-emerald-300" data-lucide="radio" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-[13px] text-neutral-400" style={{}}>
...
<svg className="lucide lucide-sparkles w-5 h-5 text-white/80" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-zap w-5 h-5" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-lightbulb mt-0.5 w-[24px] h-[24px] text-[#ffffff]/60" data-icon-replaced="true" data-lucide="lightbulb" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '24px', height: '24px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-sm text-white/90 font-medium">
                        Analyzed backlog:
                        <span className="text-white">43 items</span>
</p>
<p className="text-[13px] text-white/60">
                        Grouped by priority and complexity
                      </p>
</div>
</div>
...
<svg className="lucide lucide-target w-5 h-5 text-white/70" data-lucide="target" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10"></circle>
...
<svg className="lucide lucide-check-circle w-5 h-5 text-emerald-400" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="text-center mb-16">
<div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-zinc-200 backdrop-blur mb-6">
<svg className="h-3.5 w-3.5 text-emerald-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path>
</svg>
            Trust &amp; Safety
          </div>
<h2 className="sm:text-4xl text-3xl font-semibold text-white tracking-tight">
            Private by design. Sovereign by default.
          </h2>
<p className="mt-3 text-base text-zinc-300">
            The 2026 Standard for privacy-first AI.
          </p>
</div>
...
<svg className="w-[24px] h-[24px] text-slate-400" data-icon-replaced="true" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '24px', height: '24px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
<path className="" d="m9 11 3 3L22 4"></path>
</svg>
                  Connected
                </span>
</div>
...
<p className="mt-1 text-sm text-zinc-400 relative z-10">
                Your archive data is never used to train general-purpose models.
                It stays yours.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
<div className="flex -space-x-2">
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d74688b7-be82-48a3-9cec-f76b3dab7664_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7468f79a-0c70-4144-876e-c2b1838fef60_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1c97346f-367a-4525-88c9-983c427260ae_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
</div>
...
<path className="" d="M12 17.5V22"></path>
<path className="" d="M3.27 6.96 8 12.01 8 17"></path>
<path className="" d="M12 17.5V12l-5-3"></path>
</svg>
</div>
...
<p className="mt-1 text-sm text-zinc-400 relative z-10">
                Clear recording indicators and a 'review-before-save' flow
                ensure no surprises.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
<div className="flex -space-x-2">
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/15654b26-7c5f-4651-ba85-3a208a386304_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9fe835bd-f1a4-4aed-ade9-38038cdd0542_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
</div>
...
<path className="" d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z"></path>
...
<h3 className="z-10 text-lg font-semibold text-white tracking-tight mt-4 relative">
                Family-Controlled Keys
              </h3>
<p className="mt-1 text-sm text-zinc-400 relative z-10">
                Deletion and access rights are governed by designated
                custodians, not us.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
<div className="flex -space-x-2">
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8e2b95ff-a165-434a-bdc9-cdb963c750e9_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ce224171-c77b-4f9d-bcb4-78d291d25746_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ed0e64fa-763f-438b-9101-248ccb06c3b0_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
</div>
...
<p className="z-10 text-sm text-zinc-400 mt-1 relative">
                We encrypt data as early as possible in the pipeline, often
                right on the device.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
<div className="flex -space-x-2">
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5ad0226f-b99c-4dd2-af42-ef28d1218fc2_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f6b5dd2c-270e-4d8c-999d-e80c1fd8ce4f_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
</div>
...
<div className="flex items-start justify-between relative z-10">
<div className="flex w-12 h-12 rounded-xl items-center justify-center">
<svg className="text-slate-400 w-[24px] h-[24px]" data-icon-replaced="true" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '24px', height: '24px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M20 7h-9"></path>
<path className="" d="M14 17H5"></path>
<circle className="" cx="17" cy="17" r="3"></circle>
<circle className="" cx="7" cy="7" r="3"></circle>
</svg>
</div>
<span className="inline-flex items-center gap-1.5 rounded-md bg-zinc-400/10 px-2 py-1 text-xs text-zinc-300 ring-1 ring-zinc-400/20">
                  Available
...
<p className="mt-1 text-sm text-zinc-400 relative z-10">
                Identity misuse safeguards, access logging, and impersonation
                boundaries.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
<div className="flex -space-x-2">
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c61ae90a-e493-4cce-bea2-a162a411950f_320w.webp)] bg-cover bg-center ring-zinc-900 ring-2 rounded-full"></div>
<div className="w-6 h-6 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e6dafb6e-9b5b-48fb-91ee-fc60ed98224a_320w.webp)] bg-cover bg-center rounded-full ring-zinc-900 ring-2"></div>
</div>
...
<p className="mt-1 text-sm text-zinc-400 relative z-10">
                Transparent dashboards showing exactly who has keys, custodian
                rights, and export access.
              </p>
<div className="flex gap-2 z-10 mt-4 relative items-center">
...
<span className="block bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-indigo-600 pt-0 pb-3">
                Why now.
              </span>
</h1>
<div className="mt-6 flex items-center gap-4 text-sm text-slate-300" style={{}}>
<div className="flex items-center gap-2 font-sans">
<svg className="lucide lucide-users h-4 w-4 text-violet-300" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
<path d="M16 3.128a4 4 0 0 1 0 7.744"></path>
<path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
<circle cx="9" cy="7" r="4"></circle>
...
<div className="flex items-center gap-2 font-sans">
<svg className="lucide lucide-shield-check h-4 w-4 text-violet-300" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path>
...
<p className="text-base leading-relaxed text-slate-300 font-sans" style={{}}>
              Aging populations and the 'silver economy' need dignified, simple
              tech. Families want meaning, not just storage. We are validating
              demand signals, consent UX, and feasibility in our upcoming
              cohort.
            </p>
<div className="mt-6 flex items-center gap-3">
<button className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-medium text-zinc-200 hover:bg-white/5 border border-white/10" style={{}}>
                Watch demo
                <svg className="lucide lucide-play h-4 w-4" data-lucide="play" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<span className="inline-flex items-center rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-medium text-slate-200 font-sans" style={{}}>
                Validation
              </span>
</div>
<h3 className="mt-4 text-xl font-semibold tracking-tight text-white font-sans">
              Demand Signals
            </h3>
<p className="text-sm text-slate-300 mt-1" style={{}}>
              Engaging HNW families, estate planners, and retirement communities
              to understand legacy needs.
            </p>
<div className="mt-4 overflow-hidden rounded-2xl">
<img alt="planning board" className="aspect-[3/4] w-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/29dd441c-b152-4b38-9344-09c4c69cf4d3_800w.webp"/>
</div>
</article>
<article className="relative overflow-hidden ring-1 ring-white/10 bg-white/5 rounded-3xl p-4 shadow-sm backdrop-blur" style={{}}>
<div className="flex items-start justify-between">
...
<svg className="lucide lucide-users h-4 w-4" data-lucide="users" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
<path d="M16 3.128a4 4 0 0 1 0 7.744"></path>
<path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
<circle cx="9" cy="7" r="4"></circle>
...
<p className="text-sm text-slate-300 mt-1" style={{}}>
              Designing interfaces that make 'opting in' to voice capture feel
              safe, transparent, and reversible.
            </p>
<div className="mt-4 overflow-hidden rounded-2xl">
<img alt="team working" className="aspect-[3/4] w-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4affdc79-17b4-44eb-bcc9-3e1e2650e990_800w.webp"/>
</div>
</article>
<article className="relative overflow-hidden ring-1 ring-white/10 bg-white/5 rounded-3xl p-4 shadow-sm backdrop-blur" style={{}}>
<div className="flex items-start justify-between">
...
<button aria-label="Open" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-200 hover:bg-white/10" style={{}}>
<svg className="lucide lucide-trending-up h-4 w-4" data-lucide="trending-up" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="mt-1 text-sm text-slate-300 font-sans" style={{}}>
              Structuring a 30-50 user trial to test on-device privacy
              architecture and emotional resonance.
            </p>
<div className="mt-4 overflow-hidden rounded-2xl">
<img alt="analytics" className="aspect-[3/4] w-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8da12aa0-5f07-423e-a3f5-4f8d175fe2a5_1600w.webp"/>
</div>
</article>
</div>
</div>
...
<p className="mt-3 text-base text-zinc-300">
            We aren't launching blindly. We're listening first.
          </p>
</div>
...
<p className="mt-2 text-sm text-zinc-400">
                  "Clients constantly ask for ways to pass down more than just
                  assets. The emotional legacy is the missing piece."
                </p>
<div className="mt-4 flex items-center gap-3">
<div className="w-8 h-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/029a3dbc-6c87-4223-b3c1-e98710044e50_320w.webp)] bg-cover bg-center rounded-full"></div>
<div className="">
<p className="text-sm font-medium text-white">
                      Advisory Board Member
                    </p>
<p className="text-xs text-zinc-400">Wealth Management</p>
</div>
</div>
</div>
</div>
...
<p className="mt-2 text-sm text-zinc-400">
                  "We have the photos, but I forgot how his laugh sounded.
                  Aeterna's concept of 'passive capture' resonates deeply."
                </p>
<div className="mt-4 flex items-center gap-3">
<div className="bg-center w-8 h-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e922b9a1-2ac4-4361-a852-37eedd0618d4_320w.webp)] bg-cover rounded-full"></div>
<div className="">
<p className="text-sm font-medium text-white">
                      Pilot Participant
                    </p>
<p className="text-xs text-zinc-400">Potential User</p>
</div>
</div>
</div>
</div>
...
<p className="mt-2 text-sm text-zinc-400">
                  "The shift to small-model, on-device AI makes this feasible in
                  a way that wasn't possible two years ago."
                </p>
<div className="mt-4 flex items-center gap-3">
<div className="w-8 h-8 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5225bc30-0a01-41cb-a743-72d80d0ebc8b_320w.webp)] bg-cover bg-center rounded-full"></div>
<div className="">
<p className="text-sm font-medium text-white">Tech Lead</p>
<p className="text-xs text-zinc-400">Privacy Architecture</p>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-white">
            Help shape the first truly human legacy archive.
          </h2>
<p className="mt-2 text-zinc-300" style={{}}>
            Join the waitlist to get updates on our progress and cohort trials.
          </p>
...
<a className="inline-flex items-center gap-2 shadow-violet-900/25 text-sm font-semibold text-white bg-gradient-to-br from-violet-500 to-indigo-600 rounded-full pt-2.5 pr-5 pb-2.5 pl-5 shadow-lg transform-gpu transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_12px_24px_-6px_rgba(139,92,246,0.4)] hover:scale-[1.02] active:scale-[0.98] active:duration-75" href="#" style={{}}>
              Get Whitelisted
              <svg className="lucide lucide-arrow-right h-4 w-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14"></path>
<path d="m12 5 7 7-7 7"></path>
</svg>
</a>
...
<span className="text-sm font-medium text-zinc-300" style={{}}>
              © 2025 Aeterna. Concept-stage. Privacy-first by principle.
            </span>
</div>

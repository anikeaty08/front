...
<a className="inline-flex items-center justify-center bg-center w-[60px] h-[32px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b4813fce-7965-4388-954a-d2c706afcb91_800w.png)] bg-cover rounded-none" href="/home"></a>
...
<a className="text-sm font-medium text-white pt-2 pr-3 pb-2 pl-3" href="#">核心能力</a>
<a className="hover:text-white text-sm font-medium text-zinc-300 pt-2 pr-3 pb-2 pl-3" href="#">核心产品</a>
<a className="hover:text-white text-sm font-medium text-zinc-300 pt-2 pr-3 pb-2 pl-3" href="#">资讯中心</a>
<a className="hover:text-white text-sm font-medium text-zinc-300 pt-2 pr-3 pb-2 pl-3" href="#">加入我们</a>
<a className="hover:text-white text-sm font-medium text-zinc-300 pt-2 pr-3 pb-2 pl-3" href="#">关于我们</a>
</nav>
...
<h1 className="block bg-clip-text text-8xl font-semibold text-transparent tracking-tight bg-gradient-to-br from-[#ffffff] to-[#ffffff] pt-6 pb-3" style={{maskImage: 'linear-gradient(140deg, transparent, black 10%, black 65%, transparent)', WebkitMaskImage: 'linear-gradient(140deg, transparent, black 10%, black 65%, transparent)'}}>
        数智引领 材料创造</h1>
<p className="sm:text-3xl text-base text-slate-50 bg-gray-950/50 max-w-5xl mt-0 pt-2 pr-0 pb-2 pl-0 drop-shadow-lg" style={{maskImage: 'linear-gradient(180deg, transparent, black 25%, black 70%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 25%, black 70%, transparent)'}}>
        实现产业端全局数字价值提升，打通AI在工业场景应用的最后一公里</p>
</div>

<div className="sm:mt-16 mt-16 relative">

<section className="supports-[backdrop-filter]:bg-white/5 overflow-hidden text-white bg-white/5 border-slate-50/10 border rounded-2xl ring-white/10 ring-1 mt-24 relative backdrop-blur-xl">
...
<svg className="lucide lucide-target h-4 w-4" data-lucide="target" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-2 text-slate-400" style={{}}>
<svg className="lucide lucide-check-circle h-4 w-4 text-slate-400" data-lucide="check-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-2 text-slate-400" style={{}}>
<svg className="lucide lucide-users h-4 w-4" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-github h-4 w-4 text-white" data-lucide="github" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-figma h-4 w-4 text-white" data-lucide="figma" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-zap h-4 w-4 text-zinc-400" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center justify-between px-4 py-3 rounded-lg bg-white/5 ring-1 ring-white/10" style={{}}>
<div className="flex items-center gap-3">
<svg className="lucide lucide-activity h-4 w-4 text-zinc-400" data-lucide="activity" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-settings mr-2 h-4 w-4" data-lucide="settings" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"></path><circle className="" cx="12" cy="12" r="3"></circle></svg>
                      Permissions
                    </button>
</div>
</div>
...
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
<div className="w-10 h-10 rounded-lg bg-white/5 ring-1 ring-white/10 flex items-center justify-center text-zinc-400">
<svg className="w-5 h-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M18 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3H6a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3V6a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 3 3 0 0 0-3-3z"></path></svg>
</div>
</div>
<div>
<h3 className="text-white font-medium">Command Menu</h3>
<p className="text-sm text-zinc-400 mt-1">Access any feature or document instantly with Cmd+K. Navigate your workspace without lifting your hands.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
<div className="w-10 h-10 rounded-lg bg-white/5 ring-1 ring-white/10 flex items-center justify-center text-zinc-400">
<svg className="w-5 h-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20" x="2" y="4"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
</div>
</div>
<div className="">
<h3 className="text-white font-medium">Inbox &amp; Notifications</h3>
<p className="text-sm text-zinc-400 mt-1">Stay updated with a consolidated inbox. Filter by mentions, assignments, or project updates.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
...
<div>
<h3 className="text-white font-medium">Custom Workflows</h3>
<p className="text-sm text-zinc-400 mt-1">Define custom states and automations. Adapt the tool to match your team's unique process.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
...
<p className="text-sm text-zinc-400 mt-1">Contextual comments on every issue. Keep the conversation right where the work happens.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
<div className="w-10 h-10 rounded-lg bg-white/5 ring-1 ring-white/10 flex items-center justify-center text-zinc-400">
<svg className="w-5 h-5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="18" rx="2" width="18" x="3" y="3"></rect><path d="M15 3v18"></path><path d="m8 9 3 3-3 3"></path></svg>
</div>
</div>
<div>
<h3 className="text-white font-medium">Split View</h3>
<p className="text-sm text-zinc-400 mt-1">Multitask efficiently. View issues alongside your roadmap or documentation.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition duration-300">
<div className="flex-shrink-0">
...
<p className="text-sm text-zinc-400 mt-1">Keep working even without internet. Changes sync automatically when you're back online.</p>
</div>
</div>
</div>
</div>

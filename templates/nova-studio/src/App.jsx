...
<img alt="Portrait photography of a woman with short dark hair" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a0598941-97b9-43d5-8007-56fa92437c3c_1600w.webp"/>

<button className="absolute left-3 top-1/2 -translate-y-1/2 inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/80 border border-slate-700/70 text-slate-200 hover:bg-slate-800/90 transition">
<i className="lucide lucide-chevron-left h-4 w-4"></i>
</button>
<button className="absolute right-3 top-1/2 -translate-y-1/2 inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/80 border border-slate-700/70 text-slate-200 hover:bg-slate-800/90 transition">
<i className="lucide lucide-chevron-right h-4 w-4"></i>
</button>
...
<svg className="lucide lucide-camera w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="solar" data-solar="clock-circle-bold-duotone" height="14" strokeWidth="2" style={{color: 'rgb(148, 163, 184)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10" fill="#94a3b8" opacity=".5"></path><path clip-rule="evenodd" d="M12 7.25a.75.75 0 0 1 .75.75v3.69l2.28 2.28a.75.75 0 1 1-1.06 1.06l-2.5-2.5a.75.75 0 0 1-.22-.53V8a.75.75 0 0 1 .75-.75" fill="#94a3b8" fill-rule="evenodd"></path></svg>
<span className="">Analog &amp; digital workflows</span>
</div>
<div className="flex items-center gap-2 text-xs text-slate-400">
<svg className="lucide lucide-sparkles h-3.5 w-3.5 w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="solar" data-solar="calendar-add-bold-duotone" height="14" strokeWidth="2" style={{color: 'rgb(148, 163, 184)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M6.96 2c.418 0 .756.31.756.692V4.09c.67-.012 1.422-.012 2.268-.012h4.032c.846 0 1.597 0 2.268.012V2.692c0-.382.338-.692.756-.692s.756.31.756.692V4.15c1.45.106 2.403.368 3.103 1.008c.7.641.985 1.513 1.101 2.842v1H2V8c.116-1.329.401-2.2 1.101-2.842c.7-.64 1.652-.902 3.103-1.008V2.692c0-.382.339-.692.756-.692" fill="#94a3b8"></path><path d="M22 14v-2c0-.839-.013-2.335-.026-3H2.006c-.013.665 0 2.161 0 3v2c0 3.771 0 5.657 1.17 6.828C4.349 22 6.234 22 10.004 22h4c3.77 0 5.654 0 6.826-1.172S22 17.771 22 14" fill="#94a3b8" opacity=".5"></path><path clip-rule="evenodd" d="M16 13.25a.75.75 0 0 1 .75.75v1.25H18a.75.75 0 0 1 0 1.5h-1.25V18a.75.75 0 0 1-1.5 0v-1.25H14a.75.75 0 0 1 0-1.5h1.25V14a.75.75 0 0 1 .75-.75" fill="#94a3b8" fill-rule="evenodd"></path></svg>
...
<img alt="Muted beige fashion portrait" className="transition duration-500 group-hover:scale-[1.03] w-full h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a59cc4df-4519-45ac-a6d8-de00a626a02e_800w.webp"/>
...
<article className="group rounded-2xl bg-slate-900/80 overflow-hidden border border-slate-800/90 flex flex-col">
<div className="relative">
<img alt="Dark-toned portrait with earring" className="h-36 w-full object-cover transition duration-500 group-hover:scale-[1.03]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
<span className="absolute left-3 top-3 rounded-full bg-slate-950/80 px-2 py-0.5 text-[10px] font-medium uppercase tracking-[0.18em] text-slate-200">
                      Night Signal
                    </span>
</div>
...
</section><section className="sm:px-6 lg:px-8 lg:py-10 max-w-6xl mt-24 mr-auto mb-24 ml-auto pt-2 pr-4 pb-10 pl-4">
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">

<div className="flex justify-center lg:justify-start">
<div className="overflow-hidden shadow-black/40 sm:max-w-sm bg-gradient-to-br from-white/10 to-white/0 w-full max-w-xs rounded-[2.5rem] relative shadow-2xl gap-x-3 gap-y-3" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '2.5rem'}}>

<div className="flex items-center justify-between px-4 pt-3 pb-2 text-[13px] text-slate-200">
<div className="flex items-center gap-1.5">
<span className="text-xl font-semibold tracking-tight">Lumina</span>
<i className="lucide lucide-chevron-down w-3 h-3 text-slate-400"></i>
</div>
<div className="flex items-center gap-3 text-xs">
<span className="">9:41</span>
<span className="w-4 h-1.5 rounded-full bg-slate-600 overflow-hidden">
<span className="block h-full w-3/4 bg-slate-100"></span>
</span>
</div>
</div>

<div className="flex gap-3 overflow-x-auto no-scrollbar pr-3 pb-3 pl-3 gap-x-3 gap-y-3 items-center">
<div className="flex flex-col items-center gap-1">
<div className="relative w-11 h-11 rounded-full bg-slate-900 flex items-center justify-center border border-cyan-400/70">
<span className="text-[11px] font-semibold tracking-tight text-cyan-100">
                NK
              </span>
<span className="absolute -right-0.5 -bottom-0.5 inline-flex items-center justify-center w-4 h-4 rounded-full bg-cyan-500 text-xs text-slate-950 font-medium">
                +
              </span>
</div>
...
<div className="flex flex-col items-center gap-1">
<div className="w-11 h-11 rounded-full border border-fuchsia-400/80 p-[2px]">
<img alt="3D render capsule" className="w-full h-full object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/419fb450-fb0d-4f9e-9852-133d18177ec0_320w.webp"/>
</div>
<span className="text-xs text-slate-400">Luma</span>
</div>
<div className="flex flex-col items-center gap-1">
<div className="w-11 h-11 rounded-full border border-amber-400/80 p-[2px]">
<img alt="Minimal product" className="w-full h-full object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/feadc71c-fe96-42c7-912b-466bd1d637b6_320w.webp"/>
</div>
<span className="text-xs text-slate-400">Radius</span>
</div>
<div className="flex flex-col items-center gap-1">
<div className="w-11 h-11 rounded-full border border-emerald-400/80 p-[2px]">
<img alt="Soft light render" className="w-full h-full object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/eb7d05f7-a48c-46ee-89a0-43060e107242_320w.webp"/>
</div>
<span className="text-xs text-slate-400">Halo</span>
</div>
</div>

<div className="border-t border-slate-800/80 pt-2 pb-3">
<div className="flex items-center justify-between px-3 pb-2">
<div className="flex items-center gap-2">
<div className="w-7 h-7 rounded-full overflow-hidden border border-slate-700">
<img alt="Profile avatar" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&amp;fit=crop&amp;w=200&amp;q=80"/>
</div>
<div className="flex flex-col">
<span className="text-xs font-medium text-slate-100 tracking-tight">Nova Studio</span>
<span className="text-xs text-slate-500">Sponsored · Berlin</span>
</div>
</div>
<button className="text-slate-500">
<i className="lucide lucide-more-horizontal w-4 h-4"></i>
</button>
</div>
<div className="aspect-[4/5] bg-slate-900/90">
<img alt="Soft-lit product render on neutral background" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b813d408-b6f5-47e6-8569-1a52804aba18_800w.webp"/>
</div>

<div className="px-3 pt-2">
<button className="w-full rounded-xl bg-cyan-500 text-slate-950 text-xs font-medium py-1.5 flex items-center justify-between px-3 hover:bg-cyan-400 transition">
<span className="">Launch your visual campaign</span>
<svg className="lucide lucide-arrow-right w-3.5 h-3.5 w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="solar" data-solar="rocket-bold-duotone" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(2, 6, 23)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m14.447 16.377l5.847-5.83c.842-.839 1.263-1.259 1.484-1.792S22 7.627 22 6.44v-.567c0-1.826 0-2.739-.569-3.306S19.947 2 18.116 2h-.57c-1.19 0-1.785 0-2.32.221c-.536.221-.957.641-1.8 1.48L7.58 9.531c-.984.98-1.594 1.589-1.83 2.176a1.5 1.5 0 0 0-.112.562c0 .802.647 1.448 1.942 2.739l.174.173l2.038-2.069a.75.75 0 1 1 1.069 1.053L8.816 16.24l.137.137c1.295 1.29 1.943 1.936 2.747 1.936c.178 0 .348-.031.519-.094c.603-.222 1.219-.836 2.228-1.842m2.747-6.846a1.946 1.946 0 0 1-2.747 0a1.93 1.93 0 0 1 0-2.738a1.946 1.946 0 0 1 2.747 0a1.93 1.93 0 0 1 0 2.738" fill="#020617" fill-rule="evenodd"></path><path d="M9.034 5.963L6.491 8.5c-.467.466-.896.893-1.235 1.28a6 6 0 0 0-.619.82l-.024-.025l-.095-.094a4.9 4.9 0 0 0-1.532-1.004l-.123-.05l-.379-.15a.764.764 0 0 1-.259-1.252C3.345 6.907 4.69 5.566 5.34 5.297a3.4 3.4 0 0 1 1.788-.229c.546.081 1.063.362 1.907.895m4.342 13.35c.205.208.34.355.464.512q.243.311.434.658c.142.26.253.537.474 1.092a.69.69 0 0 0 1.126.224l.084-.083c1.12-1.117 2.465-2.458 2.735-3.105a3.35 3.35 0 0 0 .229-1.782c-.081-.545-.362-1.06-.897-1.902l-2.552 2.544c-.478.477-.916.914-1.313 1.256c-.237.206-.497.41-.784.586" fill="#020617" opacity=".5"></path></svg>
</button>
</div>

<div className="flex text-xs text-slate-400 pt-2 pr-3 pb-2 pl-3 items-center justify-between">
<span className="">312 likes · 8 comments</span>
...
<h2 className="text-4xl sm:text-5xl lg:text-[40px] font-semibold tracking-tight text-slate-50">
          Social stories that turn quiet scrolls into booked projects.
        </h2>
<p className="text-base text-slate-400 max-w-md">
          Every launch blends narrative, motion, and light calibration to keep your work in-frame and in-mind—across the feeds your clients live in.
        </p>
</div>
...
<svg className="w-4.5 h-4.5" strokeWidth="1.7" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 7.75C4 6.784 4.784 6 5.75 6h12.5c.966 0 1.75.784 1.75 1.75v7.5A2.75 2.75 0 0 1 17.25 18H6.75A2.75 2.75 0 0 1 4 15.25z" fill="#0ea5e9" opacity=".5"></path>
<path d="M7 9.75A.75.75 0 0 1 7.75 9h3.5a.75.75 0 0 1 0 1.5h-3.5A.75.75 0 0 1 7 9.75m0 3A.75.75 0 0 1 7.75 12h1.5a.75.75 0 0 1 0 1.5h-1.5A.75.75 0 0 1 7 12.75" fill="#e0f2fe"></path>
</svg>
</div>
...
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/80 border border-slate-800/90">
<svg className="w-4.5 h-4.5" strokeWidth="1.7" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 6.75A1.75 1.75 0 0 1 5.75 5h12.5A1.75 1.75 0 0 1 20 6.75v10.5A1.75 1.75 0 0 1 18.25 19H5.75A1.75 1.75 0 0 1 4 17.25z" fill="#22c55e" opacity=".5"></path>
<path d="M8.53 11.47a.75.75 0 0 1 1.06 0L11 12.88l3.47-3.47a.75.75 0 0 1 1.06 1.06l-4 4a.75.75 0 0 1-1.06 0l-2-2a.75.75 0 0 1 0-1.06" fill="#dcfce7"></path>
</svg>
</div>
<div className="flex flex-col gap-1">
<div className="flex items-baseline gap-3">
...
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/80 border border-slate-800/90">
<svg className="w-4.5 h-4.5" strokeWidth="1.7" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 5.75A1.75 1.75 0 0 1 6.75 4h10.5A1.75 1.75 0 0 1 19 5.75v12.5A1.75 1.75 0 0 1 17.25 20H6.75A1.75 1.75 0 0 1 5 18.25z" fill="#eab308" opacity=".5"></path>
<path d="M9.75 8a.75.75 0 0 1 .75.75v4.19l1.72-1.72a.75.75 0 0 1 1.06 1.06l-3 3A.75.75 0 0 1 9 15.75v-7A.75.75 0 0 1 9.75 8" fill="#fef9c3"></path>
</svg>
</div>
<div className="flex flex-col gap-1">
<div className="flex items-baseline gap-3">
...
<button className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-br from-white/80 to-white/40 text-sm font-medium text-slate-950 px-3 py-2 hover:bg-slate-200 transition">
<span>Download full campaign report</span>
<svg className="lucide lucide-download w-[16px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="arrow-down-outline" height="16" strokeWidth="2" style={{color: 'rgb(2, 6, 23)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M12 3.25a.75.75 0 0 1 .75.75v14.19l4.72-4.72a.75.75 0 1 1 1.06 1.06l-6 6a.75.75 0 0 1-1.06 0l-6-6a.75.75 0 1 1 1.06-1.06l4.72 4.72V4a.75.75 0 0 1 .75-.75" fill="#020617" fill-rule="evenodd"></path></svg>
</button>
...
</section><section className="sm:px-6 lg:px-8 lg:py-10 max-w-6xl mt-24 mr-auto mb-24 ml-auto pt-6 pr-4 pb-10 pl-4">
<div className="flex flex-col gap-8">
...
<p className="text-base sm:text-lg text-slate-400 max-w-2xl">
        A cross-section of teams that traded crowded feeds for considered stories—pairing disciplined production with measurable lift in the metrics that matter.
      </p>
</div>

<div className="overflow-hidden bg-gradient-to-br from-white/10 to-white/0 rounded-3xl" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '24px'}}>

<div className="hidden md:grid grid-cols-12 text-[11px] uppercase font-medium text-slate-500 tracking-[0.16em] bg-slate-950/80 border-slate-800/80 border-b pt-3 pr-4 pb-3 pl-4">
...
<article className="border-slate-800/80 border-b">
<div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:py-5 pt-4 pr-4 pb-4 pl-4 gap-x-4 gap-y-4">
<div className="md:col-span-3 flex flex-col gap-1 text-sm text-slate-400">
...
<div className="md:col-span-2 flex flex-col gap-1 text-sm text-slate-300">
<div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.16em] text-emerald-300">
<svg className="w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="solar" data-solar="pie-chart-2-bold-duotone" height="14" strokeWidth="2" style={{color: 'rgb(110, 231, 183)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M6.222 4.601a9.5 9.5 0 0 1 1.395-.771c1.372-.615 2.058-.922 2.97-.33c.913.59.913 1.56.913 3.5v1.5c0 1.886 0 2.828.586 3.414s1.528.586 3.414.586H17c1.94 0 2.91 0 3.5.912c.592.913.285 1.599-.33 2.97a9.5 9.5 0 0 1-10.523 5.435A9.5 9.5 0 0 1 6.222 4.601" fill="#6ee7b7" opacity=".5"></path><path d="M21.446 7.069a8.03 8.03 0 0 0-4.515-4.515C15.389 1.947 14 3.344 14 5v4a1 1 0 0 0 1 1h4c1.657 0 3.053-1.39 2.446-2.931" fill="#6ee7b7"></path></svg>
              Impact
            </div>
...
<button className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-800/80 bg-slate-900/80 text-slate-300 hover:text-slate-50 hover:border-slate-700 transition">
<svg className="w-[15px] h-[15px]" data-icon-replaced="true" data-icon-set="solar" data-solar="circle-top-up-bold-duotone" height="15" strokeWidth="2" style={{width: '15px', height: '15px', color: 'rgb(248, 250, 252)'}} viewbox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10" fill="#f8fafc" opacity=".5"></path><path clip-rule="evenodd" d="M12.47 11.53a.75.75 0 0 1 0-1.06l7.72-7.72h-3.534a.75.75 0 0 1 0-1.5H22a.75.75 0 0 1 .75.75v5.344a.75.75 0 0 1-1.5 0V3.81l-7.72 7.72a.75.75 0 0 1-1.06 0" fill="#f8fafc" fill-rule="evenodd"></path></svg>
</button>
</div>
</div>
</article>

<article className="border-b border-slate-800/80">
<div className="grid grid-cols-1 md:grid-cols-12 gap-4 px-4 py-4 md:py-5">
<div className="md:col-span-3 flex flex-col gap-1 text-sm text-slate-400">
<span className="font-medium text-slate-200 tracking-tight">
...
<svg className="w-[14px] h-[14px]" data-icon-replaced="true" data-icon-set="solar" data-solar="chart-2-bold-duotone" height="14" strokeWidth="2" style={{color: 'rgb(125, 211, 252)', width: '14px', height: '14px'}} viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M3.293 9.293C3 9.586 3 10.057 3 11v6c0 .943 0 1.414.293 1.707S4.057 19 5 19s1.414 0 1.707-.293S7 17.943 7 17v-6c0-.943 0-1.414-.293-1.707S5.943 9 5 9s-1.414 0-1.707.293" fill="#7dd3fc"></path><path d="M17.293 2.293C17 2.586 17 3.057 17 4v13c0 .943 0 1.414.293 1.707S18.057 19 19 19s1.414 0 1.707-.293S21 17.943 21 17V4c0-.943 0-1.414-.293-1.707S19.943 2 19 2s-1.414 0-1.707.293" fill="#7dd3fc" opacity=".4"></path><path d="M10 7c0-.943 0-1.414.293-1.707S11.057 5 12 5s1.414 0 1.707.293S14 6.057 14 7v10c0 .943 0 1.414-.293 1.707S12.943 19 12 19s-1.414 0-1.707-.293S10 17.943 10 17z" fill="#7dd3fc" opacity=".7"></path><path d="M3 21.25a.75.75 0 0 0 0 1.5h18a.75.75 0 0 0 0-1.5z" fill="#7dd3fc"></path></svg>
              Retention
            </div>
<p className="text-sm text-slate-300">
...
<div className="md:col-span-1 flex items-start justify-end">
<button className="inline-flex hover:text-slate-50 hover:border-slate-700 transition text-slate-300 bg-slate-900/80 w-8 h-8 border-slate-800/80 border rounded-full items-center justify-center">
<svg className="w-[15px] h-[15px]" data-icon-replaced="true" data-icon-set="solar" data-solar="circle-top-up-bold-duotone" height="15" strokeWidth="2" style={{width: '15px', height: '15px', color: 'rgb(248, 250, 252)'}} viewbox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg"><path className="" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12s4.477 10 10 10" fill="#f8fafc" opacity=".5"></path><path clip-rule="evenodd" d="M12.47 11.53a.75.75 0 0 1 0-1.06l7.72-7.72h-3.534a.75.75 0 0 1 0-1.5H22a.75.75 0 0 1 .75.75v5.344a.75.75 0 0 1-1.5 0V3.81l-7.72 7.72a.75.75 0 0 1-1.06 0" fill="#f8fafc" fill-rule="evenodd"></path></svg>
</button>
</div>
</div>
</article>
...
<article className="">
<div className="grid grid-cols-1 md:grid-cols-12 gap-4 px-4 py-5">
<div className="md:col-span-3 flex flex-col gap-1 text-sm text-slate-400">
<span className="font-medium text-slate-200 tracking-tight">
              E‑commerce &amp; DTC
            </span>
...
<div className="inline-flex items-center gap-2 rounded-2xl bg-slate-900/80 border border-slate-800/80 px-3 py-2">
<svg className="w-[15px] h-[15px] text-amber-300" data-icon-set="solar" data-solar="clapperboard-play-bold-duotone" height="15" viewbox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M3 11.25C3 8.35 3 6.9 3.88 5.92S6.2 4.5 9 4.5h6c2.8 0 4.2 0 5.08.92C21 6.9 21 8.35 21 11.25V15c0 2.8 0 4.2-.92 5.1S17.8 21 15 21H9c-2.8 0-4.2 0-5.12-.9S3 17.8 3 15z" opacity=".5"></path>
<path d="M3.3 6.21c.21-.5.51-.93.93-1.33c.82-.79 2.03-1.08 3.77-1.17l.59 1.7l-1.84 1.63zm6.24-.07l-1-2.82C9.29 3.3 9.93 3.25 10.7 3.25h.3l.78 2.2zm3.45-.24L12.25 3.25H15c.74 0 1.35.03 1.87.12l.73 2.07zM18.83 5l.55 1.58l-1.72 1.51l-1.05-2.96z" opacity="1"></path>
<path d="M11.44 11.47a.75.75 0 0 0-1.19.61v3.84a.75.75 0 0 0 1.19.61l2.77-1.92a.75.75 0 0 0 0-1.22z"></path>
</g>
</svg>
<span className="text-[11px] font-medium tracking-[0.14em] uppercase text-amber-100">
                  Launch series
                </span>
</div>
<p className="text-sm text-slate-400">
...
<div className="md:col-span-1 flex items-start justify-end">
<button className="inline-flex hover:text-slate-50 hover:border-slate-700 transition text-slate-300 bg-slate-900/80 w-8 h-8 border-slate-800/80 border rounded-full items-center justify-center">
<svg className="w-[15px] h-[15px]" data-icon-replaced="true" data-icon-set="solar" data-solar="calendar-search-bold-duotone" height="15" strokeWidth="2" style={{width: '15px', height: '15px', color: 'rgb(248, 250, 252)'}} viewbox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg"><path d="M6.96 2c.418 0 .756.31.756.692V4.09c.67-.012 1.422-.012 2.268-.012h4.032c.846 0 1.597 0 2.268.012V2.692c0-.382.338-.692.756-.692s.756.31.756.692V4.15c1.45.106 2.403.368 3.103 1.008c.7.641.985 1.513 1.101 2.842v1H2V8c.116-1.329.401-2.2 1.101-2.842c.7-.64 1.652-.902 3.103-1.008V2.692c0-.382.339-.692.756-.692" fill="#f8fafc"></path><path d="M22 14v-2c0-.839-.013-2.335-.026-3H2.006c-.013.665 0 2.161 0 3v2c0 3.771 0 5.657 1.17 6.828C4.349 22 6.234 22 10.004 22h4c3.77 0 5.654 0 6.826-1.172S22 17.771 22 14" fill="#f8fafc" opacity=".5"></path><path clip-rule="evenodd" d="M18.75 16.5a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5M15 18.75a3.75 3.75 0 1 1 6.879 2.068l1.401 1.402a.75.75 0 1 1-1.06 1.06l-1.402-1.401A3.75 3.75 0 0 1 15 18.75" fill="#f8fafc" fill-rule="evenodd"></path></svg>
</button>
</div>
</div>
</article>
...
<div className="inline-flex bg-slate-950/60 rounded-full pt-1.5 pr-3 pb-1.5 pl-3 gap-x-2 gap-y-2 items-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}>
<svg className="w-[13px] h-[13px]" data-icon-set="solar" data-solar="document-text-bold-duotone" height="13" viewbox="0 0 24 24" width="13" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M5 4.25C5 3.01 6.007 2 7.25 2h6.086c.465 0 .91.185 1.238.514l2.912 2.912c.33.328.514.773.514 1.238V19.75A2.25 2.25 0 0 1 15.75 22H7.25A2.25 2.25 0 0 1 5 19.75z" opacity=".5"></path>
<path d="M9 11.25A.75.75 0 0 1 9.75 10.5h4.5a.75.75 0 0 1 0 1.5h-4.5A.75.75 0 0 1 9 11.25m0 3A.75.75 0 0 1 9.75 13.5h2.5a.75.75 0 0 1 0 1.5h-2.5A.75.75 0 0 1 9 14.25M14.5 2.25v2.75c0 .69.56 1.25 1.25 1.25h2.75z"></path>
</g>
</svg>
...
</section><section className="sm:px-6 lg:px-8 lg:py-10 max-w-6xl mt-24 mr-auto mb-24 ml-auto pt-6 pr-4 pb-12 pl-4">
<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

<div className="overflow-hidden flex bg-gradient-to-br from-white/10 to-white/0 h-full rounded-3xl pt-8 pr-6 pb-8 pl-6 relative items-center" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '24px'}}>
<div className="absolute inset-0 pointer-events-none" style={{backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(148,163,184,0.25) 1px, transparent 0)', backgroundSize: '18px 18px', opacity: '0.45'}}>
</div>

<div className="z-10 relative w-full">
<div className="relative mx-auto w-full max-w-md h-64">

<div className="absolute inset-8 border border-dashed border-slate-700/70 rotate-[-18deg]"></div>
<div className="absolute inset-4 border border-dashed border-slate-700/70 rotate-[-12deg] bg-slate-900/40"></div>
<div className="border-dashed bg-slate-900 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e0be2642-7091-4c16-8ad7-8bc98b5a8fdf_1600w.webp)] bg-cover bg-center border-slate-600/70 border absolute top-0 right-0 bottom-0 left-0 rotate-[-6deg]">
</div>

<div className="absolute -left-2 top-6 flex items-center gap-2">
<span className="flex h-7 w-9 items-center justify-center rounded-md bg-slate-950 text-[11px] font-medium tracking-[0.18em] text-slate-100">
              01
            </span>
<div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100/90 px-3 py-1 text-[11px] font-medium text-slate-900">
<svg className="w-[13px] h-[13px]" data-icon-set="solar" data-solar="search-bold-duotone" height="13" viewbox="0 0 24 24" width="13" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M11.5 3A6.5 6.5 0 1 0 18 9.5A6.508 6.508 0 0 0 11.5 3" opacity=".5"></path>
<path d="M20.53 19.47L17.2 16.14a8 8 0 1 0-1.06 1.06L19.47 20.53a.75.75 0 0 0 1.06-1.06M5 9.5A4.5 4.5 0 1 1 9.5 14A4.505 4.505 0 0 1 5 9.5" opacity="1"></path>
</g>
</svg>
          Discover
        </div>
</div>
<div className="absolute right-0 top-24 flex items-center gap-2">
<div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100/90 px-3 py-1 text-[11px] font-medium text-slate-900">
<svg className="w-[13px] h-[13px]" data-icon-set="solar" data-solar="target-bold-duotone" height="13" viewbox="0 0 24 24" width="13" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M12 3a9 9 0 1 0 9 9a9.01 9.01 0 0 0-9-9" opacity=".5"></path>
<path d="M12 7a5 5 0 1 0 5 5a5.006 5.006 0 0 0-5-5m0 3a2 2 0 1 1-2 2a2 2 0 0 1 2-2" opacity="1"></path>
</g>
</svg>
          Map
        </div>
...
<div className="absolute -left-1 bottom-12 flex items-center gap-2">
<span className="flex h-7 w-9 items-center justify-center rounded-md bg-slate-950 text-[11px] font-medium tracking-[0.18em] text-slate-100">
              03
            </span>
<div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100/90 px-3 py-1 text-[11px] font-medium text-slate-900">
<svg className="w-[13px] h-[13px]" data-icon-set="solar" data-solar="clapperboard-play-bold-duotone" height="13" viewbox="0 0 24 24" width="13" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M3 11.25C3 8.35 3 6.9 3.88 5.92S6.2 4.5 9 4.5h6c2.8 0 4.2 0 5.08.92C21 6.9 21 8.35 21 11.25V15c0 2.8 0 4.2-.92 5.1S17.8 21 15 21H9c-2.8 0-4.2 0-5.12-.9S3 17.8 3 15z" opacity=".5"></path>
<path d="M3.3 6.21c.21-.5.51-.93.93-1.33c.82-.79 2.03-1.08 3.77-1.17l.59 1.7l-1.84 1.63zm6.24-.07l-1-2.82C9.29 3.3 9.93 3.25 10.7 3.25h.3l.78 2.2zm3.45-.24L12.25 3.25H15c.74 0 1.35.03 1.87.12l.73 2.07zM18.83 5l.55 1.58l-1.72 1.51l-1.05-2.96z" opacity="1"></path>
...
<div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100/90 px-3 py-1 text-[11px] font-medium text-slate-900">
<svg className="w-[13px] h-[13px]" data-icon-set="solar" data-solar="rocket-bold-duotone" height="13" viewbox="0 0 24 24" width="13" xmlns="http://www.w3.org/2000/svg">
<g fill="currentColor">
<path d="M14.447 16.377L20.294 10.547c.842-.839 1.263-1.259 1.484-1.792S22 7.627 22 6.44v-.567c0-1.826 0-2.739-.569-3.306S19.947 2 18.116 2h-.57c-1.19 0-1.785 0-2.32.221c-.536.221-.957.641-1.8 1.48L7.58 9.531c-.984.98-1.594 1.589-1.83 2.176a1.5 1.5 0 0 0-.112.562c0 .802.647 1.448 1.942 2.739l.174.173l2.038-2.069a.75.75 0 1 1 1.069 1.053L8.816 16.24l.137.137c1.295 1.29 1.943 1.936 2.747 1.936c.178 0 .348-.031.519-.094c.603-.222 1.219-.836 2.228-1.842" opacity=".5"></path>
<path d="M18.894 8.531a1.946 1.946 0 0 1-2.747 0a1.93 1.93 0 0 1 0-2.738a1.946 1.946 0 0 1 2.747 0a1.93 1.93 0 0 1 0 2.738" opacity="1"></path>
...
<p className="text-base sm:text-lg text-slate-400 max-w-xl">
          A four-part studio workflow that keeps your stories coherent, measurable, and unmistakably yours—from discovery call to launch recap.
        </p>
</div>
<div className="space-y-4">

<div className="flex gap-3">
<div className="flex text-[24px] text-6xl font-medium text-slate-100 w-6 h-6 rounded-full mt-1 items-center justify-center">
            01
          </div>
<div className="flex-1">
<div className="flex items-center gap-2">
<span className="text-base font-medium text-slate-100 tracking-tight">
                Listen &amp; uncover
              </span>
</div>
<p className="mt-1 text-base text-slate-400">
              We map your brand, context and constraints in a focused intake sprint, surfacing the stories that actually move your clients.
            </p>
</div>
</div>
...
<p className="mt-1 text-base text-slate-400">
              We outline a channel-specific storyboard, shot lists and cadence plan that fits your team’s reality—not an idealized calendar.
            </p>
</div>
</div>

<div className="flex gap-3">
<div className="flex text-[24px] font-medium text-slate-100 w-6 h-6 rounded-full mt-1 items-center justify-center">
            03
          </div>
<div className="flex-1">
<div className="flex items-center gap-2">
...
<p className="mt-1 text-base text-slate-400">
              Production days turn into modular scenes, stills and motion loops that can be reused across 3–6 months of campaigns.
            </p>
</div>
</div>
...
<p className="mt-1 text-base text-slate-400">
              We coordinate posting windows, track in-platform metrics, and ship a post-launch debrief within 21 days to inform the next cycle.
            </p>
</div>
</div>
</div>
...
<button className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-br from-white/80 to-white/40 px-4 py-2 text-sm font-medium text-slate-950 hover:bg-slate-200 transition">
<span className="">Walk me through a sample sprint</span>
<svg className="w-[15px] h-[15px]" data-icon-replaced="true" data-icon-set="solar" data-solar="arrow-right-up-bold-duotone" height="15" strokeWidth="2" style={{color: 'rgb(2, 6, 23)', width: '15px', height: '15px'}} viewbox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M17.47 15.53a.75.75 0 0 0 1.28-.53V6a.75.75 0 0 0-.75-.75H9a.75.75 0 0 0-.53 1.28z" fill="#020617" fill-rule="evenodd"></path><path d="M5.47 17.47a.75.75 0 1 0 1.06 1.06l6.97-6.97l-1.06-1.06z" fill="#020617" opacity=".5"></path></svg></button></div></div></div></section><section className="sm:px-6 lg:px-8 lg:py-12 max-w-6xl mt-24 mr-auto mb-24 ml-auto pt-10 pr-4 pb-12 pl-4">
...
<h1 className="text-4xl sm:text-5xl lg:text-[44px] font-semibold tracking-tight text-slate-50">
            Systems for stories that grow with your studio.
          </h1>
<p className="text-base sm:text-lg text-slate-400 max-w-xl">
            Lumen Narrative Studio turns scattered content ideas into a durable visual system—designed to compound across launches, channels, and seasons.
          </p>
...
<path d="M3 11h18v3.385c0 3.655 0 5.483-1.17 6.549C18.66 22 16.773 22 13 22h-2c-3.773 0-5.66 0-6.83-1.066C3 19.868 3 18.04 3 14.385z"></path>
<path d="M8 12.75a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 12.75m4-1.5a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-1.5 0v-5a.75.75 0 0 1 .75-.75m4 3a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75"></path>
</g>
</svg>
</div>
<div className="flex flex-col">
...
<p className="text-sm text-slate-200">
            Share your next launch in 5 questions. Within 48 hours, you’ll get a tailored storyboard outline and channel map.
          </p>
...
<img alt="Storyboarding and creative planning" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/419fb450-fb0d-4f9e-9852-133d18177ec0_800w.webp"/>
</div>
...
<img alt="Modular production setup in studio" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4a0df060-4f2f-415a-8efc-510669e96e2a_800w.webp"/>
</div>
<div className="flex items-center justify-between gap-2 border-t border-slate-200 pt-3">
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900 text-slate-50">
<svg className="w-[16px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="display-bold-duotone" height="16" strokeWidth="2" style={{color: 'rgb(248, 250, 252)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M2.879 3.844C2 4.687 2 6.044 2 8.76v.96c0 2.715 0 4.073.879 4.916c.878.844 2.293.844 5.121.844h8c2.828 0 4.243 0 5.121-.844c.879-.843.879-2.2.879-4.916v-.96c0-2.715 0-4.073-.879-4.916C20.243 3 18.828 3 16 3H8c-2.828 0-4.243 0-5.121.844" fill="#f8fafc" fill-rule="evenodd"></path><path d="M18.237 19.596L12.75 17.84v-2.36h-1.5v2.36l-5.487 1.756a.714.714 0 0 0-.474.911a.757.757 0 0 0 .948.455L12 19.118l5.763 1.845a.757.757 0 0 0 .949-.456a.714.714 0 0 0-.475-.91" fill="#f8fafc" opacity=".5"></path></svg>
</div>
<span className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
              Core service
            </span>
...
<p className="text-sm text-slate-600">
              Build a reusable library of scenes, frames, and motion loops that powers 3–9 months of content with each shoot.
            </p>
...
<div className="flex flex-col gap-4">
<div className="relative h-32 w-full rounded-2xl overflow-hidden border border-slate-800/80">
<img alt="Analytics dashboard for content performance" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/41c6783e-584f-4e25-a83d-11fae0327186_800w.webp"/>
</div>
<div className="flex items-center justify-between gap-2 border-t border-slate-800/80 pt-3">
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/90 border border-slate-800/90">
<svg className="w-[16px] h-[16px]" data-icon-replaced="true" data-icon-set="solar" data-solar="rocket-2-bold-duotone" height="16" strokeWidth="2" style={{color: 'rgb(248, 250, 252)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m15.502 14.367l5.03-5.014c.724-.722 1.087-1.083 1.277-1.543C22 7.351 22 6.84 22 5.82v-.49c0-1.57 0-2.355-.49-2.843C21.022 2 20.235 2 18.659 2h-.489c-1.024 0-1.537 0-1.997.19s-.823.551-1.547 1.274l-5.03 5.014c-.846.844-1.371 1.367-1.574 1.873c-.064.16-.097.317-.097.483c0 .69.557 1.245 1.671 2.356l.15.149l1.754-1.78a.645.645 0 0 1 .919.906l-1.76 1.785l.119.117c1.114 1.11 1.67 1.666 2.362 1.666q.228 0 .447-.081c.519-.191 1.048-.72 1.916-1.585m2.363-5.888c-.652.65-1.71.65-2.363 0a1.66 1.66 0 0 1 0-2.356c.653-.65 1.71-.65 2.363 0s.653 1.705 0 2.356M2.774 12.481a.76.76 0 0 1 0 1.074l-.156.155a.34.34 0 0 0 0 .48a.34.34 0 0 0 .483 0l1.713-1.71a.76.76 0 0 1 1.072 1.075l-1.712 1.71a1.86 1.86 0 0 1-2.629 0a1.857 1.857 0 0 1 0-2.629l.156-.155a.76.76 0 0 1 1.073 0m4.523 4.215c.293.3.288.78-.012 1.073l-1.73 1.692a.759.759 0 0 1-1.061-1.085l1.73-1.692a.76.76 0 0 1 1.073.012m4.184 1.422a.76.76 0 0 1 0 1.074l-1.713 1.71a.34.34 0 0 0 0 .48c.134.133.35.133.484 0l.156-.155A.759.759 0 0 1 11.48 22.3l-.155.155a1.86 1.86 0 0 1-2.63 0a1.857 1.857 0 0 1 0-2.629l1.713-1.71a.76.76 0 0 1 1.073.001" fill="#f8fafc" fill-rule="evenodd"></path><path d="M10.846 5.41L8.658 7.59c-.402.401-.77.769-1.062 1.101a5 5 0 0 0-.532.706l-.022-.021l-.08-.08a4.2 4.2 0 0 0-1.319-.865l-.106-.042l-.325-.13a.658.658 0 0 1-.223-1.077c.963-.96 2.12-2.114 2.679-2.346a2.9 2.9 0 0 1 1.537-.197c.47.07.915.311 1.641.77m3.736 11.484c.176.18.293.306.399.44q.21.268.373.567c.123.223.218.462.408.939c.155.388.67.491.968.193l.073-.072c.963-.96 2.12-2.114 2.353-2.67a2.9 2.9 0 0 0 .197-1.534c-.07-.468-.312-.912-.772-1.636l-2.195 2.189c-.411.41-.789.786-1.13 1.08a5 5 0 0 1-.674.504m-6.896-2.33a.759.759 0 1 0-1.073-1.073L4.47 15.632a.759.759 0 1 0 1.074 1.074zm2.809 2.806a.759.759 0 1 0-1.073-1.073l-2.128 2.127a.76.76 0 0 0 1.074 1.074z" fill="#f8fafc" opacity=".5"></path></svg>
</div>
<span className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
              Metrics &amp; lift
            </span>
...
<p className="text-sm text-slate-400">
              Connect every scene to a measurable outcome with dashboards that translate reach, saves, and replies into next-step decisions.
            </p>
</div>
</div>
</article>
...
<div className="flex flex-col gap-4">
<div className="relative h-32 w-full rounded-2xl overflow-hidden border border-slate-800/80">
<img alt="Creative team reviewing content system" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3e54e567-5c30-441a-baee-ee5f1bd4e184_800w.webp"/>
</div>
<div className="flex items-center justify-between gap-2 border-t border-slate-800/80 pt-3">
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-slate-900/90 border border-slate-800/90">
...
<p className="text-sm text-slate-400">
              Equip your in‑house team with format playbooks, shot recipes, and posting guidelines so the system keeps working after the engagement.
            </p>
</div>
</div>
</article>
...
</section><section className="sm:px-6 lg:px-8 lg:py-12 mt-10 mr-auto mb-24 ml-auto pt-8 pr-4 pb-10 pl-4 gap-x-8 gap-y-8">
...
<span className="text-3xl sm:text-4xl lg:text-7xl font-medium tracking-tight">
              +49 171 294 8037
            </span>
...
<p className="text-[80px] xs:text-[120px] sm:text-[160px] md:text-[120px] lg:text-[160px] xl:text-[200px] leading-none font-normal text-slate-50 tracking-tight w-full">NOVA STUDIO</p>
</div>
</div>

...
<canvas className="particles-js-canvas-el" height="1470" style={{width: '100%', height: '100%'}} width="2880"></canvas></div>
</div>
...
<span className="" data-i18n="nav.solutions">Solutions</span>
</a>
...
<span className="" data-i18n="nav.product">Product</span>
</a>
...
<span className="" data-i18n="nav.services">Services</span>
</a>
...
<span className="" data-i18n="nav.restaurants">About us</span>
</a>
</nav>
</div>
...
<span className="" data-i18n="nav.getStarted">Build Your Digital Platform</span>
</a>
...
<main className="flex h-[calc(100vh-80px)] z-20 relative items-end">
...
<span className="" data-i18n="hero.pill">Alberta based • technology company</span>
</div>
...
<span className="" data-i18n="hero.headline">Transform Your Business</span>
...
<p className="text-[11px] text-slate-400 font-geist mt-2" data-i18n="pov.portrait">Nova AI Technologies</p>
</div>
...
<span className="" data-i18n="pov.pill">Featured Core Product</span>
</div>
...
<span className="" data-i18n="pov.title">Complete Digital Platform</span>
</h2>
...
<section className="overflow-hidden lg:py-24 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/72c90007-7638-4902-8dda-5a6c20e92741_3840w.jpg)] bg-cover z-20 pt-16 pb-16 relative" id="resources">
<div className="pointer-events-none z-0 absolute inset-0">
<div className="absolute inset-y-0 left-[12.5%] w-px bg-gradient-to-b from-transparent via-white/5 to-transparent"></div>
<div className="absolute inset-y-0 left-[37.5%] w-px bg-gradient-to-b from-transparent via-white/5 to-transparent"></div>
<div className="absolute inset-y-0 left-1/2 w-px bg-gradient-to-b from-transparent via-white/8 to-transparent"></div>
...
<span className="" data-i18n="details.title">Digital Systems for Real Businesses</span>
</h2>
...
<span className="" data-i18n="details.c1Mini">Platform signals</span>
</div>
...
<span className="" data-i18n="details.c2Tag">Automations • integrations • AI</span>
</div>
</div>
</div>
...
<a className="inline-flex items-center gap-2 hover:bg-white/15 transition text-sm font-medium text-white font-geist bg-white/10 ring-white/15 ring-1 rounded-full pt-2.5 pr-4 pb-2.5 pl-4" href="/#solutions">
<span className="" data-i18n="details.cta2">View Solutions</span>
...
<span className="" data-i18n="details.cta3">ERP systems</span>
<iconify-icon className="transition-transform duration-200 group-hover:translate-x-0.5" height="16" icon="solar:arrow-right-linear" width="16"></iconify-icon>
</a>
</div>
</div>
...
<span className="" data-i18n="aud2.pill">Built for</span>
</div>
<h2 className="mt-4 sm:text-5xl md:text-6xl text-4xl font-normal tracking-tighter font-geist animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.15s_both]">
<span className="" data-i18n="aud2.title">Systems that fit your reality</span>
</h2>
<p className="md:mt-4 md:text-lg leading-relaxed animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.25s_both] text-base text-white/70 font-geist mt-3" data-i18n="aud2.desc">We builds digital infrastructure for teams that need real operations, not just marketing pages.</p>
</div>
...
<span className="" data-i18n="aud2.c1L1">Professional website platform</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-300 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c1L2">Automation for admin tasks</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-300 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<div className="overflow-hidden md:p-8 flex flex-col animate-on-scroll [animation:fadeSlideIn_1s_ease-out_0.28s_both] bg-gradient-to-b from-white/10 to-white/5 ring-blue-400/50 ring-2 rounded-3xl pt-6 pr-6 pb-6 pl-6 relative backdrop-blur-md">
<div className="absolute top-4 right-4">
<span className="inline-flex items-center gap-1 text-[10px] font-medium text-blue-200 font-geist bg-blue-400/20 ring-blue-400/40 ring-1 rounded-full pt-1 pr-2.5 pb-1 pl-2.5" data-i18n="aud2.badge">
            CORE
          </span>
</div>
<div className="flex-1">
<h3 className="text-xl font-normal tracking-tight font-geist" data-i18n="aud2.c2Title">Custom Business Systems</h3>
<p className="text-sm text-slate-200/80 font-geist mt-2" data-i18n="aud2.c2Desc">End-to-end platforms to run, automate, and scale your operations</p>
<ul className="mt-8 space-y-3">
<li className="flex items-start gap-3 text-sm text-slate-200 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c2L1">Custom ERP &amp; internal tools</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-200 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c2L2">Workflow automation systems</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-200 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c2L3">API integration &amp; dashboards</span>
</li>
</ul>
</div>
...
<span className="" data-i18n="aud2.c2Cta">View systems</span>
</a>
</div>
...
<p className="text-sm text-slate-400 font-geist mt-2" data-i18n="aud2.c3Desc">Custom platforms, dashboards, and AI systems for teams that scale.</p>
<ul className="mt-8 space-y-3">
<li className="flex items-start gap-3 text-sm text-slate-300 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c3L1">Custom internal systems</span>
</li>
<li className="flex items-start gap-3 text-sm text-slate-300 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<li className="flex items-start gap-3 text-sm text-slate-300 font-geist">
<iconify-icon className="text-blue-300 shrink-0 mt-0.5" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="" data-i18n="aud2.c3L3">Operational dashboards</span>
</li>
</ul>
</div>
<a className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-white/10 text-white ring-1 ring-white/15 px-4 py-2.5 text-sm font-medium font-geist hover:bg-white/15 transition w-full" href="/#start">
...
<span className="" data-i18n="close.pill">Ready to build?</span>
</div>
...
<p className="leading-relaxed text-lg text-slate-300 font-geist mt-6" data-i18n="close.desc">At Nova we designs and delivers premium digital systems, platforms, automations, and AI built to run in production and scale with your growth.</p>
...
<span className="" data-i18n="close.cta">Start Your Transformation</span>
...
<span className="" data-i18n="close.cta2">View Solutions</span>
...
<span className="" data-i18n="close.b1">Custom-built systems</span>
</div>
<div className="flex items-center gap-2">
<iconify-icon className="text-blue-300" height="16" icon="solar:check-circle-linear" width="16"></iconify-icon>
<span className="" data-i18n="close.b2">Automation + AI</span>
</div>
<div className="flex items-center gap-2">
<iconify-icon className="text-blue-300" height="16" icon="solar:check-circle-linear" width="16"></iconify-icon>
<span className="" data-i18n="close.b3">Production-ready</span>
</div>
</div>
</div>
</div>
...
<div className="md:px-8 lg:py-20 max-w-7xl z-10 mr-auto ml-auto pt-16 pr-6 pb-16 pl-6 relative">
<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12 gap-x-8 gap-y-8">
<div className="col-span-2">
<a aria-label="PSYCHO MAKER" className="inline-flex items-center justify-center bg-center w-[120px] h-[36px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f7466370-2832-4fdd-84c2-0932bb0dd850_800w.png)] bg-cover rounded-full" href="#"></a>
<p className="leading-relaxed text-sm text-slate-400 font-geist max-w-xs mt-4" data-i18n="footer.blurb">Nova AI Technologies Inc is a futuristic Digital Systems Studio building intelligent platforms, automation, and AI infrastructure for modern businesses.</p>
...
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col1L2" href="#resources">Services</a></li>
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col1L3" href="#showcase">Product</a></li>
</ul>
</div>
<div className="">
<h3 className="text-sm font-medium text-white font-geist" data-i18n="footer.col2Title">Capabilities</h3>
<ul className="mt-4 space-y-3">
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col2L1" href="#resources">Digital Presence</a></li>
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col2L2" href="#resources">Automation &amp; AI</a></li>
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col2L3" href="#resources">Custom Platforms</a></li>
</ul>
</div>
<div className="">
<h3 className="text-sm font-medium text-white font-geist" data-i18n="footer.col3Title">Industries</h3>
<ul className="mt-4 space-y-3">
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col3L1" href="#solutions">Local Businesses</a></li>
<li className=""><a className="hover:text-white transition text-sm text-slate-400 font-geist" data-i18n="footer.col3L2" href="#solutions">Ecommerce</a></li>
<li className=""><a className="text-sm text-slate-400 hover:text-white transition font-geist" data-i18n="footer.col3L3" href="#solutions">Startups</a></li>
</ul>
</div>
...
<span className="">hello@novaaitechnologies.com</span>
</a>
</li>
<li className="">
...
<span className="" data-i18n="footer.phone">+1 (587) 816-6553</span>
</a>
</li>
<li className="">
...
<span className="" data-i18n="footer.contactLink">Get in touch</span>
</a>
</li>
</ul>
<div className="mt-6">
...
<div className="flex flex-col md:flex-row md:items-center gap-4 border-white/5 border-t mt-14 pt-8 gap-x-4 gap-y-4 items-start justify-between">
<p className="text-xs text-slate-500 font-geist">
<span className="">© </span><span className="" id="year">2026</span><span className="">Nova AI Technology Inc</span>
<span className="text-slate-600"> • </span>
<span className="" data-i18n="footer.rights">All rights reserved.</span>
</p>

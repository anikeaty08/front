...
<a className="btn-wrapper" href="#" style={{'--dot-size': '6px', '--line-weight': '1px', '--line-distance': '0.8rem 1rem', '--animation-speed': '0.35s', '--dot-color': '#FACC15', '--line-color': '#FACC15', '--grid-color': '#fff3', position: 'relative', display: 'inline-flex', justifyContent: 'center', alignItems: 'center', width: 'auto', height: 'auto', padding: 'var(--line-distance)', userSelect: 'none'}}>

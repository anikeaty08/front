...
<nav className="fixed z-50 flex mix-blend-difference w-full pt-6 pr-6 pb-6 pl-6 top-0 left-0 items-start justify-between">
...
<div className="text-xs text-neutral-600 font-mono">0%</div>
</div>
</nav>

<main className="flex flex-col lg:px-12 w-full h-full z-10 pt-32 pr-6 pb-6 pl-6 relative justify-between">

<div className="z-20 max-w-2xl relative">
<h1 className="text-6xl md:text-8xl lg:text-9xl leading-[0.85] tracking-tighter text-white font-medium">
</h1>
</div>

<div className="z-10 flex pointer-events-none overflow-hidden absolute top-0 right-0 bottom-0 left-0 items-center justify-center">
...
<img alt="Katana Close Up" className="mask-image-gradient opacity-90 w-full h-auto object-cover bg-center invert rotate-15" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e3eed919-264d-4077-8d44-0446bab683ee_3840w.jpg" style={{filter: 'contrast(1.1) saturate(0) brightness(1.2)', maskImage: 'linear-gradient(180deg, transparent, black 20%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 20%, black 80%, transparent)'}}/>
<div className="absolute top-[40%] left-[30%] w-32 h-64 bg-red-600/20 mix-blend-overlay blur-3xl rounded-full"></div>
</div>
</div>
</div>

<div className="md:left-24 -translate-y-1/2 z-30 animate-clip-text delay-500 absolute top-1/2 left-6">
</div>

<div className="z-0 flex pointer-events-none animate-clip-text delay-500 w-[400px] h-full absolute top-0 right-0 bottom-0 items-center justify-end">

...
gtag('config', 'G-2M6V79H761');
      ...
      document.querySelectorAll('button').forEach((btn) => {
        if (btn.textContent.trim() === 'Imprimir') btn.addEventListener('click', () => window.print());
        if (btn.textContent.trim() === 'Duplicar') btn.addEventListener('click', async () => {
          const title = "Auditoría de Diagnóstico Inicial";
          try {
            await navigator.clipboard.writeText(title);
            btn.classList.add('ring-2','ring-blue-500/40');
            setTimeout(() => btn.classList.remove('ring-2','ring-blue-500/40'), 900);
          } catch (e) {}
        });
      });
...
<div className="absolute inset-0 bg-[radial-gradient(ellipse_100%_100%_at_50%_-20%,rgba(234,88,12,0.25),transparent_80%)]"></div>
<div className="absolute inset-0 opacity-20 [background-image:linear-gradient(to_right,rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:3rem_3rem]"></div>
</div>
<div className="sm:px-6 lg:px-8 w-full max-w-6xl mr-auto ml-auto pr-4 pl-4 relative">

<header className="pt-16 sm:pt-24 flex flex-col items-center text-center relative z-10">
<div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-orange-500/30 bg-orange-500/10 mb-6 shadow-[0_0_30px_rgba(234,88,12,0.3)]">
...
<div className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-orange-500/20 text-orange-300 ring-1 ring-orange-400/30 shadow-[0_0_15px_rgba(234,88,12,0.2)]">
...
<section className="rounded-2xl border border-white/10 bg-white/5 hover-card">
...
<section className="mt-6 rounded-2xl border border-white/10 bg-white/5 hover-card">
<div className="flex items-start justify-between gap-4 border-b border-white/10 p-5 sm:p-6">
<div className="min-w-0">
<h2 className="text-lg sm:text-xl font-semibold tracking-tight text-zinc-50">
...
<div className="rounded-2xl border border-white/10 bg-zinc-950/30 p-4 sm:p-5">
<p className="text-sm sm:text-base font-medium text-zinc-100">
                      ¿Utilizáis un CRM? (HubSpot, Pipedrive, Salesforce,
                      Excel). ¿Qué versión/plan tenéis?
                    </p>
<textarea className="mt-3 w-full rounded-xl border border-white/10 bg-zinc-950/40 px-4 py-3 text-sm sm:text-base text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30" placeholder="Herramienta, plan, usuarios, quién administra, limitaciones..." rows="3"></textarea>
<div className="mt-3 rounded-xl border border-white/10 bg-white/5 p-3">
<p className="text-xs font-medium uppercase tracking-widest text-zinc-400">
                        Consejo (lógica condicional para formulario)
                      </p>
<p className="mt-1 text-sm sm:text-base text-zinc-200">
                        Pregunta:
                        <span className="font-medium text-zinc-100">
...
<br/>
                        Si
                        <span className="font-medium text-zinc-100">SÍ</span>
                        : muestra
                        <span className="font-medium text-zinc-100">“¿Cuál?”</span>
<br/>
                        Si
                        <span className="font-medium text-zinc-100">NO</span>
                        : muestra
                        <span className="font-medium text-zinc-100">
                          “¿Dónde apuntáis los leads? (Excel, Papel, Notas)”
                        </span>
</p>
</div>
</div>
...
<div className="rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 hover-card text-left">

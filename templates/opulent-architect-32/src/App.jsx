...
<a className="nav-logo" href="#">Opulent Architect</a>
...
<p className="testimonial-text">"Opulent Architect didn't just design a house; they shaped a sanctuary that feels entirely rooted in the landscape. Our energy bills are practically non-existent, yet the space feels luxurious and warm."</p>
...
<p className="testimonial-text">"Working with Opulent Architect is a truly collaborative experience. They listen deeply, not just to us, but to the land itself. The house they built for us breathes with the seasons."</p>
<div className="testimonial-author">
...
<h3>Opulent Architect Wins Dezeen Architecture Award</h3>
...
<a className="btn-glow" href="mailto:hello@opulentarchitect.com">
...
<div className="footer-logo">Opulent Architect</div>
...
<h4>Contact</h4>
<ul>
<li><a href="mailto:hello@opulentarchitect.com">hello@opulentarchitect.com</a></li>
...
<p>© 2023 Opulent Architect. All rights reserved.</p>

...
card.classList.remove('scale-[1.02]', 'shadow-2xl', 'z-10', 'border-accent', 'ring-1', 'ring-obsidian/5', 'opacity-100');
...
gtag('config', 'G-2M6V79H761');
      ...
      void main() {
          ...
          float alpha = 1.0;
          vec3 color1 = uColor;
          // Interpolate with Red #DC2626
          vec3 color2 = vec3(0.863, 0.149, 0.149);
...
<iconify-icon height="12" icon="solar:round-transfer-linear" style={{strokeWidth: '1.5'}} width="12"></iconify-icon>
</div>
...
<button className="group relative isolate overflow-hidden bg-obsidian text-white text-xs font-semibold px-6 py-2.5 rounded shadow-[0_1px_2px_rgba(0,0,0,0.08)] ring-1 ring-white/10 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:scale-[1.04] hover:shadow-[0_8px_24px_-4px_rgba(249,115,22,0.25)] hover:bg-[#292524] hover:ring-white/20 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-obsidian/20 focus:ring-offset-1">
...
<button className="group relative isolate overflow-hidden bg-accent text-white text-sm font-semibold px-8 py-3.5 rounded shadow-[0_1px_2px_rgba(0,0,0,0.08)] ring-1 ring-white/10 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:scale-[1.03] hover:shadow-[0_12px_32px_-8px_rgba(249,115,22,0.4)] hover:bg-primary active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-accent/20 focus:ring-offset-2 flex items-center gap-2">
...
<style>
                    ...
                    @keyframes pulse-context {
                      0% { transform: scale(1); fill: #1C1917; }
                      5% { transform: scale(1.4); fill: #EA580C; }
                      15% { transform: scale(1); fill: #1C1917; }
                    }
                    ...
                    @keyframes pulse-assumptions {
                      ...
                      30% { stroke-width: 2.5; transform: scale(1.05); stroke: #F97316; }
                      40% { stroke-width: 1.5; transform: scale(1); stroke: #1C1917; }
                    }
                    ...
                    @keyframes pulse-evidence {
                      ...
                      60% { stroke-width: 2.5; transform: scale(1.05); stroke: #EA580C; }
                      70% { stroke-width: 1.5; transform: scale(1); stroke: #1C1917; }
                    }

                    .node-outcome { animation: pulse-outcome 6s infinite ease-out; transform-origin: 320px 150px; }
                    @keyframes pulse-outcome {
                      85% { transform: scale(1); fill: #1C1917; }
                      90% { transform: scale(1.25); fill: #F97316; }
                      100% { transform: scale(1); fill: #1C1917; }
                    }
...
<path d="M50,150 C100,150 100,80 150,80" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>
<path d="M50,150 C100,150 100,220 150,220" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>
<path d="M150,80 C200,80 200,120 250,120" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>
<path d="M150,220 C200,220 200,180 250,180" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>
<path d="M250,120 L320,150" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>
<path d="M250,180 L320,150" fill="none" stroke="#E7E5E4" strokeWidth="2"></path>

<path className="signal-path" d="M50,150 C100,150 100,80 150,80 C200,80 200,120 250,120 L320,150" fill="none" stroke="#F97316" strokeLinecap="round" strokeWidth="2.5"></path>

<circle className="node-context" cx="50" cy="150" fill="#1C1917" r="6"></circle>
<text fill="#1C1917" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" text-anchor="middle" x="50" y="175">
                    Context
                  </text>
<rect className="node-assumptions" fill="white" height="20" rx="4" stroke="#1C1917" strokeWidth="1.5" width="80" x="150" y="70"></rect>
<text dy="1" fill="#1C1917" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="190" y="83">
                    Assumptions
                  </text>
<rect fill="white" height="20" rx="4" stroke="#E7E5E4" width="80" x="150" y="210"></rect>
<rect fill="#FAFAFA" height="20" rx="4" width="60" x="250" y="170"></rect>
<rect className="node-evidence" fill="white" height="20" rx="4" stroke="#1C1917" strokeWidth="1.5" width="60" x="250" y="110"></rect>
<text dy="1" fill="#1C1917" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="9" font-weight="600" text-anchor="middle" x="280" y="123">
                    Evidence
                  </text>
<circle className="node-outcome" cx="320" cy="150" fill="#1C1917" r="12"></circle>
<path className="outcome-check" d="M316 150l3 3 5-5" fill="none" stroke="#FFFFFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
<text fill="#1C1917" fontFamily='"Plus Jakarta Sans", sans-serif' fontSize="10" font-weight="600" text-anchor="middle" x="320" y="178">
                    Outcome
                  </text>
</svg>
...
<div className="absolute inset-0 bg-[radial-gradient(#1C191708_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none"></div>
...
<div className="absolute left-1/2 top-4 w-px bg-accent -translate-x-1/2 transition-all duration-75 ease-linear h-0 max-h-[calc(100%-2rem)]" id="lifecycle-line"></div>
...
<div className="flex items-center gap-2">
<iconify-icon className="text-subtle" height="14" icon="solar:question-circle-linear" width="14"></iconify-icon>
...
<div className="w-8 h-8 bg-canvas rounded flex items-center justify-center border border-border/50">
<iconify-icon className="text-subtle" height="14" icon="solar:chart-square-linear" width="14"></iconify-icon>
</div>
<div>
...
<div className="w-[42%] pl-8">
<span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-red text-white text-xs font-semibold shadow-lg shadow-red/20">
...
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle bg-[#E7E5E4] px-2 py-1 rounded inline-block">
                      SHA: 8f2a...9c1
                    </span>
</div>
<div className="relative shrink-0 z-10">
...
<div className="absolute inset-0 bg-[linear-gradient(to_right,#1C191708_1px,transparent_1px),linear-gradient(to_bottom,#1C191708_1px,transparent_1px)] bg-[size:24px_24px] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
...
<iconify-icon height="20" icon="solar:branching-paths-up-linear" style={{strokeWidth: '1.5'}} width="20"></iconify-icon>
</div>
...
<div className="px-3 py-1 bg-canvas border border-border rounded text-[10px] font-mono text-subtle uppercase tracking-wider group-hover:text-accent group-hover:border-accent/30 transition-colors">
                      Live Trace
                    </div>
</div>
</div>
...
<path d="M0,0 L4,2 L0,4" fill="#1C1917"></path>
</marker>
</defs>

<path d="M20,50 C100,50 120,20 200,20 C280,20 300,80 380,80 C460,80 480,50 560,50" fill="none" stroke="#E7E5E4" stroke-dasharray="4 4" strokeWidth="1.5"></path>

<path className="transition-all duration-[1500ms] ease-in-out group-hover:stroke-dashoffset-0" d="M20,50 C100,50 120,20 200,20 C280,20 300,80 380,80 C460,80 480,50 560,50" fill="none" marker-end="url(#arrow-head)" stroke="#F97316" stroke-dasharray="600" stroke-dashoffset="600" strokeWidth="1.5"></path>

<g className="transition-all duration-500 delay-0 opacity-100 group-hover:scale-110 origin-center">
<circle cx="20" cy="50" fill="#1C1917" r="4"></circle>
...
<circle cx="200" cy="20" fill="#fff" r="4" stroke="#1C1917" strokeWidth="1.5"></circle>
...
<circle cx="380" cy="80" fill="#fff" r="4" stroke="#1C1917" strokeWidth="1.5"></circle>
...
<circle cx="560" cy="50" fill="#EA580C" r="4"></circle>
<text className="text-[8px] font-mono fill-[#EA580C] font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300" text-anchor="middle" x="560" y="70">
                        RESULT
                      </text>
</g>
</svg>
...
<div className="relative w-full h-16 bg-white border border-border rounded shadow-sm flex items-center px-4 gap-4 z-10 transition-transform duration-300 group-hover:translate-y-[-5px] group-hover:shadow-md group-hover:border-obsidian/20">
...
<div className="h-full w-2/3 bg-obsidian/20 group-hover:bg-accent/40 transition-colors duration-500"></div>
</div>
</div>
</div>
</div>
...
<div className="absolute inset-0 rounded-full border-t border-accent transparent animate-spin [animation-duration:3s] opacity-0 group-hover:opacity-100"></div>
<iconify-icon className="text-subtle group-hover:text-accent transition-colors" height="20" icon="solar:history-linear" style={{strokeWidth: '1.5'}} width="20"></iconify-icon>
</div>

<div className="w-24 h-32 bg-white border border-border shadow-lg rounded-sm p-4 space-y-3 transition-all duration-500 group-hover:shadow-xl group-hover:scale-105 group-hover:border-accent/20">
<div className="w-6 h-6 rounded bg-accent/10"></div>
<div className="space-y-1.5">
<div className="h-1.5 w-full bg-obsidian/10 rounded overflow-hidden">
<div className="h-full w-0 bg-accent group-hover:w-full transition-all duration-700 delay-300 ease-out"></div>
</div>
<div className="h-1.5 w-3/4 bg-obsidian/10 rounded overflow-hidden">
<div className="h-full w-0 bg-accent group-hover:w-full transition-all duration-700 delay-500 ease-out"></div>
</div>
<div className="h-1.5 w-5/6 bg-obsidian/10 rounded overflow-hidden">
<div className="h-full w-0 bg-accent group-hover:w-full transition-all duration-700 delay-700 ease-out"></div>
</div>
</div>
</div>
</div>
...
<style>
              .def-active .def-num { border-color: #F97316; color: #FFFFFF; background-color: #F97316; transform: scale(1.1); box-shadow: 0 4px 12px rgba(249,115,22,0.2); }
...
<div className="h-full bg-accent w-0 transition-all duration-700 ease-in-out" id="def-line-fill"></div>
</div>
...
<button aria-label="Previous testimonial" className="group w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-accent hover:border-accent transition-all disabled:opacity-30 disabled:cursor-not-allowed" id="testimonial-prev">
<iconify-icon height="18" icon="solar:alt-arrow-left-linear" style={{strokeWidth: '1.5'}} width="18"></iconify-icon>
</button>
<button aria-label="Next testimonial" className="group w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-accent hover:border-accent transition-all disabled:opacity-30 disabled:cursor-not-allowed" id="testimonial-next">
...
<div>
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform text-accent" id="t-stat-val-0">
                  5x
                </div>
...
<div>
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform text-accent" id="t-stat-val-1">
                  100%
                </div>
...
<div>
<div className="text-3xl font-bold mb-1 transition-all duration-300 ease-out transform text-accent" id="t-stat-val-2">
                  Zero
                </div>
...
<div className="pricing-card group relative p-8 rounded-xl border border-border bg-white flex flex-col cursor-pointer hover:-translate-y-1 hover:shadow-xl hover:border-obsidian/30 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 pricing-transition" id="pricing-hobby" role="button" tabindex="0">

<div className="absolute inset-0 rounded-xl bg-gradient-to-b from-accent/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
...
<button className="w-full py-3 rounded-lg border border-border text-xs font-semibold text-obsidian bg-white transition-all duration-300 ease-out hover:scale-[1.03] hover:border-accent hover:text-accent hover:shadow-[0_0_15px_rgba(249,115,22,0.1)] active:scale-[0.97] active:duration-100 relative z-10">
                Start Trial
              </button>
</div>

<div className="pricing-card group relative p-8 rounded-xl bg-obsidian text-white shadow-xl shadow-obsidian/20 flex flex-col cursor-pointer hover:-translate-y-1 hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent scale-[1.02] z-10 pricing-transition" id="pricing-pro" role="button" tabindex="0">
<div className="mb-4">
<span className="font-semibold text-orangeLight">Team</span>
</div>
...
<button className="w-full py-3 rounded-lg bg-accent text-white text-xs font-semibold transition-all duration-300 ease-out hover:scale-[1.03] hover:bg-primary hover:shadow-[0_0_20px_rgba(249,115,22,0.3)] active:scale-[0.97] active:duration-100 relative z-10">
                Contact Sales
              </button>
</div>

<div className="pricing-card group relative p-8 rounded-xl border border-border bg-white flex flex-col cursor-pointer hover:-translate-y-1 hover:shadow-xl hover:border-obsidian/30 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 pricing-transition" id="pricing-ent" role="button" tabindex="0">
...
<li><a className="hover:text-accent" href="#">Features</a></li>
<li><a className="hover:text-accent" href="#">Security</a></li>
<li><a className="hover:text-accent" href="#">Enterprise</a></li>
</ul>
</div>
<div className="space-y-4">
...
<ul className="space-y-2 text-xs text-subtle">
<li><a className="hover:text-accent" href="#">Twitter</a></li>
<li><a className="hover:text-accent" href="#">LinkedIn</a></li>
<li><a className="hover:text-accent" href="#">GitHub</a></li>
</ul>
</div>
</div>
</div>

...
<div className="absolute w-full h-full left-0 top-0 -z-10" data-scene-id="id-gpef8kfjlordtmepfhybk" data-us-initialized="true" data-us-project="0yOnLW8hxq07qszxBw0D"><canvas aria-label="Unicorn Studio Scene" height="1030" role="img" style={{width: '1040px', height: '687px'}} width="1561"></canvas></div>
...
<a className="text-sm font-medium text-neutral-400 hover:text-cyan-400 transition-colors font-geist" href="#constellation">Constellation</a>
<a className="text-sm font-medium text-neutral-400 hover:text-cyan-400 transition-colors font-geist" href="#schema">Schema</a>
<a className="text-sm font-medium text-neutral-400 hover:text-cyan-400 transition-colors font-geist" href="#pricing">Access</a>
</div>
<div className="flex items-center gap-4">
<div className="hidden md:flex items-center gap-2 px-3 py-1 rounded border border-white/10 bg-white/5">
<span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
<span className="mono-font text-[10px] text-neutral-400 font-geist">GRID: ONLINE</span>
</div>
<button className="bg-white text-black px-5 py-2 text-sm font-semibold hover:bg-cyan-50 transition-colors font-geist">
          Initialize
        </button>
</div>
</div>
...
<div className="inline-flex items-center gap-2 px-3 py-1 mb-8 border border-cyan-500/30 bg-cyan-950/30 text-cyan-400 text-xs font-medium tracking-widest uppercase mono-font font-geist">
<span className="w-2 h-2 border border-cyan-400 bg-cyan-400/50"></span>
    Global Latency &lt; 10ms
  </div>
<h1 className="md:text-8xl text-5xl text-white tracking-tighter mb-6 leading-[1.05] font-playfair font-medium">
  PLANETARY SCALE
  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 via-cyan-400 to-teal-500 decrypt-target font-playfair font-medium" data-value="DATA MESH">DATA MESH</span>
</h1>
<p className="max-w-xl mx-auto text-lg text-neutral-400 mb-10 leading-relaxed font-light font-geist">
    The first decentralized orbital network for high-frequency trading and autonomous logistics.
    <span className="text-white font-geist">Zero terrestrial bottlenecks.</span>
</p>
...
<button className="px-8 py-4 bg-transparent border border-white/10 text-white hover:border-cyan-500/50 hover:text-cyan-400 hover:bg-cyan-950/10 transition-all font-medium mono-font text-sm font-geist">
          VIEW DOCUMENTATION
        </button>
</div>
</div>
...
<div className="flex items-center gap-16 px-8">
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:database" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5v14a9 3 0 0 0 18 0V5"></path><path d="M3 12a9 3 0 0 0 18 0"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">DATA_HEAVY</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:shield-check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12l2 2l4-4"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">SECURE_NET</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:globe" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20a14.5 14.5 0 0 0 0-20M2 12h20"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">GLOBAL_OPS</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:code-2" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="m18 16l4-4l-4-4M6 8l-4 4l4 4m8.5-12l-5 16" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> <span className="text-2xl brand-font text-cyan-800 font-playfair font-medium">SYNTAX_CORP</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:wifi" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 20h.01M2 8.82a15 15 0 0 1 20 0M5 12.859a10 10 0 0 1 14 0m-10.5 3.57a5 5 0 0 1 7 0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">SIGNAL_IO</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:server" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><rect height="8" rx="2" ry="2" width="20" x="2" y="2"></rect><rect height="8" rx="2" ry="2" width="20" x="2" y="14"></rect><path d="M6 6h.01M6 18h.01"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">MAINFRAME</span></div>
</div>
<div className="flex items-center gap-16 px-8">
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:database" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5v14a9 3 0 0 0 18 0V5"></path><path d="M3 12a9 3 0 0 0 18 0"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">DATA_HEAVY</span></div>
<div className="flex items-center gap-2"><svg aria-hidden="true" data-icon="lucide:shield-check" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12l2 2l4-4"></path></g></svg> <span className="text-2xl brand-font text-cyan-900 font-playfair font-medium">SECURE_NET</span></div>
...
<div className="">
<h2 className="text-4xl md:text-5xl text-white mb-4 decrypt-target font-playfair font-medium" data-value="Global Constellation">Global Constellation</h2>
<p className="text-neutral-400 max-w-md font-geist">Real-time telemetry of the active node topology. Monitoring 4,203 satellites in Low Earth Orbit.</p>
</div>
<div className="flex flex-col items-end">
<div className="text-4xl text-cyan-400 mono-font font-playfair font-medium">4,203</div>
<div className="text-xs text-neutral-500 uppercase tracking-widest font-geist">Active Nodes</div>
</div>
</div>
...
<span className="font-geist">SIGNAL STRENGTH: 98%</span>
</div>
<div className="text-neutral-500 font-geist">
          LAT: 34.0522 N 
          LON: 118.2437 W
        </div>
</div>
...
<div className="text-cyan-500 mono-font text-xs mb-4 font-geist">/// ARCHITECTURE VIEW</div>
<h2 className="text-3xl text-white mb-6 font-playfair font-medium">Neural Uplink Schema</h2>
<p className="text-neutral-400 mb-6 leading-relaxed font-geist">
...
<text className="font-geist" fill="#666" fontFamily="monospace" fontSize="10" text-anchor="middle" x="50" y="230">SOURCE</text>
<circle className="pulse-node" cx="200" cy="200" fill="#333" r="4"></circle>
<rect height="40" rx="4" stroke="#444" width="40" x="180" y="180"></rect>
<text className="font-geist" fill="#666" fontFamily="monospace" fontSize="10" text-anchor="middle" x="200" y="240">ENCRYPT</text>
...
<text className="font-geist" fill="#666" fontFamily="monospace" fontSize="10" text-anchor="middle" x="600" y="240">DECRYPT</text>
<circle cx="750" cy="200" fill="#333" r="4"></circle>
<text className="font-geist" fill="#666" fontFamily="monospace" fontSize="10" text-anchor="middle" x="750" y="230">TARGET</text>
</svg>
<div className="absolute top-4 right-4 text-xs text-cyan-500 mono-font animate-pulse font-geist">LIVE TRAFFIC VIEW</div>
</div>
</div>
</div>
</section>
...
<h2 className="text-4xl text-white mb-4 font-playfair font-medium">Protocol Layers</h2>
<p className="text-neutral-500 font-geist">Full stack verification from physical uplink to application logic.</p>
</div>
...
<div className="text-xs text-neutral-600 mono-font mb-2 font-geist">LAYER 1</div>
<div className="text-white font-bold mb-1 font-geist">Physical</div>
<div className="text-xs text-neutral-400 font-geist">Laser Optical Link</div>
...
<div className="text-xs text-neutral-600 mono-font mb-2 font-geist">LAYER 2</div>
<div className="text-white font-bold mb-1 font-geist">Network</div>
<div className="text-xs text-neutral-400 font-geist">Orbital Mesh Routing</div>
<div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
...
<div className="text-xs text-neutral-600 mono-font mb-2 font-geist">LAYER 3</div>
<div className="text-white font-bold mb-1 font-geist">Transport</div>
<div className="text-xs text-neutral-400 font-geist">Quantum Encryption</div>
<div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
...
<div className="text-xs text-neutral-600 mono-font mb-2 font-geist">LAYER 4</div>
<div className="text-white font-bold mb-1 font-geist">Application</div>
<div className="text-xs text-neutral-400 font-geist">Edge Compute API</div>
<div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
...
<div className="px-2 py-0.5 rounded bg-cyan-900/30 border border-cyan-500/30 text-cyan-400 text-[10px] font-bold uppercase tracking-wider font-geist">Developer API</div>
</div>
<h2 className="text-4xl md:text-5xl text-white mb-6 decrypt-target font-playfair font-medium" data-value="Direct Neural Interface">Direct Neural Interface</h2>
<p className="text-neutral-400 mb-8 leading-relaxed max-w-md font-geist">
...
<div className="w-8 h-8 rounded bg-neutral-800 flex items-center justify-center text-white shrink-0 mt-1 font-geist">1</div>
<div>
<h4 className="text-white font-medium font-geist">Install CLI</h4>
<p className="text-sm text-neutral-500 font-geist">npm install -g orbital-cli</p>
</div>
</div>
<div className="flex items-start gap-4">
<div className="w-8 h-8 rounded bg-neutral-800 flex items-center justify-center text-white shrink-0 mt-1 font-geist">2</div>
<div>
<h4 className="text-white font-medium font-geist">Authenticate</h4>
<p className="text-sm text-neutral-500 font-geist">orbital auth --token=sk_live_...</p>
</div>
</div>
</div>
</div>
...
<div className="ml-auto text-xs text-neutral-600 mono-font font-geist">bash — 80x24</div>
</div>
<div className="p-6 font-mono text-sm text-neutral-300">
<p className="mb-2 font-geist"><span className="text-green-500 font-geist">user@orbital</span>:<span className="text-blue-500 font-geist">~</span>$ orbital connect --region=us-east</p>
<p className="mb-2 text-neutral-500 font-geist">Initializing handshake...</p>
<p className="mb-2 text-neutral-500 font-geist">Resolving sat_id: <span className="text-yellow-500 font-geist">SAT-9942</span></p>
<p className="mb-2"><span className="text-cyan-400 font-geist">✓ Link established (3ms)</span></p>
<div className="mt-2 flex items-center"><span className="text-green-500 mr-2 font-geist">➜</span><span className="w-2 h-4 bg-white cursor-blink"></span></div>
</div>
</div>
...
<span className="text-xs text-cyan-500 font-bold mono-font font-geist">JSON_RESPONSE</span>
<div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse"></div>
</div>
<div className="p-6 font-mono text-sm text-cyan-100/80">
<pre className="font-geist">{
  "status": "connected",
  "node": "LEO-492",
  "latency": "4ms",
...
<span className="text-xs text-emerald-500 font-bold mono-font font-geist">SECURE_CHANNEL</span>
</div>
...
<h4 className="text-white font-bold font-geist">End-to-End Encrypted</h4>
<p className="text-xs text-neutral-500 mt-1 font-geist">Keys managed via satellite hardware module</p>
</div>
</div>
</div>
</div>
...
<div className="max-w-7xl mx-auto px-6">
<div className="text-center mb-16">
<h2 className="text-4xl md:text-5xl text-white mb-4 decrypt-target font-playfair font-medium" data-value="Access Tiers">Access Tiers</h2>
<p className="text-neutral-400 font-geist">Scale your bandwidth from atmospheric to deep space.</p>
</div>
...
<button className="w-full py-3 rounded border border-white/10 text-white hover:bg-white hover:text-black transition-colors font-medium font-geist">Select Plan</button>
</div>

<div className="book-cover">
<div className="text-xs text-neutral-500 font-bold uppercase tracking-widest mb-4 font-geist">Atmospheric</div>
<div className="text-3xl text-white mb-6 font-playfair font-medium">$499<span className="text-sm text-neutral-500 font-normal font-geist">/mo</span></div>
<p className="text-sm text-neutral-400 font-geist">Hover to open specifications</p>
...
<button className="w-full py-3 rounded bg-cyan-600 text-white hover:bg-cyan-500 transition-colors font-medium shadow-[0_0_20px_rgba(6,182,212,0.3)] font-geist">Initialize</button>
</div>

<div className="book-cover">
<div className="absolute top-0 right-0 bg-cyan-500 text-black text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase tracking-wider font-geist">Recommended</div>
<div className="text-xs text-cyan-400 font-bold uppercase tracking-widest mb-4 font-geist">Stratospheric</div>
<div className="text-4xl text-white mb-6 font-playfair font-medium">$1,299<span className="text-sm text-neutral-500 font-normal font-geist">/mo</span></div>
<p className="text-sm text-neutral-400 font-geist">Hover to open specifications</p>
<div className="mt-auto flex justify-end">
<svg aria-hidden="true" data-icon="lucide:arrow-right" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</div>
...
<button className="w-full py-3 rounded border border-white/10 text-white hover:bg-white hover:text-black transition-colors font-medium font-geist">Contact Sales</button>
</div>

<div className="book-cover">
<div className="text-xs text-neutral-500 font-bold uppercase tracking-widest mb-4 font-geist">Orbital</div>
<div className="text-3xl text-white mb-6 font-playfair font-medium">Custom</div>
<p className="text-sm text-neutral-400 font-geist">Hover to open specifications</p>
<div className="mt-auto flex justify-end">
<svg aria-hidden="true" data-icon="lucide:arrow-right" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</div>
...
<h2 className="text-4xl text-white mb-4 decrypt-target font-playfair font-medium" data-value="Transmission Logs">Transmission Logs</h2>
<p className="text-neutral-500 font-geist">Encrypted testimonials from the deep web.</p>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Commander Shepard</div>
<div className="text-xs text-cyan-500 mono-font font-geist">SSV NORMANDY</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"The latency on the Orbital grid is practically non-existent. We stream telemetry from the outer rim without a single packet drop."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Dr. Aris Arasaka</div>
<div className="text-xs text-cyan-500 mono-font font-geist">NETWATCH</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"Security is paramount when dealing with rogue AIs. Orbital's quantum encryption layer is the only thing we trust."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Unit 734</div>
<div className="text-xs text-cyan-500 mono-font font-geist">AUTONOMOUS COLLECTIVE</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"Uplink successful. Throughput exceeds terrestrial limitations by 400%. Logic execution at edge nodes confirmed."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Sarah Connor</div>
<div className="text-xs text-cyan-500 mono-font font-geist">RESISTANCE</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"They can't shut this network down. It's decentralized, resilient, and fast. Exactly what we needed."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Hiro Protagonist</div>
<div className="text-xs text-cyan-500 mono-font font-geist">METAVERSE COURIER</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"Delivering heavy data payloads used to be a headache. With the Orbital API, I just point and shoot."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
...
<div>
<div className="text-sm font-bold text-white font-geist">Elon M.</div>
<div className="text-xs text-cyan-500 mono-font font-geist">MARS COLONY 1</div>
</div>
</div>
<p className="text-sm text-neutral-300 leading-relaxed font-geist">"The interplanetary lag is finally manageable. We are using Orbital for all colony logistics."</p>
<div className="mt-4 pt-4 border-t border-white/5 flex justify-between text-[10px] text-neutral-500 mono-font">
<span className="font-geist">SECURE_CHANNEL</span>
<span className="font-geist">VERIFIED</span>
</div>
...
<h2 className="text-4xl text-white mb-6 font-playfair font-medium">Ready to leave the atmosphere?</h2>
...
<button className="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-3 text-sm font-bold uppercase transition-colors font-geist">Connect</button>
</div>
</div>
<div className="flex gap-16">
<div className="flex flex-col gap-4">
<h4 className="text-neutral-500 text-xs font-bold uppercase tracking-widest mb-2 font-geist">Protocol</h4>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">Documentation</a>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">API Reference</a>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">Node Status</a>
</div>
<div className="flex flex-col gap-4">
<h4 className="text-neutral-500 text-xs font-bold uppercase tracking-widest mb-2 font-geist">Corporation</h4>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">About</a>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">Careers</a>
<a className="text-neutral-300 hover:text-cyan-400 transition-colors text-sm font-geist" href="#">Legal</a>
</div>
</div>
</div>
...
<p className="font-geist">© 2088 ORBITAL INDUSTRIES. ALL RIGHTS RESERVED.</p>
<div className="flex gap-4 mt-4 md:mt-0">
<span className="font-geist">SECURED BY QUANTUM-256</span>
<span className="font-geist">LOCATION: LOW EARTH ORBIT</span>
</div>
</div>
</div>
</footer>

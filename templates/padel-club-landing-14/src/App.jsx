...
<button className="w-full py-3 rounded-xl border border-gray-200 font-medium text-sm hover-black hover:bg-black hover:text-white transition-all font-geist">Book Court</button>
</div>

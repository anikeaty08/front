...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="top-0 w-full h-screen -z-10 mix-blend-soft-light bg-cover bg-center absolute" data-alpha-mask="80" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/27bd390e-0c99-4da9-80f7-d800070eaa60_3840w.png")', maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 80%, transparent)'}}></div>


<nav className="fixed sm:px-6 z-50 pt-4 pr-4 pb-4 pl-4 top-0 right-0 left-0">
<div className="flex transition-all hover:bg-white/20 bg-white/10 max-w-7xl border-white/20 border rounded-full mr-auto ml-auto pt-3 pr-6 pb-3 pl-6 shadow-lg backdrop-blur-xl items-center justify-between">
<div className="flex items-center gap-2.5">

<span className="text-base font-light text-white tracking-tight drop-shadow-md">Firm Collective</span>
</div>
<div className="hidden md:flex gap-8 gap-x-8 gap-y-8 items-center">
<a className="hover:text-white hover:bg-white/10 transition-all text-sm font-medium text-white/90 rounded-full pt-1.5 pr-3 pb-1.5 pl-3" href="#">Philosophy</a>
<a className="hover:text-white hover:bg-white/10 transition-all text-sm font-medium text-white/90 rounded-full pt-1.5 pr-3 pb-1.5 pl-3" href="#">People</a>
<a className="hover:text-white hover:bg-white/10 transition-all text-sm font-medium text-white/90 rounded-full pt-1.5 pr-3 pb-1.5 pl-3" href="#">Portfolio</a>
</div>
<div className="flex items-center gap-3">
<button className="hidden md:flex gap-2 hover:bg-stone-100 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 text-sm font-medium text-stone-900 bg-white rounded-full pt-2.5 pr-5 pb-2.5 pl-5 gap-x-2 gap-y-2 items-center">LPs -&gt;</button>
...
<img alt="Padel Community" className="w-full h-full object-cover hero-bg-animate" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/27bd390e-0c99-4da9-80f7-d800070eaa60_3840w.png" style={{}}/>

<div className="bg-gradient-to-b from-black/60 via-black/40 to-black/80 absolute top-0 right-0 bottom-0 left-0"></div>
</div>
<div className="sm:px-6 lg:px-8 lg:pt-210 z-10 text-center max-w-7xl mr-auto ml-auto pt-20 pr-4 pl-4 relative">
<h1 className="leading-[1.05] sm:text-6xl lg:text-7xl text-5xl font-semibold text-white tracking-tight text-center mb-8">Backing managers <br/> <span className="text-white/60">building firms to last.</span></h1>
<p className="leading-relaxed sm:text-base text-lg font-light text-stone-200 max-w-xl mr-auto mb-10 ml-auto">We partner early with next-gen managers building enduring venture firms through earned access, domain fluency and deep conviction.</p>
...
<section className="sm:px-6 lg:px-8 bg-neutral-800 px-4 py-12">
...
</section><section className="sm:px-6 lg:px-8 pt-12 pr-4 pb-12 pl-4">
<div className="max-w-7xl mr-auto ml-auto">
<div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
<div className="">
<span className="uppercase block text-sm font-semibold text-[#0379B9] tracking-wider mb-2" style={{}}>Philosophy</span>
<h2 className="md:text-4xl text-3xl font-semibold text-stone-900 tracking-tight">Upcoming Events</h2>
...
<img alt="Community Group" className="relative rounded-3xl shadow-xl w-full object-cover aspect-[4/3] rotate-2 border-4 border-white" src="default" style={{}}/>
</div>

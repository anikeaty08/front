...
<span className="font-display text-[9px] sm:text-[10px] tracking-[0.18em] uppercase text-[#F5F7FA] whitespace-nowrap truncate">
              Parallel Worlds
              <span className="text-[#7D8794]">|| Studio</span>
</span>
</a>

<div className="hidden xl:flex items-center border border-[#171A1F]/80 bg-[#0C0D10]/90">
<a className="font-display text-[10px] tracking-[0.18em] uppercase text-[#B8C0CC] px-6 py-3 border-r border-[#171A1F]/80 transition-colors duration-300 hover:text-[#CFAE6E]" href="#thesis">
              Thesis
            </a>
<a className="font-display text-[10px] tracking-[0.18em] uppercase text-[#B8C0CC] px-6 py-3 border-r border-[#171A1F]/80 transition-colors duration-300 hover:text-[#CFAE6E]" href="#principles">
              Principles
            </a>
<a className="font-display text-[10px] tracking-[0.18em] uppercase text-[#B8C0CC] px-6 py-3 border-r border-[#171A1F]/80 transition-colors duration-300 hover:text-[#CFAE6E]" href="#architecture">
              Architecture
            </a>
<a className="font-display text-[10px] tracking-[0.18em] uppercase text-[#B8C0CC] px-6 py-3 transition-colors duration-300 hover:text-[#CFAE6E]" href="#applications">
              Realities
            </a>
</div>

<div className="hidden xl:flex items-center">
<a className="group inline-flex items-center gap-3 border border-[#232833] bg-[#111318]/90 px-4 sm:px-5 py-3 font-display text-[10px] tracking-[0.18em] uppercase text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]" href="#thesis">
...
<div className="hidden absolute right-0 top-full mt-2 w-[260px] border border-[#171A1F]/80 bg-[#050505]/95 backdrop-blur-md" id="tablet-menu">
...
<span className="font-display text-[16vw] leading-none tracking-[-0.08em] text-transparent bg-clip-text bg-gradient-to-r from-[#d7dde8]/[0.025] via-[#9ED8FF]/[0.05] to-[#d7dde8]/[0.02]">
          PARALLEL
        </span>
</div>
...
<span className="font-display text-[9px] sm:text-[10px] md:text-[11px] uppercase tracking-[0.16em] md:tracking-[0.18em] text-[#B8C0CC] leading-tight">
...
<span className="block text-[#F5F7FA] text-[2.55rem] sm:text-[3.6rem] md:text-[4.7rem] lg:text-[5.8rem] xl:text-[6.6rem]">
              Designing
            </span>
<span className="block text-[2.55rem] sm:text-[3.6rem] md:text-[4.7rem] lg:text-[5.8rem] xl:text-[6.6rem] text-transparent bg-clip-text bg-gradient-to-r from-[#9ED8FF] via-[#74C7FF] to-[#C8EAFF] drop-shadow-[0_0_20px_rgba(158,216,255,0.12)]">
              Parallel
            </span>
<span className="block text-[#DCE3EE] text-[2.55rem] sm:text-[3.6rem] md:text-[4.7rem] lg:text-[5.8rem] xl:text-[6.6rem]">
              Worlds
            </span>
</h1>

<p className="text-[#AEB8C6] text-[0.95rem] sm:text-[1rem] md:text-base max-w-[42rem] md:max-w-[34rem] xl:max-w-[42rem] font-light leading-relaxed">
...
<a className="group inline-flex items-center gap-4 border border-[#232833] bg-[#0C0D10]/90 px-5 md:px-7 py-3.5 md:py-4 font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]" href="#thesis">
<span className="inline-flex items-center gap-3">
<span className="w-1.5 h-1.5 bg-[#9ED8FF] transition-colors duration-300 group-hover:bg-[#CFAE6E]"></span>
<span className="">Enter World</span>
</span>
...
<div className="relative w-full max-w-[25rem] md:max-w-[21rem] xl:max-w-[24.5rem] border border-[#171A1F]/80 bg-[#090B0E]/45 backdrop-blur-[2px] px-5 py-5 md:px-6 md:py-6">
...
<span className="font-display text-[10px] uppercase tracking-[0.18em] text-[#D7DEE8]">
                Active Environment
              </span>
</div>
<div className="space-y-3">
<div className="flex items-start justify-between gap-6 border-b border-[#171A1F]/70 pb-3">
<span className="font-display text-[9px] uppercase tracking-[0.16em] text-[#7D8794] pt-0.5">
                  Coordinates
                </span>
<span className="text-[12px] md:text-[13px] text-[#E4EBF4] tracking-[0.08em] uppercase text-right leading-[1.45]">
<span className="block whitespace-nowrap">40.7128° N</span>
<span className="block whitespace-nowrap">74.0060° W</span>
</span>
</div>
<div className="flex items-start justify-between gap-6 border-b border-[#171A1F]/70 pb-3">
<span className="font-display text-[9px] uppercase tracking-[0.16em] text-[#7D8794]">
                  Status
                </span>
<span className="text-[12px] md:text-[13px] text-[#BFD8EE] tracking-[0.08em] uppercase whitespace-nowrap">
                  Active
                </span>
</div>
...
<span className="text-[12px] md:text-[13px] text-[#E4EBF4] tracking-[0.08em] uppercase whitespace-nowrap">
                  Editorial Thesis
                </span>
</div>
</div>
...
<span className="text-[10px] uppercase tracking-[0.18em] text-[#8A93A1]">
                Signal Calibrated
              </span>
</div>
</div>
...
<div className="absolute inset-0 bg-[#9ED8FF]/22 backdrop-blur-[3px]"></div>
...
<div className="absolute left-[18%] top-[18%] h-[180px] w-[180px] rounded-full bg-[#9ED8FF]/[0.03] blur-[90px]"></div>
<div className="absolute right-[12%] bottom-[12%] h-[160px] w-[160px] rounded-full bg-[#CFAE6E]/[0.02] blur-[100px]"></div>
</div>
...
<span className="text-[10px] md:text-[11px] uppercase text-[#D6C29A] tracking-[0.18em] font-display">
                02 / The Thesis
              </span>
</div>
</div>
...
<h2 className="font-display leading-[1.08] tracking-[-0.04em] max-w-[19ch] text-[1.25rem] sm:text-[1.5rem] md:text-[1.8rem] lg:text-[2.2rem] text-[#F5F7FA]">
              The interface is a boundary.
              <span className="text-[#9ED8FF]">
                We are dismantling it to build immersive logic systems
              </span>
<span className="text-[#DCE3EE]">
                where interaction feels like habitation.
              </span>
</h2>
...
<p className="text-[11px] md:text-[12px] uppercase tracking-[0.18em] text-[#A08E68] leading-relaxed">
...
<div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#171A1F] to-transparent"></div>
<div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#171A1F] to-transparent"></div>
<div className="absolute left-[14%] top-[22%] h-[180px] w-[180px] rounded-full bg-[#9ED8FF]/[0.025] blur-[90px]"></div>
<div className="absolute right-[12%] bottom-[16%] h-[160px] w-[160px] rounded-full bg-[#CFAE6E]/[0.02] blur-[100px]"></div>
</div>
<div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">

<div className="overflow-hidden flex bg-[#0C0D10]/50 h-full min-h-[400px] rounded-none p-8 md:p-12 relative items-center border border-[#171A1F]">
...
<span className="flex h-8 w-10 items-center justify-center bg-[#050505] border border-[#171A1F] font-display text-[10px] text-[#9ED8FF]">
                    L.01
                  </span>
<div className="inline-flex items-center gap-2 bg-[#12141A] border border-[#171A1F] px-3 py-1.5 text-[10px] tracking-widest text-[#F5F7FA] uppercase">
                    Foundation
                  </div>
</div>
...
<span className="flex h-8 w-10 items-center justify-center bg-[#050505] border border-[#171A1F] font-display text-[10px] text-[#CFAE6E]">
                    L.04
                  </span>
</div>
</div>
...
<span className="w-8 h-px bg-[#CFAE6E]"></span>
<p className="font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#D6C29A]">
                  03 / System Architecture
                </p>
</div>
<h2 className="font-display text-[2rem] sm:text-[2.5rem] lg:text-[3.2rem] tracking-[-0.045em] uppercase text-[#F5F7FA] leading-[1.02] max-w-[11ch]">
                Built in
                <span className="text-[#9ED8FF]">layers</span>
                .
              </h2>
<p className="text-[#B8C0CC] text-[1rem] md:text-[1.05rem] font-light max-w-xl leading-[1.85]">
...
<div className="font-display text-xs text-[#7D8794] mt-1 w-8 group-hover:text-[#9ED8FF] transition-colors">
                  L.01
                </div>
<div className="flex-1">
<h3 className="font-display text-lg tracking-tight uppercase text-[#F5F7FA]">
                    Spatial Foundation
                  </h3>
<p className="mt-2 text-[#9AA6B5] text-sm md:text-[0.95rem] font-light leading-[1.8]">
                    The underlying geometry of the world — scale, alignment,
                    depth, containment, and the structural logic that gives
                    every element a place to exist.
                  </p>
</div>
</div>
...
<p className="mt-2 text-[#9AA6B5] text-sm md:text-[0.95rem] font-light leading-[1.8]">
                    Typography, contrast, material language, and directional
                    cues transform the structure into something legible,
                    atmospheric, and emotionally precise.
                  </p>
</div>
</div>
...
<p className="mt-2 text-[#9AA6B5] text-sm md:text-[0.95rem] font-light leading-[1.8]">
                    Motion, response, sequencing, and state change define how
                    the world behaves over time — not as animation for
                    decoration, but as a readable system of cause and effect.
                  </p>
</div>
</div>

<div className="flex gap-6 group cursor-default">
<div className="font-display text-xs text-[#7D8794] mt-1 w-8 group-hover:text-[#CFAE6E] transition-colors">
                  L.04
                </div>
<div className="flex-1">
<h3 className="font-display text-lg tracking-tight uppercase text-[#F5F7FA]">
...
<p className="mt-2 text-[#9AA6B5] text-sm md:text-[0.95rem] font-light leading-[1.8]">
                    The final layer: mood, tension, and sensory coherence. This
                    is where a digital interface stops feeling assembled and
...
<div className="absolute right-[10%] bottom-[12%] h-[150px] w-[150px] rounded-full bg-[#CFAE6E]/[0.02] blur-[90px]"></div>
</div>
<div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
...
<span className="w-8 h-px bg-[#CFAE6E]"></span>
<h2 className="font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#D6C29A]">
                04 / Projected Realities
              </h2>
</div>
<h3 className="font-display uppercase leading-[0.98] tracking-[-0.045em] text-[#F5F7FA] text-[2rem] sm:text-[2.5rem] md:text-[3.2rem] max-w-[10ch]">
              Constructed
              <span className="block text-[#9ED8FF]">Environments</span>
</h3>
<p className="text-[0.98rem] md:text-[1.05rem] text-[#B8C0CC] font-light mt-5 max-w-2xl leading-[1.85]">
...
<img alt="Editorial Environments" className="aspect-video w-full object-cover opacity-60 grayscale mix-blend-screen transition-all duration-700 group-hover:opacity-88 group-hover:grayscale-0 group-hover:mix-blend-normal group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/889ebd8a-b88e-43e7-82e3-7678d849acc2_3840w.jpg?w=800&amp;q=80"/>
...
<span className="inline-flex items-center border border-[#9ED8FF]/30 bg-[#9ED8FF]/10 px-2 py-1 text-[10px] uppercase tracking-widest text-[#9ED8FF]">
                  ENV.01
                </span>
</div>
<h4 className="font-display text-[1.2rem] sm:text-[1.4rem] uppercase tracking-[-0.03em] text-[#F5F7FA]">
                Editorial Environments
              </h4>
<p className="mt-3 text-sm md:text-[0.95rem] text-[#9AA6B5] font-light leading-[1.8] max-w-2xl">
...
<span className="mt-1.5 w-1.5 h-1.5 bg-[#CFAE6E] shrink-0"></span>
<p className="text-[11px] md:text-[12px] uppercase tracking-[0.18em] text-[#A08E68] leading-relaxed">
                  Designed for brands that need presence, not just presentation.
                </p>
</div>
</div>
</div>
...
<h4 className="font-display text-lg uppercase tracking-tight text-[#F5F7FA]">
                  Product Realities
                </h4>
<span className="inline-flex items-center border border-[#9ED8FF]/30 bg-[#9ED8FF]/10 px-2 py-1 text-[10px] uppercase tracking-widest text-[#9ED8FF]">
                  ENV.02
...
<p className="mt-2 text-sm text-[#7D8794] font-light leading-relaxed">
                Identities expressed as environments with mood, hierarchy, and
                depth.
              </p>
<div className="mt-6 overflow-hidden border border-[#171A1F]">
...
<span className="inline-flex items-center border border-[#171A1F] bg-[#12141A] px-2 py-1 text-[10px] uppercase tracking-widest text-[#7D8794]">
                  ENV.04
                </span>
</div>
<p className="mt-2 text-sm text-[#7D8794] font-light leading-relaxed">
                Speculative interfaces shaped for post-screen behavior and
                adaptive perception.
              </p>
<div className="mt-6 overflow-hidden border border-[#171A1F]">
...
<p className="mt-2 text-sm text-[#7D8794] font-light leading-relaxed">
                Transactions and decision paths embedded within immersive
                environments.
              </p>
<div className="mt-6 overflow-hidden border border-[#171A1F]">
...
<p className="mt-2 text-sm text-[#7D8794] font-light leading-relaxed">
                Intent translated directly into environmental response and
                adaptive states.
              </p>
<div className="mt-6 overflow-hidden border border-[#171A1F]">
...
<div className="absolute left-1/2 top-[18%] -translate-x-1/2 h-[220px] w-[520px] bg-[#9ED8FF]/[0.05] blur-[120px]"></div>
<div className="absolute right-[18%] bottom-[20%] h-[160px] w-[160px] bg-[#CFAE6E]/[0.03] blur-[90px] rounded-full"></div>
...
<span className="font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#D6C29A]">
              06 / Closing Vision
            </span>
<span className="w-8 md:w-10 h-px bg-[#CFAE6E]"></span>
</div>

<h2 className="font-display uppercase leading-[0.96] tracking-[-0.045em] text-[#F5F7FA] text-[1.9rem] sm:text-[2.5rem] md:text-[3.2rem] lg:text-[4.1rem] max-w-[16ch] mx-auto">
...
<p className="mt-8 md:mt-10 max-w-2xl mx-auto text-[1rem] md:text-[1.08rem] text-[#B8C0CC] font-light leading-[1.9]">
...
<span className="mt-1.5 w-1.5 h-1.5 bg-[#CFAE6E] shrink-0"></span>
<p className="text-[11px] md:text-[12px] uppercase tracking-[0.18em] text-[#A08E68] leading-relaxed text-left">
...
<a className="group inline-flex items-center gap-4 border border-[#232833] bg-[#0C0D10]/90 px-6 md:px-7 py-4 font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]" href="#">
<span className="inline-flex items-center gap-3">
<span className="w-1.5 h-1.5 bg-[#9ED8FF] transition-colors duration-300 group-hover:bg-[#CFAE6E]"></span>
...
<a className="inline-flex items-center gap-3 border border-[#171A1F] bg-transparent px-6 md:px-7 py-4 font-display text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#B8C0CC] transition-all duration-300 hover:border-[#9ED8FF]/40 hover:text-[#9ED8FF]" href="#applications">
...
<div className="absolute right-[12%] bottom-[14%] h-[150px] w-[150px] rounded-full bg-[#CFAE6E]/[0.02] blur-[90px]"></div>
...
<svg className="shrink-0" fill="none" height="22" stroke="#9ED8FF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.25" viewbox="0 0 24 24" width="22">
<polyline points="5 17 12 12 19 17"></polyline>
<polyline points="5 12 12 7 19 12"></polyline>
<polyline points="5 7 12 2 19 7"></polyline>
</svg>
<span className="font-display text-[10px] md:text-[11px] tracking-[0.18em] uppercase text-[#F5F7FA]">
                Parallel Worlds
                <span className="text-[#7D8794]">|| Studio</span>
</span>
</div>
<p className="mt-5 text-[0.98rem] text-[#9AA6B5] font-light leading-[1.85] max-w-sm">
...
<span className="mt-1.5 w-1.5 h-1.5 bg-[#CFAE6E] shrink-0"></span>
<p className="text-[11px] md:text-[12px] uppercase tracking-[0.18em] text-[#A08E68] leading-relaxed">
                Built for clients who want to be remembered as spaces, not
                pages.
              </p>
</div>
</div>
...
<div>
<p className="font-display text-[10px] md:text-[11px] tracking-[0.18em] uppercase text-[#D6C29A]">
                Explore
              </p>
<ul className="mt-5 space-y-3">
<li>
<a className="text-[11px] md:text-[12px] uppercase tracking-[0.16em] text-[#7D8794] hover:text-[#9ED8FF] transition-all duration-300 hover:translate-x-[2px] inline-block" href="#thesis">
                    Thesis
                  </a>
</li>
<li>
<a className="text-[11px] md:text-[12px] uppercase tracking-[0.16em] text-[#7D8794] hover:text-[#9ED8FF] transition-colors" href="#architecture">
                    Architecture
                  </a>
</li>
<li>
<a className="text-[11px] md:text-[12px] uppercase tracking-[0.16em] text-[#7D8794] hover:text-[#9ED8FF] transition-colors" href="#applications">
                    Realities
                  </a>
</li>
</ul>
...
<ul className="mt-5 space-y-3">
<li>
<a className="text-[11px] md:text-[12px] uppercase tracking-[0.16em] text-[#7D8794] hover:text-[#9ED8FF] transition-colors" href="#">
                    Method
                  </a>
</li>
<li>
...
<p className="text-[10px] md:text-[11px] uppercase tracking-[0.16em] text-[#4A505C]">
            Sys.Rev.01 ©
            <span className="font-display text-[#7D8794]">MMXXVI</span>
            Parallel Worlds || Studio
          </p>
<div className="flex flex-wrap items-center gap-6">
<a className="text-[10px] md:text-[11px] uppercase tracking-[0.16em] text-[#4A505C] hover:text-[#9ED8FF] transition-colors" href="#">
              Imprint
            </a>
<a className="text-[10px] md:text-[11px] uppercase tracking-[0.16em] text-[#4A505C] hover:text-[#9ED8FF] transition-colors" href="#">
              Privacy

...
<nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 rounded-[3rem] px-6 py-4 flex items-center justify-between transition-all duration-500 border" id="navbar">
<div className="text-2xl font-semibold text-[#E8E4DC] tracking-tight font-heading">
        PCOW
      </div>
<div className="hidden uppercase md:flex text-lg font-extrabold text-[#E8E4DC]/70 tracking-widest font-mono gap-x-16 gap-y-16 items-center">
<a className="hover:text-[#C07D2A] transition-colors" href="#services">
          Services
        </a>
<a className="hover:text-[#C07D2A] transition-colors" href="#philosophy">
          Philosophy
        </a>
<a className="hover:text-[#C07D2A] transition-colors" href="#protocol">
          Protocol
        </a>
</div>
...
<section className="relative min-h-[100dvh] w-full flex flex-col justify-end p-6 md:p-12 lg:p-24 overflow-hidden">

<div className="absolute inset-0 z-0">
<img alt="Heavy Civil Construction" className="w-full h-full object-cover object-center scale-105" id="hero-img" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7db786ae-102c-4234-bcfb-30446000409f_3840w.jpg?w=800&amp;q=80"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0B0F14] via-[#0B0F14]/70 to-transparent"></div>
</div>

<div className="flex flex-col w-full z-10 pb-32 md:pb-16 relative gap-x-4 gap-y-4 items-start">
<div className="hero-elem uppercase md:text-lg text-xs font-extrabold text-[#C07D2A] tracking-[0.2em] font-mono">
          Civil &amp; Structural Concrete
        </div>
<div className="flex flex-col -gap-2">
<h1 className="hero-elem leading-[0.85] uppercase text-5xl md:text-[5.5vw] lg:text-[6vw] xl:text-[6vw] 2xl:text-[6.5vw] font-bold text-[#E8E4DC] tracking-tighter font-heading md:whitespace-nowrap w-full">
            Polished Concrete of Wyoming
          </h1>
<h2 className="hero-elem font-display italic text-5xl md:text-7xl lg:text-[5.5rem] leading-none text-[#C8BFB0] tracking-tight">
            Trust built to last.
          </h2>
</div>
<p className="hero-elem font-body text-base md:text-lg text-[#E8E4DC]/70 max-w-2xl mt-4 mb-8">
          Polished Concrete, Concrete Repairs, Custom Logos, Concrete Sealing,
          Commercial Flooring, and Industrial Flooring across Wyoming and
          surrounding states.
        </p>
...
<span className="bg-layer"></span>
<span className="content flex items-center gap-2 font-extrabold">
            Initiate Engagement
...
<div className="absolute bottom-0 left-0 w-full p-4 md:px-12 md:py-8 border-t border-[#E8E4DC]/10 z-10 grid grid-cols-2 md:flex md:flex-nowrap justify-between gap-y-3 gap-x-2 md:gap-4 font-mono text-xs text-[#E8E4DC]/50 tracking-widest">
<div className="hero-elem text-xs md:text-lg font-extrabold">
          40+ YRS EXPERIENCE
        </div>
<div className="hero-elem text-xs md:text-lg font-bold">
          1000+ PROJECTS DELIVERED
        </div>
<div className="hero-elem text-xs md:text-lg font-bold">
          LICENSED &amp; BONDED
        </div>
<div className="hero-elem text-xs md:text-lg font-bold">WYOMING BASED</div>
</div>
</section>
...
<div className="">
<div className="uppercase text-base font-semibold text-[#C07D2A] tracking-widest font-mono mb-4">
              The Catalog
            </div>
<h2 className="font-heading font-semibold text-4xl md:text-6xl text-[#E8E4DC] tracking-tighter uppercase">
              Capabilities
            </h2>
</div>
<p className="font-body text-[#E8E4DC]/60 max-w-md text-sm md:text-base text-balance">
            Built for the complexity others won't touch. We self-perform the
            critical path to control the outcome.
          </p>
</div>
...
<h3 className="font-heading font-semibold text-3xl tracking-tight uppercase mb-3">
                Civil General Contracting
              </h3>
<p className="font-body text-[#E8E4DC]/70 text-sm md:text-base text-balance">
                End-to-end management of complex infrastructure deployments,
                ensuring strict adherence to structural tolerances and municipal
                timelines.
              </p>
</div>
</div>
...
<h3 className="font-heading font-semibold text-xl tracking-tight uppercase mb-2">
              Elevated Concrete
            </h3>
<p className="font-body text-[#0B0F14]/70 text-sm">
              Suspended slabs and vertical elements demanding high-strength mix
              designs.
            </p>
</div>
...
<p className="font-body text-[#0B0F14]/70 text-sm">
              Single-source responsibility from formwork and rebar placement to
              final cure.
            </p>
</div>
...
<h3 className="font-heading font-semibold text-xl tracking-tight uppercase mb-2 mt-6">
              Structural Concrete
            </h3>
<p className="font-body text-[#0B0F14]/70 text-sm">
              Massive load-bearing foundations, retaining walls, and
...
<p className="font-body text-[#0B0F14]/70 text-sm">
              Monolithic pours requiring precision formwork engineering.
            </p>
</div>
...
<div className="absolute top-0 left-0 w-1 h-full bg-[#C07D2A] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
<h3 className="font-heading font-semibold text-2xl tracking-tight uppercase mb-2">
              Concrete Roadways &amp; Sidewalks
            </h3>
<p className="font-body text-[#E8E4DC]/60 text-sm">
              Heavy-duty paving, DOT-compliant flatwork, and public access
              infrastructure.
            </p>
</div>
...
<div className="absolute top-0 left-0 w-1 h-full bg-[#0D2340] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
<h3 className="font-heading font-semibold text-xl tracking-tight uppercase mb-2">
              RCP, Arch &amp; Box Culverts
            </h3>
<p className="font-body text-[#0B0F14]/70 text-sm">
              Precast and cast-in-place subterranean drainage networks.
            </p>
</div>
...
<p className="font-body text-[#0B0F14]/70 text-sm">
              Deep excavations and watertight structural construction.
            </p>
</div>
...
<div className="absolute top-0 left-0 w-1 h-full bg-[#0D2340] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
<h3 className="font-heading font-semibold text-2xl tracking-tight uppercase mb-2">
              Storm Drainage, Water &amp; Sewer Lines
            </h3>
<p className="font-body text-[#0B0F14]/70 text-sm">
              Utility infrastructure installation through high-density urban
              corridors.
            </p>
</div>
...
<h3 className="font-heading font-semibold text-xl tracking-tight uppercase mb-2 mt-6">
              Boring, Tunneling &amp; Directional Drilling
            </h3>
<p className="font-body text-[#E8E4DC]/60 text-sm">
              Trenchless utility installation to preserve surface integrity.
            </p>
</div>
...
<p className="font-body text-[#0B0F14]/70 text-sm">
              Engineered detention vaults and flow control systems.
            </p>
</div>
...
<div className="absolute top-0 left-0 w-1 h-full bg-[#0D2340] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
<h3 className="font-heading font-semibold text-xl tracking-tight uppercase mb-2">
              Submerged Utility Lines
            </h3>
<p className="font-body text-[#0B0F14]/70 text-sm">
              Aquatic crossings and specialized marine civil installations.
            </p>
</div>
...
<h3 className="font-heading font-semibold text-3xl text-[#C07D2A] tracking-tight uppercase mb-2 ml-2">
              Design Build Construction
            </h3>
<p className="font-body text-[#E8E4DC]/70 text-sm md:text-base ml-2">
              Collaborative delivery method compressing schedules by overlapping
              design and construction phases. We engineer the constructability
              into the plans before mobilization.
            </p>
</div>
</div>
</div>
...
<div className="">
<p className="font-body text-[#E8E4DC]/50 text-lg md:text-xl mb-6">
            Most contractors focus on winning the bid.
          </p>
...
<p className="font-body text-[#E8E4DC]/50 text-lg md:text-xl mb-6">
            Speed is sold as a virtue.
          </p>
<h2 className="font-display italic text-5xl md:text-7xl lg:text-8xl text-[#E8E4DC] tracking-tight leading-[0.9] max-w-4xl split-text">
<span className="text-[#C07D2A] not-italic font-heading uppercase tracking-tighter mr-4 inline-block transform translate-y-[-0.1em]">
              Precision
            </span>
            is our promise.
          </h2>
...
<div className="w-full h-full max-h-[800px] bg-[#0D2340] rounded-[1.5rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between overflow-hidden shadow-2xl relative border border-[#E8E4DC]/10" style={{filter: 'none'}}>
<div className="relative z-10 w-full md:w-1/2 flex flex-col gap-6">
<div className="font-mono text-xl text-[#C07D2A]">01</div>
<h3 className="font-heading font-semibold text-5xl md:text-6xl text-[#E8E4DC] tracking-tighter uppercase leading-[0.9]">
                Comprehensive Project Assessment
              </h3>
<p className="font-body text-[#E8E4DC]/70 text-lg md:text-xl max-w-md">
                We begin every engagement with a rigorous site evaluation, scope
                definition, and feasibility analysis — before a single number is
                quoted.
              </p>
</div>
...
<div className="absolute inset-[30%] border border-[#C07D2A] rounded-full scale-50 text-center flex items-center justify-center font-mono text-xs">
                SCOPE
              </div>
</div>
</div>
...
<div className="w-full h-full max-h-[800px] bg-[#C8BFB0] rounded-[1.5rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between overflow-hidden shadow-2xl relative" style={{filter: 'none'}}>
<div className="relative z-10 w-full md:w-1/2 flex flex-col gap-6">
<div className="font-mono text-xl text-[#0D2340]">02</div>
<h3 className="font-heading font-semibold text-5xl md:text-6xl text-[#0B0F14] tracking-tighter uppercase leading-[0.9]">
                Precision Field Execution
              </h3>
<p className="font-body text-[#0B0F14]/80 text-lg md:text-xl max-w-md">
                Our crews operate with military-grade scheduling and real-time
                coordination — no surprises, no excuses, no cost overruns.
              </p>
</div>
...
<p className="font-body text-[#E8E4DC]/70 text-lg md:text-xl max-w-md">
                Every project closes with full documentation, punch-list
                sign-off, and a 30-day post-completion warranty review.
              </p>
</div>
...
<h2 className="font-display italic text-5xl md:text-7xl text-[#E8E4DC] tracking-tight leading-[0.9]">Let's build together something that lasts.</h2>
<p className="font-body text-[#E8E4DC]/60 text-lg max-w-sm">
            Tell us about your project infrastructure needs. Our estimating team
            responds within one business day.
          </p>
<div className="hidden lg:block mt-12 font-mono text-xs text-[#E8E4DC]/40 uppercase tracking-widest">
            Polished Concrete of Wyoming Licensed &amp; Bonded
          </div>
</div>
...
<h3 className="font-display italic text-4xl text-[#C07D2A] mb-4">
              We'll be in touch.
            </h3>
<p className="font-body text-[#E8E4DC]/60">
              Your bid request has been securely logged. Our team is reviewing
              the specifications.
            </p>
</div>
<form className="flex flex-col relative z-10 gap-y-10" id="bid-form">
...
<label className="uppercase transition-all peer-focus:-top-4 peer-focus:text-[#C07D2A] peer-focus:text-[10px] peer-valid:-top-4 peer-valid:text-[10px] text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute top-3 left-0" htmlFor="name">
                  Full Name
                </label>
</div>
<div className="relative group">
...
<label className="uppercase transition-all peer-focus:-top-4 peer-focus:text-[#C07D2A] peer-focus:text-[10px] peer-valid:-top-4 peer-valid:text-[10px] text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute top-3 left-0" htmlFor="company">
                  Company Name
                </label>
</div>
</div>
...
<label className="uppercase transition-all peer-focus:-top-4 peer-focus:text-[#C07D2A] peer-focus:text-[10px] peer-valid:-top-4 peer-valid:text-[10px] text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute top-3 left-0" htmlFor="phone">
                  Phone Number
                </label>
</div>
<div className="relative group">
...
<label className="uppercase transition-all peer-focus:-top-4 peer-focus:text-[#C07D2A] peer-focus:text-[10px] peer-valid:-top-4 peer-valid:text-[10px] text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute top-3 left-0" htmlFor="email">
                  Email Address
                </label>
</div>
</div>
...
<span className="-top-4 text-[10px] uppercase text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute left-0">
                Project Type
              </span>
...
<span className="" id="dropdown-val">Select Primary Service</span>
...
<label className="uppercase transition-all peer-focus:-top-4 peer-focus:text-[#C07D2A] peer-focus:text-[10px] peer-valid:-top-4 peer-valid:text-[10px] text-sm text-[#E8E4DC]/40 tracking-widest font-mono absolute top-3 left-0" htmlFor="description">
                Project Description
              </label>
</div>
...
<div className="text-4xl font-heading font-semibold text-[#E8E4DC] tracking-tighter mb-4">
              PCOW
            </div>
<p className="font-display italic text-2xl text-[#C8BFB0] tracking-tight">
              Precision Poured. Trust Built.
            </p>
</div>

<div className="flex flex-col uppercase text-xs text-[#E8E4DC]/70 tracking-widest font-mono gap-x-3 gap-y-3">
<a className="hover:text-[#C07D2A] transition-colors text-base w-fit" href="#services">
              Services
            </a>
<a className="hover:text-[#C07D2A] transition-colors text-base w-fit" href="#projects">
              Projects
            </a>
<a className="hover:text-[#C07D2A] transition-colors text-base font-bold w-fit" href="#about">
              About PCOW
            </a>
<a className="hover:text-[#C07D2A] transition-colors text-base w-fit" href="#contact">
              Contact
            </a>
</div>
...
<a className="hover:text-[#E8E4DC] transition-colors" href="#">
                Privacy
              </a>
<a className="hover:text-[#E8E4DC] transition-colors" href="#">
                Terms
...
<div className="font-mono text-[10px] text-[#E8E4DC]/30 uppercase tracking-widest">
            © 2026 Polished Concrete of Wyoming. All Rights Reserved.
          </div>

...
<p className="mb-8 max-w-2xl text-sm text-neutral-300 sm:text-base">
      Built for founders, operators, and sales teams, Pegasus is an AI-first customer operating system
...
<img alt="Pegasus Logo" className="h-8 w-auto object-contain" src="https://digitaldynamics.uk/wp-content/uploads/2025/12/MASTER-text-logo-scaled.png"/>

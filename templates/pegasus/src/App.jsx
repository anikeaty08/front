...
<div className="w-[50rem] h-[50rem] rounded-full bg-blue-600/20 blur-[120px] mix-blend-screen animate-pulse duration-[4000ms]"></div>
</div>

<canvas className="absolute inset-0 w-full h-full" height="814" id="hero-canvas" width="1512"></canvas>
</div>
...
<div className="flex bg-center w-9 h-9 bg-[url(https://digitaldynamics.uk/wp-content/uploads/2025/12/MASTER-text-logo-scaled.png)] bg-contain bg-no-repeat rounded-none pt-6 pr-12 pb-6 pl-12 items-center justify-center">
<div className="grid grid-cols-2 gap-0.5"></div>
</div>
...
<a className="hover:text-white transition-colors" href="#achievements">
              Teams
            </a>
...
<p className="mb-8 max-w-2xl text-sm text-neutral-300 sm:text-base">
          Built for founders, operators, and sales teams, Pegasus is an AI-first
          customer operating system that keeps projects, conversations, and
          deals perfectly aligned without drowning you in tabs.
        </p>
...
<button className="group hover:bg-white hover:text-black transition-all duration-300 flex reveal-on-scroll reveal-delay-200 is-visible text-white bg-neutral-100/20 border-white/40 border rounded-full pt-2.5 pr-8 pb-2.5 pl-8 backdrop-blur-md gap-x-2 gap-y-2 items-center">
            Watch Demo
          </button>
</div>
</div>
...
<p className="text-xs font-medium text-neutral-500 uppercase tracking-wider mb-6 pl-2">
                Admin tools
              </p>
...
<div className="bg-gradient-to-r from-blue-500/20 to-transparent/0 opacity-100 border-[#5c9aff] border-l-2 absolute top-0 right-0 bottom-0 left-0"></div>
...
<span className="bg-blue-500 text-white text-[10px] font-bold h-5 w-5 rounded-full flex items-center justify-center">
                    2
                  </span>
</a>
</nav>
...
<p className="text-xs text-neutral-400">
                    See your daily platform usage at a glance
                  </p>
</div>
</div>
...
<span className="absolute -top-1 -right-1 w-4 h-4 bg-blue-500 rounded-full border-2 border-[#09090b] text-[8px] font-bold flex items-center justify-center text-white">
                    2
                  </span>
</button>
</div>
...
<button className="px-2 py-1 rounded-full bg-white/5 text-white text-[10px]">
                      7d
                    </button>
<button className="px-2 py-1 rounded-full hover:bg-white/5">
                      30d
                    </button>
<button className="px-2 py-1 rounded-full hover:bg-white/5">
                      90d
...
<circle className="animate-pulse" cx="185" cy="35" fill="#3b82f6" r="4" stroke="#111117" strokeWidth="2"></circle>
</svg>
</div>
...
<div className="flex items-end gap-1.5 h-10">
<div className="w-2.5 bg-blue-500/40 rounded-sm h-[30%] origin-bottom animate-bar" style={{animationDelay: '0ms'}}></div>
...
<div className="w-2.5 bg-blue-500/70 rounded-sm h-[40%] origin-bottom animate-bar" style={{animationDelay: '120ms'}}></div>
...
<div className="mb-12 flex items-center justify-center"></div>
...
<p className="mb-10 max-w-2xl text-sm text-neutral-300 sm:text-base">
          Capture briefs, roadmaps, and meeting notes in living documents that
          sit right next to your pipelines. Keep your team aligned on what’s
          being built, why it matters, and who owns the next move.
        </p>
...
<p className="mt-3 text-neutral-400">
            Pegasus keeps your work, communication, and planning unified.
          </p>
</div>
...
<p className="text-sm leading-relaxed text-neutral-400">
                Organise tasks by team, priority, or project stage with flexible
                views that adapt to how your team works.
              </p>
</div>
</div>
...
<div className="flex items-center gap-2 text-[10px] text-neutral-400 font-medium tracking-wide uppercase ml-auto">
...
<svg className="text-neutral-400" fill="none" height="8" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="8">
<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
<circle cx="12" cy="7" r="4"></circle>
</svg>
</div>
</div>
<div className="text-xs text-neutral-200 font-medium mb-3">
                    Rvysion website redesign
                  </div>
<div className="flex gap-2">
<span className="rounded-[4px] bg-amber-500/10 border border-amber-500/20 px-1.5 py-0.5 text-[9px] text-amber-200/70 font-medium">
                      Freelance
                    </span>
<span className="rounded-[4px] bg-white/5 border border-white/5 px-1.5 py-0.5 text-[9px] text-neutral-400">
                      May 20
                    </span>
</div>
</div>
...
<div className="text-xs text-neutral-200 font-medium mb-2">
                    Apple tv series website
                  </div>
<div className="flex gap-2">
<span className="rounded-[4px] bg-emerald-500/10 border border-emerald-500/20 px-1.5 py-0.5 text-[9px] text-emerald-200/70 font-medium">
                      Mobile app
                    </span>
</div>
</div>
...
<div className="flex flex-col p-8 pt-2">
<h3 className="mb-3 text-lg font-medium text-white tracking-tight">
                Visualize progress and stay on track.
              </h3>
<p className="text-sm leading-relaxed text-neutral-400">
                Create timelines that everyone can follow. Forecast delivery
                dates and see blockers before they derail momentum.
              </p>
</div>
</div>
...
<p className="text-sm leading-relaxed text-neutral-400">
                Keep everyone aligned, without chasing updates. Mention
                teammates, share files, and leave feedback.
              </p>
</div>
</div>
...
<svg className="text-neutral-400" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<rect height="11" rx="2" ry="2" width="18" x="3" y="11"></rect>
<path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
</svg>
...
<svg className="ml-auto text-neutral-500" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-[11px] font-medium text-white transition-colors">
                      Break It On Purpose
                    </span>
</div>
...
<span className="text-[11px] text-neutral-400 group-hover/item:text-neutral-200">
                      Big Brain Zone
                    </span>
</div>
<div className="flex items-center gap-3 opacity-60 group/item cursor-pointer hover:opacity-100 transition-opacity">
...
<p className="text-sm leading-relaxed text-neutral-400">
                Build repeatable workflows that match your process. Automate
                what you can, and customize whatever you need.
              </p>
</div>
</div>
...
<p className="text-sm leading-relaxed text-neutral-400">
                Track performance with clean dashboards and actionable reports —
                from big-picture progress to individual velocity.
              </p>
</div>
</div>
...
<svg className="text-neutral-600 group-hover:text-white/60 transition-colors" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex flex-col p-8 pt-2">
<h3 className="mb-3 text-lg font-medium text-white tracking-tight">
                Organised Calls &amp; Meetings
              </h3>
<p className="text-sm leading-relaxed text-neutral-400">
                Easily book one-on-one sessions with experts or reserve your
                spot in upcoming live streams.
              </p>
</div>
</div>
</div>
...
<section className="bg-[#050509] w-full pt-24 pb-32 relative overflow-hidden">
...
<h3 className="text-4xl font-semibold text-white tracking-tight mb-3">
              25,000+
            </h3>
...
<p className="text-sm text-neutral-400 leading-relaxed max-w-xs">
              Dash helps teams ship faster, from scrappy startups to growing
              enterprises.
            </p>
</div>
...
<span className="text-[9px] text-neutral-500 font-mono w-10">
                      PER-08
                    </span>
<span className="text-[10px] text-neutral-300 truncate flex-1">
                      Rvysion website redesign
                    </span>
<span className="text-[8px] px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-200/70 border border-amber-500/10">
                      Freelance
                    </span>
</div>
...
<span className="text-[8px] px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-200/70 border border-emerald-500/10">
                      Mobile app
                    </span>
</div>
...
<span className="text-[8px] px-1.5 py-0.5 rounded bg-purple-500/10 text-purple-200/70 border border-purple-500/10">
                      Framer
                    </span>
</div>
</div>
...
<span className="ml-auto text-[9px] bg-indigo-500/20 text-indigo-300 px-1.5 py-0.5 rounded text-center min-w-[18px]">
                      +9
                    </span>
</div>
...
<p className="text-sm text-neutral-400 leading-relaxed max-w-xs">
              Loved by founders, managers, and doers who actually get things
              done.
            </p>
</div>
...
<h3 className="text-xl font-medium text-white tracking-tight mb-2 leading-snug">
              ...
              <span className="text-neutral-400">
                Built for global teams with local flexibility and multi-timezone
                syncing.
              </span>
</h3>
</div>
...
<section className="overflow-hidden selection:bg-indigo-500/30 bg-center bg-[#050509] w-full pt-24 pb-32 relative" style={{maskImage: 'linear-gradient(180deg, transparent, black 25%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 25%, black 80%, transparent)'}}>
...
<p className="text-lg text-neutral-400 leading-relaxed max-w-2xl mx-auto">
            A unified workspace for analytics, team management, and project
            tracking. Designed for speed and modularity.
          </p>
</div>
...
<span className="text-xl font-bold text-white tracking-tight bg-[url(https://digitaldynamics.uk/wp-content/uploads/2025/12/MASTER-text-logo-scaled.png)] bg-contain bg-no-repeat bg-center px-16 py-8"></span>
...
<div className="w-9 h-9 rounded-full border-2 border-[#18181B] bg-neutral-700 overflow-hidden">
...
<div className="w-9 h-9 rounded-full border-2 border-[#18181B] bg-neutral-600 overflow-hidden">
...
<div className="w-9 h-9 rounded-full border-2 border-[#18181B] bg-white text-black flex items-center justify-center text-[10px] font-bold z-10">
                    +4
                  </div>
</div>
</div>
...
<div className="absolute -top-9 left-[40%] transform -translate-x-1/2 bg-white text-black px-2.5 py-1 rounded-md text-[10px] font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                06:14
              </div>
...
<div className="text-[10px] text-neutral-500 uppercase tracking-widest font-bold mb-0.5">
                  Oct
                </div>
...
<button className="px-4 py-1.5 text-xs font-medium text-white bg-blue-500 shadow-lg shadow-blue-500/20 rounded-full transition-all">
                  Weekly
                </button>
<button className="px-4 py-1.5 text-xs font-medium text-neutral-500 hover:text-white transition-colors">
                  Monthly
                </button>
</div>
</div>
...
<div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs text-neutral-500 font-medium">
                  Mon
                </div>
<div className="opacity-0 group-hover/bar:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] bg-neutral-800 px-2 py-1 rounded text-white transition-opacity">
                  4.2h
                </div>
</div>
...
<div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs text-blue-400 font-bold">
                  Thu
                </div>
</div>
...
<section className="overflow-hidden selection:bg-indigo-500/30 w-full pt-24 pb-32 relative">
...
<p className="text-xl text-neutral-400 leading-relaxed max-w-2xl">
            Dash simplifies performance tracking and insights across your
            business, so you spend less time analyzing, and more time growing.
          </p>
</div>
...
<svg className="w-3 h-3 ml-1 text-neutral-600" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24">
<path d="m6 9 6 6 6-6"></path>
</svg>
</div>
</div>
...
<div className="text-[10px] text-neutral-500 font-medium mb-3 uppercase tracking-wider">
                  Program Initiative
                </div>
<h4 className="text-2xl font-medium text-white mb-8 tracking-tight">
                  Rayna v2 Documentation
                </h4>
...
<div className="flex items-center gap-3">
<span className="w-20 text-[11px] text-neutral-500 font-medium">
                      Properties
                    </span>
<div className="flex items-center gap-2">
...
<div className="w-1 h-1 rounded-full bg-amber-400 shadow-[0_0_4px_rgba(251,191,36,0.5)]"></div>
                        Ongoing
                      </span>
...
<svg className="" fill="none" height="10" stroke="currentColor" strokeWidth="2" viewbox="0 0 24 24" width="10">
...
<path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 -center gap-1.5 px-2 py-0.5 rounded border border-indigo-500/20 bg-indigo-500/10 text-[10px] font-medium text-indigo-300"></path>
</svg>
...
<p className="text-sm text-neutral-400 leading-relaxed max-w-md">
                  In this program, you'll learn the basic things you need to be
                  able to build any website on Framer. It's the basic
                  infrastructure program. The goal is to take the lessons in
                  bits enough to understand the rudiments before advancing to
                  the next learning phase.
                </p>
<div className="mt-8 text-[11px] text-neutral-500 font-medium mb-2 opacity-50">
                  Activities
                </div>
</div>
...
<div className="mb-10 pr-8">
<h3 className="text-2xl font-medium text-white mb-4 tracking-tight">
                Plan, assign, and prioritize without the back-and-forth.
              </h3>
<p className="text-neutral-400 text-lg leading-relaxed">
                Organise tasks by team, priority, or project stage with flexible
                views that adapt to how your team works.
...
<svg className="text-neutral-500" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12">
...
<div className="rounded-3xl p-8 ring-1 ring-white/10 bg-[#0a0a0c] flashlight-card reveal-on-scroll delay-100" style={{-MouseX: '840.3199920654297px', -MouseY: '-7094.88720703125px'}}>
...
<div className="rounded-3xl p-8 ring-1 ring-indigo-500 bg-[#0a0a0c] relative flashlight-card reveal-on-scroll delay-200" style={{-MouseX: '424.32000732421875px', -MouseY: '-7094.88720703125px'}}>
...
<span className="text-sm text-neutral-400 pro-monthly-label font-medium">
                Monthly
              </span>
...
<div className="rounded-3xl p-8 ring-1 ring-white/10 bg-[#0a0a0c] flashlight-card reveal-on-scroll delay-300" style={{-MouseX: '8.32000732421875px', -MouseY: '-7094.88720703125px'}}>
...
<div className="mt-6 flex items-center justify-center gap-3">
<span className="text-sm text-neutral-400 enterprise-monthly-label font-medium">
                Monthly
              </span>
...
<li className="">
<a className="text-sm leading-6 text-neutral-400 hover:text-white" href="#">
                      Marketing
                    </a>
</li>
<li className="">
...
<p className="text-xs leading-5 text-neutral-500">
            © 2026 Pegasus - Command Centre. Developed &amp; Powered by Digital
            Dynamics.
          </p>
</div>
</div>

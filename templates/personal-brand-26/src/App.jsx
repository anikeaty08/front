...
<div className="h-full bg-orange-500 rounded-full progress-bar" style={{-TargetWidth: '42%'}}></div>
</div>
...
<div className="w-full h-1.5 bg-neutral-100 rounded-full overflow-hidden">
<div className="h-full bg-neutral-900 rounded-full progress-bar delay-200" style={{-TargetWidth: '100%'}}></div>
</div>
...
<div className="w-full h-1.5 bg-neutral-100 rounded-full overflow-hidden">
<div className="h-full bg-neutral-300 rounded-full progress-bar delay-300" style={{-TargetWidth: '30%'}}></div>
</div>

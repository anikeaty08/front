...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="fixed top-0 w-full h-screen bg-center -z-10 bg-cover" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/38c8bb15-0807-4e7c-9c91-ddfb3ba673dd_3840w.jpg")'}}></div>
...
</div><div className="" id="glow" style={{position: 'absolute', display: 'flex', width: '12rem'}}><div className="circle" style={{width: '100%', height: '30px', filter: 'blur(2rem)', animation: 'pulse_3011 4s infinite', zIndex: '-1', background: 'rgba(254, 83, 186, 0.636)'}}></div><div className="circle" style={{width: '100%', height: '30px', filter: 'blur(2rem)', animation: 'pulse_3011 4s infinite', zIndex: '-1', background: 'rgba(142, 81, 234, 0.704)'}}></div></div><style>
...
<img alt="Client" className="w-12 h-12 rounded-full object-cover border-2 border-purple-400/30" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/04b430ce-45fe-4c6d-b375-4a4d349051a7_320w.jpg" style={{}}/>
<div>
...
<div className="flex items-start gap-4 mb-4">
<img alt="Client" className="w-12 h-12 rounded-full object-cover border-2 border-pink-400/30" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2a59325f-6c7c-497d-be59-b73f7bbb9e60_320w.jpg"/>
<div>
...
<div className="flex items-start gap-4 mb-4">
<img alt="Client" className="w-12 h-12 rounded-full object-cover border-2 border-green-400/30" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0d5d1d2c-b8df-49fe-b836-b3462b5e330d_320w.jpg"/>
<div className="">

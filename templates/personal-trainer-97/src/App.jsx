...
<header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-transparent border-b border-transparent" id="main-header">
<div className="container mx-auto px-5 md:px-10 py-4 flex items-center justify-between">
<div className="flex flex-col">
<a className="font-display font-extrabold text-2xl text-white tracking-tight flex items-center gap-2" href="#">
<span className="text-[#2979FF]">LP</span> LUCAS PRADO
                </a>
</div>
<nav className="hidden lg:flex items-center gap-8 font-mono text-xs font-normal text-[#B0B0B0]">
<a className="hover:text-white transition-colors relative group" href="#metodo">
                    Método
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-[#2979FF] transition-all duration-300 group-hover:w-full"></span>
</a>
<a className="hover:text-white transition-colors relative group" href="#resultados">
                    Resultados
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-[#2979FF] transition-all duration-300 group-hover:w-full"></span>
</a>
<a className="hover:text-white transition-colors relative group" href="#modalidades">
                    Modalidades
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-[#2979FF] transition-all duration-300 group-hover:w-full"></span>
</a>
<a className="hover:text-white transition-colors relative group" href="#sobre">
                    Sobre
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-[#2979FF] transition-all duration-300 group-hover:w-full"></span>
</a>
</nav>
<a className="hidden md:flex btn-primary px-6 py-3 font-mono text-xs items-center gap-2 font-normal" href="#whatsapp">
...
<section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#050D1A]">

<div className="absolute inset-0 z-0">
<img alt="Lucas Prado" className="w-full h-full object-cover object-top opacity-60 mix-blend-luminosity hero-img" src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&amp;w=2000&amp;auto=format&amp;fit=crop"/>
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 w-full text-center pointer-events-none hero-text">
...
<span className="block text-[#2979FF] reveal-up delay-200">SÓ RESULTADO.</span>
</h1>
...
<a className="btn-primary px-8 py-4 font-mono text-xs font-normal text-center flex items-center justify-center gap-2" href="https://instagram.com/teamlucasprado" target="_blank">
<iconify-icon icon="solar:instagram-linear" width="18"></iconify-icon>
                        Seguir no Instagram
                    </a>
<a className="btn-secondary px-8 py-4 font-mono text-xs font-normal text-center" href="#modalidades">
                        Quero Começar
                    </a>
</div>
</div>
...
<div className="font-mono text-[0.65rem] text-[#B0B0B0] mb-1">Modalidades</div>
<div className="font-display font-extrabold text-xl md:text-2xl text-white tracking-tight">PRESENCIAL · ONLINE</div>
</div>
<div className="glass-card p-4 md:p-5">
<div className="font-mono text-[0.65rem] text-[#B0B0B0] mb-1">Especialidades</div>
<div className="font-display font-extrabold text-xl md:text-2xl text-white tracking-tight">5 ÁREAS</div>
</div>
<div className="glass-card p-4 md:p-5 hidden sm:block">
<div className="font-mono text-[0.65rem] text-[#B0B0B0] mb-1">Atendimento</div>
<div className="font-display font-extrabold text-xl md:text-2xl text-white tracking-tight">PERSONALIZADO</div>
</div>
<div className="glass-card p-4 md:p-5 hidden lg:block">
<div className="font-mono text-[0.65rem] text-[#B0B0B0] mb-1">Método</div>
<div className="font-display font-extrabold text-xl md:text-2xl text-[#2979FF] tracking-tight">TESTADO E APROVADO</div>
</div>
</div>
</div>
</div>
...
<img alt="" className="absolute inset-0 w-full h-full object-cover opacity-5 pointer-events-none" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=2000&amp;auto=format&amp;fit=crop"/>
...
<span className="font-mono text-xs eyebrow block mb-6 reveal-right">Para quem é</span>
...
<iconify-icon className="text-[#2979FF] mt-1 shrink-0" icon="solar:check-circle-linear" width="20"></iconify-icon>
<p className="font-body text-sm text-[#F2F2F2]">Quer <strong className="font-normal text-white">emagrecer</strong> sem dietas mirabolantes e sem passar fome.</p>
</div>
<div className="flex items-start gap-4">
<iconify-icon className="text-[#2979FF] mt-1 shrink-0" icon="solar:check-circle-linear" width="20"></iconify-icon>
<p className="font-body text-sm text-[#F2F2F2]">Busca <strong className="font-normal text-white">hipertrofia</strong> com treino estruturado e progressivo.</p>
</div>
<div className="flex items-start gap-4">
<iconify-icon className="text-[#2979FF] mt-1 shrink-0" icon="solar:check-circle-linear" width="20"></iconify-icon>
<p className="font-body text-sm text-[#F2F2F2]">Treina há anos e sente que está <strong className="font-normal text-white">travado, sem evolução.</strong></p>
</div>
</div>
</div>
...
<iconify-icon className="text-[#2979FF] mb-4" icon="solar:running-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-[#2979FF] mb-4" icon="solar:dumbbell-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-[#2979FF] mb-4" icon="solar:heart-pulse-linear" width="32"></iconify-icon>
...
<iconify-icon className="text-[#2979FF] mb-4" icon="solar:users-group-rounded-linear" width="32"></iconify-icon>
...
<p className="font-body text-[#B0B0B0] text-base md:text-lg reveal-up delay-200">
                    Sem planilha genérica. Sem protocolo copiado da internet. Cada aluno começa com uma avaliação e sai com um caminho desenhado para o seu corpo e objetivo.
                </p>
</div>
...
<img alt="Avaliação" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1594381898411-846e7d193883?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
...
<img alt="Protocolo" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
...
<p className="font-body text-sm text-[#B0B0B0] leading-relaxed">
                        Treino desenhado para o seu nível, sua disponibilidade e seu objetivo. Ajustado a cada ciclo. Nada genérico.
                    </p>
</div>
...
<div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-6 border border-white/5 group-hover:border-[#2979FF]/50 transition-colors">
<div className="absolute inset-0 bg-[#050D1A]/30 z-10 group-hover:bg-transparent transition-colors"></div>
<img alt="Acompanhamento" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
...
<p className="font-body text-sm text-[#B0B0B0] leading-relaxed">
                        Suporte contínuo, ajustes constantes e motivação quando você precisar. Presencialmente ou à distância.
                    </p>
</div>
</div>
</div>
...
<p className="font-body text-[#B0B0B0] text-base reveal-up delay-100">
                    Nada de fotografia editada ou resultado milagroso. O que você vê aqui foi conquistado com trabalho, constância e método.
                </p>
</div>
...
<img alt="Treino" className="w-full rounded bg-[#0B1628] opacity-80 hover:opacity-100 transition-opacity" src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&amp;w=600&amp;auto=format&amp;fit=crop" style={{mixBlendMode: 'luminosity'}}/>
<img alt="Treino" className="w-full rounded bg-[#0B1628] opacity-80 hover:opacity-100 transition-opacity" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=600&amp;auto=format&amp;fit=crop" style={{mixBlendMode: 'luminosity'}}/>
<img alt="Treino" className="w-full rounded bg-[#0B1628] opacity-80 hover:opacity-100 transition-opacity" src="https://images.unsplash.com/photo-1574680096145-d05b474e2155?q=80&amp;w=600&amp;auto=format&amp;fit=crop" style={{mixBlendMode: 'luminosity'}}/>
<img alt="Treino" className="w-full rounded bg-[#0B1628] opacity-80 hover:opacity-100 transition-opacity" src="https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&amp;w=600&amp;auto=format&amp;fit=crop" style={{mixBlendMode: 'luminosity'}}/>
</div>
...
<img alt="Presencial" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
...
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Treino 100% acompanhado
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Correção de movimento na hora
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Avaliação física inclusa
                            </li>
</ul>
<div className="border-t border-white/10 pt-6 mb-6">
<span className="font-display font-semibold text-2xl text-white">SOB CONSULTA</span>
</div>
<a className="btn-secondary w-full py-3 text-center text-xs font-mono" href="#whatsapp">Saber Mais</a>
</div>
</div>
...
<img alt="Online" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1599058917212-d750089bc07e?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
<div className="absolute bottom-4 left-6 z-20">
...
<ul className="space-y-4 mb-8 flex-1">
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-bold"></iconify-icon> Protocolo personalizado
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-bold"></iconify-icon> Suporte direto por WhatsApp
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-bold"></iconify-icon> Ajustes periódicos
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-bold"></iconify-icon> Análise de vídeos de execução
                            </li>
</ul>
...
<a className="btn-primary w-full py-4 text-center text-xs font-mono font-normal" href="#whatsapp">Quero Começar</a>
</div>
</div>
...
<div className="h-40 w-full relative">
<div className="absolute inset-0 bg-[#050D1A]/60 z-10"></div>
<img alt="A Domicílio" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&amp;w=600&amp;auto=format&amp;fit=crop"/>
<div className="absolute bottom-4 left-6 z-20">
...
<ul className="space-y-4 mb-8 flex-1">
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Comodidade total
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Adaptação ao seu espaço
                            </li>
<li className="flex items-center gap-3 font-body text-sm text-[#F2F2F2]">
<iconify-icon className="text-[#2979FF]" icon="solar:check-circle-linear"></iconify-icon> Equipamentos levados por mim
                            </li>
</ul>
<div className="border-t border-white/10 pt-6 mb-6">
<span className="font-display font-semibold text-2xl text-white">SOB CONSULTA</span>
...
<img alt="" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=1000&amp;auto=format&amp;fit=crop"/>
</div>
<div className="container mx-auto px-5 md:px-10 relative z-10">
...
<img alt="Lucas Prado - Perfil" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
...
<p>
                            A filosofia é simples: resultado não vem de método complicado — vem de consistência, acompanhamento real e um protocolo feito para você, não para uma planilha genérica.
                        </p>
<p>
...
<iconify-icon className="text-[#2979FF] mt-1" icon="solar:diploma-linear" width="20"></iconify-icon>
<div>
...
<div className="flex items-start gap-3">
<iconify-icon className="text-[#2979FF] mt-1" icon="solar:target-linear" width="20"></iconify-icon>
<div>
...
<div className="flex items-start gap-3">
<iconify-icon className="text-[#2979FF] mt-1" icon="solar:map-point-linear" width="20"></iconify-icon>
<div>
...
<div className="flex items-start gap-3">
<iconify-icon className="text-[#2979FF] mt-1" icon="solar:instagram-linear" width="20"></iconify-icon>
<div>
<h4 className="font-mono text-[0.65rem] text-[#6B6B6B] mb-1">INSTAGRAM</h4>
<a className="font-body text-sm text-[#F2F2F2] hover:text-[#2979FF] transition-colors" href="#">@teamlucasprado</a>
</div>
</div>
</div>
</div>
...
<img alt="" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
<div className="container mx-auto px-5 md:px-10 relative z-10">
...
<details className="group bg-[#050D1A] rounded-lg border border-white/5 overflow-hidden transition-all duration-300 [&amp;[open]]:glass-card">
<summary className="flex justify-between items-center p-6 text-lg font-body font-medium text-white cursor-pointer select-none">
                            ...
                            <iconify-icon className="faq-icon text-[#2979FF] transition-transform duration-300" icon="solar:alt-arrow-down-linear" width="24"></iconify-icon>
</summary>
...
<div className="faq-content px-6 pb-6 text-[#B0B0B0] font-body text-sm md:text-base leading-relaxed border-t border-transparent group-open:border-[#2979FF]/10 pt-4">
                            Os valores variam conforme a modalidade e o plano. Entre em contato para receber uma proposta personalizada sem compromisso.
                        </div>
</details>
</div>
</div>
...
<div className="absolute inset-0 z-0">
<img alt="Lucas Prado CTA" className="w-full h-full object-cover object-center opacity-40 mix-blend-luminosity" src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&amp;w=2000&amp;auto=format&amp;fit=crop"/>
...
<div className="animate-ticker font-display font-extrabold text-2xl md:text-4xl text-[#2979FF] tracking-widest inline-block">
                S E G U I R · N O · I N S T A G R A M · @ T E A M L U C A S P R A D O · C O M E Ç A R · A G O R A · S E M · E N R O L A Ç Ã O · R E S U L T A D O · R E A L · S E G U I R · N O · I N S T A G R A M · @ T E A M L U C A S P R A D O ·
            </div>
<div aria-hidden="true" className="animate-ticker font-display font-extrabold text-2xl md:text-4xl text-[#2979FF] tracking-widest inline-block">
                S E G U I R · N O · I N S T A G R A M · @ T E A M L U C A S P R A D O · C O M E Ç A R · A G O R A · S E M · E N R O L A Ç Ã O · R E S U L T A D O · R E A L · S E G U I R · N O · I N S T A G R A M · @ T E A M L U C A S P R A D O ·
            </div>
</div>
...
<a className="btn-primary px-10 py-5 font-mono text-sm font-normal text-center flex items-center justify-center gap-2" href="https://instagram.com/teamlucasprado" target="_blank">
<iconify-icon icon="solar:instagram-linear" width="20"></iconify-icon>
                    Seguir no Instagram
                </a>
<a className="btn-secondary px-10 py-5 font-mono text-sm font-normal text-center flex items-center justify-center gap-2" href="#whatsapp">
...
<a className="font-display font-extrabold text-3xl text-white tracking-tight flex items-center gap-2 mb-4" href="#">
<span className="text-[#2979FF]">LP</span> LUCAS PRADO
                    </a>
<p className="font-mono text-xs text-[#6B6B6B] tracking-widest">RESULTADO SEM FRESCURA.</p>
</div>

<div className="md:col-span-3">
<h4 className="font-mono text-xs text-white mb-6">NAVEGAÇÃO</h4>
<ul className="space-y-3 font-body text-sm text-[#B0B0B0]">
<li><a className="hover:text-[#2979FF] transition-colors" href="#metodo">Método</a></li>
<li><a className="hover:text-[#2979FF] transition-colors" href="#resultados">Resultados</a></li>
<li><a className="hover:text-[#2979FF] transition-colors" href="#modalidades">Modalidades</a></li>
<li><a className="hover:text-[#2979FF] transition-colors" href="#sobre">Sobre</a></li>
</ul>
</div>
...
<li>
<a className="flex items-center gap-2 hover:text-[#2979FF] transition-colors" href="https://instagram.com/teamlucasprado" target="_blank">
<iconify-icon icon="solar:instagram-linear" width="18"></iconify-icon>
                                @teamlucasprado
                            </a>
</li>
<li>
<a className="flex items-center gap-2 hover:text-[#2979FF] transition-colors" href="mailto:lucasspradoo01@gmail.com">
<iconify-icon icon="solar:letter-linear" width="18"></iconify-icon>
                                lucasspradoo01@gmail.com
                            </a>
</li>
<li>
<a className="flex items-center gap-2 hover:text-[#2979FF] transition-colors" href="#whatsapp">

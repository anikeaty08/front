...
<div className="hidden lg:flex gap-7 gap-x-7 gap-y-7 items-center">
<a className="dark:text-slate-400 hover:text-brand-teal transition-colors text-sm font-medium text-slate-600" href="/home">home</a>
...
<a className="dark:text-slate-400 hover:text-brand-teal transition-colors text-sm font-medium text-slate-600" href="/client-portal">Client
        Portal</a>
</div>
...
<div className="xl:px-0 grid grid-cols-1 lg:grid-cols-12 max-w-[1200px] mr-auto ml-auto pr-6 pl-6 gap-x-12 gap-y-12 items-center">
...
<button className="hover:bg-teal-500 transition-colors shadow-teal-900/10 text-base font-semibold text-white/ rounded-full pt-3.5 pr-8 pb-3.5 pl-8 shadow-lg">
                        Check Availability
                    </button>
...
<path className="" d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
</path>
</svg>
                    CPR Certified
                </div>

...
<img alt="Beige fashion editorial" className="h-full w-full object-cover" loading="lazy" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a8f75e15-5f15-4877-a253-da0b8f89efee_1600w.jpg"/>
</div>
<div className="absolute inset-0 transition-opacity duration-500 ease-out opacity-0 pointer-events-none" data-index="2">
<img alt="Moody mountains" className="h-full w-full object-cover" loading="lazy" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a3001134-ae66-49be-8bea-f8eed8b7e07e_1600w.jpg" style={{}}/>
</div>
<div className="absolute inset-0 transition-opacity duration-500 ease-out opacity-0 pointer-events-none" data-index="3">
<img alt="3D minimal render" className="h-full w-full object-cover" loading="lazy" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bf79840-b7ed-4d8d-acd3-c5f5835a065e_800w.jpg" style={{}}/>
</div>
...
<div className="ring-1 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4ba34171-fc4e-49ee-a2c4-13a87fd225c6_1600w.jpg)] bg-cover rounded-3xl pt-20 pr-5 pb-20 pl-5 shadow-sm ring-neutral-200 bg-white flex-1 min-h-0">
</div>
...
<img alt="Suzy Liu at work" className="h-80 sm:h-96 w-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0c1c4611-4743-407c-9375-ca363769720b_1600w.jpg"/>
...
<img alt="Art print in soft light" className="w-40 sm:w-52 md:w-64 rounded-2xl object-cover shadow-sm ring-1 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9a421cf7-e975-430b-88c5-f554775493e1_800w.jpg"/>
</div>
<div className="absolute right-0 sm:right-8 top-8 sm:top-14 rotate-6">
<img alt="Smiling client portrait" className="w-40 sm:w-52 md:w-64 rounded-2xl object-cover shadow-sm ring-1 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c0aab170-b3d3-4816-9435-0ac1e1d853a3_800w.jpg"/>
</div>
<div className="absolute -left-4 sm:left-8 bottom-6 sm:bottom-10 -rotate-12">
<img alt="Editorial fashion blur" className="w-44 sm:w-60 md:w-72 rounded-2xl object-cover shadow-sm ring-1 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/eab41fb3-55ff-46e1-973d-56fe1a4282a3_800w.jpg"/>
</div>
<div className="absolute right-2 sm:right-10 bottom-4 sm:bottom-8 rotate-6">
<img alt="Minimal architecture scene" className="w-40 sm:w-52 md:w-64 rounded-2xl object-cover shadow-sm ring-1 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b59bad79-703a-4c05-8ed2-fafcc49a7b51_800w.jpg"/>
</div>
</div>

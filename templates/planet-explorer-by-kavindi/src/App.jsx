...
<h1 className="text-lg font-medium tracking-tight leading-none">PLANET EXPLORER</h1>
</div>
<span className="text-xs text-slate-400 font-medium tracking-wide ml-10">SOLAR SYSTEM V.1.0</span>
</div>
...
<div className="flex items-center gap-1.5">
<i className="w-4 h-4 text-indigo-400" data-lucide="star"></i>
<span className="text-xs font-medium tracking-tight text-slate-200">450 XP</span>
</div>
</div>
<button className="glass-panel w-10 h-10 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors">
<i className="w-5 h-5 text-slate-300" data-lucide="settings-2"></i>
</button>
</div>
</nav>
...
<i className="w-3 h-3" data-lucide="thermometer"></i>
...
<div className="bg-slate-900/40 rounded-xl p-3 border border-white/5">
<div className="flex items-center gap-2 mb-1 text-slate-400">
<i className="w-3 h-3" data-lucide="orbit"></i>
...
<i className="w-4 h-4" data-lucide="glasses"></i>
                AR Mode
            </button>
</div>
...
<i className="w-4 h-4" data-lucide="rewind"></i>
</button>
...
<i className="w-4 h-4" data-lucide="fast-forward"></i>
</button>
</div>
...
<div className="absolute inset-0 z-[60] bg-slate-950 flex items-center justify-center flex-col gap-4 transition-opacity duration-1000" id="loader">
<div className="w-12 h-12 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
<p className="text-sm font-medium tracking-tight text-slate-400 animate-pulse">Initializing Space Engine...</p>
</div>

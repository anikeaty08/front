...
'float-delayed-2': 'float 5s ease-in-out 2s infinite',
'float-delayed-3': 'float 8s ease-in-out 0.5s infinite',
'pulse-glow': 'pulseGlow 3s infinite',
'energy-flow': 'dash 3s linear infinite',
...
<section className="relative pt-24 pb-12 lg:pt-32 lg:pb-32 overflow-hidden min-h-[90vh] lg:min-h-screen flex items-center bg-dark">

<div className="absolute inset-0 bg-grid-pattern opacity-10 pointer-events-none"></div>
<div className="absolute inset-0 noise-bg opacity-30 pointer-events-none"></div>

<div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[300px] h-[300px] sm:w-[800px] sm:h-[800px] bg-brand/10 rounded-full blur-[100px] sm:blur-[150px] pointer-events-none z-0 opacity-20 animate-pulse-glow"></div>

<div className="mobile-container relative z-10">
<div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">

<div className="flex flex-col items-center lg:items-start text-center lg:text-left z-20 order-1">

<div className="reveal-element inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/5 border border-brand/20 text-brand text-[9px] sm:text-[10px] font-bold uppercase tracking-wider mb-6 backdrop-blur-md shadow-[0_0_15px_-5px_rgba(204,255,0,0.3)]">
<span className="w-1.5 h-1.5 rounded-full bg-brand animate-pulse shadow-[0_0_8px_#CCFF00]"></span>
              Novo Método Disponível
            </div>

<h1 className="reveal-element font-heading font-bold text-3xl sm:text-6xl lg:text-7xl leading-[1.1] tracking-tighter text-white mb-6 text-balance max-w-2xl" style={{transitionDelay: '100ms'}}>
              Playerpack: O Arsenal de Templates para <span className="text-brand inline-block drop-shadow-[0_0_25px_rgba(204,255,0,0.3)]">Vender Design Estratégico</span>.
            </h1>

<p className="reveal-element text-neutral-400 text-sm sm:text-lg mb-8 max-w-xl text-balance font-light leading-relaxed tracking-tight" style={{transitionDelay: '200ms'}}>
...
<div className="reveal-element flex flex-col w-full sm:w-auto sm:flex-row items-center gap-4 sm:gap-6" style={{transitionDelay: '300ms'}}>
<a className="w-full sm:w-auto btn-press btn-sheen px-8 py-3.5 bg-brand text-black font-bold text-xs sm:text-sm rounded-full transition-all hover:scale-105 hover:shadow-[0_0_30px_-5px_rgba(204,255,0,0.5)] flex items-center justify-center gap-2 group" href="#offer">
                Quero os templates
                <span className="iconify group-hover:translate-x-1 transition-transform" data-icon="lucide:arrow-right" data-width="16"></span>
</a>
<div className="flex items-center gap-4 sm:gap-6 text-[10px] sm:text-xs font-medium text-neutral-400">
<div className="flex items-center gap-1.5 group cursor-default">
<span className="iconify text-brand" data-icon="lucide:check-circle-2" data-width="12"></span>
<span>100% Online</span>
</div>
<div className="flex items-center gap-1.5 group cursor-default">
<span className="iconify text-brand" data-icon="lucide:infinity" data-width="12"></span>
<span>Vitalício</span>
</div>
</div>
</div>
...
<div className="reveal-element relative w-full h-[320px] sm:h-[500px] flex items-center justify-center perspective-scene order-2 lg:order-2 overflow-visible" style={{transitionDelay: '400ms'}}>

<div className="relative w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] scale-[0.8] sm:scale-75 lg:scale-90 xl:scale-100 flex items-center justify-center preserve-3d">

<svg className="absolute inset-0 w-full h-full z-0 pointer-events-none opacity-40 overflow-visible" viewbox="0 0 500 500">
<defs>
...
<path className="animate-energy-flow" d="M100 100 L250 250" filter="url(#glow-line)" stroke="#CCFF00" stroke-dasharray="5 5" strokeWidth="1"></path>
<path className="animate-energy-flow" d="M400 100 L250 250" filter="url(#glow-line)" stroke="#CCFF00" stroke-dasharray="5 5" strokeWidth="1" style={{animationDelay: '-1s'}}></path>
<path className="animate-energy-flow" d="M400 400 L250 250" filter="url(#glow-line)" stroke="#CCFF00" stroke-dasharray="5 5" strokeWidth="1" style={{animationDelay: '-2s'}}></path>
<path className="animate-energy-flow" d="M100 400 L250 250" filter="url(#glow-line)" stroke="#CCFF00" stroke-dasharray="5 5" strokeWidth="1" style={{animationDelay: '-0.5s'}}></path>
</svg>

<div className="absolute w-[260px] h-[300px] sm:w-[300px] sm:h-[340px] bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl z-10 shadow-2xl flex flex-col overflow-hidden group" style={{transform: 'rotateY(-12deg) rotateX(6deg)', boxShadow: '-20px 20px 60px -10px rgba(0,0,0,0.8), 0 0 40px rgba(204,255,0,0.05)'}}>

<div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent"></div>
<div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div>

<div className="h-8 sm:h-10 border-b border-white/5 flex items-center justify-between px-4 bg-black/20">
<div className="flex gap-1.5">
<div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-neutral-600"></div>
<div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-neutral-600"></div>
</div>
<div className="h-1 w-12 bg-white/10 rounded-full"></div>
</div>

<div className="p-4 sm:p-5 flex-1 flex flex-col gap-3 sm:gap-4 relative">
<div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:20px_20px]"></div>

<div className="flex items-end justify-between h-20 sm:h-24 gap-2 relative z-10 px-2">
<div className="w-full bg-white/5 rounded-t-sm h-[40%]"></div>
<div className="w-full bg-white/5 rounded-t-sm h-[60%]"></div>
<div className="w-full bg-brand/20 rounded-t-sm h-[30%]"></div>
<div className="w-full bg-brand rounded-t-sm h-[80%] shadow-[0_0_15px_rgba(204,255,0,0.4)] relative">
<div className="absolute -top-5 sm:-top-6 left-1/2 -translate-x-1/2 text-[8px] font-bold text-brand bg-black/50 px-1 rounded border border-brand/20">ROI</div>
</div>
<div className="w-full bg-white/5 rounded-t-sm h-[50%]"></div>
</div>

<div className="space-y-1.5 sm:space-y-2 mt-2 relative z-10">
<div className="flex items-center gap-3 p-2 rounded bg-white/5 border border-white/5">
<div className="w-5 h-5 sm:w-6 sm:h-6 rounded bg-brand/10 flex items-center justify-center text-brand">
<span className="iconify" data-icon="lucide:activity" data-width="12"></span>
</div>
<div className="h-1.5 w-16 sm:w-20 bg-white/10 rounded-full"></div>
</div>
<div className="flex items-center gap-3 p-2 rounded bg-white/5 border border-white/5">
<div className="w-5 h-5 sm:w-6 sm:h-6 rounded bg-white/5 flex items-center justify-center text-neutral-500">
<span className="iconify" data-icon="lucide:bar-chart-2" data-width="12"></span>
</div>
<div className="h-1.5 w-10 sm:w-14 bg-white/10 rounded-full"></div>
</div>
</div>
</div>
</div>
...
<div className="absolute top-[5%] left-[-5%] sm:top-[-5%] sm:left-[5%] z-20 animate-float">
<div className="glass-panel p-2 sm:p-3 rounded-xl border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col items-center gap-1 sm:gap-2 w-20 sm:w-24">
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 border border-brand/30 flex items-center justify-center text-brand shadow-[0_0_10px_rgba(204,255,0,0.2)]">
<span className="iconify" data-icon="lucide:radar" data-width="16"></span>
</div>
<div className="text-center">
<span className="block text-[6px] sm:text-[8px] text-neutral-500 font-bold tracking-widest uppercase">M01</span>
</div>
</div>
</div>

<div className="absolute top-[5%] right-[-5%] sm:top-[-5%] sm:right-[5%] z-20 animate-float-delayed">
<div className="glass-panel p-2 sm:p-3 rounded-xl border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col items-center gap-1 sm:gap-2 w-20 sm:w-24">
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 border border-brand/30 flex items-center justify-center text-brand shadow-[0_0_10px_rgba(204,255,0,0.2)]">
<span className="iconify" data-icon="lucide:dna" data-width="16"></span>
</div>
<div className="text-center">
<span className="block text-[6px] sm:text-[8px] text-neutral-500 font-bold tracking-widest uppercase">M02</span>
</div>
</div>
</div>

<div className="absolute bottom-[5%] right-[-5%] sm:bottom-[-5%] sm:right-[5%] z-20 animate-float-delayed-2">
<div className="glass-panel p-2 sm:p-3 rounded-xl border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col items-center gap-1 sm:gap-2 w-20 sm:w-24">
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 border border-brand/30 flex items-center justify-center text-brand shadow-[0_0_10px_rgba(204,255,0,0.2)]">
<span className="iconify" data-icon="lucide:crown" data-width="16"></span>
</div>
<div className="text-center">
<span className="block text-[6px] sm:text-[8px] text-neutral-500 font-bold tracking-widest uppercase">M03</span>
</div>
</div>
</div>

<div className="absolute bottom-[5%] left-[-5%] sm:bottom-[-5%] sm:left-[5%] z-20 animate-float-delayed-3">
<div className="glass-panel p-2 sm:p-3 rounded-xl border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col items-center gap-1 sm:gap-2 w-20 sm:w-24">
<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 border border-brand/30 flex items-center justify-center text-brand shadow-[0_0_10px_rgba(204,255,0,0.2)]">
<span className="iconify" data-icon="lucide:eye" data-width="16"></span>
</div>
<div className="text-center">
<span className="block text-[6px] sm:text-[8px] text-neutral-500 font-bold tracking-widest uppercase">M04</span>
</div>
</div>
</div>
</div>
...
<div className="lg:w-7/12 flex flex-col gap-16 lg:gap-32 pb-32 w-full">

<div className="arsenal-card glass-panel rounded-2xl overflow-hidden inactive" data-index="1">
<div className="h-48 sm:h-56 bg-black/40 relative overflow-hidden border-b border-white/5">
<div className="absolute inset-0 bg-grid-pattern opacity-20"></div>
<div className="absolute bottom-4 right-4 text-[100px] sm:text-[120px] leading-none font-heading font-bold text-white/5 select-none">
                  01
                </div>
...
<span className="text-sm sm:text-lg font-semibold tracking-tight text-white">
                  Template PlayerScan
                  <span className="text-neutral-500 font-normal text-xs sm:text-base ml-1 block sm:inline">
                    (Diagnóstico)
                  </span>
</span>
</div>
...
<div className="mobile-container max-w-3xl">
...
<div className="mobile-container flex flex-col md:flex-row justify-between items-center gap-6">

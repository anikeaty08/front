...
<span className="text-lg font-medium tracking-tight">Pro Finance</span>
</div>
...
<a className="hover:text-black transition-colors" href="#">Catalog</a>
<a className="hover:text-black transition-colors" href="#">Price</a>
<a className="hover:text-black transition-colors" href="#">Help</a>
</div>
...
<svg className="text-black/80" fill="none" height="40" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="40"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"></path></svg>
</span>
</h1>
...
<a className="text-base font-medium flex items-center gap-2 group" href="#">
                            Find Out More 
...
<span className="text-xl font-medium tracking-tight">Market</span>
<i className="w-5 h-5 text-neutral-400" data-lucide="sliders-horizontal"></i>
</div>
...
<span className="text-sm text-neutral-400">Find stocks...</span>
</div>
</div>
...
<span className="text-2xl font-medium tracking-tight">+6.48%</span>
<div className="flex -space-x-2">
<div className="w-6 h-6 rounded-full bg-blue-400"></div>
<div className="w-6 h-6 rounded-full bg-red-400"></div>
<div className="w-6 h-6 rounded-full bg-white text-[8px] flex items-center justify-center text-black font-bold">+2</div>
</div>
</div>
</div>
...
<div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-neutral-100"><i className="w-5 h-5 fill-current" data-lucide="apple"></i></div>
<div>
<p className="text-sm font-medium">Apple Inc</p>
<p className="text-xs text-neutral-500">$132.15</p>
</div>
</div>
...
<div className="flex items-center justify-between p-3 bg-neutral-50 rounded-xl">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center text-white"><i className="w-5 h-5" data-lucide="music"></i></div>
<div>
<p className="text-sm font-medium">Spotify</p>
<p className="text-xs text-neutral-500">$292.92</p>
</div>
</div>
...
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-black"><i className="w-5 h-5 fill-current" data-lucide="apple"></i></div>
<div>
<h3 className="text-lg font-medium leading-none">Apple Inc</h3>
<span className="text-xs text-neutral-500">AAPL</span>
</div>
</div>
<div className="w-8 h-8 rounded-full border border-neutral-800 flex items-center justify-center">
<i className="w-4 h-4 text-neutral-400" data-lucide="star"></i>
</div>
</div>

<div className="mb-6">
<h2 className="text-3xl font-medium tracking-tight">$132.15</h2>
<span className="text-green-400 text-sm font-medium">+1.25% (+$1.73)</span>
</div>
...
<button className="text-xs font-medium text-black bg-white rounded-lg py-1.5 px-3 shadow-sm">Day</button>
...
<p className="text-sm font-medium">$130.42</p>
</div>
<div className="text-right">
<p className="text-[10px] text-neutral-500 uppercase tracking-wider">High</p>
<p className="text-sm font-medium">$133.00</p>
</div>
</div>

<div className="mt-auto pb-8 flex gap-3">
<button className="flex-1 bg-red-500 hover:bg-red-600 text-white font-medium py-3 rounded-xl transition-colors">Sell</button>
<button className="flex-1 bg-[#ccf32f] hover:bg-[#bce325] text-black font-medium py-3 rounded-xl transition-colors">Buy</button>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-5xl font-medium tracking-tight mb-16 max-w-lg">Get the Most Out <br/> of Your Investments</h2>
...
<p className="text-lg text-neutral-500 mb-8 leading-relaxed">Manage all your financial assets from one place smoothly.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium hover:gap-3 transition-all" href="#">
...
<svg className="absolute bottom-10 right-4 w-20 h-20 text-black z-20" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 100 100">
<path d="M10,50 C30,20 70,80 90,50"></path>
<circle cx="85" cy="45" fill="none" r="5"></circle>
</svg>
</div>
</div>
...
<p className="text-lg text-neutral-500 mb-8 leading-relaxed">Analyze the results and try different strategies for more income.</p>
<a className="inline-flex items-center gap-2 text-sm font-medium hover:gap-3 transition-all" href="#">
                            Read More <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>
...
<svg className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-12 text-black" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 100 50">
<polyline points="0,50 20,40 40,45 60,10 80,20 100,5" strokeLinecap="round" strokeLinejoin="round"></polyline>
</svg>
</div>
</div>
</div>
...
<i className="w-6 h-6 text-black" data-lucide="zap"></i>
</div>
<div>
<h3 className="text-xl font-medium mb-2">Smooth Start</h3>
<p className="text-lg text-neutral-500 leading-relaxed mb-4">Without a visit to the office, we will set up your brokerage account in 5 minutes.</p>
<button className="bg-neutral-100 hover:bg-neutral-200 px-4 py-2 rounded-lg text-xs font-medium transition-colors">Open an Account</button>
</div>
</div>

<div className="flex gap-6 items-start">
<div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#ccf32f]/40 flex items-center justify-center">
<i className="w-6 h-6 text-black" data-lucide="headset"></i>
</div>
<div>
<h3 className="text-xl font-medium mb-2">24/7 Support</h3>
<p className="text-lg text-neutral-500 leading-relaxed mb-4">Our support team is always available to answer questions and resolve any issues.</p>
<button className="bg-neutral-100 hover:bg-neutral-200 px-4 py-2 rounded-lg text-xs font-medium transition-colors">Ask a Question</button>
</div>
</div>

<div className="flex gap-6 items-start">
<div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#ccf32f]/40 flex items-center justify-center">
<i className="w-6 h-6 text-black" data-lucide="coins"></i>
</div>
<div>
<h3 className="text-xl font-medium mb-2">Low Commissions</h3>
<p className="text-lg text-neutral-500 leading-relaxed mb-4">We give you the best rate we can for any kind of transactions. No extra fees.</p>
<button className="bg-neutral-100 hover:bg-neutral-200 px-4 py-2 rounded-lg text-xs font-medium transition-colors">Explore Prices</button>
</div>
</div>
...
<p className="text-lg text-neutral-500 leading-relaxed mb-4">You don't have to have large sums to start investing, start small.</p>
<button className="bg-neutral-100 hover:bg-neutral-200 px-4 py-2 rounded-lg text-xs font-medium transition-colors">Start Now</button>
</div>
</div>
</div>
</section>
...
<p className="text-neutral-500 mb-10 text-lg">The largest banks, funds and exchanges from <br/> all over the world cooperate with us</p>
<div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-60 grayscale">

<div className="w-12 h-12 bg-neutral-100 rounded-full flex items-center justify-center p-3">
<svg fill="currentColor" viewbox="0 0 24 24"><path d="M12 2L2 22h20L12 2zm0 4l6 14H6l6-14z"></path></svg>
</div>
<div className="w-12 h-12 bg-neutral-100 rounded-full flex items-center justify-center p-3">
<svg fill="currentColor" viewbox="0 0 24 24"><circle cx="8" cy="12" r="6"></circle><circle cx="16" cy="12" opacity="0.5" r="6"></circle></svg>
</div>
<div className="w-12 h-12 bg-neutral-100 rounded-full flex items-center justify-center p-3">
...
<div className="w-12 h-12 bg-neutral-100 rounded-full flex items-center justify-center p-3">
<svg fill="currentColor" viewbox="0 0 24 24"><path d="M2 12l10-10 10 10-10 10L2 12zm2 0l8 8 8-8-8-8-8 8z"></path></svg>
</div>
</div>
</section>
...
<h3 className="text-3xl font-medium tracking-tight">$16,988.31</h3>
<span className="inline-block bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-semibold mt-1">+$1,247 23.8%</span>
</div>
<div className="bg-black rounded-xl p-4 mb-4">
<div className="flex justify-between items-center text-white mb-2">
<span className="text-xs font-medium">Brokerage Account</span>
<i className="w-4 h-4 text-neutral-500" data-lucide="more-horizontal"></i>
</div>
<div className="text-white text-lg font-medium">$5,738.70</div>
<div className="flex gap-2 mt-3">
<button className="flex-1 bg-neutral-800 text-white text-[10px] py-1.5 rounded-lg border border-neutral-700">Analytics</button>
<button className="flex-1 bg-neutral-800 text-white text-[10px] py-1.5 rounded-lg border border-neutral-700">Replenish</button>
</div>
</div>
<div className="space-y-3">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<div className="w-6 h-6 rounded-full bg-neutral-100 flex items-center justify-center"><i className="w-3 h-3 fill-current" data-lucide="apple"></i></div>
<span className="text-xs font-medium">Apple Inc</span>
</div>
<span className="text-xs font-medium text-green-600">+$188.25</span>
</div>
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-blue-600"><i className="w-3 h-3" data-lucide="wind"></i></div>
<span className="text-xs font-medium">Microsoft</span>
</div>
<span className="text-xs font-medium text-green-600">+$1,402.71</span>
</div>
</div>
</div>
</div>
...
<span className="absolute top-4 right-6 text-xs text-neutral-400 font-mono">135.76 <br/> <span className="text-green-400">+1.25%</span></span>

<svg className="w-full h-full opacity-90 overflow-visible" viewbox="0 0 300 100">
<defs>
...
<div className="w-full md:w-1/2">
<h2 className="text-3xl md:text-5xl font-medium tracking-tight mb-6">100,000+ <br/> Stonks in Your App</h2>
...
<svg fill="none" height="100" stroke="black" strokeWidth="1" viewbox="0 0 200 100" width="200">
...
<div className="w-8 h-8 rounded-full bg-black flex items-center justify-center"><i className="w-4 h-4 text-white fill-current" data-lucide="apple"></i></div>
<div>
<p className="text-xs font-semibold">Apple Inc</p>
<p className="text-[10px] text-neutral-500">AAPL</p>
</div>
<div className="ml-auto text-xs font-semibold">$1,882.03</div>
</div>
...
<div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center"><i className="w-4 h-4 text-white" data-lucide="layout-grid"></i></div>
<div>
<p className="text-xs font-semibold">Microsoft corp</p>
<p className="text-[10px] text-neutral-500">MSFT</p>
</div>
<div className="ml-auto text-right">
<p className="text-xs font-semibold">$1,402.71</p>
...
<div className="w-8 h-8 rounded-full bg-blue-200 flex items-center justify-center"><i className="w-4 h-4 text-blue-600" data-lucide="box"></i></div>
<div>
<p className="text-xs font-semibold">Dropbox Inc</p>
<p className="text-[10px] text-neutral-500">DBX</p>
</div>
<div className="ml-auto text-right">
<p className="text-xs font-semibold">$669.12</p>
...
<section className="max-w-7xl mx-auto px-6 mb-24 text-center">
<h2 className="text-3xl md:text-5xl font-medium tracking-tight mb-8">Get the App for Free <br/> and Start Now</h2>
...
<div className="w-4 h-4 rounded-full bg-[#ccf32f]"></div>
<span className="text-lg font-medium">Pro Finance</span>
</div>
</div>
...
<li><a className="hover:text-white transition-colors" href="#">Stocks &amp; Founds</a></li>
<li><a className="hover:text-white transition-colors" href="#">Learn</a></li>
...
<input className="w-full bg-neutral-900 border border-neutral-800 rounded-full py-3 pl-5 pr-12 text-sm text-white focus:outline-none focus:border-[#ccf32f]" placeholder="Your e-mail" type="email"/>

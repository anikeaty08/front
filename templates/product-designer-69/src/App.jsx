...
<span className="text-xs font-mono text-[#64906E]/80 font-semibold" id="localTime">05:50 PM</span>
</div>
...
<p className="leading-relaxed text-lg font-normal text-stone-950/80 max-w-xl">High-fidelity interfaces focused on data density &amp; user autonomy.</p>
</div>
...
<p className="leading-relaxed text-balance text-base font-normal text-neutral-700 mb-4">Bridging the Gap Between Talent and Company Insiders.</p>
<div className="flex flex-wrap gap-2 pt-1 mt-auto">
<span className="px-2.5 py-1 text-[11px] font-medium text-neutral-600 bg-neutral-50/50 backdrop-blur-md border border-neutral-200/60 rounded-lg shadow-sm tracking-wide">
                  Python
                </span>
...
<p className="leading-relaxed text-balance text-base font-normal text-neutral-700 mb-4">Design System for SAP</p>
<div className="flex flex-wrap gap-2 pt-1 mt-auto">
<span className="px-2.5 py-1 text-[11px] font-medium text-neutral-600 bg-neutral-50/50 backdrop-blur-md border border-neutral-200/60 rounded-lg shadow-sm tracking-wide">
                  IoT
                </span>
...
<p className="text-base font-normal text-neutral-700 leading-relaxed text-balance mb-4">
                Comprehensive React design system.
              </p>
<div className="flex flex-wrap gap-2 pt-1 mt-auto">
<span className="px-2.5 py-1 text-[11px] font-medium text-neutral-600 bg-neutral-50/50 backdrop-blur-md border border-neutral-200/60 rounded-lg shadow-sm tracking-wide">
                  Tokens
...
<div className="card-glare" style={{mixBlendMode: 'soft-light'}}></div>

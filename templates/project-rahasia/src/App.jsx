...
<svg aria-hidden="true" className="iconify text-indigo-500 iconify--lucide" data-height="20" data-icon="lucide:terminal" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M12 19h8M4 17l6-6l-6-6" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
<span className="font-bold tracking-tight text-white text-lg">
            Project Rahasia
          </span>
</div>
<div className="hidden md:flex gap-8 text-sm font-medium text-slate-400">
<a className="hover:text-white transition-colors" href="#agents">
            Tentang
          </a>
...
<a className="hidden md:flex items-center gap-2 text-xs font-mono bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2 rounded-md transition-all text-white" href="#contact">
...
<div className="code-bg opacity-20 absolute top-0 right-0 bottom-0 left-0"></div>
<div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-600/20 rounded-full blur-3xl filter opacity-50 animate-pulse"></div>
<div className="filter bg-blue-600/10 opacity-30 w-96 h-96 rounded-full absolute right-1/4 bottom-1/4 blur-3xl"></div>
</div>
...
<p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 font-light leading-relaxed">
          Tugas aplikasi, web UMKM, toko online sampai aplikasi mobile.
        </p>
<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
<a className="w-full sm:w-auto px-8 py-3.5 bg-white text-slate-950 text-sm font-medium rounded-lg hover:bg-slate-200 transition-all flex items-center justify-center gap-2 group" href="#contact">
            KONSULTASI GRATIS
...
<a className="w-full sm:w-auto px-8 py-3.5 bg-white/5 border border-white/10 text-white text-sm font-medium rounded-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2" href="#portfolio">
...
<section className="py-24 relative border-t border-white/5 bg-slate-950" id="agents">
<div className="max-w-7xl mx-auto px-6">
<div className="grid lg:grid-cols-2 gap-16 items-center">
<div>
<h2 className="text-xs font-mono text-indigo-400 mb-4 uppercase tracking-widest">
              Tim Dibalik Layar
            </h2>
<h3 className="text-3xl font-medium text-white mb-6 tracking-tight">
              Kami arsitek digital anda.
            </h3>
<p className="text-slate-400 leading-relaxed mb-6">
              Kumpulan programmer baik yang akan membantu anda dari nol sampai
              aplikasi jadi.
            </p>
<div className="flex items-center gap-4 text-sm text-slate-500 border-l-2 border-indigo-500/50 pl-4">
...
<svg aria-hidden="true" className="iconify text-indigo-400 iconify--lucide" data-icon="lucide:layers" data-width="18" height="18" role="img" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path></g></svg>
<h4 className="text-sm font-mono font-medium text-white uppercase tracking-wider">
                Tech Stack
              </h4>
</div>
...
<div className="flex flex-col items-center gap-2 group cursor-pointer">
<div className="p-3 rounded-lg bg-white/5 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-colors text-slate-400">
<svg aria-hidden="true" className="iconify iconify--simple-icons" data-icon="simple-icons:php" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7.01 10.207h-.944l-.515 2.648h.838q.834 0 1.242-.314q.408-.315.55-1.049q.137-.705-.124-.995q-.262-.29-1.047-.29M12 5.688C5.373 5.688 0 8.514 0 12s5.373 6.313 12 6.313S24 15.486 24 12s-5.373-6.312-12-6.312m-3.26 7.451c-.261.25-.575.438-.917.551q-.505.163-1.285.164H5.357l-.327 1.681H3.652l1.23-6.326h2.65q1.195 0 1.744.628q.549.627.33 1.752a2.8 2.8 0 0 1-.305.847q-.215.383-.561.703m4.024.715l.543-2.799q.094-.478-.068-.651q-.16-.174-.687-.174H11.46l-.704 3.625H9.388l1.23-6.327h1.367l-.327 1.682h1.218q1.15 0 1.586.401c.436.401.378.7.263 1.299l-.572 2.944zm7.597-2.265a2.8 2.8 0 0 1-.305.847q-.214.383-.561.703a2.44 2.44 0 0 1-.917.551q-.504.163-1.286.164h-1.18l-.327 1.682h-1.378l1.23-6.326h2.649q1.195 0 1.744.628q.55.626.331 1.751m-2.595-1.382h-.943l-.516 2.648h.838q.835 0 1.242-.314q.407-.315.551-1.049q.137-.705-.125-.995c-.262-.29-.524-.29-1.047-.29" fill="currentColor"></path></svg>
</div>
<span className="text-xs font-mono text-slate-500 group-hover:text-slate-300">
                  PHP/Laravel
                </span>
...
<div className="flex flex-col items-center gap-2 group cursor-pointer">
<div className="p-3 rounded-lg bg-white/5 group-hover:bg-green-500/20 group-hover:text-green-400 transition-colors text-slate-400">
<svg aria-hidden="true" className="iconify iconify--simple-icons" data-icon="simple-icons:vuedotjs" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M24 1.61h-9.94L12 5.16L9.94 1.61H0l12 20.78ZM12 14.08L5.16 2.23h4.43L12 6.41l2.41-4.18h4.43Z" fill="currentColor"></path></svg>
</div>
<span className="text-xs font-mono text-slate-500 group-hover:text-slate-300">
                  Vue
                </span>
...
<div className="flex flex-col items-center gap-2 group cursor-pointer">
<div className="p-3 rounded-lg bg-white/5 group-hover:bg-blue-500/20 group-hover:text-blue-400 transition-colors text-slate-400">
<svg aria-hidden="true" className="iconify iconify--simple-icons" data-icon="simple-icons:flutter" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M14.314 0L2.3 12L6 15.7L21.684.013h-7.357zm.014 11.072L7.857 17.53l6.47 6.47H21.7l-6.46-6.468l6.46-6.46h-7.37z" fill="currentColor"></path></svg>
</div>
<span className="text-xs font-mono text-slate-500 group-hover:text-slate-300">
                  Flutter
                </span>
...
<div className="flex flex-col items-center gap-2 group cursor-pointer">
<div className="p-3 rounded-lg bg-white/5 group-hover:bg-purple-500/20 group-hover:text-purple-400 transition-colors text-slate-400">
<svg aria-hidden="true" className="iconify iconify--simple-icons" data-icon="simple-icons:kotlin" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M24 24H0V0h24L12 12Z" fill="currentColor"></path></svg>
</div>
<span className="text-xs font-mono text-slate-500 group-hover:text-slate-300">
                  Kotlin
                </span>
...
<h2 className="text-3xl font-medium text-white tracking-tight mb-2">
              Project Rahasia Yang Sudah Keluar
            </h2>
<p className="text-slate-400">Beberapa project yang kami kerjakan.</p>
</div>
...
<div className="group glass-panel rounded-xl overflow-hidden hover:border-indigo-500/30 transition-all duration-300">
<div className="h-48 bg-slate-900 relative overflow-hidden">
<div className="absolute inset-0 bg-slate-800 animate-pulse"></div>

<div className="absolute inset-0 flex items-center justify-center">
<svg aria-hidden="true" className="iconify text-slate-600 opacity-20 iconify--lucide" data-icon="lucide:shopping-bag" data-width="64" height="64" role="img" viewbox="0 0 24 24" width="64" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M16 10a4 4 0 0 1-8 0M3.103 6.034h17.794"></path><path d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z"></path></g></svg>
</div>
<div className="absolute inset-0 backdrop-blur-[2px] bg-slate-900/10"></div>
<div className="absolute top-4 right-4 bg-black/50 backdrop-blur-md px-2 py-1 rounded text-[10px] font-mono text-white border border-white/10">
                TOP SECRET
              </div>
</div>
<div className="p-6">
<div className="flex gap-2 mb-4">
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-indigo-500/10 text-indigo-400 border border-indigo-500/10">
                  Laravel
                </span>
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/10">
                  Vue
                </span>
</div>
<h3 className="text-lg font-medium text-white mb-2">Project 1</h3>
<p className="text-sm text-slate-400 mb-6 line-clamp-2">
                Sistem informasi project 1.
              </p>
<button className="w-full py-2 rounded-lg border border-white/10 hover:bg-white/5 text-xs text-white transition-colors flex items-center justify-center gap-2 group-hover:border-indigo-500/30">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:eye" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M2.062 12.348a1 1 0 0 1 0-.696a10.75 10.75 0 0 1 19.876 0a1 1 0 0 1 0 .696a10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></g></svg>
                LIHAT DEMO
              </button>
</div>
</div>
...
<div className="group glass-panel rounded-xl overflow-hidden hover:border-indigo-500/30 transition-all duration-300">
<div className="h-48 bg-slate-900 relative overflow-hidden">
<div className="absolute inset-0 bg-slate-800 animate-pulse delay-75"></div>
<div className="absolute inset-0 flex items-center justify-center">
<svg aria-hidden="true" className="iconify text-slate-600 opacity-20 iconify--lucide" data-icon="lucide:bar-chart-2" data-width="64" height="64" role="img" viewbox="0 0 24 24" width="64" xmlns="http://www.w3.org/2000/svg"><path d="M5 21v-6m7 6V3m7 18V9" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</div>
<div className="absolute inset-0 backdrop-blur-[2px] bg-slate-900/10"></div>
<div className="absolute top-4 right-4 bg-black/50 backdrop-blur-md px-2 py-1 rounded text-[10px] font-mono text-white border border-white/10">
                CLASSIFIED
...
<div className="p-6">
<div className="flex gap-2 mb-4">
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-yellow-500/10 text-yellow-400 border border-yellow-500/10">
                  Django
                </span>
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-blue-500/10 text-blue-400 border border-blue-500/10">
                  PostgreSQL
                </span>
</div>
<h3 className="text-lg font-medium text-white mb-2">Project 2</h3>
<p className="text-sm text-slate-400 mb-6 line-clamp-2">
                Sistem informasi project 2.
              </p>
<button className="w-full py-2 rounded-lg border border-white/10 hover:bg-white/5 text-xs text-white transition-colors flex items-center justify-center gap-2 group-hover:border-indigo-500/30">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:eye" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M2.062 12.348a1 1 0 0 1 0-.696a10.75 10.75 0 0 1 19.876 0a1 1 0 0 1 0 .696a10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></g></svg>
                LIHAT DEMO
...
<div className="group glass-panel rounded-xl overflow-hidden hover:border-indigo-500/30 transition-all duration-300">
<div className="h-48 bg-slate-900 relative overflow-hidden">
<div className="absolute inset-0 bg-slate-800 animate-pulse delay-150"></div>
<div className="absolute inset-0 flex items-center justify-center">
<svg aria-hidden="true" className="iconify text-slate-600 opacity-20 iconify--lucide" data-icon="lucide:smartphone" data-width="64" height="64" role="img" viewbox="0 0 24 24" width="64" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><rect height="20" rx="2" ry="2" width="14" x="5" y="2"></rect><path d="M12 18h.01"></path></g></svg>
</div>
<div className="absolute inset-0 backdrop-blur-[2px] bg-slate-900/10"></div>
<div className="absolute top-4 right-4 bg-black/50 backdrop-blur-md px-2 py-1 rounded text-[10px] font-mono text-white border border-white/10">
                RESTRICTED
...
<div className="p-6">
<div className="flex gap-2 mb-4">
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-cyan-500/10 text-cyan-400 border border-cyan-500/10">
                  Flutter
                </span>
<span className="px-2 py-0.5 rounded text-[10px] font-medium bg-orange-500/10 text-orange-400 border border-orange-500/10">
                  Firebase
                </span>
</div>
<h3 className="text-lg font-medium text-white mb-2">Project 3</h3>
<p className="text-sm text-slate-400 mb-6 line-clamp-2">
                Sistem informasi project 3.
              </p>
<button className="w-full py-2 rounded-lg border border-white/10 hover:bg-white/5 text-xs text-white transition-colors flex items-center justify-center gap-2 group-hover:border-indigo-500/30">
<svg aria-hidden="true" className="iconify iconify--lucide" data-icon="lucide:eye" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M2.062 12.348a1 1 0 0 1 0-.696a10.75 10.75 0 0 1 19.876 0a1 1 0 0 1 0 .696a10.75 10.75 0 0 1-19.876 0"></path><circle cx="12" cy="12" r="3"></circle></g></svg>
                LIHAT DEMO
...
<section className="py-24 bg-slate-950 border-t border-white/5 relative overflow-hidden" id="services">

<div className="absolute right-0 top-0 h-full w-px bg-gradient-to-b from-transparent via-indigo-500/20 to-transparent"></div>
<div className="max-w-5xl mx-auto px-6">
<h2 className="text-4xl font-medium text-white tracking-tight mb-12">
          SERVICES_AVAILABLE
        </h2>
<div className="overflow-hidden rounded-xl border border-white/10">
<table className="w-full text-left border-collapse">
<thead>
<tr className="bg-white/5 text-xs uppercase font-mono text-slate-500 border-b border-white/10">
<th className="py-4 px-6 w-1/3">Layanan</th>
...
<p className="text-slate-400 text-sm leading-relaxed">
                    Website toko, sekolah, atau sistem kasir. Bisa cetak struk,
                    kirim notif WA otomatis.
                  </p>
</td>
<td className="py-6 px-6 align-middle text-right">
<svg aria-hidden="true" className="iconify text-slate-600 group-hover:text-indigo-400 transition-colors iconify--lucide" data-icon="lucide:arrow-up-right" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10M7 17L17 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</td>
</tr>
<tr className="group hover:bg-white/5 transition-colors">
<td className="py-6 px-6 align-top">
...
<td className="py-6 px-6 align-top">
<p className="text-slate-400 text-sm leading-relaxed">
                    APK ringan, bisa mode offline, UI modern, dan siap upload
                    langsung di Play Store.
                  </p>
</td>
<td className="py-6 px-6 align-middle text-right">
<svg aria-hidden="true" className="iconify text-slate-600 group-hover:text-emerald-400 transition-colors iconify--lucide" data-icon="lucide:arrow-up-right" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10M7 17L17 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</td>
</tr>
<tr className="group hover:bg-white/5 transition-colors">
<td className="py-6 px-6 align-top">
...
<td className="py-6 px-6 align-top">
<p className="text-slate-400 text-sm leading-relaxed">
                    Bot input data struk, hitung stok otomatis, kirim laporan
                    rekap ke bos tiap malam.
                  </p>
</td>
<td className="py-6 px-6 align-middle text-right">
<svg aria-hidden="true" className="iconify text-slate-600 group-hover:text-purple-400 transition-colors iconify--lucide" data-icon="lucide:arrow-up-right" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10M7 17L17 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</td>
</tr>
</tbody>
</table>
...
<section className="py-24 relative bg-slate-950" id="contact">
<div className="absolute inset-0 bg-gradient-to-t from-indigo-900/10 to-transparent"></div>
<div className="max-w-4xl mx-auto px-6 relative z-10">
<div className="text-center mb-12">
<div className="inline-flex items-center gap-2 mb-4 text-emerald-500 text-xs font-mono">
...
<p className="text-slate-400 text-lg">
            Punya ide tugas tapi malas eksekusi? Warung mau go-digital?
            <br/>
...
<div className="glass-panel p-8 rounded-2xl md:p-12 shadow-2xl shadow-indigo-500/5">
...
<input className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm" placeholder="Agen 1" type="text"/>
</div>
<div className="space-y-2">
<label className="text-xs font-medium text-slate-400 uppercase tracking-wider">
                  Email
                </label>
<input className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm" placeholder="john@gmail.com" type="email"/>
</div>
</div>
<div className="space-y-2">
<label className="text-xs font-medium text-slate-400 uppercase tracking-wider">
...
<textarea className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm resize-none" placeholder="Ceritakan detailnya..." rows="4"></textarea>
</div>
<button className="w-full py-4 bg-white hover:bg-slate-200 text-slate-950 font-semibold rounded-lg transition-all flex items-center justify-center gap-2 group" type="button">
...
<a className="flex items-center gap-2 text-slate-500 hover:text-white transition-colors" href="#">
...
<span className="text-xs font-mono">@projectrahasia</span>
</a>
</div>
<a className="flex items-center gap-2 text-emerald-400 hover:text-emerald-300 transition-colors text-sm font-medium" href="#">
...
<p className="text-[10px] text-slate-600 font-mono">
            ENCRYPTED // SECURE // 2023 PROJECT RAHASIA
            <br/>
            ALL RIGHTS RESERVED IN THE SHADOWS.
          </p>
</div>
</div>
</section>

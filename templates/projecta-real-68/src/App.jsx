...
gtag('config', 'G-2M6V79H761');
      ...
      const services = [
          { text: "Gayrimenkul Satışı" },
          { text: "Gayrimenkul Alımı" },
          { text: "Gayrimenkul Kiralama" }
      ];
...
<div className="px-4 font-medium tracking-tight text-lg hidden md:block uppercase tracking-wider">
          PROJECTA
        </div>
...
<span className="text-[14vw] xl:text-[240px] reveal-element font-normal visible">
            PROJECTA
          </span>
<span className="text-[7vw] xl:text-[90px] self-end -mt-[1vw] xl:-mt-4 reveal-element mr-[5%] visible" style={{transitionDelay: '100ms'}}>
            Gayrimenkul
          </span>
</h1>
</div>
...
<div className="text-lg md:text-[20px] text-gray-500 font-normal leading-tight">
            Sizin ve Hedefleriniz İçin Ulaşılabilir
          </div>
</div>
</div>
</section>
...
<h2 className="md:text-[48px] leading-[1.1] text-5xl font-normal tracking-[-0.04em]">
          Avantajlarınız
          <span className="text-[#A1A19F]">PROJECTA ile</span>
</h2>
...
<img className="w-full h-full object-cover hover-card-bg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
...
<span className="text-lg font-medium text-black">Samimiyet</span>
</div>
...
<p className="leading-relaxed text-sm font-medium text-white pt-2 drop-shadow-md">
                Size her zaman samimiyetle yaklaşıyoruz. Her adımda adil ve şeffaf bir ortaklık.
              </p>
</div>
</div>
</div>
...
<img className="w-full h-full object-cover hover-card-bg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col justify-end">
<div className="glass-panel self-start px-5 py-2.5 rounded-full mb-3 backdrop-blur-md bg-white/90">
<span className="text-lg font-medium text-black">Bölgesellik</span>
</div>
<div className="h-0 overflow-hidden group-hover:h-auto group-active:h-auto transition-all duration-500 ease-out opacity-0 group-hover:opacity-100 group-active:opacity-100">
<p className="leading-relaxed text-sm font-medium text-white pt-2 drop-shadow-md">
                Bölgeyi ve pazarı avucumuzun içi gibi biliyoruz. Yerel köklere sahibiz.
              </p>
</div>
</div>
</div>
...
<div className="group relative aspect-[3/4] rounded-[24px] overflow-hidden cursor-pointer reveal-element reveal-init">
<img className="w-full h-full object-cover hover-card-bg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
<div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col justify-end">
<div className="glass-panel self-start px-5 py-2.5 rounded-full mb-3 backdrop-blur-md bg-white/90">
<span className="text-lg font-medium text-black">Güven</span>
</div>
<div className="h-0 overflow-hidden group-hover:h-auto group-active:h-auto transition-all duration-500 ease-out opacity-0 group-hover:opacity-100 group-active:opacity-100">
<p className="text-white text-sm leading-relaxed pt-2 font-medium drop-shadow-md">
                Başarımızın temeli güvendir. Gizlilik, güvenilirlik ve dürüstlükle hareket ediyoruz.
              </p>
</div>
</div>
</div>
...
<div className="group relative aspect-[3/4] rounded-[24px] overflow-hidden cursor-pointer lg:translate-y-16 reveal-element reveal-init">
<img className="w-full h-full object-cover hover-card-bg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp"/>
<div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors duration-500"></div>
<div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col justify-end">
<div className="glass-panel self-start px-5 py-2.5 rounded-full mb-3 backdrop-blur-md bg-white/90">
<span className="text-lg font-medium text-black">Uzmanlık</span>
</div>
<div className="h-0 overflow-hidden group-hover:h-auto group-active:h-auto transition-all duration-500 ease-out opacity-0 group-hover:opacity-100 group-active:opacity-100">
<p className="text-white text-sm leading-relaxed pt-2 font-medium drop-shadow-md">
                Yılların deneyimi ve derinlemesine uzmanlık size en iyi hizmeti garanti eder.
              </p>
</div>
</div>
</div>
...
<h2 className="md:text-[48px] leading-tight text-4xl font-normal text-[#17191F] tracking-[-0.04em]">
            Neden Sizin İçin
            <br/>
<span className="text-[#A1A19F]">Doğru İş Ortağıyız:</span>
</h2>
...
<p className="text-[20px] leading-[1.3] text-[#17191F] tracking-[-0.01em] max-w-sm">
                “Başından beri çok iyi hissediyorduk. Her şey bizim için mükemmeldi. Danışmanlık ve tabii ki elde edilen satış fiyatı.”
              </p>
<div className="absolute bottom-[26px] right-[18px] w-[200px] h-[120px] md:w-[280px] md:h-[150px]">
<img className="w-full h-full object-cover rounded-xl shadow-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp"/>
...
<span className="text-gray-400 text-xs">Haziran 2025</span>
</div>
</div>
</div>
</div>
...
<div className="min-w-full md:min-w-[527px] flex flex-col group hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] transition-shadow bg-white h-[345px] border-gray-200 border rounded-[24px] pt-8 pr-8 pb-8 pl-8 relative shadow-[0_4px_20px_rgba(0,0,0,0.02)] justify-between">
<p className="text-[20px] leading-[1.3] text-[#17191F] tracking-[-0.01em] max-w-sm">
                “Profesyonel, hızlı ve tamamen şeffaf. Sözünü tutan bir emlak ofisi. Kesinlikle tekrar çalışırız.”
              </p>
<div className="absolute bottom-[26px] right-[18px] w-[200px] h-[120px] md:w-[280px] md:h-[150px]">
<img className="w-full h-full object-cover rounded-xl shadow-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute -bottom-4 -left-4 bg-white/90 backdrop-blur border border-white/50 rounded-full pl-2 pr-5 py-2 flex items-center gap-3 shadow-lg">
<img className="w-10 h-10 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
<div className="flex flex-col">
<span className="text-black text-sm font-medium">
                      Thomas K.
                    </span>
<span className="text-gray-400 text-xs">Mayıs 2025</span>
</div>
</div>
</div>
</div>
...
<p className="text-[20px] leading-[1.3] tracking-[-0.01em] text-[#17191F] max-w-sm">
                “Mükemmel piyasa bilgisi ve çok kişisel bir hizmet. Villamızın satışı sorunsuz gerçekleşti.”
              </p>
<div className="absolute bottom-[26px] right-[18px] w-[200px] h-[120px] md:w-[280px] md:h-[150px]">
<img className="w-full h-full object-cover rounded-xl shadow-md" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp"/>
<div className="absolute -bottom-4 -left-4 bg-white/90 backdrop-blur border border-white/50 rounded-full pl-2 pr-5 py-2 flex items-center gap-3 shadow-lg">
<img className="w-10 h-10 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp"/>
<div className="flex flex-col">
<span className="text-black text-sm font-medium">
                      Michael B.
                    </span>
<span className="text-gray-400 text-xs">Nisan 2025</span>
</div>
</div>
</div>
</div>
...
<h2 className="text-[8vw] md:text-[6rem] font-normal leading-none tracking-tighter mix-blend-overlay" id="service-text">Gayrimenkul Satışı</h2>
</div>
...
<h2 className="text-4xl md:text-[48px] font-normal tracking-[-0.04em] leading-[1.1]">
            Sadece Sizin Sormadığınız Sorular
          </h2>
</div>
...
<span className="text-xl font-medium tracking-tight">
                Sürecin şeffaflığına güvenebilir miyim?
              </span>
...
<div className="pb-8 text-gray-600 text-lg leading-relaxed">
                Kesinlikle. Şeffaflık ve adalet bizim için en önemli unsurlardır. Her adım sizinle tam olarak koordine edilir.
              </div>
</div>
</div>
...
<button className="accordion-header w-full flex justify-between items-start text-left p-8 gap-4">
<span className="text-xl font-medium tracking-tight">
                Aynı anda birkaç emlakçıyla çalışabilir miyim?
              </span>
...
<div className="pb-8 text-gray-600 text-lg leading-relaxed">
                Evet, elbette. Ancak deneyimlerimize göre bu yaklaşım mülk sahipleri için avantajlı olmuyor. Nedenlerini detaylıca 
                <a className="text-black underline" href="#">Tek Yetkili Emlakçı</a>
                sayfamızda açıklıyoruz.
              </div>
</div>
</div>
...
<button className="accordion-header w-full flex justify-between items-start text-left p-8 gap-4">
<span className="text-xl font-medium tracking-tight">
                Satış süreci ortalama ne kadar sürer?
              </span>
<div className="bg-[#F6F7FA] p-3 rounded-full shrink-0 accordion-icon">
<svg className="lucide lucide-chevron-down w-5 h-5" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</div>
...
<div className="accordion-content px-8">
<div className="pb-8 text-gray-600 text-lg leading-relaxed">
                Ortalama olarak 3 ila 6 ay sürer, ancak bu konuma, fiyata ve genel piyasa durumuna büyük ölçüde bağlıdır.
              </div>
</div>
</div>
</div>
...
<h4 className="text-lg font-medium text-gray-400">Gayrimenkul</h4>
...
<div className="space-y-6">
<h4 className="text-lg font-medium text-gray-400">Kurumsal</h4>
<ul className="space-y-4">
<li>
<a className="text-2xl font-normal hover:text-gray-500 transition-colors tracking-tight" href="#">
                  Hakkımızda
...
<div className="space-y-6">
<h4 className="text-lg font-medium text-gray-400">Hizmet Merkezi</h4>
<ul className="space-y-4">
<li>
<a className="text-2xl font-normal hover:text-gray-500 transition-colors tracking-tight" href="#">
                  İletişim
...
<div className="space-y-6">
<h4 className="text-lg font-medium text-gray-400">Sorularınız mı var?</h4>
...
<input className="w-full bg-[#F6F7FA] py-4 pl-6 pr-14 rounded-xl outline-none focus:ring-1 focus:ring-black transition-all" placeholder="E-posta adresiniz" type="email"/>
...
<a className="hover:text-black decoration-1" href="#">Gizlilik Politikası</a>
<a className="hover:text-black decoration-1" href="#">Aydınlatma Metni</a>
</div>

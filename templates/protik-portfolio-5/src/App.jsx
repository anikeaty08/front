...
<canvas className="fixed z-0 pointer-events-auto opacity-60 w-full h-full top-0 right-0 bottom-0 left-0" height="525" id="starfield" width="840"></canvas><canvas className="fixed z-0 pointer-events-auto opacity-60 w-full h-full top-0 right-0 bottom-0 left-0" height="525" id="starfield" width="840"></canvas>
...
<span className="text-sm font-medium text-white/90 tracking-tight">PROTIK</span>
</div>
...
<a className="hover:text-white transition-colors duration-300 inline-flex items-center gap-2" href="https://github.com/protik7545" rel="noreferrer" target="_blank">
        GitHub
...
<div className="hero-text-layer text-center px-4 flex flex-col items-center" id="hero-content" style={{filter: 'blur(0px)'}}>
...
<a className="pointer-events-auto mt-6 inline-flex items-center gap-2 text-xs font-medium text-white/80 hover:text-white transition-colors md:hidden" href="https://github.com/protik7545" rel="noreferrer" target="_blank">
<iconify-icon icon="solar:code-square-linear" width="16"></iconify-icon>
        github.com/protik7545
        <iconify-icon icon="solar:arrow-right-up-linear" width="14"></iconify-icon>
</a>
</div>
</div>
...
<a className="mt-4 inline-flex items-center justify-center gap-2 text-xs font-medium text-white/80 hover:text-white transition-colors" href="mailto:protiksarker7545@gmail.com">
<iconify-icon icon="solar:letter-linear" width="16"></iconify-icon>
            protiksarker7545@gmail.com
          </a>
</div>

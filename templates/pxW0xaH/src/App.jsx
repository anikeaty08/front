...
<h1 className="text-2xl md:text-3xl font-bold text-white">Network Infrastructure Dashboard</h1>
...
<div className="md:col-span-2 bg-gray-900 rounded-xl overflow-hidden border border-gray-800 shadow-lg">
...
<div className="absolute bottom-4 right-4 bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2 z-10">

...
<button className="flex-1 bg-[#1e1e3a] rounded-xl py-3 flex flex-col items-center text-sm shadow">
<i className="fas fa-arrow-down text-blue-400 mb-1"></i> Receive
          </button>
<button className="flex-1 bg-[#1e1e3a] rounded-xl py-3 flex flex-col items-center text-sm shadow">
<i className="fas fa-arrow-up text-purple-400 mb-1"></i> Send
          </button>
<button className="flex-1 bg-[#1e1e3a] rounded-xl py-3 flex flex-col items-center text-sm shadow">
<i className="fas fa-exchange-alt text-green-400 mb-1"></i> Exchange
          </button>
</div>
<div>
...
<p className="text-xs text-gray-400">From Alex • 17:50</p>
</div>
</div>
<p className="font-bold text-green-400">+$200.00</p>
</div>
<div className="bg-[#1e1e3a] rounded-2xl p-4 shadow-lg flex items-center justify-between">
<div className="flex items-center">
<div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center mr-3">
<i className="fas fa-arrow-up text-purple-400"></i>
</div>
<div>
<p className="font-medium">Sent</p>
<p className="text-xs text-gray-400">To Taylor • 15:32</p>
</div>
</div>
<p className="font-bold text-red-400">-$78.50</p>
</div>
<div className="bg-[#1e1e3a] rounded-2xl p-4 shadow-lg flex items-center justify-between">
<div className="flex items-center">
...
<p className="text-xs text-gray-400">USD to EUR • 13:12</p>
</div>
</div>
<p className="font-bold text-yellow-400">-$150.00</p>
</div>
</div>
</div>
</main>
...
<div className="flex flex-col items-center active cursor-pointer">

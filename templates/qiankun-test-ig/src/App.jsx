...
<div className="flashlight-card aspect-[3/4] flex flex-col w-full max-w-md h-[75vh] max-h-[800px] rounded-3xl p-10 relative shadow-2xl overflow-hidden" style={{background: 'linear-gradient(to right bottom, rgba(234, 88, 12, 0.1), rgba(0, 0, 0, 0))', '--mouse-x': '309px', '--mouse-y': '133px'}}>
...
<div className="flashlight-card aspect-[3/4] overflow-hidden flex flex-col bg-center font-space-mono bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-blue-500/10 to-blue-500/0 w-full h-[75vh] max-w-md max-h-[800px] rounded-3xl pt-10 pr-10 pb-10 pl-10 shadow-2xl" style={{'--mouse-x': '272px', '--mouse-y': '23px'}}>
<div className="flex justify-between items-center mb-8 animate-item text-white/50" style={{animationName: 'enter'}}>
...
<div className="flashlight-card aspect-[3/4] h-[75vh] max-h-[800px] w-full max-w-md rounded-3xl overflow-hidden flex flex-col border shadow-2xl relative border-white/10" style={{'--mouse-x': '360px', '--mouse-y': '224px'}}>

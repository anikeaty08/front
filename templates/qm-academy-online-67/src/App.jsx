...
<a className="text-sm font-medium hover:text-white transition-colors" href="#">Soluciones</a>
<a className="text-sm font-medium hover:text-white transition-colors" href="#">Cursos</a>
<a className="text-sm font-medium hover:text-white transition-colors" href="#">Certificación</a>
<a className="text-sm font-medium hover:text-white transition-colors" href="#">Precios</a>
</div>
<div className="flex items-center gap-4">

<button aria-label="Cambiar idioma a Inglés" className="flex items-center gap-1.5 text-sm font-medium text-slate-400 hover:text-white transition-colors mr-2 group">
<i className="w-4 h-4 text-slate-500 group-hover:text-blue-400 transition-colors" data-lucide="globe"></i>
<span>EN</span>
</button>
<div className="h-4 w-px bg-white/10 hidden sm:block"></div>
<a className="hidden md:block text-sm font-medium text-slate-400 hover:text-white" href="#">Acceder</a>
<a className="bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-full text-sm font-medium transition-all border border-white/5 flex items-center gap-2" href="#">
                    Empezar <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>
</div>
</nav>
...
<span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
                        ...
                        Nuevos Módulos ISO 9001:2024 Disponibles
                    </div>
<h1 className="text-5xl lg:text-7xl font-semibold text-white tracking-tight leading-[1.1]">
                        Construye un <span className="gradient-text">Futuro Brillante</span> a través de la Gestión.
                    </h1>
<p className="text-lg text-slate-400 max-w-lg leading-relaxed">
                        Domina los estándares de la industria. Cursos dirigidos por expertos sobre certificación ISO, gestión de calidad y excelencia operativa para individuos y organizaciones.
                    </p>
...
<span className="text-white font-medium">4.9/5</span> de 2,500+ estudiantes
                        </div>
</div>
</div>
...
<div>
<p className="text-white font-medium text-sm">Curso Completado</p>
<p className="text-xs text-slate-400">Auditor Líder ISO 27001</p>
</div>
</div>
...
<span className="text-xs font-medium text-white">Taller en Vivo</span>
</div>
</div>
</div>
</div>
...
<h2 className="text-sm font-medium text-purple-400 uppercase tracking-widest mb-3">APRENDE CON NOSOTROS</h2>
<h3 className="text-3xl lg:text-4xl font-semibold text-white tracking-tight">Oportunidad de Aprendizaje Online</h3>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3">Cursos de Expertos</h4>
<p className="text-slate-400 text-base leading-relaxed">
                        Aprende directamente de auditores certificados ISO y veteranos de la gestión con experiencia real.
                    </p>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3">Más de 500 Temas</h4>
<p className="text-blue-100/80 text-base leading-relaxed mb-6">
                        Desde Gestión de Riesgos hasta Seguridad Ambiental, accede a nuestra biblioteca completa.
                    </p>
<a className="inline-flex items-center gap-2 text-white font-medium text-sm hover:gap-3 transition-all" href="#">
                        Leer Más <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3">Videos Actualizados</h4>
<p className="text-slate-400 text-base leading-relaxed">
                        El contenido se actualiza trimestralmente para reflejar las últimas revisiones de estándares internacionales.
                    </p>
</div>
</div>
</div>
...
<div className="pr-4">
<p className="text-white text-sm font-medium">Video Tutoriales de Calidad</p>
<p className="text-xs text-slate-300">Ver Intro</p>
</div>
</div>
</div>
...
<h2 className="text-sm font-medium text-blue-400 uppercase tracking-widest">SOBRE NOSOTROS</h2>
<h3 className="text-3xl lg:text-4xl font-semibold text-white tracking-tight leading-tight">
                            Experiencia en Centro de <br/> Aprendizaje Online
                        </h3>
<p className="text-lg text-slate-400 leading-relaxed">
                            Cerramos la brecha entre los estándares teóricos y la aplicación práctica. Nuestra academia está diseñada para empoderar a los profesionales para implementar marcos ISO de manera efectiva.
                        </p>
</div>
...
<p className="text-sm text-slate-500">Estudiantes Inscritos</p>
</div>
<div>
<p className="text-3xl font-semibold text-white mb-1">236+</p>
<p className="text-sm text-slate-500">Sesiones Finalizadas</p>
</div>
<div>
<p className="text-3xl font-semibold text-white mb-1">99%</p>
<p className="text-sm text-slate-500">Tasa de Satisfacción</p>
</div>
</div>
</div>
</div>
...
<div>
<h2 className="text-sm font-medium text-purple-400 uppercase tracking-widest mb-2">100% GRATIS</h2>
<h3 className="text-3xl font-semibold text-white tracking-tight">Empieza a Aprender con Cursos Gratuitos</h3>
</div>
<a className="text-blue-400 hover:text-blue-300 text-sm font-medium flex items-center gap-2" href="#">
                    Ver todos los cursos <i className="w-4 h-4" data-lucide="arrow-right"></i>
</a>
</div>
...
<div className="absolute top-3 left-3 bg-blue-600/90 text-white text-xs px-2 py-1 rounded font-medium">Básico</div>
</div>
<div className="p-5">
<h4 className="text-lg font-medium text-white mb-2 group-hover:text-blue-400 transition-colors">Fundamentos ISO 9001</h4>
...
<span className="text-xs text-slate-400">12 Lecciones</span>
</div>
<span className="text-blue-400 font-semibold text-sm">Gratis</span>
</div>
</div>
</div>
...
<div className="absolute top-3 left-3 bg-purple-600/90 text-white text-xs px-2 py-1 rounded font-medium">Avanzado</div>
</div>
<div className="p-5">
<h4 className="text-lg font-medium text-white mb-2 group-hover:text-purple-400 transition-colors">Maestría en Auditoría Interna</h4>
<div className="flex items-center gap-1 mb-4">
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
...
<div className="flex items-center gap-2">
<i className="w-4 h-4 text-slate-500" data-lucide="book"></i>
<span className="text-xs text-slate-400">24 Lecciones</span>
</div>
...
<div className="absolute top-3 left-3 bg-blue-600/90 text-white text-xs px-2 py-1 rounded font-medium">Gestión</div>
</div>
<div className="p-5">
<h4 className="text-lg font-medium text-white mb-2 group-hover:text-blue-400 transition-colors">Evaluación de Riesgos 101</h4>
<div className="flex items-center gap-1 mb-4">
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
...
<div className="flex items-center gap-2">
<i className="w-4 h-4 text-slate-500" data-lucide="book"></i>
<span className="text-xs text-slate-400">18 Lecciones</span>
</div>
<span className="text-blue-400 font-semibold text-sm">Gratis</span>
</div>
</div>
...
<div className="absolute top-3 left-3 bg-emerald-600/90 text-white text-xs px-2 py-1 rounded font-medium">Seguridad</div>
</div>
<div className="p-5">
<h4 className="text-lg font-medium text-white mb-2 group-hover:text-purple-400 transition-colors">Salud y Seguridad (ISO 45001)</h4>
<div className="flex items-center gap-1 mb-4">
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
<i className="w-3 h-3 text-yellow-500 fill-current" data-lucide="star"></i>
...
<div className="flex items-center gap-2">
<i className="w-4 h-4 text-slate-500" data-lucide="book"></i>
<span className="text-xs text-slate-400">30 Lecciones</span>
</div>
...
<h2 className="text-sm font-medium text-blue-400 uppercase tracking-widest mb-3">TESTIMONIO</h2>
<h3 className="text-3xl font-semibold text-white tracking-tight mb-12">Lo Que Dicen De Nosotros</h3>
<div className="relative">
...
<blockquote className="text-2xl text-slate-300 font-light leading-relaxed mb-8">
                    "El curso de implementación de ISO 9001 cambió el juego para nuestra organización. La estructura fue clara, concisa e increíblemente práctica para nuestro equipo de auditoría."
                </blockquote>
...
<div className="text-slate-500 text-sm">Gerente de Calidad, TechCorp</div>
</div>
...
<div>
<h2 className="text-sm font-medium text-blue-200 uppercase tracking-widest mb-3">BOLETÍN INFORMATIVO</h2>
<h3 className="text-3xl lg:text-4xl font-semibold text-white tracking-tight mb-4">Recibe Todas Nuestras Notificaciones</h3>
<p className="text-blue-100 text-lg leading-relaxed mb-8">
                            Suscríbete para recibir las últimas actualizaciones sobre cambios en las normas ISO, lanzamientos de nuevos cursos y consejos exclusivos de gestión.
                        </p>
...
<input className="flex-1 bg-slate-950/50 border border-white/10 text-white placeholder-slate-400 rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500/50" placeholder="Ingresa tu correo electrónico" type="email"/>
...
<p className="text-slate-400 text-base leading-relaxed mb-6">
                        Empoderando a profesionales en todo el mundo con educación accesible y de alta calidad en sistemas de gestión.
                    </p>
<div className="flex gap-4">
...
<div>
<h4 className="text-white font-medium mb-6">Acerca de</h4>
<ul className="space-y-4 text-slate-400 text-sm">
<li><a className="hover:text-blue-400 transition-colors" href="#">Cómo funciona</a></li>
<li><a className="hover:text-blue-400 transition-colors" href="#">Instructores</a></li>
<li><a className="hover:text-blue-400 transition-colors" href="#">Historias de Éxito</a></li>
</ul>
</div>
<div>
<h4 className="text-white font-medium mb-6">Cursos</h4>
<ul className="space-y-4 text-slate-400 text-sm">
...
<li><a className="hover:text-blue-400 transition-colors" href="#">Auditoría Interna</a></li>
<li><a className="hover:text-blue-400 transition-colors" href="#">Gestión de Riesgos</a></li>
</ul>
</div>
<div>
<h4 className="text-white font-medium mb-6">Soporte</h4>
<ul className="space-y-4 text-slate-400 text-sm">
<li><a className="hover:text-blue-400 transition-colors" href="#">Centro de Ayuda</a></li>
<li><a className="hover:text-blue-400 transition-colors" href="#">Contáctanos</a></li>
...
<p>© 2024 QM Academy. Todos los derechos reservados.</p>

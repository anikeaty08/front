...
<span className="absolute right-0 top-1/2 -translate-y-1/2 text-[240px] text-black/[0.02] font-extralight">01</span>
<div className="max-w-4xl">
<h1 className="flex flex-col leading-[0.9]">
<span className="text-[72px] md:text-[72px] tracking-[0.3em] font-bold">THE</span>
<span className="text-[116px] md:text-[116px] tracking-[0.2em] font-bold">NYCHE</span>
</h1>
<p className="mt-6 text-[14px] tracking-[0.2em] text-gray-500 uppercase">NYC Fashion &amp; Culture</p>
</div>
</div>
</section>
...
<section className="relative h-[480px] mb-24 group overflow-hidden">
<img alt="Featured" className="w-full h-full object-cover object-[center_40%] brightness-90 transition-all duration-400 group-hover:brightness-100" src="featured.jpg"/>

...
<h2 className="text-3xl md:text-4xl font-light mb-4 feature-fade" style={{letterSpacing: '-0.02em'}}>
<span className="bg-gradient-to-br from-purple-300 to-purple-500 bg-clip-text text-transparent">
                        Powerful Features
                    </span>
</h2>
<p className="text-purple-200 text-lg md:text-xl max-w-2xl mx-auto feature-fade feature-fade-delay-1">
...
<div className="bg-black/40 backdrop-blur-sm border border-purple-900/40 rounded-xl p-6 relative group feature-fade feature-fade-delay-1">
<div className="glow-effect opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
...
<div className="bg-black/40 backdrop-blur-sm border border-purple-900/40 rounded-xl p-6 relative group feature-fade feature-fade-delay-2">
<div className="glow-effect opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center mb-4">
<svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="bg-black/40 backdrop-blur-sm border border-purple-900/40 rounded-xl p-6 relative group feature-fade feature-fade-delay-3">
<div className="glow-effect opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
<div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center mb-4">
<svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

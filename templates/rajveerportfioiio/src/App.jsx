...
<div className="">
<div className="shadow-blue-900/20 flex overflow-hidden bg-white w-16 h-16 rounded-xl mb-6 shadow-lg items-center justify-center">
<img alt="Forum Sport" className="w-full h-full object-contain pt-0 pr-0 pb-0 pl-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7fd25a23-10e8-437b-91f8-bb82ae7edece_320w.webp"/>
</div>
...
<div className="">
<div className="flex shadow-black/20 text-xs font-medium text-white text-center bg-[#1a1a1a] w-16 h-16 rounded-xl mb-6 pt-1 pr-1 pb-1 pl-1 shadow-lg items-center justify-center">DOOERS</div>
...
<svg aria-hidden="true" className="lucide lucide-users w-16 h-16 stroke-[1] text-[#e6e4df]" data-lucide="users" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>
</div>
...
<div className="flex-grow flex items-center justify-center">
<svg aria-hidden="true" className="lucide lucide-globe w-16 h-16 stroke-[1] text-[#e6e4df]" data-lucide="globe" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg>
</div>

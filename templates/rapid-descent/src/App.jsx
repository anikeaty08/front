...
<a className="font-bebas text-4xl tracking-tight text-white transition-colors duration-300" href="#" id="header-logo">
            RAPID <span className="text-[#D4FF33]">DESCENT</span>
</a>

<div className="hidden md:flex items-center gap-8">
<a className="text-xs font-medium uppercase tracking-widest text-white/80 hover:text-[#D4FF33] transition-colors" href="#services">Services</a>
<a className="text-xs font-medium uppercase tracking-widest text-white/80 hover:text-[#D4FF33] transition-colors" href="#pricing">Pricing</a>
<a className="text-xs font-medium uppercase tracking-widest text-white/80 hover:text-[#D4FF33] transition-colors" href="#about">About</a>
<a className="text-xs font-medium uppercase tracking-widest text-white/80 hover:text-[#D4FF33] transition-colors" href="#products">Sales</a>
<a className="text-xs font-medium uppercase tracking-widest text-white/80 hover:text-[#D4FF33] transition-colors" href="#contact">Contact</a>
</div>

<div className="flex items-center gap-4">
<a className="hidden md:inline-flex items-center justify-center hover:bg-[#ccee22] transition-transform hover:-translate-y-0.5 active:translate-y-0 shadow-lime-400/20 text-sm font-medium text-[#305F8E] bg-[#D4FF33] rounded-lg pt-2.5 pr-6 pb-2.5 pl-6 shadow-lg" href="#booking">Book Service</a>
...
<a className="text-lg font-medium text-white/90 hover:text-[#D4FF33]" href="#services">Services</a>
<a className="text-lg font-medium text-white/90 hover:text-[#D4FF33]" href="#pricing">Pricing</a>
<a className="text-lg font-medium text-white/90 hover:text-[#D4FF33]" href="#about">About</a>
<a className="text-lg font-medium text-white/90 hover:text-[#D4FF33]" href="#products">Bike Sales</a>
<a className="text-lg font-semibold text-[#D4FF33]" href="#booking">Book Now</a>
</div>
</div>
</header>
...
<p className="text-2xl md:text-3xl text-blue-100 max-w-3xl mx-auto mb-12 font-light">
            Specialist Mountain Bike Servicing • Custom Wheels • Suspension • Bosch E-Bike Certified
        </p>
<div className="flex flex-col sm:flex-row items-center justify-center gap-5">
<a className="sm:w-auto hover:bg-[#ccee22] transition-all hover:scale-[1.02] shadow-lime-400/20 text-lg font-medium text-[#305F8E] bg-[#D4FF33] w-full rounded-lg pt-4 pr-8 pb-4 pl-8 shadow-xl" href="#booking">Book Service</a>
...
<section className="md:py-32 bg-[#fafafa] pt-24 pb-24" id="services">
...
<p className="text-neutral-500 text-xl font-light">
            From routine maintenance to complex suspension overhauls and custom builds, we tailor our work to cyclists of all levels.
          </p>
</div>
...
<div className="flex flex-col h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1f718461-609e-4bfe-bf9d-6685631261c6_800w.jpg?w=800&amp;q=80)] bg-cover bg-center z-10 pt-8 pr-8 pb-8 pl-8 relative">
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m12 14 4-4"></path><path d="M3.34 19a10 10 0 1 1 17.32 0"></path></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">Suspension Servicing</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Fork lowers, air shaft service, and complete shock overhauls. Keep your ride plush and responsive.
              </p>
</div>
</div>
...
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m12 2 2.7 9.9"></path><path d="m12 22-2.7-9.9"></path><path d="m2 12 9.9-2.7"></path><path d="m22 12-9.9 2.7"></path></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">Custom Wheel Builds</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Expert wheel building, truing, and tensioning. Custom lace-ups tailored to your riding style and weight.
              </p>
</div>
</div>
...
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 2v2"></path><path d="M17 2v2"></path><path d="M12 2v2"></path><path d="M2 9h20"></path><path d="M2 15h20"></path><path d="M12 22v-7"></path><path d="M7 22v-7"></path><path d="M17 22v-7"></path></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">E-Bike Specialist</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Bosch certified technicians. Diagnostics, firmware updates, and drivetrain reinforcement for high-torque systems.
              </p>
</div>
</div>
...
<div className="absolute inset-0 bg-gradient-to-b from-[#1e3a5c]/90 via-[#1e3a5c]/80 to-[#1e3a5c]/95 transition-opacity duration-300"></div>
<div className="flex flex-col bg-center h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ac7d4f45-65e9-4857-a97d-857d9ffa0225_800w.jpg)] bg-cover z-10 pt-8 pr-8 pb-8 pl-8 relative">
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M20.42 4.58a5.4 5.4 0 0 0-7.65 0l-.77.78-.77-.78a5.4 5.4 0 0 0-7.65 0C1.46 6.7 1.33 10.28 4 13l8 8 8-8c2.67-2.72 2.54-6.3.42-8.42z"></path></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">Pro Builds</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Assembly of online-purchased bikes, frame swaps, and full custom builds from the frame up with expert advice.
              </p>
</div>
</div>
...
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"></path><line x1="4" x2="4" y1="22" y2="15"></line></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">Mechanic for Hire</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Available for track-side support at events across NSW &amp; abroad. Pro-level support when it counts.
              </p>
</div>
</div>
...
<div className="absolute inset-0 bg-gradient-to-b from-[#1e3a5c]/90 via-[#1e3a5c]/80 to-[#1e3a5c]/95 transition-opacity duration-300"></div>
<div className="flex flex-col bg-center h-full bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3248d0f5-3fbc-4708-945d-4b9a6f74dc6d_800w.jpg)] bg-cover z-10 pt-8 pr-8 pb-8 pl-8 relative">
<div className="w-14 h-14 rounded-lg bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#D4FF33] group-hover:border-[#D4FF33] transition-colors">
<svg className="text-white group-hover:text-[#305F8E] w-7 h-7 transition-colors" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>
</div>
<h3 className="font-bebas text-3xl mb-3 text-white tracking-wide">Routine Repairs</h3>
<p className="text-blue-100/80 text-lg leading-relaxed mb-6 font-light">
                Brake bleeds, gear tunes, and safety checks. Precision work to keep your bike running fresh.
              </p>
</div>
</div>
</div>
...
<svg className="w-5 h-5 text-[#D4FF33] shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg>
                Gear tune &amp; indexing
              </li>
<li className="flex items-start gap-4 text-base text-blue-100/80 font-light">
<svg className="w-5 h-5 text-[#D4FF33] shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg>
...
<p className="text-neutral-600 text-xl mb-6 font-light leading-relaxed">
              Based in Kahibah, NSW, Rapid Descent Workshop is a specialist repair service dedicated to mountain bikes and the riders who push them to the limit.
            </p>
<p className="text-neutral-500 text-lg mb-6 font-light leading-relaxed">
              We focus on precision. Whether it's a complex suspension service, a custom wheel build, or an E-bike diagnostic, every job is treated with the same attention to detail as a race bike.
            </p>
<p className="text-neutral-500 text-lg font-light leading-relaxed">
              We are an <span className="text-[#305F8E] font-medium">Authorised Dealer for Orange Bikes and Commencal</span>, offering full builds, custom setups, and expert local advice for the Hunter region trails.
            </p>
</div>
...
<h4 className="font-medium text-xl text-[#305F8E] mb-2 tracking-tight">Authorised Dealer</h4>
<p className="text-sm text-neutral-500">Official dealer for Orange Bikes (UK) and Commencal.</p>
</div>
...
<h4 className="font-medium text-xl text-[#305F8E] mb-2 tracking-tight">Mechanic for Hire</h4>
<p className="text-sm text-neutral-500">Available for track-side support at events in NSW &amp; abroad.</p>
</div>
...
<div className="w-12 h-12 rounded bg-[#305F8E]/10 flex items-center justify-center mb-5 text-[#305F8E]">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 2v2"></path><path d="M17 2v2"></path><path d="M12 2v2"></path><path d="M2 9h20"></path><path d="M2 15h20"></path><path d="M12 22v-7"></path><path d="M7 22v-7"></path><path d="M17 22v-7"></path></svg>
</div>
<h4 className="font-medium text-xl text-[#305F8E] mb-2 tracking-tight">E-Bike Ready</h4>
<p className="text-sm text-neutral-500">Bosch certified. Software updates, diagnostics and repairs.</p>
</div>
...
<h4 className="font-medium text-xl text-[#305F8E] mb-2 tracking-tight">Appointment Only</h4>
<p className="text-sm text-neutral-500">Dedicated time slots ensure your bike gets the focus it deserves.</p>
</div>
</div>
</div>
</div>
...
<div className="flex gap-6 w-max animate-marquee px-4" id="marquee-track">
...
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">T</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Tim B.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"Rick is a legend. Sorted out my suspension issues that two other shops couldn't fix. The Orange Five feels brand new again."</p>
...
</div><div className="w-[320px] md:w-[360px] flex-shrink-0 bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col h-auto hover:shadow-md transition-shadow duration-300 select-none">
<div className="flex items-start justify-between mb-3">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">S</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Sarah J.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"Love that they are an official Commencal dealer. Got my new bike built up perfectly and the suspension dialled for my weight."</p>
<div className="mt-auto">
<div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 text-[10px] font-semibold text-[#305F8E] uppercase tracking-wide">
                        Commencal Meta
                      </div>
...
<div className="flex items-start justify-between mb-3">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">M</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Mark D.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"Excellent E-bike service. The Bosch diagnostic found the error code immediately. Fast, professional and local."</p>
<div className="mt-auto">
<div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 text-[10px] font-semibold text-[#305F8E] uppercase tracking-wide">
                        Specialized Levo
                      </div>
...
<div className="flex items-start justify-between mb-3">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">P</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Paul R.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"Best wheel builder in the Hunter. My custom rims have taken a beating at Glenrock and are still dead straight."</p>
<div className="mt-auto">
<div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 text-[10px] font-semibold text-[#305F8E] uppercase tracking-wide">
                        Santa Cruz
                      </div>
...
<div className="flex items-start justify-between mb-3">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">J</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Jason K.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"The 'Like New' service is worth every cent. The bike runs silent and smooth. Highly recommend Rapid Descent."</p>
<div className="mt-auto">
<div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 text-[10px] font-semibold text-[#305F8E] uppercase tracking-wide">
                        Norco Sight
                      </div>
...
<div className="flex items-start justify-between mb-3">
<div className="flex items-center gap-3">
<div className="w-10 h-10 rounded-full bg-[#305F8E] text-white flex items-center justify-center text-lg font-medium">E</div>
<div>
<div className="font-semibold text-[#244a70] leading-tight">Emma L.</div>
...
<p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-4">"Dropped my bike off for a brake bleed and gear tune. Done in 24 hours. Great to have such a pro workshop in Kahibah."</p>
<div className="mt-auto">
<div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 text-[10px] font-semibold text-[#305F8E] uppercase tracking-wide">
                        Trek Rail
                      </div>
...
<p className="text-neutral-500 text-xl mb-8 font-light">
              Work is scheduled by appointment only. Select your service below and we will contact you to confirm the drop-off time.
            </p>
<div className="space-y-4">
<div className="flex items-center gap-3">
<svg className="w-5 h-5 text-[#305F8E]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
<span className="text-neutral-700 text-lg">Payments: Bank Transfer or Cash (No EFTPOS)</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-5 h-5 text-[#305F8E]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
<span className="text-neutral-700 text-lg">Drop-offs strictly by appointment</span>
</div>
<div className="flex items-center gap-3">
<svg className="w-5 h-5 text-[#305F8E]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
<span className="text-neutral-700 text-lg">Workshop Address: Banforth Lane, Kahibah NSW</span>
</div>
</div>
</div>
...
<div>
<label className="block text-sm font-medium text-[#305F8E] mb-2">Full Name</label>
...
<div>
<label className="block text-sm font-medium text-[#305F8E] mb-2">Phone</label>
...
<div>
<label className="block text-sm font-medium text-[#305F8E] mb-2">Email</label>
...
<div>
<label className="block text-sm font-medium text-[#305F8E] mb-2">Bike Brand &amp; Model</label>
...
<div>
<div className="font-semibold text-[#244a70]">Fresh As Service</div>
<div className="text-xs text-neutral-500">Routine maintenance &amp; repairs.</div>
</div>
</div>
<div className="font-bebas text-2xl text-neutral-300 group-hover:text-[#305F8E] transition-colors">$220</div>
</label>
...
<div className="font-semibold text-[#244a70] flex items-center gap-2">
                          Like New Annual
                          <span className="px-2 py-0.5 rounded-full bg-[#305F8E] text-white text-[10px] font-bold uppercase tracking-wider">Popular</span>
</div>
<div className="text-xs text-neutral-500">Comprehensive annual service.</div>
</div>
</div>
...
<div>
<div className="font-semibold text-[#244a70]">New Bike PRO</div>
<div className="text-xs text-neutral-500">Ultimate custom build &amp; wrap.</div>
</div>
</div>
<div className="font-bebas text-2xl text-neutral-300 group-hover:text-[#305F8E] transition-colors">$1500</div>
</label>
</div>
...
<span className="text-xs font-medium text-neutral-700">Gear Tune</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Brake Bleed &amp; Tune</span>
</div>
<span className="text-xs font-semibold">$50</span>
</label>
<label className="flex items-center justify-between p-3 rounded-lg border border-neutral-200 bg-white cursor-pointer hover:bg-neutral-50">
...
<span className="text-xs font-medium text-neutral-700">Wheel True</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Wheel Build</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Fork Lowers &amp; Air Shaft</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Shock Air Can</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Dropper Post Install</span>
</div>
...
<span className="text-xs font-medium text-neutral-700">Bike Build BASIC</span>
</div>
...
<div>
<label className="block text-sm font-medium text-[#305F8E] mb-2">Additional Notes</label>
...
<p className="max-w-sm mb-6 text-base font-light">
              Kahibah's dedicated bicycle repair service. Trusted precision work tailored to cyclists of all levels.
            </p>
</div>
<div>
...
<li className="flex items-center gap-3 hover:text-[#D4FF33] transition-colors">
<svg className="w-4 h-4" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect height="16" rx="2" width="20" x="2" y="4"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
<a href="mailto:rick81boyer@gmail.com">rick81boyer@gmail.com</a>
</li>
<li className="flex items-start gap-3">
<svg className="w-4 h-4 mt-0.5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>
...
<li className="flex justify-between"><span>Mon - Fri</span> <span className="text-white">9am - 5pm</span></li>
<li className="flex justify-between"><span>Sat - Sun</span> <span className="text-blue-200/50">Closed</span></li>
</ul>
<div className="mt-6 flex items-center gap-2 text-xs text-[#D4FF33]">
<svg className="w-3 h-3 text-[#D4FF33]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
              By appointment only
            </div>
</div>
</div>

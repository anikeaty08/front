...
<a className="nav__logo" href="#">RAVENBRAIN</a>
<div aria-label="Main navigation" className="nav__links" id="navLinks" role="navigation">
<a className="" href="#capabilities">Data Analysis</a>
<a className="" href="#platform">Local LLM</a>
<a className="" href="#pricing">Web&amp;Application</a>
<a className="" href="#">About RavenBrain</a>
</div>
<div className="nav__actions">
<a className="btn btn-ghost" href="#" id="navSignIn" style={{display: 'inline-flex'}}>Sign in</a>
...
<h1 className="hero__title">Data Analysis<br/><strong className="">Visualization &amp; Automation</strong></h1>
</div>
<div className="hero__bottom reveal is-visible">
<p className="hero__desc">복잡하고 방대한 데이터 속에서 숨겨진 인사이트를 발견하는 것은 세상을 변화 시키는 힘입니다.</p>
<div className="hero__actions">
<a className="btn btn-primary" href="#">문의하기</a>
<a className="btn btn-ghost" href="#">소개영상</a>
</div>
</div>
...
<div className="trust-bar__item reveal-child"><iconify-icon className="" icon="lucide:zap"></iconify-icon> Voltex</div>
<div className="trust-bar__item reveal-child"><iconify-icon className="" icon="lucide:terminal"></iconify-icon> Synaptic</div>
...
<h2 className="section-title">Analyze all data across the world<br/><span className="text-gradient">Powerful Tecplot tools and AI</span></h2>
<p className="section-desc">현존하는 모든 데이터를 가공하고 분석합니다. 필요에 따라 전처리 작업을 진행하여 원하는 결과물을 얻을 수 있도록  처리합니다.</p>
</div>
...
<span className="cap-tab__text">Data Analysis</span>
</div>
...
<span className="cap-tab__text">Data Visualiztion</span>
</div>
...
<span className="cap-tab__text">WorkFlow Automation</span>
</div>
...
<span className="cap-tab__text">Sales Tecplot Solutio</span>
</div>
...
<span className="cap-tab__text">Data Server</span>
</div>
</div>
<div className="capabilities__panels">

<div className="cap-panel is-active" id="cap-compute">
<h3 className="cap-panel__title">강력한 데이터 분석 툴은 Tecplot </h3>
<p className="cap-panel__desc">Tecplot은 세계에서 가장 많이 사용되는 데이터 분석 툴로 CFD, CAE, 시뮬레이션 데이터는 물론 실험, 연구, 측정 데이터를 후처리하는 강력한 프로그램입니다.</p>
...
<h2 className="section-title">AI powered by a local LLM<br/><span className="text-gradient">Run AI locally with full privacy and control</span></h2>
<p className="section-desc">데이터를 외부로 보내지 않고, 완전히 통제 가능한 AI를 로컬에서 실행하세요. 완전한 프라이버시와 제어권을 제공합니다.</p>
</div>
...
<div className=""><span className="t-prompt">$</span> <span className="t-cmd">zenith deploy</span> <span className="t-flag">--model</span> llama-3.2 <span className="t-flag">--region</span> us-east-1</div>
<div className=""> </div>
<div className="t-line"><span className=""><span className="t-dim">  ●</span> Validating model config</span><span className="t-time"><span className="t-success">✓</span> 0.3s</span></div>
...
<div className="t-line"><span className=""><span className="t-dim">  ●</span> Deploying to 12 edge locations</span><span className="t-time"><span className="t-success">✓</span> 1.8s</span></div>
<div className="t-line"><span className=""><span className="t-dim">  ●</span> Running health checks</span><span className="t-time"><span className="t-success">✓</span> 0.5s</span></div>
...
<div className=""> </div>
<div className=""><span className="t-success">  ✓ Deployment complete in 6.9s</span></div>
<div className=""><span className="t-dim">  →</span> <span className="t-url">https://api.zenith.dev/v1/llama-3.2</span></div>
<div className=""><span className="t-dim">  →</span> <span className="t-url">https://app.zenith.dev/d/d-7f3a</span><span className="t-cursor"></span></div>
</div>
</div>
...
<div className="" style={{fontSize: '0.72rem', fontWeight: '400', marginBottom: '2px'}}>Ollama</div>
<div className="" style={{fontSize: '0.65rem', color: 'var(--text-3)'}}>Zero config</div>
</div>
<div className="platform__feat reveal-child" style={{textAlign: 'center', padding: '16px 8px', borderRadius: '10px', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid var(--border)'}}>
<iconify-icon className="" icon="lucide:git-branch" style={{fontSize: '1.1rem', color: 'var(--blue-light)', marginBottom: '6px', display: 'block'}}></iconify-icon>
<div className="" style={{fontSize: '0.72rem', fontWeight: '400', marginBottom: '2px'}}>vLLM</div>
<div className="" style={{fontSize: '0.65rem', color: 'var(--text-3)'}}>Preview URLs</div>
</div>
<div className="platform__feat reveal-child" style={{textAlign: 'center', padding: '16px 8px', borderRadius: '10px', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid var(--border)'}}>
<iconify-icon className="" icon="lucide:activity" style={{fontSize: '1.1rem', color: 'var(--blue-light)', marginBottom: '6px', display: 'block'}}></iconify-icon>
<div className="" style={{fontSize: '0.72rem', fontWeight: '400', marginBottom: '2px'}}>Mistral</div>
<div className="" style={{fontSize: '0.65rem', color: 'var(--text-3)'}}>Real-time</div>
</div>
<div className="platform__feat reveal-child" style={{textAlign: 'center', padding: '16px 8px', borderRadius: '10px', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid var(--border)'}}>
<iconify-icon className="" icon="lucide:rotate-ccw" style={{fontSize: '1.1rem', color: 'var(--blue-light)', marginBottom: '6px', display: 'block'}}></iconify-icon>
<div className="" style={{fontSize: '0.72rem', fontWeight: '400', marginBottom: '2px'}}>Gemma</div>
<div className="" style={{fontSize: '0.65rem', color: 'var(--text-3)'}}>One click</div>
</div>
</div>
</div>
</section>
...
<h3 className="pipeline__step-title">웹사이트 구축</h3>
<p className="pipeline__step-desc">기획부터 배포까지, 빠르고 안정적인 사용자 중심 웹사이트를 제공합니다.</p>
</div>
<div className="pipeline__step reveal-child">
<div className="pipeline__tag">Train</div>
<div className="pipeline__node"><iconify-icon icon="lucide:brain"></iconify-icon></div>
<h3 className="pipeline__step-title">앱 &amp; 어플리케이션 개발</h3>
<p className="pipeline__step-desc">비즈니스 성장을 위한 맞춤형 어플리케이션을 구축합니다.</p>
</div>
<div className="pipeline__step reveal-child">
<div className="pipeline__tag">Deploy</div>
<div className="pipeline__node"><iconify-icon icon="lucide:rocket"></iconify-icon></div>
<h3 className="pipeline__step-title">서버 &amp; 워크스테이션 구축</h3>
<p className="pipeline__step-desc">요구사항에 맞춘 최적의 서버와 워크스테이션을 설계 및 구축합니다.</p>
</div>
</div>
...
<div className="" style={{display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap'}}>
...
<div className="pricing-card__feature"><iconify-icon icon="lucide:check"></iconify-icon> 10K inferences / month
          </div>
...
<div className="pricing-card__features">
<div className="pricing-card__feature"><iconify-icon icon="lucide:check"></iconify-icon> 1M inferences / month
          </div>
<div className="pricing-card__feature"><iconify-icon icon="lucide:check"></iconify-icon> Unlimited deployments
          </div>
<div className="pricing-card__feature"><iconify-icon icon="lucide:check"></iconify-icon> Priority support</div>
<div className="pricing-card__feature"><iconify-icon icon="lucide:check"></iconify-icon> Advanced observability
          </div>
...
<div className="pricing__enterprise-desc">Dedicated infrastructure, SSO, RBAC, custom SLAs, and 24/7 premium
            support.</div>
</div>
</div>

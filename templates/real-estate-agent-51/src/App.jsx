        ...
        const listingData = [
            {
                ...
                area: "145 m²",
                rooms: "4+kk",
                image: "https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/56f3438a-36b0-4c31-97a7-55099a9a3f2d_1600w.jpg",
                ...
                const html = `
                    <article class="bg-white rounded-3xl border border-slate-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <img src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg" alt="${item.title}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                        ...
                        <div class="p-8 flex flex-col flex-grow">
                            <div class="mb-5">
                                <h3 class="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">${item.title}</h3>
                            ...
                            <div class="mt-auto flex items-center justify-between">
                                <span class="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">${item.price}</span>
...
<li className=""><a className="block py-2 px-3 text-slate-600 rounded hover:bg-slate-100 md:hover:bg-transparent md:hover:text-slate-900 md:p-0 transition-colors font-google-sans-flex" href="#about" style={{}}>O mně</a></li>
...
<li className=""><a className="block py-2 px-3 text-slate-600 rounded hover:bg-slate-100 md:hover:bg-transparent md:hover:text-slate-900 md:p-0 transition-colors font-google-sans-flex" href="#process" style={{}}>Jak pracuji</a></li>
<li className=""><a className="block py-2 px-3 text-slate-600 rounded hover:bg-slate-100 md:hover:bg-transparent md:hover:text-slate-900 md:p-0 transition-colors font-google-sans-flex" href="#testimonials" style={{}}>Reference</a></li>
</ul>
</div>
</div>
...
<h1 className="leading-[0.95] md:text-7xl lg:text-7xl text-5xl font-extrabold text-slate-900 font-google-sans-flex" style={{}}>Bezpečný prodej nemovitosti,<br className=""/> <span className="text-slate-300 font-google-sans-flex" style={{}}>minimum stresu.</span></h1>
...
<img alt="Client" className="w-10 h-10 border-2 border-white rounded-full object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&amp;fit=crop&amp;q=80&amp;w=100" style={{}}/>
<img alt="Client" className="w-10 h-10 border-2 border-white rounded-full object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&amp;fit=crop&amp;q=80&amp;w=100" style={{}}/>
<img alt="Client" className="w-10 h-10 border-2 border-white rounded-full object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&amp;fit=crop&amp;q=80&amp;w=100" style={{}}/>
</div>
...
<p className="text-2xl font-extrabold tracking-wide font-google-sans-flex" style={{}}>David Kirschner</p>
...
<p className="text-5xl font-extrabold text-slate-900 tracking-tight font-google-sans-flex" style={{}}>12+</p>
...
<div className="text-center md:text-left">
<p className="text-5xl font-extrabold text-slate-900 tracking-tight font-google-sans-flex" style={{}}>150</p>
...
<div className="text-center md:text-left">
<p className="text-5xl font-extrabold text-slate-900 tracking-tight font-google-sans-flex" style={{}}>98%</p>
...
<div className="text-center md:text-left">
<p className="text-5xl font-extrabold text-slate-900 tracking-tight font-google-sans-flex" style={{}}>21</p>
...
<h2 className="md:text-5xl text-4xl font-extrabold text-slate-900 tracking-tight mb-6 font-google-sans-flex" style={{}}>Můj přístup k prodeji</h2>
...
<section className="bg-slate-50 pt-24 pb-24" id="listings">
<div className="max-w-7xl mr-auto ml-auto pr-6 pl-6">
<div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
<div className="">
<h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 font-display font-google-sans-flex" style={{}}>Aktuální nabídka</h2>
...
<span className="absolute top-4 left-4 bg-blue-600 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 font-display shadow-sm">
                                Novinka
                            </span>
<span className="absolute top-4 right-4 bg-white/95 backdrop-blur-md text-slate-900 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 border border-slate-100 font-display shadow-sm">
                                Prodej
                            </span>
<img alt="Luxusní mezonet s terasou" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="group-hover:opacity-100 transition-opacity duration-300 flex bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bf2c8df6-9a32-478e-a7f2-ee2cd75340d1_800w.jpg)] bg-cover bg-center pt-6 pr-6 pb-6 pl-6 absolute top-0 right-0 bottom-0 left-0 items-end">
<button className="w-full bg-white text-slate-900 font-bold py-3.5 rounded-xl text-sm hover:bg-slate-100 tracking-wide font-display">Zobrazit detail</button>
</div>
</div>
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Luxusní mezonet s terasou</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Praha 2 - Vinohrady
                                </p>
</div>
...
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">24 500 000 Kč</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Terasa</span>
</div>
</div>
</div>
</article>
<article className="bg-white rounded-3xl border border-slate-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
<div className="relative h-64 overflow-hidden">
<span className="absolute top-4 left-4 bg-orange-500 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 font-display shadow-sm">
                                Rezervováno
                            </span>
<span className="absolute top-4 right-4 bg-white/95 backdrop-blur-md text-slate-900 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 border border-slate-100 font-display shadow-sm">
                                Prodej
                            </span>
<img alt="Rodinný dům u lesa" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
...
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Rodinný dům u lesa</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Průhonice
                                </p>
...
<div className="mt-auto flex items-center justify-between">
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">32 000 000 Kč</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Zahrada</span>
</div>
</div>
</div>
</article>
<article className="bg-white rounded-3xl border border-slate-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
<div className="relative h-64 overflow-hidden">
<span className="absolute top-4 left-4 bg-green-600 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 font-display shadow-sm">
                                Volné
                            </span>
<span className="absolute top-4 right-4 bg-white/95 backdrop-blur-md text-slate-900 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 border border-slate-100 font-display shadow-sm">
                                Pronájem
                            </span>
<img alt="Moderní byt v novostavbě" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
<button className="w-full bg-white text-slate-900 font-bold py-3.5 rounded-xl text-sm hover:bg-slate-100 tracking-wide font-display">Zobrazit detail</button>
</div>
</div>
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Moderní byt v novostavbě</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Praha 8 - Karlín
                                </p>
...
<div className="mt-auto flex items-center justify-between">
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">35 000 Kč / měs</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Balkon</span>
</div>
</div>
</div>
</article>
<article className="bg-white rounded-3xl border border-slate-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
<div className="relative h-64 overflow-hidden">
<span className="absolute top-4 left-4 bg-slate-400 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 font-display shadow-sm">
                                Prodáno
                            </span>
<span className="absolute top-4 right-4 bg-white/95 backdrop-blur-md text-slate-900 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full z-10 border border-slate-100 font-display shadow-sm">
                                Prodej
                            </span>
<img alt="Investiční apartmán" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
<button className="w-full bg-white text-slate-900 font-bold py-3.5 rounded-xl text-sm hover:bg-slate-100 tracking-wide font-display">Zobrazit detail</button>
</div>
</div>
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Investiční apartmán</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Praha 1 - Staré Město
                                </p>
...
<div className="mt-auto flex items-center justify-between">
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">12 900 000 Kč</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Hist. centrum</span>
</div>
</div>
</div>
</article>
...
<img alt="Vila s výhledem na město" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
<button className="w-full bg-white text-slate-900 font-bold py-3.5 rounded-xl text-sm hover:bg-slate-100 tracking-wide font-display">Zobrazit detail</button>
</div>
</div>
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Vila s výhledem na město</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Praha 6 - Hanspaulka
                                </p>
...
<div className="mt-auto flex items-center justify-between">
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">58 000 000 Kč</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Sauna</span>
</div>
</div>
</div>
</article>
...
<img alt="Kancelářské prostory" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
<button className="w-full bg-white text-slate-900 font-bold py-3.5 rounded-xl text-sm hover:bg-slate-100 tracking-wide font-display">Zobrazit detail</button>
</div>
</div>
<div className="p-8 flex flex-col flex-grow">
<div className="mb-5">
<h3 className="text-xl font-semibold text-slate-900 mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors tracking-tight font-space-grotesk">Kancelářské prostory</h3>
<p className="text-slate-500 text-sm flex items-center gap-1.5 font-bold uppercase tracking-wide opacity-80">
<iconify-icon icon="solar:map-point-linear" width="14"></iconify-icon>
                                    Praha 4 - Pankrác
                                </p>
...
<div className="mt-auto flex items-center justify-between">
<span className="text-lg font-bold text-slate-900 tracking-tight font-space-grotesk">450 Kč / m²</span>
<div className="flex gap-2">
<span className="px-2.5 py-1 bg-slate-50 text-[10px] text-slate-600 rounded-md border border-slate-200 font-bold uppercase tracking-wider">Klimatizace</span>
</div>
</div>
</div>
</article>
...
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-20 text-center font-display font-google-sans-flex" style={{}}>Jak probíhá spolupráce</h2>
...
<div className="max-w-7xl mx-auto px-6">
<h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-12 font-display font-google-sans-flex" style={{}}>Co říkají klienti</h2>
...
<h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-12 text-center font-display font-google-sans-flex" style={{}}>Časté dotazy</h2>
...
<div>
<h2 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-8 font-display font-google-sans-flex" style={{}}>Připraveni na prodej?</h2>
...
<a className="text-2xl font-bold hover:text-blue-300 transition-colors tracking-tight font-display font-google-sans-flex" href="tel:+420777888999" style={{}}>+420 777 888 999</a>
</div>
</div>
<div className="flex items-start gap-5">
<div className="w-12 h-12 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-center flex-shrink-0 text-white">
...
<a className="text-2xl font-bold hover:text-blue-300 transition-colors tracking-tight font-display font-google-sans-flex" href="mailto:david@kirschner.cz" style={{}}>david@kirschner.cz</a>
</div>
</div>
<div className="flex items-start gap-5">
<div className="w-12 h-12 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-center flex-shrink-0 text-white">
...
<h3 className="text-3xl font-extrabold mb-8 tracking-tight font-display font-google-sans-flex" style={{}}>Napište mi zprávu</h3>

...
<div className="font-display font-semibold tracking-tighter text-xl uppercase flex items-center gap-2 cursor-hover">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="square" strokeWidth="2" viewbox="0 0 24 24" width="24">
...
<button className="bg-surface border border-white/20 px-6 py-3 font-mono text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-all cursor-hover flex items-center gap-2">
                Terminal
...
<div className="max-w-[1440px] mx-auto px-4 md:px-8 w-full grid grid-cols-4 md:grid-cols-12 gap-4 md:gap-8 relative z-10">
<div className="col-span-4 md:col-span-8 flex flex-col justify-center reveal-up">
<div className="flex items-center gap-3 mb-6">
<span className="font-mono text-accent text-xs tracking-widest uppercase">/001/ Protocol</span>
<div className="h-px w-12 bg-accent/50"></div>
</div>
<h1 className="text-fluid-h1 font-display font-bold uppercase tracking-tighter text-white mb-8">
                        Own the Asset.<br/>Scale the Alpha.
                    </h1>
<p className="text-fluid-body text-[#A1A1A1] max-w-xl mb-12">
                        Precision-engineered real estate acquisition for high-net-worth portfolios. We don't find houses; we secure asymmetric yields through proprietary data architecture.
                    </p>
<div className="flex flex-col sm:flex-row gap-4">
<button className="bg-accent text-black font-semibold uppercase py-5 px-10 clip-slant hover:-skew-x-6 hover:scale-105 transition-all duration-300 text-sm tracking-wide cursor-hover flex items-center justify-center gap-2">
                            Initiate Acquisition
                            <iconify-icon className="text-lg" icon="solar:arrow-right-linear" strokeWidth="1.5"></iconify-icon>
</button>
<button className="bg-surface border border-white/10 text-white font-semibold uppercase py-5 px-10 clip-slant-reverse hover:bg-white/5 transition-all duration-300 text-sm tracking-wide cursor-hover">
                            Analyze Market Data
                        </button>
</div>
</div>
<div className="col-span-4 md:col-span-4 relative mt-16 md:mt-0 reveal-up" style={{transitionDelay: '0.2s'}}>
<div className="w-full h-[60vh] md:h-[75vh] relative group overflow-hidden border border-white/10">
<img alt="Brutalist Architecture" className="w-full h-full object-cover grayscale contrast-125 brightness-75 group-hover:scale-105 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-1000" src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=1000&amp;q=80"/>

<div className="absolute bottom-6 -left-6 md:-left-12 bg-[#121212]/90 backdrop-blur-md border border-white/10 p-6 shadow-2xl z-20">
<div className="font-mono text-accent text-xs tracking-widest mb-2 uppercase flex items-center gap-2">
<span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse"></span>
                                Live Feed
                            </div>
<div className="font-display font-semibold tracking-tighter text-3xl mb-1">$1.4B+</div>
<div className="text-[#A1A1A1] text-xs uppercase tracking-wider">Closed Transactions</div>
</div>

<div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMjU1LDwyNTUsMjU1LDAuMSkiLz48L3N2Zz4=')] opacity-30 mix-blend-overlay"></div>
</div>
</div>
</div>
</section>

<section className="py-24 md:py-40 relative border-b border-white/10" id="intelligence">
<div className="max-w-[1440px] mx-auto px-4 md:px-8 w-full">
<div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-16 md:mb-24 reveal-up">
<div className="max-w-2xl">
<div className="flex items-center gap-3 mb-6">
<span className="font-mono text-accent text-xs tracking-widest uppercase">/002/ Intelligence</span>
</div>
<h2 className="text-fluid-h2 font-display font-semibold uppercase tracking-tighter text-white">
                            Data-Driven<br/>Dominance.
                        </h2>
</div>
<p className="text-fluid-body text-[#A1A1A1] max-w-md">
                        We utilize proprietary predictive modeling to identify off-market opportunities before they hit public consciousness. Algorithms dictate entry.
                    </p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">

<div className="bg-surface/50 border border-white/10 p-8 hover:bg-white/5 hover:border-accent/50 transition-all duration-500 group reveal-up cursor-hover">
<iconify-icon className="text-3xl text-[#A1A1A1] group-hover:text-accent transition-colors mb-8" icon="solar:chart-square-linear" strokeWidth="1.5"></iconify-icon>
<div className="font-mono text-xs text-[#A1A1A1] mb-2">Metric Alpha</div>
<div className="font-display font-semibold text-4xl text-white mb-4 tracking-tighter"><span className="counter" data-target="22.45">0.00</span>%</div>
<div className="text-sm text-[#A1A1A1] leading-relaxed">Average annual appreciation across our global managed portfolio.</div>
</div>

<div className="bg-surface/50 border border-white/10 p-8 hover:bg-white/5 hover:border-accent/50 transition-all duration-500 group reveal-up cursor-hover" style={{transitionDelay: '0.1s'}}>
<iconify-icon className="text-3xl text-[#A1A1A1] group-hover:text-accent transition-colors mb-8" icon="solar:radar-linear" strokeWidth="1.5"></iconify-icon>
<div className="font-mono text-xs text-[#A1A1A1] mb-2">Market Lead</div>
<div className="font-display font-semibold text-4xl text-white mb-4 tracking-tighter"><span className="counter" data-target="14">0</span> Days</div>
<div className="text-sm text-[#A1A1A1] leading-relaxed">Average time advantage we secure on prime off-market assets.</div>
</div>

<div className="bg-surface/50 border border-white/10 p-8 hover:bg-white/5 hover:border-accent/50 transition-all duration-500 group reveal-up cursor-hover" style={{transitionDelay: '0.2s'}}>
<iconify-icon className="text-3xl text-[#A1A1A1] group-hover:text-accent transition-colors mb-8" icon="solar:shield-keyhole-linear" strokeWidth="1.5"></iconify-icon>
<div className="font-mono text-xs text-[#A1A1A1] mb-2">Risk Mitigation</div>
<div className="font-display font-semibold text-4xl text-white mb-4 tracking-tighter">99.8%</div>
<div className="text-sm text-[#A1A1A1] leading-relaxed">Historical success rate in achieving targeted baseline ROI parameters.</div>
</div>
</div>
</div>
</section>

<section className="py-24 md:py-40 relative border-b border-white/10 overflow-hidden" id="portfolio">
<div className="max-w-[1440px] mx-auto px-4 md:px-8 w-full mb-12 reveal-up">
<div className="flex items-center gap-3 mb-6">
<span className="font-mono text-accent text-xs tracking-widest uppercase">/003/ Archives</span>
</div>
<h2 className="text-fluid-h2 font-display font-semibold uppercase tracking-tighter text-white">
                    Acquired Assets.
                </h2>
...
<div className="font-display text-5xl md:text-6xl text-accent tracking-tighter" id="calc-output">
                                    $8.78M
                                </div>
</div>
</div>

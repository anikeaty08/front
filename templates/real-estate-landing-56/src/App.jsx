...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      const categories = [
        {
          ...
          themes: [
            { name: 'America', bg: '#ffffff', text: '#0f172a', primary: '#dc2626', border: '#e2e8f0' },
            { name: 'Liberty', bg: '#f8fafc', text: '#1e3a8a', primary: '#b91c1c', border: '#cbd5e1' },
            { name: 'Federal', bg: '#1e1b4b', text: '#e0e7ff', primary: '#ffffff', border: '#312e81', contrast: '#0f0e26' },
            { name: 'Capital', bg: '#0f172a', text: '#f8fafc', primary: '#94a3b8', border: '#334155', contrast: '#020617' },
            { name: 'State', bg: '#f1f5f9', text: '#334155', primary: '#475569', border: '#cbd5e1' },
            { name: 'Trust', bg: '#eff6ff', text: '#172554', primary: '#2563eb', border: '#bfdbfe' },
            { name: 'Executive', bg: '#ffffff', text: '#000000', primary: '#171717', border: '#e5e5e5' },
            { name: 'Metro', bg: '#f5f5f5', text: '#171717', primary: '#2563eb', border: '#d4d4d4' },
            { name: 'Tower', bg: '#262626', text: '#f5f5f5', primary: '#737373', border: '#404040', contrast: '#171717' },
            { name: 'Board', bg: '#f5f7fa', text: '#1f2937', primary: '#374151', border: '#d1d5db' },
            { name: 'Venture', bg: '#0c0a09', text: '#fca5a5', primary: '#ef4444', border: '#451a03', contrast: '#000000' },
            { name: 'Equity', bg: '#064e3b', text: '#ecfdf5', primary: '#10b981', border: '#047857', contrast: '#022c22' },
        ...
        },
        {
          ...
          themes: [
            { name: 'Canvas', bg: '#f4f2ef', text: '#1c1917', primary: '#1c1917', border: '#d6d3d1' }, 
      ...
      let currentActiveThemeName = 'America'; // Default for Real Estate America
      ...
      function selectTheme(theme, categoryId) {
        ...
        if (theme.contrast) {
            ...
            root.style.setProperty('--bg-contrast', '#0f172a'); // Default Dark Slate for REA
      ...
      function openCopyModal() {
        ...
        const contrastVal = currentThemeValues.contrast ? currentThemeValues.contrast : '#0f172a';
...
<div className="bg-[var(--bg-contrast)] text-[var(--text-inverse)] text-xs md:text-sm py-2.5 text-center tracking-wide font-medium relative z-50 transition-colors duration-500">
<p>
...
<div className="border-2 border-[var(--text-main)] p-1.5 relative bg-transparent hover:bg-[var(--text-main)] transition-colors duration-300">
<i className="w-5 h-5 text-[var(--text-main)] group-hover:text-[var(--bg-main)] transition-colors duration-300" data-lucide="home"></i>
</div>
<div>
<span className="font-jakarta font-bold tracking-tight text-lg leading-none block text-[var(--text-main)]">
              REAL ESTATE AMERICA
            </span>
...
<button className="flex items-center gap-1 font-bold text-[var(--color-primary)] hover:opacity-70">
            Exclusive Listings
            <i className="w-3 h-3 opacity-50" data-lucide="star"></i>
</button>
</nav>
...
<img alt="American Estate" className="absolute inset-0 w-full h-full object-cover opacity-60 transition-opacity duration-700" src="https://images.unsplash.com/photo-1600596542815-27838b206e69?q=80&amp;w=2940&amp;auto=format&amp;fit=crop"/>
...
<h1 className="text-5xl font-medium text-white tracking-tight font-playfair mb-6 drop-shadow-2xl md:text-7xl lg:text-8xl leading-[0.9]">
            The American<br/>
<i className="font-serif italic text-white/80">Dream</i> Home
            </h1>
<p className="text-white/70 text-sm md:text-base max-w-md ml-auto mb-8 font-medium leading-relaxed">
                From coast to coast, we connect you with properties that define success. Experience the highest standard in American real estate.
            </p>
...
<p className="text-[var(--text-muted)] leading-relaxed text-sm">
            Discover a curated collection of family estates, city penthouses, and suburban retreats designed for the modern lifestyle.
          </p>
</div>
<div className="group cursor-pointer">
<span className="text-[10px] font-bold tracking-[0.2em] text-[var(--color-primary)] uppercase mb-4 block opacity-60 group-hover:opacity-100 transition-opacity">
...
<p className="text-[var(--text-muted)] leading-relaxed text-sm">
            Prime locations for your business. We offer comprehensive commercial brokerage services nationwide.
          </p>
</div>
<div className="group cursor-pointer">
<span className="text-[10px] font-bold tracking-[0.2em] text-[var(--color-primary)] uppercase mb-4 block opacity-60 group-hover:opacity-100 transition-opacity">
...
<p className="text-[var(--text-muted)] leading-relaxed text-sm">
            Strategic real estate opportunities for the discerning investor. Secure your future with tangible assets.
          </p>
</div>
</div>
</section>
...
<span className="text-white font-bold tracking-widest text-xs">REA INC.</span>
</div>
<span className="text-[var(--text-inverse)] text-[10px] tracking-[0.3em] opacity-50 uppercase">
        © 2024 Real Estate America Inc. All Rights Reserved.
      </span>
</div>
...
<button className="w-full bg-[var(--color-primary)] text-white py-3 text-xs font-bold tracking-widest uppercase hover:opacity-90 transition-opacity flex items-center justify-center gap-2" onclick="copyToClipboard()">

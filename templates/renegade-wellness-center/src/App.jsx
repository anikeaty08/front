...
<div className="sm:px-6 lg:px-8 text-left bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e81f3f05-6ff9-49b8-a03e-a2a67a2433cf_3840w.png)] max-w-7xl bg-contain mx-auto px-4">
<div className="flex items-center justify-between h-16">
<nav className="hidden md:flex items-center gap-7 text-sm text-neutral-600">
<a className="hover:text-neutral-900 transition-colors font-geist bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e81f3f05-6ff9-49b8-a03e-a2a67a2433cf_800w.png)]" href="#"></a>
</nav>
<a className="sm:text-3xl text-2xl font-medium tracking-tight font-playfair" href="#">Renegade Wellness Center</a>
...
<div className="sm:px-6 lg:px-8 sm:pt-14 max-w-7xl mr-auto ml-auto pt-10 pr-4 pl-4">
<div className="grid lg:grid-cols-12 gap-8 items-stretch">
<div className="lg:col-span-12 [animation:fadeSlideIn_1s_ease-out_0.1s_both]">
<h1 className="text-[13vw] leading-[0.8] sm:text-[9rem] md:text-[10rem] lg:text-[11rem] font-medium text-neutral-900 tracking-tight font-playfair">Renegade Wellness Center</h1>
</div>
...
<img alt="Happy dog running" className="sm:h-[420px] text-left w-full h-[300px] object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b0f35040-b088-4c55-bfb6-1d0a7a9fcaf8_3840w.png"/>
...
<div className="lg:col-span-4 sm:p-6 flex flex-col [animation:fadeSlideIn_1s_ease-out_0.3s_both] bg-white border-neutral-200 border rounded-3xl pt-5 pr-5 pb-5 pl-5 justify-between">
<div className="">
...
<div className="bg-lime-400 h-40 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7bbb668c-3149-4a85-957c-ac3592f8705e_800w.jpg)] bg-cover rounded-2xl [animation:fadeSlideIn_1s_ease-out_0.1s_both] animate-on-scroll"></div>
<div className="bg-violet-400 h-40 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9bc6a9fc-d5f6-456f-8805-4dc091bf7d0f_800w.jpg)] bg-cover rounded-2xl [animation:fadeSlideIn_1s_ease-out_0.2s_both] animate-on-scroll"></div>
<div className="bg-orange-400 h-40 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1cde2a93-8ded-44b4-93b4-2f5455b71b69_800w.jpg)] bg-cover rounded-2xl [animation:fadeSlideIn_1s_ease-out_0.3s_both] animate-on-scroll"></div>
<div className="bg-amber-400 h-40 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0d8aca8d-7da0-4da9-9c6c-720dfd147ca3_800w.jpg)] bg-cover rounded-2xl [animation:fadeSlideIn_1s_ease-out_0.4s_both] animate-on-scroll"></div>
</div>
<div className="mt-8">

...
<h1 className="text-2xl tracking-tighter animate-scroll-down mb-4 font-black">MANA®</h1>
</div>
...
<h3 className="text-xs font-bold">MANA</h3>
...
<label className="text-[8px]">TO: MANA</label>

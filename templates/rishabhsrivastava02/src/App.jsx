...
<div className="loader fixed flex flex-col z-[9999] text-white top-0 right-0 bottom-0 left-0 items-center justify-center"><div className="z-[9999] absolute top-0 right-0 bottom-0 left-0" data-container-bg="true"><div className="aura-background-component w-full h-[700px] absolute top-0 hue-rotate-15 saturate-150 brightness-125" data-alpha-mask="80" style={{maskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)'}}>
...
<div className="loader-counter font-display text-8xl md:text-9xl font-medium tracking-tighter leading-none translate-y-full" style={{width: '100%'}}>100</div>
</div>
...
</div><nav className="fixed top-0 w-full px-6 py-6 md:px-12 md:py-8 flex justify-between items-center z-50 mix-blend-exclusion text-white transition-all duration-300">
<div className="flex gap-2 text-2xl font-semibold tracking-tighter font-display mix-blend-darken items-center">RISHABH SRIVASTAVA</div>
<div className="hidden md:flex gap-8 text-xs font-medium tracking-widest uppercase opacity-80">
<a className="hover:opacity-100 transition-opacity" href="#">SKILLS
</a>
<a className="hover:opacity-100 transition-opacity" href="#">Studio</a>
<a className="hover:opacity-100 transition-opacity" href="#">WORK
</a>
...
<section className="overflow-hidden bg-[#F5F5F7] w-full h-screen relative" id="hero">

<div className="content"><div className="absolute top-0 right-0 bottom-0 left-0" data-container-bg="true"><div className="absolute w-full h-full left-0 top-0 -z-10" data-us-project="rOckgwd0fvktpb8agzJw"></div>
</div>
...
<section className="md:px-20 z-20 max-w-[1600px] mr-auto ml-auto pt-32 pr-6 pb-32 pl-6 relative shadow-[0_4px_6px_rgba(0,_0,_0,_0.049),_0_9.6px_7.6px_rgba(0,_0,_0,_0.069),_0_18px_14.3px_rgba(0,_0,_0,_0.086),_0_32px_25.6px_rgba(0,_0,_0,_0.103),_0_60px_47.8px_rgba(0,_0,_0,_0.123),_0_143px_114.3px_rgba(0,_0,_0,_0.172)] backdrop-blur-lg">
<div className="grid gap-y-12 gap-x-6 lg:grid-cols-12">
<div className="lg:col-span-4 flex flex-col border-black/10 border-t pt-4 justify-between">
<span className="uppercase xl:bg-clip-text xl:text-transparent text-4xl tracking-widest font-mono bg-[conic-gradient(from_180deg,var(--tw-gradient-stops))] from-slate-400 via-slate-600 to-slate-400" style={{maskImage: 'linear-gradient(210deg, transparent, black 0%, black 100%, transparent)', WebkitMaskImage: 'linear-gradient(210deg, transparent, black 0%, black 100%, transparent)'}}>MY PRODUCTIVE SKILLS.... 
AutoCAD , 
Revit architecture ,
 Revit structure, 
Navisworks.</span>
</div><div className="lg:col-span-4 flex flex-col border-black/10 border-t pt-4 justify-between">
<span className="uppercase text-4xl text-zinc-950 tracking-widest font-mono" style={{maskImage: 'linear-gradient(210deg, transparent, black 0%, black 100%, transparent)'}}></span>
</div>
<div className="lg:col-span-8 lg:col-start-5">
<h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-medium leading-[1.05] tracking-tight max-w-6xl intro-scrub-text text-dark"><span className="scrub-word">Architecture </span><span className="scrub-word">is </span><span className="scrub-word">not </span><span className="scrub-word">about </span><span className="scrub-word">filling </span><span className="scrub-word">space. </span><span className="scrub-word">It </span><span className="scrub-word">is </span><span className="scrub-word">about </span><span className="scrub-word">creating </span><span className="scrub-word">the </span><span className="scrub-word">void </span><span className="scrub-word">that </span><span className="scrub-word">remains. </span><span className="scrub-word">We </span><span className="scrub-word">excavate </span><span className="scrub-word">the </span><span className="scrub-word">atmosphere </span><span className="scrub-word">to </span><span className="scrub-word">reveal </span><span className="scrub-word">the </span><span className="scrub-word">essential </span><span className="scrub-word">silence </span><span className="scrub-word">of </span><span className="scrub-word">a </span><span className="scrub-word">place. </span></h2>
</div>
</div>
</section>
...
<h2 className="md:text-5xl text-dark text-4xl font-medium tracking-tight font-merriweather">forms follows functions.....</h2>
</div>
<div className="hidden md:block">
</div>
</div>
<div className="md:px-6 w-full max-w-7xl mr-auto ml-auto pr-4 pl-4">
...
<h3 className="font-display text-2xl md:text-3xl font-medium tracking-tight mt-6 text-dark">SAUDI VILLA</h3>
<p className="text-xs font-medium text-gray-400 uppercase tracking-widest mt-2">JEDDAH SAUDI</p>
</div>
...
<span className="border-border text-[10px] uppercase font-medium text-gray-500 tracking-wider bg-gray-50 border rounded-full pt-1 pr-3 pb-1 pl-3">2026
</span>
</div>
</div>
</div>
<div className="relative h-[60%] lg:h-full order-1 lg:order-2 overflow-hidden bg-gray-100">
<img alt="Project" className="transition-transform duration-1000 hover:scale-105 w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f0ce5a11-ae17-4f15-aed6-0fc41cb2df94_1600w.png?w=800&amp;q=80"/>
</div>
</div>
</div>
...
<h3 className="md:text-3xl text-dark text-2xl font-medium tracking-tight font-display mt-6">KOVIL RESTAURANT</h3>
<p className="uppercase text-xs font-medium text-gray-400 tracking-widest mt-2">JEDDAH SAUDI</p>
</div>
<div className="space-y-6 hidden lg:block">
<p className="text-sm text-gray-500 leading-relaxed font-normal">
...
<div className="relative h-[60%] lg:h-full order-1 lg:order-2 overflow-hidden bg-gray-100">
<img alt="Project" className="transition-transform duration-1000 hover:scale-105 w-full h-full object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/abac5fe2-da99-4f67-bc18-625805f56999_1600w.png?w=800&amp;q=80"/>
</div>
</div>
</div>
...
<h3 className="md:text-3xl text-dark text-2xl font-medium tracking-tight font-display mt-6">FIRDAUS MANSON</h3>
<p className="uppercase text-xs font-medium text-gray-400 tracking-widest mt-2">SAUDI ARABIA</p>
</div>
<div className="space-y-6 hidden lg:block">
...
<div className="relative h-[60%] lg:h-full order-1 lg:order-2 overflow-hidden bg-gray-100">
<img alt="Project" className="transition-transform duration-1000 hover:scale-105 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f6448c24-0c9f-4f1d-9334-3ec2e2d64b37_1600w.png?w=800&amp;q=80"/>
</div>
</div>
</div>
</div>
...
</section></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div>
...
<img className="aspect-[3/4] opacity-90 w-full object-contain rounded-md grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/16df3085-2d53-4e7f-80ed-afe5522caee5_3840w.png?w=800&amp;q=80"/>
<img className="aspect-[4/5] opacity-90 w-full object-cover rounded-md grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/586f321f-362b-464b-b960-463af2e45e57_1600w.png"/>
...
<span className="text-xs text-gray-400 mt-2">FOLLOW FOR SECTIONS AND ELEVATIONS
</span>
</div>
</div>

<div className="parallax-col flex flex-col gap-4 md:gap-6">
<img className="aspect-[3/4] opacity-90 w-full object-cover rounded-md grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/676c4c54-c216-49da-aa58-3e06ff26a50a_1600w.png?w=800&amp;q=80"/>
...
<img className="aspect-[4/3] opacity-90 w-full object-cover rounded-md grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8b1b4268-b755-46ed-a8d6-1f8b9626a863_1600w.png?w=800&amp;q=80"/>
</div>

<div className="parallax-col flex flex-col md:gap-6 hidden md:flex pt-40 gap-x-4 gap-y-4">
<div className="w-full aspect-[3/4] bg-[#111] text-white flex items-center justify-center rounded-md">
<iconify-icon className="opacity-50" height="48" icon="solar:square-alt-arrow-down-outline" style={{color: 'rgb(255, 255, 255)'}} width="48"></iconify-icon>
</div>
<img className="aspect-[4/5] opacity-90 w-full object-contain rounded-md grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0ad1bc4c-2c81-46a4-85be-ff290598eff1_1600w.png?w=800&amp;q=80"/>
</div>
</div>
</section>
...
<div className="leading-relaxed z-10 font-light text-gray-500 max-w-lg relative">I 
reduce until only the truth remains. Every project is an attempt to capture the invisible.</div>
...
<span className="text-[10px] uppercase font-medium text-gray-300 tracking-widest">THANKYOU  </span>
</div>
<a className="block group" href="mailto:hello@RISHABH.com">
...
<span className="text-[10px] uppercase font-semibold text-gray-500 tracking-widest">© 2026</span>
<div className="text-[10px] text-gray-600 uppercase tracking-widest"> Studio</div>RISHABH 
                </div>
</div>
</div>
</footer>

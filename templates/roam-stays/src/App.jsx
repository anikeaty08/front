...
<nav className="sticky flex z-50 text-base font-medium tracking-tight bg-[#F1F4F1]/95 w-full border-[#C7D0C8] border-b pt-4 pr-6 pb-4 pl-6 top-0 backdrop-blur-sm items-center justify-between">

<div className="hidden md:flex gap-8">
<a className="hover:text-[#5F6F65] transition-colors italic" href="/stays">
            Stays
          </a>
<a className="hover:text-[#8C867D] transition-colors italic" href="/experiences">
            Experiences
          </a>
<a className="hover:text-[#8C867D] transition-colors italic" href="/journal">
            Journal
          </a>
</div>
...
<span className="uppercase cursor-pointer text-xl font-semibold tracking-tight" onclick="window.location.href='/home';window.location.href='/home';window.location.href='/home';window.location.href='/'" role="button">
              ROAM
            </span>
</a>
</div>
...
<div className="hidden md:flex gap-8">
<a className="hover:text-[#8C867D] transition-colors italic" href="/host">
            Become a Host
          </a>
<a className="hover:text-[#8C867D] transition-colors italic" href="/login">
            Login
          </a>
</div>

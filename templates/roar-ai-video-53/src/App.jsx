...
<a className="bg-white/5 hover:bg-white/10 px-5 py-2 text-xs tracking-widest uppercase transition-all text-neutral-300 font-geist" href="#">Roar.ai</a>
<div className="hidden md:flex items-center gap-1">
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#strategy">Стратегия</a>
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#workflows">Процесс</a>
</div>
...
<div className="hidden md:flex items-center gap-1">
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#results">Кейсы</a>
<a className="hover:text-white px-4 py-2 text-xs tracking-widest uppercase transition-colors text-neutral-500 font-geist" href="#contact">Контакты</a>
</div>
...
<span className="relative z-10 font-geist">Обсудить</span>
...
<span className="[animation:animationIn_0.8s_ease-out_0.2s_both] animate-on-scroll tracking-tighter font-space-grotesk font-light">Создаем креативный</span>
<span className="text-gradient [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll font-light tracking-tighter font-space-grotesk">AI-контент</span>
</h1>
</div>
...
<span className="text-xs md:text-sm leading-none text-white font-geist">Active</span>
</div>
</div>
</div>
<h2 className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll text-lg text-neutral-400 tracking-tight font-space-grotesk md:text-3xl">
                        Студия видеопродакшна для брендов
                    </h2>
</div>
<div className="leading-relaxed [animation:animationIn_0.8s_ease-out_0.6s_both] animate-on-scroll md:text-2xl text-xs text-neutral-500 font-space-grotesk text-center max-w-2xl">Мы используем нейросети для создания вирусных роликов, автоматизации монтажа и масштабирования вашего бренда в социальных сетях.</div>
</div>
...
<span data-prefix="+" data-suffix="%" data-target="400">+400%</span>
</div>
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Рост охватов</h3>
</div>
</div>
...
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Новых лидов</h3>
</div>
</div>
...
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">Ускорение</h3>
</div>
</div>
</div>
</div>
...
<span className="reveal-word font-space-grotesk font-light">Хватит</span> <span className="reveal-word font-space-grotesk font-light">гадать.</span> <span className="reveal-word font-space-grotesk font-light">Начните</span>
...
<iconify-icon className="text-2xl mr-2 text-neutral-300" icon="solar:cpu-bold-duotone"></iconify-icon> Масштабироваться
                    </span>
<span className="reveal-word font-space-grotesk font-light">с</span> <span className="reveal-word font-space-grotesk font-light">помощью</span>
<span className="reveal-word text-black bg-white px-4 py-1 mx-1 font-space-grotesk font-light">Нейро-Движка,</span>
<span className="reveal-word font-space-grotesk font-light">который</span> <span className="reveal-word font-space-grotesk font-light">превращает</span> <span className="reveal-word font-space-grotesk font-light">контент</span> <span className="reveal-word font-space-grotesk font-light">в</span>
...
<span className="reveal-word font-space-grotesk font-light">стабильную</span> <span className="reveal-word font-space-grotesk font-light">прибыль.</span>
</h2>
</div>
</div>
</section>
...
<h2 className="text-5xl md:text-6xl uppercase mb-8 lg:mb-8 text-white tracking-tighter font-space-grotesk font-light">
                        AI<br/><span className="text-neutral-600">Протокол</span>
</h2>
...
<div className="">
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">01 / Анализ Трендов</h3>
<p className="step-text text-sm text-neutral-500 font-geist">AI анализирует 50M+ сигналов.</p>
</div>
</div>
...
<div>
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">02 / Генерация Видео</h3>
<p className="step-text text-sm text-neutral-500 font-geist">Авто-создание вирусных роликов.</p>
</div>
</div>
...
<div>
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">03 / Конверсия</h3>
<p className="step-text text-sm text-neutral-500 font-geist">Просмотры превращаются в продажи.</p>
</div>
</div>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">Анализ Трендов</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            Наши нейронные сети сканируют социальные графы в реальном времени, выявляя микротренды еще до того, как они достигнут пика.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Анализ настроений</li>
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Карта конкурентов</li>
<li className="flex items-center gap-3"><iconify-icon className="text-green-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Оценка виральности</li>
</ul>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">AI Продакшн</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            От сценария до монтажа — наши агенты берут на себя рутину. Мы создаем видеоконтент с высоким удержанием, адаптированный под алгоритмы TikTok, Reels и Shorts.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:check-circle-bold-duotone"></iconify-icon> AI Голос и Аватары</li>
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Авто-субтитры</li>
<li className="flex items-center gap-3"><iconify-icon className="text-blue-500" icon="solar:check-circle-bold-duotone"></iconify-icon> A/B тесты обложек</li>
</ul>
</div>
...
<h3 className="text-3xl text-white mb-6 font-space-grotesk tracking-tight">Конверсия в Доход</h3>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                            Просмотры — это хорошо, но деньги важнее. Наши автоматизированные воронки квалифицируют лидов в комментариях и директе 24/7.
                        </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Мгновенный ответ</li>
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:check-circle-bold-duotone"></iconify-icon> CRM Интеграция</li>
<li className="flex items-center gap-3"><iconify-icon className="text-purple-500" icon="solar:check-circle-bold-duotone"></iconify-icon> Квалификация лидов</li>
</ul>
</div>
</div>
</div>
...
<div className="">
<h2 className="text-5xl md:text-7xl uppercase mb-2 text-white tracking-tighter font-space-grotesk font-light">Результаты</h2>
<p className="text-xs uppercase tracking-widest text-neutral-500 font-geist">/ Кейсы / ROI</p>
</div>
</div>
...
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Вертикальный формат</h3>
</div>
</div>
</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Глобальный охват</h3>
</div>
</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Нейросети</h3>
</div>
</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Аналитика</h3>
</div>
</div>
</div>
...
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">Инсталлы</h3>
</div>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-5xl uppercase text-center text-white tracking-tighter font-space-grotesk font-light">
                Отзывы <span className="text-neutral-600">Клиентов</span>
</h2>
</div>
...
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"Рабочие процессы на базе AI не просто автоматизировали наш постинг, они фундаментально изменили стратегию. Мы масштабировались до 1М охвата."</p>
...
<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"Точность таргетинга не похожа ни на что, что мы видели. Мы снизили CPA на 40%, удвоив объем контента."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
...
<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">"Автоматизированные воронки в Direct приносят квалифицированных лидов, пока мы спим. ROI был очевиден в первые 14 дней."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
...
<h2 className="md:text-8xl uppercase text-5xl font-light text-white tracking-tighter font-space-grotesk mix-blend-plus-lighter mb-8">
                Готовы <span className="text-neutral-600">К Взлету?</span>
</h2>
<p className="text-xl text-neutral-400 font-geist mix-blend-plus-lighter max-w-xl mr-auto mb-10 ml-auto">
    Присоединяйтесь к 1% брендов, использующих автономную инфраструктуру роста.
</p>
<div className="">
...
<div className="">
<h3 className="text-3xl uppercase text-white mb-6 tracking-tighter font-space-grotesk font-light">Начать проект</h3>
<p className="text-sm text-neutral-400 mb-8 leading-relaxed font-geist">
                        Заполните параметры вашего запроса. Наши AI-агенты категоризируют вашу заявку, и стратег свяжется с вами в течение 24 часов.
                    </p>
...
<label className="absolute left-0 -top-3 text-[10px] text-neutral-500 uppercase tracking-widest transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-neutral-600 peer-focus:-top-3 peer-focus:text-[10px] peer-focus:text-white font-geist" htmlFor="message">О задаче</label>
</div>
...
<span className="font-geist">Отправить</span>
...
<a className="hover:text-white transition-colors font-geist" href="#">Политика</a>
<a className="hover:text-white transition-colors font-geist" href="#">Условия</a>
<a className="hover:text-white transition-colors font-geist" href="#">Статус</a>
</div>
</div>
...
<p className="font-geist">© 2024 Roar Growth Systems. // Все права защищены</p>

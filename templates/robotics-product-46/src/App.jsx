...
<img alt="Brand Logo" className="transition-transform duration-300 group-hover:scale-105 w-auto h-10 object-contain" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/288b92a4-f9e1-4169-8097-65331bc9a36c_320w.png"/>
</div>
...
<a className="hover:text-gray-900 transition-colors" href="#">Safety</a>
<a className="hover:text-gray-900 transition-colors" href="#">Vision</a>
</div>
<button className="hover:bg-gray-800 hover:scale-105 transition-all duration-300 active:scale-95 text-sm font-medium text-white bg-gray-900 rounded-full pt-3 pr-8 pb-3 pl-8 shadow-lg">
      Reserve
    </button>
</div>
</nav>
...
<div className="max-w-7xl z-0 mr-0 mb-0 ml-0 pt-0 pr-10 pl-20 relative">
...
<h2 className="leading-tight md:text-3xl text-3xl font-thin text-gray-900 tracking-tighter font-montserrat text-left mt-200 mr-50 ml-5 pr-50 pl-50">
          The world's first bio-emotive home guardian.
        </h2>
<div className="space-y-3">
<button className="hover:bg-gray-800 transition-all hover:shadow-2xl hover:-translate-y-1 text-sm font-medium text-white bg-gray-900 rounded-full mr-10 ml-5 pt-3 pr-10 pb-3 pl-10 shadow-xl">
                            Reserve
                        </button>
<p className="uppercase text-xs font-medium tracking-wide opacity-60 pr-10 pl-5">Shipping late 2026</p>
</div>
</div>

...
<span className="text-base md:text-lg font-semibold text-white tracking-tight font-display text-left">Roys<span className="font-light text-yellow-500">Company</span></span>
</a>
...
<span className="text-lg font-bold text-white tracking-tight font-display">Roys<span className="font-light text-yellow-500">Company</span></span>
</a>
...
<div className="text-[10px] uppercase text-yellow-600 tracking-widest text-center md:text-left">© 2025 RoysCompany Agency. All Rights Reserved.</div>

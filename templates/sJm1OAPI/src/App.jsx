...
<h2 className="text-xl font-semibold text-white">Complete Your Account Setup</h2>
...
<h3 className="text-lg font-medium text-white mb-4">Set Up Your Security Preferences</h3>
<p className="text-neutral-400 mb-6">Enhance your account security by configuring these important settings.</p>
...
<p className="text-neutral-400 text-sm mt-1">Add an extra layer of security to your account by requiring a verification code in addition to your password.</p>
</div>
</div>
</div>
...
<div className="ml-3 flex-1">
<div className="flex justify-between items-center">
<h4 className="text-white font-medium">Strong Password Requirements</h4>
<label className="relative inline-flex items-center cursor-pointer">
<input checked="" className="sr-only peer" type="checkbox" value=""/>
<div className="w-11 h-6 bg-neutral-700 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-neutral-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
</label>
</div>
<p className="text-neutral-400 text-sm mt-1">Enforce strong password policies including minimum length, special characters, and regular password changes.</p>
</div>
</div>
</div>
...
<p className="text-neutral-400 text-sm mt-1">Receive email notifications when there are new login attempts from unrecognized devices.</p>
</div>
</div>
</div>

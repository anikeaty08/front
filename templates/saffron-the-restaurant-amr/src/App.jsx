...
<span className="iconify text-amber-500 text-2xl" data-icon="lucide:utensils-crossed" data-strokeWidth="1.5"></span>
...
<span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">Amritpuram</span>
</h1>
...
<span className="iconify" data-icon="lucide:calendar-check" data-strokeWidth="1.5"></span>
                    Book a Table
                </a>
...
<div className="mb-16">
<h2 className="text-3xl font-medium tracking-tight text-white mb-4">Why Saffron?</h2>
...
<span className="iconify text-xl" data-icon="lucide:sparkles" data-strokeWidth="1.5"></span>
</div>
...
<div className="group glass-panel p-8 rounded-2xl hover:bg-zinc-900/80 transition-all duration-300">
<div className="w-10 h-10 rounded-lg bg-zinc-800 flex items-center justify-center mb-6 group-hover:bg-amber-500/20 group-hover:text-amber-500 transition-colors">
<span className="iconify text-xl" data-icon="lucide:concierge-bell" data-strokeWidth="1.5"></span>
</div>
<h3 className="text-lg font-medium text-white mb-3">Service Options</h3>
<ul className="space-y-2 text-sm text-zinc-400">
<li className="flex items-center gap-2"><span className="iconify text-amber-500" data-icon="lucide:check"></span> Dine-in &amp; Table Service</li>
<li className="flex items-center gap-2"><span className="iconify text-amber-500" data-icon="lucide:check"></span> No-contact delivery</li>
<li className="flex items-center gap-2"><span className="iconify text-amber-500" data-icon="lucide:check"></span> Takeaway</li>
</ul>
</div>

<div className="group glass-panel p-8 rounded-2xl hover:bg-zinc-900/80 transition-all duration-300">
<div className="w-10 h-10 rounded-lg bg-zinc-800 flex items-center justify-center mb-6 group-hover:bg-amber-500/20 group-hover:text-amber-500 transition-colors">
<span className="iconify text-xl" data-icon="lucide:coffee" data-strokeWidth="1.5"></span>
</div>
...
<span className="iconify" data-icon="lucide:utensils" data-strokeWidth="1.5"></span>
                            Thali Specials
                        </h3>
...
<div>
<h3 className="text-xl font-medium text-amber-500 mb-6 flex items-center gap-2">
<span className="iconify" data-icon="lucide:chef-hat" data-strokeWidth="1.5"></span>
                            Main Course
                        </h3>
...
<div>
<h3 className="text-xl font-medium text-amber-500 mb-6 flex items-center gap-2">
<span className="iconify" data-icon="lucide:croissant" data-strokeWidth="1.5"></span>
                            Indian Breads
                        </h3>
...
<div>
<h3 className="text-xl font-medium text-amber-500 mb-6 flex items-center gap-2">
<span className="iconify" data-icon="lucide:soup" data-strokeWidth="1.5"></span>
                            Rice &amp; Raita
                        </h3>
<div className="space-y-3">
<div className="flex justify-between items-center text-sm">
...
<div>
<h3 className="text-xl font-medium text-amber-500 mb-6 flex items-center gap-2">
<span className="iconify" data-icon="lucide:cup-soda" data-strokeWidth="1.5"></span>
                            Beverages &amp; Desserts
                        </h3>
...
<span className="iconify text-amber-500" data-icon="lucide:accessibility" data-strokeWidth="1.5"></span>
...
<div>
<div className="flex items-center gap-3 mb-4 text-white">
<span className="iconify text-amber-500" data-icon="lucide:users" data-strokeWidth="1.5"></span>
...
<div>
<div className="flex items-center gap-3 mb-4 text-white">
<span className="iconify text-amber-500" data-icon="lucide:car" data-strokeWidth="1.5"></span>
...
<div>
<div className="flex items-center gap-3 mb-4 text-white">
<span className="iconify text-amber-500" data-icon="lucide:credit-card" data-strokeWidth="1.5"></span>
...
<span className="iconify" data-icon="lucide:phone-call" data-strokeWidth="1.5"></span>
</div>
<div>
...
<span className="iconify absolute right-3 top-3.5 text-zinc-500 pointer-events-none" data-icon="lucide:calendar" data-strokeWidth="1.5"></span>
</div>
</div>
<div className="space-y-2">
...
<span className="iconify absolute right-3 top-3.5 text-zinc-500 pointer-events-none" data-icon="lucide:chevron-down" data-strokeWidth="1.5"></span>
</div>
</div>
</div>

...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
    ...
    !function(){if(!window.UnicornStudio){window.UnicornStudio={isInitialized:!1};var i=document.createElement("script");i.src="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.29/dist/unicornStudio.umd.js",i.onload=function(){window.UnicornStudio.isInitialized||(UnicornStudio.init(),window.UnicornStudio.isInitialized=!0)},(document.head || document.body).appendChild(i)}}();
                ...
                (function() {
            const wrapper = document.getElementById('card-wrapper-aura');
            if (!wrapper) return;
            ...
            let currentIndex = 0;
            const btn = document.getElementById('card-btn-aura');
            const titleEl = document.getElementById('card-title-aura');
            const badgeEl = document.getElementById('card-badge-aura');
            const descEl = document.getElementById('card-desc-aura');
            const dotsContainer = document.getElementById('card-dots-aura');
            const headerEl = document.getElementById('card-header-aura');

            if (btn) {
                btn.addEventListener('click', (e) => {
                    e.stopPropagation(); // Prevent edit mode selection issues
                    ...
                    setTimeout(() => {
                        ...
                        Array.from(dotsContainer.children).forEach((dot, idx) => {
                            if (idx === currentIndex) {
                                dot.className = 'w-1.5 h-1.5 bg-black rounded-full transition-all duration-300';
                            } else {
                                dot.className = 'w-1.5 h-1.5 bg-gray-300 rounded-full transition-all duration-300';
                            }
                        });
...
<nav className="relative z-50 w-full h-[80px] lg:h-[100px] flex items-center justify-between px-6 lg:px-[6%] border-b border-white/5 bg-[#0a051e]/80 backdrop-blur-md animate-reveal sticky top-0">
<div className="flex items-center gap-3">
<svg aria-hidden="true" className="iconify text-purple-400 iconify--solar text-2xl w-[24px] h-[24px]" data-icon="solar:atom-bold-duotone" data-icon-replaced="true" data-icon-set="solar" data-solar="share-circle-bold-duotone" height="24" role="img" strokeWidth="2" style={{color: 'rgb(192, 132, 252)', width: '24px', height: '24px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7.205 7.562a.75.75 0 0 0-.993-1.124A8.73 8.73 0 0 0 3.25 13a.75.75 0 0 0 1.5 0a7.23 7.23 0 0 1 2.455-5.438m10.583-1.124a.75.75 0 0 0-.993 1.124A7.23 7.23 0 0 1 19.25 13a.75.75 0 0 0 1.5 0a8.73 8.73 0 0 0-2.962-6.562m-7.601 13.584a.75.75 0 1 0-.374 1.452a8.8 8.8 0 0 0 4.374 0a.75.75 0 1 0-.374-1.452A7.3 7.3 0 0 1 12 20.25a7.3 7.3 0 0 1-1.813-.228" fill="#c084fc" opacity=".5"></path><path d="M9 6a3 3 0 1 0 6 0a3 3 0 0 0-6 0M2.5 18a3 3 0 1 0 6 0a3 3 0 0 0-6 0m16 3a3 3 0 1 1 0-6a3 3 0 0 1 0 6" fill="#c084fc"></path></svg>
...
<a className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-wider bg-white text-black py-2.5 px-5 rounded-sm hover:bg-purple-50 transition-colors" href="#">
                Get Started
            </a>
...
<span className="block animate-reveal delay-100">Global</span>
<span className="block text-white/40 lg:ml-[1em] animate-reveal delay-200">Scale</span>
<span className="block text-white/80 animate-reveal delay-300">Systems</span>
</h1>
...
<svg aria-hidden="true" className="iconify text-lg iconify--solar" data-icon="solar:arrow-right-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M3.25 12a.75.75 0 0 1 .75-.75h9.25v1.5H4a.75.75 0 0 1-.75-.75" fill="currentColor" fill-rule="evenodd" opacity=".5"></path><path d="M13.25 12.75V18a.75.75 0 0 0 1.28.53l6-6a.75.75 0 0 0 0-1.06l-6-6a.75.75 0 0 0-1.28.53z" fill="currentColor"></path></svg>
</div>
</button>
...
<p className="leading-relaxed lg:text-left lg:mx-0 text-lg font-light text-white/50 text-center max-w-md mx-auto">
                SAKURA provides the foundational architecture for next-generation predictive modeling and retention
                analytics.
            </p>
</div>
...
<div className="relative w-full max-w-[320px] lg:max-w-[360px] mx-auto lg:mx-0 h-[72px] flex items-center" style={{maskImage: 'linear-gradient(to right, transparent, black 20%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 20%, black 80%, transparent)'}}>
<div className="flex gap-12 items-center w-max animate-marquee will-change-transform">

<div className="opacity-50 hover:opacity-100 transition-all duration-500 grayscale hover:grayscale-0 cursor-pointer">
...
<div className="hidden lg:block marker -top-[2.5px] -left-[2.5px]"></div>
<div className="hidden lg:block marker -top-[2.5px] -right-[2.5px]"></div>
<img alt="Abstract Form" className="contrast-125 group-hover:scale-105 transition-transform duration-1000 ease-out opacity-60 mix-blend-lighten w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2cd4b4af-fea6-4fa5-a9c4-c0c963623db7_1600w.png"/>
<div className="absolute inset-0 z-10 pointer-events-none bg-cover bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/32ec2ecf-e699-440d-9f1c-f0a2515b3040_1600w.png)]" style={{}}>
</div>
...
<div className="flex flex-col shadow-purple-900/20 group overflow-hidden lg:rounded-none text-black bg-white w-full h-full rounded-sm pt-6 pr-6 pb-6 pl-6 relative shadow-2xl justify-between transition-all duration-500" id="card-wrapper-aura">
...
<svg className="lucide lucide-trophy opacity-60" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<path d="M8.5 22v-2.05"></path>
<path d="M15.5 22v-2.05"></path>
</svg>
<span className="text-[10px] font-semibold uppercase tracking-widest" id="card-badge-aura">Leader</span>
</div>
<h3 className="text-xl font-semibold leading-tight tracking-tight" id="card-title-aura">
                        PredictiveArchitecture</h3>
</div>
...
<p className="text-sm text-gray-500 font-medium leading-relaxed mb-4 border-l-2 border-purple-200 pl-3 transition-all duration-300 ease-out transform translate-y-0" id="card-desc-aura">
                        Awarded for highest reliability in enterprise AI deployment sectors.
                    </p>
</div>

<div className="flex items-center justify-between border-t border-gray-100 pt-3">
<div className="flex gap-1" id="card-dots-aura">
<div className="w-1.5 h-1.5 bg-black rounded-full transition-all duration-300"></div>
<div className="w-1.5 h-1.5 bg-gray-300 rounded-full transition-all duration-300"></div>
<div className="w-1.5 h-1.5 bg-gray-300 rounded-full transition-all duration-300"></div>
</div>
<button className="group/btn p-2 -mr-2 cursor-pointer rounded-full hover:bg-purple-50 transition-colors outline-none" id="card-btn-aura">
<svg className="lucide lucide-arrow-right text-gray-400 group-hover/btn:text-purple-600 transition-colors" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
</button>
</div>
</div>
...
<h2 className="lg:text-8xl text-4xl font-normal text-white tracking-tight mb-8" style={{animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) both'}}>
                Intelligence Scale 
                <span className="text-white/30">Infrastructure.</span>
</h2>
<div className="delay-100 grid grid-cols-1 lg:grid-cols-2 gap-12" style={{animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) both'}}>
<p className="text-lg text-white/60 font-light leading-relaxed">
                    Deploy autonomous agents that recursively optimize your data pipelines. 
                    SAKURA bridges the gap between predictive generation and structural reliability.
                </p>
<div className="flex gap-4 items-center lg:justify-end">
<div className="h-[1px] w-12 bg-white/20"></div>
<span className="text-xs font-mono text-white/40 uppercase">Architecture v2.0</span>
</div>
</div>
</div>

<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 gap-x-6 gap-y-6" onmousemove="for(const card of this.children){const rect=card.getBoundingClientRect(),x=event.clientX-rect.left,y=event.clientY-rect.top;card.style.setProperty('--mouse-x', x + 'px');card.style.setProperty('--mouse-y', y + 'px');}">

<div className="delay-200 col-span-1 lg:col-span-2 group hover:bg-white/[0.04] transition-all duration-500 flex flex-col hover:border-white/10 h-full border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden" style={{animation: '1s cubic-bezier(0.16, 1, 0.3, 1) 0s 1 normal both running reveal-up', '--mouse-x': '284.3671875px', '--mouse-y': '223px'}}>
...
<h3 className="text-lg font-medium text-white mb-3 tracking-tight flex items-center gap-2">
                        Semantic Generation
                        <svg className="lucide lucide-sparkles w-4 h-4 text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
</h3>
<p className="text-sm text-white/50 font-light leading-relaxed">Convert unstructured data streams into professionally structured reports instantaneously.</p>
</div>
</div>

<div className="delay-300 col-span-1 lg:col-span-2 group hover:bg-white/[0.04] transition-all duration-500 flex flex-col hover:border-white/10 h-full border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden" style={{animation: '1s cubic-bezier(0.16, 1, 0.3, 1) 0s 1 normal both running reveal-up', '--mouse-x': '-190.2109375px', '--mouse-y': '223px'}}>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '0'}}></div>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '0', WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', WebkitMaskComposite: 'xor', maskComposite: 'exclude', padding: '1px'}}></div>
...
<svg aria-hidden="true" className="iconify text-6xl text-white/20 group-hover:text-purple-400/80 transition-colors duration-500 iconify--solar" data-icon="solar:widget-2-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M2 6.634a4.634 4.634 0 1 1 9.268 0a4.634 4.634 0 0 1-9.268 0" fill="currentColor" fill-rule="evenodd"></path><path clip-rule="evenodd" d="M12.732 17.366a4.634 4.634 0 1 1 9.269 0a4.634 4.634 0 0 1-9.269 0" fill="currentColor" fill-rule="evenodd" opacity=".5"></path><path d="M2 17.5c0-2.121 0-3.182.659-3.841S4.379 13 6.5 13s3.182 0 3.841.659S11 15.379 11 17.5s0 3.182-.659 3.841S8.621 22 6.5 22s-3.182 0-3.841-.659S2 19.621 2 17.5" fill="currentColor"></path><path d="M13 6.5c0-2.121 0-3.182.659-3.841S15.379 2 17.5 2s3.182 0 3.841.659S22 4.379 22 6.5s0 3.182-.659 3.841S19.621 11 17.5 11s-3.182 0-3.841-.659S13 8.621 13 6.5" fill="currentColor" opacity=".5"></path></svg>
</div>
<div className="relative z-10">
<h3 className="text-lg font-medium text-white mb-3 tracking-tight">Holistic Observability</h3>
<p className="text-sm text-white/50 font-light leading-relaxed">Synthesize fragmented metrics into a single, coherent system operational view.</p>
</div>
</div>

<div className="delay-200 col-span-1 lg:col-span-3 group hover:bg-white/[0.04] transition-all duration-500 flex flex-col min-h-[320px] hover:border-white/10 border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden" style={{animation: '1s cubic-bezier(0.16, 1, 0.3, 1) 0s 1 normal both running reveal-up', '--mouse-x': '284.3671875px', '--mouse-y': '-176.5px'}}>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '0'}}></div>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '0', WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', WebkitMaskComposite: 'xor', maskComposite: 'exclude', padding: '1px'}}></div>
<div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-50 transition-opacity z-10">
<svg className="lucide lucide-scan-search w-[32px] h-[32px]" data-icon-replaced="true" data-lucide="scan-search" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" style={{width: '32px', height: '32px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 7V5a2 2 0 0 1 2-2h2"></path><path d="M17 3h2a2 2 0 0 1 2 2v2"></path><path d="M21 17v2a2 2 0 0 1-2 2h-2"></path><path d="M7 21H5a2 2 0 0 1-2-2v-2"></path><circle cx="12" cy="12" r="3"></circle><path d="m16 16-1.9-1.9"></path></svg>
</div>
<div className="mt-auto relative z-10">
<h3 className="text-xl font-medium text-white mb-3 tracking-tight">Deep Neural Inspection</h3>
<p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
                        Our AI recursively scans unstructured data to surface hidden correlations and critical anomalies before they impact production.
                        The system learns from historical incidents to predict future outages.
                    </p>
<div className="mt-8 flex items-center gap-4">
<div className="text-xs font-mono text-purple-400 bg-purple-400/10 px-2 py-1 rounded">98% Accuracy</div>
<div className="text-xs font-mono text-white/40">Real-time Analysis</div>
</div>
</div>
</div>

<div className="delay-300 col-span-1 lg:col-span-3 group hover:bg-white/[0.04] transition-all duration-500 flex flex-col min-h-[320px] hover:border-white/10 border-white/5 border rounded-sm pt-8 pr-8 pb-8 pl-8 relative backdrop-blur-lg justify-between overflow-hidden" style={{animation: '1s cubic-bezier(0.16, 1, 0.3, 1) 0s 1 normal both running reveal-up', '--mouse-x': '-427.5px', '--mouse-y': '-176.5px'}}>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '0'}}></div>
<div className="pointer-events-none absolute -inset-px rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '0', WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', WebkitMaskComposite: 'xor', maskComposite: 'exclude', padding: '1px'}}></div>
<div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-50 transition-opacity z-10">
<svg className="lucide lucide-mail-check w-[32px] h-[32px]" data-icon-replaced="true" data-lucide="mail-check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" style={{width: '32px', height: '32px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8"></path><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path><path d="m16 19 2 2 4-4"></path></svg>
</div>
<div className="mt-auto relative z-10">
<h3 className="text-xl font-medium text-white mb-3 tracking-tight">Autonomous Dispatch</h3>
<p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
                        Intelligent routing of actionable insights to stakeholders via personalized, context-aware communication channels.
                        Reduce noise by ensuring only relevant alerts reach the engineering team.
                    </p>
<div className="mt-8 flex -space-x-2 overflow-hidden">
<div className="inline-block h-6 w-6 rounded-full ring-2 ring-[#0a051e] bg-gray-600"></div>
<div className="inline-block h-6 w-6 rounded-full ring-2 ring-[#0a051e] bg-gray-500"></div>
<div className="inline-block h-6 w-6 rounded-full ring-2 ring-[#0a051e] bg-gray-400"></div>
<div className="inline-block h-6 w-6 rounded-full ring-2 ring-[#0a051e] bg-white/10 flex items-center justify-center text-[9px] font-mono text-white">+12</div>
</div>
</div>
</div>
</div>
</div>
</section><section className="overflow-hidden lg:py-32 text-white w-full z-20 pt-24 pb-24 relative">
...
<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 mb-8 gap-x-8 gap-y-8" onmousemove="const cards = this.querySelectorAll('.group'); for(const card of cards){ const rect = card.getBoundingClientRect(); const x = event.clientX - rect.left; const y = event.clientY - rect.top; card.style.setProperty('--mouse-x', x + 'px'); card.style.setProperty('--mouse-y', y + 'px'); }">

<div className="lg:col-span-7 flex flex-col gap-6 gap-x-6 gap-y-6">

<div className="group hover:bg-white/[0.04] transition-all duration-500 border border-white/5 hover:border-white/10 rounded-sm backdrop-blur-lg p-10 lg:p-12 relative overflow-hidden flex flex-col justify-center min-h-[240px]" style={{'--mouse-x': '298.3671875px', '--mouse-y': '644.5px'}}>
...
<div className="lg:h-[500px] overflow-hidden group h-[420px] border-white/5 hover:border-white/10 border rounded-sm relative backdrop-blur-lg transition-all duration-500 shadow-sm" style={{'--mouse-x': '298.3671875px', '--mouse-y': '380.5px'}}>
<img alt="Data Network Structure" className="transition-transform duration-1000 group-hover:scale-105 filter group-hover:saturate-100 w-full h-full object-cover absolute top-0 right-0 bottom-0 left-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b5326861-9214-4075-b2d4-dedfcf9cc3ea_1600w.webp"/>
...
<div className="hover:bg-white/[0.04] text-white p-10 rounded-sm transform transition-all duration-500 hover:-translate-y-1 relative overflow-hidden group h-full flex flex-col justify-between border border-white/5 hover:border-white/10 backdrop-blur-lg" style={{'--mouse-x': '-536.8046875px', '--mouse-y': '644.5px'}}>
...
<p className="text-xl font-light leading-relaxed mb-10 text-white/90">
              "SAKURA's predictive modeling slashed our latency by 40% in just two weeks. The recursive optimization
              agents are basically magic for our devops pipeline."
            </p>
</div>
<div className="flex items-center justify-between border-t border-white/10 pt-6 relative z-10">
<div className="flex items-center gap-4">
<img alt="Elena Rostova" className="w-12 h-12 rounded-full border-2 border-white/10 grayscale group-hover:grayscale-0 transition-all object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dc6dc108-07ea-4b25-98fb-c8196765a394_320w.webp" style={{}}/>
<div className="">
...
<iconify-icon className="opacity-60" icon="simple-icons:openai" width="14"></iconify-icon>
</div>
</div>
</div>
...
<div className="hover:bg-white/[0.04] p-8 rounded-sm border border-white/5 hover:border-white/10 transform transition-all duration-500 hover:-translate-y-1 relative group text-white backdrop-blur-lg" style={{'--mouse-x': '-536.8046875px', '--mouse-y': '263.5px'}}>
...
<p className="text-base font-normal leading-relaxed mb-8 text-slate-400 relative z-10">
            "The centralized storage substrate is incredibly robust. We migrated 5PB of data without a single packet
            loss. Absolutely essential infrastructure."
          </p>
<div className="flex items-center justify-between border-t border-white/10 pt-6 relative z-10">
<div className="flex items-center gap-4">
<img alt="Marcus Chen" className="w-10 h-10 rounded-full border border-white/10 grayscale group-hover:grayscale-0 transition-all" src="https://i.pravatar.cc/150?u=a042581f4e29026704d" style={{}}/>
<div className="">
...
<div className="hover:bg-white/[0.04] p-8 rounded-sm border border-white/5 hover:border-white/10 transform transition-all duration-500 hover:-translate-y-1 relative group backdrop-blur-lg" style={{'--mouse-x': '-536.8046875px', '--mouse-y': '-25.5px'}}>
...
<p className="text-base font-normal leading-relaxed mb-8 text-slate-400 relative z-10">
            "Finally, observability that actually makes sense. The holistic view dashboard saved our ops team hundreds
            of hours in Q3 alone."
          </p>
<div className="flex items-center justify-between border-t border-white/10 pt-6 relative z-10">
<div className="flex items-center gap-4">
<img alt="Sarah Jenkins" className="w-10 h-10 rounded-full border border-white/10 grayscale group-hover:grayscale-0 transition-all" src="https://i.pravatar.cc/150?u=a04258114e29026702d" style={{}}/>
<div>
...
<h3 className="text-3xl lg:text-4xl font-medium text-white tracking-tight mb-2">Ready to scale your intelligence?
        </h3>
...
</section><section className="relative w-full py-24 lg:py-32 overflow-hidden z-20 border-t border-white/5">
...
<div className="relative w-full overflow-hidden mb-20 lg:mb-24" style={{maskImage: 'linear-gradient(to right, transparent, black 15%, black 85%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 15%, black 85%, transparent)'}}>
<style>
    ...
    .animate-marquee-slow {
      animation: marquee-scroll-slow 80s linear infinite;
    }
...
<img alt="User" className="w-10 h-10 rounded-full grayscale group-hover:grayscale-0 transition-all border border-white/10" src="https://i.pravatar.cc/150?u=a042581f4e29026024d"/>
<div>
...
<iconify-icon className="text-white/30 text-lg" icon="simple-icons:nvidia"></iconify-icon>
<iconify-icon className="text-purple-400 text-sm" icon="solar:star-bold-duotone"></iconify-icon>
</div>
</div>
<div className="bg-white/[0.03] backdrop-blur-md border border-white/5 p-6 rounded-sm hover:bg-white/[0.06] transition-all hover:-translate-y-1 group">
<div className="flex items-center gap-4 mb-4">
<img alt="User" className="w-10 h-10 rounded-full grayscale group-hover:grayscale-0 transition-all border border-white/10" src="https://i.pravatar.cc/150?u=a042581f4e29026704b"/>
<div>
...
<iconify-icon className="text-white/30 text-xl" icon="simple-icons:ibm"></iconify-icon>
<div className="flex gap-0.5 text-purple-400/60">
<iconify-icon className="text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-xs" icon="solar:star-bold-duotone"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-2xl" icon="solar:quote-up-square-bold-duotone"></iconify-icon>
</div>
...
<div className="flex items-center gap-3">
<img className="w-8 h-8 rounded-full grayscale border border-white/10" src="https://i.pravatar.cc/150?u=23"/>
...
<iconify-icon className="ml-auto text-white/30 text-lg" icon="simple-icons:anthropic"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-purple-400 text-xl" icon="solar:verified-check-bold-duotone"></iconify-icon>
</div>
<div className="flex items-center gap-4 mb-3">
<img className="w-10 h-10 rounded-full grayscale group-hover:grayscale-0 transition-all border border-white/10" src="https://i.pravatar.cc/150?u=12"/>
<div>
...
<iconify-icon className="text-white/30 text-lg" icon="simple-icons:openai"></iconify-icon>
</div>
</div>
</div>
...
<iconify-icon className="text-purple-400 text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-purple-400 text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-purple-400 text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-purple-400 text-xs" icon="solar:star-bold-duotone"></iconify-icon>
<iconify-icon className="text-purple-400 text-xs" icon="solar:star-bold-duotone"></iconify-icon>
...
<div className="flex items-center gap-3">
<img className="w-8 h-8 rounded-full grayscale border border-white/10" src="https://i.pravatar.cc/150?u=54"/>
<div className="">
<h4 className="text-xs font-medium text-white">Elias K.</h4>
<p className="text-[10px] text-white/40 uppercase">SpaceX</p>
</div>
<iconify-icon className="ml-auto text-white/30 text-sm" icon="simple-icons:spacex"></iconify-icon>
</div>
</div>
<div className="relative h-40 rounded-sm overflow-hidden border border-white/5 group">
<img className="absolute inset-0 w-full h-full object-cover grayscale opacity-60 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c6fe7f3d-bf69-4eff-a8b0-25beb3a0d389_800w.webp"/>
...
<div className="bg-white/[0.03] backdrop-blur-md border border-white/5 p-6 rounded-sm hover:bg-white/[0.06] transition-all hover:-translate-y-1 group">
<div className="flex items-center gap-4 mb-4">
<img className="w-10 h-10 rounded-full grayscale group-hover:grayscale-0 transition-all border border-white/10" src="https://i.pravatar.cc/150?u=88"/>
<div>
...
<div className="flex justify-between items-center border-t border-white/5 pt-4">
<iconify-icon className="text-white/30 text-lg" icon="simple-icons:googlecloud"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-xl" icon="solar:graph-new-up-bold-duotone"></iconify-icon>
</div>
<div>
...
<img className="w-9 h-9 rounded-full grayscale border border-white/10" src="https://i.pravatar.cc/150?u=33"/>
<div>
...
<iconify-icon className="text-white/30 text-lg" icon="simple-icons:linear"></iconify-icon>
</div>
</div>
...
<iconify-icon className="text-xl" icon="simple-icons:amazon"></iconify-icon>
<iconify-icon className="text-xl" icon="simple-icons:meta"></iconify-icon>
<iconify-icon className="text-xl" icon="simple-icons:netflix"></iconify-icon>
</div>
</div>
</div>
...
<iconify-icon className="text-lg transition-transform group-hover:translate-x-1" icon="solar:arrow-right-bold-duotone"></iconify-icon>
</button>
</div>
</div>
</section><section className="z-20 w-full border-white/5 border-t relative">
...
<button className="w-full pt-8 pb-8 flex items-center justify-between cursor-pointer text-left focus:outline-none" onclick="const ans = this.nextElementSibling; const icon = this.querySelector('iconify-icon'); ans.classList.toggle('hidden'); icon.classList.toggle('rotate-45');">
<h3 className="text-lg font-light text-white/90 group-hover:text-white transition-colors">Can you guarantee 99.99% recursive uptime?</h3>
<iconify-icon className="text-2xl text-white/30 group-hover:text-purple-400 transition-all duration-300" icon="solar:add-circle-bold-duotone"></iconify-icon>
</button>
<div className="hidden pb-8 text-white/60 font-light leading-relaxed animate-reveal">
            Our recursive neural topology autonomously reroutes data streams through redundant nodes, ensuring continuous availability even during catastrophic localized failures.
          </div>
</div>

<div className="group border-b border-white/5">
<button className="w-full pt-8 pb-8 flex items-center justify-between cursor-pointer text-left focus:outline-none" onclick="const ans = this.nextElementSibling; const icon = this.querySelector('iconify-icon'); ans.classList.toggle('hidden'); icon.classList.toggle('rotate-45');">
<h3 className="text-lg font-light text-white/90 group-hover:text-white transition-colors">Where are the neural data nodes geographically located?</h3>
<iconify-icon className="text-2xl text-white/30 group-hover:text-purple-400 transition-all duration-300" icon="solar:add-circle-bold-duotone"></iconify-icon>
</button>
<div className="hidden pb-8 text-white/60 font-light leading-relaxed animate-reveal">
             Nodes are distributed across 40+ tier-4 data centers globally, with primary clusters in Tokyo, Frankfurt, and Northern Virginia to minimize signal latency.
          </div>
</div>
</div>
</div>

<div className="overflow-hidden w-full rounded-sm mb-32 relative group" onmousemove="const rect=this.getBoundingClientRect(); const x=event.clientX - rect.left; const y=event.clientY - rect.top; this.style.setProperty('--mouse-x', x + 'px'); this.style.setProperty('--mouse-y', y + 'px');" style={{'--mouse-x': '1092.3671875px', '--mouse-y': '299px'}}>
...
<svg className="absolute top-0 right-0 h-full w-full opacity-20 pointer-events-none z-0" fill="none" viewbox="0 0 1000 400" xmlns="http://www.w3.org/2000/svg">
<circle cx="850" cy="200" r="150" stroke="white" stroke-dasharray="4 4" strokeWidth="1"></circle>
<circle cx="850" cy="200" opacity="0.5" r="280" stroke="white" strokeWidth="0.5"></circle>
<path d="M0 400 C 300 400, 600 200, 1000 200" fill="none" stroke="white" strokeWidth="0.5"></path>
<circle cx="750" cy="300" fill="white" r="2"></circle>
</svg>
<div className="lg:px-16 lg:py-20 flex flex-col lg:flex-row lg:items-end bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1a5c78a4-2c8f-45ca-be6a-164d15d324bc_3840w.webp)] bg-cover z-10 pt-16 pr-8 pb-16 pl-8 relative gap-x-12 gap-y-12 items-start justify-between" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.1))'}}>
...
<a className="group relative inline-flex flex-col justify-between w-64 h-28 border border-white/10 bg-white/[0.02] backdrop-blur-xl hover:bg-white/[0.08] hover:border-white/30 hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.1)] transition-all duration-500 rounded-sm p-5 overflow-hidden" href="#">
...
<iconify-icon className="text-xl text-white/70 group-hover:text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" icon="solar:arrow-right-up-linear"></iconify-icon>
</div>
...
<p className="text-lg text-white/80 font-light leading-relaxed">
                    Our dedicated architecture team is standing by to assist with custom deployment strategies and recursive
                    scaling.
                </p>
</div>
</div>
...
</section><footer className="relative w-full border-t border-white/5 bg-[#0a051e] z-20 pt-24 pb-12">
<div className="max-w-[1600px] mx-auto px-6 lg:px-[6%]">
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">

<div className="lg:col-span-2">
<div className="flex items-center gap-2 text-white mb-6">
<iconify-icon className="text-purple-400 text-2xl" icon="solar:atom-bold-duotone"></iconify-icon>
<span className="font-bold tracking-tight">SAKURA</span>
</div>
</div>
...
<li className=""><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">Documentation</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">API Reference</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">System Status</a> <span className="inline-block w-1.5 h-1.5 rounded-full bg-emerald-500 ml-1"></span></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">Open Source</a></li>
</ul>
</div>
<div className="lg:col-span-2">
<h4 className="text-xs font-mono text-white/40 uppercase mb-6">Company</h4>
<ul className="space-y-4">
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">About</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">Research</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">Careers</a></li>
<li><a className="text-sm text-white/60 hover:text-white transition-colors" href="#">Legal</a></li>
</ul>
</div>
<div className="lg:col-span-2">
...
<ul className="space-y-4">
<li>
<a className="flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors" href="#">
<iconify-icon className="text-xs" icon="simple-icons:x"></iconify-icon> Twitter
            </a>
</li>
<li>
<a className="flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors" href="#">
<iconify-icon className="text-xs" icon="simple-icons:github"></iconify-icon> GitHub
            </a>
</li>
<li>
<a className="flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors" href="#">
...
<a className="group flex flex-col justify-between p-6 w-full sm:w-48 h-32 border border-white/10 hover:bg-white/[0.03] hover:border-white/20 transition-all rounded-sm" href="#">
<div className="w-full flex justify-end">
<iconify-icon className="text-white/40 group-hover:text-purple-400 transition-colors" icon="solar:arrow-right-up-linear"></iconify-icon>
</div>
<div>
...
<p className="text-xs text-white/30">© 2024 SAKURA Systems Inc. All rights reserved.</p>
<div className="flex gap-6">
<a className="text-xs text-white/30 hover:text-white transition-colors" href="#">Privacy Policy</a>
<a className="text-xs text-white/30 hover:text-white transition-colors" href="#">Terms of Service</a>
</div>
</div>
</div>
</footer>

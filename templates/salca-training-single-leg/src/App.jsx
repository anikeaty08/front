...
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" className="absolute inset-0 w-full h-full" frameborder="0" src="https://www.youtube.com/embed/JRXLbrX_sys?rel=0&amp;modestbranding=1&amp;playsinline=1" title="Salca Demo Video">
</iframe>
</div>
</header>
</div>
...
<div className="relative w-full aspect-square bg-gray-900 rounded-3xl overflow-hidden shadow-2xl group border border-white/10">
<img alt="Practice your Balance" className="transition-transform duration-700 group-hover:scale-105 w-full h-full object-cover z-10 relative" src="attached-image.jpg"/>
</div>
</div>
</div>
</section>

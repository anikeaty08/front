...
<svg className="iconify" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<a className="flex items-center gap-2 text-sm font-medium text-gray-900 hover:text-brand-600 transition-colors tracking-tight" href="tel:0400000000">
...
<a className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-gray-900 border border-gray-200" href="tel:0400000000">
...
<div className="bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4401067f-6325-47b4-bed8-902c860ffad0_3840w.jpg)] bg-cover bg-center z-0 absolute top-0 right-0 bottom-0 left-0">
...
<span className="text-brand-200 text-xs font-medium tracking-wide uppercase">
              Serving Sutherland Shire &amp; St George
            </span>
</div>
...
<h2 className="text-2xl md:text-3xl font-medium text-gray-200 tracking-tight leading-snug max-w-3xl text-center">
              Professional Pressure Cleaning That Restores Your Property
            </h2>
</div>
<p className="text-lg md:text-xl text-gray-300 mb-10 max-w-xl mx-auto leading-relaxed font-light">
            Fast, reliable exterior pressure washing and soft washing. We bring
            your home back to life with zero hassle.
          </p>
...
<p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">
            We use the right pressure and the right solutions to safely clean
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/97206b69-8974-44da-9ade-d0bc0f048485_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Remove oil stains, tyre marks, and years of grime build-up
                  instantly.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('Driveway Cleaning')">
                Get a Quote
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/99a3abaa-0cc7-4209-999b-d40a9e142b2a_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Safe low-pressure cleaning to remove mould and dirt from
                  weatherboards and render.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('House Washing')">
                Get a Quote
                <svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/40282789-73f7-4150-976d-8d92bb9fccad_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Extend the life of your roof by removing lichen, moss, and
                  oxidative buildup.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('Roof Cleaning')">
                Get a Quote
                <svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/1434dbf3-5e13-4c70-92c7-7b3f8a4ac5b9_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Restore the natural colour of your stone or brick pavers
                  without damage.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('Pavers &amp; Pathways')">
                Get a Quote
                <svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/29da96ae-3c75-4e69-8996-54f260996aa9_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Reliable maintenance for apartment complexes, shopfronts, and
                  commercial spaces.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('Commercial Cleaning')">
                Get a Quote
                <svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/96922261-38dc-4155-bc78-b117606c3799_800w.jpg)] bg-cover bg-center transition-transform duration-700 group-hover:scale-105"></div>
...
<p className="text-sm text-gray-200 mb-6 leading-relaxed font-light">
                  Scheduled cleaning to keep your property value high
                  year-round.
                </p>
</div>
<button className="text-sm font-medium text-white hover:text-brand-300 flex items-center gap-1 transition-colors" onclick="openQuoteForm('General Maintenance')">
                Get a Quote
                <svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="16" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
...
<img alt="Driveway Cleaning" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1595846519845-68e298c2edd8?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-black/40"></div>
<div className="flex bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/face8928-c4b3-4ffc-8b13-f9df3adb8025_1600w.jpg)] bg-cover bg-center absolute top-0 right-0 bottom-0 left-0 items-center justify-center">
...
<img alt="House Washing" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-black/40"></div>
<div className="flex bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6240dcbb-3743-4dd0-ae6c-71bd7892bd0c_1600w.jpg)] bg-cover bg-center absolute top-0 right-0 bottom-0 left-0 items-center justify-center">
<div className="bg-white/90 backdrop-blur text-gray-900 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider">
                Soft Wash House Clean
              </div>
</div>
</div>
</div>
...
<h2 className="text-4xl font-medium text-gray-900 mb-6 tracking-tighter">
              Trusted Locally for Reliable Exterior Cleaning
            </h2>
<p className="text-lg text-gray-600 mb-6 leading-relaxed font-light">
              Sallesis Pressure Washing is owner-operated. That means you deal
              directly with Andrew, ensuring communication is clear and the job
...
<span className="text-gray-700 text-sm">
                  Servicing Sutherland Shire &amp; St George
                </span>
</div>
<div className="flex items-center gap-3">
<svg aria-hidden="true" data-icon="lucide:check-circle-2" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<a className="bg-white/10 text-white border border-white/20 hover:bg-white/20 text-lg font-medium px-10 py-4 rounded-xl shadow-sm transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm" href="tel:0400000000">
<svg aria-hidden="true" className="" data-icon="lucide:phone" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" data-icon="lucide:droplet" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<span className="font-semibold text-gray-900">Sallesis</span>
</div>
<p className="text-gray-500 leading-relaxed mb-6 text-sm max-w-xs">
              Professional pressure washing and maintenance services for
              Sutherland Shire &amp; St George. Restoring value to your home.
            </p>
</div>
<div>
...
<a className="text-gray-600 hover:text-brand-600 transition-colors" href="tel:0400000000">
                  0400 000 000
                </a>
</li>
<li className="flex items-start gap-3">
...
<a className="text-gray-600 hover:text-brand-600 transition-colors" href="mailto:andrew@sallesis.com.au">
                  info@sallesis.com.au
                </a>
</li>
<li className="flex items-start gap-3">
...
<span className="text-gray-600">
                  Sutherland Shire &amp; St George, NSW
                </span>
</li>
<li className="flex items-start gap-3">
...
<span className="text-gray-600">ABN: XX XXX XXX XXX</span>
</li>
</ul>
</div>
</div>
...
<p className="text-gray-400 text-xs">
            © 2025 Sallesis Pressure Washing &amp; Maintenance.
          </p>
</div>
</div>
</footer>
...
<input className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all text-sm placeholder-gray-400 hover:border-gray-300" placeholder="0400 000 000" required="" type="tel"/>
</div>
<div className="space-y-1.5">
<label className="block text-xs font-semibold uppercase tracking-wide text-gray-600">
                  Location
...
<option value="Pavers &amp; Pathways">
                  Pavers &amp; Pathways
                </option>
<option value="Commercial Cleaning">Strata/Commercial</option>

...
<section className="sm:py-24 py-16 pb-16 max-w-5xl mx-auto px-6 border-t border-white/5">
<div className="mb-12">
...
<span className="">PROVA SOCIAL</span>
...
<p className="sm:text-lg text-neutral-400 max-w-3xl mt-0 mr-auto mb-6 ml-0">
                            O que nossos parceiros dizem sobre escalar suas operações com a ScalePage. Feedback real de quem vive o crescimento no dia a dia.
                        </p>
<div className="flex justify-start">
<a className="inline-flex items-center gap-3 ring-1 ring-white/10 hover:shadow-2xl hover:bg-white/10 transition bg-white/5 rounded-full pt-2 pr-2 pb-2 pl-2 shadow" href="#">
...
<span className="px-3 text-sm font-medium text-white">Ver Cases de Sucesso</span>
</a>
</div>
</div>
</div>
...
<div className="grid grid-cols-1 lg:grid-cols-3 gap-0 rounded-2xl overflow-hidden shadow-sm ring-1 ring-white/10 fade-in-up animate">
...
<p className="text-sm leading-relaxed mb-6">"As páginas foram entregues em menos de 48 horas e a qualidade é impressionante. Nossas conversões dobraram na primeira semana."</p>
<div className="flex items-center justify-between">
<div className="">
<div className="text-sm font-medium text-white">Ricardo M.</div>
<div className="text-xs mt-1 text-neutral-500">CEO, E-commerce Moda</div>
</div>
...
<div className="w-6 h-6 rounded-full border bg-neutral-300 border-black/10"></div>
<div className="">
<div className="text-sm font-medium">Juliana S.</div>
<div className="text-xs text-black/60">Diretora, Clínica Estética</div>
</div>
</div>
...
<p className="leading-relaxed relative z-10 text-sm font-medium">"Finalmente uma agência que fala minha língua. Sem termos técnicos complicados, apenas estratégia clara e resultado no caixa."</p>
</div>
...
<p className="text-sm leading-relaxed mb-6">"Mais de 10 negócios transformados com a ScalePage. O processo de onboarding é rápido e a execução é impecável."</p>
<div className="flex items-center justify-between">
<div>
<div className="text-sm font-medium text-white">Marcos D.</div>
<div className="text-xs mt-1 text-neutral-500">Infoprodutor</div>
</div>
<div className="w-8 h-8 rounded-full border bg-neutral-800 border-white/10"></div>
</div>
</div>
...
<div className="text-white bg-[#0A0A0B] border-white/10 border-r pt-6 pr-6 pb-6 pl-6 scale-in stagger-delay-1 animate">
<div className="text-3xl sm:text-4xl font-semibold tracking-tight mb-2">2h</div>
<div className="text-xs text-neutral-500">Tempo médio de resposta</div>
</div>
<div className="p-6 border-r bg-[#0A0A0B] text-white border-white/10 scale-in stagger-delay-2 animate">
<div className="text-3xl sm:text-4xl font-semibold tracking-tight mb-2">10k+</div>
<div className="text-xs text-neutral-500">Leads gerados/mês</div>
</div>
<div className="p-6 bg-[#0A0A0B] text-white scale-in stagger-delay-3 animate">
<div className="text-3xl sm:text-4xl font-semibold tracking-tight mb-2">3x</div>
<div className="text-xs text-neutral-500">ROI médio dos clientes</div>
</div>
</div>
</div>
</div>
...
<button className="group relative h-12 px-8 rounded-full font-medium text-sm transition-all overflow-hidden flex items-center gap-2 bg-white text-black hover:bg-neutral-200">

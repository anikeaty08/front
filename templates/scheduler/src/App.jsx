...
<img alt="" className="absolute inset-x-0 top-[-10%] mx-auto w-[1200px] max-w-none opacity-20 blur-3xl select-none pointer-events-none object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5b29e34e-9f3d-44f2-b328-fd4771713a34_1600w.webp"/>
...
<a className="inline-flex items-center justify-center bg-center w-[140px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/26a2e18f-1e9a-4273-9f82-f86ac5cc7d5b_1600w.png)] bg-cover rounded invert" href="#"></a>
...
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/ff011286-28d0-42f1-9e8f-9bffe0a9edf7_320w.webp"/>
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f0d70bb8-0ddf-4ff2-9227-d94dc46ef062_320w.webp"/>
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/81a14d03-8b28-415a-b8d8-bf76b3206731_320w.webp"/>
<img alt="" className="h-8 w-8 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5b29e34e-9f3d-44f2-b328-fd4771713a34_320w.webp"/>
</div>
...
<img alt="" className="h-8 w-8 rounded-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8dff104c-a210-4477-afa4-4c0d1b81d5ff_320w.webp"/>
</div>
</div>
...
<img alt="" className="h-5 w-5 sm:h-6 sm:w-6 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/95de6b39-0881-4e57-a835-d5b11821be6f_320w.webp"/>
<img alt="" className="h-5 w-5 sm:h-6 sm:w-6 rounded-full ring-2 ring-white object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6cece196-f0bf-472f-b752-67bc4ff893c8_320w.webp"/>
</div>
</div>
</div>
...
<h2 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight [animation:fadeSlideIn_0.5s_ease-out_0.2s_both] animate-on-scroll">
              A clear path from chaos to a calm calendar
            </h2>
<p className="mt-4 text-sm sm:text-base text-slate-300 [animation:fadeSlideIn_0.5s_ease-out_0.3s_both] animate-on-scroll">
              We audit, auto-schedule, and align your team so everyone gets more
              focus time and fewer conflicts.
            </p>
</div>
...
<div className="flex -space-x-2">
<img alt="" className="ring-2 ring-slate-800 w-7 h-7 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/bb8589c5-e897-4621-8d44-3d8f2ce3fccc_320w.webp"/>
<img alt="" className="w-7 h-7 object-cover ring-slate-800 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5b29e34e-9f3d-44f2-b328-fd4771713a34_320w.webp"/>
<img alt="" className="w-7 h-7 object-cover ring-slate-800 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b432539e-c2e6-4226-b552-a6f99c1c3465_320w.webp"/>
</div>
...
<img alt="People collaborating in a calm session" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7aa6b155-1e13-43fb-80d9-eb5c31d2bfef_1600w.webp"/>
</figure>
</div>
...
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">Mobile &amp; desktop apps</span>
</li>
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">1 time zone</span>
</li>
</ul>
</div>
...
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">Team review &amp; approval</span>
</li>
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">12 time zones</span>
</li>
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">Analytics &amp; insights</span>
</li>
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">99.99% SLA</span>
</li>
<li className="flex items-start gap-3">
<svg className="h-5 w-5 text-slate-900 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span className="text-slate-600">On-premise deployment option</span>
</li>
</ul>
</div>
</div>
...
<div className="flex -space-x-2">
<img alt="" className="w-8 h-8 object-cover ring-slate-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9e6e6cbe-3fd8-4ddf-8c83-5b3cf071500e_320w.webp"/>
<img alt="" className="w-8 h-8 object-cover ring-slate-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/288eb1de-b7ea-4a25-8a5c-dee0646f850d_320w.webp"/>
<img alt="" className="ring-2 ring-slate-900 w-8 h-8 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/097da8f2-4a13-4733-9db6-7ec925c5b913_320w.webp"/>
</div>
<div>
...
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Pricing</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Changelog</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Roadmap</a></li>
</ul>
</div>
...
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Careers</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Press</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Contact</a></li>
</ul>
</div>
...
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Help Center</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Community</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Status</a></li>
</ul>
</div>
...
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Security</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">Compliance</a></li>
<li><a className="text-slate-600 hover:text-slate-900 transition" href="#">GDPR</a></li>
</ul>
</div>
</div>

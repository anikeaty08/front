...
<span className="font-heading font-bold text-2xl tracking-tighter uppercase leading-none mt-1">SETOR<span className="text-acid">.</span>ZERO</span>
</a>
...
<a className="font-heading font-semibold text-lg uppercase tracking-wide hover:text-acid transition-colors" href="#">Visão</a>
<a className="font-heading font-semibold text-lg uppercase tracking-wide hover:text-acid transition-colors" href="#">Tecnologia</a>
<a className="font-heading font-semibold text-lg uppercase tracking-wide hover:text-acid transition-colors" href="#">Agentes</a>
<a className="font-heading font-semibold text-lg uppercase tracking-wide text-acid" href="#">Atualizações</a>
</nav>
...
<div className="bg-acid text-black px-2 py-0.5 text-[10px] font-mono font-bold uppercase tracking-widest">Transmissão Recebida</div>
<div className="text-zinc-500 text-[10px] font-mono uppercase tracking-widest">Código: 882-X</div>
</div>
<h1 className="font-heading font-bold text-7xl md:text-[9rem] leading-[0.85] tracking-tighter uppercase text-white mb-8 mix-blend-overlay">
                        Silencie<br/>O<br/><span className="text-transparent stroke-text" style={{WebkitTextStroke: '2px white'}}>Ruído</span>
</h1>
...
<p className="text-lg md:text-xl text-zinc-300 max-w-xl font-medium leading-snug">
                            Não somos apenas sobreviventes. Somos arquitetos do novo silêncio. Junte-se ao protocolo de extração antes que o setor entre em colapso.
                        </p>
...
<span className="font-mono text-xs font-bold uppercase tracking-widest">Nossa Missão</span>
</div>
...
<h2 className="font-heading font-black text-6xl md:text-8xl lg:text-9xl uppercase leading-[0.85] tracking-tighter mb-8">
                            Não apenas <br/>sobrevivemos.<br/>Nós tomamos <br/>de volta.
                        </h2>
<p className="font-medium text-xl md:text-2xl leading-tight max-w-2xl border-l-4 border-black pl-6">
                            Setor Zero é um jogo de tiro de extração PVP onde sua respiração é o único relógio que importa. A colônia está perdida, mas os recursos permanecem. 
                        </p>
</div>
</div>
</div>
...
<span className="font-heading font-black text-[12rem] leading-none uppercase">Garanta o Recurso // Não Deixe Rastros //</span>
<span className="font-heading font-black text-[12rem] leading-none uppercase">Garanta o Recurso // Não Deixe Rastros //</span>
</div>
</div>
</section>
...
<span>Velocidade_Leitura: 40ms</span>
<span>//</span>
<span>Tamanho_Dados: 24TB</span>
</div>
</div>
...
<h3 className="font-heading font-bold text-3xl uppercase tracking-wide text-white mb-4">Você É O Caçador</h3>
<p className="text-zinc-400 leading-relaxed text-sm mb-8">
                            Cada sombra contém uma ameaça. Use escâneres ambientais avançados para rastrear assinaturas de calor e batimentos cardíacos. O silêncio é sua arma principal.
                        </p>
...
<h3 className="font-heading font-bold text-3xl uppercase tracking-wide text-white mb-4">Ou A Presa</h3>
<p className="text-zinc-400 leading-relaxed text-sm mb-8">
                            A IA da colônia se rebelou. Sistemas de defesa automatizados e outros corredores querem o que você tem. A extração nunca é garantida.
                        </p>
<ul className="space-y-2 border-t border-white/10 pt-6">
<li className="flex items-center gap-2 text-xs font-mono text-zinc-500 uppercase">
<iconify-icon className="text-acid" icon="solar:check-read-linear"></iconify-icon>
                                Táticas de Enxame de IA
                            </li>
<li className="flex items-center gap-2 text-xs font-mono text-zinc-500 uppercase">
<iconify-icon className="text-acid" icon="solar:check-read-linear"></iconify-icon>
                                Rivalidade Dinâmica
...
<h3 className="font-heading font-bold text-3xl uppercase tracking-wide text-white mb-4">Garanta A Carga</h3>
<p className="text-zinc-400 leading-relaxed text-sm mb-8">
                            Artefatos são pesados e se degradam com o tempo. Gerencie seu oxigênio, peso no inventário e vigor para alcançar o ponto de extração.
                        </p>
<ul className="space-y-2 border-t border-white/10 pt-6">
<li className="flex items-center gap-2 text-xs font-mono text-zinc-500 uppercase">
<iconify-icon className="text-acid" icon="solar:check-read-linear"></iconify-icon>
...
<button className="py-5 font-heading text-lg font-bold uppercase tracking-wide text-acid border-b-2 border-acid whitespace-nowrap">Registro de Transmissão</button>
<button className="py-5 font-heading text-lg font-bold uppercase tracking-wide text-zinc-500 hover:text-white transition-colors border-b-2 border-transparent whitespace-nowrap">Diário de Dev</button>
<button className="py-5 font-heading text-lg font-bold uppercase tracking-wide text-zinc-500 hover:text-white transition-colors border-b-2 border-transparent whitespace-nowrap">Arquivos de História</button>
</div>

<div className="flex items-center border-t md:border-t-0 md:border-l border-white/10 h-full">
<div className="relative group h-full">
<input className="w-full md:w-72 bg-transparent border-none text-xs font-mono text-white placeholder-zinc-600 focus:ring-0 px-6 py-5 uppercase outline-none h-full" placeholder="PESQUISAR BANCO DE DADOS..." type="text"/>
...
<h3 className="font-heading font-bold text-3xl uppercase leading-none text-zinc-100 mb-4 group-hover:text-acid transition-colors">
                            Análise de Telemetria de Armas
                        </h3>
<p className="text-sm text-zinc-400 leading-relaxed mb-8 flex-grow">
                            Ajustando os padrões de recuo com base no feedback da comunidade. O novo modelo balístico introduz propagação variável...
                        </p>
...
<span className="text-xs font-bold uppercase tracking-wider">Acessar Dados</span>
...
<h3 className="font-heading font-bold text-3xl uppercase leading-none text-zinc-100 mb-4 group-hover:text-acid transition-colors">
                            Artefatos da Colônia
                        </h3>
<p className="text-sm text-zinc-400 leading-relaxed mb-8 flex-grow">
                            Discos de dados recuperados sugerem um propósito secundário para o posto avançado em Tau Ceti. Fragmentos criptografados revelam...
                        </p>
<a className="inline-flex items-center justify-between w-full p-3 border border-zinc-800 bg-black/20 hover:bg-acid hover:text-black hover:border-acid transition-all group/btn" href="#">
<span className="text-xs font-bold uppercase tracking-wider">Acessar Dados</span>
<iconify-icon icon="solar:arrow-right-up-linear" width="16"></iconify-icon>
...
<h3 className="font-heading font-bold text-3xl uppercase leading-none text-zinc-100 mb-4 group-hover:text-acid transition-colors">
                            Hotfix: Oclusão de Áudio
                        </h3>
<p className="text-sm text-zinc-400 leading-relaxed mb-8 flex-grow">
                            Corrigindo os problemas de áudio espacial perto do núcleo do reator. Os passos agora são ocluídos corretamente pelas portas blindadas.
                        </p>
<a className="inline-flex items-center justify-between w-full p-3 border border-zinc-800 bg-black/20 hover:bg-acid hover:text-black hover:border-acid transition-all group/btn" href="#">
<span className="text-xs font-bold uppercase tracking-wider">Acessar Dados</span>
<iconify-icon icon="solar:arrow-right-up-linear" width="16"></iconify-icon>
...
<h4 className="font-heading font-bold text-2xl uppercase tracking-tight text-white mb-2">Setor Zero</h4>
<p className="text-xs text-zinc-500 mb-6 font-mono">
                            NÓ DE TRANSMISSÃO UESC<br/>
                            CANAL SEGURO: #9942
                        </p>
</div>
<div>
<ul className="space-y-4 font-heading font-bold text-xl uppercase tracking-wide">
<li><a className="text-white hover:text-acid transition-colors" href="#">O Jogo</a></li>
<li><a className="text-white hover:text-acid transition-colors" href="#">Mídia</a></li>
<li><a className="text-white hover:text-acid transition-colors" href="#">Notícias</a></li>
<li><a className="text-white hover:text-acid transition-colors" href="#">Loja</a></li>
</ul>
</div>
<div>
<ul className="space-y-4 font-heading font-bold text-xl uppercase tracking-wide">
<li><a className="text-zinc-500 hover:text-white transition-colors" href="#">Carreiras</a></li>
<li><a className="text-zinc-500 hover:text-white transition-colors" href="#">Suporte</a></li>
<li><a className="text-zinc-500 hover:text-white transition-colors" href="#">Kit de Imprensa</a></li>
</ul>
</div>
<div className="col-span-1">
<p className="text-xs font-bold uppercase tracking-widest text-white mb-4">Mantenha-se Informado</p>
<div className="flex">
<input className="bg-zinc-900 border-none text-white text-xs px-4 py-3 w-full focus:ring-1 focus:ring-acid font-mono" placeholder="ENDEREÇO DE E-MAIL" type="email"/>

          ...
          !function(){if(!window.UnicornStudio){window.UnicornStudio={isInitialized:!1};var i=document.createElement("script");i.src="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.34/dist/unicornStudio.umd.js",i.onload=function(){window.UnicornStudio.isInitialized||(UnicornStudio.init(),window.UnicornStudio.isInitialized=!0)},(document.head || document.body).appendChild(i)}}();
                  ...
                  document.addEventListener("DOMContentLoaded", function() {
                    const initChart = () => {
                      ...
                      const canvas = document.getElementById('seoTrafficChart');
                      if (!canvas) return;
                      ...
                      new Chart(ctx, {
                        ...
                        data: {
                          ...
                          datasets: [{
                            ...
                            data: [42000, 45000, 48000, 58000, 72000, 85000, 115000, 145000],
                            borderColor: '#f97316',
                          ...
                          },
                          {
                            ...
                            data: [40000, 41000, 42000, 41500, 43000, 42500, 44000, 45000],
                            borderColor: '#525252',
                            borderWidth: 1,
                            borderDash: [5, 5],
                            pointRadius: 0,
                        ...
                        options: {
                          ...
                          plugins: {
                            ...
                            tooltip: {
                              ...
                              titleFont: { family: 'ui-sans-serif, system-ui, sans-serif' },
                          ...
                          scales: {
                            y: {
                              ...
                              ticks: { color: '#737373', maxTicksLimit: 5, callback: function(value) { return value / 1000 + 'k'; } }
                            },
                            x: {
                              grid: { display: false },
                              ticks: { color: '#737373' }
...
<button className="px-4 py-1.5 text-xs text-neutral-400 hover:text-white transition-colors flex items-center gap-1 font-sans">
          Features
          <svg aria-hidden="true" className="lucide lucide-chevron-down w-3 h-3" data-lucide="chevron-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m6 9 6 6 6-6"></path></svg>
</button>
<a className="px-4 py-1.5 text-xs text-neutral-400 hover:text-white transition-colors font-sans" href="#">
          Resources
        </a>
...
<svg aria-hidden="true" className="lucide lucide-sparkles w-3 h-3 text-orange-400" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
<span className="font-sans">Social Growth, Autopilot Mode</span>
</div>

<h1 className="lg:text-[76px] leading-[1.05] animate-entry delay-150 text-5xl font-light text-white tracking-tight font-bricolage mb-6">SEARCH SALIENCE <span className="inline-flex align-middle mx-1"></span> <br/> SEO EXPERTS <br/> </h1>

<p className="leading-relaxed animate-entry delay-200 text-lg text-neutral-400 font-sans max-w-xl mb-10">At Search Salience, we don't just help you rank; we make you impossible to ignore. We combine cutting-edge SEO strategy with Generative Search Optimisation (GSO) to ensure your brand dominates both traditional search and the AI-powered answers shaping the future of discovery. More visibility. More authority. More growth.</p>
...
<div className="lg:col-span-5 flex lg:justify-end lg:mt-0 z-10 animate-entry delay-500 mt-0 relative justify-center">
...
<span className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-200 to-orange-400 font-bricolage font-light tracking-tight">
                  +842%
                </span>
...
<button className="hover:brightness-110 transition-all text-sm text-white font-sans bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 w-full border-white/20 rounded-full border-t mb-8 pt-3 pb-3 shadow-[0_4px_15px_rgba(249,115,22,0.4)]">
              Analyze Trends
            </button>
...
<section className="-mt-4 lg:-mt-8 animate-entry delay-700 [animation:animationIn_0.8s_ease-out_0.1s_both] animate-on-scroll lg:px-0 max-w-7xl mr-auto ml-auto pt-0 pr-2.5 pb-24 pl-2.5 relative">
...
<svg className="lucide lucide-activity text-orange-500" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
</svg>
                Salience OS
              </a>
<span className="opacity-40 font-sans">/</span>
<span className="text-white font-sans">SEO Performance</span>
...
<input className="bg-transparent text-sm text-zinc-300 placeholder-zinc-600 focus:outline-none w-48 font-sans" placeholder="Search keywords, pages..." type="text"/>
</div>
...
<svg className="lucide lucide-layout-grid text-orange-400" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<li>
<a className="flex items-center gap-2 px-2 py-2 rounded-md text-sm text-neutral-400 hover:text-white hover:bg-white/5 transition-colors font-sans" href="#">
<svg className="lucide lucide-link" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<li>
<a className="flex items-center gap-2 px-2 py-2 rounded-md text-sm text-neutral-400 hover:text-white hover:bg-white/5 transition-colors font-sans" href="#">
<svg className="lucide lucide-target" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-3">
<h3 className="text-white text-2xl font-bricolage font-light tracking-tight">
                      Search Visibility
                    </h3>
<span className="text-[11px] rounded-md bg-green-500/10 text-green-400 ring-1 ring-green-500/20 px-2 py-0.5 uppercase font-sans">
                      Surging
                    </span>
</div>
...
<div className="mt-2 text-sm text-neutral-400 font-sans">
                  Organic traffic and keyword rankings are increasing across key clusters •
...
<div className="px-4 sm:px-6 py-6 space-y-4 flex-grow overflow-y-auto">

<div className="rounded-xl ring-1 ring-white/10 bg-white/[0.02] p-4">
<div className="flex items-center justify-between mb-2">
<div className="text-sm text-white font-sans">Organic Traffic Growth</div>
<div className="flex gap-3">
<div className="flex items-center gap-1 text-xs text-orange-400 font-sans">
...
<canvas height="384" id="seoTrafficChart" style={{display: 'block', boxSizing: 'border-box', height: '192px', width: '410px'}} width="820"></canvas>
</div>
</div>
...
<div className="text-xs text-neutral-500 mt-0.5 font-sans">
                          Top 3 positions secured • 12 new featured snippets
                        </div>
</div>
</div>
<span className="text-[10px] rounded-md bg-green-500/10 text-green-400 ring-1 ring-green-500/20 px-2 py-0.5 font-sans">
                      RANKING UP
                    </span>
</div>
<div className="mt-4 bg-black/40 rounded-lg ring-1 ring-white/5 p-3 font-mono text-xs">
<div className="grid grid-cols-1 gap-y-3">
<div className="flex justify-between items-center text-neutral-400 font-sans">
<span className="text-white">"generative search optimization"</span>
<div className="flex items-center gap-4">
<span>Vol: 12.5k</span>
<span className="text-green-400 flex items-center gap-1 w-20 justify-end">
<svg className="lucide lucide-trending-up" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex justify-between items-center text-neutral-400 font-sans">
<span className="text-white">"enterprise seo platform"</span>
<div className="flex items-center gap-4">
<span>Vol: 8.2k</span>
<span className="text-green-400 flex items-center gap-1 w-20 justify-end">
<svg className="lucide lucide-trending-up" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex justify-between items-center text-neutral-400 font-sans">
<span className="text-white">"ai content strategies"</span>
<div className="flex items-center gap-4">
<span>Vol: 18.1k</span>
<span className="text-green-400 flex items-center gap-1 w-20 justify-end">
<svg className="lucide lucide-trending-up" fill="none" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<div className="text-xs text-neutral-500 mt-0.5 font-sans">
                          Batch #412 • 15,000 URLs • Checking for Core Web Vitals
                        </div>
</div>
</div>
...
<p className="text-sm text-neutral-300 leading-relaxed font-sans">
                    Syncing live with Google Search Console and Analytics. Index status is healthy.
                  </p>
...
<span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-white/5 ring-1 ring-white/10 text-white/80 hover:bg-white/10 hover:text-white transition-colors">
<svg className="lucide lucide-bar-chart" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-white/5 ring-1 ring-white/10 text-white/80 hover:bg-white/10 hover:text-white transition-colors">
<svg className="lucide lucide-globe" fill="none" height="14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10"></circle>
...
<blockquote className="text-xl md:text-2xl leading-relaxed text-neutral-200 mb-10 relative z-10 font-bricolage font-light tracking-tight transition-opacity duration-300" id="t-quote">
...
<svg aria-hidden="true" className="lucide lucide-zap w-6 h-6 fill-white/20" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg>
...
<svg aria-hidden="true" className="lucide lucide-rocket w-6 h-6 text-neutral-500 group-hover:text-white transition-colors" data-lucide="rocket" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09"></path><path d="M9 12a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.4 22.4 0 0 1-4 2z"></path><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 .05 5 .05"></path></svg>
</button>
...
<span className="text-3xl text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-200 to-orange-400 font-bricolage font-light tracking-tight" id="plan-price">
                    $29.00
                  </span>
...
<button className="w-full py-4 rounded-full bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 hover:brightness-110 text-white transition-all shadow-[0_8px_30px_-5px_rgba(249,115,22,0.4)] flex items-center justify-center gap-2 group/btn relative z-10 hover:shadow-[0_8px_40px_-5px_rgba(249,115,22,0.6)] border-t border-white/20 font-sans" id="plan-cta">
                Start Growing
                <svg aria-hidden="true" className="lucide lucide-arrow-right-circle w-5 h-5 text-white/80 transition-transform group-hover/btn:translate-x-1" data-lucide="arrow-right-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m12 16 4-4-4-4"></path><path d="M8 12h8"></path></svg>
</button>
</div>
</div>
</div>
...
<h2 className="text-2xl md:text-3xl text-white mb-3 font-bricolage font-light tracking-tight">
          Join our newsletter
        </h2>

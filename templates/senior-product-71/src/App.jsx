...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
            ...
            cards.forEach(card => {
                ...
                card.addEventListener('mousemove', (e) => {
                    ...
                    animationFrameId = requestAnimationFrame(() => {
                        ...
                        // Scale Logic: Check if card is currently focused (scroll-focus)
                        const isFocused = card.classList.contains('scroll-focus');
                        // HOVER EFFECT: Scale up significantly (1.02) when hovering (mousemove active)
                        const scaleVal = 1.02;
                ...
                card.addEventListener('mouseleave', () => {
                    ...
                    // Remove inline transform so CSS class (scroll-focus) can take effect if present
      ...
      (function(){
        ...
        const sections=['heroSection','work','about'];
        ...
        function update(){
          ...
          for(const id of sections){
            ...
            if(el && scroll >= (el.offsetTop - window.innerHeight/2.5)){
              current=id;
            }
          }
          if((window.innerHeight + scroll) >= document.body.offsetHeight - 50){
            current='about';
          }

          links.forEach(link => {
            const href = link.getAttribute('href');
            const linkId = href === '#' ? 'heroSection' : href.substring(1);

            if(linkId === current){
              link.classList.remove('text-neutral-600', 'hover:bg-[#44588C]');
              link.classList.add('nav-active');
            } else {
              link.classList.add('text-neutral-600', 'hover:bg-[#44588C]');
...
<main className="grid grid-cols-1 gap-10 md:p-8 z-10 w-full max-w-[1800px] pt-4 pr-4 pb-24 pl-4 relative">
...
<canvas className="w-full h-full opacity-40" height="455" id="waveCanvas" width="1697"></canvas>
</div>

<div className="card-glare"></div>

<div className="relative z-10 pointer-events-none pl-2 flex flex-col justify-center max-w-7xl">

<div className="parallax-layer-3 animate-enter flex items-center gap-3 mb-8 pointer-events-auto" style={{transform: 'translateZ(60px)', transition: 'transform 0.6s cubic-bezier(0.2, 0.8, 0.2, 1)'}}>
...
<span className="md:text-sm text-xs font-medium text-neutral-700">
                Product Designer
              </span>
...
<h1 className="parallax-layer-2 text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight leading-[0.95] font-sans mb-8 text-balance drop-shadow-sm" style={{transform: 'translateZ(40px)', transition: 'transform 0.6s cubic-bezier(0.2, 0.8, 0.2, 1)'}}>
<span className="block animate-enter delay-100 pb-2">
<span className="animate-diffuse-text">Taming Chaos</span>
</span>
<span className="block animate-enter delay-200 mt-2 pb-2">
<span className="animate-diffuse-text pr-2">
                for Enterprise Scale
              </span>
</span>
</h1>
<p className="parallax-layer-1 animate-enter delay-300 leading-relaxed text-balance md:text-2xl pointer-events-auto text-lg font-normal text-neutral-700 mb-12 max-w-5xl" style={{transform: 'translateZ(20px)', transition: 'transform 0.6s cubic-bezier(0.2, 0.8, 0.2, 1)'}}>
            I design intelligent systems and intuitive experiences for the
            enterprise. Previously building cloud platforms at
...
<a className="group/btn h-14 px-8 bg-[#0f172a] text-white text-base font-medium transition-all duration-300 hover:scale-[1.03] active:scale-95 flex items-center gap-3 hover:bg-[#020617] shadow-xl shadow-[#44588C]/10 cursor-pointer rounded-lg relative overflow-hidden ring-1 ring-white/10" href="#work">
<span className="z-10 relative">See Case Studies</span>
<div className="group-hover/btn:opacity-100 transition-opacity duration-500 ease-out bg-gradient-to-r from-[#72A29D] to-[#44588C] opacity-0 absolute top-0 right-0 bottom-0 left-0"></div>
...
<line className="" x1="12" x2="12" y1="5" y2="19"></line>
...
<div className="">
<h3 className="text-2xl font-bold text-neutral-900 tracking-tight leading-tight mb-2 group-hover-gradient-text transition-all">
                  Azure Machine Config
                </h3>
<p className="leading-relaxed line-clamp-2 font-normal text-neutral-500 text-sm">
...
<span className="inline-flex items-center transition-colors hover:bg-neutral-200 hover:text-neutral-900 text-xs font-medium text-neutral-600 bg-neutral-100 rounded-md pt-1 pr-2.5 pb-1 pl-2.5">
...
<div className="">
<h3 className="leading-tight group-hover-gradient-text transition-all text-2xl font-bold text-neutral-900 tracking-tight mb-2" style={{}}>
...
<div className="">
<h3 className="leading-tight group-hover-gradient-text transition-all text-2xl font-bold text-neutral-900 tracking-tight mb-2">
...
<div className="main-section md:px-8 md:pt-8 md:pb-4 flex flex-col overflow-hidden group/exp backdrop-saturate-200 hover:shadow-[0_25px_50px_-10px_rgba(0,0,0,0.15),inset_0_0_40px_rgba(255,255,255,0.8)] transition-all duration-500 bg-gradient-to-br from-white/60 via-white/40 to-white/20 h-fit border-white/60 border rounded-xl pt-6 pr-6 pb-3 pl-6 relative shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1),inset_0_0_30px_rgba(255,255,255,0.7)] backdrop-blur-3xl">
<div className="absolute inset-0 rounded-xl pointer-events-none shadow-[inset_0_1px_0_0_rgba(255,255,255,0.7),inset_0_0_20px_0_rgba(255,255,255,0.1)]"></div>
<div className="tech-corner corner-tl"></div>
<div className="tech-corner corner-tr"></div>
<div className="tech-corner corner-bl"></div>
<div className="tech-corner corner-br"></div>
<div className="flex z-10 mb-4 relative items-center justify-between">
<h2 className="md:text-2xl text-2xl font-bold text-neutral-900 tracking-tight">
              Experience
            </h2>
<a aria-label="Resume" className="hover:bg-neutral-100 hover:text-[#44588C] transition-colors text-neutral-400 rounded-full pt-2 pr-2 pb-2 pl-2" href="#">
<svg className="lucide lucide-download w-[20px] h-[20px] text-slate-900" data-icon-replaced="true" data-icon-set="lucide" data-lucide="download" fill="none" height="26" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.25" style={{width: '20px', height: '20px'}} viewbox="0 0 24 24" width="26" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex flex-col z-10 pl-2 relative" style={{position: 'relative', zIndex: '10'}}>
<div className="group/job relative pl-6 pb-0 border-l-2 border-neutral-100 border-gradient-hover transition-colors duration-300">
<span className="absolute -left-[6px] top-3 h-2.5 w-2.5 rounded-full bg-[#72A29D] ring-4 ring-white shadow-sm z-10 transition-all duration-300 group-hover/job:scale-125 group-hover/job:ring-[#72A29D]/20">
<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#72A29D] opacity-75"></span>
</span>
<div className="flex flex-col cursor-default py-0.5">
<div className="flex justify-between items-baseline mb-0.5">
<h3 className="group-hover-gradient-text transition-all text-lg font-bold text-neutral-900 tracking-tight">
                    Microsoft
                  </h3>
...
<span className="text-neutral-800 font-bold block mb-2 text-xs uppercase tracking-wide group-hover/subitem:text-[#44588C] transition-colors">
...
<span className="block mb-1.5 pl-2 border-l-2 border-neutral-200 group-hover/subitem:border-[#44588C]/50">
...
<span className="block pl-2 border-l-2 border-neutral-200 group-hover/subitem:border-[#44588C]/50">
...
<div className="group/job relative pl-6 pb-0 border-l-2 border-neutral-100 border-gradient-hover transition-colors duration-300">
<span className="absolute -left-[6px] top-3 h-2.5 w-2.5 rounded-full bg-neutral-300 ring-4 ring-white group-hover/job:bg-[#72A29D] transition-all duration-300 z-10 group-hover/job:scale-125 group-hover/job:ring-[#72A29D]/20"></span>
<div className="flex flex-col cursor-default py-0.5">
<div className="flex justify-between items-baseline mb-0.5">
<h3 className="group-hover-gradient-text transition-all text-lg font-bold text-neutral-900 tracking-tight">
                    SAP
...
<div className="group/job relative pl-6 pb-0 border-l-2 border-transparent transition-colors duration-300 border-gradient-hover">
<div className="absolute -left-[2px] top-0 w-[2px] h-[34px] bg-neutral-100 group-hover/job:bg-[#72A29D] transition-colors duration-300"></div>
<span className="absolute -left-[6px] top-3 h-2.5 w-2.5 rounded-full bg-neutral-300 ring-4 ring-white group-hover/job:bg-[#72A29D] transition-all duration-300 z-10 group-hover/job:scale-125 group-hover/job:ring-[#72A29D]/20"></span>
<div className="flex flex-col cursor-default py-0.5">
<div className="flex justify-between items-baseline mb-0.5">
<h3 className="group-hover-gradient-text transition-all text-lg font-bold text-neutral-900 tracking-tight">
...
<div className="group-hover/job:opacity-100 transition-opacity duration-200 opacity-0 pt-1 pb-1 flex flex-col gap-1">
<div className="group/subitem relative p-4 -mx-4 rounded-xl transition-all duration-300 cursor-default border border-transparent hover:bg-neutral-50 hover:shadow-[0_2px_10px_-2px_rgba(0,0,0,0.05),inset_0_0_0_1px_rgba(0,0,0,0.02)] hover:ring-0 hover:z-20">
<span className="block uppercase group-hover/subitem:text-[#44588C] transition-colors text-xs font-bold text-neutral-800 tracking-wide mb-2" style={{}}>
                          AI Product
                        </span>
<div className="text-sm font-medium text-neutral-900 group-hover/subitem:text-black transition-colors">
<span className="block mb-1.5 pl-2 border-l-2 border-neutral-200 group-hover/subitem:border-[#44588C]/50">
...
<a className="nav-link hover:text-white transition-all duration-300 text-sm font-semibold rounded-full pt-2 pr-4 pb-2 pl-4 nav-active" href="#">
          Home
        </a>
<a className="nav-link px-4 py-2 text-sm font-semibold hover:text-white rounded-full transition-all duration-300 text-neutral-600 hover:bg-[#44588C]" href="#work">
          Work
        </a>
<a className="nav-link px-4 py-2 text-sm font-semibold hover:text-white rounded-full transition-all duration-300 text-neutral-600 hover:bg-[#44588C]" href="#about">
          About
        </a>
<div className="w-px h-5 mx-1 bg-neutral-300"></div>
<div className="flex items-center gap-2">

<a className="group/social p-2.5 rounded-full hover:bg-[#44588C] hover:text-white border border-transparent transition-all duration-300" href="https://linkedin.com" target="_blank">
...
<button className="group/social p-2.5 rounded-full hover:bg-[#44588C] hover:text-white border border-transparent transition-all duration-300" onclick="copyEmail()">
<svg className="transition-colors text-neutral-600 group-hover/social:text-white" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">

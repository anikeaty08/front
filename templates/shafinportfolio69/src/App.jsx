...
<div className="aura-background-component fixed top-0 w-full h-screen -z-10 opacity-50" data-alpha-mask="71" style={{maskImage: 'linear-gradient(to bottom, transparent, black 0%, black 71%, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, transparent, black 0%, black 71%, transparent)'}}><div className="absolute inset-0 -z-10" id="particles-js">


<canvas className="particles-js-canvas-el" height="883" style={{width: '100%', height: '100%'}} width="1370"></canvas></div></div>

<div className="fixed top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[400px] bg-white/[0.03] blur-[100px] rounded-full pointer-events-none -z-10"></div>
...
<div className="flex group-hover:scale-90 transition-transform duration-300 text-xs font-bold w-5 h-5 rounded-full items-center justify-center text-black bg-white">s
</div>
<span className="" style={{}}>Shafin</span>
</a>
...
<p className="sm:text-xl leading-relaxed text-lg font-light max-w-2xl mb-10 text-stone-400" style={{}}>I'm shafin a multidisciplinary designer focused on building accessible, human-centered interfaces for the next generation of web applications.</p>
...
<section className="border-y bg-white/[0.01] border-white/5">
...
<p className="text-sm text-stone-500">
              A curation of projects from 2021-2024
            </p>
</div>
...
<div className="">
<h3 className="text-lg font-medium tracking-tight group-hover:text-stone-200 transition-colors text-white">
                  Chronos Finance
                </h3>
...
<h2 className="text-2xl font-medium tracking-tight mb-12 text-white">
          Expertise
        </h2>
...
<p className="text-sm text-stone-500 leading-relaxed font-light">
              Creating pixel-perfect, aesthetic user interfaces with a focus on
              usability, typography, and motion details.
            </p>
</div>
...
<p className="text-sm text-stone-500 leading-relaxed font-light">
              Translating designs into clean, semantic code using React,
              Tailwind CSS, and modern frontend frameworks.
            </p>
</div>
...
<p className="text-sm text-stone-500 leading-relaxed font-light">
              Building scalable component libraries and documentation to ensure
...
<h2 className="text-4xl sm:text-5xl font-medium tracking-tighter mb-6 text-white">
          Ready to collaborate?
        </h2>
<p className="text-lg text-stone-500 mb-10 font-light">
          I'm currently available for freelance projects and open to full-time
          opportunities.
        </p>
<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
<a className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-sm font-medium transition-colors bg-white text-black hover:bg-stone-200" href="mailto:hello@alex.design">
            Start a Project
          </a>
<a className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-sm font-medium border transition-colors text-white border-white/10 hover:bg-white/5" href="#">
            Schedule Call
          </a>
</div>
</section>
...
<div className="w-4 h-4 rounded-full flex items-center justify-center text-[8px] font-bold bg-stone-800 text-white">
            a
          </div>
<span className="text-sm text-stone-500" style={{}}>© 2026 Shafin. All rights reserved.</span>
</div>

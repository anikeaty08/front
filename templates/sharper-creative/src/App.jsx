...
<a className="inline-flex items-center justify-center bg-center mix-blend-screen w-[60px] h-[60px] bg-[url(https://cdn.midjourney.com/3f5c16da-080f-427f-a80d-ee75c8f5a173/0_0.png?w=800&amp;q=80)] bg-cover rounded invert" href="#"></a>
</div>
...
<input className="placeholder-white/40 outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20 transition xl:bg-gray-950 text-sm text-white bg-black/70 w-full h-10 border-gray-800 border rounded-xl pr-10 pl-10 backdrop-blur" placeholder="Search documentation..." type="text"/>
<div className="absolute left-3 inset-y-0 flex items-center pointer-events-none text-white/50">
<svg className="lucide lucide-search w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<svg className="lucide lucide-menu w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 5h16"></path>
...
<input className="w-full h-10 pr-10 pl-10 rounded-xl border backdrop-blur placeholder-white/40 text-sm outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20 transition border-white/5 bg-black/70 text-white" placeholder="Search documentation..." type="text"/>
<div className="absolute left-3 inset-y-0 flex items-center pointer-events-none text-white/50">
<svg className="lucide lucide-search w-4 h-4" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m21 21-4.34-4.34"></path>
<circle cx="11" cy="11" r="8"></circle>
...
<a className="inline-flex items-center gap-2 transition min-w-[120px] justify-center hover:bg-white/10 hover:text-white font-normal text-white/70 bg-white/5 border-white/10 border rounded-xl pt-[12px] pr-[20px] pb-[12px] pl-[20px]" href="#demo">
              Watch demo
...
<line className="" x1="21" x2="14" y1="4" y2="4"></line>
<line x1="10" x2="3" y1="4" y2="4"></line>
<line x1="21" x2="12" y1="12" y2="12"></line>
<line className="" x1="8" x2="3" y1="12" y2="12"></line>
<line x1="21" x2="16" y1="20" y2="20"></line>
<line x1="12" x2="3" y1="20" y2="20"></line>
<circle cx="12" cy="4" r="2"></circle>
<circle className="" cx="8" cy="12" r="2"></circle>
...
<svg className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m21 21-4.34-4.34"></path>
<circle cx="11" cy="11" r="8"></circle>
</svg>
<input className="text-[15px] placeholder-gray-500 outline-none ring-inset focus:ring-gray-700 text-gray-200 bg-gray-900/70 w-full ring-gray-800 ring-1 rounded-xl pt-3 pr-48 pb-3 pl-10" placeholder="Search 1302 components..." type="text"/>
...
<button className="inline-flex ring-inset hover:text-white hover:ring-gray-700 transition text-sm font-medium text-gray-200 bg-gray-900 ring-gray-800 ring-1 rounded-xl pt-2 pr-3 pb-2 pl-3 gap-x-2 gap-y-2 items-center">
<svg className="h-5 w-5" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path className="" d="m6 8 6 6 6-6"></path>
</svg>
                  Recommended
                </button>
</div>
...
<img alt="Shiny CTA preview" className="h-full w-full object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d98c7990-66a7-4e51-b746-3e37a1d353ba_800w.webp"/>
</div>
...
<img alt="Author" className="ring-1 ring-gray-800 w-6 h-6 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/71ad0e95-131b-49d0-b467-355dc7813bbb_320w.webp"/>
...
<img alt="Gradient CTA preview" className="h-full w-full object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/05c76ddb-2184-4dd8-8e7d-3465ddde84ea_800w.webp"/>
</div>
...
<div className="mt-4 flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="Author" className="ring-1 ring-neutral-800 w-6 h-6 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/dc0337fb-ed78-4515-a35d-9bf52d6af946_320w.webp"/>
...
<div className="relative">
<div className="aspect-[16/9] overflow-hidden bg-black">
<img alt="Hover CTA" className="transition duration-500 group-hover:scale-[1.02] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/39d6bd74-d7eb-4a3c-afb3-43091ef38e3e_800w.webp"/>
</div>
...
<div className="mt-4 flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="Author" className="ring-1 ring-neutral-800 w-6 h-6 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3e3e1091-f8e8-4022-a02a-fa37a35c59a5_320w.jpg"/>
<span className="text-sm font-medium text-neutral-300">
                    Benjamin Boulanger
                  </span>
</div>
...
<img alt="Dark Hero Section" className="transition duration-500 group-hover:scale-[1.02] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/1ba6f795-44b8-4fb8-8d5e-0e4c4599dc65_800w.webp"/>
</div>
<div className="absolute right-3 top-3">
<span className="rounded-full bg-neutral-100 text-neutral-900 px-2.5 py-1 text-xs font-medium">
                  PRO
...
<div className="relative">
<div className="aspect-[16/9] overflow-hidden bg-black">
<img alt="Aura Background" className="h-full w-full object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b34c34bf-c2b8-4550-af1d-a366851554b1_800w.webp"/>
</div>
<div className="absolute right-3 top-3">
<span className="rounded-full bg-neutral-100 text-neutral-900 px-2.5 py-1 text-xs font-medium">
                  PRO
...
<div className="relative">
<div className="aspect-[16/9] overflow-hidden bg-black">
<img alt="Hover CTA with Glow" className="h-full w-full object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/4df30c23-a097-4c8e-afdf-8e0168abcd6b_800w.webp"/>
</div>
</div>
<div className="p-4">
<h3 className="text-[18px] font-semibold tracking-tight text-white">
...
<div className="mt-4 flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="Author" className="ring-1 ring-neutral-800 w-6 h-6 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8a90d32f-809f-4383-b71f-6a9c50621b69_320w.jpg"/>
<span className="text-sm font-medium text-neutral-300">
                    Megan Lyn
                  </span>
</div>
...
<div className="relative">
<div className="aspect-[16/9] overflow-hidden bg-neutral-950">
<img alt="Marquee Testimonials" className="transition duration-500 group-hover:scale-[1.02] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/103e9b5d-1921-4cd5-a80d-9445881f318d_800w.webp"/>
</div>
</div>
<div className="p-4">
<h3 className="text-[18px] font-semibold tracking-tight text-white">
...
<div className="mt-4 flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="Author" className="ring-1 ring-neutral-800 w-6 h-6 object-cover rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b476201e-4ebc-447a-b9b9-0c7e4e8302a0_320w.jpg"/>
<span className="text-sm font-medium text-neutral-300">
                    Meng To
                  </span>
</div>
...
<div className="relative">
<div className="aspect-[16/9] overflow-hidden bg-white">
<img alt="Market Data Feature" className="transition duration-500 group-hover:scale-[1.02] w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/82781526-4ef8-4653-8d37-243d7194d6e5_800w.webp"/>
</div>
</div>
<div className="p-4">
<h3 className="text-[18px] font-semibold tracking-tight text-white">
...
<div className="mt-4 flex items-center justify-between">
<div className="flex items-center gap-2">
<img alt="Author" className="h-6 w-6 rounded-full object-cover ring-1 ring-neutral-800" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&amp;w=200&amp;auto=format&amp;fit=crop"/>
<span className="text-sm font-medium text-neutral-300">
                    Meng To
                  </span>
</div>
...
<article className="relative overflow-hidden aspect-[4/3] bg-center bg-cover border-white/10 rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/af5c4f11-0653-43c0-b21e-5b8cc085c9f3_800w.jpg)]">
...
<article className="relative overflow-hidden aspect-[4/3] bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/60f49edd-2009-43cf-a12a-d82fd91aae5e_800w.jpg)] bg-cover border-white/10 rounded-2xl">
...
<article className="relative overflow-hidden aspect-[4/5] bg-center bg-cover border-white/10 rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b19e7d3a-309c-4d55-9373-80ca043c0f49_800w.jpg)]">
...
<article className="relative overflow-hidden aspect-[4/5] bg-center bg-cover border-white/10 rounded-2xl bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7df94c66-5d1e-4235-a476-1d2d8881a456_800w.jpg)]">
<div className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/20 to-black/60"></div>
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-white/10 border-white/15 border rounded-full py-1.5 px-1.5 backdrop-blur">
<svg className="h-3.5 w-3.5" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<a className="group relative overflow-hidden ring-1 ring-white/10 bg-neutral-900/60 rounded-3xl shadow-sm backdrop-blur" href="#work">
...
<div className="flex items-center gap-3">
<img alt="Sarah Chen" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&amp;h=200&amp;fit=crop"/>
<div>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Marcus Rodriguez" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&amp;h=200&amp;fit=crop"/>
<div>
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Marcus Rodriguez
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Elena Popova" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&amp;h=200&amp;fit=crop"/>
<div>
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Elena Popova
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="James Park" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&amp;h=200&amp;fit=crop"/>
<div>
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      James Park
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Aria Thompson" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&amp;h=200&amp;fit=crop"/>
<div>
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Aria Thompson
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Luca Martinez" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&amp;h=200&amp;fit=crop"/>
<div className="">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Luca Martinez
                    </h4>
...
<div className="flex flex-col gap-4 sm:gap-5">
<a className="group relative overflow-hidden ring-1 ring-white/10 bg-neutral-900/60 rounded-3xl shadow-sm backdrop-blur" href="#work">
<img alt="Design system" className="h-72 w-full transition-transform duration-500 group-hover:scale-105 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5162c07d-8a65-4a42-9a8c-c48dbea36297_800w.jpg"/>
<div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
<div className="absolute bottom-0 left-0 right-0 p-5">
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Noah Kim" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&amp;h=200&amp;fit=crop"/>
<div className="">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Noah Kim
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Zara Williams" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=200&amp;h=200&amp;fit=crop"/>
<div className="">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Zara Williams
                    </h4>
...
<div className="flex items-center justify-between gap-3 mb-2">
<div className="flex items-center gap-3">
<img alt="Oliver Jensen" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20" src="https://images.unsplash.com/photo-1463453091185-61582044d556?w=200&amp;h=200&amp;fit=crop"/>
<div className="">
<h4 className="text-base sm:text-lg tracking-tight font-medium text-white font-geist">
                      Oliver Jensen
                    </h4>
...
<svg className="lucide lucide-arrow-right relative z-10" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2f563338-39fa-47ea-9761-658d4f3f84db_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/de692cd3-6ed5-40da-b589-663e89889a1c_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/42dfe760-aef6-44a2-bff9-70aa005c5961_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c18d9fac-84d4-4727-95df-38b04c62ac05_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c3e3fffd-33c5-442f-924a-7bc1032b2c0f_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/31996fe3-f9da-42d7-bf65-2cc5d5417271_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5989c16d-4aa3-4351-bfdb-fac959736459_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6c39c735-18f1-4b74-aa61-180fbb2b4770_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6209234e-73ff-4176-bf91-c05fa95cc596_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3f4ec54c-12b4-4eb2-a0c3-1d78cb6c9e02_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8cfa0961-8c53-4d57-b87c-3b8eaffcd08b_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/42f0787e-2f7f-4ae7-9c64-3f1d597bf1b8_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c8701b7a-a3f2-4ad0-95be-f2f027c8e390_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/83ca20c0-64e5-412d-9c79-224a4ae90b74_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c920d31f-46c8-4f39-957b-9a8d8e511a1a_800w.jpg"/>
</div>
</div>
<div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 sm:gap-4 flex-shrink-0 pr-2 sm:pr-4">
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9a421cf7-e975-430b-88c5-f554775493e1_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0c82a12e-5af1-47d3-963d-65c3987dd2be_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e63aa468-ae44-4756-84db-fcacd6cec9e2_800w.jpg"/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="sm:h-28 lg:h-36 w-full h-20 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cf90a7bf-fee3-4a9d-887b-c46bfea61ba8_800w.jpg"/>
</div>
...
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a160135e-dfe8-4d26-b2e5-2915ebe6f3a2_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/9a3ff98a-df58-478d-a4ae-f3c6d3f3ba61_800w.jpg" style={{}}/>
</div>
<div className="rounded-xl sm:rounded-2xl overflow-hidden ring-1 ring-white/10 bg-white/5">
<img alt="Community member" className="w-full h-20 sm:h-28 lg:h-36 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7063bc06-62fe-4811-b5fa-4b1e09b26a81_800w.jpg"/>
</div>
</div>
</div>
</div>
...
<input className="w-full h-10 px-4 rounded-xl border text-sm placeholder-white/40 outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20 backdrop-blur border-white/20 bg-white/10 text-white" placeholder="you@company.com" required="" type="email"/>

...
<nav className="absolute top-0 left-0 right-0 z-50 px-6 md:px-10 py-8 flex justify-between items-start animate-enter delay-500">shreyas
</nav>
...
<p className="text-white/80 text-lg md:text-xl font-light max-w-xl leading-relaxed font-geist mb-10 animate-enter delay-300">
                        The ultimate destination for lunch &amp; dinner in Montréal. Authentic flavors, high ratings, and affordable luxury.
                    </p>
...
<p className="text-stone-500 font-geist leading-relaxed text-lg mb-4">
                            Whether you're dining solo, gathering with a group, or visiting as a tourist, Restaurant Canada Best offers a welcoming atmosphere for everyone.
                        </p>
...
<p className="text-black font-semibold font-jakarta text-sm">Restaurant Canada Best</p>
<p className="text-stone-400 text-xs font-geist mt-0.5">Experience authentic Montréal dining today.</p>
</div>

...
<span className="text-lg font-semibold tracking-tight group-hover:opacity-80 transition-opacity font-nunito" style={{}}>
              Shree Krishna Bakers
            </span>
</a>

<div className="hidden md:flex items-center gap-8 text-sm font-medium text-stone-500">
<a className="hover:text-stone-900 transition-colors font-nunito" href="#about" style={{}}>
              About
            </a>
<a className="hover:text-stone-900 transition-colors font-nunito" href="#menu" style={{}}>
              Menu
            </a>
<a className="hover:text-stone-900 transition-colors font-nunito" href="#faq" style={{}}>
              FAQ
            </a>
<a className="hover:text-stone-900 transition-colors font-nunito" href="#contact" style={{}}>
              Contact
            </a>
</div>

<a className="hidden md:flex items-center gap-2 hover:bg-stone-800 hover:shadow-lg hover:shadow-stone-900/10 transition-all active:scale-95 text-xs font-medium text-white bg-stone-900 rounded-full pt-2 pr-4 pb-2 pl-4" href="https://wa.me/9887900025">
<span className="font-nunito" onclick="window.location.href='http://zoma.to/r/20929909'" role="button">Order Now</span>
...
<a className="whitespace-nowrap hover:text-orange-600 font-nunito" href="#home" style={{}}>
          Home
        </a>
<a className="whitespace-nowrap hover:text-orange-600 font-nunito" href="#about" style={{}}>
          About Us
        </a>
<a className="whitespace-nowrap hover:text-orange-600 font-nunito" href="#menu" style={{}}>
          Full Menu
        </a>
<a className="whitespace-nowrap hover:text-orange-600 font-nunito" href="#contact" style={{}}>
          Locations
        </a>
</div>
</nav>
...
<div className="inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-3 py-1 text-xs font-medium text-orange-700 mb-6 font-nunito" style={{}}>
...
<h1 className="text-4xl md:text-6xl tracking-tight text-stone-900 mb-6 leading-tight font-nunito font-semibold" style={{}}>
          Best Bakery &amp; Cake Shop
          <br className="hidden md:block"/>
          in Jaipur
        </h1>
<p className="text-base md:text-lg text-stone-500 mb-10 max-w-xl mx-auto leading-relaxed font-nunito" style={{}}>
...
<a className="sm:w-auto flex items-center justify-center gap-2 hover:bg-green-700 transition-all hover:shadow-green-200 text-sm font-medium text-white bg-green-600 w-full rounded-lg pt-3 pr-6 pb-3 pl-6 shadow-sm font-nunito" href="http://zoma.to/r/20929909">Order on zomato </a>
<a className="sm:w-auto flex items-center justify-center gap-2 hover:bg-stone-50 hover:border-stone-300 transition-all text-sm font-medium text-stone-700 bg-white w-full border-stone-200 border rounded-lg pt-3 pr-6 pb-3 pl-6 font-nunito" href="https://share.google/OuTrQ8oE4AO1h4OVX">
...
<span className="font-nunito" style={{}}>Made with Love</span>
</div>
</div>
</div>
<div className="order-1 md:order-2">
<h2 className="text-2xl md:text-3xl tracking-tight text-stone-900 mb-4 font-nunito font-semibold" style={{}}>
              About Shree Krishna Bakers
            </h2>
<p className="text-stone-500 mb-6 leading-relaxed font-nunito" style={{}}>
...
<h2 className="text-3xl tracking-tight text-stone-900 mb-3 font-nunito font-semibold" style={{}}>
            Our Menu
          </h2>
<p className="text-stone-500 text-sm max-w-md mx-auto font-nunito" style={{}}>
...
<h3 className="text-lg font-medium text-stone-900 font-nunito" style={{}}>
                Patties
              </h3>
</div>
<ul className="space-y-3">
<li className="flex justify-between items-center text-sm">
<span className="text-stone-700 font-nunito" style={{}}>
                  Aloo Patties
                </span>
<span className="font-medium text-stone-900 font-nunito" style={{}}>
                  ₹20
                </span>
</li>
<li className="flex justify-between items-center text-sm">
...
<span className="ml-auto text-xs font-medium text-rose-600 bg-rose-50 px-2 py-1 rounded font-nunito" style={{}}>
                Custom Available
              </span>
</div>
...
<p className="mt-4 text-xs text-stone-400 italic font-nunito" style={{}}>
...
<h2 className="text-2xl tracking-tight text-stone-900 mb-8 text-center font-nunito font-semibold" style={{}}>
...
<h3 className="font-medium text-stone-800 font-nunito" style={{}}>
...
<p className="mt-3 text-sm text-stone-500 leading-relaxed font-nunito" style={{}}>
...
<div className="">
<h2 className="text-2xl md:text-3xl tracking-tight text-white mb-6 font-nunito font-semibold" style={{}}>
              Visit Shree Krishna Bakers
            </h2>
<p className="mb-8 text-stone-400 font-nunito" style={{}}>
...
<div className="" onclick="window.location.href='https://maps.app.goo.gl/cbVgH8QmhKjtVYt67'" role="button">
<h4 className="text-white font-medium mb-1 font-nunito" style={{}}>
                    Location
                  </h4>
<p className="text-sm cursor-pointer font-nunito" onclick="window.location.href='https://maps.app.goo.gl/u7tBWFjdXaHfYMLT6'" role="button">Jaipur, Rajasthan, India</p>
</div>
</div>
<div className="flex items-start gap-4">
<div className="rounded-full bg-stone-800 p-3 text-white">
...
<p className="text-sm font-nunito" style={{}}>Open Daily</p>
<p className="text-sm font-nunito" style={{}}>Closes at 11:30 PM</p>
</div>
</div>
<div className="flex flex-col sm:flex-row gap-4 pt-4">
<a className="flex items-center justify-center gap-2 hover:bg-stone-200 transition-colors text-sm font-medium text-stone-900 bg-white rounded-lg pt-3 pr-6 pb-3 pl-6 font-nunito" href="/tel:+9887900025">
<iconify-icon icon="solar:phone-calling-linear" width="20"></iconify-icon>
                  Call Now
                </a>
<a className="flex items-center justify-center gap-2 hover:bg-stone-800 transition-colors text-sm font-medium text-white border-stone-700 border rounded-lg pt-3 pr-6 pb-3 pl-6 font-nunito" href="https://wa.me/919887900025">
...
<span className="text-lg font-semibold tracking-tight font-nunito" style={{}}>
                Shree Krishna Bakers
              </span>
</a>
<p className="text-sm leading-relaxed mb-6 font-nunito" style={{}}>
...
<div className="">
<h4 className="text-white font-medium mb-4 font-nunito" style={{}}>
              Explore
            </h4>
<ul className="space-y-3 text-sm">
<li className="">
<a className="hover:text-white transition-colors font-nunito" href="#home" style={{}}>
                  Home
                </a>
</li>
<li className="">
<a className="hover:text-white transition-colors font-nunito" href="#about" style={{}}>
                  About Us
                </a>
</li>
<li className="">
<a className="hover:text-white transition-colors font-nunito" href="#menu" style={{}}>
                  Full Menu
                </a>
</li>
</ul>
...
<ul className="space-y-3 text-sm">
<li className="">
<a className="hover:text-white transition-colors font-nunito" href="#" style={{}}>
                  Custom Cakes
                </a>
</li>
<li className="">
...
<span className="font-nunito">91+988790025</span>
</li>
<li className="flex items-center gap-2">
<iconify-icon className="" icon="solar:letter-linear"></iconify-icon>
<span className="font-nunito" style={{}}>rksharma0888@gmail.com</span>
</li>
</ul>
</div>
</div>

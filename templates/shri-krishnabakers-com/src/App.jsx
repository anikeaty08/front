...
<h1 className="text-4xl md:text-6xl tracking-tight text-stone-900 mb-6 leading-tight font-playfair font-medium" style={{}}>
...
<a className="sm:w-auto flex items-center justify-center gap-2 hover:bg-green-700 transition-all hover:shadow-green-200 text-sm font-medium text-white font-geist bg-green-600 w-full rounded-lg pt-3 pr-6 pb-3 pl-6 shadow-sm" href="https://wa.me/919887900025">
...
<h2 className="text-2xl md:text-3xl tracking-tight text-stone-900 mb-4 font-playfair font-medium" style={{}}>
...
<h2 className="text-3xl tracking-tight text-stone-900 mb-3 font-playfair font-medium" style={{}}>
            Our Menu
          </h2>
...
<h2 className="text-2xl tracking-tight text-stone-900 mb-8 text-center font-playfair font-medium" style={{}}>
...
<div className="">
<h2 className="text-2xl md:text-3xl tracking-tight text-white mb-6 font-playfair font-medium" style={{}}>
...
<p className="text-sm font-geist cursor-pointer" onclick="window.location.href='https://maps.app.goo.gl/u7tBWFjdXaHfYMLT6'" role="button">Jaipur, Rajasthan, India</p>
</div>
</div>
<div className="flex items-start gap-4">
<div className="rounded-full bg-stone-800 p-3 text-white">
...
<a className="flex items-center justify-center gap-2 hover:bg-stone-200 transition-colors text-sm font-medium text-stone-900 font-geist bg-white rounded-lg pt-3 pr-6 pb-3 pl-6" href="/tel:+9887900025">
<iconify-icon icon="solar:phone-calling-linear" width="20"></iconify-icon>
                  Call Now
                </a>
<a className="flex items-center justify-center gap-2 hover:bg-stone-800 transition-colors text-sm font-medium text-white font-geist border-stone-700 border rounded-lg pt-3 pr-6 pb-3 pl-6" href="https://wa.me/919887900025">

...
<span className="text-xl font-semibold tracking-tight">Srihari Chelluri</span>
</a>
...
<a className="hover:text-white transition" href="#portfolio" style={{}}>
                Portfolio
              </a>
<a className="hover:text-white transition" href="#about" style={{}}>About</a>
<a className="hover:text-white transition" href="#services" style={{}}>
                Services
              </a>
<a className="hover:text-white transition" href="#process" style={{}}>Process</a>
<a className="hover:text-white transition" href="#contact" style={{}}>Contact</a>
</nav>
<div className="flex items-center gap-3">
<a className="group inline-flex min-w-[140px] cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:scale-105 border-gradient hover:text-white gap-2 text-sm font-medium text-white/80 tracking-tight bg-white/5 rounded-full pt-3 pr-5 pb-3 pl-5 relative backdrop-blur-xl gap-x-2 gap-y-2 items-center justify-center hidden md:inline-flex" href="#contact" style={{}}>
                Hire Me
...
<a className="text-base text-white/70 hover:text-white transition py-2" href="#portfolio" style={{}}>
                Portfolio
              </a>
...
<span className="block text-[10vw] sm:text-7xl lg:text-8xl flex items-center justify-center gap-4 sm:gap-6">Designing</span>
<span className="block text-[10vw] sm:text-7xl lg:text-8xl animate-shimmer-mask [--shine:220%] text-white/80">intelligent visual</span>
<span className="block text-[10vw] sm:text-7xl lg:text-8xl">experiences</span>
</h1>

<p aria-label="Specializing in cinematic CGI, product visualization, and character design. Bringing imagination to life through cutting-edge 3D artistry." className="max-w-3xl mx-auto text-lg md:text-xl text-white/80 type-words is-in" data-delay=".4s" data-duration="2s" data-ease="ease-in-out" data-stagger=".2s" style={{-Stagger: '0.2s', -Dur: '2s', -Ease: 'ease-in-out', -Delay: '0.4s'}}><span className="w" style={{-I: '0'}}>Transforming </span><span className="w" style={{-I: '1'}}>complex </span><span className="w" style={{-I: '2'}}>ideas </span><span className="w" style={{-I: '3'}}>into </span><span className="w" style={{-I: '4'}}>AI-enhanced </span><span className="w" style={{-I: '5'}}>visual, </span><span className="w" style={{-I: '6'}}>motion, </span><span className="w" style={{-I: '7'}}>and </span><span className="w" style={{-I: '8'}}>UI </span><span className="w" style={{-I: '9'}}>experiences </span><span className="w" style={{-I: '10'}}>that </span><span className="w" style={{-I: '11'}}>drive </span><span className="w" style={{-I: '12'}}>clarity, </span><span className="w" style={{-I: '13'}}>engagement, </span><span className="w" style={{-I: '14'}}>and </span><span className="w" style={{-I: '15'}}>growth.in </span><span className="w" style={{-I: '16'}}>CGI, </span><span className="w" style={{-I: '17'}}>product </span><span className="w" style={{-I: '18'}}>visualization, </span><span className="w" style={{-I: '19'}}>and </span><span className="w" style={{-I: '20'}}>character </span><span className="w" style={{-I: '21'}}>design. </span><span className="w" style={{-I: '22'}}>Bringing </span><span className="w" style={{-I: '23'}}>imagination </span><span className="w" style={{-I: '24'}}>to </span><span className="w" style={{-I: '25'}}>life </span><span className="w" style={{-I: '26'}}>through </span><span className="w" style={{-I: '27'}}>cutting-edge </span><span className="w" style={{-I: '28'}}>3D </span><span className="w" style={{-I: '29'}}>artistry. </span></p>
...
<h2 className="md:text-6xl text-4xl font-semibold text-white tracking-tight mt-5 drop-shadow-xl">Featured Work</h2>
<p className="md:text-lg text-base text-white/70 mt-4">A curated selection of design, motion, UI, and print projects built for enterprise, product, and growth-driven teams.</p>
</div>
</div>
...
<article className="group snap-center shrink-0 sm:w-[68vw] md:w-[520px] lg:w-[640px] aspect-[16/10] overflow-hidden bg-neutral-900/40 w-[82vw] ring-1 rounded-2xl relative" data-index="0" style={{transform: 'scale(0.94)', opacity: '0.55'}}>
...
<svg aria-hidden="true" className="lucide lucide-sparkles h-3.5 w-3.5 text-lime-300" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
</span>
                    3D Render • Interface
                  </div>
...
<svg aria-hidden="true" className="lucide lucide-arrow-up-right h-5 w-5" data-lucide="arrow-up-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
</a>
</div>
</div>
...
<svg aria-hidden="true" className="lucide lucide-chevron-left h-5 w-5" data-lucide="chevron-left" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m15 18-6-6 6-6"></path></svg>
</button>
...
<svg aria-hidden="true" className="lucide lucide-chevron-right h-5 w-5" data-lucide="chevron-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m9 18 6-6-6-6"></path></svg>
</button>
</article>
...
<button className="filter-btn active px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/80 hover:bg-white/10 transition" data-filter="all" style={{}}>
            All Work
          </button>
...
<p className="text-xs text-white/60 mt-1" style={{}}>Motion Graphics • 2023</p>
<div className="flex gap-2 mt-3">
<span className="text-xs px-2 py-1 rounded-full bg-white/10 text-white/80" style={{}}>
                  Houdini
                </span>
...
<p className="text-xs text-white/60 mt-1" style={{}}>Character Design • 2023</p>
<div className="flex gap-2 mt-3">
<span className="text-xs px-2 py-1 rounded-full bg-white/10 text-white/80" style={{}}>
                  ZBrush
                </span>
...
<a className="inline-flex items-center gap-2 border-gradient before:rounded-full hover:bg-white/10 transition text-sm font-medium text-white/80 bg-white/5 rounded-full px-6 py-3" href="#contact" style={{}}>
            View Full Portfolio
...
<div className="">
<div className="inline-flex gap-2 border-gradient before:rounded-full bg-white/5 rounded-full pt-1.5 pr-3 pb-1.5 pl-3 backdrop-blur gap-x-2 gap-y-2 items-center">
<span className="text-xs text-white/70" style={{}}>About Me</span>
</div>
...
<p className="text-base md:text-lg text-white/70 mt-6" style={{}}>
                    I’m Srihari Chelluri, a Creative Lead and Senior Graphic, Motion &amp; UI/UX and priint designer with 11+ years of experience designing high-impact visual systems across enterprise technology, product, HealthTech, CRM, IoT, e-commerce, and advertising.

I specialize in translating complex ideas into clear, scalable, and performance-driven design experiences-combining visual design, motion storytelling, UI/UX, and AI-enhanced workflows. My work focuses on clarity, consistency, and outcomes, not just aesthetics.
                  </p>
<p className="text-base md:text-lg text-white/70 mt-4" style={{}}>
                    By leveraging AI-powered tools and intelligent automation, I streamline creative processes, enhance execution speed, and maintain design quality at scale-partnering closely with marketing, sales, product, and leadership teams to deliver measurable business impact.
                  </p>
</div>
</article>
...
<p className="text-base md:text-lg text-white/70 mt-6" style={{}}>
                    Strategic graphic and UI design enhanced by AI-driven workflows-transforming complexity into clarity across digital
                    experiences.
                  </p>
<p className="text-base md:text-lg text-white/70 mt-4" style={{}}>
                    Strategic design and visual storytelling that ensure clarity, consistency, and impact across every touchpoint.
                  </p>
</div>
</article>
...
<div>
<div className="inline-flex items-center gap-2 rounded-full border-gradient before:rounded-full bg-white/5 px-3 py-1.5 backdrop-blur">
<span className="text-xs text-white/70" style={{}}>Print Media</span>
</div>
<h2 className="mt-5 text-4xl md:text-6xl text-white drop-shadow-xl font-semibold tracking-tight">
                    Motion that communicates with intelligence
                  </h2>
<p className="text-base md:text-lg text-white/70 mt-6" style={{}}>
                    Purpose-driven motion graphics enhanced by AI-assisted workflows to simplify complexity and elevate storytelling.
                  </p>
<p className="text-base md:text-lg text-white/70 mt-4" style={{}}>
                    Animation tools and AI-assisted workflows—production-ready motion assets designed for clarity, consistency, and scale.
                  </p>
</div>
</article>
...
<p className="text-base md:text-lg text-white/70 mt-6" style={{}}>
                    Thoughtfully designed print media that reinforces brand identity and delivers clear, consistent messaging across
                    physical experiences.
                  </p>
<p className="text-base md:text-lg text-white/70 mt-4" style={{}}>
                    From concept to final artwork, every piece is crafted with precision—ensuring readability, brand alignment, and
...
<svg aria-hidden="true" className="lucide lucide-play-circle w-6 h-6 text-rose-400" data-lucide="play-circle" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M9 9.003a1 1 0 0 1 1.517-.859l4.997 2.997a1 1 0 0 1 0 1.718l-4.997 2.997A1 1 0 0 1 9 14.996z"></path><circle cx="12" cy="12" r="10"></circle></svg>
</div>
<h3 className="text-xl font-semibold text-white tracking-tight" style={{}}>
              Motion Graphics
            </h3>
...
<svg aria-hidden="true" className="lucide lucide-globe w-6 h-6 text-amber-400" data-lucide="globe" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg>
</div>
<h3 className="text-xl font-semibold text-white tracking-tight" style={{}}>
              Environment Design
            </h3>
...
<svg aria-hidden="true" className="lucide lucide-mail w-3.5 h-3.5 text-white-400" data-lucide="mail" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path><rect height="16" rx="2" width="20" x="2" y="4"></rect></svg>
...
<p className="text-base md:text-lg text-white/70 max-w-2xl mx-auto mb-8" style={{}}>
...
<a className="inline-flex items-center gap-2 border-gradient before:rounded-full hover:bg-white/10 transition text-sm font-medium text-white/80 bg-white/5 rounded-full px-6 py-3" href="#" style={{}}>
              Schedule Call
...
<p className="text-sm text-white/60 leading-relaxed mb-4" style={{}}>
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4" style={{}}>Quick Links</h3>
<ul className="space-y-3">
<li className="">
<a className="text-sm text-white/60 hover:text-white transition" href="#portfolio" style={{}}>
                    Portfolio
                  </a>
</li>
<li>
...
<div className="">
<h3 className="text-sm font-semibold text-white mb-4" style={{}}>Services</h3>
<ul className="space-y-3">
<li className="">
<a className="text-sm text-white/60 hover:text-white transition" href="#services" style={{}}>
                    Product Visualization
...
<p className="text-xs text-white/50 text-center md:text-left" style={{}}>
              ©
              <span id="year" style={{}}>2026</span>
              Alexia Rivera. All rights reserved.
            </p>
<div className="flex items-center gap-6 text-xs text-white/60">
<a className="hover:text-white transition" href="#" style={{}}>Privacy Policy</a>
<a className="hover:text-white transition" href="#" style={{}}>
                Terms of Service
              </a>
<a className="hover:text-white transition" href="#" style={{}}>Cookie Policy</a>
<a className="hover:text-white transition" href="#contact" style={{}}>Contact</a>
</div>
</div>
</div>

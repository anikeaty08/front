...
<div className="hidden lg:flex flex-1 justify-center items-center gap-6 lg:gap-8 text-base text-zinc-400 font-normal">
...
<a className="flex items-center justify-center px-4 py-2 border border-zinc-700 bg-zinc-900/50 rounded-full text-base font-normal text-zinc-300 hover:bg-zinc-800 transition-colors backdrop-blur-sm" href="#">
              Book a demo
            </a>
<a className="flex items-center justify-center px-5 py-2 bg-zinc-800 text-emerald-400 border border-emerald-500/30 rounded-full text-base font-normal hover:bg-zinc-700 shadow-[0_0_15px_rgba(16,185,129,0.2)] transition-all hover:shadow-[0_0_20px_rgba(16,185,129,0.4)]" href="#">
              Start free
            </a>
</div>
</div>
...
<p className="text-xl text-zinc-300/80 mb-10 max-w-2xl mx-auto font-extralight leading-relaxed">
          SignalAI helps teams find high-intent accounts, generate multi-channel
          outreach, and turn signals into pipeline.
        </p>

<div className="max-w-md mx-auto">
<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
<a className="w-full sm:w-auto px-8 py-3 bg-zinc-800 text-emerald-400 border border-emerald-500/30 rounded-full text-base font-light shadow-[0_0_15px_rgba(16,185,129,0.2)] hover:bg-zinc-700 transition-all hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] whitespace-nowrap" href="#">
              Start free
            </a>
<a className="w-full sm:w-auto px-8 py-3 bg-zinc-900/50 border border-zinc-700/50 text-zinc-200 rounded-full text-base font-light hover:bg-zinc-800 hover:text-white transition-all backdrop-blur-sm whitespace-nowrap" href="#">
              View demo
            </a>
</div>
</div>
...
<iconify-icon className="text-xl md:text-2xl" icon="solar:soundwave-linear" strokeWidth="1.5"></iconify-icon>
                  Dolby
                </span>
<span className="text-xl md:text-2xl font-light tracking-tight flex items-center gap-1">
<iconify-icon className="text-xl md:text-2xl" icon="solar:global-linear" strokeWidth="1.5"></iconify-icon>
                  SMARTLING
                </span>
...
<h2 className="text-3xl md:text-4xl font-light tracking-tight text-white leading-[1.3] max-w-3xl drop-shadow-[0_2px_10px_rgba(255,255,255,0.1)]">
              "SignalAI completely changed how our RevOps team runs outbound. We
              identify buying signals instantly and launch targeted sequences in
              minutes. What used to take days of research now happens
              automatically."
            </h2>
...
<iconify-icon className="text-lg" icon="solar:chat-square-linear" strokeWidth="1.5"></iconify-icon>
                  SignalBase
                </div>
</div>
</div>
...
<span className="block text-zinc-300/70">signal to pipeline</span>
</h2>
<p className="text-lg text-zinc-400 font-extralight mb-16 max-w-xl mx-auto">
          Powered by our core framework, one of the
          <br className="hidden md:block"/>
          largest intent networks online.
        </p>
...
<iconify-icon className="text-2xl text-emerald-400 drop-shadow-[0_0_5px_rgba(52,211,153,0.8)]" icon="solar:wi-fi-router-linear" strokeWidth="1.5"></iconify-icon>
</div>
...
<p className="text-base text-zinc-500 font-extralight max-w-[26ch]">
                Detect buying intent across engagement, firmographic changes,
...
<p className="text-sm text-zinc-300/80 font-light leading-relaxed mb-5">
                    Identify intent early, filter noise, and prioritize accounts
                    that match your ICP.
                  </p>
...
<div className="text-xs text-zinc-500 font-light">
                    Signals → Intent score
                  </div>
<div className="text-xs text-emerald-300/80 font-light">
                    View details
                  </div>
</div>
</div>
...
<iconify-icon className="text-2xl text-amber-400 drop-shadow-[0_0_5px_rgba(251,191,36,0.8)]" icon="solar:inbox-linear" strokeWidth="1.5"></iconify-icon>
</div>
<h3 className="text-xl font-light tracking-tight text-zinc-200 mb-3 group-hover:text-amber-300 transition-colors">
                Intent Routing
              </h3>
<p className="text-base text-zinc-500 font-extralight max-w-[26ch]">
                Filter inbound activity, prioritize urgency, and route accounts
                into the right outreach flow.
              </p>
...
<div className="flex-1 overflow-auto pr-1">
<p className="text-sm text-zinc-300/80 font-light leading-relaxed mb-5">
                    Automatically evaluate incoming signals and route high-value
                    accounts into the right campaign sequence.
                  </p>
...
<iconify-icon className="text-2xl text-cyan-300 drop-shadow-[0_0_5px_rgba(34,211,238,0.8)]" icon="solar:database-linear" strokeWidth="1.5"></iconify-icon>
</div>
<h3 className="text-xl font-light tracking-tight text-zinc-200 mb-3 group-hover:text-cyan-200 transition-colors">
                Context Engine
              </h3>
<p className="text-base text-zinc-500 font-extralight max-w-[26ch]">
                Enrich accounts and contacts with verified context so every
                message lands with relevance.
              </p>
...
<p className="text-sm text-zinc-300/80 font-light leading-relaxed mb-4">
                    Add role context and firmographics so targeting stays
                    precise and personalization scales cleanly.
                  </p>
...
<iconify-icon className="text-2xl text-violet-300 drop-shadow-[0_0_5px_rgba(168,85,247,0.8)]" icon="solar:rocket-linear" strokeWidth="1.5"></iconify-icon>
</div>
<h3 className="text-xl font-light tracking-tight text-zinc-200 mb-3 group-hover:text-violet-300 transition-colors">
                Outreach Engine
              </h3>
<p className="text-base text-zinc-500 font-extralight max-w-[26ch]">
                Generate personalized sequences and launch multi-channel
                outreach across your pipeline.
              </p>
...
<p className="text-sm text-zinc-300/80 font-light leading-snug mb-4">
                    Launch personalized outreach sequences that adapt to signals
...
<a className="inline-flex items-center justify-center px-6 py-3.5 bg-zinc-900/50 border border-zinc-700/50 text-zinc-300 rounded-full text-base font-light hover:bg-zinc-800 transition-colors backdrop-blur-sm" href="#">
                Explore workflows
              </a>
</div>
<ul className="space-y-5">
<li className="flex items-start gap-3">
<iconify-icon className="text-xl text-zinc-500 mt-1 shrink-0" icon="solar:document-text-linear" strokeWidth="1.5"></iconify-icon>
<span className="text-lg text-zinc-400 font-extralight">
                  Detect intent signals before competitors do
                </span>
</li>
<li className="flex items-start gap-3">
<iconify-icon className="text-xl text-zinc-500 mt-1 shrink-0" icon="solar:bolt-linear" strokeWidth="1.5"></iconify-icon>
<span className="text-lg text-zinc-400 font-extralight">
                  Generate multi-channel sequences in seconds
                </span>
</li>
<li className="flex items-start gap-3">
<iconify-icon className="text-xl text-zinc-500 mt-1 shrink-0" icon="solar:target-linear" strokeWidth="1.5"></iconify-icon>
<span className="text-lg text-zinc-400 font-extralight">
...
<iconify-icon className="text-xs" icon="solar:stars-linear" strokeWidth="1.5"></iconify-icon>
                  Signal Console
                </div>
</div>
...
<div className="absolute inset-0 bg-emerald-500/5 mix-blend-screen pointer-events-none z-10 animate-pulse" style={{animationDuration: '4s'}}></div>
<div className="flex items-center gap-2 text-xs font-light text-zinc-500 mb-2 uppercase tracking-wide">
...
<iconify-icon className="text-emerald-400 drop-shadow-[0_0_5px_rgba(52,211,153,0.8)]" icon="solar:users-group-rounded-linear" strokeWidth="1.5"></iconify-icon>
                        Account map
                      </div>
<p className="text-base text-zinc-400 font-extralight leading-relaxed mb-1">
<strong className="text-zinc-200 font-light">
                          Root Admin
                        </strong>
                        · Core Systems, Acme
                      </p>
<p className="text-base text-zinc-500 font-extralight leading-relaxed">
                        Admin handles primary logic for experience layer. IP
                        localized to US-East.
                      </p>
...
<div className="">
<div className="flex items-center gap-2 text-sm font-light text-zinc-300 mb-2">
<iconify-icon className="text-amber-400 drop-shadow-[0_0_5px_rgba(251,191,36,0.8)]" icon="solar:lightbulb-minimalistic-linear" strokeWidth="1.5"></iconify-icon>
                        Signal analysis
                      </div>
...
<p className="text-base text-zinc-500 font-extralight leading-relaxed">
                        Acme established handshake and requested payload limits.
                        Deploy override configs.
                      </p>
<span className="text-sm font-light text-emerald-400 mt-2 inline-block cursor-pointer hover:text-emerald-300">
                        Reveal context ▾
                      </span>
...
<h2 className="md:text-5xl text-4xl text-white tracking-tight font-extralight mb-4 drop-shadow-[0_2px_10px_rgba(255,255,255,0.1)]">
                ...
                <br className="hidden md:block"/>
<span className="block text-zinc-300/70">modern revenue teams</span>
</h2>
<p className="leading-relaxed text-lg font-light text-zinc-400 mt-4">
                Millions of buying signals processed daily across the SignalAI
                signal network.
              </p>
</div>
...
<div className="absolute bottom-3 right-6 w-2 h-2 rounded-full bg-violet-500 shadow-[0_0_8px_rgba(139,92,246,0.8)] animate-pulse"></div>
<div className="absolute bottom-3 right-10 w-2 h-2 rounded-full bg-zinc-700 shadow-[inset_0_1px_2px_rgba(0,0,0,0.8)]"></div>
...
<p className="text-sm text-violet-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(167,139,250,0.6)]">
                    “SignalAI surfaces the right accounts before our competitors
                    even see them.”
                  </p>
</div>
...
<img alt="Liam" className="w-10 h-10 rounded-full border-[1.5px] border-violet-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[240deg]" src="https://images.unsplash.com/photo-1560250097-0b9358e1b572?auto=format&amp;fit=crop&amp;q=80&amp;w=64&amp;h=64"/>
</div>
<div>
...
<p className="text-sm text-amber-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(251,191,36,0.6)]">
                    “We replaced three tools and our pipeline velocity doubled
                    within two quarters.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-amber-950 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
<img alt="Elena" className="w-10 h-10 rounded-full border-[1.5px] border-amber-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[10deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6e825b87-0682-49e3-98c2-dbdab1f8f9c5_320w.webp"/>
</div>
<div>
...
<p className="text-sm text-cyan-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(34,211,238,0.6)]">
                    “The signal scoring is incredibly accurate. Our SDRs focus
                    only on accounts that matter.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-cyan-950 shadow-[0_0_10px_rgba(6,182,212,0.2)]">
<img alt="Marcus" className="w-10 h-10 rounded-full border-[1.5px] border-cyan-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[180deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/25df7579-09f7-4c8c-bb39-18a974a980d0_320w.webp"/>
</div>
<div>
...
<p className="text-sm text-emerald-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(52,211,153,0.6)]">
                    “SignalAI turned our outbound into a predictable pipeline
                    engine.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
...
<p className="text-sm text-violet-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(167,139,250,0.6)]">
                    “We finally have a system that connects intent data to real
                    revenue outcomes.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-violet-950 shadow-[0_0_10px_rgba(139,92,246,0.2)]">
<img alt="Noah" className="w-10 h-10 rounded-full border-[1.5px] border-violet-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[240deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/71d7ad40-af9f-4af2-baa2-8d7eb0382908_3840w.webp?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-violet-300 font-light drop-shadow-[0_0_4px_rgba(196,181,253,0.6)]">
                      Noah Bennett
...
<p className="text-sm text-amber-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(251,191,36,0.6)]">
                    “Pipeline generation became measurable the moment we adopted
                    SignalAI.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-amber-950 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
<img alt="Jordan" className="w-10 h-10 rounded-full border-[1.5px] border-amber-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[10deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f4bda977-4e02-4ce3-b6d3-1f8a5d3197db_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-amber-300 font-light drop-shadow-[0_0_4px_rgba(252,211,77,0.6)]">
                      Jordan Malik
...
<p className="text-sm text-cyan-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(34,211,238,0.6)]">
                    “Our outbound campaigns now start with signals instead of
                    guesswork.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-cyan-950 shadow-[0_0_10px_rgba(6,182,212,0.2)]">
<img alt="Camila" className="w-10 h-10 rounded-full border-[1.5px] border-cyan-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[180deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b5fa796b-5a4e-4746-8463-8e491f896f5c_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-cyan-300 font-light drop-shadow-[0_0_4px_rgba(103,232,249,0.6)]">
                      Camila Ortega
...
<p className="text-sm text-violet-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(167,139,250,0.6)]">
                    “The routing and orchestration layers are incredibly
                    powerful.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-violet-950 shadow-[0_0_10px_rgba(139,92,246,0.2)]">
<img alt="Thomas" className="w-10 h-10 rounded-full border-[1.5px] border-violet-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[240deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5a8f3649-9a97-4446-955e-d3ced353790f_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-violet-300 font-light drop-shadow-[0_0_4px_rgba(196,181,253,0.6)]">
                      Thomas Reid
...
<p className="text-sm text-emerald-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(52,211,153,0.6)]">
                    “SignalAI replaced our enrichment and intent stack in one
                    platform.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-emerald-950 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
<img alt="Daniel" className="w-10 h-10 rounded-full border-[1.5px] border-emerald-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[90deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a44deb57-f322-4fc8-9184-d05e21080cb2_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-emerald-300 font-light drop-shadow-[0_0_4px_rgba(110,231,183,0.6)]">
                      Daniel Foster
...
<p className="text-sm text-amber-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(251,191,36,0.6)]">
                    “The signal intelligence layer changed how we prioritize
                    accounts.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-amber-950 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
<img alt="Natalie" className="w-10 h-10 rounded-full border-[1.5px] border-amber-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[10deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/09d49595-2875-4825-b17d-d0945c838877_3840w.webp?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-amber-300 font-light drop-shadow-[0_0_4px_rgba(252,211,77,0.6)]">
                      Natalie Zhou
...
<p className="text-sm text-cyan-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(34,211,238,0.6)]">
                    “Our SDR team now launches sequences based on real buying
                    intent.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-cyan-950 shadow-[0_0_10px_rgba(6,182,212,0.2)]">
<img alt="Lucas" className="w-10 h-10 rounded-full border-[1.5px] border-cyan-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[180deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/eb93b27a-f6f8-488f-8c32-5ecb690fad2e_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-cyan-300 font-light drop-shadow-[0_0_4px_rgba(103,232,249,0.6)]">
                      Lucas Romero
...
<p className="text-sm text-violet-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(167,139,250,0.6)]">
                    “We went from reactive outreach to proactive signal-based
                    selling.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-violet-950 shadow-[0_0_10px_rgba(139,92,246,0.2)]">
<img alt="Arjun" className="w-10 h-10 rounded-full border-[1.5px] border-violet-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[240deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/7aea9f51-9846-468c-ad86-f2b0c6d00c65_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-violet-300 font-light drop-shadow-[0_0_4px_rgba(196,181,253,0.6)]">
                      Arjun Patel
...
<div className="w-[380px] shrink-0 mr-6 p-3 rounded-[32px] bg-zinc-800 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),_0_20px_40px_-10px_rgba(0,0,0,0.9),_0_0_0_1px_rgba(0,0,0,1)] flex flex-col relative">
<div className="absolute bottom-3 right-6 w-2 h-2 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)] animate-pulse" style={{animationDelay: '2s'}}></div>
<div className="absolute bottom-3 right-10 w-2 h-2 rounded-full bg-zinc-700 shadow-[inset_0_1px_2px_rgba(0,0,0,0.8)]"></div>
<div className="relative h-full rounded-[20px] bg-[#0a0500] p-6 shadow-[inset_0_0_40px_rgba(0,0,0,1)] border-[6px] border-zinc-950 flex flex-col justify-between overflow-hidden">
<div className="absolute inset-0 pointer-events-none z-20 opacity-30 mix-blend-overlay" style={{background: 'repeating-linear-gradient(0deg,#000,#000 2px,transparent 2px,transparent 4px)'}}></div>
<div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/5 to-transparent pointer-events-none z-10 rounded-t-[14px]"></div>
...
<p className="text-sm text-amber-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(251,191,36,0.6)]">
                    “The orchestration engine is the most advanced we’ve seen.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-amber-950 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
<img alt="Claire" className="w-10 h-10 rounded-full border-[1.5px] border-amber-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[10deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/8a90d32f-809f-4383-b71f-6a9c50621b69_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-amber-300 font-light drop-shadow-[0_0_4px_rgba(252,211,77,0.6)]">
                      Claire Dubois
...
<div className="w-[380px] shrink-0 mr-6 p-3 rounded-[32px] bg-zinc-800 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),_0_20px_40px_-10px_rgba(0,0,0,0.9),_0_0_0_1px_rgba(0,0,0,1)] flex flex-col relative">
<div className="absolute bottom-3 right-6 w-2 h-2 rounded-full bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,0.8)] animate-pulse" style={{animationDelay: '2.5s'}}></div>
<div className="absolute bottom-3 right-10 w-2 h-2 rounded-full bg-zinc-700 shadow-[inset_0_1px_2px_rgba(0,0,0,0.8)]"></div>
<div className="relative h-full rounded-[20px] bg-[#00050a] p-6 shadow-[inset_0_0_40px_rgba(0,0,0,1)] border-[6px] border-zinc-950 flex flex-col justify-between overflow-hidden">
<div className="absolute inset-0 pointer-events-none z-20 opacity-30 mix-blend-overlay" style={{background: 'repeating-linear-gradient(0deg,#000,#000 2px,transparent 2px,transparent 4px)'}}></div>
<div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/5 to-transparent pointer-events-none z-10 rounded-t-[14px]"></div>
...
<p className="text-sm text-cyan-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(34,211,238,0.6)]">
                    “Our pipeline coverage increased dramatically within weeks.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-cyan-950 shadow-[0_0_10px_rgba(6,182,212,0.2)]">
<img alt="Ethan" className="w-10 h-10 rounded-full border-[1.5px] border-cyan-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[180deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/83bdae25-92d0-491a-95ce-8daf7c7d1834_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-cyan-300 font-light drop-shadow-[0_0_4px_rgba(103,232,249,0.6)]">
                      Ethan Wallace
...
<div className="w-[380px] shrink-0 mr-6 p-3 rounded-[32px] bg-zinc-800 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),_0_20px_40px_-10px_rgba(0,0,0,0.9),_0_0_0_1px_rgba(0,0,0,1)] flex flex-col relative">
<div className="absolute bottom-3 right-6 w-2 h-2 rounded-full bg-violet-500 shadow-[0_0_8px_rgba(139,92,246,0.8)] animate-pulse" style={{animationDelay: '3s'}}></div>
<div className="absolute bottom-3 right-10 w-2 h-2 rounded-full bg-zinc-700 shadow-[inset_0_1px_2px_rgba(0,0,0,0.8)]"></div>
<div className="relative h-full rounded-[20px] bg-[#05000a] p-6 shadow-[inset_0_0_40px_rgba(0,0,0,1)] border-[6px] border-zinc-950 flex flex-col justify-between overflow-hidden">
<div className="absolute inset-0 pointer-events-none z-20 opacity-30 mix-blend-overlay" style={{background: 'repeating-linear-gradient(0deg,#000,#000 2px,transparent 2px,transparent 4px)'}}></div>
<div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/5 to-transparent pointer-events-none z-10 rounded-t-[14px]"></div>
...
<p className="text-sm text-violet-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(167,139,250,0.6)]">
                    “The signal network provides insights we couldn’t get
                    anywhere else.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-violet-950 shadow-[0_0_10px_rgba(139,92,246,0.2)]">
<img alt="Hannah" className="w-10 h-10 rounded-full border-[1.5px] border-violet-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[240deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d6d87d18-41f2-4c59-9e4e-3805a4e595d1_3840w.jpg?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-violet-300 font-light drop-shadow-[0_0_4px_rgba(196,181,253,0.6)]">
                      Hannah Fischer
...
<div className="w-[380px] shrink-0 mr-6 p-3 rounded-[32px] bg-zinc-800 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),_0_20px_40px_-10px_rgba(0,0,0,0.9),_0_0_0_1px_rgba(0,0,0,1)] flex flex-col relative">
<div className="absolute bottom-3 right-6 w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" style={{animationDelay: '3.5s'}}></div>
<div className="absolute bottom-3 right-10 w-2 h-2 rounded-full bg-zinc-700 shadow-[inset_0_1px_2px_rgba(0,0,0,0.8)]"></div>
<div className="relative h-full rounded-[20px] bg-[#020a02] p-6 shadow-[inset_0_0_40px_rgba(0,0,0,1)] border-[6px] border-zinc-950 flex flex-col justify-between overflow-hidden">
<div className="absolute inset-0 pointer-events-none z-20 opacity-30 mix-blend-overlay" style={{background: 'repeating-linear-gradient(0deg,#000,#000 2px,transparent 2px,transparent 4px)'}}></div>
<div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-white/5 to-transparent pointer-events-none z-10 rounded-t-[14px]"></div>
<div className="absolute inset-0 bg-emerald-500/5 mix-blend-screen pointer-events-none z-10 animate-pulse" style={{animationDuration: '3.8s'}}></div>
<div className="relative z-30 mb-6">
<span className="text-xs font-light text-emerald-500/70 uppercase tracking-widest block mb-4">
                    Revenue Growth
                  </span>
<p className="text-sm text-emerald-400/90 font-light leading-relaxed drop-shadow-[0_0_3px_rgba(52,211,153,0.6)]">
                    “SignalAI gave our sales team a real competitive edge.”
                  </p>
</div>
<div className="relative z-30 flex items-center gap-4">
<div className="relative p-0.5 rounded-full bg-emerald-950 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
<img alt="Mateo" className="w-10 h-10 rounded-full border-[1.5px] border-emerald-500/50 object-cover opacity-80 mix-blend-luminosity grayscale sepia-[.5] hue-rotate-[90deg]" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/25df7579-09f7-4c8c-bb39-18a974a980d0_3840w.webp?w=800&amp;q=80"/>
</div>
<div>
<div className="text-sm text-emerald-300 font-light drop-shadow-[0_0_4px_rgba(110,231,183,0.6)]">
                      Mateo Alvarez
...
<h2 className="text-4xl md:text-5xl font-extralight tracking-tight text-white leading-tight">
            ...
            <br className="hidden md:block"/>
<span className="block text-zinc-300/70">signals into pipeline</span>
</h2>
<p className="mt-6 text-lg text-zinc-400 font-light leading-relaxed max-w-xl mx-auto">
            From intent detection to outbound execution, SignalAI connects
            buying signals directly to revenue workflows.
          </p>
</div>
...
<li className="">Territory routing</li>
<li>SDR assignment</li>
<li className="">CRM pipeline sync</li>
</ul>
</div>
...
<p className="leading-relaxed text-lg font-light text-zinc-400 max-w-xl mt-6">
              SignalAI is built for modern revenue teams operating in regulated
              environments with encryption, access controls, and auditability
...
<iconify-icon className="text-xl text-emerald-400" icon="solar:lock-password-linear" strokeWidth="1.5"></iconify-icon>
</div>
...
<p className="mt-4 text-sm text-zinc-400 font-light leading-relaxed">
                TLS in transit, AES-256 at rest, and optional key rotation for
...
<iconify-icon className="text-xl text-amber-400" icon="solar:user-id-linear" strokeWidth="1.5"></iconify-icon>
</div>
<div className="text-sm text-white font-light tracking-tight">
                  Access controls
                </div>
...
<p className="mt-4 text-sm text-zinc-400 font-light leading-relaxed">
                SSO/SAML support, SCIM provisioning, and role based permissions
                for every workflow and team.
              </p>
</div>
<div className="bg-zinc-900/40 backdrop-blur-sm rounded-2xl border border-zinc-800 p-6 hover:bg-zinc-800/50 transition-colors">
...
<iconify-icon className="text-xl text-cyan-300" icon="solar:clipboard-check-linear" strokeWidth="1.5"></iconify-icon>
</div>
<div className="text-sm text-white font-light tracking-tight">
                  Auditability
                </div>
...
<p className="mt-4 text-sm text-zinc-400 font-light leading-relaxed">
                Immutable audit logs, configurable retention, and export ready
                reporting for compliance and review.
              </p>
</div>
<div className="bg-zinc-900/40 backdrop-blur-sm rounded-2xl border border-zinc-800 p-6 hover:bg-zinc-800/50 transition-colors">
...
<iconify-icon className="text-xl text-violet-300" icon="solar:server-square-linear" strokeWidth="1.5"></iconify-icon>
</div>
<div className="text-sm text-white font-light tracking-tight">
                  Secure runtime
                </div>
...
<p className="mt-4 text-sm text-zinc-400 font-light leading-relaxed">
                Hardened infrastructure, least privilege services, and isolated
                execution designed for scale and safety.
              </p>
</div>
...
<h2 className="text-4xl md:text-[2.75rem] tracking-tight text-white mb-6 leading-[1.1] drop-shadow-[0_2px_15px_rgba(16,185,129,0.15)] font-light relative z-10">
              ...
              <br/>
              into
              <span className="text-emerald-400 italic">pipeline</span>
</h2>
<p className="text-base text-zinc-400 font-extralight mb-10 max-w-md leading-relaxed relative z-10 mx-auto lg:mx-0">
              SignalAI captures intent, scores accounts in real time, and
              launches outreach the moment buyers show interest. Route
              high-intent accounts directly into your pipeline automatically.
            </p>

<div className="flex flex-col sm:flex-row gap-4 max-w-[26rem] w-full justify-center lg:justify-start relative z-10">
<button className="flex-1 py-3.5 bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 font-light text-base hover:bg-emerald-500/20 transition-colors shadow-[0_0_15px_rgba(16,185,129,0.1)] px-7 rounded-full">
                Start free
              </button>
<button className="flex-1 py-3.5 bg-zinc-950 border border-zinc-800 text-white font-light text-base hover:bg-zinc-900 transition-colors px-7 rounded-full">
                Book a demo
              </button>
</div>
...
<div className="w-full max-w-md mx-6 lg:mx-12 bg-[#050505] rounded-xl shadow-[0_0_40px_rgba(0,0,0,0.8)] border border-zinc-800 flex flex-col relative z-30 overflow-hidden">
...
<div className="flex-1 bg-[#020502] p-5 flex flex-col gap-3 relative">
<style>
                  ...
                  .row-1 .status-dot { animation-delay: 0s; }
                  ...
                  .row-2 .status-dot { animation-delay: 2s; }
                  ...
                  .row-3 .status-dot { animation-delay: 4s; }
                  ...
                  .row-4 .status-dot { animation-delay: 6s; }
                </style>
<div className="absolute inset-0 bg-emerald-500/5 mix-blend-screen pointer-events-none z-10 animate-pulse" style={{animationDuration: '4s'}}></div>
...
<span>
                        Account:
                        <span className="text-zinc-300">Vortex Labs</span>
                        • Score: 92
                      </span>
</div>
</div>
...
<div className="pl-5 flex flex-col gap-1">
<div className="text-xs text-zinc-400 font-light flex items-center justify-between">
<span>Firmographic + technographic match</span>
</div>
</div>
</div>
...
<span>
                        Channel:
                        <span className="text-zinc-300">Email + LinkedIn</span>
</span>
</div>
</div>
</div>
...
<span>
                        Stage:
                        <span className="text-zinc-300">Discovery</span>
                        • Owner assigned
                      </span>
</div>
</div>
...
<section className="max-w-[1000px] mx-auto px-6 pb-40 relative z-10" id="faq-section">
...
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Most teams can connect their CRM, define their ICP, and
                    start routing signals in under one day.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    No. Teams can start free, explore the workflow, and book a
                    demo later for deeper onboarding.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    SignalAI is designed to plug into modern CRMs and outbound
                    workflows first, so setup is lightweight.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-emerald-300 transition-colors duration-300">
                  Can I define my own ideal customer profile?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-emerald-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. You can configure ICP filters, scoring inputs, and
                    routing logic around your market.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-emerald-300 transition-colors duration-300">
                  How much setup is required for the first workflow?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-emerald-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Minimal setup. Choose a signal trigger (e.g., website
                    visit), map it to an email sequence, and activate.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. SignalAI uses encryption across transport and storage
                    layers to keep customer data protected.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. Enterprise environments can use identity provisioning
                    and access controls to manage users securely.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. SignalAI provides auditability so teams can review
                    activity, changes, and operational events.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Permissions can be managed by role so GTM, RevOps, and
                    admins each see what they need.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-amber-300 transition-colors duration-300">
                  Can regulated teams use SignalAI securely?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-amber-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Absolutely. We support dedicated instances and custom
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. Workflows can launch the moment a qualified signal is
                    detected.
                  </p>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Accounts can be routed by territory, segment, owner, or
                    stage depending on your operating model.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. Pipeline actions and qualified accounts can be pushed
                    into your existing sales workflow.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-cyan-300 transition-colors duration-300">
                  Can we adapt workflows to different teams?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-cyan-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. SDR, AE, and RevOps teams can each use different
                    routing logic and activation rules.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-cyan-300 transition-colors duration-300">
                  What kinds of outbound workflows can we automate?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-cyan-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Anything from intro emails and LinkedIn tasks to Slack
                    alerts and CRM field updates.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. Our free tier allows you to test signal capture and
                    basic routing for a limited number of accounts.
                  </p>
</div>
</div>
</div>
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    You can easily upgrade to Pro or Enterprise plans to add
                    more seats, signals, and integration depth.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-violet-300 transition-colors duration-300">
                  Is pricing based on seats, usage, or workflows?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-violet-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    We use a hybrid model: platform fee for core features +
                    usage for signal volume. Unlimited workflows.
                  </p>
</div>
</div>
</div>
...
<button className="w-full py-5 flex justify-between items-center text-left gap-4" onclick="window.toggleFaq(this)">
<span className="text-lg font-light text-zinc-300 group-hover:text-violet-300 transition-colors duration-300">
                  Can admins control permissions across teams?
                </span>
<iconify-icon className="faq-icon text-xl text-zinc-600 group-hover:text-violet-400 transition-all duration-300 shrink-0" icon="solar:add-circle-linear"></iconify-icon>
</button>
<div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-300 ease-out">
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    Yes. Granular RBAC ensures teams only access the data and
...
<div className="min-h-0">
<p className="pb-6 text-zinc-400 font-light leading-relaxed">
                    All plans include documentation and chat support. Enterprise
                    plans get a dedicated solutions engineer.
                  </p>
</div>
</div>
</div>
...
<p className="text-sm text-zinc-400 font-light leading-relaxed">
      Turn buying signals into pipeline with automated scoring,
      routing, and outbound workflows.
    </p>
</div>
...
<li><a className="hover:text-emerald-400 transition-colors" href="#">Book a demo</a></li>
</ul>
</div>
...
<li><a className="hover:text-emerald-400 transition-colors" href="#">Signal Network</a></li>
</ul>
</div>
...
<li><a className="hover:text-emerald-400 transition-colors" href="#">Login</a></li>
</ul>
</div>
</div>
</div>

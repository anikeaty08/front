...
<span className="text-xl font-bold tracking-tight text-white uppercase group-hover:text-blue-500 transition-colors">Slater<span className="text-blue-600">Gym</span></span>
</a>
...
<h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-tighter text-white mb-8 leading-[0.95] animate-on-scroll is-visible" style={{animationDelay: '0.2s'}}>
          STOP GUESSING.<br/>
<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-700">START TRAINING.</span>
</h1>

<p className="text-xl sm:text-2xl text-white/70 max-w-2xl leading-relaxed mb-10 animate-on-scroll is-visible" style={{animationDelay: '0.3s'}}>
...
<img alt="Coach helping client with weights" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&amp;w=2940&amp;auto=format&amp;fit=crop"/>
</div>
...
<svg className="lucide lucide-quote absolute top-6 right-6 text-blue-700/20 w-16 h-16" data-lucide="quote" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path></svg>

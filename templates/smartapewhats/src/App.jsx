...
<div className="fixed inset-0 z-0 opacity-100" id="canvas-container"><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas><canvas height="1538" style={{display: 'block', width: '1000px', height: '769px'}} width="2000"></canvas></div>
...
<img alt="Logo" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c027c960-ebe6-4ef7-97bd-1247499c2d50_320w.jpg"/>
</div>
<span className="text-obsidian text-sm font-bold tracking-tight font-sans">SMARTAPE</span>
</div>
...
<div className="premium-card overflow-hidden w-full h-full rounded-xl pt-6 pr-6 pb-6 pl-6 relative">
...
<svg className="w-full h-full" strokeWidth="2" style={{width: '100%', height: '100%'}} viewbox="0 0 400 300">
<style>
                    .signal-path-main {
                      stroke-dasharray: 40 400;
                      stroke-dashoffset: 40;
                      animation: signal-flow-main 4s linear infinite;
                    }
                    @keyframes signal-flow-main {
                      0% { stroke-dashoffset: 40; opacity: 0; }
                      10% { opacity: 1; }
                      90% { stroke-dashoffset: -400; opacity: 1; }
                    ...
                    .data-fetch {
                      ...
                      animation: fetch-anim 3s ease-in-out infinite;
                    }
                    @keyframes fetch-anim {
                    ...
                    .node-pulse { animation: pulse-node 4s infinite ease-in-out; transform-origin: center; }
...
<marker id="arrow-active" markerheight="6" markerunits="strokeWidth" markerwidth="6" orient="auto" refx="5" refy="3">
<path d="M0,0 L6,3 L0,6" fill="#10B981"></path>
</marker>
</defs>


<path d="M60,150 L140,150" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>

<path d="M180,130 C180,90 220,90 260,90" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>

<path d="M180,170 C180,210 220,210 260,210" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>

<path d="M220,150 L340,150" fill="none" stroke="#E5E5E5" strokeWidth="2"></path>

<path className="signal-path-main" d="M60,150 L140,150" fill="none" stroke="#10B981" strokeWidth="2"></path>
<path className="data-fetch" d="M180,130 C180,90 220,90 260,90" fill="none" stroke="#10B981" strokeWidth="2" style={{animationDelay: '0.5s'}}></path>
<path className="data-fetch" d="M260,210 C220,210 180,210 180,170" fill="none" stroke="#10B981" strokeWidth="2" style={{animationDelay: '1.5s'}}></path>
<path className="signal-path-main" d="M220,150 L340,150" fill="none" stroke="#10B981" strokeWidth="2" style={{animationDelay: '2s'}}></path>

<g className="node-pulse" style={{transformOrigin: '60px 150px'}}>
<circle cx="60" cy="150" fill="white" r="24" stroke="#E5E5E5" strokeWidth="1.5"></circle>
<path d="M52 146c0-5.5 4.5-8 10-8s10 2.5 10 8c0 3-2 5-4 7l-4 4v3" fill="none" stroke="#111" strokeLinecap="round" strokeWidth="1.5"></path>
<circle cx="60" cy="164" fill="#111" r="1.5"></circle>
</g>
<text fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="10" font-weight="600" text-anchor="middle" x="60" y="190">Usuario</text>

<g className="node-pulse" style={{transformOrigin: '180px 150px'}}>
<rect fill="#111" height="50" rx="8" stroke="#111" strokeWidth="1.5" width="80" x="140" y="125"></rect>
<path d="M170 145l5 5 10-10" fill="none" stroke="none"></path>

<rect fill="#10B981" height="6" rx="1" width="6" x="155" y="140"></rect>
<rect fill="#fff" height="6" rx="1" width="6" x="165" y="140"></rect>
<rect fill="#fff" height="6" rx="1" width="6" x="155" y="150"></rect>
<rect fill="#fff" height="6" rx="1" width="6" x="165" y="150"></rect>
<text fill="white" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="11" font-weight="700" x="185" y="153">AGENTE</text>
</g>

<g style={{transformOrigin: '300px 90px'}}>
<rect fill="white" height="40" rx="6" stroke="#E5E5E5" strokeWidth="1.5" width="90" x="260" y="70"></rect>
<rect fill="#F5F5F7" height="24" rx="4" width="24" x="268" y="78"></rect>
<path d="M280 82v16m-8-8h16" stroke="#E5E5E5" strokeLinecap="round" strokeWidth="1.5"></path>
<path d="M275 85h10v10h-10z" fill="#9CA3AF"></path>
<text fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="9" font-weight="600" x="300" y="94">Info Empresa</text>
</g>

<g style={{transformOrigin: '300px 210px'}}>
<rect fill="white" height="40" rx="6" stroke="#E5E5E5" strokeWidth="1.5" width="90" x="260" y="190"></rect>
<rect fill="#ECFDF5" height="24" rx="4" width="24" x="268" y="198"></rect>
<path d="M280 205a5 5 0 1 0 0 10 5 5 0 0 0 0-10z" fill="none" stroke="#10B981" strokeWidth="1.5"></path>
<text fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="9" font-weight="600" x="300" y="214">Preferencias</text>
</g>

<g className="node-pulse" style={{transformOrigin: '340px 150px'}}>
<circle cx="340" cy="150" fill="#10B981" r="18"></circle>
<path d="M334 150l4 4 8-8" fill="none" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</g>
<text fill="#111" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="10" font-weight="600" text-anchor="middle" x="340" y="185">Respuesta</text>
</svg>

<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-obsidian text-white text-[10px] font-medium px-3 py-1.5 rounded shadow-xl flex items-center gap-2">
...
<div className="text-center mb-12 shrink-0 opacity-0 transition-opacity duration-700" id="lifecycle-header" style={{opacity: '0'}}>
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.1" style={{transform: 'scale(1)'}}>
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.25" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.4" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle uppercase tracking-wider block mb-1">
                      03 Data
                    </span>
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.55" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.7" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">
<span className="font-mono text-[10px] text-subtle uppercase tracking-wider block mb-1">
                      05 Result
                    </span>
...
<div className="lifecycle-step group flex items-center justify-between w-full opacity-30 transition-all duration-500" data-threshold="0.85" style={{transform: 'scale(1)'}}>
<div className="w-[42%] text-right pr-8">

...
<svg className="lucide lucide-asterisk text-white w-8 h-8 absolute rotate-45" data-lucide="asterisk" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6v12"></path><path d="M17.196 9 6.804 15"></path><path d="m6.804 9 10.392 6"></path></svg>
<svg className="lucide lucide-asterisk absolute w-[32px] h-[32px]" data-icon-replaced="true" data-lucide="asterisk" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '32px', height: '32px', color: 'rgb(249, 115, 22)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6v12"></path><path d="M17.196 9 6.804 15"></path><path d="m6.804 9 10.392 6"></path></svg>
</div>
<span className="text-xl text-white font-sans" style={{}}>Luminous</span>
</div>

<div className="hidden md:flex items-center bg-white/5 border border-white/10 rounded-full px-1 py-1 backdrop-blur-md">
<a className="flex items-center gap-2 text-xs text-white bg-neutral-800/80 border-white/5 border rounded-full pt-1.5 pr-4 pb-1.5 pl-4 shadow-inner" href="/home">
<span className="w-1.5 h-1.5 rounded-full bg-orange-500"></span>
          Home
        </a>
<a className="hover:text-white transition-colors text-xs text-neutral-400 pt-1.5 pr-4 pb-1.5 pl-4" href="/about-us">
          About Us
        </a>
<a className="hover:text-white transition-colors text-xs text-neutral-400 pt-1.5 pr-4 pb-1.5 pl-4" href="/pricing">
          Pricing
        </a>
<button className="hover:text-white transition-colors flex text-xs text-neutral-400 pt-1.5 pr-4 pb-1.5 pl-4 gap-x-1 gap-y-1 items-center" onclick="window.location.href='/features'" role="button">
          Features
          
        </button>
<a className="hover:text-white transition-colors text-xs text-neutral-400 pt-1.5 pr-4 pb-1.5 pl-4" href="/resources">
          Resources
        </a>
</div>

<a className="hidden md:block hover:brightness-110 transition-all text-sm text-white bg-gradient-to-b from-orange-400 to-orange-600 border-white/20 rounded-full border-t pt-2 pr-5 pb-2 pl-5 shadow-[0_0_15px_-3px_rgba(249,115,22,0.4)]" href="/getstarted">
        Get Started
      </a>
</nav>
...
<svg className="lucide lucide-sparkles w-3 h-3 text-orange-400" data-lucide="sparkles" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"></path><path d="M20 2v4"></path><path d="M22 4h-4"></path><circle cx="4" cy="20" r="2"></circle></svg>
<span className="font-sans" style={{}}>Social Growth, Autopilot Mode</span>
</div>
...
<span className="font-sans" style={{}}>Explore design</span>
</button>
...
<span className="font-sans" style={{}}>Total Impressions</span>
</div>
...
<section className="-mt-4 animate-entry delay-700 [animation:animationIn_0.8s_ease-out_0.1s_both] animate-on-scroll lg:-mt-8 lg:px-0 lg:pb-0 max-w-7xl mr-auto ml-auto pt-0 pr-2.5 pb-24 pl-2.5 relative">
...
<svg className="lucide lucide-trending-up text-orange-400" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-3">
<h3 className="text-white text-2xl font-bricolage font-light tracking-tight" style={{}}>
                      Viral Velocity
                    </h3>
...
<div className="text-neutral-500 font-sans" style={{}}>
                        → Impressions:
                        <span className="text-orange-400 ml-1 font-sans" style={{}}>
                          2.4M
                        </span>
</div>
<div className="text-neutral-500 font-sans" style={{}}>
...
<div className="text-[10px] text-neutral-400 mb-1 font-sans" style={{}}>
                        Reach/hr
                      </div>
<div className="text-lg text-white font-sans" style={{}}>
                        84.3K
                      </div>
</div>
<div className="bg-white/5 rounded-lg p-3 ring-1 ring-white/5">
...
<div className="text-lg text-orange-400 font-sans" style={{}}>
                        9.2
                      </div>
</div>
</div>
...
<div className="flex flex-col lg:flex-row lg:items-center mb-3 gap-x-6 gap-y-4 items-start">
<div className="flex flex-col gap-x-y-1 gap-y-1 items-start">
<span className="uppercase text-sm text-orange-400 tracking-widest">
          Featured
        </span>
<span className="leading-none text-7xl font-light text-white/5 tracking-tight font-bricolage">
          01.
        </span>
</div>
...
<button className="group inline-flex gap-2 transition-all hover:bg-neutral-200 whitespace-nowrap font-medium text-black bg-white rounded-full pt-3 pr-6 pb-3 pl-6 shadow-[0_0_20px_rgba(255,255,255,0.3)] gap-x-2 gap-y-2 items-center">
                Start Growing
...
<div className="flex flex-col items-center text-center gap-4 group cursor-pointer">
<div className="w-14 h-14 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-neutral-400 group-hover:text-white group-hover:border-orange-500/30 group-hover:bg-orange-500/10 transition-all duration-300">
<svg className="lucide lucide-message-circle" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<div className="col-span-2 font-sans" style={{}}>Trending Topic</div>
...
<div className="text-right font-sans" style={{}}>842k</div>
...
<svg className="lucide lucide-target text-neutral-400 mb-5 group-hover:text-orange-500 transition-colors duration-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex flex-col items-start group">
<div className="w-8 h-px bg-neutral-700 mb-6 group-hover:bg-orange-500 transition-colors duration-300"></div>
<svg className="lucide lucide-refresh-cw text-neutral-400 mb-5 group-hover:text-orange-500 transition-colors duration-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="w-8 h-px bg-neutral-700 mb-6 group-hover:bg-orange-500 transition-colors duration-300"></div>
<svg className="lucide lucide-shield-check text-neutral-400 mb-5 group-hover:text-orange-500 transition-colors duration-300" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<section className="animate-on-scroll [animation:animationIn_0.8s_ease-out_0.2s_both] max-w-7xl mr-auto ml-auto pt-0 pr-6 pb-0 pl-6">
<section className="animate-entry delay-200 [animation:animationIn_0.8s_ease-out_0.1s_both] animate-on-scroll lg:mx-auto lg:mb-0 bg-gradient-to-tr from-gray-500/0 via-gray-500/10 to-gray-500/0 from-white/0 via-white/10 to-white/0 max-w-7xl rounded-3xl mt-24 mr-auto mb-24 ml-auto pt-10 pr-10 pb-4 pl-10 relative" style={{position: 'relative', -BorderGradient: 'linear-gradient(45deg, rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', -BorderRadiusBefore: '24px'}}>
...
<div className="space-y-2">
<h2 className="md:text-5xl text-4xl font-normal text-white tracking-tight font-bricolage">
              Engineered for
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">
                      Exponential Growth
                    </span>
</h2>
<p className="leading-relaxed text-base text-neutral-400 max-w-2xl">
...
<div className="hidden lg:flex gap-x-2 gap-y-2">
<button className="group inline-flex transition-all hover:bg-neutral-200 whitespace-nowrap font-medium text-black bg-white rounded-full pt-3 pr-6 pb-3 pl-6 shadow-[0_0_20px_rgba(255,255,255,0.3)] gap-x-2 gap-y-2 items-center">
                Compare Plans
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-16 mb-20 w-full">

<div className="group relative flex flex-col p-8 md:p-12 min-h-[420px] rounded-[32px] bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white overflow-hidden shadow-[0_0_40px_-10px_rgba(249,115,22,0.3)] transition-all hover:scale-[1.01] duration-500">
...
<span className="text-orange-100/80 font-mono text-sm tracking-wider">
                  / 01
                </span>
</div>

<div className="z-10 mt-auto relative">
<h3 className="text-4xl md:text-5xl font-semibold tracking-tight text-white mb-6 leading-[1.1] font-bricolage">
            Predictive Intelligence
          </h3>
<p className="text-base font-medium leading-relaxed text-orange-50/90 max-w-md font-sans border-t border-white/20 pt-6">
            While others analyze the past, Luminous predicts the future.
            Our AI identifies viral vectors 48 hours before they peak.
          </p>
</div>

<div className="absolute top-[-20%] right-[-10%] w-[400px] h-[400px] bg-white/20 blur-[100px] rounded-full pointer-events-none mix-blend-overlay">
</div>
<div className="absolute bottom-0 right-0 w-full h-1/2 bg-gradient-to-t from-black/20 to-transparent pointer-events-none">
</div>
</div>

<div className="group relative flex flex-col p-8 md:p-12 min-h-[420px] rounded-[32px] bg-[#0A0A0A] border border-white/5 overflow-hidden transition-all hover:scale-[1.01] duration-500 hover:border-white/10">
...
<div className="flex justify-between items-start z-10 w-full mb-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-orange-500/10 group-hover:border-orange-500/30 transition-colors">
<svg className="lucide lucide-zap text-neutral-400 group-hover:text-orange-500 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>
</svg>
</div>
<span className="text-neutral-600 font-mono text-sm tracking-wider group-hover:text-orange-500/50 transition-colors">
                  / 02
                </span>
</div>
...
<p className="text-base font-medium leading-relaxed text-neutral-500 max-w-md font-sans border-t border-white/5 pt-6 group-hover:text-neutral-400 transition-colors">
...
<div className="flex justify-between items-start z-10 w-full mb-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-orange-500/10 group-hover:border-orange-500/30 transition-colors">
<svg className="lucide lucide-shield-check text-neutral-400 group-hover:text-orange-500 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex justify-between items-start z-10 w-full mb-auto">
<div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-orange-500/10 group-hover:border-orange-500/30 transition-colors">
<svg className="lucide lucide-layers text-neutral-400 group-hover:text-orange-500 transition-colors" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex flex-col lg:flex-row lg:items-center mb-3 gap-x-6 gap-y-4 items-start">
<div className="flex flex-col gap-x-y-1 gap-y-1 items-start">
<span className="uppercase text-sm text-orange-400 tracking-widest">TESTIMONIALS</span>
<span className="leading-none text-7xl font-light text-white/5 tracking-tight font-bricolage">03.</span>
</div>
<div className="space-y-2">
<h2 className="md:text-5xl text-4xl font-normal text-white tracking-tight font-bricolage">Real Results. <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-orange-600">Real Growth.</span></h2>
<p className="leading-relaxed text-base text-neutral-400 max-w-2xl">Hear directly from the creators and brands who have used Luminous to drastically increase their engagement and reach.</p>
<button className="lg:hidden mt-6 w-full sm:w-auto px-6 py-3 bg-orange-600 text-white rounded-lg shadow-lg hover:bg-orange-500 transition-colors whitespace-nowrap font-sans">
                    Start Growing Now
                  </button>
</div>
...
<img alt="Member" className="w-full h-full object-cover transition-opacity duration-300" id="t-image" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/649a17f7-ce90-412e-bc8c-6227953b3ba4_1600w.webp"/>
...
<div className="flex flex-col gap-x-y-1 gap-y-1 items-start">
<span className="uppercase text-sm text-orange-400 tracking-widest">PRICING</span>
<span className="leading-none text-7xl font-light text-white/5 tracking-tight font-bricolage">04.</span>
</div>
<div className="space-y-2">
<h2 className="md:text-5xl text-4xl font-normal text-white tracking-tight font-bricolage">Unlock <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-orange-600">Viral Growth.</span></h2>
</div>
</div>
...
<span className="text-xl font-sans" style={{}}>Creator</span>
...
<h3 className="text-3xl text-white font-bricolage font-light tracking-tight" id="plan-title" style={{}}>
                  Creator
                </h3>
...
<a className="text-neutral-500 hover:text-white transition-colors" href="#">
<svg className="lucide lucide-linkedin w-[18px] h-[18px]" data-icon-replaced="true" data-icon-set="logos" data-logos="linkedin-icon" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '18px', height: '18px'}} viewbox="0 0 256 256" width="18" xmlns="http://www.w3.org/2000/svg">
<path d="M218.123 218.127h-37.931v-59.403c0-14.165-.253-32.4-19.728-32.4c-19.756 0-22.779 15.434-22.779 31.369v60.43h-37.93V95.967h36.413v16.694h.51a39.91 39.91 0 0 1 35.928-19.733c38.445 0 45.533 25.288 45.533 58.186zM56.955 79.27c-12.157.002-22.014-9.852-22.016-22.009s9.851-22.014 22.008-22.016c12.157-.003 22.014 9.851 22.016 22.008A22.013 22.013 0 0 1 56.955 79.27m18.966 138.858H37.95V95.967h37.97zM237.033.018H18.89C8.58-.098.125 8.161-.001 18.471v219.053c.122 10.315 8.576 18.582 18.89 18.474h218.144c10.336.128 18.823-8.139 18.966-18.474V18.454c-.147-10.33-8.635-18.588-18.966-18.453" fill="#ffffff"></path>
</svg>
</a>
</div>
</div>

...
<h2 className="text-[44px] sm:text-6xl lg:text-7xl leading-[0.9] text-zinc-100 mt-2 font-geist font-medium tracking-tighter">
                    Transforming communities worldwide.</h2>
...
<div className="">
<p className="text-sm text-zinc-100 font-medium tracking-tight font-geist">Creating lasting change
                            together</p>
<p className="mt-1 text-sm text-zinc-300 font-geist">Discover how our dedicated programs provide
                            essential resources and support to communities in need across the globe.</p>
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d8a18803-85b3-44b8-8ded-36a46f674b9c_800w.jpg)] bg-cover">
</div>
...
<article className="relative overflow-hidden aspect-[4/3] bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 border border-black/30 rounded-2xl">
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/fed1b639-6302-4656-940e-0f519fb2348b_800w.jpg)] bg-cover">
</div>
<div className="absolute top-3 right-3">
...
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c7e0c43a-8d25-4baf-aedb-f084dd7ecaa9_800w.jpg)] bg-cover">
</div>
<div className="absolute top-3 right-3">
...
<article className="relative overflow-hidden aspect-[4/3] bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 border border-black/30 rounded-2xl">
<div className="absolute inset-0 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a64e6770-50ba-4159-829d-d5f20fab2595_800w.jpg)] bg-cover">
</div>
<div className="absolute top-3 right-3">
...
<div className="absolute bottom-3 left-3 right-3">
<p className="text-white text-lg font-medium tracking-tight leading-tight font-geist">SafeHaven
                            </p>
</div>
</article>
</div>

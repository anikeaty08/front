...
<iconify-icon className="" height="28" icon="simple-icons:shopify" width="96"></iconify-icon>
...
<iconify-icon className="" height="24" icon="solar:alt-arrow-left-outline" style={{color: 'rgb(255, 255, 255)'}} width="24"></iconify-icon>
</div>
...
<iconify-icon className="text-gray-900" height="32" icon="solar:target-linear" style={{color: 'rgb(17, 24, 39)'}} width="32"></iconify-icon>
</div>
...
<img alt="Sofia Little" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-[2rem] overflow-hidden mb-6 relative">
<img alt="James Cohen" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>
...
<div className="group cursor-pointer">
<div className="aspect-[3/4] rounded-[2rem] overflow-hidden mb-6 relative">
<img alt="Maya Rodriguez" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
</div>

...
<canvas className="particles-js-canvas-el" height="1658" style={{width: '100%', height: '100%'}} width="786"></canvas></div>
</div>
<div className="bg-center opacity-70 w-full h-screen bg-cover absolute top-0 blur-sm" data-alpha-mask="80" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c595d20b-42ec-4942-a0cd-07031086f442_3840w.jpg")', maskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 0%, black 80%, transparent)'}}></div>
...
<a className="inline-flex items-center justify-center bg-center w-[100px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/bcb70761-6a38-4c33-b473-8ad0ac012039_1600w.png)] bg-cover rounded" href="#"></a>

<nav className="hidden lg:flex gap-x-8 items-center">
<a className="text-sm text-neutral-300 hover:text-white transition" href="#">About</a>
<a className="text-sm text-neutral-300 hover:text-white transition" href="#">Benefits</a>
<a className="text-sm text-neutral-300 hover:text-white transition" href="#">Features</a>
<a className="text-sm text-neutral-300 hover:text-white transition" href="#">Pricing</a>
<a className="text-sm text-neutral-300 hover:text-white transition" href="#">FAQ</a>
</nav>
...
<svg className="lucide lucide-arrow-right arrow-icon relative z-10" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{transition: '0.4s'}} viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14"></path>
<path d="m12 5 7 7-7 7"></path>
</svg>
<span className="text-gradient relative z-10" style={{background: 'linear-gradient(90deg, rgb(255, 255, 255) 0%, rgba(255, 182, 193, 0.9) 50%, rgb(255, 255, 255) 100%) 0% center / 200% 100% text', WebkitTextFillColor: 'transparent', transition: 'background-position 0.6s'}}>
          Get started
        </span>
</button>
...
<a className="text-base text-neutral-300 hover:text-white transition py-2 px-3 rounded-lg hover:bg-white/5" href="#">About</a>
<a className="text-base text-neutral-300 hover:text-white transition py-2 px-3 rounded-lg hover:bg-white/5" href="#">Benefits</a>
<a className="text-base text-neutral-300 hover:text-white transition py-2 px-3 rounded-lg hover:bg-white/5" href="#">Features</a>
<a className="text-base text-neutral-300 hover:text-white transition py-2 px-3 rounded-lg hover:bg-white/5" href="#">Pricing</a>
<a className="text-base text-neutral-300 hover:text-white transition py-2 px-3 rounded-lg hover:bg-white/5" href="#">FAQ</a>
</nav>
</div>
<style>
    @keyframes slideDown {
...
<img alt="Customer 1" className="w-6 h-6 object-cover rounded-full ring-2 ring-neutral-900" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/5d65d3ad-0fbe-4a33-88e6-e2f43acfa643_800w.webp"/>
<img alt="Customer 2" className="h-6 w-6 rounded-full ring-2 object-cover ring-neutral-900" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/61563867-d875-4481-bc33-80e5be1f705a_320w.webp" style={{}}/>
<img alt="Customer 3" className="w-6 h-6 object-cover ring-neutral-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/eacb0d5f-9d72-4b22-be01-fb1e118870a7_320w.webp"/>
<img alt="Customer 4" className="w-6 h-6 object-cover rounded-full ring-neutral-900/95 ring-2" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6ed20ae5-f8be-4c56-abdd-7784974ad093_320w.webp"/>
</span>
...
<h1 className="sm:text-6xl md:text-7xl text-4xl font-semibold tracking-tight text-center mt-2 mb-2 in-view" data-scroll-animate="blur-up" style={{maskImage: 'linear-gradient(90deg, transparent, black 55%, black 60%, transparent)', opacity: '1', transform: 'translateY(0px)'}}>
...
<p className="sm:text-lg text-base text-neutral-300 text-center mt-5 in-view" data-scroll-animate="fade-up" style={{maskImage: 'linear-gradient(90deg, transparent, black 0%, black 100%, transparent)', opacity: '1', transform: 'translateY(0px)'}}>
          Turn scattered data into clear decisions. Solara reveals patterns,
...
<div className="inner-layer-1 absolute inset-0 rounded-full" style={{background: 'radial-gradient(circle at var(--x) var(--y), rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.2) 40%, transparent 70%)', opacity: '0.6', transition: 'opacity 0.5s', pointerEvents: 'none', zIndex: '2'}}></div>
<div className="inner-layer-2 absolute inset-0 rounded-full" style={{background: 'radial-gradient(ellipse at var(--x) var(--y), rgba(244,63,94,0.4) 0%, rgba(251,113,133,0.2) 30%, transparent 60%)', opacity: '0.4', transition: 'opacity 0.5s', pointerEvents: 'none', filter: 'blur(8px)', zIndex: '3'}}></div>
...
<div className="depth-shadow absolute inset-0 rounded-full" style={{boxShadow: 'rgba(0, 0, 0, 0.3) 0px -4px 8px inset, rgba(255, 255, 255, 0.3) 0px 4px 8px inset', opacity: '0.5', transition: 'opacity 0.5s', pointerEvents: 'none', zIndex: '7'}}></div>
...
<div className="absolute -inset-2 rounded-full" style={{background: 'radial-gradient(circle at center, rgba(244,63,94,0.4) 0%, rgba(251,113,133,0.2) 40%, transparent 70%)', opacity: '0', transition: 'opacity 0.5s ease', filter: 'blur(20px)', pointerEvents: 'none', zIndex: '-1'}}></div>
<style>
...
<span className="font-medium">Solara Console</span>
...
<input className="w-64 rounded-lg pl-9 pr-3 py-2 text-sm placeholder:text-neutral-400 border focus:outline-none focus:ring-2 focus:ring-white/20 bg-white/5 border-white/10" placeholder="Search anything..."/>
</div>
...
<canvas aria-label="Revenue chart" data-canvas="rev" height="188" style={{display: 'block', boxSizing: 'border-box', height: '94px', width: '277px'}} width="554"></canvas>
</div>
...
<div className="h-full">
<canvas className="" data-canvas="growth" height="188" style={{display: 'block', boxSizing: 'border-box', height: '94px', width: '277px'}} width="554"></canvas>
</div>
</div>
</div>
...
<p className="sm:text-lg text-base text-neutral-300 text-center mt-4" style={{opacity: '1', transform: 'translateY(0px)'}}>
            Opinionated defaults, clear insights, and embedded intelligence so
            every team can move with confidence.
          </p>
</div>

<div className="overflow-hidden sm:p-8 bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/0e462543-eb2b-45e3-ab99-f68cecbaef90_1600w.jpg)] max-w-fit bg-cover border rounded-2xl pt-6 pr-6 pb-6 pl-6 relative bg-neutral-900/70 border-white/10" data-card="hero-feature" data-scroll-animate="fade-up">
...
<div className="-top-2 [--fx-filter:blur(10px)_liquid-glass(5,10)_saturate(1.25)_noise(0.5,1,0)] sm:w-80 bg-neutral-900/20 w-64 border-white/10 border rounded-xl px-4 py-4 absolute right-0 backdrop-blur">
<div className="flex items-center justify-between">
...
<div className="mt-3 h-24 rounded-lg border p-2 bg-neutral-900/70 border-white/10">
<div className="h-full">
<canvas className="" data-canvas="hero-line" height="156" style={{display: 'block', boxSizing: 'border-box', height: '78px', width: '204px'}} width="408"></canvas>
</div>
</div>
</div>

<div className="sm:mt-32 lg:mt-24 bg-neutral-900/10 w-full max-w-sm border-white/10 border ring-white/10 ring-1 rounded-xl mt-32 pt-4 pr-4 pb-4 pl-4 relative backdrop-blur [--fx-filter:blur(13px)_liquid-glass(5,10)_saturate(1.25)_noise(0.5,1,0)]">
<div className="text-xs text-neutral-300">Revenue Growth</div>
<div className="text-[13px] text-neutral-400">Weekly report</div>
...
<canvas className="" data-canvas="hero-bars" height="188" style={{display: 'block', boxSizing: 'border-box', height: '94px', width: '259px'}} width="518"></canvas>
...
<div className="bg-neutral-900/70 border-white/10 border rounded-2xl pt-6 pr-6 pb-6 pl-6" data-card="advanced-analytics">
...
<div className="bg-neutral-900/70 border-white/10 border rounded-xl mt-5 pt-4 pr-4 pb-4 pl-4">
<div className="flex items-center justify-between">
...
<div className="overflow-hidden flex bg-neutral-900/70 h-40 border-white/10 border rounded-lg mt-3 pt-4 pr-4 pb-4 pl-4 relative items-center justify-center" style={{background: 'radial-gradient(circle, rgba(255, 255, 255, 0.05) 30%, transparent 70%)'}}>
...
<div className="rounded-2xl border p-6 border-white/10 bg-neutral-900/70" data-card="scalable-solutions">
...
<div className="mt-5 rounded-xl border p-4 border-white/10 bg-neutral-900/70">
<div className="flex items-center justify-between">
<div className="text-sm text-neutral-300">Activities</div>
...
<div className="mt-3 h-36 rounded-lg border p-2 bg-neutral-900/70 border-white/10 relative overflow-hidden" style={{background: 'linear-gradient(135deg, rgba(244,63,94,0.08) 0%, rgba(251,113,133,0.05) 100%)'}}>
<div className="h-full">
<canvas className="" data-canvas="ss-lines" height="252" style={{display: 'block', boxSizing: 'border-box', height: '126px', width: '259px'}} width="518"></canvas>
</div>
...
<span className="text-sm font-medium text-rose-400">Pricing</span>
...
<div aria-label="Billing period" className="inline-flex overflow-hidden rounded-lg mt-6" role="tablist" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(248, 113, 113, 0), rgba(220, 38, 38, 0.25))', -BorderRadiusBefore: '8px', opacity: '1', transform: 'translateY(0px)'}}>
<button aria-controls="pricing-grid" aria-selected="true" className="px-4 py-2 text-sm font-medium bg-white text-neutral-900" data-billing="monthly">
              Monthly
            </button>
<button aria-controls="pricing-grid" aria-selected="false" className="transition hover:bg-white/5 text-sm font-medium text-neutral-300 bg-[radial-gradient(circle_at_right,var(--tw-gradient-stops))] from-red-400/10 to-red-600/0 pt-2 pr-4 pb-2 pl-4" data-billing="annual">
              Annual
            </button>
</div>
</div>
...
<div className="flex flex-col overflow-hidden bg-gradient-to-br from-white/10 to-white/0 rounded-2xl pt-6 pr-6 pb-6 pl-6" data-card="plan-free" id="pricing-card-free" style={{position: 'relative', transformStyle: 'preserve-3d', transform: 'perspective(800px) rotateX(0deg) rotateY(0deg)'}}>
<div className="absolute inset-0 pointer-events-none" style={{background: 'radial-gradient(120% 120% at 93.917% 7.53579%, rgba(244, 63, 94, 0.25) 0%, rgba(244, 63, 94, 0.12) 35%, rgba(244, 63, 94, 0.05) 55%, rgba(0, 0, 0, 0) 75%)', opacity: '0', transition: 'opacity 0.3s'}}></div>
<div className="text-sm relative text-neutral-300">Free</div>
...
<div className="text-sm text-neutral-400">per user/month</div>
</div>
...
<button className="w-full inline-flex items-center justify-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition border-rose-400/40 text-rose-400 hover:bg-white/5">
                Get started
              </button>
</div>
...
<div className="overflow-hidden flex flex-col rounded-2xl ring-1 pt-6 pr-6 pb-6 pl-6 relative bg-neutral-900/80 ring-white/10" data-card="plan-pro" id="pricing-card-pro" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', -BorderRadiusBefore: '16px', transformStyle: 'preserve-3d', transform: 'translateY(0px)', opacity: '1'}}>

<div className="absolute inset-0 pointer-events-none" style={{background: 'radial-gradient(120% 120% at 79.7819% 94.743%, rgba(244, 63, 94, 0.25) 0%, rgba(244, 63, 94, 0.12) 35%, rgba(244, 63, 94, 0.05) 55%, rgba(0, 0, 0, 0) 75%)', transition: 'opacity 0.3s'}}></div>
<div className="relative flex items-center justify-between">
<div className="text-sm text-neutral-300">Pro</div>
...
<div className="relative text-neutral-400">For growing teams</div>
...
<button className="w-full inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition bg-white text-neutral-900 hover:bg-neutral-100">
                Get started
              </button>
</div>
...
<div className="flex flex-col overflow-hidden bg-gradient-to-br from-white/10 to-white/0 rounded-2xl pt-6 pr-6 pb-6 pl-6" data-card="plan-enterprise" id="pricing-card-enterprise" style={{position: 'relative', transformStyle: 'preserve-3d', transform: 'perspective(800px) rotateX(0deg) rotateY(0deg)', opacity: '1'}}>
<div className="absolute inset-0 pointer-events-none" style={{background: 'radial-gradient(120% 120% at 37.4425% 95.515%, rgba(244, 63, 94, 0.25) 0%, rgba(244, 63, 94, 0.12) 35%, rgba(244, 63, 94, 0.05) 55%, rgba(0, 0, 0, 0) 75%)', opacity: '0', transition: 'opacity 0.3s'}}></div>
<div className="text-sm relative text-neutral-300">Enterprise</div>
<div className="mt-2 flex items-baseline gap-2 relative">
<div aria-atomic="true" aria-live="polite" className="text-3xl font-semibold tracking-tight">
...
<img alt="Reviewer 1" className="w-6 h-6 object-cover ring-neutral-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/11f35e13-4c7b-438c-b1cc-8f7b6e822e1b_320w.webp"/>
<img alt="Reviewer 2" className="w-6 h-6 object-cover ring-neutral-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/1c97346f-367a-4525-88c9-983c427260ae_320w.webp"/>
<img alt="Reviewer 3" className="w-6 h-6 object-cover ring-neutral-900 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2ea4b3ee-c3f5-4111-8dde-ef8bea1bc03a_320w.webp"/>
<img alt="Reviewer 4" className="w-6 h-6 object-cover rounded-full ring-neutral-900 ring-2" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/58d960c3-f652-497d-9e25-a9bc4d765213_320w.webp"/>
</span>
...
<img alt="Aisha Green" className="w-10 h-10 object-cover ring-white/10 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/43fc57bc-1266-44cf-a579-3f8ec64d4431_320w.webp"/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Priya Patel" className="w-10 h-10 object-cover ring-white/10 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8a90d32f-809f-4383-b71f-6a9c50621b69_320w.jpg"/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Jonas Weber" className="w-10 h-10 object-cover ring-white/10 ring-2 rounded-full" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c4ee565a-2084-483b-8358-9fc06da5ee99_320w.jpg"/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Aisha Green" className="w-10 h-10 object-cover rounded-full ring-white/10 ring-2" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f19d9627-4570-4c87-b42e-f42bc9d1bc31_320w.jpg"/>
<div className="">
<div className="text-sm font-medium">Aisha Green</div>
<div className="text-xs text-neutral-400">
                      Head of Business Intelligence
...
<div className="mt-5 flex items-center gap-3">
<img alt="Michael Chen" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f804111a-fe24-4660-b754-0f3654213f91_320w.jpg" style={{}}/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Rachel Adams" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/decdab76-d615-4089-a761-525ee4dc4a0f_320w.webp" style={{}}/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Liam O'Connor" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/17d18233-806b-40ae-aeda-9251f822ee0a_320w.webp"/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Michael Chen" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/f4bda977-4e02-4ce3-b6d3-1f8a5d3197db_320w.jpg" style={{}}/>
<div className="">
<div className="text-sm font-medium">Michael Chen</div>
<div className="text-xs text-neutral-400">IT Security Lead</div>
</div>
...
<div className="mt-5 flex items-center gap-3">
<img alt="Carlos Rivera" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/05c24471-1ab5-4e25-ab8c-e6fd10e1f913_320w.jpg" style={{}}/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Sofia Martinez" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7f5162d4-7171-4641-9041-6611d52f432e_320w.webp" style={{}}/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Noah Bennett" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c1080949-1bf1-41d5-b2fb-6ff27d985c7d_320w.jpg" style={{}}/>
<div className="">
...
<div className="mt-5 flex items-center gap-3">
<img alt="Carlos Rivera" className="h-10 w-10 rounded-full object-cover ring-2 ring-white/10" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/58013d7d-eac3-419f-81c0-aaf209ded685_320w.webp" style={{}}/>
<div className="">
<div className="text-sm font-medium">Carlos Rivera</div>
<div className="text-xs text-neutral-400">CEO</div>
</div>
...
<div className="rounded-2xl border overflow-hidden border-white/10 bg-neutral-900/70" data-card="cta-primary" data-scroll-animate="blur-up">
...
<div className="bg-center bg-neutral-950/50 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/37503864-ed52-4579-b3a4-02e1397fe2d3_3840w.jpg)] bg-cover absolute top-0 right-0 bottom-0 left-0"></div>
...
<div className="sparkle-container" style={{position: 'absolute', inset: '0px', borderRadius: 'inherit', overflow: 'hidden', pointerEvents: 'none', opacity: '0.6', transition: 'opacity 0.4s'}}>
...
<svg className="orbit-sparkles" style={{position: 'absolute', inset: '-20px', width: 'calc(100% + 40px)', height: 'calc(100% + 40px)', pointerEvents: 'none', opacity: '0', transition: 'opacity 0.4s'}} viewbox="0 0 200 100">
...
<button className="inline-flex transition overflow-hidden group text-sm text-white/90 rounded-full pt-3 pr-5 pb-3 pl-5 relative gap-x-2 gap-y-2 items-center" onmousemove="const rect = this.getBoundingClientRect(); const x = event.clientX - rect.left; const y = event.clientY - rect.top; const centerX = rect.width / 2; const centerY = rect.height / 2; const rotateX = ((y - centerY) / centerY) * -15; const rotateY = ((x - centerX) / centerX) * 15; this.style.transform = `perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) translateZ(25px)`; this.style.setProperty('--x', ((x / rect.width) * 100) + '%'); this.style.setProperty('--y', ((y / rect.height) * 100) + '%');" onmouseout="this.style.transform='perspective(1000px) rotateX(0deg) rotateY(0deg) translateZ(15px)'; this.style.boxShadow='0 8px 32px rgba(0,0,0,0.3), inset 0 2px 4px rgba(255,255,255,0.4), inset 0 -2px 4px rgba(0,0,0,0.2), 0 0 0 1px rgba(255,255,255,0.1) inset'; this.querySelector('.inner-layer-1').style.opacity='0.6'; this.querySelector('.inner-layer-2').style.opacity='0.4'; this.querySelector('.light-sweep').style.transform='translate(-150%, 150%) rotate(45deg)'; this.querySelector('.depth-shadow').style.opacity='0.5';" onmouseover="this.style.transform='perspective(1000px) rotateX(-10deg) rotateY(8deg) translateZ(25px)'; this.style.boxShadow='0 20px 60px rgba(0,0,0,0.4), inset 0 3px 6px rgba(255,255,255,0.5), inset 0 -3px 6px rgba(0,0,0,0.3), 0 0 0 1px rgba(255,255,255,0.2) inset, 0 0 60px rgba(244,63,94,0.4)'; this.querySelector('.inner-layer-1').style.opacity='1'; this.querySelector('.inner-layer-2').style.opacity='0.8'; this.querySelector('.light-sweep').style.transform='translate(150%, -150%) rotate(45deg)'; this.querySelector('.depth-shadow').style.opacity='1';" style={{-X: '97.23839606494748%', -Y: '31.254402809449015%', background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.05) 100%)', border: '1px solid rgba(255, 255, 255, 0.3)', boxShadow: 'rgba(0, 0, 0, 0.3) 0px 8px 32px, rgba(255, 255, 255, 0.4) 0px 2px 4px inset, rgba(0, 0, 0, 0.2) 0px -2px 4px inset, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset', backdropFilter: 'blur(20px)', transformStyle: 'preserve-3d', transition: '0.5s cubic-bezier(0.4, 0, 0.2, 1)', transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg) translateZ(15px)'}}>
<div className="absolute inset-0 rounded-full" style={{background: 'linear-gradient(135deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.2) 50%, rgba(255,255,255,0.05) 100%)', pointerEvents: 'none', zIndex: '1'}}></div>
<div className="inner-layer-1 absolute inset-0 rounded-full" style={{background: 'radial-gradient(circle at var(--x) var(--y), rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.2) 40%, transparent 70%)', opacity: '0.6', transition: 'opacity 0.5s', pointerEvents: 'none', zIndex: '2'}}></div>
<div className="inner-layer-2 absolute inset-0 rounded-full" style={{background: 'radial-gradient(ellipse at var(--x) var(--y), rgba(244,63,94,0.4) 0%, rgba(251,113,133,0.2) 30%, transparent 60%)', opacity: '0.4', transition: 'opacity 0.5s', pointerEvents: 'none', filter: 'blur(8px)', zIndex: '3'}}></div>
<div className="light-sweep absolute inset-0 rounded-full" style={{background: 'linear-gradient(135deg, transparent 0%, rgba(255, 255, 255, 0.8) 50%, transparent 100%)', transform: 'translate(-150%, 150%) rotate(45deg)', transition: 'transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)', pointerEvents: 'none', filter: 'blur(6px)', width: '200%', height: '200%', top: '-50%', left: '-50%', zIndex: '4'}}></div>
...
<a className="inline-flex items-center justify-center bg-center mix-blend-screen w-[100px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/bcb70761-6a38-4c33-b473-8ad0ac012039_1600w.png)] bg-cover rounded" href="#"></a>

<nav className="grid grid-cols-3 sm:flex sm:flex-row items-center gap-4 text-sm">
<a className="transition text-neutral-300 hover:text-white" href="#">
              Why us
            </a>
<a className="transition text-neutral-300 hover:text-white" href="#">
              Benefits
...
<div className="flex items-center gap-3">
<a aria-label="LinkedIn" className="inline-flex items-center justify-center w-6 h-6 rounded bg-rose-500 hover:opacity-90 transition text-white" href="#">
...
<a aria-label="Instagram" className="inline-flex items-center justify-center w-6 h-6 rounded border transition border-white/10 text-neutral-300 hover:text-white hover:bg-white/5" href="#">
<svg className="lucide lucide-instagram w-3.5 h-3.5" data-lucide="instagram" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="5" ry="5" width="20" x="2" y="2"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
</a>
<a aria-label="Twitter" className="inline-flex items-center justify-center w-6 h-6 rounded border transition border-white/10 text-neutral-300 hover:text-white hover:bg-white/5" href="#">
...
<div className="absolute w-full h-32 bg-gradient-to-t from-rose-500 via-rose-500 to-transparent" style={{animation: 'glowDown 4s ease-in-out infinite', filter: 'blur(2px)', opacity: '0.8'}}></div>
</div>
</div>

...
<svg className="lucide lucide-menu text-white w-4 h-4" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
</button>
</nav>
...
<div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-[#0b0b0c]" style={{}}></div>
...
<button className="bg-white/5 hover:bg-white/10 text-white border border-white/10 px-6 py-3 rounded-full font-medium text-sm transition-colors flex items-center gap-2 backdrop-blur-sm" style={{}}>
                        Contact us
...
<div className="group relative aspect-[4/5] rounded-2xl overflow-hidden cursor-pointer border border-white/5">
<img alt="Living Room" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1616486338812-3dadae4b4f9d?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0c]/90 via-black/20 to-transparent"></div>
<div className="absolute top-4 left-4">
<div className="px-3 py-1.5 rounded-full bg-white/90 backdrop-blur-md text-xs font-semibold text-black shadow-sm">
                            Trending
...
<div className="group relative aspect-[4/5] rounded-2xl overflow-hidden cursor-pointer border border-white/5">
<img alt="Bedroom" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1616594039964-40891a909639?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0c]/90 via-black/20 to-transparent"></div>
<div className="absolute top-4 left-4">
<div className="px-3 py-1.5 rounded-full bg-white/90 backdrop-blur-md text-xs font-semibold text-black shadow-sm">
                            Available
...
<div className="group relative aspect-[4/5] rounded-2xl overflow-hidden cursor-pointer border border-white/5">
<img alt="Pool" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1572331165267-854da2b00cc3?q=80&amp;w=800&amp;auto=format&amp;fit=crop"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0c]/90 via-black/20 to-transparent"></div>
<div className="absolute top-4 left-4">
<div className="px-3 py-1.5 rounded-full bg-white/90 backdrop-blur-md text-xs font-semibold text-black shadow-sm">
                            Seasonal
...
<div className="bg-[#121212] border border-white/5 p-8 rounded-2xl hover:border-white/10 transition-colors group" style={{}}>
...
<div className="bg-[#121212] border border-white/5 p-8 rounded-2xl hover:border-white/10 transition-colors group" style={{}}>
<div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 transition-colors bg-amber-500/10 group-hover:bg-amber-500/20">
<svg className="lucide lucide-trending-up w-6 h-6 text-amber-500" data-lucide="trending-up" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 7h6v6"></path><path d="m22 7-8.5 8.5-5-5L2 17"></path></svg>
</div>
...
<section className="py-24 bg-[#0b0b0c]" style={{}}>
<div className="max-w-7xl mx-auto px-6 lg:px-12">
...
<section className="py-24 bg-[#0b0b0c] overflow-hidden" style={{}}>
<div className="max-w-7xl mx-auto px-6 lg:px-12">
...
<div className="bg-[#121212] rounded-2xl overflow-hidden border border-white/5 p-6 pb-8" style={{}}>
...
<section className="py-24 bg-[#0b0b0c] relative" style={{}}>
...
<div className="bg-[#141414] hover:bg-[#1a1a1a] rounded-lg border border-white/5 p-5 flex justify-between items-center cursor-pointer transition-colors group" style={{}}>
<span className="text-slate-200 font-medium text-base">How do I start buying a home?</span>
<svg className="lucide lucide-plus text-slate-500 w-5 h-5 transition-colors group-hover:text-amber-300" data-lucide="plus" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg>
</div>
<div className="bg-[#141414] hover:bg-[#1a1a1a] rounded-lg border border-white/5 p-5 flex justify-between items-center cursor-pointer transition-colors group" style={{}}>
...
<footer className="bg-[#0b0b0c] border-t border-white/5 pt-24 pb-12 relative z-10" style={{}}>
<div className="max-w-7xl mx-auto px-6 lg:px-12">
...
<p className="text-slate-400 text-lg leading-relaxed mb-10 max-w-md" style={{}}>
...
<a className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-slate-300 transition-colors" href="#" style={{}}>
...
<div>
<p className="text-white font-medium mb-1">Adress</p>
...
<div className="bg-[#141414] p-8 rounded-2xl border border-white/5" style={{}}>
<form className="space-y-5">
<div className="grid grid-cols-2 gap-5">
<div className="space-y-2">
<label className="text-xs font-medium text-slate-300 ml-1">Name</label>
<input className="w-full bg-[#1e1e1e] border border-white/5 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 transition-all focus:ring-amber-300/50" placeholder="Your name" type="text"/>
</div>
<div className="space-y-2">
<label className="text-xs font-medium text-slate-300 ml-1">Surname</label>
<input className="w-full bg-[#1e1e1e] border border-white/5 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 transition-all focus:ring-amber-300/50" placeholder="Your surname" type="text"/>
</div>
</div>
<div className="grid grid-cols-2 gap-5">
<div className="space-y-2">
<label className="text-xs font-medium text-slate-300 ml-1">Mail</label>
<input className="w-full bg-[#1e1e1e] border border-white/5 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 transition-all focus:ring-amber-300/50" placeholder="Your email address" type="email"/>
</div>
<div className="space-y-2">
<label className="text-xs font-medium text-slate-300 ml-1">Phone</label>
<input className="w-full bg-[#1e1e1e] border border-white/5 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 transition-all focus:ring-amber-300/50" placeholder="Your phone number" type="tel"/>
</div>
</div>
<div className="space-y-2">
<label className="text-xs font-medium text-slate-300 ml-1">Message</label>
<textarea className="w-full bg-[#1e1e1e] border border-white/5 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 transition-all resize-none focus:ring-amber-300/50" placeholder="How can we help you" rows="4"></textarea>
</div>
<button className="mt-4 text-[#0b0b0c] px-6 py-3 rounded-full font-medium text-sm transition-colors flex items-center gap-2 hover:bg-amber-200 bg-amber-500" type="button">
                            Send the message
                            <svg className="lucide lucide-arrow-up-right w-4 h-4" data-lucide="arrow-up-right" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
</button>
</form>
...
<span className="text-white text-xl font-script">Solflare</span>
<div className="flex gap-6 text-xs text-slate-500">
<a className="hover:text-slate-300 transition-colors" href="#">About</a>
<a className="hover:text-slate-300 transition-colors" href="#">Properties</a>
<a className="hover:text-slate-300 transition-colors" href="#">Testimonials</a>
<a className="hover:text-slate-300 transition-colors" href="#">Blog</a>
<a className="hover:text-slate-300 transition-colors" href="#">FAQ</a>
<a className="hover:text-slate-300 transition-colors" href="#">Licenses</a>
</div>
</div>
</div>
</footer>

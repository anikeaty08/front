...
<div className="energy-streak layer-far" style={{left: '2%', animationDuration: '22s', animationDelay: '-2s', -StreakOpacity: '0.08'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '15%', animationDuration: '25s', animationDelay: '-10s', -StreakOpacity: '0.1'}}></div>
<div className="energy-streak layer-mid" style={{left: '22%', animationDuration: '14s', animationDelay: '-5s', -StreakOpacity: '0.18'}}></div>
<div className="energy-streak layer-mid" style={{left: '35%', animationDuration: '16s', animationDelay: '-1s', -StreakOpacity: '0.2'}}></div>
<div className="energy-streak layer-near star hidden md:block" style={{left: '42%', animationDuration: '7s', animationDelay: '-3s', -StreakOpacity: '0.5'}}></div>
<div className="energy-streak layer-far" style={{left: '50%', animationDuration: '24s', animationDelay: '-12s', -StreakOpacity: '0.09'}}></div>
<div className="energy-streak layer-mid" style={{left: '60%', animationDuration: '13s', animationDelay: '-8s', -StreakOpacity: '0.19'}}></div>
<div className="energy-streak layer-near" style={{left: '68%', animationDuration: '8s', animationDelay: '-4s', -StreakOpacity: '0.4'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '75%', animationDuration: '26s', animationDelay: '-6s', -StreakOpacity: '0.1'}}></div>
<div className="energy-streak layer-mid" style={{left: '82%', animationDuration: '15s', animationDelay: '-9s', -StreakOpacity: '0.22'}}></div>
<div className="energy-streak layer-mid" style={{left: '90%', animationDuration: '12s', animationDelay: '-2s', -StreakOpacity: '0.25'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '96%', animationDuration: '29s', animationDelay: '-10s', -StreakOpacity: '0.08'}}></div>
</div>

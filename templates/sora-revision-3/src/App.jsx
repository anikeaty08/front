...
<div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-blue-50/30 dark:bg-[#020204] transition-colors duration-500">
...
<div className="energy-streak layer-far" style={{left: '2%', animationDuration: '22s', animationDelay: '-2s', '--streak-opacity': '0.08'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '15%', animationDuration: '25s', animationDelay: '-10s', '--streak-opacity': '0.1'}}></div>
<div className="energy-streak layer-mid" style={{left: '22%', animationDuration: '14s', animationDelay: '-5s', '--streak-opacity': '0.18'}}></div>
<div className="energy-streak layer-mid" style={{left: '35%', animationDuration: '16s', animationDelay: '-1s', '--streak-opacity': '0.2'}}></div>
<div className="energy-streak layer-near star hidden md:block" style={{left: '42%', animationDuration: '7s', animationDelay: '-3s', '--streak-opacity': '0.5'}}></div>
<div className="energy-streak layer-far" style={{left: '50%', animationDuration: '24s', animationDelay: '-12s', '--streak-opacity': '0.09'}}></div>
<div className="energy-streak layer-mid" style={{left: '60%', animationDuration: '13s', animationDelay: '-8s', '--streak-opacity': '0.19'}}></div>
<div className="energy-streak layer-near" style={{left: '68%', animationDuration: '8s', animationDelay: '-4s', '--streak-opacity': '0.4'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '75%', animationDuration: '26s', animationDelay: '-6s', '--streak-opacity': '0.1'}}></div>
<div className="energy-streak layer-mid" style={{left: '82%', animationDuration: '15s', animationDelay: '-9s', '--streak-opacity': '0.22'}}></div>
<div className="energy-streak layer-mid" style={{left: '90%', animationDuration: '12s', animationDelay: '-2s', '--streak-opacity': '0.25'}}></div>
<div className="energy-streak layer-far hidden md:block" style={{left: '96%', animationDuration: '29s', animationDelay: '-10s', '--streak-opacity': '0.08'}}></div>
</div>
...
<div aria-hidden="true" className="absolute inset-0 z-0 pointer-events-none overflow-hidden chaos-container" id="chaos-container">
...
<div className="relative w-full max-w-[320px] md:max-w-[360px] perspective-dramatic mx-auto group phone-wrapper-trigger">

<div className="absolute inset-0 z-[-1] rounded-[3rem] bg-blue-500/0 transition-all duration-700 ease-out group-hover:bg-blue-400/10 dark:group-hover:bg-blue-500/10 blur-3xl scale-95 group-hover:scale-110"></div>

...
<span className="flex items-center gap-2 text-[#888888]"><iconify-icon icon="solar:verified-check-linear"></iconify-icon> Agréé VHU</span>
<span className="flex items-center gap-2 text-[#888888]"><iconify-icon icon="solar:map-point-linear"></iconify-icon> Toute l'Île-de-France</span>
</div>
</div>
</header>
...
<span className="font-display text-xs md:text-sm font-medium uppercase tracking-widest text-[#888888]">Disponible maintenant — 24h/24, 7j/7</span>
</div>
...
<a className="group block mb-12" href="tel:+33753201967">
...
<a className="flex-1 bg-[#E30613] text-white font-display font-bold uppercase tracking-tight text-lg py-5 px-6 flex items-center justify-center gap-3 hover:bg-white hover:text-[#0A0A0A] transition-all group border border-transparent" href="tel:+33753201967">
<iconify-icon className="text-2xl group-hover:animate-ring" icon="solar:phone-calling-linear" strokeWidth="2"></iconify-icon>
                    Appeler maintenant
                </a>
<a className="flex-1 bg-[#25D366] text-white font-display font-bold uppercase tracking-tight text-lg py-5 px-6 flex items-center justify-center gap-3 hover:bg-white hover:text-[#0A0A0A] transition-all border border-transparent" href="https://wa.me/33753201967?text=Bonjour,%20je%20souhaite%20faire%20enlever%20mon%20épave%20en%20Île-de-France." rel="noopener" target="_blank">
<iconify-icon className="text-2xl" icon="solar:chat-round-dots-linear" strokeWidth="2"></iconify-icon>
                    Écrire sur WhatsApp
                </a>
</div>
...
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:truck-linear"></iconify-icon>
...
<div className="bg-[#1A1A1A] p-8 border border-transparent hover:border-[#E30613] transition-colors group">
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:document-text-linear"></iconify-icon>
...
<div className="bg-[#1A1A1A] p-8 border border-transparent hover:border-[#E30613] transition-colors group">
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:leaf-linear"></iconify-icon>
...
<div className="bg-[#1A1A1A] p-8 border border-transparent hover:border-[#E30613] transition-colors group">
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:danger-triangle-linear"></iconify-icon>
...
<div className="bg-[#1A1A1A] p-8 border border-transparent hover:border-[#E30613] transition-colors group">
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:settings-linear"></iconify-icon>
...
<div className="bg-[#1A1A1A] p-8 border border-transparent hover:border-[#E30613] transition-colors group">
<iconify-icon className="text-4xl text-[#E30613] mb-6 group-hover:scale-110 transition-transform" icon="solar:clipboard-list-linear"></iconify-icon>
...
<div className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] text-[#E30613] border border-[#333]"><iconify-icon className="text-xl" icon="solar:routing-2-linear"></iconify-icon></div>
<span className="font-medium">Voitures</span> <span className="text-sm text-[#888888] ml-auto">Toutes marques</span>
</li>
<li className="flex items-center gap-4 text-lg">
<div className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] text-[#E30613] border border-[#333]"><iconify-icon className="text-xl" icon="solar:bicycle-linear"></iconify-icon></div>
<span className="font-medium">Motos et scooters</span>
</li>
<li className="flex items-center gap-4 text-lg">
<div className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] text-[#E30613] border border-[#333]"><iconify-icon className="text-xl" icon="solar:bus-linear"></iconify-icon></div>
<span className="font-medium">Utilitaires et camionnettes</span>
</li>
<li className="flex items-center gap-4 text-lg">
<div className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] text-[#E30613] border border-[#333]"><iconify-icon className="text-xl" icon="solar:delivery-linear"></iconify-icon></div>
<span className="font-medium">Camions et poids lourds</span>
</li>
<li className="flex items-center gap-4 text-lg">
<div className="w-10 h-10 flex items-center justify-center bg-[#1A1A1A] text-[#E30613] border border-[#333]"><iconify-icon className="text-xl" icon="solar:fire-square-linear"></iconify-icon></div>
...
<iconify-icon className="text-3xl text-[#E30613] mb-4" icon="solar:wallet-money-linear"></iconify-icon>
...
<div className="border border-[#222] p-6 bg-[#1A1A1A]">
<iconify-icon className="text-3xl text-[#E30613] mb-4" icon="solar:bolt-linear"></iconify-icon>
...
<div className="border border-[#222] p-6 bg-[#1A1A1A]">
<iconify-icon className="text-3xl text-[#E30613] mb-4" icon="solar:shield-check-linear"></iconify-icon>
...
<div className="border border-[#222] p-6 bg-[#1A1A1A]">
<iconify-icon className="text-3xl text-[#E30613] mb-4" icon="solar:file-check-linear"></iconify-icon>
...
<a className="bg-[#E30613] text-white font-display font-bold uppercase tracking-tight text-xl py-6 px-10 hover:bg-white hover:text-[#0A0A0A] transition-colors flex items-center gap-4" href="tel:+33753201967">
...
<summary className="flex items-center justify-between p-6 cursor-pointer font-display font-bold uppercase tracking-tight text-lg select-none">
                        ...
                        <iconify-icon className="text-[#E30613] text-xl transition-transform group-open:rotate-180" icon="solar:alt-arrow-down-linear"></iconify-icon>
</summary>
...
<a className="flex-1 bg-[#0A0A0A] text-white font-display font-bold uppercase tracking-tight text-lg md:text-xl py-6 px-6 flex items-center justify-center gap-3 hover:bg-[#1A1A1A] transition-colors border-2 border-transparent" href="tel:+33753201967">
<iconify-icon className="text-3xl" icon="solar:phone-calling-linear" strokeWidth="2"></iconify-icon>
                    Appeler 07 53 20 19 67
                </a>
<a className="sm:flex-none sm:w-1/3 bg-[#25D366] text-white font-display font-bold uppercase tracking-tight text-lg md:text-xl py-6 px-6 flex items-center justify-center gap-3 hover:bg-green-600 transition-colors border-2 border-transparent" href="https://wa.me/33753201967?text=Bonjour,%20je%20souhaite%20faire%20enlever%20mon%20épave%20en%20Île-de-France." rel="noopener" target="_blank">
<iconify-icon className="text-3xl" icon="solar:chat-round-dots-linear" strokeWidth="2"></iconify-icon>
                    WhatsApp
                </a>
</div>
</div>
...
<a className="flex items-center gap-3 text-[#E30613] font-display font-bold text-2xl hover:text-white transition-colors" href="tel:+33753201967">
                            07 53 20 19 67
                        </a>
<a className="flex items-center gap-3 text-[#25D366] font-medium text-sm hover:text-white transition-colors" href="https://wa.me/33753201967?text=Bonjour,%20je%20souhaite%20faire%20enlever%20mon%20épave%20en%20Île-de-France." rel="noopener" target="_blank">
<iconify-icon className="text-xl" icon="solar:chat-round-dots-linear"></iconify-icon> Contact WhatsApp
                        </a>
<span className="flex items-center gap-3 text-[#888888] font-medium text-sm">
<iconify-icon className="text-xl" icon="solar:letter-linear"></iconify-icon> contact@sosepaveidf.fr
                        </span>
</div>
</div>
...
<a aria-label="Appeler maintenant" className="w-14 h-14 md:w-16 md:h-16 bg-[#E30613] text-white flex items-center justify-center shadow-[0_0_20px_rgba(227,6,19,0.3)] hover:bg-white hover:text-[#E30613] transition-all group relative" href="tel:+33753201967" title="Appeler maintenant">

<span className="absolute inset-0 border-2 border-[#E30613] animate-ping opacity-50"></span>
<iconify-icon className="text-2xl md:text-3xl relative z-10 group-hover:animate-ring" icon="solar:phone-calling-linear" strokeWidth="2"></iconify-icon>
</a>

<a aria-label="Message WhatsApp" className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] text-white flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:bg-white hover:text-[#25D366] transition-all relative" href="https://wa.me/33753201967?text=Bonjour,%20je%20souhaite%20faire%20enlever%20mon%20épave%20en%20Île-de-France.%0A%0AVoici%20mes%20infos%20:%0A-%20Ville%20/%20code%20postal%20:%0A-%20Marque%20et%20modèle%20du%20véhicule%20:%0A-%20État%20du%20véhicule%20:%0A%0AMerci." rel="noopener" target="_blank" title="Message WhatsApp">
<span className="absolute inset-0 border-2 border-[#25D366] animate-ping opacity-20"></span>
<iconify-icon className="text-2xl md:text-3xl relative z-10" icon="solar:chat-round-dots-linear" strokeWidth="2"></iconify-icon>
</a>
</div>

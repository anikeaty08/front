...
<span>Nie zamykaj tej strony.</span>
<span className="text-emerald-400">
              Istnieje szansa na powiększenie Twojego zamówienia o pakiet.
            </span>
</div>
...
<a className="bg-zinc-800 text-zinc-200 px-8 py-5 rounded-full text-xl font-medium border border-zinc-700 hover:bg-zinc-700 hover:text-white transition-colors flex items-center justify-center w-full sm:w-auto text-center" href="https://cart.easy.tools/checkout/73623231/pakiet">
...
<span className="text-base font-normal text-zinc-100 leading-snug">
                Bezpłatna Lekcja - “Projektowanie dużej ilości grafik oraz
                filmów do kampanii reklamowych”
              </span>
</div>
</div>
...
<a className="w-full rounded-full bg-emerald-500 hover:bg-emerald-400 transition-colors duration-300 px-6 py-4 text-lg font-medium text-white shadow-[0_0_30px_rgba(16,185,129,0.25)] flex items-center justify-center gap-2 group" href="https://cart.easy.tools/checkout/73623231/pakiet">
...
<a className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white font-medium text-xl sm:text-2xl px-8 sm:px-12 py-5 sm:py-6 rounded-full transition-all duration-300 shadow-[0_0_40px_-10px_rgba(16,185,129,0.8)] hover:shadow-[0_0_60px_-15px_rgba(16,185,129,1)] hover:-translate-y-1 w-full sm:w-auto z-10" href="https://cart.easy.tools/checkout/73623231/pakiet">

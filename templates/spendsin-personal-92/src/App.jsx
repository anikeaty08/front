...
<a className="hover:underline decoration-2 underline-offset-4" href="#portfolio">
            Portfolio
          </a>
...
<span className="text-xs font-bold tracking-wide uppercase">
              For contractors doing $5–10M where growth is breaking the process.
            </span>
</div>
<h1 className="text-5xl md:text-7xl tracking-tight leading-[1] mb-8 font-medium">
<span className="block text-2xl md:text-3xl font-semibold mb-6 tracking-normal text-zinc-800 font-sans leading-snug">
              For contractors doing $5–10M where growth is breaking the process.
            </span>
            Stop losing hours
            <br/>
...
<p className="text-xl text-zinc-600 mb-10 leading-relaxed font-medium">
            Your bidding, job tracking, and scheduling aren't as tight as you
            think. Run the audit. Then replace the spreadsheets with a system
            that actually works. The real question is how long you keep putting
            it off.
          </p>
...
<div className="text-sm font-medium">
                  "Added ₹500 for coffee to 'Dining' category."
                </div>
</div>
</div>
</div>
...
<p className="mt-6 text-xl text-zinc-600 font-medium max-w-2xl mx-auto leading-relaxed">
            We help construction companies eliminate chaos by designing reliable
            processes tailored to how you build.
          </p>
</div>
...
<span className="text-5xl text-black/40 block mb-6 font-bold">01</span>
<h3 className="text-2xl leading-tight mb-4 font-bold">
              Workflow Mapping
            </h3>
<p className="font-medium text-zinc-800 mb-8 flex-1">
              We analyze your current workflows to uncover bottlenecks and
              delays. Each step is clearly mapped so everyone understands what
              needs to happen and when.
            </p>
<a className="inline-block font-bold hover:underline mt-auto" href="#">
              Learn More →
            </a>
</div>
...
<span className="text-5xl text-black/40 block mb-6 font-bold">02</span>
<h3 className="text-2xl leading-tight mb-4 font-bold">
              Standard Operating Procedures
            </h3>
<p className="font-medium text-zinc-800 mb-8 flex-1">
              We create clear, repeatable SOPs for critical tasks, customized to
              your team, your projects, and how you actually work.
            </p>
<a className="inline-block font-bold hover:underline mt-auto" href="#">
              Learn More →
            </a>
...
<span className="text-5xl text-black/40 block mb-6 font-bold">03</span>
<h3 className="text-2xl leading-tight mb-4 font-bold">
              Digital Automation
            </h3>
<p className="font-medium text-zinc-800 mb-8 flex-1">
              Implementation of digital tools to reduce manual work. Scheduling,
              documentation, and reporting become faster and easier to manage.
            </p>
<a className="inline-block font-bold hover:underline mt-auto" href="#">
              Learn More →
            </a>
...
<p className="text-lg font-medium mb-8">
            Stop switching between apps. Track your Mutual Funds (MFAPI) and
            Stocks (Yahoo Finance) alongside your daily expenses. Visualize your
...
<a className="inline-block font-bold hover:underline mt-8" href="#">
              Learn More →
            </a>
</div>
...
<p className="font-medium border-l-2 border-[#86efac] pl-3">
                We create clear, repeatable SOPs for critical tasks, customized
                to your team, your projects, and how you actually work.
              </p>
</div>
<a className="inline-block font-bold hover:underline mt-8" href="#">
              Learn More →
...
<p className="font-medium border-l-2 border-[#ff9ebb] pl-3">
                Implementation of digital tools to reduce manual work.
                Scheduling, documentation, and reporting become faster and
                easier to manage.
              </p>
</div>
<a className="inline-block font-bold hover:underline mt-8" href="#">
...
<p className="text-xl text-black/80 mb-8 font-medium">
            Fully responsive design means you can track expenses the moment you
            spend. Toggle Dark Mode for late-night budgeting sessions.
          </p>
...
<p className="text-xl font-bold text-black/80 mb-12 max-w-2xl mx-auto">
          Join thousands of users tracking their finances with SpendsIn. Built
          with React 19 &amp; Supabase for speed and security.
        </p>

...
<nav :className="scrolled ? 'bg-white/90 shadow-sm backdrop-blur-md' : 'bg-transparent'" @scroll.window="scrolled = (window.pageYOffset &gt; 20)" className="fixed top-0 w-full z-50 transition-all duration-300 border-b border-transparent" x-data="{ open: false, scrolled: false }">
...
<span className="iconify" data-icon="lucide:check-circle"></span> Registered Charity
                </div>
<div className="flex items-center gap-2 text-xs font-medium uppercase tracking-wide text-zinc-400">
<span className="iconify" data-icon="lucide:check-circle"></span> Spiritual Healing
                </div>
<div className="flex items-center gap-2 text-xs font-medium uppercase tracking-wide text-zinc-400">
<span className="iconify" data-icon="lucide:check-circle"></span> Community Support
                </div>
</div>
</div>
</section>

...
<a className="block text-lg text-neutral-900 font-medium hover:translate-x-1 transition-transform font-geist" href="#" style={{}}>Home</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="#" style={{}}>Work</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="#" style={{}}>Services</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="#" style={{}}>Pricing</a>
<a className="block hover:text-neutral-900 hover:translate-x-1 transition-all text-lg text-neutral-500 font-geist" href="#" style={{}}>Contact</a>
</nav>
</div>

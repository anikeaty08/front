...
<a className="block text-3xl tracking-tighter font-medium group font-geist" href="#" style={{}}>
        start<span className="text-neutral-400 group-hover:text-neutral-900 transition-colors font-geist" style={{}}>.agency</span>
</a>
</div>
<nav className="space-y-4 animate-clip-in" style={{animationDelay: '0.2s'}}>
<a className="block text-lg text-neutral-900 font-medium hover:translate-x-1 transition-transform font-geist" href="#/home" style={{}}>Home</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="/work" style={{}}>Work</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="/services" style={{}}>Services</a>
<a className="block text-lg text-neutral-500 hover:text-neutral-900 hover:translate-x-1 transition-all font-geist" href="/pricing" style={{}}>Pricing</a>
<a className="block hover:text-neutral-900 hover:translate-x-1 transition-all text-lg text-neutral-500 font-geist" href="/contact" style={{}}>Contact</a>
</nav>
</div>
...
<p className="font-medium text-neutral-900 font-geist" style={{}}>start.agency</p>
<p className="text-neutral-500 font-geist" style={{}}>@startagency</p>
</div>
</div>
<p className="text-xs text-neutral-400 font-geist" style={{}}>Template designed by François Savard from END Agency.</p>
</div>
</aside>
...
<h1 className="leading-[0.95] lg:text-7xl xl:text-7xl text-5xl font-medium text-neutral-900 tracking-tight font-geist" style={{}}>Design partner for startups that move fast and ship right.</h1>
...
<p className="text-base text-neutral-500 font-geist">Trusted by startups that raised millions and globally
        recognized
        brands</p>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '111.5px', -MouseY: '68px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '155.5px', -MouseY: '75px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '114.5px', -MouseY: '50px'}}>
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="lenovo" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '168.5px', -MouseY: '68.3125px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '125.5px', -MouseY: '94.3125px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '62.5px', -MouseY: '3.3125px'}}>
...
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="logitech" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
...
<div className="glass-panel rounded-2xl w-48 h-24 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-500 spotlight-card" onmousemove="handleSpotlight(event)">
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="samsung" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
...
<div className="glass-panel rounded-2xl w-48 h-24 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-500 spotlight-card" onmousemove="handleSpotlight(event)">
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="vercel" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
<path d="m12 1.608l12 20.784H0Z" fill="currentColor"></path>
</svg>
</div>
<div className="glass-panel rounded-2xl w-48 h-24 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-500 spotlight-card" onmousemove="handleSpotlight(event)">
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="stripe" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
...
<div className="glass-panel rounded-2xl w-48 h-24 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-500 spotlight-card" onmousemove="handleSpotlight(event)">
<svg className="text-neutral-900 opacity-80" data-icon-set="simple-icons" data-simple-icons="notion" height="96" style={{}} viewbox="0 0 24 24" width="96" xmlns="http://www.w3.org/2000/svg">
...
<h2 className="lg:text-5xl text-4xl font-medium text-neutral-900 tracking-tight font-geist" style={{}}>Featured Work
      </h2>
...
<div className="carousel-card active lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2" id="card-0" onmousemove="handleSpotlight(event)" style={{-MouseX: '909.5px', -MouseY: '274.96875px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">

<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
<span className="bg-white/80 backdrop-blur px-3 py-1 rounded-full text-xs font-medium border border-black/5 font-geist" style={{}}>Fintech Dashboard</span>
</div>
...
<div className="carousel-card next lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 gap-x-4 gap-y-4" id="card-1" onmousemove="handleSpotlight(event)" style={{-MouseX: '4.7427978515625px', -MouseY: '141.655029296875px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
<span className="bg-white/80 backdrop-blur px-3 py-1 rounded-full text-xs font-medium border border-black/5 font-geist" style={{}}>Mobile Health App</span>
</div>
...
<div className="carousel-card prev w-full lg:w-3/4 h-full glass-panel rounded-3xl p-2 spotlight-card cursor-pointer" id="card-2" onmousemove="handleSpotlight(event)" style={{-MouseX: '742.219482421875px', -MouseY: '99.342529296875px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
<span className="bg-white/80 backdrop-blur px-3 py-1 rounded-full text-xs font-medium border border-black/5 font-geist" style={{}}>SaaS Analytics</span>
</div>
...
<h3 className="text-2xl font-medium text-neutral-900 tracking-tight mb-2 font-geist" style={{}}>10 years</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>Designing inside real startups, not
          from the outside.
        </p>
</div>

<div className="bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.04)] transition-shadow duration-300">
<h3 className="text-2xl font-medium text-neutral-900 tracking-tight mb-2 font-geist" style={{}}>300+ websites</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>SaaS, fintech, AI, consumer, B2B.
        </p>
</div>

<div className="bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.04)] transition-shadow duration-300">
<h3 className="text-2xl font-medium text-neutral-900 tracking-tight mb-2 font-geist" style={{}}>$S 10 mil value</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>Across companies we’ve helped design
          and launch.</p>
</div>

<div className="bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.04)] transition-shadow duration-300">
<h3 className="text-2xl font-medium text-neutral-900 tracking-tight mb-2 font-geist" style={{}}>80% clients return
        </h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>Because good collaboration beats
          good decks.</p>
</div>
</div>
</section>
...
<p className="sm:text-base text-sm text-zinc-950 tracking-tight font-geist mt-1">Three simple steps to
        automate
        your content</p>
</div>
...
<span className="absolute -top-4 left-6 inline-flex items-center px-4 py-1.5 rounded-full border border-neutral-200 bg-white text-xs sm:text-sm text-neutral-800 tracking-tight font-geist" style={{}}>STEP 1</span>
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist" style={{}}>Kickoff &amp;
          alignment</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist" style={{}}>Goals,
          constraints,
          timelines. No guessing.</p>
</div>

<div className="lg:col-span-4 sm:p-8 hover-lift flex flex-col bg-white h-full border-neutral-200 border rounded-2xl pt-6 pr-6 pb-6 pl-6 relative">
<span className="absolute -top-4 left-6 inline-flex items-center px-4 py-1.5 rounded-full border border-neutral-200 bg-white text-xs sm:text-sm text-neutral-800 tracking-tight font-geist" style={{}}>STEP 2</span>
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist" style={{}}>Design &amp;
          iteration</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist" style={{}}>Fast
          cycles,
          constant
...
<div className="lg:col-span-4 sm:p-8 hover-lift flex flex-col bg-white h-full border-neutral-200 border rounded-2xl pt-6 pr-6 pb-6 pl-6 relative">
<span className="absolute -top-4 left-6 inline-flex items-center px-4 py-1.5 rounded-full border border-neutral-200 bg-white text-xs sm:text-sm text-neutral-800 tracking-tight font-geist" style={{}}>STEP 3</span>
...
<h3 className="sm:text-4xl text-3xl text-neutral-900 tracking-tighter mt-6 font-geist" style={{}}>Delivery &amp;
          handoff</h3>
<p className="sm:text-base text-sm text-neutral-600 tracking-tight max-w-[52ch] mt-2 font-geist" style={{}}>Clean
          files, clear
...
<p className="leading-relaxed text-base text-zinc-900 font-geist" style={{}}>
...
<p className="leading-relaxed text-base font-medium text-zinc-900 font-normal font-geist" style={{}}>
...
<p className="leading-relaxed text-base font-medium text-zinc-50 mb-2 font-geist" style={{}}>Case study - Workly
          </p>
<h2 className="leading-tight md:text-4xl lg:text-5xl text-2xl font-normal text-white tracking-tight mb-8 font-geist" style={{}}>
            Redesigned
...
<span className="font-geist" style={{}}>Read more</span>
...
<p className="text-xs text-white/50 uppercase tracking-widest mb-4 font-medium font-geist" style={{}}>Trusted by
              teams at
            </p>
...
<span className="text-xs font-semibold text-zinc-900 font-geist" style={{}}>9:41</span>
...
<path className="" d="M12 3C7.5 3 3.75 4.95 1 8l11 13l11-13c-2.75-3.05-6.5-5-11-5" fill="currentColor">
</path>
</svg>
...
<div className="">
<p className="text-lg font-normal text-zinc-900 tracking-tight font-geist" style={{}}>Hi, Marcus</p>
</div>
<div className="w-8 h-8 bg-zinc-100 rounded-full flex items-center justify-center">
<svg className="text-zinc-600" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path className="" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4m0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4" fill="currentColor">
</path>
</svg>
</div>
</div>
...
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist" style={{}}>Today's
                      suggestion</p>
<p className="text-base font-normal text-white tracking-tight mb-3 font-geist" style={{}}>Complete Module
                      3
                    </p>
...
<span className="text-zinc-400 font-geist" style={{}}>2h 15m · Zone 2</span>
<span className="text-indigo-400 font-geist" style={{}}>65%</span>
</div>
</div>
</div>

<div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4">
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist" style={{}}>Weekly
                      Progress
                    </p>
<p className="text-xl font-normal text-zinc-900 tracking-tight mb-2 font-geist" style={{}}>87% Learning
                      Load</p>
<div className="flex items-center gap-2">
...
<span className="text-[10px] text-emerald-600 font-medium font-geist" style={{}}>Optimal</span>
</div>
</div>

<div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4">
<p className="text-[10px] text-zinc-400 uppercase tracking-wider mb-1 font-geist" style={{}}>XP Balance
                    </p>
<div className="flex items-baseline gap-1">
<p className="text-xl font-semibold text-zinc-900 tracking-tight font-geist" style={{}}>4,850</p>
<span className="text-sm text-zinc-400 font-geist" style={{}}>XP</span>
</div>
</div>
</div>
</div>
...
<div className="grid lg:grid-cols-12 lg:gap-4" style={{}}>

<div className="lg:col-span-4 space-y-6">
<h2 className="lg:text-4xl text-3xl font-medium text-neutral-900 tracking-tight font-geist">Why startups
    choose
    start.agency</h2>
<p className="text-[17px] leading-relaxed font-normal text-neutral-500 font-geist" style={{}}>
...
<div className="">
<h3 className="text-lg font-medium text-neutral-900 mb-2 font-geist" style={{}}>We think like founders</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>We care about speed,
...
<div className="">
<h3 className="text-lg font-medium text-neutral-900 mb-2 font-geist" style={{}}>Embedded collaboration</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>Slack, Figma, async updates.
...
<div className="">
<h3 className="text-lg font-medium text-neutral-900 mb-2 font-geist" style={{}}>Clear delivery, no drama</h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>You know what’s being worked
...
<div className="">
<h3 className="text-lg font-medium text-neutral-900 mb-2 font-geist" style={{}}>Built for change </h3>
<p className="text-[15px] leading-relaxed text-neutral-500 font-geist" style={{}}>Pivots happen. We adapt
...
<div className="lg:col-span-4 space-y-6">
<h2 className="lg:text-4xl text-3xl font-medium text-neutral-900 tracking-tight font-geist" style={{}}>What we do</h2>
<p className="text-[17px] leading-relaxed font-normal text-neutral-500 font-geist" style={{}}>Different industries,
...
<span className="text-base font-medium text-neutral-900 font-geist" style={{}}>Product Design</span>
</div>
...
<li className="font-geist" style={{}}>Web Apps</li>
<li className="font-geist" style={{}}>Mobile Apps</li>
<li className="font-geist" style={{}}>Design Systems</li>
<li className="font-geist" style={{}}>Prototyping &amp; Ideation</li>
</ul>
</div>
</div>
...
<span className="text-base font-medium text-neutral-900 font-geist" style={{}}>Web Design</span>
</div>
<div className="bg-white border border-neutral-200/60 p-6 rounded-2xl h-full">
<ul className="space-y-3 text-[15px] text-neutral-500">
<li className="font-geist" style={{}}>Landing Pages</li>
<li className="font-geist" style={{}}>Multi-Page Websites</li>
<li className="flex gap-x-2 gap-y-2 items-center font-geist" style={{}}>Aura Development</li>
<li className="font-geist" style={{}}>Animations</li>
</ul>
</div>
</div>
...
<span className="text-base font-medium text-neutral-900 font-geist" style={{}}>Brand Identity</span>
</div>
<div className="bg-white border border-neutral-200/60 p-6 rounded-2xl h-full">
<ul className="space-y-3 text-[15px] text-neutral-500">
<li className="font-geist" style={{}}>Brand Guidelines</li>
<li className="font-geist" style={{}}>Brand Assets</li>
<li className="font-geist" style={{}}>Logos &amp; Marks</li>
<li className="font-geist" style={{}}>Pitch Decks</li>
</ul>
</div>
</div>
</div>
...
<div className="lg:col-span-4 space-y-6">
<h2 className="lg:text-4xl text-3xl font-medium text-neutral-900 tracking-tight font-geist" style={{}}>Growth for
      startups shipping fast.</h2>
<p className="text-[17px] leading-relaxed font-normal text-neutral-500 font-geist" style={{}}>Dedicated design lead.
      Unlimited requests.
      Strategic input.
...
<h3 className="text-base font-semibold text-neutral-900 tracking-tight font-geist" style={{}}>Monthly Retainer
          </h3>
<span className="bg-neutral-100 text-neutral-600 px-2.5 py-1 rounded-full text-xs font-medium border border-neutral-200/50 font-geist" style={{}}>Most Popular</span>
</div>
<p className="text-[15px] text-neutral-500 mb-8 font-geist" style={{}}>Perfect for early teams getting off the
          ground</p>
<div className="text-2xl font-semibold text-neutral-900 tracking-tight mb-4 font-geist" style={{}}>$S6,990/month
        </div>
<div className="flex flex-col sm:flex-row gap-3">
<button className="flex-1 bg-neutral-900 text-white font-medium px-6 py-3 rounded-full hover:bg-neutral-800 transition-colors flex items-center justify-center gap-2 text-[15px] font-geist" style={{}}>
              Start Today
...
<button className="flex-1 bg-white text-neutral-900 border border-neutral-200 font-medium px-6 py-3 rounded-full hover:bg-neutral-50 transition-colors flex items-center justify-center gap-2 text-[15px] font-geist" style={{}}>
<svg className="" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<span className="font-geist" style={{}}>Priority delivery <span className="text-neutral-400 ml-1 cursor-help font-geist" style={{}} title="Info">ⓘ</span></span>
</li>
<li className="flex items-start gap-3 text-[15px] text-neutral-600">
<svg className="text-neutral-400 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<span className="font-geist" style={{}}><span className="border-b border-neutral-300 font-geist" style={{}}>All our services</span>,
...
<span className="font-geist" style={{}}>Weekly delivery and pause or cancel anytime</span>
</li>
<li className="flex items-start gap-3 text-[15px] text-neutral-600">
<svg className="text-neutral-400 shrink-0" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
</svg>
<span className="font-geist" style={{}}>1:1 communication on Slack and optional weekly call</span>
</li>
</ul>
</div>
...
<h4 className="text-base font-medium text-neutral-900 mb-2 font-geist" style={{}}>Pause anytime</h4>
<p className="text-[14px] leading-relaxed text-neutral-500 font-geist" style={{}}>Put your retainer on hold
...
<h4 className="text-base font-medium text-neutral-900 mb-2 font-geist" style={{}}>Try it for a week</h4>
<p className="text-[14px] leading-relaxed text-neutral-500 font-geist" style={{}}>If you're not satisfied and
...
<span className="text-[11px] font-medium text-neutral-500 font-geist" style={{}}>Checkout powered by Stripe</span>
</div>
</div>
</div>
</div>
...
<h2 className="text-[44px] leading-[0.9] sm:text-6xl lg:text-7xl xl:text-5xl text-[#000000] tracking-tighter text-left font-geist" style={{}}>
        Testimonials.</h2>
<p className="sm:text-base text-sm text-zinc-400 tracking-tight mt-1 font-geist" style={{}}>Real stories, real success.
...
<p className="text-lg sm:text-xl md:text-2xl text-neutral-900 tracking-tighter font-geist" style={{}}>
...
<div className="">
<div className="text-sm tracking-tight font-geist" style={{}}>Sarah Chen</div>
<div className="text-xs text-neutral-500 tracking-tight font-geist" style={{}}>Marketing Director, TechFlow
                  </div>
</div>
</div>
</article>
...
<div className="">
<div className="text-sm tracking-tight font-geist" style={{}}>Marcus Rodriguez</div>
<div className="text-xs text-neutral-500 tracking-tight font-geist" style={{}}>Content Lead, GrowthLab</div>
</div>
</div>
</article>
...
<div className="">
<div className="text-sm tracking-tight font-geist" style={{}}>Emma Thompson</div>
<div className="text-xs text-neutral-500 tracking-tight font-geist" style={{}}>Founder, Digital Ventures
                  </div>
</div>
</div>
</article>
...
<div>
<div className="text-sm tracking-tight font-geist" style={{}}>Alex Morgan</div>
<div className="text-xs text-neutral-500 tracking-tight font-geist" style={{}}>Creative Director, Apex
                    Studios
                  </div>
</div>
</div>
...
<div>
<div className="text-sm tracking-tight font-geist" style={{}}>Priya Patel</div>
<div className="text-xs text-neutral-500 tracking-tight font-geist" style={{}}>Head of Marketing,
                    InnovateCorp
                  </div>
</div>
</div>
...
<div className="grid lg:grid-cols-12 lg:gap-4">
<div className="lg:col-span-4 space-y-6">
<h2 className="text-3xl lg:text-4xl font-medium tracking-tight text-neutral-900 font-geist" style={{}}>
      Frequency Asked Questions
    </h2>
<p className="text-[17px] text-neutral-500 leading-relaxed font-normal font-geist" style={{}}>
      Everything you need to know about the product and billing. Can't find the answer you're looking for? Please <a className="underline underline-offset-4 text-neutral-900 hover:text-neutral-600 transition-colors font-geist" href="#" style={{}}>chat
...
<h3 className="text-base font-medium text-neutral-900 font-geist" style={{}}>How does the "pause" feature work?
          </h3>
...
<div className="faq-answer hidden mt-4 text-neutral-500 text-[15px] leading-relaxed font-geist" style={{}}>
...
<div className="bg-white border border-neutral-200/60 rounded-2xl p-6 cursor-pointer group hover:border-neutral-300 transition-colors" onclick="this.querySelector('.faq-answer').classList.toggle('hidden'); this.querySelector('.faq-icon').classList.toggle('rotate-180')">
<div className="flex justify-between items-center">
<h3 className="text-base font-medium text-neutral-900 font-geist" style={{}}>What is the typical turnaround
            time?
          </h3>
<svg className="text-neutral-400 faq-icon transition-transform duration-300" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="m6 9 6 6 6-6"></path>
...
<div className="bg-white border border-neutral-200/60 rounded-2xl p-6 cursor-pointer group hover:border-neutral-300 transition-colors" onclick="this.querySelector('.faq-answer').classList.toggle('hidden'); this.querySelector('.faq-icon').classList.toggle('rotate-180')">
<div className="flex justify-between items-center">
<h3 className="text-base font-medium text-neutral-900 font-geist" style={{}}>Do you offer development services?
          </h3>
<svg className="text-neutral-400 faq-icon transition-transform duration-300" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="m6 9 6 6 6-6"></path>
</svg>
...
<div className="bg-white border border-neutral-200/60 rounded-2xl p-6 cursor-pointer group hover:border-neutral-300 transition-colors" onclick="this.querySelector('.faq-answer').classList.toggle('hidden'); this.querySelector('.faq-icon').classList.toggle('rotate-180')">
<div className="flex justify-between items-center">
<h3 className="text-base font-medium text-neutral-900 font-geist" style={{}}>How do we communicate?</h3>
<svg className="text-neutral-400 faq-icon transition-transform duration-300" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="m6 9 6 6 6-6"></path>
</svg>
</div>
...
<span className="text-sm font-semibold text-neutral-900 tracking-tight font-geist" style={{}}>start.agency</span>
<span className="text-[11px] uppercase text-neutral-400 tracking-[0.16em] font-geist" style={{}}>Start with design</span>
</div>
</div>
<p className="text-sm text-neutral-500 max-w-sm font-geist" style={{}}>We partner with startups on early stage and
              help them solve
...
<h3 className="uppercase text-xs font-medium text-neutral-400 tracking-[0.16em] font-geist" style={{}}>Service
              </h3>
<ul className="space-y-2 text-neutral-600">
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Website
                    design</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Product
                    design</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Brand
                    identity</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Website
                    development</a></li>
</ul>
...
<div className="space-y-3">
<h3 className="uppercase text-xs font-medium text-neutral-400 tracking-[0.16em] font-geist" style={{}}>Case
                studies</h3>
<ul className="space-y-2 text-neutral-600">
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Project
                    1</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Project
                    2</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Project
...
<div className="space-y-3">
<h3 className="text-xs font-medium uppercase tracking-[0.16em] text-neutral-400 font-geist" style={{}}>Company
              </h3>
<ul className="space-y-2 text-neutral-600">
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Studio</a>
</li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Clients</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Careers</a></li>
<li className=""><a className="hover:text-neutral-900 transition-colors font-geist" href="#" style={{}}>Contact</a></li>
</ul>
</div>
</div>
</div>
...
<p className="font-geist" style={{}}>© 2025 start.agency</p>
<div className="flex flex-wrap gap-4">
<a className="hover:text-neutral-700 transition-colors font-geist" href="#" style={{}}>Privacy Policy</a>
<a className="hover:text-neutral-700 transition-colors font-geist" href="#" style={{}}>Terms of Service</a>
<a className="hover:text-neutral-700 transition-colors font-geist" href="#" style={{}}>Data Processing</a>
<a className="hover:text-neutral-700 transition-colors font-geist" href="#" style={{}}>Cookie Settings</a>
</div>
</div>
</div>
</div>

...
<a className="hover:text-[#982626] transition-colors" href="#services">Services</a>
<a className="hover:text-[#982626] transition-colors" href="#regenerative">Regenerative Medicine</a>
<a className="hover:text-[#982626] transition-colors" href="#about">About Us</a>
<a className="hover:text-[#982626] transition-colors" href="#reviews">Reviews</a>
...
<div className="animate-fade-up text-[10px] uppercase md:mb-8 font-bold text-[#982626] tracking-widest font-montserrat bg-[#982626]/5 w-fit border-[#982626]/10 border rounded-full mb-6 pt-1 pr-3 pb-1 pl-3" style={{}}>ATTENTION: City RESIDENTS SUFFERING FROM CHRONIC PAIN</div>
...
<img alt="Dr. Patient Interaction" className="w-full h-full object-cover opacity-80 group-hover:opacity-60 transition-all duration-700 group-hover:scale-105" src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&amp;fit=crop&amp;q=80&amp;w=2068"/>
...
<h2 className="md:text-5xl text-3xl font-medium text-gray-900 tracking-tight font-serif mb-4" style={{}}>Why Choose Us</h2>
...
<p className="leading-relaxed z-10 text-sm font-light text-gray-500 relative" style={{}}>Every procedure is performed by Dr. PRP, a board-certified specialist, not a nurse or assistant.</p>
...
<div className="mt-auto self-end group-hover:text-[#982626] transition-colors duration-500 transform group-hover:scale-110 text-[#982626]/20">
<iconify-icon className="" height="96" icon="solar:user-heart-linear" width="96"></iconify-icon>
</div>
</div>
</div>
</section>
...
<iconify-icon className="" height="40" icon="solar:dna-linear" style={{color: '#982626'}} width="40"></iconify-icon>
</div>
...
<iconify-icon className="" height="40" icon="solar:virus-outline" style={{color: '#982626'}} width="40"></iconify-icon>
</div>
<h3 className="text-lg md:text-xl font-bold font-montserrat mb-2 md:mb-3 text-gray-900">
...
<div className="flex flex-col items-center text-center group">
<div className="w-20 h-20 md:w-24 md:h-24 border rounded-full flex items-center justify-center text-xl md:text-2xl font-serif mb-5 md:mb-6 shadow-sm group-hover:border-[#982626] group-hover:text-[#982626] transition-colors bg-white border-gray-200 text-gray-400">
<iconify-icon className="" height="40" icon="solar:stethoscope-outline" style={{color: '#982626'}} width="40"></iconify-icon>
</div>
<h3 className="text-lg md:text-xl font-bold font-montserrat mb-2 md:mb-3 text-gray-900">
...
<div className="flex text-xs font-bold text-[#982626] bg-[#982626]/10 w-10 h-10 rounded-full items-center justify-center">P</div>
<div className="">
...
<h2 className="md:text-6xl text-5xl text-gray-900 tracking-tight font-serif mb-8">Hi, I'm Dr. PRP</h2>

<p className="leading-relaxed text-lg font-light text-gray-500 mb-8">I founded this Company with one mission: to eliminate the guesswork in pain management and help patients avoid unnecessary surgeries.</p>
<p className="leading-relaxed text-lg font-light text-gray-500 mb-10">After completing my doctorate, I realized most traditional treatments are reactive. They focus on masking symptoms with medication rather than healing the root cause. We built this practice to change that.</p>
<p className="leading-relaxed text-lg font-light text-gray-500 mb-10">With over 25 years of experience as a board-certified physician specializing in physical medicine and rehabilitation, I've dedicated my career to regenerative medicine procedures including PRP, MFAT, BMAC, prolotherapy, and shockwave therapy. As an expert in PRP and Shockwave therapy, I focus on treating the root cause of your pain, not just the symptoms.</p>
...
<a className="text-2xl font-medium italic text-gray-900 tracking-tight font-serif" href="#" style={{}}>PRP Company</a>
<p className="flex items-center justify-center md:justify-start gap-2 text-sm font-light text-gray-500 mt-4" style={{}}>Anytown USA</p>
<p className="flex items-center justify-center md:justify-start gap-2 text-sm font-light text-gray-500 mt-2" style={{}}>{iconify-icon} (415) 555-1685</p>
</div>
...
<p className="">© PRP All rights reserved.</p>
</div>
</footer>

...
<div className="absolute top-0 right-0 bottom-0 left-0" data-container-bg="true">
<img alt="Background" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/386aed4d-4457-47f0-9edf-23b08539d1e4_3840w.webp"/>
</div>
...
<img alt="Mountain Landscape at Sunset" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/ef749f82-a7d0-4319-97df-75365c533bc7_1600w.webp"/>
...
<img alt="Author" className="w-8 h-8 rounded-full ring-1 ring-neutral-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3e3e1091-f8e8-4022-a02a-fa37a35c59a5_320w.jpg"/>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Modern Office Workspace" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7f78131e-65e9-49b2-aa1f-ccc33e28df9f_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<div className="flex items-center justify-between">
<div className="flex gap-2 items-center">
<img alt="Author" className="w-8 h-8 rounded-full ring-1 ring-neutral-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/dc0337fb-ed78-4515-a35d-9bf52d6af946_320w.webp"/>
<div className="flex flex-col leading-tight">
<span className="text-base font-medium text-neutral-200 font-geist" style={{}}>
                        Benny To
                      </span>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Urban City Street at Night" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7356ff87-92cc-4a91-a88b-3ad9a28041bf_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Professional Portrait Photography" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/7969202b-d159-47e3-badd-ce3ff5efef3a_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Tropical Beach Paradise" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b5d711f2-c1d8-4a6c-80aa-a69b42a33e00_1600w.jpg"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Fresh Food and Ingredients" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cc78b114-8d82-4b45-b756-25d0697fe629_1600w.jpg"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<div className="flex items-center justify-between">
<div className="flex gap-2 items-center">
<img alt="Author" className="w-8 h-8 rounded-full ring-1 ring-neutral-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8a90d32f-809f-4383-b71f-6a9c50621b69_320w.jpg"/>
<div className="flex flex-col leading-tight">
<span className="text-base font-medium text-neutral-200 font-geist" style={{}}>
                        Megan Lyn
                      </span>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Abstract Art and Patterns" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/8dbdc665-9457-4d9e-8802-35ee5a13090e_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<div className="flex items-center justify-between">
<div className="flex gap-2 items-center">
<img alt="Author" className="w-8 h-8 rounded-full ring-1 ring-neutral-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b476201e-4ebc-447a-b9b9-0c7e4e8302a0_320w.jpg"/>
<div className="flex flex-col leading-tight">
<span className="text-base font-medium text-neutral-200 font-geist" style={{}}>
                        Meng To
                      </span>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Technology and Innovation" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/82781526-4ef8-4653-8d37-243d7194d6e5_800w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Wildlife and Nature Photography" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/aedb2425-6c2b-48a3-8ba5-01ea63f19cf5_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Minimalist Architecture" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2974da65-b519-45e9-a413-b9d7b00099a5_1600w.jpg"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<div className="flex items-center justify-between">
<div className="flex gap-2 items-center">
<img alt="Author" className="w-8 h-8 rounded-full ring-1 ring-neutral-800 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/24f664fd-07a7-45e6-9553-ed03aa0c764f_320w.jpg"/>
<div className="flex flex-col leading-tight">
<span className="text-base font-medium text-neutral-200 font-geist" style={{}}>
                        Meng To
                      </span>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Sunset Over the Ocean" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a8a18478-d20b-4c5f-9811-5e3a92a55aa1_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<article className="group relative overflow-hidden rounded-2xl ring-1 ring-neutral-800 bg-neutral-900/60">
<img alt="Cozy Interior Design" className="w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition duration-500 group-hover:scale-[1.02]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/e1cdcac4-b146-4843-a403-1e0e749b5e24_1600w.webp"/>
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
<div className="flex flex-col group-hover:translate-y-0 transition-transform duration-300 pt-6 pr-6 pb-6 pl-6 absolute right-0 bottom-0 left-0 translate-y-4 gap-x-3 gap-y-3">
<h4 className="text-2xl lg:text-lg font-semibold text-white mb-1 font-geist" style={{}}>
...
<img alt="Endless Inspiration" className="md:h-[420px] transition duration-500 group-hover:scale-[1.02] w-full h-72 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/c3e3fffd-33c5-442f-924a-7bc1032b2c0f_1600w.jpg"/>
...
<article className="card group w-full md:flex-1 min-w-0 overflow-hidden transition-all duration-500 ease-out bg-neutral-900/60 ring-neutral-800 ring-1 rounded-2xl relative" style={{flex: '1 1 0%'}}>
<img alt="Professional Quality" className="md:h-[420px] transition duration-500 group-hover:scale-[1.02] w-full h-72 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/56ed5565-df57-4091-904a-06ea43760e76_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent pointer-events-none"></div>
<div className="absolute top-4 left-4 right-4">
<span className="inline-flex rounded-lg px-3 py-2 text-white text-lg sm:text-xl font-semibold font-geist">
...
<article className="card group w-full md:flex-1 min-w-0 overflow-hidden transition-all duration-500 ease-out bg-neutral-900/60 ring-neutral-800 ring-1 rounded-2xl relative" style={{flex: '1 1 0%'}}>
<img alt="Time-Saving Search" className="md:h-[420px] transition duration-500 group-hover:scale-[1.02] w-full h-72 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6663740f-b15d-4a86-bcad-0623f9660f7c_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent pointer-events-none"></div>
<div className="absolute top-4 left-4 right-4">
<span className="inline-flex rounded-lg px-3 py-2 text-white text-lg sm:text-xl font-semibold font-geist">
                    Time-Saving Search
...
<article className="card group w-full md:flex-1 min-w-0 overflow-hidden transition-all duration-500 ease-out bg-neutral-900/60 ring-neutral-800 ring-1 rounded-2xl relative" style={{flex: '1 1 0%'}}>
<img alt="Free for Everyone" className="md:h-[420px] transition duration-500 group-hover:scale-[1.02] w-full h-72 object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/aa00117b-6282-48e6-8a58-cb95c40a5b90_1600w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent pointer-events-none"></div>
<div className="absolute top-4 left-4 right-4">
<span className="inline-flex rounded-lg px-3 py-2 text-white text-lg sm:text-xl font-semibold font-geist">
                    Free for Everyone
...
<div className="flex-1 flex bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6663740f-b15d-4a86-bcad-0623f9660f7c_1600w.jpg)] bg-cover items-center justify-center">
</div>

...
<a className="hover:text-[#D6FF4F] transition-colors" href="#">Work</a>
<a className="hover:text-[#D6FF4F] transition-colors" href="#">
            Services
          </a>
<a className="hover:text-[#D6FF4F] transition-colors" href="#">Studio</a>
<a className="hover:text-[#D6FF4F] transition-colors" href="#">Journal</a>
<a className="mt-6 inline-flex items-center justify-center rounded-full bg-[#F5F5F5] hover:bg-[#D6FF4F] text-[#0E0F11] px-8 py-3 text-sm font-semibold uppercase tracking-wider transition-colors" href="#">
            Start a Project
          </a>
...
<div className="fixed flex z-50 pt-6 pr-4 pl-4 top-0 right-0 left-0 justify-center">
<nav className="flex shadow-black/50 bg-[#15171B]/80 w-full max-w-[1500px] border-[#23252B] border rounded-full pt-3 pr-6 pb-3 pl-6 shadow-2xl backdrop-blur-md items-center justify-between">

<div className="hidden md:flex gap-8 items-center">
<a className="hover:text-[#D6FF4F] transition-colors text-sm font-medium text-[#F5F5F5]" href="/work">
              Work
            </a>
<a className="hover:text-[#F5F5F5] transition-colors text-sm font-medium text-[#A1A1A6]" href="/services">
              Services
            </a>
<a className="hover:text-[#F5F5F5] transition-colors text-sm font-medium text-[#A1A1A6]" href="/studio">
              Studio
            </a>
<a className="hover:text-[#F5F5F5] transition-colors text-sm font-medium text-[#A1A1A6]" href="/journal">
              Journal
            </a>
</div>

<button className="md:hidden p-1 text-[#F5F5F5]" id="open-menu-btn">
<svg aria-hidden="true" data-icon="lucide:menu" data-strokeWidth="1.5" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<span className="uppercase text-lg font-semibold text-[#F5F5F5] tracking-tight font-heading">
                STUDIO
              </span>
</a>
</div>
...
<div className="hidden md:flex gap-8 items-center">
<a className="hover:bg-[#D6FF4F] uppercase transition-colors text-xs font-semibold text-[#0E0F11] tracking-wider bg-[#F5F5F5] rounded-full pt-2 pr-5 pb-2 pl-5" href="/project">
              Start a Project
            </a>
</div>
...
<div className="pt-10 px-4 pb-10 md:px-8 md:pt-12 md:pb-12 max-w-[1550px] mx-auto">
<h1 className="text-[14vw] md:text-[11vw] leading-[0.85] font-heading font-medium text-[#F5F5F5] tracking-tight text-center w-full mb-8 sm:mb-12 break-words">
            Visual
            <br/>
<span className="text-[#23252B] stroke-text">Language</span>
</h1>
...
<p className="text-[11px] uppercase sm:text-xs sm:text-left md:px-4 md:mb-4 md:mt-4 text-[#A1A1A6]/70 tracking-widest text-center mt-1 mb-4 px-4">
...
<img alt="Abstract 3D Design" className="hero-slide absolute inset-0 w-full h-full object-cover opacity-80" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/68c70ed3-3617-478c-b904-4a86ef50ff12_3840w.webp" style={{}}/>
<img alt="Liquid Metal" className="hero-slide absolute inset-0 w-full h-full object-cover opacity-80" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/feda1066-8c70-434c-9899-9f49ec90da32_3840w.webp" style={{}}/>
<img alt="Dark Architecture" className="hero-slide absolute inset-0 w-full h-full object-cover opacity-80" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ad12226b-9c56-48b6-81b8-bf1ef9f0cb87_3840w.webp" style={{}}/>
</div>
...
<svg aria-hidden="true" data-icon="lucide:play" data-strokeWidth="3" data-width="12" height="12" role="img" viewbox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
...
<img className="opacity-60 group-hover:opacity-90 group-hover:scale-110 transition-all duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/46281a5c-f67e-419c-9644-02c7d3b25deb_800w.webp" style={{}}/>
<div className="bg-gradient-to-t from-[#0E0F11] via-transparent to-transparent absolute top-0 right-0 bottom-0 left-0"></div>
...
<p className="mt-2 text-[11px] leading-relaxed text-[#A1A1A6] opacity-100 sm:opacity-0 sm:translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
...
<a className="group relative aspect-[3/4] overflow-hidden rounded-3xl border border-[#23252B] bg-[#15171B]" href="#">
<img className="opacity-60 group-hover:opacity-90 group-hover:scale-110 transition-all duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bde9069b-1960-4868-9138-c74f2a623acd_800w.webp" style={{}}/>
...
<a className="group relative aspect-[3/4] overflow-hidden rounded-3xl border border-[#23252B] bg-[#15171B]" href="#">
<img className="opacity-60 group-hover:opacity-90 group-hover:scale-110 transition-all duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/039a9170-346c-47e5-8218-e281b3d525dd_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0E0F11] via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 p-6 w-full">
<span className="text-[10px] font-sans uppercase tracking-widest text-[#D6FF4F] mb-1 block">
                  Category
...
<a className="group relative aspect-[3/4] overflow-hidden rounded-3xl border border-[#23252B] bg-[#15171B]" href="#">
<img className="opacity-60 group-hover:opacity-90 group-hover:scale-110 transition-all duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/981546c5-4246-4dec-90f8-8fba1e9dd71d_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-[#0E0F11] via-transparent to-transparent"></div>
<div className="absolute bottom-0 left-0 p-6 w-full">
<span className="text-[10px] font-sans uppercase tracking-widest text-[#D6FF4F] mb-1 block">
                  Category
...
<svg aria-hidden="true" data-icon="lucide:layers" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center bg-[#0E0F11] rounded-full px-4 py-2 gap-3 w-full sm:w-auto md:w-auto border border-[#23252B] focus-within:border-[#D6FF4F] transition-colors">
<svg aria-hidden="true" data-icon="lucide:clock" data-width="14" height="14" role="img" viewbox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg">
<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
...
<div className="md:col-span-3 p-6 md:p-8 md:border-r border-[#23252B] flex flex-col justify-between h-auto md:min-h-[600px]">
...
<p className="mt-3 text-[10px] font-sans uppercase tracking-[0.2em] text-[#A1A1A6]/60">
...
<h2 className="text-4xl md:text-5xl font-heading font-medium tracking-tight leading-[0.95] mb-4 text-[#F5F5F5]">
...
<p className="mt-4 text-[10px] font-sans uppercase tracking-[0.2em] text-[#A1A1A6]/60">
                  All projects shown are client-approved
                </p>
...
<img className="opacity-80 group-hover:scale-110 transition-transform duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c55b9091-b0ca-4842-92d7-7be239f76440_800w.webp"/>
...
<div className="group cursor-pointer bg-[#0E0F11] p-6 hover:bg-[#15171B] transition-colors">
<div className="relative aspect-[4/3] bg-[#15171B] rounded-2xl overflow-hidden mb-5 border border-[#23252B]">
<img className="opacity-80 group-hover:scale-110 transition-transform duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d3d4d588-f8cc-4129-8a9b-d0f004d15ab4_800w.webp"/>
</div>
<div className="flex justify-between items-start mb-2">
<div>
<h3 className="text-lg font-heading font-medium text-[#F5F5F5] tracking-tight">
...
<div className="group cursor-pointer bg-[#0E0F11] p-6 hover:bg-[#15171B] transition-colors">
<div className="relative aspect-[4/3] bg-[#15171B] rounded-2xl overflow-hidden mb-5 border border-[#23252B]">
<img className="opacity-80 group-hover:scale-110 transition-transform duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3d80181f-00cd-4e1e-9a4b-d2a9c4811268_800w.webp" style={{}}/>
</div>
<div className="flex justify-between items-start mb-2">
<div>
<h3 className="text-lg font-heading font-medium text-[#F5F5F5] tracking-tight">
...
<div className="group cursor-pointer bg-[#0E0F11] p-6 hover:bg-[#15171B] transition-colors">
<div className="relative aspect-[4/3] bg-[#15171B] rounded-2xl overflow-hidden mb-5 border border-[#23252B]">
<img className="opacity-80 group-hover:scale-110 transition-transform duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ce5b89c0-9457-4f7b-8448-33b0e21f643a_800w.webp"/>
<div className="absolute top-3 right-3 bg-[#0E0F11]/80 backdrop-blur border border-[#23252B] px-3 py-1 rounded-full text-[10px] font-medium text-[#F5F5F5] uppercase tracking-wider">
                    Awarded
                  </div>
</div>
...
<div className="group cursor-pointer bg-[#0E0F11] p-6 hover:bg-[#15171B] transition-colors">
<div className="relative aspect-[4/3] bg-[#15171B] rounded-2xl overflow-hidden mb-5 border border-[#23252B]">
<img className="opacity-80 group-hover:scale-110 transition-transform duration-700 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/809511d8-3f42-4b75-a11a-ae6515af0d22_800w.webp"/>
</div>
<div className="flex justify-between items-start mb-2">
<div>
<h3 className="text-lg font-heading font-medium text-[#F5F5F5] tracking-tight">
...
<svg aria-hidden="true" data-icon="lucide:telescope" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
...
<h3 className="text-xl font-heading font-medium text-[#F5F5F5]">
                  Strategy
                </h3>
...
<div className="flex flex-col items-center gap-4 relative z-10 group">
<div className="w-14 h-14 rounded-full bg-[#15171B] border border-[#23252B] flex items-center justify-center text-[#A1A1A6] group-hover:text-[#D6FF4F] group-hover:border-[#D6FF4F] transition-all">
<svg aria-hidden="true" data-icon="lucide:pen-tool" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
...
<div className="flex flex-col items-center gap-4 relative z-10 group">
<div className="w-14 h-14 rounded-full bg-[#15171B] border border-[#23252B] flex items-center justify-center text-[#A1A1A6] group-hover:text-[#D6FF4F] group-hover:border-[#D6FF4F] transition-all">
<svg aria-hidden="true" data-icon="lucide:code-2" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div className="lg:col-span-5 p-8 md:p-16 lg:border-r border-[#23252B] flex flex-col justify-center bg-[#0E0F11]">
...
<h2 className="text-3xl md:text-5xl font-heading font-medium tracking-tight mb-4 text-[#F5F5F5]">
                  The Studio Standard
                </h2>
<p className="text-xl md:text-2xl font-heading font-medium tracking-tight text-[#F5F5F5]/90 mb-8">
...
<svg aria-hidden="true" data-icon="lucide:scan-face" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M3 7V5a2 2 0 0 1 2-2h2m10 0h2a2 2 0 0 1 2 2v2m0 10v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2m5-3s1.5 2 4 2s4-2 4-2M9 9h.01M15 9h.01" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
<div>
...
<div className="flex gap-5 group">
<div className="shrink-0 text-[#23252B] group-hover:text-[#D6FF4F] transition-colors mt-1">
<svg aria-hidden="true" data-icon="lucide:diamond" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41L13.7 2.71a2.41 2.41 0 0 0-3.41 0Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
<div>
<h3 className="text-sm font-bold font-sans uppercase tracking-widest text-[#F5F5F5] mb-2">
...
<div className="flex gap-5 group">
<div className="shrink-0 text-[#23252B] group-hover:text-[#D6FF4F] transition-colors mt-1">
<svg aria-hidden="true" data-icon="lucide:zap" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<p className="leading-relaxed text-sm text-[#A1A1A6]" style={{}}>
...
<img className="group-hover:scale-105 transition-transform duration-700 opacity-60 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a795a8d9-4bac-4f56-b06c-0cfaba3dbc9a_1600w.webp"/>
...
<img className="group-hover:scale-105 transition-transform duration-700 opacity-60 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b9fdfc28-8272-467a-b305-f09454abb35a_1600w.webp" style={{}}/>
<div className="absolute bottom-6 left-6 bg-[#0E0F11]/80 backdrop-blur px-4 py-2 rounded-full text-[10px] text-[#F5F5F5] font-mono border border-[#23252B]">
                    Fig. 02 — Materials
                  </div>
</div>
<div className="relative overflow-hidden group h-[300px] sm:h-auto bg-[#15171B]">
<img className="group-hover:scale-105 transition-transform duration-700 opacity-60 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3a6e12d2-345b-4681-a0ae-d817646753f8_1600w.webp" style={{}}/>
<div className="absolute bottom-6 left-6 bg-[#0E0F11]/80 backdrop-blur px-4 py-2 rounded-full text-[10px] text-[#F5F5F5] font-mono border border-[#23252B]">
                    Fig. 03 — Output
                  </div>
</div>
...
<div className="border-t border-[#23252B] bg-[#0E0F11] py-24 px-6 md:px-8">
<div className="max-w-[1550px] mx-auto">
...
<h2 className="text-3xl md:text-5xl font-heading font-medium tracking-tight text-[#F5F5F5] mb-6">
                  Who We Work With
                </h2>
<p className="text-[#A1A1A6] text-sm leading-relaxed mb-8">
...
<div className="bg-[#15171B] border border-[#23252B] rounded-3xl p-8 flex flex-col h-full">
<div className="flex items-center gap-3 mb-6">
<div className="w-8 h-8 rounded-full bg-[#D6FF4F]/10 flex items-center justify-center text-[#D6FF4F]">
...
<h3 className="text-lg font-heading font-medium text-[#F5F5F5]">
                      Good Fit
                    </h3>
</div>
<ul className="space-y-4 flex-1">
<li className="flex items-start gap-3">
<span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#D6FF4F] shrink-0"></span>
<span className="text-sm text-[#A1A1A6] leading-relaxed">
...
<div className="bg-[#0E0F11] border border-[#23252B] rounded-3xl p-8 flex flex-col h-full opacity-60 hover:opacity-100 transition-opacity">
<div className="flex items-center gap-3 mb-6">
<div className="w-8 h-8 rounded-full bg-[#23252B] flex items-center justify-center text-[#A1A1A6]">
...
<h3 className="text-lg font-heading font-medium text-[#A1A1A6]">
                      Not a Fit
                    </h3>
</div>
<ul className="space-y-4 flex-1">
<li className="flex items-start gap-3">
<span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#23252B] shrink-0"></span>
...
<img className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d3da1789-0f7a-4fbc-b7b6-606f9b85b083_3840w.jpg?w=800&amp;q=80"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">
<svg aria-hidden="true" data-icon="lucide:quote" data-width="32" height="32" role="img" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
...
<blockquote className="text-2xl md:text-4xl font-heading leading-tight text-[#F5F5F5] mb-8 font-semibold">
...
<div className="text-[#A1A1A6] text-sm uppercase tracking-widest mt-1">
                      CTO, Nexus Protocol
                    </div>
<div className="mt-3 text-[10px] font-sans uppercase tracking-[0.2em] text-[#A1A1A6]/60">
...
<div className="md:col-span-5 h-full">
<div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#23252B] relative h-full">
<img className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bc6f2c9a-f51b-4d76-a0af-37c36400e46b_3840w.jpg?w=800&amp;q=80"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">
...
<div className="md:col-span-5 h-full">
<div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#23252B] relative h-full">
<img alt="Client portrait" className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f84e0ac4-082e-4160-8877-3043e2a8b63a_3840w.jpg?w=800&amp;q=80"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">
...
<div className="md:col-span-5 h-full">
<div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#23252B] relative h-full">
<img alt="Client portrait" className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/61711827-1dac-47d1-adf8-adb0cf8dd596_3840w.webp?w=800&amp;q=80"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">
...
<div className="md:col-span-5 h-full">
<div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#23252B] relative h-full">
<img alt="Client portrait" className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c547d889-f49f-4ac7-abd8-c889b4b523d5_3840w.jpg?w=800&amp;q=80"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">
...
<svg aria-hidden="true" data-icon="lucide:arrow-left" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<svg aria-hidden="true" data-icon="lucide:arrow-right" data-width="20" height="20" role="img" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14m-7-7l7 7l-7 7" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</button>
</div>
...
<section aria-label="Start a project" className="bg-[#0E0F11] border-t border-[#23252B]">
<div className="max-w-[1550px] mr-auto ml-auto pt-16 pr-6 pb-16 pl-6">
<div className="md:p-12 flex flex-col md:flex-row md:items-center bg-[#15171B] border-[#23252B] border rounded-[2rem] pt-8 pr-8 pb-8 pl-8 gap-x-8 gap-y-8 items-start justify-between">
<div className="max-w-xl">
<span className="text-[10px] font-mono text-[#D6FF4F] block mb-4 border-b border-[#23252B] w-fit pb-1 tracking-widest">
                  07 — NEW BUSINESS
                </span>
<h2 className="text-3xl md:text-4xl font-heading font-medium tracking-tight leading-tight text-[#F5F5F5]">
...
<a className="inline-flex items-center justify-center rounded-full bg-[#F5F5F5] hover:bg-[#D6FF4F] text-[#0E0F11] px-8 py-3 text-xs font-semibold uppercase tracking-wider transition-colors" href="#">
                  Start a Project
                </a>
<span className="text-[10px] font-sans uppercase tracking-[0.2em] text-[#A1A1A6]/70">
                  Brief form · 48h response
                </span>
</div>
</div>
...
<footer className="text-[#F5F5F5] bg-[#0E0F11] border-[#23252B] border-t pt-20 pb-10">
...
<svg aria-hidden="true" data-icon="lucide:instagram" data-width="18" height="18" role="img" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
...
<a className="w-10 h-10 rounded-full border border-[#23252B] flex items-center justify-center hover:bg-[#F5F5F5] hover:text-[#0E0F11] transition-colors text-[#A1A1A6]" href="#">
<svg aria-hidden="true" data-icon="lucide:twitter" data-width="18" height="18" role="img" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
...
<a className="w-10 h-10 rounded-full border border-[#23252B] flex items-center justify-center hover:bg-[#F5F5F5] hover:text-[#0E0F11] transition-colors text-[#A1A1A6]" href="#">
<svg aria-hidden="true" data-icon="lucide:linkedin" data-width="18" height="18" role="img" viewbox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
<g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">

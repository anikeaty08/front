...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
      ...
      document.addEventListener('DOMContentLoaded', () => { const wrapper = document.getElementById('hero-parallax-wrapper'); let rafId; window.addEventListener('mousemove', (e) => { if (rafId) return; rafId = requestAnimationFrame(() => { const x = (window.innerWidth / 2 - e.clientX) * 0.015; const y = (window.innerHeight / 2 - e.clientY) * 0.015; wrapper.style.transform = `scale(1.05) translate3d(${x}px, ${y}px, 0)`; rafId = null; }); }, { passive: true }); });
...
<div className="aura-background-component absolute inset-0 w-full h-full" data-alpha-mask="80" style="
      ...
      -webkit-mask-size: 100% 100%;
              mask-size: 100% 100%;
    ">
<div className="absolute inset-0 w-full h-full bg-neutral-950" data-us-project="XxCmD31vVBmiINgvYCho"></div>
...
<a className="text-xs font-sans uppercase tracking-widest text-[#A1A1A6] hover:text-[#F5F5F5] border-b border-[#23252B] pb-1" href="#">
            Start a Project
          </a>
</div>
</div>
...
<a className="text-sm font-medium text-[#F5F5F5] hover:text-[#D6FF4F] transition-colors" href="#">
              Projects
            </a>
<a className="text-sm font-medium text-[#A1A1A6] hover:text-[#F5F5F5] transition-colors" href="#">
              Services
            </a>
<a className="text-sm font-medium text-[#A1A1A6] hover:text-[#F5F5F5] transition-colors" href="#">
              Insights
...
<svg aria-hidden="true" data-icon="lucide:mail" data-strokeWidth="1.5" data-width="24" height="24" role="img" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<h1 className="text-[14vw] md:text-[11vw] leading-[0.85] sm:mb-12 break-words font-medium text-[#F5F5F5] tracking-tight font-heading text-center w-full mb-8">
            Visual
            <br/>
...
<div className="absolute inset-0 w-full h-full scale-[1.05] will-change-transform" id="hero-parallax-wrapper">
<div className="flex h-full w-max animate-hero-scroll" id="hero-track">

<div className="relative h-full w-[100vw] md:w-[60vw] shrink-0 border-r border-[#23252B] overflow-hidden">
<img alt="Abstract 3D Design" className="h-full w-full object-cover opacity-80 animate-hero-img" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/68c70ed3-3617-478c-b904-4a86ef50ff12_3840w.webp"/>
</div>
<div className="relative h-full w-[100vw] md:w-[60vw] shrink-0 border-r border-[#23252B] overflow-hidden">
<img alt="Liquid Metal" className="h-full w-full object-cover opacity-80 animate-hero-img" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/feda1066-8c70-434c-9899-9f49ec90da32_3840w.webp"/>
</div>
<div className="relative h-full w-[100vw] md:w-[60vw] shrink-0 border-r border-[#23252B] overflow-hidden">
<img alt="Dark Architecture" className="h-full w-full object-cover opacity-80 animate-hero-img" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ad12226b-9c56-48b6-81b8-bf1ef9f0cb87_3840w.webp"/>
</div>
...
<p className="text-sm text-[#A1A1A6] leading-relaxed max-w-[240px]">
                  A curation of our most recent work defining brands across
                  fintech, lifestyle, and culture.
                </p>
...
<img className="group-hover:scale-105 transition-transform duration-700 opacity-60 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b9fdfc28-8272-467a-b305-f09454abb35a_1600w.webp" style={{transition: 'outline 0.1s ease-in-out', outline: 'rgb(245, 158, 11) solid 2px', outlineOffset: '2px'}}/>
<div className="absolute bottom-6 left-6 bg-[#0E0F11]/80 backdrop-blur px-4 py-2 rounded-full text-[10px] text-[#F5F5F5] font-mono border border-[#23252B]">
                    Fig. 02 — Materials
                  </div>
</div>
<div className="relative overflow-hidden group h-[300px] sm:h-auto bg-[#15171B]">
<img className="group-hover:scale-105 transition-transform duration-700 opacity-60 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3a6e12d2-345b-4681-a0ae-d817646753f8_1600w.webp" style={{transition: 'outline 0.1s ease-in-out'}}/>
<div className="absolute bottom-6 left-6 bg-[#0E0F11]/80 backdrop-blur px-4 py-2 rounded-full text-[10px] text-[#F5F5F5] font-mono border border-[#23252B]">
                    Fig. 03 — Output
                  </div>
</div>
...
<img className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3e6a3c0b-6b9e-4eb4-8fe1-9182d0819de9_1600w.webp"/>
</div>
</div>
...
<div className="md:col-span-5 h-full">
<div className="aspect-[4/5] rounded-2xl overflow-hidden border border-[#23252B] relative h-full">
<img className="w-full h-full object-cover opacity-80 grayscale hover:grayscale-0 transition-all duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f23d6400-b168-45c4-9907-f18dab7fda64_1600w.webp"/>
</div>
</div>
<div className="md:col-span-7 flex flex-col justify-center">
<div className="mb-8">

...
<img alt="" className="h-full w-full object-cover object-center opacity-100" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/22df5474-7a3a-4fea-b5c6-e2980964892d_3840w.jpg"/>
</div>
...
<img alt="Futuristic render" className="absolute inset-0 h-full w-full object-cover" src="https://scontent-del2-3.xx.fbcdn.net/v/t39.30808-6/602905681_844065638606512_615413257261496638_n.jpg?_nc_cat=103&amp;ccb=1-7&amp;_nc_sid=1d70fc&amp;_nc_ohc=2a24_SvIIs8Q7kNvwHs3Hvn&amp;_nc_oc=Adpr897Y-0KkwWDMOfPFiSjPzqqGIrLEzkDrLYcyF55-sRGX9oiZdyRSJQ0Q7XMIND6qCUrLYljjWw5ah0VlUQRU&amp;_nc_zt=23&amp;_nc_ht=scontent-del2-3.xx&amp;_nc_gid=VSQkYlv8CzzlNY-48fAgTA&amp;_nc_ss=7a3a8&amp;oh=00_Af3JiWrwx-rkol5zr_ap93Xrw3lSBBoR6uvgDoSfQ2nUgA&amp;oe=69D561C9"/>
...
<div className="">
<div className="text-sm tracking-widest text-white/60">SM</div>
<div className="text-[22px] tracking-tight font-semibold">Subhan Masoodi</div>
</div>
</div>
...
<p className="mt-1.5 text-sm text-white/0">Sign in to continue your conversation.</p>
</div>

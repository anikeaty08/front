...
<img alt="Block Blast logo" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a845d5b5-3393-45fb-9f92-7f139692636f_320w.jpg"/>
</div>
<h1 className="flex flex-col items-center text-center w-full max-w-4xl mr-auto mb-10 ml-auto" style={{textWrap: 'balance'}}>
<span className="block leading-[1.1] sm:text-4xl md:text-5xl lg:text-6xl xl:text-[4rem] text-4xl font-semibold text-white tracking-tight pt-3 pb-3">The ORGANIC feed runs 24/7. Pizza Ready isn't in it.</span>
...
<p className="leading-relaxed md:text-2xl text-base font-medium text-gray-300 text-center w-full max-w-2xl mr-auto ml-auto" style={{textWrap: 'balance'}}>Your users watch 300+ organic videos a day. None of them are Pizza Ready. We change that.</p>
</div>
...
<video autoplay="" className="w-full h-full object-cover z-0 absolute top-0 right-0 bottom-0 left-0" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1774019844/AQPJ33TecpcwjlyflLni-RRmu-mRb7xIuQMlzCZDNmO4jrUklvl9i4InkpVe-wHhe6xiW9gS0vX07aluUj6RR9Fyg3x6LDhXivC3fm2KgQ_vc9jgs.mp4"></video>
...
<div className="relative w-full h-1/2 bg-black">
<video autoplay="" className="absolute inset-0 w-full h-full object-cover z-0" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1774019861/202603201409_sj4bb1.mp4"></video>
...
<h2 className="md:text-4xl text-2xl font-medium text-white tracking-tight mb-3">What Pizza Ready looks like in the feed.</h2>
</div>
...
<video autoplay="" className="w-full h-full object-cover z-0 absolute top-0 right-0 bottom-0 left-0" loading="lazy" loop="" muted="" playsinline="" src="https://res.cloudinary.com/dpklxai6v/video/upload/v1774019861/202603201409_sj4bb1.mp4"></video>
...
<h2 className="text-3xl md:text-4xl font-semibold text-white tracking-tight mb-6">
          Pizza Ready players are scrolling right now.
        </h2>
...
<div className="uppercase text-base text-white tracking-widest">are Pizza ReadY</div>
</div>
<div className="glass-panel rounded-xl p-6 min-w-[180px] flex-1">
<div className="text-4xl font-semibold text-white tracking-tight mb-2">
              80%
...
<p className="text-base font-medium text-slate-400 text-center mt-12">We show data. Book 15 minutes and we walk you through Pizza Ready on the organic feed.</p>
</div>
</section>
...
<p className="md:text-xl text-lg font-normal text-white">15 minutes. We show you what Pizza Ready looks like in the organic feed.</p>

...
const animElements = document.querySelectorAll(`
  .reveal, .reveal-clip-left, .reveal-slide-right, 
  .reveal-clip-up, .reveal-pop, .reveal-zoom, .reveal-soft, 
  .stagger-children, .stagger-scale, .stagger-blur, 
  .stagger-pop, .stagger-draw, .stagger-soft, .stagger-clip
`);
...
// Service Cards Interactive Hover Glow
...
// Hero Button WebGL/Canvas Particle Effect
const btnCanvas = document.getElementById('heroBtnCanvas');
if (btnCanvas) {
  ...
  class Particle {
    constructor() {
      ...
      this.y = Math.random() * btnCanvas.height;
    ...
    update() {
      ...
      // Bounce off edges
      if (this.x <= 0 || this.x >= btnCanvas.width) this.speedX *= -1;
      if (this.y <= 0 || this.y >= btnCanvas.height) this.speedY *= -1;
    }
    
    draw() {
      ctx.fillStyle = `rgba(193, 127, 89, ${this.alpha})`;
      ctx.beginPath();
  ...
  function animateBtnCanvas() {
    ...
    requestAnimationFrame(animateBtnCanvas);
  }
...
<div className="cursor-glow" id="cursorGlow" style={{left: '463px', top: '295px'}}></div>

<nav className="nav" id="nav">
<div className="container nav-inner">
<a className="nav-logo" href="#">Ve Be</a>
...
<svg aria-hidden="true" className="iconify iconify--solar" data-icon="solar:buildings-bold" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="M15 2h2c1.886 0 2.828 0 3.414.586S21 4.114 21 6v15.25h1a.75.75 0 0 1 0 1.5H2a.75.75 0 0 1 0-1.5h1V9c0-1.886 0-2.828.586-3.414S5.114 5 7 5h4c1.886 0 2.828 0 3.414.586S15 7.114 15 9v12.25h1.5V8.91c0-.865 0-1.659-.087-2.304c-.095-.711-.32-1.463-.938-2.08c-.618-.619-1.37-.844-2.08-.94c-.637-.085-1.418-.086-2.269-.086c.084-.387.225-.68.46-.914C12.172 2 13.114 2 15 2M5.25 8A.75.75 0 0 1 6 7.25h6a.75.75 0 0 1 0 1.5H6A.75.75 0 0 1 5.25 8m0 3a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75m0 3a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75M9 18.25a.75.75 0 0 1 .75.75v2.25h-1.5V19a.75.75 0 0 1 .75-.75" fill="currentColor" fill-rule="evenodd"></path></svg>
    Award-Winning Sustainable Interiors
  </div>
<h1 className="hero-title">Designing spaces<br/>that breathe with <em>nature</em></h1>
<p className="hero-description">We create interiors that don't just exist in the environment — they converse with it. Every space is a dialogue between human aspiration and ecological responsibility.</p>
...
<h2 className="section-title reveal-slide-right reveal-delay-1">Interiors as <em>living dialogue</em></h2>
<p className="philosophy-quote reveal-slide-right reveal-delay-2">"The best interiors are not monuments to ego, but <span className="">quiet conversations</span> between place, purpose, and the passage of time."</p>
<p className="philosophy-desc reveal-slide-right reveal-delay-3">At Ve Be Interiors, we believe every space should give back more than it takes. Our biophilic approach integrates passive heating, natural ventilation, living walls, and locally-sourced materials into designs that feel timeless rather than trendy.</p>
...
<p>Full-service interior design from concept sketches through construction documents. Residential, commercial, and cultural projects shaped by sustainability.</p>
</div>
<div className="service-card reveal-child">
...
<p className="">Design doesn't stop at the facade. We design spaces that extend the living experience into gardens, courtyards, and natural terraces.</p>
</div>
<div className="service-card reveal-child">
...
<span>Net-Zero Interiors</span><div className="marquee-dot"></div>
...
<p className="testimonial-text">"Ve Be Interiors didn't just design a house; they shaped a sanctuary that feels entirely rooted in the landscape. Our energy bills are practically non-existent, yet the space feels luxurious and warm."</p>
...
<p className="testimonial-text">"Working with Ve Be Interiors is a truly collaborative experience. They listen deeply, not just to us, but to the land itself. The house they built for us breathes with the seasons."</p>
<div className="testimonial-author">
...
<span>Dezeen Awards<br/>Interiors 2022</span>
</div>
<div className="award-item">
...
<span>ArchDaily Interior<br/>of the Year 2021</span>
</div>
</div>
</div>
...
<img alt="Timber interior detail" className="blog-card-image" loading="lazy" src="https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?w=600&amp;q=80"/>
</div>
...
<h3>Ve Be Interiors Wins Dezeen Interiors Award</h3>
...
<a className="btn-glow" href="mailto:hello@vebeinteriors.com">
...
<div className="footer-logo">Ve Be Interiors</div>
<p className="">Creating sustainable, award-winning interiors that harmonize human living with the natural world. Luxury meets responsibility.</p>
...
<a aria-label="Pinterest" className="" href="#"><iconify-icon icon="fa6-brands:pinterest-p"></iconify-icon></a>
<a aria-label="Twitter" className="" href="#"><iconify-icon icon="fa6-brands:x-twitter"></iconify-icon></a>
</div>
</div>
...
<li className=""><a className="" href="#services">Design Services</a></li>
<li className=""><a href="#projects">Selected Works</a></li>
<li className=""><a href="#process">Methodology</a></li>
...
<ul className="">
<li className=""><a className="" href="mailto:hello@vebeinteriors.com">Contact@vebeinteriors.com</a></li>
<li className=""><a className="" href="tel:+15550192837">+1 (555) 019-2837</a></li>
<li className=""><a className="" href="#">1200 Eco Boulevard,<br/>Portland, OR 97204</a></li>
</ul>
</div>
<div className="footer-column">
<h4>Newsletter</h4>
<p style={{fontSize: '0.85rem', color: 'var(--color-text-muted)', marginBottom: '1rem', lineHeight: '1.6'}}>Subscribe for insights on sustainable interior design and studio updates.</p>
...
<p>© 2023 Ve Be Interiors. All rights reserved.</p>

...
<header className="flex shrink-0 w-full items-start justify-between">
...
<svg className="lucide lucide-menu w-[16px] h-[16px]" data-icon-replaced="true" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{color: 'rgb(255, 255, 255)', width: '16px', height: '16px'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
</button>
</div>
</header>

<main className="flex-1 flex flex-col md:flex-row md:items-stretch md:mt-8 overflow-hidden w-full mt-6 gap-x-6 gap-y-6 items-center justify-between">

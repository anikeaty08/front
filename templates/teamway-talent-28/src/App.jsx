...
<nav className="md:px-12 flex w-full max-w-[1440px] mr-auto ml-auto pt-6 pr-6 pb-6 pl-6 items-center justify-between">
...
<a className="hover:text-gray-900 transition-colors" href="#">Компании</a>
<a className="hover:text-gray-900 transition-colors" href="#">Участники</a>
<a className="hover:text-gray-900 transition-colors" href="#">Сообщество</a>
<a className="hover:text-gray-900 transition-colors" href="#">О нас</a>
<a className="hover:text-gray-900 transition-colors" href="#">Login</a>
</div>

<div className="hidden md:block">
<button className="hover:bg-gray-800 transition-all text-sm font-medium text-white bg-gray-900 rounded-full pt-2.5 pr-5 pb-2.5 pl-5">Найти талант</button>
</div>
...
<main className="md:px-12 lg:flex lg:gap-16 w-full max-w-[1440px] mr-auto ml-auto pt-8 pr-6 pb-20 pl-6 items-center">

<div className="lg:w-[40%] flex flex-col lg:mb-0 mb-16 justify-center">
<h1 className="md:text-6xl lg:text-[5rem] leading-[1.1] text-5xl font-semibold text-gray-900 tracking-tight mb-8">Построй свою <br/> команду мечты <br/> сегодня.</h1>
<p className="md:text-xl leading-relaxed text-lg font-normal text-gray-600 max-w-md mb-10">Достигните успеха с нашей тщательно подобранной командой экспертов. Нанимайте сейчас, чтобы получить непревзойденные результаты.</p>
...
<span className="text-sm font-medium">Нанимаете сотрудников? Закажите звонок</span>
...
<span className="flex items-center gap-1 text-xs font-semibold text-gray-900">Михаил <svg className="lucide lucide-check-circle-2 w-3 h-3 text-black fill-current" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg></span>
<span className="text-[10px] text-gray-500 font-medium">Frontend Dev.</span>
</div>
</div>
</div>

<div className="flex flex-col min-h-[220px] bg-[#E0D8F5] rounded-3xl pt-6 pr-6 pb-6 pl-6 justify-center">
<h3 className="text-xl font-medium text-gray-900 tracking-tight mb-3">Удаленный резерв талантов</h3>
<p className="leading-relaxed text-xs font-normal text-gray-700">Предварительно проверенные удаленные разработчики, дизайнеры и менеджеры по продуктам с техническими и коммуникативными навыками мирового уровня.</p>
</div>
</div>
...
<h3 className="text-xl font-medium text-gray-900 tracking-tight mb-3">Быстрый и адаптируемый</h3>
<p className="leading-relaxed text-xs font-normal text-gray-700">Наймите сотрудников всего за 72 часа. Легко корректируйте размер своей команды от месяца к месяцу в соответствии с потребностями.</p>
</div>
...
<div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm py-2 px-3 rounded-2xl shadow-lg flex items-center gap-2">
<div className="flex flex-col">
<span className="flex items-center gap-1 text-xs font-semibold text-gray-900">Александр <svg className="lucide lucide-check-circle-2 w-3 h-3 text-black fill-current" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg></span>
...
<div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm py-2 px-3 rounded-2xl shadow-lg flex items-center gap-2">
<div className="flex flex-col">
<span className="flex items-center gap-1 text-xs font-semibold text-gray-900">Леся <svg className="lucide lucide-check-circle-2 w-3 h-3 text-black fill-current" data-lucide="check-circle-2" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg></span>
<span className="text-[10px] text-gray-500 font-medium">Mobile Dev.</span>
</div>
</div>
</div>

<div className="overflow-hidden flex flex-col flex-grow min-h-[300px] bg-[#FBCBA5] rounded-3xl pt-6 pr-6 pb-6 pl-6 relative justify-center">
...
<p className="leading-snug text-lg font-medium text-gray-900 tracking-tight">Будьте уверены, вам не придется беспокоиться о каких-либо безумных сборах или юридических хлопотах.</p>
</div>
</div>
</div>
</div>
...
<svg className="lucide lucide-zap w-5 h-5 fill-current" data-lucide="zap" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg> Layerise
                </div>

...
<div className="group relative">
<div className="aspect-[4/5] overflow-hidden rounded-lg bg-zinc-900 mb-4 relative border border-white/5">
<img alt="Marcus Cole" className="object-cover w-full h-full opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500 grayscale group-hover:grayscale-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60"></div>
</div>
...
<div className="group relative">
<div className="aspect-[4/5] overflow-hidden rounded-lg bg-zinc-900 mb-4 relative border border-white/5">
<img alt="Elena Rodriguez" className="object-cover w-full h-full opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500 grayscale group-hover:grayscale-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60"></div>
</div>
...
<div className="group relative">
<div className="aspect-[4/5] overflow-hidden rounded-lg bg-zinc-900 mb-4 relative border border-white/5">
<img alt="David Park" className="object-cover w-full h-full opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-500 grayscale group-hover:grayscale-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60"></div>
</div>
...
<section className="overflow-hidden pt-24 pb-24 relative" id="schedule">
...
<div className="flex items-center gap-2">
<div className="w-5 h-5 rounded-full bg-zinc-800 overflow-hidden">
<img className="w-full h-full object-cover grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/30104e3c-5eea-4b93-93e9-5313698a7156_1600w.webp"/>
</div>
...
<div className="flex items-center gap-2">
<div className="w-5 h-5 rounded-full bg-zinc-800 overflow-hidden">
<img className="w-full h-full object-cover grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
</div>
...
<h2 className="md:text-4xl text-3xl font-medium text-white tracking-tighter">Tickets Type</h2>
</div>

<div className="flex justify-center mb-16">
<div className="inline-flex bg-zinc-900/80 border-white/5 border rounded-lg pt-1 pr-1 pb-1 pl-1 relative backdrop-blur-sm">
<button className="text-xs font-medium text-white bg-zinc-800 z-10 border-white/5 border rounded-md pt-1.5 pr-6 pb-1.5 pl-6 shadow-sm">Individuals</button>
<button className="hover:text-zinc-300 z-10 transition-colors text-xs font-medium text-zinc-500 rounded-md pt-1.5 pr-6 pb-1.5 pl-6">Teams</button>
</div>
</div>
...
<div className="max-w-7xl mx-auto px-6">
<div className="flex flex-col md:flex-row border-white/5 border-b mb-0 pb-0 items-end justify-between">
<div className="">
...
<footer className="overflow-hidden bg-zinc-950 border-white/5 border-t pt-20 pb-12 relative">
...
<div className="bg-zinc-900/50 w-full max-w-md border-white/5 border rounded-2xl pt-6 pr-6 pb-6 pl-6 backdrop-blur-sm">

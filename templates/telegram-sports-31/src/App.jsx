...
<main className="max-w-lg w-full mx-auto flex flex-col items-center text-center">
...
<h1 className="text-3xl sm:text-4xl font-semibold tracking-tight text-[#ff4bd1] mb-2">
            SONDIP CHANNEL
        </h1>
...
<div className="w-full bg-white/[0.03] border border-white/[0.08] backdrop-blur-md rounded-3xl p-8 mb-8 shadow-2xl relative overflow-hidden group">
...
<a className="relative inline-flex items-center justify-center gap-2.5 w-full py-4 px-6 rounded-full text-white text-base font-semibold shadow-lg shadow-pink-500/25 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] hover:shadow-pink-500/40 ring-1 ring-white/10" href="https://t.me/+1YIvicdPFutjYWFl" style={{background: 'linear-gradient(90deg, #ff00cc, #ff4bd1)'}}>
<iconify-icon className="text-xl rotate-45" icon="solar:map-arrow-up-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
                JOIN TELEGRAM NOW
            </a>
</div>
...
<span>100% Accurate Football &amp; Cricket Predictions</span>
</li>
<li className="flex items-start gap-3 py-3.5 border-b border-white/[0.06] last:border-0 group transition-colors hover:text-white">
<iconify-icon className="text-lg text-[#ff4bd1] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<li className="flex items-start gap-3 py-3.5 border-b border-white/[0.06] last:border-0 group transition-colors hover:text-white">
<iconify-icon className="text-lg text-[#ff4bd1] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<span>Exclusive Members-Only Premium Picks</span>
</li>
<li className="flex items-start gap-3 py-3.5 border-b border-white/[0.06] last:border-0 group transition-colors hover:text-white">
<iconify-icon className="text-lg text-[#ff4bd1] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
...
<li className="flex items-start gap-3 py-3.5 border-b border-white/[0.06] last:border-0 group transition-colors hover:text-white">
<iconify-icon className="text-lg text-[#ff4bd1] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<span>Bankroll Management Strategies</span>
</li>
<li className="flex items-start gap-3 py-3.5 border-b border-white/[0.06] last:border-0 group transition-colors hover:text-white">
<iconify-icon className="text-lg text-[#ff4bd1] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" icon="solar:check-circle-linear" style={{strokeWidth: '1.5'}}></iconify-icon>
<span>Weekly Accumulator &amp; Combo Bets</span>
</li>
</ul>
</div>

<footer className="mt-12 text-xs text-zinc-500 font-medium">

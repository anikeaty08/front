...
<div className="group overflow-hidden bg-zinc-900/30 z-10 rounded-[2.5rem] mb-6 relative backdrop-blur-xl" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.05))', '--border-radius-before': '2.5rem'}}>
...
<div className="group overflow-hidden z-10 rounded-[2.5rem] mb-6 relative backdrop-blur-xl border bg-zinc-900/30 border-white/5" style={{'--border-gradient': 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.05))', '--border-radius-before': '2.5rem'}}>
...
<div className="flex hover:bg-white/[0.04] transition-colors cursor-pointer group bg-gradient-to-br rounded-xl px-3 py-3 items-center justify-between from-white/10 to-white/0" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '12px'}}>
<div className="flex items-center gap-3">
...
<div className="flex flex-col flex-1 transition-colors bg-gradient-to-br rounded-2xl pt-3 pr-3 pb-3 pl-3 hover:bg-white/10 from-white/10 to-white/0" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '16px'}}>
...
<span className="inline-flex items-center gap-1.5 text-[10px] font-medium bg-gradient-to-br rounded-full pt-1 pr-2.5 pb-1 pl-2.5 text-zinc-300 from-white/10 to-white/0" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0))', '--border-radius-before': '9999px'}}>
...
<div className="group transition-all duration-500 hover:bg-zinc-900/60 bg-zinc-900/40 rounded-[2.5rem] relative backdrop-blur-sm px-5 py-8 md:p-10" style={{position: 'relative', -BorderGradient: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.1))', '--border-radius-before': '2.5rem'}}>

...
<span className="text-base font-medium text-slate-900 tracking-tight" style={{}}>MindFlow Strategies</span>
</div>
<p>markos@mindflowstrategies.com</p>
<p></p><p className="text-sm text-slate-400">Helping private practice therapists achieve true autonomy. <br className="md:hidden"/>© 2025 MindFlow Strategies</p>
</div>
</footer>

...
<a className="text-xl font-medium tracking-tighter uppercase text-slate-900 flex items-center gap-2" href="#">
<iconify-icon className="text-teal-500" icon="lucide:waves" strokeWidth="1.5" width="20"></iconify-icon>
                Ocean Rays
            </a>

<div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-500">
<a className="hover:text-slate-900 transition-colors duration-200" href="#shop">Shop</a>
<a className="hover:text-slate-900 transition-colors duration-200" href="#benefits">The Science</a>
<a className="hover:text-slate-900 transition-colors duration-200" href="#about">Our Source</a>
<a className="hover:text-slate-900 transition-colors duration-200" href="#recipes">Recipes</a>
</div>
...
<a className="group hover:bg-slate-800 transition-all duration-300 flex items-center gap-2 shadow-slate-200 text-sm font-medium text-white bg-slate-900 rounded-full pt-3 pr-8 pb-3 pl-8 relative shadow-lg" href="https://www.whatnot.com/user/theoceanrays">
                        Shop Collection
...
<iconify-icon className="" icon="lucide:play-circle" strokeWidth="1.5" width="16"></iconify-icon>
                        Watch the Process
                    </button>
</div>
<div className="pt-8 flex items-center gap-6 text-slate-400 text-xs font-medium uppercase tracking-widest">
<div className="flex items-center gap-2">
<iconify-icon icon="lucide:droplets" strokeWidth="1.5" width="16"></iconify-icon>
                        Wildcrafted
                    </div>
<div className="flex items-center gap-2">
<iconify-icon icon="lucide:vegan" strokeWidth="1.5" width="16"></iconify-icon>
                        Organic
                    </div>
<div className="flex items-center gap-2">
...
<img alt="Ocean Rays Sea Moss Gel" className="group-hover:scale-105 transition-transform duration-700 ease-in-out w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dd1a4eda-6472-4294-a070-1bb7e507618b_1600w.png"/>
...
<div className="inline-flex gap-12 animate-[marquee_20s_linear_infinite] text-xs font-medium tracking-widest uppercase">
<span className="">Gut Health</span>
<span>•</span>
<span className="">Immunity Support</span>
<span>•</span>
<span>Radiant Skin</span>
<span>•</span>
<span className="">Thyroid Balance</span>
<span>•</span>
<span className="">Energy Boost</span>
<span className="">•</span>
<span className="">Gut Health</span>
<span>•</span>
...
<div className="absolute inset-0 bg-slate-200 animate-pulse hidden"></div> 
<img alt="Gold Sea Moss" className="group-hover:scale-105 transition-transform duration-500 mix-blend-multiply w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5265f8a5-9731-43cc-87c1-91e816288ebd_800w.png"/>
...
<svg className="" data-icon-set="lucide" data-lucide="plus" height="20" style={{}} viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14m-7-7v14" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
</button>
</div>
...
<div className="group relative">
<div className="relative aspect-square rounded-2xl bg-slate-50 overflow-hidden mb-5 border border-slate-100">
<img alt="Purple Sea Moss" className="group-hover:scale-105 transition-transform duration-500 mix-blend-multiply w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/855ab896-1602-4568-b024-95f76e8f7474_800w.png"/>
...
<div className="group relative">
<div className="relative aspect-square rounded-2xl bg-slate-50 overflow-hidden mb-5 border border-slate-100">
<img alt="Infused Sea Moss" className="group-hover:scale-105 transition-transform duration-500 mix-blend-multiply w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bebbcab0-4d36-4990-9730-eec0541fc8c5_800w.png"/>
<button className="absolute bottom-4 right-4 h-10 w-10 bg-white rounded-full shadow-md flex items-center justify-center text-slate-900 hover:bg-teal-500 hover:text-white transition-all duration-300 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0">
...
<img alt="User" className="h-full w-full object-cover" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=100&amp;q=80"/>
</div>
<div>
...
<iconify-icon className="text-teal-400 mb-6" icon="lucide:waves" strokeWidth="1.5" width="32"></iconify-icon>
...
<input className="flex-1 bg-white/10 border border-white/10 rounded-full px-6 py-3 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 backdrop-blur-sm transition-all" placeholder="email@address.com" type="email"/>
<button className="bg-white text-slate-900 px-8 py-3 rounded-full font-medium hover:bg-teal-50 transition-colors" type="button">Subscribe</button>
</form>
...
<a className="text-lg font-medium tracking-tighter uppercase text-slate-900 flex items-center gap-2 mb-6" href="#">
<iconify-icon className="text-teal-500" icon="lucide:waves" strokeWidth="1.5" width="18"></iconify-icon>
                        Ocean Rays
                    </a>
...
<li className=""><a className="hover:text-teal-600 transition-colors" href="#">All Gels</a></li>
<li className=""><a className="hover:text-teal-600 transition-colors" href="#">Bundles</a></li>
<li className=""><a className="hover:text-teal-600 transition-colors" href="#">Wholesale</a></li>
</ul>
</div>
<div className="">
...
<li><a className="hover:text-teal-600 transition-colors" href="#">Sourcing</a></li>
...
<li><a className="hover:text-teal-600 transition-colors" href="#">Shipping</a></li>
</ul>
</div>
</div>

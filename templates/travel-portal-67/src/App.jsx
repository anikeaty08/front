...
'90%': { transform: 'translate(-10%, 10%)' },
         ...
         const translations = {
            en: {
                ...
                faq_a1: "Seamlessly. We prioritize integration over replacement. Luxota offers real-time synchronization.",
...
<div className="text-[8rem] md:text-[12rem] font-medium leading-none tracking-tighter text-white/5 relative z-10 font-sans"><span id="counter">100</span>%</div>
...
</div><div className="cursor-dot hidden md:block" style={{left: '730px', top: '76px'}}></div>
<div className="cursor-outline hidden md:flex" style={{left: '1008px', top: '530px'}}><span className="cursor-text" data-i18n="cursor_view">View</span></div>
...
<div className="md:col-span-4 flex flex-col justify-center p-6 lg:sticky lg:top-32 self-start text-start [animation:fadeInLeft_1s_ease-out_both] animate-on-scroll">
...
<div className="spotlight-card rounded-[2rem] p-10 flex flex-col justify-between group cursor-none h-full min-h-[400px] [animation:fadeInUp_0.8s_ease-out_0.1s_both] animate-on-scroll" style={{'--mouse-x': '310px', '--mouse-y': '2627.33349609375px'}}>
...
<div className="spotlight-card rounded-[2rem] p-10 flex flex-col justify-center group cursor-none min-h-[220px] [animation:fadeInUp_0.8s_ease-out_0.2s_both] animate-on-scroll" style={{'--mouse-x': '-86px', '--mouse-y': '2627.33349609375px'}}>
...
<div className="spotlight-card rounded-[2rem] p-10 flex-1 min-h-[240px] flex flex-col justify-end group cursor-none [animation:fadeInUp_0.8s_ease-out_0.3s_both] animate-on-scroll" style={{'--mouse-x': '-86px', '--mouse-y': '2383.33349609375px'}}>
...
<div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1212px', height: '3789px', padding: '0px 0px 3000px'}}><div className="pin-spacer" style={{order: '0', placeSelf: 'auto', gridArea: 'auto', zIndex: 'auto', float: 'none', flexShrink: '1', display: 'block', margin: '0px', inset: '0px', position: 'relative', flexBasis: 'auto', overflow: 'visible', boxSizing: 'border-box', width: '1212px', height: '3789px', padding: '0px 0px 3000px'}}><section className="hidden lg:block h-screen relative" id="architecture-pin" style={{inset: '0.333496px auto auto 0px', margin: '0px', maxWidth: '1212px', width: '1212px', maxHeight: '789px', height: '789px', padding: '0px', boxSizing: 'border-box', position: 'fixed'}}>
...
<a className="spotlight-card shrink-0 flex overflow-hidden cursor-pointer group bg-[#050507] w-[70vw] h-[65vh] max-w-[900px] border-white/10 border rounded-[2.5rem] pt-16 pr-16 pb-16 pl-16 relative" href="/travel" style={{'--mouse-x': '1200.70166015625px', '--mouse-y': '-62.85417175292969px'}}>
...
<a className="spotlight-card shrink-0 flex overflow-hidden cursor-pointer group bg-[#050507] w-[70vw] h-[65vh] max-w-[900px] border-white/10 border rounded-[2.5rem] pt-16 pr-16 pb-16 pl-16 relative" href="/sharehub" style={{'--mouse-x': '13.872222900390625px', '--mouse-y': '197.70895385742188px'}}>
<div className="w-5/12 flex flex-col justify-between relative z-10 h-full text-start">
<div className="">
<div className="inline-flex p-4 rounded-2xl bg-white/5 border border-white/10 mb-10 shadow-xl backdrop-blur-md group-hover:bg-white/10 transition-colors">
...
<a className="w-[70vw] max-w-[900px] h-[65vh] spotlight-card rounded-[2.5rem] p-16 shrink-0 relative flex overflow-hidden border border-white/10 bg-[#050507] cursor-pointer group" href="#trustee" style={{'--mouse-x': '-645.54833984375px', '--mouse-y': '-62.85417175292969px'}}>
<div className="w-5/12 flex flex-col justify-between relative z-10 h-full text-start">
<div>
<div className="inline-flex p-4 rounded-2xl bg-white/5 border border-white/10 mb-10 shadow-xl backdrop-blur-md group-hover:bg-white/10 transition-colors">
...
<a className="spotlight-card rounded-3xl p-8 border border-white/10 block [animation:fadeInUp_0.8s_ease-out_both] animate-on-scroll" href="#" style={{'--mouse-x': '730px', '--mouse-y': '76px'}}>
...
<a className="spotlight-card rounded-3xl p-8 border border-white/10 block [animation:fadeInUp_0.8s_ease-out_0.1s_both] animate-on-scroll" href="#" style={{'--mouse-x': '730px', '--mouse-y': '76px'}}>
...
<a className="spotlight-card rounded-3xl p-8 border border-white/10 block [animation:fadeInUp_0.8s_ease-out_0.2s_both] animate-on-scroll" href="#" style={{'--mouse-x': '730px', '--mouse-y': '76px'}}>
...
<div className="lg:sticky lg:top-32 self-start text-start [animation:fadeInLeft_1s_ease-out_both] animate-on-scroll">
...
<div className="group cursor-pointer transition-all hover:translate-x-2 rtl:hover:-translate-x-2 text-start [animation:fadeInUp_0.6s_ease-out_0.1s_both] animate-on-scroll">
...
<div className="group cursor-pointer transition-all hover:translate-x-2 rtl:hover:-translate-x-2 text-start [animation:fadeInUp_0.6s_ease-out_0.2s_both] animate-on-scroll">
...
<div className="group cursor-pointer transition-all hover:translate-x-2 rtl:hover:-translate-x-2 text-start [animation:fadeInUp_0.6s_ease-out_0.3s_both] animate-on-scroll">
...
<div className="group cursor-pointer transition-all hover:translate-x-2 rtl:hover:-translate-x-2 text-start [animation:fadeInUp_0.6s_ease-out_0.4s_both] animate-on-scroll">
...
<div>
<span className="text-xs text-luxota-accent font-mono mb-4 block tracking-widest [animation:fadeInUp_0.8s_ease-out_both] animate-on-scroll" data-i18n="comm_label">[ 04 — COMMERCIAL MODEL ]</span>
<h2 className="text-4xl md:text-6xl font-medium tracking-tight text-white leading-[1.1] [animation:fadeInUp_0.8s_ease-out_0.1s_both] animate-on-scroll">
...
<div className="relative ps-8 border-s border-white/10 [animation:fadeInUp_0.8s_ease-out_0.2s_both] animate-on-scroll">
...
<div className="relative ps-8 border-s border-luxota-accent [animation:fadeInUp_0.8s_ease-out_0.3s_both] animate-on-scroll">
...
<div className="pt-4 [animation:fadeInUp_0.8s_ease-out_0.4s_both] animate-on-scroll">
...
<div className="lg:col-span-7 relative [animation:scaleIn_1s_cubic-bezier(0.16,1,0.3,1)_0.2s_both] animate-on-scroll">
...
<div className="text-center mb-20 [animation:fadeInUp_0.8s_ease-out_both] animate-on-scroll">
...
<div className="faq-item group border border-white/5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] transition-all overflow-hidden [animation:fadeInUp_0.8s_ease-out_0.1s_both] animate-on-scroll">
...
<div className="px-6 pb-8 text-luxota-dim leading-relaxed max-w-2xl text-start" data-i18n="faq_a1">Seamlessly. We prioritize integration over replacement. Luxota offers real-time synchronization.</div>
</div>
</div>
<div className="faq-item group border border-white/5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] transition-all overflow-hidden [animation:fadeInUp_0.8s_ease-out_0.2s_both] animate-on-scroll">
<button className="w-full flex justify-between items-center p-6 text-start focus:outline-none">
...
<h2 className="text-6xl md:text-9xl font-medium tracking-tightest text-white mb-10 leading-[0.85] [animation:scaleIn_1s_cubic-bezier(0.16,1,0.3,1)_both] animate-on-scroll">
...
<div className="flex flex-col items-center gap-10 [animation:fadeInUp_0.8s_ease-out_0.3s_both] animate-on-scroll">
...
<div className="[animation:fadeInUp_0.8s_ease-out_both] animate-on-scroll">
...
<div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-luxota-dim/60 font-mono tracking-wider gap-4 [animation:fadeIn_1s_ease-out_0.5s_both] animate-on-scroll">

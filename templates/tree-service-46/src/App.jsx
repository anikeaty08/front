...
<a className="text-xl font-semibold tracking-tight text-stone-900" href="#">andy's<span className="text-emerald-600">tree</span></a>
...
<span className="iconify text-white/90" data-icon="lucide:trees" data-width="120" style={{strokeWidth: '1'}}></span>
</div>
</div>
<div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-xl shadow-stone-900/10">
<div className="flex items-center gap-3">
<div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center">
<span className="iconify text-amber-600" data-icon="lucide:clock" data-width="20" style={{strokeWidth: '1.5'}}></span>
</div>
<div>
...
<span className="iconify text-emerald-600" data-icon="lucide:scissors" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-amber-600" data-icon="lucide:axe" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-rose-600" data-icon="lucide:disc-3" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-sky-600" data-icon="lucide:zap" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-violet-600" data-icon="lucide:sprout" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-teal-600" data-icon="lucide:leaf" data-width="24" style={{strokeWidth: '1.5'}}></span>
</div>
...
<span className="iconify text-white" data-icon="lucide:check" data-width="16" style={{strokeWidth: '2'}}></span>
</div>
<div>
...
<span className="iconify text-amber-400" data-icon="lucide:star" data-width="18" style={{fill: 'currentColor'}}></span>
<span className="iconify text-amber-400" data-icon="lucide:star" data-width="18" style={{fill: 'currentColor'}}></span>
<span className="iconify text-amber-400" data-icon="lucide:star" data-width="18" style={{fill: 'currentColor'}}></span>
<span className="iconify text-amber-400" data-icon="lucide:star" data-width="18" style={{fill: 'currentColor'}}></span>
<span className="iconify text-amber-400" data-icon="lucide:star" data-width="18" style={{fill: 'currentColor'}}></span>
...
<span className="iconify text-white" data-icon="lucide:phone" data-width="22" style={{strokeWidth: '1.5'}}></span>
</div>
<div>
...
<span className="iconify text-white" data-icon="lucide:mail" data-width="22" style={{strokeWidth: '1.5'}}></span>
</div>
<div>
...
<span className="iconify text-white" data-icon="lucide:map-pin" data-width="22" style={{strokeWidth: '1.5'}}></span>
</div>
<div>

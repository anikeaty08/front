...
'100%': { transform: 'translateY(100%)' },
      ...
      // TYPEWRITER EFFECT
      const words = ["plumbers", "electricians", "landscapers", "builders", "hvac pros"];
      let i = 0;
      let timer;
      ...
      function typeWriter() {
        ...
        if (currentText.length < word.length) {
          textElement.innerHTML += word.charAt(currentText.length);
      ...
      backdrop.addEventListener('click', closeAuditModal);
...
<div className="w-full max-w-5xl mx-auto mt-9 mb-6 relative z-20 animate-slide-up-delayed opacity-0" style={{animationDelay: '2.6s'}}>

<div className="flex items-center justify-center gap-2 mb-4 opacity-90 hover:opacity-100 transition-opacity">
<span className="text-sm font-medium text-slate-500 dark:text-slate-400 tracking-wider uppercase">
              Trusted by
            </span>
<div className="flex items-center gap-0.5">
<iconify-icon className="text-amber-400" icon="ri:star-fill" width="12"></iconify-icon>
<iconify-icon className="text-amber-400" icon="ri:star-fill" width="12"></iconify-icon>
<iconify-icon className="text-amber-400" icon="ri:star-fill" width="12"></iconify-icon>
<iconify-icon className="text-amber-400" icon="ri:star-fill" width="12"></iconify-icon>
<iconify-icon className="text-amber-400" icon="ri:star-fill" width="12"></iconify-icon>
</div>
<iconify-icon className="text-emerald-500" icon="lucide:badge-check" width="16"></iconify-icon>
</div>
<div className="relative w-full overflow-hidden mask-fade-sides group select-none">
<div className="flex gap-12 md:gap-20 w-max animate-infinite-scroll group-hover:[animation-play-state:paused] items-center py-2">


<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 160 40">
<path d="M20 6 L34 34 H28 L20 18 L12 34 H6 L20 6 Z M16 26 H24"></path>
<text fontFamily="'Inter', sans-serif" fontSize="18" font-weight="700" letter-spacing="-0.5" x="42" y="27">
                  ATLAS BUILD
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 170 40">
<path d="M15 4 L25 4 L21 16 L28 16 L12 36 L16 20 L9 20 Z"></path>
<text fontFamily="'Inter', sans-serif" fontSize="17" font-weight="800" letter-spacing="0.5" x="36" y="26">
                  IRONCLAD
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 180 40">
<path d="M8 20 Q14 10 20 20 T32 20" strokeLinecap="round" strokeWidth="2.5"></path>
<path d="M8 26 Q14 16 20 26 T32 26" opacity="0.6" strokeLinecap="round" strokeWidth="2.5"></path>
<text fill="currentColor" fontFamily="'Inter', sans-serif" fontSize="18" font-weight="600" stroke="none" x="40" y="26">
                  BlueWave
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 170 40">
<path d="M10 24 L20 8 L30 24 M15 24 L20 16 L25 24"></path>
<text fontFamily="'Inter', sans-serif" fontSize="18" font-weight="700" letter-spacing="1" x="38" y="26">
                  SUMMIT
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 160 40">
<path d="M20 6 L23 14 L31 14 L24 19 L27 27 L20 22 L13 27 L16 19 L9 14 L17 14 Z" opacity="0.8"></path>
<text fontFamily="'Inter', sans-serif" fontSize="19" font-weight="500" x="38" y="26">
                  ClearView
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 180 40">
<rect fill="none" height="24" rx="4" stroke="currentColor" strokeWidth="2" width="24" x="8" y="8"></rect>
<path d="M14 26 L14 14 L26 26 L26 14" stroke="currentColor" strokeWidth="2.5"></path>
<text fontFamily="'Inter', sans-serif" fontSize="17" font-weight="800" letter-spacing="0.5" x="40" y="26">
                  NORTHSIDE
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 170 40">
<circle cx="20" cy="20" fill="none" r="8" stroke="currentColor" strokeWidth="1.5"></circle>
<path d="M20 8 V6 M20 34 V32 M8 20 H6 M34 20 H32 M12 12 L10 10 M30 30 L28 28 M12 28 L10 30 M30 12 L28 10" stroke="currentColor" strokeWidth="1.5"></path>
<text fontFamily="'Inter', sans-serif" fontSize="18" font-weight="600" x="40" y="26">
                  SolarEdge
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 140 40">
<path d="M10 20 L18 12 L26 20 V30 H10 Z" fill="none" stroke="currentColor" strokeWidth="2"></path>
<text fontFamily="'Inter', sans-serif" fontSize="19" font-weight="700" x="36" y="26">
                  Prime
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="none" stroke="currentColor" strokeWidth="2" viewbox="0 0 170 40">
<path d="M10 16 H26 M8 22 H24 M12 28 H28" strokeLinecap="round"></path>
<text fill="currentColor" fontFamily="'JetBrains Mono', monospace" fontSize="18" font-weight="700" stroke="none" x="38" y="26">
                  FLOWTECH
                </text>
</svg>

<svg className="h-8 md:h-10 w-auto text-slate-600 dark:text-slate-400 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-default" fill="currentColor" viewbox="0 0 130 40">
<path d="M20 8 L23 16 L31 16 L24 21 L27 29 L20 24 L13 29 L16 21 L9 16 L17 16 Z"></path>
<text fontFamily="'Inter', sans-serif" fontSize="18" font-weight="700" letter-spacing="1" x="38" y="26">
                  ELITE
                </text>
</svg>
...
<div className="dashboard-container w-full max-w-6xl z-20 mx-auto px-4 relative animate-slide-up-delayed opacity-0 mt-20" style={{animationDelay: '0.5s'}}>
...
<p className="text-[13px] text-slate-500 truncate group-hover:text-slate-700 transition-colors">
                    Is the quote strictly valid for 7 days?
                  </p>
</div>
</div>
<div className="bg-white p-4 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.02)] border border-slate-100 flex items-center gap-3.5 hover:shadow-md transition-shadow cursor-pointer group">
...
<iconify-icon className="text-blue-500 opacity-80 group-hover:opacity-100 transition-opacity" icon="lucide:message-square" width="16"></iconify-icon>
</div>
<p className="text-[13px] text-slate-500 truncate group-hover:text-slate-700 transition-colors">
                    Can you guys start on Monday?
                  </p>
</div>
</div>
<div className="bg-white p-4 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.02)] border border-slate-100 flex items-center gap-3.5 hover:shadow-md transition-shadow cursor-pointer group">
<div className="w-11 h-11 rounded-full bg-slate-100 flex items-center justify-center text-slate-700 font-bold text-sm border border-slate-200/50">
                  J
                </div>
<div className="flex-1 min-w-0">
<div className="flex justify-between items-center mb-0.5">
...
<iconify-icon className="text-slate-400 opacity-80 group-hover:opacity-100 transition-opacity" icon="lucide:mail" width="16"></iconify-icon>
</div>
<p className="text-[13px] text-slate-500 truncate group-hover:text-slate-700 transition-colors">
                    Re: Commercial Project Inquiry
                  </p>
</div>
</div>
</div>
...
<iconify-icon icon="lucide:inbox" width="20"></iconify-icon>
</div>
<div className="flex flex-col items-center gap-1 p-2 text-slate-300">
<iconify-icon icon="lucide:users" width="20"></iconify-icon>
</div>
<div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-blue-500/30 -mt-6 border-4 border-white">
...
<div className="absolute inset-0 bg-slate-50/30 dark:bg-[#020204]/70 -z-10 transition-colors duration-500"></div>
<div className="max-w-7xl mx-auto px-6 relative z-10">
<div className="text-center mb-16">
<h2 className="text-3xl md:text-4xl font-medium text-slate-900 dark:text-white tracking-tight font-serif mb-4">
            Simple, ROI-positive pricing.
          </h2>
<p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto">
            Most clients recover their monthly investment with just
            <span className="text-slate-900 dark:text-white font-medium">
              one saved lead
            </span>
            .
...
<div className="relative p-8 rounded-2xl bg-white/60 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 backdrop-blur-md flex flex-col">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
              Perfect for solopreneurs getting started with automation.
            </p>
<button className="w-full py-2.5 rounded-lg border border-slate-200 dark:border-white/10 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors mb-8" onclick="openAuditModal()">
              Get Started
            </button>
<ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400 flex-1">
...
<div className="relative p-8 rounded-2xl bg-white dark:bg-[#0a0a0c] border border-blue-500/30 dark:border-blue-500/30 shadow-xl shadow-blue-500/10 flex flex-col transform md:-translate-y-4">
<div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-3 py-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[10px] font-bold uppercase tracking-wider rounded-full shadow-lg shadow-blue-500/20">
              Most Popular
            </div>
<h3 className="text-lg font-medium text-slate-900 dark:text-white mb-2">
              Growth
...
<p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
              For growing teams needing full operational control.
            </p>
<button className="w-full py-2.5 rounded-lg bg-blue-600 text-sm font-medium text-white hover:bg-blue-500 transition-colors shadow-lg shadow-blue-500/20 mb-8" onclick="openAuditModal()">
              Start Scaling
            </button>
<ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400 flex-1">
<li className="flex items-center gap-3">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
              For established businesses over $1M/yr revenue.
            </p>
<button className="w-full py-2.5 rounded-lg border border-slate-200 dark:border-white/10 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors mb-8" onclick="openAuditModal()">
              Book Call
            </button>
...
<footer className="border-t border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#020204] pt-16 pb-8">
...
<span className="font-bold text-slate-900 dark:text-white">SORA</span>
</div>
<p className="text-sm text-slate-500 dark:text-slate-400 max-w-xs text-center md:text-left">
              Automating service businesses to help owners get off the tools and
              on to the beach.
            </p>
</div>
<div className="flex gap-8 text-sm text-slate-600 dark:text-slate-400">
<a className="hover:text-blue-600 dark:hover:text-white transition-colors" href="#services">
              Services
            </a>
<a className="hover:text-blue-600 dark:hover:text-white transition-colors" href="#pricing">
              Pricing
            </a>
<a className="hover:text-blue-600 dark:hover:text-white transition-colors" href="#" onclick="openAuditModal()">
              Book Audit
            </a>
</div>
</div>
...
<div aria-labelledby="modal-title" aria-modal="true" className="fixed inset-0 z-[100] hidden" id="audit-modal" role="dialog">

<div className="fixed inset-0 bg-slate-900/40 dark:bg-black/60 backdrop-blur-sm transition-opacity opacity-0" id="modal-backdrop"></div>
<div className="fixed inset-0 z-10 overflow-y-auto">
<div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
<div className="relative transform overflow-hidden rounded-2xl bg-white dark:bg-[#0f0f11] border border-slate-200 dark:border-white/10 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg scale-95 opacity-0" id="modal-panel">
<div className="absolute right-4 top-4">
<button className="text-slate-400 hover:text-slate-500 dark:hover:text-white transition-colors" onclick="closeAuditModal()">
<iconify-icon icon="lucide:x" width="20"></iconify-icon>
</button>
</div>
<div className="px-6 py-6 sm:p-8">
<div className="sm:flex sm:items-start gap-4">
<div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/20 sm:mx-0 sm:h-10 sm:w-10 mb-4 sm:mb-0">
<iconify-icon className="text-blue-600 dark:text-blue-400" icon="lucide:calendar-clock" width="20"></iconify-icon>
</div>
...
<p className="text-sm text-slate-500 dark:text-slate-400">
                      We'll analyze your current lead flow and show you exactly
                      where you're losing money. No pressure, just actionable
                      data.
                    </p>
</div>
</div>
...
<input className="block w-full rounded-md border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 dark:bg-white/5 dark:ring-white/10 dark:text-white sm:text-sm sm:leading-6" id="email" name="email" placeholder="you@company.com" type="email"/>
</div>
<div>
<label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1" htmlFor="phone">
                    Phone Number
                  </label>
<input className="block w-full rounded-md border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 dark:bg-white/5 dark:ring-white/10 dark:text-white sm:text-sm sm:leading-6" id="phone" name="phone" placeholder="(555) 123-4567" type="tel"/>
</div>
</div>
<div className="mt-8 sm:flex sm:flex-row-reverse">
<button className="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 sm:ml-3 sm:w-auto transition-all" type="button">
                  Book Call
                </button>
<button className="mt-3 inline-flex w-full justify-center rounded-md bg-white dark:bg-transparent px-3 py-2.5 text-sm font-semibold text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-white/5 sm:mt-0 sm:w-auto transition-all" onclick="closeAuditModal()" type="button">
                  Cancel
                </button>
</div>
</div>
<div className="bg-slate-50 dark:bg-white/5 px-6 py-3 text-center sm:px-8">
<p className="text-xs text-slate-500 dark:text-slate-400">
<iconify-icon className="inline mb-0.5 mr-1" icon="lucide:lock" width="10"></iconify-icon>
                Your data is secure. We hate spam too.
              </p>
</div>
</div>
</div>

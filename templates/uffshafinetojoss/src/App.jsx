...
<h1 className="leading-tight dark:text-white sm:text-4xl md:text-5xl lg:text-6xl text-3xl font-medium text-zinc-900 tracking-tight mb-12"><span className="inline-block origin-bottom-right hover:rotate-12 transition-transform duration-300">🏕️</span> Hi, I'm Shafin <span className="inline-block align-middle">

...
<div className="relative w-[320px] h-[650px] bg-black rounded-[40px] p-2 shadow-2xl">

<div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[120px] h-[34px] bg-black rounded-b-[20px] z-20"></div>

<div className="relative bg-gradient-to-b from-indigo-900 to-purple-900 w-full h-full rounded-[32px] overflow-hidden">

<div className="flex justify-between items-center px-6 pt-2 text-white text-xs">
<span>9:41</span>
...
<h1 className="text-white text-2xl font-semibold">Serene</h1>
...
<p className="text-white/80 text-sm">TODAY'S QUOTE</p>
<p className="text-white text-base mt-1">"Breathing in, I calm my body. Breathing out, I smile."</p>
</div>

<div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 mb-6">
<div className="flex justify-between items-center mb-4">
<span className="text-white/80 text-sm">DAILY MEDITATION</span>
<span className="text-white/80 text-xs">15 MIN</span>
</div>
<div className="flex justify-center">
<div className="relative h-32 w-32">
<svg className="w-full h-full" viewbox="0 0 100 100">
<circle cx="50" cy="50" fill="none" r="45" stroke="#ffffff33" strokeWidth="5"></circle>
<circle cx="50" cy="50" fill="none" r="45" stroke="#ffffff" stroke-dasharray="283" stroke-dashoffset="70" strokeWidth="5" transform="rotate(-90 50 50)"></circle>
</svg>
<div className="absolute inset-0 flex items-center justify-center">
<span className="text-white text-3xl font-light">12:30</span>
</div>
</div>
</div>
...
<svg className="h-6 w-6 text-purple-900" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-white text-lg font-medium mb-4">Recommended</p>
<div className="flex space-x-4 overflow-x-auto pb-4">
<div className="bg-white/10 backdrop-blur-lg rounded-xl p-3 min-w-[140px]">
<div className="h-20 bg-indigo-400/30 rounded-lg mb-2 flex items-center justify-center">
<svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
</svg>
</div>
<p className="text-white text-sm">Sleep Better</p>
<p className="text-white/60 text-xs">20 min</p>
</div>
<div className="bg-white/10 backdrop-blur-lg rounded-xl p-3 min-w-[140px]">
<div className="h-20 bg-purple-400/30 rounded-lg mb-2 flex items-center justify-center">
<svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-white text-sm">Morning Calm</p>
<p className="text-white/60 text-xs">10 min</p>
</div>
</div>
</div>

<div className="absolute bottom-0 left-0 right-0 bg-white/10 backdrop-blur-lg h-16 flex justify-around items-center px-6">

...
<span className="block mt-2 bg-gradient-to-r from-rose-400 via-pink-500 to-rose-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-[gradient_4s_ease_infinite]">
            Aduke mi,
          </span>
       Will you be my
          <span className="block mt-2 bg-gradient-to-r from-rose-400 via-pink-500 to-rose-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-[gradient_4s_ease_infinite]">
...
<p className="reveal delay-200 text-center text-lg md:text-xl font-light text-slate-500 max-w-lg mx-auto leading-relaxed mb-12">
        I've planned a day full of sweet moments, but it's missing the most
...
<iconify-icon className="text-xl group-hover:animate-pulse" icon="solar:letter-heart-linear"></iconify-icon>
</button>
...
<iconify-icon className="text-xl group-hover:animate-pulse" icon="solar:heart-lock-linear"></iconify-icon>
</button>
...
<iconify-icon className="text-xl group-hover:animate-pulse" icon="solar:star-shine-linear"></iconify-icon>
</button>
</div>
...
<p className="text-xs font-light text-slate-500 leading-relaxed">
            I promise to bring my best mood—and probably some terrible
            jokes—just to see you smile.
          </p>
</div>
...
<span className="text-xs font-medium">February 13th-15th· </span>
</div>
</div>
</div>

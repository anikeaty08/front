...
<p className="reveal delay-200 text-center text-lg md:text-xl font-light text-slate-500 max-w-lg mx-auto leading-relaxed mb-12 tracking-tight">
            I've planned a beautiful day on <span className="text-slate-800 font-medium">Feb 14th</span>, but it's missing the most important ingredient: <span className="text-slate-800 font-medium">You</span>.
        </p>
...
<p className="text-xs font-normal text-slate-500 leading-relaxed">
                    I promise to bring my best mood—and probably some terrible jokes—just to see you smile, Krupali.
                </p>
</div>
...
<p className="text-xs font-normal text-slate-500 leading-relaxed">
                    Let's add another wonderful chapter to our story. I can't wait to spend Feb 14th with you.
                </p>
</div>
</div>
</main>
...
<p className="text-xs text-slate-400 font-medium tracking-widest uppercase opacity-70">
            Made with <iconify-icon className="inline text-rose-400 align-middle" icon="solar:heart-bold"></iconify-icon> for Krupali
        </p>
</footer>
...
<p className="text-sm font-light text-slate-500 leading-relaxed mb-10 px-4">
                You've made me the happiest person, Krupali. Get ready for an amazing time.
            </p>
...
<span className="text-sm font-medium">February 14th</span>

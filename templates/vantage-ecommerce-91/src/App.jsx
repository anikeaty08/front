...
<img alt="Retro Handheld Console" className="hover:scale-105 transition-transform duration-500 opacity-90 mix-blend-multiply w-full h-full object-contain drop-shadow-lg" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/156448c9-cf4f-480c-ac45-61157b204a8e_1600w.png"/>
...
<div className="relative aspect-square bg-[#F7F5FF] rounded-[32px] overflow-hidden mb-6 p-10 flex items-center justify-center transition-transform duration-300 group-hover:-translate-y-1">
<img alt="Horizon Glow Sneakers" className="hover:scale-105 transition-transform duration-500 mix-blend-multiply w-full h-full object-contain drop-shadow-xl" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/27666450-2d55-4c41-ade0-c14b1a69f54e_1600w.png"/>
<div className="absolute bottom-5 right-5 w-12 h-12 bg-[#ECE5F5] rounded-full flex items-center justify-center text-gray-900 shadow-sm transition-all duration-300 group-hover:bg-white group-hover:scale-110">
<i className="w-5 h-5" data-lucide="arrow-up-right"></i>
</div>
</div>
...
<h2 className="text-4xl sm:text-5xl md:text-[3.5rem] leading-[1.05] font-semibold text-gray-900 tracking-tighter mb-10 max-w-3xl" id="tQuote">The layout feels premium and effortless. Our conversion rate went up within the first week after switching.</h2>

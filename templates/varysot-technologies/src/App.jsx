...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center bg-gray-50" onmousemove="handleSpotlight(event)" style={{-MouseX: '111.5px', -MouseY: '68px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center bg-gray-50" onmousemove="handleSpotlight(event)" style={{-MouseX: '155.5px', -MouseY: '75px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center bg-gray-50" onmousemove="handleSpotlight(event)" style={{-MouseX: '114.5px', -MouseY: '50px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center bg-gray-50" onmousemove="handleSpotlight(event)" style={{-MouseX: '168.5px', -MouseY: '68.3125px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card w-48 h-24 rounded-2xl grayscale items-center justify-center bg-gray-50" onmousemove="handleSpotlight(event)" style={{-MouseX: '125.5px', -MouseY: '94.3125px'}}>
...
<div className="carousel-card glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 lg:w-3/4 active" id="card-0" onmousemove="handleSpotlight(event)" style={{-MouseX: '909.5px', -MouseY: '274.96875px'}}>
...
<div className="carousel-card glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 lg:w-3/4 next" id="card-1" onmousemove="handleSpotlight(event)" style={{-MouseX: '4.7427978515625px', -MouseY: '141.655029296875px'}}>
<div className="w-full h-full rounded-2xl overflow-hidden relative group bg-gray-50">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
...
<div className="carousel-card glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2 lg:w-3/4 prev" id="card-2" onmousemove="handleSpotlight(event)" style={{-MouseX: '742.219482421875px', -MouseY: '99.342529296875px'}}>
<div className="w-full h-full rounded-2xl overflow-hidden relative group bg-gray-50">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">

...
<span className="block text-lg font-semibold tracking-tight font-geist">VENCEDOR</span>
</div>
</div>
</a>
...
<a className="hover:text-white transition-colors duration-200 text-sm font-medium text-gray-300 font-geist" href="/resume.pdf" rel="noopener noreferrer" target="_blank">Resume</a>
</nav>
...
<svg aria-hidden="true" className="lucide lucide-menu w-5 h-5" data-lucide="menu" fill="none" height="24" stroke="currentColor" stroke-line="round" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
</button>
</div>
...
<section className="lg:pt-40 lg:pb-28 overflow-hidden cursor-invert-mask pt-32 pb-20 relative" id="heroSection" style={{'--cursor-x': '961px', '--cursor-y': '375px'}}>
<div className="mx-auto max-w-7xl px-6 lg:px-8">
<div className="text-center">

<div className="flex animate-scale-in opacity-0 mb-8 justify-center" style={{animationDelay: '0.8s'}}>
<div className="parallax-scale relative" data-parallax="scale" data-scale-end="1.2" data-scale-start="1" style={{transform: 'scale(1)', transition: 'transform 0.1s ease-out'}}>
<img alt="Jordan Chen" className="lg:h-40 lg:w-40 transition-all duration-300 w-32 h-32 object-cover ring-white/20 ring-4 rounded-full shadow-2xl" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/d7726e19-0a5b-4f3d-bdd5-10cb85ed3ea4_320w.jpg" style={{transform: 'inherit'}}/>
</div>
</div>

<div className="opacity-0 animate-slide-up" style={{animationDelay: '1s'}}>
<h1 className="lg:text-7xl xl:text-8xl text-5xl font-bold text-white tracking-tight" id="heroHeadline"><span className="letter-animated">
</span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated">C</span><span className="letter-animated">r</span><span className="letter-animated">e</span><span className="letter-animated">a</span><span className="letter-animated">t</span><span className="letter-animated">i</span><span className="letter-animated">v</span><span className="letter-animated">e</span><span className="letter-animated" style={{marginRight: '0.5rem'}}> </span><span className="letter-animated">D</span><span className="letter-animated">e</span><span className="letter-animated">s</span><span className="letter-animated">i</span><span className="letter-animated">g</span><span className="letter-animated">n</span><span className="letter-animated">e</span><span className="letter-animated">r</span><span className="letter-animated">
...
<p className="lg:text-2xl leading-relaxed text-xl font-light text-gray-400 tracking-tight font-geist max-w-3xl mt-6 mr-auto ml-auto">Crafting cinematic visuals and high-fidelity designs. I blend technical precision with creative storytelling to build brands that resonate.</p>
</div>
...
<svg aria-hidden="true" className="lucide lucide-play w-5 h-5" data-lucide="play" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
              View my work
...
<div className="text-center">
<div className="lg:text-3xl text-2xl font-light text-white tracking-tight font-geist" style={{}}>5+</div>
<div className="text-sm text-gray-400 mt-1 font-geist" style={{}}>Years</div>
</div>
<div className="text-center">
<div className="lg:text-3xl text-2xl font-light text-white tracking-tight font-geist">70+</div>
<div className="text-sm text-gray-400 mt-1 font-geist" style={{}}>Projects</div>
</div>
<div className="text-center">
<div className="lg:text-3xl text-2xl font-light text-white tracking-tight font-geist">100%</div>
<div className="text-sm text-gray-400 font-geist mt-1">Commitment</div>
</div>
</div>
</div>
</div>
...
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Adobe</div>
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Photoshop</div>
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Illustrator</div>
...
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Figma</div>
...
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Photoshop</div>
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Illustrator</div>
<div className="hover:text-gray-300 transition-colors text-lg font-medium text-gray-400 tracking-tight font-geist">Premiere Pro</div>
...
<h2 className="lg:text-5xl animate-slide-up text-4xl font-bold text-white tracking-tight font-geist opacity-0" style={{animationDelay: '2s'}}>
            What I do
          </h2>
<p className="animate-slide-up text-xl text-gray-400 font-geist opacity-0 mt-4" style={{animationDelay: '2.2s'}}>Merging technical precision with creative storytelling to build brands that stand out</p>
</div>
...
<svg aria-hidden="true" className="lucide lucide-check w-4 h-4 text-green-400" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<a className="hidden lg:inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur text-white px-4 py-2 text-xs font-medium hover:bg-white/15 transition-all duration-300 opacity-0 animate-fade-in font-geist" href="#" style={{animationDelay: '3.2s'}}>
        See all
        <svg aria-hidden="true" className="lucide lucide-arrow-up-right w-3.5 h-3.5" data-lucide="arrow-up-right" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
</a>
</div>
...
<img alt="Aurora Financial App" className="h-full w-full object-cover transition duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a6ea5042-fd78-4888-b5e1-47f268a0569b_800w.jpg" style={{}}/>
<div className="group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ca7a6783-e504-4eda-bd37-946281afc089_1600w.jpg)] bg-cover absolute top-0 right-0 bottom-0 left-0"></div>
...
<span className="text-sm font-medium text-white font-geist" style={{}}>Folu's Creation</span>
<span className="text-[10px] uppercase text-gray-300 tracking-wider font-geist" style={{}}>Fashion Brand</span>
</div>
</div>
</div>
</article>
...
<div className="relative aspect-[16/10] overflow-hidden">
<img alt="Nexus Dashboard" className="h-full w-full object-cover transition duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/78877756-9e45-410e-b630-78c3dfb8e94c_1600w.jpg" style={{}}/>
...
<img alt="Working outdoors on a laptop" className="object-cover w-full h-[400px] lg:h-[480px] transition-transform duration-700 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/b6453140-0e66-40b1-89b8-06321fdcdc09_1600w.jpg" style={{}}/>
</div>
</div>
...
<img alt="Design workspace setup" className="object-cover w-full h-28 lg:h-36 transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/dfbdff07-910b-401f-9b3c-472e23555ca7_800w.jpg" style={{}}/>
</div>
</div>
<div className="rounded-2xl bg-white/5 border border-white/10 p-3 shadow-lg hover:bg-white/10 transition-all duration-300 group cursor-pointer">
<div className="overflow-hidden rounded-xl ring-1 ring-white/10">
...
<div className="rounded-2xl bg-white/5 border border-white/10 p-3 shadow-lg hover:bg-white/10 transition-all duration-300 group cursor-pointer">
<div className="overflow-hidden rounded-xl ring-1 ring-white/10">
<img alt="Design workspace setup" className="object-cover w-full h-28 lg:h-36 transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/72c8b3bf-292e-4424-b26d-4fcb776f58d6_800w.jpg" style={{}}/>
</div>
</div>
<div className="rounded-2xl bg-white/5 border border-white/10 p-3 shadow-lg hover:bg-white/10 transition-all duration-300 group cursor-pointer">
<div className="overflow-hidden rounded-xl ring-1 ring-white/10">
<img alt="Creative tools and materials" className="object-cover w-full h-28 lg:h-36 transition-transform duration-500 group-hover:scale-105" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/2b8b03a2-19b6-4f4d-a27f-4bd29d76f583_800w.jpg" style={{}}/>
</div>
</div>
</div>
</div>
...
<div className="max-w-7xl lg:px-8 mr-auto ml-auto pr-6 pl-6" i42"="">
...
<div className="grid h-8 w-8 place-items-center ring-1 ring-white/10 text-sm font-medium text-slate-200 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/f804111a-fe24-4660-b754-0f3654213f91_320w.jpg)] bg-cover rounded-full px-4 py-4">
</div>
...
<div className="text-sm text-gray-400 font-geist-mono mb-2" style={{opacity: '1', borderRight: '2px solid rgb(16, 185, 129)'}}>/</div></div>
</div>
</div>
<div className="relative">
...
<rect fill="#10B981" height="40" width="3" x="20" y="25"></rect>
<rect fill="#10B981" height="45" width="3" x="40" y="20"></rect>
<rect fill="#10B981" height="50" width="3" x="60" y="15"></rect>
<rect fill="#10B981" height="55" width="3" x="80" y="10"></rect>
<rect fill="#10B981" height="53" width="3" x="100" y="12"></rect>
<rect fill="#10B981" height="57" width="3" x="120" y="8"></rect>
<rect fill="#10B981" height="60" width="3" x="140" y="5"></rect>
<rect fill="#10B981" height="62" width="3" x="160" y="3"></rect>
<rect fill="#10B981" height="63" width="3" x="180" y="2"></rect>
<rect fill="#10B981" height="64" width="3" x="200" y="1"></rect>
...
<rect fill="#10B981" height="35" width="2" x="10" y="20"></rect>
<rect fill="#10B981" height="40" width="2" x="25" y="15"></rect>
<rect fill="#10B981" height="37" width="2" x="40" y="18"></rect>
<rect fill="#10B981" height="43" width="2" x="55" y="12"></rect>
<rect fill="#10B981" height="45" width="2" x="70" y="10"></rect>
<rect fill="#10B981" height="47" width="2" x="85" y="8"></rect>
<rect fill="#10B981" height="50" width="2" x="100" y="5"></rect>
<rect fill="#10B981" height="52" width="2" x="115" y="3"></rect>
<rect className="" fill="#10B981" height="53" width="2" x="130" y="2"></rect>
...
<svg aria-hidden="true" className="lucide lucide-dribbble w-5 h-5 text-gray-300" data-lucide="dribbble" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><path d="M19.13 5.09C15.22 9.14 10 10.44 2.25 10.94"></path><path d="M21.75 12.84c-6.62-1.41-12.14 1-16.38 6.32"></path><path d="M8.56 2.75c4.37 6 6 9.42 8 17.72"></path></svg>
</a>
<a className="rounded-2xl bg-white/10 border border-white/20 p-3 hover:bg-white/15 transition-colors" href="#">
<svg aria-hidden="true" className="lucide lucide-twitter w-5 h-5 text-gray-300" data-lucide="twitter" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
</a>
<a className="rounded-2xl bg-white/10 border border-white/20 p-3 hover:bg-white/15 transition-colors" href="#">
<svg aria-hidden="true" className="lucide lucide-linkedin w-5 h-5 text-gray-300" data-lucide="linkedin" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect height="12" width="4" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
</a>
<a className="rounded-2xl bg-white/10 border border-white/20 p-3 hover:bg-white/15 transition-colors" href="#">
<svg aria-hidden="true" className="lucide lucide-github w-5 h-5 text-gray-300" data-lucide="github" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
</a>
</div>
</div>

...
<a className="inline-flex items-center justify-center bg-center mix-blend-multiply w-[120px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/90adae1c-a460-4edd-9d6d-7501e7d6fca5_800w.jpg)] bg-cover rounded py-2 invert" href="#" style={{}}></a>
...
<span className="relative text-base font-semibold">Download</span>
<svg className="lucide lucide-download lucide-arrow-right relative ml-3 w-[24px] h-[16px]" data-icon-replaced="true" data-lucide="download" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" style={{width: '24px', height: '16px', color: 'rgb(255, 255, 255)'}} viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 15V3"></path><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><path d="m7 10 5 5 5-5"></path></svg>
</a>
...
<h1 className="mt-4 text-5xl md:text-6xl lg:text-7xl tracking-tight text-slate-900 font-instrument-serif font-normal">
                Nature, Reimagined
              </h1>
...
<div className="relative bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/a735bdb7-9170-45a8-912f-07e33e0abaa4_1600w.jpg)] bg-cover rounded-3xl" style={{}}>
...
<svg className="lucide lucide-menu h-5 w-5" data-lucide="menu" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M4 5h16"></path><path d="M4 12h16"></path><path className="" d="M4 19h16"></path></svg>
</button>
<button className="h-10 w-10 rounded-full bg-white/10 backdrop-blur ring-1 ring-white/10 text-white flex items-center justify-center hover:bg-white/15">
<svg className="lucide lucide-moon h-5 w-5" data-lucide="moon" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"></path></svg>
</button>
</div>

<div className="relative md:p-10 lg:p-14 pt-8 pr-8 pb-8 pl-8">
<div className="relative overflow-hidden min-h-[420px] md:min-h-[520px] flex bg-emerald-950/20 bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/cab73078-80bd-4f30-8d0d-775e21f09e27_1600w.jpg)] bg-cover ring-white/10 ring-1 rounded-3xl items-center justify-center" style={{}}><video autoplay="" className="absolute inset-0 w-full h-full object-cover" loop="" muted="" playsinline="" src="https://cdn.midjourney.com/video/57983e9f-22bf-4ecb-9ccf-107e0f02fd40/1.mp4"></video>
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-emerald-700 transition-colors duration-300">AI Plant Monitoring</h4>
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-sky-700 transition-colors duration-300">Precision Environmental Control</h4>
<p className="text-slate-600 font-sans text-sm leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-violet-700 transition-colors duration-300">Growth Analytics &amp; Insights</h4>
<p className="text-slate-600 font-sans text-sm leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-amber-700 transition-colors duration-300">Mobile Management</h4>
<p className="text-slate-600 font-sans text-sm leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-teal-700 transition-colors duration-300">Resource Optimization</h4>
<p className="text-slate-600 font-sans text-sm leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
...
<h4 className="text-xl font-semibold text-slate-900 mb-3 font-sans tracking-tight group-hover:text-rose-700 transition-colors duration-300">Expert Community</h4>
<p className="text-slate-600 font-sans text-sm leading-relaxed group-hover:text-slate-700 transition-colors duration-300">
...
<span className="absolute left-18 -top-24 group-hover:scale-100 -z-10 group-hover:duration-700 duration-500 origin-center transform transition-all bg-teal-800 w-60 h-60 rounded-full scale-0"></span>
...
<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2">
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-emerald-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-emerald-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="flex bg-slate-200 w-full h-full items-center justify-center group-hover:bg-emerald-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">MR</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-emerald-700 transition-colors duration-300">Maria Rodriguez</h4>
<p className="text-sm text-slate-600 font-sans">Urban Farm Owner</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" style={{transitionDelay: '0.1s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" style={{transitionDelay: '0.2s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" style={{transitionDelay: '0.3s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" style={{transitionDelay: '0.4s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
</div>
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "VerdantIQ transformed my urban farm completely. The AI monitoring caught nutrient deficiencies I never would have noticed, and my yield increased by 40% in just one season."
          </p>
<div className="flex gap-2 text-neutral-950/50 items-center group-hover:text-emerald-600 transition-colors duration-300">
<svg className="lucide lucide-trending-up group-hover:animate-bounce" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polyline points="22,7 13.5,15.5 8.5,10.5 2,17"></polyline>
<polyline points="16,7 22,7 22,13"></polyline>
</svg>
<span className="text-sm font-medium font-sans">+40% Yield Increase</span>
</div>
</div>
</div>

<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2" style={{animationDelay: '0.1s'}}>
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-sky-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-sky-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="w-full h-full bg-slate-200 flex items-center justify-center group-hover:bg-sky-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">JC</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-sky-700 transition-colors duration-300">James Chen</h4>
<p className="text-sm text-slate-600 font-sans">Hydroponic Specialist</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<svg fill="-400 group-hover:scale-110 transition-transform duration-200" height="16" style={{transitionDelay: '0.2s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
</svg>
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" style={{transitionDelay: '0.3s'}} viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"></polygon>
...
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "The precision environmental control is incredible. My hydroponic systems now maintain perfect conditions 24/7, and I've reduced water usage by 35% while improving plant quality."
          </p>
<div className="flex items-center gap-2 text-neutral-950/50 group-hover:text-sky-600 transition-colors duration-300">
<svg className="lucide lucide-droplets group-hover:animate-bounce" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"></path>
<path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"></path>
</svg>
<span className="text-sm font-medium font-sans">-35% Water Usage</span>
</div>
</div>
</div>

<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2" style={{animationDelay: '0.2s'}}>
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-violet-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-violet-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="w-full h-full bg-slate-200 flex items-center justify-center group-hover:bg-violet-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">SG</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-violet-700 transition-colors duration-300">Sarah Green</h4>
<p className="text-sm text-slate-600 font-sans">Greenhouse Manager</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "The growth analytics have revolutionized how we plan our harvests. We can predict optimal harvest times with 95% accuracy and our customers love the consistency."
          </p>
<div className="flex items-center gap-2 text-neutral-950/50 group-hover:text-violet-600 transition-colors duration-300">
<svg className="lucide lucide-target group-hover:animate-pulse" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10"></circle>
<circle cx="12" cy="12" r="6"></circle>
<circle cx="12" cy="12" r="2"></circle>
</svg>
<span className="text-sm font-medium font-sans">95% Accuracy</span>
</div>
</div>
</div>

<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2" style={{animationDelay: '0.3s'}}>
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-amber-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-amber-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="w-full h-full bg-slate-200 flex items-center justify-center group-hover:bg-amber-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">DW</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-amber-700 transition-colors duration-300">David Wilson</h4>
<p className="text-sm text-slate-600 font-sans">Home Grower</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "As a beginner, VerdantIQ made growing accessible. The mobile app guides me through everything, and I'm amazed that I can monitor my plants while traveling."
          </p>
<div className="flex items-center gap-2 text-neutral-950/50 group-hover:text-amber-600 transition-colors duration-300">
<svg className="lucide lucide-smartphone group-hover:animate-pulse" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<rect height="20" rx="2" ry="2" width="14" x="5" y="2"></rect>
<path d="M12 18h.01"></path>
</svg>
<span className="text-sm font-medium font-sans">Beginner Friendly</span>
</div>
</div>
</div>

<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2" style={{animationDelay: '0.4s'}}>
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-teal-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-teal-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="w-full h-full bg-slate-200 flex items-center justify-center group-hover:bg-teal-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">LM</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-teal-700 transition-colors duration-300">Lisa Martinez</h4>
<p className="text-sm text-slate-600 font-sans">Organic Farm Co-op</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "Resource optimization has been a game-changer for our co-op. We've cut energy costs by 28% while maintaining organic certification and improving soil health."
          </p>
<div className="flex items-center gap-2 text-neutral-950/50 group-hover:text-teal-600 transition-colors duration-300">
<svg className="lucide lucide-leaf group-hover:animate-bounce" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"></path>
<path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"></path>
</svg>
<span className="text-sm font-medium font-sans">-28% Energy Costs</span>
</div>
</div>
</div>

<div className="relative group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2" style={{animationDelay: '0.5s'}}>
<div className="bg-[#f1f5f9] h-full rounded-2xl pt-6 pr-6 pb-6 pl-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] group-hover:shadow-xl group-hover:shadow-rose-500/10 group-hover:bg-white transition-all duration-500">
<div className="flex items-center gap-3 mb-4">
<div className="w-12 h-12 bg-rose-200 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300">
<div className="w-full h-full bg-slate-200 flex items-center justify-center group-hover:bg-rose-100 transition-colors duration-300">
<span className="text-sm font-semibold text-[#000000]">AT</span>
</div>
</div>
<div className="">
<h4 className="font-semibold text-slate-900 font-sans group-hover:text-rose-700 transition-colors duration-300">Alex Thompson</h4>
<p className="text-sm text-slate-600 font-sans">Vertical Farm CEO</p>
</div>
</div>
<div className="flex gap-1 mb-4">
<svg className="text-amber-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" height="16" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<p className="text-slate-700 font-sans text-sm leading-relaxed mb-4 group-hover:text-slate-800 transition-colors duration-300">
            "The expert community feature has been invaluable. Having 24/7 access to growing experts helped us scale from 5 to 50 growing towers without losing quality."
          </p>
<div className="flex items-center gap-2 text-neutral-950/50 group-hover:text-rose-600 transition-colors duration-300">
<svg className="lucide lucide-users group-hover:animate-pulse" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
<circle cx="9" cy="7" r="4"></circle>
<path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
<path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
</svg>
<span className="text-sm font-medium font-sans">10x Scale Growth</span>
</div>
</div>
</div>
</div>

<div className="mt-16 bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-8 group hover:shadow-2xl hover:shadow-teal-500/10 transition-all duration-700 cursor-pointer">
<div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
<div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat">
<div className="text-3xl md:text-4xl font-bold text-slate-900 mb-2 font-sans group-hover/stat:text-emerald-600 transition-colors duration-300">10,000+</div>
<div className="text-slate-600 font-sans text-sm group-hover/stat:text-slate-800 transition-colors duration-300">Active Growers</div>
<div className="w-12 h-1 bg-emerald-200 rounded-full mx-auto mt-2 opacity-0 group-hover/stat:opacity-100 transition-all duration-500"></div>
</div>
<div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat" style={{transitionDelay: '0.1s'}}>
<div className="text-3xl md:text-4xl font-bold text-slate-900 mb-2 font-sans group-hover/stat:text-amber-600 transition-colors duration-300">4.9</div>
<div className="text-slate-600 font-sans text-sm group-hover/stat:text-slate-800 transition-colors duration-300">Average Rating</div>
<div className="w-12 h-1 bg-amber-200 rounded-full mx-auto mt-2 opacity-0 group-hover/stat:opacity-100 transition-all duration-500"></div>
</div>
<div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat" style={{transitionDelay: '0.2s'}}>
<div className="text-3xl md:text-4xl font-bold text-slate-900 mb-2 font-sans group-hover/stat:text-teal-600 transition-colors duration-300">45%</div>
<div className="text-slate-600 font-sans text-sm group-hover/stat:text-slate-800 transition-colors duration-300">Average Yield Increase</div>
<div className="w-12 h-1 bg-teal-200 rounded-full mx-auto mt-2 opacity-0 group-hover/stat:opacity-100 transition-all duration-500"></div>
</div>
<div className="transform transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/stat" style={{transitionDelay: '0.3s'}}>
<div className="text-3xl md:text-4xl font-bold text-slate-900 mb-2 font-sans group-hover/stat:text-violet-600 transition-colors duration-300">24/7</div>
<div className="text-slate-600 font-sans text-sm group-hover/stat:text-slate-800 transition-colors duration-300">Expert Support</div>
<div className="w-12 h-1 bg-violet-200 rounded-full mx-auto mt-2 opacity-0 group-hover/stat:opacity-100 transition-all duration-500"></div>
</div>
</div>

<div className="absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none">
<div absolute="" animate-ping"="" bg-emerald-400="" className="absolute top-4 left-4 w-2 h-2 bg-teal-400=" h-1="" right-12="" rounded-full="" style={{animationDelay: '0.5s'}} top-8="" w-1=""></div>
<div className="absolute bottom-6 left-8 w-1.5 h-1.5 bg-violet-400 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
<div className="absolute bottom-4 right-4 w-1 h-1 bg-amber-400 rounded-full animate-ping" style={{animationDelay: '1.5s'}}></div>
</div>
</div>

<div className="text-center mt-16">
<a className="inline-flex items-center justify-center gap-3 hover:text-white transition-colors relative overflow-hidden group z-10 duration-1000 text-xl text-white bg-teal-500 w-60 h-12 rounded-2xl shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] hover:scale-105 hover:shadow-2xl hover:shadow-teal-500/20 transform" href="#">
<span className="absolute group-hover:scale-100 -z-20 left-22 -top-24 group-hover:duration-500 duration-700 origin-center transform transition-all bg-teal-600 w-60 h-60 rounded-full scale-0"></span>
<span className="absolute left-18 -top-24 group-hover:scale-100 -z-10 group-hover:duration-700 duration-500 origin-center transform transition-all bg-teal-800 w-60 h-60 rounded-full scale-0"></span>
<span className="text-sm font-medium group-hover:animate-pulse">Join Our Growing Community</span>
</a>
</div>
</div>
...
<div className="inline-flex items-center justify-center bg-center mix-blend-multiply w-[120px] h-[40px] bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/90adae1c-a460-4edd-9d6d-7501e7d6fca5_800w.jpg)] bg-cover rounded py-2 brightness-0 invert mb-4" style={{}}></div>

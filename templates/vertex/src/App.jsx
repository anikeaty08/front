...
<span className="bg-center text-sm font-semibold text-white tracking-tight w-[160px] h-[45px] bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bd96dec3-273e-4fd7-918b-76da0bacd391_1600w.png)] bg-cover"></span>
</a>
...
<span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
            ...
            Now available: Advanced AI Architecture Course
          </div>
</div>
...
<h1 className="sm:text-6xl lg:text-7xl leading-[1.1] animate-hero-element animate-title-1 text-5xl font-medium text-white tracking-tighter mb-6">
  Where <span className="text-green-300">learning</span> <br className="hidden sm:block"/> <span className="text-[#ffffff]">
  becomes 
...
<p className="sm:text-lg leading-relaxed animate-hero-element animate-description text-base text-neutral-400 max-w-2xl mt-4 mr-auto ml-auto">
          ...
          pushing the boundaries of what's possible. High-leverage learning for
...
<span className="text-sm font-semibold tracking-tight text-white transition-colors group-hover:text-green-100">
                Start Your Journey
              </span>
</div>
</button>
...
<h2 className="text-3xl sm:text-4xl lg:text-5xl leading-[1.05] text-white tracking-tighter font-normal">
                    ...
                    <span className="text-[#ffffff]">speed and focus.</span>
</h2>
...
<p className="text-xs text-neutral-400 mt-1 leading-relaxed max-w-xs">
                            AI-driven recommendations that evolve with your
                            progress and learning velocity.
                          </p>
</div>
</div>
...
<p className="text-xs text-neutral-400 mt-1 leading-relaxed max-w-xs">
                            Get rapid feedback from industry experts across the
                            distributed network.
                          </p>
</div>
</div>
...
<p className="text-xs text-neutral-400">Architect scalable AI</p>
</div>
</div>
...
<p className="text-xs text-neutral-400">Learn by doing</p>
</div>
</div>
</div>
</div>
...
<h2 className="sm:text-5xl text-4xl font-semibold text-white tracking-tight mt-6 mb-4">
            Sync your
            <span className="text-[#ffffff]">entire workflow.</span>
</h2>
<p className="text-base text-neutral-400 max-w-2xl mt-3 mr-auto ml-auto">
            Connect your learning journey directly with the tools you use every
            day. Push code, share designs, and collaborate in real-time.
          </p>
</div>
...
<p className="text-neutral-400 max-w-xl mx-auto">
          Curated learning paths for the modern creator.
        </p>
</div>
...
<p className="text-sm text-neutral-400 mb-4 line-clamp-2">
              Master the art of procedural generation and abstract design
              principles using modern tools.
            </p>
...
<p className="text-sm text-neutral-400 mb-4 line-clamp-2">
              Building high-performance applications with legacy constraints and
              modern speed.
            </p>
<div className="flex items-center gap-3 text-xs text-neutral-500 font-medium">
<span className="flex items-center gap-1">
...
<p className="text-sm text-neutral-400 mb-4 line-clamp-2">
              Advanced cinematography and lighting techniques for 3D
              environments.
            </p>
<div className="flex items-center gap-3 text-xs text-neutral-500 font-medium">
<span className="flex items-center gap-1">
...
<h2 className="mt-6 text-4xl sm:text-5xl tracking-tight font-medium text-white font-geist">
            Join 50,000+
            <span className="text-[#ffffff]">cognitive pioneers.</span>
</h2>
<p className="mt-4 text-lg text-neutral-400 max-w-2xl mx-auto font-geist">
            Connect with researchers, designers, and founders pushing the
...
<span className="quote-word transition-colors duration-500" data-word-index="12" style={{color: 'rgb(64, 64, 64)'}}>community</span>

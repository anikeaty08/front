...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
  ...
  return (
    <>
      <div className="absolute top-0 w-full -z-10 h-[880px] blur-3xl bg-cover bg-center" style={{backgroundImage: 'url("https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6e8f8a18-3a4d-4b1b-9b05-db364b6430e6_3840w.jpg")'}}></div>
...
<h1 className="max-w-4xl text-4xl sm:text-6xl md:text-7xl lg:text-8xl leading-[1.05] font-medium text-black tracking-tighter" style={{fontFamily: '\'Playfair Display\', serif'}}>
        I design moods<img alt="Mood thumbnail" className="inline-block align-middle sm:h-12 sm:w-20 md:h-16 md:w-28 w-14 h-10 object-cover rounded-xl mr-2 ml-2 shadow-[0_2px_10px_rgba(0,0,0,0.12)]" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/22088bb8-d417-4e6a-9056-75d1a270d105_320w.jpg" style={{}}/> that move people—<span className="whitespace-nowrap">for brands,</span> products, and spaces.
      </h1>
...
<article className="relative overflow-hidden aspect-[3/4] bg-center cursor-pointer bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/6442f8b2-3d30-4884-9f30-adcfcc0043c0_800w.jpg)] bg-cover border-neutral-200 border rounded-2xl" onclick="window.location.href='/work-neon'" role="button" style={{}}>
...
<article className="relative overflow-hidden aspect-[3/4] bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/71f7b8bc-6bae-401a-b7fd-461564dbd7b0_800w.jpg)] bg-cover border-neutral-200 border rounded-2xl cursor-pointer" onclick="window.location.href='/work-neon'" role="button" style={{}}>
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-black/30 border border-white/20 rounded-full px-1.5 py-1.5 backdrop-blur">
...
<article className="relative overflow-hidden aspect-[1/1] bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/14590110-b7b4-428d-bf0c-a85921aa5058_800w.jpg)] bg-cover border-neutral-200 border rounded-2xl cursor-pointer" onclick="window.location.href='/work-neon'" role="button" style={{}}>
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-black/30 border border-white/20 rounded-full px-1.5 py-1.5 backdrop-blur">
...
<article className="relative overflow-hidden aspect-[1/1] bg-center bg-[url(https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/2977947c-4a50-48ff-9019-0950ce76ba7a_800w.jpg)] bg-cover border-neutral-200 border rounded-2xl cursor-pointer" onclick="window.location.href='/work-neon'" role="button">
<div className="absolute top-3 left-3">
<span className="inline-flex items-center gap-2 text-xs text-white/90 bg-black/30 border border-white/20 rounded-full px-1.5 py-1.5 backdrop-blur">
...
<img alt="" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/94f85473-10ec-40cb-b97f-ff3b6f076199_800w.jpg"/>
</div>
</div>
<div className="relative z-10">
<div className="w-52 h-36 rounded-xl overflow-hidden ring-1 ring-emerald-300 shadow-[0_0_0_2px_rgba(16,185,129,0.35)]">
<img alt="" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/3df10614-4cdb-4e4f-9e1d-19959aed90a0_800w.jpg"/>
</div>
</div>
<div className="relative rotate-6">
<div className="w-44 h-32 rounded-xl overflow-hidden ring-1 ring-white/10">
<img alt="" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/df528971-1835-44e0-b06b-c0e517476a73_800w.jpg"/>
</div>
</div>
</div>
...
<div className="flex items-center gap-2">
<button className="inline-flex hover:text-emerald-400 transition text-neutral-400 w-8 h-8 items-center justify-center" id="aura-emfp9kg68">
...
<img alt="Design workspace" className="ring-1 ring-neutral-800 w-full object-cover rounded-3xl" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/83ca20c0-64e5-412d-9c79-224a4ae90b74_1600w.jpg"/>
...
<p className="text-[11px] uppercase tracking-[0.2em] text-neutral-400">2015–2018</p>
...
<div className="relative mb-10">
<span className="absolute -left-3 top-3 h-px w-3 bg-neutral-700"></span>
<p className="text-[11px] uppercase tracking-[0.2em] text-neutral-400">2019–2021</p>
...
<div className="relative mb-10">
<span className="absolute -left-3 top-3 h-px w-3 bg-neutral-700"></span>
<p className="text-[11px] uppercase tracking-[0.2em] text-neutral-400">2022–2023</p>
<p className="mt-1 text-white text-base sm:text-lg font-medium tracking-tight">Founded Vibe Studio, developed methodology</p>
</div>
<div className="relative mb-10">
<span className="absolute -left-3 top-3 h-px w-3 bg-neutral-700"></span>
<p className="text-[11px] uppercase tracking-[0.2em] text-neutral-400">2024</p>
...
<li><a className="hover:text-emerald-600 transition" href="#services">Packages</a></li>
<li><a className="hover:text-emerald-600 transition" href="#about">About</a></li>
</ul>
</div>
<div className="">
...
<li className="flex items-start gap-2">
<svg className="w-4 h-4 text-emerald-600 mt-0.5" fill="none" stroke="currentColor" style={{strokeWidth: '1.5'}} viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className="" d="M20 6 9 17l-5-5"></path></svg>

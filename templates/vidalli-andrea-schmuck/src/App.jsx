...
<a className="hover:text-black transition-colors duration-300" href="#kollektion">Kollektion</a>
<a className="hover:text-black transition-colors duration-300" href="#atelier">ÜBER MICH</a>
</div>
...
<path d="M50 5 L93.3 30 V75 L50 95 L6.7 75 V30 L50 5Z" fill="none" stroke="currentColor" strokeWidth="3"></path>
<text fill="currentColor" fontFamily="Playfair Display" fontSize="40" text-anchor="middle" x="50" y="65">VA</text>
...
<span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[10px] text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">0</span>
</button>
</div>
</div>
</nav>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-screen-2xl w-full h-full items-center">
...
<h1 className="md:text-7xl lg:text-8xl leading-[0.95] serif text-5xl font-normal text-black tracking-tight">
                    Echte Werte.<br/>
<span className="text-gold italic">Reine Form.</span>
</h1>
<p className="md:text-lg leading-relaxed text-base text-gray-600 max-w-md">Handgefertigte Unikate aus Krottendorf. Ich verbinde traditionelles Handwerk mit modernem Minimalismus. Kein Prunk, sondern purer Ausdruck.</p>
...
<span className="relative z-10 group-hover:text-black transition-colors duration-300">Kollektion ansehen</span>
...
<a className="group uppercase hover:bg-black hover:text-white transition-colors duration-300 text-xs font-normal text-black tracking-widest text-center border-black border pt-4 pr-8 pb-4 pl-8" href="#atelier">ÜBER MICH</a>
</div>
</div>

<div className="order-1 md:order-2 relative h-[60vh] md:h-[80vh] bg-gray-100 overflow-hidden">
<img alt="Gold Schmuck Detail" className="object-center hover:grayscale-0 transition-all duration-1000 w-full h-full object-cover grayscale" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/de3055f3-7ce2-4f8e-810a-1d061b7f3537_1600w.jpg"/>
...
<span className="uppercase text-xs tracking-widest">Krottendorf, AT</span>
</div>
</div>
</div>
</header>
...
<span className="text-6xl md:text-8xl font-normal tracking-tighter uppercase text-black/5 mx-8">Handmade</span>
<span className="text-6xl md:text-8xl font-normal tracking-tighter uppercase text-gold/20 serif italic mx-8">Vidalli</span>
<span className="text-6xl md:text-8xl font-normal tracking-tighter uppercase text-black/5 mx-8">Timeless</span>
<span className="text-6xl md:text-8xl font-normal tracking-tighter uppercase text-gold/20 serif italic mx-8">Unique</span>
</div>
...
<span className="text-gold font-normal text-xs tracking-widest uppercase mb-3 block">Aktuelle Kollektion</span>
<h2 className="text-4xl tracking-tight text-black serif font-normal">Signature Pieces</h2>
</div>
...
<span className="text-[10px] uppercase z-20 font-normal text-black tracking-wider bg-white pt-1 pr-3 pb-1 pl-3 absolute top-4 left-4">Neu</span>
</div>
<div className="flex justify-between items-baseline">
<div className="">
<h3 className="text-xl text-black serif font-normal">Aura Ring</h3>
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">18k Gold</p>
</div>
...
<div className="flex justify-between items-baseline">
<div className="">
<h3 className="text-xl text-black serif font-normal">Luna Halskette</h3>
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">Süßwasserperle</p>
</div>
...
<div className="flex justify-between items-baseline">
<div>
<h3 className="text-xl text-black serif font-normal">Nova Ohrringe</h3>
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">Silber 925</p>
</div>
...
<div className="flex justify-between items-baseline">
<div>
<h3 className="text-xl text-black serif font-normal">Helix Armreif</h3>
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">Gold Vermeil</p>
</div>
...
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">Massivgold</p>
</div>
...
<span className="absolute top-4 left-4 bg-black text-white px-3 py-1 text-[10px] uppercase tracking-wider font-normal z-20">Set</span>
</div>
<div className="flex justify-between items-baseline">
<div>
<h3 className="text-xl text-black serif font-normal">Abend-Set</h3>
<p className="text-xs text-gray-500 uppercase tracking-wide mt-1 group-hover:text-gold transition-colors">Complete Collection</p>
</div>
...
<h2 className="md:text-5xl lg:text-6xl serif leading-tight text-4xl font-normal tracking-tight">Vidalli Andrea<br/> <span className="text-gold italic">Handwerk &amp; Seele</span></h2>
<p className="leading-relaxed text-lg font-light text-gray-400">Abseits der Massenproduktion entsteht hier Schmuck mit Charakter. Jedes Stück geht durch meine Hände – vom Entwurf bis zur Politur. Ich nutze ausschließlich recyceltes Gold und konfliktfreie Steine, weil wahrer Luxus Verantwortung bedeutet.</p>
...
<div className="border-l border-gold pl-4">
<h4 className="text-gold serif text-xl mb-1 font-normal">Krottendorf, Steiermark</h4>
...
<h3 className="text-lg font-normal text-black mb-2">Lebenslange Garantie</h3>
<p className="text-sm text-gray-500 max-w-xs mx-auto">Auf alle Material- und Verarbeitungsfehler.</p>
</div>
<div className="p-8 text-center group">
<div className="mb-4 text-gray-400 group-hover:text-gold transition-colors duration-300 flex justify-center">
<iconify-icon icon="lucide:refresh-cw" strokeWidth="1.5" width="32"></iconify-icon>
</div>
<h3 className="text-lg font-normal text-black mb-2">Kostenlose Aufarbeitung</h3>
<p className="text-sm text-gray-500 max-w-xs mx-auto">Einmal jährlich polieren wir Ihr Schmuckstück.</p>
</div>
<div className="p-8 text-center group">
<div className="mb-4 text-gray-400 group-hover:text-gold transition-colors duration-300 flex justify-center">
<iconify-icon icon="lucide:gift" strokeWidth="1.5" width="32"></iconify-icon>
</div>
<h3 className="text-lg font-normal text-black mb-2">Premium Verpackung</h3>
<p className="text-sm text-gray-500 max-w-xs mx-auto">Nachhaltig und elegant verpackt als Geschenk.</p>
</div>
</div>
</div>
</section>
...
<text fill="currentColor" fontFamily="Playfair Display" fontSize="50" font-weight="bold" text-anchor="middle" x="50" y="70">VA</text>
</svg>
<span className="serif text-2xl font-normal tracking-tight">Vidalli Andrea</span>
</div>
<p className="leading-relaxed text-sm text-gray-400 max-w-xs mb-8">Wir kreieren Schmuck für Individualisten. Zeitloses Design trifft auf steirische Handwerkskunst.</p>
...
<div className="">
<h5 className="text-xs font-semibold uppercase tracking-widest text-gold mb-6">Shop</h5>
<ul className="space-y-4 text-sm text-gray-400">
<li className=""><a className="hover:text-white transition-colors" href="#">Neuheiten</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Bestseller</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Geschenke</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Gutscheine</a></li>
</ul>
</div>
<div className="">
<h5 className="text-xs font-semibold uppercase tracking-widest text-gold mb-6">Service</h5>
<ul className="space-y-4 text-sm text-gray-400">
<li className=""><a className="hover:text-white transition-colors" href="#">Kontakt</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Versand &amp; Retouren</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Ringgröße finden</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">FAQ</a></li>
</ul>
</div>
<div className="col-span-2 md:col-span-1">
<h5 className="text-xs font-semibold uppercase tracking-widest text-gold mb-6">Newsletter</h5>
<p className="text-xs text-gray-500 mb-4">Erhalten Sie 10% Rabatt auf Ihre erste Bestellung.</p>
...
<button className="text-xs uppercase tracking-widest hover:text-gold transition-colors" type="button">Senden</button>
</form>
</div>
</div>
</div>

...
<img alt="Sports Car" className="hero-image opacity-70 w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/3fd1034d-cce6-4503-8511-e5294e5ea53f_3840w.jpg?w=800&amp;q=80"/>
</div>
<div className="bg-gradient-to-t from-black to-transparent h-32 absolute inset-x-0 bottom-0"></div>
<div className="relative z-10 text-center px-6">
<h1 className="hero-title text-5xl md:text-7xl lg:text-8xl font-semibold tracking-tight">
        WELCOME — YOU’VE ENTERED MY WORLD
      </h1>
</div>
<div className="-translate-x-1/2 nav-fade absolute bottom-8 left-1/2">

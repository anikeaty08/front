...
!function(){if(!window.UnicornStudio){window.UnicornStudio={isInitialized:!1};var i=document.createElement("script");i.src="https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.4.29/dist/unicornStudio.umd.js",i.onload=function(){window.UnicornStudio.isInitialized||(UnicornStudio.init(),window.UnicornStudio.isInitialized=!0)},(document.head || document.body).appendChild(i)}}();
      ...
      const staggerObserver = new IntersectionObserver((entries) => {
        entries.forEach((entry, index) => {
          if (entry.isIntersecting) {
            // Get all stagger items in the same parent
...
<a className="text-sm text-white/60 hover:text-white transition-colors duration-200" href="#features">Features</a>
<a className="text-sm text-white/60 hover:text-white transition-colors duration-200" href="#how-it-works">How It Works</a>
<a className="text-sm text-white/60 hover:text-white transition-colors duration-200" href="#pricing">Pricing</a>
<a className="text-sm text-white/60 hover:text-white transition-colors duration-200" href="#download">Download</a>
</nav>
<div className="flex items-center gap-3">
...
<span className="text-xs sm:text-sm text-white/70">Now available for Tesla Model 3, Y, S &amp; X</span>
</div>
<h1 className="text-4xl font-semibold tracking-tight mb-4 slide-up is-visible sm:text-5xl md:text-6xl sm:mb-6 lg:text-7xl lg:font-thin">
            Your EV, <span className="bg-clip-text text-transparent animate-gradient xl:bg-neutral-50/60">Supercharged</span>
</h1>
<p className="text-base sm:text-lg md:text-xl leading-relaxed text-white/60 mb-6 sm:mb-8 px-4 slide-up is-visible">The most advanced dashboard for your electric vehicle. Monitor battery health, optimize charging, and control climate all from one beautiful interface.</p>
...
<img alt="Dashboard Preview" className="w-full rounded-[16px] sm:rounded-[20px] shadow-2xl saturate-0" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/601b80ba-5955-4fd5-ba24-5754613b5f3f_1600w.jpg"/>
</div>
</div>
</div>
</div>
...
<p className="text-base sm:text-lg text-white/60 max-w-2xl mx-auto slide-up px-4">
            Stay informed with live updates and comprehensive vehicle metrics at your fingertips
          </p>
</div>
...
<div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-1">Battery Status</h3>
<p className="text-sm text-white/60">Model 3 Long Range</p>
</div>
...
<span className="text-xs text-emerald-300 font-medium">Charging</span>
</div>
</div>
<div className="mb-6 sm:mb-8">
<div className="flex items-end gap-2 mb-3">
<span className="text-5xl sm:text-6xl font-semibold tracking-tight">78</span>
...
<div className="relative h-full bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full animate-progress" style={{width: '78%'}}>
...
<p className="text-xl sm:text-2xl font-semibold tracking-tight">243 mi</p>
<p className="text-xs text-white/50 mt-1">Est. 312 mi at 100%</p>
</div>
<div className="bg-white/[0.03] rounded-[14px] sm:rounded-[16px] p-3 sm:p-4 border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.08] transition-all duration-200">
<div className="flex items-center gap-2 mb-2">
<svg className="lucide lucide-clock w-4 h-4 text-indigo-400" data-lucide="clock" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6v6l4 2"></path><circle cx="12" cy="12" r="10"></circle></svg>
<span className="text-xs text-white/60">Time Remaining</span>
</div>
<p className="text-xl sm:text-2xl font-semibold tracking-tight">1h 24m</p>
<p className="text-xs text-white/50 mt-1">Full charge by 3:45 PM</p>
</div>
<div className="bg-white/[0.03] rounded-[14px] sm:rounded-[16px] p-3 sm:p-4 border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.08] transition-all duration-200">
<div className="flex items-center gap-2 mb-2">
<svg className="lucide lucide-gauge w-4 h-4 text-cyan-400" data-lucide="gauge" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m12 14 4-4"></path><path d="M3.34 19a10 10 0 1 1 17.32 0"></path></svg>
<span className="text-xs text-white/60">Charge Rate</span>
</div>
<p className="text-xl sm:text-2xl font-semibold tracking-tight">48 kW</p>
<p className="text-xs text-white/50 mt-1">Supercharger V3</p>
</div>
<div className="bg-white/[0.03] rounded-[14px] sm:rounded-[16px] p-3 sm:p-4 border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.08] transition-all duration-200">
<div className="flex items-center gap-2 mb-2">
<svg className="lucide lucide-activity w-4 h-4 text-violet-400" data-lucide="activity" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
<span className="text-xs text-white/60">Battery Health</span>
</div>
<p className="text-xl sm:text-2xl font-semibold tracking-tight">98%</p>
<p className="text-xs text-white/50 mt-1">Excellent condition</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-base sm:text-lg font-semibold tracking-tight">Climate</h3>
...
<circle className="text-cyan-400 sm:hidden" cx="56" cy="56" fill="none" r="50" stroke="currentColor" stroke-dasharray="314.16" stroke-dashoffset="125.66" strokeLinecap="round" strokeWidth="8"></circle>
<circle className="text-white/[0.06] hidden sm:block" cx="64" cy="64" fill="none" r="56" stroke="currentColor" strokeWidth="8"></circle>
<circle className="text-cyan-400 hidden sm:block" cx="64" cy="64" fill="none" r="56" stroke="currentColor" stroke-dasharray="351.86" stroke-dashoffset="140.74" strokeLinecap="round" strokeWidth="8"></circle>
</svg>
<div className="absolute inset-0 flex flex-col items-center justify-center">
<span className="text-2xl sm:text-3xl font-semibold tracking-tight">72</span>
<span className="text-xs sm:text-sm text-white/60">°F</span>
</div>
</div>
</div>
<p className="text-sm text-white/60 text-center mb-4">Interior temperature</p>
<div className="space-y-2">
<div className="flex items-center justify-between text-sm">
<span className="text-white/60">Fan Speed</span>
<span className="font-medium">Auto</span>
</div>
<div className="relative h-2 bg-white/[0.06] rounded-full overflow-hidden">
<div className="h-full bg-gradient-to-r from-cyan-500 to-cyan-400 rounded-full transition-all duration-300 hover:from-cyan-400 hover:to-cyan-300" style={{width: '60%'}}></div>
</div>
</div>
</div>
...
<p className="text-sm text-white/80 mb-2">Tesla Supercharger</p>
<p className="text-xs text-white/50 mb-4">123 Main St, San Francisco, CA</p>
...
<svg className="lucide lucide-trending-down w-5 h-5 text-emerald-300" data-lucide="trending-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 17h6v-6"></path><path d="m22 17-8.5-8.5-5 5L2 7"></path></svg>
</div>
<h3 className="text-base font-semibold tracking-tight">Efficiency</h3>
</div>
<p className="text-2xl sm:text-3xl font-semibold tracking-tight mb-1">264</p>
<p className="text-sm text-white/60">Wh/mi average</p>
<div className="mt-4 flex items-center gap-2">
<div className="flex-1 h-1.5 bg-white/[0.06] rounded-full overflow-hidden">
<div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full transition-all duration-500 hover:from-emerald-400 hover:to-emerald-300" style={{width: '85%'}}></div>
</div>
...
<svg className="lucide lucide-route w-5 h-5 text-blue-300" data-lucide="route" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="6" cy="19" r="3"></circle><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"></path><circle cx="18" cy="5" r="3"></circle></svg>
</div>
<h3 className="text-base font-semibold tracking-tight">Trip</h3>
</div>
<p className="text-2xl sm:text-3xl font-semibold tracking-tight mb-1">142.8</p>
<p className="text-sm text-white/60">Miles driven today</p>
<div className="mt-4 flex items-center gap-2">
<div className="flex-1 h-1.5 bg-white/[0.06] rounded-full overflow-hidden">
<div className="h-full bg-gradient-to-r from-blue-500 to-blue-400 rounded-full transition-all duration-500 hover:from-blue-400 hover:to-blue-300" style={{width: '45%'}}></div>
</div>
...
<h3 className="text-base font-semibold tracking-tight">Tire Pressure</h3>
</div>
<p className="text-2xl sm:text-3xl font-semibold tracking-tight mb-1">42</p>
<p className="text-sm text-white/60">PSI average</p>
<div className="mt-4 grid grid-cols-2 gap-2">
<div className="text-xs">
<span className="text-white/50">FL:</span>
<span className="text-white/80 ml-1 font-medium">42</span>
</div>
<div className="text-xs">
...
<div className="text-xs">
<span className="text-white/50">RL:</span>
<span className="text-white/80 ml-1 font-medium">41</span>
</div>
<div className="text-xs">
<span className="text-white/50">RR:</span>
<span className="text-white/80 ml-1 font-medium">42</span>
</div>
</div>
</div>
...
<p className="text-sm text-white/80 font-medium">All Systems OK</p>
</div>
<p className="text-sm text-white/60 mb-4">Sentry mode active</p>
<button className="w-full py-2 rounded-[10px] bg-white/[0.06] border border-white/[0.08] hover:bg-white/[0.1] hover:border-white/[0.12] transition-all duration-200 text-sm font-medium flex items-center justify-center gap-2 hover:scale-[1.02]">
...
<p className="text-base sm:text-lg text-white/60 max-w-2xl mx-auto slide-up px-4">
            Powerful features designed to give you complete control over your electric vehicle
          </p>
</div>
...
<svg className="lucide lucide-battery-charging w-6 h-6 text-cyan-300" data-lucide="battery-charging" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m11 7-3 5h4l-3 5"></path><path d="M14.856 6H16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.935"></path><path d="M22 14v-4"></path><path d="M5.14 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2.936"></path></svg>
</div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Smart Battery Management</h3>
<p className="text-white/60 text-sm leading-relaxed">
              Real-time monitoring of battery health, charge cycles, and optimal charging schedules to maximize lifespan.
            </p>
</div>
...
<svg className="lucide lucide-snowflake w-6 h-6 text-cyan-300" data-lucide="snowflake" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m10 20-1.25-2.5L6 18"></path><path d="M10 4 8.75 6.5 6 6"></path><path d="m14 20 1.25-2.5L18 18"></path><path d="m14 4 1.25 2.5L18 6"></path><path d="m17 21-3-6h-4"></path><path d="m17 3-3 6 1.5 3"></path><path d="M2 12h6.5L10 9"></path><path d="m20 10-1.5 2 1.5 2"></path><path d="M22 12h-6.5L14 15"></path><path d="m4 10 1.5 2L4 14"></path><path d="m7 21 3-6-1.5-3"></path><path d="m7 3 3 6h4"></path></svg>
</div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Climate Control</h3>
<p className="text-white/60 text-sm leading-relaxed">
              Pre-condition your cabin temperature, adjust fan speed, and manage energy-efficient climate settings remotely.
            </p>
</div>

<div className="glass rounded-[20px] sm:rounded-[24px] border border-white/[0.08] p-6 hover:border-white/[0.12] hover:shadow-xl transition-all duration-300 stagger-item hover:scale-[1.02]">
<div className="flex bg-gradient-to-br from-cyan-500/20 to-blue-500/10 w-12 h-12 border-cyan-400/20 border rounded-[16px] mb-4 items-center justify-center">
<svg className="lucide lucide-map w-6 h-6 text-cyan-300" data-lucide="map" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z"></path><path d="M15 5.764v15"></path><path d="M9 3.236v15"></path></svg>
</div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Charging Station Finder</h3>
<p className="text-white/60 text-sm leading-relaxed">
              Locate nearby charging stations, check availability, and navigate to the most convenient location.
            </p>
</div>

<div className="glass rounded-[20px] sm:rounded-[24px] border border-white/[0.08] p-6 hover:border-white/[0.12] hover:shadow-xl transition-all duration-300 stagger-item hover:scale-[1.02]">
<div className="flex bg-gradient-to-br from-cyan-500/20 to-blue-500/10 w-12 h-12 border-cyan-400/20 border rounded-[16px] mb-4 items-center justify-center">
<svg className="lucide lucide-trending-down w-6 h-6 text-cyan-300" data-lucide="trending-down" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M16 17h6v-6"></path><path d="m22 17-8.5-8.5-5 5L2 7"></path></svg>
</div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Energy Analytics</h3>
<p className="text-white/60 text-sm leading-relaxed">
              Track energy consumption patterns, costs, and efficiency metrics with detailed charts and insights.
            </p>
</div>
...
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Security &amp; Alerts</h3>
<p className="leading-relaxed text-sm text-white/60">
              Remote lock/unlock, motion alerts, and instant notifications for any security events or anomalies.
            </p>
</div>

<div className="glass rounded-[20px] sm:rounded-[24px] border border-white/[0.08] p-6 hover:border-white/[0.12] hover:shadow-xl transition-all duration-300 stagger-item hover:scale-[1.02]">
<div className="flex bg-gradient-to-br from-cyan-500/20 to-blue-500/10 w-12 h-12 border-cyan-400/20 border rounded-[16px] mb-4 items-center justify-center">
<svg className="lucide lucide-smartphone w-6 h-6 text-cyan-300" data-lucide="smartphone" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><rect height="20" rx="2" ry="2" width="14" x="5" y="2"></rect><path d="M12 18h.01"></path></svg>
</div>
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Multi-Platform</h3>
<p className="text-white/60 text-sm leading-relaxed">
              Access your dashboard from any device—iOS, Android, web, or in-car display integration.
            </p>
</div>
</div>
</div>
...
<p className="text-lg text-white/60 max-w-2xl mx-auto">
            Simple setup process to connect your vehicle and start monitoring
          </p>
</div>
...
<h3 className="text-xl font-semibold tracking-tight mb-3">Download App</h3>
<p className="text-white/60">
              Install Volta from App Store or Google Play. Available for all major platforms.
            </p>
</div>
...
<h3 className="text-xl font-semibold tracking-tight mb-3">Connect Vehicle</h3>
<p className="text-white/60">
              Sign in with your Tesla account. We use secure OAuth for complete safety.
            </p>
</div>
...
<h3 className="text-xl font-semibold tracking-tight mb-3">Start Monitoring</h3>
<p className="text-white/60">
              Access your dashboard and start managing your EV like never before.
            </p>
</div>
</div>
</div>
...
<div className="glass rounded-[20px] sm:rounded-[24px] border border-white/[0.08] p-6 hover:border-white/[0.12] hover:shadow-xl transition-all duration-300 stagger-item hover:scale-[1.02]">
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Starter</h3>
<div className="mb-6">
...
<span>Basic battery monitoring</span>
</li>
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Pro</h3>
<div className="mb-6">
<span className="text-3xl sm:text-4xl font-semibold tracking-tight">$9</span>
<span className="text-white/60">/month</span>
</div>
<ul className="space-y-3 mb-6">
<li className="flex items-start gap-2 text-sm text-white/70">
...
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span>Scheduled climate control</span>
</li>
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span>Energy cost tracking</span>
</li>
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<div className="glass rounded-[20px] sm:rounded-[24px] border border-white/[0.08] p-6 hover:border-white/[0.12] hover:shadow-xl transition-all duration-300 stagger-item hover:scale-[1.02]">
<h3 className="text-lg sm:text-xl font-semibold tracking-tight mb-2">Premium</h3>
<div className="mb-6">
...
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
<span>Advanced security alerts</span>
</li>
<li className="flex items-start gap-2 text-sm text-white/70">
<svg className="lucide lucide-check w-4 h-4 text-emerald-400 mt-0.5 shrink-0" data-lucide="check" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M20 6 9 17l-5-5"></path></svg>
...
<p className="text-base sm:text-lg text-white/60 mb-8 max-w-2xl mx-auto px-4">
              Join thousands of EV owners who trust Volta for their daily drive
            </p>
...
<li><a className="text-sm text-white/60 hover:text-white transition-colors duration-200" href="#">Features</a></li>
...
<p className="text-sm text-white/40">© 2024 Volta. All rights reserved.</p>

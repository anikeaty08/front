...
tailwind.config = { theme: { extend: { fontFamily: { sans: ['Cairo', 'sans-serif'], display: ['Cairo', 'sans-serif'], hand: ['Cairo', 'cursive'] }, colors: { brand: { sky: '#00E5FF', secondary: '#FF3D81', highlight: '#FFD400', accent: '#7CFF6B', dark: '#050507', panel: '#0E1016', text: '#F2F4FF' } } } } }
...
<nav className="fixed -translate-x-1/2 flex shadow-black/50 transition-all duration-300 hover:border-brand-text/20 hover:shadow-brand-sky/10 bg-gradient-to-br from-brand-text/10 to-brand-text/0 w-full lg:w-fit max-w-[90vw] z-50 rounded-full ring-brand-text/10 ring-1 pt-1.5 ps-4 pb-1.5 pe-1.5 top-6 left-1/2 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] backdrop-blur-xl items-center justify-between hover:shadow-brand-sky/30">

<div className="flex gap-2.5 items-center ms-8">
...
<div className="hidden md:flex items-center gap-6 ms-8">
...
<button className="flex gap-2 hover:bg-brand-sky hover:text-brand-dark transition-colors group text-xs font-semibold text-black bg-brand-text rounded-full pt-2 pe-4 pb-2 ps-4 gap-x-2 gap-y-2 items-center flex-none">
        اكتشف كيف نعمل
        <svg aria-hidden="true" className="iconify group-hover:-translate-x-0.5 transition-transform rotate-180" data-icon="solar:arrow-left-bold-duotone" height="1em" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
...
<h1 className="lg:text-9xl leading-[1.1] text-brand-sky text-glow text-7xl font-bold mb-6 font-display">
          حلول ذكية.
          <br/>
<span className="text-brand-text opacity-90">
            تقنية متطورة.
            <span className="text-brand-secondary">للمستقبل.</span>
</span>
</h1>
<p className="font-sans text-xl lg:text-2xl font-light text-brand-text/70 leading-relaxed tracking-tight max-w-xl mb-12">
          نحول أفكارك إلى واقع رقمي ملموس، ونبني لك أنظمة برمجية متطورة تدعم نمو
          أعمالك بكفاءة عالية.
        </p>
...
<button className="hover:bg-brand-text/10 hover:text-brand-text transition-all flex text-sm font-medium text-slate-300 bg-brand-text/5 rounded-full pt-3 pe-6 pb-3 ps-6 gap-x-2 gap-y-2 items-center group" style={{boxShadow: '0 4px 20px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.05)', position: 'relative', -BorderGradient: 'linear-gradient(180deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.15))', -BorderRadiusBefore: '9999px'}}>
<span className="text-sm font-medium tracking-tight">شاهد خدماتنا</span>
<svg className="opacity-70 group-hover:opacity-100 group-hover:-translate-x-0.5 transition-all rotate-180" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-3xl font-display text-brand-sky mb-2 opacity-90 font-bold">
            أنظمة مجربة
          </span>
...
<span className="text-3xl font-display text-brand-secondary mb-2 opacity-90 font-bold">
            تقنية حديثة
          </span>
...
<div className="text-xs font-mono tracking-widest text-brand-text/50 text-center mb-4">
                نحن خيار الشركات التقنية الرائدة
              </div>
</div>
</div>
<style>
...
<p className="text-xl text-brand-text/60 leading-relaxed max-w-2xl font-light tracking-tight">
          لا نعمل بعشوائية. نقوم بتحليل متطلباتك التقنية وبناء أنظمة برمجية
          قابلة للتوسع، مما يضمن استدامة أعمالك ونموها المستمر في السوق الرقمي.
        </p>
</div>
...
<p className="text-base text-brand-text/50 leading-relaxed mb-12 relative z-10 font-light">
            نحول العمليات المعقدة إلى أنظمة بسيطة وفعالة يسهل استخدامها
            وتطويرها.
          </p>
...
<p className="text-xs text-brand-text/90 font-light leading-relaxed">
                  تحليل متطلبات النظام لمشروع
                  <span className="text-brand-text font-medium">ألفا</span>
                  . تحديد
                  <span className="text-brand-sky">أولويات التطوير</span>
                  للمرحلة القادمة.
                </p>
</div>
...
<p className="text-base text-brand-text/50 leading-relaxed mb-12 font-light group-hover:text-brand-text/70 transition-colors">
              تحليل البيانات واتخاذ القرارات بناءً على حقائق السوق وسلوك
              المستخدمين الفعلي.
            </p>
...
<p className="text-base text-brand-text/50 leading-relaxed mb-12 relative z-10 font-light">
            نشر التحديثات وإدارة البنية التحتية عبر منصات متعددة لضمان استمرارية
            العمل.
          </p>
...
<span className="">حد التوزيع</span>
<span className="text-brand-sky">75% مجدول</span>
</div>
...
<svg className="lucide lucide-arrow-left relative z-10 transition-transform duration-300 group-hover:-translate-x-1 rotate-180" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<path d="M5 12h14"></path>
<path d="m12 5 7 7-7 7"></path>
</svg>
...
<span className="text-[10px] font-mono uppercase tracking-widest text-brand-accent">
                    تم البناء بواسطة فايرال
                  </span>
</div>
<p className="font-serif text-lg text-brand-text italic leading-relaxed">
                  لقد بنيت منتجاً رائعاً، ونحن نساعدك في توسيعه تقنياً. نوضح
                  الرؤية ونبني الأنظمة التي تدعم نموك.
                </p>
...
<p className="text-sm text-brand-text/60 font-light leading-relaxed">
                  الفرق الصغيرة لا تملك وقتاً للهدر. نعمل كجزء من فريقك لتقليل
                  الحمل التشغيلي والتركيز على الإنجاز.
                </p>
<div className="text-xs font-mono text-brand-text/40 uppercase tracking-widest mt-4">
                  تنفيذ بدون أعباء إدارية.
                </div>
</div>
<div className="group cursor-default">
<div className="flex items-center gap-3 mb-3">
...
<p className="text-sm text-brand-text/60 font-light leading-relaxed">
                  نحول الأفكار إلى منتجات قابلة للاستخدام، ونضمن عمل أنظمتك
                  بكفاءة عالية على مدار الساعة.
                </p>
<div className="text-xs font-mono text-brand-text/40 uppercase tracking-widest mt-4">
                  الاستمرارية تتغلب على العشوائية.
                </div>
</div>
</div>
...
<h2 className="text-4xl md:text-5xl lg:text-7xl font-serif font-semibold tracking-tight text-brand-text leading-[1.05] mb-6">
          نظام بسيط. تسليم مستمر.
        </h2>
<p className="text-xl text-brand-text/60 leading-relaxed max-w-2xl font-light tracking-tight">
          فايرال ليست مجرد حملة، بل نظام تشغيل أسبوعي للتطوير والنشر، مصمم
          ليتضاعف تأثيره بمرور الوقت.
        </p>
</div>
...
<p className="text-sm text-brand-text/50 font-light leading-relaxed">
            نبدأ بفهم منتجك وسوقك، ثم نوضح الرسالة لتكون مفهومة وجذابة لجمهورك
            المستهدف.
          </p>
</div>
<div className="flex flex-col p-8 rounded-[24px] border border-brand-text/5 bg-brand-text/[0.02] hover:bg-brand-text/[0.04] transition-colors duration-300 group">
...
<p className="text-sm text-brand-text/50 font-light leading-relaxed">
            نحدد الهيكلية والمنصات والإيقاع الزمني، ليصبح العمل عملية منظمة
            بدلاً من مجرد علامات استفهام.
          </p>
</div>
<div className="flex flex-col p-8 rounded-[24px] border border-brand-text/5 bg-brand-text/[0.02] hover:bg-brand-text/[0.04] transition-colors duration-300 group">
...
<p className="text-sm text-brand-text/50 font-light leading-relaxed">
            كل أسبوع، نقوم بتسليم التحديثات والمحتوى. لا انتظار للكمال، الزخم
            يُبنى من خلال الاستمرارية.
          </p>
</div>
<div className="flex flex-col p-8 rounded-[24px] border border-brand-text/5 bg-brand-text/[0.02] hover:bg-brand-text/[0.04] transition-colors duration-300 group">
<div className="w-10 h-10 rounded-full border border-brand-text/10 bg-brand-panel flex items-center justify-center mb-6 text-brand-sky group-hover:text-brand-text transition-colors">
...
<p className="text-sm text-brand-text/50 font-light leading-relaxed">
            ما ينجح نضاعف التركيز عليه، وما لا ينجح نستبعده. مع الوقت، تتضاعف
            النتائج ويقل الجهد.
          </p>
</div>
<div className="flex flex-col p-8 rounded-[24px] border border-brand-text/5 bg-brand-text/[0.02] hover:bg-brand-text/[0.04] transition-colors duration-300 group">
...
<p className="relative z-10 text-xl md:text-2xl font-serif text-brand-text font-light leading-relaxed mb-8">
                نوضح ما تقوله، ولمن، ولماذا هو مهم — بحيث تعزز كل قطعة محتوى نفس
                الإشارة.
              </p>
...
<p className="text-sm text-brand-text/50 font-light leading-relaxed max-w-sm">
                  نطور خططاً وسرديات مصممة لتناسب طريقة توزيع المنصات للمحتوى.
                </p>
</div>
</div>
...
<span>هل هذا للشركات B2B أم B2C؟</span>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              كلاهما. النظام مبني حول الوضوح والاستمرارية والتوزيع — وهذا ينطبق
              سواء كنت تبيع برمجيات، خدمات، أو منتجات.
            </p>
</details>

<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">هل تنشرون بالنيابة عنا أم معنا؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              يعتمد ذلك على الاتفاق. بعض الفرق تريد تنفيذاً كاملاً، والبعض الآخر
              يفضل التوجيه والهيكلة والمراجعة.
            </p>
</details>

<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">كم من الوقت قبل أن نرى النتائج؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              الأمر ليس حول قفزات ليلية. معظم الفرق تشعر بالوضوح فوراً وترى
              الزخم يبنى خلال الأسابيع الأولى.
            </p>
</details>

<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">ما المنصات التي تركزون عليها؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              نركز على المنصات حيث المحتوى المستمر والتوزيع هو الأهم — عادة X،
              LinkedIn، وتيك توك.
            </p>
</details>
...
<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">ماذا لو كان لدينا محتوى بالفعل؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              هذا أمر جيد. نقوم بتدقيق ما هو موجود، وتحديد الإشارة، والبناء على
              ما يعمل بالفعل.
            </p>
</details>
...
<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">هل هناك التزام طويل الأمد؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              لا قيود طويلة الأمد. الهدف هو بناء الزخم والوضوح — وليس حبس الفرق
              في عقود.
            </p>
</details>
...
<details className="group py-6 [&amp;_summary::-webkit-details-marker]:hidden">
<summary className="flex items-center justify-between cursor-pointer list-none text-lg md:text-xl font-medium text-brand-text/90 hover:text-brand-sky transition-colors">
<span className="">ماذا يحدث في استشارة النمو؟</span>
<span className="transition-transform duration-300 group-open:rotate-180 opacity-50 group-hover:opacity-100">
<svg fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="24">
<path d="M6 9l6 6 6-6"></path>
</svg>
...
<p className="text-brand-text/50 mt-4 font-light leading-relaxed">
              نراجع منتجك ورسالتك والإشارة الحالية، ثم نحدد مساراً واضحاً للمضي
              قدماً.
            </p>
</details>
</div>
...
<div className="flex flex-col gap-4">
<h4 className="text-xs font-mono uppercase tracking-widest text-brand-text/30 mb-2">
            احصل على تحديثات فايرال
          </h4>
<div className="flex gap-2">
<input className="bg-brand-text/5 border border-brand-text/10 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-brand-sky/50 w-full transition-colors" placeholder="أدخل بريدك الإلكتروني" type="email"/>
...
<p>© 2024 فايرال. جميع الحقوق محفوظة.</p>

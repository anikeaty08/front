...
<h1 className="text-2xl font-medium text-blue-800">Search</h1>
...
<input className="w-full bg-white border border-secondary/30 rounded-xl py-3.5 px-4 text-sm text-blue-700 placeholder-secondary focus:outline-none focus:ring-2 focus:ring-secondary/50 pl-11" placeholder="Search cities, zip codes..." type="text"/>
<button className="absolute left-3 top-1/2 transform -translate-y-1/2 text-secondary">
...
<div className="mb-6">
<h2 className="text-lg font-medium text-blue-800 mb-3">Popular Cities</h2>
...
<div>
<h2 className="text-lg font-medium text-blue-800 mb-3">Search by Region</h2>
<div className="grid grid-cols-2 gap-3">
<button className="bg-white p-4 rounded-xl shadow-sm border border-secondary/20 flex items-center gap-3">
<div className="w-10 h-10 flex items-center justify-center bg-blue-50 rounded-full text-blue-600">
<i className="bi bi-globe-americas"></i>
</div>
<span className="text-blue-800 font-medium">Americas</span>
</button>
<button className="bg-white p-4 rounded-xl shadow-sm border border-secondary/20 flex items-center gap-3">
<div className="w-10 h-10 flex items-center justify-center bg-blue-50 rounded-full text-blue-600">
<i className="bi bi-globe-europe-africa"></i>
</div>
<span className="text-blue-800 font-medium">Europe</span>
</button>
<button className="bg-white p-4 rounded-xl shadow-sm border border-secondary/20 flex items-center gap-3">
<div className="w-10 h-10 flex items-center justify-center bg-blue-50 rounded-full text-blue-600">
<i className="bi bi-globe-asia-australia"></i>
</div>
<span className="text-blue-800 font-medium">Asia</span>
</button>
<button className="bg-white p-4 rounded-xl shadow-sm border border-secondary/20 flex items-center gap-3">
<div className="w-10 h-10 flex items-center justify-center bg-blue-50 rounded-full text-blue-600">
<i className="bi bi-globe-central-south-asia"></i>
</div>
<span className="text-blue-800 font-medium">Africa</span>
</button>
</div>
</div>
</div>
...
<i className="bi bi-search-heart-fill text-xl"></i>

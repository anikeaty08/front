...
<h2 className="text-3xl md:text-5xl font-bold mb-4">Our Core Features</h2>
<p className="text-lg text-gray-600 max-w-3xl mx-auto">We combine strategic thinking with exceptional design to create digital experiences that transform brands and drive business growth.</p>
</div>
...
<p className="text-gray-600 mb-6">We dive deep into your business challenges to create solutions that align with your goals and resonate with your audience.</p>
...
<p className="text-gray-600 mb-6">Our award-winning design team creates visually stunning experiences that capture attention and drive engagement.</p>
<ul className="space-y-2 text-gray-600">
<li className="flex items-center">
<svg className="w-5 h-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
...
<p className="text-gray-600 mb-6">Our development team brings designs to life with clean, efficient code that ensures performance and scalability.</p>
<ul className="space-y-2 text-gray-600">
<li className="flex items-center">
<svg className="w-5 h-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
...
<a className="inline-flex items-center bg-blue-600 text-white font-bold px-8 py-4 rounded-lg hover:bg-blue-700 transition-colors" href="#">

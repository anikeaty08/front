...
<span className="" style={{}}>Get Started</span>
...
<div className="">
<p className="text-sm font-medium text-gray-900 font-geist">Unified analytics</p>
<p className="text-sm text-gray-600 font-geist">See revenue, expenses, and cash at a glance.</p>
</div>
</div>
<div className="flex items-start gap-3">
<div className="flex shrink-0 sm:w-9 sm:h-9 bg-white/10 w-8 h-8 border-white/10 border rounded-lg mt-0.5 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] backdrop-blur-md items-center justify-center">
...
<div className="">
<p className="text-sm font-medium text-gray-900 font-geist">Real‑time trends</p>
<p className="text-sm text-gray-600 font-geist">Monitor KPIs with live updates.</p>
</div>
</div>
<div className="flex items-start gap-3">
<div className="flex shrink-0 sm:w-9 sm:h-9 bg-white/10 w-8 h-8 border-white/10 border rounded-lg mt-0.5 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] backdrop-blur-md items-center justify-center">
...
<div className="">
<p className="text-sm font-medium text-gray-900 font-geist">Automated reports</p>
<p className="text-sm text-gray-600 font-geist">Schedule insights, reclaim your time.</p>
</div>
</div>
</div>
</section>
...
<p className="mt-3 text-xs text-gray-500 font-geist">Revenue</p>
<p className="text-lg font-semibold text-gray-900 tracking-tight font-geist">$92,310</p>
</div>
<div className="bg-white ring-black/5 ring-1 rounded-xl pt-4 pr-4 pb-4 pl-4">
<div className="flex items-center justify-between">
...
<p className="mt-3 text-xs text-gray-500 font-geist">Net Profit</p>
<p className="text-lg font-semibold text-gray-900 tracking-tight font-geist">$30,145</p>
</div>
...
<p className="mt-3 text-xs text-gray-500 font-geist">Customers</p>
...
<p className="mt-3 text-xs text-gray-500 font-geist">Growth Rate</p>
...
<span className="font-geist">Q1 2024</span>
...
<p className="text-sm font-medium text-gray-900 tracking-tight font-geist">All Systems Go</p>
</div>
</div>
...
<div>
<p className="text-xs text-gray-500 font-geist">Trend</p>
<p className="text-sm font-medium text-gray-900 tracking-tight font-geist">↑ Improving</p>
</div>
</div>
</div>
</div>
...
<img alt="Client 1" className="h-6 w-6 sm:h-8 sm:w-8 rounded-full object-cover ring-2 ring-white" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b4068fc8-aab7-4479-94f9-f732424eb0e3_320w.jpg"/>
<img alt="Client 2" className="h-6 w-6 sm:h-8 sm:w-8 rounded-full object-cover ring-2 ring-white" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/97281bb5-4be6-4df1-8517-e3ebc0c061e0_320w.jpg"/>
<img alt="Client 3" className="h-6 w-6 sm:h-8 sm:w-8 rounded-full object-cover ring-2 ring-white" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/d3da1789-0f7a-4fbc-b7b6-606f9b85b083_320w.jpg"/>
<img alt="Client 4" className="h-6 w-6 sm:h-8 sm:w-8 rounded-full object-cover ring-2 ring-white" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/b058d52d-70d0-4c76-85ec-35b1d0a78d93_320w.jpg"/>
</div>
<div className="text-xs">
<p className="font-medium text-gray-900 font-geist">Loved by teams</p>
...
<div className="text-xs">
<p className="font-medium text-gray-900 font-geist tracking-tight">4.9 average rating</p>
...
<img alt="Mobile dashboard preview" className="sm:h-[600px] w-full h-[520px] object-cover" src="https://hoirqrkdgbmvpwutwuwj-all.supabase.co/storage/v1/object/public/assets/assets/ea3a5611-6ce0-4973-9c34-7b2492e29a38_800w.jpg"/>
</div>
</div>
...
<p className="text-sm font-medium text-gray-900 tracking-tight font-geist">Live alerts</p>
</div>
</div>
</div>
</div>
...
<p className="mt-4 text-sm text-gray-400 font-geist max-w-sm">
          Real-time financial visibility for modern teams. Understand revenue, costs, and trends instantly.
        </p>
...
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Features</a></li>
<li className=""><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Integrations</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Pricing</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Mobile App</a></li>
...
<ul className="mt-4 space-y-3">
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">About</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Careers</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Blog</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Press</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Contact</a></li>
</ul>
</div>
...
<ul className="mt-4 space-y-3">
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Documentation</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Help Center</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">API Reference</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Guides</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Community</a></li>
</ul>
</div>
...
<ul className="mt-4 space-y-3">
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Privacy</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Terms</a></li>
<li className=""><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Security</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Compliance</a></li>
<li><a className="text-sm text-gray-400 hover:text-white transition font-geist" href="#">Cookie Policy</a></li>
</ul>
</div>
</div>
</div>
...
<h3 className="text-base font-semibold text-white font-geist tracking-tight">Stay up to date</h3>
<p className="mt-2 text-sm text-gray-400 font-geist">Get the latest product updates and finance insights delivered to your inbox.</p>
<form className="mt-4 flex gap-2">
<input className="flex-1 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2.5 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white/30 font-geist" placeholder="Enter your email" type="email"/>
...
<p className="text-xs text-gray-400 font-geist">© 2024 Finance. All rights reserved.</p>
<div className="flex items-center gap-6 text-xs text-gray-400">
<a className="hover:text-white transition font-geist" href="#">Status</a>
<a className="hover:text-white transition font-geist" href="#">Sitemap</a>
<a className="hover:text-white transition font-geist" href="#">Accessibility</a>
</div>
</div>
</div>

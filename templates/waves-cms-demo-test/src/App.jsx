...
<span className="font-display font-bold text-xl tracking-tighter text-white group-hover:text-accent transition-colors">Waves<span className="text-accent group-hover:text-white transition-colors">//</span>CMS</span>
</a>
...
<h1 className="md:text-9xl leading-[0.9] scramble-text text-6xl font-bold text-white tracking-tighter font-display mix-blend-screen mb-6">
                    EFFICIENT <br/>
<span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-400 to-gray-600">FLUIDITY</span>
</h1>
<p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-10 font-light">
                    The enterprise infrastructure layer for autonomous content. <br/>
                    Zero latency. Zero hallucinations. Pure deterministic compute.
                </p>
<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
<button className="bg-accent text-white px-8 py-4 font-bold text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-all hover-trigger w-full sm:w-auto btn-magnetic">
                        Start Instance
                    </button>
...
<div className="w-10 h-10 bg-accent flex items-center justify-center mb-4 text-white font-bold">
...
<div className="h-full bg-gradient-to-r from-accent to-purple-500 w-[82%] rounded-full"></div>
</div>
</div>
</div>
...
<span className="text-purple-400">import</span> waves <span className="text-purple-400">as</span> wv
                            <span className="text-gray-600"># Connect to the grid</span>
                            client = wv.Client(api_key=<span className="text-green-400">"wv_live_..."</span>)
                            <span className="text-gray-600"># Run deterministic inference</span>
                            response = client.generate(
                              model=<span className="text-green-400">"waves-v4-turbo"</span>,
...
<div className="relative w-40 h-40 border border-accent rounded-full flex items-center justify-center z-10 shadow-[0_0_50px_rgba(0,136,255,0.3)] bg-black/50 backdrop-blur-sm">
...
<div className="border border-accent bg-[#0a0a0a] p-8 rounded-2xl relative hover-trigger transform md:-translate-y-4 shadow-[0_0_30px_rgba(0,136,255,0.1)] spotlight-card">
...
<button className="w-full py-3 bg-accent text-white rounded font-bold uppercase text-xs tracking-wider hover:bg-white hover:text-black transition-all z-10 relative">Deploy Key</button>
</div>
<div className="border border-white/10 p-8 rounded-2xl hover:bg-white/5 transition-colors hover-trigger spotlight-card glass-panel">
...
<span className="text-[20vw] font-display font-black text-white whitespace-nowrap -ml-10">WAVES</span>
</div>
...
<button className="bg-accent text-white px-6 py-3 rounded font-bold text-sm hover:bg-white hover:text-black transition-colors">JOIN</button>
</div>
</div>

...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="text-center mb-16">
<h2 className="text-3xl sm:text-4xl font-semibold tracking-tighter text-slate-900">Ce qu'ils en pensent</h2>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
<div className="p-6 rounded-2xl bg-slate-50 border border-slate-100">
<div className="flex gap-1 text-yellow-400 mb-3 text-sm">★★★★★</div>
<p className="text-slate-700 text-sm leading-relaxed mb-4">"Franchement incroyable 😍 site reçu en 24h et déjà mes premiers clients ! Le design est ouf et super pro."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-medium text-xs">M</div>
<div>
<p className="text-sm font-medium text-slate-900">Marc D.</p>
<p className="text-xs text-slate-500">Freelance</p>
</div>
</div>
</div>
<div className="p-6 rounded-2xl bg-slate-50 border border-slate-100">
<div className="flex gap-1 text-yellow-400 mb-3 text-sm">★★★★★</div>
<p className="text-slate-700 text-sm leading-relaxed mb-4">"J'avais peur d'avancer l'argent... Le fait de payer à la fin m'a rassuré. Et le résultat est parfait, merci l'équipe ! 🙌"</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-medium text-xs">S</div>
<div>
...
<div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 md:hidden lg:block">
<div className="flex gap-1 text-yellow-400 mb-3 text-sm">★★★★★</div>
<p className="text-slate-700 text-sm leading-relaxed mb-4">"Rapide, net et sans bavure. La com' sur WhatsApp est hyper fluide. Mon site vitrine tue, effet Apple garanti 🍏."</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-700 font-medium text-xs">A</div>
<div>
<p className="text-sm font-medium text-slate-900">Antoine B.</p>

...
<span className="relative z-10 font-geist">Réserver</span>
</a>
</div>
</nav>
...
<div className="absolute -left-4 md:left-20 top-0 flex flex-col gap-2 opacity-30 hidden lg:flex [animation:animationIn_0.8s_ease-out_0.5s_both] animate-on-scroll animate">
...
<span className="text-gradient [animation:animationIn_0.8s_ease-out_0.3s_both] animate-on-scroll font-light tracking-tighter font-space-grotesk text-glow animate">
                Digitale
              </span>
</h1>
</div>
...
<h2 className="[animation:animationIn_0.8s_ease-out_0.4s_both] animate-on-scroll text-lg text-neutral-400 tracking-tight font-space-grotesk md:text-3xl animate">
              L'ingénierie web de premier plan.
            </h2>
</div>
<div className="leading-relaxed [animation:animationIn_0.8s_ease-out_0.6s_both] animate-on-scroll md:text-2xl text-xs text-neutral-500 font-space-grotesk text-center max-w-lg animate">
            Nous concevons des sites web haute performance qui dominent les résultats de recherche. Vos vues et votre présence en ligne augmenteront massivement.
          </div>
</div>
...
<div className="">
<div className="text-4xl text-white mb-1 tracking-tighter font-space-grotesk font-light">
<span className="" data-suffix="x" data-target="10">10x</span>
</div>
<h3 className="text-xs uppercase tracking-widest text-neutral-500 font-geist">
...
<h2 className="text-5xl md:text-6xl uppercase mb-8 lg:mb-8 text-white tracking-tighter font-space-grotesk font-light">
              Protocole
              <br/>
<span className="text-neutral-600">Digital</span>
</h2>
...
<div>
<h3 className="text-xl uppercase tracking-widest text-white font-space-grotesk">
                    02 / Développement Moderne
                  </h3>
<p className="step-text text-sm text-neutral-500 font-geist">
                    Exécution au pixel près.
                  </p>
</div>
</div>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                Avant que le code n'apparaisse à l'écran, nous cartographions votre écosystème numérique. Nous analysons la structure du site et les lacunes en mots-clés pour construire un plan d'action qui garantit une présence en ligne dominante.
              </p>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                Nous n'utilisons pas de modèles préfabriqués. Nous concevons des applications web sur mesure avec des technologies modernes (Next.js, React) pour garantir des temps de chargement instantanés et une expérience utilisateur parfaite.
              </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3">
<iconify-icon className="text-blue-500" icon="solar:check-circle-bold-duotone"></iconify-icon>
                  Stack Moderne (Next.js/React)
                </li>
<li className="flex items-center gap-3">
<iconify-icon className="text-blue-500" icon="solar:check-circle-bold-duotone"></iconify-icon>
...
<p className="text-neutral-400 leading-relaxed mb-8 font-geist">
                Un beau site est inutile si personne ne le voit. Nos stratégies assurent que les vues sur votre entreprise augmenteront drastiquement, transformant les visiteurs en clients fidèles.
              </p>
<ul className="space-y-4 font-geist text-sm text-neutral-300">
<li className="flex items-center gap-3">
<iconify-icon className="text-purple-500" icon="solar:check-circle-bold-duotone"></iconify-icon>
                  Domination des Mots-clés
                </li>
<li className="flex items-center gap-3">
<iconify-icon className="text-purple-500" icon="solar:check-circle-bold-duotone"></iconify-icon>
...
<img alt="Mobile" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity grayscale-0 hover:grayscale duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/917d6f93-fb36-439a-8c48-884b67b35381_1600w.jpg"/>
...
<img alt="Web" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-80 transition-opacity grayscale-0 hover:grayscale duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4734259a-bad7-422f-981e-ce01e79184f2_1600w.jpg"/>
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">
                  Syntaxe Propre
                </h3>
...
<img alt="Process" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-80 transition-opacity grayscale-0 hover:grayscale duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/c543a9e1-f226-4ced-80b0-feb8445a75b9_1600w.jpg"/>
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">
                  Infra Évolutive
                </h3>
...
<img alt="Data" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-80 transition-opacity grayscale-0 hover:grayscale duration-500" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5bab247f-35d9-400d-a82b-fd87cfe913d2_1600w.webp"/>
<div className="absolute bottom-6 left-6 z-20">
<h3 className="text-xl uppercase tracking-tight font-space-grotesk text-white">
                  Données Clés
                </h3>
...
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">
                "Search Salience a totalement repensé notre présence en ligne. La vitesse de notre site est instantanée et nos vues organiques ont doublé en 6 mois."
              </p>
...
<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0 hover:border-purple-500/30 transition-colors">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">
                "La précision de leur stratégie SEO est unique. Nous avons réduit nos dépenses publicitaires de 40% tout en augmentant massivement nos leads."
              </p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
...
<div className="w-[400px] border border-subtle p-8 bg-[#050505] shrink-0 hover:border-purple-500/30 transition-colors">
<p className="text-sm leading-relaxed mb-6 text-neutral-300 font-geist">
                "Leur développement web sur mesure nous a donné une plateforme qui convertit vraiment. Le ROI était évident dès les 14 premiers jours."
              </p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 flex items-center justify-center">
...
<h2 className="md:text-8xl uppercase text-5xl font-light text-white tracking-tighter font-space-grotesk mix-blend-plus-lighter mb-8">
          Prêt à
          <span className="text-neutral-600">Décoller ?</span>
</h2>
<p className="text-xl text-neutral-400 font-geist mix-blend-plus-lighter max-w-xl mr-auto mb-10 ml-auto">
          Associez-vous à l'agence d'ingénierie digitale la plus avancée pour maximiser votre présence en ligne.
        </p>
<div className="">
...
<p className="text-sm text-neutral-400 mb-8 leading-relaxed font-geist">
              Parlez-nous de votre projet. Notre équipe d'experts analysera votre demande pour booster votre visibilité en ligne. Réponse sous 24h.
            </p>
...
<span className="font-geist">contact@searchsalience.fr</span>
</div>
<div className="flex items-center gap-4 text-neutral-300">
<iconify-icon className="text-lg" icon="solar:map-point-bold-duotone"></iconify-icon>
<span className="font-geist">Paris, France</span>
</div>
</div>
</div>
...
<span className="font-geist">Envoyer</span>
...
<p className="font-geist">
            © 2024 Search Salience Systems. Tous droits réservés.
          </p>

...
<div className="fixed inset-0 z-50 flex items-center justify-center bg-[#030305] transition-opacity duration-1000" id="loader">
...
<canvas className="w-full h-full outline-none cursor-auto" data-engine="three.js r160" height="1898" id="webgl-canvas" style={{width: '1248px', height: '949px'}} width="2496"></canvas>
</div>
...
<div className="w-8 h-8 rounded-full border border-neutral-800 flex items-center justify-center bg-neutral-900/50 group-hover:border-cyan-500/50 transition-colors duration-300">
<span className="font-semibold text-sm tracking-tighter">N</span>
</div>
<span className="text-sm font-medium tracking-tight text-neutral-400 group-hover:text-white transition-colors glitch-target">
            NEXUS
          </span>
</div>
<nav className="hidden md:flex items-center gap-8 glass-panel py-2 rounded-full scale-[1.03] px-7 py-2.5">
...
<button className="group flex items-center gap-2 px-4 py-2 border border-neutral-800 rounded-lg hover:border-cyan-500/30 hover:bg-cyan-500/5 transition-all duration-300">
<span className="text-xs font-medium text-neutral-300 group-hover:text-cyan-400">
            Connect
          </span>
<iconify-icon className="text-neutral-500 group-hover:text-cyan-400 group-hover:translate-x-0.5 transition-all" icon="solar:alt-arrow-right-linear" width="16"></iconify-icon>
</button>
</header>
...
<p className="hero-reveal text-sm md:text-base text-neutral-400 leading-relaxed font-light">
              Experience the convergence of data and aesthetics. Click the core
              to initiate particle disintegration sequence.
            </p>
</div>
...
<span className="text-sm font-semibold tracking-tight group-hover:text-black">
                    Initialize
                  </span>
<iconify-icon icon="solar:play-linear" width="18"></iconify-icon>
</div>
</button>
<button className="group px-6 py-3 border border-neutral-800 rounded-lg hover:border-neutral-600 transition-colors bg-neutral-900/20 backdrop-blur-sm">
<div className="flex items-center gap-2">
<span className="text-sm font-medium text-neutral-300">
                    Documentation
                  </span>
<iconify-icon className="text-neutral-500 group-hover:text-white transition-colors" icon="solar:file-text-linear" width="18"></iconify-icon>
</div>
</button>
</div>
</div>
...
<span className="text-xs font-mono text-cyan-400" id="coords">0.38.0.00.00</span>
</div>
...
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home2'" role="button">
            2
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home3'" role="button">
            3
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home4'" role="button">
            4
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home5'" role="button">
            5
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home6'" role="button">
            6
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home7'" role="button">
            7
          </button>
<button className="flex text-[10px hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 hover:shadow-[0_0_px_rgba(6,182,212,0.15)] cursor-pointer font-bold text-neutral-600 w-12 h-12 border-neutral-800/50 border rounded-sm items-center justify-center bg-white/15 text-neutral-200 border-neutral-700/60" onclick="window.location.href='/home8'" role="button">
            8
          </button>
</div>

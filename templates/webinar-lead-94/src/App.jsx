...
<span className="font-semibold text-gray-900 tracking-tight">WLL</span>
</span>
...
<button className="inline-flex transition-all hover:brightness-110 hover:shadow text-sm font-medium text-white h-11 rounded-md pr-5 pl-5 shadow-sm items-center justify-center" data-open-modal="#sampleModal" style={{backgroundColor: '#14B8A6'}}>Get a Sample PDF →</button>
...
<p className="text-sm text-gray-600">Your Webinar</p>
</div>
...
<p className="text-base font-semibold text-gray-900">Webinar link</p>
</div>
<div className="rounded-lg border border-gray-200 bg-white p-3">
<p className="text-xs text-gray-500">We delivery</p>
<p className="text-base font-semibold text-gray-900">PDF in 48 hrs</p>
</div>
<div className="rounded-lg border border-gray-200 bg-white p-3">
...
<p className="text-base font-semibold text-gray-900 mt-1">Freed up for revenue</p>
</div>
</div>
</div>
</div>
<div className="flex gap-3 text-sm text-gray-600 bg-white/60 border-gray-200 border rounded-md pt-3 pr-3 pb-3 pl-3 items-center mt-6 md:mt-8">
...
<li className="flex flex-col gap-3" data-reveal="">
<div className="flex gap-2 &lt;span class= items-center">
<span className="inline-flex h-7 w-7 items-center justify-center rounded-md border border-gray-200 bg-gray-50 text-sm font-medium text-gray-900">3</span>
<span className="text-sm font-medium text-gray-900">Outline &amp; draft</span>
</div>
...
<button className="inline-flex hover:brightness-110 text-sm font-medium text-white h-10 rounded-md pr-4 pl-4 shadow-sm items-center justify-center" data-open-modal="#sampleModal" style={{backgroundColor: '#14B8A6'}}>Get a sample →</button>
</div>
</div>
</div>
</section>
...
<button className="md:w-auto inline-flex hover:brightness-110 text-sm font-medium text-white w-full h-11 rounded-md pr-5 pl-5 shadow-sm items-center justify-center" data-open-modal="#sampleModal" style={{backgroundColor: '#14B8A6'}}>Get a sample PDF →</button>
</div>
</div>

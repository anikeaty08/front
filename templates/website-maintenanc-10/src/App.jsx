...
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '40%', animationDelay: '0s'}}></div>
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '60%', animationDelay: '0.5s'}}></div>
<div className="w-full bg-[#10B981] rounded-t-sm chart-bar shadow-[0_0_10px_rgba(16,185,129,0.2)]" style={{'--target-height': '85%', animationDelay: '1s'}}></div>
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '30%', animationDelay: '1.5s'}}></div>
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '50%', animationDelay: '2s'}}></div>
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '45%', animationDelay: '2.5s'}}></div>
<div className="w-full bg-[#F4F7FC] rounded-t-sm chart-bar" style={{'--target-height': '20%', animationDelay: '3s'}}></div>
</div>
</div>

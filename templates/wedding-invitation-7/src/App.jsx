...
try{if(window.parent&&window.parent!==window){window.parent.promotekit_referral="1fd2949a-d22c-431b-92bf-02d4ad04ee24";window.parent.document.cookie="promotekit_referral=1fd2949a-d22c-431b-92bf-02d4ad04ee24;path=/;domain=.aura.build;max-age=31536000"}}catch(e){}
        ...
        musicBtn.addEventListener('click', () => {
            if (isPlaying) {
                audio.pause();
                musicIcon.setAttribute('icon', 'solar:play-circle-linear');
                musicBtn.classList.remove('animate-pulse');
            } else {
                audio.play();
                musicIcon.setAttribute('icon', 'solar:pause-circle-linear');
...
<div id="intro-envelope">
<img alt="Luxury green envelope with gold wax seal" src="https://i.postimg.cc/87MqxK6q/Gold-wax-seal-on-dark-green-envelope.jpg"/>
</div>
...
<button className="bg-white/10 backdrop-blur-md p-3 rounded-full hover:bg-white/20 transition-all border border-white/20 group relative overflow-hidden text-white flex items-center justify-center" id="music-btn">
<iconify-icon height="20" icon="solar:music-note-linear" id="music-icon" strokeWidth="1.5" width="20"></iconify-icon>
</button>
</div>
</aside>
...
<div className="mt-8 flex justify-center text-[#6b7c62] animate-bounce">
...
<div className="bg-white p-6 rounded-lg shadow-sm border border-stone-100 text-center fade-in-section hover:border-[#6b7c62]/30 transition-colors group">
<div className="text-[#6b7c62] mx-auto mb-3 flex justify-center">
...
<div className="bg-white p-6 rounded-lg shadow-sm border border-stone-100 text-center fade-in-section hover:border-[#6b7c62]/30 transition-colors group">
<div className="text-[#6b7c62] mx-auto mb-3 flex justify-center">
<iconify-icon height="24" icon="solar:wine-glass-linear" strokeWidth="1.5" width="24"></iconify-icon>
</div>
...
<a className="text-stone-400 hover:text-[#6b7c62] transition-colors flex items-center" href="#">
<iconify-icon height="18" icon="ri:instagram-line" width="18"></iconify-icon>
</a>
<a className="text-stone-400 hover:text-[#6b7c62] transition-colors flex items-center" href="#">

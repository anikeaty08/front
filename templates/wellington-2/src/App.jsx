  ...
  (function(d, t) {
      ...
      v.onload = function() {
        window.voiceflow.chat.load({
          verify: { projectID: '6921afbbd60769c74113a0fc' },
...
<div className="">
<h2 className="lg:text-5xl leading-tight text-4xl font-medium text-[#18181B] tracking-tight mb-6">Sound like a native, communicate like a leader</h2>
<p className="leading-relaxed text-xl font-light text-[#52525B] mb-8">
          Talk&amp;Flow combines rigorous speech analysis with career-focused scenarios. Our immersive voice AI transforms your spoken English, neutralizing accents and boosting confidence in just 15 minutes a day.
        </p>
</div>
</div>
...
<div className="mt-6 md:mt-0 max-w-xs text-[#A1A1AA] text-lg font-light">
                        Our engine analyzes tone, pace, and grammar in real-time. Practice in a safe environment before the big meeting.
...
<svg aria-hidden="true" className="iconify text-2xl transform transition-transform duration-300 iconify--solar" data-icon="solar:add-circle-bold-duotone" height="1em" id="icon-0" role="img" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><path className="" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10" fill="currentColor" opacity=".5"></path><path className="" d="M12.75 9a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V15a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25z" fill="currentColor"></path></svg>
</div>
</div>
...
<p className="text-[#A1A1AA] max-w-2xl text-lg font-light pt-4">
                                    Our AI listens to phonemes and stress patterns, providing instant visual cues to help you correct mispronunciations before they become habits.
                                </p>
</div>
</div>
</div>
...
<p className="text-[#A1A1AA] max-w-2xl text-lg font-light pt-4">
                                    Stop translating in your head. The engine suggests more natural, business-appropriate phrasing for emails, pitches, and negotiations as you speak.
                                </p>
</div>
</div>
</div>
...
<p className="text-[#A1A1AA] max-w-2xl text-lg font-light pt-4">
                                    Practice salary negotiations, daily standups, or client calls. The AI persona adapts its difficulty and tone based on your performance.
                                </p>
</div>
</div>
</div>
...
<p className="text-[#A1A1AA] max-w-2xl text-lg font-light pt-4">
                                    Experience zero-lag interaction. Our edge computing network ensures the conversation feels as natural as speaking to a human in the same room.
                                </p>
</div>
</div>
</div>
...
<div id="voiceflow-chat"></div><div id="voiceflow-chat"></div>
    </>
  );
}

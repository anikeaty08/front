...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '188px', -MouseY: '38.9453125px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '188px', -MouseY: '12.9453125px'}}>
...
<div className="glass-panel flex hover:grayscale-0 transition-all duration-500 spotlight-card bg-neutral-50 w-48 h-24 rounded-2xl grayscale items-center justify-center" onmousemove="handleSpotlight(event)" style={{-MouseX: '56px', -MouseY: '-0.0546875px'}}>
...
<div className="carousel-card active lg:w-3/4 glass-panel spotlight-card cursor-pointer w-full h-full rounded-3xl pt-2 pr-2 pb-2 pl-2" id="card-0" onmousemove="handleSpotlight(event)" style={{-MouseX: '443px', -MouseY: '3.6953125px'}}>
...
<div className="carousel-card prev w-full lg:w-3/4 h-full glass-panel rounded-3xl p-2 spotlight-card cursor-pointer" id="card-2" onmousemove="handleSpotlight(event)" style={{-MouseX: '741.0642700195312px', -MouseY: '206.18917846679688px'}}>
<div className="w-full h-full bg-neutral-50 rounded-2xl overflow-hidden relative group">
<div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">

...
<div className="md:col-span-2 spotlight-card rounded-xl p-8 group transition-all duration-300 reveal h-[300px] flex flex-col justify-between" style={{-MouseX: '0px', -MouseY: '0px'}}>

...
<div className="hidden md:flex items-center bg-white/5 rounded px-3 py-1.5 border border-white/5 mr-2">
<span className="iconify text-neutral-500" data-icon="lucide:search" data-width="14" style={{strokeWidth: '1.5'}}></span>
<input className="bg-transparent border-none text-xs text-white placeholder-neutral-500 focus:outline-none ml-2 w-48" placeholder="Search parts..." type="text"/>
<span className="text-[10px] text-neutral-600 border border-white/10 rounded px-1.5 ml-4">⌘K</span>
</div>
...
<a className="nav-tab active h-10 flex items-center px-1 text-xs font-medium text-neutral-400 hover:text-white transition-colors border-b border-transparent" href="#">
                    Overview
                </a>
<span className="w-px h-3 bg-white/10 mx-2"></span>
<a className="nav-tab h-10 flex items-center gap-2 px-1 text-xs font-medium text-neutral-400 hover:text-white transition-colors border-b border-transparent group" href="#">
<span className="iconify text-neutral-600 group-hover:text-white transition-colors" data-icon="lucide:circuit-board" data-width="14"></span>
                    Components
                </a>
<a className="nav-tab h-10 flex items-center gap-2 px-1 text-xs font-medium text-neutral-400 hover:text-white transition-colors border-b border-transparent group" href="#">
<span className="iconify text-neutral-600 group-hover:text-white transition-colors" data-icon="lucide:monitor" data-width="14"></span>
                    Pre-Built
                </a>
<a className="nav-tab h-10 flex items-center gap-2 px-1 text-xs font-medium text-neutral-400 hover:text-white transition-colors border-b border-transparent group" href="#">
<span className="iconify text-neutral-600 group-hover:text-white transition-colors" data-icon="lucide:laptop" data-width="14"></span>
                    Laptops
                </a>
<a className="nav-tab h-10 flex items-center gap-2 px-1 text-xs font-medium text-neutral-400 hover:text-white transition-colors border-b border-transparent group" href="#">
<span className="iconify text-neutral-600 group-hover:text-white transition-colors" data-icon="lucide:headphones" data-width="14"></span>
                    Gear
                </a>
<span className="w-px h-3 bg-white/10 mx-2"></span>
<a className="nav-tab h-10 flex items-center gap-2 px-1 text-xs font-medium text-indigo-400 hover:text-indigo-300 transition-colors border-b border-transparent" href="#">
...
<section className="py-24 px-6 border-t border-white/5 bg-neutral-900/30" id="builder">
<div className="max-w-4xl mx-auto">
<h2 className="text-2xl text-white font-medium tracking-tight mb-8 text-center">Interactive Builder</h2>
<div className="glass-card rounded-xl overflow-hidden shadow-2xl shadow-black/50">

<div className="flex border-b border-white/5 bg-white/[0.02]">
<button className="flex-1 py-4 text-xs sm:text-sm font-medium text-neutral-500 hover:text-white transition-colors border-r border-white/5 flex items-center justify-center gap-2">
<span className="iconify" data-icon="lucide:wand-2" data-width="14"></span>
                        Quick Wizard
                    </button>
<button className="flex-1 py-4 text-xs sm:text-sm font-medium text-white bg-white/5 shadow-[inset_0_-2px_0_0_#6366f1] flex items-center justify-center gap-2">
...
<button className="w-full flex items-center justify-between p-3 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-white text-sm font-medium transition-all">
<span className="flex items-center gap-3">
<span className="iconify text-indigo-400" data-icon="lucide:cpu" data-width="18"></span> Processor
                                </span>
<span className="iconify text-indigo-400" data-icon="lucide:chevron-right" data-width="16"></span>
</button>
<button className="w-full flex items-center justify-between p-3 rounded-lg border border-transparent hover:bg-white/5 text-neutral-500 hover:text-neutral-300 text-sm transition-colors">
<span className="flex items-center gap-3">
<span className="iconify" data-icon="lucide:fan" data-width="18"></span> Cooling
                                </span>
</button>
<button className="w-full flex items-center justify-between p-3 rounded-lg border border-transparent hover:bg-white/5 text-neutral-500 hover:text-neutral-300 text-sm transition-colors">
<span className="flex items-center gap-3">
<span className="iconify" data-icon="lucide:monitor-smartphone" data-width="18"></span> Graphics
                                </span>
</button>
<button className="w-full flex items-center justify-between p-3 rounded-lg border border-transparent hover:bg-white/5 text-neutral-500 hover:text-neutral-300 text-sm transition-colors">
<span className="flex items-center gap-3">
<span className="iconify" data-icon="lucide:hard-drive" data-width="18"></span> Storage
                                </span>
</button>
</div>
...
<h3 className="text-white font-medium text-sm tracking-wide">SELECT PROCESSOR</h3>
<a className="text-xs text-indigo-400 hover:text-indigo-300 flex items-center gap-1 transition-colors" href="#">
                                    Compare Specs <span className="iconify" data-icon="lucide:external-link" data-width="12"></span>
</a>
</div>
<div className="space-y-4">

<label className="group relative block cursor-pointer">
<input checked="" className="peer sr-only" name="cpu_select" type="radio"/>
<div className="flex items-center gap-4 p-4 rounded-lg border border-neutral-800 bg-neutral-900/40 hover:bg-neutral-800/80 transition-all peer-checked:border-indigo-500/40 peer-checked:bg-indigo-500/5 peer-checked:shadow-[0_0_20px_-10px_rgba(99,102,241,0.3)]">
<div className="h-12 w-12 rounded bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
<span className="iconify text-white" data-icon="simple-icons:intel" data-width="24"></span>
</div>
<div className="flex-1">
<div className="flex justify-between items-center mb-1">
<span className="text-sm font-medium text-white group-hover:text-indigo-200 transition-colors">Intel Core i9-13900K</span>
<span className="text-sm font-semibold text-white tracking-tight">$589.00</span>
</div>
<div className="text-xs text-neutral-500 flex items-center gap-2">
<span className="bg-white/10 px-1.5 py-0.5 rounded text-[10px] text-neutral-300">24 Cores</span>
<span>3.0 GHz base, 5.8 GHz turbo</span>
</div>
</div>
<div className="w-5 h-5 rounded-full border border-neutral-600 peer-checked:bg-indigo-500 peer-checked:border-indigo-500 flex items-center justify-center shrink-0 transition-colors">
<span className="iconify text-white opacity-0 peer-checked:opacity-100" data-icon="lucide:check" data-width="12" style={{strokeWidth: '3'}}></span>
</div>
</div>
</label>

<label className="group relative block cursor-pointer">
<input className="peer sr-only" name="cpu_select" type="radio"/>
<div className="flex items-center gap-4 p-4 rounded-lg border border-neutral-800 bg-neutral-900/40 hover:bg-neutral-800/80 transition-all peer-checked:border-indigo-500/40 peer-checked:bg-indigo-500/5">
<div className="h-12 w-12 rounded bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
<span className="iconify text-white" data-icon="simple-icons:amd" data-width="24"></span>
</div>
<div className="flex-1">
<div className="flex justify-between items-center mb-1">
<span className="text-sm font-medium text-white group-hover:text-indigo-200 transition-colors">AMD Ryzen 9 7950X</span>
<span className="text-sm font-semibold text-white tracking-tight">$569.00</span>
</div>
<div className="text-xs text-neutral-500 flex items-center gap-2">
<span className="bg-white/10 px-1.5 py-0.5 rounded text-[10px] text-neutral-300">16 Cores</span>
<span>4.5 GHz base, 5.7 GHz turbo</span>
</div>
</div>
<div className="w-5 h-5 rounded-full border border-neutral-600 peer-checked:bg-indigo-500 peer-checked:border-indigo-500 flex items-center justify-center shrink-0 transition-colors">
<span className="iconify text-white opacity-0 peer-checked:opacity-100" data-icon="lucide:check" data-width="12" style={{strokeWidth: '3'}}></span>
...
<div className="flex-1">
<div className="flex justify-between items-center mb-1">
<span className="text-sm font-medium text-white group-hover:text-indigo-200 transition-colors">Intel Core i7-13700K</span>
<span className="text-sm font-semibold text-white tracking-tight">$419.00</span>
</div>
<div className="text-xs text-neutral-500 flex items-center gap-2">
<span className="bg-white/10 px-1.5 py-0.5 rounded text-[10px] text-neutral-300">16 Cores</span>
<span>3.4 GHz base, 5.4 GHz turbo</span>
</div>
</div>
<div className="w-5 h-5 rounded-full border border-neutral-600 peer-checked:bg-indigo-500 peer-checked:border-indigo-500 flex items-center justify-center shrink-0 transition-colors">
<span className="iconify text-white opacity-0 peer-checked:opacity-100" data-icon="lucide:check" data-width="12" style={{strokeWidth: '3'}}></span>
...
<span className="block text-[10px] uppercase tracking-wider text-neutral-500 font-medium">Estimated Total</span>
<span className="block text-xl font-semibold text-white tracking-tight">$3,429.00</span>
</div>
</div>
<div className="flex gap-3 w-full sm:w-auto">
<button className="flex-1 sm:flex-none px-4 py-2.5 rounded border border-white/10 text-neutral-300 text-xs font-medium hover:bg-white/5 hover:text-white transition-colors">
                                Save Config
                            </button>
<button className="flex-1 sm:flex-none px-6 py-2.5 rounded bg-white text-black text-xs font-semibold hover:bg-neutral-200 transition-colors flex items-center justify-center gap-2">
                                Review Build

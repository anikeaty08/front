...
<span className="text-sm font-medium tracking-tight">Youth Foundry</span>
</a>
...
<a className="transition-colors hover:text-white" href="#roles">Network</a>
<a className="transition-colors hover:text-white" href="#process">Process</a>
</div>
<div className="flex items-center gap-4">
<a className="hidden md:block text-sm font-light text-zinc-400 hover:text-white transition-colors" href="#">Sign in</a>
...
<span className="text-xs font-light tracking-wide text-zinc-300">Accepting new applications</span>
</div>
<h1 className="text-5xl md:text-6xl lg:text-7xl font-medium tracking-tighter leading-[1.05] mb-6 gradient-text">
                Meet the People You Need to Build Your Startup.
            </h1>
<p className="text-lg md:text-xl font-light text-zinc-400 leading-relaxed mb-10 max-w-lg">
                Youth Foundry connects startup founders, operators, investors, and early team members who want to work together on new companies.
            </p>
...
<p className="text-xs font-light tracking-wider uppercase text-zinc-400">Scroll to assemble network</p>
...
<p className="text-base font-light text-zinc-500 leading-relaxed">
                    Instead of large, noisy networking groups, we facilitate targeted introductions helping founders meet the exact co-founders, operators, investors, and early hires they need.
                </p>
</div>
</section>

<section className="py-32 md:w-1/2 md:pr-12" id="roles">
<h2 className="text-3xl md:text-4xl font-medium tracking-tight mb-4">Who it's for.</h2>
...
<h2 className="text-3xl md:text-4xl font-medium tracking-tight mb-12">How it works.</h2>
...
<h3 className="text-lg font-medium tracking-tight text-white mb-2">Apply to Join</h3>
<p className="text-sm font-light text-zinc-400 leading-relaxed">
                        Tell us about your startup, your background, or the specific role you're looking for. We review applications weekly.
                    </p>
</div>
<div className="relative pl-8 md:pl-10">
...
<h3 className="text-lg font-medium tracking-tight text-white mb-2">Get Access</h3>
<p className="text-sm font-light text-zinc-400 leading-relaxed">
                        Approved members get immediate access to the Youth Foundry private network and directory of vetted builders.
                    </p>
</div>
<div className="relative pl-8 md:pl-10">
...
<h3 className="text-lg font-medium tracking-tight text-white mb-2">Start Building</h3>
<p className="text-sm font-light text-zinc-400 leading-relaxed">
                        Meet co-founders, hire early team members, secure operators, or find angel investors to accelerate your timeline.
                    </p>
...
<span className="text-xs font-medium tracking-tight text-zinc-400">Youth Foundry © 2024</span>
</div>

...
<div className="flex bg-gradient-to-br from-black/10 to-black/0 border-white/5 border rounded-none pt-3 pr-4 pb-3 pl-4 backdrop-blur-md [--fx-filter:blur(10px)_liquid-glass(5,10)_saturate(1.25)_noise(0.5,1,0)] items-center justify-between">
...
<a className="group relative flex items-center h-[36px] hover:text-white transition-colors" href="#features">
          Features
...
<a className="group relative flex items-center h-[36px] hover:text-white transition-colors" href="#usecases">
          Use Cases
          <span className="absolute -bottom-[13px] left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_10px_2px_rgba(251,146,60,0.5)]"></span>
</a>
<a className="group relative flex items-center h-[36px] hover:text-white transition-colors" href="#pricing">
          Pricing
          <span className="absolute -bottom-[13px] left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_10px_2px_rgba(251,146,60,0.5)]"></span>
</a>
<a className="group relative flex items-center h-[36px] hover:text-white transition-colors" href="#docs">
          Docs
          <span className="absolute -bottom-[13px] left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_10px_2px_rgba(251,146,60,0.5)]"></span>
</a>
<a className="group relative flex items-center h-[36px] hover:text-white transition-colors" href="#changelog">
          Changelog
          <span className="absolute -bottom-[13px] left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-[0_0_10px_2px_rgba(251,146,60,0.5)]"></span>
</a>
</div>
...
<section className="grid grid-cols-1 gap-10 lg:gap-12 md:py-14 min-h-[500px] lg:min-h-screen pt-10 pb-10 relative items-center" style={{}}>
<div className="z-10 flex-grow flex flex-col md:py-0 pt-14 pb-14 relative justify-center">


<div className="group relative">

<h1 className="text-[13vw] md:text-[11vw] lg:text-[10rem] leading-[0.8] uppercase select-none md:text-left md:mt-6 font-medium text-white tracking-tighter font-oswald text-center mix-blend-normal max-w-4xl mt-4">
...
<p className="text-neutral-400 text-base md:text-lg leading-relaxed max-w-xl animate-on-scroll md:text-left text-center mx-auto md:mx-0" data-animation="up" data-delay="800">
...
<div className="flex flex-col md:flex-row gap-4 md:mx-0 mr-auto ml-auto gap-x-4 gap-y-4 items-center">
...
<div className="hero-perspective -mt-8 group md:px-0 md:pt-20 my-24 pt-20 pr-4 pb-20 pl-4" style={{maskImage: 'linear-gradient(180deg, transparent, black 0%, black 25%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 0%, black 25%, transparent)'}}>
...
<section className="pb-14 gap-x-0 gap-y-0" style={{}}>
...
<section className="shadow-black/30 bg-gradient-to-br from-black/10 to-black/0 border-[#ffffff]/5 border rounded-none pt-0 pr-8 pb-0 pl-8 shadow-2xl backdrop-blur-sm">
...
<svg className="w-full h-full" fill="none" viewbox="0 0 200 120">

<path d="M40 30 L100 40" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M40 30 L100 80" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M40 60 L100 40" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M40 60 L100 80" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M40 90 L100 40" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M40 90 L100 80" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M100 40 L160 60" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>
<path d="M100 80 L160 60" stroke="rgba(255,255,255,0.1)" strokeWidth="1"></path>

<circle cx="40" cy="30" fill="#6366f1" fillOpacity="0.8" r="4"></circle>
<circle cx="40" cy="60" fill="#6366f1" fillOpacity="0.8" r="4"></circle>
<circle cx="40" cy="90" fill="#6366f1" fillOpacity="0.8" r="4"></circle>

<circle cx="100" cy="40" fill="#a855f7" r="5"></circle>
<circle className="" cx="100" cy="80" fill="#a855f7" r="5"></circle>

<circle className="animate-pulse" cx="160" cy="60" fill="#10b981" r="6"></circle>
</svg>

<div className="absolute top-2 left-0 text-[10px] font-mono uppercase tracking-wider text-orange-400/60" style={{}}>
                Input
              </div>
<div className="absolute bottom-2 right-0 text-[10px] font-mono uppercase tracking-wider text-yellow-400/60">
                Output
              </div>
</div>
</div>
...
<p className="text-sm text-white/50 font-light leading-relaxed">
              Deploy custom predictive models trained on your specific business data patterns.
            </p>
</div>
</div>
...
<div className="flex items-center justify-between p-2.5 rounded-md border border-red-500/20 bg-red-500/5 transform group-hover:scale-105 transition-transform duration-300">
<div className="flex items-center gap-3">
<div className="h-6 w-6 rounded-full bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center text-[10px] font-bold text-white ring-1 ring-white/20" style={{}}>
                    JP
                  </div>
<span className="text-xs font-medium text-white/90">j.parker@co.com</span>
</div>
<div className="flex items-center gap-2">
<div className="h-1.5 w-1.5 rounded-full bg-red-500 animate-pulse"></div>
<span className="text-xs font-mono font-semibold text-red-400">98.2</span>
</div>
</div>

<div className="flex items-center justify-between p-2.5 rounded-md border border-white/5 bg-white/5 opacity-60">
<div className="flex items-center gap-3">
<div className="h-6 w-6 rounded-full bg-zinc-700 flex items-center justify-center text-[10px] font-bold text-white ring-1 ring-white/10">
                    AL
                  </div>
<span className="text-xs font-medium text-white/90">a.lee@inc.io</span>
</div>
<span className="text-xs font-mono font-semibold text-yellow-400">45.0</span>
</div>

<div className="flex items-center justify-between p-2.5 rounded-md border border-white/5 bg-white/5 opacity-40">
<div className="flex items-center gap-3">
<div className="h-6 w-6 rounded-full bg-zinc-700 flex items-center justify-center text-[10px] font-bold text-white ring-1 ring-white/10">
                    MS
                  </div>
<span className="text-xs font-medium text-white/90">m.scott@paper.com</span>
</div>
<span className="text-xs font-mono font-semibold text-yellow-400">12.4</span>
</div>
</div>
</div>
<div className="relative z-10">
...
<p className="text-sm text-white/50 font-light leading-relaxed">
              Instant risk scoring for every user and account, updated in real-time.
            </p>
</div>
</div>
...
<path className="" d="M0 100 L20 80 L40 85 L60 50 L80 40 L100 20" fill="none" stroke="#a855f7" strokeWidth="2" vector-effect="non-scaling-stroke"></path>

<path d="M100 20 L120 15 L140 10" fill="none" opacity="0.6" stroke="#a855f7" stroke-dasharray="4 4" strokeWidth="2" vector-effect="non-scaling-stroke"></path>
...
<p className="text-sm text-white/50 font-light leading-relaxed">
              Forecast user retention cohorts with high accuracy using historical patterns.
            </p>
</div>
</div>
...
<svg className="lucide lucide-workflow text-white" fill="none" height="32" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
<rect height="8" rx="2" width="8" x="3" y="3"></rect>
<rect height="8" rx="2" width="8" x="13" y="13"></rect>
<path d="m8 11 3 3"></path>
...
<div className="w-24 p-2.5 rounded-md bg-zinc-800 border border-white/10 shadow-lg flex flex-col items-center gap-2 z-10 group-hover:-translate-y-1 transition-transform duration-500">
<div className="flex items-center gap-2 w-full mb-1">
<div className="h-2 w-2 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.5)] bg-orange-400" style={{}}></div>
<div className="h-1 w-10 bg-white/30 rounded-full"></div>
</div>
<div className="space-y-1 w-full opacity-50">
<div className="h-1 w-full bg-white/20 rounded-full"></div>
<div className="h-1 w-2/3 bg-white/20 rounded-full"></div>
</div>
</div>

<div className="h-px w-12 bg-gradient-to-r from-orange-400/30 to-yellow-400/30" style={{}}></div>

<div className="w-24 p-2.5 rounded-md bg-zinc-800 border border-white/10 shadow-lg flex flex-col items-center gap-2 z-10 group-hover:-translate-y-1 transition-transform duration-500 delay-75">
<div className="flex items-center gap-2 w-full mb-1">
<div className="h-2 w-2 rounded-full shadow-[0_0_8px_rgba(192,132,252,0.5)] bg-yellow-400" style={{}}></div>
...
<div className="h-px w-12 bg-gradient-to-r to-yellow-400/30 from-yellow-400/30" style={{}}></div>

<div className="w-24 p-2.5 rounded-md bg-zinc-800 border border-white/10 shadow-lg flex flex-col items-center gap-2 z-10 group-hover:-translate-y-1 transition-transform duration-500 delay-150">
<div className="flex items-center gap-2 w-full mb-1">
<div className="h-2 w-2 rounded-full shadow-[0_0_8px_rgba(52,211,153,0.5)] bg-yellow-400"></div>
...
<div className="absolute top-[50%] left-[28%] w-1.5 h-1.5 rounded-full animate-ping opacity-20 bg-orange-400" style={{}}>
</div>
<div className="absolute top-[50%] right-[28%] w-1.5 h-1.5 rounded-full animate-ping opacity-20 delay-500 bg-yellow-400">
</div>
</div>
</div>
</div>
...
<p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
              Drag-and-drop editor to build and customize your AI data pipelines without writing code.
            </p>
</div>
</div>
...
<div className="absolute top-0 right-0 p-8 opacity-20 group-hover:opacity-40 transition-opacity z-10">
<svg className="lucide lucide-zap text-white" fill="none" height="32" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewbox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center gap-3 p-3 rounded-md border shadow-sm backdrop-blur-sm bg-orange-500/10 border-orange-500/20" style={{}}>
<div className="flex h-8 w-8 items-center justify-center rounded-full shrink-0 bg-orange-500/20 text-orange-400" style={{}}>
...
<div className="flex-1">
<div className="text-xs font-medium text-orange-200" style={{}}>Scale Up Cluster</div>
<div className="text-[10px] font-mono mt-0.5 text-orange-200/60" style={{}}>Executed 2m ago • Policy #842</div>
</div>
<div className="h-1.5 w-1.5 rounded-full bg-orange-500" style={{}}></div>
</div>
<div className="flex items-center gap-3 p-3 rounded-md bg-white/5 border border-white/5 opacity-60">
<div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white/60 shrink-0">
<svg className="lucide lucide-clock" fill="none" height="16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10"></circle>
<polyline points="12 6 12 12 16 14"></polyline>
</svg>
</div>
<div className="">
<div className="text-xs font-medium text-white/80">Clear Redis Cache</div>
<div className="text-[10px] text-white/40 font-mono mt-0.5">Scheduled in 5m</div>
</div>
</div>
</div>
</div>
...
<p className="text-sm text-white/50 font-light leading-relaxed max-w-md">
              Trigger preventative workflows and route alerts to the right engineers before incidents escalate.
            </p>
</div>
</div>
</div>
...
<div className="shadow-black/30 bg-gradient-to-br from-black/10 to-black/0 border-white/5 border mt-12 mb-20 pt-12 pr-8 pb-12 pl-8 shadow-2xl backdrop-blur-sm">
...
<div className="shadow-black/30 bg-gradient-to-br from-black/10 to-black/0 border-white/5 border mt-12 mb-20 pt-12 pr-8 pl-8 shadow-2xl backdrop-blur-sm">

<div className="w-full mb-24">

<div className="max-w-4xl">
<h2 className="lg:text-8xl text-4xl font-normal text-white tracking-tight mb-6 scroll-animate" data-delay="0s" style={{animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) both'}}>
...
<div className="max-w-4xl">
<p className="text-lg text-white/60 font-light leading-relaxed scroll-animate" data-delay="0.1s">
...
<section className="overflow-hidden py-24 relative scroll-animate" data-delay="0.3s">
<style className="">
...
<p className="text-xs font-semibold tracking-[0.2em] text-zinc-500 uppercase mb-6">Testimonials</p>
<h2 className="text-4xl md:text-6xl font-medium tracking-tight text-white leading-[1.1] max-w-4xl">
...
<img alt="Patrick Nawrocki" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5045c0e4-a0e6-44f5-9ce2-f0aeec2f9b70_320w.webp"/>
...
<img alt="Patrick Nawrocki" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/5045c0e4-a0e6-44f5-9ce2-f0aeec2f9b70_320w.webp"/>
</div>
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Pri Patel" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/96e3ccfa-3799-4c9c-9f2a-263c0ff6a449_800w.webp"/>
...
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Pri Patel" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/96e3ccfa-3799-4c9c-9f2a-263c0ff6a449_320w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
...
<div className="shrink-0 md:w-[380px] group overflow-hidden cursor-pointer bg-zinc-900 w-[340px] h-[520px] border-white/5 border rounded-none relative" onmousemove="const rect=this.getBoundingClientRect();this.style.setProperty('--mouse-x',(event.clientX-rect.left)+'px');this.style.setProperty('--mouse-y',(event.clientY-rect.top)+'px');">
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Rob West" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/90c82ac7-8c89-497c-8962-bdd860119762_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0">
</div>
<div className="flex flex-col pt-10 pr-10 pb-10 pl-10 absolute top-0 right-0 bottom-0 left-0 justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Rob West" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/90c82ac7-8c89-497c-8962-bdd860119762_800w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Dom Tyler" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e0c64293-e54b-4d62-9151-31a66e06c56f_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0"></div>
<div className="flex flex-col pt-10 pr-10 pb-10 pl-10 absolute top-0 right-0 bottom-0 left-0 justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Dom Tyler" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/e0c64293-e54b-4d62-9151-31a66e06c56f_320w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Patrick Nawrocki" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d5b68ad-9d29-4f08-b56e-16cc0770d7a1_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0"></div>
<div className="absolute inset-0 p-10 flex flex-col justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Patrick Nawrocki" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/4d5b68ad-9d29-4f08-b56e-16cc0770d7a1_320w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Pri Patel" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a509702a-3896-475f-8097-e800010621c8_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0"></div>
<div className="absolute inset-0 p-10 flex flex-col justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Pri Patel" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/a509702a-3896-475f-8097-e800010621c8_320w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
            "YUNA has completely transformed our workflow. The predictive insights are spot-on and have saved us countless hours of manual analysis and guesswork."
          </p>
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Rob West" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/44ca2ca4-af8d-40c2-812d-9fc7ae6e9779_800w.webp"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0"></div>
<div className="absolute inset-0 p-10 flex flex-col justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Rob West" className="w-full h-full object-cover" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/44ca2ca4-af8d-40c2-812d-9fc7ae6e9779_320w.webp"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
...
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.06), transparent 40%)', zIndex: '10'}}></div>
<div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{background: 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(255, 255, 255, 0.4), transparent 40%)', zIndex: '10', padding: '1px', mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)', maskComposite: 'exclude'}}></div>
<img alt="Dom Tyler" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 z-0" src="https://images.unsplash.com/photo-1724525647065-f948fc102e68?w=2160&amp;q=80"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-all duration-500 group-hover:bg-black/80 z-0"></div>
<div className="absolute inset-0 p-10 flex flex-col justify-between z-20">
<div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-75">
<div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 mb-6 backdrop-blur-md">
<img alt="Dom Tyler" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=150&amp;h=150&amp;fit=crop&amp;crop=faces"/>
</div>
<p className="text-[17px] leading-relaxed text-zinc-100 font-light drop-shadow-md">
            "The lovely team at DesignMe provided our startup with significant leverage. Their work is exceptionally professional, and they always take the time to understand us."
          </p>

...
<h1 className="text-white text-lg font-medium">Add City</h1>
</div>
...
<input className="bg-[#1a1a1a] text-gray-200 text-sm rounded-lg block w-full pl-10 p-3 border border-[#232323] focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for a city..." type="text"/>
</div>

<div className="mb-6">
<button className="w-full flex items-center justify-between p-4 bg-[#151515] rounded-xl border border-[#232323] hover:bg-[#1a1a1a]">
...
<div className="mb-6">
<h2 className="text-gray-400 text-xs mb-3 px-1">RECENT SEARCHES</h2>
<div className="space-y-2">
<div className="flex items-center justify-between p-3 bg-[#151515] rounded-lg border border-[#232323]">
<div className="flex items-center">
<span className="text-white text-sm">New York, US</span>
</div>
<div className="flex items-center text-xs text-gray-500">
<span>73°F</span>
<svg className="w-4 h-4 ml-2 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center justify-between p-3 bg-[#151515] rounded-lg border border-[#232323]">
<div className="flex items-center">
<span className="text-white text-sm">London, UK</span>
</div>
<div className="flex items-center text-xs text-gray-500">
<span>59°F</span>
<svg className="w-4 h-4 ml-2 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div>
<h2 className="text-gray-400 text-xs mb-3 px-1">POPULAR CITIES</h2>
<div className="space-y-2">
<div className="flex items-center justify-between p-3 bg-[#151515] rounded-lg border border-[#232323]">
<div className="flex items-center">
<span className="text-white text-sm">Tokyo, Japan</span>
</div>
<div className="flex items-center text-xs text-gray-500">
<span>68°F</span>
<svg className="w-4 h-4 ml-2 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center justify-between p-3 bg-[#151515] rounded-lg border border-[#232323]">
<div className="flex items-center">
<span className="text-white text-sm">Paris, France</span>
</div>
<div className="flex items-center text-xs text-gray-500">
<span>62°F</span>
<svg className="w-4 h-4 ml-2 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="flex items-center justify-between p-3 bg-[#151515] rounded-lg border border-[#232323]">
<div className="flex items-center">
<span className="text-white text-sm">Sydney, Australia</span>
</div>
<div className="flex items-center text-xs text-gray-500">
<span>75°F</span>
<svg className="w-4 h-4 ml-2 text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

...
<span className="text-[11px] uppercase font-medium text-neutral-300 tracking-wide font-geist">Zarządzanie Ryzykiem 2025</span>
</div>
...
<p className="reveal active md:text-xl leading-relaxed text-lg font-light text-neutral-400 tracking-tight font-geist max-w-xl mr-auto mb-10 ml-auto">Era Deepfake nadeszła. To co widzisz, może być kłamstwem. <span className="font-medium text-white">Kliknij materiały poniżej, aby je zweryfikować.</span></p>
...
<span className="flex items-center gap-2 relative">Przekonaj się</span>
</button>
</div>
</div>
</header>
...
<div className="reveal glass-panel relative rounded-2xl overflow-hidden aspect-video max-w-5xl mx-auto active group cursor-pointer hover:border-white/30 transition-all" onclick="openImageLightbox('https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/bbb8a1d6-7426-4d5a-a4bd-3130504c54d1_800w.png')">
<img alt="Hacker Backstage View" className="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/af33fefa-7c90-41e3-aa7f-267e378c3410_3840w.png" style={{}}/>
...
<span className="w-1.5 h-1.5 bg-[#980003] rounded-full animate-pulse"></span>
                            Live System Monitor
                        </div>
<h4 className="text-xl font-bold text-white mb-2 font-geist">Proces Generowania</h4>
</div>
...
<p className="text-xs text-neutral-500 font-geist leading-relaxed -multi">Algorytm podmienia twarz aktora na twarz
          osoby znanej. Mimika jest synchronizowana w czasie rzeczywistym.</p>
</div>
...
<div className="max-w-3xl space-y-4 reveal active">
<h2 className="uppercase text-base font-medium text-[#980003] tracking-widest font-geist">Backstage</h2>
<h3 className="text-3xl md:text-4xl tracking-tight text-white font-jakarta font-medium">Mapowanie Twarzy</h3>
...
<img alt="Face Swap Tech" className="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-700" src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/9d054da1-fe0e-4baf-9a10-d63efbfa9e9c_1600w.png"/>
<div className="absolute bottom-0 left-0 w-full p-8 md:p-10 z-20 pointer-events-none flex justify-between items-end">
<div className="max-w-xl">
<h4 className="text-xl font-bold text-white mb-2 font-geist">Real-time Face Swap</h4>
<p className="leading-relaxed text-xs text-neutral-400 font-geist">Widok oprogramowania nakładającego maskę w czasie rzeczywistym.</p>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3 font-jakarta">Zasada ograniczonego zaufania</h4>
<p className="text-sm text-neutral-400 leading-relaxed font-geist">Jeśli oferta brzmi zbyt dobrze, by była prawdziwa – to kłamstwo. Deepfake jest narzędziem, ale mechanizm socjotechniki jest stary.</p>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3 font-jakarta">Weryfikacja zwrotna</h4>
<p className="text-sm text-neutral-400 leading-relaxed font-geist">Rozłącz się. Zadzwoń samodzielnie. Sprawdź adres URL strony. Nie klikaj w linki z nieznanych źródeł.</p>
</div>
...
<h4 className="text-xl font-semibold text-white mb-3 font-jakarta">Chroń swoje dane</h4>
<p className="text-sm text-neutral-400 leading-relaxed font-geist">Twoje zdjęcia i głos w internecie to paliwo dla AI. Ustaw profile na prywatne, nie udostępniaj próbek głosu.</p>
</div>
</div>
</div>
</section>

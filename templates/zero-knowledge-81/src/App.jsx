...
<div className="flex group-hover:border-accent/50 transition-colors overflow-hidden bg-center bg-white w-10 h-10 bg-[url(https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/31bcd8b2-21f4-4ed4-a1ed-aa79969ba1df_320w.png)] bg-cover border-white/10 border rounded-lg pt-0.5 pr-0.5 pb-0.5 pl-0.5 shadow-[0_0_20px_-10px_rgba(20,241,149,0.5)] items-center justify-center"></div>
...
<a className="text-secondary hover:text-white hover:bg-white/5 transition-all text-xs font-medium rounded-full pt-1.5 pr-4 pb-1.5 pl-4" href="#features" style={{}}>Protocol</a>
<a className="text-secondary hover:text-white hover:bg-white/5 transition-all text-xs font-medium rounded-full pt-1.5 pr-4 pb-1.5 pl-4" href="#how" style={{}}>How it works</a>
<a className="text-secondary hover:text-white hover:bg-white/5 transition-all text-xs font-medium rounded-full pt-1.5 pr-4 pb-1.5 pl-4" href="#security">App</a>
</div>
...
<div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in delay-200 px-6 mb-24" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0.9953', transform: 'translate(0px, 0.0953px)'}}>
<button className="hover:bg-gray-100 transition-all sm:w-auto flex gap-2 text-sm font-bold text-black bg-white w-full h-12 rounded-lg pr-8 pl-8 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] gap-x-2 gap-y-2 items-center justify-center" style={{}}>Coming soon<span className="iconify" data-icon="logos:solana" data-width="16"></span></button>
<button className="text-secondary hover:text-white hover:bg-white/10 hover:border-white/20 transition-all sm:w-auto flex text-sm font-medium bg-white/5 w-full h-12 border-white/10 border rounded-lg pr-8 pl-8 backdrop-blur-sm gap-x-2 gap-y-2 items-center justify-center" onclick="window.location.href='/home'" role="button">
<svg aria-hidden="true" className="" data-icon="lucide:terminal" height="16" role="img" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M12 19h8M4 17l6-6l-6-6" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                    Read Docs
                </button>
</div>

<div className="max-w-4xl mx-auto px-4 animate-fade-in delay-300" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0.9731', transform: 'translate(0px, 0.5399px)'}}>
...
<div className="w-full border-y border-white/5 bg-black/20 backdrop-blur-sm mb-32 animate-fade-in delay-300" style={{translate: 'none', rotate: 'none', scale: 'none', opacity: '0.912', transform: 'translate(0px, 1.7608px)'}}>
...
<li className=""><a className="hover:text-white transition-colors" href="#">App</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Statistics</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Compliance</a></li>
</ul>
</div>
<div className="">
...
<li className=""><a className="hover:text-white transition-colors" href="#">Audits</a></li>
</ul>
</div>
<div className="">
<h5 className="text-sm font-medium text-white mb-4" style={{}}>Socials (coming soon)</h5>
<ul className="space-y-2 text-xs text-secondary">
<li className=""><a className="hover:text-white transition-colors" href="#">Twitter (X)</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Discord</a></li>
<li className=""><a className="hover:text-white transition-colors" href="#">Telegram</a></li>
</ul>
</div>
</div>

...
<div className="border-x max-w-7xl mr-auto ml-auto border-white/20">
<div className="pt-6">
<div className="flex items-center justify-between px-6 md:px-12 h-14">
<a className="flex items-center gap-2 group" href="#">
<div className="flex items-baseline gap-0 font-geist text-2xl tracking-tighter text-white">
<span className="font-black">L</span>
<span className="font-thin tracking-normal">umen</span>
</div>
</a>
<div className="hidden md:flex items-center gap-8">
<a className="text-sm font-medium text-gray-400 hover:text-white transition-colors font-geist" href="#">
                Product
              </a>
<a className="text-sm font-medium text-gray-400 hover:text-white transition-colors font-geist" href="#">
                Security
...
<a className="hidden sm:inline-flex bg-white/5 hover:bg-white/10 border border-white/10 text-white text-[11px] uppercase font-bold px-5 py-2.5 rounded-none transition-all tracking-[0.1em] font-geist" href="#">
    Log in
  </a>
<a className="hidden sm:inline-flex group uppercase transition-all duration-500 hover:scale-[1.02] active:scale-[0.98] text-[11px] font-black text-white tracking-[0.15em] bg-transparent rounded-none px-7 py-3 relative items-center justify-center overflow-hidden font-geist" href="#">
<span className="transition-shadow duration-500 group-hover:shadow-[0_0_25px_-5px_rgba(34,197,94,0.4)] bg-gradient-to-r from-green-900 via-emerald-500 to-teal-400 p-[1px] absolute inset-0 rounded-none shadow-[0_0_15px_-5px_rgba(21,128,61,0.3)]">
<span className="block bg-black w-full h-full rounded-none"></span>
</span>
...
<div className="w-full h-px mt-6 bg-white/20"></div>
</div>
</nav>

<main className="flex flex-col border-x md:pt-32 md:pb-32 z-10 text-center w-full max-w-7xl pt-16 pr-6 pb-24 pl-6 relative items-center justify-center mx-auto border-white/20" data-section="hero">
...
<section className="flex flex-col border-x w-full max-w-7xl border-white/20 mr-auto ml-auto relative">

<div className="md:pt-10 md:pb-10 md:mt-0 z-10 bg-[#050505]/50 w-full border-t mt-12 pt-8 pb-8 relative border-white/20" data-section="trusted-logos-mid">
<div className="flex flex-wrap md:justify-between gap-8 md:gap-16 opacity-60 hover:opacity-100 transition-opacity duration-500 mix-blend-screen grayscale gap-x-12 gap-y-10 justify-center px-6 md:px-12 max-w-7xl mx-auto">
<svg className="fill-current w-[90px] h-[22px] text-white" height="24" strokeWidth="2" viewbox="0 0 512 166" width="95" xmlns="http://www.w3.org/2000/svg">
<path d="M72.23 37.647c10.01 0 18.124 8.114 18.124 18.123V128H18.123C8.113 128 0 119.886 0 109.877V89.652c0-10.009 8.114-18.123 18.123-18.123h19.524v28.705a5.18 5.18 0 0 0 5.178 5.178h9.881v-40a5.18 5.18 0 0 0-5.178-5.177H1.294V37.647zm85.886 67.765L158.117 0h37.648v128h-72.23c-10.009 0-18.123-8.114-18.123-18.123V55.77c0-10.009 8.114-18.123 18.123-18.123h19.522v62.587a5.18 5.18 0 0 0 5.178 5.178zm105.412 0V37.647h37.649V147.52c0 10.01-8.114 18.123-18.123 18.123h-70.936v-26.348h51.411V128h-34.583c-10.009 0-18.123-8.114-18.123-18.123v-72.23h37.646v62.587a5.18 5.18 0 0 0 5.178 5.178zm124.937-67.765c10.009 0 18.123 8.114 18.123 18.123v20.225c0 10.01-8.114 18.123-18.123 18.123H368.94V65.414a5.177 5.177 0 0 0-5.178-5.178h-9.88v39.998a5.18 5.18 0 0 0 5.178 5.178h46.233V128h-70.935c-10.009 0-18.123-8.114-18.123-18.123v-72.23zm105.412 0c10.01 0 18.123 8.114 18.123 18.123V128h-37.647V65.413c0-2.848-2.33-5.178-5.178-5.178h-9.881V128h-37.648V37.647z"></path>
</svg>
...
<div className="md:px-12 bg-[#050505] border-t pt-24 pr-6 pb-24 pl-6 relative border-white/20">
...
<div className="grid grid-cols-1 md:grid-cols-3 w-full border-white/20 border-t gap-x-5 gap-y-5">
<div className="md:p-12 md:border-b-0 md:border-r border-white/20 flex flex-col gap-5 hover:bg-white/[0.02] transition-colors group border-b p-8 relative">
...
<iconify-icon height="22" icon="solar:shield-keyhole-linear" width="22"></iconify-icon>
</div>
<div className="">
<h3 className="text-lg font-medium text-white font-geist tracking-tight mb-2">
        Zero-Knowledge Architecture
      </h3>
<p className="text-sm text-gray-400 font-geist leading-relaxed">
        Your data is encrypted locally before it ever reaches our
        servers. We never have access to your keys or your passwords.
      </p>
</div>
</div>
...
<div className="w-11 h-11 rounded-lg border border-white/20 bg-white/[0.03] flex items-center justify-center text-white group-hover:bg-white/[0.08] transition-colors shadow-inner shadow-white/5">
<iconify-icon height="22" icon="solar:folder-with-files-linear" width="22"></iconify-icon>
</div>
<div className="">
<h3 className="text-lg font-medium text-white font-geist tracking-tight mb-2">
        Isolated Workspaces
...
<div className="w-11 h-11 rounded-lg border border-white/20 bg-white/[0.03] flex items-center justify-center text-white group-hover:bg-white/[0.08] transition-colors shadow-inner shadow-white/5">
<iconify-icon height="22" icon="solar:history-linear" width="22"></iconify-icon>
</div>
<div className="">
<h3 className="text-lg font-medium text-white font-geist tracking-tight mb-2">
...
<div className="grid grid-cols-1 lg:grid-cols-2 w-full border-t border-white/20" data-section="cli-integration">

<div className="md:p-12 lg:p-16 xl:p-20 lg:border-b-0 lg:border-r flex flex-col border-b pt-8 pr-8 pb-8 pl-8 relative justify-center border-white/20">
<div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-white/10 to-transparent opacity-50"></div>
<a className="inline-flex w-fit items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/[0.02] border border-white/[0.08] text-xs font-medium text-gray-300 mb-8 font-geist hover:bg-white/[0.05] transition-colors" href="#">
...
<div className="p-8 md:p-12 lg:p-16 xl:p-20 flex items-center justify-center relative overflow-hidden group">

<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-emerald-600/15 blur-[100px] rounded-full pointer-events-none group-hover:bg-emerald-600/25 transition-colors duration-700"></div>

<div className="w-full max-w-lg rounded-xl border border-white/10 bg-[#050505]/80 backdrop-blur-md shadow-2xl overflow-hidden relative z-10 transform transition-transform duration-700 group-hover:scale-[1.02]">
...
<div className="p-6 font-mono text-xs md:text-sm text-gray-400 leading-loose whitespace-pre overflow-x-auto">
<span className="text-emerald-400">~/project</span>
              $ lumen env pull --stage
              <span className="text-blue-400">production</span>
<span className="text-green-400">✔</span>
              Authenticated as dev-team-alpha
              <span className="text-green-400">✔</span>
              Decrypted 14 secrets securely
              <span className="text-gray-500">
                Injecting into local environment...
              </span>
<span className="text-emerald-400">~/project</span>
              $ npm run dev
...
<div className="flex flex-col border-t relative border-white/20" data-section="workflow-process">
<div className="md:px-12 bg-[#050505] border-t pt-24 pr-6 pb-24 pl-6 relative border-white/20">
<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
<div className="flex flex-col space-y-10">
<div className="flex items-center gap-4 group">
...
<div className="grid grid-cols-1 md:grid-cols-3 border-white/20 border-t gap-x-6 gap-y-6">
<div className="md:p-12 md:border-b-0 md:border-r border-white/20 flex flex-col gap-6 group hover:bg-white/[0.02] transition-colors text-center border-b p-8 relative items-center">
<div className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest font-geist border border-white/20 px-3 py-1 rounded-full bg-white/[0.03]">
      Step 01
    </div>
<div className="w-12 h-12 rounded-full border border-white/20 bg-[#050505] flex items-center justify-center text-white relative z-10">
...
<p className="text-sm text-gray-400 font-geist leading-relaxed">
        Define clients, projects, and environments. Assign RBAC roles
        strictly to those who need access.
      </p>
</div>
</div>
...
<p className="text-sm text-gray-400 font-geist leading-relaxed">
        Push local variables to your cloud vaults, instantly encrypting
        them with individual public keys.
      </p>
</div>
</div>
...
<p className="text-sm text-gray-400 font-geist leading-relaxed">
        Pull secrets seamlessly into Vercel, AWS, or Docker builds at
        runtime without exposing plain text.
      </p>
</div>
</div>
</div>
</div>
<div className="grid grid-cols-1 lg:grid-cols-2 w-full border-t bg-[#050505] relative border-white/20" data-section="vision-mission">

<div className="flex flex-col justify-between p-8 md:p-12 lg:p-20 border-b lg:border-b-0 lg:border-r min-h-[600px] border-white/20">
<div className="mb-12">
<div className="flex items-center gap-4 group mb-8 border-white/20">
<span className="text-sm text-white/40 tracking-tighter font-mono">
                03
              </span>
<div className="w-px h-4 bg-white/10"></div>
...
<p className="text-base text-gray-400 font-geist leading-relaxed max-w-md font-light">
              ...
              secure development. No black boxes, just pure cryptographic proof
              designed for teams.
            </p>
</div>
<div className="flex flex-col w-full">

<div className="group py-6 border-t border-white/[0.06] flex items-center justify-between cursor-pointer">
<span className="text-lg text-white font-geist font-medium tracking-tight">
                Our Core Mission
              </span>
<iconify-icon className="text-white transition-colors" height="20" icon="lucide:chevron-right" width="20"></iconify-icon>
</div>

<div className="group py-6 border-t border-white/[0.06] flex items-center justify-between cursor-pointer hover:bg-white/[0.02] transition-colors -mx-4 px-4 sm:mx-0 sm:px-0">
<span className="text-lg text-gray-500 group-hover:text-white transition-colors font-geist font-medium tracking-tight">
...
<div className="group py-6 border-t border-b border-white/[0.06] flex items-center justify-between cursor-pointer hover:bg-white/[0.02] transition-colors -mx-4 px-4 sm:mx-0 sm:px-0">
<span className="text-lg text-gray-500 group-hover:text-white transition-colors font-geist font-medium tracking-tight">
                Global Compliance
              </span>
<iconify-icon className="text-gray-600 group-hover:text-white transition-colors" height="20" icon="lucide:chevron-right" width="20"></iconify-icon>
...
<div className="relative flex-grow overflow-hidden w-full h-full min-h-[300px]">
<div className="absolute inset-0 bg-radial-gradient from-white/[0.1] to-transparent z-10 mix-blend-overlay"></div>
<img alt="Abstract Data Structure" className="absolute inset-0 w-full h-full object-cover opacity-80 grayscale mix-blend-screen scale-105 transform transition-transform duration-1000 hover:scale-100" src="https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&amp;w=2532&amp;auto=format&amp;fit=crop"/>

<div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[#050505] to-transparent z-20"></div>
</div>

<div className="relative z-30 bg-[#050505] border-t p-8 md:p-12 lg:p-16 flex flex-col justify-center border-white/20">
<p className="text-lg md:text-xl text-gray-300 font-geist font-light leading-relaxed">
              "We believe that security tools should be open, auditable, and
              designed for the people who actually use them every day. We exist
              to make zero-trust the default standard for development teams
              worldwide."
            </p>
</div>
</div>
...
<div className="overflow-hidden bg-[#050505] border-t mt-0 pt-8 pb-8 relative border-white/20" data-section="marquee-top">
...
<div className="border-white/[0.06] md:px-12 border-x bg-[#050505] w-full border-t pt-24 pr-6 pb-24 pl-6 relative">
<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
<div className="flex flex-col space-y-10">
<div className="flex items-center gap-4 group">
<span className="text-sm text-white/40 tracking-tighter font-mono">
...
<div className="border-t border-white/20 md:px-12 flex flex-col overflow-hidden bg-[#050505] w-full py-24 px-6 relative items-center justify-center" data-section="testimonial-quote">
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-emerald-600/5 blur-[120px] rounded-full pointer-events-none">
</div>
<iconify-icon className="text-white/10 mb-8 relative z-10" height="48" icon="solar:quote-left-linear" width="48"></iconify-icon>
<p className="text-2xl md:text-4xl font-light text-white font-geist tracking-tight text-center max-w-4xl leading-tight mb-10 relative z-10">
...
<img alt="Avatar" className="w-full h-full object-cover grayscale opacity-80" src="https://i.pravatar.cc/100?img=32"/>
</div>
...
<div className="flex flex-col border-white/20 w-full border-t relative" data-section="pricing-plans">
<div className="md:px-12 bg-[#050505] border-white/10 border-b pt-24 pr-6 pb-24 pl-6 relative">
<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
<div className="flex flex-col space-y-10 border-white/10">
<div className="flex items-center gap-4 group">
<span className="text-sm text-white/40 tracking-tighter font-mono">
                  05
                </span>
...
<div className="grid grid-cols-1 lg:grid-cols-3 border-white/20 border-t">

<div className="md:p-12 lg:border-b-0 lg:border-r flex flex-col group overflow-hidden transition-colors hover:bg-white/[0.01] border-white/20 border-b pt-8 pr-8 pb-8 pl-8 relative">
...
<p className="text-sm text-gray-400 font-geist mb-6">
...
<a className="w-full text-center bg-transparent border border-white/20 hover:border-white/40 hover:bg-white/5 text-white text-xs font-bold tracking-widest uppercase py-4 rounded-none transition-all mb-8 font-geist" href="#">
              Get Started
            </a>
...
<span className="">Up to 3 individual projects</span>
</li>
<li className="flex items-start gap-3 text-sm text-gray-300 font-geist">
<iconify-icon className="text-white/40 shrink-0" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="">Unlimited personal secrets</span>
</li>
<li className="flex items-start gap-3 text-sm text-gray-300 font-geist">
<iconify-icon className="text-white/40 shrink-0" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<span className="">No team sharing</span>
</li>
</ul>
</div>

<div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-white/20 flex flex-col bg-white/[0.02] relative group overflow-hidden">
<div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-emerald-500 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 shadow-[0_0_15px_rgba(16,185,129,0.6)]"></div>
<div className="flex items-center justify-between mb-2">
<h3 className="text-lg font-medium text-white font-geist tracking-tight">
                Pro
              </h3>
<span className="text-[10px] font-semibold text-white uppercase tracking-widest font-geist border border-white/20 px-2 py-0.5 rounded bg-white/10">
                Most Popular
              </span>
</div>
<p className="text-sm text-gray-400 font-geist mb-6">
...
<li className="flex items-start gap-3 text-sm text-gray-300 font-geist">
<iconify-icon className="text-white shrink-0" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="">Advanced role-based access</span>
</li>
<li className="flex items-start gap-3 text-sm text-gray-300 font-geist">
<iconify-icon className="text-white shrink-0" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
<span className="">CI/CD Pipeline integrations</span>
</li>
<li className="flex items-start gap-3 text-sm text-gray-300 font-geist">
<iconify-icon className="text-white shrink-0" height="20" icon="solar:check-circle-linear" width="20"></iconify-icon>
...
<p className="text-sm text-gray-400 font-geist mb-6">
              Custom infrastructure for large orgs.
            </p>
<div className="flex items-baseline gap-1 mb-8">
<span className="text-4xl font-normal text-white tracking-tight">
                Custom
...
<div className="border-white/[0.06] overflow-hidden bg-[#050505]/50 border-t mt-0 pt-8 pb-8 relative" data-section="marquee-bottom">
<div className="max-w-7xl mx-auto px-6 md:px-12 relative">
...
<div className="flex flex-col bg-[#050505] w-full border-t relative items-center justify-center border-white/20" data-section="faq-section">

<div className="absolute inset-0 bg-radial-gradient from-white/[0.03] to-transparent pointer-events-none"></div>
<div className="grid grid-cols-1 lg:grid-cols-2 z-10 w-full max-w-7xl mr-auto ml-auto relative">

<div className="flex flex-col md:p-12 lg:p-16 lg:border-b-0 lg:border-r min-h-[500px] h-full border-b pt-8 pr-8 pb-8 pl-8 justify-between border-white/20">
...
<div className="group border-b border-white/[0.06] p-8 md:p-10 flex items-center justify-between cursor-pointer hover:bg-white/[0.02] transition-colors">
...
<div className="group p-8 md:p-10 flex items-center justify-between cursor-pointer hover:bg-white/[0.02] transition-colors">
<span className="text-lg text-white font-geist font-light tracking-tight uppercase pr-8">
...
<div className="flex flex-col overflow-hidden text-center bg-[#050505] w-full border-t pt-32 pr-6 pb-32 pl-6 relative items-center justify-center border-white/20" data-section="cta-ready-to-secure">

<div className="absolute inset-0 bg-radial-gradient from-white/[0.04] to-transparent pointer-events-none"></div>
...
<footer className="z-20 w-full border-t relative border-white/20" data-section="footer">
<div className="border-x md:px-12 bg-[#050505] max-w-7xl mx-auto px-6 py-16 border-white/20">
<div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-8">

<div className="col-span-2 flex flex-col gap-6">
<a className="flex items-center gap-0 font-geist text-2xl tracking-tighter" href="#">
<span className="font-black">L</span>
<span className="font-thin tracking-normal">umen</span>
</a>
<p className="text-sm text-gray-500 font-geist max-w-xs leading-relaxed">
              The specialized password manager built for development agencies.
              Securely share credentials across teams and clients with absolute
              zero-trust encryption.
            </p>
<div className="flex items-center gap-4">
<a className="w-8 h-8 rounded-full border border-white/5 bg-white/[0.02] flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all" href="#">
<iconify-icon className="" icon="ri:twitter-x-fill" width="16"></iconify-icon>
</a>
<a className="w-8 h-8 rounded-full border border-white/5 bg-white/[0.02] flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all" href="#">
<iconify-icon className="" icon="ri:github-fill" width="18"></iconify-icon>
</a>
<a className="w-8 h-8 rounded-full border border-white/5 bg-white/[0.02] flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all" href="#">
<iconify-icon icon="ri:discord-fill" width="18"></iconify-icon>
</a>
</div>
</div>

<div className="flex flex-col gap-6">
<h4 className="text-xs font-bold text-white uppercase tracking-widest font-geist">
              Product
            </h4>
<ul className="flex flex-col gap-3">
<li>
<a className="text-sm text-gray-500 hover:text-white transition-colors font-geist" href="#">
                  Features
                </a>
</li>
<li className="">
...
<div className="border-t mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 border-white/20">
<p className="text-xs text-gray-600 font-geist">
            © 2024 Lumen Security Inc. All rights reserved. Built with
            cryptographic integrity.
          </p>
<div className="flex items-center gap-6">
<div className="flex items-center gap-2">
<span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
<span className="text-xs text-gray-500 font-geist tracking-tight">
                Systems Operational
              </span>
</div>
<div className="flex items-center gap-1 border border-white/10 rounded-md px-2 py-1 bg-white/[0.02]">
<iconify-icon className="text-gray-500" icon="solar:globus-linear" width="14"></iconify-icon>
<span className="text-[10px] text-gray-400 font-medium font-geist">
                Global / EN
              </span>
</div>
</div>

...
<div className="bg-gradient-to-b from-white/30 via-white/20 to-white/90 absolute top-0 right-0 bottom-0 left-0"></div>
</div>
...
<p className="md:text-2xl leading-relaxed text-xl font-normal text-zinc-600 tracking-tight max-w-2xl mr-auto mb-12 ml-auto">Stop chasing leads. Zoey handles the outreach, the booking, and the follow-up 24/7. You just take the meeting.</p>
